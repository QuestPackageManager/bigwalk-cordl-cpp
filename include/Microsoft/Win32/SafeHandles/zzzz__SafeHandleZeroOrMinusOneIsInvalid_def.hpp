...
/// @brief Method .ctor, addr 0x1815dd5b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  ownsHandle) ;

/// @brief Method get_IsInvalid, addr 0x1815dd5c0, size 0x50, virtual true, abstract: false, final false
