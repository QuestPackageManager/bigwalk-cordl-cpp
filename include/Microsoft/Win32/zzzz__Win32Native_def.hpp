...
public:
// Declarations
/// @brief Method GetMessage, addr 0x1815e83b0, size 0x30, virtual false, abstract: false, final false
static inline ::StringW GetMessage(int32_t  hr) ;

/// @brief Method MakeHRFromErrorCode, addr 0x1815e83e0, size 0x10, virtual false, abstract: false, final false
