...
// Write type traits
MARK_REF_T(::Microsoft::CSharp::CodeDomProvider*);
DEFINE_IL2CPP_CLASS(::Microsoft::CSharp::CodeDomProvider*, "Microsoft.CSharp", "CodeDomProvider");
...
static_assert(sizeof(::Microsoft::CSharp::CodeDomProvider) == 0x10, "Size mismatch!");
