...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::WaterBodyExclusion);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::WaterBodyExclusion, "WaveHarmonic.Crest", "WaterBodyExclusion");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.WaterBodyExclusion
...
static ::WaveHarmonic::Crest::WaterBodyExclusion const Exclude;

/// @brief Field Include value: I32(1)
static ::WaveHarmonic::Crest::WaterBodyExclusion const Include;

/// @brief Field None value: I32(0)
static ::WaveHarmonic::Crest::WaterBodyExclusion const None;
...
static_assert(offsetof(::WaveHarmonic::Crest::WaterBodyExclusion, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::WaterBodyExclusion) == 0x4, "Size mismatch!");
