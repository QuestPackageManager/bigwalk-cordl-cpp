...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::WaterDataBackgroundMode);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::WaterDataBackgroundMode, "WaveHarmonic.Crest", "WaterDataBackgroundMode");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.WaterDataBackgroundMode
...
static ::WaveHarmonic::Crest::WaterDataBackgroundMode const Always;

/// @brief Field Disabled value: I32(2)
static ::WaveHarmonic::Crest::WaterDataBackgroundMode const Disabled;

/// @brief Field Inactive value: I32(1)
static ::WaveHarmonic::Crest::WaterDataBackgroundMode const Inactive;

/// @brief Field Never value: I32(3)
static ::WaveHarmonic::Crest::WaterDataBackgroundMode const Never;
...
static_assert(offsetof(::WaveHarmonic::Crest::WaterDataBackgroundMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::WaterDataBackgroundMode) == 0x4, "Size mismatch!");
