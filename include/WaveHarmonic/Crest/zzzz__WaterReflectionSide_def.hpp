...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::WaterReflectionSide);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::WaterReflectionSide, "WaveHarmonic.Crest", "WaterReflectionSide");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.WaterReflectionSide
...
static ::WaveHarmonic::Crest::WaterReflectionSide const Above;

/// @brief Field Below value: I32(2)
static ::WaveHarmonic::Crest::WaterReflectionSide const Below;

/// @brief Field Both value: I32(0)
static ::WaveHarmonic::Crest::WaterReflectionSide const Both;
...
static_assert(offsetof(::WaveHarmonic::Crest::WaterReflectionSide, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::WaterReflectionSide) == 0x4, "Size mismatch!");
