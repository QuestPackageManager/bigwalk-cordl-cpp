...
#include <cstdint>
CORDL_MODULE_EXPORT(AlbedoLodInput)
...
namespace WaveHarmonic::Crest {
class AlbedoLodInput;
}
// Write type traits
MARK_REF_T(::WaveHarmonic::Crest::AlbedoLodInput*);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::AlbedoLodInput*, "WaveHarmonic.Crest", "AlbedoLodInput");
// Dependencies WaveHarmonic.Crest.LodInput
namespace WaveHarmonic::Crest {
// Is value type: false
// CS Name: WaveHarmonic.Crest.AlbedoLodInput
class CORDL_TYPE AlbedoLodInput : public ::WaveHarmonic::Crest::LodInput {
public:
// Declarations
...
static inline ::WaveHarmonic::Crest::AlbedoLodInput* New_ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr AlbedoLodInput() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "AlbedoLodInput", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AlbedoLodInput(AlbedoLodInput && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AlbedoLodInput", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
AlbedoLodInput(AlbedoLodInput const& ) = delete;
...
static_assert(sizeof(::WaveHarmonic::Crest::AlbedoLodInput) == 0xb0, "Size mismatch!");
