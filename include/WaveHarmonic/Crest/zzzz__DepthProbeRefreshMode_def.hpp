...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::DepthProbeRefreshMode);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::DepthProbeRefreshMode, "WaveHarmonic.Crest", "DepthProbeRefreshMode");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.DepthProbeRefreshMode
...
static ::WaveHarmonic::Crest::DepthProbeRefreshMode const EveryFrame;

/// @brief Field OnStart value: I32(0)
static ::WaveHarmonic::Crest::DepthProbeRefreshMode const OnStart;

/// @brief Field ViaScripting value: I32(2)
static ::WaveHarmonic::Crest::DepthProbeRefreshMode const ViaScripting;
...
static_assert(offsetof(::WaveHarmonic::Crest::DepthProbeRefreshMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::DepthProbeRefreshMode) == 0x4, "Size mismatch!");
