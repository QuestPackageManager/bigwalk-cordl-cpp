#pragma once
// IWYU pragma private; include "WaveHarmonic/Crest/FloatingObjectModel.hpp"
...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::FloatingObjectModel);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::FloatingObjectModel, "WaveHarmonic.Crest", "FloatingObjectModel");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.FloatingObjectModel
...
static ::WaveHarmonic::Crest::FloatingObjectModel const AlignNormal;

/// @brief Field Probes value: I32(1)
static ::WaveHarmonic::Crest::FloatingObjectModel const Probes;
...
static_assert(offsetof(::WaveHarmonic::Crest::FloatingObjectModel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::FloatingObjectModel) == 0x4, "Size mismatch!");
