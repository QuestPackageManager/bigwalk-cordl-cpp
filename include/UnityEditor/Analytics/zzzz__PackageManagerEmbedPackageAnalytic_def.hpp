...
public:
// Declarations
/// @brief Method CreatePackageManagerEmbedPackageAnalytic, addr 0x1825478a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1825478f0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
