...
/// @brief Field asset_extensions, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_asset_extensions, put=__cordl_internal_set_asset_extensions)) ::ArrayW<::StringW>  asset_extensions;
...
/// @brief Method CreateAssetExportAnalytic, addr 0x182546730, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_asset_extensions() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_asset_extensions() ;
...
constexpr void __cordl_internal_set_asset_extensions(::ArrayW<::StringW>  value) ;
...
/// @brief Method .ctor, addr 0x182546780, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field asset_extensions, offset: 0x48, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___asset_extensions;
...
static_assert(sizeof(::UnityEditor::Analytics::AssetExportAnalytic) == 0x58, "Size mismatch!");
