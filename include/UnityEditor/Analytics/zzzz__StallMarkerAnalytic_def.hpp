...
/// @brief Method CreateStallMarkerAnalytic, addr 0x182548010, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182548060, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::StallMarkerAnalytic) == 0x48, "Size mismatch!");
