...
// Write type traits
MARK_REF_T(::UnityEngine::Collision2D*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Collision2D*, "UnityEngine", "Collision2D");
// Dependencies System.Object, UnityEngine.ContactPoint2D, UnityEngine.Vector2
namespace UnityEngine {
// Is value type: false
...
/// @brief Field m_LegacyContacts, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_LegacyContacts, put=__cordl_internal_set_m_LegacyContacts)) ::ArrayW<::UnityEngine::ContactPoint2D>  m_LegacyContacts;
...
/// @brief Field m_ReusedContacts, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ReusedContacts, put=__cordl_internal_set_m_ReusedContacts)) ::ArrayW<::UnityEngine::ContactPoint2D>  m_ReusedContacts;
...
/// @brief Field m_Rigidbody, offset 0x18, size 0x4 
 ...
 __declspec(property(get=get_relativeVelocity)) ::UnityEngine::Vector2  relativeVelocity;

 __declspec(property(get=get_rigidbody)) ::UnityW<::UnityEngine::Rigidbody2D>  rigidbody;
...
constexpr ::ArrayW<::UnityEngine::ContactPoint2D> const& __cordl_internal_get_m_LegacyContacts() const;

constexpr ::ArrayW<::UnityEngine::ContactPoint2D>& __cordl_internal_get_m_LegacyContacts() ;
...
constexpr ::ArrayW<::UnityEngine::ContactPoint2D> const& __cordl_internal_get_m_ReusedContacts() const;

constexpr ::ArrayW<::UnityEngine::ContactPoint2D>& __cordl_internal_get_m_ReusedContacts() ;
...
constexpr void __cordl_internal_set_m_LegacyContacts(::ArrayW<::UnityEngine::ContactPoint2D>  value) ;
...
constexpr void __cordl_internal_set_m_ReusedContacts(::ArrayW<::UnityEngine::ContactPoint2D>  value) ;

constexpr void __cordl_internal_set_m_Rigidbody(int32_t  value) ;

/// @brief Method get_collider, addr 0x1822f0b50, size 0x70, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider2D> get_collider() ;

/// @brief Method get_relativeVelocity, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_relativeVelocity() ;

/// @brief Method get_rigidbody, addr 0x1822f0bc0, size 0x40, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody2D> get_rigidbody() ;

/// @brief Method get_transform, addr 0x1822f0c00, size 0x3e0, virtual false, abstract: false, final false
...
/// @brief Field m_ReusedContacts, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::ContactPoint2D>  ___m_ReusedContacts;

/// @brief Field m_LegacyContacts, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::ContactPoint2D>  ___m_LegacyContacts;
...
static_assert(sizeof(::UnityEngine::Collision2D) == 0x40, "Size mismatch!");
