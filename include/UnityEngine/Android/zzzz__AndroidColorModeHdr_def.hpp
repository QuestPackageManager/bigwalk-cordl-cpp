...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidColorModeHdr, "UnityEngine.Android", "AndroidColorModeHdr");
// Dependencies 
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Android::AndroidColorModeHdr, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Android::AndroidColorModeHdr) == 0x4, "Size mismatch!");
