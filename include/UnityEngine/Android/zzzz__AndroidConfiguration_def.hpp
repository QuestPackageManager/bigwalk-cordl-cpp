...
/// @brief Method ToString, addr 0x182224b60, size 0x650, virtual true, abstract: false, final false
...
/// @brief Method get_colorMode, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_colorMode() ;

/// @brief Method get_colorModeHdr, addr 0x1822251b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidColorModeHdr get_colorModeHdr() ;

/// @brief Method get_colorModeWideColorGamut, addr 0x1822251c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidColorModeWideColorGamut get_colorModeWideColorGamut() ;

/// @brief Method get_densityDpi, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_densityDpi() ;

/// @brief Method get_fontScale, addr 0x18048d8a0, size 0x10, virtual false, abstract: false, final false
inline float_t get_fontScale() ;

/// @brief Method get_fontWeightAdjustment, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_fontWeightAdjustment() ;

/// @brief Method get_hardKeyboardHidden, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidHardwareKeyboardHidden get_hardKeyboardHidden() ;

/// @brief Method get_keyboard, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidKeyboard get_keyboard() ;

/// @brief Method get_keyboardHidden, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidKeyboardHidden get_keyboardHidden() ;

/// @brief Method get_locales, addr 0x1822251d0, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Android::AndroidLocale*> get_locales() ;

/// @brief Method get_mobileCountryCode, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_mobileCountryCode() ;

/// @brief Method get_mobileNetworkCode, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_mobileNetworkCode() ;

/// @brief Method get_navigation, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidNavigation get_navigation() ;

/// @brief Method get_navigationHidden, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidNavigationHidden get_navigationHidden() ;

/// @brief Method get_orientation, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidOrientation get_orientation() ;

/// @brief Method get_primaryLocaleCountry, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_primaryLocaleCountry() ;

/// @brief Method get_primaryLocaleLanguage, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_primaryLocaleLanguage() ;

/// @brief Method get_screenHeightDp, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_screenHeightDp() ;

/// @brief Method get_screenLayout, addr 0x180e25b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_screenLayout() ;

/// @brief Method get_screenLayoutDirection, addr 0x182225280, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidScreenLayoutDirection get_screenLayoutDirection() ;

/// @brief Method get_screenLayoutLong, addr 0x182225290, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidScreenLayoutLong get_screenLayoutLong() ;

/// @brief Method get_screenLayoutRound, addr 0x1822252a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidScreenLayoutRound get_screenLayoutRound() ;

/// @brief Method get_screenLayoutSize, addr 0x1822252b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidScreenLayoutSize get_screenLayoutSize() ;

/// @brief Method get_screenWidthDp, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
inline int32_t get_screenWidthDp() ;

/// @brief Method get_smallestScreenWidthDp, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_smallestScreenWidthDp() ;

/// @brief Method get_touchScreen, addr 0x1803d7410, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidTouchScreen get_touchScreen() ;

/// @brief Method get_uiMode, addr 0x180497940, size 0x10, virtual false, abstract: false, final false
inline int32_t get_uiMode() ;

/// @brief Method get_uiModeNight, addr 0x1822252c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidUIModeNight get_uiModeNight() ;

/// @brief Method get_uiModeType, addr 0x1822252d0, size 0x1c0, virtual false, abstract: false, final false
