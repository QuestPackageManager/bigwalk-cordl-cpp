...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidLocale*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidLocale*, "UnityEngine.Android", "AndroidLocale");
...
/// @brief Method get_country, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_country() ;

/// @brief Method get_language, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidLocale) == 0x20, "Size mismatch!");
