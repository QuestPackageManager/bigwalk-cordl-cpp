...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::LightType, "UnityEngine.Experimental.GlobalIllumination", "LightType");
// Dependencies 
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::LightType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::LightType) == 0x1, "Size mismatch!");
