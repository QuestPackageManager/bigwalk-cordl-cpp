...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::LightMode, "UnityEngine.Experimental.GlobalIllumination", "LightMode");
// Dependencies 
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::LightMode, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::LightMode) == 0x1, "Size mismatch!");
