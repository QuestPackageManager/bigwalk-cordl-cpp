...
constexpr RectangleLight(::UnityEngine::EntityId  entityId, bool  shadow, ::UnityEngine::Experimental::GlobalIllumination::LightMode  mode, ::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  orientation, ::UnityEngine::Experimental::GlobalIllumination::LinearColor  color, ::UnityEngine::Experimental::GlobalIllumination::LinearColor  indirectColor, float_t  range, float_t  width, float_t  height, ::UnityEngine::Experimental::GlobalIllumination::FalloffType  falloff) noexcept;
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::RectangleLight, entityId) == 0x0, "Offset mismatch!");
