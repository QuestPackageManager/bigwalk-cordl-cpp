...
/// @brief Method BuiltinUpdate, addr 0x1822a4de0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Internal_BuiltinRuntimeReflectionSystem_New, addr 0x1822a4df0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method TickRealtimeProbes, addr 0x1822a4de0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Experimental::Rendering::BuiltinRuntimeReflectionSystem) == 0x10, "Size mismatch!");
