...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::DefaultFormat, "UnityEngine.Experimental.Rendering", "DefaultFormat");
// Dependencies 
namespace UnityEngine::Experimental::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::Rendering::DefaultFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::Rendering::DefaultFormat) == 0x4, "Size mismatch!");
