...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::GraphicsFormat, "UnityEngine.Experimental.Rendering", "GraphicsFormat");
// Dependencies 
namespace UnityEngine::Experimental::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::Rendering::GraphicsFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::Rendering::GraphicsFormat) == 0x4, "Size mismatch!");
