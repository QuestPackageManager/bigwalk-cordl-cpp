...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::TextureCreationFlags, "UnityEngine.Experimental.Rendering", "TextureCreationFlags");
// Dependencies 
namespace UnityEngine::Experimental::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::Rendering::TextureCreationFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::Rendering::TextureCreationFlags) == 0x4, "Size mismatch!");
