...
// Write type traits
MARK_REF_T(::UnityEngine::Experimental::Rendering::XRMirrorView*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::XRMirrorView*, "UnityEngine.Experimental.Rendering", "XRMirrorView");
...
/// @brief Method RenderMirrorView, addr 0x181fdef80, size 0xb60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Experimental::Rendering::XRMirrorView) == 0x10, "Size mismatch!");
