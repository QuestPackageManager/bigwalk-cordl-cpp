...
public:
// Declarations
/// @brief Method CompareColors, addr 0x1823597a0, size 0x140, virtual false, abstract: false, final false
inline bool CompareColors(::UnityEngine::Color  left, ::UnityEngine::Color  right) ;

/// @brief Method CompareVector2, addr 0x1823598e0, size 0xc0, virtual false, abstract: false, final false
inline bool CompareVector2(::UnityEngine::Vector2  left, ::UnityEngine::Vector2  right) ;

/// @brief Method Equals, addr 0x1823599a0, size 0x270, virtual false, abstract: false, final false
