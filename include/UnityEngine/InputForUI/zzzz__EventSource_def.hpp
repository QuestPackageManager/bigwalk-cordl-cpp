...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::EventSource, "UnityEngine.InputForUI", "EventSource");
// Dependencies 
namespace UnityEngine::InputForUI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::InputForUI::EventSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::EventSource) == 0x4, "Size mismatch!");
