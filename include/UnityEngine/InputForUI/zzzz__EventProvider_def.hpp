...
// Ctor Parameters [CppParam { name: "handler", ty: "::UnityEngine::InputForUI::EventConsumer*", modifiers: "", def_value: None }, CppParam { name: "priority", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "playerId", ty: "::System::Nullable_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "_types", ty: "::System::Collections::Generic::HashSet_1<::UnityEngine::InputForUI::Event_Type>*", modifiers: "", def_value: None }]
constexpr EventProvider_Registration(::UnityEngine::InputForUI::EventConsumer*  handler, int32_t  priority, ::System::Nullable_1<int32_t>  playerId, ::System::Collections::Generic::HashSet_1<::UnityEngine::InputForUI::Event_Type>*  _types) noexcept;
...
/// @brief Method <Subscribe>b__7_0, addr 0x18045a3b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method <Unsubscribe>b__0, addr 0x1822eb610, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "EventProvider___c__DisplayClass8_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
EventProvider___c__DisplayClass8_0(EventProvider___c__DisplayClass8_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "EventProvider___c__DisplayClass8_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
...
/// @brief Method Bootstrap, addr 0x1822e49d0, size 0x40, virtual false, abstract: false, final false
static inline void Bootstrap() ;

/// @brief Method Dispatch, addr 0x1822e4a10, size 0x130, virtual false, abstract: false, final false
static inline void Dispatch(::by_ref<::UnityEngine::InputForUI::Event>  ev) ;

/// @brief Method Initialize, addr 0x1822e4b40, size 0xe0, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method NotifyUpdate, addr 0x1822e4c20, size 0xc0, virtual false, abstract: false, final false
static inline void NotifyUpdate() ;

/// @brief Method OnFocusChanged, addr 0x1822e4ce0, size 0xc0, virtual false, abstract: false, final false
static inline void OnFocusChanged(bool  focus) ;

/// @brief Method SetEnabled, addr 0x1822e4da0, size 0xf0, virtual false, abstract: false, final false
static inline void SetEnabled(bool  enable) ;

/// @brief Method Shutdown, addr 0x1822e4e90, size 0xb0, virtual false, abstract: false, final false
static inline void Shutdown() ;

/// @brief Method Subscribe, addr 0x1822e4f40, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method Unsubscribe, addr 0x1822e51a0, size 0xa0, virtual false, abstract: false, final false
