...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::NavigationEvent_Direction, "UnityEngine.InputForUI", "NavigationEvent/Direction");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::NavigationEvent_Type, "UnityEngine.InputForUI", "NavigationEvent/Type");
...
static_assert(offsetof(::UnityEngine::InputForUI::NavigationEvent_Type, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::NavigationEvent_Type) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::InputForUI::NavigationEvent_Direction, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method DetermineMoveDirection, addr 0x1822ea520, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x1822ea590, size 0x140, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_eventModifiers, addr 0x180396ee0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x1802f41a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_eventModifiers, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x1802f43d0, size 0x10, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x1804bda40, size 0x10, virtual false, abstract: false, final false
