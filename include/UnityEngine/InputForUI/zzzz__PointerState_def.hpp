...
/// @brief Method OnButtonChange, addr 0x1822eb120, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method OnButtonDown, addr 0x1822eb1e0, size 0x80, virtual false, abstract: false, final false
inline void OnButtonDown(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::InputForUI::PointerEvent_Button  button) ;

/// @brief Method OnButtonUp, addr 0x1822eb260, size 0x20, virtual false, abstract: false, final false
inline void OnButtonUp(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::InputForUI::PointerEvent_Button  button) ;

/// @brief Method OnMove, addr 0x1822eb280, size 0x30, virtual false, abstract: false, final false
inline void OnMove(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::Vector2  position, int32_t  displayIndex) ;

/// @brief Method Reset, addr 0x1822eb2b0, size 0x60, virtual false, abstract: false, final false
inline void Reset() ;

static inline ::Unity::IntegerTime::DiscreteTime getStaticF_kClickDelay() ;

/// @brief Method get_ButtonsState, addr 0x18038fe90, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::PointerEvent_ButtonsState get_ButtonsState() ;

/// @brief Method get_ClickCount, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ClickCount() ;

/// @brief Method get_LastDisplayIndex, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LastDisplayIndex() ;

/// @brief Method get_LastPosition, addr 0x180346a90, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_LastPosition() ;

/// @brief Method get_LastPositionValid, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_LastPositionValid() ;

/// @brief Method get_LastPressedButton, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::PointerEvent_Button get_LastPressedButton() ;

/// @brief Method get_NextPressTime, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ClickCount, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_ClickCount(int32_t  value) ;

/// @brief Method set_LastDisplayIndex, addr 0x1802f43d0, size 0x10, virtual false, abstract: false, final false
inline void set_LastDisplayIndex(int32_t  value) ;

/// @brief Method set_LastPosition, addr 0x180346ab0, size 0x10, virtual false, abstract: false, final false
inline void set_LastPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_LastPositionValid, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_LastPositionValid(bool  value) ;

/// @brief Method set_LastPressedButton, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
inline void set_LastPressedButton(::UnityEngine::InputForUI::PointerEvent_Button  value) ;

/// @brief Method set_NextPressTime, addr 0x1804bda50, size 0x10, virtual false, abstract: false, final false
