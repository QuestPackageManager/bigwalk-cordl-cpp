...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::KeyEvent_Type, "UnityEngine.InputForUI", "KeyEvent/Type");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::ButtonsState_KeyEvent__buttons_e__FixedBuffer, "UnityEngine.InputForUI", "KeyEvent/ButtonsState/<buttons>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::KeyEvent, "UnityEngine.InputForUI", "KeyEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::KeyEvent_ButtonsState, "UnityEngine.InputForUI", "KeyEvent/ButtonsState");
// Dependencies 
namespace UnityEngine::InputForUI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::InputForUI::KeyEvent_Type, value__) == 0x4, "Offset mismatch!");
...
static_assert(sizeof(::UnityEngine::InputForUI::ButtonsState_KeyEvent__buttons_e__FixedBuffer) == 0x28, "Size mismatch!");
...
/// @brief Method ClearUnchecked, addr 0x1822e3ca0, size 0x20, virtual false, abstract: false, final false
inline void ClearUnchecked(uint32_t  index) ;

/// @brief Method GetAllPressed, addr 0x1822e3e40, size 0x80, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::KeyCode>* GetAllPressed() ;

/// @brief Method GetUnchecked, addr 0x1822e3cc0, size 0x20, virtual false, abstract: false, final false
inline bool GetUnchecked(uint32_t  index) ;

/// @brief Method IsPressed, addr 0x1822e3ec0, size 0x40, virtual false, abstract: false, final false
inline bool IsPressed(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method Reset, addr 0x1822e3f00, size 0x20, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetPressed, addr 0x1822e3f20, size 0x40, virtual false, abstract: false, final false
inline void SetPressed(::UnityEngine::KeyCode  keyCode, bool  pressed) ;

/// @brief Method SetUnchecked, addr 0x1822e3cf0, size 0x20, virtual false, abstract: false, final false
inline void SetUnchecked(uint32_t  index) ;

/// @brief Method ShouldBeProcessed, addr 0x1822e3f60, size 0x10, virtual false, abstract: false, final false
static inline bool ShouldBeProcessed(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method ToString, addr 0x1822e3f70, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x1822eb500, size 0x60, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::InputForUI::ButtonsState_KeyEvent__GetAllPressed_d__8* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.KeyCode>.GetEnumerator, addr 0x1822eb560, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.KeyCode>.get_Current, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::KeyCode System_Collections_Generic_IEnumerator_UnityEngine_KeyCode__get_Current() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1822eb560, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1822eb5e0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x1822ea350, size 0xe0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_eventModifiers, addr 0x1803eb0e0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x180392fe0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_eventModifiers, addr 0x180511530, size 0x10, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x180393000, size 0x10, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x1803c8fa0, size 0x10, virtual false, abstract: false, final false
