...
/// @brief Method ToString, addr 0x1822e6550, size 0xd0, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "compositionString", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_timestamp_k__BackingField", ty: "::Unity::IntegerTime::DiscreteTime", modifiers: "", def_value: None }, CppParam { name: "_eventSource_k__BackingField", ty: "::UnityEngine::InputForUI::EventSource", modifiers: "", def_value: None }, CppParam { name: "_playerId_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_eventModifiers_k__BackingField", ty: "::UnityEngine::InputForUI::EventModifiers", modifiers: "", def_value: None }]
constexpr IMECompositionEvent(::StringW  compositionString, ::Unity::IntegerTime::DiscreteTime  _timestamp_k__BackingField, ::UnityEngine::InputForUI::EventSource  _eventSource_k__BackingField, uint32_t  _playerId_k__BackingField, ::UnityEngine::InputForUI::EventModifiers  _eventModifiers_k__BackingField) noexcept;
...
static_assert(sizeof(::UnityEngine::InputForUI::IMECompositionEvent) == 0x20, "Size mismatch!");
