...
// Write type traits
MARK_REF_T(::UnityEngine::InputForUI::InputEventPartialProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::InputEventPartialProvider*, "UnityEngine.InputForUI", "InputEventPartialProvider");
...
/// @brief Method GetTimestamp, addr 0x1822e6620, size 0x30, virtual false, abstract: false, final false
inline ::Unity::IntegerTime::DiscreteTime GetTimestamp(::by_ref<::UnityEngine::Event*>  ev) ;

/// @brief Method Initialize, addr 0x1822e6650, size 0x30, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::UnityEngine::InputForUI::InputEventPartialProvider* New_ctor() ;

/// @brief Method OnFocusChanged, addr 0x1822e6680, size 0x20, virtual true, abstract: false, final true
inline void OnFocusChanged(bool  focus) ;

/// @brief Method SendNextOrPreviousNavigationEventOnTabKeyDownEvent, addr 0x1822e66a0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ToCommandEvent, addr 0x1822e6810, size 0x180, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::CommandEvent ToCommandEvent(::by_ref<::UnityEngine::Event*>  ev) ;

/// @brief Method ToKeyEvent, addr 0x1822e6990, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::KeyEvent ToKeyEvent(::by_ref<::UnityEngine::Event*>  ev) ;

/// @brief Method ToTextInputEvent, addr 0x1822e6ae0, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::TextInputEvent ToTextInputEvent(::by_ref<::UnityEngine::Event*>  ev) ;

/// @brief Method Update, addr 0x1822e6dd0, size 0x370, virtual true, abstract: false, final true
inline void Update() ;

/// @brief Method UpdateEventModifiers, addr 0x1822e6b50, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822e7140, size 0x300, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::InputForUI::InputEventPartialProvider) == 0x58, "Size mismatch!");
