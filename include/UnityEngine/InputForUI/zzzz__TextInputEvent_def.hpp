...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(TextInputEvent)
...
/// @brief Method ToString, addr 0x1822eb410, size 0xd0, virtual true, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::InputForUI::TextInputEvent, _timestamp_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputForUI::TextInputEvent, _eventSource_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputForUI::TextInputEvent, _playerId_k__BackingField) == 0x14, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::InputForUI::TextInputEvent, _eventModifiers_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::TextInputEvent) == 0x20, "Size mismatch!");
