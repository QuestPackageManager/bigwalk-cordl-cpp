...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::PointerEvent_Button, "UnityEngine.InputForUI", "PointerEvent/Button");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::PointerEvent_Type, "UnityEngine.InputForUI", "PointerEvent/Type");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::PointerEvent, "UnityEngine.InputForUI", "PointerEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::PointerEvent_ButtonsState, "UnityEngine.InputForUI", "PointerEvent/ButtonsState");
// Dependencies 
namespace UnityEngine::InputForUI {
// Is value type: true
...
static ::UnityEngine::InputForUI::PointerEvent_Type const TrackedCanceled;
...
static_assert(offsetof(::UnityEngine::InputForUI::PointerEvent_Type, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::PointerEvent_Type) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::InputForUI::PointerEvent_Button, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::PointerEvent_Button) == 0x4, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Get, addr 0x1822e3ce0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x181e0ed10, size 0x20, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputForUI::PointerEvent_Button  button, bool  pressed) ;

/// @brief Method ToString, addr 0x1822e3ff0, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputForUI::PointerEvent_ButtonsState) == 0x4, "Size mismatch!");
...
/// @brief Method ButtonFromButtonIndex, addr 0x1822ea6d0, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::InputForUI::PointerEvent_Button ButtonFromButtonIndex(int32_t  index) ;

/// @brief Method ToString, addr 0x1822ea6e0, size 0x660, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_altitude, addr 0x1822ead40, size 0x60, virtual false, abstract: false, final false
inline float_t get_altitude() ;

/// @brief Method get_azimuth, addr 0x1822eada0, size 0xe0, virtual false, abstract: false, final false
inline float_t get_azimuth() ;

/// @brief Method get_eventModifiers, addr 0x1803becf0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x1803fa740, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventSource get_eventSource() ;

/// @brief Method get_isPrimaryPointer, addr 0x1822eae80, size 0x20, virtual false, abstract: false, final false
inline bool get_isPrimaryPointer() ;

/// @brief Method get_timestamp, addr 0x1802e5710, size 0x10, virtual true, abstract: false, final true
inline ::Unity::IntegerTime::DiscreteTime get_timestamp() ;

/// @brief Method get_worldRay, addr 0x1822eaea0, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method set_eventModifiers, addr 0x180511560, size 0x10, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x18051e950, size 0x10, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x18051e940, size 0x10, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x180511570, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::InputForUI::PointerEvent_Type", modifiers: "", def_value: None }, CppParam { name: "pointerIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "position", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "deltaPosition", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "worldPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "worldOrientation", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }, CppParam { name: "maxDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "scroll", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "displayIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "tilt", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "twist", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "pressure", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "isInverted", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "button", ty: "::UnityEngine::InputForUI::PointerEvent_Button", modifiers: "", def_value: None }, CppParam { name: "buttonsState", ty: "::UnityEngine::InputForUI::PointerEvent_ButtonsState", modifiers: "", def_value: None }, CppParam { name: "clickCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_timestamp_k__BackingField", ty: "::Unity::IntegerTime::DiscreteTime", modifiers: "", def_value: None }, CppParam { name: "_eventSource_k__BackingField", ty: "::UnityEngine::InputForUI::EventSource", modifiers: "", def_value: None }, CppParam { name: "_playerId_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_eventModifiers_k__BackingField", ty: "::UnityEngine::InputForUI::EventModifiers", modifiers: "", def_value: None }]
constexpr PointerEvent(::UnityEngine::InputForUI::PointerEvent_Type  type, int32_t  pointerIndex, ::UnityEngine::Vector2  position, ::UnityEngine::Vector2  deltaPosition, ::UnityEngine::Vector3  worldPosition, ::UnityEngine::Quaternion  worldOrientation, float_t  maxDistance, ::UnityEngine::Vector2  scroll, int32_t  displayIndex, ::UnityEngine::Vector2  tilt, float_t  twist, float_t  pressure, bool  isInverted, ::UnityEngine::InputForUI::PointerEvent_Button  button, ::UnityEngine::InputForUI::PointerEvent_ButtonsState  buttonsState, int32_t  clickCount, ::Unity::IntegerTime::DiscreteTime  _timestamp_k__BackingField, ::UnityEngine::InputForUI::EventSource  _eventSource_k__BackingField, uint32_t  _playerId_k__BackingField, ::UnityEngine::InputForUI::EventModifiers  _eventModifiers_k__BackingField) noexcept;
