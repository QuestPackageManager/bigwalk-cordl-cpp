...
// Ctor Parameters [CppParam { name: "viewTotal", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "viewCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "viewOffset", ty: "uint32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::VFX::VFXCameraXRSettings) == 0xc, "Size mismatch!");
