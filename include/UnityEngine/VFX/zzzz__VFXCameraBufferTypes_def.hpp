...
DEFINE_IL2CPP_CLASS(::UnityEngine::VFX::VFXCameraBufferTypes, "UnityEngine.VFX", "VFXCameraBufferTypes");
// Dependencies 
namespace UnityEngine::VFX {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::VFX::VFXCameraBufferTypes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::VFX::VFXCameraBufferTypes) == 0x4, "Size mismatch!");
