...
DEFINE_IL2CPP_CLASS(::UnityEngine::ColorGamut, "UnityEngine", "ColorGamut");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ColorGamut, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ColorGamut) == 0x4, "Size mismatch!");
