...
DEFINE_IL2CPP_CLASS(::UnityEngine::RenderTextureMemoryless, "UnityEngine", "RenderTextureMemoryless");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RenderTextureMemoryless, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RenderTextureMemoryless) == 0x4, "Size mismatch!");
