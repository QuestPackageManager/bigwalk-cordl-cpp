...
DEFINE_IL2CPP_CLASS(::UnityEngine::StateInfoIndex, "UnityEngine", "StateInfoIndex");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::StateInfoIndex, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::StateInfoIndex) == 0x4, "Size mismatch!");
