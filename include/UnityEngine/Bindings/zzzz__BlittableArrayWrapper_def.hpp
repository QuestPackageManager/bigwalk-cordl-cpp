...
DEFINE_IL2CPP_CLASS(::UnityEngine::Bindings::BlittableArrayWrapper_UpdateFlags, "UnityEngine.Bindings", "BlittableArrayWrapper/UpdateFlags");
...
static_assert(offsetof(::UnityEngine::Bindings::BlittableArrayWrapper_UpdateFlags, value__) == 0x4, "Offset mismatch!");
...
// Ctor Parameters [CppParam { name: "data", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "updateFlags", ty: "::UnityEngine::Bindings::BlittableArrayWrapper_UpdateFlags", modifiers: "", def_value: None }]
