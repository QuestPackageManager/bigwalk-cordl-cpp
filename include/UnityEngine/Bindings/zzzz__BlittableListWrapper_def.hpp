...
// Ctor Parameters [CppParam { name: "arrayWrapper", ty: "::UnityEngine::Bindings::BlittableArrayWrapper", modifiers: "", def_value: None }, CppParam { name: "listSize", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Bindings::BlittableListWrapper) == 0x18, "Size mismatch!");
