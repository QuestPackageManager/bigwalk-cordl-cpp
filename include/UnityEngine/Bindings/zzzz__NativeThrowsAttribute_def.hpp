...
/// @brief Method set_ThrowsException, addr 0x1803924a0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Bindings::NativeThrowsAttribute) == 0x18, "Size mismatch!");
