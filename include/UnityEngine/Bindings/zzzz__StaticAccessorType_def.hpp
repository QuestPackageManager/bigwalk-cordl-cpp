...
DEFINE_IL2CPP_CLASS(::UnityEngine::Bindings::StaticAccessorType, "UnityEngine.Bindings", "StaticAccessorType");
// Dependencies 
namespace UnityEngine::Bindings {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Bindings::StaticAccessorType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Bindings::StaticAccessorType) == 0x4, "Size mismatch!");
