...
/// @brief Method .ctor, addr 0x18230d570, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition) ;

/// @brief Method .ctor, addr 0x18230d530, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition, ::StringW  stubReturnStatement) ;

/// @brief Method set_Condition, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_StubReturnStatement, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Bindings::NativeConditionalAttribute) == 0x28, "Size mismatch!");
