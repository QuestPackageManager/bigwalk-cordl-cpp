...
static_assert(offsetof(::UnityEngine::Bindings::TargetType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Bindings::TargetType) == 0x4, "Size mismatch!");
