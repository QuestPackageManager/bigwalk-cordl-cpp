...
/// @brief Method SetPendingException, addr 0x18227ee40, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Bindings::ExceptionMarshaller) == 0x10, "Size mismatch!");
