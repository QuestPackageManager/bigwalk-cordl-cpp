...
/// @brief Field <DoesNotContributeToSize>k__BackingField, offset 0x10, size 0x1 
 __declspec(property(get=__cordl_internal_get__DoesNotContributeToSize_k__BackingField, put=__cordl_internal_set__DoesNotContributeToSize_k__BackingField)) bool  _DoesNotContributeToSize_k__BackingField;
...
/// @brief Method set_DoesNotContributeToSize, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Bindings::IgnoreAttribute) == 0x18, "Size mismatch!");
