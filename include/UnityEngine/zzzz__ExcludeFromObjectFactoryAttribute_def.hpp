...
// Write type traits
MARK_REF_T(::UnityEngine::ExcludeFromObjectFactoryAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ExcludeFromObjectFactoryAttribute*, "UnityEngine", "ExcludeFromObjectFactoryAttribute");
...
static_assert(sizeof(::UnityEngine::ExcludeFromObjectFactoryAttribute) == 0x10, "Size mismatch!");
