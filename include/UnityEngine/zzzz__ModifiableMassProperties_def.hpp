...
DEFINE_IL2CPP_CLASS(::UnityEngine::ModifiableMassProperties, "UnityEngine", "ModifiableMassProperties");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "inverseMassScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "inverseInertiaScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "otherInverseMassScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "otherInverseInertiaScale", ty: "float_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::ModifiableMassProperties) == 0x10, "Size mismatch!");
