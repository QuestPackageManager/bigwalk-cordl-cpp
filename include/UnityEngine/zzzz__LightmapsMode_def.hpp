...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightmapsMode, "UnityEngine", "LightmapsMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LightmapsMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LightmapsMode) == 0x4, "Size mismatch!");
