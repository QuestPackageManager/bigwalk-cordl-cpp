...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightShadows, "UnityEngine", "LightShadows");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LightShadows, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LightShadows) == 0x4, "Size mismatch!");
