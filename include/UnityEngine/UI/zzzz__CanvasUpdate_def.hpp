...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CanvasUpdate, "UnityEngine.UI", "CanvasUpdate");
// Dependencies 
namespace UnityEngine::UI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UI::CanvasUpdate, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::CanvasUpdate) == 0x4, "Size mismatch!");
