...
public:
// Declarations
/// @brief Method GetRelativeMousePositionForDrag, addr 0x182526f10, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetRelativeMousePositionForRaycast, addr 0x182526ff0, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetRelativeMousePositionForRaycast(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method RelativeMouseAtScaled, addr 0x1825270b0, size 0x3d0, virtual false, abstract: false, final false
