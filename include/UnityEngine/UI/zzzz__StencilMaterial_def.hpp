...
// Write type traits
MARK_REF_T(::UnityEngine::UI::StencilMaterial*);
MARK_REF_T(::UnityEngine::UI::StencilMaterial_MatEntry*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::StencilMaterial*, "UnityEngine.UI", "StencilMaterial");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::StencilMaterial_MatEntry*, "UnityEngine.UI", "StencilMaterial/MatEntry");
...
/// @brief Method .ctor, addr 0x182526e30, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UI::StencilMaterial_MatEntry) == 0x40, "Size mismatch!");
...
/// @brief Method Add, addr 0x1802dd520, size 0x10, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material*  baseMat, int32_t  stencilID) ;

/// @brief Method Add, addr 0x182532b10, size 0x30, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material*  baseMat, int32_t  stencilID, ::UnityEngine::Rendering::StencilOp  operation, ::UnityEngine::Rendering::CompareFunction  compareFunction, ::UnityEngine::Rendering::ColorWriteMask  colorWriteMask) ;

/// @brief Method Add, addr 0x182532b40, size 0x610, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material*  baseMat, int32_t  stencilID, ::UnityEngine::Rendering::StencilOp  operation, ::UnityEngine::Rendering::CompareFunction  compareFunction, ::UnityEngine::Rendering::ColorWriteMask  colorWriteMask, int32_t  readMask, int32_t  writeMask) ;

/// @brief Method ClearAll, addr 0x182533150, size 0x110, virtual false, abstract: false, final false
static inline void ClearAll() ;

/// @brief Method LogWarningWhenNotInBatchmode, addr 0x182533260, size 0x40, virtual false, abstract: false, final false
static inline void LogWarningWhenNotInBatchmode(::StringW  warning, ::UnityEngine::Object*  context) ;

/// @brief Method Remove, addr 0x1825332a0, size 0x120, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UI::StencilMaterial) == 0x10, "Size mismatch!");
