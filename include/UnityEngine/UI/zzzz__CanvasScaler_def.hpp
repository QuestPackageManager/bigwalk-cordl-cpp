...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CanvasScaler_ScaleMode, "UnityEngine.UI", "CanvasScaler/ScaleMode");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CanvasScaler_ScreenMatchMode, "UnityEngine.UI", "CanvasScaler/ScreenMatchMode");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CanvasScaler_Unit, "UnityEngine.UI", "CanvasScaler/Unit");
...
static_assert(offsetof(::UnityEngine::UI::CanvasScaler_ScaleMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::CanvasScaler_ScaleMode) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::CanvasScaler_ScreenMatchMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::CanvasScaler_ScreenMatchMode) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::CanvasScaler_Unit, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method Canvas_preWillRenderCanvases, addr 0x181163d10, size 0xc1a0, virtual false, abstract: false, final false
inline void Canvas_preWillRenderCanvases() ;

/// @brief Method Handle, addr 0x182516400, size 0xd0, virtual true, abstract: false, final false
inline void Handle() ;

/// @brief Method HandleConstantPhysicalSize, addr 0x182516050, size 0xe0, virtual true, abstract: false, final false
inline void HandleConstantPhysicalSize() ;

/// @brief Method HandleConstantPixelSize, addr 0x182516130, size 0x70, virtual true, abstract: false, final false
inline void HandleConstantPixelSize() ;

/// @brief Method HandleScaleWithScreenSize, addr 0x1825161a0, size 0x1f0, virtual true, abstract: false, final false
inline void HandleScaleWithScreenSize() ;

/// @brief Method HandleWorldCanvas, addr 0x182516390, size 0x70, virtual true, abstract: false, final false
inline void HandleWorldCanvas() ;

static inline ::UnityEngine::UI::CanvasScaler* New_ctor() ;

/// @brief Method OnDisable, addr 0x1825164d0, size 0xa0, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182516570, size 0x80, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetReferencePixelsPerUnit, addr 0x1825165f0, size 0x40, virtual false, abstract: false, final false
inline void SetReferencePixelsPerUnit(float_t  referencePixelsPerUnit) ;

/// @brief Method SetScaleFactor, addr 0x182516630, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182516680, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultSpriteDPI, addr 0x1802e2d80, size 0x10, virtual false, abstract: false, final false
inline float_t get_defaultSpriteDPI() ;

/// @brief Method get_dynamicPixelsPerUnit, addr 0x1802f8050, size 0x10, virtual false, abstract: false, final false
inline float_t get_dynamicPixelsPerUnit() ;

/// @brief Method get_fallbackScreenDPI, addr 0x1802e2b90, size 0x10, virtual false, abstract: false, final false
inline float_t get_fallbackScreenDPI() ;

/// @brief Method get_matchWidthOrHeight, addr 0x1802f7fd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_matchWidthOrHeight() ;

/// @brief Method get_physicalUnit, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::CanvasScaler_Unit get_physicalUnit() ;

/// @brief Method get_referencePixelsPerUnit, addr 0x1802f80d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_referencePixelsPerUnit() ;

/// @brief Method get_referenceResolution, addr 0x1825166d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_referenceResolution() ;

/// @brief Method get_scaleFactor, addr 0x1803f2be0, size 0x10, virtual false, abstract: false, final false
inline float_t get_scaleFactor() ;

/// @brief Method get_screenMatchMode, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::CanvasScaler_ScreenMatchMode get_screenMatchMode() ;

/// @brief Method get_uiScaleMode, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::CanvasScaler_ScaleMode get_uiScaleMode() ;

/// @brief Method set_defaultSpriteDPI, addr 0x1825166e0, size 0x20, virtual false, abstract: false, final false
inline void set_defaultSpriteDPI(float_t  value) ;

/// @brief Method set_dynamicPixelsPerUnit, addr 0x18046fb70, size 0x10, virtual false, abstract: false, final false
inline void set_dynamicPixelsPerUnit(float_t  value) ;

/// @brief Method set_fallbackScreenDPI, addr 0x1802e2f60, size 0x10, virtual false, abstract: false, final false
inline void set_fallbackScreenDPI(float_t  value) ;

/// @brief Method set_matchWidthOrHeight, addr 0x18046fb80, size 0x10, virtual false, abstract: false, final false
inline void set_matchWidthOrHeight(float_t  value) ;

/// @brief Method set_physicalUnit, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_physicalUnit(::UnityEngine::UI::CanvasScaler_Unit  value) ;

/// @brief Method set_referencePixelsPerUnit, addr 0x1802f81c0, size 0x10, virtual false, abstract: false, final false
inline void set_referencePixelsPerUnit(float_t  value) ;

/// @brief Method set_referenceResolution, addr 0x182516700, size 0x80, virtual false, abstract: false, final false
inline void set_referenceResolution(::UnityEngine::Vector2  value) ;

/// @brief Method set_scaleFactor, addr 0x182516780, size 0x20, virtual false, abstract: false, final false
inline void set_scaleFactor(float_t  value) ;

/// @brief Method set_screenMatchMode, addr 0x180393010, size 0x10, virtual false, abstract: false, final false
inline void set_screenMatchMode(::UnityEngine::UI::CanvasScaler_ScreenMatchMode  value) ;

/// @brief Method set_uiScaleMode, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
