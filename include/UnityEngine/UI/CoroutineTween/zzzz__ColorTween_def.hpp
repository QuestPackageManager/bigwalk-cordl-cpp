...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode, "UnityEngine.UI.CoroutineTween", "ColorTween/ColorTweenMode");
...
static_assert(offsetof(::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode) == 0x4, "Size mismatch!");
...
/// @brief Method AddOnChangedCallback, addr 0x182537e60, size 0xa0, virtual false, abstract: false, final false
inline void AddOnChangedCallback(::UnityEngine::Events::UnityAction_1<::UnityEngine::Color>*  callback) ;

/// @brief Method GetDuration, addr 0x18049a530, size 0x10, virtual false, abstract: false, final false
inline float_t GetDuration() ;

/// @brief Method GetIgnoreTimescale, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool GetIgnoreTimescale() ;

/// @brief Method TweenValue, addr 0x1821847e0, size 0x160, virtual true, abstract: false, final true
inline void TweenValue(float_t  floatPercentage) ;

/// @brief Method ValidTarget, addr 0x18175b340, size 0x20, virtual true, abstract: false, final true
inline bool ValidTarget() ;

/// @brief Method get_duration, addr 0x18049a530, size 0x10, virtual true, abstract: false, final true
inline float_t get_duration() ;

/// @brief Method get_ignoreTimeScale, addr 0x1803561b0, size 0x10, virtual true, abstract: false, final true
inline bool get_ignoreTimeScale() ;

/// @brief Method get_startColor, addr 0x18038fea0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_startColor() ;

/// @brief Method get_targetColor, addr 0x1802e2d70, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_targetColor() ;

/// @brief Method get_tweenMode, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_duration, addr 0x180bb44a0, size 0x3450, virtual false, abstract: false, final false
inline void set_duration(float_t  value) ;

/// @brief Method set_ignoreTimeScale, addr 0x180499eb0, size 0x10, virtual false, abstract: false, final false
inline void set_ignoreTimeScale(bool  value) ;

/// @brief Method set_startColor, addr 0x18051e9e0, size 0x10, virtual false, abstract: false, final false
inline void set_startColor(::UnityEngine::Color  value) ;

/// @brief Method set_targetColor, addr 0x1802f1b20, size 0x10, virtual false, abstract: false, final false
inline void set_targetColor(::UnityEngine::Color  value) ;

/// @brief Method set_tweenMode, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Target", ty: "::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenCallback*", modifiers: "", def_value: None }, CppParam { name: "m_StartColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "m_TargetColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "m_TweenMode", ty: "::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode", modifiers: "", def_value: None }, CppParam { name: "m_Duration", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_IgnoreTimeScale", ty: "bool", modifiers: "", def_value: None }]
constexpr ColorTween(::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenCallback*  m_Target, ::UnityEngine::Color  m_StartColor, ::UnityEngine::Color  m_TargetColor, ::UnityEngine::UI::CoroutineTween::ColorTween_ColorTweenMode  m_TweenMode, float_t  m_Duration, bool  m_IgnoreTimeScale) noexcept;
