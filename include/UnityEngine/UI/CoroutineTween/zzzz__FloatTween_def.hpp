...
// Write type traits
MARK_REF_T(::UnityEngine::UI::CoroutineTween::FloatTween_FloatTweenCallback*);
MARK_VAL_T(::UnityEngine::UI::CoroutineTween::FloatTween);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CoroutineTween::FloatTween_FloatTweenCallback*, "UnityEngine.UI.CoroutineTween", "FloatTween/FloatTweenCallback");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::CoroutineTween::FloatTween, "UnityEngine.UI.CoroutineTween", "FloatTween");
...
static_assert(sizeof(::UnityEngine::UI::CoroutineTween::FloatTween_FloatTweenCallback) == 0x30, "Size mismatch!");
...
/// @brief Method AddOnChangedCallback, addr 0x18253a780, size 0xa0, virtual false, abstract: false, final false
inline void AddOnChangedCallback(::UnityEngine::Events::UnityAction_1<float_t>*  callback) ;

/// @brief Method GetDuration, addr 0x180346a80, size 0x10, virtual false, abstract: false, final false
inline float_t GetDuration() ;

/// @brief Method GetIgnoreTimescale, addr 0x18039e7b0, size 0x10, virtual false, abstract: false, final false
inline bool GetIgnoreTimescale() ;

/// @brief Method TweenValue, addr 0x182184bd0, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method get_duration, addr 0x180346a80, size 0x10, virtual true, abstract: false, final true
inline float_t get_duration() ;

/// @brief Method get_ignoreTimeScale, addr 0x18039e7b0, size 0x10, virtual true, abstract: false, final true
inline bool get_ignoreTimeScale() ;

/// @brief Method get_startValue, addr 0x180303b40, size 0x10, virtual false, abstract: false, final false
inline float_t get_startValue() ;

/// @brief Method get_targetValue, addr 0x180303b30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_duration, addr 0x180346aa0, size 0x10, virtual false, abstract: false, final false
inline void set_duration(float_t  value) ;

/// @brief Method set_ignoreTimeScale, addr 0x18039e7c0, size 0x10, virtual false, abstract: false, final false
inline void set_ignoreTimeScale(bool  value) ;

/// @brief Method set_startValue, addr 0x18051eae0, size 0x10, virtual false, abstract: false, final false
inline void set_startValue(float_t  value) ;

/// @brief Method set_targetValue, addr 0x18051eaf0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::CoroutineTween::FloatTween) == 0x18, "Size mismatch!");
