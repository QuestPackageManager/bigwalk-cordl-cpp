...
/// @brief Field <useLegacyMeshGeneration>k__BackingField, offset 0xa0, size 0x1 
 __declspec(property(get=__cordl_internal_get__useLegacyMeshGeneration_k__BackingField, put=__cordl_internal_set__useLegacyMeshGeneration_k__BackingField)) bool  _useLegacyMeshGeneration_k__BackingField;
...
/// @brief Field m_CachedUvs, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CachedUvs, put=__cordl_internal_set_m_CachedUvs)) ::ArrayW<::UnityEngine::Vector2>  m_CachedUvs;
...
/// @brief Field m_ColorTweenRunner, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ColorTweenRunner, put=__cordl_internal_set_m_ColorTweenRunner)) ::UnityEngine::UI::CoroutineTween::TweenRunner_1<::UnityEngine::UI::CoroutineTween::ColorTween>*  m_ColorTweenRunner;
...
/// @brief Method CacheCanvas, addr 0x182365bd0, size 0x120, virtual false, abstract: false, final false
inline void CacheCanvas() ;

/// @brief Method CreateColorFromAlpha, addr 0x182365cf0, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Color CreateColorFromAlpha(float_t  alpha) ;

/// @brief Method CrossFadeAlpha, addr 0x182365d10, size 0x60, virtual true, abstract: false, final false
inline void CrossFadeAlpha(float_t  alpha, float_t  duration, bool  ignoreTimeScale) ;

/// @brief Method CrossFadeColor, addr 0x182365fe0, size 0x40, virtual true, abstract: false, final false
inline void CrossFadeColor(::UnityEngine::Color  targetColor, float_t  duration, bool  ignoreTimeScale, bool  useAlpha) ;

/// @brief Method CrossFadeColor, addr 0x182365d70, size 0x270, virtual true, abstract: false, final false
inline void CrossFadeColor(::UnityEngine::Color  targetColor, float_t  duration, bool  ignoreTimeScale, bool  useAlpha, bool  useRGB) ;

/// @brief Method DoLegacyMeshGeneration, addr 0x182366020, size 0x310, virtual false, abstract: false, final false
inline void DoLegacyMeshGeneration() ;

/// @brief Method DoMeshGeneration, addr 0x182366330, size 0x430, virtual false, abstract: false, final false
inline void DoMeshGeneration() ;

/// @brief Method GetPixelAdjustedRect, addr 0x182366760, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method OnBeforeTransformParentChanged, addr 0x1823668d0, size 0x90, virtual true, abstract: false, final false
inline void OnBeforeTransformParentChanged() ;

/// @brief Method OnCanvasHierarchyChanged, addr 0x182366960, size 0xe0, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnCullingChanged, addr 0x182366a40, size 0x80, virtual true, abstract: false, final false
inline void OnCullingChanged() ;

/// @brief Method OnDestroy, addr 0x182366ac0, size 0x130, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x181d6a3a0, size 0x20, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x182366bf0, size 0x280, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182366e70, size 0xc0, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnFillVBO, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnFillVBO(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  vbo) ;

/// @brief Method OnPopulateMesh, addr 0x182366f30, size 0x80, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::Mesh*  m) ;

/// @brief Method OnPopulateMesh, addr 0x182366fb0, size 0x1f0, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  vh) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x1823671a0, size 0x70, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x182367210, size 0x90, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method PixelAdjustPoint, addr 0x1823672a0, size 0x130, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 PixelAdjustPoint(::UnityEngine::Vector2  point) ;

/// @brief Method Raycast, addr 0x182367880, size 0x20, virtual true, abstract: false, final false
inline bool Raycast(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method Raycast, addr 0x1823673d0, size 0x4b0, virtual false, abstract: false, final false
inline bool Raycast(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera, bool  ignoreMasks) ;

/// @brief Method Rebuild, addr 0x1823678a0, size 0x90, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  update) ;

/// @brief Method RegisterDirtyLayoutCallback, addr 0x182367930, size 0x90, virtual false, abstract: false, final false
inline void RegisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method RegisterDirtyMaterialCallback, addr 0x1823679c0, size 0x90, virtual false, abstract: false, final false
inline void RegisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method RegisterDirtyVerticesCallback, addr 0x182367a50, size 0x90, virtual false, abstract: false, final false
inline void RegisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method SetAllDirty, addr 0x182367ae0, size 0x70, virtual true, abstract: false, final false
inline void SetAllDirty() ;

/// @brief Method SetLayoutDirty, addr 0x182367b50, size 0xa0, virtual true, abstract: false, final false
inline void SetLayoutDirty() ;

/// @brief Method SetMaterialDirty, addr 0x182367bf0, size 0x90, virtual true, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetNativeSize, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void SetNativeSize() ;

/// @brief Method SetRaycastDirty, addr 0x182367c80, size 0xb0, virtual false, abstract: false, final false
inline void SetRaycastDirty() ;

/// @brief Method SetVerticesDirty, addr 0x182367d30, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method UnregisterDirtyLayoutCallback, addr 0x182367dc0, size 0x90, virtual false, abstract: false, final false
inline void UnregisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UnregisterDirtyMaterialCallback, addr 0x182367e50, size 0x90, virtual false, abstract: false, final false
inline void UnregisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UnregisterDirtyVerticesCallback, addr 0x182367ee0, size 0x90, virtual false, abstract: false, final false
inline void UnregisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UpdateGeometry, addr 0x182367f70, size 0x20, virtual true, abstract: false, final false
inline void UpdateGeometry() ;

/// @brief Method UpdateMaterial, addr 0x182367f90, size 0xc0, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Vector2> const& __cordl_internal_get_m_CachedUvs() const;

constexpr ::ArrayW<::UnityEngine::Vector2>& __cordl_internal_get_m_CachedUvs() ;
...
constexpr void __cordl_internal_set_m_CachedUvs(::ArrayW<::UnityEngine::Vector2>  value) ;
...
/// @brief Method .ctor, addr 0x1823680f0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_canvas, addr 0x1823681e0, size 0x30, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_canvasRenderer, addr 0x182368170, size 0x70, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CanvasRenderer> get_canvasRenderer() ;

/// @brief Method get_color, addr 0x180a26490, size 0x12a0, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_defaultGraphicMaterial, addr 0x182368210, size 0x80, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_defaultGraphicMaterial() ;

/// @brief Method get_defaultMaterial, addr 0x182368210, size 0x80, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_defaultMaterial() ;

/// @brief Method get_depth, addr 0x182368290, size 0x20, virtual false, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_mainTexture, addr 0x1823682b0, size 0x40, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_material, addr 0x182368440, size 0x50, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_materialForRendering, addr 0x1823682f0, size 0x150, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_materialForRendering() ;

/// @brief Method get_raycastPadding, addr 0x182368490, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_raycastPadding() ;

/// @brief Method get_raycastTarget, addr 0x1814f2bc0, size 0x10, virtual true, abstract: false, final false
inline bool get_raycastTarget() ;

/// @brief Method get_rectTransform, addr 0x1823684a0, size 0x40, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_useLegacyMeshGeneration, addr 0x1805fa960, size 0x10, virtual false, abstract: false, final false
inline bool get_useLegacyMeshGeneration() ;

/// @brief Method get_workerMesh, addr 0x1823684e0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x1823685a0, size 0x50, virtual true, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_material, addr 0x1823685f0, size 0x60, virtual true, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_raycastPadding, addr 0x182368650, size 0x10, virtual false, abstract: false, final false
inline void set_raycastPadding(::UnityEngine::Vector4  value) ;

/// @brief Method set_raycastTarget, addr 0x182368660, size 0xb0, virtual true, abstract: false, final false
inline void set_raycastTarget(bool  value) ;

/// @brief Method set_useLegacyMeshGeneration, addr 0x1817eed70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_CachedUvs, offset: 0x90, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::Vector2>  ___m_CachedUvs;
...
static_assert(sizeof(::UnityEngine::UI::Graphic) == 0xa8, "Size mismatch!");
