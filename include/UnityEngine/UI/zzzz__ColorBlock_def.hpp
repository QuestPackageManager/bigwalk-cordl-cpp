...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ColorBlock, "UnityEngine.UI", "ColorBlock");
...
/// @brief Field defaultColorBlock, offset 0xffffffff, size 0x58 
 __declspec(property(get=getStaticF_defaultColorBlock, put=setStaticF_defaultColorBlock)) ::UnityEngine::UI::ColorBlock  defaultColorBlock;
...
/// @brief Method Equals, addr 0x18235dcf0, size 0xe0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x18235ddd0, size 0x2c0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::ColorBlock  other) ;

/// @brief Method GetHashCode, addr 0x18235e090, size 0x70, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::UnityEngine::UI::ColorBlock getStaticF_defaultColorBlock() ;

/// @brief Method get_colorMultiplier, addr 0x180356140, size 0x10, virtual false, abstract: false, final false
inline float_t get_colorMultiplier() ;

/// @brief Method get_disabledColor, addr 0x18052ca40, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_disabledColor() ;

/// @brief Method get_fadeDuration, addr 0x180315260, size 0x10, virtual false, abstract: false, final false
inline float_t get_fadeDuration() ;

/// @brief Method get_highlightedColor, addr 0x1802e5810, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_highlightedColor() ;

/// @brief Method get_normalColor, addr 0x1804f6880, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_normalColor() ;

/// @brief Method get_pressedColor, addr 0x1802f41b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_pressedColor() ;

/// @brief Method get_selectedColor, addr 0x1802e30e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x18235e410, size 0x80, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UI::ColorBlock  point1, ::UnityEngine::UI::ColorBlock  point2) ;

/// @brief Method op_Inequality, addr 0x18235e490, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method set_colorMultiplier, addr 0x1803561c0, size 0x10, virtual false, abstract: false, final false
inline void set_colorMultiplier(float_t  value) ;

/// @brief Method set_disabledColor, addr 0x180e94c00, size 0x2a50, virtual false, abstract: false, final false
inline void set_disabledColor(::UnityEngine::Color  value) ;

/// @brief Method set_fadeDuration, addr 0x1803dccc0, size 0x10, virtual false, abstract: false, final false
inline void set_fadeDuration(float_t  value) ;

/// @brief Method set_highlightedColor, addr 0x180c0b430, size 0x5050, virtual false, abstract: false, final false
inline void set_highlightedColor(::UnityEngine::Color  value) ;

/// @brief Method set_normalColor, addr 0x1803bdb10, size 0x20, virtual false, abstract: false, final false
inline void set_normalColor(::UnityEngine::Color  value) ;

/// @brief Method set_pressedColor, addr 0x1815b93b0, size 0x10, virtual false, abstract: false, final false
inline void set_pressedColor(::UnityEngine::Color  value) ;

/// @brief Method set_selectedColor, addr 0x18187c9d0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::ColorBlock) == 0x58, "Size mismatch!");
