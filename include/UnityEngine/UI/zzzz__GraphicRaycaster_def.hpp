...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::GraphicRaycaster_BlockingObjects, "UnityEngine.UI", "GraphicRaycaster/BlockingObjects");
...
static_assert(offsetof(::UnityEngine::UI::GraphicRaycaster_BlockingObjects, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method <Raycast>b__27_0, addr 0x18236f080, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x182364070, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x182364470, size 0xbb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182365080, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Graphic>>* getStaticF_s_SortedGraphics() ;

/// @brief Method get_blockingMask, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method get_blockingObjects, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GraphicRaycaster_BlockingObjects get_blockingObjects() ;

/// @brief Method get_canvas, addr 0x1823650f0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_eventCamera, addr 0x182365140, size 0x90, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_ignoreReversedGraphics, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_ignoreReversedGraphics() ;

/// @brief Method get_renderOrderPriority, addr 0x1823651d0, size 0xb0, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_sortOrderPriority, addr 0x182365280, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method set_blockingMask, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
inline void set_blockingMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_blockingObjects, addr 0x1803914d0, size 0x10, virtual false, abstract: false, final false
inline void set_blockingObjects(::UnityEngine::UI::GraphicRaycaster_BlockingObjects  value) ;

/// @brief Method set_ignoreReversedGraphics, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
