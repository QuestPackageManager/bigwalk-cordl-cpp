...
MARK_REF_T(::UnityEngine::UI::ScrollRect*);
MARK_REF_T(::UnityEngine::UI::ScrollRect_ScrollRectEvent*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ScrollRect_MovementType, "UnityEngine.UI", "ScrollRect/MovementType");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ScrollRect_ScrollbarVisibility, "UnityEngine.UI", "ScrollRect/ScrollbarVisibility");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ScrollRect*, "UnityEngine.UI", "ScrollRect");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ScrollRect_ScrollRectEvent*, "UnityEngine.UI", "ScrollRect/ScrollRectEvent");
// Dependencies 
namespace UnityEngine::UI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UI::ScrollRect_MovementType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::ScrollRect_MovementType) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::ScrollRect_ScrollbarVisibility, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::ScrollRect_ScrollbarVisibility) == 0x4, "Size mismatch!");
...
// Dependencies UnityEngine.Bounds, UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.UIBehaviour, UnityEngine.UI.ScrollRect::MovementType, UnityEngine.UI.ScrollRect::ScrollbarVisibility, UnityEngine.Vector2, UnityEngine.Vector3
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Field m_HorizontalScrollbarVisibility, offset 0x58, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_HorizontalScrollbarVisibility, put=__cordl_internal_set_m_HorizontalScrollbarVisibility)) ::UnityEngine::UI::ScrollRect_ScrollbarVisibility  m_HorizontalScrollbarVisibility;
...
/// @brief Field m_VerticalScrollbarVisibility, offset 0x5c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_VerticalScrollbarVisibility, put=__cordl_internal_set_m_VerticalScrollbarVisibility)) ::UnityEngine::UI::ScrollRect_ScrollbarVisibility  m_VerticalScrollbarVisibility;
...
/// @brief Method AdjustBounds, addr 0x18252a220, size 0xa0, virtual false, abstract: false, final false
static inline void AdjustBounds(::by_ref<::UnityEngine::Bounds>  viewBounds, ::by_ref<::UnityEngine::Vector2>  contentPivot, ::by_ref<::UnityEngine::Vector3>  contentSize, ::by_ref<::UnityEngine::Vector3>  contentPos) ;
...
/// @brief Method CalculateOffset, addr 0x18252a2c0, size 0x140, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 CalculateOffset(::UnityEngine::Vector2  delta) ;

/// @brief Method EnsureLayoutHasRebuilt, addr 0x18252a400, size 0x30, virtual false, abstract: false, final false
inline void EnsureLayoutHasRebuilt() ;

/// @brief Method GetBounds, addr 0x18252a430, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method InternalCalculateOffset, addr 0x18252a500, size 0x130, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 InternalCalculateOffset(::by_ref<::UnityEngine::Bounds>  viewBounds, ::by_ref<::UnityEngine::Bounds>  contentBounds, bool  horizontal, bool  vertical, ::UnityEngine::UI::ScrollRect_MovementType  movementType, ::by_ref<::UnityEngine::Vector2>  delta) ;

/// @brief Method InternalGetBounds, addr 0x18252a630, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method IsActive, addr 0x18252a830, size 0x30, virtual true, abstract: false, final false
inline bool IsActive() ;

/// @brief Method LateUpdate, addr 0x18252a860, size 0x8c0, virtual true, abstract: false, final false
...
/// @brief Method OnBeginDrag, addr 0x18252b120, size 0xf0, virtual true, abstract: false, final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDisable, addr 0x18252b210, size 0x140, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x18252b350, size 0x260, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x18252b5b0, size 0xf0, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnEndDrag, addr 0x18252b6a0, size 0x20, virtual true, abstract: false, final false
inline void OnEndDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnInitializePotentialDrag, addr 0x18252b6c0, size 0x20, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x18252b6e0, size 0x10, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnScroll, addr 0x18252b6f0, size 0x1c0, virtual true, abstract: false, final false
inline void OnScroll(::UnityEngine::EventSystems::PointerEventData*  data) ;

/// @brief Method Rebuild, addr 0x18252b8b0, size 0xf0, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method RubberDelta, addr 0x18252b9a0, size 0x60, virtual false, abstract: false, final false
static inline float_t RubberDelta(float_t  overStretching, float_t  viewSize) ;

/// @brief Method SetContentAnchoredPosition, addr 0x18252ba00, size 0x100, virtual true, abstract: false, final false
inline void SetContentAnchoredPosition(::UnityEngine::Vector2  position) ;

/// @brief Method SetDirty, addr 0x18252bbc0, size 0x90, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetDirtyCaching, addr 0x18252bb00, size 0xc0, virtual false, abstract: false, final false
inline void SetDirtyCaching() ;

/// @brief Method SetHorizontalNormalizedPosition, addr 0x18252bc50, size 0x50, virtual false, abstract: false, final false
inline void SetHorizontalNormalizedPosition(float_t  value) ;

/// @brief Method SetLayoutHorizontal, addr 0x18252bca0, size 0x5e0, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x18252c280, size 0x120, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method SetNormalizedPosition, addr 0x18252c3a0, size 0x280, virtual true, abstract: false, final false
inline void SetNormalizedPosition(float_t  value, int32_t  axis) ;

/// @brief Method SetVerticalNormalizedPosition, addr 0x18252c620, size 0x50, virtual false, abstract: false, final false
inline void SetVerticalNormalizedPosition(float_t  value) ;

/// @brief Method StopMovement, addr 0x18252c670, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method UpdateBounds, addr 0x18252c680, size 0x440, virtual false, abstract: false, final false
inline void UpdateBounds() ;

/// @brief Method UpdateCachedData, addr 0x18252cac0, size 0x260, virtual false, abstract: false, final false
inline void UpdateCachedData() ;

/// @brief Method UpdateOneScrollbarVisibility, addr 0x18252cd20, size 0x90, virtual false, abstract: false, final false
static inline void UpdateOneScrollbarVisibility(bool  xScrollingNeeded, bool  xAxisEnabled, ::UnityEngine::UI::ScrollRect_ScrollbarVisibility  scrollbarVisibility, ::UnityEngine::UI::Scrollbar*  scrollbar) ;

/// @brief Method UpdatePrevData, addr 0x18252cdb0, size 0xa0, virtual false, abstract: false, final false
inline void UpdatePrevData() ;

/// @brief Method UpdateScrollbarLayout, addr 0x18252ce50, size 0x2f0, virtual false, abstract: false, final false
inline void UpdateScrollbarLayout() ;

/// @brief Method UpdateScrollbarVisibility, addr 0x18252d140, size 0xb0, virtual false, abstract: false, final false
inline void UpdateScrollbarVisibility() ;

/// @brief Method UpdateScrollbars, addr 0x18252d1f0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18252d3b0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_content, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_content() ;

/// @brief Method get_decelerationRate, addr 0x1802f7fd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_decelerationRate() ;

/// @brief Method get_elasticity, addr 0x1803f68d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_hScrollingNeeded, addr 0x18252d460, size 0x50, virtual false, abstract: false, final false
inline bool get_hScrollingNeeded() ;

/// @brief Method get_horizontal, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_horizontal() ;

/// @brief Method get_horizontalNormalizedPosition, addr 0x18252d4b0, size 0x110, virtual false, abstract: false, final false
inline float_t get_horizontalNormalizedPosition() ;

/// @brief Method get_horizontalScrollbar, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Scrollbar> get_horizontalScrollbar() ;

/// @brief Method get_horizontalScrollbarSpacing, addr 0x18046fae0, size 0x10, virtual false, abstract: false, final false
inline float_t get_horizontalScrollbarSpacing() ;

/// @brief Method get_horizontalScrollbarVisibility, addr 0x1802e0b20, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollbarVisibility get_horizontalScrollbarVisibility() ;

/// @brief Method get_inertia, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_inertia() ;

/// @brief Method get_layoutPriority, addr 0x180393450, size 0x10, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x1821a36f0, size 0x10, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x1821a36f0, size 0x10, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_movementType, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_MovementType get_movementType() ;

/// @brief Method get_normalizedPosition, addr 0x18252d5c0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_normalizedPosition() ;

/// @brief Method get_onValueChanged, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollRectEvent* get_onValueChanged() ;

/// @brief Method get_preferredHeight, addr 0x1821a36f0, size 0x10, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x1821a36f0, size 0x10, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_rectTransform, addr 0x18252d600, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_scrollSensitivity, addr 0x1802e2d90, size 0x10, virtual false, abstract: false, final false
inline float_t get_scrollSensitivity() ;

/// @brief Method get_vScrollingNeeded, addr 0x18252d650, size 0x50, virtual false, abstract: false, final false
inline bool get_vScrollingNeeded() ;

/// @brief Method get_velocity, addr 0x1803d9940, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_velocity() ;

/// @brief Method get_vertical, addr 0x180503cd0, size 0x10, virtual false, abstract: false, final false
inline bool get_vertical() ;

/// @brief Method get_verticalNormalizedPosition, addr 0x18252d6a0, size 0x110, virtual false, abstract: false, final false
inline float_t get_verticalNormalizedPosition() ;

/// @brief Method get_verticalScrollbar, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Scrollbar> get_verticalScrollbar() ;

/// @brief Method get_verticalScrollbarSpacing, addr 0x18046fad0, size 0x10, virtual false, abstract: false, final false
inline float_t get_verticalScrollbarSpacing() ;

/// @brief Method get_verticalScrollbarVisibility, addr 0x180503b40, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollbarVisibility get_verticalScrollbarVisibility() ;

/// @brief Method get_viewRect, addr 0x18252d7b0, size 0xd0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_viewRect() ;

/// @brief Method get_viewport, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_content, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_content(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_decelerationRate, addr 0x18046fb80, size 0x10, virtual false, abstract: false, final false
inline void set_decelerationRate(float_t  value) ;

/// @brief Method set_elasticity, addr 0x18046fb30, size 0x10, virtual false, abstract: false, final false
inline void set_elasticity(float_t  value) ;

/// @brief Method set_horizontal, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
inline void set_horizontal(bool  value) ;

/// @brief Method set_horizontalNormalizedPosition, addr 0x18252d880, size 0x20, virtual false, abstract: false, final false
inline void set_horizontalNormalizedPosition(float_t  value) ;

/// @brief Method set_horizontalScrollbar, addr 0x18252d8c0, size 0xf0, virtual false, abstract: false, final false
inline void set_horizontalScrollbar(::UnityEngine::UI::Scrollbar*  value) ;

/// @brief Method set_horizontalScrollbarSpacing, addr 0x18252d8a0, size 0x10, virtual false, abstract: false, final false
inline void set_horizontalScrollbarSpacing(float_t  value) ;

/// @brief Method set_horizontalScrollbarVisibility, addr 0x18252d8b0, size 0x10, virtual false, abstract: false, final false
inline void set_horizontalScrollbarVisibility(::UnityEngine::UI::ScrollRect_ScrollbarVisibility  value) ;

/// @brief Method set_inertia, addr 0x180c29b80, size 0x2090, virtual false, abstract: false, final false
inline void set_inertia(bool  value) ;

/// @brief Method set_movementType, addr 0x1803914d0, size 0x10, virtual false, abstract: false, final false
inline void set_movementType(::UnityEngine::UI::ScrollRect_MovementType  value) ;

/// @brief Method set_normalizedPosition, addr 0x18252d9b0, size 0x60, virtual false, abstract: false, final false
inline void set_normalizedPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_onValueChanged, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::ScrollRect_ScrollRectEvent*  value) ;

/// @brief Method set_scrollSensitivity, addr 0x1802e2ff0, size 0x10, virtual false, abstract: false, final false
inline void set_scrollSensitivity(float_t  value) ;

/// @brief Method set_velocity, addr 0x18252da10, size 0x10, virtual false, abstract: false, final false
inline void set_velocity(::UnityEngine::Vector2  value) ;

/// @brief Method set_vertical, addr 0x180503d00, size 0x10, virtual false, abstract: false, final false
inline void set_vertical(bool  value) ;

/// @brief Method set_verticalNormalizedPosition, addr 0x18252da20, size 0x20, virtual false, abstract: false, final false
inline void set_verticalNormalizedPosition(float_t  value) ;

/// @brief Method set_verticalScrollbar, addr 0x18252da60, size 0xf0, virtual false, abstract: false, final false
inline void set_verticalScrollbar(::UnityEngine::UI::Scrollbar*  value) ;

/// @brief Method set_verticalScrollbarSpacing, addr 0x18252da40, size 0x10, virtual false, abstract: false, final false
inline void set_verticalScrollbarSpacing(float_t  value) ;

/// @brief Method set_verticalScrollbarVisibility, addr 0x18252da50, size 0x10, virtual false, abstract: false, final false
inline void set_verticalScrollbarVisibility(::UnityEngine::UI::ScrollRect_ScrollbarVisibility  value) ;

/// @brief Method set_viewport, addr 0x18252db50, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::ScrollRect) == 0x130, "Size mismatch!");
