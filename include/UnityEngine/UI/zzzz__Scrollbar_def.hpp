...
namespace UnityEngine::UI {
class Scrollbar__ClickRepeat_d__59;
}
namespace UnityEngine::UI {
class Selectable;
}
...
MARK_REF_T(::UnityEngine::UI::Scrollbar*);
MARK_REF_T(::UnityEngine::UI::Scrollbar_ScrollEvent*);
MARK_REF_T(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Scrollbar_Axis, "UnityEngine.UI", "Scrollbar/Axis");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Scrollbar_Direction, "UnityEngine.UI", "Scrollbar/Direction");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Scrollbar*, "UnityEngine.UI", "Scrollbar");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Scrollbar_ScrollEvent*, "UnityEngine.UI", "Scrollbar/ScrollEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59*, "UnityEngine.UI", "Scrollbar/<ClickRepeat>d__59");
// Dependencies 
namespace UnityEngine::UI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UI::Scrollbar_Direction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::Scrollbar_Direction) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UI::Scrollbar_ScrollEvent) == 0x30, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::Scrollbar_Axis, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method MoveNext, addr 0x1825359c0, size 0xf0, virtual true, abstract: false, final true
...
static_assert(offsetof(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59, ___screenPosition) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UI::Scrollbar__ClickRepeat_d__59, ___camera) == 0x30, "Offset mismatch!");
...
/// @brief Method ClickRepeat, addr 0x18252dc00, size 0xa0, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method ClickRepeat, addr 0x18252db80, size 0x80, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::Vector2  screenPosition, ::UnityEngine::Camera*  camera) ;

/// @brief Method DoUpdateDrag, addr 0x18252dca0, size 0xc0, virtual false, abstract: false, final false
inline void DoUpdateDrag(::UnityEngine::Vector2  handleCorner, float_t  remainingSize) ;

/// @brief Method FindSelectableOnDown, addr 0x18252dd60, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown() ;

/// @brief Method FindSelectableOnLeft, addr 0x18252dd90, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft() ;

/// @brief Method FindSelectableOnRight, addr 0x18252ddc0, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight() ;

/// @brief Method FindSelectableOnUp, addr 0x18252ddf0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method MayDrag, addr 0x18252de20, size 0x70, virtual false, abstract: false, final false
inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

static inline ::UnityEngine::UI::Scrollbar* New_ctor() ;

/// @brief Method OnBeginDrag, addr 0x18252de90, size 0x1d0, virtual true, abstract: false, final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDisable, addr 0x18252e060, size 0x10, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x18252e070, size 0xf0, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x18252e160, size 0x90, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnInitializePotentialDrag, addr 0x18252e1f0, size 0x10, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnMove, addr 0x18252e200, size 0x480, virtual true, abstract: false, final false
inline void OnMove(::UnityEngine::EventSystems::AxisEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x18252e680, size 0x170, virtual true, abstract: false, final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerUp, addr 0x18252e7f0, size 0x40, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x18252e830, size 0x40, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method Rebuild, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method Set, addr 0x18252ea40, size 0xf0, virtual false, abstract: false, final false
inline void Set(float_t  input, bool  sendCallback) ;

/// @brief Method SetDirection, addr 0x18252e870, size 0x150, virtual false, abstract: false, final false
inline void SetDirection(::UnityEngine::UI::Scrollbar_Direction  direction, bool  includeRectLayouts) ;

/// @brief Method SetValueWithoutNotify, addr 0x18252e9c0, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x18252eff0, size 0x20, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCachedReferences, addr 0x18252eb30, size 0x80, virtual false, abstract: false, final false
inline void UpdateCachedReferences() ;

/// @brief Method UpdateDrag, addr 0x18252ec50, size 0x210, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::RectTransform*  containerRect, ::UnityEngine::Vector2  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method UpdateDrag, addr 0x18252ebb0, size 0xa0, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method UpdateVisuals, addr 0x18252ee60, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18252f010, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_axis, addr 0x18252f080, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_Axis get_axis() ;

/// @brief Method get_direction, addr 0x181e56d60, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_Direction get_direction() ;

/// @brief Method get_handleRect, addr 0x1803370a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_handleRect() ;

/// @brief Method get_numberOfSteps, addr 0x1818e7a50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_numberOfSteps() ;

/// @brief Method get_onValueChanged, addr 0x1803370e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_ScrollEvent* get_onValueChanged() ;

/// @brief Method get_reverseValue, addr 0x18252f0a0, size 0x20, virtual false, abstract: false, final false
inline bool get_reverseValue() ;

/// @brief Method get_size, addr 0x180474c40, size 0x10, virtual false, abstract: false, final false
inline float_t get_size() ;

/// @brief Method get_stepSize, addr 0x18252f0c0, size 0x30, virtual false, abstract: false, final false
inline float_t get_stepSize() ;

/// @brief Method get_value, addr 0x18252f0f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x18252f150, size 0x40, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UI::Scrollbar_Direction  value) ;

/// @brief Method set_handleRect, addr 0x18252f190, size 0x40, virtual false, abstract: false, final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_numberOfSteps, addr 0x18252f1d0, size 0x50, virtual false, abstract: false, final false
inline void set_numberOfSteps(int32_t  value) ;

/// @brief Method set_onValueChanged, addr 0x1803371b0, size 0x20, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::Scrollbar_ScrollEvent*  value) ;

/// @brief Method set_size, addr 0x18252f220, size 0x60, virtual false, abstract: false, final false
inline void set_size(float_t  value) ;

/// @brief Method set_value, addr 0x18252f280, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::Scrollbar) == 0x148, "Size mismatch!");
