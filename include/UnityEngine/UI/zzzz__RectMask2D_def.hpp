...
/// @brief Field m_MaskableTargets, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_MaskableTargets, put=__cordl_internal_set_m_MaskableTargets)) ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::UI::MaskableGraphic>>*  m_MaskableTargets;
...
/// @brief Method AddClippable, addr 0x182528730, size 0xb0, virtual false, abstract: false, final false
inline void AddClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method IsRaycastLocationValid, addr 0x1825287e0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method OnCanvasHierarchyChanged, addr 0x182528890, size 0x30, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDestroy, addr 0x1825288c0, size 0x10, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x1825288d0, size 0x60, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182528930, size 0x30, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x182528890, size 0x30, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method PerformClipping, addr 0x182528960, size 0x8f0, virtual true, abstract: false, final false
inline void PerformClipping() ;

/// @brief Method RemoveClippable, addr 0x182529250, size 0x140, virtual false, abstract: false, final false
inline void RemoveClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method UpdateClipSoftness, addr 0x182529390, size 0x200, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182529590, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Canvas, addr 0x182529690, size 0xc0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_Canvas() ;

/// @brief Method get_canvasRect, addr 0x182529750, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_canvasRect() ;

/// @brief Method get_padding, addr 0x1825297e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_padding() ;

/// @brief Method get_rectTransform, addr 0x1825297f0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_rootCanvasRect, addr 0x182529840, size 0x140, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rootCanvasRect() ;

/// @brief Method get_softness, addr 0x180bb8990, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_padding, addr 0x182529980, size 0x10, virtual false, abstract: false, final false
inline void set_padding(::UnityEngine::Vector4  value) ;

/// @brief Method set_softness, addr 0x182529990, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::RectMask2D) == 0x90, "Size mismatch!");
