...
/// @brief Field m_TempVerts, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TempVerts, put=__cordl_internal_set_m_TempVerts)) ::ArrayW<::UnityEngine::UIVertex>  m_TempVerts;
...
/// @brief Method AssignDefaultFont, addr 0x182533470, size 0x30, virtual false, abstract: false, final false
inline void AssignDefaultFont() ;

/// @brief Method AssignDefaultFontIfNecessary, addr 0x182533420, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method FontTextureChanged, addr 0x1825334a0, size 0xb0, virtual false, abstract: false, final false
inline void FontTextureChanged() ;

/// @brief Method GetGenerationSettings, addr 0x182533550, size 0x180, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerationSettings GetGenerationSettings(::UnityEngine::Vector2  extents) ;

/// @brief Method GetTextAnchorPivot, addr 0x1825336d0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x1825337d0, size 0x20, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1825337f0, size 0x40, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPopulateMesh, addr 0x182533830, size 0x650, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method UpdateGeometry, addr 0x182533e80, size 0x40, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIVertex> const& __cordl_internal_get_m_TempVerts() const;

constexpr ::ArrayW<::UnityEngine::UIVertex>& __cordl_internal_get_m_TempVerts() ;
...
constexpr void __cordl_internal_set_m_TempVerts(::ArrayW<::UnityEngine::UIVertex>  value) ;
...
/// @brief Method .ctor, addr 0x182533ec0, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::UnityEngine::Material> getStaticF_s_DefaultText() ;

/// @brief Method get_alignByGeometry, addr 0x182533f50, size 0x10, virtual false, abstract: false, final false
inline bool get_alignByGeometry() ;

/// @brief Method get_alignment, addr 0x182533f60, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextAnchor get_alignment() ;

/// @brief Method get_cachedTextGenerator, addr 0x182533fd0, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerator* get_cachedTextGenerator() ;

/// @brief Method get_cachedTextGeneratorForLayout, addr 0x182533f70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_font, addr 0x182534080, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Font> get_font() ;

/// @brief Method get_fontSize, addr 0x182534060, size 0x10, virtual false, abstract: false, final false
inline int32_t get_fontSize() ;

/// @brief Method get_fontStyle, addr 0x182534070, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::FontStyle get_fontStyle() ;

/// @brief Method get_horizontalOverflow, addr 0x182534090, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_lineSpacing, addr 0x1825340a0, size 0x10, virtual false, abstract: false, final false
inline float_t get_lineSpacing() ;

/// @brief Method get_mainTexture, addr 0x1825340b0, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method get_pixelsPerUnit, addr 0x1825341a0, size 0xd0, virtual false, abstract: false, final false
inline float_t get_pixelsPerUnit() ;

/// @brief Method get_preferredHeight, addr 0x182534270, size 0x140, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x1825343b0, size 0x120, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_resizeTextForBestFit, addr 0x1825344d0, size 0x10, virtual false, abstract: false, final false
inline bool get_resizeTextForBestFit() ;

/// @brief Method get_resizeTextMaxSize, addr 0x1825344e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_resizeTextMaxSize() ;

/// @brief Method get_resizeTextMinSize, addr 0x1825344f0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_resizeTextMinSize() ;

/// @brief Method get_supportRichText, addr 0x182534500, size 0x10, virtual false, abstract: false, final false
inline bool get_supportRichText() ;

/// @brief Method get_text, addr 0x180474bf0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method get_verticalOverflow, addr 0x182534510, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_alignByGeometry, addr 0x182534520, size 0x30, virtual false, abstract: false, final false
inline void set_alignByGeometry(bool  value) ;

/// @brief Method set_alignment, addr 0x182534550, size 0x50, virtual false, abstract: false, final false
inline void set_alignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_font, addr 0x182534640, size 0x90, virtual false, abstract: false, final false
inline void set_font(::UnityEngine::Font*  value) ;

/// @brief Method set_fontSize, addr 0x1825345a0, size 0x50, virtual false, abstract: false, final false
inline void set_fontSize(int32_t  value) ;

/// @brief Method set_fontStyle, addr 0x1825345f0, size 0x50, virtual false, abstract: false, final false
inline void set_fontStyle(::UnityEngine::FontStyle  value) ;

/// @brief Method set_horizontalOverflow, addr 0x1825346d0, size 0x50, virtual false, abstract: false, final false
inline void set_horizontalOverflow(::UnityEngine::HorizontalWrapMode  value) ;

/// @brief Method set_lineSpacing, addr 0x182534720, size 0x60, virtual false, abstract: false, final false
inline void set_lineSpacing(float_t  value) ;

/// @brief Method set_resizeTextForBestFit, addr 0x182534780, size 0x50, virtual false, abstract: false, final false
inline void set_resizeTextForBestFit(bool  value) ;

/// @brief Method set_resizeTextMaxSize, addr 0x1825347d0, size 0x50, virtual false, abstract: false, final false
inline void set_resizeTextMaxSize(int32_t  value) ;

/// @brief Method set_resizeTextMinSize, addr 0x182534820, size 0x50, virtual false, abstract: false, final false
inline void set_resizeTextMinSize(int32_t  value) ;

/// @brief Method set_supportRichText, addr 0x182534870, size 0x50, virtual false, abstract: false, final false
inline void set_supportRichText(bool  value) ;

/// @brief Method set_text, addr 0x1825348c0, size 0xe0, virtual true, abstract: false, final false
inline void set_text(::StringW  value) ;

/// @brief Method set_verticalOverflow, addr 0x1825349a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Field m_TempVerts, offset: 0x100, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::UIVertex>  ___m_TempVerts;

/// @brief Size padding 0x110 - 0x108 = 0x8, packed as 0x8
...
static_assert(sizeof(::UnityEngine::UI::Text) == 0x110, "Size mismatch!");
