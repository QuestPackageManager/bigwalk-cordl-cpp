...
MARK_REF_T(::UnityEngine::UI::Toggle*);
MARK_REF_T(::UnityEngine::UI::Toggle_ToggleEvent*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Toggle_ToggleTransition, "UnityEngine.UI", "Toggle/ToggleTransition");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Toggle*, "UnityEngine.UI", "Toggle");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Toggle_ToggleEvent*, "UnityEngine.UI", "Toggle/ToggleEvent");
// Dependencies 
namespace UnityEngine::UI {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UI::Toggle_ToggleTransition, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::Toggle_ToggleTransition) == 0x4, "Size mismatch!");
...
/// @brief Method InternalToggle, addr 0x1825352b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x182535310, size 0x40, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x182535350, size 0xc0, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x182535410, size 0x30, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182535440, size 0x80, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPointerClick, addr 0x1825354c0, size 0x70, virtual true, abstract: false, final false
inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnSubmit, addr 0x1825352b0, size 0x60, virtual true, abstract: false, final false
inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData*  eventData) ;

/// @brief Method PlayEffect, addr 0x182535530, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x182535730, size 0x150, virtual false, abstract: false, final false
inline void Set(bool  value, bool  sendCallback) ;

/// @brief Method SetIsOnWithoutNotify, addr 0x1825355b0, size 0x10, virtual false, abstract: false, final false
inline void SetIsOnWithoutNotify(bool  value) ;

/// @brief Method SetToggleGroup, addr 0x1825355c0, size 0x170, virtual false, abstract: false, final false
inline void SetToggleGroup(::UnityEngine::UI::ToggleGroup*  newGroup, bool  setMemberValue) ;

/// @brief Method Start, addr 0x182535880, size 0x60, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x1825358e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_group, addr 0x1803370d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::ToggleGroup> get_group() ;

/// @brief Method get_isOn, addr 0x1803716c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_group, addr 0x182535940, size 0x70, virtual false, abstract: false, final false
inline void set_group(::UnityEngine::UI::ToggleGroup*  value) ;

/// @brief Method set_isOn, addr 0x1825359b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::Toggle) == 0x128, "Size mismatch!");
