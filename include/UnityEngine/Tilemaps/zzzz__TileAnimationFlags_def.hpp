...
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::TileAnimationFlags, "UnityEngine.Tilemaps", "TileAnimationFlags");
// Dependencies 
namespace UnityEngine::Tilemaps {
// Is value type: true
...
__E_UnscaledTime = static_cast<int32_t>(0x8),
__E_SyncAnimation = static_cast<int32_t>(0x10),
};
...
/// @brief Field SyncAnimation value: I32(16)
static ::UnityEngine::Tilemaps::TileAnimationFlags const SyncAnimation;

/// @brief Field UnscaledTime value: I32(8)
static ::UnityEngine::Tilemaps::TileAnimationFlags const UnscaledTime;
...
static_assert(offsetof(::UnityEngine::Tilemaps::TileAnimationFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Tilemaps::TileAnimationFlags) == 0x4, "Size mismatch!");
