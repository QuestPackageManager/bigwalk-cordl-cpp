...
// Write type traits
MARK_REF_T(::UnityEngine::Tilemaps::ITilemap*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::ITilemap*, "UnityEngine.Tilemaps", "ITilemap");
...
/// @brief Method CreateInstance, addr 0x18235b2b0, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Tilemaps::ITilemap* CreateInstance() ;

/// @brief Method FindAllRefreshPositions, addr 0x18235b300, size 0x2b0, virtual false, abstract: false, final false
static inline void FindAllRefreshPositions(::UnityEngine::Tilemaps::ITilemap*  tilemap, int32_t  count, ::System::IntPtr  oldTilesIntPtr, ::System::IntPtr  newTilesIntPtr, ::System::IntPtr  positionsIntPtr) ;

/// @brief Method GetAllTileData, addr 0x18235b5b0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method RefreshTile, addr 0x18235b740, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Tilemaps::ITilemap) == 0x30, "Size mismatch!");
