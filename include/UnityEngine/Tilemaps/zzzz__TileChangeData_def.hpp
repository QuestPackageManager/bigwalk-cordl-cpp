...
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::TileChangeData, "UnityEngine.Tilemaps", "TileChangeData");
...
static_assert(sizeof(::UnityEngine::Tilemaps::TileChangeData) == 0x68, "Size mismatch!");
