...
DEFINE_IL2CPP_CLASS(::UnityEngine::ApplicationMemoryUsage, "UnityEngine", "ApplicationMemoryUsage");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ApplicationMemoryUsage, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ApplicationMemoryUsage) == 0x4, "Size mismatch!");
