...
#include <cmath>
#include <cstddef>
CORDL_MODULE_EXPORT(SmoothStepFloat2)
...
// Write type traits
MARK_VAL_T(::UnityEngine::Splines::Interpolators::SmoothStepFloat2);
DEFINE_IL2CPP_CLASS(::UnityEngine::Splines::Interpolators::SmoothStepFloat2, "UnityEngine.Splines.Interpolators", "SmoothStepFloat2");
// Dependencies 
namespace UnityEngine::Splines::Interpolators {
// Is value type: true
// CS Name: UnityEngine.Splines.Interpolators.SmoothStepFloat2
#pragma pack(push, 0)
struct CORDL_TYPE SmoothStepFloat2 {
public:
// Declarations
...
/// @brief Method Interpolate, addr 0x18217b730, size 0x40, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Splines::Interpolators::SmoothStepFloat2) == 0x1, "Size mismatch!");
