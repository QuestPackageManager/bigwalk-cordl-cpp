...
// Write type traits
MARK_REF_T(::UnityEngine::UnityEngineModuleAssembly*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UnityEngineModuleAssembly*, "UnityEngine", "UnityEngineModuleAssembly");
...
static_assert(sizeof(::UnityEngine::UnityEngineModuleAssembly) == 0x10, "Size mismatch!");
