...
DEFINE_IL2CPP_CLASS(::UnityEngine::ColorSpace, "UnityEngine", "ColorSpace");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ColorSpace, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ColorSpace) == 0x4, "Size mismatch!");
