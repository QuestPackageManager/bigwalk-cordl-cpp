...
// Write type traits
MARK_REF_T(::UnityEngine::Networking::UnityWebRequestAsyncOperation*);
MARK_REF_T(::UnityEngine::Networking::UnityWebRequestAsyncOperation_BindingsMarshaller*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::UnityWebRequestAsyncOperation*, "UnityEngine.Networking", "UnityWebRequestAsyncOperation");
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::UnityWebRequestAsyncOperation_BindingsMarshaller*, "UnityEngine.Networking", "UnityWebRequestAsyncOperation/BindingsMarshaller");
...
public:
// Declarations
/// @brief Method ConvertToManaged, addr 0x182549450, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182549a60, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_webRequest, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* get_webRequest() ;

/// @brief Method set_webRequest, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Networking::UnityWebRequestAsyncOperation) == 0x28, "Size mismatch!");
