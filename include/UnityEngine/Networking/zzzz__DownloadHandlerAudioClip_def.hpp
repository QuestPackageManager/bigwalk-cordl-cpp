...
/// @brief Method Create, addr 0x182549060, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Create_Injected, addr 0x182549050, size 0x10, virtual false, abstract: false, final false
static inline ::System::IntPtr Create_Injected(::UnityEngine::Networking::DownloadHandlerAudioClip*  obj, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  url, ::UnityEngine::AudioType  audioType) ;

/// @brief Method Dispose, addr 0x182549180, size 0x30, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetContent, addr 0x1825491b0, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::AudioClip> GetContent(::UnityEngine::Networking::UnityWebRequest*  www) ;

/// @brief Method GetNativeData, addr 0x182549280, size 0x20, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method GetText, addr 0x1825492a0, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetText() ;

/// @brief Method InternalCreateAudioClip, addr 0x1825492c0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1825492c0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  url, ::UnityEngine::AudioType  audioType) ;

/// @brief Method get_audioClip, addr 0x1825492f0, size 0xe0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioClip> get_audioClip() ;

/// @brief Method get_audioClip_Injected, addr 0x1825492e0, size 0x10, virtual false, abstract: false, final false
