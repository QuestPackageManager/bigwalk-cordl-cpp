...
// Write type traits
MARK_REF_T(::UnityEngine::NoAllocHelpers*);
MARK_GEN_REF_T_PTR(::UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1);
DEFINE_IL2CPP_CLASS(::UnityEngine::NoAllocHelpers*, "UnityEngine", "NoAllocHelpers");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1, "UnityEngine", "NoAllocHelpers/ListPrivateFieldAccess`1");
...
// Declarations
template<typename T>
using ListPrivateFieldAccess_1 = ::UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1<T>;
...
/// @brief Method PrepareListForNativeFill, addr 0x182274ad0, size 0x90, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::NoAllocHelpers) == 0x10, "Size mismatch!");
