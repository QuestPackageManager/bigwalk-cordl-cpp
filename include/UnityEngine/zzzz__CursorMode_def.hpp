...
DEFINE_IL2CPP_CLASS(::UnityEngine::CursorMode, "UnityEngine", "CursorMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CursorMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CursorMode) == 0x4, "Size mismatch!");
