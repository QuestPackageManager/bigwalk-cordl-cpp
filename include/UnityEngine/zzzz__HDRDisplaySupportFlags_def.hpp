...
DEFINE_IL2CPP_CLASS(::UnityEngine::HDRDisplaySupportFlags, "UnityEngine", "HDRDisplaySupportFlags");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::HDRDisplaySupportFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::HDRDisplaySupportFlags) == 0x4, "Size mismatch!");
