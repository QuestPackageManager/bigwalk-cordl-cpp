...
/// @brief Method Add, addr 0x1822d2f20, size 0x50, virtual false, abstract: false, final false
inline void Add(::UnityEngine::GUILayoutEntry*  e) ;

/// @brief Method ApplyOptions, addr 0x1822d2f70, size 0x100, virtual true, abstract: false, final false
inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*>  options) ;

/// @brief Method ApplyStyleSettings, addr 0x1822d3070, size 0xe0, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::UnityEngine::GUIStyle*  style) ;

/// @brief Method CalcHeight, addr 0x1822d3150, size 0x440, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x1822d3590, size 0x4b0, virtual true, abstract: false, final false
inline void CalcWidth() ;

/// @brief Method GetLast, addr 0x1822d3a40, size 0x1d0, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetLast() ;

/// @brief Method GetNext, addr 0x1822d3c10, size 0x1c0, virtual false, abstract: false, final false
inline ::UnityEngine::GUILayoutEntry* GetNext() ;

static inline ::UnityEngine::GUILayoutGroup* New_ctor() ;

/// @brief Method ResetCursor, addr 0x1822d3dd0, size 0x10, virtual false, abstract: false, final false
inline void ResetCursor() ;

/// @brief Method SetHorizontal, addr 0x1822d3de0, size 0x5c0, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x1822d43a0, size 0x5e0, virtual true, abstract: false, final false
inline void SetVertical(float_t  y, float_t  height) ;

/// @brief Method ToString, addr 0x1822d4980, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822d4c40, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::GUILayoutEntry* getStaticF_none() ;

/// @brief Method get_marginBottom, addr 0x180bb89c0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_marginBottom() ;

/// @brief Method get_marginLeft, addr 0x180371760, size 0x10, virtual true, abstract: false, final false
inline int32_t get_marginLeft() ;

/// @brief Method get_marginRight, addr 0x180371750, size 0x10, virtual true, abstract: false, final false
inline int32_t get_marginRight() ;

/// @brief Method get_marginTop, addr 0x180310fd0, size 0x10, virtual true, abstract: false, final false
