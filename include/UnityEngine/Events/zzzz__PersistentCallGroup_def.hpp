...
// Write type traits
MARK_REF_T(::UnityEngine::Events::PersistentCallGroup*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::PersistentCallGroup*, "UnityEngine.Events", "PersistentCallGroup");
...
/// @brief Method Initialize, addr 0x18227f9e0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18227fab0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Events::PersistentCallGroup) == 0x18, "Size mismatch!");
