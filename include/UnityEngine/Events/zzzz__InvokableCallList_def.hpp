...
// Write type traits
MARK_REF_T(::UnityEngine::Events::InvokableCallList*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::InvokableCallList*, "UnityEngine.Events", "InvokableCallList");
...
/// @brief Field m_ExecutingCalls, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ExecutingCalls, put=__cordl_internal_set_m_ExecutingCalls)) ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>*  m_ExecutingCalls;
...
/// @brief Field m_PersistentCalls, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PersistentCalls, put=__cordl_internal_set_m_PersistentCalls)) ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>*  m_PersistentCalls;

/// @brief Field m_RuntimeCalls, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RuntimeCalls, put=__cordl_internal_set_m_RuntimeCalls)) ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>*  m_RuntimeCalls;

/// @brief Method AddListener, addr 0x18227ef10, size 0x70, virtual false, abstract: false, final false
inline void AddListener(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method AddPersistentInvokableCall, addr 0x18227ef80, size 0x70, virtual false, abstract: false, final false
inline void AddPersistentInvokableCall(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method ClearPersistent, addr 0x18227eff0, size 0x80, virtual false, abstract: false, final false
inline void ClearPersistent() ;

static inline ::UnityEngine::Events::InvokableCallList* New_ctor() ;

/// @brief Method PrepareInvoke, addr 0x18227f070, size 0x80, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke() ;

/// @brief Method RemoveListener, addr 0x18227f0f0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18227f250, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Events::InvokableCallList) == 0x30, "Size mismatch!");
