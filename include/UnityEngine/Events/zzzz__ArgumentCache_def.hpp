...
// Write type traits
MARK_REF_T(::UnityEngine::Events::ArgumentCache*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::ArgumentCache*, "UnityEngine.Events", "ArgumentCache");
...
/// @brief Method OnAfterDeserialize, addr 0x18227c230, size 0x30, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x18227c230, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method get_boolArgument, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_boolArgument() ;

/// @brief Method get_floatArgument, addr 0x1802f80d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_floatArgument() ;

/// @brief Method get_intArgument, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_intArgument() ;

/// @brief Method get_stringArgument, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_stringArgument() ;

/// @brief Method get_unityObjectArgument, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_unityObjectArgument() ;

/// @brief Method get_unityObjectArgumentAssemblyTypeName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Events::ArgumentCache) == 0x38, "Size mismatch!");
