...
// Write type traits
MARK_REF_T(::UnityEngine::Events::UnityEventBase*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::UnityEventBase*, "UnityEngine.Events", "UnityEventBase");
...
/// @brief Method AddCall, addr 0x18228b7a0, size 0x70, virtual false, abstract: false, final false
inline void AddCall(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method DirtyPersistentCalls, addr 0x18228b810, size 0xa0, virtual false, abstract: false, final false
inline void DirtyPersistentCalls() ;

/// @brief Method FindMethod, addr 0x18228b8b0, size 0xe0, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* FindMethod(::UnityEngine::Events::PersistentCall*  call) ;

/// @brief Method FindMethod, addr 0x18228b990, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method GetPersistentEventCount, addr 0x18228bbd0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPersistentEventCount() ;

/// @brief Method GetValidMethodInfo, addr 0x18228bbe0, size 0x180, virtual false, abstract: false, final false
static inline ::System::Reflection::MethodInfo* GetValidMethodInfo(::System::Type*  objectType, ::StringW  functionName, ::ArrayW<::System::Type*>  argumentTypes) ;

static inline ::UnityEngine::Events::UnityEventBase* New_ctor() ;

/// @brief Method PrepareInvoke, addr 0x18228bd60, size 0x140, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke() ;

/// @brief Method RebuildPersistentCallsIfNeeded, addr 0x18228bea0, size 0xf0, virtual false, abstract: false, final false
inline void RebuildPersistentCallsIfNeeded() ;

/// @brief Method RemoveListener, addr 0x18228bf90, size 0x160, virtual false, abstract: false, final false
inline void RemoveListener(::System::Object*  targetObj, ::System::Reflection::MethodInfo*  method) ;

/// @brief Method ToString, addr 0x18228c0f0, size 0x60, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x18228c150, size 0x10, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x18228c150, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18228c160, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Events::UnityEventBase) == 0x28, "Size mismatch!");
