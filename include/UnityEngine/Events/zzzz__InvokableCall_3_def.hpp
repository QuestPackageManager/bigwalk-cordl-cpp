...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Events::InvokableCall_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Events::InvokableCall_3, "UnityEngine.Events", "InvokableCall`3");
