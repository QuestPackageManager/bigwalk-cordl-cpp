...
// Write type traits
MARK_REF_T(::UnityEngine::Events::UnityEventTools*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::UnityEventTools*, "UnityEngine.Events", "UnityEventTools");
...
public:
// Declarations
/// @brief Method TidyAssemblyTypeName, addr 0x18228c280, size 0x100, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Events::UnityEventTools) == 0x10, "Size mismatch!");
