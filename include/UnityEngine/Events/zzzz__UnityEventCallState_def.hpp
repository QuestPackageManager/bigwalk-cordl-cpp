...
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::UnityEventCallState, "UnityEngine.Events", "UnityEventCallState");
// Dependencies 
namespace UnityEngine::Events {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Events::UnityEventCallState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Events::UnityEventCallState) == 0x4, "Size mismatch!");
