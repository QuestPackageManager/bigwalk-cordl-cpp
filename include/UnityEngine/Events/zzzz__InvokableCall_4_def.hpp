...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Events::InvokableCall_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Events::InvokableCall_4, "UnityEngine.Events", "InvokableCall`4");
