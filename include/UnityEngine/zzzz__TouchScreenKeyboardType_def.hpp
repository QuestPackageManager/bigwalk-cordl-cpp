...
DEFINE_IL2CPP_CLASS(::UnityEngine::TouchScreenKeyboardType, "UnityEngine", "TouchScreenKeyboardType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TouchScreenKeyboardType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TouchScreenKeyboardType) == 0x4, "Size mismatch!");
