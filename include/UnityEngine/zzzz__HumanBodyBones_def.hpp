...
DEFINE_IL2CPP_CLASS(::UnityEngine::HumanBodyBones, "UnityEngine", "HumanBodyBones");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::HumanBodyBones, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::HumanBodyBones) == 0x4, "Size mismatch!");
