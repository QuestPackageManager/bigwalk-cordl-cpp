...
/// @brief Method Invoke, addr 0x18222aea0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18222af30, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AndroidJavaRunnable*  runnable) ;

/// @brief Method run, addr 0x18222afb0, size 0x20, virtual false, abstract: false, final false
inline void run() ;
