...
DEFINE_IL2CPP_CLASS(::UnityEngine::MixedLightingMode, "UnityEngine", "MixedLightingMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::MixedLightingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::MixedLightingMode) == 0x4, "Size mismatch!");
