...
MARK_GEN_VAL_T(::UnityEngine::Awaitable_1_Awaiter);
...
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Awaitable_1_Awaiter, "UnityEngine", "Awaitable`1/Awaiter");
// Dependencies 
namespace UnityEngine {
// cpp template
template<typename T>
// Is value type: true
// CS Name: UnityEngine.Awaitable`1/Awaiter<T>
struct CORDL_TYPE Awaitable_1_Awaiter {
public:
// Declarations
...
inline void _ctor(::UnityEngine::Awaitable_1<T>*  coroutine) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr Awaitable_1_Awaiter() ;

// Ctor Parameters [CppParam { name: "_coroutine", ty: "::UnityEngine::Awaitable_1<T>*", modifiers: "", def_value: None }]
constexpr Awaitable_1_Awaiter(::UnityEngine::Awaitable_1<T>*  _coroutine) noexcept;
...
/// @brief Field _coroutine, offset: 0x0, size: 0x8, def value: None
 ::UnityEngine::Awaitable_1<T>*  _coroutine;
...
public:
// Declarations
using Awaiter = ::UnityEngine::Awaitable_1_Awaiter<T>;
...
inline void ContinueWith(::System::Action*  continuation) ;

/// @brief Method GetAwaiter, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::UnityEngine::Awaitable_1_Awaiter<T> GetAwaiter() ;
