...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchFilterSettings, "UnityEngine.Rendering", "BatchFilterSettings");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method set_allDepthSorted, addr 0x18228dd70, size 0x20, virtual false, abstract: false, final false
inline void set_allDepthSorted(bool  value) ;

/// @brief Method set_batchLayer, addr 0x180503b60, size 0x10, virtual false, abstract: false, final false
inline void set_batchLayer(uint8_t  value) ;

/// @brief Method set_motionMode, addr 0x181014340, size 0x2de0, virtual false, abstract: false, final false
inline void set_motionMode(::UnityEngine::MotionVectorGenerationMode  value) ;

/// @brief Method set_receiveShadows, addr 0x18228dd90, size 0x20, virtual false, abstract: false, final false
inline void set_receiveShadows(bool  value) ;

/// @brief Method set_shadowCastingMode, addr 0x181a74780, size 0x10, virtual false, abstract: false, final false
inline void set_shadowCastingMode(::UnityEngine::Rendering::ShadowCastingMode  value) ;

/// @brief Method set_staticShadowCaster, addr 0x18228ddb0, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "renderingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "rendererPriority", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_sceneCullingMask", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "layer", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_batchLayer", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_motionMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_shadowMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_receiveShadows", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_staticShadowCaster", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_allDepthSorted", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_isSceneCullingMaskSet", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr BatchFilterSettings(uint32_t  renderingLayerMask, int32_t  rendererPriority, uint64_t  m_sceneCullingMask, uint8_t  layer, uint8_t  m_batchLayer, uint8_t  m_motionMode, uint8_t  m_shadowMode, uint8_t  m_receiveShadows, uint8_t  m_staticShadowCaster, uint8_t  m_allDepthSorted, uint8_t  m_isSceneCullingMaskSet) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::BatchFilterSettings) == 0x18, "Size mismatch!");
