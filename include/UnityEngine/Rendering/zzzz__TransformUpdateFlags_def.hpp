...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TransformUpdateFlags, "UnityEngine.Rendering", "TransformUpdateFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::TransformUpdateFlags, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::TransformUpdateFlags) == 0x1, "Size mismatch!");
