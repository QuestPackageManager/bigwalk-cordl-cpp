...
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeBakingSet*);
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeBakingSet_PerScenarioDataInfo*);
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet_Version, "UnityEngine.Rendering", "ProbeVolumeBakingSet/Version");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet*, "UnityEngine.Rendering", "ProbeVolumeBakingSet");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet_PerScenarioDataInfo*, "UnityEngine.Rendering", "ProbeVolumeBakingSet/PerScenarioDataInfo");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet_CellCounts, "UnityEngine.Rendering", "ProbeVolumeBakingSet/CellCounts");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask, "UnityEngine.Rendering", "ProbeVolumeBakingSet/ProbeLayerMask");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingSet_SerializedPerSceneCellList, "UnityEngine.Rendering", "ProbeVolumeBakingSet/SerializedPerSceneCellList");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static ::UnityEngine::Rendering::ProbeVolumeBakingSet_Version const AssetsAlwaysReferenced;
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolumeBakingSet_Version, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet_Version) == 0x4, "Size mismatch!");
...
/// @brief Method ComputeHasValidData, addr 0x18200db30, size 0x60, virtual false, abstract: false, final false
inline bool ComputeHasValidData(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method HasValidData, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool HasValidData(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method Initialize, addr 0x18200db90, size 0x60, virtual false, abstract: false, final false
inline void Initialize(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method IsValid, addr 0x18200dbf0, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet_PerScenarioDataInfo) == 0x38, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Add, addr 0x18200b6e0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet_CellCounts) == 0x8, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet_SerializedPerSceneCellList) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask) == 0x10, "Size mismatch!");

} // namespace end def UnityEngine::Rendering
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.IO.LowLevel.Unsafe.ReadCommand, Unity.IO.LowLevel.Unsafe.ReadCommandArray, Unity.Mathematics.uint4, UnityEngine.Bounds, UnityEngine.LayerMask, UnityEngine.Rendering.ProbeVolumeBakingProcessSettings, UnityEngine.Rendering.ProbeVolumeBakingSet::ProbeLayerMask, UnityEngine.Rendering.ProbeVolumeBakingSet::Version, UnityEngine.ScriptableObject, UnityEngine.Vector3, UnityEngine.Vector3Int
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field renderingLayerMasks, offset 0x1e0, size 0x8 
 __declspec(property(get=__cordl_internal_get_renderingLayerMasks, put=__cordl_internal_set_renderingLayerMasks)) ::ArrayW<::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask>  renderingLayerMasks;
...
/// @brief Method AlignUp16, addr 0x182013b90, size 0x30, virtual false, abstract: false, final false
static inline int32_t AlignUp16(int32_t  count) ;

/// @brief Method BlendLightingScenario, addr 0x182013bc0, size 0x210, virtual false, abstract: false, final false
inline void BlendLightingScenario(::StringW  otherScenario, float_t  blendingFactor) ;

/// @brief Method CheckCompatibleCellLayout, addr 0x182013dd0, size 0x80, virtual false, abstract: false, final false
inline bool CheckCompatibleCellLayout() ;

/// @brief Method Cleanup, addr 0x182013e50, size 0x200, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method ComputeHasSupportData, addr 0x182014050, size 0x40, virtual false, abstract: false, final false
inline bool ComputeHasSupportData() ;

/// @brief Method ComputeHasValidSharedData, addr 0x182014090, size 0x40, virtual false, abstract: false, final false
inline bool ComputeHasValidSharedData() ;

/// @brief Method ComputeRegionMasks, addr 0x1820140d0, size 0xb0, virtual false, abstract: false, final false
inline ::Unity::Mathematics::uint4 ComputeRegionMasks() ;

/// @brief Method FileExists, addr 0x182014180, size 0x70, virtual false, abstract: false, final false
inline bool FileExists(::StringW  path) ;

/// @brief Method GetBakingHashCode, addr 0x1820141f0, size 0x1b0, virtual false, abstract: false, final false
inline int32_t GetBakingHashCode() ;

/// @brief Method GetCellData, addr 0x1820143a0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeReferenceVolume_CellData* GetCellData(int32_t  cellIndex) ;

/// @brief Method GetCellDesc, addr 0x1820143e0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeReferenceVolume_CellDesc* GetCellDesc(int32_t  cellIndex) ;

/// @brief Method GetCellSizeInBricks, addr 0x182014420, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetCellSizeInBricks(int32_t  simplificationLevels) ;

/// @brief Method GetChunkGPUMemory, addr 0x182014450, size 0x40, virtual false, abstract: false, final false
inline int32_t GetChunkGPUMemory(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method GetMaxSubdivision, addr 0x182014490, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetMaxSubdivision(int32_t  simplificationLevels) ;

/// @brief Method GetMinBrickSize, addr 0x1820144a0, size 0x20, virtual false, abstract: false, final false
static inline float_t GetMinBrickSize(float_t  minDistanceBetweenProbes) ;

/// @brief Method GetSceneCellIndexList, addr 0x1820144c0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method HasBakedData, addr 0x182014500, size 0xd0, virtual false, abstract: false, final false
inline bool HasBakedData(::StringW  scenario) ;

/// @brief Method HasSameSceneGUIDs, addr 0x1820145d0, size 0x1a0, virtual false, abstract: false, final false
inline bool HasSameSceneGUIDs(::UnityEngine::Rendering::ProbeVolumeBakingSet*  other) ;

/// @brief Method HasSupportData, addr 0x182014770, size 0x10, virtual false, abstract: false, final false
inline bool HasSupportData() ;

/// @brief Method HasValidSharedData, addr 0x182014780, size 0x10, virtual false, abstract: false, final false
inline bool HasValidSharedData() ;

/// @brief Method Initialize, addr 0x182014790, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method Migrate, addr 0x1820149c0, size 0x80, virtual false, abstract: false, final false
inline void Migrate() ;

static inline ::UnityEngine::Rendering::ProbeVolumeBakingSet* New_ctor() ;

/// @brief Method OnEnable, addr 0x182014a40, size 0xf0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x182014b30, size 0x100, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method PruneCellIndexList, addr 0x182014d00, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method PruneCellIndexListForScenario, addr 0x182014c30, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method ReleaseCell, addr 0x182014de0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method RequestScratchBuffer, addr 0x182014e30, size 0xb0, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> RequestScratchBuffer(int32_t  size) ;

/// @brief Method ResolveAllCellData, addr 0x182014ee0, size 0x40, virtual false, abstract: false, final false
inline bool ResolveAllCellData() ;

/// @brief Method ResolveCellData, addr 0x182014f20, size 0x300, virtual false, abstract: false, final false
inline bool ResolveCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolvePerScenarioCellData, addr 0x182015610, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method ResolvePerScenarioCellData, addr 0x182015220, size 0x3f0, virtual false, abstract: false, final false
inline bool ResolvePerScenarioCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolveSharedCellData, addr 0x182015bd0, size 0x1e0, virtual false, abstract: false, final false
inline bool ResolveSharedCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolveSharedCellData, addr 0x182015db0, size 0x6a0, virtual false, abstract: false, final false
...
/// @brief Method SetActiveScenario, addr 0x182016450, size 0x190, virtual false, abstract: false, final false
inline void SetActiveScenario(::StringW  scenario, bool  verbose) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x1820165e0, size 0x260, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x182016840, size 0x1a0, virtual true, abstract: false, final true
...
constexpr ::ArrayW<::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask> const& __cordl_internal_get_renderingLayerMasks() const;

constexpr ::ArrayW<::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask>& __cordl_internal_get_renderingLayerMasks() ;
...
constexpr void __cordl_internal_set_renderingLayerMasks(::ArrayW<::UnityEngine::Rendering::ProbeVolumeBakingSet_ProbeLayerMask>  value) ;
...
/// @brief Method .ctor, addr 0x1820169e0, size 0x340, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakedSkyOcclusion, addr 0x182016d20, size 0x10, virtual false, abstract: false, final false
inline bool get_bakedSkyOcclusion() ;

/// @brief Method get_bakedSkyShadingDirection, addr 0x182016d30, size 0x10, virtual false, abstract: false, final false
inline bool get_bakedSkyShadingDirection() ;

/// @brief Method get_cellSizeInBricks, addr 0x182016d40, size 0x30, virtual false, abstract: false, final false
inline int32_t get_cellSizeInBricks() ;

/// @brief Method get_cellSizeInMeters, addr 0x182016d70, size 0x60, virtual false, abstract: false, final false
inline float_t get_cellSizeInMeters() ;

/// @brief Method get_hasDilation, addr 0x182016dd0, size 0x20, virtual false, abstract: false, final false
inline bool get_hasDilation() ;

/// @brief Method get_lightingScenarios, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_lightingScenarios() ;

/// @brief Method get_maxSubdivision, addr 0x182016df0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxSubdivision() ;

/// @brief Method get_minBrickSize, addr 0x182016e00, size 0x20, virtual false, abstract: false, final false
inline float_t get_minBrickSize() ;

/// @brief Method get_otherScenario, addr 0x1803459e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_otherScenario() ;

/// @brief Method get_scenarioBlendingFactor, addr 0x1818e3ba0, size 0x10, virtual false, abstract: false, final false
inline float_t get_scenarioBlendingFactor() ;

/// @brief Method get_sceneGUIDs, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_sceneGUIDs() ;

/// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

/// @brief Method set_bakedSkyOcclusion, addr 0x182016e20, size 0x10, virtual false, abstract: false, final false
inline void set_bakedSkyOcclusion(bool  value) ;

/// @brief Method set_bakedSkyShadingDirection, addr 0x182016e30, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingSet) == 0x1f0, "Size mismatch!");
