...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolume_Mode, "UnityEngine.Rendering", "ProbeVolume/Mode");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolume_Version, "UnityEngine.Rendering", "ProbeVolume/Version");
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolume_Version, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolume_Mode, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method Awake, addr 0x182017c90, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x182017cc0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
