...
/// @brief Method .ctor, addr 0x1820364d0, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::GenerateHLSL) == 0x30, "Size mismatch!");
