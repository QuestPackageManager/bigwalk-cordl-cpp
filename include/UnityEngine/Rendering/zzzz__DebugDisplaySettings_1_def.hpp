...
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplaySettings_1___c);
...
constexpr ::System::Collections::Generic::IEqualityComparer_1<::UnityEngine::Rendering::IDebugDisplaySettingsData*>* i___System__Collections__Generic__IEqualityComparer_1___UnityEngine__Rendering__IDebugDisplaySettingsData__() noexcept;
...
/// @brief Field m_Settings, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Settings, put=__cordl_internal_set_m_Settings)) ::System::Collections::Generic::HashSet_1<::UnityEngine::Rendering::IDebugDisplaySettingsData*>*  m_Settings;
