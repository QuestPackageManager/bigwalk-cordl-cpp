...
/// @brief Method IsSupported, addr 0x182047270, size 0x20, virtual false, abstract: false, final false
static inline bool IsSupported() ;

/// @brief Method SetEasuConstants, addr 0x1820474a0, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method SetEasuConstants, addr 0x182047290, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method SetRcasConstants, addr 0x182047790, size 0x10, virtual false, abstract: false, final false
static inline void SetRcasConstants(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, float_t  sharpnessStops) ;

/// @brief Method SetRcasConstants, addr 0x182047710, size 0x80, virtual false, abstract: false, final false
static inline void SetRcasConstants(::UnityEngine::Rendering::CommandBuffer*  cmd, float_t  sharpnessStops) ;

/// @brief Method SetRcasConstantsLinear, addr 0x1820476c0, size 0x20, virtual false, abstract: false, final false
static inline void SetRcasConstantsLinear(::UnityEngine::Rendering::CommandBuffer*  cmd, float_t  sharpnessLinear) ;

/// @brief Method SetRcasConstantsLinear, addr 0x1820476e0, size 0x30, virtual false, abstract: false, final false
