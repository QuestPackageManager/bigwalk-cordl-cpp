...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReceiverSphereCuller_SplitInfo, "UnityEngine.Rendering", "ReceiverSphereCuller/SplitInfo");
...
static_assert(sizeof(::UnityEngine::Rendering::ReceiverSphereCuller_SplitInfo) == 0x14, "Size mismatch!");
...
/// @brief Method ComputeSplitVisibilityMask, addr 0x182098880, size 0x3d0, virtual false, abstract: false, final false
static inline uint32_t ComputeSplitVisibilityMask(::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  lightFacingFrustumPlanes, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::ReceiverSphereCuller_SplitInfo>  splitInfos, ::Unity::Mathematics::float3x3  worldToLightSpaceRotation, ::by_ref<::UnityEngine::Rendering::AABB>  bounds) ;
...
/// @brief Method Dispose, addr 0x182098830, size 0x50, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "splitInfos", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::ReceiverSphereCuller_SplitInfo>", modifiers: "", def_value: None }, CppParam { name: "worldToLightSpaceRotation", ty: "::Unity::Mathematics::float3x3", modifiers: "", def_value: None }]
constexpr ReceiverSphereCuller(::Unity::Collections::NativeList_1<::UnityEngine::Rendering::ReceiverSphereCuller_SplitInfo>  splitInfos, ::Unity::Mathematics::float3x3  worldToLightSpaceRotation) noexcept;
