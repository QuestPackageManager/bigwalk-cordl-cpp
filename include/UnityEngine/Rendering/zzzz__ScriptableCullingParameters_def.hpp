...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ScriptableCullingParameters, "UnityEngine.Rendering", "ScriptableCullingParameters");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ScriptableCullingParameters__m_LayerFarCullDistances_e__FixedBuffer, "UnityEngine.Rendering", "ScriptableCullingParameters/<m_LayerFarCullDistances>e__FixedBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
// Dependencies UnityEngine.Matrix4x4, UnityEngine.Rendering.CameraProperties, UnityEngine.Rendering.CullingOptions, UnityEngine.Rendering.LODParameters, UnityEngine.Rendering.ReflectionProbeSortingCriteria, UnityEngine.Rendering.ScriptableCullingParameters::<m_CullingPlanes>e__FixedBuffer, UnityEngine.Rendering.ScriptableCullingParameters::<m_LayerFarCullDistances>e__FixedBuffer, UnityEngine.Vector3
namespace UnityEngine::Rendering {
// Is value type: true
...
using _m_LayerFarCullDistances_e__FixedBuffer = ::UnityEngine::Rendering::ScriptableCullingParameters__m_LayerFarCullDistances_e__FixedBuffer;
 ...
 __declspec(property(get=get_cullingMatrix)) ::UnityEngine::Matrix4x4  cullingMatrix;
...
/// @brief Field layerCount, offset 0xffffffff, size 0x4 
 ...
 __declspec(property(get=get_lodParameters)) ::UnityEngine::Rendering::LODParameters  lodParameters;
...
/// @brief Method Equals, addr 0x1822b1500, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822b0e40, size 0x6c0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ScriptableCullingParameters  other) ;

/// @brief Method GetCullingPlane, addr 0x1822b1590, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Plane GetCullingPlane(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x1822b1680, size 0x210, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLayerCullingDistance, addr 0x1822b1890, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_cullingMatrix, addr 0x1822b1990, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_cullingMatrix() ;

/// @brief Method get_cullingOptions, addr 0x1822b1a10, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CullingOptions get_cullingOptions() ;

/// @brief Method get_cullingPlaneCount, addr 0x1816bea70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_lodParameters, addr 0x1822b1a30, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::LODParameters get_lodParameters() ;

/// @brief Method get_stereoProjectionMatrix, addr 0x1822b1a90, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method set_conservativeEnclosingSphere, addr 0x1822b1b10, size 0x20, virtual false, abstract: false, final false
inline void set_conservativeEnclosingSphere(bool  value) ;

/// @brief Method set_cullingOptions, addr 0x1822b1b30, size 0x20, virtual false, abstract: false, final false
inline void set_cullingOptions(::UnityEngine::Rendering::CullingOptions  value) ;

/// @brief Method set_maximumVisibleLights, addr 0x1822b1b50, size 0x20, virtual false, abstract: false, final false
inline void set_maximumVisibleLights(int32_t  value) ;

/// @brief Method set_numIterationsEnclosingSphere, addr 0x1822b1b70, size 0x20, virtual false, abstract: false, final false
inline void set_numIterationsEnclosingSphere(int32_t  value) ;

/// @brief Method set_reflectionProbeSortingCriteria, addr 0x1822b1b90, size 0x20, virtual false, abstract: false, final false
inline void set_reflectionProbeSortingCriteria(::UnityEngine::Rendering::ReflectionProbeSortingCriteria  value) ;

/// @brief Method set_shadowDistance, addr 0x1822b1bb0, size 0x20, virtual false, abstract: false, final false
inline void set_shadowDistance(float_t  value) ;

/// @brief Method set_stereoProjectionMatrix, addr 0x1822b1bd0, size 0x70, virtual false, abstract: false, final false
inline void set_stereoProjectionMatrix(::UnityEngine::Matrix4x4  value) ;

/// @brief Method set_stereoSeparationDistance, addr 0x1822b1c40, size 0x20, virtual false, abstract: false, final false
inline void set_stereoSeparationDistance(float_t  value) ;

/// @brief Method set_stereoViewMatrix, addr 0x1822b1c60, size 0x6d0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_LODParameters", ty: "::UnityEngine::Rendering::LODParameters", modifiers: "", def_value: None }, CppParam { name: "m_CullingPlanes", ty: "::UnityEngine::Rendering::ScriptableCullingParameters__m_CullingPlanes_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_CullingPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_SceneMask", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "m_ViewID", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "m_LayerFarCullDistances", ty: "::UnityEngine::Rendering::ScriptableCullingParameters__m_LayerFarCullDistances_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_LayerCull", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_Origin", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "m_ShadowDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_ShadowNearPlaneOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingOptions", ty: "::UnityEngine::Rendering::CullingOptions", modifiers: "", def_value: None }, CppParam { name: "m_ReflectionProbeSortingCriteria", ty: "::UnityEngine::Rendering::ReflectionProbeSortingCriteria", modifiers: "", def_value: None }, CppParam { name: "m_CameraProperties", ty: "::UnityEngine::Rendering::CameraProperties", modifiers: "", def_value: None }, CppParam { name: "m_AccurateOcclusionThreshold", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_MaximumPortalCullingJobs", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_StereoViewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_StereoProjectionMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_StereoSeparationDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_maximumVisibleLights", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ConservativeEnclosingSphere", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_NumIterationsEnclosingSphere", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ScriptableCullingParameters(::UnityEngine::Rendering::LODParameters  m_LODParameters, ::UnityEngine::Rendering::ScriptableCullingParameters__m_CullingPlanes_e__FixedBuffer  m_CullingPlanes, int32_t  m_CullingPlaneCount, uint32_t  m_CullingMask, uint64_t  m_SceneMask, uint64_t  m_ViewID, ::UnityEngine::Rendering::ScriptableCullingParameters__m_LayerFarCullDistances_e__FixedBuffer  m_LayerFarCullDistances, int32_t  m_LayerCull, ::UnityEngine::Matrix4x4  m_CullingMatrix, ::UnityEngine::Vector3  m_Origin, float_t  m_ShadowDistance, float_t  m_ShadowNearPlaneOffset, ::UnityEngine::Rendering::CullingOptions  m_CullingOptions, ::UnityEngine::Rendering::ReflectionProbeSortingCriteria  m_ReflectionProbeSortingCriteria, ::UnityEngine::Rendering::CameraProperties  m_CameraProperties, float_t  m_AccurateOcclusionThreshold, int32_t  m_MaximumPortalCullingJobs, ::UnityEngine::Matrix4x4  m_StereoViewMatrix, ::UnityEngine::Matrix4x4  m_StereoProjectionMatrix, float_t  m_StereoSeparationDistance, int32_t  m_maximumVisibleLights, bool  m_ConservativeEnclosingSphere, int32_t  m_NumIterationsEnclosingSphere) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::ScriptableCullingParameters) == 0x638, "Size mismatch!");
