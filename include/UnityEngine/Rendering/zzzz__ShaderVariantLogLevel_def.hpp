...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShaderVariantLogLevel, "UnityEngine.Rendering", "ShaderVariantLogLevel");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ShaderVariantLogLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ShaderVariantLogLevel) == 0x4, "Size mismatch!");
