...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderTargetBinding, "UnityEngine.Rendering", "RenderTargetBinding");
...
public:
// Declarations
 __declspec(property(get=get_colorLoadActions)) ::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction>  colorLoadActions;

 __declspec(property(get=get_colorRenderTargets)) ::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>  colorRenderTargets;
...
/// @brief Method get_colorLoadActions, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction> get_colorLoadActions() ;

/// @brief Method get_colorRenderTargets, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier> get_colorRenderTargets() ;

/// @brief Method get_colorStoreActions, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction> get_colorStoreActions() ;

/// @brief Method get_depthLoadAction, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderBufferLoadAction get_depthLoadAction() ;

/// @brief Method get_depthRenderTarget, addr 0x18052c9a0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderTargetIdentifier get_depthRenderTarget() ;

/// @brief Method get_depthStoreAction, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderBufferStoreAction get_depthStoreAction() ;

/// @brief Method get_flags, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_ColorRenderTargets", ty: "::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>", modifiers: "", def_value: None }, CppParam { name: "m_DepthRenderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: None }, CppParam { name: "m_ColorLoadActions", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction>", modifiers: "", def_value: None }, CppParam { name: "m_ColorStoreActions", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction>", modifiers: "", def_value: None }, CppParam { name: "m_DepthLoadAction", ty: "::UnityEngine::Rendering::RenderBufferLoadAction", modifiers: "", def_value: None }, CppParam { name: "m_DepthStoreAction", ty: "::UnityEngine::Rendering::RenderBufferStoreAction", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::Rendering::RenderTargetFlags", modifiers: "", def_value: None }]
constexpr RenderTargetBinding(::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>  m_ColorRenderTargets, ::UnityEngine::Rendering::RenderTargetIdentifier  m_DepthRenderTarget, ::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction>  m_ColorLoadActions, ::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction>  m_ColorStoreActions, ::UnityEngine::Rendering::RenderBufferLoadAction  m_DepthLoadAction, ::UnityEngine::Rendering::RenderBufferStoreAction  m_DepthStoreAction, ::UnityEngine::Rendering::RenderTargetFlags  m_Flags) noexcept;
...
/// @brief Field m_ColorRenderTargets, offset: 0x0, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>  m_ColorRenderTargets;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderTargetBinding) == 0x50, "Size mismatch!");
