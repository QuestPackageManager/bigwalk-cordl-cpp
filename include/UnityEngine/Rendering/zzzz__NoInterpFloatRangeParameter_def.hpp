...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::NoInterpFloatRangeParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::NoInterpFloatRangeParameter*, "UnityEngine.Rendering", "NoInterpFloatRangeParameter");
...
/// @brief Method set_value, addr 0x1820477b0, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpFloatRangeParameter) == 0x28, "Size mismatch!");
