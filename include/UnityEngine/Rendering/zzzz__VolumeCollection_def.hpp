...
/// @brief Field m_SortedVolumes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SortedVolumes, put=__cordl_internal_set_m_SortedVolumes)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>*>*  m_SortedVolumes;
...
/// @brief Method ChangeLayer, addr 0x18204fe60, size 0x290, virtual false, abstract: false, final false
inline bool ChangeLayer(::UnityEngine::Rendering::Volume*  volume, int32_t  previousLayerIndex, int32_t  currentLayerIndex) ;

/// @brief Method GrabVolumes, addr 0x1820500f0, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method Register, addr 0x182050340, size 0x1d0, virtual false, abstract: false, final false
inline bool Register(::UnityEngine::Rendering::Volume*  volume, int32_t  layer) ;

/// @brief Method SetLayerIndexDirty, addr 0x181fc9430, size 0xb0, virtual false, abstract: false, final false
inline void SetLayerIndexDirty(int32_t  layerIndex) ;

/// @brief Method SortByPriority, addr 0x182050510, size 0xf0, virtual false, abstract: false, final false
static inline void SortByPriority(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>*  volumes) ;

/// @brief Method Unregister, addr 0x182050600, size 0x120, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>*>* const& __cordl_internal_get_m_SortedVolumes() const;
...
constexpr void __cordl_internal_set_m_SortedVolumes(::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>*>*  value) ;
...
/// @brief Method .ctor, addr 0x182050720, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_count, addr 0x180df9d80, size 0x600, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::VolumeCollection) == 0x28, "Size mismatch!");
