...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DownscaleParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DownscaleParameter*, "UnityEngine.Rendering.Universal", "DownscaleParameter");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DownscaleParameter) == 0x20, "Size mismatch!");
