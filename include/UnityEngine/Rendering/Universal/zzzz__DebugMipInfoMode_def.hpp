...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugMipInfoMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugMipInfoMode) == 0x4, "Size mismatch!");
