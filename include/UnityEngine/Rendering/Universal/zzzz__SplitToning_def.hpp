...
/// @brief Method IsActive, addr 0x18210c1c0, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18210c240, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::SplitToning) == 0x50, "Size mismatch!");
