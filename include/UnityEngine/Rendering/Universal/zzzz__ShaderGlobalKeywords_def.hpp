...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ShaderGlobalKeywords*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShaderGlobalKeywords*, "UnityEngine.Rendering.Universal", "ShaderGlobalKeywords");
...
public:
// Declarations
/// @brief Field AdditionalLightShadows, offset 0xffffffff, size 0x4 
...
/// @brief Field AdditionalLightsPixel, offset 0xffffffff, size 0x4 
...
/// @brief Field AdditionalLightsVertex, offset 0xffffffff, size 0x4 
...
/// @brief Field BillboardFaceCameraPos, offset 0xffffffff, size 0x4 
...
/// @brief Field BlitSingleSlice, offset 0xffffffff, size 0x4 
...
/// @brief Field CastingPunctualLightShadow, offset 0xffffffff, size 0x4 
...
/// @brief Field ClusterLightLoop, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_ClusterLightLoop, put=setStaticF_ClusterLightLoop)) ::UnityEngine::Rendering::GlobalKeyword  ClusterLightLoop;

/// @brief Field DBufferMRT1, offset 0xffffffff, size 0x4 
...
/// @brief Field DBufferMRT2, offset 0xffffffff, size 0x4 
...
/// @brief Field DBufferMRT3, offset 0xffffffff, size 0x4 
...
/// @brief Field DEBUG_DISPLAY, offset 0xffffffff, size 0x4 
...
/// @brief Field DIRLIGHTMAP_COMBINED, offset 0xffffffff, size 0x4 
...
/// @brief Field DOWNSAMPLING_SIZE_16, offset 0xffffffff, size 0x4 
...
/// @brief Field DOWNSAMPLING_SIZE_2, offset 0xffffffff, size 0x4 
...
/// @brief Field DOWNSAMPLING_SIZE_4, offset 0xffffffff, size 0x4 
...
/// @brief Field DOWNSAMPLING_SIZE_8, offset 0xffffffff, size 0x4 
...
/// @brief Field DYNAMICLIGHTMAP_ON, offset 0xffffffff, size 0x4 
...
/// @brief Field DecalLayers, offset 0xffffffff, size 0x4 
...
/// @brief Field DecalNormalBlendHigh, offset 0xffffffff, size 0x4 
...
/// @brief Field DecalNormalBlendLow, offset 0xffffffff, size 0x4 
...
/// @brief Field DecalNormalBlendMedium, offset 0xffffffff, size 0x4 
...
/// @brief Field DisableTexture2DXArray, offset 0xffffffff, size 0x4 
...
/// @brief Field EDITOR_VISUALIZATION, offset 0xffffffff, size 0x4 
...
/// @brief Field EVALUATE_SH_MIXED, offset 0xffffffff, size 0x4 
...
/// @brief Field EVALUATE_SH_VERTEX, offset 0xffffffff, size 0x4 
...
/// @brief Field ForwardPlus, offset 0xffffffff, size 0x4 
...
/// @brief Field FoveatedRenderingNonUniformRaster, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_FoveatedRenderingNonUniformRaster, put=setStaticF_FoveatedRenderingNonUniformRaster)) ::UnityEngine::Rendering::GlobalKeyword  FoveatedRenderingNonUniformRaster;

/// @brief Field LIGHTMAP_BICUBIC_SAMPLING, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_LIGHTMAP_BICUBIC_SAMPLING, put=setStaticF_LIGHTMAP_BICUBIC_SAMPLING)) ::UnityEngine::Rendering::GlobalKeyword  LIGHTMAP_BICUBIC_SAMPLING;

/// @brief Field LIGHTMAP_ON, offset 0xffffffff, size 0x4 
...
/// @brief Field LOD_FADE_CROSSFADE, offset 0xffffffff, size 0x4 
...
/// @brief Field LightCookies, offset 0xffffffff, size 0x4 
...
/// @brief Field LightLayers, offset 0xffffffff, size 0x4 
...
/// @brief Field LightmapShadowMixing, offset 0xffffffff, size 0x4 
...
/// @brief Field LinearToSRGBConversion, offset 0xffffffff, size 0x4 
...
/// @brief Field MainLightShadowCascades, offset 0xffffffff, size 0x4 
...
/// @brief Field MainLightShadowScreen, offset 0xffffffff, size 0x4 
...
/// @brief Field MainLightShadows, offset 0xffffffff, size 0x4 
...
/// @brief Field MixedLightingSubtractive, offset 0xffffffff, size 0x4 
...
/// @brief Field ProbeVolumeL1, offset 0xffffffff, size 0x4 
...
/// @brief Field ProbeVolumeL2, offset 0xffffffff, size 0x4 
...
/// @brief Field ReflectionProbeAtlas, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_ReflectionProbeAtlas, put=setStaticF_ReflectionProbeAtlas)) ::UnityEngine::Rendering::GlobalKeyword  ReflectionProbeAtlas;

/// @brief Field ReflectionProbeBlending, offset 0xffffffff, size 0x4 
...
/// @brief Field ReflectionProbeBoxProjection, offset 0xffffffff, size 0x4 
...
/// @brief Field ReflectionProbeRotation, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_ReflectionProbeRotation, put=setStaticF_ReflectionProbeRotation)) ::UnityEngine::Rendering::GlobalKeyword  ReflectionProbeRotation;

/// @brief Field RenderPassEnabled, offset 0xffffffff, size 0x4 
...
/// @brief Field SCREEN_COORD_OVERRIDE, offset 0xffffffff, size 0x4 
...
/// @brief Field ScreenSpaceIrradiance, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_ScreenSpaceIrradiance, put=setStaticF_ScreenSpaceIrradiance)) ::UnityEngine::Rendering::GlobalKeyword  ScreenSpaceIrradiance;

/// @brief Field ScreenSpaceOcclusion, offset 0xffffffff, size 0x4 
...
/// @brief Field ShadowsShadowMask, offset 0xffffffff, size 0x4 
...
/// @brief Field SoftShadows, offset 0xffffffff, size 0x4 
...
/// @brief Field SoftShadowsHigh, offset 0xffffffff, size 0x4 
...
/// @brief Field SoftShadowsLow, offset 0xffffffff, size 0x4 
...
/// @brief Field SoftShadowsMedium, offset 0xffffffff, size 0x4 
...
/// @brief Field USE_UNITY_CROSSFADE, offset 0xffffffff, size 0x4 
...
/// @brief Field WriteRenderingLayers, offset 0xffffffff, size 0x4 
...
/// @brief Field XROcclusionMeshCombined, offset 0xffffffff, size 0x4 
...
/// @brief Field _ADD_PRECOMPUTED_VELOCITY, offset 0xffffffff, size 0x4 
...
/// @brief Field _ALPHAMODULATE_ON, offset 0xffffffff, size 0x4 
...
/// @brief Field _ALPHAPREMULTIPLY_ON, offset 0xffffffff, size 0x4 
...
/// @brief Field _ALPHATEST_ON, offset 0xffffffff, size 0x4 
...
/// @brief Field _DEFERRED_FIRST_LIGHT, offset 0xffffffff, size 0x4 
...
/// @brief Field _DEFERRED_MAIN_LIGHT, offset 0xffffffff, size 0x4 
...
/// @brief Field _DEFERRED_MIXED_LIGHTING, offset 0xffffffff, size 0x4 
...
/// @brief Field _DEFERRED_STENCIL, offset 0xffffffff, size 0x4 
...
/// @brief Field _DETAIL_MULX2, offset 0xffffffff, size 0x4 
...
/// @brief Field _DETAIL_SCALED, offset 0xffffffff, size 0x4 
...
/// @brief Field _DIRECTIONAL, offset 0xffffffff, size 0x4 
...
/// @brief Field _ENABLE_ALPHA_OUTPUT, offset 0xffffffff, size 0x4 
...
/// @brief Field _GBUFFER_NORMALS_OCT, offset 0xffffffff, size 0x4 
...
/// @brief Field _OUTPUT_DEPTH, offset 0xffffffff, size 0x4 
...
/// @brief Field _SPOT, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF__SPOT, put=setStaticF__SPOT)) ::UnityEngine::Rendering::GlobalKeyword  _SPOT;

/// @brief Field _SURFACE_TYPE_TRANSPARENT, offset 0xffffffff, size 0x4 
...
/// @brief Method InitializeShaderGlobalKeywords, addr 0x18213eca0, size 0xa90, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::GlobalKeyword getStaticF_ClusterLightLoop() ;
...
static inline ::UnityEngine::Rendering::GlobalKeyword getStaticF_LIGHTMAP_BICUBIC_SAMPLING() ;
...
static inline ::UnityEngine::Rendering::GlobalKeyword getStaticF_ReflectionProbeAtlas() ;
...
static inline ::UnityEngine::Rendering::GlobalKeyword getStaticF_ReflectionProbeRotation() ;
...
static inline ::UnityEngine::Rendering::GlobalKeyword getStaticF_ScreenSpaceIrradiance() ;
...
static inline void setStaticF_ClusterLightLoop(::UnityEngine::Rendering::GlobalKeyword  value) ;
...
static inline void setStaticF_LIGHTMAP_BICUBIC_SAMPLING(::UnityEngine::Rendering::GlobalKeyword  value) ;
...
static inline void setStaticF_ReflectionProbeAtlas(::UnityEngine::Rendering::GlobalKeyword  value) ;
...
static inline void setStaticF_ReflectionProbeRotation(::UnityEngine::Rendering::GlobalKeyword  value) ;
...
static inline void setStaticF_ScreenSpaceIrradiance(::UnityEngine::Rendering::GlobalKeyword  value) ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ShaderGlobalKeywords) == 0x10, "Size mismatch!");
