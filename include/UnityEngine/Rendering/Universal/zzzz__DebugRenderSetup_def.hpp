...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugRenderSetup*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugRenderSetup*, "UnityEngine.Rendering.Universal", "DebugRenderSetup");
...
/// @brief Method Begin, addr 0x1820ce2e0, size 0x40, virtual false, abstract: false, final false
inline void Begin(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

/// @brief Method CreateDrawingSettings, addr 0x1820ce320, size 0x200, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::DrawingSettings  drawingSettings) ;

/// @brief Method CreateRendererList, addr 0x1820ce520, size 0x160, virtual false, abstract: false, final false
inline void CreateRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::by_ref<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::by_ref<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::by_ref<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock, ::by_ref<::UnityEngine::Rendering::RendererList>  rendererList) ;

/// @brief Method CreateRendererList, addr 0x1820ce680, size 0x160, virtual false, abstract: false, final false
inline void CreateRendererList(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::by_ref<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::by_ref<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::by_ref<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>  rendererListHdl) ;

/// @brief Method Dispose, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DrawWithRendererList, addr 0x1820ce7e0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method End, addr 0x1820ce830, size 0x40, virtual false, abstract: false, final false
inline void End(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

/// @brief Method GetIndex, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetIndex() ;

/// @brief Method GetRenderStateBlock, addr 0x1820ce870, size 0x360, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::Universal::DebugRenderSetup* New_ctor(::UnityEngine::Rendering::Universal::DebugHandler*  debugHandler, int32_t  index, ::UnityEngine::Rendering::FilteringSettings  filteringSettings) ;
...
/// @brief Method .ctor, addr 0x1820cebd0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_LightingSettings, addr 0x1820cec20, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings() ;

/// @brief Method get_MaterialSettings, addr 0x1820cec30, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings() ;

/// @brief Method get_RenderingSettings, addr 0x1820cec40, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugRenderSetup) == 0x40, "Size mismatch!");
