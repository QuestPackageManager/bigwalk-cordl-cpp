...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugFullScreenMode, "UnityEngine.Rendering.Universal", "DebugFullScreenMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugFullScreenMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugFullScreenMode) == 0x4, "Size mismatch!");
