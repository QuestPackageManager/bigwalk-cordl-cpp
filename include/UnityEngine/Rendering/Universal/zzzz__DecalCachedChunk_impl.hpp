...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)(int32_t)>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::RemoveAtSwapBack)> {
  constexpr static std::size_t size = 0x1f0;
  constexpr static std::size_t addrs = 0x1820ced50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 6}
                ));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)(int32_t)>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::SetCapacity)> {
  ...
  constexpr static std::size_t addrs = 0x1820cef40;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 7}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::DecalCachedChunk::*)()>(&::UnityEngine::Rendering::Universal::DecalCachedChunk::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x1820cec50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::Universal::DecalCachedChunk*>(), 8}
                ));
    return ___internal_method;
  }
};
...
constexpr ::ArrayW<::UnityEngine::BoundingSphere>& UnityEngine::Rendering::Universal::DecalCachedChunk::__cordl_internal_get_boundingSphereArray()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___boundingSphereArray;
}
constexpr ::ArrayW<::UnityEngine::BoundingSphere> const& UnityEngine::Rendering::Universal::DecalCachedChunk::__cordl_internal_get_boundingSphereArray() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___boundingSphereArray;
}
constexpr void UnityEngine::Rendering::Universal::DecalCachedChunk::__cordl_internal_set_boundingSphereArray(::ArrayW<::UnityEngine::BoundingSphere>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___boundingSphereArray = value;
}
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::Universal::DecalCachedChunk*>());
}
// Ctor Parameters []
