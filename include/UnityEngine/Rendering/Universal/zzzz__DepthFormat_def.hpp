...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DepthFormat, "UnityEngine.Rendering.Universal", "DepthFormat");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DepthFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DepthFormat) == 0x4, "Size mismatch!");
