...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::RTHandleResourcePool*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RTHandleResourcePool*, "UnityEngine.Rendering.Universal", "RTHandleResourcePool");
...
/// @brief Field m_ResourcePool, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ResourcePool, put=__cordl_internal_set_m_ResourcePool)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<::UnityEngine::Rendering::RTHandle*,int32_t>>*>*  m_ResourcePool;
...
/// @brief Method AddResourceToPool, addr 0x1821109a0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x182110ae0, size 0x190, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateTextureDesc, addr 0x182110c70, size 0x150, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderGraphModule::TextureDesc CreateTextureDesc(::UnityEngine::RenderTextureDescriptor  desc, ::UnityEngine::Rendering::RenderGraphModule::TextureSizeMode  textureSizeMode, int32_t  anisoLevel, float_t  mipMapBias, ::UnityEngine::FilterMode  filterMode, ::UnityEngine::TextureWrapMode  wrapMode, ::StringW  name) ;

/// @brief Method GetHashCodeWithNameHash, addr 0x182110dc0, size 0x90, virtual false, abstract: false, final false
inline int32_t GetHashCodeWithNameHash(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureDesc>  texDesc) ;

/// @brief Method LogDebugInfo, addr 0x182110e50, size 0x2f0, virtual false, abstract: false, final false
inline void LogDebugInfo() ;

static inline ::UnityEngine::Rendering::Universal::RTHandleResourcePool* New_ctor() ;

/// @brief Method PurgeUnusedResources, addr 0x182111140, size 0x230, virtual false, abstract: false, final false
inline void PurgeUnusedResources(int32_t  currentFrameIndex) ;

/// @brief Method ShouldReleaseResource, addr 0x182111370, size 0x20, virtual false, abstract: false, final false
static inline bool ShouldReleaseResource(int32_t  lastUsedFrameIndex, int32_t  currentFrameIndex) ;

/// @brief Method TryGetResource, addr 0x182111390, size 0x100, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<::UnityEngine::Rendering::RTHandle*,int32_t>>*>* const& __cordl_internal_get_m_ResourcePool() const;

constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<::UnityEngine::Rendering::RTHandle*,int32_t>>*>*& __cordl_internal_get_m_ResourcePool() ;

constexpr void __cordl_internal_set_m_RemoveList(::System::Collections::Generic::List_1<int32_t>*  value) ;

constexpr void __cordl_internal_set_m_ResourcePool(::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<::UnityEngine::Rendering::RTHandle*,int32_t>>*>*  value) ;

/// @brief Method .ctor, addr 0x1821114e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_staleResourceCapacity, addr 0x182111560, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_staleResourceCapacity, addr 0x182111580, size 0x20, virtual false, abstract: false, final false
...
/// @brief Field m_ResourcePool, offset: 0x10, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<::UnityEngine::Rendering::RTHandle*,int32_t>>*>*  ___m_ResourcePool;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RTHandleResourcePool) == 0x20, "Size mismatch!");
