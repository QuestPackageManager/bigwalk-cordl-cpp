...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugMipMapModeTerrainTexture, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugMipMapModeTerrainTexture) == 0x4, "Size mismatch!");
