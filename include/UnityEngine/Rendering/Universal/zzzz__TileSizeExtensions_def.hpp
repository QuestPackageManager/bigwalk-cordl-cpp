...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::TileSizeExtensions*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::TileSizeExtensions*, "UnityEngine.Rendering.Universal", "TileSizeExtensions");
...
public:
// Declarations
/// @brief Method IsValid, addr 0x18212ddf0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::TileSizeExtensions) == 0x10, "Size mismatch!");
