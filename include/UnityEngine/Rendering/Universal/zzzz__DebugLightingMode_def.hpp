...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugLightingMode, "UnityEngine.Rendering.Universal", "DebugLightingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
__E_GlobalIllumination = static_cast<int32_t>(0x6),
};
...
/// @brief Field GlobalIllumination value: I32(6)
static ::UnityEngine::Rendering::Universal::DebugLightingMode const GlobalIllumination;

/// @brief Field LightingWithNormalMaps value: I32(3)
static ::UnityEngine::Rendering::Universal::DebugLightingMode const LightingWithNormalMaps;

/// @brief Field LightingWithoutNormalMaps value: I32(2)
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugLightingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugLightingMode) == 0x4, "Size mismatch!");
