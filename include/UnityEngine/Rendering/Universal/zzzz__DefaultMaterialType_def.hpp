...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DefaultMaterialType, "UnityEngine.Rendering.Universal", "DefaultMaterialType");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DefaultMaterialType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DefaultMaterialType) == 0x4, "Size mismatch!");
