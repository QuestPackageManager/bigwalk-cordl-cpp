...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalSurfaceData, "UnityEngine.Rendering.Universal", "DecalSurfaceData");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
/// @brief Field AlbedoNormal value: I32(1)
static ::UnityEngine::Rendering::Universal::DecalSurfaceData const AlbedoNormal;

/// @brief Field AlbedoNormalMAOS value: I32(2)
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalSurfaceData, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalSurfaceData) == 0x4, "Size mismatch!");
