...
/// @brief Method DecodeHeader, addr 0x182136800, size 0x30, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<uint32_t,uint32_t> DecodeHeader(uint32_t  zBin) ;

/// @brief Method EncodeHeader, addr 0x182136830, size 0x10, virtual false, abstract: false, final false
static inline uint32_t EncodeHeader(uint32_t  min, uint32_t  max) ;

/// @brief Method Execute, addr 0x182136840, size 0x140, virtual true, abstract: false, final true
inline void Execute(int32_t  jobIndex) ;

/// @brief Method FillZBins, addr 0x182136980, size 0x310, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "bins", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "minMaxZs", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>", modifiers: "", def_value: None }, CppParam { name: "zBinScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "zBinOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "binCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "wordsPerTile", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lightCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "reflectionProbeCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "batchCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "viewCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "isOrthographic", ty: "bool", modifiers: "", def_value: None }]
constexpr ZBinningJob(::Unity::Collections::NativeArray_1<uint32_t>  bins, ::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>  minMaxZs, float_t  zBinScale, float_t  zBinOffset, int32_t  binCount, int32_t  wordsPerTile, int32_t  lightCount, int32_t  reflectionProbeCount, int32_t  batchCount, int32_t  viewCount, bool  isOrthographic) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ZBinningJob) == 0x48, "Size mismatch!");
