...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalResource, "UnityEngine.Rendering.Universal", "UniversalResource");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalResource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalResource) == 0x4, "Size mismatch!");
