...
/// @brief Method .ctor, addr 0x182148890, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::VolumeRequiresRendererFeatures) == 0x18, "Size mismatch!");
