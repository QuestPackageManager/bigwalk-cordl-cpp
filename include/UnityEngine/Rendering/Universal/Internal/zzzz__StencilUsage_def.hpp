...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::StencilUsage, "UnityEngine.Rendering.Universal.Internal", "StencilUsage");
// Dependencies 
namespace UnityEngine::Rendering::Universal::Internal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::Internal::StencilUsage, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::StencilUsage) == 0x4, "Size mismatch!");
