...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::RenderTargetBufferSystem_SwapBuffer, "UnityEngine.Rendering.Universal.Internal", "RenderTargetBufferSystem/SwapBuffer");
// Dependencies 
namespace UnityEngine::Rendering::Universal::Internal {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "rtMSAA", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: None }, CppParam { name: "rtResolve", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: None }, CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "msaa", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::RenderTargetBufferSystem_SwapBuffer) == 0x20, "Size mismatch!");
...
/// @brief Method Clear, addr 0x18215fdf0, size 0x30, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x18215fe20, size 0x60, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method EnableMSAA, addr 0x18215fe80, size 0x30, virtual false, abstract: false, final false
inline void EnableMSAA(bool  enable) ;

/// @brief Method GetBackBuffer, addr 0x18215feb0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetBackBuffer(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method GetBufferA, addr 0x18215ff30, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetBufferA() ;

/// @brief Method GetFrontBuffer, addr 0x18215ff50, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method PeekBackBuffer, addr 0x182160010, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* PeekBackBuffer() ;

/// @brief Method ReAllocate, addr 0x182160080, size 0x1f0, virtual false, abstract: false, final false
inline void ReAllocate(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method SetCameraSettings, addr 0x182160270, size 0xb0, virtual false, abstract: false, final false
inline void SetCameraSettings(::UnityEngine::RenderTextureDescriptor  desc, ::UnityEngine::FilterMode  filterMode) ;

/// @brief Method Swap, addr 0x182160320, size 0x20, virtual false, abstract: false, final false
inline void Swap() ;
...
/// @brief Method .ctor, addr 0x182160360, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_backBuffer, addr 0x1821603d0, size 0x20, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::Universal::Internal::RenderTargetBufferSystem_SwapBuffer> get_backBuffer() ;

/// @brief Method get_frontBuffer, addr 0x1821603f0, size 0x20, virtual false, abstract: false, final false
