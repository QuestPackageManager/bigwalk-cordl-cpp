...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::Internal::DeferredConfig*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::DeferredConfig*, "UnityEngine.Rendering.Universal.Internal", "DeferredConfig");
...
/// @brief Method get_IsDX10, addr 0x1821376d0, size 0x20, virtual false, abstract: false, final false
static inline bool get_IsDX10() ;

/// @brief Method get_IsOpenGL, addr 0x1821376f0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_IsDX10, addr 0x182137710, size 0x20, virtual false, abstract: false, final false
static inline void set_IsDX10(bool  value) ;

/// @brief Method set_IsOpenGL, addr 0x182137730, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::DeferredConfig) == 0x10, "Size mismatch!");
