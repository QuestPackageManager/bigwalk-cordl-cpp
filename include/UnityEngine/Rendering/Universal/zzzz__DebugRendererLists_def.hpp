...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugRendererLists*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugRendererLists*, "UnityEngine.Rendering.Universal", "DebugRendererLists");
...
/// @brief Field m_ActiveDebugRendererList, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ActiveDebugRendererList, put=__cordl_internal_set_m_ActiveDebugRendererList)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::RendererList>*  m_ActiveDebugRendererList;

/// @brief Field m_ActiveDebugRendererListHdl, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ActiveDebugRendererListHdl, put=__cordl_internal_set_m_ActiveDebugRendererListHdl)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*  m_ActiveDebugRendererListHdl;
...
/// @brief Field m_DebugRenderSetups, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DebugRenderSetups, put=__cordl_internal_set_m_DebugRenderSetups)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DebugRenderSetup*>*  m_DebugRenderSetups;
...
/// @brief Method CreateDebugRenderSetups, addr 0x1820bfd50, size 0x120, virtual false, abstract: false, final false
inline void CreateDebugRenderSetups(::UnityEngine::Rendering::FilteringSettings  filteringSettings) ;

/// @brief Method CreateRendererListsWithDebugRenderState, addr 0x1820c0280, size 0x430, virtual false, abstract: false, final false
inline void CreateRendererListsWithDebugRenderState(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::by_ref<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::by_ref<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::by_ref<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock) ;

/// @brief Method CreateRendererListsWithDebugRenderState, addr 0x1820bfe70, size 0x410, virtual false, abstract: false, final false
inline void CreateRendererListsWithDebugRenderState(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::by_ref<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::by_ref<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::by_ref<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock) ;

/// @brief Method DisposeDebugRenderLists, addr 0x1820c06b0, size 0xa0, virtual false, abstract: false, final false
inline void DisposeDebugRenderLists() ;

/// @brief Method DrawWithRendererList, addr 0x1820c0750, size 0x1d0, virtual false, abstract: false, final false
inline void DrawWithRendererList(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

static inline ::UnityEngine::Rendering::Universal::DebugRendererLists* New_ctor(::UnityEngine::Rendering::Universal::DebugHandler*  debugHandler, ::UnityEngine::Rendering::FilteringSettings  filteringSettings) ;

/// @brief Method PrepareRendererListForRasterPass, addr 0x1820c0920, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820c0a40, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugRendererLists) == 0x50, "Size mismatch!");
