...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugValidationMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugValidationMode) == 0x4, "Size mismatch!");
