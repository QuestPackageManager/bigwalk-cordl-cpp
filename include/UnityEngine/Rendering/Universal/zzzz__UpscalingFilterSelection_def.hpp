...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UpscalingFilterSelection, "UnityEngine.Rendering.Universal", "UpscalingFilterSelection");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::UpscalingFilterSelection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::UpscalingFilterSelection) == 0x4, "Size mismatch!");
