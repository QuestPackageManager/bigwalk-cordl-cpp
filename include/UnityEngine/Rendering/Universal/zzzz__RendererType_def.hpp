...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RendererType, "UnityEngine.Rendering.Universal", "RendererType");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RendererType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RendererType) == 0x4, "Size mismatch!");
