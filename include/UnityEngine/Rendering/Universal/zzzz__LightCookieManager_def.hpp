...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieShaderFormat, "UnityEngine.Rendering.Universal", "LightCookieManager/LightCookieShaderFormat");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping, "UnityEngine.Rendering.Universal", "LightCookieManager/LightCookieMapping");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::LightCookieManager_Settings, "UnityEngine.Rendering.Universal", "LightCookieManager/Settings");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1, "UnityEngine.Rendering.Universal", "LightCookieManager/WorkSlice`1");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Settings_LightCookieManager_AtlasSettings, "UnityEngine.Rendering.Universal", "LightCookieManager/Settings/AtlasSettings");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieShaderFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieShaderFormat) == 0x4, "Size mismatch!");
...
/// @brief Method get_isPow2, addr 0x1820f5530, size 0x30, virtual false, abstract: false, final false
inline bool get_isPow2() ;

/// @brief Method get_isSquare, addr 0x1820f5560, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "resolution", ty: "::UnityEngine::Vector2Int", modifiers: "", def_value: None }, CppParam { name: "format", ty: "::UnityEngine::Experimental::Rendering::GraphicsFormat", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Settings_LightCookieManager_AtlasSettings) == 0xc, "Size mismatch!");
...
/// @brief Method Create, addr 0x18210b760, size 0xc0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "atlas", ty: "::UnityEngine::Rendering::Universal::Settings_LightCookieManager_AtlasSettings", modifiers: "", def_value: None }, CppParam { name: "maxAdditionalLights", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cubeOctahedralSizeScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "useStructuredBuffer", ty: "bool", modifiers: "", def_value: None }]
constexpr LightCookieManager_Settings(::UnityEngine::Rendering::Universal::Settings_LightCookieManager_AtlasSettings  atlas, int32_t  maxAdditionalLights, float_t  cubeOctahedralSizeScale, bool  useStructuredBuffer) noexcept;
...
/// @brief Method <.cctor>b__6_0, addr 0x18210d840, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method <.cctor>b__6_1, addr 0x18210d910, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field s_CompareByBufferIndex, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_CompareByBufferIndex, put=setStaticF_s_CompareByBufferIndex)) ::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>*  s_CompareByBufferIndex;

/// @brief Field s_CompareByCookieSize, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_CompareByCookieSize, put=setStaticF_s_CompareByCookieSize)) ::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>*  s_CompareByCookieSize;

static inline ::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>* getStaticF_s_CompareByBufferIndex() ;

static inline ::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>* getStaticF_s_CompareByCookieSize() ;

static inline void setStaticF_s_CompareByBufferIndex(::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>*  value) ;

static inline void setStaticF_s_CompareByCookieSize(::System::Func_3<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,int32_t>*  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr LightCookieManager_LightCookieMapping() ;

// Ctor Parameters [CppParam { name: "visibleLightIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "lightBufferIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "light", ty: "::UnityW<::UnityEngine::Light>", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "m_Data", ty: "::ArrayW<T>", modifiers: "", def_value: None }, CppParam { name: "m_Start", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field lightMappings, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightMappings, put=__cordl_internal_set_lightMappings)) ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>  lightMappings;
...
/// @brief Method Resize, addr 0x18210dd90, size 0xb0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>& __cordl_internal_get_lightMappings() ;
...
constexpr void __cordl_internal_set_lightMappings(::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>  value) ;
...
/// @brief Method Clear, addr 0x1820fcae0, size 0x50, virtual false, abstract: false, final false
inline void Clear(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method Dispose, addr 0x1820fcb30, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method Resize, addr 0x1820fcb80, size 0x1a0, virtual false, abstract: false, final false
inline void Resize(int32_t  size) ;

/// @brief Method Upload, addr 0x1820fcd20, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820fce60, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  size, bool  useStructuredBuffer) ;

/// @brief Method get_atlasUVRects, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector4> get_atlasUVRects() ;

/// @brief Method get_cookieEnableBits, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::ShaderBitArray get_cookieEnableBits() ;

/// @brief Method get_isUploaded, addr 0x1802f8060, size 0x10, virtual false, abstract: false, final false
inline bool get_isUploaded() ;

/// @brief Method get_lightTypes, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<float_t> get_lightTypes() ;

/// @brief Method get_worldToLights, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_worldToLights() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_isUploaded, addr 0x1802f8090, size 0x10, virtual false, abstract: false, final false
...
template<typename T>
using WorkSlice_1 = ::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<T>;
...
/// @brief Method AdjustUVRect, addr 0x1820fa280, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method ApproximateCookieSizeDivisor, addr 0x1820fa360, size 0x40, virtual false, abstract: false, final false
inline int32_t ApproximateCookieSizeDivisor(float_t  requestAtlasRatio) ;

/// @brief Method ComputeCookieRequestPixelCount, addr 0x1820fa3a0, size 0xc0, virtual false, abstract: false, final false
inline uint32_t ComputeCookieRequestPixelCount(::by_ref<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings) ;

/// @brief Method ComputeOctahedralCookieSize, addr 0x1820fa460, size 0xe0, virtual false, abstract: false, final false
inline int32_t ComputeOctahedralCookieSize(::UnityEngine::Texture*  cookie) ;

/// @brief Method Dispose, addr 0x1820fa540, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Fetch2D, addr 0x1820fa5b0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method FetchCube, addr 0x1820fa700, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method FetchUVRects, addr 0x1820fa8b0, size 0x220, virtual false, abstract: false, final false
inline int32_t FetchUVRects(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::ArrayW<::UnityEngine::Vector4>  textureAtlasUVRects, int32_t  cookieSizeDivisor) ;

/// @brief Method FilterAndValidateAdditionalLights, addr 0x1820faad0, size 0x310, virtual false, abstract: false, final false
inline int32_t FilterAndValidateAdditionalLights(::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>  validLightMappings) ;

/// @brief Method GetLightCookieShaderDataIndex, addr 0x1820fade0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetLightCookieShaderDataIndex(int32_t  visibleLightIndex) ;

/// @brief Method GetLightCookieShaderFormat, addr 0x1820fae00, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetLightUVScaleOffset, addr 0x1820fae80, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method InitAdditionalLights, addr 0x1820fb0b0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x1820fba10, size 0x1d0, virtual false, abstract: false, final false
inline void Setup(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method SetupAdditionalLights, addr 0x1820fb1b0, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method SetupMainLight, addr 0x1820fb430, size 0x5e0, virtual false, abstract: false, final false
...
/// @brief Method ShrinkUVRect, addr 0x1820fbbe0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method UpdateAdditionalLightsAtlas, addr 0x1820fbc50, size 0x1c0, virtual false, abstract: false, final false
inline int32_t UpdateAdditionalLightsAtlas(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::ArrayW<::UnityEngine::Vector4>  textureAtlasUVRects) ;

/// @brief Method UploadAdditionalLights, addr 0x1820fbe10, size 0xad0, virtual false, abstract: false, final false
inline void UploadAdditionalLights(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::by_ref<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::by_ref<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Vector4>>  validUvRects) ;
...
/// @brief Method .ctor, addr 0x1820fc960, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_AdditionalLightsCookieAtlasTexture, addr 0x1820fc9b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_AdditionalLightsCookieAtlasTexture() ;

/// @brief Method get_IsKeywordLightCookieEnabled, addr 0x1813ef470, size 0x10, virtual false, abstract: false, final false
inline bool get_IsKeywordLightCookieEnabled() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method isInitialized, addr 0x1819fe570, size 0x20, virtual false, abstract: false, final false
inline bool isInitialized() ;

static inline void setStaticF_s_DirLightProj(::UnityEngine::Matrix4x4  value) ;

/// @brief Method set_IsKeywordLightCookieEnabled, addr 0x1813ec680, size 0x10, virtual false, abstract: false, final false
