...
/// @brief Method .ctor, addr 0x1820fce70, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::MotionBlur) == 0x58, "Size mismatch!");
