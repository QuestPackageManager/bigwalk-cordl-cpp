...
/// @brief Method IsActive, addr 0x18210dc60, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18210dcd0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::WhiteBalance) == 0x48, "Size mismatch!");
