...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::NeutralRangeReductionMode, "UnityEngine.Rendering.Universal", "NeutralRangeReductionMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::NeutralRangeReductionMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::NeutralRangeReductionMode) == 0x4, "Size mismatch!");
