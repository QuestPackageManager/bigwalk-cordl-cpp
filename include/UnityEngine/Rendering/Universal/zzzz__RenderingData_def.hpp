...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderingData, "UnityEngine.Rendering.Universal", "RenderingData");
...
/// @brief Method .ctor, addr 0x18213eac0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ContextContainer*  frameData) ;

/// @brief Method get_cullResults, addr 0x18213eb90, size 0x30, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::CullingResults> get_cullResults() ;

/// @brief Method get_perObjectData, addr 0x18213ebc0, size 0x30, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::PerObjectData> get_perObjectData() ;

/// @brief Method get_postProcessingEnabled, addr 0x18213ebf0, size 0x30, virtual false, abstract: false, final false
inline ::by_ref<bool> get_postProcessingEnabled() ;

/// @brief Method get_supportsDynamicBatching, addr 0x18213ec20, size 0x30, virtual false, abstract: false, final false
inline ::by_ref<bool> get_supportsDynamicBatching() ;

/// @brief Method get_universalRenderingData, addr 0x18213ec50, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderingData) == 0x28, "Size mismatch!");
