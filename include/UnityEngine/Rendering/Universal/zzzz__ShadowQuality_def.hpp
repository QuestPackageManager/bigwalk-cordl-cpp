...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShadowQuality, "UnityEngine.Rendering.Universal", "ShadowQuality");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ShadowQuality, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ShadowQuality) == 0x4, "Size mismatch!");
