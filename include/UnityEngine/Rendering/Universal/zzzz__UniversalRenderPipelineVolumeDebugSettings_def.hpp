...
/// @brief Method .ctor, addr 0x1820de9a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_selectedCameraLayerMask, addr 0x1820de9b0, size 0x80, virtual true, abstract: false, final false
inline ::UnityEngine::LayerMask get_selectedCameraLayerMask() ;

/// @brief Method get_selectedCameraPosition, addr 0x1820dea30, size 0x80, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 get_selectedCameraPosition() ;

/// @brief Method get_selectedCameraVolumeStack, addr 0x1820deab0, size 0x80, virtual true, abstract: false, final false
inline ::UnityEngine::Rendering::VolumeStack* get_selectedCameraVolumeStack() ;

/// @brief Method get_targetRenderPipeline, addr 0x1820deb30, size 0x10, virtual true, abstract: false, final false
