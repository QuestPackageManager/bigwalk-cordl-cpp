...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::MotionVectorsPersistentData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::MotionVectorsPersistentData*, "UnityEngine.Rendering.Universal", "MotionVectorsPersistentData");
// Dependencies System.Object, UnityEngine.Matrix4x4, UnityEngine.Vector3
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Field m_PreviousPreviousProjection, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PreviousPreviousProjection, put=__cordl_internal_set_m_PreviousPreviousProjection)) ::ArrayW<::UnityEngine::Matrix4x4>  m_PreviousPreviousProjection;
...
/// @brief Field m_worldSpaceCameraPos, offset 0x78, size 0xc 
 ...
 __declspec(property(get=get_previousPreviousViewStereo)) ::ArrayW<::UnityEngine::Matrix4x4>  previousPreviousViewStereo;

 __declspec(property(get=get_previousPreviousWorldSpaceCameraPos)) ::UnityEngine::Vector3  previousPreviousWorldSpaceCameraPos;

 __declspec(property(get=get_previousProjectionStereo)) ::ArrayW<::UnityEngine::Matrix4x4>  previousProjectionStereo;

 __declspec(property(get=get_previousViewProjection)) ::UnityEngine::Matrix4x4  previousViewProjection;

 __declspec(property(get=get_previousViewProjectionStereo)) ::ArrayW<::UnityEngine::Matrix4x4>  previousViewProjectionStereo;

 __declspec(property(get=get_previousViewStereo)) ::ArrayW<::UnityEngine::Matrix4x4>  previousViewStereo;
 ...
 __declspec(property(get=get_viewStereo)) ::ArrayW<::UnityEngine::Matrix4x4>  viewStereo;

 __declspec(property(get=get_worldSpaceCameraPos)) ::UnityEngine::Vector3  worldSpaceCameraPos;

/// @brief Method GetXRMultiPassId, addr 0x1820fe410, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x1820fe440, size 0x3c0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetGlobalMotionMatrices, addr 0x1820fe800, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x1820fea00, size 0x6a0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_LastFrameIndex() ;

constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_PrevAspectRatio() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_PrevAspectRatio() ;

constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_PreviousPreviousProjection() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_PreviousPreviousProjection() ;

constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_PreviousPreviousView() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_PreviousPreviousView() ;

constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_PreviousProjection() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_PreviousProjection() ;

constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_PreviousView() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_PreviousView() ;
...
constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_Projection() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_Projection() ;

constexpr ::ArrayW<::UnityEngine::Matrix4x4> const& __cordl_internal_get_m_View() const;

constexpr ::ArrayW<::UnityEngine::Matrix4x4>& __cordl_internal_get_m_View() ;
...
constexpr void __cordl_internal_set_m_LastFrameIndex(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_PrevAspectRatio(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set_m_PreviousPreviousProjection(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_PreviousPreviousView(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_PreviousProjection(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_PreviousView(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_PreviousViewProjection(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_Projection(::ArrayW<::UnityEngine::Matrix4x4>  value) ;

constexpr void __cordl_internal_set_m_View(::ArrayW<::UnityEngine::Matrix4x4>  value) ;
...
/// @brief Method .ctor, addr 0x1820ff0a0, size 0x190, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_deltaTime, addr 0x1802e58b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_deltaTime() ;

/// @brief Method get_lastDeltaTime, addr 0x180474bc0, size 0x10, virtual false, abstract: false, final false
inline float_t get_lastDeltaTime() ;

/// @brief Method get_lastFrameIndex, addr 0x1820ff230, size 0x10, virtual false, abstract: false, final false
inline int32_t get_lastFrameIndex() ;

/// @brief Method get_previousPreviousProjectionStereo, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_previousPreviousProjectionStereo() ;

/// @brief Method get_previousPreviousViewStereo, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_previousPreviousViewStereo() ;

/// @brief Method get_previousPreviousWorldSpaceCameraPos, addr 0x1820ff240, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_previousPreviousWorldSpaceCameraPos() ;

/// @brief Method get_previousProjectionStereo, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_previousProjectionStereo() ;

/// @brief Method get_previousViewProjection, addr 0x1820ff260, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_previousViewProjection() ;

/// @brief Method get_previousViewProjectionStereo, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_previousViewProjectionStereo() ;

/// @brief Method get_previousViewStereo, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_previousViewStereo() ;

/// @brief Method get_previousWorldSpaceCameraPos, addr 0x1820ff290, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_previousWorldSpaceCameraPos() ;

/// @brief Method get_projectionStereo, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_projectionStereo() ;

/// @brief Method get_stagingMatrixStereo, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_stagingMatrixStereo() ;

/// @brief Method get_viewProjection, addr 0x1820ff2b0, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_viewProjection() ;

/// @brief Method get_viewProjectionStereo, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_viewProjectionStereo() ;

/// @brief Method get_viewStereo, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4> get_viewStereo() ;

/// @brief Method get_worldSpaceCameraPos, addr 0x1820ff2e0, size 0x20, virtual false, abstract: false, final false
