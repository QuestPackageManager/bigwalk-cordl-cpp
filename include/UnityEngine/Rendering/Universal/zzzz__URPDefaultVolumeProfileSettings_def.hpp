...
static_assert(offsetof(::UnityEngine::Rendering::Universal::URPDefaultVolumeProfileSettings_Version, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method get_volumeProfile, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_volumeProfile, addr 0x182134f60, size 0x30, virtual true, abstract: false, final true
