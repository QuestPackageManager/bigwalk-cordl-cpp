...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalCulledChunk*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalCulledChunk*, "UnityEngine.Rendering.Universal", "DecalCulledChunk");
...
/// @brief Field visibleDecalIndexArray, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_visibleDecalIndexArray, put=__cordl_internal_set_visibleDecalIndexArray)) ::ArrayW<int32_t>  visibleDecalIndexArray;
...
/// @brief Method Dispose, addr 0x1820cf610, size 0x60, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalCulledChunk* New_ctor() ;

/// @brief Method RemoveAtSwapBack, addr 0x1820cf670, size 0x60, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x1820cf6d0, size 0x80, virtual true, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_visibleDecalIndexArray() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_visibleDecalIndexArray() ;
...
constexpr void __cordl_internal_set_visibleDecalIndexArray(::ArrayW<int32_t>  value) ;
...
/// @brief Field visibleDecalIndexArray, offset: 0x50, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___visibleDecalIndexArray;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalCulledChunk) == 0x70, "Size mismatch!");
