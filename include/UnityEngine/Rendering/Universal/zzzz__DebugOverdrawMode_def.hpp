...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugOverdrawMode, "UnityEngine.Rendering.Universal", "DebugOverdrawMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugOverdrawMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugOverdrawMode) == 0x4, "Size mismatch!");
