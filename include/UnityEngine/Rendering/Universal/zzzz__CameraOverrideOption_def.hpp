...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CameraOverrideOption, "UnityEngine.Rendering.Universal", "CameraOverrideOption");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::CameraOverrideOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::CameraOverrideOption) == 0x4, "Size mismatch!");
