...
/// @brief Field <sharedDecalEntityManager>k__BackingField, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__sharedDecalEntityManager_k__BackingField, put=setStaticF__sharedDecalEntityManager_k__BackingField)) ::UnityEngine::Rendering::Universal::SharedDecalEntityManager*  _sharedDecalEntityManager_k__BackingField;
...
/// @brief Field m_DecalCreateDrawCallSystem, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalCreateDrawCallSystem, put=__cordl_internal_set_m_DecalCreateDrawCallSystem)) ::UnityEngine::Rendering::Universal::DecalCreateDrawCallSystem*  m_DecalCreateDrawCallSystem;

/// @brief Field m_DecalDrawDBufferSystem, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalDrawDBufferSystem, put=__cordl_internal_set_m_DecalDrawDBufferSystem)) ::UnityEngine::Rendering::Universal::DecalDrawDBufferSystem*  m_DecalDrawDBufferSystem;

/// @brief Field m_DecalDrawForwardEmissiveSystem, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalDrawForwardEmissiveSystem, put=__cordl_internal_set_m_DecalDrawForwardEmissiveSystem)) ::UnityEngine::Rendering::Universal::DecalDrawFowardEmissiveSystem*  m_DecalDrawForwardEmissiveSystem;

/// @brief Field m_DecalDrawScreenSpaceSystem, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalDrawScreenSpaceSystem, put=__cordl_internal_set_m_DecalDrawScreenSpaceSystem)) ::UnityEngine::Rendering::Universal::DecalDrawScreenSpaceSystem*  m_DecalDrawScreenSpaceSystem;
...
/// @brief Field m_DecalSkipCulledSystem, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalSkipCulledSystem, put=__cordl_internal_set_m_DecalSkipCulledSystem)) ::UnityEngine::Rendering::Universal::DecalSkipCulledSystem*  m_DecalSkipCulledSystem;

/// @brief Field m_DecalUpdateCachedSystem, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalUpdateCachedSystem, put=__cordl_internal_set_m_DecalUpdateCachedSystem)) ::UnityEngine::Rendering::Universal::DecalUpdateCachedSystem*  m_DecalUpdateCachedSystem;

/// @brief Field m_DecalUpdateCulledSystem, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalUpdateCulledSystem, put=__cordl_internal_set_m_DecalUpdateCulledSystem)) ::UnityEngine::Rendering::Universal::DecalUpdateCulledSystem*  m_DecalUpdateCulledSystem;

/// @brief Field m_DecalUpdateCullingGroupSystem, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DecalUpdateCullingGroupSystem, put=__cordl_internal_set_m_DecalUpdateCullingGroupSystem)) ::UnityEngine::Rendering::Universal::DecalUpdateCullingGroupSystem*  m_DecalUpdateCullingGroupSystem;
...
/// @brief Field m_ForwardEmissivePass, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ForwardEmissivePass, put=__cordl_internal_set_m_ForwardEmissivePass)) ::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*  m_ForwardEmissivePass;
...
/// @brief Field m_ScreenSpaceDecalRenderPass, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScreenSpaceDecalRenderPass, put=__cordl_internal_set_m_ScreenSpaceDecalRenderPass)) ::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass*  m_ScreenSpaceDecalRenderPass;

/// @brief Field m_ScreenSpaceSettings, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScreenSpaceSettings, put=__cordl_internal_set_m_ScreenSpaceSettings)) ::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings*  m_ScreenSpaceSettings;
...
/// @brief Method AddRenderPasses, addr 0x1820e1030, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method ChangeAdaptivePerformanceDrawDistances, addr 0x1820e11f0, size 0x70, virtual false, abstract: false, final false
inline void ChangeAdaptivePerformanceDrawDistances() ;

/// @brief Method Create, addr 0x1820e1260, size 0x50, virtual true, abstract: false, final false
inline void Create() ;

/// @brief Method Dispose, addr 0x1820e12b0, size 0x90, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetDBufferSettings, addr 0x1820e1340, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DBufferSettings* GetDBufferSettings() ;

/// @brief Method GetScreenSpaceSettings, addr 0x1820e1390, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings* GetScreenSpaceSettings() ;

/// @brief Method GetTechnique, addr 0x1820e13c0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetTechnique, addr 0x1820e14e0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetTechnique, addr 0x1820e1580, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method IsAutomaticDBuffer, addr 0x1820e1640, size 0x30, virtual false, abstract: false, final false
inline bool IsAutomaticDBuffer() ;

static inline ::UnityEngine::Rendering::Universal::DecalRendererFeature* New_ctor() ;

/// @brief Method OnCameraPreCull, addr 0x1820e1670, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method RecreateSystemsIfNeeded, addr 0x1820e1790, size 0x610, virtual false, abstract: false, final false
...
/// @brief Method RequireRenderingLayers, addr 0x1820e1da0, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820e1e60, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_intermediateRendering, addr 0x181939b90, size 0x10, virtual false, abstract: false, final false
inline bool get_intermediateRendering() ;

/// @brief Method get_isGLDevice, addr 0x1820e1eb0, size 0x30, virtual false, abstract: false, final false
static inline bool get_isGLDevice() ;

/// @brief Method get_requiresDecalLayers, addr 0x181fc26d0, size 0x10, virtual false, abstract: false, final false
inline bool get_requiresDecalLayers() ;

/// @brief Method get_settings, addr 0x1802f4a50, size 0x10, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::Universal::DecalSettings*> get_settings() ;

/// @brief Method get_sharedDecalEntityManager, addr 0x1820dfae0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalRendererFeature) == 0xe0, "Size mismatch!");
