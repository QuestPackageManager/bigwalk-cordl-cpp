...
/// @brief Field UsePipelineSettings value: I32(1)
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RendererOverrideOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RendererOverrideOption) == 0x4, "Size mismatch!");
