...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::LightCookieFormat, "UnityEngine.Rendering.Universal", "LightCookieFormat");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::LightCookieFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::LightCookieFormat) == 0x4, "Size mismatch!");
