...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::MsaaQuality, "UnityEngine.Rendering.Universal", "MsaaQuality");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::MsaaQuality, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::MsaaQuality) == 0x4, "Size mismatch!");
