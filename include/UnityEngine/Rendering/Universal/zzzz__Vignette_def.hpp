...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::Vignette*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Vignette*, "UnityEngine.Rendering.Universal", "Vignette");
...
/// @brief Method IsActive, addr 0x1820cc600, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18210dae0, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Vignette) == 0x60, "Size mismatch!");
