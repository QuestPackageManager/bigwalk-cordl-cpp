...
/// @brief Method Reset, addr 0x1820de170, size 0x220, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method UpdateDisplayStats, addr 0x1820de390, size 0x30, virtual false, abstract: false, final false
inline void UpdateDisplayStats() ;

/// @brief Method UpdateMaterials, addr 0x1820de3c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820de420, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsPostProcessingAllowed, addr 0x1820de430, size 0x1a0, virtual true, abstract: false, final false
inline bool get_IsPostProcessingAllowed() ;

/// @brief Method get_commonSettings, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon* get_commonSettings() ;

/// @brief Method get_displayStats, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplaySettingsStats_1<::UnityEngine::Rendering::Universal::URPProfileId>* get_displayStats() ;

/// @brief Method get_gpuResidentDrawerSettings, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer* get_gpuResidentDrawerSettings() ;

/// @brief Method get_lightingSettings, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_lightingSettings() ;

/// @brief Method get_materialSettings, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_materialSettings() ;

/// @brief Method get_renderingSettings, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* get_renderingSettings() ;

/// @brief Method get_volumeSettings, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplaySettingsVolume* get_volumeSettings() ;

/// @brief Method set_commonSettings, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_commonSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon*  value) ;

/// @brief Method set_displayStats, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_gpuResidentDrawerSettings, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_gpuResidentDrawerSettings(::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  value) ;

/// @brief Method set_lightingSettings, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_lightingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting*  value) ;

/// @brief Method set_materialSettings, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_materialSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial*  value) ;

/// @brief Method set_renderingSettings, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_renderingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering*  value) ;

/// @brief Method set_volumeSettings, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
