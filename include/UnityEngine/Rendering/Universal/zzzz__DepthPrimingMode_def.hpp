...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DepthPrimingMode, "UnityEngine.Rendering.Universal", "DepthPrimingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
/// @brief Field Forced value: I32(2)
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DepthPrimingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DepthPrimingMode) == 0x4, "Size mismatch!");
