...
/// @brief Method IsActive, addr 0x1820f9f00, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1820f9fa0, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;
