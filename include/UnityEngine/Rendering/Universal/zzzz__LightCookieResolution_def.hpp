...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::LightCookieResolution, "UnityEngine.Rendering.Universal", "LightCookieResolution");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::LightCookieResolution, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::LightCookieResolution) == 0x4, "Size mismatch!");
