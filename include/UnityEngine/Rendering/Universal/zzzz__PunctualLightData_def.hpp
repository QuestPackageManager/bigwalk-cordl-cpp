...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::PunctualLightData, "UnityEngine.Rendering.Universal", "PunctualLightData");
...
// Ctor Parameters [CppParam { name: "wsPos", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "attenuation", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "spotDirection", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "occlusionProbeInfo", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "layerMask", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr PunctualLightData(::UnityEngine::Vector3  wsPos, float_t  radius, ::UnityEngine::Vector4  color, ::UnityEngine::Vector4  attenuation, ::UnityEngine::Vector3  spotDirection, int32_t  flags, ::UnityEngine::Vector4  occlusionProbeInfo, uint32_t  layerMask) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::PunctualLightData) == 0x54, "Size mismatch!");
