...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::HDRACESPreset, "UnityEngine.Rendering.Universal", "HDRACESPreset");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::HDRACESPreset, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::HDRACESPreset) == 0x4, "Size mismatch!");
