...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalShaderPassNames*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalShaderPassNames*, "UnityEngine.Rendering.Universal", "DecalShaderPassNames");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalShaderPassNames) == 0x10, "Size mismatch!");
