...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__dataIndices_e__FixedBuffer, "UnityEngine.Rendering.Universal", "ReflectionProbeManager/CachedProbe/<dataIndices>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__levels_e__FixedBuffer, "UnityEngine.Rendering.Universal", "ReflectionProbeManager/CachedProbe/<levels>e__FixedBuffer");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ReflectionProbeManager_CachedProbe, "UnityEngine.Rendering.Universal", "ReflectionProbeManager/CachedProbe");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__dataIndices_e__FixedBuffer) == 0x1c, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__levels_e__FixedBuffer) == 0x1c, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "updateCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "imageContentsHash", ty: "::UnityEngine::Hash128", modifiers: "", def_value: None }, CppParam { name: "size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "mipCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "dataIndices", ty: "::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__dataIndices_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "levels", ty: "::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__levels_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "texture", ty: "::UnityW<::UnityEngine::Texture>", modifiers: "", def_value: None }, CppParam { name: "lastUsed", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "hdrData", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }]
constexpr ReflectionProbeManager_CachedProbe(uint32_t  updateCount, ::UnityEngine::Hash128  imageContentsHash, int32_t  size, int32_t  mipCount, ::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__dataIndices_e__FixedBuffer  dataIndices, ::UnityEngine::Rendering::Universal::CachedProbe_ReflectionProbeManager__levels_e__FixedBuffer  levels, ::UnityW<::UnityEngine::Texture>  texture, int32_t  lastUsed, ::UnityEngine::Vector4  hdrData) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ReflectionProbeManager_CachedProbe) == 0x78, "Size mismatch!");
...
/// @brief Method Create, addr 0x1821115a0, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::Universal::ReflectionProbeManager Create() ;

/// @brief Method Dispose, addr 0x1821115f0, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetScaleOffset, addr 0x182111680, size 0x190, virtual false, abstract: false, final false
inline ::Unity::Mathematics::float4 GetScaleOffset(int32_t  level, int32_t  dataIndex, bool  includePadding, bool  yflip) ;

/// @brief Method Init, addr 0x182111810, size 0x420, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method UpdateGpuData, addr 0x182111c30, size 0x1810, virtual false, abstract: false, final false
...
/// @brief Method get_atlasRT, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_atlasRT() ;

/// @brief Method get_atlasRTHandle, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Resolution", ty: "::Unity::Mathematics::int2", modifiers: "", def_value: None }, CppParam { name: "m_AtlasTexture0", ty: "::UnityW<::UnityEngine::RenderTexture>", modifiers: "", def_value: None }, CppParam { name: "m_AtlasTexture1", ty: "::UnityW<::UnityEngine::RenderTexture>", modifiers: "", def_value: None }, CppParam { name: "m_AtlasTexture0Handle", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: None }, CppParam { name: "m_AtlasAllocator", ty: "::UnityEngine::Rendering::Universal::BuddyAllocator", modifiers: "", def_value: None }, CppParam { name: "m_Cache", ty: "::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::Rendering::Universal::ReflectionProbeManager_CachedProbe>*", modifiers: "", def_value: None }, CppParam { name: "m_WarningCache", ty: "::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_NeedsUpdate", ty: "::System::Collections::Generic::List_1<int32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_NeedsRemove", ty: "::System::Collections::Generic::List_1<int32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_BoxMax", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_BoxMin", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_ProbePosition", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_MipScaleOffset", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "m_Rotations", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }]
