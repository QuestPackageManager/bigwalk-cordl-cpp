...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings*, "UnityEngine.Rendering.Universal", "DecalScreenSpaceSettings");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings) == 0x18, "Size mismatch!");
