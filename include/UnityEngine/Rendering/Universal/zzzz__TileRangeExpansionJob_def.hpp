...
/// @brief Method Execute, addr 0x18212dc30, size 0x1c0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "tileRanges", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::InclusiveRange>", modifiers: "", def_value: None }, CppParam { name: "tileMasks", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "rangesPerItem", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "itemsPerTile", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "wordsPerTile", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "tileResolution", ty: "::Unity::Mathematics::int2", modifiers: "", def_value: None }]
constexpr TileRangeExpansionJob(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::InclusiveRange>  tileRanges, ::Unity::Collections::NativeArray_1<uint32_t>  tileMasks, int32_t  rangesPerItem, int32_t  itemsPerTile, int32_t  wordsPerTile, ::Unity::Mathematics::int2  tileResolution) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::TileRangeExpansionJob) == 0x38, "Size mismatch!");
