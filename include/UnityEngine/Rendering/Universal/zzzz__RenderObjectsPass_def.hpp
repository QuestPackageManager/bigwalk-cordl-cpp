...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjectsPass*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjectsPass___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjectsPass*, "UnityEngine.Rendering.Universal", "RenderObjectsPass");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*, "UnityEngine.Rendering.Universal", "RenderObjectsPass/PassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjectsPass___c*, "UnityEngine.Rendering.Universal", "RenderObjectsPass/<>c");
// Dependencies System.Object, UnityEngine.Rendering.RenderGraphModule.RendererListHandle, UnityEngine.Rendering.RenderGraphModule.TextureHandle, UnityEngine.Rendering.RendererList, UnityEngine.Rendering.Universal.RenderPassEvent
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Field <>9__33_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__33_0, put=setStaticF___9__33_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__33_0;

static inline ::UnityEngine::Rendering::Universal::RenderObjectsPass___c* New_ctor() ;

/// @brief Method <RecordRenderGraph>b__33_0, addr 0x1820e4aa0, size 0xa0, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__33_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::RenderObjectsPass___c*  value) ;

static inline void setStaticF___9__33_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
/// @brief Field <overrideMaterialPassIndex>k__BackingField, offset 0x90, size 0x4 
 __declspec(property(get=__cordl_internal_get__overrideMaterialPassIndex_k__BackingField, put=__cordl_internal_set__overrideMaterialPassIndex_k__BackingField)) int32_t  _overrideMaterialPassIndex_k__BackingField;
...
/// @brief Field <overrideShaderPassIndex>k__BackingField, offset 0xa0, size 0x4 
 __declspec(property(get=__cordl_internal_get__overrideShaderPassIndex_k__BackingField, put=__cordl_internal_set__overrideShaderPassIndex_k__BackingField)) int32_t  _overrideShaderPassIndex_k__BackingField;

/// @brief Field <overrideShader>k__BackingField, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__overrideShader_k__BackingField, put=__cordl_internal_set__overrideShader_k__BackingField)) ::UnityW<::UnityEngine::Shader>  _overrideShader_k__BackingField;

/// @brief Field m_CameraSettings, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CameraSettings, put=__cordl_internal_set_m_CameraSettings)) ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  m_CameraSettings;
...
/// @brief Method ExecutePass, addr 0x1820e2f30, size 0x4c0, virtual false, abstract: false, final false
static inline void ExecutePass(::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*  passData, ::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::UnityEngine::Rendering::RendererList  rendererList, bool  isYFlipped) ;

/// @brief Method Init, addr 0x1820e3890, size 0x340, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method InitPassData, addr 0x1820e33f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method InitRendererLists, addr 0x1820e3450, size 0x440, virtual false, abstract: false, final false
inline void InitRendererLists(::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::by_ref<::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*>  passData, ::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, bool  useRenderGraph) ;

static inline ::UnityEngine::Rendering::Universal::RenderObjectsPass* New_ctor(::UnityEngine::Rendering::Universal::URPProfileId  profileId, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

static inline ::UnityEngine::Rendering::Universal::RenderObjectsPass* New_ctor(::StringW  profilerTag, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method RecordRenderGraph, addr 0x1820e3bd0, size 0xa30, virtual true, abstract: false, final false
inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::ContextContainer*  frameData) ;

/// @brief Method SetDepthState, addr 0x1820e4600, size 0x90, virtual false, abstract: false, final false
inline void SetDepthState(bool  writeEnabled, ::UnityEngine::Rendering::CompareFunction  function) ;

/// @brief Method SetDetphState, addr 0x1820e4600, size 0x90, virtual false, abstract: false, final false
inline void SetDetphState(bool  writeEnabled, ::UnityEngine::Rendering::CompareFunction  function) ;

/// @brief Method SetStencilState, addr 0x1820e4690, size 0x110, virtual false, abstract: false, final false
inline void SetStencilState(int32_t  reference, ::UnityEngine::Rendering::CompareFunction  compareFunction, ::UnityEngine::Rendering::StencilOp  passOp, ::UnityEngine::Rendering::StencilOp  failOp, ::UnityEngine::Rendering::StencilOp  zFailOp) ;
...
/// @brief Method .ctor, addr 0x1820e47a0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::Universal::URPProfileId  profileId, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method .ctor, addr 0x1820e4870, size 0x150, virtual false, abstract: false, final false
inline void _ctor(::StringW  profilerTag, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method get_overrideMaterial, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_overrideMaterial() ;

/// @brief Method get_overrideMaterialPassIndex, addr 0x1805d4740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_overrideMaterialPassIndex() ;

/// @brief Method get_overrideShader, addr 0x1802ec4d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_overrideShader() ;

/// @brief Method get_overrideShaderPassIndex, addr 0x181c9bb30, size 0x10, virtual false, abstract: false, final false
inline int32_t get_overrideShaderPassIndex() ;

/// @brief Method set_overrideMaterial, addr 0x1803e1880, size 0x20, virtual false, abstract: false, final false
inline void set_overrideMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_overrideMaterialPassIndex, addr 0x180cbfed0, size 0x10, virtual false, abstract: false, final false
inline void set_overrideMaterialPassIndex(int32_t  value) ;

/// @brief Method set_overrideShader, addr 0x1802ec810, size 0x20, virtual false, abstract: false, final false
inline void set_overrideShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_overrideShaderPassIndex, addr 0x181fcacd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Size padding 0x130 - 0x128 = 0x8, packed as 0x8
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderObjectsPass) == 0x130, "Size mismatch!");
