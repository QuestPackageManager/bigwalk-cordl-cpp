...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::UniversalCameraData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalCameraData*, "UnityEngine.Rendering.Universal", "UniversalCameraData");
// Dependencies UnityEngine.CameraType, UnityEngine.Color, UnityEngine.LayerMask, UnityEngine.Matrix4x4, UnityEngine.Rect, UnityEngine.RenderTextureDescriptor, UnityEngine.Rendering.ContextItem, UnityEngine.Rendering.SortingCriteria, UnityEngine.Rendering.Universal.AntialiasingMode, UnityEngine.Rendering.Universal.AntialiasingQuality, UnityEngine.Rendering.Universal.CameraRenderType, UnityEngine.Rendering.Universal.HDRColorBufferPrecision, UnityEngine.Rendering.Universal.ImageScalingMode, UnityEngine.Rendering.Universal.ImageUpscalingFilter, UnityEngine.Rendering.Universal.TemporalAA::Settings, UnityEngine.Vector3, UnityEngine.Vector4
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
public:
// Declarations
/// @brief Field <xr>k__BackingField, offset 0x1a8, size 0x8 
...
/// @brief Field antialiasingQuality, offset 0x1d8, size 0x4 
...
/// @brief Field baseCamera, offset 0x238, size 0x8 
...
/// @brief Field blitsOffscreenUICover, offset 0x19f, size 0x1 
 __declspec(property(get=__cordl_internal_get_blitsOffscreenUICover, put=__cordl_internal_set_blitsOffscreenUICover)) bool  blitsOffscreenUICover;
...
/// @brief Field cameraTargetDescriptor, offset 0x100, size 0x34 
...
/// @brief Field cameraType, offset 0x190, size 0x4 
...
/// @brief Field captureActions, offset 0x1b8, size 0x8 
...
/// @brief Field fsrOverrideSharpness, offset 0x180, size 0x1 
...
/// @brief Field fsrSharpness, offset 0x184, size 0x4 
 __declspec(property(get=__cordl_internal_get_fsrSharpness, put=__cordl_internal_set_fsrSharpness)) float_t  fsrSharpness;

/// @brief Field hdrColorBufferPrecision, offset 0x188, size 0x4 
 __declspec(property(get=__cordl_internal_get_hdrColorBufferPrecision, put=__cordl_internal_set_hdrColorBufferPrecision)) ::UnityEngine::Rendering::Universal::HDRColorBufferPrecision  hdrColorBufferPrecision;
...
/// @brief Field imageScalingMode, offset 0x178, size 0x4 
...
/// @brief Field isAlphaOutputEnabled, offset 0x197, size 0x1 
...
/// @brief Field isDefaultViewport, offset 0x194, size 0x1 
...
/// @brief Field isDitheringEnabled, offset 0x1d1, size 0x1 
...
/// @brief Field isHdrEnabled, offset 0x195, size 0x1 
 __declspec(property(get=__cordl_internal_get_isHdrEnabled, put=__cordl_internal_set_isHdrEnabled)) bool  isHdrEnabled;

/// @brief Field isLastBaseCamera, offset 0x240, size 0x1 
 __declspec(property(get=__cordl_internal_get_isLastBaseCamera, put=__cordl_internal_set_isLastBaseCamera)) bool  isLastBaseCamera;
...
/// @brief Field isStopNaNEnabled, offset 0x1d0, size 0x1 
...
/// @brief Field m_HistoryManager, offset 0xe8, size 0x8 
...
/// @brief Field maxShadowDistance, offset 0x1b0, size 0x4 
...
/// @brief Field postProcessingRequiresDepthTexture, offset 0x19a, size 0x1 
...
/// @brief Field renderer, offset 0x1e0, size 0x8 
...
/// @brief Field rendersOffscreenUI, offset 0x19e, size 0x1 
 __declspec(property(get=__cordl_internal_get_rendersOffscreenUI, put=__cordl_internal_set_rendersOffscreenUI)) bool  rendersOffscreenUI;
...
/// @brief Field requiresDepthTexture, offset 0x198, size 0x1 
...
/// @brief Field requiresOpaqueTexture, offset 0x199, size 0x1 
...
/// @brief Field resolveFinalTarget, offset 0x1e8, size 0x1 
...
/// @brief Field scaledHeight, offset 0xe4, size 0x4 
 __declspec(property(get=__cordl_internal_get_scaledHeight, put=__cordl_internal_set_scaledHeight)) int32_t  scaledHeight;

/// @brief Field scaledWidth, offset 0xe0, size 0x4 
 __declspec(property(get=__cordl_internal_get_scaledWidth, put=__cordl_internal_set_scaledWidth)) int32_t  scaledWidth;

/// @brief Field screenCoordScaleBias, offset 0x158, size 0x10 
...
/// @brief Field screenSizeOverride, offset 0x148, size 0x10 
...
/// @brief Field stackAnyPostProcessingEnabled, offset 0x1b5, size 0x1 
...
/// @brief Field stackLastCameraOutputToHDR, offset 0x19d, size 0x1 
...
/// @brief Field stpHistory, offset 0x210, size 0x8 
...
/// @brief Field taaHistory, offset 0x208, size 0x8 
...
/// @brief Field taaSettings, offset 0x218, size 0x20 
...
/// @brief Field targetTexture, offset 0xf8, size 0x8 
...
/// @brief Field upscalingFilter, offset 0x17c, size 0x4 
...
/// @brief Field useGPUOcclusionCulling, offset 0x19c, size 0x1 
...
/// @brief Field useScreenCoordOverride, offset 0x144, size 0x1 
...
/// @brief Field volumeLayerMask, offset 0x1c0, size 0x4 
...
/// @brief Field volumeTrigger, offset 0x1c8, size 0x8 
...
/// @brief Field worldSpaceCameraPos, offset 0x1ec, size 0xc 
...
/// @brief Field xrRendering, offset 0x19b, size 0x1 
...
/// @brief Method GetGPUProjectionMatrix, addr 0x1820e5460, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetProjectionMatrix, addr 0x1820e5570, size 0x290, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetProjectionMatrix(int32_t  viewIndex) ;

/// @brief Method GetProjectionMatrixNoJitter, addr 0x1820e54e0, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetProjectionMatrixNoJitter(int32_t  viewIndex) ;

/// @brief Method GetViewMatrix, addr 0x1820e5800, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method IsHandleYFlipped, addr 0x1820e5890, size 0x290, virtual false, abstract: false, final false
inline bool IsHandleYFlipped(::UnityEngine::Rendering::RTHandle*  handle) ;

/// @brief Method IsRenderTargetProjectionMatrixFlipped, addr 0x1820e5b20, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method IsSTPEnabled, addr 0x1820e5b90, size 0x20, virtual false, abstract: false, final false
inline bool IsSTPEnabled() ;

/// @brief Method IsSTPRequested, addr 0x1820e5bb0, size 0x20, virtual false, abstract: false, final false
inline bool IsSTPRequested() ;

/// @brief Method IsTemporalAAEnabled, addr 0x1820e5bd0, size 0xb0, virtual false, abstract: false, final false
inline bool IsTemporalAAEnabled() ;

/// @brief Method IsTemporalAARequested, addr 0x1820e5c80, size 0x10, virtual false, abstract: false, final false
inline bool IsTemporalAARequested() ;

static inline ::UnityEngine::Rendering::Universal::UniversalCameraData* New_ctor() ;

/// @brief Method PushBuiltinShaderConstantsXR, addr 0x1820e5c90, size 0x8b0, virtual false, abstract: false, final false
inline void PushBuiltinShaderConstantsXR(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, bool  renderIntoTexture) ;

/// @brief Method Reset, addr 0x1820e6540, size 0x240, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SetViewAndProjectionMatrix, addr 0x1820e6780, size 0xb0, virtual false, abstract: false, final false
inline void SetViewAndProjectionMatrix(::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  projectionMatrix) ;

/// @brief Method SetViewProjectionAndJitterMatrix, addr 0x1820e6830, size 0x80, virtual false, abstract: false, final false
...
constexpr bool const& __cordl_internal_get_blitsOffscreenUICover() const;

constexpr bool& __cordl_internal_get_blitsOffscreenUICover() ;
...
constexpr bool const& __cordl_internal_get_isLastBaseCamera() const;

constexpr bool& __cordl_internal_get_isLastBaseCamera() ;
...
constexpr bool const& __cordl_internal_get_rendersOffscreenUI() const;

constexpr bool& __cordl_internal_get_rendersOffscreenUI() ;
...
constexpr int32_t const& __cordl_internal_get_scaledHeight() const;

constexpr int32_t& __cordl_internal_get_scaledHeight() ;

constexpr int32_t const& __cordl_internal_get_scaledWidth() const;

constexpr int32_t& __cordl_internal_get_scaledWidth() ;
...
constexpr void __cordl_internal_set_blitsOffscreenUICover(bool  value) ;
...
constexpr void __cordl_internal_set_isLastBaseCamera(bool  value) ;
...
constexpr void __cordl_internal_set_rendersOffscreenUI(bool  value) ;
...
constexpr void __cordl_internal_set_scaledHeight(int32_t  value) ;

constexpr void __cordl_internal_set_scaledWidth(int32_t  value) ;
...
/// @brief Method get_hdrDisplayColorGamut, addr 0x1820e68b0, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::ColorGamut get_hdrDisplayColorGamut() ;

/// @brief Method get_hdrDisplayInformation, addr 0x1820e6900, size 0xe0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::HDROutputUtils_HDRDisplayInformation get_hdrDisplayInformation() ;

/// @brief Method get_historyManager, addr 0x180474bf0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::UniversalCameraHistory* get_historyManager() ;

/// @brief Method get_isGameCamera, addr 0x1820e69e0, size 0x10, virtual false, abstract: false, final false
inline bool get_isGameCamera() ;

/// @brief Method get_isHDROutputActive, addr 0x1820e69f0, size 0xb0, virtual false, abstract: false, final false
inline bool get_isHDROutputActive() ;

/// @brief Method get_isPreviewCamera, addr 0x1820e6aa0, size 0x10, virtual false, abstract: false, final false
inline bool get_isPreviewCamera() ;

/// @brief Method get_isRenderPassSupportedCamera, addr 0x1820e6ab0, size 0x20, virtual false, abstract: false, final false
inline bool get_isRenderPassSupportedCamera() ;

/// @brief Method get_isSceneViewCamera, addr 0x1820e6ad0, size 0x10, virtual false, abstract: false, final false
inline bool get_isSceneViewCamera() ;

/// @brief Method get_rendersOverlayUI, addr 0x1820e6ae0, size 0x70, virtual false, abstract: false, final false
inline bool get_rendersOverlayUI() ;

/// @brief Method get_requireSrgbConversion, addr 0x1820e6b50, size 0x140, virtual false, abstract: false, final false
inline bool get_requireSrgbConversion() ;

/// @brief Method get_resetHistory, addr 0x1820e6c90, size 0x10, virtual false, abstract: false, final false
inline bool get_resetHistory() ;

/// @brief Method get_resolveToScreen, addr 0x1820e6ca0, size 0x60, virtual false, abstract: false, final false
inline bool get_resolveToScreen() ;

/// @brief Method get_xr, addr 0x180345c20, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Experimental::Rendering::XRPass* get_xr() ;

/// @brief Method get_xrUniversal, addr 0x1820e6d00, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::XRPassUniversal* get_xrUniversal() ;

/// @brief Method set_historyManager, addr 0x180474ca0, size 0x20, virtual false, abstract: false, final false
inline void set_historyManager(::UnityEngine::Rendering::Universal::UniversalCameraHistory*  value) ;

/// @brief Method set_xr, addr 0x180346180, size 0x20, virtual false, abstract: false, final false
...
/// @brief Field scaledWidth, offset: 0xe0, size: 0x4, def value: None
 int32_t  ___scaledWidth;

/// @brief Field scaledHeight, offset: 0xe4, size: 0x4, def value: None
 int32_t  ___scaledHeight;

/// @brief Field m_HistoryManager, offset: 0xe8, size: 0x8, def value: None
 ::UnityEngine::Rendering::Universal::UniversalCameraHistory*  ___m_HistoryManager;

/// @brief Field renderType, offset: 0xf0, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::CameraRenderType  ___renderType;

/// @brief Field targetTexture, offset: 0xf8, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ___targetTexture;

/// @brief Field cameraTargetDescriptor, offset: 0x100, size: 0x34, def value: None
 ::UnityEngine::RenderTextureDescriptor  ___cameraTargetDescriptor;

/// @brief Field pixelRect, offset: 0x134, size: 0x10, def value: None
 ::UnityEngine::Rect  ___pixelRect;

/// @brief Field useScreenCoordOverride, offset: 0x144, size: 0x1, def value: None
 bool  ___useScreenCoordOverride;

/// @brief Field screenSizeOverride, offset: 0x148, size: 0x10, def value: None
 ::UnityEngine::Vector4  ___screenSizeOverride;

/// @brief Field screenCoordScaleBias, offset: 0x158, size: 0x10, def value: None
 ::UnityEngine::Vector4  ___screenCoordScaleBias;

/// @brief Field pixelWidth, offset: 0x168, size: 0x4, def value: None
 int32_t  ___pixelWidth;

/// @brief Field pixelHeight, offset: 0x16c, size: 0x4, def value: None
 int32_t  ___pixelHeight;

/// @brief Field aspectRatio, offset: 0x170, size: 0x4, def value: None
 float_t  ___aspectRatio;

/// @brief Field renderScale, offset: 0x174, size: 0x4, def value: None
 float_t  ___renderScale;

/// @brief Field imageScalingMode, offset: 0x178, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::ImageScalingMode  ___imageScalingMode;

/// @brief Field upscalingFilter, offset: 0x17c, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::ImageUpscalingFilter  ___upscalingFilter;

/// @brief Field fsrOverrideSharpness, offset: 0x180, size: 0x1, def value: None
 bool  ___fsrOverrideSharpness;

/// @brief Field fsrSharpness, offset: 0x184, size: 0x4, def value: None
 float_t  ___fsrSharpness;

/// @brief Field hdrColorBufferPrecision, offset: 0x188, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::HDRColorBufferPrecision  ___hdrColorBufferPrecision;

/// @brief Field clearDepth, offset: 0x18c, size: 0x1, def value: None
 bool  ___clearDepth;

/// @brief Field cameraType, offset: 0x190, size: 0x4, def value: None
 ::UnityEngine::CameraType  ___cameraType;

/// @brief Field isDefaultViewport, offset: 0x194, size: 0x1, def value: None
 bool  ___isDefaultViewport;

/// @brief Field isHdrEnabled, offset: 0x195, size: 0x1, def value: None
 bool  ___isHdrEnabled;

/// @brief Field allowHDROutput, offset: 0x196, size: 0x1, def value: None
 bool  ___allowHDROutput;

/// @brief Field isAlphaOutputEnabled, offset: 0x197, size: 0x1, def value: None
 bool  ___isAlphaOutputEnabled;

/// @brief Field requiresDepthTexture, offset: 0x198, size: 0x1, def value: None
 bool  ___requiresDepthTexture;

/// @brief Field requiresOpaqueTexture, offset: 0x199, size: 0x1, def value: None
 bool  ___requiresOpaqueTexture;

/// @brief Field postProcessingRequiresDepthTexture, offset: 0x19a, size: 0x1, def value: None
 bool  ___postProcessingRequiresDepthTexture;

/// @brief Field xrRendering, offset: 0x19b, size: 0x1, def value: None
 bool  ___xrRendering;

/// @brief Field useGPUOcclusionCulling, offset: 0x19c, size: 0x1, def value: None
 bool  ___useGPUOcclusionCulling;

/// @brief Field stackLastCameraOutputToHDR, offset: 0x19d, size: 0x1, def value: None
 bool  ___stackLastCameraOutputToHDR;

/// @brief Field rendersOffscreenUI, offset: 0x19e, size: 0x1, def value: None
 bool  ___rendersOffscreenUI;

/// @brief Field blitsOffscreenUICover, offset: 0x19f, size: 0x1, def value: None
 bool  ___blitsOffscreenUICover;

/// @brief Field defaultOpaqueSortFlags, offset: 0x1a0, size: 0x4, def value: None
 ::UnityEngine::Rendering::SortingCriteria  ___defaultOpaqueSortFlags;

/// @brief Field <xr>k__BackingField, offset: 0x1a8, size: 0x8, def value: None
 ::UnityEngine::Experimental::Rendering::XRPass*  ____xr_k__BackingField;

/// @brief Field maxShadowDistance, offset: 0x1b0, size: 0x4, def value: None
 float_t  ___maxShadowDistance;

/// @brief Field postProcessEnabled, offset: 0x1b4, size: 0x1, def value: None
 bool  ___postProcessEnabled;

/// @brief Field stackAnyPostProcessingEnabled, offset: 0x1b5, size: 0x1, def value: None
 bool  ___stackAnyPostProcessingEnabled;

/// @brief Field captureActions, offset: 0x1b8, size: 0x8, def value: None
...
/// @brief Field volumeLayerMask, offset: 0x1c0, size: 0x4, def value: None
 ::UnityEngine::LayerMask  ___volumeLayerMask;

/// @brief Field volumeTrigger, offset: 0x1c8, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Transform>  ___volumeTrigger;

/// @brief Field isStopNaNEnabled, offset: 0x1d0, size: 0x1, def value: None
 bool  ___isStopNaNEnabled;

/// @brief Field isDitheringEnabled, offset: 0x1d1, size: 0x1, def value: None
 bool  ___isDitheringEnabled;

/// @brief Field antialiasing, offset: 0x1d4, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::AntialiasingMode  ___antialiasing;

/// @brief Field antialiasingQuality, offset: 0x1d8, size: 0x4, def value: None
 ::UnityEngine::Rendering::Universal::AntialiasingQuality  ___antialiasingQuality;

/// @brief Field renderer, offset: 0x1e0, size: 0x8, def value: None
 ::UnityEngine::Rendering::Universal::ScriptableRenderer*  ___renderer;

/// @brief Field resolveFinalTarget, offset: 0x1e8, size: 0x1, def value: None
 bool  ___resolveFinalTarget;

/// @brief Field worldSpaceCameraPos, offset: 0x1ec, size: 0xc, def value: None
 ::UnityEngine::Vector3  ___worldSpaceCameraPos;

/// @brief Field backgroundColor, offset: 0x1f8, size: 0x10, def value: None
 ::UnityEngine::Color  ___backgroundColor;

/// @brief Field taaHistory, offset: 0x208, size: 0x8, def value: None
 ::UnityEngine::Rendering::Universal::TaaHistory*  ___taaHistory;

/// @brief Field stpHistory, offset: 0x210, size: 0x8, def value: None
 ::UnityEngine::Rendering::Universal::StpHistory*  ___stpHistory;

/// @brief Field taaSettings, offset: 0x218, size: 0x20, def value: None
 ::UnityEngine::Rendering::Universal::TemporalAA_Settings  ___taaSettings;

/// @brief Field baseCamera, offset: 0x238, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Camera>  ___baseCamera;

/// @brief Field isLastBaseCamera, offset: 0x240, size: 0x1, def value: None
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___scaledWidth) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___scaledHeight) == 0xe4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___m_HistoryManager) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___renderType) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___targetTexture) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___cameraTargetDescriptor) == 0x100, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___pixelRect) == 0x134, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___useScreenCoordOverride) == 0x144, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___screenSizeOverride) == 0x148, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___screenCoordScaleBias) == 0x158, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___pixelWidth) == 0x168, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___pixelHeight) == 0x16c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___aspectRatio) == 0x170, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___renderScale) == 0x174, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___imageScalingMode) == 0x178, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___upscalingFilter) == 0x17c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___fsrOverrideSharpness) == 0x180, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___fsrSharpness) == 0x184, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___hdrColorBufferPrecision) == 0x188, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___clearDepth) == 0x18c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___cameraType) == 0x190, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isDefaultViewport) == 0x194, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isHdrEnabled) == 0x195, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___allowHDROutput) == 0x196, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isAlphaOutputEnabled) == 0x197, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___requiresDepthTexture) == 0x198, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___requiresOpaqueTexture) == 0x199, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___postProcessingRequiresDepthTexture) == 0x19a, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___xrRendering) == 0x19b, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___useGPUOcclusionCulling) == 0x19c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___stackLastCameraOutputToHDR) == 0x19d, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___rendersOffscreenUI) == 0x19e, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___blitsOffscreenUICover) == 0x19f, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___defaultOpaqueSortFlags) == 0x1a0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ____xr_k__BackingField) == 0x1a8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___maxShadowDistance) == 0x1b0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___postProcessEnabled) == 0x1b4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___stackAnyPostProcessingEnabled) == 0x1b5, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___captureActions) == 0x1b8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___volumeLayerMask) == 0x1c0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___volumeTrigger) == 0x1c8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isStopNaNEnabled) == 0x1d0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isDitheringEnabled) == 0x1d1, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___antialiasing) == 0x1d4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___antialiasingQuality) == 0x1d8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___renderer) == 0x1e0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___resolveFinalTarget) == 0x1e8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___worldSpaceCameraPos) == 0x1ec, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___backgroundColor) == 0x1f8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___taaHistory) == 0x208, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___stpHistory) == 0x210, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___taaSettings) == 0x218, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___baseCamera) == 0x238, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalCameraData, ___isLastBaseCamera) == 0x240, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalCameraData) == 0x248, "Size mismatch!");
