...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderGraphUtils*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderGraphUtils_PassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderGraphUtils___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderGraphUtils*, "UnityEngine.Rendering.Universal", "RenderGraphUtils");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderGraphUtils_PassData*, "UnityEngine.Rendering.Universal", "RenderGraphUtils/PassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderGraphUtils___c*, "UnityEngine.Rendering.Universal", "RenderGraphUtils/<>c");
...
/// @brief Field <>9__6_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__6_0, put=setStaticF___9__6_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderGraphUtils_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__6_0;

static inline ::UnityEngine::Rendering::Universal::RenderGraphUtils___c* New_ctor() ;

/// @brief Method <SetGlobalTexture>b__6_0, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderGraphUtils_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__6_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::RenderGraphUtils___c*  value) ;

static inline void setStaticF___9__6_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::RenderGraphUtils_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderGraphUtils___c) == 0x10, "Size mismatch!");
...
/// @brief Field s_SetGlobalTextureProfilingSampler, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SetGlobalTextureProfilingSampler, put=setStaticF_s_SetGlobalTextureProfilingSampler)) ::UnityEngine::Rendering::ProfilingSampler*  s_SetGlobalTextureProfilingSampler;

/// @brief Method SetGlobalTexture, addr 0x18213e6b0, size 0x2a0, virtual false, abstract: false, final false
static inline void SetGlobalTexture(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  graph, int32_t  nameId, ::UnityEngine::Rendering::RenderGraphModule::TextureHandle  handle, ::StringW  passName, ::StringW  file, int32_t  line) ;

/// @brief Method UseDBufferIfValid, addr 0x18213e950, size 0xb0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderGraphUtils) == 0x10, "Size mismatch!");
