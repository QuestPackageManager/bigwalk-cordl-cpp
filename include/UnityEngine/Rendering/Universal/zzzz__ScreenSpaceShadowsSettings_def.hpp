...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ScreenSpaceShadowsSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceShadowsSettings*, "UnityEngine.Rendering.Universal", "ScreenSpaceShadowsSettings");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceShadowsSettings) == 0x10, "Size mismatch!");
