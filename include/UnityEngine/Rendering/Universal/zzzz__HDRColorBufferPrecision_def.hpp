...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::HDRColorBufferPrecision, "UnityEngine.Rendering.Universal", "HDRColorBufferPrecision");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::HDRColorBufferPrecision, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::HDRColorBufferPrecision) == 0x4, "Size mismatch!");
