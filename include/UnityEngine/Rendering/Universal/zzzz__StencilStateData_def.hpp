...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::StencilStateData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::StencilStateData*, "UnityEngine.Rendering.Universal", "StencilStateData");
...
/// @brief Method .ctor, addr 0x1820c5150, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::StencilStateData) == 0x28, "Size mismatch!");
