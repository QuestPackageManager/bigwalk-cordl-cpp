...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ChromaticAberration*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ChromaticAberration*, "UnityEngine.Rendering.Universal", "ChromaticAberration");
...
/// @brief Method .ctor, addr 0x1820f6990, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ChromaticAberration) == 0x40, "Size mismatch!");
