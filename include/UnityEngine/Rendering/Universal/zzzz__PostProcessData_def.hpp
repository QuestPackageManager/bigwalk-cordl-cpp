...
/// @brief Field subpixelMorphologicalAntialiasingPS, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_subpixelMorphologicalAntialiasingPS, put=__cordl_internal_set_subpixelMorphologicalAntialiasingPS)) ::UnityW<::UnityEngine::Shader>  subpixelMorphologicalAntialiasingPS;
...
/// @brief Method get_version, addr 0x1805d4730, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_version, addr 0x1802e2ba0, size 0x10, virtual true, abstract: false, final true
inline int32_t get_version() ;
