...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalDrawScreenSpaceSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalDrawScreenSpaceSystem*, "UnityEngine.Rendering.Universal", "DecalDrawScreenSpaceSystem");
...
public:
// Declarations
/// @brief Method GetPassIndex, addr 0x180912500, size 0x270, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820cfa10, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalDrawScreenSpaceSystem) == 0x40, "Size mismatch!");
