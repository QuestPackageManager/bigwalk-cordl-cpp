...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalEntityManager*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalEntityManager___c*);
MARK_VAL_T(::UnityEngine::Rendering::Universal::DecalEntityManager_CombinedChunks);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalEntityManager*, "UnityEngine.Rendering.Universal", "DecalEntityManager");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalEntityManager___c*, "UnityEngine.Rendering.Universal", "DecalEntityManager/<>c");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalEntityManager_CombinedChunks, "UnityEngine.Rendering.Universal", "DecalEntityManager/CombinedChunks");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "entityChunk", ty: "::UnityEngine::Rendering::Universal::DecalEntityChunk*", modifiers: "", def_value: None }, CppParam { name: "cachedChunk", ty: "::UnityEngine::Rendering::Universal::DecalCachedChunk*", modifiers: "", def_value: None }, CppParam { name: "culledChunk", ty: "::UnityEngine::Rendering::Universal::DecalCulledChunk*", modifiers: "", def_value: None }, CppParam { name: "drawCallChunk", ty: "::UnityEngine::Rendering::Universal::DecalDrawCallChunk*", modifiers: "", def_value: None }, CppParam { name: "previousChunkIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "valid", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method <Update>b__26_0, addr 0x1820ddf00, size 0xb0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalEntityManager___c) == 0x10, "Size mismatch!");
...
/// @brief Field cachedChunks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_cachedChunks, put=__cordl_internal_set_cachedChunks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalCachedChunk*>*  cachedChunks;
...
/// @brief Field culledChunks, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_culledChunks, put=__cordl_internal_set_culledChunks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalCulledChunk*>*  culledChunks;
...
/// @brief Field drawCallChunks, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_drawCallChunks, put=__cordl_internal_set_drawCallChunks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalDrawCallChunk*>*  drawCallChunks;

/// @brief Field entityChunks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_entityChunks, put=__cordl_internal_set_entityChunks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalEntityChunk*>*  entityChunks;
...
/// @brief Field m_CombinedChunks, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CombinedChunks, put=__cordl_internal_set_m_CombinedChunks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalEntityManager_CombinedChunks>*  m_CombinedChunks;
...
/// @brief Field m_MaterialToChunkIndex, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_MaterialToChunkIndex, put=__cordl_internal_set_m_MaterialToChunkIndex)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Material>,int32_t>*  m_MaterialToChunkIndex;
...
/// @brief Method CreateChunkIndex, addr 0x1820d1330, size 0x3c0, virtual false, abstract: false, final false
inline int32_t CreateChunkIndex(::UnityEngine::Material*  material) ;

/// @brief Method CreateDecalEntity, addr 0x1820d16f0, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method DestroyDecalEntity, addr 0x1820d1a10, size 0x1e0, virtual false, abstract: false, final false
inline void DestroyDecalEntity(::UnityEngine::Rendering::Universal::DecalEntity  decalEntity) ;

/// @brief Method Dispose, addr 0x1820d1bf0, size 0x440, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsValid, addr 0x1820d2030, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x1820d2760, size 0x5c0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateAllDecalEntitiesData, addr 0x1820d2060, size 0x120, virtual false, abstract: false, final false
inline void UpdateAllDecalEntitiesData() ;

/// @brief Method UpdateDecalEntityData, addr 0x1820d2180, size 0x5e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d2d20, size 0x270, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_decalProjectorMesh, addr 0x1820d2f90, size 0x80, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_decalProjectorMesh() ;

/// @brief Method get_errorMaterial, addr 0x1820d3010, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalEntityManager) == 0x80, "Size mismatch!");
