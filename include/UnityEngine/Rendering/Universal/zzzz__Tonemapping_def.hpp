...
/// @brief Field neutralHDRRangeReductionMode, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_neutralHDRRangeReductionMode, put=__cordl_internal_set_neutralHDRRangeReductionMode)) ::UnityEngine::Rendering::Universal::NeutralRangeReductionModeParameter*  neutralHDRRangeReductionMode;
...
/// @brief Method IsActive, addr 0x18210ca60, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18210ca90, size 0x230, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Tonemapping) == 0x80, "Size mismatch!");
