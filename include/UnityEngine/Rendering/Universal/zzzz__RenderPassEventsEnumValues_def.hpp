...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderPassEventsEnumValues*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderPassEventsEnumValues*, "UnityEngine.Rendering.Universal", "RenderPassEventsEnumValues");
...
/// @brief Field values, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_values, put=setStaticF_values)) ::ArrayW<int32_t>  values;

static inline ::ArrayW<int32_t> getStaticF_values() ;

static inline void setStaticF_values(::ArrayW<int32_t>  value) ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderPassEventsEnumValues) == 0x10, "Size mismatch!");
