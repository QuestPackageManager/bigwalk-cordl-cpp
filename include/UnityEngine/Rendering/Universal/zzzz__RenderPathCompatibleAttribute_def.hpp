...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderPathCompatibleAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderPathCompatibleAttribute*, "UnityEngine.Rendering.Universal", "RenderPathCompatibleAttribute");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderPathCompatibleAttribute) == 0x18, "Size mismatch!");
