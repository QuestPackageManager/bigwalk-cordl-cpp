...
// Ctor Parameters [CppParam { name: "cameraID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "jobHandle", ty: "::Unity::Jobs::JobHandle", modifiers: "", def_value: None }]
...
/// @brief Field <>9__28_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__28_0, put=setStaticF___9__28_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  __9__28_0;

static inline ::UnityEngine::Rendering::InstanceCuller___c* New_ctor() ;

/// @brief Method <InstanceOcclusionTest>b__28_0, addr 0x1820ac8c0, size 0x70, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>* getStaticF___9__28_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::InstanceCuller___c*  value) ;

static inline void setStaticF___9__28_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  value) ;
...
/// @brief Method AddOcclusionCullingDispatch, addr 0x1820946f0, size 0xa30, virtual false, abstract: false, final false
inline void AddOcclusionCullingDispatch(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::by_ref<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, ::by_ref<::UnityEngine::Rendering::IndirectBufferContextHandles>  bufferHandles, ::by_ref<::UnityEngine::Rendering::OccluderHandles>  occluderHandles, ::UnityEngine::Rendering::RenderersBatchersContext*  batchersContext) ;

/// @brief Method AnimateCrossFades, addr 0x182095120, size 0x370, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle AnimateCrossFades(::UnityEngine::Rendering::CPUPerCameraInstanceData  perCameraInstanceData, ::UnityEngine::Rendering::BatchCullingContext  cc, ::by_ref<::UnityEngine::Rendering::CPUPerCameraInstanceData_PerCameraInstanceDataArrays>  cameraInstanceData, ::by_ref<bool>  hasAnimatedCrossfade) ;

/// @brief Method ComputeWorstCaseDrawCommandCount, addr 0x182095490, size 0x70, virtual false, abstract: false, final false
inline int32_t ComputeWorstCaseDrawCommandCount(::by_ref<::UnityEngine::Rendering::BatchCullingContext>  cc, ::UnityEngine::Rendering::BinningConfig  binningConfig, ::UnityEngine::Rendering::CPUDrawInstanceData*  drawInstanceData) ;

/// @brief Method CreateCompactedVisibilityMaskJob, addr 0x182095500, size 0x1a0, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateCompactedVisibilityMaskJob(::by_ref<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::Unity::Collections::NativeArray_1<uint8_t>  rendererVisibilityMasks, ::Unity::Jobs::JobHandle  cullingJobHandle) ;

/// @brief Method CreateCullJobTree, addr 0x1820956a0, size 0xd10, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateCullJobTree(::by_ref<::UnityEngine::Rendering::BatchCullingContext>  cc, ::UnityEngine::Rendering::BatchCullingOutput  cullingOutput, ::by_ref<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::by_ref<::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly>  sharedInstanceData, ::by_ref<::UnityEngine::Rendering::CPUPerCameraInstanceData>  perCameraInstanceData, ::by_ref<::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly>  instanceDataBuffer, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>  lodGroupCullingData, ::UnityEngine::Rendering::CPUDrawInstanceData*  drawInstanceData, ::Unity::Collections::NativeParallelHashMap_2<uint32_t,::UnityEngine::Rendering::BatchID>  batchIDs, float_t  smallMeshScreenPercentage, ::UnityEngine::Rendering::OcclusionCullingCommon*  occlusionCullingCommon) ;

/// @brief Method CreateFrustumCullingJob, addr 0x1820963b0, size 0x7f0, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateFrustumCullingJob(::by_ref<::UnityEngine::Rendering::BatchCullingContext>  cc, ::by_ref<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::by_ref<::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly>  sharedInstanceData, ::by_ref<::UnityEngine::Rendering::CPUPerCameraInstanceData>  perCameraInstanceData, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>  lodGroupCullingData, ::by_ref<::UnityEngine::Rendering::BinningConfig>  binningConfig, float_t  smallMeshScreenPercentage, ::UnityEngine::Rendering::OcclusionCullingCommon*  occlusionCullingCommon, ::Unity::Collections::NativeArray_1<uint8_t>  rendererVisibilityMasks, ::Unity::Collections::NativeArray_1<uint8_t>  rendererMeshLodSettings, ::Unity::Collections::NativeArray_1<uint8_t>  rendererCrossFadeValues) ;

/// @brief Method Dispose, addr 0x182096ba0, size 0xd0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeCompactVisibilityMasks, addr 0x18208f290, size 0x30, virtual false, abstract: false, final false
inline void DisposeCompactVisibilityMasks() ;

/// @brief Method DisposeSceneViewHiddenBits, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void DisposeSceneViewHiddenBits() ;

/// @brief Method EnsureValidOcclusionTestResults, addr 0x182096c70, size 0x2d0, virtual false, abstract: false, final false
inline void EnsureValidOcclusionTestResults(int32_t  viewInstanceID) ;

/// @brief Method FlushDebugCounters, addr 0x182096f40, size 0x70, virtual false, abstract: false, final false
inline void FlushDebugCounters() ;

/// @brief Method GetCompactedVisibilityMasks, addr 0x182096fb0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ParallelBitArray GetCompactedVisibilityMasks(bool  syncCullingJobs) ;

/// @brief Method Init, addr 0x182097030, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method InstanceOccludersUpdated, addr 0x182097270, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method InstanceOcclusionTest, addr 0x182097330, size 0x4a0, virtual false, abstract: false, final false
inline void InstanceOcclusionTest(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::by_ref<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::SubviewOcclusionTest>  subviewOcclusionTests, ::UnityEngine::Rendering::RenderersBatchersContext*  batchersContext) ;

/// @brief Method OnBeginCameraRendering, addr 0x1820977d0, size 0x20, virtual false, abstract: false, final false
inline void OnBeginCameraRendering(::UnityEngine::Camera*  camera) ;

/// @brief Method OnBeginSceneViewCameraRendering, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void OnBeginSceneViewCameraRendering() ;

/// @brief Method OnEndCameraRendering, addr 0x1820977d0, size 0x20, virtual false, abstract: false, final false
inline void OnEndCameraRendering(::UnityEngine::Camera*  camera) ;

/// @brief Method OnEndSceneViewCameraRendering, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void OnEndSceneViewCameraRendering() ;

/// @brief Method UpdateFrame, addr 0x1820977f0, size 0xf0, virtual false, abstract: false, final false
