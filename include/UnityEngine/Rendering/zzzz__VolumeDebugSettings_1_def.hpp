...
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::VolumeDebugSettings_1___c);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::VolumeDebugSettings_1___c__DisplayClass22_0);
...
/// @brief Field <additionalCameraDatas>k__BackingField, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__additionalCameraDatas_k__BackingField, put=setStaticF__additionalCameraDatas_k__BackingField)) ::System::Collections::Generic::List_1<T>*  _additionalCameraDatas_k__BackingField;
...
/// @brief Field <targetRenderPipeline>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__targetRenderPipeline_k__BackingField, put=__cordl_internal_set__targetRenderPipeline_k__BackingField)) ::System::Type*  _targetRenderPipeline_k__BackingField;
...
/// @brief Field volumes, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_volumes, put=__cordl_internal_set_volumes)) ::ArrayW<::UnityW<::UnityEngine::Rendering::Volume>>  volumes;

/// @brief Field weights, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_weights, put=__cordl_internal_set_weights)) ::ArrayW<float_t>  weights;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::Rendering::Volume>> const& __cordl_internal_get_volumes() const;

constexpr ::ArrayW<::UnityW<::UnityEngine::Rendering::Volume>>& __cordl_internal_get_volumes() ;

constexpr ::ArrayW<float_t> const& __cordl_internal_get_weights() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_weights() ;
...
constexpr void __cordl_internal_set_weights(::ArrayW<float_t>  value) ;
...
/// @brief Field weights, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<float_t>  ___weights;

/// @brief Field volumes, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::UnityW<::UnityEngine::Rendering::Volume>>  ___volumes;
