...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IndexFormat, "UnityEngine.Rendering", "IndexFormat");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::IndexFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::IndexFormat) == 0x4, "Size mismatch!");
