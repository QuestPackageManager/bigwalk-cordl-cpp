...
/// @brief Method .ctor, addr 0x18204c990, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpVector2Parameter) == 0x20, "Size mismatch!");
