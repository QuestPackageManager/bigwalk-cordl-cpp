...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugShapes*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugShapes*, "UnityEngine.Rendering", "DebugShapes");
...
/// @brief Method BuildBox, addr 0x181fed3b0, size 0x730, virtual false, abstract: false, final false
inline void BuildBox(::by_ref<::UnityEngine::Mesh*>  outputMesh, float_t  length, float_t  width, float_t  height) ;

/// @brief Method BuildCone, addr 0x181fedae0, size 0x7a0, virtual false, abstract: false, final false
...
/// @brief Method BuildCustomSphereMesh, addr 0x181fee280, size 0x80, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> BuildCustomSphereMesh(float_t  radius, uint32_t  longSubdiv, uint32_t  latSubdiv) ;

/// @brief Method BuildPyramid, addr 0x181fee300, size 0x320, virtual false, abstract: false, final false
inline void BuildPyramid(::by_ref<::UnityEngine::Mesh*>  outputMesh, float_t  width, float_t  height, float_t  depth) ;

/// @brief Method BuildShapes, addr 0x181fee620, size 0x160, virtual false, abstract: false, final false
inline void BuildShapes() ;

/// @brief Method BuildSphere, addr 0x181fee780, size 0x5a0, virtual false, abstract: false, final false
...
/// @brief Method RebuildResources, addr 0x181feed20, size 0x1b0, virtual false, abstract: false, final false
inline void RebuildResources() ;

/// @brief Method RequestBoxMesh, addr 0x181feeed0, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestBoxMesh() ;

/// @brief Method RequestConeMesh, addr 0x181feeef0, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestConeMesh() ;

/// @brief Method RequestPyramidMesh, addr 0x181feef10, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestPyramidMesh() ;

/// @brief Method RequestSphereMesh, addr 0x181feef30, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_instance, addr 0x181feef50, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::DebugShapes) == 0x30, "Size mismatch!");
