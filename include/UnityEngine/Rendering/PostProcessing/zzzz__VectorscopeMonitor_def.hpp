...
#include <cmath>
#include <cstdint>
CORDL_MODULE_EXPORT(VectorscopeMonitor)
...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor*, "UnityEngine.Rendering.PostProcessing", "VectorscopeMonitor");
// Dependencies UnityEngine.Rendering.PostProcessing.Monitor
namespace UnityEngine::Rendering::PostProcessing {
// Is value type: false
// CS Name: UnityEngine.Rendering.PostProcessing.VectorscopeMonitor
class CORDL_TYPE VectorscopeMonitor : public ::UnityEngine::Rendering::PostProcessing::Monitor {
public:
// Declarations
/// @brief Field exposure, offset 0x20, size 0x4 
...
static inline ::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor* New_ctor() ;

/// @brief Method OnDisable, addr 0x181fd0a60, size 0x60, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Render, addr 0x181fd0ac0, size 0x410, virtual true, abstract: false, final false
inline void Render(::UnityEngine::Rendering::PostProcessing::PostProcessRenderContext*  context) ;

/// @brief Method ShaderResourcesAvailable, addr 0x181fd0ed0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181fd0ef0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr VectorscopeMonitor() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "VectorscopeMonitor", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
VectorscopeMonitor(VectorscopeMonitor && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "VectorscopeMonitor", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
VectorscopeMonitor(VectorscopeMonitor const& ) = delete;
...
/// @brief Field exposure, offset: 0x20, size: 0x4, def value: None
 float_t  ___exposure;
...
static_assert(offsetof(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor, ___size) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor, ___exposure) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor, ___m_Data) == 0x28, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::PostProcessing::VectorscopeMonitor) == 0x30, "Size mismatch!");
