...
public:
// Declarations
/// @brief Method AllocateInstance, addr 0x1820a1d10, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::InstanceHandle AllocateInstance(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method AllocateSharedInstance, addr 0x1820a1dc0, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::SharedInstanceHandle AllocateSharedInstance() ;

/// @brief Method Dispose, addr 0x1820a1e30, size 0x70, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FreeInstance, addr 0x1820a1ea0, size 0x50, virtual false, abstract: false, final false
inline void FreeInstance(::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method FreeSharedInstance, addr 0x1820a1ef0, size 0x30, virtual false, abstract: false, final false
inline void FreeSharedInstance(::UnityEngine::Rendering::SharedInstanceHandle  instance) ;

/// @brief Method GetInstanceAllocator, addr 0x1820a1f20, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::InstanceAllocator GetInstanceAllocator(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method GetInstanceHandlesLength, addr 0x1820a1fb0, size 0x50, virtual false, abstract: false, final false
inline int32_t GetInstanceHandlesLength(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method GetInstancesLength, addr 0x1820a2000, size 0x60, virtual false, abstract: false, final false
inline int32_t GetInstancesLength(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method Initialize, addr 0x1820a2060, size 0x80, virtual false, abstract: false, final false
