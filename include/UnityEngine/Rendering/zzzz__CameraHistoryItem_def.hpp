...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::CameraHistoryItem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CameraHistoryItem*, "UnityEngine.Rendering", "CameraHistoryItem");
...
/// @brief Method AllocHistoryFrameRT, addr 0x181fd4320, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* AllocHistoryFrameRT(int32_t  id, int32_t  count, ::by_ref<::UnityEngine::RenderTextureDescriptor>  desc, ::UnityEngine::FilterMode  filterMode, ::StringW  name) ;

/// @brief Method AllocHistoryFrameRT, addr 0x181fd42c0, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* AllocHistoryFrameRT(int32_t  id, int32_t  count, ::by_ref<::UnityEngine::RenderTextureDescriptor>  desc, ::StringW  name) ;

/// @brief Method GetCurrentFrameRT, addr 0x181fd4380, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetCurrentFrameRT(int32_t  id) ;

/// @brief Method GetPreviousFrameRT, addr 0x181fd4390, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetPreviousFrameRT(int32_t  id) ;

/// @brief Method MakeId, addr 0x181fd43b0, size 0x10, virtual false, abstract: false, final false
inline int32_t MakeId(uint32_t  index) ;

static inline ::UnityEngine::Rendering::CameraHistoryItem* New_ctor() ;

/// @brief Method OnCreate, addr 0x180c3ff30, size 0x4250, virtual true, abstract: false, final false
inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem*  owner, uint32_t  typeId) ;

/// @brief Method ReleaseHistoryFrameRT, addr 0x181fd43c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18172edb0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_storage, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::CameraHistoryItem) == 0x20, "Size mismatch!");
