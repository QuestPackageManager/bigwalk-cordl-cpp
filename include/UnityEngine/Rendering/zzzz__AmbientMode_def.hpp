...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AmbientMode, "UnityEngine.Rendering", "AmbientMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::AmbientMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::AmbientMode) == 0x4, "Size mismatch!");
