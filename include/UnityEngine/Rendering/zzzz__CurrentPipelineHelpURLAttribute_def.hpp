...
/// @brief Method .ctor, addr 0x18200d0c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_pageHash, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_pageHash() ;

/// @brief Method get_pageName, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::CurrentPipelineHelpURLAttribute) == 0x38, "Size mismatch!");
