...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUResidentDrawerMode, "UnityEngine.Rendering", "GPUResidentDrawerMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::GPUResidentDrawerMode, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::GPUResidentDrawerMode) == 0x1, "Size mismatch!");
