...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::TextureGradientParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TextureGradientParameter*, "UnityEngine.Rendering", "TextureGradientParameter");
...
/// @brief Method Release, addr 0x18204f110, size 0x60, virtual true, abstract: false, final false
inline void Release() ;
...
static_assert(sizeof(::UnityEngine::Rendering::TextureGradientParameter) == 0x20, "Size mismatch!");
