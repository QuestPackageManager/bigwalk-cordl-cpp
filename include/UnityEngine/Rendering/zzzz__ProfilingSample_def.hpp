...
/// @brief Method Dispose, addr 0x181ff1f00, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181ff1ea0, size 0x60, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method .ctor, addr 0x181ff2000, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::CommandBuffer*  cmd, ::StringW  format, ::System::Object*  arg) ;

/// @brief Method .ctor, addr 0x181ff20b0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::CommandBuffer*  cmd, ::StringW  format, ::ArrayW<::System::Object*>  args) ;

/// @brief Method .ctor, addr 0x181ff1f60, size 0xa0, virtual false, abstract: false, final false
