...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CameraLateLatchMatrixType, "UnityEngine.Rendering", "CameraLateLatchMatrixType");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Field InverseView value: I32(1)
static ::UnityEngine::Rendering::CameraLateLatchMatrixType const InverseView;

/// @brief Field InverseViewProjection value: I32(3)
...
/// @brief Field ViewProjection value: I32(2)
...
static_assert(offsetof(::UnityEngine::Rendering::CameraLateLatchMatrixType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CameraLateLatchMatrixType) == 0x4, "Size mismatch!");
