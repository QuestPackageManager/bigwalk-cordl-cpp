...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugActionRepeatMode, "UnityEngine.Rendering", "DebugActionRepeatMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DebugActionRepeatMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DebugActionRepeatMode) == 0x4, "Size mismatch!");
