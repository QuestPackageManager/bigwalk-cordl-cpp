...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1::ParallelWriter<T>, Unity.Collections.NativeList`1<T>, UnityEngine.Rendering.DrawInstance, UnityEngine.Rendering.InstanceHandle
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x18209f9e0, size 0xe0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "instancesSorted", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "drawInstances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>", modifiers: "", def_value: None }, CppParam { name: "outDrawInstanceIndicesWriter", ty: "::Unity::Collections::NativeList_1_ParallelWriter<int32_t>", modifiers: "", def_value: None }]
constexpr FindDrawInstancesJob(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instancesSorted, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>  drawInstances, ::Unity::Collections::NativeList_1_ParallelWriter<int32_t>  outDrawInstanceIndicesWriter) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::FindDrawInstancesJob) == 0x20, "Size mismatch!");
