...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::NoInterpCubemapParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::NoInterpCubemapParameter*, "UnityEngine.Rendering", "NoInterpCubemapParameter");
...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x18204c890, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpCubemapParameter) == 0x20, "Size mismatch!");
