...
static_assert(offsetof(::UnityEngine::Rendering::SupportedRenderingFeatures_ReflectionProbeModes, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes) == 0x4, "Size mismatch!");
...
/// @brief Field <defaultMixedLightingModes>k__BackingField, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__defaultMixedLightingModes_k__BackingField, put=__cordl_internal_set__defaultMixedLightingModes_k__BackingField)) ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes  _defaultMixedLightingModes_k__BackingField;
...
/// @brief Field <mixedLightingModes>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__mixedLightingModes_k__BackingField, put=__cordl_internal_set__mixedLightingModes_k__BackingField)) ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes  _mixedLightingModes_k__BackingField;
...
/// @brief Field <reflectionProbeModes>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__reflectionProbeModes_k__BackingField, put=__cordl_internal_set__reflectionProbeModes_k__BackingField)) ::UnityEngine::Rendering::SupportedRenderingFeatures_ReflectionProbeModes  _reflectionProbeModes_k__BackingField;
...
/// @brief Field <supportsHDR>k__BackingField, offset 0x3c, size 0x1 
 ...
 __declspec(property(get=get_reflectionProbeModes)) ::UnityEngine::Rendering::SupportedRenderingFeatures_ReflectionProbeModes  reflectionProbeModes;
...
/// @brief Method FallbackLightmapperByRef, addr 0x1804bdbc0, size 0x20, virtual false, abstract: false, final false
static inline void FallbackLightmapperByRef(::System::IntPtr  lightmapperPtr) ;

/// @brief Method FallbackMixedLightingModeByRef, addr 0x1822b5bf0, size 0x120, virtual false, abstract: false, final false
static inline void FallbackMixedLightingModeByRef(::System::IntPtr  fallbackModePtr) ;

/// @brief Method IsAmbientProbeBakingSupported, addr 0x1822b5d10, size 0x20, virtual false, abstract: false, final false
static inline void IsAmbientProbeBakingSupported(::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsDefaultReflectionProbeBakingSupported, addr 0x1822b5d30, size 0x20, virtual false, abstract: false, final false
static inline void IsDefaultReflectionProbeBakingSupported(::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsLightmapBakeTypeSupported, addr 0x1822b5dd0, size 0x80, virtual false, abstract: false, final false
static inline bool IsLightmapBakeTypeSupported(::UnityEngine::LightmapBakeType  bakeType) ;

/// @brief Method IsLightmapBakeTypeSupportedByRef, addr 0x1822b5d50, size 0x80, virtual false, abstract: false, final false
static inline void IsLightmapBakeTypeSupportedByRef(::UnityEngine::LightmapBakeType  bakeType, ::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsLightmapperSupportedByRef, addr 0x1804da150, size 0x10, virtual false, abstract: false, final false
static inline void IsLightmapperSupportedByRef(int32_t  lightmapper, ::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsLightmapsModeSupportedByRef, addr 0x1822b5e50, size 0x30, virtual false, abstract: false, final false
static inline void IsLightmapsModeSupportedByRef(::UnityEngine::LightmapsMode  mode, ::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsMixedLightingModeSupported, addr 0x1822b5f50, size 0xa0, virtual false, abstract: false, final false
static inline bool IsMixedLightingModeSupported(::UnityEngine::MixedLightingMode  mixedMode) ;

/// @brief Method IsMixedLightingModeSupportedByRef, addr 0x1822b5e80, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method IsRotatingReflectionProbesSupported, addr 0x1822b5ff0, size 0x20, virtual false, abstract: false, final false
static inline void IsRotatingReflectionProbesSupported(::System::IntPtr  isSupportedPtr) ;

/// @brief Method IsUIOverlayRenderedBySRP, addr 0x1822b6010, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method OverridesLightProbeSystem, addr 0x1822b6030, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822b6100, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* getStaticF_s_Active() ;

/// @brief Method get_active, addr 0x1822b6160, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* get_active() ;

/// @brief Method get_ambientProbeBaking, addr 0x1803023c0, size 0x10, virtual false, abstract: false, final false
inline bool get_ambientProbeBaking() ;

/// @brief Method get_defaultMixedLightingModes, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes get_defaultMixedLightingModes() ;

/// @brief Method get_defaultReflectionProbeBaking, addr 0x18049a520, size 0x10, virtual false, abstract: false, final false
inline bool get_defaultReflectionProbeBaking() ;

/// @brief Method get_enlighten, addr 0x1803a74f0, size 0x10, virtual false, abstract: false, final false
inline bool get_enlighten() ;

/// @brief Method get_lightmapBakeTypes, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LightmapBakeType get_lightmapBakeTypes() ;

/// @brief Method get_lightmapsModes, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LightmapsMode get_lightmapsModes() ;

/// @brief Method get_mixedLightingModes, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes get_mixedLightingModes() ;

/// @brief Method get_overridesLightProbeSystem, addr 0x1814f2bb0, size 0x10, virtual false, abstract: false, final false
inline bool get_overridesLightProbeSystem() ;

/// @brief Method get_reflectionProbeModes, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::SupportedRenderingFeatures_ReflectionProbeModes get_reflectionProbeModes() ;

/// @brief Method get_rendersUIOverlay, addr 0x18049ec40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_active, addr 0x1822b6240, size 0x50, virtual false, abstract: false, final false
static inline void set_active(::UnityEngine::Rendering::SupportedRenderingFeatures*  value) ;

/// @brief Method set_overridesLightProbeSystem, addr 0x1822124b0, size 0x10, virtual false, abstract: false, final false
inline void set_overridesLightProbeSystem(bool  value) ;

/// @brief Method set_rendersUIOverlay, addr 0x18049ec60, size 0x10, virtual false, abstract: false, final false
inline void set_rendersUIOverlay(bool  value) ;

/// @brief Method set_skyOcclusion, addr 0x1803a7520, size 0x10, virtual false, abstract: false, final false
inline void set_skyOcclusion(bool  value) ;

/// @brief Method set_supportsHDR, addr 0x1803cbfc0, size 0x10, virtual false, abstract: false, final false
