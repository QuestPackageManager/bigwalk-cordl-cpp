...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::PerObjectData, "UnityEngine.Rendering", "PerObjectData");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::PerObjectData, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::PerObjectData) == 0x4, "Size mismatch!");
