...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MeshProceduralInfo, "UnityEngine.Rendering", "MeshProceduralInfo");
...
static_assert(sizeof(::UnityEngine::Rendering::MeshProceduralInfo) == 0x10, "Size mismatch!");
