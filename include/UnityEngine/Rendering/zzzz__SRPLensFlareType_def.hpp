...
static_assert(offsetof(::UnityEngine::Rendering::SRPLensFlareType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::SRPLensFlareType) == 0x4, "Size mismatch!");
