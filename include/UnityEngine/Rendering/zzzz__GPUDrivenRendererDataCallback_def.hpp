...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::GPUDrivenRendererDataCallback*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUDrivenRendererDataCallback*, "UnityEngine.Rendering", "GPUDrivenRendererDataCallback");
...
inline void Invoke(::by_ref<::UnityEngine::Rendering::GPUDrivenRendererGroupData>  rendererData, ::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::Mesh>>*  meshes, ::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::Material>>*  materials) ;
...
static_assert(sizeof(::UnityEngine::Rendering::GPUDrivenRendererDataCallback) == 0x80, "Size mismatch!");
