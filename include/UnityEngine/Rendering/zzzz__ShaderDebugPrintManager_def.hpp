...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShaderDebugPrintManager_DebugValueType, "UnityEngine.Rendering", "ShaderDebugPrintManager/DebugValueType");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::ShaderDebugPrintManager_DebugValueType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ShaderDebugPrintManager_DebugValueType) == 0x4, "Size mismatch!");
...
/// @brief Method BufferReadComplete, addr 0x181ff36c0, size 0x870, virtual false, abstract: false, final false
inline void BufferReadComplete(::UnityEngine::Rendering::AsyncGPUReadbackRequest  request) ;

/// @brief Method ClearShaderDebugPrintBuffer, addr 0x181ff3f30, size 0xb0, virtual false, abstract: false, final false
inline void ClearShaderDebugPrintBuffer() ;

/// @brief Method DebugValueTypeToElemSize, addr 0x181ff3fe0, size 0x70, virtual false, abstract: false, final false
inline int32_t DebugValueTypeToElemSize(::UnityEngine::Rendering::ShaderDebugPrintManager_DebugValueType  type) ;

/// @brief Method DefaultOutput, addr 0x181ff4050, size 0x10, virtual false, abstract: false, final false
inline void DefaultOutput(::StringW  line) ;

/// @brief Method EndFrame, addr 0x181ff4060, size 0x80, virtual false, abstract: false, final false
inline void EndFrame() ;

static inline ::UnityEngine::Rendering::ShaderDebugPrintManager* New_ctor() ;

/// @brief Method PrintImmediate, addr 0x181ff40e0, size 0x90, virtual false, abstract: false, final false
inline void PrintImmediate() ;

/// @brief Method SetShaderDebugPrintBindings, addr 0x181ff4170, size 0x160, virtual false, abstract: false, final false
inline void SetShaderDebugPrintBindings(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method SetShaderDebugPrintInputConstants, addr 0x181ff42d0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ff4440, size 0x200, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x181ff4640, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::ShaderDebugPrintManager* get_instance() ;

/// @brief Method get_outputLine, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_outputAction, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
