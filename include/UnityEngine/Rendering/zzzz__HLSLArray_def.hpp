...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::HLSLArray*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::HLSLArray*, "UnityEngine.Rendering", "HLSLArray");
...
static_assert(sizeof(::UnityEngine::Rendering::HLSLArray) == 0x20, "Size mismatch!");
