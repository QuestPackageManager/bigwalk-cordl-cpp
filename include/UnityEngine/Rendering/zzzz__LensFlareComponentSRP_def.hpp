...
MARK_REF_T(::UnityEngine::Rendering::LensFlareComponentSRP*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareComponentSRP_Version, "UnityEngine.Rendering", "LensFlareComponentSRP/Version");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareComponentSRP*, "UnityEngine.Rendering", "LensFlareComponentSRP");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::LensFlareComponentSRP_Version, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method OnDestroy, addr 0x1820233a0, size 0x10, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x1820233b0, size 0x30, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1820233e0, size 0x50, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x182023430, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820234c0, size 0x320, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method celestialProjectedOcclusionRadius, addr 0x1820237e0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_lensFlareData, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_lensFlareData, addr 0x182023840, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::LensFlareComponentSRP) == 0x80, "Size mismatch!");
