...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GraphicsFenceType, "UnityEngine.Rendering", "GraphicsFenceType");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::GraphicsFenceType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::GraphicsFenceType) == 0x4, "Size mismatch!");
