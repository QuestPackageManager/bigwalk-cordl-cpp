...
public:
// Declarations
/// @brief Method AlignUpGroup, addr 0x18204d6e0, size 0x10, virtual false, abstract: false, final false
static inline int32_t AlignUpGroup(int32_t  value) ;

/// @brief Method CalculateTotalBufferSize, addr 0x18204d6f0, size 0x40, virtual false, abstract: false, final false
static inline void CalculateTotalBufferSize(int32_t  maxElementCount, ::by_ref<int32_t>  totalSize, ::by_ref<int32_t>  levelCounts) ;

/// @brief Method DivUpGroup, addr 0x182011310, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x18204ccd0, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources Create(int32_t  newMaxElementCount, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::RenderGraphModule::IBaseRenderGraphBuilder*  builder, bool  outputIsTemp) ;

/// @brief Method Create, addr 0x18204cd10, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x18204cd70, size 0x5b0, virtual false, abstract: false, final false
inline void Initialize(int32_t  newMaxElementCount, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::RenderGraphModule::IBaseRenderGraphBuilder*  builder, bool  outputIsTemp) ;

/// @brief Method Initialize, addr 0x18204d320, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method get_output, addr 0x1802d5350, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x18204d9f0, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUPrefixSum_SupportResources Create(int32_t  maxElementCount) ;

/// @brief Method Dispose, addr 0x18204da40, size 0x80, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Load, addr 0x18204dc90, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method LoadFromShaderGraph, addr 0x18204db30, size 0x160, virtual false, abstract: false, final false
inline void LoadFromShaderGraph(::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources  shaderGraphResources) ;

/// @brief Method Resize, addr 0x18204dd80, size 0x260, virtual false, abstract: false, final false
inline void Resize(int32_t  newMaxElementCount) ;

/// @brief Method <Dispose>g__TryFreeBuffer|15_0, addr 0x182044b80, size 0x10, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method LoadKernels, addr 0x18204e8a0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method DispatchDirect, addr 0x182047840, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method DispatchDirect, addr 0x1820477e0, size 0x60, virtual false, abstract: false, final false
inline void DispatchDirect(::UnityEngine::Rendering::IComputeCommandBuffer*  cmdBuffer, ::by_ref<::UnityEngine::Rendering::GPUPrefixSum_DirectArgs>  arguments) ;

/// @brief Method DispatchIndirect, addr 0x182047a30, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method DispatchIndirect, addr 0x182047c30, size 0x60, virtual false, abstract: false, final false
inline void DispatchIndirect(::UnityEngine::Rendering::IComputeCommandBuffer*  cmdBuffer, ::by_ref<::UnityEngine::Rendering::GPUPrefixSum_IndirectDirectArgs>  arguments) ;

/// @brief Method ExecuteCommonIndirect, addr 0x182047c90, size 0x390, virtual false, abstract: false, final false
inline void ExecuteCommonIndirect(::UnityEngine::Rendering::CommandBuffer*  cmdBuffer, ::UnityEngine::GraphicsBuffer*  inputBuffer, ::by_ref<::UnityEngine::Rendering::GPUPrefixSum_SupportResources>  supportResources, bool  isExclusive) ;

/// @brief Method PackPrefixSumArgs, addr 0x182048020, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 PackPrefixSumArgs(int32_t  a, int32_t  b, int32_t  c, int32_t  d) ;

/// @brief Method .ctor, addr 0x182048090, size 0xa0, virtual false, abstract: false, final false
