...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderBufferStoreAction, "UnityEngine.Rendering", "RenderBufferStoreAction");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Field DontCare value: I32(3)
...
/// @brief Field StoreAndResolve value: I32(2)
...
static_assert(offsetof(::UnityEngine::Rendering::RenderBufferStoreAction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderBufferStoreAction) == 0x4, "Size mismatch!");
