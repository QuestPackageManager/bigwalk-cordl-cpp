...
static_assert(sizeof(::UnityEngine::Rendering::LODGroupCullingData__transitionDistances_e__FixedBuffer) == 0x20, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "worldSpaceReferencePoint", ty: "::Unity::Mathematics::float3", modifiers: "", def_value: None }, CppParam { name: "lodCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "sqrDistances", ty: "::UnityEngine::Rendering::LODGroupCullingData__sqrDistances_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "transitionDistances", ty: "::UnityEngine::Rendering::LODGroupCullingData__transitionDistances_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "worldSpaceSize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "percentageFlags", ty: "::UnityEngine::Rendering::LODGroupCullingData__percentageFlags_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "forceLODMask", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr LODGroupCullingData(::Unity::Mathematics::float3  worldSpaceReferencePoint, int32_t  lodCount, ::UnityEngine::Rendering::LODGroupCullingData__sqrDistances_e__FixedBuffer  sqrDistances, ::UnityEngine::Rendering::LODGroupCullingData__transitionDistances_e__FixedBuffer  transitionDistances, float_t  worldSpaceSize, ::UnityEngine::Rendering::LODGroupCullingData__percentageFlags_e__FixedBuffer  percentageFlags, uint8_t  forceLODMask) noexcept;
