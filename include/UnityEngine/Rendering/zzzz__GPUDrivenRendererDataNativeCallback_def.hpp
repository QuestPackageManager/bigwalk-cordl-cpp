...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::GPUDrivenRendererDataNativeCallback*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUDrivenRendererDataNativeCallback*, "UnityEngine.Rendering", "GPUDrivenRendererDataNativeCallback");
...
inline void Invoke(::by_ref<::UnityEngine::Rendering::GPUDrivenRendererGroupDataNative>  rendererDataNative, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Mesh>>*  meshes, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>*  materials, ::UnityEngine::Rendering::GPUDrivenRendererDataCallback*  callback) ;
...
static_assert(sizeof(::UnityEngine::Rendering::GPUDrivenRendererDataNativeCallback) == 0x80, "Size mismatch!");
