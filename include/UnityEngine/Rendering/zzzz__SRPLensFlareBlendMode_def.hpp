...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SRPLensFlareBlendMode, "UnityEngine.Rendering", "SRPLensFlareBlendMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::SRPLensFlareBlendMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::SRPLensFlareBlendMode) == 0x4, "Size mismatch!");
