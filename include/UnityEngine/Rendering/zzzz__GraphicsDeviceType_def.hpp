...
static_assert(offsetof(::UnityEngine::Rendering::GraphicsDeviceType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::GraphicsDeviceType) == 0x4, "Size mismatch!");
