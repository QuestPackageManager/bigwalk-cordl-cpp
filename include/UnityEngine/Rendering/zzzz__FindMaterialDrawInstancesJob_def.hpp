...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FindMaterialDrawInstancesJob, "UnityEngine.Rendering", "FindMaterialDrawInstancesJob");
...
/// @brief Method Execute, addr 0x18209fac0, size 0xe0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "materialsSorted", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "drawInstances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>", modifiers: "", def_value: None }, CppParam { name: "outDrawInstanceIndicesWriter", ty: "::Unity::Collections::NativeList_1_ParallelWriter<int32_t>", modifiers: "", def_value: None }]
constexpr FindMaterialDrawInstancesJob(::Unity::Collections::NativeArray_1<uint32_t>  materialsSorted, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>  drawInstances, ::Unity::Collections::NativeList_1_ParallelWriter<int32_t>  outDrawInstanceIndicesWriter) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::FindMaterialDrawInstancesJob) == 0x20, "Size mismatch!");
