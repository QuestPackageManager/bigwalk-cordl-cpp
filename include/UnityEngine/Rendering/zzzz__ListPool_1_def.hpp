...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::ListPool_1);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::ListPool_1___c);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ListPool_1, "UnityEngine.Rendering", "ListPool`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ListPool_1___c, "UnityEngine.Rendering", "ListPool`1/<>c");
...
/// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::List_1<T>*> Get(::by_ref<::System::Collections::Generic::List_1<T>*>  value) ;
