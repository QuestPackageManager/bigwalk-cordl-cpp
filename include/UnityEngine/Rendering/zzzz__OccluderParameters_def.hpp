...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderParameters, "UnityEngine.Rendering", "OccluderParameters");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x182097f80, size 0xf0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "viewInstanceID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "subviewCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "depthTexture", ty: "::UnityEngine::Rendering::RenderGraphModule::TextureHandle", modifiers: "", def_value: None }, CppParam { name: "depthSize", ty: "::UnityEngine::Vector2Int", modifiers: "", def_value: None }, CppParam { name: "depthIsArray", ty: "bool", modifiers: "", def_value: None }]
constexpr OccluderParameters(int32_t  viewInstanceID, int32_t  subviewCount, ::UnityEngine::Rendering::RenderGraphModule::TextureHandle  depthTexture, ::UnityEngine::Vector2Int  depthSize, bool  depthIsArray) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderParameters) == 0x24, "Size mismatch!");
