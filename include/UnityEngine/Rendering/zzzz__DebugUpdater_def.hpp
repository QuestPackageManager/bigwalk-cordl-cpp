...
namespace UnityEngine::Rendering {
class DebugUpdater__RefreshRuntimeUINextFrame_d__14;
}
...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugUpdater*);
MARK_REF_T(::UnityEngine::Rendering::DebugUpdater__DoAfterInputModuleUpdated_d__9*);
MARK_REF_T(::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14*);
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14*, "UnityEngine.Rendering", "DebugUpdater/<RefreshRuntimeUINextFrame>d__14");
...
/// @brief Method MoveNext, addr 0x181ff51d0, size 0xa0, virtual true, abstract: false, final true
...
namespace UnityEngine::Rendering {
// Is value type: false
// CS Name: UnityEngine.Rendering.DebugUpdater/<RefreshRuntimeUINextFrame>d__14
class CORDL_TYPE DebugUpdater__RefreshRuntimeUINextFrame_d__14 : public ::System::Object {
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_System_Object__get_Current)) ::System::Object*  System_Collections_Generic_IEnumerator_System_Object__Current;
...
/// @brief Method MoveNext, addr 0x181ff5270, size 0xc0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14* New_ctor(int32_t  __1__state) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr DebugUpdater__RefreshRuntimeUINextFrame_d__14() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "DebugUpdater__RefreshRuntimeUINextFrame_d__14", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
DebugUpdater__RefreshRuntimeUINextFrame_d__14(DebugUpdater__RefreshRuntimeUINextFrame_d__14 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "DebugUpdater__RefreshRuntimeUINextFrame_d__14", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
DebugUpdater__RefreshRuntimeUINextFrame_d__14(DebugUpdater__RefreshRuntimeUINextFrame_d__14 const& ) = delete;
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14, _____2__current) == 0x18, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14) == 0x20, "Size mismatch!");
...
using _RefreshRuntimeUINextFrame_d__14 = ::UnityEngine::Rendering::DebugUpdater__RefreshRuntimeUINextFrame_d__14;
...
/// @brief Method CheckInputModuleExists, addr 0x181feefb0, size 0x50, virtual false, abstract: false, final false
inline void CheckInputModuleExists() ;

/// @brief Method CreateDebugEventSystem, addr 0x181fef000, size 0x40, virtual false, abstract: false, final false
inline void CreateDebugEventSystem() ;

/// @brief Method DestroyDebugEventSystem, addr 0x181fef040, size 0x70, virtual false, abstract: false, final false
inline void DestroyDebugEventSystem() ;

/// @brief Method DisableRuntime, addr 0x181fef0b0, size 0x100, virtual false, abstract: false, final false
static inline void DisableRuntime() ;

/// @brief Method DoAfterInputModuleUpdated, addr 0x181fef1b0, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DoAfterInputModuleUpdated(::System::Action*  action) ;

/// @brief Method EnableRuntime, addr 0x181fef200, size 0x100, virtual false, abstract: false, final false
static inline void EnableRuntime() ;

/// @brief Method EnsureExactlyOneEventSystem, addr 0x181fef300, size 0x130, virtual false, abstract: false, final false
inline void EnsureExactlyOneEventSystem() ;

/// @brief Method HandleInternalEventSystemComponents, addr 0x181fef430, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method RefreshRuntimeUINextFrame, addr 0x181fef5a0, size 0x20, virtual false, abstract: false, final false
static inline ::System::Collections::IEnumerator* RefreshRuntimeUINextFrame() ;

/// @brief Method RuntimeInit, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
static inline void RuntimeInit() ;

/// @brief Method SetEnabled, addr 0x181fef5c0, size 0x1f0, virtual false, abstract: false, final false
static inline void SetEnabled(bool  enabled) ;

/// @brief Method Update, addr 0x181fef7b0, size 0x3e0, virtual false, abstract: false, final false
inline void Update() ;
...
static_assert(sizeof(::UnityEngine::Rendering::DebugUpdater) == 0x28, "Size mismatch!");
