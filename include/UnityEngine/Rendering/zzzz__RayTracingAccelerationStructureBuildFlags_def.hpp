...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RayTracingAccelerationStructureBuildFlags, "UnityEngine.Rendering", "RayTracingAccelerationStructureBuildFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RayTracingAccelerationStructureBuildFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RayTracingAccelerationStructureBuildFlags) == 0x4, "Size mismatch!");
