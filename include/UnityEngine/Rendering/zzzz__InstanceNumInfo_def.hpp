...
static_assert(sizeof(::UnityEngine::Rendering::InstanceNumInfo__InstanceNums_e__FixedBuffer) == 0x8, "Size mismatch!");
...
/// @brief Method GetInstanceNum, addr 0x1809079a0, size 0x1b0, virtual false, abstract: false, final false
inline int32_t GetInstanceNum(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method GetInstanceNumIncludingChildren, addr 0x1820b0760, size 0xe0, virtual false, abstract: false, final false
inline int32_t GetInstanceNumIncludingChildren(::UnityEngine::Rendering::InstanceType  type) ;

/// @brief Method GetTotalInstanceNum, addr 0x1820b0840, size 0x20, virtual false, abstract: false, final false
inline int32_t GetTotalInstanceNum() ;

/// @brief Method InitDefault, addr 0x18035d7d0, size 0x20, virtual false, abstract: false, final false
inline void InitDefault() ;

/// @brief Method .ctor, addr 0x1820b0880, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  meshRendererNum, int32_t  speedTreeNum) ;

/// @brief Method .ctor, addr 0x1820b0860, size 0x20, virtual false, abstract: false, final false
