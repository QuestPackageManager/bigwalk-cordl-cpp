...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion, "UnityEngine.Rendering", "ProbeVolumeBakingProcessSettings/SettingsVersion");
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion) == 0x4, "Size mismatch!");
...
/// @brief Method SetDefaults, addr 0x182013800, size 0x70, virtual false, abstract: false, final false
inline void SetDefaults() ;

/// @brief Method Upgrade, addr 0x182013870, size 0x40, virtual false, abstract: false, final false
inline void Upgrade() ;

/// @brief Method .ctor, addr 0x1820138b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Default, addr 0x182013920, size 0x160, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Version", ty: "::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion", modifiers: "", def_value: None }, CppParam { name: "dilationSettings", ty: "::UnityEngine::Rendering::ProbeDilationSettings", modifiers: "", def_value: None }, CppParam { name: "virtualOffsetSettings", ty: "::UnityEngine::Rendering::VirtualOffsetSettings", modifiers: "", def_value: None }]
constexpr ProbeVolumeBakingProcessSettings(::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion  m_Version, ::UnityEngine::Rendering::ProbeDilationSettings  dilationSettings, ::UnityEngine::Rendering::VirtualOffsetSettings  virtualOffsetSettings) noexcept;
