...
/// @brief Method BitAnd, addr 0x18202f160, size 0x70, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitAnd(::UnityEngine::Rendering::IBitArray*  other) ;

/// @brief Method BitNot, addr 0x18202f1d0, size 0x40, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitNot() ;

/// @brief Method BitOr, addr 0x18202f210, size 0x70, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitOr(::UnityEngine::Rendering::IBitArray*  other) ;

/// @brief Method Equals, addr 0x18202f280, size 0x70, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x18202f2f0, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x18202f320, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x18202f3b0, size 0x30, virtual true, abstract: false, final true
inline bool get_Item(uint32_t  index) ;

/// @brief Method get_allFalse, addr 0x181649c50, size 0x50, virtual true, abstract: false, final true
inline bool get_allFalse() ;

/// @brief Method get_allTrue, addr 0x18202f3e0, size 0x20, virtual true, abstract: false, final true
inline bool get_allTrue() ;

/// @brief Method get_capacity, addr 0x1809018c0, size 0x20, virtual true, abstract: false, final true
inline uint32_t get_capacity() ;

/// @brief Method get_humanizedData, addr 0x18202f400, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method op_BitwiseAnd, addr 0x18202f4d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseOr, addr 0x18202f4e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_OnesComplement, addr 0x18202f4f0, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::BitArray64 op_OnesComplement(::UnityEngine::Rendering::BitArray64  a) ;

/// @brief Method set_Item, addr 0x18202f500, size 0x30, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::BitArray64) == 0x8, "Size mismatch!");
