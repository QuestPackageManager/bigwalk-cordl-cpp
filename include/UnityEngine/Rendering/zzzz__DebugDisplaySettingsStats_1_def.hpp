...
class DebugDisplaySettingsStats_1_StatsPanel;
}
namespace UnityEngine::Rendering {
template<typename TProfileId>
...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplaySettingsStats_1);
...
/// @brief Field <debugDisplayStats>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__debugDisplayStats_k__BackingField, put=__cordl_internal_set__debugDisplayStats_k__BackingField)) ::UnityEngine::Rendering::DebugDisplayStats_1<TProfileId>*  _debugDisplayStats_k__BackingField;
