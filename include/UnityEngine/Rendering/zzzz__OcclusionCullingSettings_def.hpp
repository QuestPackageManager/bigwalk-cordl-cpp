...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingSettings, "UnityEngine.Rendering", "OcclusionCullingSettings");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1820981f0, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "viewInstanceID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "occlusionTest", ty: "::UnityEngine::Rendering::OcclusionTest", modifiers: "", def_value: None }, CppParam { name: "instanceMultiplier", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingSettings) == 0xc, "Size mismatch!");
