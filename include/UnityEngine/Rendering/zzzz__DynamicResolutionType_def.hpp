...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DynamicResolutionType, "UnityEngine.Rendering", "DynamicResolutionType");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DynamicResolutionType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DynamicResolutionType) == 0x1, "Size mismatch!");
