...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ConstantBuffer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ConstantBuffer*, "UnityEngine.Rendering", "ConstantBuffer");
...
/// @brief Field m_RegisteredConstantBuffers, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_RegisteredConstantBuffers, put=setStaticF_m_RegisteredConstantBuffers)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ConstantBufferBase*>*  m_RegisteredConstantBuffers;
...
static inline void Push(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, ::by_ref<CBType>  data, ::UnityEngine::Material*  mat, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<CBType>  data, ::UnityEngine::ComputeShader*  cs, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<CBType>  data, ::UnityEngine::Material*  mat, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::UnityEngine::Rendering::IComputeCommandBuffer*  cmd, ::by_ref<CBType>  data, ::UnityEngine::ComputeShader*  cs, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::by_ref<CBType>  data, ::UnityEngine::ComputeShader*  cs, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::by_ref<CBType>  data, ::UnityEngine::Material*  mat, int32_t  shaderId) ;

/// @brief Method PushGlobal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void PushGlobal(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, ::by_ref<CBType>  data, int32_t  shaderId) ;

/// @brief Method PushGlobal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void PushGlobal(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<CBType>  data, int32_t  shaderId) ;

/// @brief Method PushGlobal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void PushGlobal(::by_ref<CBType>  data, int32_t  shaderId) ;

/// @brief Method Register, addr 0x181fd66b0, size 0x90, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::Rendering::ConstantBufferBase*  cb) ;

/// @brief Method ReleaseAll, addr 0x181fd6740, size 0xd0, virtual false, abstract: false, final false
...
template<typename CBType>
static inline void UpdateData(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, ::by_ref<CBType>  data) ;

/// @brief Method UpdateData, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void UpdateData(::UnityEngine::Rendering::CommandBuffer*  cmd, ::by_ref<CBType>  data) ;

/// @brief Method UpdateData, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void UpdateData(::by_ref<CBType>  data) ;
...
static_assert(sizeof(::UnityEngine::Rendering::ConstantBuffer) == 0x10, "Size mismatch!");
