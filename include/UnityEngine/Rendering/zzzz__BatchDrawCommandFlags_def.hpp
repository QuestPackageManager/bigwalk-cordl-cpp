...
static_assert(offsetof(::UnityEngine::Rendering::BatchDrawCommandFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BatchDrawCommandFlags) == 0x4, "Size mismatch!");
