...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugAction, "UnityEngine.Rendering", "DebugAction");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DebugAction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DebugAction) == 0x4, "Size mismatch!");
