...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OpaqueSortMode, "UnityEngine.Rendering", "OpaqueSortMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::OpaqueSortMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::OpaqueSortMode) == 0x4, "Size mismatch!");
