...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::CameraEventUtils*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CameraEventUtils*, "UnityEngine.Rendering", "CameraEventUtils");
...
public:
// Declarations
/// @brief Method IsValid, addr 0x18227d4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::CameraEventUtils) == 0x10, "Size mismatch!");
