...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ColorSpaceUtils*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ColorSpaceUtils*, "UnityEngine.Rendering", "ColorSpaceUtils");
...
static_assert(sizeof(::UnityEngine::Rendering::ColorSpaceUtils) == 0x10, "Size mismatch!");
