...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FilteringSettings, "UnityEngine.Rendering", "FilteringSettings");
...
/// @brief Method Equals, addr 0x1822a9060, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822a8ff0, size 0x70, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::FilteringSettings  other) ;

/// @brief Method GetHashCode, addr 0x1822a9130, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1822a9180, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_renderQueueRange, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1822a9220, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method set_batchLayerMask, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_batchLayerMask(uint32_t  value) ;

/// @brief Method set_excludeMotionVectorObjects, addr 0x1822a9290, size 0x20, virtual false, abstract: false, final false
inline void set_excludeMotionVectorObjects(bool  value) ;

/// @brief Method set_forceAllMotionVectorObjects, addr 0x1822a92b0, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_RenderQueueRange", ty: "::UnityEngine::Rendering::RenderQueueRange", modifiers: "", def_value: None }, CppParam { name: "m_LayerMask", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_RenderingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_BatchLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_ExcludeMotionVectorObjects", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ForceAllMotionVectorObjects", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_SortingLayerRange", ty: "::UnityEngine::Rendering::SortingLayerRange", modifiers: "", def_value: None }]
constexpr FilteringSettings(::UnityEngine::Rendering::RenderQueueRange  m_RenderQueueRange, int32_t  m_LayerMask, uint32_t  m_RenderingLayerMask, uint32_t  m_BatchLayerMask, int32_t  m_ExcludeMotionVectorObjects, int32_t  m_ForceAllMotionVectorObjects, ::UnityEngine::Rendering::SortingLayerRange  m_SortingLayerRange) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::FilteringSettings) == 0x20, "Size mismatch!");
