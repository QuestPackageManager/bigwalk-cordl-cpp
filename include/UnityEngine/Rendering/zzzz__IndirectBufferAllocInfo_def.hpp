...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IndirectBufferAllocInfo, "UnityEngine.Rendering", "IndirectBufferAllocInfo");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
// Declarations
/// @brief Method GetExtraDrawInfoSlotIndex, addr 0x1820af4a0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetExtraDrawInfoSlotIndex() ;

/// @brief Method IsEmpty, addr 0x1820af4c0, size 0x20, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method IsWithinLimits, addr 0x1820af4e0, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "drawAllocIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "drawCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "instanceAllocIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "instanceCount", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::IndirectBufferAllocInfo) == 0x10, "Size mismatch!");
