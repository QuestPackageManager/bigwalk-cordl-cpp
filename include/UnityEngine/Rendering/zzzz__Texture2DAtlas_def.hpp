...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Texture2DAtlas_BlitType, "UnityEngine.Rendering", "Texture2DAtlas/BlitType");
...
static_assert(offsetof(::UnityEngine::Rendering::Texture2DAtlas_BlitType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Texture2DAtlas_BlitType) == 0x4, "Size mismatch!");
...
/// @brief Method AddTexture, addr 0x18203e320, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method AllocateTexture, addr 0x18203e610, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method AllocateTextureWithoutBlit, addr 0x18203e410, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method AllocateTextureWithoutBlit, addr 0x18203e5b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Blit2DTexture, addr 0x18203e820, size 0x220, virtual false, abstract: false, final false
inline void Blit2DTexture(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Vector4  scaleOffset, ::UnityEngine::Texture*  texture, ::UnityEngine::Vector4  sourceScaleOffset, bool  blitMips, ::UnityEngine::Rendering::Texture2DAtlas_BlitType  blitType) ;

/// @brief Method BlitCubeTexture2D, addr 0x18203ea40, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method BlitOctahedralTexture, addr 0x18203eb60, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method BlitTexture, addr 0x18203ebd0, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method ClearTarget, addr 0x18203ed50, size 0x160, virtual false, abstract: false, final false
inline void ClearTarget(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method EnsureTextureSlot, addr 0x18203eeb0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method GetCachedTextureSize, addr 0x18203f070, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int GetCachedTextureSize(int32_t  id) ;

/// @brief Method GetTextureHash, addr 0x18203f0b0, size 0x40, virtual false, abstract: false, final false
inline int32_t GetTextureHash(::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method GetTextureID, addr 0x18203f130, size 0x10, virtual false, abstract: false, final false
inline int32_t GetTextureID(::UnityEngine::Texture*  texture) ;

/// @brief Method GetTextureID, addr 0x18203f0f0, size 0x40, virtual false, abstract: false, final false
inline int32_t GetTextureID(::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method GetTextureMipmapCount, addr 0x18203f140, size 0x30, virtual false, abstract: false, final false
inline int32_t GetTextureMipmapCount(int32_t  width, int32_t  height) ;

/// @brief Method Is2D, addr 0x18203f170, size 0x90, virtual false, abstract: false, final false
inline bool Is2D(::UnityEngine::Texture*  texture) ;

/// @brief Method IsCached, addr 0x18203f280, size 0x40, virtual false, abstract: false, final false
inline bool IsCached(::by_ref<::UnityEngine::Vector4>  scaleOffset, int32_t  id) ;

/// @brief Method IsCached, addr 0x18203f2c0, size 0x60, virtual false, abstract: false, final false
inline bool IsCached(::by_ref<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Texture*  texture) ;

/// @brief Method IsCached, addr 0x18203f200, size 0x80, virtual false, abstract: false, final false
inline bool IsCached(::by_ref<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method IsSingleChannelBlit, addr 0x18203f320, size 0x220, virtual false, abstract: false, final false
inline bool IsSingleChannelBlit(::UnityEngine::Texture*  source, ::UnityEngine::Texture*  destination) ;

/// @brief Method MarkGPUTextureInvalid, addr 0x18203f540, size 0x20, virtual false, abstract: false, final false
inline void MarkGPUTextureInvalid(int32_t  instanceId) ;

/// @brief Method MarkGPUTextureValid, addr 0x18203f560, size 0x20, virtual false, abstract: false, final false
inline void MarkGPUTextureValid(int32_t  instanceId, bool  mipAreValid) ;

/// @brief Method NeedsUpdate, addr 0x18203f580, size 0xa0, virtual true, abstract: false, final false
inline bool NeedsUpdate(int32_t  id, int32_t  updateCount, bool  needMips) ;

/// @brief Method NeedsUpdate, addr 0x18203f8d0, size 0x180, virtual true, abstract: false, final false
inline bool NeedsUpdate(::UnityEngine::Texture*  texture, bool  needMips) ;

/// @brief Method NeedsUpdate, addr 0x18203f620, size 0x2b0, virtual true, abstract: false, final false
...
/// @brief Method Release, addr 0x18203fa50, size 0x80, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method ResetAllocator, addr 0x18203fad0, size 0x70, virtual false, abstract: false, final false
inline void ResetAllocator() ;

/// @brief Method UpdateTexture, addr 0x18203fb40, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method UpdateTexture, addr 0x18203fd30, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18203fe30, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method get_AtlasTexture, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_AtlasTexture() ;

/// @brief Method get_maxMipLevelPadding, addr 0x182040140, size 0x40, virtual false, abstract: false, final false
