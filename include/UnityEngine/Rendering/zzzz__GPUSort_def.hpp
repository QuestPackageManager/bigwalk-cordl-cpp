...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort_Stage, "UnityEngine.Rendering", "GPUSort/Stage");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort, "UnityEngine.Rendering", "GPUSort");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort_Args, "UnityEngine.Rendering", "GPUSort/Args");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort_RenderGraphResources, "UnityEngine.Rendering", "GPUSort/RenderGraphResources");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort_SupportResources, "UnityEngine.Rendering", "GPUSort/SupportResources");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUSort_SystemResources, "UnityEngine.Rendering", "GPUSort/SystemResources");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
// Declarations
/// @brief Method Dispose, addr 0x18204dac0, size 0x70, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Load, addr 0x18204dd00, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "sortBufferKeys", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "sortBufferValues", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::GPUSort_SupportResources) == 0x10, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "count", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "maxDepth", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "inputKeys", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "inputValues", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "resources", ty: "::UnityEngine::Rendering::GPUSort_SupportResources", modifiers: "", def_value: None }, CppParam { name: "workGroupCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GPUSort_Args(uint32_t  count, uint32_t  maxDepth, ::UnityEngine::GraphicsBuffer*  inputKeys, ::UnityEngine::GraphicsBuffer*  inputValues, ::UnityEngine::Rendering::GPUSort_SupportResources  resources, int32_t  workGroupCount) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::GPUSort_Args) == 0x30, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Create, addr 0x18204caf0, size 0x1e0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUSort_RenderGraphResources Create(int32_t  count, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::RenderGraphModule::IBaseRenderGraphBuilder*  builder) ;

/// @brief Method Create, addr 0x18204c9f0, size 0x100, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUSort_RenderGraphResources Create(int32_t  count, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphBuilder  builder) ;

// Ctor Parameters []
// @brief default ctor
constexpr GPUSort_RenderGraphResources() ;

// Ctor Parameters [CppParam { name: "sortBufferKeys", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }, CppParam { name: "sortBufferValues", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::GPUSort_RenderGraphResources) == 0x18, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::GPUSort_Stage, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CopyBuffer, addr 0x182048130, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x182048490, size 0x260, virtual false, abstract: false, final false
inline void Dispatch(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::GPUSort_Args  args) ;

/// @brief Method Dispatch, addr 0x1820486f0, size 0xb0, virtual false, abstract: false, final false
inline void Dispatch(::UnityEngine::Rendering::IComputeCommandBuffer*  cmd, ::UnityEngine::Rendering::GPUSort_Args  args) ;

/// @brief Method DispatchStage, addr 0x1820482b0, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820487a0, size 0x1b0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Keywords", ty: "::ArrayW<::UnityEngine::Rendering::LocalKeyword>", modifiers: "", def_value: None }, CppParam { name: "resources", ty: "::UnityEngine::Rendering::GPUSort_SystemResources", modifiers: "", def_value: None }]
