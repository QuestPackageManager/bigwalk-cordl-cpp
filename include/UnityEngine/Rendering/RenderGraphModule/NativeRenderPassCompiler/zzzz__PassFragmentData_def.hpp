...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x18207ba80, size 0x70, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method SameSubResource, addr 0x182087310, size 0x20, virtual false, abstract: false, final false
static inline bool SameSubResource(::by_ref<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassFragmentData>  x, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassFragmentData>  y) ;

/// @brief Method .ctor, addr 0x182087330, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle, ::UnityEngine::Rendering::RenderGraphModule::AccessFlags  flags, int32_t  mipLevel, int32_t  depthSlice) ;
