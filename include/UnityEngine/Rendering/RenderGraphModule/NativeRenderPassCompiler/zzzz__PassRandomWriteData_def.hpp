...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassRandomWriteData, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "PassRandomWriteData");
...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x182087370, size 0x40, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1820873b0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  resource, int32_t  index, bool  preserveCounterValue) ;
