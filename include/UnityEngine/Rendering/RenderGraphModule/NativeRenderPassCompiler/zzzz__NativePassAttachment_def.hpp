...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassAttachment, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "NativePassAttachment");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x182084630, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle, ::UnityEngine::Rendering::RenderBufferLoadAction  loadAction, ::UnityEngine::Rendering::RenderBufferStoreAction  storeAction, bool  memoryless, int32_t  mipLevel, int32_t  depthSlice) ;

// Ctor Parameters []
// @brief default ctor
constexpr NativePassAttachment() ;

// Ctor Parameters [CppParam { name: "handle", ty: "::UnityEngine::Rendering::RenderGraphModule::ResourceHandle", modifiers: "", def_value: None }, CppParam { name: "loadAction", ty: "::UnityEngine::Rendering::RenderBufferLoadAction", modifiers: "", def_value: None }, CppParam { name: "storeAction", ty: "::UnityEngine::Rendering::RenderBufferStoreAction", modifiers: "", def_value: None }, CppParam { name: "memoryless", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "mipLevel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "depthSlice", ty: "int32_t", modifiers: "", def_value: None }]
constexpr NativePassAttachment(::UnityEngine::Rendering::RenderGraphModule::ResourceHandle  handle, ::UnityEngine::Rendering::RenderBufferLoadAction  loadAction, ::UnityEngine::Rendering::RenderBufferStoreAction  storeAction, bool  memoryless, int32_t  mipLevel, int32_t  depthSlice) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassAttachment) == 0x20, "Size mismatch!");
