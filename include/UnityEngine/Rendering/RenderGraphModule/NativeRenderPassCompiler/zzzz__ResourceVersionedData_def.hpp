...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::ResourceVersionedData, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "ResourceVersionedData");
// Dependencies 
namespace UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler {
// Is value type: true
...
public:
// Declarations
/// @brief Method RegisterReadingPass, addr 0x182087680, size 0xc0, virtual false, abstract: false, final false
inline void RegisterReadingPass(Il2CppObject*  ctx, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  h, int32_t  passId, int32_t  index) ;

/// @brief Method RemoveReadingPass, addr 0x182066eb0, size 0x100, virtual false, abstract: false, final false
inline void RemoveReadingPass(Il2CppObject*  ctx, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  h, int32_t  passId) ;

/// @brief Method SetWritingPass, addr 0x182066fb0, size 0x10, virtual false, abstract: false, final false
inline void SetWritingPass(Il2CppObject*  ctx, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  h, int32_t  passId) ;

// Ctor Parameters []
// @brief default ctor
constexpr ResourceVersionedData() ;

// Ctor Parameters [CppParam { name: "written", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "writePassId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "numReaders", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::ResourceVersionedData) == 0xc, "Size mismatch!");
