...
/// @brief Method IsValid, addr 0x1804bda20, size 0x10, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method .ctor, addr 0x182079d10, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  handle, ::UnityEngine::Rendering::RenderGraphModule::RendererListHandleType  type) ;

/// @brief Method get_handle, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
inline int32_t get_handle() ;

/// @brief Method op_Implicit, addr 0x182079d30, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method set_handle, addr 0x1804bd900, size 0x10, virtual false, abstract: false, final false
