...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*, "UnityEngine.Rendering.RenderGraphModule", "ComputeGraphContext");
...
/// @brief Method FromInternalContext, addr 0x182052780, size 0xb0, virtual true, abstract: false, final true
inline void FromInternalContext(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  context) ;

/// @brief Method GetTextureUVOrigin, addr 0x182052830, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IDerivedRendergraphContext.GetTextureUVOrigin, addr 0x182052830, size 0x50, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::RenderGraphModule::TextureUVOrigin UnityEngine_Rendering_RenderGraphModule_IDerivedRendergraphContext_GetTextureUVOrigin(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  textureHandle) ;
...
/// @brief Method get_defaultResources, addr 0x1820528e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources() ;

/// @brief Method get_renderGraphPool, addr 0x1820528f0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext) == 0x20, "Size mismatch!");
