...
constexpr ::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version  UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version::Initial{static_cast<int32_t>(0x0)};
constexpr ::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version  UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version::Count{static_cast<int32_t>(0x1)};
constexpr ::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version  UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version::Latest{static_cast<int32_t>(0x0)};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::*)()>(&::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::UnityEngine_Rendering_IRenderPipelineGraphicsSettings_get_version)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x180303b50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityW<::UnityEngine::Shader> (::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::*)()>(&::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::get_coreCopyPS)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::*)(::UnityEngine::Shader*)>(&::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::set_coreCopyPS)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x182077410;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources*>(),
                        {"set_coreCopyPS", {}, {::i2c::type_of<::UnityEngine::Shader*>()}}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::*)()>(&::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::_ctor)> {
  constexpr static std::size_t size = 0x10;
...
constexpr ::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version& UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::__cordl_internal_get_m_Version()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Version;
}
constexpr ::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version const& UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::__cordl_internal_get_m_Version() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Version;
}
constexpr void UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::__cordl_internal_set_m_Version(::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources*>());
}
...
constexpr ::UnityEngine::Rendering::IRenderPipelineResources* UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::i___UnityEngine__Rendering__IRenderPipelineResources() noexcept {
return static_cast<::UnityEngine::Rendering::IRenderPipelineResources*>(static_cast<void*>(this));
}
...
constexpr ::UnityEngine::Rendering::IRenderPipelineGraphicsSettings* UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources::i___UnityEngine__Rendering__IRenderPipelineGraphicsSettings() noexcept {
return static_cast<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>(static_cast<void*>(this));
}
// Ctor Parameters []
