...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphProfileId, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphProfileId");
// Dependencies 
namespace UnityEngine::Rendering::RenderGraphModule {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphProfileId, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphProfileId) == 0x4, "Size mismatch!");
