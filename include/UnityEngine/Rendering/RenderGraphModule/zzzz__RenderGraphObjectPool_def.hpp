...
MARK_REF_T(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase*);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPool_1);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::RenderGraphModule::SharedObjectPool_1_RenderGraphObjectPool___c);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPoolBase");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPool_1, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPool`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::RenderGraphModule::SharedObjectPool_1_RenderGraphObjectPool___c, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPool`1/<>c");
...
/// @brief Field m_AllocatedArrays, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocatedArrays, put=__cordl_internal_set_m_AllocatedArrays)) ::System::Collections::Generic::List_1<::System::ValueTuple_2<::System::Object*,::System::ValueTuple_2<::System::Type*,int32_t>>>*  m_AllocatedArrays;

/// @brief Field m_AllocatedMaterialPropertyBlocks, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocatedMaterialPropertyBlocks, put=__cordl_internal_set_m_AllocatedMaterialPropertyBlocks)) ::System::Collections::Generic::List_1<::UnityEngine::MaterialPropertyBlock*>*  m_AllocatedMaterialPropertyBlocks;

/// @brief Field m_ArrayPool, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ArrayPool, put=__cordl_internal_set_m_ArrayPool)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::System::Collections::Generic::Stack_1<::System::Object*>*>*  m_ArrayPool;

/// @brief Field s_AllocatedPools, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_AllocatedPools, put=setStaticF_s_AllocatedPools)) ::UnityEngine::Rendering::DynamicArray_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase*>*  s_AllocatedPools;

/// @brief Method Cleanup, addr 0x182071bd0, size 0x100, virtual false, abstract: false, final false
inline void Cleanup() ;
...
template<typename T>
inline ::ArrayW<T> GetTempArray(int32_t  size) ;

/// @brief Method GetTempMaterialPropertyBlock, addr 0x182071cd0, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::MaterialPropertyBlock* GetTempMaterialPropertyBlock() ;

/// @brief Method IsEmpty, addr 0x182071d80, size 0x20, virtual false, abstract: false, final false
inline bool IsEmpty() ;
...
/// @brief Method ReleaseAllTempAlloc, addr 0x182071da0, size 0x1a0, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::System::Collections::Generic::Stack_1<::System::Object*>*>* const& __cordl_internal_get_m_ArrayPool() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::System::Collections::Generic::Stack_1<::System::Object*>*>*& __cordl_internal_get_m_ArrayPool() ;
...
constexpr void __cordl_internal_set_m_ArrayPool(::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::System::Collections::Generic::Stack_1<::System::Object*>*>*  value) ;

/// @brief Method .ctor, addr 0x182071fa0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool) == 0x28, "Size mismatch!");
