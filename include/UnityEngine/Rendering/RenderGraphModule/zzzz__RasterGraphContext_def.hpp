...
/// @brief Method FromInternalContext, addr 0x182054300, size 0xb0, virtual true, abstract: false, final true
inline void FromInternalContext(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  context) ;

/// @brief Method GetTextureUVOrigin, addr 0x1820543b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IDerivedRendergraphContext.GetTextureUVOrigin, addr 0x1820543b0, size 0x60, virtual true, abstract: false, final true
