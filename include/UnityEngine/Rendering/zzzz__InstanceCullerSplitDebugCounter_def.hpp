...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::InstanceCullerSplitDebugCounter, "UnityEngine.Rendering", "InstanceCullerSplitDebugCounter");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::InstanceCullerSplitDebugCounter, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::InstanceCullerSplitDebugCounter) == 0x4, "Size mismatch!");
