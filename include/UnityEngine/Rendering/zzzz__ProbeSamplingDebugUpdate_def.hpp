...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeSamplingDebugUpdate, "UnityEngine.Rendering", "ProbeSamplingDebugUpdate");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeSamplingDebugUpdate, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ProbeSamplingDebugUpdate) == 0x4, "Size mismatch!");
