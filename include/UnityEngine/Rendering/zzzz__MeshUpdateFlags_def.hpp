...
static_assert(offsetof(::UnityEngine::Rendering::MeshUpdateFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::MeshUpdateFlags) == 0x4, "Size mismatch!");
