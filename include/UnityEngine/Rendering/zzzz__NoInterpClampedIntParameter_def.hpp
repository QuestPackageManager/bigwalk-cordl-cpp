...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::NoInterpClampedIntParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::NoInterpClampedIntParameter*, "UnityEngine.Rendering", "NoInterpClampedIntParameter");
...
/// @brief Method .ctor, addr 0x182042030, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_value, addr 0x182042070, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpClampedIntParameter) == 0x28, "Size mismatch!");
