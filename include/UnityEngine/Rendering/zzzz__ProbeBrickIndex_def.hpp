...
/// @brief Method Equals, addr 0x18200b2e0, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ProbeBrickIndex_Brick  other) ;

/// @brief Method IntersectArea, addr 0x18200b360, size 0x290, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickIndex_Brick) == 0x10, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "firstChunkIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "numberOfChunks", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minSubdivInCell", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minValidBrickIndexForCellAtMaxRes", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: None }, CppParam { name: "maxValidBrickIndexForCellAtMaxResPlusOne", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: None }, CppParam { name: "entryPositionInBricksAtMaxRes", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: None }, CppParam { name: "hasOnlyBiggerBricks", ty: "bool", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo) == 0x34, "Size mismatch!");
...
public:
// Declarations
/// @brief Method GetNumberOfChunks, addr 0x18200bcf0, size 0x280, virtual false, abstract: false, final false
...
/// @brief Field entriesInfo, offset: 0x0, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>  entriesInfo;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickIndex_CellIndexUpdateInfo) == 0x8, "Size mismatch!");
...
/// @brief Method AddBricks, addr 0x18200f450, size 0x3d0, virtual false, abstract: false, final false
inline void AddBricks(::UnityEngine::Rendering::ProbeReferenceVolume_CellIndexInfo*  cellInfo, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::ProbeBrickIndex_Brick>  bricks, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ProbeBrickPool_BrickChunkAlloc>*  allocations, int32_t  allocationSize, int32_t  poolWidth, int32_t  poolHeight) ;

/// @brief Method BrickOverlapEntry, addr 0x18200f820, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x18200f860, size 0x60, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x18200f8c0, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeFragmentationRate, addr 0x18200f920, size 0x70, virtual false, abstract: false, final false
inline void ComputeFragmentationRate() ;

/// @brief Method FindSlotsForEntries, addr 0x18200f990, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method GetDebugFragmentationBuffer, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetDebugFragmentationBuffer() ;

/// @brief Method GetNumberOfChunks, addr 0x18200fc00, size 0x30, virtual false, abstract: false, final false
inline int32_t GetNumberOfChunks(int32_t  brickCount) ;

/// @brief Method GetRemainingChunkCount, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetRemainingChunkCount() ;

/// @brief Method GetRuntimeResources, addr 0x18200fc30, size 0xe0, virtual false, abstract: false, final false
inline void GetRuntimeResources(::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method LocationToIndex, addr 0x18200fd10, size 0x10, virtual false, abstract: false, final false
static inline int32_t LocationToIndex(int32_t  x, int32_t  y, int32_t  z, ::UnityEngine::Vector3Int  sizeOfValid) ;

/// @brief Method MarkBrickInPhysicalBuffer, addr 0x18200fd20, size 0x380, virtual false, abstract: false, final false
inline void MarkBrickInPhysicalBuffer(::by_ref<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>  entry, ::UnityEngine::Vector3Int  brickMin, ::UnityEngine::Vector3Int  brickMax, int32_t  brickSubdivLevel, int32_t  entrySubdivLevel, int32_t  idx) ;

/// @brief Method MergeIndex, addr 0x1820100a0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method RemoveBricks, addr 0x1820100c0, size 0xc0, virtual false, abstract: false, final false
inline void RemoveBricks(::UnityEngine::Rendering::ProbeReferenceVolume_CellIndexInfo*  cellInfo) ;

/// @brief Method ReserveChunks, addr 0x182010180, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SizeOfPhysicalIndexFromBudget, addr 0x182010230, size 0x30, virtual false, abstract: false, final false
inline int32_t SizeOfPhysicalIndexFromBudget(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method UpdateDebugData, addr 0x182010260, size 0x110, virtual false, abstract: false, final false
inline void UpdateDebugData() ;

/// @brief Method UploadIndexData, addr 0x182010370, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820103d0, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method get_estimatedVMemCost, addr 0x180503b40, size 0x10, virtual false, abstract: false, final false
inline int32_t get_estimatedVMemCost() ;

/// @brief Method get_fragmentationRate, addr 0x18046fae0, size 0x10, virtual false, abstract: false, final false
inline float_t get_fragmentationRate() ;

/// @brief Method set_estimatedVMemCost, addr 0x180503ba0, size 0x10, virtual false, abstract: false, final false
inline void set_estimatedVMemCost(int32_t  value) ;

/// @brief Method set_fragmentationRate, addr 0x18046fb20, size 0x10, virtual false, abstract: false, final false
