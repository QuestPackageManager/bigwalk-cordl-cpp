...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DepthBits, "UnityEngine.Rendering", "DepthBits");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DepthBits, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DepthBits) == 0x4, "Size mismatch!");
