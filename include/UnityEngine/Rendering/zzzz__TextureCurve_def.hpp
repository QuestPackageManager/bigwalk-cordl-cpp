...
/// @brief Method AddKey, addr 0x18204ea30, size 0x30, virtual false, abstract: false, final false
inline int32_t AddKey(float_t  time, float_t  value) ;

/// @brief Method Dispose, addr 0x18204ea60, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Evaluate, addr 0x18204eac0, size 0x200, virtual false, abstract: false, final false
inline float_t Evaluate(float_t  time) ;

/// @brief Method GetTexture, addr 0x18204ed20, size 0x1a0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> GetTexture() ;

/// @brief Method GetTextureFormat, addr 0x18204ecc0, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetTextureFormat() ;

/// @brief Method MoveKey, addr 0x18204eec0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x18204ea60, size 0x60, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method RemoveKey, addr 0x18204ef10, size 0x30, virtual false, abstract: false, final false
inline void RemoveKey(int32_t  index) ;

/// @brief Method SetDirty, addr 0x18204ef40, size 0x10, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SmoothTangents, addr 0x18204ef50, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18204ef80, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AnimationCurve*  baseCurve, float_t  zeroValue, bool  loop, ::by_ref<::UnityEngine::Vector2>  bounds) ;

/// @brief Method .ctor, addr 0x18204f040, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::Keyframe>  keys, float_t  zeroValue, bool  loop, ::by_ref<::UnityEngine::Vector2>  bounds) ;

/// @brief Method get_Item, addr 0x18204f0f0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::TextureCurve) == 0x40, "Size mismatch!");
