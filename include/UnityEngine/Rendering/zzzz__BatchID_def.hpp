...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchID, "UnityEngine.Rendering", "BatchID");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Equals, addr 0x18228ddd0, size 0x70, virtual true, abstract: false, final false
...
static inline bool op_Equality(::UnityEngine::Rendering::BatchID  a, ::UnityEngine::Rendering::BatchID  b) ;

/// @brief Method op_Inequality, addr 0x1805a8350, size 0x10, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::Rendering::BatchID  a, ::UnityEngine::Rendering::BatchID  b) ;
...
static_assert(sizeof(::UnityEngine::Rendering::BatchID) == 0x4, "Size mismatch!");
