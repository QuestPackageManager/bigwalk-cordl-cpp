...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingDebugOutput, "UnityEngine.Rendering", "OcclusionCullingDebugOutput");
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingDebugOutput) == 0xb0, "Size mismatch!");
