...
static_assert(offsetof(::UnityEngine::Rendering::BlendMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BlendMode) == 0x4, "Size mismatch!");
