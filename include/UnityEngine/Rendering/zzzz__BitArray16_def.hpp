...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BitArray16, "UnityEngine.Rendering", "BitArray16");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method BitAnd, addr 0x18202e060, size 0x70, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitAnd(::UnityEngine::Rendering::IBitArray*  other) ;

/// @brief Method BitNot, addr 0x18202e0d0, size 0x40, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitNot() ;

/// @brief Method BitOr, addr 0x18202e110, size 0x70, virtual true, abstract: false, final true
inline ::UnityEngine::Rendering::IBitArray* BitOr(::UnityEngine::Rendering::IBitArray*  other) ;

/// @brief Method Equals, addr 0x18202e180, size 0x70, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x18202e1f0, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x18202e220, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x18202e2b0, size 0x30, virtual true, abstract: false, final true
inline bool get_Item(uint32_t  index) ;

/// @brief Method get_allFalse, addr 0x1813b2000, size 0xb220, virtual true, abstract: false, final true
inline bool get_allFalse() ;

/// @brief Method get_allTrue, addr 0x18202e2e0, size 0x20, virtual true, abstract: false, final true
inline bool get_allTrue() ;

/// @brief Method get_capacity, addr 0x180720990, size 0xd7f0, virtual true, abstract: false, final true
inline uint32_t get_capacity() ;

/// @brief Method get_humanizedData, addr 0x18202e300, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method op_BitwiseAnd, addr 0x18202e3d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseOr, addr 0x18202e3e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_OnesComplement, addr 0x18202e3f0, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::BitArray16 op_OnesComplement(::UnityEngine::Rendering::BitArray16  a) ;

/// @brief Method set_Item, addr 0x18202e400, size 0x30, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::BitArray16) == 0x2, "Size mismatch!");
