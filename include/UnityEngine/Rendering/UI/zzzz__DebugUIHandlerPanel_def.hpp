...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerPanel*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerPanel*, "UnityEngine.Rendering.UI", "DebugUIHandlerPanel");
...
/// @brief Method GetFirstItem, addr 0x1820806b0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetFirstItem() ;

/// @brief Method GetPanel, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Panel* GetPanel() ;

/// @brief Method GetYPosInScroll, addr 0x182080700, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x182080860, size 0x80, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnScrollbarClicked, addr 0x1820808e0, size 0x20, virtual false, abstract: false, final false
inline void OnScrollbarClicked() ;

/// @brief Method ResetDebugManager, addr 0x182080900, size 0x20, virtual false, abstract: false, final false
inline void ResetDebugManager() ;

/// @brief Method SelectNextItem, addr 0x182080920, size 0x50, virtual false, abstract: false, final false
inline void SelectNextItem() ;

/// @brief Method SelectPreviousItem, addr 0x182080970, size 0x50, virtual false, abstract: false, final false
inline void SelectPreviousItem() ;

/// @brief Method SetPanel, addr 0x1820809c0, size 0x50, virtual false, abstract: false, final false
inline void SetPanel(::UnityEngine::Rendering::DebugUI_Panel*  panel) ;

/// @brief Method SetScrollTarget, addr 0x1802f8080, size 0x10, virtual false, abstract: false, final false
inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  target) ;

/// @brief Method UpdateScroll, addr 0x182080a10, size 0x170, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerPanel) == 0x68, "Size mismatch!");
