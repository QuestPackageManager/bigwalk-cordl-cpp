...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerValue*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerValue*, "UnityEngine.Rendering.UI", "DebugUIHandlerValue");
...
/// @brief Method OnEnable, addr 0x182082ba0, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSelection, addr 0x18207f090, size 0x60, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x182082bb0, size 0x60, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Update, addr 0x182082c10, size 0x160, virtual false, abstract: false, final false
inline void Update() ;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerValue) == 0x80, "Size mismatch!");
