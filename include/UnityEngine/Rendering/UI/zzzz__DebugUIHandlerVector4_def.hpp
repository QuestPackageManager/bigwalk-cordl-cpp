...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerVector4*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerVector4*, "UnityEngine.Rendering.UI", "DebugUIHandlerVector4");
...
/// @brief Method Next, addr 0x182083b10, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method OnSelection, addr 0x182083bc0, size 0xa0, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetValue, addr 0x182083c60, size 0xd0, virtual false, abstract: false, final false
inline void SetValue(float_t  v, bool  x, bool  y, bool  z, bool  w) ;

/// @brief Method SetWidget, addr 0x182083d30, size 0x340, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method SetupSettings, addr 0x182084070, size 0xf0, virtual false, abstract: false, final false
inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*  field) ;

/// @brief Method <SetWidget>b__8_0, addr 0x182084160, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_0() ;

/// @brief Method <SetWidget>b__8_1, addr 0x182084190, size 0x90, virtual false, abstract: false, final false
inline void _SetWidget_b__8_1(float_t  x) ;

/// @brief Method <SetWidget>b__8_2, addr 0x182084220, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_2() ;

/// @brief Method <SetWidget>b__8_3, addr 0x182084250, size 0x90, virtual false, abstract: false, final false
inline void _SetWidget_b__8_3(float_t  x) ;

/// @brief Method <SetWidget>b__8_4, addr 0x1820842e0, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_4() ;

/// @brief Method <SetWidget>b__8_5, addr 0x182084310, size 0x90, virtual false, abstract: false, final false
inline void _SetWidget_b__8_5(float_t  x) ;

/// @brief Method <SetWidget>b__8_6, addr 0x1820843a0, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_6() ;

/// @brief Method <SetWidget>b__8_7, addr 0x1820843d0, size 0x90, virtual false, abstract: false, final false
inline void _SetWidget_b__8_7(float_t  x) ;

/// @brief Method <SetupSettings>b__10_0, addr 0x182084460, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__10_0() ;

/// @brief Method <SetupSettings>b__10_1, addr 0x182084470, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__10_1() ;

/// @brief Method <SetupSettings>b__10_2, addr 0x182084480, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerVector4) == 0xa0, "Size mismatch!");
