...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerFoldout*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerFoldout*, "UnityEngine.Rendering.UI", "DebugUIHandlerFoldout");
...
/// @brief Method Next, addr 0x18207f1e0, size 0xa0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next() ;

/// @brief Method OnAction, addr 0x18207f280, size 0x50, virtual true, abstract: false, final false
inline void OnAction() ;

/// @brief Method OnDecrement, addr 0x18207f2d0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method OnIncrement, addr 0x18207f320, size 0x50, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method OnSelection, addr 0x18207f370, size 0x90, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x18207f400, size 0x3a0, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValue, addr 0x18207f7a0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerFoldout) == 0x80, "Size mismatch!");
