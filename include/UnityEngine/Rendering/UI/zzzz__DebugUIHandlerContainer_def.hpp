...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerContainer*);
...
/// @brief Method <IsDirectChild>b__0, addr 0x182088220, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerContainer___c__DisplayClass3_0) == 0x18, "Size mismatch!");
...
/// @brief Method GetActiveChildren, addr 0x18207e3e0, size 0x230, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>>* GetActiveChildren() ;

/// @brief Method GetFirstItem, addr 0x18207e610, size 0x40, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetFirstItem() ;

/// @brief Method GetLastItem, addr 0x18207e650, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetLastItem() ;

/// @brief Method IsDirectChild, addr 0x18207e6a0, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerContainer) == 0x28, "Size mismatch!");
