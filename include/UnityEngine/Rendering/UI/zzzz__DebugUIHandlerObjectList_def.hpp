...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerObjectList*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerObjectList*, "UnityEngine.Rendering.UI", "DebugUIHandlerObjectList");
...
/// @brief Method OnDecrement, addr 0x182080380, size 0x20, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnIncrement, addr 0x1820803a0, size 0x20, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method SetWidget, addr 0x1820803c0, size 0x30, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x1820803f0, size 0xa0, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerObjectList) == 0x90, "Size mismatch!");
