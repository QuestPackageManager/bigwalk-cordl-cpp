...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerButton*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerButton*, "UnityEngine.Rendering.UI", "DebugUIHandlerButton");
...
/// @brief Method OnAction, addr 0x18207c0d0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method SetWidget, addr 0x18207c130, size 0x60, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerButton) == 0x70, "Size mismatch!");
