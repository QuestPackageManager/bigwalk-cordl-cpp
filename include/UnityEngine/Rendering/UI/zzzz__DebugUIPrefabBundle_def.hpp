...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIPrefabBundle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIPrefabBundle*, "UnityEngine.Rendering.UI", "DebugUIPrefabBundle");
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIPrefabBundle) == 0x20, "Size mismatch!");
