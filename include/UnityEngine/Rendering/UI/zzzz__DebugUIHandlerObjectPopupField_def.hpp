...
/// @brief Method ChangeSelectedObject, addr 0x182080490, size 0xc0, virtual false, abstract: false, final false
inline void ChangeSelectedObject() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerObjectPopupField* New_ctor() ;

/// @brief Method OnDecrement, addr 0x182080550, size 0x10, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnIncrement, addr 0x182080560, size 0x10, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method SetWidget, addr 0x182080570, size 0x30, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x1820805a0, size 0x60, virtual true, abstract: false, final false
