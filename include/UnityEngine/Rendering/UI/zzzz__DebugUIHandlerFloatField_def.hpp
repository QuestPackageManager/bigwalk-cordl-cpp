...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField*, "UnityEngine.Rendering.UI", "DebugUIHandlerFloatField");
...
/// @brief Method ChangeValue, addr 0x18207eed0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method OnDecrement, addr 0x18207ef50, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method OnIncrement, addr 0x18207f020, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method SetWidget, addr 0x18207f0f0, size 0x70, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x18207f160, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerFloatField) == 0x78, "Size mismatch!");
