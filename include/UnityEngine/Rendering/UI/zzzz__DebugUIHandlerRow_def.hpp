...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerRow*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerRow*, "UnityEngine.Rendering.UI", "DebugUIHandlerRow");
...
/// @brief Method GetChild, addr 0x182081600, size 0xb0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> GetChild(int32_t  index) ;

/// @brief Method IsActive, addr 0x1820816b0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method TryGetChild, addr 0x182081770, size 0x40, virtual false, abstract: false, final false
inline bool TryGetChild(int32_t  index, ::by_ref<::UnityEngine::GameObject*>  child) ;

/// @brief Method Update, addr 0x1820817b0, size 0x430, virtual false, abstract: false, final false
inline void Update() ;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerRow) == 0x88, "Size mismatch!");
