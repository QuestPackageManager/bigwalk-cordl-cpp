...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerVector3*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerVector3*, "UnityEngine.Rendering.UI", "DebugUIHandlerVector3");
...
/// @brief Method Next, addr 0x182083390, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method OnSelection, addr 0x182083440, size 0xa0, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetValue, addr 0x1820834e0, size 0xb0, virtual false, abstract: false, final false
inline void SetValue(float_t  v, bool  x, bool  y, bool  z) ;

/// @brief Method SetWidget, addr 0x182083590, size 0x280, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method SetupSettings, addr 0x182083810, size 0xf0, virtual false, abstract: false, final false
inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*  field) ;

/// @brief Method <SetWidget>b__7_0, addr 0x182083900, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__7_0() ;

/// @brief Method <SetWidget>b__7_1, addr 0x182083930, size 0x70, virtual false, abstract: false, final false
inline void _SetWidget_b__7_1(float_t  v) ;

/// @brief Method <SetWidget>b__7_2, addr 0x1820839a0, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__7_2() ;

/// @brief Method <SetWidget>b__7_3, addr 0x1820839d0, size 0x70, virtual false, abstract: false, final false
inline void _SetWidget_b__7_3(float_t  v) ;

/// @brief Method <SetWidget>b__7_4, addr 0x182083a40, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__7_4() ;

/// @brief Method <SetWidget>b__7_5, addr 0x182083a70, size 0x70, virtual false, abstract: false, final false
inline void _SetWidget_b__7_5(float_t  v) ;

/// @brief Method <SetupSettings>b__9_0, addr 0x182083ae0, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__9_0() ;

/// @brief Method <SetupSettings>b__9_1, addr 0x182083af0, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__9_1() ;

/// @brief Method <SetupSettings>b__9_2, addr 0x182083b00, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerVector3) == 0x98, "Size mismatch!");
