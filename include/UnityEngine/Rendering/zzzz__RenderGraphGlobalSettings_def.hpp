...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphGlobalSettings_Version, "UnityEngine.Rendering", "RenderGraphGlobalSettings/Version");
...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphGlobalSettings_Version, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderGraphGlobalSettings_Version) == 0x4, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1820269d0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_enableCompilationCaching, addr 0x18039e7b0, size 0x10, virtual false, abstract: false, final false
inline bool get_enableCompilationCaching() ;

/// @brief Method get_enableValidityChecks, addr 0x1804e67f0, size 0x10, virtual false, abstract: false, final false
inline bool get_enableValidityChecks() ;

/// @brief Convert to "::UnityEngine::Rendering::IRenderPipelineGraphicsSettings"
constexpr ::UnityEngine::Rendering::IRenderPipelineGraphicsSettings* i___UnityEngine__Rendering__IRenderPipelineGraphicsSettings() noexcept;

/// @brief Method set_enableCompilationCaching, addr 0x1820269e0, size 0x30, virtual false, abstract: false, final false
inline void set_enableCompilationCaching(bool  value) ;

/// @brief Method set_enableValidityChecks, addr 0x182026a10, size 0x30, virtual false, abstract: false, final false
