...
public:
// Declarations
/// @brief Method flattenIndex, addr 0x18200b2c0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickPool_BrickChunkAlloc) == 0xc, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Cleanup, addr 0x18200d120, size 0x170, virtual false, abstract: false, final false
inline void Cleanup() ;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickPool_DataLocation) == 0x68, "Size mismatch!");
...
/// @brief Method Allocate, addr 0x182010690, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method AllocatePool, addr 0x1820105a0, size 0xf0, virtual false, abstract: false, final false
inline void AllocatePool(int32_t  width, int32_t  height, int32_t  depth) ;

/// @brief Method Cleanup, addr 0x182010880, size 0x10, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x182010890, size 0x30, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateDataLocation, addr 0x1820108c0, size 0x520, virtual false, abstract: false, final false
...
/// @brief Method CreateDataTexture, addr 0x182010de0, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method Deallocate, addr 0x182011020, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method DerivePoolSizeFromBudget, addr 0x1820110d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method EnsureTextureValidity, addr 0x182011130, size 0xc0, virtual false, abstract: false, final false
inline bool EnsureTextureValidity(bool  renderingLayers, bool  skyOcclusion, bool  skyDirection, bool  probeOcclusion) ;

/// @brief Method EnsureTextureValidity, addr 0x1820110e0, size 0x50, virtual false, abstract: false, final false
inline void EnsureTextureValidity() ;

/// @brief Method EstimateMemoryCost, addr 0x1820112d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method EstimateMemoryCostForBlending, addr 0x1820111f0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetChunkCount, addr 0x182011310, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetChunkCount(int32_t  brickCount) ;

/// @brief Method GetChunkSizeInBrickCount, addr 0x180901990, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetChunkSizeInBrickCount() ;

/// @brief Method GetChunkSizeInProbeCount, addr 0x180908cc0, size 0x510, virtual false, abstract: false, final false
static inline int32_t GetChunkSizeInProbeCount() ;

/// @brief Method GetPoolDimensions, addr 0x182011320, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int GetPoolDimensions() ;

/// @brief Method GetPoolHeight, addr 0x18051e7a0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPoolHeight() ;

/// @brief Method GetPoolWidth, addr 0x1803fa740, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPoolWidth() ;

/// @brief Method GetProbeOcclusionTexture, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetProbeOcclusionTexture() ;

/// @brief Method GetRemainingChunkCount, addr 0x1805d4740, size 0x10, virtual false, abstract: false, final false
inline int32_t GetRemainingChunkCount() ;

/// @brief Method GetRuntimeResources, addr 0x182011340, size 0x660, virtual false, abstract: false, final false
inline void GetRuntimeResources(::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method GetSkyOcclusionTexture, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetSkyOcclusionTexture() ;

/// @brief Method GetSkyShadingDirectionIndicesTexture, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetSkyShadingDirectionIndicesTexture() ;

/// @brief Method GetValidityTexture, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetValidityTexture() ;

/// @brief Method Initialize, addr 0x1820119a0, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method ProbeCountToDataLocSize, addr 0x182011d20, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3Int ProbeCountToDataLocSize(int32_t  numProbes) ;

/// @brief Method Update, addr 0x182011f70, size 0x730, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x1820126a0, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method UpdateValidity, addr 0x182011da0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182012dc0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_estimatedVMemCost, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_estimatedVMemCost, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
