...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderStateBlock, "UnityEngine.Rendering", "RenderStateBlock");
...
/// @brief Method Equals, addr 0x1822aef30, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822aed40, size 0x1f0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RenderStateBlock  other) ;

/// @brief Method GetHashCode, addr 0x1822af000, size 0x100, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1822af100, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RenderStateMask  mask) ;

/// @brief Method get_mask, addr 0x1803d5ab0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderStateMask get_mask() ;

/// @brief Method get_stencilReference, addr 0x180de9ef0, size 0x60, virtual false, abstract: false, final false
inline int32_t get_stencilReference() ;

/// @brief Method get_stencilState, addr 0x1822af230, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_blendState, addr 0x1822af280, size 0x70, virtual false, abstract: false, final false
inline void set_blendState(::UnityEngine::Rendering::BlendState  value) ;

/// @brief Method set_depthState, addr 0x1822af2f0, size 0x20, virtual false, abstract: false, final false
inline void set_depthState(::UnityEngine::Rendering::DepthState  value) ;

/// @brief Method set_mask, addr 0x1803d5ac0, size 0x10, virtual false, abstract: false, final false
inline void set_mask(::UnityEngine::Rendering::RenderStateMask  value) ;

/// @brief Method set_rasterState, addr 0x1822af310, size 0x40, virtual false, abstract: false, final false
inline void set_rasterState(::UnityEngine::Rendering::RasterState  value) ;

/// @brief Method set_stencilReference, addr 0x180de9f50, size 0xe0, virtual false, abstract: false, final false
inline void set_stencilReference(int32_t  value) ;

/// @brief Method set_stencilState, addr 0x1822af350, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BlendState", ty: "::UnityEngine::Rendering::BlendState", modifiers: "", def_value: None }, CppParam { name: "m_RasterState", ty: "::UnityEngine::Rendering::RasterState", modifiers: "", def_value: None }, CppParam { name: "m_DepthState", ty: "::UnityEngine::Rendering::DepthState", modifiers: "", def_value: None }, CppParam { name: "m_StencilState", ty: "::UnityEngine::Rendering::StencilState", modifiers: "", def_value: None }, CppParam { name: "m_StencilReference", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Mask", ty: "::UnityEngine::Rendering::RenderStateMask", modifiers: "", def_value: None }]
constexpr RenderStateBlock(::UnityEngine::Rendering::BlendState  m_BlendState, ::UnityEngine::Rendering::RasterState  m_RasterState, ::UnityEngine::Rendering::DepthState  m_DepthState, ::UnityEngine::Rendering::StencilState  m_StencilState, int32_t  m_StencilReference, ::UnityEngine::Rendering::RenderStateMask  m_Mask) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderStateBlock) == 0x6c, "Size mismatch!");
