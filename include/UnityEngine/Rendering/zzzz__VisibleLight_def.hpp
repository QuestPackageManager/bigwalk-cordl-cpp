...
// Dependencies UnityEngine.Color, UnityEngine.LightType, UnityEngine.Matrix4x4, UnityEngine.Rect, UnityEngine.Rendering.VisibleLightFlags, UnityEngine.Vector2
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Equals, addr 0x1822b6a60, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822b6830, size 0x230, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::VisibleLight  other) ;

/// @brief Method GetHashCode, addr 0x1822b6b30, size 0x190, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_finalColor, addr 0x180a178d0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_finalColor() ;

/// @brief Method get_light, addr 0x1822b6cc0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Light> get_light() ;

/// @brief Method get_lightType, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LightType get_lightType() ;

/// @brief Method get_localToWorldMatrix, addr 0x1822b6d10, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_range, addr 0x18046fad0, size 0x10, virtual false, abstract: false, final false
inline float_t get_range() ;

/// @brief Method get_spotAngle, addr 0x18034f9d0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_LightType", ty: "::UnityEngine::LightType", modifiers: "", def_value: None }, CppParam { name: "m_FinalColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "m_ScreenRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "m_LocalToWorldMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_Range", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SpotAngle", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_InnerSpotAngle", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_AreaSize", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "m_InstanceId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::Rendering::VisibleLightFlags", modifiers: "", def_value: None }]
constexpr VisibleLight(::UnityEngine::LightType  m_LightType, ::UnityEngine::Color  m_FinalColor, ::UnityEngine::Rect  m_ScreenRect, ::UnityEngine::Matrix4x4  m_LocalToWorldMatrix, float_t  m_Range, float_t  m_SpotAngle, float_t  m_InnerSpotAngle, ::UnityEngine::Vector2  m_AreaSize, int32_t  m_InstanceId, ::UnityEngine::Rendering::VisibleLightFlags  m_Flags) noexcept;
...
/// @brief Field m_InnerSpotAngle, offset: 0x6c, size: 0x4, def value: None
 float_t  m_InnerSpotAngle;

/// @brief Field m_AreaSize, offset: 0x70, size: 0x8, def value: None
 ::UnityEngine::Vector2  m_AreaSize;

/// @brief Field m_InstanceId, offset: 0x78, size: 0x4, def value: None
 int32_t  m_InstanceId;

/// @brief Field m_Flags, offset: 0x7c, size: 0x4, def value: None
...
static_assert(offsetof(::UnityEngine::Rendering::VisibleLight, m_InnerSpotAngle) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::VisibleLight, m_AreaSize) == 0x70, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::VisibleLight, m_InstanceId) == 0x78, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::VisibleLight, m_Flags) == 0x7c, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::VisibleLight) == 0x80, "Size mismatch!");
