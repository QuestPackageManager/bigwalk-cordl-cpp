...
/// @brief Field obsoleteHasProbeVolumes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_obsoleteHasProbeVolumes, put=__cordl_internal_set_obsoleteHasProbeVolumes)) ::UnityEngine::Rendering::SerializedDictionary_2<::StringW,bool>*  obsoleteHasProbeVolumes;

/// @brief Field obsoleteSceneBounds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_obsoleteSceneBounds, put=__cordl_internal_set_obsoleteSceneBounds)) ::UnityEngine::Rendering::SerializedDictionary_2<::StringW,::UnityEngine::Bounds>*  obsoleteSceneBounds;
...
/// @brief Method SetParentObject, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeSceneData) == 0x28, "Size mismatch!");
