...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::CPUDrawInstanceData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CPUDrawInstanceData*, "UnityEngine.Rendering", "CPUDrawInstanceData");
...
/// @brief Method DestroyDrawInstanceIndices, addr 0x18209bc30, size 0x90, virtual false, abstract: false, final false
inline void DestroyDrawInstanceIndices(::Unity::Collections::NativeArray_1<int32_t>  drawInstanceIndicesToDestroy) ;

/// @brief Method DestroyDrawInstances, addr 0x18209bcc0, size 0x200, virtual false, abstract: false, final false
inline void DestroyDrawInstances(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  destroyedInstances) ;

/// @brief Method DestroyMaterialDrawInstances, addr 0x18209bec0, size 0x200, virtual false, abstract: false, final false
inline void DestroyMaterialDrawInstances(::Unity::Collections::NativeArray_1<uint32_t>  destroyedBatchMaterials) ;

/// @brief Method Dispose, addr 0x18209c0c0, size 0xb0, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Initialize, addr 0x18209c170, size 0x160, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method NeedsRebuild, addr 0x181537080, size 0x10, virtual false, abstract: false, final false
inline void NeedsRebuild() ;

static inline ::UnityEngine::Rendering::CPUDrawInstanceData* New_ctor() ;

/// @brief Method RebuildDrawListsIfNeeded, addr 0x18209c2d0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method get_batchHash, addr 0x180a26490, size 0x12a0, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t> get_batchHash() ;

/// @brief Method get_drawBatchIndices, addr 0x18209c4a0, size 0x20, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<int32_t> get_drawBatchIndices() ;

/// @brief Method get_drawBatches, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch> get_drawBatches() ;

/// @brief Method get_drawInstanceIndices, addr 0x1814d83f0, size 0x50, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<int32_t> get_drawInstanceIndices() ;

/// @brief Method get_drawInstances, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance> get_drawInstances() ;

/// @brief Method get_drawRanges, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawRange> get_drawRanges() ;

/// @brief Method get_rangeHash, addr 0x1802e5810, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::RangeKey,int32_t> get_rangeHash() ;

/// @brief Method get_valid, addr 0x18209c4c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::CPUDrawInstanceData) == 0x60, "Size mismatch!");
