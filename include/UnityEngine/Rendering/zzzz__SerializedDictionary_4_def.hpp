...
class SerializedDictionary_4;
}
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::SerializedDictionary_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::SerializedDictionary_4, "UnityEngine.Rendering", "SerializedDictionary`4");
