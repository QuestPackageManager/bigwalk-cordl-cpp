...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GraphicsTier, "UnityEngine.Rendering", "GraphicsTier");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::GraphicsTier, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::GraphicsTier) == 0x4, "Size mismatch!");
