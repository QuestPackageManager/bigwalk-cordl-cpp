...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShaderPropertyFlags, "UnityEngine.Rendering", "ShaderPropertyFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ShaderPropertyFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ShaderPropertyFlags) == 0x4, "Size mismatch!");
