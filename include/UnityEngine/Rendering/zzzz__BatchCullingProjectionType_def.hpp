...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchCullingProjectionType, "UnityEngine.Rendering", "BatchCullingProjectionType");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::BatchCullingProjectionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BatchCullingProjectionType) == 0x4, "Size mismatch!");
