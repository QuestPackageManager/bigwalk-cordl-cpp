...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugOccluderStats, "UnityEngine.Rendering", "DebugOccluderStats");
...
static_assert(sizeof(::UnityEngine::Rendering::DebugOccluderStats) == 0x10, "Size mismatch!");
