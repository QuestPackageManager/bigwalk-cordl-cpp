...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugDisplaySettingsUI*);
...
/// @brief Field panels, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_panels, put=__cordl_internal_set_panels)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IDebugDisplaySettingsPanelDisposable*>*  panels;

static inline ::UnityEngine::Rendering::DebugDisplaySettingsUI___c__DisplayClass3_0* New_ctor() ;

/// @brief Method <RegisterDebug>b__0, addr 0x181ff5aa0, size 0x1d0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::DebugDisplaySettingsUI___c__DisplayClass3_0) == 0x20, "Size mismatch!");
...
/// @brief Field m_DisposablePanels, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DisposablePanels, put=__cordl_internal_set_m_DisposablePanels)) ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Rendering::IDebugDisplaySettingsPanelDisposable*>*  m_DisposablePanels;
...
/// @brief Method GetReset, addr 0x181fe7910, size 0x40, virtual true, abstract: false, final true
inline ::System::Action* GetReset() ;

static inline ::UnityEngine::Rendering::DebugDisplaySettingsUI* New_ctor() ;

/// @brief Method RegisterDebug, addr 0x181fe7950, size 0x2a0, virtual false, abstract: false, final false
inline void RegisterDebug(::UnityEngine::Rendering::IDebugDisplaySettings*  settings) ;

/// @brief Method Reset, addr 0x181fe7bf0, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method UnregisterDebug, addr 0x181fe7c70, size 0x3e0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::DebugDisplaySettingsUI) == 0x20, "Size mismatch!");
