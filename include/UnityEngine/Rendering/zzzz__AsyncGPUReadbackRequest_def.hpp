...
/// @brief Method GetDataRaw, addr 0x18227cc40, size 0x20, virtual false, abstract: false, final false
inline ::System::IntPtr GetDataRaw(int32_t  layer) ;

/// @brief Method GetLayerCount, addr 0x18227cc60, size 0x20, virtual false, abstract: false, final false
inline int32_t GetLayerCount() ;

/// @brief Method GetLayerDataSize, addr 0x18227cc80, size 0x20, virtual false, abstract: false, final false
inline int32_t GetLayerDataSize() ;

/// @brief Method HasError, addr 0x18227cca0, size 0x20, virtual false, abstract: false, final false
inline bool HasError() ;

/// @brief Method InvokeCallback, addr 0x180ccb9e0, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method IsDone, addr 0x18227ccc0, size 0x10, virtual false, abstract: false, final false
inline bool IsDone() ;

/// @brief Method SetScriptingCallback, addr 0x18227ccd0, size 0x20, virtual false, abstract: false, final false
inline void SetScriptingCallback(::System::Action_1<::UnityEngine::Rendering::AsyncGPUReadbackRequest>*  callback) ;

/// @brief Method WaitForCompletion, addr 0x18227ccf0, size 0x20, virtual false, abstract: false, final false
inline void WaitForCompletion() ;

/// @brief Method get_done, addr 0x18227ccc0, size 0x10, virtual false, abstract: false, final false
inline bool get_done() ;

/// @brief Method get_hasError, addr 0x18227cca0, size 0x20, virtual false, abstract: false, final false
inline bool get_hasError() ;

/// @brief Method get_layerCount, addr 0x18227cc60, size 0x20, virtual false, abstract: false, final false
inline int32_t get_layerCount() ;

/// @brief Method get_layerDataSize, addr 0x18227cc80, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::AsyncGPUReadbackRequest) == 0x10, "Size mismatch!");
