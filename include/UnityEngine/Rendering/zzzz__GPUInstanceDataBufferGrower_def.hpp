...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUInstanceDataBufferGrower_GPUResources, "UnityEngine.Rendering", "GPUInstanceDataBufferGrower/GPUResources");
...
/// @brief Method CreateResources, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CreateResources() ;

/// @brief Method Dispose, addr 0x181bc8a70, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method LoadShaders, addr 0x1820a1a70, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::GPUInstanceDataBufferGrower_GPUResources) == 0x10, "Size mismatch!");
...
/// @brief Method SubmitToGpu, addr 0x1820a0680, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820a0930, size 0x210, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_SrcBuffer", ty: "::UnityEngine::Rendering::GPUInstanceDataBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_DstBuffer", ty: "::UnityEngine::Rendering::GPUInstanceDataBuffer*", modifiers: "", def_value: None }]
