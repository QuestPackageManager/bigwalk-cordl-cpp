...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::OccluderContext_ShaderIDs*);
MARK_VAL_T(::UnityEngine::Rendering::OccluderContext);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderContext_ShaderIDs*, "UnityEngine.Rendering", "OccluderContext/ShaderIDs");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderContext, "UnityEngine.Rendering", "OccluderContext");
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderContext_ShaderIDs) == 0x10, "Size mismatch!");

} // namespace end def UnityEngine::Rendering
// Dependencies Unity.Collections.NativeArray`1<T>, UnityEngine.Rendering.OccluderDepthPyramidConstants, UnityEngine.Rendering.OccluderDerivedData, UnityEngine.Rendering.OccluderMipBounds, UnityEngine.Vector2Int
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method AllocateTexturesIfNecessary, addr 0x1820b20b0, size 0x250, virtual false, abstract: false, final false
inline void AllocateTexturesIfNecessary(bool  debugOverlayEnabled) ;

/// @brief Method CreateFarDepthPyramid, addr 0x1820b2300, size 0x560, virtual false, abstract: false, final false
inline void CreateFarDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates, ::by_ref<::UnityEngine::Rendering::OccluderHandles>  occluderHandles, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  silhouettePlanes, ::UnityEngine::ComputeShader*  occluderDepthPyramidCS, int32_t  occluderDepthDownscaleKernel) ;

/// @brief Method Dispose, addr 0x1820b2860, size 0xd0, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method Import, addr 0x1820b2930, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method PrepareOccluders, addr 0x1820b2a80, size 0xb0, virtual false, abstract: false, final false
inline void PrepareOccluders(::by_ref<::UnityEngine::Rendering::OccluderParameters>  occluderParams) ;

/// @brief Method SetKeyword, addr 0x1820b2b30, size 0x50, virtual false, abstract: false, final false
static inline void SetKeyword(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::UnityEngine::ComputeShader*  cs, ::by_ref<::UnityEngine::Rendering::LocalKeyword>  keyword, bool  value) ;

/// @brief Method SetupFarDepthPyramidConstants, addr 0x1814d00e0, size 0x890, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OccluderDepthPyramidConstants SetupFarDepthPyramidConstants(::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  silhouettePlanes) ;
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderContext) == 0x80, "Size mismatch!");
