...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderTargetFlags, "UnityEngine.Rendering", "RenderTargetFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RenderTargetFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderTargetFlags) == 0x4, "Size mismatch!");
