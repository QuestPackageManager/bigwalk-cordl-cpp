...
/// @brief Field m_StreamableCellDescs, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_StreamableCellDescs, put=__cordl_internal_set_m_StreamableCellDescs)) ::UnityEngine::Rendering::SerializedDictionary_2<int32_t,::UnityEngine::Rendering::ProbeVolumeStreamableAsset_StreamableCellDesc>*  m_StreamableCellDescs;

 __declspec(property(get=get_streamableCellDescs)) ::UnityEngine::Rendering::SerializedDictionary_2<int32_t,::UnityEngine::Rendering::ProbeVolumeStreamableAsset_StreamableCellDesc>*  streamableCellDescs;

/// @brief Method CloseFile, addr 0x182026190, size 0x80, virtual false, abstract: false, final false
inline void CloseFile() ;

/// @brief Method Dispose, addr 0x182026210, size 0x70, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FileExists, addr 0x182026280, size 0xa0, virtual false, abstract: false, final false
inline bool FileExists() ;

/// @brief Method GetAssetPath, addr 0x182026320, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetAssetPath() ;

/// @brief Method GetFileSize, addr 0x1820263a0, size 0x50, virtual false, abstract: false, final false
inline int64_t GetFileSize() ;

/// @brief Method HasValidAssetReference, addr 0x1820263f0, size 0x40, virtual false, abstract: false, final false
inline bool HasValidAssetReference() ;

/// @brief Method IsOpen, addr 0x182026430, size 0x10, virtual false, abstract: false, final false
inline bool IsOpen() ;

/// @brief Method IsValid, addr 0x182026440, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;

static inline ::UnityEngine::Rendering::ProbeVolumeStreamableAsset* New_ctor(::StringW  apvStreamingAssetsPath, ::UnityEngine::Rendering::SerializedDictionary_2<int32_t,::UnityEngine::Rendering::ProbeVolumeStreamableAsset_StreamableCellDesc>*  cellDescs, int32_t  elementSize, ::StringW  bakingSetGUID, ::StringW  assetGUID) ;

/// @brief Method OpenFile, addr 0x182026460, size 0x60, virtual false, abstract: false, final false
inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFile() ;

/// @brief Method RefreshAssetPath, addr 0x1820264c0, size 0x70, virtual false, abstract: false, final false
...
constexpr ::UnityEngine::Rendering::SerializedDictionary_2<int32_t,::UnityEngine::Rendering::ProbeVolumeStreamableAsset_StreamableCellDesc>* const& __cordl_internal_get_m_StreamableCellDescs() const;
...
/// @brief Method .ctor, addr 0x182026530, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::StringW  apvStreamingAssetsPath, ::UnityEngine::Rendering::SerializedDictionary_2<int32_t,::UnityEngine::Rendering::ProbeVolumeStreamableAsset_StreamableCellDesc>*  cellDescs, int32_t  elementSize, ::StringW  bakingSetGUID, ::StringW  assetGUID) ;

/// @brief Method get_asset, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::TextAsset> get_asset() ;

/// @brief Method get_assetGUID, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_assetGUID() ;

/// @brief Method get_elementSize, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_elementSize() ;

/// @brief Method get_streamableCellDescs, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
