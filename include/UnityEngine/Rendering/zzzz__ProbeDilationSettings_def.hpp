...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeDilationSettings, "UnityEngine.Rendering", "ProbeDilationSettings");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
// Declarations
/// @brief Method SetDefaults, addr 0x182012ec0, size 0x80, virtual false, abstract: false, final false
inline void SetDefaults() ;

/// @brief Method UpgradeFromTo, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeDilationSettings) == 0x14, "Size mismatch!");
