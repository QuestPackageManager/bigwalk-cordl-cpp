...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderersBatchersContextDesc, "UnityEngine.Rendering", "RenderersBatchersContextDesc");
...
public:
// Declarations
/// @brief Method NewDefault, addr 0x1820b7010, size 0x90, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "instanceNumInfo", ty: "::UnityEngine::Rendering::InstanceNumInfo", modifiers: "", def_value: None }, CppParam { name: "supportDitheringCrossFade", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "enableBoundingSpheresInstanceData", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "smallMeshScreenPercentage", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "enableCullerDebugStats", ty: "bool", modifiers: "", def_value: None }]
constexpr RenderersBatchersContextDesc(::UnityEngine::Rendering::InstanceNumInfo  instanceNumInfo, bool  supportDitheringCrossFade, bool  enableBoundingSpheresInstanceData, float_t  smallMeshScreenPercentage, bool  enableCullerDebugStats) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderersBatchersContextDesc) == 0x14, "Size mismatch!");
