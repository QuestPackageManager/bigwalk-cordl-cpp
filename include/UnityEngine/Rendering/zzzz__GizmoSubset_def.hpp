...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GizmoSubset, "UnityEngine.Rendering", "GizmoSubset");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Field PostImageEffects value: I32(1)
static ::UnityEngine::Rendering::GizmoSubset const PostImageEffects;

/// @brief Field PreImageEffects value: I32(0)
...
static_assert(offsetof(::UnityEngine::Rendering::GizmoSubset, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::GizmoSubset) == 0x4, "Size mismatch!");
