...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderSubviewUpdate, "UnityEngine.Rendering", "OccluderSubviewUpdate");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x182098070, size 0x180, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "subviewIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "depthSliceIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "depthOffset", ty: "::UnityEngine::Vector2Int", modifiers: "", def_value: None }, CppParam { name: "viewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "invViewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "gpuProjMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "viewOffsetWorldSpace", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }]
constexpr OccluderSubviewUpdate(int32_t  subviewIndex, int32_t  depthSliceIndex, ::UnityEngine::Vector2Int  depthOffset, ::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  invViewMatrix, ::UnityEngine::Matrix4x4  gpuProjMatrix, ::UnityEngine::Vector3  viewOffsetWorldSpace) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderSubviewUpdate) == 0xdc, "Size mismatch!");
