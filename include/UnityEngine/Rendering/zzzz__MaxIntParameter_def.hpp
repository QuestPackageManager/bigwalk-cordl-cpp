...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::MaxIntParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MaxIntParameter*, "UnityEngine.Rendering", "MaxIntParameter");
...
static_assert(sizeof(::UnityEngine::Rendering::MaxIntParameter) == 0x28, "Size mismatch!");
