...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IBaseCommandBuffer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IBaseCommandBuffer*, "UnityEngine.Rendering", "IBaseCommandBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: false
