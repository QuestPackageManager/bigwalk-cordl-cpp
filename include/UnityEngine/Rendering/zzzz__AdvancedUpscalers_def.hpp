...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AdvancedUpscalers, "UnityEngine.Rendering", "AdvancedUpscalers");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::AdvancedUpscalers, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::AdvancedUpscalers) == 0x1, "Size mismatch!");
