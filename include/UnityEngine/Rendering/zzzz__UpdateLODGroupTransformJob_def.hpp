...
// Dependencies Unity.Collections.LowLevel.Unsafe.UnsafeAtomicCounter32, Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1<T>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.EntityId, UnityEngine.Rendering.GPUInstanceIndex, UnityEngine.Rendering.LODGroupCullingData, UnityEngine.Rendering.LODGroupData, UnityEngine.Vector3
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x1820bb960, size 0x230, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "lodGroupDataHash", ty: "::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>", modifiers: "", def_value: None }, CppParam { name: "lodGroupIDs", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::EntityId>", modifiers: "", def_value: None }, CppParam { name: "worldSpaceReferencePoints", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "worldSpaceSizes", ty: "::Unity::Collections::NativeArray_1<float_t>", modifiers: "", def_value: None }, CppParam { name: "requiresGPUUpload", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "supportDitheringCrossFade", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "lodGroupData", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupData>", modifiers: "", def_value: None }, CppParam { name: "lodGroupCullingData", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>", modifiers: "", def_value: None }, CppParam { name: "atomicUpdateCount", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeAtomicCounter32", modifiers: "", def_value: None }]
constexpr UpdateLODGroupTransformJob(::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>  lodGroupDataHash, ::Unity::Collections::NativeArray_1<::UnityEngine::EntityId>  lodGroupIDs, ::Unity::Collections::NativeArray_1<::UnityEngine::Vector3>  worldSpaceReferencePoints, ::Unity::Collections::NativeArray_1<float_t>  worldSpaceSizes, bool  requiresGPUUpload, bool  supportDitheringCrossFade, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupData>  lodGroupData, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>  lodGroupCullingData, ::Unity::Collections::LowLevel::Unsafe::UnsafeAtomicCounter32  atomicUpdateCount) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::UpdateLODGroupTransformJob) == 0x60, "Size mismatch!");
