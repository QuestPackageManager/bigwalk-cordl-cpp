...
/// @brief Method <RenderDebugOccluderOverlay>b__32_0, addr 0x1820bac10, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method <RenderDebugOcclusionTestOverlay>b__29_0, addr 0x1820bad80, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method <UpdateInstanceOccluders>b__37_0, addr 0x1820baf10, size 0x4a0, virtual false, abstract: false, final false
...
/// @brief Method CreateFarDepthPyramid, addr 0x1820b2d00, size 0x1d0, virtual false, abstract: false, final false
inline void CreateFarDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates, ::by_ref<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method DeleteContext, addr 0x1820b2ed0, size 0x150, virtual false, abstract: false, final false
inline void DeleteContext(int32_t  viewInstanceID) ;

/// @brief Method DispatchDebugClear, addr 0x1820b3020, size 0x2e0, virtual false, abstract: false, final false
inline void DispatchDebugClear(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, int32_t  viewInstanceID) ;

/// @brief Method Dispose, addr 0x1820b3300, size 0x1f0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetOccluderContext, addr 0x1820b34f0, size 0x120, virtual false, abstract: false, final false
inline bool GetOccluderContext(int32_t  viewInstanceID, ::by_ref<::UnityEngine::Rendering::OccluderContext>  occluderContext) ;

/// @brief Method GetOcclusionTestDebugOutput, addr 0x1820b3610, size 0x180, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OcclusionCullingDebugOutput GetOcclusionTestDebugOutput(int32_t  viewInstanceID) ;

/// @brief Method HasOccluderContext, addr 0x1820b3790, size 0x10, virtual false, abstract: false, final false
inline bool HasOccluderContext(int32_t  viewInstanceID) ;

/// @brief Method Init, addr 0x1820b37a0, size 0x310, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Rendering::GPUResidentDrawerResources*  resources) ;

/// @brief Method NewContext, addr 0x1820b3ab0, size 0x1d0, virtual false, abstract: false, final false
inline int32_t NewContext(int32_t  viewInstanceID) ;

static inline ::UnityEngine::Rendering::OcclusionCullingCommon* New_ctor() ;

/// @brief Method PrepareCulling, addr 0x1820b3c80, size 0x410, virtual false, abstract: false, final false
inline void PrepareCulling(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OccluderContext>  occluderCtx, ::by_ref<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::by_ref<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, ::by_ref<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, bool  useOcclusionDebug) ;

/// @brief Method PrepareOccluders, addr 0x1820b4090, size 0x410, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OccluderHandles PrepareOccluders(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::by_ref<::UnityEngine::Rendering::OccluderParameters>  occluderParams) ;

/// @brief Method RenderDebugOccluderOverlay, addr 0x1820b44a0, size 0x3f0, virtual false, abstract: false, final false
inline void RenderDebugOccluderOverlay(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  debugSettings, ::UnityEngine::Vector2  screenPos, float_t  maxHeight, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  colorBuffer) ;

/// @brief Method RenderDebugOcclusionTestOverlay, addr 0x1820b4890, size 0x5f0, virtual false, abstract: false, final false
inline void RenderDebugOcclusionTestOverlay(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  debugSettings, int32_t  viewInstanceID, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  colorBuffer) ;

/// @brief Method SetDebugPyramid, addr 0x1820b4e80, size 0x90, virtual false, abstract: false, final false
static inline void SetDebugPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, int32_t  kernel, ::by_ref<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method SetDepthPyramid, addr 0x1820b4f10, size 0x40, virtual false, abstract: false, final false
static inline void SetDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, int32_t  kernel, ::by_ref<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method UpdateFrame, addr 0x1820b4fe0, size 0x250, virtual false, abstract: false, final false
inline void UpdateFrame() ;

/// @brief Method UpdateInstanceOccluders, addr 0x1820b5230, size 0x5c0, virtual false, abstract: false, final false
inline bool UpdateInstanceOccluders(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::by_ref<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates) ;

/// @brief Method UpdateOccluderStats, addr 0x1820b57f0, size 0x1d0, virtual false, abstract: false, final false
inline void UpdateOccluderStats(::UnityEngine::Rendering::DebugRendererBatcherStats*  debugStats) ;

/// @brief Method UpdateSilhouettePlanes, addr 0x1820b59c0, size 0x30, virtual false, abstract: false, final false
inline void UpdateSilhouettePlanes(int32_t  viewInstanceID, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  planes) ;

/// @brief Method UseOcclusionDebug, addr 0x1820b59f0, size 0x10, virtual false, abstract: false, final false
static inline bool UseOcclusionDebug(::by_ref<::UnityEngine::Rendering::OccluderContext>  occluderCtx) ;

/// @brief Method <RenderDebugOcclusionTestOverlay>b__29_1, addr 0x1820b4f50, size 0x90, virtual false, abstract: false, final false
