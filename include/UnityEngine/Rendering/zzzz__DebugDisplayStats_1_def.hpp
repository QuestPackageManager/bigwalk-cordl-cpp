...
class DebugDisplayStats_1_AccumulatedTiming;
}
namespace UnityEngine::Rendering {
template<typename TProfileId>
...
namespace UnityEngine::Rendering {
template<typename TProfileId>
class DebugDisplayStats_1___c__DisplayClass19_0;
}
namespace UnityEngine::Rendering {
template<typename TProfileId>
class DebugDisplayStats_1___c__DisplayClass19_1;
}
namespace UnityEngine::Rendering {
template<typename TProfileId>
class DebugDisplayStats_1___c__DisplayClass19_2;
}
namespace UnityEngine::Rendering {
template<typename TProfileId>
class DebugDisplayStats_1___c__DisplayClass6_0;
}
namespace UnityEngine::Rendering {
class DebugUI_Value;
}
...
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_0);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_1);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_2);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass6_0);
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::DebugDisplayStats_1_DebugProfilingType, "UnityEngine.Rendering", "DebugDisplayStats`1/DebugProfilingType");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1, "UnityEngine.Rendering", "DebugDisplayStats`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming, "UnityEngine.Rendering", "DebugDisplayStats`1/AccumulatedTiming");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_0, "UnityEngine.Rendering", "DebugDisplayStats`1/<>c__DisplayClass19_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_1, "UnityEngine.Rendering", "DebugDisplayStats`1/<>c__DisplayClass19_1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_2, "UnityEngine.Rendering", "DebugDisplayStats`1/<>c__DisplayClass19_2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass6_0, "UnityEngine.Rendering", "DebugDisplayStats`1/<>c__DisplayClass6_0");
...
/// @brief Field CS$<>8__locals1, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_CS$__8__locals1, put=__cordl_internal_set_CS$__8__locals1)) ::UnityEngine::Rendering::DebugDisplayStats_1___c__DisplayClass19_1<TProfileId>*  CS$__8__locals1;
...
/// @brief Field k_DetailedStatsColumnLabels, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_DetailedStatsColumnLabels, put=setStaticF_k_DetailedStatsColumnLabels)) ::ArrayW<::StringW>  k_DetailedStatsColumnLabels;
...
/// @brief Field m_AccumulatedTiming, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AccumulatedTiming, put=__cordl_internal_set_m_AccumulatedTiming)) ::ArrayW<::System::Collections::Generic::Dictionary_2<TProfileId,::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming<TProfileId>*>*>  m_AccumulatedTiming;
...
inline ::UnityEngine::Rendering::DebugUI_Value* _BuildProfilingSamplerWidgetList_g__CreateWidgetForSampler_19_0(TProfileId  samplerId, ::UnityEngine::Rendering::ProfilingSampler*  sampler, ::UnityEngine::Rendering::DebugDisplayStats_1_DebugProfilingType<TProfileId>  type) ;
...
constexpr ::ArrayW<::System::Collections::Generic::Dictionary_2<TProfileId,::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming<TProfileId>*>*> const& __cordl_internal_get_m_AccumulatedTiming() const;

constexpr ::ArrayW<::System::Collections::Generic::Dictionary_2<TProfileId,::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming<TProfileId>*>*>& __cordl_internal_get_m_AccumulatedTiming() ;
...
constexpr void __cordl_internal_set_m_AccumulatedTiming(::ArrayW<::System::Collections::Generic::Dictionary_2<TProfileId,::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming<TProfileId>*>*>  value) ;
...
static inline ::ArrayW<::StringW> getStaticF_k_DetailedStatsColumnLabels() ;

static inline void setStaticF_k_DetailedStatsColumnLabels(::ArrayW<::StringW>  value) ;
...
/// @brief Field m_AccumulatedTiming, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::Dictionary_2<TProfileId,::UnityEngine::Rendering::DebugDisplayStats_1_AccumulatedTiming<TProfileId>*>*>  ___m_AccumulatedTiming;
