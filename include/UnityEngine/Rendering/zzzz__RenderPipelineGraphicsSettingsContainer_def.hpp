...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsContainer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsContainer*, "UnityEngine.Rendering", "RenderPipelineGraphicsSettingsContainer");
...
/// @brief Field m_RuntimeSettings, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RuntimeSettings, put=__cordl_internal_set_m_RuntimeSettings)) ::UnityEngine::Rendering::RenderPipelineGraphicsSettingsCollection*  m_RuntimeSettings;
...
/// @brief Method OnAfterDeserialize, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x182026a40, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_settingsList, addr 0x181050e30, size 0x25b20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsContainer) == 0x18, "Size mismatch!");
