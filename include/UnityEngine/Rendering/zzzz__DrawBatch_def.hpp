...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DrawBatch, "UnityEngine.Rendering", "DrawBatch");
...
// Ctor Parameters [CppParam { name: "key", ty: "::UnityEngine::Rendering::DrawKey", modifiers: "", def_value: None }, CppParam { name: "instanceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "instanceOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "procInfo", ty: "::UnityEngine::Rendering::MeshProceduralInfo", modifiers: "", def_value: None }]
