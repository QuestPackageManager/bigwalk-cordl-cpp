...
// Ctor Parameters [CppParam { name: "lodGroupID", ty: "::UnityEngine::EntityId*", modifiers: "", def_value: None }, CppParam { name: "lodOffset", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "lodCount", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "fadeMode", ty: "::UnityEngine::LODFadeMode*", modifiers: "", def_value: None }, CppParam { name: "worldSpaceReferencePoint", ty: "::UnityEngine::Vector3*", modifiers: "", def_value: None }, CppParam { name: "worldSpaceSize", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "renderersCount", ty: "int16_t*", modifiers: "", def_value: None }, CppParam { name: "lastLODIsBillboard", ty: "bool*", modifiers: "", def_value: None }, CppParam { name: "forceLODMask", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "lodGroupCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "invalidLODGroupID", ty: "::UnityEngine::EntityId*", modifiers: "", def_value: None }, CppParam { name: "invalidLODGroupCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lodRenderersCount", ty: "int16_t*", modifiers: "", def_value: None }, CppParam { name: "lodScreenRelativeTransitionHeight", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "lodFadeTransitionWidth", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "lodDataCount", ty: "int32_t", modifiers: "", def_value: None }]
