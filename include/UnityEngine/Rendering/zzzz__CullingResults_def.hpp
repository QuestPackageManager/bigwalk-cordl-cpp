...
/// @brief Method ComputeDirectionalShadowMatricesAndCullingPrimitives, addr 0x1822a7980, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method ComputeDirectionalShadowMatricesAndCullingPrimitives, addr 0x1822a7a80, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ComputeDirectionalShadowMatricesAndCullingPrimitives_Injected, addr 0x1822a7970, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ComputePointShadowMatricesAndCullingPrimitives, addr 0x1822a7af0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ComputePointShadowMatricesAndCullingPrimitives, addr 0x1822a7b40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ComputeSpotShadowMatricesAndCullingPrimitives, addr 0x1822a7b60, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ComputeSpotShadowMatricesAndCullingPrimitives, addr 0x1822a7b50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x1822a7b90, size 0xc0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822a7c50, size 0x90, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::CullingResults  other) ;

/// @brief Method FillLightAndReflectionProbeIndices, addr 0x1822a7cf0, size 0x30, virtual false, abstract: false, final false
inline void FillLightAndReflectionProbeIndices(::UnityEngine::ComputeBuffer*  computeBuffer) ;

/// @brief Method FillLightAndReflectionProbeIndices, addr 0x1822a7d20, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method FillLightAndReflectionProbeIndices_Injected, addr 0x1822a7ce0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method FillLightIndexMap, addr 0x1822a7d40, size 0x10, virtual false, abstract: false, final false
static inline void FillLightIndexMap(::System::IntPtr  cullingResultsPtr, ::System::IntPtr  indexMapPtr, int32_t  indexMapSize) ;

/// @brief Method GetHashCode, addr 0x1822a7d50, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLightIndexCount, addr 0x1822a7d80, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetLightIndexCount(::System::IntPtr  cullingResultsPtr) ;

/// @brief Method GetLightIndexMap, addr 0x1822a7da0, size 0xa0, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<int32_t> GetLightIndexMap(::Unity::Collections::Allocator  allocator) ;

/// @brief Method GetLightIndexMapSize, addr 0x1822a7d90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetReflectionProbeIndexCount, addr 0x1822a7e40, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetReflectionProbeIndexCount(::System::IntPtr  cullingResultsPtr) ;

/// @brief Method GetShadowCasterBounds, addr 0x1822a7e70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetShadowCasterBounds, addr 0x1822a7e50, size 0x20, virtual false, abstract: false, final false
inline bool GetShadowCasterBounds(int32_t  lightIndex, ::by_ref<::UnityEngine::Bounds>  outBounds) ;

/// @brief Method SetLightIndexMap, addr 0x1822a7ec0, size 0x10, virtual false, abstract: false, final false
static inline void SetLightIndexMap(::System::IntPtr  cullingResultsPtr, ::System::IntPtr  indexMapPtr, int32_t  indexMapSize) ;

/// @brief Method SetLightIndexMap, addr 0x1822a7e80, size 0x40, virtual false, abstract: false, final false
inline void SetLightIndexMap(::Unity::Collections::NativeArray_1<int32_t>  lightIndexMap) ;

/// @brief Method get_lightAndReflectionProbeIndexCount, addr 0x1822a7ed0, size 0x40, virtual false, abstract: false, final false
inline int32_t get_lightAndReflectionProbeIndexCount() ;

/// @brief Method get_visibleLights, addr 0x1822a7f10, size 0x60, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleLight> get_visibleLights() ;

/// @brief Method get_visibleReflectionProbes, addr 0x1822a7f70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1822a7fd0, size 0x60, virtual false, abstract: false, final false
