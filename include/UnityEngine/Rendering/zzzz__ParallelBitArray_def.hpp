...
/// @brief Method ChunkCount, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t ChunkCount() ;

/// @brief Method Dispose, addr 0x1820b5ae0, size 0x30, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Dispose, addr 0x1820b5b10, size 0x60, virtual false, abstract: false, final false
inline void Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method FillZeroes, addr 0x1820b5b70, size 0x90, virtual false, abstract: false, final false
inline void FillZeroes(int32_t  length) ;

/// @brief Method Get, addr 0x1820b5cc0, size 0x30, virtual false, abstract: false, final false
inline bool Get(int32_t  index) ;

/// @brief Method GetBitsArray, addr 0x18038fea0, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<int64_t> GetBitsArray() ;

/// @brief Method GetChunk, addr 0x1820b5c00, size 0x20, virtual false, abstract: false, final false
inline uint64_t GetChunk(int32_t  chunk_index) ;

/// @brief Method GetSubArray, addr 0x1820b5c20, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ParallelBitArray GetSubArray(int32_t  length) ;

/// @brief Method InterlockedOrChunk, addr 0x1820b5cf0, size 0x70, virtual false, abstract: false, final false
inline void InterlockedOrChunk(int32_t  chunk_index, uint64_t  chunk_bits) ;

/// @brief Method InterlockedReadChunk, addr 0x1820b5d60, size 0x20, virtual false, abstract: false, final false
inline uint64_t InterlockedReadChunk(int32_t  chunk_index) ;

/// @brief Method Resize, addr 0x1820b5d80, size 0x140, virtual false, abstract: false, final false
inline void Resize(int32_t  newLength) ;

/// @brief Method Set, addr 0x1820b5ee0, size 0x90, virtual false, abstract: false, final false
inline void Set(int32_t  index, bool  value) ;

/// @brief Method SetChunk, addr 0x1820b5ec0, size 0x20, virtual false, abstract: false, final false
inline void SetChunk(int32_t  chunk_index, uint64_t  chunk_bits) ;

/// @brief Method .ctor, addr 0x1820b5f70, size 0x70, virtual false, abstract: false, final false
inline void _ctor(int32_t  length, ::Unity::Collections::Allocator  allocator, ::Unity::Collections::NativeArrayOptions  options) ;

/// @brief Method get_IsCreated, addr 0x180cbcd80, size 0x520, virtual false, abstract: false, final false
