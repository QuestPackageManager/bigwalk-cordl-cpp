...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::VirtualOffsetSettings, "UnityEngine.Rendering", "VirtualOffsetSettings");
...
public:
// Declarations
/// @brief Method SetDefaults, addr 0x182018a30, size 0x50, virtual false, abstract: false, final false
inline void SetDefaults() ;

/// @brief Method UpgradeFromTo, addr 0x182018a80, size 0xa0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "useVirtualOffset", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "validityThreshold", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "outOfGeoOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "searchMultiplier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "rayOriginBias", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "collisionMask", ty: "::UnityEngine::LayerMask", modifiers: "", def_value: None }]
constexpr VirtualOffsetSettings(bool  useVirtualOffset, float_t  validityThreshold, float_t  outOfGeoOffset, float_t  searchMultiplier, float_t  rayOriginBias, ::UnityEngine::LayerMask  collisionMask) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::VirtualOffsetSettings) == 0x18, "Size mismatch!");
