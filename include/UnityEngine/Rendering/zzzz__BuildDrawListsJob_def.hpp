...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1<T>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.Rendering.DrawBatch, UnityEngine.Rendering.DrawInstance, UnityEngine.Rendering.DrawKey
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x18209bb50, size 0xc0, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;

/// @brief Method IncrementCounter, addr 0x18209bc10, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "batchHash", ty: "::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawInstances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>", modifiers: "", def_value: None }, CppParam { name: "drawBatches", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>", modifiers: "", def_value: None }, CppParam { name: "internalDrawIndex", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawInstanceIndices", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
constexpr BuildDrawListsJob(::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>  batchHash, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>  drawInstances, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>  drawBatches, ::Unity::Collections::NativeArray_1<int32_t>  internalDrawIndex, ::Unity::Collections::NativeArray_1<int32_t>  drawInstanceIndices) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::BuildDrawListsJob) == 0x40, "Size mismatch!");
