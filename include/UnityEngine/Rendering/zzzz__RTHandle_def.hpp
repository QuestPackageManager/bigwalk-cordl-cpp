...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RTHandle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RTHandle*, "UnityEngine.Rendering", "RTHandle");
...
/// @brief Method ClearCustomHandleProperties, addr 0x18203b370, size 0x10, virtual false, abstract: false, final false
inline void ClearCustomHandleProperties() ;

/// @brief Method CopyToFastMemory, addr 0x18203b380, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GetInstanceID, addr 0x18203b430, size 0x60, virtual false, abstract: false, final false
inline int32_t GetInstanceID() ;

/// @brief Method GetScaledSize, addr 0x18203b490, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int GetScaledSize() ;

/// @brief Method GetScaledSize, addr 0x18203b530, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x18203b5c0, size 0x90, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method SetCustomHandleProperties, addr 0x18203b650, size 0x20, virtual false, abstract: false, final false
inline void SetCustomHandleProperties(::by_ref<::UnityEngine::Rendering::RTHandleProperties>  properties) ;

/// @brief Method SetRenderTexture, addr 0x18203b670, size 0x90, virtual false, abstract: false, final false
inline void SetRenderTexture(::UnityEngine::RenderTexture*  rt, bool  transferOwnership) ;

/// @brief Method SetTexture, addr 0x18203b700, size 0x60, virtual false, abstract: false, final false
inline void SetTexture(::UnityEngine::Rendering::RenderTargetIdentifier  tex) ;

/// @brief Method SetTexture, addr 0x18203b760, size 0x80, virtual false, abstract: false, final false
inline void SetTexture(::UnityEngine::Texture*  tex) ;

/// @brief Method SwitchOutFastMemory, addr 0x18203b7e0, size 0x70, virtual false, abstract: false, final false
inline void SwitchOutFastMemory(::UnityEngine::Rendering::CommandBuffer*  cmd, bool  copyContents) ;

/// @brief Method SwitchToFastMemory, addr 0x18203b850, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18203b900, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RTHandleSystem*  owner) ;

/// @brief Method get_externalTexture, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_externalTexture() ;

/// @brief Method get_isMSAAEnabled, addr 0x1802f8060, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_nameID, addr 0x18203b920, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderTargetIdentifier get_nameID() ;

/// @brief Method get_referenceSize, addr 0x1817d59c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int get_referenceSize() ;

/// @brief Method get_rt, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_rt() ;

/// @brief Method get_rtHandleProperties, addr 0x18203b940, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandleProperties get_rtHandleProperties() ;

/// @brief Method get_scaleFactor, addr 0x18203b990, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_scaleFactor() ;

/// @brief Method get_useScaling, addr 0x1803b2c80, size 0x10, virtual false, abstract: false, final false
inline bool get_useScaling() ;

/// @brief Method op_Implicit, addr 0x18203b9a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x18203b9f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x18203ba00, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_referenceSize, addr 0x1817d5a50, size 0x10, virtual false, abstract: false, final false
inline void set_referenceSize(::UnityEngine::Vector2Int  value) ;

/// @brief Method set_scaleFactor, addr 0x18203ba40, size 0x10, virtual false, abstract: false, final false
inline void set_scaleFactor(::UnityEngine::Vector2  value) ;

/// @brief Method set_useScaling, addr 0x1803b30e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RTHandle) == 0xb8, "Size mismatch!");
