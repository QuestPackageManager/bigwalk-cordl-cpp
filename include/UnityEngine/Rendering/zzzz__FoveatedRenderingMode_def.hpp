...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FoveatedRenderingMode, "UnityEngine.Rendering", "FoveatedRenderingMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::FoveatedRenderingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::FoveatedRenderingMode) == 0x4, "Size mismatch!");
