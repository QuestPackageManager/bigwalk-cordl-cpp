...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderDerivedData, "UnityEngine.Rendering", "OccluderDerivedData");
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderDerivedData) == 0x70, "Size mismatch!");
