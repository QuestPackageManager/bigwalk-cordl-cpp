...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::HDREncoding, "UnityEngine.Rendering", "HDREncoding");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::HDREncoding, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::HDREncoding) == 0x4, "Size mismatch!");
