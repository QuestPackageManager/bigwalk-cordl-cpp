...
static_assert(offsetof(::UnityEngine::Rendering::InstanceOcclusionTestDebugCounter, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::InstanceOcclusionTestDebugCounter) == 0x4, "Size mismatch!");
