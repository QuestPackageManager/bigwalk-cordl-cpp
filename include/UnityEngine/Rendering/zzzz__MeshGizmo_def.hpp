...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::MeshGizmo*);
...
// Ctor Parameters [CppParam { name: "__4__this", ty: "::UnityEngine::Rendering::MeshGizmo*", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::MeshGizmo___c__DisplayClass10_0) == 0x18, "Size mismatch!");
...
/// @brief Method AddWireCube, addr 0x18204bb40, size 0x7e0, virtual false, abstract: false, final false
inline void AddWireCube(::UnityEngine::Vector3  center, ::UnityEngine::Vector3  size, ::UnityEngine::Color  color) ;

/// @brief Method Clear, addr 0x18204c320, size 0x30, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x181fc11f0, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DrawMesh, addr 0x18204c350, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method RenderWireframe, addr 0x18204c480, size 0x120, virtual false, abstract: false, final false
inline void RenderWireframe(::UnityEngine::Matrix4x4  trs, ::UnityEngine::Rendering::CompareFunction  depthTest, ::StringW  gizmoName) ;

/// @brief Method <AddWireCube>g__AddEdge|10_0, addr 0x18204c5a0, size 0x1b0, virtual false, abstract: false, final false
inline void _AddWireCube_g__AddEdge_10_0(::UnityEngine::Vector3  p1, ::UnityEngine::Vector3  p2, ::by_ref<::UnityEngine::Rendering::MeshGizmo___c__DisplayClass10_0>  _cordl_fixed_empty_name_whitespace) ;
...
/// @brief Method .ctor, addr 0x18204c780, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::MeshGizmo) == 0x48, "Size mismatch!");
