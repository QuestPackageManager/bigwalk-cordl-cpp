...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::VertexAttributeFormat, "UnityEngine.Rendering", "VertexAttributeFormat");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::VertexAttributeFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::VertexAttributeFormat) == 0x4, "Size mismatch!");
