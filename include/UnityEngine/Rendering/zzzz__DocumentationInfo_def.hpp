...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DocumentationInfo*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DocumentationInfo*, "UnityEngine.Rendering", "DocumentationInfo");
...
public:
// Declarations
/// @brief Method GetDefaultPackageLink, addr 0x18200d490, size 0x20, virtual false, abstract: false, final false
static inline ::StringW GetDefaultPackageLink(::StringW  packageName) ;

/// @brief Method GetDefaultPackageLink, addr 0x18200d4b0, size 0x20, virtual false, abstract: false, final false
static inline ::StringW GetDefaultPackageLink(::StringW  packageName, ::StringW  packageVersion) ;

/// @brief Method GetPackageLink, addr 0x18200d4d0, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW GetPackageLink(::StringW  packageName, ::StringW  packageVersion, ::StringW  pageName) ;

/// @brief Method GetPackageLink, addr 0x18200d570, size 0xe0, virtual false, abstract: false, final false
static inline ::StringW GetPackageLink(::StringW  packageName, ::StringW  packageVersion, ::StringW  pageName, ::StringW  pageHash) ;

/// @brief Method GetPageLink, addr 0x18200d730, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW GetPageLink(::StringW  packageName, ::StringW  pageName) ;

/// @brief Method GetPageLink, addr 0x18200d650, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_version, addr 0x18200d7d0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::DocumentationInfo) == 0x10, "Size mismatch!");
