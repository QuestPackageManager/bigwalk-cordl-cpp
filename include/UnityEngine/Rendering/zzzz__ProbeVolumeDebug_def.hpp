...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeDebug*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeDebug*, "UnityEngine.Rendering", "ProbeVolumeDebug");
...
/// @brief Method GetReset, addr 0x1820176d0, size 0x40, virtual true, abstract: false, final true
inline ::System::Action* GetReset() ;

/// @brief Method Init, addr 0x182017710, size 0x70, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::Rendering::ProbeVolumeDebug* New_ctor() ;

/// @brief Method <GetReset>b__32_0, addr 0x182017710, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182017710, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeDebug) == 0x60, "Size mismatch!");
