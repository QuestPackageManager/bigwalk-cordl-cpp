...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReflectionProbeRefreshMode, "UnityEngine.Rendering", "ReflectionProbeRefreshMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ReflectionProbeRefreshMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ReflectionProbeRefreshMode) == 0x4, "Size mismatch!");
