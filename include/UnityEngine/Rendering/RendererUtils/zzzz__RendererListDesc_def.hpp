...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RendererUtils::RendererListDesc, "UnityEngine.Rendering.RendererUtils", "RendererListDesc");
// Dependencies System.Nullable`1<T>, UnityEngine.Rendering.CullingResults, UnityEngine.Rendering.PerObjectData, UnityEngine.Rendering.RenderQueueRange, UnityEngine.Rendering.RenderStateBlock, UnityEngine.Rendering.ShaderTagId, UnityEngine.Rendering.SortingCriteria
namespace UnityEngine::Rendering::RendererUtils {
// Is value type: true
...
public:
// Declarations
 __declspec(property(get=get_batchLayerMask, put=set_batchLayerMask)) uint32_t  batchLayerMask;
 ...
 __declspec(property(get=get_passNames, put=set_passNames)) ::ArrayW<::UnityEngine::Rendering::ShaderTagId>  passNames;
...
/// @brief Method ConvertToParameters, addr 0x1822af5e0, size 0x8c0, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x1822afea0, size 0x80, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method .ctor, addr 0x1822aff50, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method get_batchLayerMask, addr 0x181561f30, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_batchLayerMask() ;

/// @brief Method get_camera, addr 0x1803d9940, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_camera() ;

/// @brief Method get_cullingResult, addr 0x1814af090, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CullingResults get_cullingResult() ;

/// @brief Method get_passName, addr 0x1813abaa0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ShaderTagId get_passName() ;

/// @brief Method get_passNames, addr 0x1803223b0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_batchLayerMask, addr 0x181fcacc0, size 0x10, virtual false, abstract: false, final false
inline void set_batchLayerMask(uint32_t  value) ;

/// @brief Method set_camera, addr 0x1803d9970, size 0x20, virtual false, abstract: false, final false
inline void set_camera(::UnityEngine::Camera*  value) ;

/// @brief Method set_cullingResult, addr 0x182071bc0, size 0x10, virtual false, abstract: false, final false
inline void set_cullingResult(::UnityEngine::Rendering::CullingResults  value) ;

/// @brief Method set_passName, addr 0x1813f0070, size 0x10, virtual false, abstract: false, final false
inline void set_passName(::UnityEngine::Rendering::ShaderTagId  value) ;

/// @brief Method set_passNames, addr 0x1803223c0, size 0x20, virtual false, abstract: false, final false
inline void set_passNames(::ArrayW<::UnityEngine::Rendering::ShaderTagId>  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr RendererListDesc() ;

// Ctor Parameters [CppParam { name: "sortingCriteria", ty: "::UnityEngine::Rendering::SortingCriteria", modifiers: "", def_value: None }, CppParam { name: "rendererConfiguration", ty: "::UnityEngine::Rendering::PerObjectData", modifiers: "", def_value: None }, CppParam { name: "renderQueueRange", ty: "::UnityEngine::Rendering::RenderQueueRange", modifiers: "", def_value: None }, CppParam { name: "stateBlock", ty: "::System::Nullable_1<::UnityEngine::Rendering::RenderStateBlock>", modifiers: "", def_value: None }, CppParam { name: "overrideShader", ty: "::UnityW<::UnityEngine::Shader>", modifiers: "", def_value: None }, CppParam { name: "overrideMaterial", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "excludeObjectMotionVectors", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "layerMask", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "renderingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_batchLayerMask_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "overrideMaterialPassIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "overrideShaderPassIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_cullingResult_k__BackingField", ty: "::UnityEngine::Rendering::CullingResults", modifiers: "", def_value: None }, CppParam { name: "_camera_k__BackingField", ty: "::UnityW<::UnityEngine::Camera>", modifiers: "", def_value: None }, CppParam { name: "_passName_k__BackingField", ty: "::UnityEngine::Rendering::ShaderTagId", modifiers: "", def_value: None }, CppParam { name: "_passNames_k__BackingField", ty: "::ArrayW<::UnityEngine::Rendering::ShaderTagId>", modifiers: "", def_value: None }]
constexpr RendererListDesc(::UnityEngine::Rendering::SortingCriteria  sortingCriteria, ::UnityEngine::Rendering::PerObjectData  rendererConfiguration, ::UnityEngine::Rendering::RenderQueueRange  renderQueueRange, ::System::Nullable_1<::UnityEngine::Rendering::RenderStateBlock>  stateBlock, ::UnityW<::UnityEngine::Shader>  overrideShader, ::UnityW<::UnityEngine::Material>  overrideMaterial, bool  excludeObjectMotionVectors, int32_t  layerMask, uint32_t  renderingLayerMask, uint32_t  _batchLayerMask_k__BackingField, int32_t  overrideMaterialPassIndex, int32_t  overrideShaderPassIndex, ::UnityEngine::Rendering::CullingResults  _cullingResult_k__BackingField, ::UnityW<::UnityEngine::Camera>  _camera_k__BackingField, ::UnityEngine::Rendering::ShaderTagId  _passName_k__BackingField, ::ArrayW<::UnityEngine::Rendering::ShaderTagId>  _passNames_k__BackingField) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RendererUtils::RendererListDesc) == 0xd0, "Size mismatch!");

} // namespace end def UnityEngine::Rendering::RendererUtils
