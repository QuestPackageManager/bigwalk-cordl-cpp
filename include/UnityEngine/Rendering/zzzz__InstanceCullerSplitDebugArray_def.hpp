...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::InstanceCullerSplitDebugArray_Info, "UnityEngine.Rendering", "InstanceCullerSplitDebugArray/Info");
...
static_assert(sizeof(::UnityEngine::Rendering::InstanceCullerSplitDebugArray_Info) == 0xc, "Size mismatch!");
...
/// @brief Method AddSync, addr 0x1820943a0, size 0x50, virtual false, abstract: false, final false
inline void AddSync(int32_t  baseIndex, ::Unity::Jobs::JobHandle  jobHandle) ;

/// @brief Method Dispose, addr 0x1820943f0, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Init, addr 0x182094430, size 0xb0, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MoveToDebugStatsAndClear, addr 0x1820944e0, size 0x160, virtual false, abstract: false, final false
inline void MoveToDebugStatsAndClear(::UnityEngine::Rendering::DebugRendererBatcherStats*  debugStats) ;

/// @brief Method TryAddSplits, addr 0x182094640, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_Counters, addr 0x18038fea0, size 0x10, virtual false, abstract: false, final false
