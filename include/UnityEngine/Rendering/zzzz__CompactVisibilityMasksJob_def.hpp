...
/// @brief Method Execute, addr 0x1820899f0, size 0x60, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "rendererVisibilityMasks", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "compactedVisibilityMasks", ty: "::UnityEngine::Rendering::ParallelBitArray", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::CompactVisibilityMasksJob) == 0x30, "Size mismatch!");
