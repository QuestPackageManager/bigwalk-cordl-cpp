...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DynamicResolutionHandler_UpsamplerScheduleType, "UnityEngine.Rendering", "DynamicResolutionHandler/UpsamplerScheduleType");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DynamicResolutionHandler_ScalerContainer, "UnityEngine.Rendering", "DynamicResolutionHandler/ScalerContainer");
...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::Rendering::DynamicResScalePolicyType", modifiers: "", def_value: None }, CppParam { name: "method", ty: "::UnityEngine::Rendering::PerformDynamicRes*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::DynamicResolutionHandler_ScalerContainer) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::DynamicResolutionHandler_UpsamplerScheduleType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DynamicResolutionHandler_UpsamplerScheduleType) == 0x4, "Size mismatch!");
