...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShaderStrippingSetting_Version, "UnityEngine.Rendering", "ShaderStrippingSetting/Version");
...
static_assert(offsetof(::UnityEngine::Rendering::ShaderStrippingSetting_Version, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ShaderStrippingSetting_Version) == 0x4, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x18203e180, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_exportShaderVariants, addr 0x18039e7b0, size 0x10, virtual false, abstract: false, final false
inline bool get_exportShaderVariants() ;

/// @brief Method get_shaderVariantLogLevel, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ShaderVariantLogLevel get_shaderVariantLogLevel() ;

/// @brief Method get_stripRuntimeDebugShaders, addr 0x1804bdaf0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_exportShaderVariants, addr 0x18203e190, size 0x30, virtual false, abstract: false, final false
inline void set_exportShaderVariants(bool  value) ;

/// @brief Method set_shaderVariantLogLevel, addr 0x18203e1c0, size 0x30, virtual false, abstract: false, final false
inline void set_shaderVariantLogLevel(::UnityEngine::Rendering::ShaderVariantLogLevel  value) ;

/// @brief Method set_stripRuntimeDebugShaders, addr 0x18203e1f0, size 0x30, virtual false, abstract: false, final false
