...
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimatorUpdateMode, "UnityEngine", "AnimatorUpdateMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AnimatorUpdateMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AnimatorUpdateMode) == 0x4, "Size mismatch!");
