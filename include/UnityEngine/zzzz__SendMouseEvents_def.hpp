...
public:
// Declarations
/// @brief Method Compare, addr 0x1822eb6f0, size 0x50, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::SendMouseEvents_HitInfo  lhs, ::UnityEngine::SendMouseEvents_HitInfo  rhs) ;

/// @brief Method SendMessage, addr 0x1822eb740, size 0x30, virtual false, abstract: false, final false
inline void SendMessage(::StringW  name) ;

/// @brief Method op_Implicit, addr 0x1822eb770, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method DoSendMouseEvents, addr 0x1822ec320, size 0x900, virtual false, abstract: false, final false
static inline void DoSendMouseEvents(int32_t  skipRTCameras) ;

/// @brief Method SendEvents, addr 0x1822ecc20, size 0x3f0, virtual false, abstract: false, final false
static inline void SendEvents(int32_t  i, ::UnityEngine::SendMouseEvents_HitInfo  hit) ;

/// @brief Method SetMouseMoved, addr 0x1822ed010, size 0x20, virtual false, abstract: false, final false
static inline void SetMouseMoved() ;

/// @brief Method UpdateMouse, addr 0x1822ed030, size 0x160, virtual false, abstract: false, final false
