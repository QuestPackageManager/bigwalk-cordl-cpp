...
DEFINE_IL2CPP_CLASS(::UnityEngine::AvatarIKGoal, "UnityEngine", "AvatarIKGoal");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AvatarIKGoal, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AvatarIKGoal) == 0x4, "Size mismatch!");
