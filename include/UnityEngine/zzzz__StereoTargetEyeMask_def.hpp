...
DEFINE_IL2CPP_CLASS(::UnityEngine::StereoTargetEyeMask, "UnityEngine", "StereoTargetEyeMask");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::StereoTargetEyeMask, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::StereoTargetEyeMask) == 0x4, "Size mismatch!");
