...
template<typename U>
static inline void Destroy(U  playable) ;

/// @brief Method DisconnectInput, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename U>
static inline void DisconnectInput(U  playable, int32_t  inputPort) ;
...
/// @brief Method GetSpeed, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename U>
static inline double_t GetSpeed(U  playable) ;
