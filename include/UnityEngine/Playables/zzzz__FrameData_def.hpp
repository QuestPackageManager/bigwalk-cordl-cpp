...
static_assert(offsetof(::UnityEngine::Playables::FrameData_Flags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Playables::FrameData_Flags) == 0x4, "Size mismatch!");
...
using Flags = ::UnityEngine::Playables::FrameData_Flags;
 ...
 __declspec(property(get=get_effectiveParentSpeed)) float_t  effectiveParentSpeed;

 __declspec(property(get=get_frameId)) uint64_t  frameId;

/// @brief Method get_deltaTime, addr 0x18227ee80, size 0x20, virtual false, abstract: false, final false
inline float_t get_deltaTime() ;

/// @brief Method get_effectiveParentSpeed, addr 0x1802f42b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_effectiveParentSpeed() ;

/// @brief Method get_frameId, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
