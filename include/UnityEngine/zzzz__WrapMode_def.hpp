...
DEFINE_IL2CPP_CLASS(::UnityEngine::WrapMode, "UnityEngine", "WrapMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::WrapMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::WrapMode) == 0x4, "Size mismatch!");
