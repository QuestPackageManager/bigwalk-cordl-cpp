...
DEFINE_IL2CPP_CLASS(::UnityEngine::ShadowmaskMode, "UnityEngine", "ShadowmaskMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
/// @brief Field DistanceShadowmask value: I32(1)
static ::UnityEngine::ShadowmaskMode const DistanceShadowmask;

/// @brief Field Shadowmask value: I32(0)
...
static_assert(offsetof(::UnityEngine::ShadowmaskMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ShadowmaskMode) == 0x4, "Size mismatch!");
