...
/// @brief Method GetActive, addr 0x182250a50, size 0x10, virtual false, abstract: false, final false
static inline bool GetActive(int32_t  displayIndex) ;

/// @brief Method GetAutomaticHDRTonemapping, addr 0x182250a60, size 0x10, virtual false, abstract: false, final false
static inline bool GetAutomaticHDRTonemapping(int32_t  displayIndex) ;

/// @brief Method GetAvailable, addr 0x182250a70, size 0x10, virtual false, abstract: false, final false
static inline bool GetAvailable(int32_t  displayIndex) ;

/// @brief Method GetDisplayColorGamut, addr 0x182250a80, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::ColorGamut GetDisplayColorGamut(int32_t  displayIndex) ;

/// @brief Method GetGraphicsFormat, addr 0x182250a90, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetGraphicsFormat(int32_t  displayIndex) ;

/// @brief Method GetHDRModeChangeRequested, addr 0x182250aa0, size 0x10, virtual false, abstract: false, final false
static inline bool GetHDRModeChangeRequested(int32_t  displayIndex) ;

/// @brief Method GetMaxFullFrameToneMapLuminance, addr 0x182250ab0, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetMaxFullFrameToneMapLuminance(int32_t  displayIndex) ;

/// @brief Method GetMaxToneMapLuminance, addr 0x182250ac0, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetMaxToneMapLuminance(int32_t  displayIndex) ;

/// @brief Method GetMinToneMapLuminance, addr 0x182250ad0, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetMinToneMapLuminance(int32_t  displayIndex) ;

/// @brief Method GetPaperWhiteNits, addr 0x182250ae0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method RequestHDRModeChange, addr 0x182250b00, size 0x10, virtual false, abstract: false, final false
inline void RequestHDRModeChange(bool  enabled) ;

/// @brief Method RequestHDRModeChangeInternal, addr 0x182250af0, size 0x10, virtual false, abstract: false, final false
static inline void RequestHDRModeChangeInternal(int32_t  displayIndex, bool  enabled) ;

/// @brief Method SetAutomaticHDRTonemapping, addr 0x182250b10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_HDRModeChangeRequested, addr 0x182250bc0, size 0x10, virtual false, abstract: false, final false
inline bool get_HDRModeChangeRequested() ;

/// @brief Method get_active, addr 0x182250bd0, size 0x10, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_automaticHDRTonemapping, addr 0x182250be0, size 0x10, virtual false, abstract: false, final false
inline bool get_automaticHDRTonemapping() ;

/// @brief Method get_available, addr 0x182250bf0, size 0x10, virtual false, abstract: false, final false
inline bool get_available() ;

/// @brief Method get_displayColorGamut, addr 0x182250c00, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::ColorGamut get_displayColorGamut() ;

/// @brief Method get_graphicsFormat, addr 0x182250c10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat() ;

/// @brief Method get_main, addr 0x182250c20, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::HDROutputSettings* get_main() ;

/// @brief Method get_maxFullFrameToneMapLuminance, addr 0x182250c60, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxFullFrameToneMapLuminance() ;

/// @brief Method get_maxToneMapLuminance, addr 0x182250c70, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxToneMapLuminance() ;

/// @brief Method get_minToneMapLuminance, addr 0x182250c80, size 0x10, virtual false, abstract: false, final false
inline int32_t get_minToneMapLuminance() ;

/// @brief Method get_paperWhiteNits, addr 0x182250c90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_automaticHDRTonemapping, addr 0x182250ca0, size 0x40, virtual false, abstract: false, final false
