...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextAnchor, "UnityEngine", "TextAnchor");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextAnchor, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextAnchor) == 0x4, "Size mismatch!");
