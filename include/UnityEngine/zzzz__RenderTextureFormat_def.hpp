...
DEFINE_IL2CPP_CLASS(::UnityEngine::RenderTextureFormat, "UnityEngine", "RenderTextureFormat");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RenderTextureFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RenderTextureFormat) == 0x4, "Size mismatch!");
