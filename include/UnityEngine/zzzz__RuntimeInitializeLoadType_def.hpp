...
DEFINE_IL2CPP_CLASS(::UnityEngine::RuntimeInitializeLoadType, "UnityEngine", "RuntimeInitializeLoadType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RuntimeInitializeLoadType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RuntimeInitializeLoadType) == 0x4, "Size mismatch!");
