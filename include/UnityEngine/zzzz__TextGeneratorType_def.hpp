...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextGeneratorType, "UnityEngine", "TextGeneratorType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextGeneratorType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextGeneratorType) == 0x4, "Size mismatch!");
