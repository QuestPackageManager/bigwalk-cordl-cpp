...
/// @brief Method .ctor, addr 0x18226fe00, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  itemName) ;

/// @brief Method .ctor, addr 0x18226fdc0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ContextMenu) == 0x20, "Size mismatch!");
