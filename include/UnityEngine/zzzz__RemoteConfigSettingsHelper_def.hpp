...
DEFINE_IL2CPP_CLASS(::UnityEngine::RemoteConfigSettingsHelper_Tag, "UnityEngine", "RemoteConfigSettingsHelper/Tag");
...
static_assert(offsetof(::UnityEngine::RemoteConfigSettingsHelper_Tag, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RemoteConfigSettingsHelper_Tag) == 0x4, "Size mismatch!");
