...
// Write type traits
MARK_REF_T(::UnityEngine::RuntimeInitializeOnLoadMethodAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::RuntimeInitializeOnLoadMethodAttribute*, "UnityEngine", "RuntimeInitializeOnLoadMethodAttribute");
...
/// @brief Method set_loadType, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::RuntimeInitializeOnLoadMethodAttribute) == 0x18, "Size mismatch!");
