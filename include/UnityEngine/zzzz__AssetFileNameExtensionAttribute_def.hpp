...
/// @brief Field <otherExtensions>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__otherExtensions_k__BackingField, put=__cordl_internal_set__otherExtensions_k__BackingField)) ::System::Collections::Generic::IEnumerable_1<::StringW>*  _otherExtensions_k__BackingField;
...
static_assert(sizeof(::UnityEngine::AssetFileNameExtensionAttribute) == 0x20, "Size mismatch!");
