...
// Write type traits
MARK_REF_T(::UnityEngine::AddComponentMenu*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddComponentMenu*, "UnityEngine", "AddComponentMenu");
...
static_assert(sizeof(::UnityEngine::AddComponentMenu) == 0x20, "Size mismatch!");
