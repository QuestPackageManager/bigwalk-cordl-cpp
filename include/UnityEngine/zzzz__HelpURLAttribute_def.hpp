...
/// @brief Method .ctor, addr 0x182272b70, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  url) ;

/// @brief Method get_URL, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::HelpURLAttribute) == 0x28, "Size mismatch!");
