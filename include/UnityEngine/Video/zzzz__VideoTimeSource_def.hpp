...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoTimeSource, "UnityEngine.Video", "VideoTimeSource");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
/// @brief Field AudioDSPTimeSource value: I32(0)
static ::UnityEngine::Video::VideoTimeSource const AudioDSPTimeSource;

/// @brief Field GameTimeSource value: I32(1)
...
static_assert(offsetof(::UnityEngine::Video::VideoTimeSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoTimeSource) == 0x4, "Size mismatch!");
