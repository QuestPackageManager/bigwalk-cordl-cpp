...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoAspectRatio, "UnityEngine.Video", "VideoAspectRatio");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Video::VideoAspectRatio, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoAspectRatio) == 0x4, "Size mismatch!");
