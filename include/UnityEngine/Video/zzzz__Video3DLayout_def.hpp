...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::Video3DLayout, "UnityEngine.Video", "Video3DLayout");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Video::Video3DLayout, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::Video3DLayout) == 0x4, "Size mismatch!");
