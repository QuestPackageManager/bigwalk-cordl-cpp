...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoTimeUpdateMode, "UnityEngine.Video", "VideoTimeUpdateMode");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Video::VideoTimeUpdateMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoTimeUpdateMode) == 0x4, "Size mismatch!");
