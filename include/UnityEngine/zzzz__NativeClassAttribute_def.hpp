...
/// @brief Method .ctor, addr 0x18230d4e0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_Declaration, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_Declaration(::StringW  value) ;

/// @brief Method set_QualifiedNativeName, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
