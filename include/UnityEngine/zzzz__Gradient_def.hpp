...
/// @brief Method Cleanup, addr 0x182264140, size 0x30, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Cleanup_Injected, addr 0x182264130, size 0x10, virtual false, abstract: false, final false
static inline void Cleanup_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method Equals, addr 0x182264170, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x182264240, size 0xa0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Gradient*  other) ;

/// @brief Method Evaluate, addr 0x1822642f0, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Color Evaluate(float_t  time) ;

/// @brief Method Evaluate_Injected, addr 0x1822642e0, size 0x10, virtual false, abstract: false, final false
static inline void Evaluate_Injected(::System::IntPtr  _unity_self, float_t  time, ::by_ref<::UnityEngine::Color>  ret) ;

/// @brief Method Finalize, addr 0x182264340, size 0x30, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetHashCode, addr 0x180329890, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Init, addr 0x182264370, size 0x10, virtual false, abstract: false, final false
static inline ::System::IntPtr Init() ;

/// @brief Method Internal_Equals, addr 0x182264390, size 0x40, virtual false, abstract: false, final false
inline bool Internal_Equals(::System::IntPtr  other) ;

/// @brief Method Internal_Equals_Injected, addr 0x182264380, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetKeys, addr 0x1822644a0, size 0x130, virtual false, abstract: false, final false
inline void SetKeys(::ArrayW<::UnityEngine::GradientColorKey>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey>  alphaKeys) ;

/// @brief Method SetKeys, addr 0x1822643e0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method SetKeys_Injected, addr 0x1822643d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822645d0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1822645f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_alphaKeys, addr 0x182264610, size 0xa0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientAlphaKey> get_alphaKeys() ;

/// @brief Method get_alphaKeys_Injected, addr 0x182264600, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_colorKeys, addr 0x1822646c0, size 0xa0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientColorKey> get_colorKeys() ;

/// @brief Method get_colorKeys_Injected, addr 0x1822646b0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_colorSpace, addr 0x182264770, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::ColorSpace get_colorSpace() ;

/// @brief Method get_colorSpace_Injected, addr 0x182264760, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::ColorSpace get_colorSpace_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_mode, addr 0x1822647b0, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::GradientMode get_mode() ;

/// @brief Method get_mode_Injected, addr 0x1822647a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_colorSpace, addr 0x1822647f0, size 0x30, virtual false, abstract: false, final false
inline void set_colorSpace(::UnityEngine::ColorSpace  value) ;

/// @brief Method set_colorSpace_Injected, addr 0x1822647e0, size 0x10, virtual false, abstract: false, final false
static inline void set_colorSpace_Injected(::System::IntPtr  _unity_self, ::UnityEngine::ColorSpace  value) ;

/// @brief Method set_mode, addr 0x182264830, size 0x30, virtual false, abstract: false, final false
inline void set_mode(::UnityEngine::GradientMode  value) ;

/// @brief Method set_mode_Injected, addr 0x182264820, size 0x10, virtual false, abstract: false, final false
