...
DEFINE_IL2CPP_CLASS(::UnityEngine::SpritePackingRotation, "UnityEngine", "SpritePackingRotation");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::SpritePackingRotation, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::SpritePackingRotation) == 0x4, "Size mismatch!");
