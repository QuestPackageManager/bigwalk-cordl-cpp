...
DEFINE_IL2CPP_CLASS(::UnityEngine::SystemLanguage, "UnityEngine", "SystemLanguage");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::SystemLanguage, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::SystemLanguage) == 0x4, "Size mismatch!");
