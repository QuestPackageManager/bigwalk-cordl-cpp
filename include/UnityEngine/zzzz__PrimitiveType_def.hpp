...
DEFINE_IL2CPP_CLASS(::UnityEngine::PrimitiveType, "UnityEngine", "PrimitiveType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::PrimitiveType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::PrimitiveType) == 0x4, "Size mismatch!");
