...
DEFINE_IL2CPP_CLASS(::UnityEngine::MeshTopology, "UnityEngine", "MeshTopology");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::MeshTopology, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::MeshTopology) == 0x4, "Size mismatch!");
