...
// Ctor Parameters [CppParam { name: "", ty: "RejectDragAndDropMaterial", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
RejectDragAndDropMaterial(RejectDragAndDropMaterial && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "RejectDragAndDropMaterial", modifiers: "const&", def_value: None }]
