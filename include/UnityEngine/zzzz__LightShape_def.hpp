...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightShape, "UnityEngine", "LightShape");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LightShape, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LightShape) == 0x4, "Size mismatch!");
