...
/// @brief Field m_RaycastResultCache, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RaycastResultCache, put=__cordl_internal_set_m_RaycastResultCache)) ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  m_RaycastResultCache;
...
/// @brief Method ActivateModule, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method ConvertPointerEventScrollDeltaToTicks, addr 0x182536d40, size 0x50, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 ConvertPointerEventScrollDeltaToTicks(::UnityEngine::Vector2  scrollDelta) ;

/// @brief Method ConvertUIToolkitPointerId, addr 0x182536d90, size 0x30, virtual true, abstract: false, final false
inline int32_t ConvertUIToolkitPointerId(::UnityEngine::EventSystems::PointerEventData*  sourcePointerData) ;

/// @brief Method DeactivateModule, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method DetermineMoveDirection, addr 0x182536e40, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y) ;

/// @brief Method DetermineMoveDirection, addr 0x182536dc0, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y, float_t  deadZone) ;

/// @brief Method FindCommonRoot, addr 0x182536eb0, size 0x100, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> FindCommonRoot(::UnityEngine::GameObject*  g1, ::UnityEngine::GameObject*  g2) ;

/// @brief Method FindFirstRaycast, addr 0x182536fb0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetAxisEventData, addr 0x182537090, size 0xe0, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::AxisEventData* GetAxisEventData(float_t  x, float_t  y, float_t  moveDeadZone) ;

/// @brief Method GetBaseEventData, addr 0x182537170, size 0x80, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::BaseEventData* GetBaseEventData() ;

/// @brief Method GetNavigationEventDeviceType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method HandlePointerExitAndEnter, addr 0x1825371f0, size 0x6d0, virtual false, abstract: false, final false
...
/// @brief Method IsPointerOverGameObject, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::BaseInputModule* New_ctor() ;

/// @brief Method OnDisable, addr 0x1825378c0, size 0x10, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1825378d0, size 0x40, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Process, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ShouldActivateModule, addr 0x182537910, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182537950, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eventSystem, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::EventSystem> get_eventSystem() ;

/// @brief Method get_input, addr 0x1825379a0, size 0x140, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_input() ;

/// @brief Method get_inputOverride, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_inputOverride() ;

/// @brief Method get_sendPointerHoverToParent, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_sendPointerHoverToParent() ;

/// @brief Method set_inputOverride, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_inputOverride(::UnityEngine::EventSystems::BaseInput*  value) ;

/// @brief Method set_sendPointerHoverToParent, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::EventSystems::BaseInputModule) == 0x58, "Size mismatch!");
