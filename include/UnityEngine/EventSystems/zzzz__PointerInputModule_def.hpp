...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::PointerInputModule*);
MARK_REF_T(::UnityEngine::EventSystems::PointerInputModule_ButtonState*);
MARK_REF_T(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData*);
MARK_REF_T(::UnityEngine::EventSystems::PointerInputModule_MouseState*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PointerInputModule*, "UnityEngine.EventSystems", "PointerInputModule");
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PointerInputModule_ButtonState*, "UnityEngine.EventSystems", "PointerInputModule/ButtonState");
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData*, "UnityEngine.EventSystems", "PointerInputModule/MouseButtonEventData");
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PointerInputModule_MouseState*, "UnityEngine.EventSystems", "PointerInputModule/MouseState");
...
static_assert(sizeof(::UnityEngine::EventSystems::PointerInputModule_ButtonState) == 0x20, "Size mismatch!");
...
/// @brief Field m_TrackedButtons, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TrackedButtons, put=__cordl_internal_set_m_TrackedButtons)) ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::PointerInputModule_ButtonState*>*  m_TrackedButtons;

/// @brief Method AnyPressesThisFrame, addr 0x18253a820, size 0x50, virtual false, abstract: false, final false
inline bool AnyPressesThisFrame() ;

/// @brief Method AnyReleasesThisFrame, addr 0x18253a870, size 0x50, virtual false, abstract: false, final false
inline bool AnyReleasesThisFrame() ;

/// @brief Method GetButtonState, addr 0x18253a8c0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SetButtonState, addr 0x18253a9d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18253aa10, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::EventSystems::PointerInputModule_MouseState) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData) == 0x20, "Size mismatch!");
...
/// @brief Field m_PointerData, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PointerData, put=__cordl_internal_set_m_PointerData)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::PointerEventData*>*  m_PointerData;

/// @brief Method ClearSelection, addr 0x18253f680, size 0xd0, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method CopyFromTo, addr 0x18253f750, size 0x160, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData*  from, ::UnityEngine::EventSystems::PointerEventData*  to) ;

/// @brief Method DeselectIfSelectionChanged, addr 0x18253f8b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetLastPointerEventData, addr 0x18253f910, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t  id) ;

/// @brief Method GetMousePointerEventData, addr 0x18253f940, size 0x20, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData() ;

/// @brief Method GetMousePointerEventData, addr 0x18253f960, size 0x3c0, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData(int32_t  id) ;

/// @brief Method GetPointerData, addr 0x18253fd20, size 0x160, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ::by_ref<::UnityEngine::EventSystems::PointerEventData*>  data, bool  create) ;

/// @brief Method GetTouchPointerEventData, addr 0x18253fe80, size 0x350, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData* GetTouchPointerEventData(::UnityEngine::Touch  input, ::by_ref<bool>  pressed, ::by_ref<bool>  released) ;

/// @brief Method IsPointerOverGameObject, addr 0x1825401d0, size 0x40, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor() ;

/// @brief Method ProcessDrag, addr 0x182540210, size 0x1b0, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMove, addr 0x1825403c0, size 0x50, virtual true, abstract: false, final false
inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method RemovePointerData, addr 0x182540410, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method StateForMouseButton, addr 0x182540430, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData_FramePressState StateForMouseButton(int32_t  buttonId) ;

/// @brief Method ToString, addr 0x1825404e0, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182540690, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::EventSystems::PointerInputModule) == 0x68, "Size mismatch!");
