...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::AbstractEventData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::AbstractEventData*, "UnityEngine.EventSystems", "AbstractEventData");
...
/// @brief Method Reset, addr 0x18159e620, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Use, addr 0x1803b3b50, size 0x10, virtual true, abstract: false, final false
inline void Use() ;
...
/// @brief Method get_used, addr 0x180392490, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::EventSystems::AbstractEventData) == 0x18, "Size mismatch!");
