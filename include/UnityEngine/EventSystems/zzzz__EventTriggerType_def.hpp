...
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::EventTriggerType, "UnityEngine.EventSystems", "EventTriggerType");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::EventSystems::EventTriggerType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::EventSystems::EventTriggerType) == 0x4, "Size mismatch!");
