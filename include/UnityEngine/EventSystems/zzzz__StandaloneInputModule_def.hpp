...
static_assert(offsetof(::UnityEngine::EventSystems::StandaloneInputModule_InputMode, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method ActivateModule, addr 0x1825415d0, size 0x100, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method DeactivateModule, addr 0x1825416d0, size 0x10, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method ForceAutoSelect, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool ForceAutoSelect() ;

/// @brief Method GetCurrentFocusedGameObject, addr 0x1802e5800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> GetCurrentFocusedGameObject() ;

/// @brief Method GetRawMoveVector, addr 0x1825416e0, size 0x140, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetRawMoveVector() ;

static inline ::UnityEngine::EventSystems::StandaloneInputModule* New_ctor() ;

/// @brief Method Process, addr 0x1825428c0, size 0x260, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessMouseEvent, addr 0x182541a30, size 0x10, virtual false, abstract: false, final false
inline void ProcessMouseEvent() ;

/// @brief Method ProcessMouseEvent, addr 0x182541820, size 0x210, virtual false, abstract: false, final false
inline void ProcessMouseEvent(int32_t  id) ;

/// @brief Method ProcessMousePress, addr 0x182541a40, size 0x340, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData*  data) ;

/// @brief Method ProcessTouchEvents, addr 0x182541d80, size 0x5e0, virtual false, abstract: false, final false
inline bool ProcessTouchEvents() ;

/// @brief Method ProcessTouchPress, addr 0x182542360, size 0x560, virtual false, abstract: false, final false
inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData*  pointerEvent, bool  pressed, bool  released) ;

/// @brief Method ReleaseMouse, addr 0x182542b20, size 0x260, virtual false, abstract: false, final false
inline void ReleaseMouse(::UnityEngine::EventSystems::PointerEventData*  pointerEvent, ::UnityEngine::GameObject*  currentOverGo) ;

/// @brief Method ReleasePointerDrags, addr 0x182542d80, size 0x210, virtual false, abstract: false, final false
inline void ReleasePointerDrags() ;

/// @brief Method SendMoveEventToSelectedObject, addr 0x182542f90, size 0x320, virtual false, abstract: false, final false
inline bool SendMoveEventToSelectedObject() ;

/// @brief Method SendSubmitEventToSelectedObject, addr 0x1825432b0, size 0x160, virtual false, abstract: false, final false
inline bool SendSubmitEventToSelectedObject() ;

/// @brief Method SendUpdateEventToSelectedObject, addr 0x182543410, size 0xb0, virtual false, abstract: false, final false
inline bool SendUpdateEventToSelectedObject() ;

/// @brief Method ShouldActivateModule, addr 0x1825434c0, size 0x2d0, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method ShouldIgnoreEventsOnNoFocus, addr 0x1802f6470, size 0x10, virtual false, abstract: false, final false
inline bool ShouldIgnoreEventsOnNoFocus() ;

/// @brief Method UpdateModule, addr 0x182543790, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182543810, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowActivationOnMobileDevice, addr 0x181b649a0, size 0x10, virtual false, abstract: false, final false
inline bool get_allowActivationOnMobileDevice() ;

/// @brief Method get_cancelButton, addr 0x180322760, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_cancelButton() ;

/// @brief Method get_forceModuleActive, addr 0x181b649a0, size 0x10, virtual false, abstract: false, final false
inline bool get_forceModuleActive() ;

/// @brief Method get_horizontalAxis, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_horizontalAxis() ;

/// @brief Method get_inputActionsPerSecond, addr 0x1803d39c0, size 0x10, virtual false, abstract: false, final false
inline float_t get_inputActionsPerSecond() ;

/// @brief Method get_inputMode, addr 0x1802dd520, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::StandaloneInputModule_InputMode get_inputMode() ;

/// @brief Method get_repeatDelay, addr 0x1803826d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_repeatDelay() ;

/// @brief Method get_submitButton, addr 0x180322750, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_submitButton() ;

/// @brief Method get_verticalAxis, addr 0x1802ec4d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_verticalAxis() ;

/// @brief Method set_allowActivationOnMobileDevice, addr 0x1820c80f0, size 0x10, virtual false, abstract: false, final false
inline void set_allowActivationOnMobileDevice(bool  value) ;

/// @brief Method set_cancelButton, addr 0x180322790, size 0x20, virtual false, abstract: false, final false
inline void set_cancelButton(::StringW  value) ;

/// @brief Method set_forceModuleActive, addr 0x1820c80f0, size 0x10, virtual false, abstract: false, final false
inline void set_forceModuleActive(bool  value) ;

/// @brief Method set_horizontalAxis, addr 0x18163ca40, size 0x20, virtual false, abstract: false, final false
inline void set_horizontalAxis(::StringW  value) ;

/// @brief Method set_inputActionsPerSecond, addr 0x1803d3a30, size 0x10, virtual false, abstract: false, final false
inline void set_inputActionsPerSecond(float_t  value) ;

/// @brief Method set_repeatDelay, addr 0x182349c90, size 0x10, virtual false, abstract: false, final false
inline void set_repeatDelay(float_t  value) ;

/// @brief Method set_submitButton, addr 0x180322770, size 0x20, virtual false, abstract: false, final false
inline void set_submitButton(::StringW  value) ;

/// @brief Method set_verticalAxis, addr 0x1802ec810, size 0x20, virtual false, abstract: false, final false
