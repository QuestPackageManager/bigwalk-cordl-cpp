...
/// @brief Method get_currentInputModule, addr 0x182536d10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInputModule> get_currentInputModule() ;

/// @brief Method get_selectedObject, addr 0x182536d20, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_selectedObject() ;

/// @brief Method set_selectedObject, addr 0x182536d30, size 0x10, virtual false, abstract: false, final false
