...
DEFINE_IL2CPP_CLASS(::UnityEngine::VerticalWrapMode, "UnityEngine", "VerticalWrapMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::VerticalWrapMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::VerticalWrapMode) == 0x4, "Size mismatch!");
