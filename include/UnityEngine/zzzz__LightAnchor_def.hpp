...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightAnchor_UpDirection, "UnityEngine", "LightAnchor/UpDirection");
DEFINE_IL2CPP_CLASS(::UnityEngine::LightAnchor*, "UnityEngine", "LightAnchor");
DEFINE_IL2CPP_CLASS(::UnityEngine::LightAnchor_Axes, "UnityEngine", "LightAnchor/Axes");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LightAnchor_UpDirection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LightAnchor_UpDirection) == 0x4, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "up", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "right", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "forward", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }]
...
/// @brief Method GetWorldSpaceAxes, addr 0x181fd95b0, size 0x930, virtual false, abstract: false, final false
...
/// @brief Method NormalizeAngleDegree, addr 0x181fd9ee0, size 0x50, virtual false, abstract: false, final false
static inline float_t NormalizeAngleDegree(float_t  angle) ;

/// @brief Method OnDrawGizmosSelected, addr 0x181fd9f30, size 0xa0, virtual false, abstract: false, final false
inline void OnDrawGizmosSelected() ;

/// @brief Method SynchronizeOnTransform, addr 0x181fd9fd0, size 0x6b0, virtual false, abstract: false, final false
inline void SynchronizeOnTransform(::UnityEngine::Camera*  camera) ;

/// @brief Method Update, addr 0x181fdacc0, size 0x180, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTransform, addr 0x181fda680, size 0xf0, virtual false, abstract: false, final false
inline void UpdateTransform(::UnityEngine::Camera*  camera, ::UnityEngine::Vector3  anchor) ;

/// @brief Method UpdateTransform, addr 0x181fda770, size 0x550, virtual false, abstract: false, final false
...
/// @brief Method get_anchorPosition, addr 0x181fdae40, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_anchorPosition() ;

/// @brief Method get_anchorPositionOffset, addr 0x1803017d0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_anchorPositionOffset() ;

/// @brief Method get_anchorPositionOverride, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_anchorPositionOverride() ;

/// @brief Method get_distance, addr 0x1802f42b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_frameSpace, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LightAnchor_UpDirection get_frameSpace() ;

/// @brief Method get_pitch, addr 0x1802e2b90, size 0x10, virtual false, abstract: false, final false
inline float_t get_pitch() ;

/// @brief Method get_roll, addr 0x1802e2d80, size 0x10, virtual false, abstract: false, final false
inline float_t get_roll() ;

/// @brief Method get_yaw, addr 0x1802e2d90, size 0x10, virtual false, abstract: false, final false
inline float_t get_yaw() ;

/// @brief Method set_anchorPositionOffset, addr 0x181fdaf90, size 0x10, virtual false, abstract: false, final false
inline void set_anchorPositionOffset(::UnityEngine::Vector3  value) ;

/// @brief Method set_anchorPositionOverride, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_anchorPositionOverride(::UnityEngine::Transform*  value) ;

/// @brief Method set_distance, addr 0x181fdafa0, size 0x30, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_frameSpace, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
inline void set_frameSpace(::UnityEngine::LightAnchor_UpDirection  value) ;

/// @brief Method set_pitch, addr 0x181fdafd0, size 0x50, virtual false, abstract: false, final false
inline void set_pitch(float_t  value) ;

/// @brief Method set_roll, addr 0x181fdb020, size 0x50, virtual false, abstract: false, final false
inline void set_roll(float_t  value) ;

/// @brief Method set_yaw, addr 0x181fdb070, size 0x50, virtual false, abstract: false, final false
