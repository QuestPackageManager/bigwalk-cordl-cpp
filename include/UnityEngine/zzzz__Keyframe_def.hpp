...
/// @brief Method .ctor, addr 0x182247f00, size 0x30, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  value) ;

/// @brief Method .ctor, addr 0x182247ec0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  value, float_t  inTangent, float_t  outTangent) ;

/// @brief Method get_inTangent, addr 0x180303b40, size 0x10, virtual false, abstract: false, final false
inline float_t get_inTangent() ;

/// @brief Method get_inWeight, addr 0x1803bda00, size 0x10, virtual false, abstract: false, final false
inline float_t get_inWeight() ;

/// @brief Method get_outTangent, addr 0x180303b30, size 0x10, virtual false, abstract: false, final false
inline float_t get_outTangent() ;

/// @brief Method get_outWeight, addr 0x18048d8a0, size 0x10, virtual false, abstract: false, final false
inline float_t get_outWeight() ;

/// @brief Method get_time, addr 0x1802d56c0, size 0x10, virtual false, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_value, addr 0x1802d56e0, size 0x10, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method get_weightedMode, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::WeightedMode get_weightedMode() ;

/// @brief Method set_inTangent, addr 0x18051eae0, size 0x10, virtual false, abstract: false, final false
inline void set_inTangent(float_t  value) ;

/// @brief Method set_inWeight, addr 0x1803bda40, size 0x10, virtual false, abstract: false, final false
inline void set_inWeight(float_t  value) ;

/// @brief Method set_outTangent, addr 0x18051eaf0, size 0x10, virtual false, abstract: false, final false
inline void set_outTangent(float_t  value) ;

/// @brief Method set_outWeight, addr 0x1804bdb50, size 0x10, virtual false, abstract: false, final false
inline void set_outWeight(float_t  value) ;

/// @brief Method set_time, addr 0x18051eac0, size 0x10, virtual false, abstract: false, final false
inline void set_time(float_t  value) ;

/// @brief Method set_value, addr 0x18051ead0, size 0x10, virtual false, abstract: false, final false
inline void set_value(float_t  value) ;

/// @brief Method set_weightedMode, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
