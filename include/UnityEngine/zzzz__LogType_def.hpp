...
DEFINE_IL2CPP_CLASS(::UnityEngine::LogType, "UnityEngine", "LogType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LogType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LogType) == 0x4, "Size mismatch!");
