...
// Write type traits
MARK_REF_T(::UnityEngine::HashUnsafeUtilities*);
DEFINE_IL2CPP_CLASS(::UnityEngine::HashUnsafeUtilities*, "UnityEngine", "HashUnsafeUtilities");
...
public:
// Declarations
/// @brief Method ComputeHash128, addr 0x1822650c0, size 0x60, virtual false, abstract: false, final false
static inline void ComputeHash128(void*  data, uint64_t  dataSize, ::UnityEngine::Hash128*  hash) ;

/// @brief Method ComputeHash128, addr 0x182265120, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::HashUnsafeUtilities) == 0x10, "Size mismatch!");
