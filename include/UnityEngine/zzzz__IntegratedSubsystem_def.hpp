...
// Write type traits
MARK_REF_T(::UnityEngine::IntegratedSubsystem*);
MARK_REF_T(::UnityEngine::IntegratedSubsystem_BindingsMarshaller*);
DEFINE_IL2CPP_CLASS(::UnityEngine::IntegratedSubsystem*, "UnityEngine", "IntegratedSubsystem");
DEFINE_IL2CPP_CLASS(::UnityEngine::IntegratedSubsystem_BindingsMarshaller*, "UnityEngine", "IntegratedSubsystem/BindingsMarshaller");
...
/// @brief Method IsRunning, addr 0x18230d910, size 0x30, virtual false, abstract: false, final false
inline bool IsRunning() ;

/// @brief Method IsRunning_Injected, addr 0x18230d900, size 0x10, virtual false, abstract: false, final false
static inline bool IsRunning_Injected(::System::IntPtr  _unity_self) ;

static inline ::UnityEngine::IntegratedSubsystem* New_ctor() ;

/// @brief Method SetHandle, addr 0x18230d950, size 0x30, virtual false, abstract: false, final false
inline void SetHandle(::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method SetHandle_Injected, addr 0x18230d940, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_running, addr 0x18230d980, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::IntegratedSubsystem) == 0x20, "Size mismatch!");
