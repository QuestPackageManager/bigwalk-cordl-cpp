...
/// @brief Method CheckIsEditorScript, addr 0x18226d6b0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetDefaultExecutionOrderFor, addr 0x18226d7a0, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetDefaultExecutionOrderFor(::System::Type*  klass) ;

/// @brief Method GetExecuteMode, addr 0x18226d7d0, size 0x80, virtual false, abstract: false, final false
static inline int32_t GetExecuteMode(::System::Type*  klass) ;

/// @brief Method GetParentTypeDisallowingMultipleInclusion, addr 0x18226d850, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Type* GetParentTypeDisallowingMultipleInclusion(::System::Type*  type) ;

/// @brief Method GetRequiredComponents, addr 0x18226d8f0, size 0x260, virtual false, abstract: false, final false
