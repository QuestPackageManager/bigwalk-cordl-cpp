...
/// @brief Method CheckConsistency, addr 0x1822f12d0, size 0x20, virtual false, abstract: false, final false
inline void CheckConsistency() ;

/// @brief Method CreateLegacyFilter, addr 0x1822f12f0, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::ContactFilter2D CreateLegacyFilter(int32_t  layerMask, float_t  minDepth, float_t  maxDepth) ;

/// @brief Method SetDepth, addr 0x1822f1370, size 0x30, virtual false, abstract: false, final false
inline void SetDepth(float_t  minDepth, float_t  maxDepth) ;

/// @brief Method SetLayerMask, addr 0x1822f13a0, size 0x20, virtual false, abstract: false, final false
inline void SetLayerMask(::UnityEngine::LayerMask  layerMask) ;

static inline ::UnityEngine::ContactFilter2D getStaticF__noFilter() ;

/// @brief Method get_noFilter, addr 0x1822f1430, size 0x100, virtual false, abstract: false, final false
static inline ::UnityEngine::ContactFilter2D get_noFilter() ;
