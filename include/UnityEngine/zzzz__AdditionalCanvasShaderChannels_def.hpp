...
DEFINE_IL2CPP_CLASS(::UnityEngine::AdditionalCanvasShaderChannels, "UnityEngine", "AdditionalCanvasShaderChannels");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AdditionalCanvasShaderChannels, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AdditionalCanvasShaderChannels) == 0x4, "Size mismatch!");
