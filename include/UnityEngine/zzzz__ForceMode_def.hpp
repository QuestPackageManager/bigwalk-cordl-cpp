...
DEFINE_IL2CPP_CLASS(::UnityEngine::ForceMode, "UnityEngine", "ForceMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ForceMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ForceMode) == 0x4, "Size mismatch!");
