...
/// @brief Method .ctor, addr 0x1822788b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::RangeAttribute, ___min) == 0x14, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::RangeAttribute, ___max) == 0x18, "Offset mismatch!");
