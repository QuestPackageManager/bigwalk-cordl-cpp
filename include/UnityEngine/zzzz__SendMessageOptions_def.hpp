...
DEFINE_IL2CPP_CLASS(::UnityEngine::SendMessageOptions, "UnityEngine", "SendMessageOptions");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::SendMessageOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::SendMessageOptions) == 0x4, "Size mismatch!");
