...
DEFINE_IL2CPP_CLASS(::UnityEngine::CameraClearFlags, "UnityEngine", "CameraClearFlags");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CameraClearFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CameraClearFlags) == 0x4, "Size mismatch!");
