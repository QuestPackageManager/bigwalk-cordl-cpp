...
// Write type traits
MARK_REF_T(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*, "UnityEngine.SubsystemsImplementation", "SubsystemWithProvider");
...
/// @brief Field <providerBase>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__providerBase_k__BackingField, put=__cordl_internal_set__providerBase_k__BackingField)) ::UnityEngine::SubsystemsImplementation::SubsystemProvider*  _providerBase_k__BackingField;
...
/// @brief Method Destroy, addr 0x18230e360, size 0xa0, virtual true, abstract: false, final true
inline void Destroy() ;
...
/// @brief Method Stop, addr 0x18230e400, size 0x320, virtual true, abstract: false, final true
inline void Stop() ;
...
/// @brief Method get_providerBase, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* get_providerBase() ;

/// @brief Method get_running, addr 0x180392490, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_running, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider) == 0x20, "Size mismatch!");
