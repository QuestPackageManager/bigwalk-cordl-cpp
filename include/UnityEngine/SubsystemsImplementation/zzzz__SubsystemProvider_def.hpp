...
// Write type traits
MARK_REF_T(::UnityEngine::SubsystemsImplementation::SubsystemProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::SubsystemsImplementation::SubsystemProvider*, "UnityEngine.SubsystemsImplementation", "SubsystemProvider");
...
static inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* New_ctor() ;
...
static_assert(sizeof(::UnityEngine::SubsystemsImplementation::SubsystemProvider) == 0x18, "Size mismatch!");
