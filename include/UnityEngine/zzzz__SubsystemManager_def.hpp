...
/// @brief Field s_IntegratedSubsystems, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_IntegratedSubsystems, put=setStaticF_s_IntegratedSubsystems)) ::System::Collections::Generic::List_1<::UnityEngine::IntegratedSubsystem*>*  s_IntegratedSubsystems;

/// @brief Field s_StandaloneSubsystems, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_StandaloneSubsystems, put=setStaticF_s_StandaloneSubsystems)) ::System::Collections::Generic::List_1<::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*>*  s_StandaloneSubsystems;
...
/// @brief Method ClearSubsystems, addr 0x18230de90, size 0x130, virtual false, abstract: false, final false
static inline void ClearSubsystems() ;

/// @brief Method GetIntegratedSubsystemByPtr, addr 0x18230dfc0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method InitializeIntegratedSubsystem, addr 0x18230e060, size 0xb0, virtual false, abstract: false, final false
static inline void InitializeIntegratedSubsystem(::System::IntPtr  ptr, ::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method ReloadSubsystemsCompleted, addr 0x18230e110, size 0x80, virtual false, abstract: false, final false
static inline void ReloadSubsystemsCompleted() ;

/// @brief Method ReloadSubsystemsStarted, addr 0x18230e190, size 0x70, virtual false, abstract: false, final false
static inline void ReloadSubsystemsStarted() ;

/// @brief Method RemoveStandaloneSubsystem, addr 0x18230e200, size 0x50, virtual false, abstract: false, final false
static inline bool RemoveStandaloneSubsystem(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*  subsystem) ;

/// @brief Method StaticConstructScriptingClassMap, addr 0x18230e250, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::SubsystemManager) == 0x10, "Size mismatch!");
