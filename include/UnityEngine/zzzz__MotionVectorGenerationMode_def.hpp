...
DEFINE_IL2CPP_CLASS(::UnityEngine::MotionVectorGenerationMode, "UnityEngine", "MotionVectorGenerationMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::MotionVectorGenerationMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::MotionVectorGenerationMode) == 0x4, "Size mismatch!");
