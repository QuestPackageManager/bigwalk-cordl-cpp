...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextureFormat, "UnityEngine", "TextureFormat");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextureFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextureFormat) == 0x4, "Size mismatch!");
