...
DEFINE_IL2CPP_CLASS(::UnityEngine::ComputeBufferType, "UnityEngine", "ComputeBufferType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ComputeBufferType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ComputeBufferType) == 0x4, "Size mismatch!");
