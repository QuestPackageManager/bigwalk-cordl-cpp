...
/// @brief Method DisconnectAll, addr 0x182277000, size 0x10, virtual false, abstract: false, final false
static inline void DisconnectAll() ;

/// @brief Method Initialize, addr 0x182277010, size 0x10, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method IsConnected, addr 0x182277020, size 0x10, virtual false, abstract: false, final false
static inline bool IsConnected() ;

static inline ::UnityEngine::PlayerConnectionInternal* New_ctor() ;

/// @brief Method PollInternal, addr 0x182277030, size 0x10, virtual false, abstract: false, final false
static inline void PollInternal() ;

/// @brief Method RegisterInternal, addr 0x182277050, size 0xf0, virtual false, abstract: false, final false
static inline void RegisterInternal(::StringW  messageId) ;

/// @brief Method RegisterInternal_Injected, addr 0x182277040, size 0x10, virtual false, abstract: false, final false
static inline void RegisterInternal_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  messageId) ;

/// @brief Method SendMessage, addr 0x182277150, size 0x190, virtual false, abstract: false, final false
static inline void SendMessage(::StringW  messageId, ::ArrayW<uint8_t>  data, int32_t  playerId) ;

/// @brief Method SendMessage_Injected, addr 0x182277140, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method TrySendMessage, addr 0x1822772f0, size 0x1a0, virtual false, abstract: false, final false
static inline bool TrySendMessage(::StringW  messageId, ::ArrayW<uint8_t>  data, int32_t  playerId) ;

/// @brief Method TrySendMessage_Injected, addr 0x1822772e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.IPlayerEditorConnectionNative.DisconnectAll, addr 0x182277000, size 0x10, virtual true, abstract: false, final true
inline void UnityEngine_IPlayerEditorConnectionNative_DisconnectAll() ;

/// @brief Method UnityEngine.IPlayerEditorConnectionNative.Initialize, addr 0x182277010, size 0x10, virtual true, abstract: false, final true
inline void UnityEngine_IPlayerEditorConnectionNative_Initialize() ;

/// @brief Method UnityEngine.IPlayerEditorConnectionNative.IsConnected, addr 0x182277020, size 0x10, virtual true, abstract: false, final true
inline bool UnityEngine_IPlayerEditorConnectionNative_IsConnected() ;

/// @brief Method UnityEngine.IPlayerEditorConnectionNative.Poll, addr 0x182277030, size 0x10, virtual true, abstract: false, final true
inline void UnityEngine_IPlayerEditorConnectionNative_Poll() ;

/// @brief Method UnityEngine.IPlayerEditorConnectionNative.RegisterInternal, addr 0x182277490, size 0x30, virtual true, abstract: false, final true
inline void UnityEngine_IPlayerEditorConnectionNative_RegisterInternal(::System::Guid  messageId) ;

/// @brief Method UnityEngine.IPlayerEditorConnectionNative.SendMessage, addr 0x1822774c0, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.IPlayerEditorConnectionNative.TrySendMessage, addr 0x182277560, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.IPlayerEditorConnectionNative.UnregisterInternal, addr 0x182277600, size 0x30, virtual true, abstract: false, final true
inline void UnityEngine_IPlayerEditorConnectionNative_UnregisterInternal(::System::Guid  messageId) ;

/// @brief Method UnregisterInternal, addr 0x182277640, size 0xf0, virtual false, abstract: false, final false
static inline void UnregisterInternal(::StringW  messageId) ;

/// @brief Method UnregisterInternal_Injected, addr 0x182277630, size 0x10, virtual false, abstract: false, final false
