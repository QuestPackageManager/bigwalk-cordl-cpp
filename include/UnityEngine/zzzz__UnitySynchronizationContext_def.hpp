...
public:
// Declarations
/// @brief Method Invoke, addr 0x18228d830, size 0x3a0, virtual false, abstract: false, final false
inline void Invoke() ;
...
/// @brief Method CreateCopy, addr 0x18228ca70, size 0x90, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method Exec, addr 0x18228cb00, size 0x130, virtual false, abstract: false, final false
inline void Exec() ;

/// @brief Method ExecutePendingTasks, addr 0x18228cc30, size 0xd0, virtual false, abstract: false, final false
static inline bool ExecutePendingTasks(int64_t  millisecondsTimeout) ;

/// @brief Method ExecuteTasks, addr 0x18228cd00, size 0x40, virtual false, abstract: false, final false
static inline void ExecuteTasks() ;

/// @brief Method HasPendingTasks, addr 0x18228cd40, size 0x20, virtual false, abstract: false, final false
inline bool HasPendingTasks() ;

/// @brief Method InitializeSynchronizationContext, addr 0x18228cd60, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method OperationCompleted, addr 0x18228ce30, size 0x10, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x18228ce40, size 0x10, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x18228ce50, size 0x170, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  callback, ::System::Object*  state) ;

/// @brief Method Send, addr 0x18228cfc0, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18228d290, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(int32_t  mainThreadID) ;

/// @brief Method .ctor, addr 0x18228d210, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_MainThreadId, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
