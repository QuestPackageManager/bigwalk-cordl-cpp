...
DEFINE_IL2CPP_CLASS(::UnityEngine::InspectorSortDirection, "UnityEngine", "InspectorSortDirection");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::InspectorSortDirection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InspectorSortDirection) == 0x4, "Size mismatch!");
