...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightmapBakeType, "UnityEngine", "LightmapBakeType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LightmapBakeType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LightmapBakeType) == 0x4, "Size mismatch!");
