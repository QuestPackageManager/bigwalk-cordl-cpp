...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::LanguageDirection, "UnityEngine.TextCore", "LanguageDirection");
// Dependencies 
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::LanguageDirection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::LanguageDirection) == 0x4, "Size mismatch!");
