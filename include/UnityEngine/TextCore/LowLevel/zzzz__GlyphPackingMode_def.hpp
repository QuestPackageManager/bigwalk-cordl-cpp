...
static_assert(offsetof(::UnityEngine::TextCore::LowLevel::GlyphPackingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::LowLevel::GlyphPackingMode) == 0x4, "Size mismatch!");
