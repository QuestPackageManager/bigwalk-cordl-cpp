...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::LowLevel::FontEngineUtilities, "UnityEngine.TextCore.LowLevel", "FontEngineUtilities");
// Dependencies 
namespace UnityEngine::TextCore::LowLevel {
// Is value type: true
...
public:
// Declarations
/// @brief Method MaxValue, addr 0x182314470, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::LowLevel::FontEngineUtilities) == 0x1, "Size mismatch!");
