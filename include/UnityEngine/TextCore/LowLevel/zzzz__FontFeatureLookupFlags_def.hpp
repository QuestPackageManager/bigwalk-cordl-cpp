...
static_assert(offsetof(::UnityEngine::TextCore::LowLevel::FontFeatureLookupFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::LowLevel::FontFeatureLookupFlags) == 0x4, "Size mismatch!");
