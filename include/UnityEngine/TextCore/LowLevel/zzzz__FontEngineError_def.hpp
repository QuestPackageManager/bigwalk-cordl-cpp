...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::LowLevel::FontEngineError, "UnityEngine.TextCore.LowLevel", "FontEngineError");
// Dependencies 
namespace UnityEngine::TextCore::LowLevel {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::LowLevel::FontEngineError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::LowLevel::FontEngineError) == 0x4, "Size mismatch!");
