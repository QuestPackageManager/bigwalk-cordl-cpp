...
// Declarations
 ...
 __declspec(property(get=get_firstAdjustmentRecord, put=set_firstAdjustmentRecord)) ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord  firstAdjustmentRecord;
...
/// @brief Method Equals, addr 0x182317710, size 0x60, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x182317770, size 0xe0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord  other) ;

/// @brief Method GetHashCode, addr 0x182317850, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1823178b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_featureLookupFlags, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::FontFeatureLookupFlags get_featureLookupFlags() ;

/// @brief Method get_firstAdjustmentRecord, addr 0x180a1ad10, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_firstAdjustmentRecord() ;

/// @brief Method get_secondAdjustmentRecord, addr 0x180d74dc0, size 0xc80, virtual false, abstract: false, final false
...
/// @brief Method set_firstAdjustmentRecord, addr 0x182317920, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord) == 0x2c, "Size mismatch!");
