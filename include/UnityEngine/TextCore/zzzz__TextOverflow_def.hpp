...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::TextOverflow, "UnityEngine.TextCore", "TextOverflow");
// Dependencies 
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::TextOverflow, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::TextOverflow) == 0x4, "Size mismatch!");
