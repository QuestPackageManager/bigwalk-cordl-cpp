...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::GlyphClassDefinitionType, "UnityEngine.TextCore", "GlyphClassDefinitionType");
// Dependencies 
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::GlyphClassDefinitionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::GlyphClassDefinitionType) == 0x4, "Size mismatch!");
