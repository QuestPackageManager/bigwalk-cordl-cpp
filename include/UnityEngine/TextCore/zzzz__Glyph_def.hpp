...
/// @brief Method .ctor, addr 0x182317c50, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182317bf0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct  glyphStruct) ;

/// @brief Method .ctor, addr 0x182317c20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_atlasIndex, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_atlasIndex() ;

/// @brief Method get_glyphRect, addr 0x180a26490, size 0x12a0, virtual false, abstract: false, final false
...
/// @brief Method get_metrics, addr 0x180d74dc0, size 0xc80, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::GlyphMetrics get_metrics() ;

/// @brief Method get_scale, addr 0x1802f7fd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method set_atlasIndex, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_atlasIndex(int32_t  value) ;

/// @brief Method set_glyphRect, addr 0x1816eaa00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_metrics, addr 0x182317c70, size 0x70, virtual false, abstract: false, final false
inline void set_metrics(::UnityEngine::TextCore::GlyphMetrics  value) ;

/// @brief Method set_scale, addr 0x18046fb80, size 0x10, virtual false, abstract: false, final false
