...
static_assert(offsetof(::UnityEngine::TextCore::VerticalAlignment, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::VerticalAlignment) == 0x4, "Size mismatch!");
