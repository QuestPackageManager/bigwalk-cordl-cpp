...
/// @brief Method CreateString, addr 0x182347fa0, size 0x160, virtual false, abstract: false, final false
inline ::StringW CreateString() ;

/// @brief Method Equals, addr 0x1823481a0, size 0x140, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823482e0, size 0x1d0, virtual true, abstract: false, final true
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x182348100, size 0xa0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::TextCore::Text::RenderedText  other) ;

/// @brief Method GetEnumerator, addr 0x1823484b0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::RenderedText_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x182348530, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1823487f0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(char16_t  repeat, int32_t  repeatCount, ::StringW  suffix) ;

/// @brief Method .ctor, addr 0x182348580, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method .ctor, addr 0x182348650, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, int32_t  start, int32_t  length, ::StringW  suffix) ;

/// @brief Method .ctor, addr 0x182348710, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  suffix) ;

/// @brief Method get_CharacterCount, addr 0x182348880, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x182346730, size 0xd0, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x182346800, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::TextCore::Text::RenderedText>  source) ;

/// @brief Method get_Current, addr 0x181a6d940, size 0x10, virtual false, abstract: false, final false
