...
public:
// Declarations
/// @brief Method GetLinkId, addr 0x1823232a0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetLinkId() ;

/// @brief Method GetLinkText, addr 0x182323300, size 0xe0, virtual false, abstract: false, final false
inline ::StringW GetLinkText(::UnityEngine::TextCore::Text::TextInfo*  textInfo) ;

/// @brief Method SetLinkId, addr 0x1823233e0, size 0x2c0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::LinkInfo) == 0x30, "Size mismatch!");
