...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextResourceManager_FontAssetRef, "UnityEngine.TextCore.Text", "TextResourceManager/FontAssetRef");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "nameHashCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "familyNameHashCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "styleNameHashCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "familyNameAndStyleHashCode", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "fontAsset", ty: "::UnityW<::UnityEngine::TextCore::Text::FontAsset>", modifiers: "", def_value: None }]
constexpr TextResourceManager_FontAssetRef(int32_t  nameHashCode, int32_t  familyNameHashCode, int32_t  styleNameHashCode, int64_t  familyNameAndStyleHashCode, ::UnityW<::UnityEngine::TextCore::Text::FontAsset>  fontAsset) noexcept;
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextResourceManager_FontAssetRef) == 0x20, "Size mismatch!");
...
/// @brief Field s_FontAssetReferences, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_FontAssetReferences, put=setStaticF_s_FontAssetReferences)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::TextResourceManager_FontAssetRef>*  s_FontAssetReferences;
...
/// @brief Method AddFontAsset, addr 0x182357cf0, size 0x3f0, virtual false, abstract: false, final false
