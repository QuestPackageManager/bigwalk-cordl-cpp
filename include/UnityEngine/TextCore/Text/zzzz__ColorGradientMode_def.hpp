...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::ColorGradientMode, "UnityEngine.TextCore.Text", "ColorGradientMode");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::ColorGradientMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::ColorGradientMode) == 0x4, "Size mismatch!");
