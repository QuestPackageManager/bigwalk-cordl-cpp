...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextStyle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextStyle*, "UnityEngine.TextCore.Text", "TextStyle");
...
/// @brief Field m_ClosingTagUnicodeArray, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ClosingTagUnicodeArray, put=__cordl_internal_set_m_ClosingTagUnicodeArray)) ::ArrayW<uint32_t>  m_ClosingTagUnicodeArray;
...
/// @brief Method RefreshStyle, addr 0x1823542e0, size 0x180, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_m_ClosingTagUnicodeArray() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_m_ClosingTagUnicodeArray() ;
...
constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_m_OpeningTagUnicodeArray() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_m_OpeningTagUnicodeArray() ;
...
constexpr void __cordl_internal_set_m_ClosingTagUnicodeArray(::ArrayW<uint32_t>  value) ;
...
/// @brief Method .ctor, addr 0x182354460, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_hashCode, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_styleClosingDefinition, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_styleClosingDefinition() ;

/// @brief Method get_styleClosingTagArray, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t> get_styleClosingTagArray() ;

/// @brief Method get_styleOpeningDefinition, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_styleOpeningDefinition() ;

/// @brief Method get_styleOpeningTagArray, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextStyle) == 0x50, "Size mismatch!");
