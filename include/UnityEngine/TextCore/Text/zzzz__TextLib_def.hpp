...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextLib_BindingsMarshaller*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextLib_BindingsMarshaller*, "UnityEngine.TextCore.Text", "TextLib/BindingsMarshaller");
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextLib_BindingsMarshaller) == 0x10, "Size mismatch!");
