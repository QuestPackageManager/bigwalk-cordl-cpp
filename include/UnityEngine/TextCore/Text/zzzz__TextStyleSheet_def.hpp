...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextStyleSheet*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextStyleSheet*, "UnityEngine.TextCore.Text", "TextStyleSheet");
...
/// @brief Field m_StyleLookupDictionary, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_StyleLookupDictionary, put=__cordl_internal_set_m_StyleLookupDictionary)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::TextStyle*>*  m_StyleLookupDictionary;
...
/// @brief Method GetStyle, addr 0x182353f00, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(int32_t  hashCode) ;

/// @brief Method GetStyle, addr 0x182353ff0, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(::StringW  name) ;

/// @brief Method LoadStyleDictionaryInternal, addr 0x182354060, size 0x200, virtual false, abstract: false, final false
inline void LoadStyleDictionaryInternal() ;

static inline ::UnityEngine::TextCore::Text::TextStyleSheet* New_ctor() ;

/// @brief Method RefreshStyles, addr 0x182354260, size 0x10, virtual false, abstract: false, final false
inline void RefreshStyles() ;

/// @brief Method Reset, addr 0x182354260, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x182354270, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_styles, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextStyleSheet) == 0x30, "Size mismatch!");
