...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextOverflowMode, "UnityEngine.TextCore.Text", "TextOverflowMode");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::TextOverflowMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::TextOverflowMode) == 0x4, "Size mismatch!");
