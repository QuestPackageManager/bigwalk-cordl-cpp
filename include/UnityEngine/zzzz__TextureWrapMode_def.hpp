...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextureWrapMode, "UnityEngine", "TextureWrapMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextureWrapMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextureWrapMode) == 0x4, "Size mismatch!");
