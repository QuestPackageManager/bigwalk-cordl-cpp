...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::XRNode, "UnityEngine.XR", "XRNode");
// Dependencies 
namespace UnityEngine::XR {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::XR::XRNode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::XR::XRNode) == 0x4, "Size mismatch!");
