...
static_assert(offsetof(::UnityEngine::XR::MeshVertexAttributes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::XR::MeshVertexAttributes) == 0x4, "Size mismatch!");
