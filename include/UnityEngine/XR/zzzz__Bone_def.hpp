...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::Bone, "UnityEngine.XR", "Bone");
// Dependencies 
namespace UnityEngine::XR {
// Is value type: true
...
/// @brief Method Equals, addr 0x18254de70, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x18254df00, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_deviceId, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline uint64_t get_deviceId() ;

/// @brief Method get_featureIndex, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::Bone) == 0x10, "Size mismatch!");
