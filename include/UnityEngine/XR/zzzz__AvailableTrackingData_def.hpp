...
static_assert(offsetof(::UnityEngine::XR::AvailableTrackingData, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::XR::AvailableTrackingData) == 0x4, "Size mismatch!");
