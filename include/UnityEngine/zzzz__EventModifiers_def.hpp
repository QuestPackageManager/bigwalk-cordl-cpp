...
DEFINE_IL2CPP_CLASS(::UnityEngine::EventModifiers, "UnityEngine", "EventModifiers");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::EventModifiers, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::EventModifiers) == 0x4, "Size mismatch!");
