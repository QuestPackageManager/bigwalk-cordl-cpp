...
public:
// Declarations
/// @brief Method ResizeBuffers, addr 0x18225c060, size 0x10, virtual false, abstract: false, final false
static inline void ResizeBuffers(float_t  widthScale, float_t  heightScale) ;

/// @brief Method get_heightScaleFactor, addr 0x18225c070, size 0x10, virtual false, abstract: false, final false
static inline float_t get_heightScaleFactor() ;

/// @brief Method get_widthScaleFactor, addr 0x18225c080, size 0x10, virtual false, abstract: false, final false
