...
/// @brief Method WantsEvent, addr 0x1822bd000, size 0x30, virtual false, abstract: false, final false
inline bool WantsEvent(::UnityEngine::EventType  type) ;

/// @brief Method WantsLayoutPass, addr 0x1822bd030, size 0xc0, virtual false, abstract: false, final false
inline bool WantsLayoutPass(::UnityEngine::EventType  type) ;

/// @brief Method get_wantsLessLayoutEvents, addr 0x18175fe60, size 0x20, virtual false, abstract: false, final false
inline bool get_wantsLessLayoutEvents() ;

/// @brief Method get_wantsMouseEnterLeaveWindow, addr 0x180438d00, size 0x20, virtual false, abstract: false, final false
inline bool get_wantsMouseEnterLeaveWindow() ;

/// @brief Method get_wantsMouseMove, addr 0x180311f90, size 0x20, virtual false, abstract: false, final false
inline bool get_wantsMouseMove() ;

/// @brief Method set_wantsMouseEnterLeaveWindow, addr 0x1805ed730, size 0x10, virtual false, abstract: false, final false
inline void set_wantsMouseEnterLeaveWindow(bool  value) ;

/// @brief Method set_wantsMouseMove, addr 0x1804bda60, size 0x10, virtual false, abstract: false, final false
