...
DEFINE_IL2CPP_CLASS(::UnityEngine::DetailRenderMode, "UnityEngine", "DetailRenderMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::DetailRenderMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::DetailRenderMode) == 0x4, "Size mismatch!");
