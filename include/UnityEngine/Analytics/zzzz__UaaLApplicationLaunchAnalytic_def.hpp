...
/// @brief Method CreateUaaLApplicationLaunchAnalytic, addr 0x18228b620, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18228b680, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Analytics::UaaLApplicationLaunchAnalytic) == 0x38, "Size mismatch!");
