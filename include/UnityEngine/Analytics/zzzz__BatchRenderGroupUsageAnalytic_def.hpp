...
// Write type traits
MARK_REF_T(::UnityEngine::Analytics::BatchRenderGroupUsageAnalytic*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Analytics::BatchRenderGroupUsageAnalytic*, "UnityEngine.Analytics", "BatchRenderGroupUsageAnalytic");
...
/// @brief Method CreateBatchRenderGroupUsageAnalytic, addr 0x18227d2e0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18227d340, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Analytics::BatchRenderGroupUsageAnalytic) == 0x40, "Size mismatch!");
