...
public:
// Declarations
/// @brief Method CreateSubsystemsAnalyticStop, addr 0x182548760, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1825487b0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Analytics::SubsystemsAnalyticStop) == 0x38, "Size mismatch!");
