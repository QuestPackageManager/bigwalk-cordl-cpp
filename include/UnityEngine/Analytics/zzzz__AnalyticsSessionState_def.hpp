...
DEFINE_IL2CPP_CLASS(::UnityEngine::Analytics::AnalyticsSessionState, "UnityEngine.Analytics", "AnalyticsSessionState");
// Dependencies 
namespace UnityEngine::Analytics {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Analytics::AnalyticsSessionState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Analytics::AnalyticsSessionState) == 0x4, "Size mismatch!");
