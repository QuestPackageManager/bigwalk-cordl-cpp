...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PropertyChangedEvent___c::*)()>(&::UnityEngine::UIElements::PropertyChangedEvent___c::_ctor)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::PropertyChangedEvent___c*>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::PropertyChangedEvent* (::UnityEngine::UIElements::PropertyChangedEvent___c::*)()>(&::UnityEngine::UIElements::PropertyChangedEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x182412040;
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::PropertyChangedEvent___c*, "<>9", ::UnityEngine::UIElements::PropertyChangedEvent___c*>(std::forward<::UnityEngine::UIElements::PropertyChangedEvent___c*>(value));
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::BindingId (::UnityEngine::UIElements::PropertyChangedEvent::*)()>(&::UnityEngine::UIElements::PropertyChangedEvent::get_property)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x182411240;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::PropertyChangedEvent*>(),
                        {"get_property", {}, {}}
                    )));
    return ___internal_method;
  }
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PropertyChangedEvent::*)(::UnityEngine::UIElements::BindingId)>(&::UnityEngine::UIElements::PropertyChangedEvent::set_property)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x1824112c0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::PropertyChangedEvent*>(),
                        {"set_property", {}, {::i2c::type_of<::UnityEngine::UIElements::BindingId>()}}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::PropertyChangedEvent::*)()>(&::UnityEngine::UIElements::PropertyChangedEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x182411200;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::PropertyChangedEvent* (*)(::by_ref<::UnityEngine::UIElements::BindingId>)>(&::UnityEngine::UIElements::PropertyChangedEvent::GetPooled)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x1824110d0;
