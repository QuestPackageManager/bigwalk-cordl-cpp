...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Repeat, "UnityEngine.UIElements", "Repeat");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Field NoRepeat value: I32(0)
static ::UnityEngine::UIElements::Repeat const NoRepeat;

/// @brief Field Round value: I32(2)
...
/// @brief Field Repeat value: I32(3)
...
static_assert(offsetof(::UnityEngine::UIElements::Repeat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Repeat) == 0x4, "Size mismatch!");
