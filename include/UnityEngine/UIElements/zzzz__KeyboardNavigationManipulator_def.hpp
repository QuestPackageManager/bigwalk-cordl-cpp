...
/// @brief Method Invoke, addr 0x182499010, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x182509490, size 0xe0, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  evt) ;

/// @brief Method OnNavigationCancel, addr 0x182509570, size 0x30, virtual false, abstract: false, final false
inline void OnNavigationCancel(::UnityEngine::UIElements::NavigationCancelEvent*  evt) ;

/// @brief Method OnNavigationMove, addr 0x1825095a0, size 0xc0, virtual false, abstract: false, final false
inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x182509660, size 0x30, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x182509690, size 0x120, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x182509860, size 0x1d0, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method <OnKeyDown>g__GetOperation|4_0, addr 0x1825097b0, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::KeyboardNavigationOperation _OnKeyDown_g__GetOperation_4_0(::by_ref<::UnityEngine::UIElements::KeyboardNavigationManipulator___c__DisplayClass4_0>  _cordl_fixed_empty_name_whitespace) ;
