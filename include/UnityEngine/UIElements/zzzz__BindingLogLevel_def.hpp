...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BindingLogLevel, "UnityEngine.UIElements", "BindingLogLevel");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::BindingLogLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::BindingLogLevel) == 0x4, "Size mismatch!");
