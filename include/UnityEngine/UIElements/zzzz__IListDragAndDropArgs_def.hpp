...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IListDragAndDropArgs*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IListDragAndDropArgs*, "UnityEngine.UIElements", "IListDragAndDropArgs");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: false
