...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlTypeRestriction*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlTypeRestriction*, "UnityEngine.UIElements", "UxmlTypeRestriction");
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlTypeRestriction) == 0x10, "Size mismatch!");
