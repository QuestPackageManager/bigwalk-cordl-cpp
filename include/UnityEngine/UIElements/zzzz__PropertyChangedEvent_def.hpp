...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PropertyChangedEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x182412040, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x1824110d0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182411200, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_property, addr 0x182411240, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingId get_property() ;

/// @brief Method set_property, addr 0x1824112c0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::PropertyChangedEvent) == 0x100, "Size mismatch!");
