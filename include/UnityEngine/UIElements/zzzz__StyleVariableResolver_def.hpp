...
static_assert(offsetof(::UnityEngine::UIElements::StyleVariableResolver_Result, value__) == 0x4, "Offset mismatch!");
...
// Ctor Parameters [CppParam { name: "sheet", ty: "::UnityW<::UnityEngine::UIElements::StyleSheet>", modifiers: "", def_value: None }, CppParam { name: "handles", ty: "::ArrayW<::UnityEngine::UIElements::StyleValueHandle>", modifiers: "", def_value: None }]
...
/// @brief Method AddValue, addr 0x1823ec660, size 0xb0, virtual false, abstract: false, final false
inline void AddValue(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method Init, addr 0x1823ec710, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method ParseVarFunction, addr 0x1823ec7f0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method PopContext, addr 0x1823ec870, size 0x50, virtual false, abstract: false, final false
inline void PopContext() ;

/// @brief Method PushContext, addr 0x1823ec8c0, size 0x80, virtual false, abstract: false, final false
inline void PushContext(::UnityEngine::UIElements::StyleSheet*  sheet, ::ArrayW<::UnityEngine::UIElements::StyleValueHandle>  handles) ;

/// @brief Method ResolveFallback, addr 0x1823ec940, size 0x230, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleVariableResolver_Result ResolveFallback(::by_ref<int32_t>  index, bool  appendValues) ;

/// @brief Method ResolveVarFunction, addr 0x1823ecb70, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ResolveVarFunction, addr 0x1823ecc30, size 0x130, virtual false, abstract: false, final false
inline bool ResolveVarFunction(::by_ref<int32_t>  index) ;

/// @brief Method ResolveVariable, addr 0x1823ecd60, size 0x2c0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleVariableResolver_Result ResolveVariable(::StringW  variableName) ;

/// @brief Method ValidateResolvedValues, addr 0x1823ed020, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823ed160, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxParser* getStaticF_s_SyntaxParser() ;

/// @brief Method get_currentHandles, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::StyleValueHandle> get_currentHandles() ;

/// @brief Method get_currentSheet, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::StyleSheet> get_currentSheet() ;

/// @brief Method get_resolvedValues, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>* get_resolvedValues() ;

/// @brief Method get_variableContext, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_variableContext, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
