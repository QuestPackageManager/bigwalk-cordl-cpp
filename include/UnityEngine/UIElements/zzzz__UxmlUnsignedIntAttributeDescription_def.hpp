...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription*);
...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x1823fce80, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription___c) == 0x10, "Size mismatch!");
...
/// @brief Method ConvertValueToUInt, addr 0x18240b040, size 0x40, virtual false, abstract: false, final false
static inline uint32_t ConvertValueToUInt(::StringW  v, uint32_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x18240b080, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18240b190, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UxmlUnsignedIntAttributeDescription) == 0x48, "Size mismatch!");
