...
/// @brief Method .ctor, addr 0x18237f090, size 0x380, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  dataSource, ::by_ref<::Unity::Properties::PropertyPath>  dataSourcePath) ;

/// @brief Method get_dataSource, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_dataSource() ;

/// @brief Method get_dataSourcePath, addr 0x180c44180, size 0x6ea0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::DataSourceContext) == 0x98, "Size mismatch!");
