...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TextOverflow, "UnityEngine.UIElements", "TextOverflow");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::TextOverflow, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::TextOverflow) == 0x4, "Size mismatch!");
