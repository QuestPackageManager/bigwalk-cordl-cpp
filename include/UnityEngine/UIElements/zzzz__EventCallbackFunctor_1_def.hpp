...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::EventCallbackFunctor_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::EventCallbackFunctor_1, "UnityEngine.UIElements", "EventCallbackFunctor`1");
...
static inline ::UnityEngine::UIElements::EventCallbackFunctor_1<TEventType>* GetPooled(int64_t  eventTypeId, ::UnityEngine::UIElements::EventCallback_1<TEventType>*  callback, ::UnityEngine::UIElements::CallbackOptions  callbackOptions) ;
