...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::EditorPanelRootElement*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EditorPanelRootElement*, "UnityEngine.UIElements", "EditorPanelRootElement");
...
/// @brief Method OnEventCompletedAtAnyTarget, addr 0x182508b50, size 0x50, virtual false, abstract: false, final false
inline void OnEventCompletedAtAnyTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method .ctor, addr 0x182508ba0, size 0x2a0, virtual false, abstract: false, final false
inline void _ctor() ;
