...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::InheritedData, "UnityEngine.UIElements", "InheritedData");
// Dependencies UnityEngine.Color, UnityEngine.FontStyle, UnityEngine.TextAnchor, UnityEngine.TextGeneratorType, UnityEngine.UIElements.EditorTextRenderingMode, UnityEngine.UIElements.FontDefinition, UnityEngine.UIElements.Length, UnityEngine.UIElements.MaterialDefinition, UnityEngine.UIElements.TextAutoSize, UnityEngine.UIElements.TextShadow, UnityEngine.UIElements.Visibility, UnityEngine.UIElements.WhiteSpace
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x18145ba60, size 0x80, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::InheritedData Copy() ;

/// @brief Method CopyFrom, addr 0x1823c2720, size 0x1c0, virtual true, abstract: false, final true
inline void CopyFrom(::by_ref<::UnityEngine::UIElements::InheritedData>  other) ;

/// @brief Method Equals, addr 0x1823c2aa0, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823c28e0, size 0x1c0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::InheritedData  other) ;

/// @brief Method GetHashCode, addr 0x1823c2ba0, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1823c2e00, size 0x300, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "fontSize", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "letterSpacing", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "textShadow", ty: "::UnityEngine::UIElements::TextShadow", modifiers: "", def_value: None }, CppParam { name: "unityEditorTextRenderingMode", ty: "::UnityEngine::UIElements::EditorTextRenderingMode", modifiers: "", def_value: None }, CppParam { name: "unityFont", ty: "::UnityW<::UnityEngine::Font>", modifiers: "", def_value: None }, CppParam { name: "unityFontDefinition", ty: "::UnityEngine::UIElements::FontDefinition", modifiers: "", def_value: None }, CppParam { name: "unityFontStyleAndWeight", ty: "::UnityEngine::FontStyle", modifiers: "", def_value: None }, CppParam { name: "unityMaterial", ty: "::UnityEngine::UIElements::MaterialDefinition", modifiers: "", def_value: None }, CppParam { name: "unityParagraphSpacing", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "unityTextAlign", ty: "::UnityEngine::TextAnchor", modifiers: "", def_value: None }, CppParam { name: "unityTextAutoSize", ty: "::UnityEngine::UIElements::TextAutoSize", modifiers: "", def_value: None }, CppParam { name: "unityTextGenerator", ty: "::UnityEngine::TextGeneratorType", modifiers: "", def_value: None }, CppParam { name: "unityTextOutlineColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "unityTextOutlineWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "visibility", ty: "::UnityEngine::UIElements::Visibility", modifiers: "", def_value: None }, CppParam { name: "whiteSpace", ty: "::UnityEngine::UIElements::WhiteSpace", modifiers: "", def_value: None }, CppParam { name: "wordSpacing", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }]
constexpr InheritedData(::UnityEngine::Color  color, ::UnityEngine::UIElements::Length  fontSize, ::UnityEngine::UIElements::Length  letterSpacing, ::UnityEngine::UIElements::TextShadow  textShadow, ::UnityEngine::UIElements::EditorTextRenderingMode  unityEditorTextRenderingMode, ::UnityW<::UnityEngine::Font>  unityFont, ::UnityEngine::UIElements::FontDefinition  unityFontDefinition, ::UnityEngine::FontStyle  unityFontStyleAndWeight, ::UnityEngine::UIElements::MaterialDefinition  unityMaterial, ::UnityEngine::UIElements::Length  unityParagraphSpacing, ::UnityEngine::TextAnchor  unityTextAlign, ::UnityEngine::UIElements::TextAutoSize  unityTextAutoSize, ::UnityEngine::TextGeneratorType  unityTextGenerator, ::UnityEngine::Color  unityTextOutlineColor, float_t  unityTextOutlineWidth, ::UnityEngine::UIElements::Visibility  visibility, ::UnityEngine::UIElements::WhiteSpace  whiteSpace, ::UnityEngine::UIElements::Length  wordSpacing) noexcept;
...
/// @brief Field unityMaterial, offset: 0x60, size: 0x10, def value: None
 ::UnityEngine::UIElements::MaterialDefinition  unityMaterial;

/// @brief Field unityParagraphSpacing, offset: 0x70, size: 0x8, def value: None
 ::UnityEngine::UIElements::Length  unityParagraphSpacing;

/// @brief Field unityTextAlign, offset: 0x78, size: 0x4, def value: None
 ::UnityEngine::TextAnchor  unityTextAlign;

/// @brief Field unityTextAutoSize, offset: 0x7c, size: 0x14, def value: None
 ::UnityEngine::UIElements::TextAutoSize  unityTextAutoSize;

/// @brief Field unityTextGenerator, offset: 0x90, size: 0x4, def value: None
 ::UnityEngine::TextGeneratorType  unityTextGenerator;

/// @brief Field unityTextOutlineColor, offset: 0x94, size: 0x10, def value: None
 ::UnityEngine::Color  unityTextOutlineColor;

/// @brief Field unityTextOutlineWidth, offset: 0xa4, size: 0x4, def value: None
 float_t  unityTextOutlineWidth;

/// @brief Field visibility, offset: 0xa8, size: 0x4, def value: None
 ::UnityEngine::UIElements::Visibility  visibility;

/// @brief Field whiteSpace, offset: 0xac, size: 0x4, def value: None
 ::UnityEngine::UIElements::WhiteSpace  whiteSpace;

/// @brief Field wordSpacing, offset: 0xb0, size: 0x8, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityMaterial) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityParagraphSpacing) == 0x70, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityTextAlign) == 0x78, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityTextAutoSize) == 0x7c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityTextGenerator) == 0x90, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityTextOutlineColor) == 0x94, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, unityTextOutlineWidth) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, visibility) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, whiteSpace) == 0xac, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InheritedData, wordSpacing) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::InheritedData) == 0xb8, "Size mismatch!");
