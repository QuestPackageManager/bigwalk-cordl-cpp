...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DeltaSpeed, "UnityEngine.UIElements", "DeltaSpeed");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::DeltaSpeed, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::DeltaSpeed) == 0x4, "Size mismatch!");
