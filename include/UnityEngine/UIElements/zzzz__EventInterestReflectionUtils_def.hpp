...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventInterestReflectionUtils_DefaultEventInterests, "UnityEngine.UIElements", "EventInterestReflectionUtils/DefaultEventInterests");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::EventInterestReflectionUtils_DefaultEventInterests, HandleEventTrickleDownCategories) == 0x8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventInterestReflectionUtils_DefaultEventInterests, HandleEventBubbleUpCategories) == 0xc, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::EventInterestReflectionUtils_DefaultEventInterests) == 0x10, "Size mismatch!");
...
/// @brief Method ComputeDefaultEventInterests, addr 0x182410540, size 0x140, virtual false, abstract: false, final false
static inline int32_t ComputeDefaultEventInterests(::System::Type*  elementType, ::StringW  methodName) ;

/// @brief Method GetDefaultEventInterests, addr 0x182410680, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method GetEventCategory, addr 0x182410880, size 0x120, virtual false, abstract: false, final false
