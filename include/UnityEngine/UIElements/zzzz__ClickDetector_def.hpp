...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ClickDetector*);
MARK_REF_T(::UnityEngine::UIElements::ClickDetector_ButtonClickStatus*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ClickDetector*, "UnityEngine.UIElements", "ClickDetector");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ClickDetector_ButtonClickStatus*, "UnityEngine.UIElements", "ClickDetector/ButtonClickStatus");
...
/// @brief Method Reset, addr 0x182378fe0, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Field m_ClickStatus, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ClickStatus, put=__cordl_internal_set_m_ClickStatus)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::ClickDetector_ButtonClickStatus*>*  m_ClickStatus;

/// @brief Method CancelClickTracking, addr 0x182379310, size 0x80, virtual false, abstract: false, final false
inline void CancelClickTracking(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method Cleanup, addr 0x182379390, size 0xa0, virtual false, abstract: false, final false
inline void Cleanup(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*  elements) ;

/// @brief Method ContainsPointer, addr 0x182379430, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method SendClickEvent, addr 0x1823795b0, size 0x2e0, virtual false, abstract: false, final false
inline void SendClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method StartClickTracking, addr 0x182379890, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823799e0, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__s_DoubleClickTime_k__BackingField() ;

/// @brief Method get_s_DoubleClickTime, addr 0x182379b00, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_s_DoubleClickTime, addr 0x182379b20, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ClickDetector) == 0x18, "Size mismatch!");
