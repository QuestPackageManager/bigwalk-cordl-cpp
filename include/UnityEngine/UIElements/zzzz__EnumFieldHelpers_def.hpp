...
/// @brief Method ExtractValue, addr 0x18245f5f0, size 0x2c0, virtual false, abstract: false, final false
static inline bool ExtractValue(::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc, ::by_ref<::System::Type*>  resEnumType, ::by_ref<::System::Enum*>  resEnumValue, ::by_ref<bool>  resIncludeObsoleteValues) ;
