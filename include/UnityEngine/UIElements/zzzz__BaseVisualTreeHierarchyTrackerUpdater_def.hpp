...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BaseVisualTreeHierarchyTrackerUpdater_State, "UnityEngine.UIElements", "BaseVisualTreeHierarchyTrackerUpdater/State");
...
static_assert(offsetof(::UnityEngine::UIElements::BaseVisualTreeHierarchyTrackerUpdater_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::BaseVisualTreeHierarchyTrackerUpdater_State) == 0x4, "Size mismatch!");
...
/// @brief Method OnVersionChanged, addr 0x18240dfe0, size 0x1e0, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method ProcessAddOrMove, addr 0x18240e1c0, size 0x80, virtual false, abstract: false, final false
inline void ProcessAddOrMove(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method ProcessNewChange, addr 0x18240e240, size 0xa0, virtual false, abstract: false, final false
inline void ProcessNewChange(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method ProcessRemove, addr 0x18240e2e0, size 0xa0, virtual false, abstract: false, final false
inline void ProcessRemove(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method Update, addr 0x18240e380, size 0x80, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x181916bf0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
