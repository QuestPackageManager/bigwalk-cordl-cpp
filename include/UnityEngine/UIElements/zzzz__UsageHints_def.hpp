...
static_assert(offsetof(::UnityEngine::UIElements::UsageHints, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UsageHints) == 0x4, "Size mismatch!");
