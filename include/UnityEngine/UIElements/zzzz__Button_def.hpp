...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Button*);
MARK_REF_T(::UnityEngine::UIElements::Button_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Button_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x18246db00, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x18246e010, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824709b0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::Button_UxmlTraits) == 0xd8, "Size mismatch!");
...
/// @brief Method DoMeasure, addr 0x18245dbd0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method OnNavigationSubmit, addr 0x18245dc90, size 0x40, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method ResetButtonHierarchy, addr 0x18245dcd0, size 0x110, virtual false, abstract: false, final false
inline void ResetButtonHierarchy() ;

/// @brief Method UpdateButtonHierarchy, addr 0x18245dde0, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18245e4c0, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18245e350, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  clickEvent) ;

/// @brief Method .ctor, addr 0x18245e640, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method get_clickable, addr 0x18238cb90, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Clickable* get_clickable() ;

/// @brief Method get_iconImage, addr 0x18245e7e0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Background get_iconImage() ;

/// @brief Method get_text, addr 0x18245e800, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method set_clickable, addr 0x18245e820, size 0x80, virtual false, abstract: false, final false
inline void set_clickable(::UnityEngine::UIElements::Clickable*  value) ;

/// @brief Method set_iconImage, addr 0x18245e8a0, size 0x320, virtual false, abstract: false, final false
inline void set_iconImage(::UnityEngine::UIElements::Background  value) ;

/// @brief Method set_text, addr 0x18245ebc0, size 0x160, virtual true, abstract: false, final false
