...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BackgroundPositionKeyword, "UnityEngine.UIElements", "BackgroundPositionKeyword");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::BackgroundPositionKeyword, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::BackgroundPositionKeyword) == 0x4, "Size mismatch!");
