...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::DefaultTreeViewController_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::DefaultTreeViewController_1, "UnityEngine.UIElements", "DefaultTreeViewController`1");
...
/// @brief Field m_TreeDataController, offset 0x68, size 0x8 
...
/// @brief Method <SetRootItems>b__6_0, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyNode _SetRootItems_b__6_0(::Unity::Hierarchy::HierarchyNode  node) ;

/// @brief Method <SetRootItems>b__6_1, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _SetRootItems_b__6_1(int32_t  id, ::Unity::Hierarchy::HierarchyNode  node) ;
