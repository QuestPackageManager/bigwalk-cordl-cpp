...
namespace UnityEngine::UIElements {
template<typename T>
struct DynamicHeightVirtualizationController_1___c__DisplayClass67_0;
}
namespace UnityEngine::UIElements {
...
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1);
MARK_GEN_VAL_T(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo);
MARK_GEN_VAL_T(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1___c__DisplayClass67_0);
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ScrollDirection, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ScrollDirection");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_VirtualizationChange, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/VirtualizationChange");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ContentHeightCacheInfo");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1___c__DisplayClass67_0, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/<>c__DisplayClass67_0");
// Dependencies 
namespace UnityEngine::UIElements {
// cpp template
template<typename T>
...
template<typename T>
// Is value type: true
// CS Name: UnityEngine.UIElements.DynamicHeightVirtualizationController`1/<>c__DisplayClass67_0<T>
struct CORDL_TYPE DynamicHeightVirtualizationController_1___c__DisplayClass67_0 {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
constexpr DynamicHeightVirtualizationController_1___c__DisplayClass67_0() ;

// Ctor Parameters [CppParam { name: "draggedIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityEngine::UIElements::DynamicHeightVirtualizationController_1<T>*", modifiers: "", def_value: None }]
constexpr DynamicHeightVirtualizationController_1___c__DisplayClass67_0(int32_t  draggedIndex, ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1<T>*  __4__this) noexcept;
...
// Dependencies System.Nullable`1<T>, UnityEngine.UIElements.DynamicHeightVirtualizationController`1::ScrollDirection<T>, UnityEngine.UIElements.DynamicHeightVirtualizationController`1::VirtualizationChange<T>, UnityEngine.UIElements.VerticalVirtualizationController`1<T>, UnityEngine.Vector2
namespace UnityEngine::UIElements {
// cpp template
template<typename T>
// Is value type: false
...
using __c__DisplayClass67_0 = ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1___c__DisplayClass67_0<T>;
...
/// @brief Field m_AccumulatedHeight, offset 0xcc, size 0x4 
...
/// @brief Field m_ContentHeightCache, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ContentHeightCache, put=__cordl_internal_set_m_ContentHeightCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo<T>>*  m_ContentHeightCache;

/// @brief Field m_DelayedScrollOffset, offset 0xc4, size 0x8 
...
/// @brief Field m_FillCallback, offset 0xd8, size 0x8 
...
/// @brief Field m_ForcedLastVisibleItem, offset 0xb4, size 0x4 
...
/// @brief Field m_GeometryChangedCallback, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GeometryChangedCallback, put=__cordl_internal_set_m_GeometryChangedCallback)) ::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  m_GeometryChangedCallback;

/// @brief Field m_HighestCachedIndex, offset 0x88, size 0x4 
...
/// @brief Field m_IndexOutOfBoundsPredicate, offset 0x108, size 0x8 
...
/// @brief Field m_ItemHeightCache, offset 0x90, size 0x8 
...
/// @brief Field m_LastChange, offset 0xbc, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_LastChange, put=__cordl_internal_set_m_LastChange)) ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_VirtualizationChange<T>  m_LastChange;

/// @brief Field m_MinimumItemHeight, offset 0xd0, size 0x4 
...
/// @brief Field m_RefreshScrollOffsetScheduledItem, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RefreshScrollOffsetScheduledItem, put=__cordl_internal_set_m_RefreshScrollOffsetScheduledItem)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_RefreshScrollOffsetScheduledItem;

/// @brief Field m_ScheduledItem, offset 0xf0, size 0x8 
...
/// @brief Field m_ScrollDirection, offset 0xc0, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_ScrollDirection, put=__cordl_internal_set_m_ScrollDirection)) ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ScrollDirection<T>  m_ScrollDirection;

/// @brief Field m_ScrollResetCallback, offset 0xe0, size 0x8 
...
/// @brief Field m_ScrollResetScheduledItem, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScrollResetScheduledItem, put=__cordl_internal_set_m_ScrollResetScheduledItem)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_ScrollResetScheduledItem;

/// @brief Field m_ScrolledToItemIndex, offset 0xa8, size 0x8 
...
/// @brief Field m_StickToBottom, offset 0xb8, size 0x1 
...
/// @brief Field m_TimeSinceFillScheduledMs, offset 0x118, size 0x8 
...
/// @brief Field m_WaitingCache, offset 0xa0, size 0x8 
...
/// @brief Method RefreshScrollOffset, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void RefreshScrollOffset() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo<T>>* const& __cordl_internal_get_m_ContentHeightCache() const;

constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo<T>>*& __cordl_internal_get_m_ContentHeightCache() ;
...
constexpr ::UnityEngine::UIElements::IVisualElementScheduledItem* const& __cordl_internal_get_m_RefreshScrollOffsetScheduledItem() const;

constexpr ::UnityEngine::UIElements::IVisualElementScheduledItem*& __cordl_internal_get_m_RefreshScrollOffsetScheduledItem() ;
...
constexpr void __cordl_internal_set_m_ContentHeightCache(::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo<T>>*  value) ;
...
constexpr void __cordl_internal_set_m_RefreshScrollOffsetScheduledItem(::UnityEngine::UIElements::IVisualElementScheduledItem*  value) ;
...
/// @brief Field m_HighestCachedIndex, offset: 0x88, size: 0x4, def value: None
 int32_t  ___m_HighestCachedIndex;

/// @brief Field m_ItemHeightCache, offset: 0x90, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<int32_t,float_t>*  ___m_ItemHeightCache;

/// @brief Field m_ContentHeightCache, offset: 0x98, size: 0x8, def value: None
...
/// @brief Field m_WaitingCache, offset: 0xa0, size: 0x8, def value: None
 ::System::Collections::Generic::HashSet_1<int32_t>*  ___m_WaitingCache;

/// @brief Field m_ScrolledToItemIndex, offset: 0xa8, size: 0x8, def value: None
 ::System::Nullable_1<int32_t>  ___m_ScrolledToItemIndex;

/// @brief Field m_ForcedFirstVisibleItem, offset: 0xb0, size: 0x4, def value: None
 int32_t  ___m_ForcedFirstVisibleItem;

/// @brief Field m_ForcedLastVisibleItem, offset: 0xb4, size: 0x4, def value: None
 int32_t  ___m_ForcedLastVisibleItem;

/// @brief Field m_StickToBottom, offset: 0xb8, size: 0x1, def value: None
 bool  ___m_StickToBottom;

/// @brief Field m_LastChange, offset: 0xbc, size: 0x4, def value: None
 ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_VirtualizationChange<T>  ___m_LastChange;

/// @brief Field m_ScrollDirection, offset: 0xc0, size: 0x4, def value: None
 ::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ScrollDirection<T>  ___m_ScrollDirection;

/// @brief Field m_DelayedScrollOffset, offset: 0xc4, size: 0x8, def value: None
 ::UnityEngine::Vector2  ___m_DelayedScrollOffset;

/// @brief Field m_AccumulatedHeight, offset: 0xcc, size: 0x4, def value: None
 float_t  ___m_AccumulatedHeight;

/// @brief Field m_MinimumItemHeight, offset: 0xd0, size: 0x4, def value: None
 float_t  ___m_MinimumItemHeight;

/// @brief Field m_FillCallback, offset: 0xd8, size: 0x8, def value: None
 ::System::Action*  ___m_FillCallback;

/// @brief Field m_ScrollResetCallback, offset: 0xe0, size: 0x8, def value: None
 ::System::Action*  ___m_ScrollResetCallback;

/// @brief Field m_GeometryChangedCallback, offset: 0xe8, size: 0x8, def value: None
 ::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  ___m_GeometryChangedCallback;

/// @brief Field m_ScheduledItem, offset: 0xf0, size: 0x8, def value: None
...
/// @brief Field m_RefreshScrollOffsetScheduledItem, offset: 0x100, size: 0x8, def value: None
 ::UnityEngine::UIElements::IVisualElementScheduledItem*  ___m_RefreshScrollOffsetScheduledItem;

/// @brief Field m_IndexOutOfBoundsPredicate, offset: 0x108, size: 0x8, def value: None
 ::System::Predicate_1<int32_t>*  ___m_IndexOutOfBoundsPredicate;

/// @brief Field m_FillExecuted, offset: 0x110, size: 0x1, def value: None
 bool  ___m_FillExecuted;

/// @brief Field m_TimeSinceFillScheduledMs, offset: 0x118, size: 0x8, def value: None
