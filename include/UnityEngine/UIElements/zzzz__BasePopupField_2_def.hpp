...
class BasePopupField_2_PopupTextElement;
}
namespace UnityEngine::UIElements {
template<typename TValueType,typename TValueChoice>
class BasePopupField_2___c;
}
namespace UnityEngine::UIElements {
...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::BasePopupField_2);
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::BasePopupField_2_PopupTextElement);
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::BasePopupField_2___c);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::BasePopupField_2, "UnityEngine.UIElements", "BasePopupField`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::BasePopupField_2_PopupTextElement, "UnityEngine.UIElements", "BasePopupField`2/PopupTextElement");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::BasePopupField_2___c, "UnityEngine.UIElements", "BasePopupField`2/<>c");
...
/// @brief Field m_FormatSelectedValueCallback, offset 0x378, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FormatSelectedValueCallback, put=__cordl_internal_set_m_FormatSelectedValueCallback)) ::System::Func_2<TValueChoice,::StringW>*  m_FormatSelectedValueCallback;
...
/// @brief Field m_ScheduledShowMenuItem, offset 0x370, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScheduledShowMenuItem, put=__cordl_internal_set_m_ScheduledShowMenuItem)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_ScheduledShowMenuItem;
