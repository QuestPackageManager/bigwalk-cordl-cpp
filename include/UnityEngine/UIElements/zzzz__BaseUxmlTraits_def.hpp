...
/// @brief Method set_canHaveAnyAttribute, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::BaseUxmlTraits) == 0x18, "Size mismatch!");
