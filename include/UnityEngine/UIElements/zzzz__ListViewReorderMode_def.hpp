...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ListViewReorderMode, "UnityEngine.UIElements", "ListViewReorderMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::ListViewReorderMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ListViewReorderMode) == 0x4, "Size mismatch!");
