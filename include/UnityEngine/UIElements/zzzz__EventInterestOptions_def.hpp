...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventInterestOptions, "UnityEngine.UIElements", "EventInterestOptions");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::EventInterestOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::EventInterestOptions) == 0x4, "Size mismatch!");
