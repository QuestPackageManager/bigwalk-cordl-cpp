...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::BlurEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7980, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::BlurEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824c6ca0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::BlurEvent) == 0x88, "Size mismatch!");
