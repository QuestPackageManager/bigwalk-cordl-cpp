...
/// @brief Method Init, addr 0x18239b700, size 0x570, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18239bf00, size 0x290, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddId, addr 0x182399700, size 0x60, virtual false, abstract: false, final false
inline void AddId(int32_t  id) ;

/// @brief Method AddIndex, addr 0x182399760, size 0x90, virtual false, abstract: false, final false
inline void AddIndex(int32_t  index, ::System::Object*  obj) ;

/// @brief Method Clear, addr 0x182399860, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearIds, addr 0x1823997f0, size 0x30, virtual false, abstract: false, final false
inline void ClearIds() ;

/// @brief Method ClearIndices, addr 0x182399820, size 0x30, virtual false, abstract: false, final false
inline void ClearIndices() ;

/// @brief Method ClearItems, addr 0x182399850, size 0x10, virtual false, abstract: false, final false
inline void ClearItems() ;

/// @brief Method ContainsId, addr 0x1823998c0, size 0x10, virtual false, abstract: false, final false
inline bool ContainsId(int32_t  id) ;

/// @brief Method ContainsIndex, addr 0x1823998d0, size 0x10, virtual false, abstract: false, final false
inline bool ContainsIndex(int32_t  index) ;

/// @brief Method FirstIndex, addr 0x1823998e0, size 0x20, virtual false, abstract: false, final false
inline int32_t FirstIndex() ;

/// @brief Method FirstObject, addr 0x182399900, size 0x50, virtual false, abstract: false, final false
inline ::System::Object* FirstObject() ;

static inline ::UnityEngine::UIElements::BaseVerticalCollectionView_Selection* New_ctor() ;

/// @brief Method RemoveId, addr 0x182399950, size 0x40, virtual false, abstract: false, final false
inline void RemoveId(int32_t  id) ;

/// @brief Method TryRemove, addr 0x182399990, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182399a20, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_capacity, addr 0x182399b00, size 0x10, virtual false, abstract: false, final false
inline int32_t get_capacity() ;

/// @brief Method get_idCount, addr 0x180df9d70, size 0x10, virtual false, abstract: false, final false
inline int32_t get_idCount() ;

/// @brief Method get_indexCount, addr 0x182399b10, size 0x10, virtual false, abstract: false, final false
inline int32_t get_indexCount() ;

/// @brief Method get_maxIndex, addr 0x182399b20, size 0x30, virtual false, abstract: false, final false
inline int32_t get_maxIndex() ;

/// @brief Method get_minIndex, addr 0x182399b50, size 0x30, virtual false, abstract: false, final false
inline int32_t get_minIndex() ;

/// @brief Method get_selectedIds, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<int32_t>* get_selectedIds() ;

/// @brief Method set_capacity, addr 0x182399b80, size 0x50, virtual false, abstract: false, final false
inline void set_capacity(int32_t  value) ;

/// @brief Method set_selectedIds, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::BaseVerticalCollectionView_RangeSelectionDirection, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::BaseVerticalCollectionView_pointerProcessingStateEnum, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method <.ctor>b__191_1, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <GetRootElementForId>b__0, addr 0x18239ac90, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "BaseVerticalCollectionView___c__DisplayClass194_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
BaseVerticalCollectionView___c__DisplayClass194_0(BaseVerticalCollectionView___c__DisplayClass194_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "BaseVerticalCollectionView___c__DisplayClass194_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
...
/// @brief Method MoveNext, addr 0x18239acf0, size 0x1b0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::UIElements::BaseVerticalCollectionView__get_selectedItems_d__88* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Object>.GetEnumerator, addr 0x18239aea0, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x18239aea0, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x18239af20, size 0x40, virtual true, abstract: false, final true
...
/// @brief Field <currentPointerButton>k__BackingField, offset 0x3a4, size 0x4 
 __declspec(property(get=__cordl_internal_get__currentPointerButton_k__BackingField, put=__cordl_internal_set__currentPointerButton_k__BackingField)) int32_t  _currentPointerButton_k__BackingField;

/// @brief Field <pointerProcessingState>k__BackingField, offset 0x3a0, size 0x4 
 __declspec(property(get=__cordl_internal_get__pointerProcessingState_k__BackingField, put=__cordl_internal_set__pointerProcessingState_k__BackingField)) ::UnityEngine::UIElements::BaseVerticalCollectionView_pointerProcessingStateEnum  _pointerProcessingState_k__BackingField;
...
/// @brief Field m_RangeSelectionDirection, offset 0x37c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_RangeSelectionDirection, put=__cordl_internal_set_m_RangeSelectionDirection)) ::UnityEngine::UIElements::BaseVerticalCollectionView_RangeSelectionDirection  m_RangeSelectionDirection;
...
/// @brief Method AddToSelection, addr 0x18238f810, size 0xc0, virtual false, abstract: false, final false
inline void AddToSelection(int32_t  index) ;

/// @brief Method AddToSelection, addr 0x18238f8d0, size 0x80, virtual false, abstract: false, final false
inline void AddToSelection(::System::ReadOnlySpan_1<int32_t>  indexes) ;

/// @brief Method AddToSelectionWithoutValidation, addr 0x18238f520, size 0x2f0, virtual false, abstract: false, final false
inline void AddToSelectionWithoutValidation(int32_t  index) ;

/// @brief Method Apply, addr 0x18238f950, size 0x5c0, virtual false, abstract: false, final false
inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op, bool  shiftKey, bool  altKey) ;

/// @brief Method Apply, addr 0x18238ff10, size 0x170, virtual false, abstract: false, final false
inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op, ::UnityEngine::UIElements::EventBase*  sourceEvent) ;

/// @brief Method ClearSelection, addr 0x182390260, size 0x50, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method ClearSelectionWithoutValidation, addr 0x182390080, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method CreateDragger, addr 0x1823902b0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method CreateVirtualizationController, addr 0x1823902f0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method DoRangeSelection, addr 0x182390300, size 0x270, virtual false, abstract: false, final false
inline void DoRangeSelection(int32_t  rangeSelectionFinalIndex) ;

/// @brief Method DoSelect, addr 0x182390570, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method ExecuteDefaultAction, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method GetOrCreateViewController, addr 0x182390960, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionViewController* GetOrCreateViewController() ;

/// @brief Method GetOrCreateVirtualizationController, addr 0x1823909c0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionVirtualizationController* GetOrCreateVirtualizationController() ;

/// @brief Method GetRootElementForId, addr 0x182390a00, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetRootElementForId(int32_t  id) ;

/// @brief Method HandleEventBubbleUp, addr 0x182390af0, size 0x250, virtual true, abstract: false, final false
inline void HandleEventBubbleUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleItemNavigation, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool HandleItemNavigation(bool  moveIn, bool  altKey) ;

/// @brief Method HasCanStartDrag, addr 0x182390d40, size 0x10, virtual false, abstract: false, final false
inline bool HasCanStartDrag() ;

/// @brief Method HasValidDataAndBindings, addr 0x182390d50, size 0x40, virtual true, abstract: false, final false
inline bool HasValidDataAndBindings() ;

/// @brief Method InitializeDragAndDropController, addr 0x182390d90, size 0xf0, virtual false, abstract: false, final false
inline void InitializeDragAndDropController(bool  enableReordering) ;

/// @brief Method MatchesExistingSelection, addr 0x182390e80, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method NotifyOfSelectionChange, addr 0x182390ff0, size 0xc0, virtual false, abstract: false, final false
inline void NotifyOfSelectionChange() ;

/// @brief Method OnAttachToPanel, addr 0x1823910b0, size 0x220, virtual false, abstract: false, final false
inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnCustomStyleResolved, addr 0x1823912d0, size 0x150, virtual false, abstract: false, final false
inline void OnCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent*  e) ;

/// @brief Method OnDetachFromPanel, addr 0x182391420, size 0x1c0, virtual false, abstract: false, final false
inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method OnItemIndexChanged, addr 0x1823915e0, size 0x40, virtual false, abstract: false, final false
inline void OnItemIndexChanged(int32_t  srcIndex, int32_t  dstIndex) ;

/// @brief Method OnItemsSourceChanged, addr 0x182391620, size 0x60, virtual false, abstract: false, final false
inline void OnItemsSourceChanged() ;

/// @brief Method OnPointerCancel, addr 0x182391680, size 0x80, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x182391700, size 0x10, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x182391710, size 0x30, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x182391740, size 0x10, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnScroll, addr 0x182391750, size 0x80, virtual false, abstract: false, final false
inline void OnScroll(::UnityEngine::Vector2  offset) ;

/// @brief Method OnSizeChanged, addr 0x1823917d0, size 0x100, virtual false, abstract: false, final false
inline void OnSizeChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x1823918d0, size 0x40, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method PostRefresh, addr 0x182391910, size 0xe0, virtual true, abstract: false, final false
inline void PostRefresh() ;

/// @brief Method ProcessPointerDown, addr 0x1823919f0, size 0x370, virtual false, abstract: false, final false
inline void ProcessPointerDown(::UnityEngine::UIElements::IPointerEvent*  evt) ;

/// @brief Method ProcessPointerUp, addr 0x182391d60, size 0x370, virtual false, abstract: false, final false
inline void ProcessPointerUp(::UnityEngine::UIElements::IPointerEvent*  evt) ;

/// @brief Method ProcessSingleClick, addr 0x1823920d0, size 0x10, virtual false, abstract: false, final false
inline void ProcessSingleClick(int32_t  clickedIndex) ;

/// @brief Method RaiseCanStartDrag, addr 0x1823920e0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method RaiseDrop, addr 0x1823921e0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method RaiseHandleDragAndDrop, addr 0x182392280, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method RaiseSetupDragAndDrop, addr 0x182392320, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method Rebuild, addr 0x182392480, size 0x160, virtual false, abstract: false, final false
inline void Rebuild() ;

/// @brief Method RefreshItems, addr 0x1823925e0, size 0x180, virtual false, abstract: false, final false
inline void RefreshItems() ;

/// @brief Method RefreshSelection, addr 0x182392760, size 0x3f0, virtual false, abstract: false, final false
inline void RefreshSelection() ;

/// @brief Method RemoveFromSelection, addr 0x182392dc0, size 0x60, virtual false, abstract: false, final false
inline void RemoveFromSelection(int32_t  index) ;

/// @brief Method RemoveFromSelectionWithoutValidation, addr 0x182392b50, size 0x270, virtual false, abstract: false, final false
inline void RemoveFromSelectionWithoutValidation(int32_t  index) ;

/// @brief Method Resize, addr 0x182392e20, size 0xb0, virtual false, abstract: false, final false
inline void Resize(::UnityEngine::Vector2  size) ;

/// @brief Method ResolveItemHeight, addr 0x182392ed0, size 0x20, virtual false, abstract: false, final false
inline float_t ResolveItemHeight(float_t  height) ;

/// @brief Method ScheduleRebuild, addr 0x182392ef0, size 0xd0, virtual false, abstract: false, final false
inline void ScheduleRebuild() ;

/// @brief Method ScrollToItem, addr 0x182393050, size 0x70, virtual false, abstract: false, final false
inline void ScrollToItem(int32_t  index) ;

/// @brief Method ScrollToItemById, addr 0x182392fc0, size 0x90, virtual false, abstract: false, final false
inline void ScrollToItemById(int32_t  id) ;

/// @brief Method SelectAll, addr 0x1823930c0, size 0x280, virtual false, abstract: false, final false
inline void SelectAll() ;

/// @brief Method SetSelection, addr 0x1823939d0, size 0xc0, virtual false, abstract: false, final false
inline void SetSelection(int32_t  index) ;

/// @brief Method SetSelection, addr 0x1823939a0, size 0x30, virtual false, abstract: false, final false
inline void SetSelection(::System::ReadOnlySpan_1<int32_t>  indices) ;

/// @brief Method SetSelectionInternal, addr 0x182393340, size 0x380, virtual false, abstract: false, final false
inline void SetSelectionInternal(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices, bool  sendNotification) ;

/// @brief Method SetSelectionInternal, addr 0x1823936c0, size 0x2d0, virtual false, abstract: false, final false
inline void SetSelectionInternal(::System::ReadOnlySpan_1<int32_t>  indices, bool  sendNotification) ;

/// @brief Method SetSelectionWithoutNotify, addr 0x182393990, size 0x10, virtual false, abstract: false, final false
inline void SetSelectionWithoutNotify(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method SetViewController, addr 0x182393a90, size 0x190, virtual true, abstract: false, final false
inline void SetViewController(::UnityEngine::UIElements::CollectionViewController*  controller) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x182393d90, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method <Apply>g__HandleSelectionAndScroll|216_0, addr 0x182393c20, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method <RefreshSelection>g__NotifyIfChanged|205_0, addr 0x182393ce0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__191_0, addr 0x182393d10, size 0x80, virtual false, abstract: false, final false
inline void __ctor_b__191_0(float_t  v) ;

/// @brief Method .ctor, addr 0x182394b20, size 0x640, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182395160, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_activeItems, addr 0x182395220, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ReusableCollectionItem*>* get_activeItems() ;

/// @brief Method get_contentContainer, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_dragger, addr 0x1811005d0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ListViewDragger* get_dragger() ;

/// @brief Method get_fixedItemHeight, addr 0x182395280, size 0x10, virtual false, abstract: false, final false
inline float_t get_fixedItemHeight() ;

/// @brief Method get_horizontalScrollingEnabled, addr 0x182395290, size 0x10, virtual false, abstract: false, final false
inline bool get_horizontalScrollingEnabled() ;

/// @brief Method get_isRebuildScheduled, addr 0x1823952a0, size 0x20, virtual false, abstract: false, final false
inline bool get_isRebuildScheduled() ;

/// @brief Method get_itemsSource, addr 0x1823952c0, size 0x30, virtual false, abstract: false, final false
inline ::System::Collections::IList* get_itemsSource() ;

/// @brief Method get_reorderable, addr 0x1823952f0, size 0x50, virtual false, abstract: false, final false
inline bool get_reorderable() ;

/// @brief Method get_scrollView, addr 0x180388350, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ScrollView* get_scrollView() ;

/// @brief Method get_selectedIds, addr 0x182395340, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_selectedIds() ;

/// @brief Method get_selectedIndex, addr 0x182395350, size 0x30, virtual false, abstract: false, final false
inline int32_t get_selectedIndex() ;

/// @brief Method get_selectedIndices, addr 0x182395380, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_selectedIndices() ;

/// @brief Method get_selectedItem, addr 0x182395390, size 0x60, virtual false, abstract: false, final false
inline ::System::Object* get_selectedItem() ;

/// @brief Method get_selectedItems, addr 0x1823953f0, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_selectedItems() ;

/// @brief Method get_selectionType, addr 0x182395440, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SelectionType get_selectionType() ;

/// @brief Method get_showAlternatingRowBackgrounds, addr 0x182395450, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::AlternatingRowBackground get_showAlternatingRowBackgrounds() ;

/// @brief Method get_showBorder, addr 0x182395460, size 0x50, virtual false, abstract: false, final false
inline bool get_showBorder() ;

/// @brief Method get_viewController, addr 0x180fbe8d0, size 0x3ea0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionViewController* get_viewController() ;

/// @brief Method get_virtualizationController, addr 0x1823909c0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionVirtualizationController* get_virtualizationController() ;

/// @brief Method get_virtualizationMethod, addr 0x1807095b0, size 0xb360, virtual false, abstract: false, final false
...
/// @brief Method set_currentPointerButton, addr 0x1823954b0, size 0x10, virtual false, abstract: false, final false
inline void set_currentPointerButton(int32_t  value) ;

/// @brief Method set_fixedItemHeight, addr 0x1823954c0, size 0xa0, virtual false, abstract: false, final false
inline void set_fixedItemHeight(float_t  value) ;

/// @brief Method set_horizontalScrollingEnabled, addr 0x182395560, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method set_pointerProcessingState, addr 0x182395600, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_reorderable, addr 0x182395610, size 0x120, virtual false, abstract: false, final false
inline void set_reorderable(bool  value) ;

/// @brief Method set_selectedIndex, addr 0x1823920d0, size 0x10, virtual false, abstract: false, final false
inline void set_selectedIndex(int32_t  value) ;

/// @brief Method set_selectionType, addr 0x182395730, size 0xd0, virtual false, abstract: false, final false
inline void set_selectionType(::UnityEngine::UIElements::SelectionType  value) ;

/// @brief Method set_showAlternatingRowBackgrounds, addr 0x182395800, size 0x70, virtual false, abstract: false, final false
inline void set_showAlternatingRowBackgrounds(::UnityEngine::UIElements::AlternatingRowBackground  value) ;

/// @brief Method set_showBorder, addr 0x182395870, size 0x120, virtual false, abstract: false, final false
inline void set_showBorder(bool  value) ;

/// @brief Method set_virtualizationMethod, addr 0x182395990, size 0x80, virtual false, abstract: false, final false
