...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Clickable*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Clickable*, "UnityEngine.UIElements", "Clickable");
...
/// @brief Field <lastMousePosition>k__BackingField, offset 0x4c, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastMousePosition_k__BackingField, put=__cordl_internal_set__lastMousePosition_k__BackingField)) ::UnityEngine::Vector2  _lastMousePosition_k__BackingField;
...
/// @brief Field clicked, offset 0x30, size 0x8 
...
/// @brief Field m_AcceptClicksIfDisabled, offset 0x58, size 0x1 
...
/// @brief Field m_ActivePointerId, offset 0x54, size 0x4 
...
/// @brief Field m_Delay, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Delay, put=__cordl_internal_set_m_Delay)) int64_t  m_Delay;

/// @brief Field m_Interval, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Interval, put=__cordl_internal_set_m_Interval)) int64_t  m_Interval;

/// @brief Field m_PendingActivePseudoStateReset, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PendingActivePseudoStateReset, put=__cordl_internal_set_m_PendingActivePseudoStateReset)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_PendingActivePseudoStateReset;
...
/// @brief Method ContainsPointer, addr 0x182379b40, size 0x70, virtual false, abstract: false, final false
inline bool ContainsPointer(int32_t  pointerId) ;

/// @brief Method Invoke, addr 0x182379bb0, size 0x50, virtual false, abstract: false, final false
inline void Invoke(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsRepeatable, addr 0x182379c00, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method OnPointerCancel, addr 0x182379c20, size 0x50, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x182379c70, size 0x20, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x182379c90, size 0x70, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x182379d00, size 0x40, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x182379d40, size 0x70, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnTimer, addr 0x182379db0, size 0xc0, virtual false, abstract: false, final false
inline void OnTimer(::UnityEngine::UIElements::TimerState  timerState) ;

/// @brief Method ProcessCancelEvent, addr 0x182379e70, size 0xd0, virtual true, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x182379f40, size 0x250, virtual true, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x18237a190, size 0xa0, virtual true, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x18237a230, size 0x130, virtual true, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x18237a360, size 0x1a0, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method ResetActivePseudoState, addr 0x18237a500, size 0x50, virtual false, abstract: false, final false
inline void ResetActivePseudoState() ;

/// @brief Method SimulateSingleClick, addr 0x18237a550, size 0x170, virtual false, abstract: false, final false
inline void SimulateSingleClick(::UnityEngine::UIElements::EventBase*  evt, int32_t  delayMs) ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x18237a6c0, size 0x1b0, virtual true, abstract: false, final false
...
constexpr ::UnityEngine::UIElements::IVisualElementScheduledItem* const& __cordl_internal_get_m_PendingActivePseudoStateReset() const;

constexpr ::UnityEngine::UIElements::IVisualElementScheduledItem*& __cordl_internal_get_m_PendingActivePseudoStateReset() ;
...
constexpr void __cordl_internal_set_m_PendingActivePseudoStateReset(::UnityEngine::UIElements::IVisualElementScheduledItem*  value) ;

constexpr void __cordl_internal_set_m_Repeater(::UnityEngine::UIElements::IVisualElementScheduledItem*  value) ;

/// @brief Method .ctor, addr 0x18237aa00, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  handler) ;

/// @brief Method .ctor, addr 0x18237a870, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  handler, int64_t  delay, int64_t  interval) ;

/// @brief Method .ctor, addr 0x18237a940, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  handler) ;

/// @brief Method add_clicked, addr 0x18062eaa0, size 0x80, virtual false, abstract: false, final false
inline void add_clicked(::System::Action*  value) ;

/// @brief Method add_clickedWithEventInfo, addr 0x18237aac0, size 0x90, virtual false, abstract: false, final false
inline void add_clickedWithEventInfo(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  value) ;

/// @brief Method get_CallbackOptions, addr 0x18237ab50, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::CallbackOptions get_CallbackOptions() ;

/// @brief Method get_acceptClicksIfDisabled, addr 0x1803151e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_lastMousePosition, addr 0x1817850e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_lastMousePosition() ;

/// @brief Method remove_clicked, addr 0x18062ec30, size 0x80, virtual false, abstract: false, final false
inline void remove_clicked(::System::Action*  value) ;

/// @brief Method remove_clickedWithEventInfo, addr 0x18237ab60, size 0x90, virtual false, abstract: false, final false
inline void remove_clickedWithEventInfo(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  value) ;

/// @brief Method set_acceptClicksIfDisabled, addr 0x18237abf0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method set_lastMousePosition, addr 0x18237ac60, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_Delay, offset: 0x38, size: 0x8, def value: None
 int64_t  ___m_Delay;
...
/// @brief Field m_ActivePointerId, offset: 0x54, size: 0x4, def value: None
 int32_t  ___m_ActivePointerId;

/// @brief Field m_AcceptClicksIfDisabled, offset: 0x58, size: 0x1, def value: None
 bool  ___m_AcceptClicksIfDisabled;

/// @brief Field m_Repeater, offset: 0x60, size: 0x8, def value: None
 ::UnityEngine::UIElements::IVisualElementScheduledItem*  ___m_Repeater;

/// @brief Field m_PendingActivePseudoStateReset, offset: 0x68, size: 0x8, def value: None
 ::UnityEngine::UIElements::IVisualElementScheduledItem*  ___m_PendingActivePseudoStateReset;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___clickedWithEventInfo) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___clicked) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_Delay) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_Interval) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ____active_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ____lastMousePosition_k__BackingField) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_ActivePointerId) == 0x54, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_AcceptClicksIfDisabled) == 0x58, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_Repeater) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Clickable, ___m_PendingActivePseudoStateReset) == 0x68, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Clickable) == 0x70, "Size mismatch!");
