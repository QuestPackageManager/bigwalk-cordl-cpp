...
/// @brief Method .ctor, addr 0x182375d00, size 0x220, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  targetElement, ::by_ref<::UnityEngine::UIElements::BindingId>  bindingId, ::by_ref<::Unity::Properties::PropertyPath>  resolvedDataSourcePath, ::System::Object*  resolvedDataSource) ;

/// @brief Method get_bindingId, addr 0x18072e180, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingId get_bindingId() ;

/// @brief Method get_dataSource, addr 0x1803370b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_dataSource() ;

/// @brief Method get_dataSourcePath, addr 0x18072e1f0, size 0x2cf20, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyPath get_dataSourcePath() ;

/// @brief Method get_targetElement, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_TargetElement", ty: "::UnityEngine::UIElements::VisualElement*", modifiers: "", def_value: None }, CppParam { name: "m_BindingId", ty: "::UnityEngine::UIElements::BindingId", modifiers: "", def_value: None }, CppParam { name: "m_DataSourcePath", ty: "::Unity::Properties::PropertyPath", modifiers: "", def_value: None }, CppParam { name: "m_DataSource", ty: "::System::Object*", modifiers: "", def_value: None }]
constexpr BindingContext(::UnityEngine::UIElements::VisualElement*  m_TargetElement, ::UnityEngine::UIElements::BindingId  m_BindingId, ::Unity::Properties::PropertyPath  m_DataSourcePath, ::System::Object*  m_DataSource) noexcept;
...
static_assert(sizeof(::UnityEngine::UIElements::BindingContext) == 0x138, "Size mismatch!");
