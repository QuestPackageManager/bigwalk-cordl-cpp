...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::InputEvent*);
MARK_REF_T(::UnityEngine::UIElements::InputEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::InputEvent*, "UnityEngine.UIElements", "InputEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::InputEvent___c*, "UnityEngine.UIElements", "InputEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d78f0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::InputEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method GetPooled, addr 0x1824d2860, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::InputEvent* GetPooled(::StringW  previousData, ::StringW  newData) ;

/// @brief Method Init, addr 0x181114f40, size 0xb0, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x181114ff0, size 0x450, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824d2940, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_newData, addr 0x1803d5ad0, size 0x10, virtual false, abstract: false, final false
inline void set_newData(::StringW  value) ;

/// @brief Method set_previousData, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::InputEvent) == 0x78, "Size mismatch!");
