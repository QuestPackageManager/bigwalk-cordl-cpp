...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MeshWriteDataInterface, "UnityEngine.UIElements", "MeshWriteDataInterface");
...
// Ctor Parameters [CppParam { name: "vertices", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "indices", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "vertexCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "indexCount", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::MeshWriteDataInterface) == 0x18, "Size mismatch!");
