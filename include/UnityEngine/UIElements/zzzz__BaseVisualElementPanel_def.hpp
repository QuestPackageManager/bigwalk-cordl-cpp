...
/// @brief Method <.ctor>b__28_0, addr 0x182510910, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "BaseVisualElementPanel___c", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
BaseVisualElementPanel___c(BaseVisualElementPanel___c && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "BaseVisualElementPanel___c", modifiers: "const&", def_value: None }]
...
/// @brief Field <clearSettings>k__BackingField, offset 0x70, size 0x14 
 __declspec(property(get=__cordl_internal_get__clearSettings_k__BackingField, put=__cordl_internal_set__clearSettings_k__BackingField)) ::UnityEngine::UIElements::PanelClearSettings  _clearSettings_k__BackingField;

/// @brief Field <contextualMenuManager>k__BackingField, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__contextualMenuManager_k__BackingField, put=__cordl_internal_set__contextualMenuManager_k__BackingField)) ::UnityEngine::UIElements::ContextualMenuManager*  _contextualMenuManager_k__BackingField;

/// @brief Field <cursorManager>k__BackingField, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__cursorManager_k__BackingField, put=__cordl_internal_set__cursorManager_k__BackingField)) ::UnityEngine::UIElements::ICursorManager*  _cursorManager_k__BackingField;

/// @brief Field <dataBindingManager>k__BackingField, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__dataBindingManager_k__BackingField, put=__cordl_internal_set__dataBindingManager_k__BackingField)) ::UnityEngine::UIElements::DataBindingManager*  _dataBindingManager_k__BackingField;
...
/// @brief Field <referenceSpritePixelsPerUnit>k__BackingField, offset 0x6c, size 0x4 
 __declspec(property(get=__cordl_internal_get__referenceSpritePixelsPerUnit_k__BackingField, put=__cordl_internal_set__referenceSpritePixelsPerUnit_k__BackingField)) float_t  _referenceSpritePixelsPerUnit_k__BackingField;

/// @brief Field <repaintData>k__BackingField, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__repaintData_k__BackingField, put=__cordl_internal_set__repaintData_k__BackingField)) ::UnityEngine::UIElements::RepaintData*  _repaintData_k__BackingField;
...
/// @brief Field m_TopElementUnderPointers, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TopElementUnderPointers, put=__cordl_internal_set_m_TopElementUnderPointers)) ::UnityEngine::UIElements::ElementUnderPointer*  m_TopElementUnderPointers;
...
/// @brief Field textElementRegistry, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_textElementRegistry, put=__cordl_internal_set_textElementRegistry)) ::System::Lazy_1<::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::TextElement*>*>*  textElementRegistry;
...
/// @brief Method ClearCachedElementUnderPointer, addr 0x182505180, size 0x30, virtual false, abstract: false, final false
inline void ClearCachedElementUnderPointer(int32_t  pointerId, ::UnityEngine::UIElements::EventBase*  triggerEvent) ;

/// @brief Method CommitElementUnderPointers, addr 0x1825051b0, size 0x70, virtual false, abstract: false, final false
inline bool CommitElementUnderPointers() ;

/// @brief Method CreateMenu, addr 0x182505220, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::AbstractGenericMenu* CreateMenu() ;

/// @brief Method DefaultTimeSinceStartup, addr 0x182505240, size 0x10, virtual false, abstract: false, final false
static inline double_t DefaultTimeSinceStartup() ;

/// @brief Method Dispose, addr 0x182505250, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x182505280, size 0xb0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetTopElementUnderPointer, addr 0x182505330, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method InvokeAtlasChanged, addr 0x182505340, size 0x20, virtual false, abstract: false, final false
inline void InvokeAtlasChanged() ;

/// @brief Method InvokeBeforeUpdate, addr 0x182505360, size 0x20, virtual false, abstract: false, final false
inline void InvokeBeforeUpdate() ;

/// @brief Method InvokeHierarchyChanged, addr 0x182505380, size 0x30, virtual false, abstract: false, final false
inline void InvokeHierarchyChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::HierarchyChangeType  changeType, ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::UIElements::VisualElement*>*  additionalContext) ;
...
/// @brief Method Pick, addr 0x1825053b0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method RecomputeTopElementUnderPointer, addr 0x1825053e0, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method RemoveElementFromPointerCache, addr 0x182505610, size 0x10, virtual false, abstract: false, final false
inline void RemoveElementFromPointerCache(::UnityEngine::UIElements::VisualElement*  e) ;

/// @brief Method Render, addr 0x182505620, size 0x20, virtual true, abstract: false, final false
inline void Render() ;
...
/// @brief Method SendEvent, addr 0x182505640, size 0x150, virtual false, abstract: false, final false
inline void SendEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::UIElements::DispatchMode  dispatchMode) ;

/// @brief Method SetSpecializedHierarchyFlagsUpdater, addr 0x182505790, size 0xe0, virtual false, abstract: false, final false
inline void SetSpecializedHierarchyFlagsUpdater() ;

/// @brief Method SetTopElementUnderPointer, addr 0x182505870, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetTopElementUnderPointer, addr 0x182505890, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method TickSchedulingUpdaters, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void TickSchedulingUpdaters() ;

/// @brief Method TimeSinceStartupMs, addr 0x1825058b0, size 0x90, virtual false, abstract: false, final false
inline int64_t TimeSinceStartupMs() ;

/// @brief Method TimeSinceStartupSeconds, addr 0x182505940, size 0x70, virtual false, abstract: false, final false
inline double_t TimeSinceStartupSeconds() ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method UpdateDataBinding, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void UpdateDataBinding() ;

/// @brief Method UpdateElementUnderPointers, addr 0x1825059b0, size 0x200, virtual false, abstract: false, final false
inline bool UpdateElementUnderPointers() ;

/// @brief Method UpdateForRepaint, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182505be0, size 0x1f0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_atlasChanged, addr 0x182505dd0, size 0x90, virtual false, abstract: false, final false
inline void add_atlasChanged(::System::Action*  value) ;

/// @brief Method add_hierarchyChanged, addr 0x182505e60, size 0x90, virtual false, abstract: false, final false
inline void add_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent*  value) ;

/// @brief Method add_isFlatChanged, addr 0x182505ef0, size 0x90, virtual false, abstract: false, final false
inline void add_isFlatChanged(::System::Action*  value) ;

/// @brief Method add_panelDisposed, addr 0x182505f80, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_TimeSinceStartupFunc, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_clearSettings, addr 0x182506010, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_contextualMenuManager, addr 0x180322750, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::ContextualMenuManager* get_contextualMenuManager() ;

/// @brief Method get_cursorManager, addr 0x1802ec4d0, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ICursorManager* get_cursorManager() ;

/// @brief Method get_dataBindingManager, addr 0x180322760, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_disposed, addr 0x180f187e0, size 0x650, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_duringLayoutPhase, addr 0x180cbfa60, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_isDirty, addr 0x182506030, size 0x50, virtual true, abstract: false, final true
inline bool get_isDirty() ;

/// @brief Method get_isFlat, addr 0x18140d8a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_referenceSpritePixelsPerUnit, addr 0x180474bd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_referenceSpritePixelsPerUnit() ;

/// @brief Method get_repaintData, addr 0x1802ec4b0, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::RepaintData* get_repaintData() ;

/// @brief Method get_repaintVersion, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
...
/// @brief Method get_scale, addr 0x1802f42b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_scaledPixelsPerPoint, addr 0x182506080, size 0x10, virtual true, abstract: false, final true
inline float_t get_scaledPixelsPerPoint() ;

/// @brief Method get_scheduler, addr 0x182506090, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_uiElementsBridge, addr 0x182506190, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasChanged, addr 0x1825061c0, size 0x90, virtual false, abstract: false, final false
inline void remove_atlasChanged(::System::Action*  value) ;

/// @brief Method remove_hierarchyChanged, addr 0x182506250, size 0x90, virtual false, abstract: false, final false
inline void remove_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent*  value) ;

/// @brief Method remove_isFlatChanged, addr 0x1825062e0, size 0x90, virtual false, abstract: false, final false
inline void remove_isFlatChanged(::System::Action*  value) ;

/// @brief Method remove_panelDisposed, addr 0x182506370, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method set_clearSettings, addr 0x182506400, size 0x20, virtual false, abstract: false, final false
inline void set_clearSettings(::UnityEngine::UIElements::PanelClearSettings  value) ;

/// @brief Method set_contextualMenuManager, addr 0x180322770, size 0x20, virtual false, abstract: false, final false
inline void set_contextualMenuManager(::UnityEngine::UIElements::ContextualMenuManager*  value) ;

/// @brief Method set_cursorManager, addr 0x1802ec810, size 0x20, virtual true, abstract: false, final false
inline void set_cursorManager(::UnityEngine::UIElements::ICursorManager*  value) ;

/// @brief Method set_dataBindingManager, addr 0x180322790, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method set_disposed, addr 0x180f18e30, size 0xedb0, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_duringLayoutPhase, addr 0x180cbfe20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_isFlat, addr 0x182506420, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_referenceSpritePixelsPerUnit, addr 0x180474c90, size 0x10, virtual false, abstract: false, final false
inline void set_referenceSpritePixelsPerUnit(float_t  value) ;

/// @brief Method set_repaintData, addr 0x18163ca40, size 0x20, virtual true, abstract: false, final false
inline void set_repaintData(::UnityEngine::UIElements::RepaintData*  value) ;

/// @brief Method set_scale, addr 0x182506470, size 0xe0, virtual false, abstract: false, final false
