...
public:
// Declarations
/// @brief Method CaptureMouse, addr 0x18250b0c0, size 0x1f0, virtual false, abstract: false, final false
static inline void CaptureMouse(::UnityEngine::UIElements::IEventHandler*  handler) ;

/// @brief Method HasMouseCapture, addr 0x18250b2b0, size 0x100, virtual false, abstract: false, final false
