...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::StyleMatchingContext*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleMatchingContext*, "UnityEngine.UIElements", "StyleMatchingContext");
...
/// @brief Field m_StyleSheetStack, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_StyleSheetStack, put=__cordl_internal_set_m_StyleSheetStack)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UIElements::StyleSheet>>*  m_StyleSheetStack;

/// @brief Field processResult, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_processResult, put=__cordl_internal_set_processResult)) ::System::Action_2<::UnityEngine::UIElements::VisualElement*,::UnityEngine::UIElements::StyleSheets::MatchResultInfo>*  processResult;
...
/// @brief Method AddStyleSheet, addr 0x1824119a0, size 0x90, virtual false, abstract: false, final false
inline void AddStyleSheet(::UnityEngine::UIElements::StyleSheet*  sheet) ;

/// @brief Method GetStyleSheetAt, addr 0x180ca89d0, size 0xcac0, virtual false, abstract: false, final false
...
/// @brief Method RemoveStyleSheetRange, addr 0x182411a30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182411a40, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_styleSheetCount, addr 0x1809d15e0, size 0x4e0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::StyleMatchingContext) == 0x38, "Size mismatch!");
