...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AngleUnit, "UnityEngine.UIElements", "AngleUnit");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::AngleUnit, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::AngleUnit) == 0x4, "Size mismatch!");
