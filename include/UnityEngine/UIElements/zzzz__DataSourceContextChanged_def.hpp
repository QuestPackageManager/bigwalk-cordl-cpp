...
public:
// Declarations
/// @brief Method .ctor, addr 0x18237ee60, size 0x230, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  element, ::by_ref<::UnityEngine::UIElements::BindingId>  bindingId, ::by_ref<::UnityEngine::UIElements::DataSourceContext>  previousContext, ::by_ref<::UnityEngine::UIElements::DataSourceContext>  newContext) ;

// Ctor Parameters []
// @brief default ctor
constexpr DataSourceContextChanged() ;

// Ctor Parameters [CppParam { name: "m_TargetElement", ty: "::UnityEngine::UIElements::VisualElement*", modifiers: "", def_value: None }, CppParam { name: "m_BindingId", ty: "::UnityEngine::UIElements::BindingId", modifiers: "", def_value: None }, CppParam { name: "m_PreviousContext", ty: "::UnityEngine::UIElements::DataSourceContext", modifiers: "", def_value: None }, CppParam { name: "m_NewContext", ty: "::UnityEngine::UIElements::DataSourceContext", modifiers: "", def_value: None }]
constexpr DataSourceContextChanged(::UnityEngine::UIElements::VisualElement*  m_TargetElement, ::UnityEngine::UIElements::BindingId  m_BindingId, ::UnityEngine::UIElements::DataSourceContext  m_PreviousContext, ::UnityEngine::UIElements::DataSourceContext  m_NewContext) noexcept;
...
static_assert(sizeof(::UnityEngine::UIElements::DataSourceContextChanged) == 0x1d0, "Size mismatch!");
