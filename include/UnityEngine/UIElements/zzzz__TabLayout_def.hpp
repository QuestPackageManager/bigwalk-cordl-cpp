...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TabLayout*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TabLayout*, "UnityEngine.UIElements", "TabLayout");
...
/// @brief Method GetHeight, addr 0x1824ab950, size 0x20, virtual false, abstract: false, final false
static inline float_t GetHeight(::UnityEngine::UIElements::VisualElement*  t) ;

/// @brief Method GetTabOffset, addr 0x1824ab970, size 0xe0, virtual false, abstract: false, final false
inline float_t GetTabOffset(::UnityEngine::UIElements::VisualElement*  tab) ;

/// @brief Method GetWidth, addr 0x1824aba50, size 0x20, virtual false, abstract: false, final false
static inline float_t GetWidth(::UnityEngine::UIElements::VisualElement*  t) ;

/// @brief Method InitOrderTabs, addr 0x1824aba70, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ReorderDisplay, addr 0x1824abac0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824abb40, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TabLayout) == 0x28, "Size mismatch!");
