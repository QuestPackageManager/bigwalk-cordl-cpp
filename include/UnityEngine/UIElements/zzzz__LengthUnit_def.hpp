...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::LengthUnit, "UnityEngine.UIElements", "LengthUnit");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::LengthUnit, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::LengthUnit) == 0x4, "Size mismatch!");
