...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseCaptureEvent___c::*)()>(&::UnityEngine::UIElements::MouseCaptureEvent___c::_ctor)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::MouseCaptureEvent___c*>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::MouseCaptureEvent* (::UnityEngine::UIElements::MouseCaptureEvent___c::*)()>(&::UnityEngine::UIElements::MouseCaptureEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x1824d7290;
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::MouseCaptureEvent___c*, "<>9", ::UnityEngine::UIElements::MouseCaptureEvent___c*>(std::forward<::UnityEngine::UIElements::MouseCaptureEvent___c*>(value));
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::MouseCaptureEvent::*)()>(&::UnityEngine::UIElements::MouseCaptureEvent::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1824d3170;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::MouseCaptureEvent*>(),
                        {".ctor", {}, {}}
                    )));
    return ___internal_method;
  }
