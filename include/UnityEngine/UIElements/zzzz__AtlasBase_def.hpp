...
/// @brief Method InvokeAssignedToPanel, addr 0x181853df0, size 0x20, virtual false, abstract: false, final false
inline void InvokeAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method InvokeRemovedFromPanel, addr 0x1818fe1e0, size 0x20, virtual false, abstract: false, final false
inline void InvokeRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method InvokeUpdateDynamicTextures, addr 0x181913e90, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method OnAssignedToPanel, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnRemovedFromPanel, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnUpdateDynamicTextures, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method RepaintTexturedElements, addr 0x18236f960, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ReturnAtlas, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method SetDynamicTexture, addr 0x18236fa00, size 0x10, virtual false, abstract: false, final false
inline void SetDynamicTexture(::UnityEngine::UIElements::TextureId  id, ::UnityEngine::Texture*  texture) ;

/// @brief Method TryGetAtlas, addr 0x18236fa10, size 0x50, virtual true, abstract: false, final false
inline bool TryGetAtlas(::UnityEngine::UIElements::VisualElement*  ctx, ::UnityEngine::Texture2D*  src, ::by_ref<::UnityEngine::UIElements::TextureId>  atlas, ::by_ref<::UnityEngine::RectInt>  atlasRect) ;
...
/// @brief Method .ctor, addr 0x18236fa60, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
