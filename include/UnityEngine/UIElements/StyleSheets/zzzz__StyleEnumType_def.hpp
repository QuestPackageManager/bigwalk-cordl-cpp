...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::StyleEnumType, "UnityEngine.UIElements.StyleSheets", "StyleEnumType");
// Dependencies 
namespace UnityEngine::UIElements::StyleSheets {
// Is value type: true
...
__E_BackgroundPositionKeyword = static_cast<int32_t>(0x2),
__E_BackgroundSizeType = static_cast<int32_t>(0x3),
__E_DisplayStyle = static_cast<int32_t>(0x4),
__E_EasingMode = static_cast<int32_t>(0x5),
__E_EditorTextRenderingMode = static_cast<int32_t>(0x6),
__E_FlexDirection = static_cast<int32_t>(0x7),
__E_FontStyle = static_cast<int32_t>(0x8),
__E_Justify = static_cast<int32_t>(0x9),
__E_Overflow = static_cast<int32_t>(0xa),
__E_OverflowClipBox = static_cast<int32_t>(0xb),
__E_OverflowInternal = static_cast<int32_t>(0xc),
__E_Position = static_cast<int32_t>(0xd),
...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::StyleEnumType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::StyleEnumType) == 0x4, "Size mismatch!");
