...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, "UnityEngine.UIElements.StyleSheets.Syntax", "StyleSyntaxTokenType");
// Dependencies 
namespace UnityEngine::UIElements::StyleSheets::Syntax {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType) == 0x4, "Size mismatch!");
