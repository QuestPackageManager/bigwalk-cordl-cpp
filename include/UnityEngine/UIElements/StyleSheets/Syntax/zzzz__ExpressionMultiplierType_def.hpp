...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType, "UnityEngine.UIElements.StyleSheets.Syntax", "ExpressionMultiplierType");
// Dependencies 
namespace UnityEngine::UIElements::StyleSheets::Syntax {
// Is value type: true
...
/// @brief Field GroupAtLeastOne value: I32(6)
...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType) == 0x4, "Size mismatch!");
