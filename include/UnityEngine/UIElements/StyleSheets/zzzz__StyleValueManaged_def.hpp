...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::StyleValueManaged, "UnityEngine.UIElements.StyleSheets", "StyleValueManaged");
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::StyleValueManaged) == 0x10, "Size mismatch!");
