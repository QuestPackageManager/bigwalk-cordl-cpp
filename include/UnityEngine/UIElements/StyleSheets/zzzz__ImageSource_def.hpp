...
public:
// Declarations
/// @brief Method IsNull, addr 0x182474a20, size 0xa0, virtual false, abstract: false, final false
inline bool IsNull() ;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::ImageSource) == 0x20, "Size mismatch!");
