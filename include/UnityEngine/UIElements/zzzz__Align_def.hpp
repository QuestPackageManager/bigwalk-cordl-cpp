...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Align, "UnityEngine.UIElements", "Align");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Align, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Align) == 0x4, "Size mismatch!");
