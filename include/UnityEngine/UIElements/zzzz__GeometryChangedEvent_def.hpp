...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::GeometryChangedEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7ca0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x1824d23f0, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::GeometryChangedEvent* GetPooled(::UnityEngine::Rect  oldRect, ::UnityEngine::Rect  newRect) ;

/// @brief Method Init, addr 0x1824d2430, size 0x20, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x1824d2450, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824d2550, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_layoutPass, addr 0x180310fd0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_layoutPass() ;

/// @brief Method get_newRect, addr 0x181115440, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_newRect() ;

/// @brief Method get_oldRect, addr 0x180de9ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_oldRect() ;

/// @brief Method set_layoutPass, addr 0x1803f4230, size 0x10, virtual false, abstract: false, final false
inline void set_layoutPass(int32_t  value) ;

/// @brief Method set_newRect, addr 0x181115470, size 0x30, virtual false, abstract: false, final false
inline void set_newRect(::UnityEngine::Rect  value) ;

/// @brief Method set_oldRect, addr 0x1811154a0, size 0x200, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::GeometryChangedEvent) == 0x90, "Size mismatch!");
