...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IntegerField*);
MARK_REF_T(::UnityEngine::UIElements::IntegerField_IntegerInput*);
MARK_REF_T(::UnityEngine::UIElements::IntegerField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::IntegerField_UxmlTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IntegerField*, "UnityEngine.UIElements", "IntegerField");
...
/// @brief Method .ctor, addr 0x18249f070, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x1824a04b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::IntegerField_UxmlTraits) == 0xc0, "Size mismatch!");
...
/// @brief Method ApplyInputDeviceDelta, addr 0x1824937e0, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x1824939b0, size 0x70, virtual true, abstract: false, final false
inline int32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x182493a20, size 0x30, virtual true, abstract: false, final false
inline ::StringW ValueToString(int32_t  v) ;

/// @brief Method .ctor, addr 0x182493a50, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x182493a90, size 0x80, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentIntegerField, addr 0x182493b10, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x1824694b0, size 0x90, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int32_t  startValue) ;

/// @brief Method CanTryParse, addr 0x182469540, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x182469570, size 0xa0, virtual true, abstract: false, final false
inline int32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x182469610, size 0x50, virtual true, abstract: false, final false
inline ::StringW ValueToString(int32_t  v) ;

/// @brief Method .ctor, addr 0x182469840, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182469740, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_integerInput, addr 0x182469920, size 0x50, virtual false, abstract: false, final false
