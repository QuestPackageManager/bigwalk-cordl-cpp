...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::AncestorFilter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AncestorFilter*, "UnityEngine.UIElements", "AncestorFilter");
...
/// @brief Method AddHash, addr 0x1824b2da0, size 0x50, virtual false, abstract: false, final false
inline void AddHash(int32_t  hash) ;

/// @brief Method IsCandidate, addr 0x1824b2df0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method PopElement, addr 0x1824b2e40, size 0x90, virtual false, abstract: false, final false
inline void PopElement() ;

/// @brief Method PushElement, addr 0x1824b2ed0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b3090, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::AncestorFilter) == 0x4018, "Size mismatch!");
