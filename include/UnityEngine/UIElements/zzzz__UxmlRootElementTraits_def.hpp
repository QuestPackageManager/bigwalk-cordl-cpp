...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlRootElementTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlRootElementTraits*, "UnityEngine.UIElements", "UxmlRootElementTraits");
...
/// @brief Method .ctor, addr 0x18240a8f0, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlRootElementTraits) == 0x28, "Size mismatch!");
