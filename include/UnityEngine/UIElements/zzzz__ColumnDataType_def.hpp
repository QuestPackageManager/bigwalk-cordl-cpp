...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ColumnDataType, "UnityEngine.UIElements", "ColumnDataType");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::ColumnDataType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ColumnDataType) == 0x4, "Size mismatch!");
