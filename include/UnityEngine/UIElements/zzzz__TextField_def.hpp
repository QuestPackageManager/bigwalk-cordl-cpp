...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TextField*);
MARK_REF_T(::UnityEngine::UIElements::TextField_TextInput*);
MARK_REF_T(::UnityEngine::UIElements::TextField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::TextField_UxmlTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TextField*, "UnityEngine.UIElements", "TextField");
...
/// @brief Method .ctor, addr 0x18246da40, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x18246e670, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18246fd80, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::TextField_UxmlTraits) == 0x128, "Size mismatch!");
...
/// @brief Method StringToValue, addr 0x1802dc680, size 0x10, virtual true, abstract: false, final false
inline ::StringW StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x18246c460, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_multiline, addr 0x18246c470, size 0x20, virtual false, abstract: false, final false
inline bool get_multiline() ;

/// @brief Method get_parentTextField, addr 0x18246c490, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextField* get_parentTextField() ;

/// @brief Method set_multiline, addr 0x18246c4e0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method HandleEventBubbleUp, addr 0x18246b8c0, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method OnViewDataReady, addr 0x18246ba20, size 0x50, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method SetValueWithoutNotify, addr 0x18246ba70, size 0x140, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::StringW  newValue) ;

/// @brief Method StringToValue, addr 0x1802dc680, size 0x10, virtual true, abstract: false, final false
inline ::StringW StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x18246bbb0, size 0x30, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method ValueToString, addr 0x1802dc680, size 0x10, virtual true, abstract: false, final false
inline ::StringW ValueToString(::StringW  value) ;

/// @brief Method .ctor, addr 0x18246c070, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18246bf20, size 0x150, virtual false, abstract: false, final false
inline void _ctor(::StringW  label) ;

/// @brief Method .ctor, addr 0x18246bdb0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method get_multiline, addr 0x18246c1b0, size 0x70, virtual false, abstract: false, final false
inline bool get_multiline() ;

/// @brief Method get_textInput, addr 0x18246c220, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_multiline, addr 0x18246c270, size 0x190, virtual false, abstract: false, final false
inline void set_multiline(bool  value) ;

/// @brief Method set_value, addr 0x18246c400, size 0x60, virtual true, abstract: false, final false
