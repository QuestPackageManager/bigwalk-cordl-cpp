...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DragAndDropPosition, "UnityEngine.UIElements", "DragAndDropPosition");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::DragAndDropPosition, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::DragAndDropPosition) == 0x4, "Size mismatch!");
