...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::VisualData, "UnityEngine.UIElements", "VisualData");
// Dependencies UnityEngine.Color, UnityEngine.UIElements.Background, UnityEngine.UIElements.BackgroundPosition, UnityEngine.UIElements.BackgroundRepeat, UnityEngine.UIElements.BackgroundSize, UnityEngine.UIElements.Length, UnityEngine.UIElements.OverflowInternal
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x1823d22f0, size 0x1f0, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::VisualData Copy() ;

/// @brief Method CopyFrom, addr 0x1823d21a0, size 0x150, virtual true, abstract: false, final true
inline void CopyFrom(::by_ref<::UnityEngine::UIElements::VisualData>  other) ;

/// @brief Method Equals, addr 0x1823d26c0, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823d24e0, size 0x1e0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::VisualData  other) ;

/// @brief Method GetHashCode, addr 0x1823d27c0, size 0x310, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1823d2ad0, size 0x400, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "backgroundColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "backgroundImage", ty: "::UnityEngine::UIElements::Background", modifiers: "", def_value: None }, CppParam { name: "backgroundPositionX", ty: "::UnityEngine::UIElements::BackgroundPosition", modifiers: "", def_value: None }, CppParam { name: "backgroundPositionY", ty: "::UnityEngine::UIElements::BackgroundPosition", modifiers: "", def_value: None }, CppParam { name: "backgroundRepeat", ty: "::UnityEngine::UIElements::BackgroundRepeat", modifiers: "", def_value: None }, CppParam { name: "backgroundSize", ty: "::UnityEngine::UIElements::BackgroundSize", modifiers: "", def_value: None }, CppParam { name: "borderBottomColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "borderBottomLeftRadius", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "borderBottomRightRadius", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "borderLeftColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "borderRightColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "borderTopColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "borderTopLeftRadius", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "borderTopRightRadius", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "filter", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::FilterFunction>*", modifiers: "", def_value: None }, CppParam { name: "opacity", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "overflow", ty: "::UnityEngine::UIElements::OverflowInternal", modifiers: "", def_value: None }]
