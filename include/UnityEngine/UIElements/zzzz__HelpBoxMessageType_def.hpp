...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::HelpBoxMessageType, "UnityEngine.UIElements", "HelpBoxMessageType");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::HelpBoxMessageType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::HelpBoxMessageType) == 0x4, "Size mismatch!");
