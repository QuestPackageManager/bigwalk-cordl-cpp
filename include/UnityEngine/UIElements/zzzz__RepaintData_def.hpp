...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::RepaintData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RepaintData*, "UnityEngine.UIElements", "RepaintData");
...
/// @brief Method .ctor, addr 0x18250eed0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentOffset, addr 0x180409f70, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_currentOffset() ;

/// @brief Method get_currentWorldClip, addr 0x181454250, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_currentWorldClip() ;

/// @brief Method get_repaintEvent, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Event* get_repaintEvent() ;

/// @brief Method set_repaintEvent, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::RepaintData) == 0x70, "Size mismatch!");
