...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ProjectionUtils*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ProjectionUtils*, "UnityEngine.UIElements", "ProjectionUtils");
...
public:
// Declarations
/// @brief Method Ortho, addr 0x18250eaf0, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ProjectionUtils) == 0x10, "Size mismatch!");
