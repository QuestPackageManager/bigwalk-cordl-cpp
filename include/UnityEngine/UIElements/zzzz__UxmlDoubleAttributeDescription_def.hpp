...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlDoubleAttributeDescription*);
...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x1823fcda0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlDoubleAttributeDescription___c) == 0x10, "Size mismatch!");
...
/// @brief Method ConvertValueToDouble, addr 0x182409050, size 0x70, virtual false, abstract: false, final false
static inline double_t ConvertValueToDouble(::StringW  v, double_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x1824090c0, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824091d0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UxmlDoubleAttributeDescription) == 0x48, "Size mismatch!");
