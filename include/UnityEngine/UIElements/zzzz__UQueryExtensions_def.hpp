...
/// @brief Method Q, addr 0x182406ca0, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method Q, addr 0x182406f50, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Query, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::UnityEngine::UIElements::UQueryBuilder_1<T> Query(::UnityEngine::UIElements::VisualElement*  e, ::StringW  name, ::ArrayW<::StringW>  classes) ;
...
static_assert(sizeof(::UnityEngine::UIElements::UQueryExtensions) == 0x10, "Size mismatch!");
