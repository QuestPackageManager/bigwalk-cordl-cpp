...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TransitionCancelEvent*);
MARK_REF_T(::UnityEngine::UIElements::TransitionCancelEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TransitionCancelEvent*, "UnityEngine.UIElements", "TransitionCancelEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TransitionCancelEvent___c*, "UnityEngine.UIElements", "TransitionCancelEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7610, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TransitionCancelEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824d70d0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::TransitionCancelEvent) == 0x78, "Size mismatch!");
