...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::VisualTreeUpdatePhase, "UnityEngine.UIElements", "VisualTreeUpdatePhase");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::VisualTreeUpdatePhase, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::VisualTreeUpdatePhase) == 0x4, "Size mismatch!");
