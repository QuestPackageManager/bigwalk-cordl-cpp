...
static_assert(offsetof(::UnityEngine::UIElements::StyleValueType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleValueType) == 0x4, "Size mismatch!");
