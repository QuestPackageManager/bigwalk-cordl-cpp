...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BindingTarget, "UnityEngine.UIElements", "BindingTarget");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x182375c00, size 0x100, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "element", ty: "::UnityEngine::UIElements::VisualElement*", modifiers: "", def_value: None }, CppParam { name: "bindingId", ty: "::UnityEngine::UIElements::BindingId", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::BindingTarget) == 0xa0, "Size mismatch!");
