...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::StyleSelector*);
...
/// @brief Method <ToString>b__11_0, addr 0x1823e15e0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Field m_Parts, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Parts, put=__cordl_internal_set_m_Parts)) ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart>  m_Parts;
...
/// @brief Field negatedPseudoStateMask, offset 0x20, size 0x4 
 ...
 __declspec(property(get=get_parts, put=set_parts)) ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart>  parts;
...
/// @brief Method ToString, addr 0x1823dc010, size 0xf0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

constexpr ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart> const& __cordl_internal_get_m_Parts() const;

constexpr ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart>& __cordl_internal_get_m_Parts() ;
...
constexpr void __cordl_internal_set_m_Parts(::ArrayW<::UnityEngine::UIElements::StyleSelectorPart>  value) ;
...
/// @brief Method .ctor, addr 0x1823dc100, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_parts, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::StyleSelectorPart> get_parts() ;

/// @brief Method get_previousRelationship, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSelectorRelationship get_previousRelationship() ;

/// @brief Method set_parts, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_parts(::ArrayW<::UnityEngine::UIElements::StyleSelectorPart>  value) ;

/// @brief Method set_previousRelationship, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSelector) == 0x28, "Size mismatch!");
