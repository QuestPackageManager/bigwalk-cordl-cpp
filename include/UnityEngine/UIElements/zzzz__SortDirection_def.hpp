...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::SortDirection, "UnityEngine.UIElements", "SortDirection");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::SortDirection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::SortDirection) == 0x4, "Size mismatch!");
