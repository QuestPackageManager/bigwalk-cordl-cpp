...
static_assert(offsetof(::UnityEngine::UIElements::VersionChangeType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::VersionChangeType) == 0x4, "Size mismatch!");
