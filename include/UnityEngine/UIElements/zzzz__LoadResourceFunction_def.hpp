...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::LoadResourceFunction*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::LoadResourceFunction*, "UnityEngine.UIElements", "LoadResourceFunction");
...
/// @brief Method .ctor, addr 0x182509a30, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::LoadResourceFunction) == 0x80, "Size mismatch!");
