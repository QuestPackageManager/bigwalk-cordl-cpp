...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerType*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerType*, "UnityEngine.UIElements", "PointerType");
...
/// @brief Method GetPointerType, addr 0x1824d6230, size 0x80, virtual false, abstract: false, final false
static inline ::StringW GetPointerType(int32_t  pointerId) ;

/// @brief Method IsDirectManipulationDevice, addr 0x1824d62b0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::PointerType) == 0x10, "Size mismatch!");
