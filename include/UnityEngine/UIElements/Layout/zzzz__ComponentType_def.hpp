...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::ComponentType, "UnityEngine.UIElements.Layout", "ComponentType");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::ComponentType) == 0x4, "Size mismatch!");
