...
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::Layout::ManagedObjectStore_1, "UnityEngine.UIElements.Layout", "ManagedObjectStore`1");
...
constexpr ::System::Collections::Generic::List_1<::ArrayW<T>>*& __cordl_internal_get_m_Chunks() ;
...
/// @brief Field m_Chunks, offset: 0x18, size: 0x8, def value: None
 ::System::Collections::Generic::List_1<::ArrayW<T>>*  ___m_Chunks;
