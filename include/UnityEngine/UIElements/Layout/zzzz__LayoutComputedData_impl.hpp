...
// Ctor Parameters []
constexpr ::UnityEngine::UIElements::Layout::LayoutComputedData__Position_e__FixedBuffer::LayoutComputedData__Position_e__FixedBuffer()   {
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::Layout::LayoutComputedData (*)()>(&::UnityEngine::UIElements::Layout::LayoutComputedData::get_Default)> {
  ...
  constexpr static std::size_t addrs = 0x182450250;
...
// Ctor Parameters [CppParam { name: "Position", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__Position_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "Dimensions", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__Dimensions_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "Margin", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__Margin_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "Border", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__Border_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "Padding", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__Padding_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "Direction", ty: "::UnityEngine::UIElements::Layout::LayoutDirection", modifiers: "", def_value: Some("{}") }, CppParam { name: "ComputedFlexBasisGeneration", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ComputedFlexBasis", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "HadOverflow", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "GenerationCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "LastParentDirection", ty: "::UnityEngine::UIElements::Layout::LayoutDirection", modifiers: "", def_value: Some("{}") }, CppParam { name: "LastPointScaleFactor", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeasuredDimensions", ty: "::UnityEngine::UIElements::Layout::LayoutComputedData__MeasuredDimensions_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::UIElements::Layout::LayoutComputedData::LayoutComputedData(::UnityEngine::UIElements::Layout::LayoutComputedData__Position_e__FixedBuffer  Position, ::UnityEngine::UIElements::Layout::LayoutComputedData__Dimensions_e__FixedBuffer  Dimensions, ::UnityEngine::UIElements::Layout::LayoutComputedData__Margin_e__FixedBuffer  Margin, ::UnityEngine::UIElements::Layout::LayoutComputedData__Border_e__FixedBuffer  Border, ::UnityEngine::UIElements::Layout::LayoutComputedData__Padding_e__FixedBuffer  Padding, ::UnityEngine::UIElements::Layout::LayoutDirection  Direction, uint32_t  ComputedFlexBasisGeneration, float_t  ComputedFlexBasis, bool  HadOverflow, uint32_t  GenerationCount, ::UnityEngine::UIElements::Layout::LayoutDirection  LastParentDirection, float_t  LastPointScaleFactor, ::UnityEngine::UIElements::Layout::LayoutComputedData__MeasuredDimensions_e__FixedBuffer  MeasuredDimensions) noexcept  {
