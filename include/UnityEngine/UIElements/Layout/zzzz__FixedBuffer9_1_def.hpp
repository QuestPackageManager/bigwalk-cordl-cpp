...
template<typename T>
struct FixedBuffer9_1;
}
// Write type traits
MARK_GEN_VAL_T(::UnityEngine::UIElements::Layout::FixedBuffer9_1);
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::Layout::FixedBuffer9_1, "UnityEngine.UIElements.Layout", "FixedBuffer9`1");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// cpp template
template<typename T>
...
// Ctor Parameters [CppParam { name: "__0", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__1", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__2", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__3", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__4", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__5", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__6", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__7", ty: "T", modifiers: "", def_value: None }, CppParam { name: "__8", ty: "T", modifiers: "", def_value: None }]
