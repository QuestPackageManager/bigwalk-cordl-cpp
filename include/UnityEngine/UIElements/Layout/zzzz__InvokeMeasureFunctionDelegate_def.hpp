...
public:
// Declarations
/// @brief Method Invoke, addr 0x18244fc80, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18244fdd0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::InvokeMeasureFunctionDelegate) == 0x80, "Size mismatch!");
