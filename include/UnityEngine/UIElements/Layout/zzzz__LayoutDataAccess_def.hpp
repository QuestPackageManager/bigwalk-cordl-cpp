...
public:
// Declarations
/// @brief Method GetBaselineFunction, addr 0x182450470, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetCacheData, addr 0x1824504b0, size 0x60, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::UIElements::Layout::LayoutCacheData> GetCacheData(::UnityEngine::UIElements::Layout::LayoutHandle  handle) ;

/// @brief Method GetComputedData, addr 0x18244cd50, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetConfigData, addr 0x182450510, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetMeasureFunction, addr 0x182450550, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetNodeData, addr 0x182450590, size 0x60, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::UIElements::Layout::LayoutNodeData> GetNodeData(::UnityEngine::UIElements::Layout::LayoutHandle  handle) ;

/// @brief Method GetOwner, addr 0x18244cd80, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetOwner(::UnityEngine::UIElements::Layout::LayoutHandle  handle) ;

/// @brief Method GetStyleData, addr 0x18244cdb0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method SetMeasureFunction, addr 0x1824505f0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method SetOwner, addr 0x18244cde0, size 0x40, virtual false, abstract: false, final false
inline void SetOwner(::UnityEngine::UIElements::Layout::LayoutHandle  handle, ::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method .ctor, addr 0x182450640, size 0x80, virtual false, abstract: false, final false
...
/// @brief Field m_Nodes, offset: 0x8, size: 0x18, def value: None
 ::UnityEngine::UIElements::Layout::LayoutDataStore  m_Nodes;

/// @brief Field m_Configs, offset: 0x20, size: 0x18, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutDataAccess, m_Configs) == 0x20, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutDataAccess) == 0x38, "Size mismatch!");
