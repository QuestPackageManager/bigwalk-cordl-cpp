...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutNative_LayoutLogEventType, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CalculateLayout, addr 0x182451980, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method LayoutLog_Internal, addr 0x182451990, size 0xa0, virtual false, abstract: false, final false
