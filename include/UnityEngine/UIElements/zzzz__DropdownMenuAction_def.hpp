...
static_assert(offsetof(::UnityEngine::UIElements::DropdownMenuAction_Status, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::DropdownMenuAction_Status) == 0x4, "Size mismatch!");
...
/// @brief Field <status>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__status_k__BackingField, put=__cordl_internal_set__status_k__BackingField)) ::UnityEngine::UIElements::DropdownMenuAction_Status  _status_k__BackingField;
...
/// @brief Field actionStatusCallback, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_actionStatusCallback, put=__cordl_internal_set_actionStatusCallback)) ::System::Func_2<::UnityEngine::UIElements::DropdownMenuAction*,::UnityEngine::UIElements::DropdownMenuAction_Status>*  actionStatusCallback;
...
/// @brief Method AlwaysDisabled, addr 0x1802edfe0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AlwaysEnabled, addr 0x1802edd00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method UpdateActionStatus, addr 0x1824b56a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b56f0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  actionName, ::System::Action_1<::UnityEngine::UIElements::DropdownMenuAction*>*  actionCallback, ::System::Func_2<::UnityEngine::UIElements::DropdownMenuAction*,::UnityEngine::UIElements::DropdownMenuAction_Status>*  actionStatusCallback, ::System::Object*  userData) ;

/// @brief Method get_name, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method set_eventInfo, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
