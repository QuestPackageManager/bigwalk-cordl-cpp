...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TwoPaneSplitView*);
MARK_REF_T(::UnityEngine::UIElements::TwoPaneSplitView_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::TwoPaneSplitView_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x1824c57b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_FixedPaneInitialDimension, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FixedPaneInitialDimension, put=__cordl_internal_set_m_FixedPaneInitialDimension)) ::UnityEngine::UIElements::UxmlIntAttributeDescription*  m_FixedPaneInitialDimension;

/// @brief Field m_Orientation, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Orientation, put=__cordl_internal_set_m_Orientation)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::TwoPaneSplitViewOrientation>*  m_Orientation;

/// @brief Method Init, addr 0x1824c58e0, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824c5da0, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::TwoPaneSplitView_UxmlTraits) == 0xa0, "Size mismatch!");
...
/// @brief Method AdjustPanesBasedOnAnchor, addr 0x1824c1550, size 0x690, virtual false, abstract: false, final false
inline void AdjustPanesBasedOnAnchor() ;

/// @brief Method CollapseChild, addr 0x1824c1be0, size 0x2d0, virtual false, abstract: false, final false
inline void CollapseChild(int32_t  index) ;

/// @brief Method IdentifyLeftAndRightPane, addr 0x1824c1eb0, size 0xd0, virtual false, abstract: false, final false
inline void IdentifyLeftAndRightPane() ;

/// @brief Method Init, addr 0x1824c1f80, size 0x270, virtual true, abstract: false, final false
...
/// @brief Method OnPostDisplaySetup, addr 0x1824c21f0, size 0xc0, virtual false, abstract: false, final false
inline void OnPostDisplaySetup(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnSizeChange, addr 0x1824c22b0, size 0x10, virtual false, abstract: false, final false
inline void OnSizeChange(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x1824c22c0, size 0x30, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method PostDisplaySetup, addr 0x1824c22f0, size 0xf90, virtual false, abstract: false, final false
inline void PostDisplaySetup() ;

/// @brief Method SetDragLineOffset, addr 0x1824c3280, size 0x150, virtual false, abstract: false, final false
inline void SetDragLineOffset(float_t  offset) ;

/// @brief Method SetFixedPaneDimension, addr 0x1824c33d0, size 0x150, virtual false, abstract: false, final false
inline void SetFixedPaneDimension(float_t  dimension) ;

/// @brief Method SetupSplitView, addr 0x1824c3520, size 0x1f0, virtual false, abstract: false, final false
inline void SetupSplitView() ;

/// @brief Method UpdateLayout, addr 0x1824c3710, size 0x540, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824c4160, size 0x240, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_contentContainer, addr 0x1823f3360, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_dragLine, addr 0x18200af80, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_dragLine() ;

/// @brief Method get_fixedPane, addr 0x1823ed5f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_fixedPane() ;

/// @brief Method get_fixedPaneDimension, addr 0x1824c43a0, size 0x40, virtual false, abstract: false, final false
inline float_t get_fixedPaneDimension() ;

/// @brief Method get_fixedPaneIndex, addr 0x1824c43e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_fixedPaneIndex() ;

/// @brief Method get_fixedPaneInitialDimension, addr 0x1821b8d60, size 0x10, virtual false, abstract: false, final false
inline float_t get_fixedPaneInitialDimension() ;

/// @brief Method get_flexedPane, addr 0x1821a37f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_flexedPane() ;

/// @brief Method get_orientation, addr 0x180fc2780, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_fixedPaneDimension, addr 0x1824c43f0, size 0x20, virtual false, abstract: false, final false
inline void set_fixedPaneDimension(float_t  value) ;

/// @brief Method set_fixedPaneIndex, addr 0x1824c4410, size 0x80, virtual false, abstract: false, final false
inline void set_fixedPaneIndex(int32_t  value) ;

/// @brief Method set_fixedPaneInitialDimension, addr 0x1824c4490, size 0x80, virtual false, abstract: false, final false
inline void set_fixedPaneInitialDimension(float_t  value) ;

/// @brief Method set_orientation, addr 0x1824c4510, size 0x80, virtual false, abstract: false, final false
