...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MeshGenerationContext_MeshFlags, "UnityEngine.UIElements", "MeshGenerationContext/MeshFlags");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContext_MeshFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::MeshGenerationContext_MeshFlags) == 0x4, "Size mismatch!");
