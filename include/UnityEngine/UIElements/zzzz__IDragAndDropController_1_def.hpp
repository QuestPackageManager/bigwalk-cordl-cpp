...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::IDragAndDropController_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::IDragAndDropController_1, "UnityEngine.UIElements", "IDragAndDropController`1");
// Dependencies 
namespace UnityEngine::UIElements {
// cpp template
template<typename TArgs>
