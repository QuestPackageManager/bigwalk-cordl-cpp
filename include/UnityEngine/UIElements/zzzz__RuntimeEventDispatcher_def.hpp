...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::RuntimeEventDispatcher*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RuntimeEventDispatcher*, "UnityEngine.UIElements", "RuntimeEventDispatcher");
...
public:
// Declarations
/// @brief Method Create, addr 0x1824e6390, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::RuntimeEventDispatcher) == 0x10, "Size mismatch!");
