...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleCursor, "UnityEngine.UIElements", "StyleCursor");
// Dependencies UnityEngine.UIElements.Cursor, UnityEngine.UIElements.StyleKeyword
namespace UnityEngine::UIElements {
// Is value type: true
...
// Declarations
 ...
 __declspec(property(get=get_value, put=set_value)) ::UnityEngine::UIElements::Cursor  value;
...
/// @brief Method Equals, addr 0x1823d76c0, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823d7630, size 0x90, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleCursor  other) ;

/// @brief Method GetHashCode, addr 0x1823d7760, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x1823d7790, size 0x50, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x1823d77e0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x1823d7870, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Cursor  v) ;

/// @brief Method .ctor, addr 0x1823d7820, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Cursor  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x1802f41a0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x1823d78c0, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x1823d7940, size 0x50, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::StyleCursor  lhs, ::UnityEngine::UIElements::StyleCursor  rhs) ;

/// @brief Method op_Implicit, addr 0x1823d79c0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x1823d7990, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::StyleCursor op_Implicit___UnityEngine__UIElements__StyleCursor(::UnityEngine::UIElements::Cursor  v) ;

/// @brief Method set_keyword, addr 0x1802f4390, size 0x10, virtual true, abstract: false, final true
inline void set_keyword(::UnityEngine::UIElements::StyleKeyword  value) ;

/// @brief Method set_value, addr 0x1823d7a00, size 0x90, virtual true, abstract: false, final true
inline void set_value(::UnityEngine::UIElements::Cursor  value) ;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleCursor) == 0x20, "Size mismatch!");
