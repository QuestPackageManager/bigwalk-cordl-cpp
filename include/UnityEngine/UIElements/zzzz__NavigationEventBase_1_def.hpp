...
/// @brief Field <deviceType>k__BackingField, offset 0x68, size 0x4 
 __declspec(property(get=__cordl_internal_get__deviceType_k__BackingField, put=__cordl_internal_set__deviceType_k__BackingField)) ::UnityEngine::UIElements::NavigationDeviceType  _deviceType_k__BackingField;
