...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::MouseEnterEvent*);
MARK_REF_T(::UnityEngine::UIElements::MouseEnterEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseEnterEvent*, "UnityEngine.UIElements", "MouseEnterEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseEnterEvent___c*, "UnityEngine.UIElements", "MouseEnterEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d74b0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::MouseEnterEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method Init, addr 0x1824d33b0, size 0x20, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x1824d33d0, size 0x10, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseEnterEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x1824d3460, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::MouseEnterEvent) == 0xb8, "Size mismatch!");
