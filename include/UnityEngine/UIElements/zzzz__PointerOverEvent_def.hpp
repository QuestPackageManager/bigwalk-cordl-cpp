...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerOverEvent*);
MARK_REF_T(::UnityEngine::UIElements::PointerOverEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerOverEvent*, "UnityEngine.UIElements", "PointerOverEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerOverEvent___c*, "UnityEngine.UIElements", "PointerOverEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7c70, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::PointerOverEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824d6220, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::PointerOverEvent) == 0x120, "Size mismatch!");
