...
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::StyleList_1, "UnityEngine.UIElements", "StyleList`1");
...
// Ctor Parameters [CppParam { name: "m_Keyword", ty: "::UnityEngine::UIElements::StyleKeyword", modifiers: "", def_value: None }, CppParam { name: "m_Value", ty: "::System::Collections::Generic::List_1<T>*", modifiers: "", def_value: None }]
