...
/// @brief Method ApplyConverterGroupToSource, addr 0x18237e7e0, size 0xf0, virtual false, abstract: false, final false
inline void ApplyConverterGroupToSource(::UnityEngine::UIElements::ConverterGroup*  group) ;

/// @brief Method ApplyConverterGroupToUI, addr 0x18237e8d0, size 0xf0, virtual false, abstract: false, final false
inline void ApplyConverterGroupToUI(::UnityEngine::UIElements::ConverterGroup*  group) ;

/// @brief Method CacheReflectionInfo, addr 0x18237e9c0, size 0x100, virtual false, abstract: false, final false
...
static inline ::StringW GetSetValueErrorString(::Unity::Properties::VisitReturnCode  returnCode, ::System::Object*  source, ::by_ref<::Unity::Properties::PropertyPath>  sourcePath, ::System::Object*  target, ::by_ref<::UnityEngine::UIElements::BindingId>  targetPath, TValue  extractedValueFromSource) ;

/// @brief Method UpdateSource, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
template<typename TValue>
inline ::UnityEngine::UIElements::BindingResult UpdateSource(::by_ref<::UnityEngine::UIElements::BindingContext>  context, ::by_ref<TValue>  value) ;

/// @brief Method UpdateUI, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
template<typename TValue>
inline ::UnityEngine::UIElements::BindingResult UpdateUI(::by_ref<::UnityEngine::UIElements::BindingContext>  context, ::by_ref<TValue>  value) ;
...
/// @brief Method get_bindingMode, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingMode get_bindingMode() ;

/// @brief Method get_dataSource, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* get_dataSource() ;

/// @brief Method get_dataSourcePath, addr 0x18237eac0, size 0x60, virtual true, abstract: false, final true
inline ::Unity::Properties::PropertyPath get_dataSourcePath() ;

/// @brief Method get_dataSourceType, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_dataSourceType() ;

/// @brief Method get_sourceToUiConverters, addr 0x18237eb20, size 0xc0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ConverterGroup* get_sourceToUiConverters() ;

/// @brief Method get_uiToSourceConverters, addr 0x18237ebe0, size 0xc0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ConverterGroup* get_uiToSourceConverters() ;

/// @brief Method get_updateUIMethod, addr 0x18237eca0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method set_bindingMode, addr 0x18237ede0, size 0x10, virtual false, abstract: false, final false
inline void set_bindingMode(::UnityEngine::UIElements::BindingMode  value) ;

/// @brief Method set_dataSource, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void set_dataSource(::System::Object*  value) ;

/// @brief Method set_dataSourcePath, addr 0x18237edf0, size 0x70, virtual false, abstract: false, final false
inline void set_dataSourcePath(::Unity::Properties::PropertyPath  value) ;

/// @brief Method set_dataSourceType, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::DataBinding) == 0xd8, "Size mismatch!");
