...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Label*);
MARK_REF_T(::UnityEngine::UIElements::Label_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Label_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x18249f0a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x1824a00f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Label_UxmlTraits) == 0xd0, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x182493c00, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182493ba0, size 0x60, virtual false, abstract: false, final false
