...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::OverflowClipBox, "UnityEngine.UIElements", "OverflowClipBox");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Field ContentBox value: I32(1)
static ::UnityEngine::UIElements::OverflowClipBox const ContentBox;

/// @brief Field PaddingBox value: I32(0)
...
static_assert(offsetof(::UnityEngine::UIElements::OverflowClipBox, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::OverflowClipBox) == 0x4, "Size mismatch!");
