...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlLongAttributeDescription*);
...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x1823fcd20, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlLongAttributeDescription___c) == 0x10, "Size mismatch!");
...
/// @brief Method ConvertValueToLong, addr 0x182409bb0, size 0x40, virtual false, abstract: false, final false
static inline int64_t ConvertValueToLong(::StringW  v, int64_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x182409bf0, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182409d00, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UxmlLongAttributeDescription) == 0x48, "Size mismatch!");
