#pragma once
// IWYU pragma private; include "UnityEngine/UIElements/AlternatingRowBackground.hpp"
...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AlternatingRowBackground, "UnityEngine.UIElements", "AlternatingRowBackground");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Field ContentOnly value: I32(1)
...
static_assert(offsetof(::UnityEngine::UIElements::AlternatingRowBackground, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::AlternatingRowBackground) == 0x4, "Size mismatch!");
