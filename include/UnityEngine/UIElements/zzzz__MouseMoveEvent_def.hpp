...
/// @brief Method <.cctor>b__0_0, addr 0x1824d75d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x1824d3a60, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseMoveEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent*  pointerEvent) ;

/// @brief Method Init, addr 0x1824d3a70, size 0x30, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x1824d3aa0, size 0x10, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseMoveEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x1824d3b30, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
