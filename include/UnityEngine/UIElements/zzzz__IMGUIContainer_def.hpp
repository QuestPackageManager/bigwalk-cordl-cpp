...
/// @brief Method .ctor, addr 0x182513400, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x182513410, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dispose, addr 0x18250b3f0, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x182513170, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "wasUITK", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method .ctor, addr 0x18250b450, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "matrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "contentColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "backgroundColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "enabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "changed", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "displayIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "pixelsPerPoint", ty: "float_t", modifiers: "", def_value: None }]
...
static_assert(offsetof(::UnityEngine::UIElements::IMGUIContainer_GUIGlobals, pixelsPerPoint) == 0x78, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::IMGUIContainer_GUIGlobals) == 0x7c, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x1824db130, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x1824db160, size 0x20, virtual true, abstract: false, final false
inline void Dispose(bool  disposeManaged) ;

/// @brief Method DoIMGUIRepaint, addr 0x1824db180, size 0x420, virtual false, abstract: false, final false
inline void DoIMGUIRepaint() ;

/// @brief Method DoMeasure, addr 0x1824db5a0, size 0x320, virtual true, abstract: false, final false
...
/// @brief Method DoOnGUI, addr 0x1824db8c0, size 0xcf0, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentClipRect, addr 0x1824dc5b0, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetCurrentClipRect() ;

/// @brief Method GetCurrentTransformAndClip, addr 0x1824dc610, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method HandleEventBubbleUp, addr 0x1824dc880, size 0x3a0, virtual true, abstract: false, final false
inline void HandleEventBubbleUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventBubbleUpDisabled, addr 0x1818fe1e0, size 0x20, virtual true, abstract: false, final false
inline void HandleEventBubbleUpDisabled(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleIMGUIEvent, addr 0x1824dcd00, size 0xe0, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x1824dcc20, size 0xe0, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, ::System::Action*  onGUIHandler, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x1824dcde0, size 0x3d0, virtual false, abstract: false, final false
...
/// @brief Method IsContainerCapturingTheMouse, addr 0x1824dd1b0, size 0xd0, virtual false, abstract: false, final false
inline bool IsContainerCapturingTheMouse() ;

/// @brief Method IsDockAreaMouseUp, addr 0x1824dd280, size 0x90, virtual false, abstract: false, final false
static inline bool IsDockAreaMouseUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsEventInsideLocalWindow, addr 0x1824dd310, size 0x160, virtual false, abstract: false, final false
inline bool IsEventInsideLocalWindow(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsLocalEvent, addr 0x1824dd470, size 0xa0, virtual false, abstract: false, final false
inline bool IsLocalEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method MarkDirtyLayout, addr 0x1824dd510, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method OnGenerateVisualContent, addr 0x1824dd530, size 0x100, virtual false, abstract: false, final false
inline void OnGenerateVisualContent(Il2CppObject*  mgc) ;

/// @brief Method RestoreGlobals, addr 0x1824dd630, size 0x130, virtual false, abstract: false, final false
inline void RestoreGlobals() ;

/// @brief Method SaveGlobals, addr 0x1824dd760, size 0xf0, virtual false, abstract: false, final false
inline void SaveGlobals() ;

/// @brief Method SendEventToIMGUI, addr 0x1824dd8c0, size 0x200, virtual false, abstract: false, final false
inline bool SendEventToIMGUI(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SendEventToIMGUIRaw, addr 0x1824dd850, size 0x70, virtual false, abstract: false, final false
inline bool SendEventToIMGUIRaw(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SetFoldoutDepthClass, addr 0x1824ddac0, size 0xd0, virtual false, abstract: false, final false
inline void SetFoldoutDepthClass() ;

/// @brief Method VerifyBounds, addr 0x1824ddba0, size 0x350, virtual false, abstract: false, final false
inline bool VerifyBounds(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method <DoOnGUI>b__61_0, addr 0x1824ddb90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824de770, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1824de4a0, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method get_cache, addr 0x1824de780, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::GUILayoutUtility_LayoutCache* get_cache() ;

/// @brief Method get_canGrabFocus, addr 0x1824de7f0, size 0x30, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_contextType, addr 0x1824af930, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method get_cullingEnabled, addr 0x1824de820, size 0x10, virtual false, abstract: false, final false
inline bool get_cullingEnabled() ;

/// @brief Method get_focusOnlyIfHasFocusableControls, addr 0x1824609d0, size 0x10, virtual false, abstract: false, final false
inline bool get_focusOnlyIfHasFocusableControls() ;

/// @brief Method get_guiState, addr 0x1824de830, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::ObjectGUIState* get_guiState() ;

/// @brief Method get_lastWorldClip, addr 0x1824de8b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_lastWorldClip() ;

/// @brief Method get_layoutMeasuredHeight, addr 0x1824de8c0, size 0x70, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredHeight() ;

/// @brief Method get_layoutMeasuredWidth, addr 0x1824de930, size 0x70, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredWidth() ;

/// @brief Method get_onGUIHandler, addr 0x180e4a190, size 0xd960, virtual false, abstract: false, final false
...
/// @brief Method set_contextType, addr 0x1824de9a0, size 0x60, virtual false, abstract: false, final false
inline void set_contextType(::UnityEngine::UIElements::ContextType  value) ;

/// @brief Method set_cullingEnabled, addr 0x1824dea00, size 0x60, virtual false, abstract: false, final false
inline void set_cullingEnabled(bool  value) ;

/// @brief Method set_lastWorldClip, addr 0x1824dea60, size 0x10, virtual false, abstract: false, final false
inline void set_lastWorldClip(::UnityEngine::Rect  value) ;

/// @brief Method set_onGUIHandler, addr 0x1824dea70, size 0x70, virtual false, abstract: false, final false
