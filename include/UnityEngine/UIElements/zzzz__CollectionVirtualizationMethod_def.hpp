#pragma once
// IWYU pragma private; include "UnityEngine/UIElements/CollectionVirtualizationMethod.hpp"
...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::CollectionVirtualizationMethod, "UnityEngine.UIElements", "CollectionVirtualizationMethod");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::CollectionVirtualizationMethod, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::CollectionVirtualizationMethod) == 0x4, "Size mismatch!");
