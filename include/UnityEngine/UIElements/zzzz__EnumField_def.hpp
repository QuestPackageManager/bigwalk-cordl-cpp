...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::EnumField*);
MARK_REF_T(::UnityEngine::UIElements::EnumField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::EnumField_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::EnumField___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EnumField*, "UnityEngine.UIElements", "EnumField");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EnumField_UxmlFactory*, "UnityEngine.UIElements", "EnumField/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EnumField_UxmlTraits*, "UnityEngine.UIElements", "EnumField/UxmlTraits");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EnumField___c*, "UnityEngine.UIElements", "EnumField/<>c");
...
/// @brief Method .ctor, addr 0x18246dac0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::EnumField_UxmlFactory) == 0x18, "Size mismatch!");
...
public:
// Declarations
/// @brief Field m_IncludeObsoleteValues, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_IncludeObsoleteValues, put=__cordl_internal_set_m_IncludeObsoleteValues)) ::UnityEngine::UIElements::UxmlBoolAttributeDescription*  m_IncludeObsoleteValues;

/// @brief Field m_Type, offset 0x98, size 0x8 
...
/// @brief Method Init, addr 0x18246e840, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182470720, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_IncludeObsoleteValues, offset: 0xa8, size: 0x8, def value: None
 ::UnityEngine::UIElements::UxmlBoolAttributeDescription*  ___m_IncludeObsoleteValues;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::EnumField_UxmlTraits, ___m_Type) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EnumField_UxmlTraits, ___m_Value) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EnumField_UxmlTraits, ___m_IncludeObsoleteValues) == 0xa8, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::EnumField_UxmlTraits) == 0xb0, "Size mismatch!");
...
/// @brief Field <>9__31_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__31_0, put=setStaticF___9__31_0)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::MouseDownEvent*>*  __9__31_0;

static inline ::UnityEngine::UIElements::EnumField___c* New_ctor() ;

/// @brief Method <.ctor>b__31_0, addr 0x1809718d0, size 0x660, virtual false, abstract: false, final false
...
static inline ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::MouseDownEvent*>* getStaticF___9__31_0() ;

static inline void setStaticF___9(::UnityEngine::UIElements::EnumField___c*  value) ;

static inline void setStaticF___9__31_0(::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::MouseDownEvent*>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::EnumField___c) == 0x10, "Size mismatch!");

} // namespace end def UnityEngine::UIElements
// Dependencies UnityEngine.EnumData, UnityEngine.UIElements.BaseField`1<TValueType>, UnityEngine.UIElements.BindingId
namespace UnityEngine::UIElements {
// Is value type: false
...
/// @brief Field createMenuCallback, offset 0x3b8, size 0x8 
 __declspec(property(get=__cordl_internal_get_createMenuCallback, put=__cordl_internal_set_createMenuCallback)) ::System::Func_1<::UnityEngine::UIElements::AbstractGenericMenu*>*  createMenuCallback;
...
/// @brief Method ChangeValueFromMenu, addr 0x18245f9d0, size 0x60, virtual false, abstract: false, final false
inline void ChangeValueFromMenu(::System::Object*  menuItem) ;

/// @brief Method ContainsPointer, addr 0x1810f4970, size 0x2df0, virtual false, abstract: false, final false
inline bool ContainsPointer(int32_t  pointerId) ;

/// @brief Method Init, addr 0x18245fa30, size 0xa0, virtual false, abstract: false, final false
inline void Init(::System::Enum*  defaultValue) ;

/// @brief Method Init, addr 0x18245fad0, size 0xa0, virtual false, abstract: false, final false
inline void Init(::System::Enum*  defaultValue, bool  includeObsoleteValues) ;

/// @brief Method Initialize, addr 0x18245fb70, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method OnNavigationSubmit, addr 0x18245fd30, size 0x1c0, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method OnPointerDownEvent, addr 0x18245fef0, size 0x10, virtual false, abstract: false, final false
inline void OnPointerDownEvent(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMoveEvent, addr 0x18245ff00, size 0x30, virtual false, abstract: false, final false
inline void OnPointerMoveEvent(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method PopulateDataFromType, addr 0x18245ff30, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetValueWithoutNotify, addr 0x182460000, size 0x70, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::System::Enum*  newValue) ;

/// @brief Method ShowMenu, addr 0x182460070, size 0x1b0, virtual false, abstract: false, final false
inline void ShowMenu() ;

/// @brief Method UpdateMixedValueContent, addr 0x182460220, size 0x120, virtual true, abstract: false, final false
inline void UpdateMixedValueContent() ;

/// @brief Method UpdateValueLabel, addr 0x182460340, size 0x90, virtual false, abstract: false, final false
inline void UpdateValueLabel(::System::Enum*  value) ;

/// @brief Method <ShowMenu>b__42_0, addr 0x18245f9d0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824609c0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182460640, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method get_includeObsoleteValues, addr 0x1824609d0, size 0x10, virtual false, abstract: false, final false
inline bool get_includeObsoleteValues() ;

/// @brief Method get_text, addr 0x1824609e0, size 0x20, virtual false, abstract: false, final false
