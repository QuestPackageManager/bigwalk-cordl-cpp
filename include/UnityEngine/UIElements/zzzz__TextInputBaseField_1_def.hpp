...
class TextInputBaseField_1_TextInputBase;
}
namespace UnityEngine::UIElements {
template<typename TValueType>
class TextInputBaseField_1_UxmlTraits;
}
namespace UnityEngine::UIElements {
...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::TextInputBaseField_1);
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::TextInputBaseField_1_TextInputBase);
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::TextInputBaseField_1_UxmlTraits);
...
/// @brief Field m_HidePlaceholderOnFocus, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_HidePlaceholderOnFocus, put=__cordl_internal_set_m_HidePlaceholderOnFocus)) ::UnityEngine::UIElements::UxmlBoolAttributeDescription*  m_HidePlaceholderOnFocus;
...
/// @brief Field m_KeyboardType, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_KeyboardType, put=__cordl_internal_set_m_KeyboardType)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::TouchScreenKeyboardType>*  m_KeyboardType;
...
/// @brief Field <textElement>k__BackingField, offset 0x2c8, size 0x8 
 __declspec(property(get=__cordl_internal_get__textElement_k__BackingField, put=__cordl_internal_set__textElement_k__BackingField)) ::UnityEngine::UIElements::TextElement*  _textElement_k__BackingField;

/// @brief Field horizontalVariantInnerTextElementUssClassName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_horizontalVariantInnerTextElementUssClassName, put=setStaticF_horizontalVariantInnerTextElementUssClassName)) ::StringW  horizontalVariantInnerTextElementUssClassName;
...
/// @brief Field verticalHorizontalVariantInnerTextElementUssClassName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_verticalHorizontalVariantInnerTextElementUssClassName, put=setStaticF_verticalHorizontalVariantInnerTextElementUssClassName)) ::StringW  verticalHorizontalVariantInnerTextElementUssClassName;

/// @brief Field verticalScrollerVisibility, offset 0x2f8, size 0x4 
 __declspec(property(get=__cordl_internal_get_verticalScrollerVisibility, put=__cordl_internal_set_verticalScrollerVisibility)) ::UnityEngine::UIElements::ScrollerVisibility  verticalScrollerVisibility;

/// @brief Field verticalVariantInnerTextElementUssClassName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_verticalVariantInnerTextElementUssClassName, put=setStaticF_verticalVariantInnerTextElementUssClassName)) ::StringW  verticalVariantInnerTextElementUssClassName;
...
/// @brief Field m_TextInputBase, offset 0x358, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TextInputBase, put=__cordl_internal_set_m_TextInputBase)) ::UnityEngine::UIElements::TextInputBaseField_1_TextInputBase<TValueType>*  m_TextInputBase;
...
/// @brief Field s_SelectionColorProperty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SelectionColorProperty, put=setStaticF_s_SelectionColorProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<::UnityEngine::Color>  s_SelectionColorProperty;
...
static inline ::UnityEngine::UIElements::TextInputBaseField_1<TValueType>* New_ctor(::StringW  label, int32_t  maxLength, char16_t  maskChar, ::UnityEngine::UIElements::TextInputBaseField_1_TextInputBase<TValueType>*  textInputBase) ;
