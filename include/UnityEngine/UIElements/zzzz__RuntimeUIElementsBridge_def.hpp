...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::RuntimeUIElementsBridge*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RuntimeUIElementsBridge*, "UnityEngine.UIElements", "RuntimeUIElementsBridge");
...
/// @brief Method SetWantsMouseJumping, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::RuntimeUIElementsBridge) == 0x10, "Size mismatch!");
