...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleVariable, "UnityEngine.UIElements", "StyleVariable");
...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x1823ed230, size 0xc0, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "sheet", ty: "::UnityW<::UnityEngine::UIElements::StyleSheet>", modifiers: "", def_value: None }, CppParam { name: "handles", ty: "::ArrayW<::UnityEngine::UIElements::StyleValueHandle>", modifiers: "", def_value: None }]
constexpr StyleVariable(::StringW  name, ::UnityW<::UnityEngine::UIElements::StyleSheet>  sheet, ::ArrayW<::UnityEngine::UIElements::StyleValueHandle>  handles) noexcept;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleVariable) == 0x18, "Size mismatch!");
