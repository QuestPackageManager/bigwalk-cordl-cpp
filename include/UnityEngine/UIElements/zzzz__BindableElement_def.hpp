...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::BindableElement*);
MARK_REF_T(::UnityEngine::UIElements::BindableElement_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::BindableElement_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x182384450, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x182384460, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823845b0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::BindableElement_UxmlTraits, ___m_PropertyPath) == 0x88, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::BindableElement_UxmlTraits) == 0x90, "Size mismatch!");
...
/// @brief Method get_binding, addr 0x180e4a190, size 0xd960, virtual true, abstract: false, final true
...
/// @brief Method set_bindingPath, addr 0x182375a40, size 0x20, virtual true, abstract: false, final true
