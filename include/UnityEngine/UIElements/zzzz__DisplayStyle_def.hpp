...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DisplayStyle, "UnityEngine.UIElements", "DisplayStyle");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::DisplayStyle, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::DisplayStyle) == 0x4, "Size mismatch!");
