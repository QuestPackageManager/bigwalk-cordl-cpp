...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor*);
MARK_REF_T(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_VisitContext*);
...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor*, "UnityEngine.UIElements.Internal", "AutoCompletePathVisitor");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_VisitContext*, "UnityEngine.UIElements.Internal", "AutoCompletePathVisitor/VisitContext");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_InspectedTypeScope_1, "UnityEngine.UIElements.Internal", "AutoCompletePathVisitor/InspectedTypeScope`1");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_VisitedPropertyScope, "UnityEngine.UIElements.Internal", "AutoCompletePathVisitor/VisitedPropertyScope");
...
/// @brief Field <propertyPathInfos>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__propertyPathInfos_k__BackingField, put=__cordl_internal_set__propertyPathInfos_k__BackingField)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::PropertyPathInfo>*  _propertyPathInfos_k__BackingField;

/// @brief Field <types>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__types_k__BackingField, put=__cordl_internal_set__types_k__BackingField)) ::System::Collections::Generic::HashSet_1<::System::Type*>*  _types_k__BackingField;
...
/// @brief Method .ctor, addr 0x18248a460, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_current, addr 0x18248a4b0, size 0x60, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyPath get_current() ;

/// @brief Method get_currentDepth, addr 0x1803b2d80, size 0x10, virtual false, abstract: false, final false
inline int32_t get_currentDepth() ;

/// @brief Method get_propertyPathInfos, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::PropertyPathInfo>* get_propertyPathInfos() ;

/// @brief Method get_types, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<::System::Type*>* get_types() ;

/// @brief Method set_current, addr 0x18248a510, size 0x60, virtual false, abstract: false, final false
inline void set_current(::Unity::Properties::PropertyPath  value) ;

/// @brief Method set_currentDepth, addr 0x1817eed30, size 0x10, virtual false, abstract: false, final false
inline void set_currentDepth(int32_t  value) ;

/// @brief Method set_propertyPathInfos, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_VisitContext) == 0xb8, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x18248a570, size 0x150, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x18248a6c0, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18248a9b0, size 0x330, virtual false, abstract: false, final false
...
// Declarations
template<typename TContainer>
using InspectedTypeScope_1 = ::UnityEngine::UIElements::Internal::AutoCompletePathVisitor_InspectedTypeScope_1<TContainer>;
...
/// @brief Method HasReachedEnd, addr 0x18247f390, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x18247f3c0, size 0x90, virtual false, abstract: false, final false
inline void Reset() ;
...
template<typename TContainer,typename TValue>
inline void Unity_Properties_IPropertyVisitor_Visit(::Unity::Properties::Property_2<TContainer,TValue>*  property, ::by_ref<TContainer>  container) ;
...
/// @brief Method VisitPropertyType, addr 0x18247f450, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18247f6e0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxDepth, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor) == 0x20, "Size mismatch!");
