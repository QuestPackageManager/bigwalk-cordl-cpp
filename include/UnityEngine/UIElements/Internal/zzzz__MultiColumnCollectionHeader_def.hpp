...
/// @brief Method Apply, addr 0x182489c90, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method Save, addr 0x182489ed0, size 0x510, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18248a3e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_control, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn* get_control() ;

/// @brief Method get_resizeHandle, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizeHandle* get_resizeHandle() ;

/// @brief Method set_control, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_control(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn*  value) ;

/// @brief Method set_resizeHandle, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <OnContextualMenuManipulator>b__1, addr 0x182489a50, size 0x20, virtual false, abstract: false, final false
inline void _OnContextualMenuManipulator_b__1(::UnityEngine::UIElements::DropdownMenuAction*  a) ;

/// @brief Method <OnContextualMenuManipulator>b__2, addr 0x182489a70, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method <UpdateSortColumnDescriptionsOnClick>b__0, addr 0x182489ae0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ApplyColumnSorting, addr 0x182482090, size 0x4f0, virtual false, abstract: false, final false
inline void ApplyColumnSorting() ;

/// @brief Method CleanupColumnData, addr 0x182482580, size 0x2d0, virtual false, abstract: false, final false
inline void CleanupColumnData(::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*  data) ;

/// @brief Method Dispose, addr 0x182482850, size 0x240, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DoLayout, addr 0x182482a90, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method OnColumnAdded, addr 0x182482b20, size 0x410, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnAdded, addr 0x182482b10, size 0x10, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x182482f30, size 0x110, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnColumnClicked, addr 0x182483040, size 0x2c0, virtual false, abstract: false, final false
inline void OnColumnClicked(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnColumnControlGeometryChanged, addr 0x182483300, size 0x260, virtual false, abstract: false, final false
inline void OnColumnControlGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x182483560, size 0xa0, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x182483600, size 0x140, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x182483740, size 0x40, virtual false, abstract: false, final false
inline void OnColumnResized(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnContextualMenuManipulator, addr 0x182483780, size 0x5b0, virtual false, abstract: false, final false
inline void OnContextualMenuManipulator(::UnityEngine::UIElements::ContextualMenuPopulateEvent*  evt) ;

/// @brief Method OnGeometryChanged, addr 0x182483d30, size 0x120, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  e) ;

/// @brief Method OnMoveManipulatorActivated, addr 0x182483e50, size 0x50, virtual false, abstract: false, final false
inline void OnMoveManipulatorActivated(::UnityEngine::UIElements::Internal::ColumnMover*  mover) ;

/// @brief Method OnViewDataReady, addr 0x182483ea0, size 0xe0, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method RaiseColumnResized, addr 0x182483f80, size 0xe0, virtual false, abstract: false, final false
inline void RaiseColumnResized(int32_t  columnIndex) ;

/// @brief Method RaiseColumnSortingChanged, addr 0x182484060, size 0x40, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method ResizeToFit, addr 0x1824840a0, size 0x70, virtual false, abstract: false, final false
inline void ResizeToFit() ;

/// @brief Method SaveViewState, addr 0x182483740, size 0x40, virtual false, abstract: false, final false
inline void SaveViewState() ;

/// @brief Method ScheduleDoLayout, addr 0x182484110, size 0x80, virtual false, abstract: false, final false
inline void ScheduleDoLayout() ;

/// @brief Method ScrollHorizontally, addr 0x182484190, size 0x270, virtual false, abstract: false, final false
inline void ScrollHorizontally(float_t  horizontalOffset) ;

/// @brief Method UpdateColumnControls, addr 0x182484400, size 0x3b0, virtual false, abstract: false, final false
inline void UpdateColumnControls() ;

/// @brief Method UpdateSortColumnDescriptionsOnClick, addr 0x1824847b0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method UpdateSortedColumns, addr 0x182484940, size 0x480, virtual false, abstract: false, final false
inline void UpdateSortedColumns() ;

/// @brief Method UpdateSortingStatus, addr 0x182484dc0, size 0x400, virtual false, abstract: false, final false
inline void UpdateSortingStatus() ;

/// @brief Method <OnContextualMenuManipulator>b__67_0, addr 0x1824840a0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824852f0, size 0x590, virtual false, abstract: false, final false
...
/// @brief Method add_columnResized, addr 0x182485880, size 0xa0, virtual false, abstract: false, final false
inline void add_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method add_columnSortingChanged, addr 0x182485920, size 0x90, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_contextMenuPopulateEvent, addr 0x1824859b0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method add_viewDataRestored, addr 0x182485a50, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_columnContainer, addr 0x182485ae0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_columnContainer() ;

/// @brief Method get_columnDataMap, addr 0x180e6e230, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method get_columnLayout, addr 0x1823f3360, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_columns, addr 0x180388360, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_isApplyingViewState, addr 0x182485af0, size 0x10, virtual false, abstract: false, final false
inline bool get_isApplyingViewState() ;

/// @brief Method get_resizeHandleContainer, addr 0x180fc27b0, size 0x7a0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_resizeHandleContainer() ;

/// @brief Method get_sortDescriptions, addr 0x1823ed5f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortDescriptions() ;

/// @brief Method get_sortedColumnReadonly, addr 0x182468b70, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumnReadonly() ;

/// @brief Method get_sortedColumns, addr 0x182468b70, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumns() ;

/// @brief Method get_sortingEnabled, addr 0x182485b00, size 0x10, virtual false, abstract: false, final false
inline bool get_sortingEnabled() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnResized, addr 0x182485b10, size 0xa0, virtual false, abstract: false, final false
inline void remove_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method remove_columnSortingChanged, addr 0x182485bb0, size 0x90, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_contextMenuPopulateEvent, addr 0x182485c40, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method remove_viewDataRestored, addr 0x182485ce0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method set_sortDescriptions, addr 0x182485d70, size 0x80, virtual false, abstract: false, final false
inline void set_sortDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x182485df0, size 0x40, virtual false, abstract: false, final false
