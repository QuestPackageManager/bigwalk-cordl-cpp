...
/// @brief Method GetElementType, addr 0x182489680, size 0x140, virtual false, abstract: false, final false
static inline ::System::Type* GetElementType(::System::Type*  type) ;

/// @brief Method IsLastPartReached, addr 0x1824897c0, size 0x70, virtual false, abstract: false, final false
inline bool IsLastPartReached() ;

static inline ::UnityEngine::UIElements::Internal::TypePathVisitor* New_ctor() ;

/// @brief Method Reset, addr 0x182489830, size 0x90, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method get_Path, addr 0x180998d00, size 0x21b10, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyPath get_Path() ;

/// @brief Method get_ReturnCode, addr 0x181c9bb30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Path, addr 0x1824898c0, size 0x60, virtual false, abstract: false, final false
inline void set_Path(::Unity::Properties::PropertyPath  value) ;

/// @brief Method set_ReturnCode, addr 0x181fcacd0, size 0x10, virtual false, abstract: false, final false
inline void set_ReturnCode(::Unity::Properties::VisitReturnCode  value) ;

/// @brief Method set_resolvedType, addr 0x1802ec810, size 0x20, virtual false, abstract: false, final false
