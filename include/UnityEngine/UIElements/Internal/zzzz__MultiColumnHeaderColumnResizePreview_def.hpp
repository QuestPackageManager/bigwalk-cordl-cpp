...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*, "UnityEngine.UIElements.Internal", "MultiColumnHeaderColumnResizePreview");
...
/// @brief Method .ctor, addr 0x1824864c0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
