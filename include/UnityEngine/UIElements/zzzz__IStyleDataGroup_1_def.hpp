...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::IStyleDataGroup_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::IStyleDataGroup_1, "UnityEngine.UIElements", "IStyleDataGroup`1");
// Dependencies 
namespace UnityEngine::UIElements {
// cpp template
template<typename T>
