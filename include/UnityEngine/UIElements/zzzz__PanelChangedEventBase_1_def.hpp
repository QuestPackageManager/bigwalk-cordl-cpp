...
/// @brief Field <destinationPanel>k__BackingField, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__destinationPanel_k__BackingField, put=__cordl_internal_set__destinationPanel_k__BackingField)) ::UnityEngine::UIElements::IPanel*  _destinationPanel_k__BackingField;
