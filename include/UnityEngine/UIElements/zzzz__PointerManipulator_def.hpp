...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerManipulator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerManipulator*, "UnityEngine.UIElements", "PointerManipulator");
...
/// @brief Method CanStartManipulation, addr 0x18250e8c0, size 0x1f0, virtual false, abstract: false, final false
inline bool CanStartManipulation(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method CanStopManipulation, addr 0x18250eab0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::PointerManipulator) == 0x28, "Size mismatch!");
