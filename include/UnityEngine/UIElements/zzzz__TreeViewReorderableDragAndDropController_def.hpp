...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController*);
MARK_REF_T(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController_DropData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController*, "UnityEngine.UIElements", "TreeViewReorderableDragAndDropController");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController_DropData*, "UnityEngine.UIElements", "TreeViewReorderableDragAndDropController/DropData");
...
/// @brief Field draggedIds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_draggedIds, put=__cordl_internal_set_draggedIds)) ::ArrayW<int32_t>  draggedIds;
...
/// @brief Field expandedIdsBeforeDrag, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_expandedIdsBeforeDrag, put=__cordl_internal_set_expandedIdsBeforeDrag)) ::ArrayW<int32_t>  expandedIdsBeforeDrag;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_draggedIds() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_draggedIds() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_expandedIdsBeforeDrag() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_expandedIdsBeforeDrag() ;

constexpr int32_t const& __cordl_internal_get_lastItemId() const;

constexpr int32_t& __cordl_internal_get_lastItemId() ;

constexpr void __cordl_internal_set_draggedIds(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_expandedIdsBeforeDrag(::ArrayW<int32_t>  value) ;
...
static_assert(sizeof(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController_DropData) == 0x30, "Size mismatch!");
...
/// @brief Field m_ExpandDropItemScheduledItem, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ExpandDropItemScheduledItem, put=__cordl_internal_set_m_ExpandDropItemScheduledItem)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_ExpandDropItemScheduledItem;
...
/// @brief Method CanDrop, addr 0x1824be930, size 0x10, virtual true, abstract: false, final false
inline bool CanDrop() ;

/// @brief Method CompareId, addr 0x1824be940, size 0x430, virtual true, abstract: false, final false
inline int32_t CompareId(int32_t  id1, int32_t  id2) ;

/// @brief Method DelayExpandDropItem, addr 0x1824bed70, size 0x190, virtual false, abstract: false, final false
inline void DelayExpandDropItem() ;

/// @brief Method DragCleanup, addr 0x1824bef00, size 0xb0, virtual true, abstract: false, final false
inline void DragCleanup() ;

/// @brief Method ExpandDropItem, addr 0x1824befb0, size 0x180, virtual false, abstract: false, final false
inline void ExpandDropItem() ;

/// @brief Method HandleAutoExpand, addr 0x1824bf130, size 0x120, virtual true, abstract: false, final false
inline void HandleAutoExpand(::UnityEngine::UIElements::ReusableCollectionItem*  item, ::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleDragAndDrop, addr 0x1824bf250, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x1824bf2c0, size 0x410, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::UIElements::IListDragAndDropArgs*  args) ;

/// @brief Method RestoreExpanded, addr 0x1824bf6d0, size 0x1d0, virtual false, abstract: false, final false
inline void RestoreExpanded(::System::Collections::Generic::List_1<int32_t>*  ids) ;

/// @brief Method SetupDragAndDrop, addr 0x1824bf8a0, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824bf9f0, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TreeViewReorderableDragAndDropController) == 0x48, "Size mismatch!");
