...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlTemplateFactory*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlTemplateFactory*, "UnityEngine.UIElements", "UxmlTemplateFactory");
...
/// @brief Method .ctor, addr 0x18240ae90, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_uxmlName, addr 0x18240aea0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlTemplateFactory) == 0x18, "Size mismatch!");
