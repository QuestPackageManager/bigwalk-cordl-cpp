...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Vector2IntField*);
MARK_REF_T(::UnityEngine::UIElements::Vector2IntField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Vector2IntField_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::Vector2IntField___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector2IntField*, "UnityEngine.UIElements", "Vector2IntField");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector2IntField_UxmlFactory*, "UnityEngine.UIElements", "Vector2IntField/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector2IntField_UxmlTraits*, "UnityEngine.UIElements", "Vector2IntField/UxmlTraits");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector2IntField___c*, "UnityEngine.UIElements", "Vector2IntField/<>c");
...
/// @brief Method .ctor, addr 0x18246daf0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::Vector2IntField_UxmlFactory) == 0x18, "Size mismatch!");
...
/// @brief Method Init, addr 0x18246f030, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18246fef0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::UnityEngine::UIElements::Vector2IntField_UxmlTraits, ___m_YValue) == 0xa0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Vector2IntField_UxmlTraits) == 0xa8, "Size mismatch!");
...
/// @brief Method <DescribeFields>b__0_0, addr 0x1805ed280, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <DescribeFields>b__0_2, addr 0x1823dc990, size 0x10, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Vector2IntField___c) == 0x10, "Size mismatch!");
...
/// @brief Method DescribeFields, addr 0x182470ff0, size 0x2d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182471440, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1824713a0, size 0xa0, virtual false, abstract: false, final false
