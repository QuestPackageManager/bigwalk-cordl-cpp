...
/// @brief Method GetMovedUIControlTypeName, addr 0x18240bd50, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method RegisterEngineFactories, addr 0x18240be20, size 0xa40, virtual false, abstract: false, final false
static inline void RegisterEngineFactories() ;

/// @brief Method RegisterFactory, addr 0x18240c860, size 0x410, virtual false, abstract: false, final false
static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory*  factory) ;

/// @brief Method RegisterUserFactories, addr 0x18240cc70, size 0x200, virtual false, abstract: false, final false
static inline void RegisterUserFactories() ;

/// @brief Method TryGetValue, addr 0x18240ce70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_factories, addr 0x18240ced0, size 0x1e0, virtual false, abstract: false, final false
