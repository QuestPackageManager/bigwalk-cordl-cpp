...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TransitionRunEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d79e0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TransitionRunEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824d71f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::TransitionRunEvent) == 0x78, "Size mismatch!");
