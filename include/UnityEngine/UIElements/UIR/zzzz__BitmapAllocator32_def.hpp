...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::BitmapAllocator32_Page, "UnityEngine.UIElements.UIR", "BitmapAllocator32/Page");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::BitmapAllocator32_Page) == 0x8, "Size mismatch!");
...
/// @brief Method Allocate, addr 0x18243c6a0, size 0x2c0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc Allocate(::UnityEngine::UIElements::UIR::BaseShaderInfoStorage*  storage) ;

/// @brief Method Construct, addr 0x18243c960, size 0xd0, virtual false, abstract: false, final false
inline void Construct(int32_t  pageHeight, int32_t  entryWidth, int32_t  entryHeight) ;

/// @brief Method CountTrailingZeroes, addr 0x18243ca30, size 0x80, virtual false, abstract: false, final false
static inline uint8_t CountTrailingZeroes(uint32_t  val) ;

/// @brief Method ForceFirstAlloc, addr 0x18243cab0, size 0x120, virtual false, abstract: false, final false
inline void ForceFirstAlloc(uint16_t  firstPageX, uint16_t  firstPageY) ;

/// @brief Method Free, addr 0x18243cbd0, size 0xb0, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method GetAllocPageAtlasLocation, addr 0x18243cc80, size 0xb0, virtual false, abstract: false, final false
inline void GetAllocPageAtlasLocation(int32_t  page, ::by_ref<uint16_t>  x, ::by_ref<uint16_t>  y) ;

/// @brief Method get_entryHeight, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_entryHeight() ;

/// @brief Method get_entryWidth, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_PageHeight", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Pages", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::BitmapAllocator32_Page>*", modifiers: "", def_value: None }, CppParam { name: "m_AllocMap", ty: "::System::Collections::Generic::List_1<uint32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_EntryWidth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_EntryHeight", ty: "int32_t", modifiers: "", def_value: None }]
constexpr BitmapAllocator32(int32_t  m_PageHeight, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::BitmapAllocator32_Page>*  m_Pages, ::System::Collections::Generic::List_1<uint32_t>*  m_AllocMap, int32_t  m_EntryWidth, int32_t  m_EntryHeight) noexcept;
