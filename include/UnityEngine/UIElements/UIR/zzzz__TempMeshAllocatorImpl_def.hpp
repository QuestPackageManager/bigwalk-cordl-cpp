...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData, "UnityEngine.UIElements.UIR", "TempMeshAllocatorImpl/ThreadData");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData) == 0x8, "Size mismatch!");
...
/// @brief Field m_ThreadData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ThreadData, put=__cordl_internal_set_m_ThreadData)) ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>  m_ThreadData;
...
/// @brief Method AllocateTempMesh, addr 0x182447210, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x1824473e0, size 0xf0, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateNativeHandle, addr 0x1824474d0, size 0x10, virtual false, abstract: false, final false
inline void CreateNativeHandle(::by_ref<::UnityEngine::UIElements::TempMeshAllocator>  allocator) ;

/// @brief Method Dispose, addr 0x1824474e0, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x182447530, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData> const& __cordl_internal_get_m_ThreadData() const;

constexpr ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>& __cordl_internal_get_m_ThreadData() ;
...
constexpr void __cordl_internal_set_m_ThreadData(::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>  value) ;
...
/// @brief Method .ctor, addr 0x182447580, size 0x160, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disposed, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x180499eb0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_ThreadData, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>  ___m_ThreadData;
