...
#include "UnityEngine/UIElements/UIR/zzzz__NativePagedList_1_def.hpp"
template<typename T>
inline void UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>::_ctor(::StringW  profilerName, ::Unity::Collections::Allocator  allocator)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>>(),
...
// Ctor Parameters [CppParam { name: "m_Allocator", ty: "::Unity::Collections::Allocator", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_MemoryLabel", ty: "::Unity::Collections::MemoryLabel", modifiers: "", def_value: Some("{}") }]
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>::NativePagedList_1_NativeArrayAllocator(::Unity::Collections::Allocator  m_Allocator, ::Unity::Collections::MemoryLabel  m_MemoryLabel) noexcept  {
this->m_Allocator = m_Allocator;
this->m_MemoryLabel = m_MemoryLabel;
}
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>::NativePagedList_1_NativeArrayAllocator()   {
}
template<typename T>
inline void UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>::_ctor(::UnityEngine::UIElements::UIR::NativePagedList_1<T>*  nativePagedList, int32_t  offset)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>>(),
...
template<typename T>
inline bool UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>::HasNext()  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>>(),
                        {"HasNext", {}, {}}
                    )));
...
template<typename T>
inline T UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>::GetNext()  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>>(),
                        {"GetNext", {}, {}}
                    )));
...
// Ctor Parameters [CppParam { name: "m_NativePagedList", ty: "::UnityEngine::UIElements::UIR::NativePagedList_1<T>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_CurrentPage", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_IndexInCurrentPage", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_IndexOfCurrentPage", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_CountInCurrentPage", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>::NativePagedList_1_Enumerator(::UnityEngine::UIElements::UIR::NativePagedList_1<T>*  m_NativePagedList, ::Unity::Collections::NativeArray_1<T>  m_CurrentPage, int32_t  m_IndexInCurrentPage, int32_t  m_IndexOfCurrentPage, int32_t  m_CountInCurrentPage) noexcept  {
...
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::NativePagedList_1_Enumerator<T>::NativePagedList_1_Enumerator()   {
}
template<typename T>
...
template<typename T>
inline void UnityEngine::UIElements::UIR::NativePagedList_1<T>::_ctor(int32_t  poolCapacity, ::StringW  profilerName, ::Unity::Collections::Allocator  firstPageAllocator, ::Unity::Collections::Allocator  otherPagesAllocator)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
...
template<typename T>
inline ::UnityEngine::UIElements::UIR::NativePagedList_1<T>* UnityEngine::UIElements::UIR::NativePagedList_1<T>::New_ctor(int32_t  poolCapacity, ::StringW  profilerName, ::Unity::Collections::Allocator  firstPageAllocator, ::Unity::Collections::Allocator  otherPagesAllocator)  {
