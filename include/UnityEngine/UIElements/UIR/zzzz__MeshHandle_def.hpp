...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::MeshHandle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::MeshHandle*, "UnityEngine.UIElements.UIR", "MeshHandle");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::MeshHandle) == 0x60, "Size mismatch!");
