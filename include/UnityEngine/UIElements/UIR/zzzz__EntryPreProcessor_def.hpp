...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize, "UnityEngine.UIElements.UIR", "EntryPreProcessor/AllocSize");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize) == 0x8, "Size mismatch!");
...
/// @brief Field m_Allocs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Allocs, put=__cordl_internal_set_m_Allocs)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  m_Allocs;
...
/// @brief Field m_HeadAllocs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_HeadAllocs, put=__cordl_internal_set_m_HeadAllocs)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  m_HeadAllocs;
...
/// @brief Field m_Mask, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Mask, put=__cordl_internal_set_m_Mask)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  m_Mask;
...
/// @brief Field m_TailAllocs, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TailAllocs, put=__cordl_internal_set_m_TailAllocs)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  m_TailAllocs;
...
/// @brief Method Add, addr 0x182424870, size 0xa0, virtual false, abstract: false, final false
inline void Add(int32_t  vertexCount, int32_t  indexCount) ;

/// @brief Method ClearReferences, addr 0x182424910, size 0x30, virtual false, abstract: false, final false
inline void ClearReferences() ;

/// @brief Method DoEvaluate, addr 0x182424940, size 0x210, virtual false, abstract: false, final false
inline void DoEvaluate(::UnityEngine::UIElements::UIR::Entry*  entry) ;

/// @brief Method Flush, addr 0x18241ed70, size 0x70, virtual false, abstract: false, final false
inline void Flush() ;

static inline ::UnityEngine::UIElements::UIR::EntryPreProcessor* New_ctor() ;

/// @brief Method PreProcess, addr 0x182424b50, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182424e30, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_childrenIndex, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_childrenIndex() ;

/// @brief Method get_flattenedEntries, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Entry*>* get_flattenedEntries() ;

/// @brief Method get_headAllocs, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>* get_headAllocs() ;

/// @brief Method get_tailAllocs, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
