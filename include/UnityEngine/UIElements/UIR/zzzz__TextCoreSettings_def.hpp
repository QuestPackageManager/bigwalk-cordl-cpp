...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::TextCoreSettings, "UnityEngine.UIElements.UIR", "TextCoreSettings");
...
/// @brief Method Equals, addr 0x1824476e0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x182447770, size 0x1d0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::UIR::TextCoreSettings  other) ;

/// @brief Method GetHashCode, addr 0x182447940, size 0x180, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::TextCoreSettings) == 0x40, "Size mismatch!");
