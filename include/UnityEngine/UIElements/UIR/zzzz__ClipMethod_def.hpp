...
// Write type traits
MARK_VAL_T(::UnityEngine::UIElements::UIR::ClipMethod);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::ClipMethod, "UnityEngine.UIElements.UIR", "ClipMethod");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
// CS Name: UnityEngine.UIElements.UIR.ClipMethod
...
static ::UnityEngine::UIElements::UIR::ClipMethod const NotClipped;

/// @brief Field Scissor value: I32(2)
static ::UnityEngine::UIElements::UIR::ClipMethod const Scissor;

/// @brief Field ShaderDiscard value: I32(3)
static ::UnityEngine::UIElements::UIR::ClipMethod const ShaderDiscard;

/// @brief Field Stencil value: I32(4)
static ::UnityEngine::UIElements::UIR::ClipMethod const Stencil;

/// @brief Field Undetermined value: I32(0)
static ::UnityEngine::UIElements::UIR::ClipMethod const Undetermined;
...
static_assert(offsetof(::UnityEngine::UIElements::UIR::ClipMethod, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UIR::ClipMethod) == 0x4, "Size mismatch!");
