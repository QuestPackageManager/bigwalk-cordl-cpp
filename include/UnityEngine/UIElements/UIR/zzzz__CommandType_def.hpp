...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::CommandType, "UnityEngine.UIElements.UIR", "CommandType");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::UIR::CommandType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UIR::CommandType) == 0x4, "Size mismatch!");
