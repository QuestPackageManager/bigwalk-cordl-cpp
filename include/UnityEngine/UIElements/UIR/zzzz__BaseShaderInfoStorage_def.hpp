...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::BaseShaderInfoStorage*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::BaseShaderInfoStorage*, "UnityEngine.UIElements.UIR", "BaseShaderInfoStorage");
...
/// @brief Method Dispose, addr 0x18243c5d0, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18243c5c0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::BaseShaderInfoStorage) == 0x18, "Size mismatch!");
