...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::GPUBufferAllocator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::GPUBufferAllocator*, "UnityEngine.UIElements.UIR", "GPUBufferAllocator");
...
/// @brief Method Allocate, addr 0x182426e10, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size, bool  shortLived) ;

/// @brief Method Free, addr 0x182426f60, size 0x70, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::Alloc  alloc) ;

/// @brief Method HighLowCollide, addr 0x182426fd0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182426ff0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(uint32_t  maxSize) ;

/// @brief Method get_isEmpty, addr 0x182427070, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GPUBufferAllocator) == 0x20, "Size mismatch!");
