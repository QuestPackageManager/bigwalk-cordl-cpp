...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::SerializedCommandType, "UnityEngine.UIElements.UIR", "SerializedCommandType");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::UIR::SerializedCommandType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UIR::SerializedCommandType) == 0x4, "Size mismatch!");
