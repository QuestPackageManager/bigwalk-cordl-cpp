...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::BMPAlloc, "UnityEngine.UIElements.UIR", "BMPAlloc");
...
/// @brief Method Equals, addr 0x18243c4a0, size 0x30, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::UIElements::UIR::BMPAlloc  other) ;

/// @brief Method IsValid, addr 0x181a4b8e0, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method ToString, addr 0x18243c4d0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::BMPAlloc) == 0x8, "Size mismatch!");
