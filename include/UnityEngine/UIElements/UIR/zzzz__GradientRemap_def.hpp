...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::GradientRemap*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::GradientRemap*, "UnityEngine.UIElements.UIR", "GradientRemap");
...
/// @brief Method Reset, addr 0x18243d650, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GradientRemap) == 0x40, "Size mismatch!");
