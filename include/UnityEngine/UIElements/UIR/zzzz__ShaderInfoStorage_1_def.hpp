...
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UIR::ShaderInfoStorage_1, "UnityEngine.UIElements.UIR", "ShaderInfoStorage`1");
...
static inline ::UnityEngine::UIElements::UIR::ShaderInfoStorage_1<T>* New_ctor(::UnityEngine::TextureFormat  format, ::System::Func_2<::UnityEngine::Color,T>*  convert, int32_t  initialSize, int32_t  maxSize) ;
