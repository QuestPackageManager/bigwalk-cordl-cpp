...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::UIR::BasicNode_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UIR::BasicNode_1, "UnityEngine.UIElements.UIR", "BasicNode`1");
...
inline void InsertFirst(::by_ref<::UnityEngine::UIElements::UIR::BasicNode_1<T>*>  first) ;
