...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::Alloc, "UnityEngine.UIElements.UIR", "Alloc");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Alloc) == 0x18, "Size mismatch!");
