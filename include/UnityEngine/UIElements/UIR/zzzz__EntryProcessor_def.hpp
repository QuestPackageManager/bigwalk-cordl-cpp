...
/// @brief Method AppendCommand, addr 0x18241ede0, size 0x90, virtual false, abstract: false, final false
inline void AppendCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  next) ;

/// @brief Method ClearReferences, addr 0x182424f20, size 0xf0, virtual false, abstract: false, final false
inline void ClearReferences() ;

/// @brief Method CreateMeshDrawCommand, addr 0x182425010, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method DrawReverseMask, addr 0x182425140, size 0x370, virtual false, abstract: false, final false
inline void DrawReverseMask() ;

/// @brief Method Init, addr 0x1824254b0, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method ProcessFirstAlloc, addr 0x1824256d0, size 0x110, virtual false, abstract: false, final false
inline void ProcessFirstAlloc(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  allocList, ::by_ref<::UnityEngine::UIElements::UIR::MeshHandle*>  mesh) ;

/// @brief Method ProcessHead, addr 0x1824257e0, size 0xb0, virtual false, abstract: false, final false
inline void ProcessHead() ;

/// @brief Method ProcessMeshEntry, addr 0x182425890, size 0x670, virtual false, abstract: false, final false
inline void ProcessMeshEntry(::UnityEngine::UIElements::UIR::Entry*  entry, ::UnityEngine::UIElements::TextureId  textureId) ;

/// @brief Method ProcessNextAlloc, addr 0x182425f00, size 0x370, virtual false, abstract: false, final false
inline void ProcessNextAlloc() ;

/// @brief Method ProcessRange, addr 0x182426270, size 0x670, virtual false, abstract: false, final false
inline void ProcessRange(int32_t  first, int32_t  last) ;

/// @brief Method ProcessTail, addr 0x1824268e0, size 0xf0, virtual false, abstract: false, final false
inline void ProcessTail() ;

/// @brief Method UpdateOrAllocate, addr 0x1824269d0, size 0x2d0, virtual false, abstract: false, final false
static inline void UpdateOrAllocate(::by_ref<::UnityEngine::UIElements::UIR::MeshHandle*>  data, int32_t  vertexCount, int32_t  indexCount, ::UnityEngine::UIElements::UIR::UIRenderDevice*  device, ::by_ref<::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>>  verts, ::by_ref<::Unity::Collections::NativeSlice_1<uint16_t>>  indices, ::by_ref<uint16_t>  indexOffset, ::by_ref<::UnityEngine::UIElements::UIR::ChainBuilderStats>  stats) ;
...
/// @brief Method .ctor, addr 0x182426ca0, size 0x170, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_firstHeadCommand, addr 0x180337110, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstHeadCommand() ;

/// @brief Method get_firstTailCommand, addr 0x1803370f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstTailCommand() ;

/// @brief Method get_lastHeadCommand, addr 0x1803370b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_lastHeadCommand() ;

/// @brief Method get_lastTailCommand, addr 0x180474c30, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_lastTailCommand() ;

/// @brief Method set_firstHeadCommand, addr 0x180337210, size 0x20, virtual false, abstract: false, final false
inline void set_firstHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_firstTailCommand, addr 0x1803371d0, size 0x20, virtual false, abstract: false, final false
inline void set_firstTailCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_lastHeadCommand, addr 0x180337150, size 0x20, virtual false, abstract: false, final false
inline void set_lastHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_lastTailCommand, addr 0x180474d10, size 0x20, virtual false, abstract: false, final false
