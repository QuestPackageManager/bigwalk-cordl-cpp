...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::SerializedCommand, "UnityEngine.UIElements.UIR", "SerializedCommand");
...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::UIElements::UIR::SerializedCommandType", modifiers: "", def_value: None }, CppParam { name: "vertexBuffer", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "indexBuffer", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "firstRange", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "rangeCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "textureName", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "texturePtr", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "gpuDataOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "gpuData0", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "gpuData1", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "userProps", ty: "::UnityEngine::MaterialPropertyBlock*", modifiers: "", def_value: None }]
constexpr SerializedCommand(::UnityEngine::UIElements::UIR::SerializedCommandType  type, ::System::IntPtr  vertexBuffer, ::System::IntPtr  indexBuffer, int32_t  firstRange, int32_t  rangeCount, int32_t  textureName, ::System::IntPtr  texturePtr, int32_t  gpuDataOffset, ::UnityEngine::Vector4  gpuData0, ::UnityEngine::Vector4  gpuData1, ::UnityEngine::MaterialPropertyBlock*  userProps) noexcept;
