...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TransformData, "UnityEngine.UIElements", "TransformData");
// Dependencies UnityEngine.UIElements.Rotate, UnityEngine.UIElements.Scale, UnityEngine.UIElements.TransformOrigin, UnityEngine.UIElements.Translate
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x1823c5420, size 0x90, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::TransformData Copy() ;

/// @brief Method CopyFrom, addr 0x1823c53e0, size 0x40, virtual true, abstract: false, final true
inline void CopyFrom(::by_ref<::UnityEngine::UIElements::TransformData>  other) ;

/// @brief Method Equals, addr 0x1823c5670, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823c54b0, size 0x1c0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TransformData  other) ;

/// @brief Method GetHashCode, addr 0x1823c5720, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1823c57a0, size 0x230, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TransformData) == 0x54, "Size mismatch!");
