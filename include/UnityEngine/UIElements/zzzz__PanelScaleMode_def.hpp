...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PanelScaleMode, "UnityEngine.UIElements", "PanelScaleMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::PanelScaleMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::PanelScaleMode) == 0x4, "Size mismatch!");
