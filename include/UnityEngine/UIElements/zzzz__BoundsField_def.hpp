...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::BoundsField*);
MARK_REF_T(::UnityEngine::UIElements::BoundsField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::BoundsField_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x18246da20, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x18246e360, size 0x310, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824704b0, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::UnityEngine::UIElements::BoundsField_UxmlTraits, ___m_CenterYValue) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::BoundsField_UxmlTraits, ___m_CenterZValue) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::BoundsField_UxmlTraits, ___m_ExtentsXValue) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::BoundsField_UxmlTraits, ___m_ExtentsYValue) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::BoundsField_UxmlTraits, ___m_ExtentsZValue) == 0xc0, "Offset mismatch!");
...
/// @brief Method SetValueWithoutNotify, addr 0x18245ce90, size 0xd0, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Bounds  newValue) ;

/// @brief Method UpdateMixedValueContent, addr 0x18245d080, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method <.ctor>b__11_0, addr 0x18245cf60, size 0x90, virtual false, abstract: false, final false
inline void __ctor_b__11_0(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3>*  e) ;

/// @brief Method <.ctor>b__11_1, addr 0x18245cff0, size 0x90, virtual false, abstract: false, final false
inline void __ctor_b__11_1(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3>*  e) ;

/// @brief Method .ctor, addr 0x18245d500, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18245d240, size 0x2c0, virtual false, abstract: false, final false
