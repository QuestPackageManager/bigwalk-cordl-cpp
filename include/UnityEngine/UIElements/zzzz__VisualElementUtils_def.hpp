...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::VisualElementUtils*);
...
/// @brief Method <AssignInspectorStyleIfNecessary>b__5_0, addr 0x182411fa0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method AssignInspectorStyleIfNecessary, addr 0x182416db0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetFoldoutDepth, addr 0x182416e80, size 0xd0, virtual false, abstract: false, final false
static inline int32_t GetFoldoutDepth(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method GetUniqueName, addr 0x182416f50, size 0xb0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::VisualElementUtils) == 0x10, "Size mismatch!");
