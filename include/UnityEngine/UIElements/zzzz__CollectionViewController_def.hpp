...
/// @brief Method Dispose, addr 0x182395a10, size 0x50, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetIdForIndex, addr 0x1805ed280, size 0x10, virtual true, abstract: false, final false
inline int32_t GetIdForIndex(int32_t  index) ;

/// @brief Method GetIndexForId, addr 0x1805ed280, size 0x10, virtual true, abstract: false, final false
inline int32_t GetIndexForId(int32_t  id) ;

/// @brief Method GetItemForIndex, addr 0x182395a60, size 0x60, virtual true, abstract: false, final false
inline ::System::Object* GetItemForIndex(int32_t  index) ;

/// @brief Method GetItemsCount, addr 0x182395ac0, size 0x20, virtual true, abstract: false, final false
inline int32_t GetItemsCount() ;

/// @brief Method GetItemsMinCount, addr 0x181163a30, size 0xb0, virtual true, abstract: false, final false
inline int32_t GetItemsMinCount() ;

/// @brief Method InvokeBindItem, addr 0x182395ae0, size 0xd0, virtual true, abstract: false, final false
inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem, int32_t  index) ;

/// @brief Method InvokeDestroyItem, addr 0x182395bb0, size 0x20, virtual true, abstract: false, final false
inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method InvokeMakeItem, addr 0x182395bd0, size 0x40, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method InvokeUnbindItem, addr 0x182395c10, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method PreRefresh, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void PreRefresh() ;

/// @brief Method PrepareView, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void PrepareView() ;

/// @brief Method RaiseItemIndexChanged, addr 0x182395c40, size 0x20, virtual false, abstract: false, final false
inline void RaiseItemIndexChanged(int32_t  srcIndex, int32_t  dstIndex) ;

/// @brief Method RaiseItemsSourceChanged, addr 0x1802fc2c0, size 0x20, virtual false, abstract: false, final false
inline void RaiseItemsSourceChanged() ;

/// @brief Method SetBindingContext, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void SetBindingContext(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem, int32_t  index) ;

/// @brief Method SetHierarchyViewModelWithoutNotify, addr 0x182395c60, size 0x60, virtual false, abstract: false, final false
inline void SetHierarchyViewModelWithoutNotify(::Unity::Hierarchy::HierarchyViewModel*  source) ;

/// @brief Method SetView, addr 0x182395cc0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method add_itemIndexChanged, addr 0x182395d10, size 0x90, virtual false, abstract: false, final false
inline void add_itemIndexChanged(::System::Action_2<int32_t,int32_t>*  value) ;

/// @brief Method add_itemsSourceChanged, addr 0x1802fc2e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_view, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_view() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_itemIndexChanged, addr 0x182395da0, size 0x90, virtual false, abstract: false, final false
inline void remove_itemIndexChanged(::System::Action_2<int32_t,int32_t>*  value) ;

/// @brief Method remove_itemsSourceChanged, addr 0x1802fc360, size 0x80, virtual false, abstract: false, final false
inline void remove_itemsSourceChanged(::System::Action*  value) ;

/// @brief Method set_itemsSource, addr 0x182395e30, size 0x80, virtual true, abstract: false, final false
