...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextureColorSpace, "UnityEngine", "TextureColorSpace");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextureColorSpace, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextureColorSpace) == 0x4, "Size mismatch!");
