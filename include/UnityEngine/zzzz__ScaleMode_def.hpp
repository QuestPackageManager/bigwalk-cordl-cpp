...
// Write type traits
MARK_VAL_T(::UnityEngine::ScaleMode);
DEFINE_IL2CPP_CLASS(::UnityEngine::ScaleMode, "UnityEngine", "ScaleMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
__E_StretchToFill = static_cast<int32_t>(0x0),
__E_ScaleAndCrop = static_cast<int32_t>(0x1),
__E_ScaleToFit = static_cast<int32_t>(0x2),
};
...
/// @brief Field ScaleAndCrop value: I32(1)
static ::UnityEngine::ScaleMode const ScaleAndCrop;

/// @brief Field ScaleToFit value: I32(2)
static ::UnityEngine::ScaleMode const ScaleToFit;

/// @brief Field StretchToFill value: I32(0)
...
static_assert(offsetof(::UnityEngine::ScaleMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ScaleMode) == 0x4, "Size mismatch!");
