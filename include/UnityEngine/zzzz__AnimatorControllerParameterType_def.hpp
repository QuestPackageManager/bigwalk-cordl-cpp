...
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimatorControllerParameterType, "UnityEngine", "AnimatorControllerParameterType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AnimatorControllerParameterType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AnimatorControllerParameterType) == 0x4, "Size mismatch!");
