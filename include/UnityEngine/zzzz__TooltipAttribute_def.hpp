...
// Write type traits
MARK_REF_T(::UnityEngine::TooltipAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TooltipAttribute*, "UnityEngine", "TooltipAttribute");
...
/// @brief Method .ctor, addr 0x18227a3f0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TooltipAttribute) == 0x20, "Size mismatch!");
