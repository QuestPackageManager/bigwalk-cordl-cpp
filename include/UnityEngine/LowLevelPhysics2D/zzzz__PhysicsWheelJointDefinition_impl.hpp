...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::*)()>(&::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::_ctor)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x1822f84d0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::*)(bool)>(&::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::_ctor)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x1822f8420;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition (*)()>(&::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::get_defaultDefinition)> {
  constexpr static std::size_t size = 0x150;
  constexpr static std::size_t addrs = 0x1822f8580;
...
// Ctor Parameters [CppParam { name: "m_BodyA", ty: "::UnityEngine::LowLevelPhysics2D::PhysicsBody", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BodyB", ty: "::UnityEngine::LowLevelPhysics2D::PhysicsBody", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_LocalAnchorA", ty: "::UnityEngine::LowLevelPhysics2D::PhysicsTransform", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_LocalAnchorB", ty: "::UnityEngine::LowLevelPhysics2D::PhysicsTransform", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_EnableSpring", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_SpringFrequency", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_SpringDamping", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_EnableMotor", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_MotorSpeed", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_MaxMotorTorque", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_EnableLimit", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_LowerTranslationLimit", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_UpperTranslationLimit", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ForceThreshold", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_TorqueThreshold", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_TuningFrequency", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_TuningDamping", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_DrawScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_CollideConnected", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::LowLevelPhysics2D::PhysicsWheelJointDefinition::PhysicsWheelJointDefinition(::UnityEngine::LowLevelPhysics2D::PhysicsBody  m_BodyA, ::UnityEngine::LowLevelPhysics2D::PhysicsBody  m_BodyB, ::UnityEngine::LowLevelPhysics2D::PhysicsTransform  m_LocalAnchorA, ::UnityEngine::LowLevelPhysics2D::PhysicsTransform  m_LocalAnchorB, bool  m_EnableSpring, float_t  m_SpringFrequency, float_t  m_SpringDamping, bool  m_EnableMotor, float_t  m_MotorSpeed, float_t  m_MaxMotorTorque, bool  m_EnableLimit, float_t  m_LowerTranslationLimit, float_t  m_UpperTranslationLimit, float_t  m_ForceThreshold, float_t  m_TorqueThreshold, float_t  m_TuningFrequency, float_t  m_TuningDamping, float_t  m_DrawScale, bool  m_CollideConnected) noexcept  {
