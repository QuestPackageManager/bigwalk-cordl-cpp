...
// Write type traits
MARK_REF_T(::UnityEngine::SubsystemDescriptorBindings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::SubsystemDescriptorBindings*, "UnityEngine", "SubsystemDescriptorBindings");
...
public:
// Declarations
/// @brief Method GetId, addr 0x18230da50, size 0x90, virtual false, abstract: false, final false
static inline ::StringW GetId(::System::IntPtr  descriptorPtr) ;

/// @brief Method GetId_Injected, addr 0x18230da40, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::SubsystemDescriptorBindings) == 0x10, "Size mismatch!");
