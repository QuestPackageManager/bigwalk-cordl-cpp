...
DEFINE_IL2CPP_CLASS(::UnityEngine::TransformDispatchData, "UnityEngine", "TransformDispatchData");
// Dependencies Unity.Collections.NativeArray`1<T>, UnityEngine.EntityId, UnityEngine.Matrix4x4, UnityEngine.Quaternion, UnityEngine.Vector3
namespace UnityEngine {
// Is value type: true
...
/// @brief Method Dispose, addr 0x18227a4c0, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;
...
static_assert(sizeof(::UnityEngine::TransformDispatchData) == 0x60, "Size mismatch!");
