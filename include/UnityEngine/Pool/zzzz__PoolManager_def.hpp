...
// Write type traits
MARK_REF_T(::UnityEngine::Pool::PoolManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Pool::PoolManager*, "UnityEngine.Pool", "PoolManager");
...
/// @brief Field s_WeakPoolReferences, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_WeakPoolReferences, put=setStaticF_s_WeakPoolReferences)) ::System::Collections::Generic::List_1<::System::WeakReference_1<::UnityEngine::Pool::IPool*>*>*  s_WeakPoolReferences;

/// @brief Method Register, addr 0x1822837f0, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Pool::PoolManager) == 0x10, "Size mismatch!");
