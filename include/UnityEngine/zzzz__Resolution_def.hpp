...
/// @brief Method ToString, addr 0x18225bfd0, size 0x90, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_height, addr 0x18038fe90, size 0x10, virtual false, abstract: false, final false
inline int32_t get_height() ;

/// @brief Method get_refreshRateRatio, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
