...
/// @brief Method GetParent, addr 0x181ccf030, size 0x40, virtual false, abstract: false, final false
inline int32_t GetParent(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>>  pageNode) ;

/// @brief Method GetSibling, addr 0x181ccf070, size 0x40, virtual false, abstract: false, final false
inline int32_t GetSibling(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>>  pageNode) ;

/// @brief Method get_CollapsedLinePosition, addr 0x181ccf0b0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_CollapsedLinePosition() ;

/// @brief Method get_Document, addr 0x181ccf0d0, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::XPath::XPathDocument* get_Document() ;

/// @brief Method get_HasCollapsedText, addr 0x181ccf0f0, size 0x20, virtual false, abstract: false, final false
inline bool get_HasCollapsedText() ;

/// @brief Method get_HasNamespaceDecls, addr 0x181ccf110, size 0x20, virtual false, abstract: false, final false
inline bool get_HasNamespaceDecls() ;

/// @brief Method get_HasSibling, addr 0x181ccf130, size 0x20, virtual false, abstract: false, final false
inline bool get_HasSibling() ;

/// @brief Method get_IsText, addr 0x181ccf150, size 0x20, virtual false, abstract: false, final false
inline bool get_IsText() ;

/// @brief Method get_IsXmlNamespaceNode, addr 0x181ccf170, size 0x40, virtual false, abstract: false, final false
inline bool get_IsXmlNamespaceNode() ;

/// @brief Method get_LineNumber, addr 0x181ccf1b0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x181ccf1d0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x1815c9400, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x181ccf1f0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_NodeType, addr 0x181ccf210, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::XPath::XPathNodeType get_NodeType() ;

/// @brief Method get_PageInfo, addr 0x181ccf230, size 0x20, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo() ;

/// @brief Method get_Prefix, addr 0x181ccf250, size 0x50, virtual false, abstract: false, final false
