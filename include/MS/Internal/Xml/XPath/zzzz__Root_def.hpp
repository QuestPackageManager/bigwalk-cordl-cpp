...
// Write type traits
MARK_REF_T(::MS::Internal::Xml::XPath::Root*);
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Root*, "MS.Internal.Xml.XPath", "Root");
...
/// @brief Method get_Type, addr 0x180908af0, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::MS::Internal::Xml::XPath::Root) == 0x10, "Size mismatch!");
