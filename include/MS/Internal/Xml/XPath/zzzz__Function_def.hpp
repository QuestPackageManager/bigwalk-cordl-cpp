...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Function_FunctionType, "MS.Internal.Xml.XPath", "Function/FunctionType");
...
static_assert(offsetof(::MS::Internal::Xml::XPath::Function_FunctionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::MS::Internal::Xml::XPath::Function_FunctionType) == 0x4, "Size mismatch!");
...
static inline ::MS::Internal::Xml::XPath::Function* New_ctor(::MS::Internal::Xml::XPath::Function_FunctionType  ftype, ::System::Collections::Generic::List_1<::MS::Internal::Xml::XPath::AstNode*>*  argumentList) ;
...
/// @brief Method .ctor, addr 0x181cccc20, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::Function_FunctionType  ftype, ::MS::Internal::Xml::XPath::AstNode*  arg) ;

/// @brief Method .ctor, addr 0x181cccce0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cccd40, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_ReturnType, addr 0x181cccdc0, size 0x20, virtual true, abstract: false, final false
