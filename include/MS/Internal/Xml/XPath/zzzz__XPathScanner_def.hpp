...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::XPathScanner_LexKind, "MS.Internal.Xml.XPath", "XPathScanner/LexKind");
...
static_assert(offsetof(::MS::Internal::Xml::XPath::XPathScanner_LexKind, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::MS::Internal::Xml::XPath::XPathScanner_LexKind) == 0x4, "Size mismatch!");
...
/// @brief Method NextChar, addr 0x181cd21b0, size 0x50, virtual false, abstract: false, final false
inline bool NextChar() ;

/// @brief Method NextLex, addr 0x181cd2200, size 0x7a0, virtual false, abstract: false, final false
inline bool NextLex() ;

/// @brief Method ScanFraction, addr 0x181cd29a0, size 0xa0, virtual false, abstract: false, final false
inline double_t ScanFraction() ;

/// @brief Method ScanName, addr 0x181cd2a40, size 0xb0, virtual false, abstract: false, final false
inline ::StringW ScanName() ;

/// @brief Method ScanNumber, addr 0x181cd2af0, size 0x120, virtual false, abstract: false, final false
inline double_t ScanNumber() ;

/// @brief Method ScanString, addr 0x181cd2c10, size 0x110, virtual false, abstract: false, final false
inline ::StringW ScanString() ;

/// @brief Method SkipSpace, addr 0x181cd2d20, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cd2d80, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::StringW  xpathExpr) ;

/// @brief Method get_CanBeFunction, addr 0x1802fdd10, size 0x10, virtual false, abstract: false, final false
inline bool get_CanBeFunction() ;

/// @brief Method get_CurrentChar, addr 0x180416380, size 0x10, virtual false, abstract: false, final false
inline char16_t get_CurrentChar() ;

/// @brief Method get_Kind, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_NumberValue, addr 0x18051eb10, size 0x10, virtual false, abstract: false, final false
inline double_t get_NumberValue() ;

/// @brief Method get_Prefix, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SourceText, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SourceText() ;

/// @brief Method get_StringValue, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
