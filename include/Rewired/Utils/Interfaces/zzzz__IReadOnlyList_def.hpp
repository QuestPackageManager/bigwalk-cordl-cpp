...
CORDL_MODULE_INIT
#include <cstdint>
CORDL_MODULE_EXPORT(IReadOnlyList)
namespace System {
class Object;
}
...
// Write type traits
MARK_REF_T(::Rewired::Utils::Interfaces::IReadOnlyList*);
DEFINE_IL2CPP_CLASS(::Rewired::Utils::Interfaces::IReadOnlyList*, "Rewired.Utils.Interfaces", "IReadOnlyList");
// Dependencies 
namespace Rewired::Utils::Interfaces {
// Is value type: false
// CS Name: Rewired.Utils.Interfaces.IReadOnlyList
class CORDL_TYPE IReadOnlyList {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "", ty: "IReadOnlyList", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
IReadOnlyList(IReadOnlyList const& ) = delete;
