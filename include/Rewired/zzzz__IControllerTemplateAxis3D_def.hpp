...
CORDL_MODULE_INIT
CORDL_MODULE_EXPORT(IControllerTemplateAxis3D)
namespace Rewired {
...
// Write type traits
MARK_REF_T(::Rewired::IControllerTemplateAxis3D*);
DEFINE_IL2CPP_CLASS(::Rewired::IControllerTemplateAxis3D*, "Rewired", "IControllerTemplateAxis3D");
// Dependencies 
namespace Rewired {
// Is value type: false
// CS Name: Rewired.IControllerTemplateAxis3D
class CORDL_TYPE IControllerTemplateAxis3D {
public:
// Declarations
 __declspec(property(get=get_depth)) ::Rewired::IControllerTemplateAxis*  depth;
...
inline ::Rewired::IControllerTemplateAxis* get_depth() ;
...
// Ctor Parameters [CppParam { name: "", ty: "IControllerTemplateAxis3D", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
IControllerTemplateAxis3D(IControllerTemplateAxis3D const& ) = delete;
