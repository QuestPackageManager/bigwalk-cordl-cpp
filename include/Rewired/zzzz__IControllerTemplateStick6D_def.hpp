#pragma once
// IWYU pragma private; include "Rewired/IControllerTemplateStick6D.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
CORDL_MODULE_EXPORT(IControllerTemplateStick6D)
namespace Rewired {
...
// Write type traits
MARK_REF_T(::Rewired::IControllerTemplateStick6D*);
DEFINE_IL2CPP_CLASS(::Rewired::IControllerTemplateStick6D*, "Rewired", "IControllerTemplateStick6D");
// Dependencies 
namespace Rewired {
// Is value type: false
// CS Name: Rewired.IControllerTemplateStick6D
class CORDL_TYPE IControllerTemplateStick6D {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "", ty: "IControllerTemplateStick6D", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
IControllerTemplateStick6D(IControllerTemplateStick6D const& ) = delete;
