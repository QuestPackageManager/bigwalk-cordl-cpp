...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(AddPlayerMessage)
namespace Mirror {
...
// Write type traits
MARK_VAL_T(::Mirror::AddPlayerMessage);
DEFINE_IL2CPP_CLASS(::Mirror::AddPlayerMessage, "Mirror", "AddPlayerMessage");
// Dependencies 
namespace Mirror {
// Is value type: true
// CS Name: Mirror.AddPlayerMessage
#pragma pack(push, 0)
struct CORDL_TYPE AddPlayerMessage {
public:
// Declarations
...
static_assert(sizeof(::Mirror::AddPlayerMessage) == 0x1, "Size mismatch!");
