...
// Write type traits
MARK_REF_T(::Mirror::Examples::NetworkRoom::RandomColor*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::NetworkRoom::RandomColor*, "Mirror.Examples.NetworkRoom", "RandomColor");
// Dependencies Mirror.NetworkBehaviour, UnityEngine.Color32
namespace Mirror::Examples::NetworkRoom {
// Is value type: false
// CS Name: Mirror.Examples.NetworkRoom.RandomColor
...
/// @brief Method DeserializeSyncVars, addr 0x1815626c0, size 0xd0, virtual true, abstract: false, final false
inline void DeserializeSyncVars(::Mirror::NetworkReader*  reader, bool  initialState) ;

/// @brief Method MirrorProcessed, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void MirrorProcessed() ;

static inline ::Mirror::Examples::NetworkRoom::RandomColor* New_ctor() ;

/// @brief Method OnDestroy, addr 0x181562790, size 0x10, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnStartServer, addr 0x1815627a0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method set_Networkcolor, addr 0x181562b10, size 0x70, virtual false, abstract: false, final false
...
static_assert(offsetof(::Mirror::Examples::NetworkRoom::RandomColor, ___color) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::NetworkRoom::RandomColor, ___cachedMaterial) == 0x70, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::NetworkRoom::RandomColor) == 0x78, "Size mismatch!");
