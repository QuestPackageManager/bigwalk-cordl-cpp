...
// Write type traits
MARK_REF_T(::Mirror::Examples::MultipleAdditiveScenes::PlayerCamera*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::MultipleAdditiveScenes::PlayerCamera*, "Mirror.Examples.MultipleAdditiveScenes", "PlayerCamera");
// Dependencies Mirror.NetworkBehaviour
namespace Mirror::Examples::MultipleAdditiveScenes {
// Is value type: false
// CS Name: Mirror.Examples.MultipleAdditiveScenes.PlayerCamera
...
static inline ::Mirror::Examples::MultipleAdditiveScenes::PlayerCamera* New_ctor() ;
...
static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerCamera, ___mainCam) == 0x68, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::MultipleAdditiveScenes::PlayerCamera) == 0x70, "Size mismatch!");
