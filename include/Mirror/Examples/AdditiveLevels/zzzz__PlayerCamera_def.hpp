...
// Write type traits
MARK_REF_T(::Mirror::Examples::AdditiveLevels::PlayerCamera*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::AdditiveLevels::PlayerCamera*, "Mirror.Examples.AdditiveLevels", "PlayerCamera");
// Dependencies Mirror.NetworkBehaviour
namespace Mirror::Examples::AdditiveLevels {
// Is value type: false
// CS Name: Mirror.Examples.AdditiveLevels.PlayerCamera
...
static inline ::Mirror::Examples::AdditiveLevels::PlayerCamera* New_ctor() ;
...
static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerCamera, ___mainCam) == 0x68, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::AdditiveLevels::PlayerCamera) == 0x70, "Size mismatch!");
