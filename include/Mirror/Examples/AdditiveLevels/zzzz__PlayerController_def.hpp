...
// Write type traits
MARK_VAL_T(::Mirror::Examples::AdditiveLevels::PlayerController_GroundState);
MARK_REF_T(::Mirror::Examples::AdditiveLevels::PlayerController*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::AdditiveLevels::PlayerController_GroundState, "Mirror.Examples.AdditiveLevels", "PlayerController/GroundState");
DEFINE_IL2CPP_CLASS(::Mirror::Examples::AdditiveLevels::PlayerController*, "Mirror.Examples.AdditiveLevels", "PlayerController");
// Dependencies 
namespace Mirror::Examples::AdditiveLevels {
// Is value type: true
// CS Name: Mirror.Examples.AdditiveLevels.PlayerController/GroundState
...
static ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState const Falling;

/// @brief Field Grounded value: U8(2)
static ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState const Grounded;

/// @brief Field Jumping value: U8(0)
static ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState const Jumping;
...
static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController_GroundState, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::AdditiveLevels::PlayerController_GroundState) == 0x1, "Size mismatch!");

} // namespace end def Mirror::Examples::AdditiveLevels
// Dependencies Mirror.Examples.AdditiveLevels.PlayerController::GroundState, Mirror.NetworkBehaviour, UnityEngine.Vector3, UnityEngine.Vector3Int
namespace Mirror::Examples::AdditiveLevels {
// Is value type: false
// CS Name: Mirror.Examples.AdditiveLevels.PlayerController
class CORDL_TYPE PlayerController : public ::Mirror::NetworkBehaviour {
public:
// Declarations
using GroundState = ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState;
...
/// @brief Field groundState, offset 0x88, size 0x1 
 __declspec(property(get=__cordl_internal_get_groundState, put=__cordl_internal_set_groundState)) ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState  groundState;
...
static inline ::Mirror::Examples::AdditiveLevels::PlayerController* New_ctor() ;
...
constexpr ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState const& __cordl_internal_get_groundState() const;

constexpr ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState& __cordl_internal_get_groundState() ;
...
constexpr void __cordl_internal_set_groundState(::Mirror::Examples::AdditiveLevels::PlayerController_GroundState  value) ;
...
/// @brief Field groundState, offset: 0x88, size: 0x1, def value: None
 ::Mirror::Examples::AdditiveLevels::PlayerController_GroundState  ___groundState;
...
// Non member Declarations
static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___characterController) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___moveSpeedMultiplier) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___maxTurnSpeed) == 0x74, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___turnDelta) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___initialJumpSpeed) == 0x7c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___maxJumpSpeed) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___jumpDelta) == 0x84, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___groundState) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___horizontal) == 0x8c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___vertical) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___turnSpeed) == 0x94, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___jumpSpeed) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___animVelocity) == 0x9c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___animRotation) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___velocity) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PlayerController, ___direction) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::AdditiveLevels::PlayerController) == 0xc0, "Size mismatch!");
