...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(ServerRequest)
namespace Mirror {
...
// Write type traits
MARK_VAL_T(::Mirror::Discovery::ServerRequest);
DEFINE_IL2CPP_CLASS(::Mirror::Discovery::ServerRequest, "Mirror.Discovery", "ServerRequest");
// Dependencies 
namespace Mirror::Discovery {
// Is value type: true
// CS Name: Mirror.Discovery.ServerRequest
#pragma pack(push, 0)
struct CORDL_TYPE ServerRequest {
public:
// Declarations
...
static_assert(sizeof(::Mirror::Discovery::ServerRequest) == 0x1, "Size mismatch!");
