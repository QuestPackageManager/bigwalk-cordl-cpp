...
namespace Rowlan::Genesis::Ambience::Urp {
class PostProcessingSetup;
}
// Write type traits
MARK_REF_T(::Rowlan::Genesis::Ambience::Urp::PostProcessingSetup*);
DEFINE_IL2CPP_CLASS(::Rowlan::Genesis::Ambience::Urp::PostProcessingSetup*, "Rowlan.Genesis.Ambience.Urp", "PostProcessingSetup");
// Dependencies System.Object
namespace Rowlan::Genesis::Ambience::Urp {
// Is value type: false
// CS Name: Rowlan.Genesis.Ambience.Urp.PostProcessingSetup
class CORDL_TYPE PostProcessingSetup : public ::System::Object {
public:
// Declarations
static inline ::Rowlan::Genesis::Ambience::Urp::PostProcessingSetup* New_ctor() ;
...
static_assert(sizeof(::Rowlan::Genesis::Ambience::Urp::PostProcessingSetup) == 0x10, "Size mismatch!");

} // namespace end def Rowlan::Genesis::Ambience::Urp
