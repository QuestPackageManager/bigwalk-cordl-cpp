#pragma once
// IWYU pragma private; include "Rowlan/Genesis/ReGenesis/ProjectSetup.hpp"
...
// Write type traits
MARK_REF_T(::Rowlan::Genesis::ReGenesis::ProjectSetup*);
DEFINE_IL2CPP_CLASS(::Rowlan::Genesis::ReGenesis::ProjectSetup*, "Rowlan.Genesis.ReGenesis", "ProjectSetup");
// Dependencies System.Object
namespace Rowlan::Genesis::ReGenesis {
// Is value type: false
// CS Name: Rowlan.Genesis.ReGenesis.ProjectSetup
...
static constexpr ::ConstString  MENU{u"Window/Genesis for MicroVerse/ReGenesis"};
...
static constexpr ::ConstString  SETTINGS_FILENAME{u"ReGenesis Settings.asset"};
...
static_assert(sizeof(::Rowlan::Genesis::ReGenesis::ProjectSetup) == 0x10, "Size mismatch!");
