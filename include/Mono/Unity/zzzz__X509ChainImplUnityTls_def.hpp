...
// Write type traits
MARK_REF_T(::Mono::Unity::X509ChainImplUnityTls*);
DEFINE_IL2CPP_CLASS(::Mono::Unity::X509ChainImplUnityTls*, "Mono.Unity", "X509ChainImplUnityTls");
...
/// @brief Field chainStatusList, offset 0x30, size 0x8 
...
/// @brief Field nativeCertificateChain, offset 0x20, size 0x8 
...
/// @brief Field ownedList, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_ownedList, put=__cordl_internal_set_ownedList)) ::Mono::Unity::UnityTls_unitytls_x509list*  ownedList;

/// @brief Field policy, offset 0x28, size 0x8 
...
/// @brief Method AddStatus, addr 0x181b516c0, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181163b40, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x181b517c0, size 0x90, virtual true, abstract: false, final false
inline void Reset() ;
...
constexpr ::Mono::Unity::UnityTls_unitytls_x509list* const& __cordl_internal_get_ownedList() const;

constexpr ::Mono::Unity::UnityTls_unitytls_x509list*& __cordl_internal_get_ownedList() ;
...
constexpr void __cordl_internal_set_ownedList(::Mono::Unity::UnityTls_unitytls_x509list*  value) ;
...
/// @brief Method .ctor, addr 0x181b51910, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Mono::Unity::UnityTls_unitytls_x509list_ref  nativeCertificateChain, bool  reverseOrder) ;

/// @brief Method .ctor, addr 0x181b51850, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_ChainElements, addr 0x181b51990, size 0x340, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements() ;

/// @brief Method get_ChainPolicy, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy() ;

/// @brief Method get_IsValid, addr 0x181b51cd0, size 0x30, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_NativeCertificateChain, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field ownedList, offset: 0x18, size: 0x8, def value: None
 ::Mono::Unity::UnityTls_unitytls_x509list*  ___ownedList;

/// @brief Field nativeCertificateChain, offset: 0x20, size: 0x8, def value: None
 ::Mono::Unity::UnityTls_unitytls_x509list_ref  ___nativeCertificateChain;

/// @brief Field policy, offset: 0x28, size: 0x8, def value: None
 ::System::Security::Cryptography::X509Certificates::X509ChainPolicy*  ___policy;

/// @brief Field chainStatusList, offset: 0x30, size: 0x8, def value: None
 ::System::Collections::Generic::List_1<::System::Security::Cryptography::X509Certificates::X509ChainStatus>*  ___chainStatusList;

/// @brief Field reverseOrder, offset: 0x38, size: 0x1, def value: None
...
static_assert(offsetof(::Mono::Unity::X509ChainImplUnityTls, ___ownedList) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Mono::Unity::X509ChainImplUnityTls, ___nativeCertificateChain) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Mono::Unity::X509ChainImplUnityTls, ___policy) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Mono::Unity::X509ChainImplUnityTls, ___chainStatusList) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Mono::Unity::X509ChainImplUnityTls, ___reverseOrder) == 0x38, "Offset mismatch!");

static_assert(sizeof(::Mono::Unity::X509ChainImplUnityTls) == 0x40, "Size mismatch!");
