...
// Write type traits
MARK_REF_T(::Mono::Xml::SmallXmlParserException*);
DEFINE_IL2CPP_CLASS(::Mono::Xml::SmallXmlParserException*, "Mono.Xml", "SmallXmlParserException");
...
/// @brief Method .ctor, addr 0x1815cf110, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Xml::SmallXmlParserException) == 0x98, "Size mismatch!");
