...
/// @brief Method CreateDefaultProviderImpl, addr 0x181b49450, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetProviderInternal, addr 0x181b49550, size 0xf0, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* GetProviderInternal() ;

/// @brief Method InitializeInternal, addr 0x181b49650, size 0x400, virtual false, abstract: false, final false
static inline void InitializeInternal() ;

/// @brief Method InitializeProviderRegistration, addr 0x181b49a50, size 0x430, virtual false, abstract: false, final false
static inline void InitializeProviderRegistration() ;

/// @brief Method IsBtlsSupported, addr 0x1815c4100, size 0x10, virtual false, abstract: false, final false
static inline bool IsBtlsSupported() ;

/// @brief Method LookupProvider, addr 0x181b49e80, size 0x450, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* LookupProvider(::StringW  name, bool  throwOnError) ;

/// @brief Method PopulateProviders, addr 0x181b4a2d0, size 0x150, virtual false, abstract: false, final false
static inline void PopulateProviders() ;

/// @brief Method PopulateUnityProviders, addr 0x181b4a420, size 0xd0, virtual false, abstract: false, final false
