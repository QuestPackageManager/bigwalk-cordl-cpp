...
// Write type traits
MARK_REF_T(::Mono::Net::Security::BufferOffsetSize*);
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::BufferOffsetSize*, "Mono.Net.Security", "BufferOffsetSize");
...
/// @brief Method ToString, addr 0x181b3e130, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b3e190, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method get_EndOffset, addr 0x181b3e220, size 0x10, virtual false, abstract: false, final false
inline int32_t get_EndOffset() ;

/// @brief Method get_Remaining, addr 0x181b3e230, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Net::Security::BufferOffsetSize) == 0x28, "Size mismatch!");
