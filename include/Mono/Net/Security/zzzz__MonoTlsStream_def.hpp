...
/// @brief Method MoveNext, addr 0x181b4bcc0, size 0x5f0, virtual true, abstract: false, final true
...
static_assert(sizeof(::Mono::Net::Security::MonoTlsStream__CreateStream_d__18) == 0x50, "Size mismatch!");
...
/// @brief Method CloseSslStream, addr 0x181b4a5d0, size 0xb0, virtual false, abstract: false, final false
inline void CloseSslStream() ;

/// @brief Method CreateStream, addr 0x181b4a680, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181b4a760, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x181b4a770, size 0x1b0, virtual false, abstract: false, final false
inline void _ctor(::System::Net::HttpWebRequest*  request, ::System::Net::Sockets::NetworkStream*  networkStream) ;

/// @brief Method get_CertificateValidationFailed, addr 0x180468800, size 0x10, virtual false, abstract: false, final false
inline bool get_CertificateValidationFailed() ;

/// @brief Method get_ExceptionStatus, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::WebExceptionStatus get_ExceptionStatus() ;

/// @brief Method get_Request, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::HttpWebRequest* get_Request() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_CertificateValidationFailed, addr 0x180468810, size 0x10, virtual false, abstract: false, final false
