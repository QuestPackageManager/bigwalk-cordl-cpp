...
// Write type traits
MARK_REF_T(::Mono::Net::Security::AsyncProtocolResult*);
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::AsyncProtocolResult*, "Mono.Net.Security", "AsyncProtocolResult");
...
/// @brief Method get_UserResult, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Net::Security::AsyncProtocolResult) == 0x20, "Size mismatch!");
