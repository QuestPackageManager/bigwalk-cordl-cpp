...
/// @brief Method ConvertData, addr 0x181b51d70, size 0x120, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t> ConvertData(::ArrayW<uint8_t>  data) ;

/// @brief Method GetCertContentType, addr 0x181b51e90, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method ImportFallback, addr 0x181b52100, size 0xe0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t>  data) ;

/// @brief Method ImportFallback, addr 0x181b51d00, size 0x60, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t>  data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags) ;
...
/// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
