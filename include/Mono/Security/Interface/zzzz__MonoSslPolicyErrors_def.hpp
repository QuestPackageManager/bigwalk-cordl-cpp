...
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::MonoSslPolicyErrors, "Mono.Security.Interface", "MonoSslPolicyErrors");
// Dependencies 
namespace Mono::Security::Interface {
// Is value type: true
...
static_assert(offsetof(::Mono::Security::Interface::MonoSslPolicyErrors, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Security::Interface::MonoSslPolicyErrors) == 0x4, "Size mismatch!");
