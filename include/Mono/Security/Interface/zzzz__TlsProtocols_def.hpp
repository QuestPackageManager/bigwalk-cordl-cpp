...
static_assert(offsetof(::Mono::Security::Interface::TlsProtocols, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Security::Interface::TlsProtocols) == 0x4, "Size mismatch!");
