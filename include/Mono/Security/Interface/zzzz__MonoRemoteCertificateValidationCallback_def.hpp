...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*, "Mono.Security.Interface", "MonoRemoteCertificateValidationCallback");
...
/// @brief Method .ctor, addr 0x1815b8ee0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Interface::MonoRemoteCertificateValidationCallback) == 0x80, "Size mismatch!");
