...
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::AlertLevel, "Mono.Security.Interface", "AlertLevel");
// Dependencies 
namespace Mono::Security::Interface {
// Is value type: true
...
static_assert(offsetof(::Mono::Security::Interface::AlertLevel, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Mono::Security::Interface::AlertLevel) == 0x1, "Size mismatch!");
