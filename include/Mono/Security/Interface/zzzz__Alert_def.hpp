...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::Alert*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::Alert*, "Mono.Security.Interface", "Alert");
...
/// @brief Method ToString, addr 0x1815af1f0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815af260, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::AlertDescription  description) ;

/// @brief Method get_Description, addr 0x180503b10, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::AlertDescription get_Description() ;

/// @brief Method get_Level, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::AlertLevel get_Level() ;

/// @brief Method inferAlertLevel, addr 0x1815af2e0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Interface::Alert) == 0x18, "Size mismatch!");
