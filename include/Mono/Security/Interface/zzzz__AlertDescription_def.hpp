...
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::AlertDescription, "Mono.Security.Interface", "AlertDescription");
// Dependencies 
namespace Mono::Security::Interface {
// Is value type: true
...
static_assert(offsetof(::Mono::Security::Interface::AlertDescription, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Mono::Security::Interface::AlertDescription) == 0x1, "Size mismatch!");
