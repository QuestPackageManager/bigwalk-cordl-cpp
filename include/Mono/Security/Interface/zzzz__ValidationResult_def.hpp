...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::ValidationResult*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::ValidationResult*, "Mono.Security.Interface", "ValidationResult");
...
/// @brief Method .ctor, addr 0x1815bf8b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_Trusted, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_Trusted() ;

/// @brief Method get_UserDenied, addr 0x180503b10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Interface::ValidationResult) == 0x20, "Size mismatch!");
