...
/// @brief Method CheckSignature, addr 0x1815afd50, size 0x1630, virtual false, abstract: false, final false
inline bool CheckSignature() ;

/// @brief Method CompareIssuerSerial, addr 0x1815b1380, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x1815b1470, size 0xe0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method VerifyCounterSignature, addr 0x1815b1550, size 0x800, virtual false, abstract: false, final false
inline bool VerifyCounterSignature(::Mono::Security::PKCS7_SignerInfo*  cs, ::ArrayW<uint8_t>  signature) ;

/// @brief Method VerifySignature, addr 0x1815b1d50, size 0x8e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815b2630, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815b26d0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  rawData) ;

/// @brief Method get_SigningCertificate, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate() ;

/// @brief Method set_RawData, addr 0x1815b2790, size 0x140, virtual false, abstract: false, final false
