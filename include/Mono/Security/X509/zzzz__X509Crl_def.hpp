...
/// @brief Method .ctor, addr 0x1815ac390, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  entry) ;

/// @brief Method get_Extensions, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_RevocationDate, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_RevocationDate() ;

/// @brief Method get_SerialNumber, addr 0x1815ac460, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetCrlEntry, addr 0x1815ac510, size 0x180, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Crl_X509CrlEntry* GetCrlEntry(::ArrayW<uint8_t>  serialNumber) ;

/// @brief Method GetCrlEntry, addr 0x1815ac4c0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x1815ac690, size 0x660, virtual false, abstract: false, final false
inline void Parse(::ArrayW<uint8_t>  crl) ;

/// @brief Method VerifySignature, addr 0x1815accf0, size 0x1e0, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method VerifySignature, addr 0x1815acf80, size 0x250, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method VerifySignature, addr 0x1815aced0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815ad1d0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  crl) ;

/// @brief Method get_Extensions, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_Hash, addr 0x1815ad290, size 0x150, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method get_IssuerName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_NextUpdate, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
