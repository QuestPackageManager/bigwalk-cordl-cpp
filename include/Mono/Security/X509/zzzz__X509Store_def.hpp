...
// Write type traits
MARK_REF_T(::Mono::Security::X509::X509Store*);
DEFINE_IL2CPP_CLASS(::Mono::Security::X509::X509Store*, "Mono.Security.X509", "X509Store");
...
/// @brief Method BuildCertificatesCollection, addr 0x1815aea90, size 0x140, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW  storeName) ;

/// @brief Method BuildCrlsCollection, addr 0x1815aebd0, size 0x110, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW  storeName) ;

/// @brief Method CheckStore, addr 0x1815aece0, size 0x60, virtual false, abstract: false, final false
inline bool CheckStore(::StringW  path, bool  throwException) ;

/// @brief Method Load, addr 0x1815aee50, size 0x130, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> Load(::StringW  filename) ;

/// @brief Method LoadCertificate, addr 0x1815aed40, size 0x40, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW  filename) ;

/// @brief Method LoadCrl, addr 0x1815aed80, size 0xd0, virtual false, abstract: false, final false
...
constexpr ::Mono::Security::X509::X509CertificateCollection* const& __cordl_internal_get__certificates() const;
...
constexpr ::System::Collections::ArrayList* const& __cordl_internal_get__crls() const;
...
/// @brief Method .ctor, addr 0x1815aef80, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  crl, bool  newFormat) ;

/// @brief Method get_Certificates, addr 0x1815aefc0, size 0x40, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_Crls, addr 0x1815af000, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::X509::X509Store) == 0x30, "Size mismatch!");
