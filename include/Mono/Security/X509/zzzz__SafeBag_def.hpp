...
// Write type traits
MARK_REF_T(::Mono::Security::X509::SafeBag*);
DEFINE_IL2CPP_CLASS(::Mono::Security::X509::SafeBag*, "Mono.Security.X509", "SafeBag");
...
/// @brief Method get_ASN1, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_ASN1() ;

/// @brief Method get_BagOID, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::X509::SafeBag) == 0x20, "Size mismatch!");
