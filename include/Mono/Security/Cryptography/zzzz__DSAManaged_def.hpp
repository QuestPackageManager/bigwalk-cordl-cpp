...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::DSAManaged*);
MARK_REF_T(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::DSAManaged*, "Mono.Security.Cryptography", "DSAManaged");
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler*, "Mono.Security.Cryptography", "DSAManaged/KeyGeneratedEventHandler");
...
/// @brief Method .ctor, addr 0x181398c10, size 0x900, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler) == 0x80, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x1815d4980, size 0x230, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExportParameters, addr 0x1815d4bb0, size 0x290, virtual true, abstract: false, final false
...
/// @brief Method Generate, addr 0x1815d56d0, size 0x190, virtual false, abstract: false, final false
inline void Generate() ;

/// @brief Method GenerateKeyPair, addr 0x1815d4e40, size 0x150, virtual false, abstract: false, final false
inline void GenerateKeyPair() ;

/// @brief Method GenerateParams, addr 0x1815d4f90, size 0x740, virtual false, abstract: false, final false
inline void GenerateParams(int32_t  keyLength) ;

/// @brief Method ImportParameters, addr 0x1815d5860, size 0x3a0, virtual true, abstract: false, final false
...
/// @brief Method NormalizeArray, addr 0x1815d5c00, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> NormalizeArray(::ArrayW<uint8_t>  array) ;

/// @brief Method VerifySignature, addr 0x1815d5c90, size 0x3f0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815d6080, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

/// @brief Method add, addr 0x1815d6180, size 0x50, virtual false, abstract: false, final false
inline void add(::ArrayW<uint8_t>  a, ::ArrayW<uint8_t>  b, int32_t  value) ;

/// @brief Method add_KeyGenerated, addr 0x1815d6100, size 0x80, virtual false, abstract: false, final false
inline void add_KeyGenerated(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler*  value) ;

/// @brief Method get_KeySize, addr 0x1815d61d0, size 0x20, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x1815d61f0, size 0x80, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method get_Random, addr 0x1815d6270, size 0x40, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::RandomNumberGenerator* get_Random() ;

/// @brief Method remove_KeyGenerated, addr 0x1815d62b0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::DSAManaged) == 0x78, "Size mismatch!");
