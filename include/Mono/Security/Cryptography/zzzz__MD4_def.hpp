...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::MD4*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::MD4*, "Mono.Security.Cryptography", "MD4");
...
public:
// Declarations
/// @brief Method Create, addr 0x1815c6300, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::MD4) == 0x28, "Size mismatch!");
