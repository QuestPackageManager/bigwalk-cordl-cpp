...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::MD2Managed*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::MD2Managed*, "Mono.Security.Cryptography", "MD2Managed");
...
/// @brief Field PI_SUBST, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_PI_SUBST, put=setStaticF_PI_SUBST)) ::ArrayW<uint8_t>  PI_SUBST;
...
/// @brief Field checksum, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_checksum, put=__cordl_internal_set_checksum)) ::ArrayW<uint8_t>  checksum;
...
/// @brief Field x, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_x, put=__cordl_internal_set_x)) ::ArrayW<uint8_t>  x;

/// @brief Method HashCore, addr 0x1815b65c0, size 0x100, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t>  array, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x1815b66c0, size 0x110, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize, addr 0x1815b67d0, size 0x70, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method MD2Transform, addr 0x1815b6840, size 0x210, virtual false, abstract: false, final false
inline void MD2Transform(::ArrayW<uint8_t>  state, ::ArrayW<uint8_t>  checksum, ::ArrayW<uint8_t>  block, int32_t  index) ;

static inline ::Mono::Security::Cryptography::MD2Managed* New_ctor() ;

/// @brief Method Padding, addr 0x1815b6a50, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t>& __cordl_internal_get_checksum() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_x() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_x() ;

constexpr void __cordl_internal_set_buffer(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_checksum(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_count(int32_t  value) ;

constexpr void __cordl_internal_set_state(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_x(::ArrayW<uint8_t>  value) ;

/// @brief Method .ctor, addr 0x1815b6b00, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t> getStaticF_PI_SUBST() ;

static inline void setStaticF_PI_SUBST(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::Mono::Security::Cryptography::MD2Managed) == 0x50, "Size mismatch!");
