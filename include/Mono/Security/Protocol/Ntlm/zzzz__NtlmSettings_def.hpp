...
// Write type traits
MARK_REF_T(::Mono::Security::Protocol::Ntlm::NtlmSettings*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::NtlmSettings*, "Mono.Security.Protocol.Ntlm", "NtlmSettings");
...
/// @brief Method get_DefaultAuthLevel, addr 0x1815b9410, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::NtlmSettings) == 0x10, "Size mismatch!");
