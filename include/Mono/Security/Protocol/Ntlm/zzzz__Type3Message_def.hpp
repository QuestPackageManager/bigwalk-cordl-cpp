...
// Write type traits
MARK_REF_T(::Mono::Security::Protocol::Ntlm::Type3Message*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::Type3Message*, "Mono.Security.Protocol.Ntlm", "Type3Message");
...
/// @brief Field _lm, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__lm, put=__cordl_internal_set__lm)) ::ArrayW<uint8_t>  _lm;

/// @brief Field _nt, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__nt, put=__cordl_internal_set__nt)) ::ArrayW<uint8_t>  _nt;
...
/// @brief Method Decode, addr 0x1815bee90, size 0x220, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t>  message) ;

/// @brief Method DecodeString, addr 0x1815bee00, size 0x90, virtual false, abstract: false, final false
inline ::StringW DecodeString(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  len) ;

/// @brief Method EncodeString, addr 0x1815bf0b0, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> EncodeString(::StringW  text) ;

/// @brief Method Finalize, addr 0x1815bf140, size 0x70, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x1815bf1b0, size 0x510, virtual true, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__lm() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__lm() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__nt() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__nt() ;
...
constexpr void __cordl_internal_set__lm(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set__nt(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x1815bf6c0, size 0x190, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Protocol::Ntlm::Type2Message*  type2) ;

/// @brief Method set_Domain, addr 0x1815bf850, size 0x60, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Password, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_Password(::StringW  value) ;

/// @brief Method set_Username, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::Type3Message) == 0x60, "Size mismatch!");
