...
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::NtlmFlags, "Mono.Security.Protocol.Ntlm", "NtlmFlags");
// Dependencies 
namespace Mono::Security::Protocol::Ntlm {
// Is value type: true
...
static_assert(offsetof(::Mono::Security::Protocol::Ntlm::NtlmFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Security::Protocol::Ntlm::NtlmFlags) == 0x4, "Size mismatch!");
