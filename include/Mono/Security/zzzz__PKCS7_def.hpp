...
// Write type traits
MARK_REF_T(::Mono::Security::PKCS7*);
MARK_REF_T(::Mono::Security::PKCS7_ContentInfo*);
MARK_REF_T(::Mono::Security::PKCS7_EncryptedData*);
MARK_REF_T(::Mono::Security::PKCS7_SignedData*);
MARK_REF_T(::Mono::Security::PKCS7_SignerInfo*);
DEFINE_IL2CPP_CLASS(::Mono::Security::PKCS7*, "Mono.Security", "PKCS7");
DEFINE_IL2CPP_CLASS(::Mono::Security::PKCS7_ContentInfo*, "Mono.Security", "PKCS7/ContentInfo");
DEFINE_IL2CPP_CLASS(::Mono::Security::PKCS7_EncryptedData*, "Mono.Security", "PKCS7/EncryptedData");
DEFINE_IL2CPP_CLASS(::Mono::Security::PKCS7_SignedData*, "Mono.Security", "PKCS7/SignedData");
DEFINE_IL2CPP_CLASS(::Mono::Security::PKCS7_SignerInfo*, "Mono.Security", "PKCS7/SignerInfo");
...
/// @brief Method GetASN1, addr 0x18159d980, size 0x180, virtual false, abstract: false, final false
...
static inline ::Mono::Security::PKCS7_ContentInfo* New_ctor(::ArrayW<uint8_t>  data) ;
...
/// @brief Method .ctor, addr 0x18159db00, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18159dc10, size 0x160, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method .ctor, addr 0x18159db50, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data) ;

/// @brief Method .ctor, addr 0x18159dba0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method get_ASN1, addr 0x18159dd70, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_ASN1() ;

/// @brief Method get_Content, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_Content() ;

/// @brief Method get_ContentType, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ContentType() ;

/// @brief Method set_Content, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_Content(::Mono::Security::ASN1*  value) ;

/// @brief Method set_ContentType, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::PKCS7_ContentInfo) == 0x20, "Size mismatch!");
...
public:
// Declarations
 __declspec(property(get=get_EncryptedContent)) ::ArrayW<uint8_t>  EncryptedContent;
...
/// @brief Field _encrypted, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__encrypted, put=__cordl_internal_set__encrypted)) ::ArrayW<uint8_t>  _encrypted;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__encrypted() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__encrypted() ;
...
constexpr void __cordl_internal_set__encrypted(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x18159e630, size 0x290, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_EncryptedContent, addr 0x18159b680, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_EncryptedContent() ;

/// @brief Method get_EncryptionAlgorithm, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::PKCS7_EncryptedData) == 0x30, "Size mismatch!");
...
/// @brief Method OidToName, addr 0x1815a5e50, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815a5f30, size 0x6d0, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_Certificates, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_ContentInfo, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_ContentInfo* get_ContentInfo() ;

/// @brief Method get_SignerInfo, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_SignerInfo* get_SignerInfo() ;

/// @brief Method set_HashName, addr 0x1815a6600, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::PKCS7_SignedData) == 0x48, "Size mismatch!");
...
/// @brief Field serial, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_serial, put=__cordl_internal_set_serial)) ::ArrayW<uint8_t>  serial;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_serial() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_serial() ;
...
constexpr void __cordl_internal_set_serial(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x1815a6650, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815a66c0, size 0x490, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_AuthenticatedAttributes, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_AuthenticatedAttributes() ;

/// @brief Method get_HashName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_HashName() ;

/// @brief Method get_IssuerName, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_SerialNumber, addr 0x1815a6b50, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_Signature, addr 0x1815a6bc0, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Signature() ;

/// @brief Method get_UnauthenticatedAttributes, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_UnauthenticatedAttributes() ;

/// @brief Method get_Version, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline uint8_t get_Version() ;

/// @brief Method set_HashName, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_HashName(::StringW  value) ;
...
static_assert(sizeof(::Mono::Security::PKCS7_SignerInfo) == 0x50, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Mono::Security::PKCS7) == 0x10, "Size mismatch!");
