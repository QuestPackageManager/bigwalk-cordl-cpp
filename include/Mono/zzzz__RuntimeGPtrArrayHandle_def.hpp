...
/// @brief Method DestroyAndFree, addr 0x1815c8f40, size 0x20, virtual false, abstract: false, final false
static inline void DestroyAndFree(::by_ref<::Mono::RuntimeGPtrArrayHandle>  h) ;

/// @brief Method GPtrArrayFree, addr 0x1815c8f60, size 0x10, virtual false, abstract: false, final false
static inline void GPtrArrayFree(::Mono::RuntimeStructs_GPtrArray*  value) ;

/// @brief Method Lookup, addr 0x1815c8f70, size 0x40, virtual false, abstract: false, final false
