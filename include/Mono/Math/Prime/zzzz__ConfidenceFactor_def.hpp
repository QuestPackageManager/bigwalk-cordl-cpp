...
DEFINE_IL2CPP_CLASS(::Mono::Math::Prime::ConfidenceFactor, "Mono.Math.Prime", "ConfidenceFactor");
// Dependencies 
namespace Mono::Math::Prime {
// Is value type: true
...
static_assert(offsetof(::Mono::Math::Prime::ConfidenceFactor, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Math::Prime::ConfidenceFactor) == 0x4, "Size mismatch!");
