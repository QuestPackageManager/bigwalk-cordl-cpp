...
// Write type traits
MARK_REF_T(::Mono::Math::Prime::Generator::PrimeGeneratorBase*);
DEFINE_IL2CPP_CLASS(::Mono::Math::Prime::Generator::PrimeGeneratorBase*, "Mono.Math.Prime.Generator", "PrimeGeneratorBase");
...
/// @brief Method get_Confidence, addr 0x1802edfe0, size 0x10, virtual true, abstract: false, final false
inline ::Mono::Math::Prime::ConfidenceFactor get_Confidence() ;

/// @brief Method get_PrimalityTest, addr 0x1815bad20, size 0x120, virtual true, abstract: false, final false
inline ::Mono::Math::Prime::PrimalityTest* get_PrimalityTest() ;

/// @brief Method get_TrialDivisionBounds, addr 0x1815bae40, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::Math::Prime::Generator::PrimeGeneratorBase) == 0x10, "Size mismatch!");
