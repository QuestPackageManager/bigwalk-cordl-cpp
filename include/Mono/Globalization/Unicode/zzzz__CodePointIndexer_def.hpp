...
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::CodePointIndexer_TableRange, "Mono.Globalization.Unicode", "CodePointIndexer/TableRange");
// Dependencies 
namespace Mono::Globalization::Unicode {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1815d2630, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Globalization::Unicode::CodePointIndexer_TableRange) == 0x14, "Size mismatch!");
...
/// @brief Field ranges, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_ranges, put=__cordl_internal_set_ranges)) ::ArrayW<::Mono::Globalization::Unicode::CodePointIndexer_TableRange>  ranges;
...
/// @brief Method ToIndex, addr 0x1815c15d0, size 0x70, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::Mono::Globalization::Unicode::CodePointIndexer_TableRange> const& __cordl_internal_get_ranges() const;

constexpr ::ArrayW<::Mono::Globalization::Unicode::CodePointIndexer_TableRange>& __cordl_internal_get_ranges() ;
...
/// @brief Method .ctor, addr 0x1815c1640, size 0x110, virtual false, abstract: false, final false
...
/// @brief Field ranges, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::Mono::Globalization::Unicode::CodePointIndexer_TableRange>  ___ranges;
