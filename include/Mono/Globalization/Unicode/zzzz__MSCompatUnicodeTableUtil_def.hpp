...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::MSCompatUnicodeTableUtil*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::MSCompatUnicodeTableUtil*, "Mono.Globalization.Unicode", "MSCompatUnicodeTableUtil");
...
/// @brief Field Category, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Category, put=setStaticF_Category)) ::Mono::Globalization::Unicode::CodePointIndexer*  Category;

/// @brief Field Cjk, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Cjk, put=setStaticF_Cjk)) ::Mono::Globalization::Unicode::CodePointIndexer*  Cjk;

/// @brief Field CjkCHS, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_CjkCHS, put=setStaticF_CjkCHS)) ::Mono::Globalization::Unicode::CodePointIndexer*  CjkCHS;

/// @brief Field Ignorable, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Ignorable, put=setStaticF_Ignorable)) ::Mono::Globalization::Unicode::CodePointIndexer*  Ignorable;

/// @brief Field Level1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Level1, put=setStaticF_Level1)) ::Mono::Globalization::Unicode::CodePointIndexer*  Level1;

/// @brief Field Level2, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Level2, put=setStaticF_Level2)) ::Mono::Globalization::Unicode::CodePointIndexer*  Level2;

/// @brief Field Level3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Level3, put=setStaticF_Level3)) ::Mono::Globalization::Unicode::CodePointIndexer*  Level3;
...
static_assert(sizeof(::Mono::Globalization::Unicode::MSCompatUnicodeTableUtil) == 0x10, "Size mismatch!");
