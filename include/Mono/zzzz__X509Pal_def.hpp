...
// Write type traits
MARK_REF_T(::Mono::X509Pal*);
DEFINE_IL2CPP_CLASS(::Mono::X509Pal*, "Mono", "X509Pal");
...
public:
// Declarations
/// @brief Method get_Instance, addr 0x181b52240, size 0xa20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::X509Pal) == 0x10, "Size mismatch!");
