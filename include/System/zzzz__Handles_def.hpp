...
DEFINE_IL2CPP_CLASS(::System::Handles, "System", "Handles");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::Handles, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Handles) == 0x4, "Size mismatch!");
