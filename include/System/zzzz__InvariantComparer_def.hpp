...
/// @brief Method Compare, addr 0x181db1600, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181db1720, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
