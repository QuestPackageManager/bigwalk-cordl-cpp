...
DEFINE_IL2CPP_CLASS(::System::Uri_Check, "System", "Uri/Check");
DEFINE_IL2CPP_CLASS(::System::Uri_Flags, "System", "Uri/Flags");
...
static_assert(offsetof(::System::Uri_Flags, value__) == 0x8, "Offset mismatch!");

static_assert(sizeof(::System::Uri_Flags) == 0x8, "Size mismatch!");
...
static_assert(sizeof(::System::Uri_Offset) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Uri_Check, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method AllowIdnStatic, addr 0x181d79680, size 0x80, virtual false, abstract: false, final false
inline bool AllowIdnStatic(::System::UriParser*  syntax, ::System::Uri_Flags  flags) ;

/// @brief Method CalculateCaseInsensitiveHashCode, addr 0x181d79700, size 0x50, virtual false, abstract: false, final false
static inline int32_t CalculateCaseInsensitiveHashCode(::StringW  text) ;

/// @brief Method CheckAuthorityHelper, addr 0x181d79fe0, size 0xf50, virtual false, abstract: false, final false
inline uint16_t CheckAuthorityHelper(char16_t*  pString, uint16_t  idx, uint16_t  length, ::by_ref<::System::ParsingError>  err, ::by_ref<::System::Uri_Flags>  flags, ::System::UriParser*  syntax, ::by_ref<::StringW>  newHost) ;

/// @brief Method CheckAuthorityHelperHandleAnyHostIri, addr 0x181d79750, size 0x3b0, virtual false, abstract: false, final false
inline void CheckAuthorityHelperHandleAnyHostIri(char16_t*  pString, int32_t  startInput, int32_t  end, bool  iriParsing, bool  hasUnicode, ::System::UriParser*  syntax, ::by_ref<::System::Uri_Flags>  flags, ::by_ref<::StringW>  newHost, ::by_ref<::System::ParsingError>  err) ;

/// @brief Method CheckAuthorityHelperHandleDnsIri, addr 0x181d79b00, size 0x4e0, virtual false, abstract: false, final false
inline void CheckAuthorityHelperHandleDnsIri(char16_t*  pString, uint16_t  start, int32_t  end, int32_t  startInput, bool  iriParsing, bool  hasUnicode, ::System::UriParser*  syntax, ::StringW  userInfoString, ::by_ref<::System::Uri_Flags>  flags, ::by_ref<bool>  justNormalized, ::by_ref<::StringW>  newHost, ::by_ref<::System::ParsingError>  err) ;

/// @brief Method CheckCanonical, addr 0x181d7af30, size 0x380, virtual false, abstract: false, final false
inline ::System::Uri_Check CheckCanonical(char16_t*  str, ::by_ref<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method CheckForColonInFirstPathSegment, addr 0x181d7b2b0, size 0x80, virtual false, abstract: false, final false
static inline bool CheckForColonInFirstPathSegment(::StringW  uriString) ;

/// @brief Method CheckForConfigLoad, addr 0x181d7b330, size 0x90, virtual false, abstract: false, final false
inline bool CheckForConfigLoad(::StringW  data) ;

/// @brief Method CheckForEscapedUnreserved, addr 0x181d7b3c0, size 0xf0, virtual false, abstract: false, final false
inline bool CheckForEscapedUnreserved(::StringW  data) ;

/// @brief Method CheckForUnicode, addr 0x181d7b4b0, size 0xb0, virtual false, abstract: false, final false
inline bool CheckForUnicode(::StringW  data) ;

/// @brief Method CheckKnownSchemes, addr 0x181d7b560, size 0x5b0, virtual false, abstract: false, final false
static inline bool CheckKnownSchemes(int64_t*  lptr, uint16_t  nChars, ::by_ref<::System::UriParser*>  syntax) ;

/// @brief Method CheckSchemeName, addr 0x181d7bb10, size 0xe0, virtual false, abstract: false, final false
static inline bool CheckSchemeName(::StringW  schemeName) ;

/// @brief Method CheckSchemeSyntax, addr 0x181d7bbf0, size 0x100, virtual false, abstract: false, final false
static inline ::System::ParsingError CheckSchemeSyntax(char16_t*  ptr, uint16_t  length, ::by_ref<::System::UriParser*>  syntax) ;

/// @brief Method CombineUri, addr 0x181d7bcf0, size 0x840, virtual false, abstract: false, final false
static inline ::StringW CombineUri(::System::Uri*  basePart, ::StringW  relativePart, ::System::UriFormat  uriFormat) ;

/// @brief Method Compress, addr 0x181d7c530, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method CreateHelper, addr 0x181d7c970, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method CreateHostString, addr 0x181d7ccf0, size 0x3d0, virtual false, abstract: false, final false
inline void CreateHostString() ;

/// @brief Method CreateHostStringHelper, addr 0x181d7cb90, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method CreateThis, addr 0x181d7d2a0, size 0x120, virtual false, abstract: false, final false
inline void CreateThis(::StringW  uri, bool  dontEscape, ::System::UriKind  uriKind) ;

/// @brief Method CreateThisFromUri, addr 0x181d7d0c0, size 0x1e0, virtual false, abstract: false, final false
inline void CreateThisFromUri(::System::Uri*  otherUri) ;

/// @brief Method CreateUri, addr 0x181d7d880, size 0x1f0, virtual false, abstract: false, final false
inline void CreateUri(::System::Uri*  baseUri, ::StringW  relativeUri, bool  dontEscape) ;

/// @brief Method CreateUriInfo, addr 0x181d7d3c0, size 0x4c0, virtual false, abstract: false, final false
inline void CreateUriInfo(::System::Uri_Flags  cF) ;

/// @brief Method EnsureHostString, addr 0x181d7da70, size 0x60, virtual false, abstract: false, final false
inline void EnsureHostString(bool  allowDnsOptimization) ;

/// @brief Method EnsureParseRemaining, addr 0x181d7dad0, size 0x20, virtual false, abstract: false, final false
inline void EnsureParseRemaining() ;

/// @brief Method EnsureUriInfo, addr 0x181d7daf0, size 0x40, virtual false, abstract: false, final false
inline ::System::Uri_UriInfo* EnsureUriInfo() ;

/// @brief Method Equals, addr 0x181d7db30, size 0x590, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method EscapeUnescapeIri, addr 0x181d7e0c0, size 0x60, virtual false, abstract: false, final false
inline ::StringW EscapeUnescapeIri(::StringW  input, int32_t  start, int32_t  end, ::System::UriComponents  component) ;

/// @brief Method FindEndOfComponent, addr 0x181d7e1c0, size 0xb0, virtual false, abstract: false, final false
inline void FindEndOfComponent(::StringW  input, ::by_ref<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method FindEndOfComponent, addr 0x181d7e120, size 0xa0, virtual false, abstract: false, final false
inline void FindEndOfComponent(char16_t*  str, ::by_ref<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method FromHex, addr 0x181d7e270, size 0x60, virtual false, abstract: false, final false
static inline int32_t FromHex(char16_t  digit) ;

/// @brief Method GetCanonicalPath, addr 0x181d7e2d0, size 0x590, virtual false, abstract: false, final false
inline ::ArrayW<char16_t> GetCanonicalPath(::ArrayW<char16_t>  dest, ::by_ref<int32_t>  pos, ::System::UriFormat  formatAs) ;

/// @brief Method GetCombinedString, addr 0x181d7e860, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method GetComponents, addr 0x181d7ecc0, size 0x180, virtual false, abstract: false, final false
inline ::StringW GetComponents(::System::UriComponents  components, ::System::UriFormat  format) ;

/// @brief Method GetComponentsHelper, addr 0x181d7ea10, size 0x2b0, virtual false, abstract: false, final false
inline ::StringW GetComponentsHelper(::System::UriComponents  uriComponents, ::System::UriFormat  uriFormat) ;

/// @brief Method GetEscapedParts, addr 0x181d7ee40, size 0x100, virtual false, abstract: false, final false
inline ::StringW GetEscapedParts(::System::UriComponents  uriParts) ;

/// @brief Method GetException, addr 0x181d7ef40, size 0x100, virtual false, abstract: false, final false
static inline ::System::UriFormatException* GetException(::System::ParsingError  err) ;

/// @brief Method GetHashCode, addr 0x181d7f040, size 0x180, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHostViaCustomSyntax, addr 0x181d7f1c0, size 0x3a0, virtual false, abstract: false, final false
inline void GetHostViaCustomSyntax() ;

/// @brief Method GetLocalPath, addr 0x181d7f560, size 0x620, virtual false, abstract: false, final false
inline ::StringW GetLocalPath() ;

/// @brief Method GetObjectData, addr 0x181d7fb80, size 0x90, virtual false, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method GetParts, addr 0x181d7ecc0, size 0x180, virtual false, abstract: false, final false
inline ::StringW GetParts(::System::UriComponents  uriParts, ::System::UriFormat  formatAs) ;

/// @brief Method GetRelativeSerializationString, addr 0x181d7fc10, size 0x2a0, virtual false, abstract: false, final false
inline ::StringW GetRelativeSerializationString(::System::UriFormat  format) ;

/// @brief Method GetUnescapedParts, addr 0x181d7feb0, size 0xe0, virtual false, abstract: false, final false
inline ::StringW GetUnescapedParts(::System::UriComponents  uriParts, ::System::UriFormat  formatAs) ;

/// @brief Method GetUriPartsFromUserString, addr 0x181d7ff90, size 0x580, virtual false, abstract: false, final false
inline ::StringW GetUriPartsFromUserString(::System::UriComponents  uriParts) ;

/// @brief Method InFact, addr 0x181d80510, size 0x10, virtual false, abstract: false, final false
inline bool InFact(::System::Uri_Flags  flags) ;

/// @brief Method InitializeUri, addr 0x181d806e0, size 0x780, virtual false, abstract: false, final false
inline void InitializeUri(::System::ParsingError  err, ::System::UriKind  uriKind, ::by_ref<::System::UriFormatException*>  e) ;

/// @brief Method InitializeUriConfig, addr 0x181d80520, size 0x1c0, virtual false, abstract: false, final false
static inline void InitializeUriConfig() ;

/// @brief Method InternalEscapeString, addr 0x181d80e60, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW InternalEscapeString(::StringW  rawString) ;

/// @brief Method InternalIsWellFormedOriginalString, addr 0x181d80f00, size 0x400, virtual false, abstract: false, final false
inline bool InternalIsWellFormedOriginalString() ;

/// @brief Method IriParsingStatic, addr 0x181d81300, size 0x70, virtual false, abstract: false, final false
static inline bool IriParsingStatic(::System::UriParser*  syntax) ;

/// @brief Method IsAsciiLetter, addr 0x181d813a0, size 0x20, virtual false, abstract: false, final false
static inline bool IsAsciiLetter(char16_t  character) ;

/// @brief Method IsAsciiLetterOrDigit, addr 0x181d81370, size 0x30, virtual false, abstract: false, final false
static inline bool IsAsciiLetterOrDigit(char16_t  character) ;

/// @brief Method IsBaseOf, addr 0x181d81550, size 0x210, virtual false, abstract: false, final false
inline bool IsBaseOf(::System::Uri*  uri) ;

/// @brief Method IsBaseOfHelper, addr 0x181d813c0, size 0x190, virtual false, abstract: false, final false
inline bool IsBaseOfHelper(::System::Uri*  uriLink) ;

/// @brief Method IsBidiControlCharacter, addr 0x181d81760, size 0x40, virtual false, abstract: false, final false
static inline bool IsBidiControlCharacter(char16_t  ch) ;

/// @brief Method IsGenDelim, addr 0x181d817a0, size 0x30, virtual false, abstract: false, final false
static inline bool IsGenDelim(char16_t  ch) ;

/// @brief Method IsHexDigit, addr 0x181d817d0, size 0x30, virtual false, abstract: false, final false
static inline bool IsHexDigit(char16_t  character) ;

/// @brief Method IsIntranet, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
inline bool IsIntranet(::StringW  schemeHost) ;

/// @brief Method IsLWS, addr 0x181d81800, size 0x30, virtual false, abstract: false, final false
static inline bool IsLWS(char16_t  ch) ;

/// @brief Method IsWellFormedOriginalString, addr 0x181d81830, size 0x50, virtual false, abstract: false, final false
inline bool IsWellFormedOriginalString() ;

/// @brief Method IsWellFormedUriString, addr 0x181d81880, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method NotAny, addr 0x181d81930, size 0x10, virtual false, abstract: false, final false
inline bool NotAny(::System::Uri_Flags  flags) ;

/// @brief Method ParseMinimal, addr 0x181d81940, size 0x40, virtual false, abstract: false, final false
inline ::System::UriFormatException* ParseMinimal() ;

/// @brief Method ParseRemaining, addr 0x181d81980, size 0xc10, virtual false, abstract: false, final false
inline void ParseRemaining() ;

/// @brief Method ParseScheme, addr 0x181d82a20, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ParseSchemeCheckImplicitFile, addr 0x181d82590, size 0x490, virtual false, abstract: false, final false
static inline uint16_t ParseSchemeCheckImplicitFile(char16_t*  uriString, uint16_t  length, ::by_ref<::System::ParsingError>  err, ::by_ref<::System::Uri_Flags>  flags, ::by_ref<::System::UriParser*>  syntax) ;

/// @brief Method PrivateParseMinimal, addr 0x181d82bc0, size 0x670, virtual false, abstract: false, final false
inline ::System::ParsingError PrivateParseMinimal() ;

/// @brief Method PrivateParseMinimalIri, addr 0x181d82ab0, size 0x110, virtual false, abstract: false, final false
inline void PrivateParseMinimalIri(::StringW  newHost, uint16_t  idx) ;

/// @brief Method ReCreateParts, addr 0x181d83230, size 0xb70, virtual false, abstract: false, final false
inline ::StringW ReCreateParts(::System::UriComponents  parts, uint16_t  nonCanonical, ::System::UriFormat  formatAs) ;

/// @brief Method ResolveHelper, addr 0x181d83da0, size 0x420, virtual false, abstract: false, final false
...
/// @brief Method SetUserDrivenParsing, addr 0x181d841c0, size 0x20, virtual false, abstract: false, final false
inline void SetUserDrivenParsing() ;

/// @brief Method StaticInFact, addr 0x181d841e0, size 0x10, virtual false, abstract: false, final false
static inline bool StaticInFact(::System::Uri_Flags  allFlags, ::System::Uri_Flags  checkFlags) ;

/// @brief Method StaticIsFile, addr 0x181d841f0, size 0x10, virtual false, abstract: false, final false
static inline bool StaticIsFile(::System::UriParser*  syntax) ;

/// @brief Method StaticNotAny, addr 0x181d84200, size 0x10, virtual false, abstract: false, final false
static inline bool StaticNotAny(::System::Uri_Flags  allFlags, ::System::Uri_Flags  checkFlags) ;

/// @brief Method StripBidiControlCharacter, addr 0x181d84210, size 0xf0, virtual false, abstract: false, final false
static inline ::StringW StripBidiControlCharacter(char16_t*  strToClean, int32_t  start, int32_t  length) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x181d7fb80, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x181d84300, size 0x100, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryCreate, addr 0x181d84470, size 0x200, virtual false, abstract: false, final false
static inline bool TryCreate(::System::Uri*  baseUri, ::StringW  relativeUri, ::by_ref<::System::Uri*>  result) ;

/// @brief Method TryCreate, addr 0x181d84670, size 0x140, virtual false, abstract: false, final false
static inline bool TryCreate(::System::Uri*  baseUri, ::System::Uri*  relativeUri, ::by_ref<::System::Uri*>  result) ;

/// @brief Method TryCreate, addr 0x181d84400, size 0x70, virtual false, abstract: false, final false
static inline bool TryCreate(::StringW  uriString, ::System::UriKind  uriKind, ::by_ref<::System::Uri*>  result) ;

/// @brief Method UnescapeDataString, addr 0x181d847b0, size 0x120, virtual false, abstract: false, final false
static inline ::StringW UnescapeDataString(::StringW  stringToUnescape) ;

/// @brief Method UnescapeOnly, addr 0x181d848d0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d85200, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  baseUri, ::StringW  relativeUri) ;

/// @brief Method .ctor, addr 0x181d84f60, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  baseUri, ::System::Uri*  relativeUri) ;

/// @brief Method .ctor, addr 0x181d851c0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Uri_Flags  flags, ::System::UriParser*  uriParser, ::StringW  uri) ;

/// @brief Method .ctor, addr 0x181d85250, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method .ctor, addr 0x181d85140, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  uriString) ;

/// @brief Method .ctor, addr 0x181d84f20, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_AbsolutePath, addr 0x181d85360, size 0x90, virtual false, abstract: false, final false
inline ::StringW get_AbsolutePath() ;

/// @brief Method get_AbsoluteUri, addr 0x181d853f0, size 0xd0, virtual false, abstract: false, final false
inline ::StringW get_AbsoluteUri() ;

/// @brief Method get_AllowIdn, addr 0x181d854c0, size 0x90, virtual false, abstract: false, final false
inline bool get_AllowIdn() ;

/// @brief Method get_Authority, addr 0x181d85550, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_Authority() ;

/// @brief Method get_DnsSafeHost, addr 0x181d855a0, size 0x240, virtual false, abstract: false, final false
inline ::StringW get_DnsSafeHost() ;

/// @brief Method get_Fragment, addr 0x181d857e0, size 0xd0, virtual false, abstract: false, final false
inline ::StringW get_Fragment() ;

/// @brief Method get_HasAuthority, addr 0x181d858b0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasAuthority() ;

/// @brief Method get_Host, addr 0x181d859e0, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_Host() ;

/// @brief Method get_HostNameType, addr 0x181d858c0, size 0x110, virtual false, abstract: false, final false
inline ::System::UriHostNameType get_HostNameType() ;

/// @brief Method get_HostType, addr 0x181d859d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Uri_Flags get_HostType() ;

/// @brief Method get_InitializeLock, addr 0x181d85a30, size 0x80, virtual false, abstract: false, final false
static inline ::System::Object* get_InitializeLock() ;

/// @brief Method get_IsAbsoluteUri, addr 0x1802ed970, size 0x10, virtual false, abstract: false, final false
inline bool get_IsAbsoluteUri() ;

/// @brief Method get_IsDefaultPort, addr 0x181d85ab0, size 0xb0, virtual false, abstract: false, final false
inline bool get_IsDefaultPort() ;

/// @brief Method get_IsDosPath, addr 0x181d85b60, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDosPath() ;

/// @brief Method get_IsFile, addr 0x181d85b70, size 0x80, virtual false, abstract: false, final false
inline bool get_IsFile() ;

/// @brief Method get_IsImplicitFile, addr 0x181d85bf0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsImplicitFile() ;

/// @brief Method get_IsLoopback, addr 0x181d85c00, size 0x80, virtual false, abstract: false, final false
inline bool get_IsLoopback() ;

/// @brief Method get_IsNotAbsoluteUri, addr 0x181192b20, size 0x3f0, virtual false, abstract: false, final false
inline bool get_IsNotAbsoluteUri() ;

/// @brief Method get_IsUnc, addr 0x181d85ca0, size 0x40, virtual false, abstract: false, final false
inline bool get_IsUnc() ;

/// @brief Method get_IsUncOrDosPath, addr 0x181d85c80, size 0x10, virtual false, abstract: false, final false
inline bool get_IsUncOrDosPath() ;

/// @brief Method get_IsUncPath, addr 0x181d85c90, size 0x10, virtual false, abstract: false, final false
inline bool get_IsUncPath() ;

/// @brief Method get_LocalPath, addr 0x181d85ce0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_LocalPath() ;

/// @brief Method get_OriginalString, addr 0x181d85d80, size 0x60, virtual false, abstract: false, final false
inline ::StringW get_OriginalString() ;

/// @brief Method get_OriginalStringSwitched, addr 0x181d85d20, size 0x60, virtual false, abstract: false, final false
inline bool get_OriginalStringSwitched() ;

/// @brief Method get_PathAndQuery, addr 0x181d85de0, size 0x90, virtual false, abstract: false, final false
inline ::StringW get_PathAndQuery() ;

/// @brief Method get_Port, addr 0x181d85e70, size 0xc0, virtual false, abstract: false, final false
inline int32_t get_Port() ;

/// @brief Method get_PrivateAbsolutePath, addr 0x181d85f30, size 0xa0, virtual false, abstract: false, final false
inline ::StringW get_PrivateAbsolutePath() ;

/// @brief Method get_Query, addr 0x181d85fd0, size 0xd0, virtual false, abstract: false, final false
inline ::StringW get_Query() ;

/// @brief Method get_Scheme, addr 0x181d860a0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Scheme() ;

/// @brief Method get_SecuredPathIndex, addr 0x181d860e0, size 0x50, virtual false, abstract: false, final false
inline uint16_t get_SecuredPathIndex() ;

/// @brief Method get_Segments, addr 0x181d86130, size 0x170, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_Segments() ;

/// @brief Method get_Syntax, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::UriParser* get_Syntax() ;

/// @brief Method get_UserDrivenParsing, addr 0x181d862a0, size 0x10, virtual false, abstract: false, final false
inline bool get_UserDrivenParsing() ;

/// @brief Method get_UserEscaped, addr 0x181d862b0, size 0x10, virtual false, abstract: false, final false
inline bool get_UserEscaped() ;

/// @brief Method get_UserInfo, addr 0x181d862c0, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_UserInfo() ;

/// @brief Convert to "::System::Runtime::Serialization::ISerializable"
constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

/// @brief Method op_Equality, addr 0x181d86310, size 0x40, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Uri*  uri1, ::System::Uri*  uri2) ;

/// @brief Method op_Inequality, addr 0x181d86350, size 0x1a0, virtual false, abstract: false, final false
