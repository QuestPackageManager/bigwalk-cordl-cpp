...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpression0*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpression0*, "System.Linq.Expressions", "MethodCallExpression0");
...
/// @brief Method Rewrite, addr 0x181b020e0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpression0) == 0x18, "Size mismatch!");
