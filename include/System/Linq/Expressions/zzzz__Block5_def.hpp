...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Block5*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Block5*, "System.Linq.Expressions", "Block5");
...
/// @brief Method GetExpression, addr 0x181af5650, size 0x80, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x181af53f0, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>* GetOrMakeExpressions() ;

static inline ::System::Linq::Expressions::Block5* New_ctor(::System::Linq::Expressions::Expression*  arg0, ::System::Linq::Expressions::Expression*  arg1, ::System::Linq::Expressions::Expression*  arg2, ::System::Linq::Expressions::Expression*  arg3, ::System::Linq::Expressions::Expression*  arg4) ;

/// @brief Method Rewrite, addr 0x181af56d0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817699f0, size 0x570, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  arg0, ::System::Linq::Expressions::Expression*  arg1, ::System::Linq::Expressions::Expression*  arg2, ::System::Linq::Expressions::Expression*  arg3, ::System::Linq::Expressions::Expression*  arg4) ;

/// @brief Method get_ExpressionCount, addr 0x180908b40, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Block5) == 0x38, "Size mismatch!");
