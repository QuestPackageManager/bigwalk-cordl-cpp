...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::ScopeExpression*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::ScopeExpression*, "System.Linq.Expressions", "ScopeExpression");
...
/// @brief Field _variables, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__variables, put=__cordl_internal_set__variables)) ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>*  _variables;

/// @brief Method GetOrMakeVariables, addr 0x181b03640, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method ReuseOrValidateVariables, addr 0x181b03650, size 0x40, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>* ReuseOrValidateVariables(::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*  variables) ;
...
/// @brief Method get_VariablesList, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::ScopeExpression) == 0x18, "Size mismatch!");
