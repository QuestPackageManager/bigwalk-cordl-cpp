...
template<typename T>
static inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* ToReadOnly(::System::Collections::Generic::ArrayBuilder_1<T>  builder) ;
...
static_assert(sizeof(::System::Linq::Expressions::ArrayBuilderExtensions) == 0x10, "Size mismatch!");
