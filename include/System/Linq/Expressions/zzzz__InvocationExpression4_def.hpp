...
#include <cstdint>
CORDL_MODULE_EXPORT(InvocationExpression4)
...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InvocationExpression4*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InvocationExpression4*, "System.Linq.Expressions", "InvocationExpression4");
// Dependencies System.Linq.Expressions.InvocationExpression
namespace System::Linq::Expressions {
// Is value type: false
// CS Name: System.Linq.Expressions.InvocationExpression4
class CORDL_TYPE InvocationExpression4 : public ::System::Linq::Expressions::InvocationExpression {
public:
// Declarations
...
/// @brief Method GetArgument, addr 0x181b017f0, size 0x60, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetArgument(int32_t  index) ;

static inline ::System::Linq::Expressions::InvocationExpression4* New_ctor(::System::Linq::Expressions::Expression*  lambda, ::System::Type*  returnType, ::System::Linq::Expressions::Expression*  arg0, ::System::Linq::Expressions::Expression*  arg1, ::System::Linq::Expressions::Expression*  arg2, ::System::Linq::Expressions::Expression*  arg3) ;

/// @brief Method Rewrite, addr 0x181b01850, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b018e0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  lambda, ::System::Type*  returnType, ::System::Linq::Expressions::Expression*  arg0, ::System::Linq::Expressions::Expression*  arg1, ::System::Linq::Expressions::Expression*  arg2, ::System::Linq::Expressions::Expression*  arg3) ;

/// @brief Method get_ArgumentCount, addr 0x180309580, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ArgumentCount() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr InvocationExpression4() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "InvocationExpression4", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
InvocationExpression4(InvocationExpression4 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "InvocationExpression4", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
InvocationExpression4(InvocationExpression4 const& ) = delete;
...
static_assert(offsetof(::System::Linq::Expressions::InvocationExpression4, ____arg0) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Linq::Expressions::InvocationExpression4, ____arg1) == 0x28, "Offset mismatch!");

static_assert(offsetof(::System::Linq::Expressions::InvocationExpression4, ____arg2) == 0x30, "Offset mismatch!");

static_assert(offsetof(::System::Linq::Expressions::InvocationExpression4, ____arg3) == 0x38, "Offset mismatch!");

static_assert(sizeof(::System::Linq::Expressions::InvocationExpression4) == 0x40, "Size mismatch!");
