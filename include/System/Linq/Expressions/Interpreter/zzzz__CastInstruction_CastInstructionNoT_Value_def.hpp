...
// Write type traits
MARK_REF_T(::GlobalNamespace::CastInstructionNoT_CastInstruction_Value*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CastInstructionNoT_CastInstruction_Value*, "System.Linq.Expressions.Interpreter", "CastInstruction/CastInstructionNoT/Value");
...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x181b34600, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CastInstructionNoT_CastInstruction_Value) == 0x18, "Size mismatch!");
