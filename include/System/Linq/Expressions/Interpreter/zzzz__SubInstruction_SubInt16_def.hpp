...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubInstruction_SubInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubInstruction_SubInt16*, "System.Linq.Expressions.Interpreter", "SubInstruction/SubInt16");
...
/// @brief Method Run, addr 0x181b31720, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubInstruction_SubInt16) == 0x10, "Size mismatch!");
