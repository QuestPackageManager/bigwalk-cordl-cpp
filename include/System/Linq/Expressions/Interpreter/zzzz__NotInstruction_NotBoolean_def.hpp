...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotInstruction_NotBoolean*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotInstruction_NotBoolean*, "System.Linq.Expressions.Interpreter", "NotInstruction/NotBoolean");
...
/// @brief Method Run, addr 0x181b2c5d0, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotInstruction_NotBoolean) == 0x10, "Size mismatch!");
