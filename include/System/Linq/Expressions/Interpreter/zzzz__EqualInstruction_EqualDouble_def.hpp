...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualDouble*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualDouble");
...
/// @brief Method Run, addr 0x181af9640, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualDouble) == 0x10, "Size mismatch!");
