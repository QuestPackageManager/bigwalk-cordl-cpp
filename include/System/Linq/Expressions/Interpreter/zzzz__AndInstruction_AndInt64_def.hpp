...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndInt64*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndInt64");
...
/// @brief Method Run, addr 0x181af4f00, size 0xd0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndInt64) == 0x10, "Size mismatch!");
