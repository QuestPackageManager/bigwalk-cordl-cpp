...
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2__GetEnumeratorWorker_d__7);
...
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2__GetEnumeratorWorker_d__7, "System.Linq.Expressions.Interpreter", "HybridReferenceDictionary`2/<GetEnumeratorWorker>d__7");
...
/// @brief Field _keysAndValues, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__keysAndValues, put=__cordl_internal_set__keysAndValues)) ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  _keysAndValues;
...
constexpr ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>> const& __cordl_internal_get__keysAndValues() const;

constexpr ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>& __cordl_internal_get__keysAndValues() ;

constexpr void __cordl_internal_set__dict(::System::Collections::Generic::Dictionary_2<TKey,TValue>*  value) ;

constexpr void __cordl_internal_set__keysAndValues(::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  value) ;
...
/// @brief Field _keysAndValues, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  ____keysAndValues;
