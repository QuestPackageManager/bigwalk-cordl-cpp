...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::BranchInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::BranchInstruction*, "System.Linq.Expressions.Interpreter", "BranchInstruction");
...
/// @brief Field s_caches, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_caches, put=setStaticF_s_caches)) ::ArrayW<::ArrayW<::ArrayW<::System::Linq::Expressions::Interpreter::Instruction*>>>  s_caches;
...
/// @brief Method Run, addr 0x180303b50, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181af5e00, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181af5e10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Cache, addr 0x181af5e20, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181af5fb0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::BranchInstruction) == 0x20, "Size mismatch!");
