...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddOvfInstruction_AddOvfUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddOvfInstruction_AddOvfUInt64*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction/AddOvfUInt64");
...
/// @brief Method Run, addr 0x181af4240, size 0x180, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddOvfInstruction_AddOvfUInt64) == 0x10, "Size mismatch!");
