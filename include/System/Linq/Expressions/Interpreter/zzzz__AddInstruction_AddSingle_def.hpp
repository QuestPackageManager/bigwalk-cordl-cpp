...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddInstruction_AddSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddInstruction_AddSingle*, "System.Linq.Expressions.Interpreter", "AddInstruction/AddSingle");
...
/// @brief Method Run, addr 0x181af43c0, size 0x100, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddInstruction_AddSingle) == 0x10, "Size mismatch!");
