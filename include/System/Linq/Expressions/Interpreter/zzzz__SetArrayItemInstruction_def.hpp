...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*, "System.Linq.Expressions.Interpreter", "SetArrayItemInstruction");
...
/// @brief Method Run, addr 0x181b03840, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method get_ConsumedStack, addr 0x1802ee400, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x181b03920, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::SetArrayItemInstruction) == 0x10, "Size mismatch!");
