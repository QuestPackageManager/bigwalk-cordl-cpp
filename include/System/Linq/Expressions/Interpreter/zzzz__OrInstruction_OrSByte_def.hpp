...
// Write type traits
MARK_REF_T(::GlobalNamespace::OrInstruction_OrSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OrInstruction_OrSByte*, "System.Linq.Expressions.Interpreter", "OrInstruction/OrSByte");
...
/// @brief Method Run, addr 0x181b2f570, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OrInstruction_OrSByte) == 0x10, "Size mismatch!");
