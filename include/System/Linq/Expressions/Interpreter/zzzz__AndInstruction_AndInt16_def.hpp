...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndInt16*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndInt16");
...
/// @brief Method Run, addr 0x181af4d80, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndInt16) == 0x10, "Size mismatch!");
