...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_HasValue*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_HasValue*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/HasValue");
...
/// @brief Method Run, addr 0x181b26850, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_HasValue) == 0x10, "Size mismatch!");
