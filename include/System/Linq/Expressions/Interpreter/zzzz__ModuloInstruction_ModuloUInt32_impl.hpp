...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::ModuloInstruction_ModuloUInt32::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::ModuloInstruction_ModuloUInt32::Run)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x181b29da0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::ModuloInstruction_ModuloUInt32*>(),
                    {::i2c::class_of<::GlobalNamespace::ModuloInstruction_ModuloUInt32*>(), 8}
                ));
