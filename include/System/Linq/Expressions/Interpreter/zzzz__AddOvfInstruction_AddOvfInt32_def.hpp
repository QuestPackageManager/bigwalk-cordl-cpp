...
#include <cstdint>
CORDL_MODULE_EXPORT(AddOvfInstruction_AddOvfInt32)
...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddOvfInstruction_AddOvfInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddOvfInstruction_AddOvfInt32*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction/AddOvfInt32");
...
/// @brief Method Run, addr 0x181af3b40, size 0x1d0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddOvfInstruction_AddOvfInt32) == 0x10, "Size mismatch!");
