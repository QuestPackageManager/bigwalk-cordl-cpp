...
/// @brief Method <ValidateJump>b__9_0, addr 0x181b1fcd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AddDefinition, addr 0x181b0ece0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Define, addr 0x181b0edf0, size 0x280, virtual false, abstract: false, final false
inline void Define(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  block) ;

/// @brief Method DefinedIn, addr 0x181b0f070, size 0x60, virtual false, abstract: false, final false
inline bool DefinedIn(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  scope) ;

/// @brief Method EnsureLabel, addr 0x181b0f0d0, size 0x40, virtual false, abstract: false, final false
inline void EnsureLabel(::System::Linq::Expressions::Interpreter::LightCompiler*  compiler) ;

/// @brief Method FirstDefinition, addr 0x181b0f110, size 0xc0, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::LabelScopeInfo* FirstDefinition() ;

/// @brief Method GetLabel, addr 0x181b0f1d0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Reference, addr 0x181b0f220, size 0x80, virtual false, abstract: false, final false
inline void Reference(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  block) ;

/// @brief Method ValidateFinish, addr 0x181b0f2a0, size 0x40, virtual false, abstract: false, final false
inline void ValidateFinish() ;

/// @brief Method ValidateJump, addr 0x181b0f2e0, size 0x370, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b0f650, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::LabelTarget*  node) ;

/// @brief Method get_HasDefinitions, addr 0x1802ed970, size 0x10, virtual false, abstract: false, final false
inline bool get_HasDefinitions() ;

/// @brief Method get_HasMultipleDefinitions, addr 0x181b0f6c0, size 0x50, virtual false, abstract: false, final false
