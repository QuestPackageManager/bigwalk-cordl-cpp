...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubOvfInstruction_SubOvfUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubOvfInstruction_SubOvfUInt32*, "System.Linq.Expressions.Interpreter", "SubOvfInstruction/SubOvfUInt32");
...
/// @brief Method Run, addr 0x181b324b0, size 0x180, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubOvfInstruction_SubOvfUInt32) == 0x10, "Size mismatch!");
