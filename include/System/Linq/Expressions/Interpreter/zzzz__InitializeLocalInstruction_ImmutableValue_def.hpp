...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_ImmutableValue*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_ImmutableValue*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/ImmutableValue");
...
/// @brief Method BoxIfIndexMatches, addr 0x181b26950, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x181b269b0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b269e0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_ImmutableValue) == 0x20, "Size mismatch!");
