...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddOvfInstruction_AddOvfUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddOvfInstruction_AddOvfUInt32*, "System.Linq.Expressions.Interpreter", "AddOvfInstruction/AddOvfUInt32");
...
/// @brief Method Run, addr 0x181af40c0, size 0x180, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddOvfInstruction_AddOvfUInt32) == 0x10, "Size mismatch!");
