...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NewArrayInitInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NewArrayInitInstruction*, "System.Linq.Expressions.Interpreter", "NewArrayInitInstruction");
...
/// @brief Method Run, addr 0x181b02d40, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b02dc0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NewArrayInitInstruction) == 0x20, "Size mismatch!");
