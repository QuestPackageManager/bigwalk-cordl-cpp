...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanSingle*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanSingle");
...
/// @brief Method Run, addr 0x181b12c70, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanSingle) == 0x18, "Size mismatch!");
