...
// Write type traits
MARK_REF_T(::GlobalNamespace::OrInstruction_OrByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OrInstruction_OrByte*, "System.Linq.Expressions.Interpreter", "OrInstruction/OrByte");
...
/// @brief Method Run, addr 0x181b2eea0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OrInstruction_OrByte) == 0x10, "Size mismatch!");
