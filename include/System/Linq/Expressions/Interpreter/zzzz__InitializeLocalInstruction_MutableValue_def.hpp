...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_MutableValue*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_MutableValue*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/MutableValue");
...
/// @brief Method BoxIfIndexMatches, addr 0x181b2b900, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x181b2b960, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2b9e0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_MutableValue) == 0x20, "Size mismatch!");
