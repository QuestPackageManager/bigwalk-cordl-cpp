...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::DivInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::DivInstruction*, "System.Linq.Expressions.Interpreter", "DivInstruction");
...
/// @brief Method Create, addr 0x181af7dc0, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method get_ConsumedStack, addr 0x1802edfe0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x181af8110, size 0x10, virtual true, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr DivInstruction() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "DivInstruction", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
DivInstruction(DivInstruction && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "DivInstruction", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::DivInstruction) == 0x10, "Size mismatch!");
