...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::IncrementInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::IncrementInstruction*, "System.Linq.Expressions.Interpreter", "IncrementInstruction");
...
/// @brief Method Create, addr 0x181b09d80, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b0a0d0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::IncrementInstruction) == 0x10, "Size mismatch!");
