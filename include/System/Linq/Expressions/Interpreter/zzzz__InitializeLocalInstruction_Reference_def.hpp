...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_Reference*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_Reference*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/Reference");
...
/// @brief Method BoxIfIndexMatches, addr 0x181b30110, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x181b30130, size 0x30, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  index) ;

/// @brief Method get_InstructionName, addr 0x181b30160, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_Reference) == 0x18, "Size mismatch!");
