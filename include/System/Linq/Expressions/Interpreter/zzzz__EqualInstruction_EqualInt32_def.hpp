...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualInt32*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualInt32");
...
/// @brief Method Run, addr 0x181afa220, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualInt32) == 0x10, "Size mismatch!");
