...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*, "System.Linq.Expressions.Interpreter", "ExclusiveOrInstruction");
...
/// @brief Method Create, addr 0x181afd890, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181afdc50, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ExclusiveOrInstruction) == 0x10, "Size mismatch!");
