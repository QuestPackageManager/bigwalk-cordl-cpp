...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualSingleLiftedToNull");
...
/// @brief Method Run, addr 0x181b2da90, size 0xd0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualSingleLiftedToNull) == 0x10, "Size mismatch!");
