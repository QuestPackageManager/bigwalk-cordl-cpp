...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NewArrayBoundsInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NewArrayBoundsInstruction*, "System.Linq.Expressions.Interpreter", "NewArrayBoundsInstruction");
...
/// @brief Method Run, addr 0x181b02ae0, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b02bc0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NewArrayBoundsInstruction) == 0x20, "Size mismatch!");
