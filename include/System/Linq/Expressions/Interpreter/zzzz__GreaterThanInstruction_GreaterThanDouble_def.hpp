...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanInstruction_GreaterThanDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanInstruction_GreaterThanDouble*, "System.Linq.Expressions.Interpreter", "GreaterThanInstruction/GreaterThanDouble");
...
/// @brief Method Run, addr 0x181b07320, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GreaterThanInstruction_GreaterThanDouble) == 0x18, "Size mismatch!");
