...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualUInt32*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualUInt32");
...
/// @brief Method Run, addr 0x181b2de40, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualUInt32) == 0x10, "Size mismatch!");
