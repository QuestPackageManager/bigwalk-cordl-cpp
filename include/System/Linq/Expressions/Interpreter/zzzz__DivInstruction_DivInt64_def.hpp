...
// Write type traits
MARK_REF_T(::GlobalNamespace::DivInstruction_DivInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DivInstruction_DivInt64*, "System.Linq.Expressions.Interpreter", "DivInstruction/DivInt64");
...
/// @brief Method Run, addr 0x181af8300, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DivInstruction_DivInt64) == 0x10, "Size mismatch!");
