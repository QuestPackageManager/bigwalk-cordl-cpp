...
// Write type traits
MARK_REF_T(::GlobalNamespace::IncrementInstruction_IncrementUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IncrementInstruction_IncrementUInt64*, "System.Linq.Expressions.Interpreter", "IncrementInstruction/IncrementUInt64");
...
/// @brief Method Run, addr 0x181b0a570, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IncrementInstruction_IncrementUInt64) == 0x10, "Size mismatch!");
