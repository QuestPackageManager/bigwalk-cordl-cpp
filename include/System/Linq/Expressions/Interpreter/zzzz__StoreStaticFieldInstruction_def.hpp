...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::StoreStaticFieldInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::StoreStaticFieldInstruction*, "System.Linq.Expressions.Interpreter", "StoreStaticFieldInstruction");
...
/// @brief Method Run, addr 0x181b1f770, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b1f7b0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::StoreStaticFieldInstruction) == 0x18, "Size mismatch!");
