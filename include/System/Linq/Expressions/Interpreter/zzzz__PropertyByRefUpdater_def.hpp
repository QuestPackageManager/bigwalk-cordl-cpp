...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::PropertyByRefUpdater*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::PropertyByRefUpdater*, "System.Linq.Expressions.Interpreter", "PropertyByRefUpdater");
...
static inline ::System::Linq::Expressions::Interpreter::PropertyByRefUpdater* New_ctor(::System::Nullable_1<::System::Linq::Expressions::Interpreter::LocalDefinition>  obj, ::System::Reflection::PropertyInfo*  property, int32_t  argumentIndex) ;

/// @brief Method UndefineTemps, addr 0x181b265a0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x181b2fa90, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b26680, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::PropertyByRefUpdater) == 0x38, "Size mismatch!");
