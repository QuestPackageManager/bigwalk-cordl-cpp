...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanDouble*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanDouble");
...
/// @brief Method Run, addr 0x181b10620, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanDouble) == 0x18, "Size mismatch!");
