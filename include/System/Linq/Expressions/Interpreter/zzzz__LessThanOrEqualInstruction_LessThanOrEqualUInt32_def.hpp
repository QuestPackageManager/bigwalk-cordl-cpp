...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualUInt32*, "System.Linq.Expressions.Interpreter", "LessThanOrEqualInstruction/LessThanOrEqualUInt32");
...
/// @brief Method Run, addr 0x181b129d0, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualUInt32) == 0x18, "Size mismatch!");
