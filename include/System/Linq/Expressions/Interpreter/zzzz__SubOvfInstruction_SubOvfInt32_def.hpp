...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubOvfInstruction_SubOvfInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubOvfInstruction_SubOvfInt32*, "System.Linq.Expressions.Interpreter", "SubOvfInstruction/SubOvfInt32");
...
/// @brief Method Run, addr 0x181b31ee0, size 0x1d0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubOvfInstruction_SubOvfInt32) == 0x10, "Size mismatch!");
