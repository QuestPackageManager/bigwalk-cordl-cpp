...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulOvfInstruction_MulOvfUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulOvfInstruction_MulOvfUInt16*, "System.Linq.Expressions.Interpreter", "MulOvfInstruction/MulOvfUInt16");
...
/// @brief Method Run, addr 0x181b2af30, size 0x240, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MulOvfInstruction_MulOvfUInt16) == 0x10, "Size mismatch!");
