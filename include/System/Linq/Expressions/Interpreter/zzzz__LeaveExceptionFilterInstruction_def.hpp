...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LeaveExceptionFilterInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LeaveExceptionFilterInstruction*, "System.Linq.Expressions.Interpreter", "LeaveExceptionFilterInstruction");
...
/// @brief Method get_InstructionName, addr 0x181b01ce0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LeaveExceptionFilterInstruction) == 0x10, "Size mismatch!");
