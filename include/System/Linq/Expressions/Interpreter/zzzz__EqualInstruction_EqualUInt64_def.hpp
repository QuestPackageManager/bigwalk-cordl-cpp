...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualUInt64*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualUInt64");
...
/// @brief Method Run, addr 0x181afab20, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualUInt64) == 0x10, "Size mismatch!");
