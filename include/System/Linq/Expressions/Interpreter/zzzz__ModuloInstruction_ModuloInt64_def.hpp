...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModuloInstruction_ModuloInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModuloInstruction_ModuloInt64*, "System.Linq.Expressions.Interpreter", "ModuloInstruction/ModuloInt64");
...
/// @brief Method Run, addr 0x181b29ac0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ModuloInstruction_ModuloInt64) == 0x10, "Size mismatch!");
