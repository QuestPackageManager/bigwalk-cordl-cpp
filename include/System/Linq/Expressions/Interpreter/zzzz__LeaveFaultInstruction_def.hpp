...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LeaveFaultInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LeaveFaultInstruction*, "System.Linq.Expressions.Interpreter", "LeaveFaultInstruction");
...
/// @brief Method Run, addr 0x181b01e30, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b01e90, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LeaveFaultInstruction) == 0x10, "Size mismatch!");
