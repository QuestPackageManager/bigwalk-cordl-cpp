...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle*, "System.Linq.Expressions.Interpreter", "LessThanOrEqualInstruction/LessThanOrEqualSingle");
// Dependencies System.Linq.Expressions.Interpreter.LessThanOrEqualInstruction
namespace GlobalNamespace {
// Is value type: false
// CS Name: System.Linq.Expressions.Interpreter.LessThanOrEqualInstruction/LessThanOrEqualSingle
class CORDL_TYPE LessThanOrEqualInstruction_LessThanOrEqualSingle : public ::System::Linq::Expressions::Interpreter::LessThanOrEqualInstruction {
public:
// Declarations
static inline ::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle* New_ctor(::System::Object*  nullValue) ;

/// @brief Method Run, addr 0x181b12800, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSingle) == 0x18, "Size mismatch!");
