...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulOvfInstruction_MulOvfInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulOvfInstruction_MulOvfInt32*, "System.Linq.Expressions.Interpreter", "MulOvfInstruction/MulOvfInt32");
...
/// @brief Method Run, addr 0x181b2aba0, size 0x1d0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MulOvfInstruction_MulOvfInt32) == 0x10, "Size mismatch!");
