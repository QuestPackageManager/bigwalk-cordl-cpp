...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndBoolean*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndBoolean*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndBoolean");
...
/// @brief Method Run, addr 0x181af4790, size 0x160, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndBoolean) == 0x10, "Size mismatch!");
