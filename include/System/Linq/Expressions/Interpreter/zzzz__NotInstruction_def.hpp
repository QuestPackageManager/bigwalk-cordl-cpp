...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NotInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NotInstruction*, "System.Linq.Expressions.Interpreter", "NotInstruction");
...
/// @brief Method Create, addr 0x181b2e060, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2e420, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NotInstruction) == 0x10, "Size mismatch!");
