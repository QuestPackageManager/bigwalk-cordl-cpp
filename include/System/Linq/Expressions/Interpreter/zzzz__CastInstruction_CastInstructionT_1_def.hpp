...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::CastInstruction_CastInstructionT_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::CastInstruction_CastInstructionT_1, "System.Linq.Expressions.Interpreter", "CastInstruction/CastInstructionT`1");
