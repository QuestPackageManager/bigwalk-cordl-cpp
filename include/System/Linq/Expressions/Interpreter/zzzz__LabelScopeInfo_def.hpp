...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LabelScopeInfo*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LabelScopeInfo*, "System.Linq.Expressions.Interpreter", "LabelScopeInfo");
...
/// @brief Field _labels, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__labels, put=__cordl_internal_set__labels)) ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::LabelTarget*,::System::Linq::Expressions::Interpreter::LabelInfo*>*  _labels;

/// @brief Method AddLabelInfo, addr 0x181b0f710, size 0x60, virtual false, abstract: false, final false
inline void AddLabelInfo(::System::Linq::Expressions::LabelTarget*  target, ::System::Linq::Expressions::Interpreter::LabelInfo*  info) ;

/// @brief Method ContainsTarget, addr 0x181b0f770, size 0x20, virtual false, abstract: false, final false
inline bool ContainsTarget(::System::Linq::Expressions::LabelTarget*  target) ;

static inline ::System::Linq::Expressions::Interpreter::LabelScopeInfo* New_ctor(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  parent, ::System::Linq::Expressions::Interpreter::LabelScopeKind  kind) ;

/// @brief Method TryGetLabelInfo, addr 0x181b0f790, size 0x40, virtual false, abstract: false, final false
inline bool TryGetLabelInfo(::System::Linq::Expressions::LabelTarget*  target, ::by_ref<::System::Linq::Expressions::Interpreter::LabelInfo*>  info) ;
...
constexpr ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::LabelTarget*,::System::Linq::Expressions::Interpreter::LabelInfo*>* const& __cordl_internal_get__labels() const;

constexpr ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::LabelTarget*,::System::Linq::Expressions::Interpreter::LabelInfo*>*& __cordl_internal_get__labels() ;
...
constexpr void __cordl_internal_set__labels(::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::LabelTarget*,::System::Linq::Expressions::Interpreter::LabelInfo*>*  value) ;

/// @brief Method .ctor, addr 0x181b0f7d0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_CanJumpInto, addr 0x181b0f800, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LabelScopeInfo) == 0x28, "Size mismatch!");
