...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualBooleanLiftedToNull");
...
/// @brief Method Run, addr 0x181af9120, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualBooleanLiftedToNull) == 0x10, "Size mismatch!");
