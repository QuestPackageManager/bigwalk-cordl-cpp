...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::Interpreter*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::Interpreter*, "System.Linq.Expressions.Interpreter", "Interpreter");
// Dependencies System.Linq.Expressions.Interpreter.DebugInfo, System.Linq.Expressions.Interpreter.InstructionArray, System.Linq.Expressions.Interpreter.RuntimeLabel, System.Object
namespace System::Linq::Expressions::Interpreter {
// Is value type: false
...
/// @brief Field <ClosureVariables>k__BackingField, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__ClosureVariables_k__BackingField, put=__cordl_internal_set__ClosureVariables_k__BackingField)) ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  _ClosureVariables_k__BackingField;
...
/// @brief Field _debugInfos, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__debugInfos, put=__cordl_internal_set__debugInfos)) ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*>  _debugInfos;
...
/// @brief Field _labels, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__labels, put=__cordl_internal_set__labels)) ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>  _labels;

/// @brief Field _objects, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__objects, put=__cordl_internal_set__objects)) ::ArrayW<::System::Object*>  _objects;

static inline ::System::Linq::Expressions::Interpreter::Interpreter* New_ctor(::StringW  name, ::System::Linq::Expressions::Interpreter::LocalVariables*  locals, ::System::Linq::Expressions::Interpreter::InstructionArray  instructions, ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*>  debugInfos) ;

/// @brief Method Run, addr 0x181b0eb70, size 0x60, virtual false, abstract: false, final false
inline void Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>* const& __cordl_internal_get__ClosureVariables_k__BackingField() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*& __cordl_internal_get__ClosureVariables_k__BackingField() ;
...
constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*> const& __cordl_internal_get__debugInfos() const;

constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*>& __cordl_internal_get__debugInfos() ;
...
constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel> const& __cordl_internal_get__labels() const;

constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>& __cordl_internal_get__labels() ;

constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get__objects() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get__objects() ;

constexpr void __cordl_internal_set__ClosureVariables_k__BackingField(::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  value) ;

constexpr void __cordl_internal_set__LocalCount_k__BackingField(int32_t  value) ;

constexpr void __cordl_internal_set__Name_k__BackingField(::StringW  value) ;

constexpr void __cordl_internal_set__debugInfos(::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*>  value) ;

constexpr void __cordl_internal_set__instructions(::System::Linq::Expressions::Interpreter::InstructionArray  value) ;

constexpr void __cordl_internal_set__labels(::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>  value) ;

constexpr void __cordl_internal_set__objects(::ArrayW<::System::Object*>  value) ;

/// @brief Method .ctor, addr 0x181b0ec10, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Linq::Expressions::Interpreter::LocalVariables*  locals, ::System::Linq::Expressions::Interpreter::InstructionArray  instructions, ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*>  debugInfos) ;

static inline ::System::Object* getStaticF_NoValue() ;

/// @brief Method get_ClosureSize, addr 0x181b0ecc0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_ClosureSize() ;

/// @brief Method get_ClosureVariables, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Instructions, addr 0x18035c980, size 0x20, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::InstructionArray get_Instructions() ;

/// @brief Method get_LocalCount, addr 0x1802e0b20, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LocalCount() ;

/// @brief Method get_Name, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _objects, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ____objects;

/// @brief Field _labels, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>  ____labels;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::Interpreter) == 0x68, "Size mismatch!");
