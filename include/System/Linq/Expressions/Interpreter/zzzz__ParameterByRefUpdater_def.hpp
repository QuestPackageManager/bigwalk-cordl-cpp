...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ParameterByRefUpdater*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ParameterByRefUpdater*, "System.Linq.Expressions.Interpreter", "ParameterByRefUpdater");
...
/// @brief Method Update, addr 0x181b2f900, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b2f9d0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ParameterByRefUpdater) == 0x20, "Size mismatch!");
