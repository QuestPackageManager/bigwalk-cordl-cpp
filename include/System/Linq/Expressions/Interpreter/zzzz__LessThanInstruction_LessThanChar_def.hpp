...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanChar*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanChar*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanChar");
...
/// @brief Method Run, addr 0x181b10540, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanChar) == 0x18, "Size mismatch!");
