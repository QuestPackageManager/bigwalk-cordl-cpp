...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualInt16LiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualInt16LiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualInt16LiftedToNull");
...
/// @brief Method Run, addr 0x181b2d490, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualInt16LiftedToNull) == 0x10, "Size mismatch!");
