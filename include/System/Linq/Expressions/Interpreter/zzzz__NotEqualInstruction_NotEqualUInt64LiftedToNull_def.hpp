...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualUInt64LiftedToNull");
...
/// @brief Method Run, addr 0x181b2def0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64LiftedToNull) == 0x10, "Size mismatch!");
