...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_MutableBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_MutableBox*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/MutableBox");
...
/// @brief Method Run, addr 0x181b2b840, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2b8f0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_MutableBox) == 0x20, "Size mismatch!");
