...
// Write type traits
MARK_REF_T(::GlobalNamespace::OrInstruction_OrUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OrInstruction_OrUInt16*, "System.Linq.Expressions.Interpreter", "OrInstruction/OrUInt16");
...
/// @brief Method Run, addr 0x181b2f630, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OrInstruction_OrUInt16) == 0x10, "Size mismatch!");
