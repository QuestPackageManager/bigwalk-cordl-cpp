...
/// @brief Method Run, addr 0x181af8f30, size 0x1e0, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method SetTryHandler, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Handler, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::TryFaultHandler* get_Handler() ;

/// @brief Method get_InstructionName, addr 0x181af9110, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedContinuations, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
