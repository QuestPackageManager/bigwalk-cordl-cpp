...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualDouble*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualDouble");
...
/// @brief Method Run, addr 0x181b2cb10, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualDouble) == 0x10, "Size mismatch!");
