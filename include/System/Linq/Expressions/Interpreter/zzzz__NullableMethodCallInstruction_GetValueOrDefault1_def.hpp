...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/GetValueOrDefault1");
...
/// @brief Method Run, addr 0x181b26720, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault1) == 0x10, "Size mismatch!");
