...
// Write type traits
MARK_REF_T(::GlobalNamespace::AndInstruction_AndUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AndInstruction_AndUInt16*, "System.Linq.Expressions.Interpreter", "AndInstruction/AndUInt16");
...
/// @brief Method Run, addr 0x181af5090, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AndInstruction_AndUInt16) == 0x10, "Size mismatch!");
