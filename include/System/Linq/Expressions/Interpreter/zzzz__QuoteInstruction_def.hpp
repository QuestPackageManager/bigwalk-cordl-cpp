...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::QuoteInstruction*);
MARK_REF_T(::System::Linq::Expressions::Interpreter::QuoteInstruction_ExpressionQuoter*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::QuoteInstruction*, "System.Linq.Expressions.Interpreter", "QuoteInstruction");
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::QuoteInstruction_ExpressionQuoter*, "System.Linq.Expressions.Interpreter", "QuoteInstruction/ExpressionQuoter");
...
/// @brief Field _shadowedVars, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__shadowedVars, put=__cordl_internal_set__shadowedVars)) ::System::Collections::Generic::Stack_1<::System::Collections::Generic::HashSet_1<::System::Linq::Expressions::ParameterExpression*>*>*  _shadowedVars;

/// @brief Field _variables, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__variables, put=__cordl_internal_set__variables)) ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  _variables;

/// @brief Method GetBox, addr 0x181b26150, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method VisitBlock, addr 0x181b26210, size 0x110, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* VisitBlock(::System::Linq::Expressions::BlockExpression*  node) ;

/// @brief Method VisitCatchBlock, addr 0x181b26320, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method VisitParameter, addr 0x181b26420, size 0x100, virtual true, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>* const& __cordl_internal_get__variables() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*& __cordl_internal_get__variables() ;
...
constexpr void __cordl_internal_set__variables(::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  value) ;

/// @brief Method .ctor, addr 0x181b26520, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  hoistedVariables, ::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::QuoteInstruction_ExpressionQuoter) == 0x28, "Size mismatch!");
...
/// @brief Field _hoistedVariables, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__hoistedVariables, put=__cordl_internal_set__hoistedVariables)) ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  _hoistedVariables;
...
static inline ::System::Linq::Expressions::Interpreter::QuoteInstruction* New_ctor(::System::Linq::Expressions::Expression*  operand, ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  hoistedVariables) ;

/// @brief Method Run, addr 0x181b2faf0, size 0xe0, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>* const& __cordl_internal_get__hoistedVariables() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*& __cordl_internal_get__hoistedVariables() ;
...
constexpr void __cordl_internal_set__hoistedVariables(::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  value) ;
...
inline void _ctor(::System::Linq::Expressions::Expression*  operand, ::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*  hoistedVariables) ;

/// @brief Method get_InstructionName, addr 0x181b2fbd0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::QuoteInstruction) == 0x20, "Size mismatch!");
