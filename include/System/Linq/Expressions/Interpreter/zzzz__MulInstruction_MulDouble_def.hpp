...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulInstruction_MulDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulInstruction_MulDouble*, "System.Linq.Expressions.Interpreter", "MulInstruction/MulDouble");
...
/// @brief Method Run, addr 0x181b29f80, size 0x100, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MulInstruction_MulDouble) == 0x10, "Size mismatch!");
