...
// Write type traits
MARK_REF_T(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt64*, "System.Linq.Expressions.Interpreter", "ExclusiveOrInstruction/ExclusiveOrUInt64");
...
/// @brief Method Run, addr 0x181b06fb0, size 0x130, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrUInt64) == 0x10, "Size mismatch!");
