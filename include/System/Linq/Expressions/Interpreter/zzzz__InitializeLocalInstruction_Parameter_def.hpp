...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_Parameter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_Parameter*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/Parameter");
...
/// @brief Method BoxIfIndexMatches, addr 0x181b2f9f0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_InstructionName, addr 0x181b2fa10, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_Parameter) == 0x18, "Size mismatch!");
