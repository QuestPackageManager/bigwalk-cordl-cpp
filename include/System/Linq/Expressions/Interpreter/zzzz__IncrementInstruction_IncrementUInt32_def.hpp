...
// Write type traits
MARK_REF_T(::GlobalNamespace::IncrementInstruction_IncrementUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IncrementInstruction_IncrementUInt32*, "System.Linq.Expressions.Interpreter", "IncrementInstruction/IncrementUInt32");
...
/// @brief Method Run, addr 0x181b0a4c0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IncrementInstruction_IncrementUInt32) == 0x10, "Size mismatch!");
