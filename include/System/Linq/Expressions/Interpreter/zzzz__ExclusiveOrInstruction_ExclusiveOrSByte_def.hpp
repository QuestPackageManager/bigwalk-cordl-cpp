...
// Write type traits
MARK_REF_T(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrSByte*, "System.Linq.Expressions.Interpreter", "ExclusiveOrInstruction/ExclusiveOrSByte");
...
/// @brief Method Run, addr 0x181afdea0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ExclusiveOrInstruction_ExclusiveOrSByte) == 0x10, "Size mismatch!");
