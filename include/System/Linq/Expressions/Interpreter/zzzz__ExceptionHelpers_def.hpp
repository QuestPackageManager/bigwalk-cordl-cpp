...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ExceptionHelpers*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ExceptionHelpers*, "System.Linq.Expressions.Interpreter", "ExceptionHelpers");
...
public:
// Declarations
/// @brief Method UnwrapAndRethrow, addr 0x181b24520, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ExceptionHelpers) == 0x10, "Size mismatch!");
