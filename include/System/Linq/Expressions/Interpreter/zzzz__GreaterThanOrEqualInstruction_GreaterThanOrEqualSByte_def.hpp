...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte*, "System.Linq.Expressions.Interpreter", "GreaterThanOrEqualInstruction/GreaterThanOrEqualSByte");
...
/// @brief Method Run, addr 0x181b09400, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualSByte) == 0x18, "Size mismatch!");
