...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::GetArrayItemInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::GetArrayItemInstruction*, "System.Linq.Expressions.Interpreter", "GetArrayItemInstruction");
...
/// @brief Method Run, addr 0x181b00cb0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b00d90, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::GetArrayItemInstruction) == 0x10, "Size mismatch!");
