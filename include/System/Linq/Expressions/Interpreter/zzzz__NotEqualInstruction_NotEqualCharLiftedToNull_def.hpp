...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualCharLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualCharLiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualCharLiftedToNull");
...
/// @brief Method Run, addr 0x181b2c8d0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualCharLiftedToNull) == 0x10, "Size mismatch!");
