...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::SubOvfInstruction_SubOvfUInt16::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::SubOvfInstruction_SubOvfUInt16::Run)> {
  constexpr static std::size_t size = 0x260;
  constexpr static std::size_t addrs = 0x181b32250;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::SubOvfInstruction_SubOvfUInt16*>(),
                    {::i2c::class_of<::GlobalNamespace::SubOvfInstruction_SubOvfUInt16*>(), 8}
                ));
