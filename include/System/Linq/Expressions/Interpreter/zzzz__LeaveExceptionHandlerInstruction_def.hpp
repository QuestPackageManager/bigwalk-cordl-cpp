...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*, "System.Linq.Expressions.Interpreter", "LeaveExceptionHandlerInstruction");
...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*>  s_cache;

/// @brief Method Create, addr 0x181b01cf0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x181b01da0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181af8f00, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  labelIndex, bool  hasValue) ;

static inline ::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*> getStaticF_s_cache() ;

/// @brief Method get_ConsumedStack, addr 0x181af5fc0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x181b01e20, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x181af5fc0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ProducedStack() ;

static inline void setStaticF_s_cache(::ArrayW<::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction*>  value) ;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LeaveExceptionHandlerInstruction) == 0x20, "Size mismatch!");
