...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_ImmutableBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_ImmutableBox*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/ImmutableBox");
...
/// @brief Method Run, addr 0x181b26880, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_ImmutableBox) == 0x20, "Size mismatch!");
