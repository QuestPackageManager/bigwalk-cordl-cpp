...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualInt16*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualInt16");
...
/// @brief Method Run, addr 0x181b2d550, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualInt16) == 0x10, "Size mismatch!");
