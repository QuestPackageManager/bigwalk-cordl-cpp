...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::MulOvfInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::MulOvfInstruction*, "System.Linq.Expressions.Interpreter", "MulOvfInstruction");
...
/// @brief Method Create, addr 0x181b2a6a0, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2a930, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::MulOvfInstruction) == 0x10, "Size mismatch!");
