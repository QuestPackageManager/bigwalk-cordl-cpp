...
// Write type traits
MARK_REF_T(::GlobalNamespace::CastInstructionNoT_CastInstruction_Ref*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CastInstructionNoT_CastInstruction_Ref*, "System.Linq.Expressions.Interpreter", "CastInstruction/CastInstructionNoT/Ref");
...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x181b30100, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CastInstructionNoT_CastInstruction_Ref) == 0x18, "Size mismatch!");
