...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::MulOvfInstruction_MulOvfUInt32::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::MulOvfInstruction_MulOvfUInt32::Run)> {
  constexpr static std::size_t size = 0x180;
  constexpr static std::size_t addrs = 0x181b2b170;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::MulOvfInstruction_MulOvfUInt32*>(),
                    {::i2c::class_of<::GlobalNamespace::MulOvfInstruction_MulOvfUInt32*>(), 8}
                ));
