...
// Write type traits
MARK_REF_T(::GlobalNamespace::DivInstruction_DivSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DivInstruction_DivSingle*, "System.Linq.Expressions.Interpreter", "DivInstruction/DivSingle");
...
/// @brief Method Run, addr 0x181af83f0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DivInstruction_DivSingle) == 0x10, "Size mismatch!");
