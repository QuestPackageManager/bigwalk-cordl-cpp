...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LightDelegateCreator*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LightDelegateCreator*, "System.Linq.Expressions.Interpreter", "LightDelegateCreator");
...
/// @brief Field <Interpreter>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Interpreter_k__BackingField, put=__cordl_internal_set__Interpreter_k__BackingField)) ::System::Linq::Expressions::Interpreter::Interpreter*  _Interpreter_k__BackingField;
...
/// @brief Method CreateDelegate, addr 0x181b273e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Delegate* CreateDelegate() ;

/// @brief Method CreateDelegate, addr 0x181b273f0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Delegate* CreateDelegate(::ArrayW<::System::Runtime::CompilerServices::IStrongBox*>  closure) ;

static inline ::System::Linq::Expressions::Interpreter::LightDelegateCreator* New_ctor(::System::Linq::Expressions::Interpreter::Interpreter*  interpreter, ::System::Linq::Expressions::LambdaExpression*  lambda) ;
...
/// @brief Method get_Interpreter, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LightDelegateCreator) == 0x20, "Size mismatch!");
