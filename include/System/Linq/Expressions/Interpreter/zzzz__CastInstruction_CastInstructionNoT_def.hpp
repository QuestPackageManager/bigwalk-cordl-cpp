...
// Write type traits
MARK_REF_T(::GlobalNamespace::CastInstruction_CastInstructionNoT*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CastInstruction_CastInstructionNoT*, "System.Linq.Expressions.Interpreter", "CastInstruction/CastInstructionNoT");
...
/// @brief Method Create, addr 0x181b20950, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x181b209b0, size 0x120, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CastInstruction_CastInstructionNoT) == 0x18, "Size mismatch!");
