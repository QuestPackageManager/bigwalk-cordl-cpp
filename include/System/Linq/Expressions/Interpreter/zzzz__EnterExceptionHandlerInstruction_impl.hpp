...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::*)(bool)>(&::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1803924a0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::*)()>(&::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::get_InstructionName)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x181af88b0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::*)()>(&::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::get_ConsumedStack)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::*)()>(&::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::get_ProducedStack)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction::Run)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1802edd00;
...
::cordl_internals::setStaticField<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*, "Void", ::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>(std::forward<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*, "Void", ::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>();
}
...
::cordl_internals::setStaticField<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*, "NonVoid", ::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>(std::forward<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*, "NonVoid", ::System::Linq::Expressions::Interpreter::EnterExceptionHandlerInstruction*>();
}
