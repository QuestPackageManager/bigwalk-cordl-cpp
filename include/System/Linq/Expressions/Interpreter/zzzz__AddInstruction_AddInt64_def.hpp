...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddInstruction_AddInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddInstruction_AddInt64*, "System.Linq.Expressions.Interpreter", "AddInstruction/AddInt64");
...
/// @brief Method Run, addr 0x181af3550, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddInstruction_AddInt64) == 0x10, "Size mismatch!");
