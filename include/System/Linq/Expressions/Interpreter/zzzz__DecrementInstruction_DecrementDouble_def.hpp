...
// Write type traits
MARK_REF_T(::GlobalNamespace::DecrementInstruction_DecrementDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DecrementInstruction_DecrementDouble*, "System.Linq.Expressions.Interpreter", "DecrementInstruction/DecrementDouble");
...
/// @brief Method Run, addr 0x181af7500, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DecrementInstruction_DecrementDouble) == 0x10, "Size mismatch!");
