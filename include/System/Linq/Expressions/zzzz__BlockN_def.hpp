...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::BlockN*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::BlockN*, "System.Linq.Expressions", "BlockN");
...
/// @brief Field _expressions, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__expressions, put=__cordl_internal_set__expressions)) ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>*  _expressions;

/// @brief Method GetExpression, addr 0x181af5c80, size 0x20, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x181af5ca0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x181af5cb0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x181af5cf0, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::BlockN) == 0x18, "Size mismatch!");
