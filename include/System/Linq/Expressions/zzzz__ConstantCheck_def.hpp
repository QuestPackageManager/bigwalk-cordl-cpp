...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::ConstantCheck*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::ConstantCheck*, "System.Linq.Expressions", "ConstantCheck");
...
public:
// Declarations
/// @brief Method AnalyzeTypeIs, addr 0x181af72f0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method AnalyzeTypeIs, addr 0x181af71a0, size 0x150, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::ConstantCheck) == 0x10, "Size mismatch!");
