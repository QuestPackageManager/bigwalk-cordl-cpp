...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Block2*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Block2*, "System.Linq.Expressions", "Block2");
...
/// @brief Method GetExpression, addr 0x181af53a0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x181af5400, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x1802edfe0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Block2) == 0x20, "Size mismatch!");
