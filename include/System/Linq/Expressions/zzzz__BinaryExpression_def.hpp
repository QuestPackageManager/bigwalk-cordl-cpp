...
/// @brief Method Accept, addr 0x181adc470, size 0x20, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

/// @brief Method GetBinaryOpFromAssignmentOp, addr 0x181adc490, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetConversion, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* GetConversion() ;

/// @brief Method GetMethod, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::MethodInfo* GetMethod() ;

/// @brief Method IsOpAssignment, addr 0x181adc590, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x181add630, size 0x80, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Reduce() ;

/// @brief Method ReduceIndex, addr 0x181adc5a0, size 0x440, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceIndex() ;

/// @brief Method ReduceMember, addr 0x181adc9e0, size 0x300, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceMember() ;

/// @brief Method ReduceUserdefinedLifted, addr 0x181adcce0, size 0x880, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceUserdefinedLifted() ;

/// @brief Method ReduceVariable, addr 0x181add560, size 0xd0, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceVariable() ;

/// @brief Method Update, addr 0x181add6b0, size 0x460, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::BinaryExpression* Update(::System::Linq::Expressions::Expression*  left, ::System::Linq::Expressions::LambdaExpression*  conversion, ::System::Linq::Expressions::Expression*  right) ;
...
/// @brief Method get_CanReduce, addr 0x181addb10, size 0x30, virtual true, abstract: false, final false
inline bool get_CanReduce() ;

/// @brief Method get_Conversion, addr 0x180303b80, size 0x20, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* get_Conversion() ;

/// @brief Method get_IsLifted, addr 0x181addd80, size 0x110, virtual false, abstract: false, final false
inline bool get_IsLifted() ;

/// @brief Method get_IsLiftedLogical, addr 0x181addb40, size 0x110, virtual false, abstract: false, final false
inline bool get_IsLiftedLogical() ;

/// @brief Method get_IsLiftedToNull, addr 0x181addc50, size 0x130, virtual false, abstract: false, final false
inline bool get_IsLiftedToNull() ;

/// @brief Method get_IsReferenceComparison, addr 0x181adde90, size 0xd0, virtual false, abstract: false, final false
inline bool get_IsReferenceComparison() ;

/// @brief Method get_Left, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Left() ;

/// @brief Method get_Method, addr 0x181163b40, size 0x20, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Method() ;

/// @brief Method get_Right, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::BinaryExpression) == 0x20, "Size mismatch!");
