...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::Expression1_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::Expression1_1, "System.Linq.Expressions", "Expression1`1");
...
static inline ::System::Linq::Expressions::Expression1_1<TDelegate>* New_ctor(::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::ParameterExpression*  par0) ;
...
inline void _ctor(::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::ParameterExpression*  par0) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr Expression1_1() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "Expression1_1", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
Expression1_1(Expression1_1 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "Expression1_1", modifiers: "const&", def_value: None }]
