...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::InvocationExpressionN*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::InvocationExpressionN*, "System.Linq.Expressions", "InvocationExpressionN");
...
/// @brief Method GetArgument, addr 0x181b01600, size 0x20, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetArgument(int32_t  index) ;

static inline ::System::Linq::Expressions::InvocationExpressionN* New_ctor(::System::Linq::Expressions::Expression*  lambda, ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>*  arguments, ::System::Type*  returnType) ;

/// @brief Method Rewrite, addr 0x181b01b20, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b01b40, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_ArgumentCount, addr 0x181b01640, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::InvocationExpressionN) == 0x28, "Size mismatch!");
