...
DEFINE_IL2CPP_GEN_CLASS(::System::Linq::Set_1_Slot, "System.Linq", "Set`1/Slot");
// Dependencies 
namespace System::Linq {
// cpp template
template<typename TElement>
...
/// @brief Field slots, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_slots, put=__cordl_internal_set_slots)) ::ArrayW<::System::Linq::Set_1_Slot<TElement>>  slots;
...
constexpr ::ArrayW<::System::Linq::Set_1_Slot<TElement>> const& __cordl_internal_get_slots() const;

constexpr ::ArrayW<::System::Linq::Set_1_Slot<TElement>>& __cordl_internal_get_slots() ;
...
constexpr void __cordl_internal_set_slots(::ArrayW<::System::Linq::Set_1_Slot<TElement>>  value) ;
...
/// @brief Field slots, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Linq::Set_1_Slot<TElement>>  ___slots;
