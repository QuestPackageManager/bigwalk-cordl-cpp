...
static_assert(offsetof(::System::Reflection::BindingFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Reflection::BindingFlags) == 0x4, "Size mismatch!");
