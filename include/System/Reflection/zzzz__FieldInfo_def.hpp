...
/// @brief Method GetFieldFromHandle, addr 0x18167a020, size 0x30, virtual false, abstract: false, final false
static inline ::System::Reflection::FieldInfo* GetFieldFromHandle(::System::RuntimeFieldHandle  handle) ;

/// @brief Method GetFieldFromHandle, addr 0x18167a050, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetFieldOffset, addr 0x18167a090, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method GetPseudoCustomAttributes, addr 0x18167a540, size 0x190, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*> GetPseudoCustomAttributes() ;

/// @brief Method GetPseudoCustomAttributesData, addr 0x18167a0e0, size 0x460, virtual false, abstract: false, final false
inline ::ArrayW<::System::Reflection::CustomAttributeData*> GetPseudoCustomAttributesData() ;

/// @brief Method GetRawConstantValue, addr 0x18167a6d0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method SetValue, addr 0x18167a6f0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method SetValueDirect, addr 0x18167a6d0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_IsInitOnly, addr 0x18167a760, size 0x30, virtual true, abstract: false, final true
inline bool get_IsInitOnly() ;

/// @brief Method get_IsLiteral, addr 0x18167a790, size 0x30, virtual true, abstract: false, final true
inline bool get_IsLiteral() ;

/// @brief Method get_IsNotSerialized, addr 0x18167a7c0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsNotSerialized() ;

/// @brief Method get_IsPrivate, addr 0x18167a7f0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsPrivate() ;

/// @brief Method get_IsPublic, addr 0x18167a820, size 0x30, virtual true, abstract: false, final true
inline bool get_IsPublic() ;

/// @brief Method get_IsStatic, addr 0x18167a850, size 0x30, virtual true, abstract: false, final true
inline bool get_IsStatic() ;

/// @brief Method get_MemberType, addr 0x180309580, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::MemberTypes get_MemberType() ;

/// @brief Method get_marshal_info, addr 0x181633260, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::InteropServices::MarshalAsAttribute* get_marshal_info() ;

/// @brief Method internal_from_handle_type, addr 0x18167a880, size 0x10, virtual false, abstract: false, final false
