...
public:
// Declarations
/// @brief Method GetTypeInfo, addr 0x18167a910, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Reflection::IntrospectionExtensions) == 0x10, "Size mismatch!");
