...
// Write type traits
MARK_REF_T(::System::Reflection::ParameterInfo*);
DEFINE_IL2CPP_CLASS(::System::Reflection::ParameterInfo*, "System.Reflection", "ParameterInfo");
...
/// @brief Method GetCustomAttributes, addr 0x18167cea0, size 0x90, virtual true, abstract: false, final false
inline ::ArrayW<::System::Object*> GetCustomAttributes(::System::Type*  attributeType, bool  inherit) ;

/// @brief Method GetCustomAttributes, addr 0x18167ce40, size 0x60, virtual true, abstract: false, final false
inline ::ArrayW<::System::Object*> GetCustomAttributes(bool  inherit) ;

/// @brief Method GetRealObject, addr 0x18167cf30, size 0x300, virtual true, abstract: false, final true
inline ::System::Object* GetRealObject(::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method IsDefined, addr 0x18167d230, size 0x30, virtual true, abstract: false, final false
inline bool IsDefined(::System::Type*  attributeType, bool  inherit) ;

static inline ::System::Reflection::ParameterInfo* New_ctor() ;

/// @brief Method ToString, addr 0x18167d260, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method get_Attributes, addr 0x180303b50, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::ParameterAttributes get_Attributes() ;

/// @brief Method get_DefaultValue, addr 0x18167c600, size 0x20, virtual true, abstract: false, final false
inline ::System::Object* get_DefaultValue() ;

/// @brief Method get_IsIn, addr 0x18167d2d0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsIn() ;

/// @brief Method get_IsOptional, addr 0x18167d2f0, size 0x30, virtual false, abstract: false, final false
inline bool get_IsOptional() ;

/// @brief Method get_IsOut, addr 0x18167d320, size 0x170, virtual false, abstract: false, final false
inline bool get_IsOut() ;

/// @brief Method get_Member, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_ParameterType, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* get_ParameterType() ;

/// @brief Method get_Position, addr 0x180392fe0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Reflection::ParameterInfo) == 0x40, "Size mismatch!");
