...
static_assert(offsetof(::System::Reflection::CallingConventions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Reflection::CallingConventions) == 0x4, "Size mismatch!");
