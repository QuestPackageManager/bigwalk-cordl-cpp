...
/// @brief Field _keyPairArray, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__keyPairArray, put=__cordl_internal_set__keyPairArray)) ::ArrayW<uint8_t>  _keyPairArray;
...
/// @brief Field _publicKey, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__publicKey, put=__cordl_internal_set__publicKey)) ::ArrayW<uint8_t>  _publicKey;
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x181684000, size 0xc0, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__keyPairArray() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__keyPairArray() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__publicKey() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__publicKey() ;

constexpr void __cordl_internal_set__keyPairArray(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x1816840c0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Field _keyPairArray, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ____keyPairArray;
...
static_assert(sizeof(::System::Reflection::StrongNameKeyPair) == 0x30, "Size mismatch!");
