...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::RegexCode*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::RegexCode*, "System.Text.RegularExpressions", "RegexCode");
...
/// @brief Field Codes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_Codes, put=__cordl_internal_set_Codes)) ::ArrayW<int32_t>  Codes;
...
static inline ::System::Text::RegularExpressions::RegexCode* New_ctor(::ArrayW<int32_t>  codes, ::System::Collections::Generic::List_1<::StringW>*  stringlist, int32_t  trackcount, ::System::Collections::Hashtable*  caps, int32_t  capsize, ::System::Text::RegularExpressions::RegexBoyerMoore*  bmPrefix, ::System::Nullable_1<::System::Text::RegularExpressions::RegexPrefix>  fcPrefix, int32_t  anchors, bool  rightToLeft) ;

/// @brief Method OpcodeBacktracks, addr 0x181dcf5b0, size 0x60, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_Codes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_Codes() ;
...
constexpr void __cordl_internal_set_Codes(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x181dcf610, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexCode) == 0x60, "Size mismatch!");
