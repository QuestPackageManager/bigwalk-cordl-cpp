...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::RegexRunner*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::RegexRunner*, "System.Text.RegularExpressions", "RegexRunner");
...
/// @brief Field runcrawl, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_runcrawl, put=__cordl_internal_set_runcrawl)) ::ArrayW<int32_t>  runcrawl;
...
/// @brief Field runstack, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_runstack, put=__cordl_internal_set_runstack)) ::ArrayW<int32_t>  runstack;
...
/// @brief Field runtrack, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_runtrack, put=__cordl_internal_set_runtrack)) ::ArrayW<int32_t>  runtrack;
...
/// @brief Method Capture, addr 0x181de27c0, size 0x80, virtual false, abstract: false, final false
inline void Capture(int32_t  capnum, int32_t  start, int32_t  end) ;

/// @brief Method CheckTimeout, addr 0x181de2840, size 0xb0, virtual false, abstract: false, final false
inline void CheckTimeout() ;

/// @brief Method Crawl, addr 0x181de28f0, size 0xa0, virtual false, abstract: false, final false
inline void Crawl(int32_t  i) ;

/// @brief Method Crawlpos, addr 0x181de2990, size 0x10, virtual false, abstract: false, final false
inline int32_t Crawlpos() ;

/// @brief Method DoCheckTimeout, addr 0x181de29a0, size 0xb0, virtual false, abstract: false, final false
inline void DoCheckTimeout() ;

/// @brief Method DoubleCrawl, addr 0x181de2a50, size 0x70, virtual false, abstract: false, final false
inline void DoubleCrawl() ;

/// @brief Method DoubleStack, addr 0x181de2ac0, size 0x70, virtual false, abstract: false, final false
inline void DoubleStack() ;

/// @brief Method DoubleTrack, addr 0x181de2b30, size 0x70, virtual false, abstract: false, final false
inline void DoubleTrack() ;

/// @brief Method EnsureStorage, addr 0x181de2ba0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method InitMatch, addr 0x181de2c80, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method IsBoundary, addr 0x181de2ec0, size 0x90, virtual false, abstract: false, final false
inline bool IsBoundary(int32_t  index, int32_t  startpos, int32_t  endpos) ;

/// @brief Method IsECMABoundary, addr 0x181de2f50, size 0x90, virtual false, abstract: false, final false
inline bool IsECMABoundary(int32_t  index, int32_t  startpos, int32_t  endpos) ;

/// @brief Method IsMatched, addr 0x181de2fe0, size 0x20, virtual false, abstract: false, final false
inline bool IsMatched(int32_t  cap) ;

/// @brief Method MatchIndex, addr 0x181de3000, size 0x20, virtual false, abstract: false, final false
inline int32_t MatchIndex(int32_t  cap) ;

/// @brief Method MatchLength, addr 0x181de3020, size 0x20, virtual false, abstract: false, final false
inline int32_t MatchLength(int32_t  cap) ;

static inline ::System::Text::RegularExpressions::RegexRunner* New_ctor() ;

/// @brief Method Popcrawl, addr 0x181de3040, size 0x20, virtual false, abstract: false, final false
inline int32_t Popcrawl() ;

/// @brief Method Scan, addr 0x181de3060, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method StartTimeoutWatch, addr 0x181de3330, size 0x30, virtual false, abstract: false, final false
inline void StartTimeoutWatch() ;

/// @brief Method TidyMatch, addr 0x181de3360, size 0x60, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* TidyMatch(bool  quick) ;

/// @brief Method TransferCapture, addr 0x181de33c0, size 0x110, virtual false, abstract: false, final false
inline void TransferCapture(int32_t  capnum, int32_t  uncapnum, int32_t  start, int32_t  end) ;

/// @brief Method Uncapture, addr 0x181de34d0, size 0x30, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_runcrawl() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_runcrawl() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_runstack() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_runstack() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_runtrack() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_runtrack() ;
...
constexpr void __cordl_internal_set_runcrawl(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_runstack(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_runtrack(::ArrayW<int32_t>  value) ;
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexRunner) == 0x80, "Size mismatch!");
