...
public:
// Declarations
/// @brief Method .ctor, addr 0x181dc8900, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping) == 0xc, "Size mismatch!");
...
/// @brief Method Compare, addr 0x181dd5910, size 0x20, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::IComparer_1<::System::Text::RegularExpressions::RegexCharClass_SingleRange>* i___System__Collections__Generic__IComparer_1___System__Text__RegularExpressions__RegexCharClass_SingleRange_() noexcept;
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexCharClass_SingleRange) == 0x4, "Size mismatch!");
...
/// @brief Field _rangelist, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__rangelist, put=__cordl_internal_set__rangelist)) ::System::Collections::Generic::List_1<::System::Text::RegularExpressions::RegexCharClass_SingleRange>*  _rangelist;
...
/// @brief Field s_lcTable, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_lcTable, put=setStaticF_s_lcTable)) ::ArrayW<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping>  s_lcTable;
...
/// @brief Method AddCategory, addr 0x181dca570, size 0x10, virtual false, abstract: false, final false
inline void AddCategory(::StringW  category) ;

/// @brief Method AddCategoryFromName, addr 0x181dca2a0, size 0x2d0, virtual false, abstract: false, final false
inline void AddCategoryFromName(::StringW  categoryName, bool  invert, bool  caseInsensitive, ::StringW  pattern) ;

/// @brief Method AddChar, addr 0x181dca690, size 0x10, virtual false, abstract: false, final false
inline void AddChar(char16_t  c) ;

/// @brief Method AddCharClass, addr 0x181dca580, size 0x110, virtual false, abstract: false, final false
inline void AddCharClass(::System::Text::RegularExpressions::RegexCharClass*  cc) ;

/// @brief Method AddDigit, addr 0x181dca6a0, size 0x50, virtual false, abstract: false, final false
inline void AddDigit(bool  ecma, bool  negate, ::StringW  pattern) ;

/// @brief Method AddLowercase, addr 0x181dca890, size 0xf0, virtual false, abstract: false, final false
inline void AddLowercase(::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddLowercaseRange, addr 0x181dca6f0, size 0x1a0, virtual false, abstract: false, final false
inline void AddLowercaseRange(char16_t  chMin, char16_t  chMax, ::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddRange, addr 0x181dca980, size 0x90, virtual false, abstract: false, final false
inline void AddRange(char16_t  first, char16_t  last) ;

/// @brief Method AddSet, addr 0x181dcaa10, size 0x160, virtual false, abstract: false, final false
inline void AddSet(::StringW  set) ;

/// @brief Method AddSpace, addr 0x181dcab70, size 0xc0, virtual false, abstract: false, final false
inline void AddSpace(bool  ecma, bool  negate) ;

/// @brief Method AddSubtraction, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void AddSubtraction(::System::Text::RegularExpressions::RegexCharClass*  sub) ;

/// @brief Method AddWord, addr 0x181dcac30, size 0xc0, virtual false, abstract: false, final false
inline void AddWord(bool  ecma, bool  negate) ;

/// @brief Method Canonicalize, addr 0x181dcacf0, size 0x190, virtual false, abstract: false, final false
inline void Canonicalize() ;

/// @brief Method CharInCategory, addr 0x181dcaf40, size 0x150, virtual false, abstract: false, final false
static inline bool CharInCategory(char16_t  ch, ::StringW  set, int32_t  start, int32_t  mySetLength, int32_t  myCategoryLength) ;

/// @brief Method CharInCategoryGroup, addr 0x181dcae80, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CharInClass, addr 0x181dcb320, size 0x10, virtual false, abstract: false, final false
static inline bool CharInClass(char16_t  ch, ::StringW  set) ;

/// @brief Method CharInClassInternal, addr 0x181dcb090, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method CharInClassRecursive, addr 0x181dcb240, size 0xe0, virtual false, abstract: false, final false
static inline bool CharInClassRecursive(char16_t  ch, ::StringW  set, int32_t  start) ;

/// @brief Method GetRangeAt, addr 0x181dcb330, size 0x20, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexCharClass_SingleRange GetRangeAt(int32_t  i) ;

/// @brief Method IsECMAWordChar, addr 0x181dcb350, size 0x20, virtual false, abstract: false, final false
static inline bool IsECMAWordChar(char16_t  ch) ;

/// @brief Method IsEmpty, addr 0x181dcb370, size 0x60, virtual false, abstract: false, final false
static inline bool IsEmpty(::StringW  charClass) ;

/// @brief Method IsMergeable, addr 0x181dcb3d0, size 0x80, virtual false, abstract: false, final false
static inline bool IsMergeable(::StringW  charClass) ;

/// @brief Method IsNegated, addr 0x181dcb450, size 0x30, virtual false, abstract: false, final false
static inline bool IsNegated(::StringW  set) ;

/// @brief Method IsSingleton, addr 0x181dcb550, size 0xc0, virtual false, abstract: false, final false
static inline bool IsSingleton(::StringW  set) ;

/// @brief Method IsSingletonInverse, addr 0x181dcb480, size 0xd0, virtual false, abstract: false, final false
static inline bool IsSingletonInverse(::StringW  set) ;

/// @brief Method IsSubtraction, addr 0x181dcb610, size 0x60, virtual false, abstract: false, final false
static inline bool IsSubtraction(::StringW  charClass) ;

/// @brief Method IsWordChar, addr 0x181dcb670, size 0x70, virtual false, abstract: false, final false
static inline bool IsWordChar(char16_t  ch) ;

/// @brief Method NegateCategory, addr 0x181dcb6e0, size 0x80, virtual false, abstract: false, final false
...
static inline ::System::Text::RegularExpressions::RegexCharClass* New_ctor(bool  negate, ::System::Collections::Generic::List_1<::System::Text::RegularExpressions::RegexCharClass_SingleRange>*  ranges, ::System::Text::StringBuilder*  categories, ::System::Text::RegularExpressions::RegexCharClass*  subtraction) ;

/// @brief Method Parse, addr 0x181dcb900, size 0x10, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* Parse(::StringW  charClass) ;

/// @brief Method ParseRecursive, addr 0x181dcb760, size 0x1a0, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* ParseRecursive(::StringW  charClass, int32_t  start) ;

/// @brief Method RangeCount, addr 0x1809d15e0, size 0x4e0, virtual false, abstract: false, final false
inline int32_t RangeCount() ;

/// @brief Method SetFromProperty, addr 0x181dcb910, size 0x170, virtual false, abstract: false, final false
static inline ::StringW SetFromProperty(::StringW  capname, bool  invert, ::StringW  pattern) ;

/// @brief Method SingletonChar, addr 0x181dcba80, size 0x10, virtual false, abstract: false, final false
static inline char16_t SingletonChar(::StringW  set) ;

/// @brief Method ToStringClass, addr 0x181dcba90, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dcf4a0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dcf520, size 0x70, virtual false, abstract: false, final false
inline void _ctor(bool  negate, ::System::Collections::Generic::List_1<::System::Text::RegularExpressions::RegexCharClass_SingleRange>*  ranges, ::System::Text::StringBuilder*  categories, ::System::Text::RegularExpressions::RegexCharClass*  subtraction) ;
...
static inline ::ArrayW<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping> getStaticF_s_lcTable() ;
...
/// @brief Method get_CanMerge, addr 0x181dcf590, size 0x20, virtual false, abstract: false, final false
...
static inline void setStaticF_s_lcTable(::ArrayW<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping>  value) ;
...
/// @brief Method set_Negate, addr 0x1803a7490, size 0x10, virtual false, abstract: false, final false
