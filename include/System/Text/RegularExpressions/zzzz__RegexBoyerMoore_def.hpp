...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::RegexBoyerMoore*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::RegexBoyerMoore*, "System.Text.RegularExpressions", "RegexBoyerMoore");
...
/// @brief Field NegativeASCII, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_NegativeASCII, put=__cordl_internal_set_NegativeASCII)) ::ArrayW<int32_t>  NegativeASCII;

/// @brief Field NegativeUnicode, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_NegativeUnicode, put=__cordl_internal_set_NegativeUnicode)) ::ArrayW<::ArrayW<int32_t>>  NegativeUnicode;
...
/// @brief Field Positive, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_Positive, put=__cordl_internal_set_Positive)) ::ArrayW<int32_t>  Positive;
...
/// @brief Method IsMatch, addr 0x181dc9a70, size 0x50, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  text, int32_t  index, int32_t  beglimit, int32_t  endlimit) ;

/// @brief Method MatchPattern, addr 0x181dc9ac0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Scan, addr 0x181dc9bc0, size 0x2a0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_NegativeASCII() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_NegativeASCII() ;

constexpr ::ArrayW<::ArrayW<int32_t>> const& __cordl_internal_get_NegativeUnicode() const;

constexpr ::ArrayW<::ArrayW<int32_t>>& __cordl_internal_get_NegativeUnicode() ;

constexpr ::StringW const& __cordl_internal_get_Pattern() const;

constexpr ::StringW& __cordl_internal_get_Pattern() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_Positive() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_Positive() ;
...
constexpr void __cordl_internal_set_NegativeASCII(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_NegativeUnicode(::ArrayW<::ArrayW<int32_t>>  value) ;

constexpr void __cordl_internal_set_Pattern(::StringW  value) ;

constexpr void __cordl_internal_set_Positive(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x181dc9e60, size 0x440, virtual false, abstract: false, final false
...
/// @brief Field NegativeASCII, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___NegativeASCII;

/// @brief Field NegativeUnicode, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::ArrayW<int32_t>>  ___NegativeUnicode;
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexBoyerMoore) == 0x48, "Size mismatch!");
