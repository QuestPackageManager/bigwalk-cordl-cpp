...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::Group*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::Group*, "System.Text.RegularExpressions", "Group");
...
/// @brief Field _caps, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__caps, put=__cordl_internal_set__caps)) ::ArrayW<int32_t>  _caps;
...
static inline ::System::Text::RegularExpressions::Group* New_ctor(::StringW  text, ::ArrayW<int32_t>  caps, int32_t  capcount, ::StringW  name) ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__caps() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__caps() ;
...
/// @brief Method .ctor, addr 0x181dc8480, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dc84a0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_Success, addr 0x181dc8540, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::Group) == 0x40, "Size mismatch!");
