...
// Write type traits
MARK_REF_T(::System::Text::EncoderReplacementFallback*);
DEFINE_IL2CPP_CLASS(::System::Text::EncoderReplacementFallback*, "System.Text", "EncoderReplacementFallback");
...
/// @brief Method CreateFallbackBuffer, addr 0x1815e9990, size 0x60, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x1815e99f0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815e9a60, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Text::EncoderReplacementFallback) == 0x18, "Size mismatch!");
