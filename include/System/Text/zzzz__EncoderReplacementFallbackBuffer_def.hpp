...
/// @brief Method Fallback, addr 0x1815e9800, size 0xc0, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknown, int32_t  index) ;

/// @brief Method Fallback, addr 0x1815e96a0, size 0x160, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknownHigh, char16_t  charUnknownLow, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x1815e98c0, size 0x40, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method MovePrevious, addr 0x1815e9900, size 0x20, virtual true, abstract: false, final false
inline bool MovePrevious() ;

static inline ::System::Text::EncoderReplacementFallbackBuffer* New_ctor(::System::Text::EncoderReplacementFallback*  fallback) ;

/// @brief Method Reset, addr 0x1815e9920, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x1815e9940, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Text::EncoderReplacementFallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x1815e9980, size 0x10, virtual true, abstract: false, final false
