...
/// @brief Method .ctor, addr 0x1815e8d90, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, char16_t  charUnknown, int32_t  index) ;

/// @brief Method .ctor, addr 0x1815e8c50, size 0x140, virtual false, abstract: false, final false
