...
/// @brief Method CreateFallbackBuffer, addr 0x1815eb730, size 0x40, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x1815eb770, size 0x90, virtual true, abstract: false, final false
