...
// Write type traits
MARK_REF_T(::System::Text::EncodingProvider*);
DEFINE_IL2CPP_CLASS(::System::Text::EncodingProvider*, "System.Text", "EncodingProvider");
...
/// @brief Method GetEncoding, addr 0x1815eb0f0, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x1815eaf90, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncodingFromProvider(int32_t  codepage) ;

/// @brief Method GetEncodingFromProvider, addr 0x1815eaed0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x1815eb040, size 0xb0, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Text::EncodingProvider*> getStaticF_s_providers() ;

static inline void setStaticF_s_InternalSyncObject(::System::Object*  value) ;

static inline void setStaticF_s_providers(::ArrayW<::System::Text::EncodingProvider*>  value) ;
...
static_assert(sizeof(::System::Text::EncodingProvider) == 0x10, "Size mismatch!");
