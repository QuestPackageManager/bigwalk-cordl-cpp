...
// Write type traits
MARK_REF_T(::System::Text::DecoderReplacementFallbackBuffer*);
DEFINE_IL2CPP_CLASS(::System::Text::DecoderReplacementFallbackBuffer*, "System.Text", "DecoderReplacementFallbackBuffer");
...
/// @brief Method Fallback, addr 0x1815e84c0, size 0x40, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x1815e8500, size 0x40, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x1815e8540, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x1815e8550, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x1815e8570, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Text::DecoderReplacementFallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x1815e8590, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Text::DecoderReplacementFallbackBuffer) == 0x30, "Size mismatch!");
