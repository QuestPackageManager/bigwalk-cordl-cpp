...
// Write type traits
MARK_REF_T(::GlobalNamespace::UTF8Encoding_UTF8EncodingSealed*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UTF8Encoding_UTF8EncodingSealed*, "System.Text", "UTF8Encoding/UTF8EncodingSealed");
...
/// @brief Method .ctor, addr 0x181601d70, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  encoderShouldEmitUTF8Identifier) ;

/// @brief Method get_Preamble, addr 0x181601d80, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::UTF8Encoding_UTF8EncodingSealed) == 0x40, "Size mismatch!");
