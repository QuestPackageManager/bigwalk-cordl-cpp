...
// Write type traits
MARK_REF_T(::System::Text::InternalDecoderBestFitFallbackBuffer*);
DEFINE_IL2CPP_CLASS(::System::Text::InternalDecoderBestFitFallbackBuffer*, "System.Text", "InternalDecoderBestFitFallbackBuffer");
...
/// @brief Method Fallback, addr 0x18176d9e0, size 0x140, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x18176db20, size 0x30, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method TryBestFit, addr 0x18176db50, size 0x130, virtual false, abstract: false, final false
inline char16_t TryBestFit(::ArrayW<uint8_t>  bytesCheck) ;
...
/// @brief Method .ctor, addr 0x18176dc80, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method get_InternalSyncObject, addr 0x18176ddc0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::InternalDecoderBestFitFallbackBuffer) == 0x38, "Size mismatch!");
