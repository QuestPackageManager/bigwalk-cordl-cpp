...
static_assert(offsetof(::System::Guid_GuidStyles, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Guid_GuidParseThrowStyle, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Guid_ParseFailureKind, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CompareTo, addr 0x181709630, size 0x1c0, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Guid  value) ;

/// @brief Method CompareTo, addr 0x181709400, size 0x230, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  value) ;

/// @brief Method EatAllWhitespace, addr 0x1817097f0, size 0x190, virtual false, abstract: false, final false
static inline ::System::ReadOnlySpan_1<char16_t> EatAllWhitespace(::System::ReadOnlySpan_1<char16_t>  str) ;

/// @brief Method Equals, addr 0x181709980, size 0x50, virtual true, abstract: false, final true
inline bool Equals(::System::Guid  g) ;

/// @brief Method Equals, addr 0x1817099d0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x181709a60, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetResult, addr 0x181709a80, size 0x20, virtual false, abstract: false, final false
inline int32_t GetResult(uint32_t  me, uint32_t  them) ;

/// @brief Method HexToChar, addr 0x181709aa0, size 0x20, virtual false, abstract: false, final false
static inline char16_t HexToChar(int32_t  a) ;

/// @brief Method HexsToChars, addr 0x181709b60, size 0x80, virtual false, abstract: false, final false
static inline int32_t HexsToChars(char16_t*  guidChars, int32_t  a, int32_t  b) ;

/// @brief Method HexsToCharsHexOutput, addr 0x181709ac0, size 0xa0, virtual false, abstract: false, final false
static inline int32_t HexsToCharsHexOutput(char16_t*  guidChars, int32_t  a, int32_t  b) ;

/// @brief Method IsHexPrefix, addr 0x181709be0, size 0x60, virtual false, abstract: false, final false
static inline bool IsHexPrefix(::System::ReadOnlySpan_1<char16_t>  str, int32_t  i) ;

/// @brief Method NewGuid, addr 0x181709c40, size 0x50, virtual false, abstract: false, final false
static inline ::System::Guid NewGuid() ;

/// @brief Method Parse, addr 0x181709d10, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Guid Parse(::StringW  input) ;

/// @brief Method Parse, addr 0x181709c90, size 0x80, virtual false, abstract: false, final false
static inline ::System::Guid Parse(::System::ReadOnlySpan_1<char16_t>  input) ;

/// @brief Method StringToInt, addr 0x181709e20, size 0x150, virtual false, abstract: false, final false
static inline bool StringToInt(::System::ReadOnlySpan_1<char16_t>  str, ::by_ref<int32_t>  parsePos, int32_t  requiredLength, int32_t  flags, ::by_ref<int32_t>  result, ::by_ref<::System::Guid_GuidResult>  parseResult) ;

/// @brief Method StringToInt, addr 0x181709dd0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method StringToLong, addr 0x181709f70, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method StringToShort, addr 0x18170a060, size 0x60, virtual false, abstract: false, final false
static inline bool StringToShort(::System::ReadOnlySpan_1<char16_t>  str, ::by_ref<int32_t>  parsePos, int32_t  requiredLength, int32_t  flags, ::by_ref<int16_t>  result, ::by_ref<::System::Guid_GuidResult>  parseResult) ;

/// @brief Method StringToShort, addr 0x18170a0c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method System.ISpanFormattable.TryFormat, addr 0x18170a120, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method ToByteArray, addr 0x18170a1a0, size 0xd0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ToByteArray() ;

/// @brief Method ToString, addr 0x18170a270, size 0x20, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x18170a490, size 0x20, virtual false, abstract: false, final false
inline ::StringW ToString(::StringW  format) ;

/// @brief Method ToString, addr 0x18170a290, size 0x200, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  provider) ;

/// @brief Method TryFormat, addr 0x18170a4b0, size 0xa10, virtual false, abstract: false, final false
...
/// @brief Method TryParse, addr 0x18170c160, size 0xc0, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, ::by_ref<::System::Guid>  result) ;

/// @brief Method TryParse, addr 0x18170c220, size 0x70, virtual false, abstract: false, final false
static inline bool TryParse(::System::ReadOnlySpan_1<char16_t>  input, ::by_ref<::System::Guid>  result) ;

/// @brief Method TryParseExact, addr 0x18170aec0, size 0x180, virtual false, abstract: false, final false
static inline bool TryParseExact(::StringW  input, ::StringW  format, ::by_ref<::System::Guid>  result) ;

/// @brief Method TryParseExact, addr 0x18170b040, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuid, addr 0x18170bee0, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuidWithDashes, addr 0x18170b130, size 0x2a0, virtual false, abstract: false, final false
static inline bool TryParseGuidWithDashes(::System::ReadOnlySpan_1<char16_t>  guidString, ::by_ref<::System::Guid_GuidResult>  result) ;

/// @brief Method TryParseGuidWithHexPrefix, addr 0x18170b3d0, size 0x7a0, virtual false, abstract: false, final false
...
/// @brief Method TryParseGuidWithNoStyle, addr 0x18170bb70, size 0x370, virtual false, abstract: false, final false
...
/// @brief Method TryWriteBytes, addr 0x18170c290, size 0xd0, virtual false, abstract: false, final false
inline bool TryWriteBytes(::System::Span_1<uint8_t>  destination) ;

/// @brief Method WriteByteHelper, addr 0x181708ab0, size 0x1b0, virtual false, abstract: false, final false
inline void WriteByteHelper(::System::Span_1<uint8_t>  destination) ;

/// @brief Method .ctor, addr 0x18170c360, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18170c4f0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  b) ;

/// @brief Method .ctor, addr 0x18170c3d0, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<uint8_t>  b) ;

/// @brief Method .ctor, addr 0x18170c550, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x18170c620, size 0x30, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetGuidParseException, addr 0x181709090, size 0x160, virtual false, abstract: false, final false
inline ::System::Exception* GetGuidParseException() ;

/// @brief Method Init, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void Init(::System::Guid_GuidParseThrowStyle  canThrow) ;

/// @brief Method SetFailure, addr 0x181709340, size 0xc0, virtual false, abstract: false, final false
inline void SetFailure(::System::Guid_ParseFailureKind  failure, ::StringW  failureMessageID) ;

/// @brief Method SetFailure, addr 0x181709290, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x1817091f0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x181709320, size 0x20, virtual false, abstract: false, final false
