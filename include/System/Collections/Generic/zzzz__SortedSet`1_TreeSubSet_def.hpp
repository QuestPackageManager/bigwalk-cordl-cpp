...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::SortedSet_1_TreeSubSet);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::SortedSet_1_TreeSubSet, "System.Collections.Generic", "SortedSet`1/TreeSubSet");
