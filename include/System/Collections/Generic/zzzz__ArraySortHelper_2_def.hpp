...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::ArraySortHelper_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::ArraySortHelper_2, "System.Collections.Generic", "ArraySortHelper`2");
...
static inline void DownHeap(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  i, int32_t  n, int32_t  lo, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method Heapsort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void Heapsort(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  lo, int32_t  hi, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method InsertionSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void InsertionSort(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  lo, int32_t  hi, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method IntroSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void IntroSort(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  lo, int32_t  hi, int32_t  depthLimit, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method IntrospectiveSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void IntrospectiveSort(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  left, int32_t  length, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;
...
static inline int32_t PickPivotAndPartition(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  lo, int32_t  hi, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method Sort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void Sort(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  index, int32_t  length, ::System::Collections::Generic::IComparer_1<TKey>*  comparer) ;

/// @brief Method Swap, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void Swap(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, int32_t  i, int32_t  j) ;

/// @brief Method SwapIfGreaterWithItems, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void SwapIfGreaterWithItems(::ArrayW<TKey>  keys, ::ArrayW<TValue>  values, ::System::Collections::Generic::IComparer_1<TKey>*  comparer, int32_t  a, int32_t  b) ;
