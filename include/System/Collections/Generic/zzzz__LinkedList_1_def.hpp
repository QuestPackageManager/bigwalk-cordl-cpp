...
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::LinkedList_1_Enumerator, "System.Collections.Generic", "LinkedList`1/Enumerator");
// Dependencies 
namespace System::Collections::Generic {
// cpp template
template<typename T>
...
constexpr LinkedList_1_Enumerator(::System::Collections::Generic::LinkedList_1<T>*  _list, ::System::Collections::Generic::LinkedListNode_1<T>*  _node, int32_t  _version, T  _current, int32_t  _index) noexcept;
