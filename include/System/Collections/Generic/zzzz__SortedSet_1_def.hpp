...
namespace System::Collections::Generic {
template<typename T>
class SortedSet_1___c__DisplayClass52_0;
}
namespace System::Collections::Generic {
template<typename T>
class SortedSet_1___c__DisplayClass53_0;
}
namespace System::Collections::Generic {
template<typename T>
class Stack_1;
...
namespace System::Collections::Generic {
template<typename T>
class TreeSubSet_SortedSet_1___c__DisplayClass9_0;
}
namespace System::Collections::Generic {
template<typename T>
struct SortedSet_1_ElementCount;
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedSet_1);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedSet_1_Node);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedSet_1___c__DisplayClass52_0);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::SortedSet_1___c__DisplayClass53_0);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::TreeSubSet_SortedSet_1___c__DisplayClass9_0);
...
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedSet_1, "System.Collections.Generic", "SortedSet`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedSet_1_Node, "System.Collections.Generic", "SortedSet`1/Node");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedSet_1___c__DisplayClass52_0, "System.Collections.Generic", "SortedSet`1/<>c__DisplayClass52_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::SortedSet_1___c__DisplayClass53_0, "System.Collections.Generic", "SortedSet`1/<>c__DisplayClass53_0");
...
/// @brief Field <Right>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__Right_k__BackingField, put=__cordl_internal_set__Right_k__BackingField)) ::System::Collections::Generic::SortedSet_1_Node<T>*  _Right_k__BackingField;
...
// Ctor Parameters [CppParam { name: "_tree", ty: "::System::Collections::Generic::SortedSet_1<T>*", modifiers: "", def_value: None }, CppParam { name: "_version", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_stack", ty: "::System::Collections::Generic::Stack_1<::System::Collections::Generic::SortedSet_1_Node<T>*>*", modifiers: "", def_value: None }, CppParam { name: "_current", ty: "::System::Collections::Generic::SortedSet_1_Node<T>*", modifiers: "", def_value: None }, CppParam { name: "_reverse", ty: "bool", modifiers: "", def_value: None }]
constexpr SortedSet_1_Enumerator(::System::Collections::Generic::SortedSet_1<T>*  _tree, int32_t  _version, ::System::Collections::Generic::Stack_1<::System::Collections::Generic::SortedSet_1_Node<T>*>*  _stack, ::System::Collections::Generic::SortedSet_1_Node<T>*  _current, bool  _reverse) noexcept;
...
inline void CopyTo(::ArrayW<T>  array, int32_t  index, int32_t  count) ;
...
inline void InsertionBalance(::System::Collections::Generic::SortedSet_1_Node<T>*  current, ::by_ref<::System::Collections::Generic::SortedSet_1_Node<T>*>  parent, ::System::Collections::Generic::SortedSet_1_Node<T>*  grandParent, ::System::Collections::Generic::SortedSet_1_Node<T>*  greatGrandParent) ;
...
inline void ReplaceChildOrRoot(::System::Collections::Generic::SortedSet_1_Node<T>*  parent, ::System::Collections::Generic::SortedSet_1_Node<T>*  child, ::System::Collections::Generic::SortedSet_1_Node<T>*  newChild) ;

/// @brief Method ReplaceNode, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void ReplaceNode(::System::Collections::Generic::SortedSet_1_Node<T>*  match, ::System::Collections::Generic::SortedSet_1_Node<T>*  parentOfMatch, ::System::Collections::Generic::SortedSet_1_Node<T>*  successor, ::System::Collections::Generic::SortedSet_1_Node<T>*  parentOfSuccessor) ;
