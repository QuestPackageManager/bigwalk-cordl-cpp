...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::IEnumerator_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::IEnumerator_1, "System.Collections.Generic", "IEnumerator`1");
// Dependencies 
namespace System::Collections::Generic {
// cpp template
template<typename T>
