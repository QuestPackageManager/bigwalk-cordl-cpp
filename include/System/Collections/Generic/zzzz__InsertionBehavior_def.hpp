...
DEFINE_IL2CPP_CLASS(::System::Collections::Generic::InsertionBehavior, "System.Collections.Generic", "InsertionBehavior");
// Dependencies 
namespace System::Collections::Generic {
// Is value type: true
...
static_assert(offsetof(::System::Collections::Generic::InsertionBehavior, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::System::Collections::Generic::InsertionBehavior) == 0x1, "Size mismatch!");
