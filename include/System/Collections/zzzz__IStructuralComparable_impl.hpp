...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Collections::IStructuralComparable::*)(::System::Object*, ::System::Collections::IComparer*)>(&::System::Collections::IStructuralComparable::CompareTo)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::System::Collections::IStructuralComparable*>(),
                    {::i2c::class_of<::System::Collections::IStructuralComparable*>(), 0}
                ));
