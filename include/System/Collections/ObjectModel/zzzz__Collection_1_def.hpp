...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::ObjectModel::Collection_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::ObjectModel::Collection_1, "System.Collections.ObjectModel", "Collection`1");
...
constexpr ::System::Collections::Generic::IList_1<T>* const& __cordl_internal_get_items() const;
