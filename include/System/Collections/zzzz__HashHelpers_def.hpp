...
/// @brief Method ExpandPrime, addr 0x1816c6a60, size 0x30, virtual false, abstract: false, final false
static inline int32_t ExpandPrime(int32_t  oldSize) ;

/// @brief Method GetPrime, addr 0x1816c6a90, size 0x120, virtual false, abstract: false, final false
static inline int32_t GetPrime(int32_t  min) ;

/// @brief Method IsPrime, addr 0x1816c6bb0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_SerializationInfoTable, addr 0x1816c6c80, size 0x70, virtual false, abstract: false, final false
