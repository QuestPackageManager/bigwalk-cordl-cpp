...
// Write type traits
MARK_REF_T(::System::Collections::Comparer*);
DEFINE_IL2CPP_CLASS(::System::Collections::Comparer*, "System.Collections", "Comparer");
...
/// @brief Method Compare, addr 0x1816c5f10, size 0x120, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method GetObjectData, addr 0x1816c6030, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1816c6180, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Comparer) == 0x18, "Size mismatch!");
