...
// Write type traits
MARK_REF_T(::System::Collections::CaseInsensitiveComparer*);
DEFINE_IL2CPP_CLASS(::System::Collections::CaseInsensitiveComparer*, "System.Collections", "CaseInsensitiveComparer");
...
/// @brief Method Compare, addr 0x1816c5410, size 0x1c0, virtual true, abstract: false, final true
...
/// @brief Method get_Default, addr 0x1816c5660, size 0x70, virtual false, abstract: false, final false
static inline ::System::Collections::CaseInsensitiveComparer* get_Default() ;
...
static_assert(sizeof(::System::Collections::CaseInsensitiveComparer) == 0x18, "Size mismatch!");
