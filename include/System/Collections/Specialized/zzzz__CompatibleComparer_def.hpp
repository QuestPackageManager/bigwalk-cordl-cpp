...
// Write type traits
MARK_REF_T(::System::Collections::Specialized::CompatibleComparer*);
DEFINE_IL2CPP_CLASS(::System::Collections::Specialized::CompatibleComparer*, "System.Collections.Specialized", "CompatibleComparer");
...
/// @brief Method Equals, addr 0x181e0edb0, size 0x130, virtual true, abstract: false, final true
inline bool Equals(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method GetHashCode, addr 0x181e0eee0, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method get_Comparer, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::IComparer* get_Comparer() ;

/// @brief Method get_DefaultComparer, addr 0x181e0ef40, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Collections::IComparer* get_DefaultComparer() ;

/// @brief Method get_DefaultHashCodeProvider, addr 0x181e0efe0, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Collections::IHashCodeProvider* get_DefaultHashCodeProvider() ;

/// @brief Method get_HashCodeProvider, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Specialized::CompatibleComparer) == 0x20, "Size mismatch!");
