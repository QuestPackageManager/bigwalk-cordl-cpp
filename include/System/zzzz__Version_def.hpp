...
// Write type traits
MARK_REF_T(::System::Version*);
DEFINE_IL2CPP_CLASS(::System::Version*, "System", "Version");
...
/// @brief Method Clone, addr 0x18172d480, size 0x40, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method CompareTo, addr 0x18172d550, size 0x60, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Version*  value) ;

/// @brief Method CompareTo, addr 0x18172d4c0, size 0x90, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  version) ;

/// @brief Method Equals, addr 0x18172d5f0, size 0x50, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x18172d5b0, size 0x40, virtual true, abstract: false, final true
inline bool Equals(::System::Version*  obj) ;

/// @brief Method GetHashCode, addr 0x18172d640, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x18172dc20, size 0x60, virtual false, abstract: false, final false
static inline ::System::Version* Parse(::StringW  input) ;

/// @brief Method ParseVersion, addr 0x18172d670, size 0x5b0, virtual false, abstract: false, final false
static inline ::System::Version* ParseVersion(::System::ReadOnlySpan_1<char16_t>  input, bool  throwOnFailure) ;

/// @brief Method System.ISpanFormattable.TryFormat, addr 0x18172dc80, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method ToCachedStringBuilder, addr 0x18172dd40, size 0x240, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* ToCachedStringBuilder(int32_t  fieldCount) ;

/// @brief Method ToString, addr 0x18172dfd0, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x18172df80, size 0x50, virtual false, abstract: false, final false
inline ::StringW ToString(int32_t  fieldCount) ;

/// @brief Method TryFormat, addr 0x18172dc80, size 0xc0, virtual false, abstract: false, final false
inline bool TryFormat(::System::Span_1<char16_t>  destination, ::by_ref<int32_t>  charsWritten) ;

/// @brief Method TryFormat, addr 0x18172e010, size 0x110, virtual false, abstract: false, final false
inline bool TryFormat(::System::Span_1<char16_t>  destination, int32_t  fieldCount, ::by_ref<int32_t>  charsWritten) ;

/// @brief Method TryParse, addr 0x18172e1f0, size 0x90, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, ::by_ref<::System::Version*>  result) ;

/// @brief Method TryParseComponent, addr 0x18172e120, size 0xd0, virtual false, abstract: false, final false
static inline bool TryParseComponent(::System::ReadOnlySpan_1<char16_t>  component, ::StringW  componentName, bool  throwOnFailure, ::by_ref<int32_t>  parsedComponent) ;
...
/// @brief Method .ctor, addr 0x18172e4c0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18172e280, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor) ;

/// @brief Method .ctor, addr 0x18172e370, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  build) ;

/// @brief Method .ctor, addr 0x18172e3f0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  build, int32_t  revision) ;

/// @brief Method .ctor, addr 0x18172e2e0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  version) ;

/// @brief Method .ctor, addr 0x18172e490, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Version*  version) ;

/// @brief Method get_Build, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Build() ;

/// @brief Method get_DefaultFormatFieldCount, addr 0x18172e4d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_Revision, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x18172e4f0, size 0x40, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_Inequality, addr 0x18172e530, size 0x50, virtual false, abstract: false, final false
static inline bool op_Inequality(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_LessThan, addr 0x18172e580, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Version) == 0x20, "Size mismatch!");
