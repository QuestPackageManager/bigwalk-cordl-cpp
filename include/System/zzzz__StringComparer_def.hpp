...
// Write type traits
MARK_REF_T(::System::StringComparer*);
DEFINE_IL2CPP_CLASS(::System::StringComparer*, "System", "StringComparer");
...
/// @brief Method Compare, addr 0x181726760, size 0xc0, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  x, ::System::Object*  y) ;

/// @brief Method Create, addr 0x181726820, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x1817268a0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method GetHashCode, addr 0x181726910, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method get_InvariantCultureIgnoreCase, addr 0x181726b00, size 0x40, virtual false, abstract: false, final false
static inline ::System::StringComparer* get_InvariantCultureIgnoreCase() ;

/// @brief Method get_Ordinal, addr 0x181726b40, size 0x40, virtual false, abstract: false, final false
static inline ::System::StringComparer* get_Ordinal() ;

/// @brief Method get_OrdinalIgnoreCase, addr 0x1816615a0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::StringComparer) == 0x10, "Size mismatch!");
