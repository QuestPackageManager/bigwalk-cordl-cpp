...
// Write type traits
MARK_REF_T(::System::ArrayTypeMismatchException*);
DEFINE_IL2CPP_CLASS(::System::ArrayTypeMismatchException*, "System", "ArrayTypeMismatchException");
...
/// @brief Method .ctor, addr 0x18169bc80, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::ArrayTypeMismatchException) == 0x90, "Size mismatch!");
