...
/// @brief Method CreateObjRef, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type*  requestedType) ;

/// @brief Method InitializeLifetimeService, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_ObjectIdentity, addr 0x1802eb7d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity() ;

/// @brief Method set_ObjectIdentity, addr 0x1802eb7d0, size 0x10, virtual false, abstract: false, final false
