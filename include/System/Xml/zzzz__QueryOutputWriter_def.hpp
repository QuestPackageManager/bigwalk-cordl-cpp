...
// Write type traits
MARK_REF_T(::System::Xml::QueryOutputWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::QueryOutputWriter*, "System.Xml", "QueryOutputWriter");
...
/// @brief Field lookupCDataElems, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_lookupCDataElems, put=__cordl_internal_set_lookupCDataElems)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,int32_t>*  lookupCDataElems;
...
/// @brief Method Close, addr 0x181cdb1c0, size 0x90, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EndCDataSection, addr 0x1805cc510, size 0x10, virtual false, abstract: false, final false
inline void EndCDataSection() ;

/// @brief Method Flush, addr 0x181cdb250, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

static inline ::System::Xml::QueryOutputWriter* New_ctor(::System::Xml::XmlRawWriter*  writer, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method StartCDataSection, addr 0x181cdb270, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method WriteCData, addr 0x181cdb2b0, size 0x20, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181cdb2d0, size 0x20, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x181cdb2f0, size 0xc0, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x181cdb3b0, size 0x20, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteDocType, addr 0x181cdb3d0, size 0x30, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x181cdb400, size 0x20, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x181cdb420, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method WriteEntityRef, addr 0x181cdb490, size 0x20, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x181cdb4b0, size 0x50, virtual true, abstract: false, final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteNamespaceDeclaration, addr 0x181cdb500, size 0x20, virtual true, abstract: false, final false
inline void WriteNamespaceDeclaration(::StringW  prefix, ::StringW  ns) ;

/// @brief Method WriteProcessingInstruction, addr 0x181cdb520, size 0x20, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x181cdb540, size 0xc0, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cdb600, size 0x80, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteStartAttribute, addr 0x181cdb680, size 0x30, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x181cdb6b0, size 0x170, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartNamespaceDeclaration, addr 0x181cdb820, size 0x20, virtual true, abstract: false, final false
inline void WriteStartNamespaceDeclaration(::StringW  prefix) ;

/// @brief Method WriteString, addr 0x181cdb840, size 0x80, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181cdb8c0, size 0x20, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x181cdb8e0, size 0x80, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteXmlDeclaration, addr 0x181cdb960, size 0x20, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x181cdb980, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cdb9a0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method set_NamespaceResolver, addr 0x181cdbb80, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::QueryOutputWriter) == 0x70, "Size mismatch!");
