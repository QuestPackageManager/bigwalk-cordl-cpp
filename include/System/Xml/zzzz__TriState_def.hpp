...
DEFINE_IL2CPP_CLASS(::System::Xml::TriState, "System.Xml", "TriState");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::TriState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::TriState) == 0x4, "Size mismatch!");
