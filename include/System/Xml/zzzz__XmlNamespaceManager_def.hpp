...
public:
// Declarations
/// @brief Method Set, addr 0x181d26170, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method AddNamespace, addr 0x181d374d0, size 0x2b0, virtual true, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method GetEnumerator, addr 0x181d37780, size 0xd0, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetNamespacesInScope, addr 0x181d37850, size 0x120, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method LookupNamespace, addr 0x181d37ab0, size 0x40, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceDecl, addr 0x181d37970, size 0x140, virtual false, abstract: false, final false
inline int32_t LookupNamespaceDecl(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181d37af0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method PopScope, addr 0x181d37bb0, size 0xa0, virtual true, abstract: false, final false
inline bool PopScope() ;

/// @brief Method PushScope, addr 0x180e7ac20, size 0x10, virtual true, abstract: false, final false
inline void PushScope() ;

/// @brief Method RemoveNamespace, addr 0x181d37c50, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d37d40, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method get_DefaultNamespace, addr 0x181d37f10, size 0x50, virtual true, abstract: false, final false
inline ::StringW get_DefaultNamespace() ;

/// @brief Method get_NameTable, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
