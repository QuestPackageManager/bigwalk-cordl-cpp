...
// Write type traits
MARK_REF_T(::System::Xml::Schema::RestrictionFacets*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::RestrictionFacets*, "System.Xml.Schema", "RestrictionFacets");
...
static_assert(sizeof(::System::Xml::Schema::RestrictionFacets) == 0x68, "Size mismatch!");
