...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlTypeCode, "System.Xml.Schema", "XmlTypeCode");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlTypeCode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlTypeCode) == 0x4, "Size mismatch!");
