...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaUse, "System.Xml.Schema", "XmlSchemaUse");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaUse, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaUse) == 0x4, "Size mismatch!");
