...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaComplexContent*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaComplexContent*, "System.Xml.Schema", "XmlSchemaComplexContent");
...
/// @brief Method get_Content, addr 0x1802e0b30, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContent* get_Content() ;

/// @brief Method get_HasMixedAttribute, addr 0x18165d5a0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasMixedAttribute() ;

/// @brief Method get_IsMixed, addr 0x1803151e0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsMixed() ;

/// @brief Method set_Content, addr 0x180308de0, size 0x10, virtual true, abstract: false, final false
inline void set_Content(::System::Xml::Schema::XmlSchemaContent*  value) ;

/// @brief Method set_IsMixed, addr 0x181c97ee0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaComplexContent) == 0x60, "Size mismatch!");
