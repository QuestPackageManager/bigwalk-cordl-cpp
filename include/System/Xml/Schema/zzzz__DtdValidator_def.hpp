...
// Write type traits
MARK_REF_T(::System::Xml::Schema::DtdValidator*);
MARK_REF_T(::System::Xml::Schema::DtdValidator_NamespaceManager*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::DtdValidator*, "System.Xml.Schema", "DtdValidator");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::DtdValidator_NamespaceManager*, "System.Xml.Schema", "DtdValidator/NamespaceManager");
...
public:
// Declarations
/// @brief Method LookupNamespace, addr 0x1802dc680, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::DtdValidator_NamespaceManager) == 0x50, "Size mismatch!");
...
/// @brief Method AddID, addr 0x181d70600, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method CheckDefaultValue, addr 0x181d70690, size 0x290, virtual false, abstract: false, final false
static inline void CheckDefaultValue(::System::Xml::Schema::SchemaAttDef*  attdef, ::System::Xml::Schema::SchemaInfo*  sinfo, ::System::Xml::IValidationEventHandling*  eventHandling, ::StringW  baseUriStr) ;

/// @brief Method CheckForwardRefs, addr 0x181d70920, size 0x120, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x181d70a40, size 0x360, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x181d70da0, size 0x160, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method FindId, addr 0x181d70f00, size 0x30, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method GenEntity, addr 0x181d70f30, size 0x160, virtual false, abstract: false, final false
inline bool GenEntity(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method GetEntity, addr 0x181d71090, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaEntity* GetEntity(::System::Xml::XmlQualifiedName*  qname, bool  fParameterEntity) ;

/// @brief Method Init, addr 0x181d710f0, size 0x120, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MeetsStandAloneConstraint, addr 0x181d71210, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x181d71270, size 0xb0, virtual false, abstract: false, final false
inline bool Pop() ;

/// @brief Method ProcessElement, addr 0x181d71320, size 0xd0, virtual false, abstract: false, final false
inline void ProcessElement() ;

/// @brief Method ProcessTokenizedType, addr 0x181d713f0, size 0x240, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method Push, addr 0x181d71630, size 0x120, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method SetDefaultTypedValue, addr 0x181d71750, size 0x230, virtual false, abstract: false, final false
static inline void SetDefaultTypedValue(::System::Xml::Schema::SchemaAttDef*  attdef, ::System::Xml::IDtdParserAdapter*  readerAdapter) ;

/// @brief Method Validate, addr 0x181d72260, size 0x390, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x181d71980, size 0x2b0, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x181d71c30, size 0x190, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x181d71dc0, size 0x130, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidatePIComment, addr 0x181d71ef0, size 0x70, virtual false, abstract: false, final false
inline void ValidatePIComment() ;

/// @brief Method ValidateStartElement, addr 0x181d71f60, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d72630, size 0x1a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::DtdValidator) == 0xb0, "Size mismatch!");
