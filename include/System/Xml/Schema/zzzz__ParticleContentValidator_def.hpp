...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ParticleContentValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ParticleContentValidator*, "System.Xml.Schema", "ParticleContentValidator");
...
/// @brief Method AddChoice, addr 0x181d579c0, size 0xb0, virtual false, abstract: false, final false
inline void AddChoice() ;

/// @brief Method AddLeafNode, addr 0x181d57a70, size 0xd0, virtual false, abstract: false, final false
inline void AddLeafNode(::System::Xml::Schema::SyntaxTreeNode*  node) ;

/// @brief Method AddLeafRange, addr 0x181d57b40, size 0xf0, virtual false, abstract: false, final false
inline void AddLeafRange(::System::Decimal  min, ::System::Decimal  max) ;

/// @brief Method AddName, addr 0x181d57c30, size 0xb0, virtual false, abstract: false, final false
inline void AddName(::System::Xml::XmlQualifiedName*  name, ::System::Object*  particle) ;

/// @brief Method AddNamespaceList, addr 0x181d57ce0, size 0x90, virtual false, abstract: false, final false
inline void AddNamespaceList(::System::Xml::Schema::NamespaceList*  namespaceList, ::System::Object*  particle) ;

/// @brief Method AddPlus, addr 0x181d57d70, size 0x30, virtual false, abstract: false, final false
inline void AddPlus() ;

/// @brief Method AddQMark, addr 0x181d57da0, size 0x30, virtual false, abstract: false, final false
inline void AddQMark() ;

/// @brief Method AddSequence, addr 0x181d57dd0, size 0xb0, virtual false, abstract: false, final false
inline void AddSequence() ;

/// @brief Method AddStar, addr 0x181d57e80, size 0x30, virtual false, abstract: false, final false
inline void AddStar() ;

/// @brief Method BuildTransitionTable, addr 0x181d57eb0, size 0x560, virtual false, abstract: false, final false
inline ::ArrayW<::ArrayW<int32_t>> BuildTransitionTable(::System::Xml::Schema::BitSet*  firstpos, ::ArrayW<::System::Xml::Schema::BitSet*>  followpos, int32_t  endMarkerPos) ;

/// @brief Method CalculateTotalFollowposForRangeNodes, addr 0x181d58410, size 0x310, virtual false, abstract: false, final false
inline ::ArrayW<::System::Xml::Schema::BitSet*> CalculateTotalFollowposForRangeNodes(::System::Xml::Schema::BitSet*  firstpos, ::ArrayW<::System::Xml::Schema::BitSet*>  followpos, ::by_ref<::System::Xml::Schema::BitSet*>  posWithRangeTerminals) ;

/// @brief Method CheckCMUPAWithLeafRangeNodes, addr 0x181d58720, size 0x1b0, virtual false, abstract: false, final false
inline void CheckCMUPAWithLeafRangeNodes(::System::Xml::Schema::BitSet*  curpos) ;

/// @brief Method CheckUniqueParticleAttribution, addr 0x181d588d0, size 0x230, virtual false, abstract: false, final false
inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet*  curpos) ;

/// @brief Method CheckUniqueParticleAttribution, addr 0x181d58b00, size 0x90, virtual false, abstract: false, final false
inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet*  firstpos, ::ArrayW<::System::Xml::Schema::BitSet*>  followpos) ;

/// @brief Method CloseGroup, addr 0x181d58b90, size 0x150, virtual false, abstract: false, final false
inline void CloseGroup() ;

/// @brief Method Closure, addr 0x181d58ce0, size 0x180, virtual false, abstract: false, final false
inline void Closure(::System::Xml::Schema::InteriorNode*  node) ;

/// @brief Method CompleteValidation, addr 0x18167bb40, size 0x10, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method Exists, addr 0x181d58e60, size 0x30, virtual false, abstract: false, final false
inline bool Exists(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method Finish, addr 0x181d58e90, size 0x6a0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ContentValidator* Finish(bool  useDFA) ;

/// @brief Method GetApplicableMinMaxFollowPos, addr 0x181d59530, size 0x2f0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::BitSet* GetApplicableMinMaxFollowPos(::System::Xml::Schema::BitSet*  curpos, ::System::Xml::Schema::BitSet*  posWithRangeTerminals, ::ArrayW<::System::Xml::Schema::BitSet*>  minmaxFollowPos) ;

/// @brief Method InitValidation, addr 0x18167bb40, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method OpenGroup, addr 0x181d59820, size 0x20, virtual false, abstract: false, final false
inline void OpenGroup() ;

/// @brief Method Start, addr 0x181d59840, size 0x110, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ValidateElement, addr 0x18167bb40, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d59950, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType) ;

/// @brief Method .ctor, addr 0x181d59960, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ParticleContentValidator) == 0x48, "Size mismatch!");
