...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SchemaNotation*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaNotation*, "System.Xml.Schema", "SchemaNotation");
...
/// @brief Method get_SystemLiteral, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_SystemLiteral, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SchemaNotation) == 0x28, "Size mismatch!");
