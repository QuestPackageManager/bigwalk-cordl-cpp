...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_ENUMERATION*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_ENUMERATION*, "System.Xml.Schema", "Datatype_ENUMERATION");
...
/// @brief Method get_TokenizedType, addr 0x1813ef7d0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_ENUMERATION) == 0x38, "Size mismatch!");
