...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaGroupBase*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaGroupBase*, "System.Xml.Schema", "XmlSchemaGroupBase");
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaGroupBase) == 0x78, "Size mismatch!");
