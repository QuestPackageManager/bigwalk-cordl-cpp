...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Positions*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Positions*, "System.Xml.Schema", "Positions");
...
/// @brief Method Add, addr 0x181d59ab0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x1816c5ef0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x181d59b20, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Positions) == 0x18, "Size mismatch!");
