...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_normalizedString*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_normalizedString*, "System.Xml.Schema", "Datatype_normalizedString");
...
/// @brief Method get_BuiltInWhitespaceFacet, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_TypeCode, addr 0x1818c5820, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_normalizedString) == 0x38, "Size mismatch!");
