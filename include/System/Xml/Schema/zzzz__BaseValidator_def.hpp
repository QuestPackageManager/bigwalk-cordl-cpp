...
// Write type traits
MARK_REF_T(::System::Xml::Schema::BaseValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::BaseValidator*, "System.Xml.Schema", "BaseValidator");
...
/// @brief Method CreateInstance, addr 0x181d51ab0, size 0x180, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::BaseValidator* CreateInstance(::System::Xml::ValidationType  valType, ::System::Xml::XmlValidatingReaderImpl*  reader, ::System::Xml::Schema::XmlSchemaCollection*  schemaCollection, ::System::Xml::IValidationEventHandling*  eventHandling, bool  processIdentityConstraints) ;
...
static inline ::System::Xml::Schema::BaseValidator* New_ctor(::System::Xml::XmlValidatingReaderImpl*  reader, ::System::Xml::Schema::XmlSchemaCollection*  schemaCollection, ::System::Xml::IValidationEventHandling*  eventHandling) ;

/// @brief Method ProcessEntity, addr 0x181d51d80, size 0x120, virtual false, abstract: false, final false
static inline void ProcessEntity(::System::Xml::Schema::SchemaInfo*  sinfo, ::StringW  name, ::System::Xml::IValidationEventHandling*  eventHandling, ::StringW  baseUriStr, int32_t  lineNumber, int32_t  linePosition) ;

/// @brief Method ProcessEntity, addr 0x181d51c30, size 0x150, virtual false, abstract: false, final false
static inline void ProcessEntity(::System::Xml::Schema::SchemaInfo*  sinfo, ::StringW  name, ::System::Object*  sender, ::System::Xml::Schema::ValidationEventHandler*  eventhandler, ::StringW  baseUri, int32_t  lineNumber, int32_t  linePosition) ;

/// @brief Method SaveTextValue, addr 0x181d51ea0, size 0x70, virtual false, abstract: false, final false
inline void SaveTextValue(::StringW  value) ;

/// @brief Method SendValidationEvent, addr 0x181d52010, size 0x20, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code) ;

/// @brief Method SendValidationEvent, addr 0x181d52170, size 0x100, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x181d522c0, size 0x100, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW>  args) ;

/// @brief Method SendValidationEvent, addr 0x181d51f10, size 0x100, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW>  args, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEvent, addr 0x181d52030, size 0x100, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEvent, addr 0x181d52130, size 0x40, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e) ;

/// @brief Method SendValidationEvent, addr 0x181d52270, size 0x50, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method Validate, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateText, addr 0x181d523c0, size 0x260, virtual false, abstract: false, final false
inline void ValidateText() ;

/// @brief Method ValidateWhitespace, addr 0x181d52620, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d527b0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::BaseValidator*  other) ;

/// @brief Method .ctor, addr 0x181d526e0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method get_BaseUri, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Uri* get_BaseUri() ;

/// @brief Method get_EventHandler, addr 0x181d52870, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler() ;

/// @brief Method get_NameTable, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_PositionInfo, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Reader, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlValidatingReaderImpl* get_Reader() ;

/// @brief Method get_SchemaCollection, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCollection* get_SchemaCollection() ;

/// @brief Method get_SchemaInfo, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo() ;

/// @brief Method get_SchemaNames, addr 0x181d528b0, size 0xb0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* get_SchemaNames() ;

/// @brief Method get_XmlResolver, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* get_XmlResolver() ;

/// @brief Method set_BaseUri, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_BaseUri(::System::Uri*  value) ;

/// @brief Method set_DtdInfo, addr 0x181d52960, size 0xb0, virtual false, abstract: false, final false
inline void set_DtdInfo(::System::Xml::IDtdInfo*  value) ;

/// @brief Method set_XmlResolver, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::BaseValidator) == 0x80, "Size mismatch!");
