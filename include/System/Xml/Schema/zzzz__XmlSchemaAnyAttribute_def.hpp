...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaAnyAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaAnyAttribute*, "System.Xml.Schema", "XmlSchemaAnyAttribute");
...
/// @brief Method Allows, addr 0x181c96a90, size 0x20, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method BuildNamespaceList, addr 0x181c96b40, size 0x90, virtual false, abstract: false, final false
inline void BuildNamespaceList(::StringW  targetNamespace) ;

/// @brief Method BuildNamespaceListV1Compat, addr 0x181c96ab0, size 0x90, virtual false, abstract: false, final false
inline void BuildNamespaceListV1Compat(::StringW  targetNamespace) ;

/// @brief Method Intersection, addr 0x181c96bd0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method IsSubset, addr 0x181c96c50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Union, addr 0x181c96c60, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_NamespaceList, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* get_NamespaceList() ;

/// @brief Method get_ProcessContents, addr 0x1802e0b20, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContents() ;

/// @brief Method get_ProcessContentsCorrect, addr 0x181c96ce0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect() ;

/// @brief Method set_Namespace, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_ProcessContents, addr 0x1802e0d10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaAnyAttribute) == 0x68, "Size mismatch!");
