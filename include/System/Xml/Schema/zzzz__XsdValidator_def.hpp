...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XsdValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdValidator*, "System.Xml.Schema", "XsdValidator");
...
/// @brief Method AddID, addr 0x181c92fd0, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method AddIdentityConstraints, addr 0x181cd6440, size 0x300, virtual false, abstract: false, final false
inline void AddIdentityConstraints() ;

/// @brief Method AttributeIdentityConstraints, addr 0x181cd6740, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x181c93420, size 0x120, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x181cd69f0, size 0x2f0, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x181c93420, size 0x120, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method ElementIdentityConstraints, addr 0x181cd6ce0, size 0x300, virtual false, abstract: false, final false
inline void ElementIdentityConstraints() ;

/// @brief Method EndElementIdentityConstraints, addr 0x181cd6fe0, size 0x8a0, virtual false, abstract: false, final false
inline void EndElementIdentityConstraints() ;

/// @brief Method FastGetElementDecl, addr 0x181cd7880, size 0xb0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* FastGetElementDecl(::System::Object*  particle) ;

/// @brief Method FindId, addr 0x181c93aa0, size 0x30, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method Init, addr 0x181cd7930, size 0x330, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method IsXSDRoot, addr 0x181cd7c60, size 0x50, virtual false, abstract: false, final false
inline bool IsXSDRoot(::StringW  localName, ::StringW  ns) ;

/// @brief Method LoadSchema, addr 0x181cd80c0, size 0x160, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri, ::StringW  url) ;

/// @brief Method LoadSchemaFromLocation, addr 0x181cd7cb0, size 0x410, virtual false, abstract: false, final false
inline void LoadSchemaFromLocation(::StringW  uri, ::StringW  url) ;

static inline ::System::Xml::Schema::XsdValidator* New_ctor(::System::Xml::XmlValidatingReaderImpl*  reader, ::System::Xml::Schema::XmlSchemaCollection*  schemaCollection, ::System::Xml::IValidationEventHandling*  eventHandling) ;

static inline ::System::Xml::Schema::XsdValidator* New_ctor(::System::Xml::Schema::BaseValidator*  validator) ;

/// @brief Method Pop, addr 0x181cd8220, size 0xc0, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method ProcessElement, addr 0x181cd82e0, size 0x270, virtual false, abstract: false, final false
inline void ProcessElement(::System::Object*  particle) ;

/// @brief Method ProcessInlineSchema, addr 0x181cd8550, size 0x1a0, virtual false, abstract: false, final false
inline void ProcessInlineSchema() ;

/// @brief Method ProcessTokenizedType, addr 0x181c94590, size 0x230, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method ProcessXsiAttributes, addr 0x181cd86f0, size 0x6b0, virtual false, abstract: false, final false
inline void ProcessXsiAttributes(::by_ref<::System::Xml::XmlQualifiedName*>  xsiType, ::by_ref<::StringW>  xsiNil) ;

/// @brief Method Push, addr 0x181cd8da0, size 0x140, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method ThoroughGetElementDecl, addr 0x181cd8ee0, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method UnWrapUnion, addr 0x181cd91a0, size 0x40, virtual false, abstract: false, final false
inline ::System::Object* UnWrapUnion(::System::Object*  typedValue) ;

/// @brief Method Validate, addr 0x181cda1a0, size 0xc0, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x181cd91e0, size 0x1e0, virtual false, abstract: false, final false
inline ::System::Object* ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x181cd93c0, size 0x2f0, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x181cd96b0, size 0x260, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x181cd9910, size 0x350, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidateStartElement, addr 0x181cd9cb0, size 0x4f0, virtual false, abstract: false, final false
inline void ValidateStartElement() ;

/// @brief Method ValidateStartElementIdentityConstraints, addr 0x181cd9c60, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cda330, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cda360, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_HasIdentityConstraints, addr 0x181cda390, size 0x390, virtual false, abstract: false, final false
inline bool get_HasIdentityConstraints() ;

/// @brief Method get_HasSchema, addr 0x181c95b50, size 0x10, virtual false, abstract: false, final false
inline bool get_HasSchema() ;

/// @brief Method get_IsInlineSchemaStarted, addr 0x180351a50, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInlineSchemaStarted() ;

/// @brief Method get_PreserveWhitespace, addr 0x181c95b60, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XsdValidator) == 0x108, "Size mismatch!");
