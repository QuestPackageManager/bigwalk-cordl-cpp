...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_NCName*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_NCName*, "System.Xml.Schema", "Datatype_NCName");
...
/// @brief Method TryParseValue, addr 0x181d6a3c0, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method get_TypeCode, addr 0x1809019c0, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_NCName) == 0x38, "Size mismatch!");
