...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaSimpleType*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaSimpleType*, "System.Xml.Schema", "XmlSchemaSimpleType");
...
/// @brief Method Clone, addr 0x181ca9220, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method get_Content, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleTypeContent* get_Content() ;

/// @brief Method set_Content, addr 0x18163ca40, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaSimpleType) == 0xa0, "Size mismatch!");
