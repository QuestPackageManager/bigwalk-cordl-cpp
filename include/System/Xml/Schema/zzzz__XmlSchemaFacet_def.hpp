...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaFacet*, "System.Xml.Schema", "XmlSchemaFacet");
// Dependencies System.Xml.Schema.FacetType, System.Xml.Schema.XmlSchemaAnnotated
namespace System::Xml::Schema {
// Is value type: false
...
/// @brief Method get_FacetType, addr 0x180503b40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::FacetType get_FacetType() ;

/// @brief Method get_IsFixed, addr 0x1803151e0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsFixed() ;

/// @brief Method get_Value, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_FacetType, addr 0x180503ba0, size 0x10, virtual false, abstract: false, final false
inline void set_FacetType(::System::Xml::Schema::FacetType  value) ;

/// @brief Method set_IsFixed, addr 0x181c9bb60, size 0x70, virtual true, abstract: false, final false
inline void set_IsFixed(bool  value) ;

/// @brief Method set_Value, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaFacet) == 0x60, "Size mismatch!");
