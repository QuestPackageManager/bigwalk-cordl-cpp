...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSeverityType, "System.Xml.Schema", "XmlSeverityType");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSeverityType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSeverityType) == 0x4, "Size mismatch!");
