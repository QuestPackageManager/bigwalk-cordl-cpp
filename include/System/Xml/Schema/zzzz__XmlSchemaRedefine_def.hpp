...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaRedefine*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaRedefine*, "System.Xml.Schema", "XmlSchemaRedefine");
...
/// @brief Method AddAnnotation, addr 0x181ca2be0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ca2bf0, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AttributeGroups, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups() ;

/// @brief Method get_Groups, addr 0x1802ec4c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups() ;

/// @brief Method get_Items, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items() ;

/// @brief Method get_SchemaTypes, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaRedefine) == 0x88, "Size mismatch!");
