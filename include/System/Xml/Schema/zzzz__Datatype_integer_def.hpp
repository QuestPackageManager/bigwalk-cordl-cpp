...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_integer*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_integer*, "System.Xml.Schema", "Datatype_integer");
...
/// @brief Method TryParseValue, addr 0x181d6d820, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method get_TypeCode, addr 0x180720970, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_integer) == 0x38, "Size mismatch!");
