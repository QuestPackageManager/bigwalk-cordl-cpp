...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaParticle_Occurs, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaParticle_Occurs) == 0x4, "Size mismatch!");
...
/// @brief Method GetQualifiedName, addr 0x181ca2380, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_IsEmpty, addr 0x181ca2560, size 0x60, virtual true, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_MaxOccurs, addr 0x181788310, size 0x10, virtual false, abstract: false, final false
inline ::System::Decimal get_MaxOccurs() ;

/// @brief Method get_MaxOccursString, addr 0x181ca25c0, size 0xb0, virtual false, abstract: false, final false
inline ::StringW get_MaxOccursString() ;

/// @brief Method get_MinOccurs, addr 0x180e3e650, size 0xbb40, virtual false, abstract: false, final false
inline ::System::Decimal get_MinOccurs() ;

/// @brief Method get_MinOccursString, addr 0x181ca2670, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_MinOccursString() ;

/// @brief Method get_NameString, addr 0x180393520, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_NameString() ;

static inline void setStaticF_Empty(::System::Xml::Schema::XmlSchemaParticle*  value) ;

/// @brief Method set_MaxOccurs, addr 0x181ca2880, size 0x150, virtual false, abstract: false, final false
inline void set_MaxOccurs(::System::Decimal  value) ;

/// @brief Method set_MaxOccursString, addr 0x181ca26a0, size 0x1e0, virtual false, abstract: false, final false
inline void set_MaxOccursString(::StringW  value) ;

/// @brief Method set_MinOccurs, addr 0x181ca2ae0, size 0x100, virtual false, abstract: false, final false
inline void set_MinOccurs(::System::Decimal  value) ;

/// @brief Method set_MinOccursString, addr 0x181ca29d0, size 0x110, virtual false, abstract: false, final false
