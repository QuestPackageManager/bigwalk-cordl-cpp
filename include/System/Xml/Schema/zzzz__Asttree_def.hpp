...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Asttree*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Asttree*, "System.Xml.Schema", "Asttree");
...
/// @brief Method CompileXPath, addr 0x181d4f220, size 0x7a0, virtual false, abstract: false, final false
inline void CompileXPath(::StringW  xPath, bool  isField, ::System::Xml::XmlNamespaceManager*  nsmgr) ;

/// @brief Method IsAttribute, addr 0x181d4f9c0, size 0x20, virtual false, abstract: false, final false
static inline bool IsAttribute(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsDescendantOrSelf, addr 0x181d4f9e0, size 0x20, virtual false, abstract: false, final false
static inline bool IsDescendantOrSelf(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsNameTest, addr 0x181d4fa00, size 0x20, virtual false, abstract: false, final false
static inline bool IsNameTest(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsSelf, addr 0x181d4fa20, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetURN, addr 0x181d4fa40, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d4fb20, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  xPath, bool  isField, ::System::Xml::XmlNamespaceManager*  nsmgr) ;

/// @brief Method get_SubtreeArray, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Asttree) == 0x30, "Size mismatch!");
