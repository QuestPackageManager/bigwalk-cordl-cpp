...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaCollectionNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaCollectionNode*, "System.Xml.Schema", "XmlSchemaCollectionNode");
...
/// @brief Method get_Schema, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* get_Schema() ;

/// @brief Method get_SchemaInfo, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo() ;

/// @brief Method set_NamespaceURI, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_NamespaceURI(::StringW  value) ;

/// @brief Method set_Schema, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_Schema(::System::Xml::Schema::XmlSchema*  value) ;

/// @brief Method set_SchemaInfo, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaCollectionNode) == 0x28, "Size mismatch!");
