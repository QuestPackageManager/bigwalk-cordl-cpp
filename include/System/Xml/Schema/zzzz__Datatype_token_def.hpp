...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_token*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_token*, "System.Xml.Schema", "Datatype_token");
...
/// @brief Method get_TypeCode, addr 0x1809018a0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_token) == 0x38, "Size mismatch!");
