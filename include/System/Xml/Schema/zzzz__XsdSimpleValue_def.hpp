...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XsdSimpleValue*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdSimpleValue*, "System.Xml.Schema", "XsdSimpleValue");
...
/// @brief Method get_TypedValue, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_TypedValue() ;

/// @brief Method get_XmlType, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XsdSimpleValue) == 0x20, "Size mismatch!");
