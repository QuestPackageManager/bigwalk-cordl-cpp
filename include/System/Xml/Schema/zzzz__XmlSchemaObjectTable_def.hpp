...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType, "System.Xml.Schema", "XmlSchemaObjectTable/EnumeratorType");
...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry, "System.Xml.Schema", "XmlSchemaObjectTable/XmlSchemaObjectEntry");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType) == 0x4, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "qname", ty: "::System::Xml::XmlQualifiedName*", modifiers: "", def_value: None }, CppParam { name: "xso", ty: "::System::Xml::Schema::XmlSchemaObject*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry) == 0x10, "Size mismatch!");
...
/// @brief Field entries, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_entries, put=__cordl_internal_set_entries)) ::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries;
...
/// @brief Method CopyTo, addr 0x181c9d7b0, size 0xb0, virtual true, abstract: false, final true
inline void CopyTo(::System::Array*  array, int32_t  arrayIndex) ;

/// @brief Method GetEnumerator, addr 0x181c9d860, size 0x60, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* GetEnumerator() ;

static inline ::System::Xml::Schema::XmlSchemaObjectTable_ValuesCollection* New_ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries, int32_t  size) ;
...
/// @brief Method get_IsSynchronized, addr 0x181c9d8c0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot, addr 0x180a0ab20, size 0x200, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x181c9dbf0, size 0xb0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::System::Xml::Schema::XmlSchemaObjectTable_XSOEnumerator* New_ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries, int32_t  size, ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType  enumType) ;

/// @brief Method Reset, addr 0x181c9dca0, size 0x40, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181c9d8e0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries, int32_t  size, ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType  enumType) ;

/// @brief Method get_Current, addr 0x181c9dce0, size 0x140, virtual true, abstract: false, final true
...
static inline ::System::Xml::Schema::XmlSchemaObjectTable_XSODictionaryEnumerator* New_ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries, int32_t  size, ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType  enumType) ;

/// @brief Method .ctor, addr 0x181c9d8e0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::List_1<::System::Xml::Schema::XmlSchemaObjectTable_XmlSchemaObjectEntry>*  entries, int32_t  size, ::System::Xml::Schema::XmlSchemaObjectTable_EnumeratorType  enumType) ;

/// @brief Method get_Entry, addr 0x181c9d930, size 0x100, virtual true, abstract: false, final true
inline ::System::Collections::DictionaryEntry get_Entry() ;

/// @brief Method get_Key, addr 0x181c9da30, size 0xe0, virtual true, abstract: false, final true
inline ::System::Object* get_Key() ;

/// @brief Method get_Value, addr 0x181c9db10, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x181ca1dd0, size 0xe0, virtual false, abstract: false, final false
inline void Add(::System::Xml::XmlQualifiedName*  name, ::System::Xml::Schema::XmlSchemaObject*  value) ;

/// @brief Method Clear, addr 0x181ca1eb0, size 0x50, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x181ca1f00, size 0x10, virtual false, abstract: false, final false
inline bool Contains(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method FindIndexByValue, addr 0x181ca1f10, size 0x40, virtual false, abstract: false, final false
inline int32_t FindIndexByValue(::System::Xml::Schema::XmlSchemaObject*  xso) ;

/// @brief Method GetEnumerator, addr 0x181ca1f50, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::IDictionaryEnumerator* GetEnumerator() ;

/// @brief Method Insert, addr 0x181ca1fc0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x181ca20d0, size 0xa0, virtual false, abstract: false, final false
inline void Remove(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method Replace, addr 0x181ca2170, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ca2270, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Count, addr 0x180a0ad20, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x181ca22e0, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* get_Item(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method get_Values, addr 0x181ca2320, size 0x60, virtual false, abstract: false, final false
