...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_dateTimeTimeZone*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_dateTimeTimeZone*, "System.Xml.Schema", "Datatype_dateTimeTimeZone");
...
/// @brief Method .ctor, addr 0x181d6c070, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_dateTimeTimeZone) == 0x40, "Size mismatch!");
