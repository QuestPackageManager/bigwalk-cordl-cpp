...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XdrValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XdrValidator*, "System.Xml.Schema", "XdrValidator");
...
/// @brief Method CheckDefaultValue, addr 0x181c93060, size 0x3c0, virtual false, abstract: false, final false
static inline void CheckDefaultValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef, ::System::Xml::Schema::SchemaInfo*  sinfo, ::System::Xml::XmlNamespaceManager*  nsManager, ::System::Xml::XmlNameTable*  NameTable, ::System::Object*  sender, ::System::Xml::Schema::ValidationEventHandler*  eventhandler, ::StringW  baseUri, int32_t  lineNo, int32_t  linePos) ;
...
/// @brief Method CheckValue, addr 0x181c93540, size 0x3a0, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x181c938e0, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method Init, addr 0x181c93ad0, size 0x1b0, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method LoadSchema, addr 0x181c94160, size 0x1a0, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri) ;

/// @brief Method LoadSchemaFromLocation, addr 0x181c93c80, size 0x4e0, virtual false, abstract: false, final false
inline void LoadSchemaFromLocation(::StringW  uri) ;

static inline ::System::Xml::Schema::XdrValidator* New_ctor(::System::Xml::XmlValidatingReaderImpl*  reader, ::System::Xml::Schema::XmlSchemaCollection*  schemaCollection, ::System::Xml::IValidationEventHandling*  eventHandling) ;

static inline ::System::Xml::Schema::XdrValidator* New_ctor(::System::Xml::Schema::BaseValidator*  validator) ;

/// @brief Method Pop, addr 0x181c94300, size 0xa0, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method ProcessElement, addr 0x181c943a0, size 0xc0, virtual false, abstract: false, final false
inline void ProcessElement() ;

/// @brief Method ProcessInlineSchema, addr 0x181c94460, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Push, addr 0x181c947c0, size 0x140, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method QualifiedName, addr 0x181c94900, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* QualifiedName(::StringW  name, ::StringW  ns) ;

/// @brief Method ThoroughGetElementDecl, addr 0x181c94970, size 0x2d0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* ThoroughGetElementDecl() ;

/// @brief Method Validate, addr 0x181c95860, size 0x1e0, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x181c94c40, size 0x150, virtual false, abstract: false, final false
inline void ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x181c94d90, size 0x310, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x181c950a0, size 0x220, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x181c952c0, size 0x260, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidateStartElement, addr 0x181c95520, size 0x340, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c95a40, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c95ae0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XdrValidator) == 0xc0, "Size mismatch!");
