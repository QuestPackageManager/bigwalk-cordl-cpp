...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaFractionDigitsFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaFractionDigitsFacet*, "System.Xml.Schema", "XmlSchemaFractionDigitsFacet");
...
/// @brief Method .ctor, addr 0x181c9bbd0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaFractionDigitsFacet) == 0x60, "Size mismatch!");
