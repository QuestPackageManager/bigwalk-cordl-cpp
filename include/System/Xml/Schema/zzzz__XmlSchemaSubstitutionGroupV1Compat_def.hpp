...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaSubstitutionGroupV1Compat*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaSubstitutionGroupV1Compat*, "System.Xml.Schema", "XmlSchemaSubstitutionGroupV1Compat");
...
/// @brief Method .ctor, addr 0x181ca9380, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Choice, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaSubstitutionGroupV1Compat) == 0x50, "Size mismatch!");
