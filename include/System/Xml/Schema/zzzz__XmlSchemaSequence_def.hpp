...
/// @brief Method .ctor, addr 0x181ca2db0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsEmpty, addr 0x181ca2e00, size 0x90, virtual true, abstract: false, final false
