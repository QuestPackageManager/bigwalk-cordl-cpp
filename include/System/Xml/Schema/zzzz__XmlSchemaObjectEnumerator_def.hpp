...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaObjectEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaObjectEnumerator*, "System.Xml.Schema", "XmlSchemaObjectEnumerator");
...
/// @brief Method get_Current, addr 0x181ca1d70, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaObjectEnumerator) == 0x18, "Size mismatch!");
