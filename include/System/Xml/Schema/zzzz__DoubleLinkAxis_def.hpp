...
// Write type traits
MARK_REF_T(::System::Xml::Schema::DoubleLinkAxis*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::DoubleLinkAxis*, "System.Xml.Schema", "DoubleLinkAxis");
...
/// @brief Method ConvertTree, addr 0x181d55a30, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d55b40, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::Axis*  axis, ::System::Xml::Schema::DoubleLinkAxis*  inputaxis) ;

/// @brief Method get_Next, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::Axis* get_Next() ;

/// @brief Method set_Next, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::DoubleLinkAxis) == 0x48, "Size mismatch!");
