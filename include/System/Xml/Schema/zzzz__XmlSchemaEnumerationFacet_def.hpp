...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaEnumerationFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaEnumerationFacet*, "System.Xml.Schema", "XmlSchemaEnumerationFacet");
...
/// @brief Method .ctor, addr 0x181c9b010, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaEnumerationFacet) == 0x60, "Size mismatch!");
