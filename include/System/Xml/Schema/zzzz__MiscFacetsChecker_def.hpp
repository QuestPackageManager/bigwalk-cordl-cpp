...
// Write type traits
MARK_REF_T(::System::Xml::Schema::MiscFacetsChecker*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::MiscFacetsChecker*, "System.Xml.Schema", "MiscFacetsChecker");
...
static_assert(sizeof(::System::Xml::Schema::MiscFacetsChecker) == 0x10, "Size mismatch!");
