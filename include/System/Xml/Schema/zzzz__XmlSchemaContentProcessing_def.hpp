...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaContentProcessing, "System.Xml.Schema", "XmlSchemaContentProcessing");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaContentProcessing, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaContentProcessing) == 0x4, "Size mismatch!");
