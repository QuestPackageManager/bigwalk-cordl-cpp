...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_nonNegativeInteger*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_nonNegativeInteger*, "System.Xml.Schema", "Datatype_nonNegativeInteger");
...
/// @brief Method get_FacetsChecker, addr 0x181d6de90, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method get_TypeCode, addr 0x181af5c10, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_nonNegativeInteger) == 0x38, "Size mismatch!");
