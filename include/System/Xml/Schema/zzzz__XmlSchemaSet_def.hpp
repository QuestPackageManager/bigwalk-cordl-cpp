...
/// @brief Method Add, addr 0x181ca3f10, size 0x1a0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x181ca3500, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::StringW  targetNamespace, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x181ca3560, size 0x5e0, virtual false, abstract: false, final false
inline void Add(::System::Xml::Schema::XmlSchemaSet*  schemas) ;

/// @brief Method Add, addr 0x181ca3b40, size 0x3d0, virtual false, abstract: false, final false
inline void Add(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader, ::System::Collections::Hashtable*  validatedNamespaces) ;

/// @brief Method AddSchemaToSet, addr 0x181ca2e90, size 0x370, virtual false, abstract: false, final false
inline void AddSchemaToSet(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method AddToTable, addr 0x181ca3200, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method ClearTables, addr 0x181ca40b0, size 0x240, virtual false, abstract: false, final false
inline void ClearTables() ;

/// @brief Method Compile, addr 0x181ca42f0, size 0x4c0, virtual false, abstract: false, final false
inline void Compile() ;

/// @brief Method Contains, addr 0x181ca47b0, size 0x40, virtual false, abstract: false, final false
inline bool Contains(::StringW  targetNamespace) ;

/// @brief Method CopyFromCompiledSet, addr 0x181ca47f0, size 0x1170, virtual false, abstract: false, final false
inline void CopyFromCompiledSet(::System::Xml::Schema::XmlSchemaSet*  otherSet) ;

/// @brief Method CopyTo, addr 0x181ca5960, size 0xf0, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<::System::Xml::Schema::XmlSchema*>  schemas, int32_t  index) ;

/// @brief Method FindSchemaByNSAndUrl, addr 0x181ca5a50, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method GetEventHandler, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler() ;

/// @brief Method GetResolver, addr 0x181ca5cb0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* GetResolver() ;

/// @brief Method GetSchemaByUri, addr 0x181ca5cc0, size 0x120, virtual false, abstract: false, final false
inline bool GetSchemaByUri(::System::Uri*  schemaUri, ::by_ref<::System::Xml::Schema::XmlSchema*>  schema) ;

/// @brief Method GetSchemaNames, addr 0x181ca5de0, size 0xa0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* GetSchemaNames(::System::Xml::XmlNameTable*  nt) ;

/// @brief Method GetTargetNamespace, addr 0x181ca5e80, size 0x20, virtual false, abstract: false, final false
inline ::StringW GetTargetNamespace(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method InternalValidationCallback, addr 0x181ca5ea0, size 0x30, virtual false, abstract: false, final false
inline void InternalValidationCallback(::System::Object*  sender, ::System::Xml::Schema::ValidationEventArgs*  e) ;

/// @brief Method IsSchemaLoaded, addr 0x181ca5ed0, size 0x340, virtual false, abstract: false, final false
...
/// @brief Method ParseSchema, addr 0x181ca6210, size 0xf0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* ParseSchema(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader) ;

/// @brief Method PreprocessSchema, addr 0x181ca6300, size 0x120, virtual false, abstract: false, final false
inline bool PreprocessSchema(::by_ref<::System::Xml::Schema::XmlSchema*>  schema, ::StringW  targetNamespace) ;

/// @brief Method ProcessNewSubstitutionGroups, addr 0x181ca6420, size 0x2c0, virtual false, abstract: false, final false
inline void ProcessNewSubstitutionGroups(::System::Xml::Schema::XmlSchemaObjectTable*  substitutionGroupsTable, bool  resolve) ;

/// @brief Method Remove, addr 0x181ca79a0, size 0x260, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Remove(::System::Xml::Schema::XmlSchema*  schema, bool  forceCompile) ;

/// @brief Method RemoveRecursive, addr 0x181ca66e0, size 0x6f0, virtual false, abstract: false, final false
inline bool RemoveRecursive(::System::Xml::Schema::XmlSchema*  schemaToRemove) ;

/// @brief Method RemoveSchemaFromCaches, addr 0x181ca6dd0, size 0x330, virtual false, abstract: false, final false
inline void RemoveSchemaFromCaches(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method RemoveSchemaFromGlobalTables, addr 0x181ca7100, size 0x8a0, virtual false, abstract: false, final false
inline void RemoveSchemaFromGlobalTables(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Reprocess, addr 0x181ca7c00, size 0x5a0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Reprocess(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method ResolveSubstitutionGroup, addr 0x181ca81a0, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method Schemas, addr 0x181ca8680, size 0x20, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas() ;

/// @brief Method Schemas, addr 0x181ca8520, size 0x160, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas(::StringW  targetNamespace) ;

/// @brief Method SendValidationEvent, addr 0x181ca86a0, size 0x90, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method VerifyTables, addr 0x181ca8730, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ca8830, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181ca8870, size 0x210, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method add_ValidationEventHandler, addr 0x181ca8a80, size 0x120, virtual false, abstract: false, final false
inline void add_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method get_CompilationSettings, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCompilationSettings* get_CompilationSettings() ;

/// @brief Method get_CompiledInfo, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_CompiledInfo() ;

/// @brief Method get_Count, addr 0x181ca8ba0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_GlobalAttributes, addr 0x181c9d1c0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalAttributes() ;

/// @brief Method get_GlobalElements, addr 0x181c9d230, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalElements() ;

/// @brief Method get_GlobalTypes, addr 0x181c9d310, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalTypes() ;

/// @brief Method get_InternalSyncObject, addr 0x181ca8bc0, size 0x50, virtual false, abstract: false, final false
inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_IsCompiled, addr 0x1803023c0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCompiled() ;

/// @brief Method get_ReaderSettings, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_ReaderSettings() ;

/// @brief Method get_SchemaLocations, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_SchemaLocations() ;

/// @brief Method get_SortedSchemas, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::SortedList* get_SortedSchemas() ;

/// @brief Method get_SubstitutionGroups, addr 0x181c9d4a0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SubstitutionGroups() ;

/// @brief Method get_TypeExtensions, addr 0x181ca8c10, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_TypeExtensions() ;

/// @brief Method remove_ValidationEventHandler, addr 0x181ca8c80, size 0xa0, virtual false, abstract: false, final false
inline void remove_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method set_CompilationSettings, addr 0x1803f5420, size 0x10, virtual false, abstract: false, final false
inline void set_CompilationSettings(::System::Xml::Schema::XmlSchemaCompilationSettings*  value) ;

/// @brief Method set_XmlResolver, addr 0x181ca8d20, size 0x10, virtual false, abstract: false, final false
