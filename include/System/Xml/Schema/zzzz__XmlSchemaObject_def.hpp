...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaObject*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaObject*, "System.Xml.Schema", "XmlSchemaObject");
...
/// @brief Method AddAnnotation, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void AddAnnotation(::System::Xml::Schema::XmlSchemaAnnotation*  annotation) ;

/// @brief Method Clone, addr 0x181c9c5a0, size 0x50, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* Clone() ;

static inline ::System::Xml::Schema::XmlSchemaObject* New_ctor() ;

/// @brief Method OnAdd, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method SetUnhandledAttributes, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_IdAttribute, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_IdAttribute() ;

/// @brief Method get_IsProcessing, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsProcessing() ;

/// @brief Method get_LineNumber, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_NameAttribute, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_Namespaces, addr 0x181c9c5f0, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlSerializerNamespaces* get_Namespaces() ;

/// @brief Method get_Parent, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* get_Parent() ;

/// @brief Method get_SourceUri, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SourceUri() ;

/// @brief Method set_IdAttribute, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void set_IdAttribute(::StringW  value) ;

/// @brief Method set_IsProcessing, addr 0x180499eb0, size 0x10, virtual false, abstract: false, final false
inline void set_IsProcessing(bool  value) ;

/// @brief Method set_LineNumber, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_LineNumber(int32_t  value) ;

/// @brief Method set_LinePosition, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
inline void set_LinePosition(int32_t  value) ;

/// @brief Method set_NameAttribute, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Namespaces, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_Namespaces(::System::Xml::Serialization::XmlSerializerNamespaces*  value) ;

/// @brief Method set_Parent, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_Parent(::System::Xml::Schema::XmlSchemaObject*  value) ;

/// @brief Method set_SourceUri, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaObject) == 0x38, "Size mismatch!");
