...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaKey*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaKey*, "System.Xml.Schema", "XmlSchemaKey");
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaKey) == 0x78, "Size mismatch!");
