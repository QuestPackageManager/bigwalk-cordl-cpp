...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_NMTOKEN*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_NMTOKEN*, "System.Xml.Schema", "Datatype_NMTOKEN");
...
/// @brief Method get_TokenizedType, addr 0x180908af0, size 0x30, virtual true, abstract: false, final false
inline ::System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method get_TypeCode, addr 0x181cea950, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_NMTOKEN) == 0x38, "Size mismatch!");
