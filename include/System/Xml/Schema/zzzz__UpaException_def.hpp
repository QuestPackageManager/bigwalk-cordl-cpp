...
// Write type traits
MARK_REF_T(::System::Xml::Schema::UpaException*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::UpaException*, "System.Xml.Schema", "UpaException");
...
/// @brief Method .ctor, addr 0x181d5c1e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  particle1, ::System::Object*  particle2) ;

/// @brief Method get_Particle1, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_Particle1() ;

/// @brief Method get_Particle2, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::UpaException) == 0xa0, "Size mismatch!");
