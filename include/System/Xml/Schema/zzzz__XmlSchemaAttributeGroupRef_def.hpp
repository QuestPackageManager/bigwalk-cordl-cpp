...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaAttributeGroupRef*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaAttributeGroupRef*, "System.Xml.Schema", "XmlSchemaAttributeGroupRef");
...
/// @brief Method get_RefName, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_RefName() ;

/// @brief Method set_RefName, addr 0x181c971f0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaAttributeGroupRef) == 0x58, "Size mismatch!");
