...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaType, "System.Xml.Schema", "SchemaType");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::SchemaType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::SchemaType) == 0x4, "Size mismatch!");
