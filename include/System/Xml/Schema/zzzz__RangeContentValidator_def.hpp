...
// Write type traits
MARK_REF_T(::System::Xml::Schema::RangeContentValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::RangeContentValidator*, "System.Xml.Schema", "RangeContentValidator");
// Dependencies System.Xml.Schema.BitSet, System.Xml.Schema.ContentValidator
namespace System::Xml::Schema {
// Is value type: false
...
/// @brief Field followpos, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_followpos, put=__cordl_internal_set_followpos)) ::ArrayW<::System::Xml::Schema::BitSet*>  followpos;
...
/// @brief Method CompleteValidation, addr 0x181d78040, size 0x10, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x181d78050, size 0x220, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x181d78270, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x181d78410, size 0x160, virtual true, abstract: false, final false
inline void InitValidation(::System::Xml::Schema::ValidationState*  context) ;

static inline ::System::Xml::Schema::RangeContentValidator* New_ctor(::System::Xml::Schema::BitSet*  firstpos, ::ArrayW<::System::Xml::Schema::BitSet*>  followpos, ::System::Xml::Schema::SymbolsDictionary*  symbols, ::System::Xml::Schema::Positions*  positions, int32_t  endMarkerPos, ::System::Xml::Schema::XmlSchemaContentType  contentType, bool  isEmptiable, ::System::Xml::Schema::BitSet*  positionsWithRangeTerminals, int32_t  minmaxNodesCount) ;

/// @brief Method ValidateElement, addr 0x181d78570, size 0x790, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::Schema::BitSet*> const& __cordl_internal_get_followpos() const;

constexpr ::ArrayW<::System::Xml::Schema::BitSet*>& __cordl_internal_get_followpos() ;
...
constexpr void __cordl_internal_set_followpos(::ArrayW<::System::Xml::Schema::BitSet*>  value) ;
...
/// @brief Method .ctor, addr 0x181d78d00, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Field followpos, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Xml::Schema::BitSet*>  ___followpos;
...
static_assert(sizeof(::System::Xml::Schema::RangeContentValidator) == 0x48, "Size mismatch!");
