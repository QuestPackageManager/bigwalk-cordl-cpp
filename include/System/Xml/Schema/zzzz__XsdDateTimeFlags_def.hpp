...
static_assert(offsetof(::System::Xml::Schema::XsdDateTimeFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XsdDateTimeFlags) == 0x4, "Size mismatch!");
