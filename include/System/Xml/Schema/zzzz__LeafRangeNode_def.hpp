...
// Write type traits
MARK_REF_T(::System::Xml::Schema::LeafRangeNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::LeafRangeNode*, "System.Xml.Schema", "LeafRangeNode");
...
/// @brief Method ExpandTree, addr 0x181d56b50, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d56b90, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Decimal  min, ::System::Decimal  max) ;

/// @brief Method .ctor, addr 0x181d56bb0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  pos, ::System::Decimal  min, ::System::Decimal  max) ;

/// @brief Method get_IsRangeNode, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool get_IsRangeNode() ;

/// @brief Method get_Max, addr 0x180a26490, size 0x12a0, virtual false, abstract: false, final false
inline ::System::Decimal get_Max() ;

/// @brief Method get_Min, addr 0x1802e2d70, size 0x10, virtual false, abstract: false, final false
inline ::System::Decimal get_Min() ;

/// @brief Method get_NextIteration, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::BitSet* get_NextIteration() ;

/// @brief Method set_NextIteration, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::LeafRangeNode) == 0x40, "Size mismatch!");
