...
MARK_REF_T(::System::Xml::Schema::NamespaceList*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::NamespaceList_ListType, "System.Xml.Schema", "NamespaceList/ListType");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::NamespaceList*, "System.Xml.Schema", "NamespaceList");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::NamespaceList_ListType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::NamespaceList_ListType) == 0x4, "Size mismatch!");
...
/// @brief Method Allows, addr 0x181c4a120, size 0x80, virtual true, abstract: false, final false
inline bool Allows(::StringW  ns) ;

/// @brief Method Allows, addr 0x181c4a1a0, size 0x20, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method Clone, addr 0x181c4a1c0, size 0x120, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* Clone() ;

/// @brief Method CompareSetToOther, addr 0x181c4a2e0, size 0xe0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* CompareSetToOther(::System::Xml::Schema::NamespaceList*  other) ;

/// @brief Method Intersection, addr 0x181c4a3c0, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method IsSubset, addr 0x181c4a720, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method RemoveNamespace, addr 0x181c4a900, size 0x60, virtual false, abstract: false, final false
inline void RemoveNamespace(::StringW  tns) ;

/// @brief Method ToString, addr 0x181c4a960, size 0x2b0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Union, addr 0x181c4ac10, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c4af90, size 0x180, virtual false, abstract: false, final false
inline void _ctor(::StringW  namespaces, ::StringW  targetNamespace) ;

/// @brief Method get_Enumerate, addr 0x181c4b110, size 0x40, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* get_Enumerate() ;

/// @brief Method get_Excluded, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::NamespaceList) == 0x28, "Size mismatch!");
