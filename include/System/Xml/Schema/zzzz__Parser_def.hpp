...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Parser*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Parser*, "System.Xml.Schema", "Parser");
...
/// @brief Method CheckSchemaRoot, addr 0x181c4b150, size 0xe0, virtual false, abstract: false, final false
inline bool CheckSchemaRoot(::System::Xml::Schema::SchemaType  rootType, ::by_ref<::StringW>  code) ;

/// @brief Method CreateXmlNsAttribute, addr 0x181c4b230, size 0xf0, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* CreateXmlNsAttribute(::StringW  prefix, ::StringW  value) ;

/// @brief Method FinishParsing, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType FinishParsing() ;

/// @brief Method LoadAttributeNode, addr 0x181c4b320, size 0x1a0, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* LoadAttributeNode() ;

/// @brief Method LoadElementNode, addr 0x181c4b4c0, size 0x4d0, virtual false, abstract: false, final false
inline ::System::Xml::XmlElement* LoadElementNode(bool  root) ;

/// @brief Method LoadEntityReferenceInAttribute, addr 0x181c4b990, size 0x200, virtual false, abstract: false, final false
inline ::System::Xml::XmlEntityReference* LoadEntityReferenceInAttribute() ;

static inline ::System::Xml::Schema::Parser* New_ctor(::System::Xml::Schema::SchemaType  schemaType, ::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::SchemaNames*  schemaNames, ::System::Xml::Schema::ValidationEventHandler*  eventHandler) ;

/// @brief Method Parse, addr 0x181c4c260, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType Parse(::System::Xml::XmlReader*  reader, ::StringW  targetNamespace) ;

/// @brief Method ParseReaderNode, addr 0x181c4bb90, size 0x6d0, virtual false, abstract: false, final false
inline bool ParseReaderNode() ;

/// @brief Method ProcessAppInfoDocMarkup, addr 0x181c4c2c0, size 0x2a0, virtual false, abstract: false, final false
inline void ProcessAppInfoDocMarkup(bool  root) ;

/// @brief Method StartParsing, addr 0x181c4c560, size 0x470, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c4c9d0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::SchemaType  schemaType, ::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::SchemaNames*  schemaNames, ::System::Xml::Schema::ValidationEventHandler*  eventHandler) ;

/// @brief Method get_XdrSchema, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_XdrSchema() ;

/// @brief Method get_XmlSchema, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* get_XmlSchema() ;

/// @brief Method set_XmlResolver, addr 0x1803d5ad0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Parser) == 0xa8, "Size mismatch!");
