...
/// @brief Method Equal, addr 0x181d50210, size 0x70, virtual false, abstract: false, final false
static inline bool Equal(::StringW  thisname, ::StringW  thisURN, ::StringW  name, ::StringW  URN) ;

/// @brief Method MoveToAttribute, addr 0x181d50280, size 0x190, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToChild, addr 0x181d50410, size 0x270, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToParent, addr 0x181d50680, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x181d50900, size 0x40, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method Push, addr 0x181d50940, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d509c0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::ForwardAxis*  faxis, ::System::Xml::Schema::ActiveAxis*  parent) ;

/// @brief Method get_Length, addr 0x1816c5ef0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Subtree, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
