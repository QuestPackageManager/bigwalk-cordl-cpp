...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ValidatorState, "System.Xml.Schema", "ValidatorState");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::ValidatorState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::ValidatorState) == 0x4, "Size mismatch!");
