...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_dateTime*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_dateTime*, "System.Xml.Schema", "Datatype_dateTime");
...
/// @brief Method .ctor, addr 0x181d6c0a0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_dateTime) == 0x40, "Size mismatch!");
