...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_timeNoTimeZone*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_timeNoTimeZone*, "System.Xml.Schema", "Datatype_timeNoTimeZone");
...
/// @brief Method .ctor, addr 0x181d6e4f0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::Datatype_timeNoTimeZone) == 0x40, "Size mismatch!");
