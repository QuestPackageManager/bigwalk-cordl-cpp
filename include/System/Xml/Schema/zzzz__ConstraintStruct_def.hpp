...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ConstraintStruct*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ConstraintStruct*, "System.Xml.Schema", "ConstraintStruct");
...
/// @brief Method .ctor, addr 0x181d55000, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::CompiledIdentityConstraint*  constraint) ;

/// @brief Method get_TableDim, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ConstraintStruct) == 0x40, "Size mismatch!");
