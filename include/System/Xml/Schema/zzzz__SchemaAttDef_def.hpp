...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaAttDef_Reserve, "System.Xml.Schema", "SchemaAttDef/Reserve");
...
static_assert(offsetof(::System::Xml::Schema::SchemaAttDef_Reserve, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::SchemaAttDef_Reserve) == 0x4, "Size mismatch!");
...
/// @brief Method CheckXmlSpace, addr 0x181c5dd20, size 0x200, virtual false, abstract: false, final false
inline void CheckXmlSpace(::System::Xml::IValidationEventHandling*  validationEventHandling) ;

/// @brief Method Clone, addr 0x181c5df20, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IDtdAttributeInfo.get_IsDeclaredInExternal, addr 0x1803a7410, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdAttributeInfo_get_IsDeclaredInExternal() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_IsNonCDataType, addr 0x181c5df60, size 0x30, virtual true, abstract: false, final true
inline bool System_Xml_IDtdAttributeInfo_get_IsNonCDataType() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_IsXmlAttribute, addr 0x181c5df90, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdAttributeInfo_get_IsXmlAttribute() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LineNumber, addr 0x1803d5ab0, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IDtdAttributeInfo_get_LineNumber() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LinePosition, addr 0x1803fa750, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IDtdAttributeInfo_get_LinePosition() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LocalName, addr 0x181050e30, size 0x25b20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdAttributeInfo_get_LocalName() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_Prefix, addr 0x181c5dfa0, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdAttributeInfo_get_Prefix() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueExpanded, addr 0x181c5dfb0, size 0x20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueExpanded() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueTyped, addr 0x1802e5850, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueTyped() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLineNumber, addr 0x1803fa740, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IDtdDefaultAttributeInfo_get_ValueLineNumber() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLinePosition, addr 0x18051e7a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181c5e040, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181c5e020, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method .ctor, addr 0x181c5e030, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_DefaultValueChecked, addr 0x1813ece20, size 0x10, virtual false, abstract: false, final false
inline bool get_DefaultValueChecked() ;

/// @brief Method get_DefaultValueExpanded, addr 0x181c5e050, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DefaultValueExpanded() ;

/// @brief Method get_LineNumber, addr 0x1803d5ab0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x1803fa750, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_Reserved, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaAttDef_Reserve get_Reserved() ;

/// @brief Method get_SchemaAttribute, addr 0x1802ec4c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_TokenizedType, addr 0x181c5e070, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method get_ValueLineNumber, addr 0x1803fa740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ValueLineNumber() ;

/// @brief Method get_ValueLinePosition, addr 0x18051e7a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DefaultValueExpanded, addr 0x1803d49a0, size 0x10, virtual false, abstract: false, final false
inline void set_DefaultValueExpanded(::StringW  value) ;

/// @brief Method set_LineNumber, addr 0x1803d5ac0, size 0x10, virtual false, abstract: false, final false
inline void set_LineNumber(int32_t  value) ;

/// @brief Method set_LinePosition, addr 0x1804a5a80, size 0x10, virtual false, abstract: false, final false
inline void set_LinePosition(int32_t  value) ;

/// @brief Method set_Reserved, addr 0x180511560, size 0x10, virtual false, abstract: false, final false
inline void set_Reserved(::System::Xml::Schema::SchemaAttDef_Reserve  value) ;

/// @brief Method set_SchemaAttribute, addr 0x1803117a0, size 0x10, virtual false, abstract: false, final false
inline void set_SchemaAttribute(::System::Xml::Schema::XmlSchemaAttribute*  value) ;

/// @brief Method set_TokenizedType, addr 0x181c5e090, size 0x30, virtual false, abstract: false, final false
inline void set_TokenizedType(::System::Xml::XmlTokenizedType  value) ;

/// @brief Method set_ValueLineNumber, addr 0x18051e950, size 0x10, virtual false, abstract: false, final false
inline void set_ValueLineNumber(int32_t  value) ;

/// @brief Method set_ValueLinePosition, addr 0x18051e940, size 0x10, virtual false, abstract: false, final false
