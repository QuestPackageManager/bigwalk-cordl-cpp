...
/// @brief Field ks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_ks, put=__cordl_internal_set_ks)) ::ArrayW<::System::Xml::Schema::TypedObject*>  ks;
...
/// @brief Method Equals, addr 0x181d56580, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x181d56630, size 0x2f0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsQualified, addr 0x181d56920, size 0x40, virtual false, abstract: false, final false
inline bool IsQualified() ;

static inline ::System::Xml::Schema::KeySequence* New_ctor(int32_t  dim, int32_t  line, int32_t  col) ;

/// @brief Method ToString, addr 0x181d56960, size 0xf0, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::Schema::TypedObject*> const& __cordl_internal_get_ks() const;

constexpr ::ArrayW<::System::Xml::Schema::TypedObject*>& __cordl_internal_get_ks() ;
...
constexpr void __cordl_internal_set_ks(::ArrayW<::System::Xml::Schema::TypedObject*>  value) ;

constexpr void __cordl_internal_set_poscol(int32_t  value) ;

constexpr void __cordl_internal_set_posline(int32_t  value) ;

/// @brief Method .ctor, addr 0x181d56a50, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_PosCol, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_PosCol() ;

/// @brief Method get_PosLine, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_PosLine() ;

/// @brief Method set_Item, addr 0x181d56ab0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::KeySequence) == 0x28, "Size mismatch!");
