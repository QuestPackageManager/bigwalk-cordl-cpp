...
/// @brief Field globalIdCounter, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_globalIdCounter, put=setStaticF_globalIdCounter)) int32_t  globalIdCounter;
...
/// @brief Field moreAttributes, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_moreAttributes, put=__cordl_internal_set_moreAttributes)) ::ArrayW<::System::Xml::XmlAttribute*>  moreAttributes;
...
/// @brief Method AddAnnotation, addr 0x181c9c660, size 0x30, virtual true, abstract: false, final false
inline void AddAnnotation(::System::Xml::Schema::XmlSchemaAnnotation*  annotation) ;

/// @brief Method Clone, addr 0x181c9c690, size 0xf0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Clone() ;

/// @brief Method CompileSchema, addr 0x181c9c810, size 0x190, virtual false, abstract: false, final false
inline bool CompileSchema(::System::Xml::Schema::XmlSchemaCollection*  xsc, ::System::Xml::XmlResolver*  resolver, ::System::Xml::Schema::SchemaInfo*  schemaInfo, ::StringW  ns, ::System::Xml::Schema::ValidationEventHandler*  validationEventHandler, ::System::Xml::XmlNameTable*  nameTable, bool  CompileContentModel) ;

/// @brief Method CompileSchemaInSet, addr 0x181c9c780, size 0x90, virtual false, abstract: false, final false
inline void CompileSchemaInSet(::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::ValidationEventHandler*  eventHandler, ::System::Xml::Schema::XmlSchemaCompilationSettings*  compilationSettings) ;

/// @brief Method DeepClone, addr 0x181c9c9a0, size 0x380, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* DeepClone() ;

/// @brief Method GetExternalSchemasList, addr 0x181c9cd20, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x181c9ceb0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SetIsCompiled, addr 0x1803cf510, size 0x10, virtual false, abstract: false, final false
inline void SetIsCompiled(bool  isCompiled) ;

/// @brief Method SetUnhandledAttributes, addr 0x1803d5ad0, size 0x10, virtual true, abstract: false, final false
...
constexpr ::System::Collections::ArrayList* const& __cordl_internal_get_importedNamespaces() const;

constexpr ::System::Collections::ArrayList*& __cordl_internal_get_importedNamespaces() ;

constexpr ::System::Collections::ArrayList* const& __cordl_internal_get_importedSchemas() const;

constexpr ::System::Collections::ArrayList*& __cordl_internal_get_importedSchemas() ;

constexpr ::System::Xml::Schema::XmlSchemaObjectCollection* const& __cordl_internal_get_includes() const;
...
constexpr ::ArrayW<::System::Xml::XmlAttribute*> const& __cordl_internal_get_moreAttributes() const;

constexpr ::ArrayW<::System::Xml::XmlAttribute*>& __cordl_internal_get_moreAttributes() ;
...
/// @brief Method .ctor, addr 0x181c9cff0, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF_globalIdCounter() ;

/// @brief Method get_AttributeFormDefault, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaForm get_AttributeFormDefault() ;

/// @brief Method get_AttributeGroups, addr 0x181c9d1c0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups() ;

/// @brief Method get_Attributes, addr 0x181c9d230, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Attributes() ;

/// @brief Method get_BaseUri, addr 0x1803b2f10, size 0x10, virtual false, abstract: false, final false
inline ::System::Uri* get_BaseUri() ;

/// @brief Method get_BlockDefault, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_BlockDefault() ;

/// @brief Method get_Document, addr 0x181c9d2a0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_Document() ;

/// @brief Method get_ElementFormDefault, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaForm get_ElementFormDefault() ;

/// @brief Method get_Elements, addr 0x181c9d310, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Elements() ;

/// @brief Method get_ErrorCount, addr 0x180371740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ErrorCount() ;

/// @brief Method get_FinalDefault, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_FinalDefault() ;

/// @brief Method get_Groups, addr 0x1802ec4d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups() ;

/// @brief Method get_Id, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method get_IdAttribute, addr 0x1802e5710, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_IdAttribute() ;

/// @brief Method get_IdentityConstraints, addr 0x180322760, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_IdentityConstraints() ;

/// @brief Method get_Ids, addr 0x1803459d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_Ids() ;

/// @brief Method get_ImportedNamespaces, addr 0x181c9d380, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_ImportedNamespaces() ;

/// @brief Method get_ImportedSchemas, addr 0x181c9d3f0, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_ImportedSchemas() ;

/// @brief Method get_Includes, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Includes() ;

/// @brief Method get_IsChameleon, addr 0x1805e8f80, size 0x10, virtual false, abstract: false, final false
inline bool get_IsChameleon() ;

/// @brief Method get_IsCompiledBySet, addr 0x18048f650, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCompiledBySet() ;

/// @brief Method get_IsPreprocessed, addr 0x181b87e60, size 0x10, virtual false, abstract: false, final false
inline bool get_IsPreprocessed() ;

/// @brief Method get_IsRedefined, addr 0x181c9ae70, size 0x10, virtual false, abstract: false, final false
inline bool get_IsRedefined() ;

/// @brief Method get_Items, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items() ;

/// @brief Method get_Notations, addr 0x180322750, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Notations() ;

/// @brief Method get_SchemaId, addr 0x181c9d460, size 0x40, virtual false, abstract: false, final false
inline int32_t get_SchemaId() ;

/// @brief Method get_SchemaTypes, addr 0x181c9d4a0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SchemaTypes() ;

/// @brief Method get_TargetNamespace, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_TargetNamespace() ;

/// @brief Method get_Version, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Version() ;

static inline void setStaticF_globalIdCounter(int32_t  value) ;

/// @brief Method set_AttributeFormDefault, addr 0x180393000, size 0x10, virtual false, abstract: false, final false
inline void set_AttributeFormDefault(::System::Xml::Schema::XmlSchemaForm  value) ;

/// @brief Method set_BaseUri, addr 0x1813fdbb0, size 0x20, virtual false, abstract: false, final false
inline void set_BaseUri(::System::Uri*  value) ;

/// @brief Method set_BlockDefault, addr 0x180511530, size 0x10, virtual false, abstract: false, final false
inline void set_BlockDefault(::System::Xml::Schema::XmlSchemaDerivationMethod  value) ;

/// @brief Method set_ElementFormDefault, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_ElementFormDefault(::System::Xml::Schema::XmlSchemaForm  value) ;

/// @brief Method set_ErrorCount, addr 0x18154a190, size 0x10, virtual false, abstract: false, final false
inline void set_ErrorCount(int32_t  value) ;

/// @brief Method set_FinalDefault, addr 0x180511580, size 0x10, virtual false, abstract: false, final false
inline void set_FinalDefault(::System::Xml::Schema::XmlSchemaDerivationMethod  value) ;

/// @brief Method set_Id, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
inline void set_Id(::StringW  value) ;

/// @brief Method set_IdAttribute, addr 0x1802e5a20, size 0x10, virtual true, abstract: false, final false
inline void set_IdAttribute(::StringW  value) ;

/// @brief Method set_IsChameleon, addr 0x1805e90d0, size 0x10, virtual false, abstract: false, final false
inline void set_IsChameleon(bool  value) ;

/// @brief Method set_IsCompiledBySet, addr 0x1805d6e00, size 0x10, virtual false, abstract: false, final false
inline void set_IsCompiledBySet(bool  value) ;

/// @brief Method set_IsPreprocessed, addr 0x181b88060, size 0x10, virtual false, abstract: false, final false
inline void set_IsPreprocessed(bool  value) ;

/// @brief Method set_IsRedefined, addr 0x181c9d510, size 0x1e0, virtual false, abstract: false, final false
inline void set_IsRedefined(bool  value) ;

/// @brief Method set_TargetNamespace, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_TargetNamespace(::StringW  value) ;

/// @brief Method set_Version, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field moreAttributes, offset: 0x70, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlAttribute*>  ___moreAttributes;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchema) == 0xf0, "Size mismatch!");
