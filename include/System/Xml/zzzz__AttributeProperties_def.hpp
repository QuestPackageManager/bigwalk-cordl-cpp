...
DEFINE_IL2CPP_CLASS(::System::Xml::AttributeProperties, "System.Xml", "AttributeProperties");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::AttributeProperties, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::AttributeProperties) == 0x4, "Size mismatch!");
