...
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::SaveOptions, "System.Xml.Linq", "SaveOptions");
// Dependencies 
namespace System::Xml::Linq {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Linq::SaveOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Linq::SaveOptions) == 0x4, "Size mismatch!");
