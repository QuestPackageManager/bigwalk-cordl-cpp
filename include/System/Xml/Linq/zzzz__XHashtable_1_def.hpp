...
namespace System::Xml::Linq {
template<typename TValue>
class XHashtable_1_ExtractKeyDelegate;
}
namespace System::Xml::Linq {
template<typename TValue>
class XHashtable_1_XHashtableState;
}
namespace System {
struct IntPtr;
}
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Xml::Linq::XHashtable_1);
MARK_GEN_REF_T_PTR(::System::Xml::Linq::XHashtable_1_ExtractKeyDelegate);
MARK_GEN_REF_T_PTR(::System::Xml::Linq::XHashtable_1_XHashtableState);
MARK_GEN_VAL_T(::System::Xml::Linq::XHashtableState_XHashtable_1_Entry);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Xml::Linq::XHashtable_1, "System.Xml.Linq", "XHashtable`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Xml::Linq::XHashtable_1_ExtractKeyDelegate, "System.Xml.Linq", "XHashtable`1/ExtractKeyDelegate");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Xml::Linq::XHashtable_1_XHashtableState, "System.Xml.Linq", "XHashtable`1/XHashtableState");
DEFINE_IL2CPP_GEN_CLASS(::System::Xml::Linq::XHashtableState_XHashtable_1_Entry, "System.Xml.Linq", "XHashtable`1/XHashtableState/Entry");
...
// Dependencies System.Object, System.Xml.Linq.XHashtable`1::XHashtableState::Entry<TValue>
namespace System::Xml::Linq {
// cpp template
template<typename TValue>
// Is value type: false
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>>  _entries;
...
inline bool FindEntry(int32_t  hashCode, ::StringW  key, int32_t  index, int32_t  count, ::by_ref<int32_t>  entryIndex) ;
...
inline bool TryAdd(TValue  value, ::by_ref<TValue>  newValue) ;

/// @brief Method TryGetValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool TryGetValue(::StringW  key, int32_t  index, int32_t  count, ::by_ref<TValue>  value) ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get__buckets() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__buckets() ;

constexpr ::ArrayW<::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>> const& __cordl_internal_get__entries() const;

constexpr ::ArrayW<::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>>& __cordl_internal_get__entries() ;
...
constexpr void __cordl_internal_set__entries(::ArrayW<::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>>  value) ;
...
/// @brief Field _entries, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Xml::Linq::XHashtableState_XHashtable_1_Entry<TValue>>  ____entries;
