...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlNodeEventHandler*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlNodeEventHandler*, "System.Xml.Serialization", "XmlNodeEventHandler");
...
static_assert(sizeof(::System::Xml::Serialization::XmlNodeEventHandler) == 0x80, "Size mismatch!");
