...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlAnyElementAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlAnyElementAttribute*, "System.Xml.Serialization", "XmlAnyElementAttribute");
...
/// @brief Method AddKeyHash, addr 0x181d2fa10, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Name, addr 0x181d2fa80, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Namespace, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_Order, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlAnyElementAttribute) == 0x28, "Size mismatch!");
