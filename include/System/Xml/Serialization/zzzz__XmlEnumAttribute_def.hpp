...
/// @brief Method AddKeyHash, addr 0x181d3d2f0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlEnumAttribute) == 0x18, "Size mismatch!");
