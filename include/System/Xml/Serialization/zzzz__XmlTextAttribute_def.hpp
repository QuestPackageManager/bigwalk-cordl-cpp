...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTextAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTextAttribute*, "System.Xml.Serialization", "XmlTextAttribute");
...
/// @brief Method AddKeyHash, addr 0x181d60cb0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlTextAttribute) == 0x20, "Size mismatch!");
