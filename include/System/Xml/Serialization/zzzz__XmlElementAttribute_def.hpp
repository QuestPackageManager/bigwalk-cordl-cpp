...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlElementAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlElementAttribute*, "System.Xml.Serialization", "XmlElementAttribute");
...
/// @brief Method AddKeyHash, addr 0x181d3cdb0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d3cf10, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  elementName) ;

/// @brief Method .ctor, addr 0x181d3ced0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  elementName, ::System::Type*  type) ;

/// @brief Method get_DataType, addr 0x181d2fa80, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DataType() ;

/// @brief Method get_ElementName, addr 0x181d3a1b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_IsNullable, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_Namespace, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_Order, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Order() ;

/// @brief Method get_Type, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlElementAttribute) == 0x48, "Size mismatch!");
