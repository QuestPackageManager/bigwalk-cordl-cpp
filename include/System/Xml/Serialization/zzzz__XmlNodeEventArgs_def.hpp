...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlNodeEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlNodeEventArgs*, "System.Xml.Serialization", "XmlNodeEventArgs");
...
/// @brief Method .ctor, addr 0x181d37f60, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlNodeEventArgs) == 0x28, "Size mismatch!");
