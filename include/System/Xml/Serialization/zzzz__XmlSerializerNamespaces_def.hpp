...
/// @brief Method Add, addr 0x181d39060, size 0xd0, virtual false, abstract: false, final false
inline void Add(::StringW  prefix, ::StringW  ns) ;

/// @brief Method AddInternal, addr 0x181d38fe0, size 0x80, virtual false, abstract: false, final false
inline void AddInternal(::StringW  prefix, ::StringW  ns) ;

static inline ::System::Xml::Serialization::XmlSerializerNamespaces* New_ctor() ;

/// @brief Method ToArray, addr 0x181d39130, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x181d391d0, size 0x60, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_NamespaceList, addr 0x181d39230, size 0x330, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_NamespaceList() ;

/// @brief Method get_Namespaces, addr 0x181640290, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_Namespaces() ;

/// @brief Method set_Namespaces, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
