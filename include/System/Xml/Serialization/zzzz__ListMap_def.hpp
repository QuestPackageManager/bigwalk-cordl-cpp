...
/// @brief Method Equals, addr 0x181d56bd0, size 0x150, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method FindElement, addr 0x181d571c0, size 0x180, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindElement(::StringW  elementName, ::StringW  ns) ;

/// @brief Method FindElement, addr 0x181d56d20, size 0x4a0, virtual false, abstract: false, final false
...
/// @brief Method FindTextElement, addr 0x181d57340, size 0x170, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindTextElement() ;

/// @brief Method GetArrayType, addr 0x181d574b0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method get_ItemInfo, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ItemInfo() ;

/// @brief Method set_ChoiceMember, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ItemInfo, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
