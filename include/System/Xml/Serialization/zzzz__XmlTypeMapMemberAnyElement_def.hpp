...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTypeMapMemberAnyElement*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTypeMapMemberAnyElement*, "System.Xml.Serialization", "XmlTypeMapMemberAnyElement");
...
/// @brief Method IsElementDefined, addr 0x181d61130, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method get_IsDefaultAny, addr 0x181d61330, size 0x1b0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlTypeMapMemberAnyElement) == 0x80, "Size mismatch!");
