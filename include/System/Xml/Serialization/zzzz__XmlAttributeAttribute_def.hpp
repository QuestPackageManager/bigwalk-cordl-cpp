...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlAttributeAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlAttributeAttribute*, "System.Xml.Serialization", "XmlAttributeAttribute");
...
/// @brief Method AddKeyHash, addr 0x181d3a470, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeName, addr 0x181d2fa80, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_AttributeName() ;

/// @brief Method get_DataType, addr 0x181d3a1b0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DataType() ;

/// @brief Method get_Form, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaForm get_Form() ;

/// @brief Method get_Namespace, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method set_DataType, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlAttributeAttribute) == 0x38, "Size mismatch!");
