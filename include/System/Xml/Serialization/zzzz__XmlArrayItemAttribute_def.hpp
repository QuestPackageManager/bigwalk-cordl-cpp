...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlArrayItemAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlArrayItemAttribute*, "System.Xml.Serialization", "XmlArrayItemAttribute");
...
/// @brief Method AddKeyHash, addr 0x181d3a060, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_IsNullableSpecified, addr 0x18049c410, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_NestingLevel, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlArrayItemAttribute) == 0x40, "Size mismatch!");
