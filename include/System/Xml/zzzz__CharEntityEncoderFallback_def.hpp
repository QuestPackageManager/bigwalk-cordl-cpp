...
// Write type traits
MARK_REF_T(::System::Xml::CharEntityEncoderFallback*);
DEFINE_IL2CPP_CLASS(::System::Xml::CharEntityEncoderFallback*, "System.Xml", "CharEntityEncoderFallback");
...
/// @brief Method CanReplaceAt, addr 0x181c21e00, size 0x40, virtual false, abstract: false, final false
inline bool CanReplaceAt(int32_t  index) ;

/// @brief Method CreateFallbackBuffer, addr 0x181c21e40, size 0x90, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

static inline ::System::Xml::CharEntityEncoderFallback* New_ctor() ;

/// @brief Method Reset, addr 0x181c21ed0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_MaxCharCount, addr 0x180901900, size 0x10, virtual true, abstract: false, final false
inline int32_t get_MaxCharCount() ;

/// @brief Method set_StartOffset, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::CharEntityEncoderFallback) == 0x30, "Size mismatch!");
