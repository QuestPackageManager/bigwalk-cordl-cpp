...
// Write type traits
MARK_REF_T(::System::Xml::XmlCachedStream*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlCachedStream*, "System.Xml", "XmlCachedStream");
...
/// @brief Method .ctor, addr 0x181d2ff70, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlCachedStream) == 0x58, "Size mismatch!");
