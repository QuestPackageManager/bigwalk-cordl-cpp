...
// Write type traits
MARK_REF_T(::System::Xml::XmlEncodedRawTextWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlEncodedRawTextWriter*, "System.Xml", "XmlEncodedRawTextWriter");
...
/// @brief Field bufBytes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_bufBytes, put=__cordl_internal_set_bufBytes)) ::ArrayW<uint8_t>  bufBytes;
...
/// @brief Field bufChars, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_bufChars, put=__cordl_internal_set_bufChars)) ::ArrayW<char16_t>  bufChars;
...
/// @brief Method AmpEntity, addr 0x181ce1950, size 0x20, virtual false, abstract: false, final false
static inline char16_t* AmpEntity(char16_t*  pDst) ;

/// @brief Method CarriageReturnEntity, addr 0x181ce1970, size 0x20, virtual false, abstract: false, final false
static inline char16_t* CarriageReturnEntity(char16_t*  pDst) ;

/// @brief Method ChangeTextContentMark, addr 0x181ce1990, size 0xa0, virtual false, abstract: false, final false
inline void ChangeTextContentMark(bool  value) ;

/// @brief Method CharEntity, addr 0x181ce1a30, size 0x90, virtual false, abstract: false, final false
static inline char16_t* CharEntity(char16_t*  pDst, char16_t  ch) ;

/// @brief Method Close, addr 0x181ce1ac0, size 0x70, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EncodeChar, addr 0x181ce1b30, size 0xc0, virtual false, abstract: false, final false
inline void EncodeChar(::by_ref<char16_t*>  pSrc, char16_t*  pSrcEnd, ::by_ref<char16_t*>  pDst) ;

/// @brief Method EncodeChars, addr 0x181ce1bf0, size 0x150, virtual false, abstract: false, final false
inline void EncodeChars(int32_t  startOffset, int32_t  endOffset, bool  writeAllToStream) ;

/// @brief Method EncodeSurrogate, addr 0x181ce1d40, size 0xc0, virtual false, abstract: false, final false
static inline char16_t* EncodeSurrogate(char16_t*  pSrc, char16_t*  pSrcEnd, char16_t*  pDst) ;

/// @brief Method Flush, addr 0x181ce2210, size 0x80, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushBuffer, addr 0x181ce1e00, size 0x350, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method FlushEncoder, addr 0x181ce2150, size 0xc0, virtual false, abstract: false, final false
inline void FlushEncoder() ;

/// @brief Method GrowTextContentMarks, addr 0x181ce2290, size 0x70, virtual false, abstract: false, final false
inline void GrowTextContentMarks() ;

/// @brief Method GtEntity, addr 0x181ce2300, size 0x20, virtual false, abstract: false, final false
static inline char16_t* GtEntity(char16_t*  pDst) ;

/// @brief Method InvalidXmlChar, addr 0x181ce2320, size 0xe0, virtual false, abstract: false, final false
inline char16_t* InvalidXmlChar(int32_t  ch, char16_t*  pDst, bool  entitize) ;

/// @brief Method LineFeedEntity, addr 0x181ce2400, size 0x20, virtual false, abstract: false, final false
static inline char16_t* LineFeedEntity(char16_t*  pDst) ;

/// @brief Method LtEntity, addr 0x181ce2420, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method QuoteEntity, addr 0x181ce2440, size 0x20, virtual false, abstract: false, final false
static inline char16_t* QuoteEntity(char16_t*  pDst) ;

/// @brief Method RawEndCData, addr 0x181ce2460, size 0x20, virtual false, abstract: false, final false
static inline char16_t* RawEndCData(char16_t*  pDst) ;

/// @brief Method RawStartCData, addr 0x181ce2480, size 0x30, virtual false, abstract: false, final false
static inline char16_t* RawStartCData(char16_t*  pDst) ;

/// @brief Method RawText, addr 0x181ce24b0, size 0x230, virtual false, abstract: false, final false
inline void RawText(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method RawText, addr 0x181ce26e0, size 0x40, virtual false, abstract: false, final false
inline void RawText(::StringW  s) ;

/// @brief Method StartElementContent, addr 0x181ce2720, size 0x20, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method TabEntity, addr 0x181ce2740, size 0x20, virtual false, abstract: false, final false
static inline char16_t* TabEntity(char16_t*  pDst) ;

/// @brief Method ValidateContentChars, addr 0x181ce2760, size 0x2d0, virtual false, abstract: false, final false
inline void ValidateContentChars(::StringW  chars, ::StringW  propertyName, bool  allowOnlyWhitespace) ;

/// @brief Method WriteAttributeTextBlock, addr 0x181ce2a30, size 0x440, virtual false, abstract: false, final false
inline void WriteAttributeTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteCData, addr 0x181ce32a0, size 0x170, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCDataSection, addr 0x181ce2e70, size 0x430, virtual false, abstract: false, final false
inline void WriteCDataSection(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181ce3410, size 0x150, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x181c22ad0, size 0x80, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x181ce39a0, size 0xf0, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteCommentOrPi, addr 0x181ce3560, size 0x440, virtual false, abstract: false, final false
inline void WriteCommentOrPi(::StringW  text, int32_t  stopChar) ;

/// @brief Method WriteDocType, addr 0x181ce3a90, size 0x230, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteElementTextBlock, addr 0x181ce3cc0, size 0x480, virtual false, abstract: false, final false
inline void WriteElementTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteEndAttribute, addr 0x181ce4140, size 0x50, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x181ce4190, size 0x120, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteEndNamespaceDeclaration, addr 0x181ce42b0, size 0x50, virtual true, abstract: false, final false
inline void WriteEndNamespaceDeclaration() ;

/// @brief Method WriteEntityRef, addr 0x181ce4300, size 0xb0, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x181ce43b0, size 0xf0, virtual true, abstract: false, final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteNamespaceDeclaration, addr 0x181ce44a0, size 0x60, virtual true, abstract: false, final false
inline void WriteNamespaceDeclaration(::StringW  prefix, ::StringW  namespaceName) ;

/// @brief Method WriteNewLine, addr 0x181ce4500, size 0x90, virtual false, abstract: false, final false
inline char16_t* WriteNewLine(char16_t*  pDst) ;

/// @brief Method WriteProcessingInstruction, addr 0x181ce4590, size 0x100, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x181ce48f0, size 0x80, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cdc400, size 0x70, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteRawWithCharChecking, addr 0x181ce4690, size 0x260, virtual false, abstract: false, final false
inline void WriteRawWithCharChecking(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method WriteStartAttribute, addr 0x181ce4970, size 0x100, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x181ce4a70, size 0xd0, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartNamespaceDeclaration, addr 0x181ce4b40, size 0x120, virtual true, abstract: false, final false
inline void WriteStartNamespaceDeclaration(::StringW  prefix) ;

/// @brief Method WriteString, addr 0x181ce4c60, size 0x80, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181ce4ce0, size 0x100, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x181ce4de0, size 0x80, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteXmlDeclaration, addr 0x181ce4e60, size 0x1d0, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x181ce5030, size 0x40, virtual true, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_bufBytes() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_bufBytes() ;

constexpr int32_t const& __cordl_internal_get_bufBytesUsed() const;

constexpr int32_t& __cordl_internal_get_bufBytesUsed() ;

constexpr ::ArrayW<char16_t> const& __cordl_internal_get_bufChars() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_bufChars() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_textContentMarks() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_textContentMarks() ;
...
constexpr void __cordl_internal_set_bufBytes(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_bufBytesUsed(int32_t  value) ;

constexpr void __cordl_internal_set_bufChars(::ArrayW<char16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181ce5070, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x181ce5150, size 0x2b0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x181ce5400, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  writer, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method get_SupportsNamespaceDeclarationInChunks, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
...
/// @brief Field textContentMarks, offset: 0x90, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___textContentMarks;
...
static_assert(sizeof(::System::Xml::XmlEncodedRawTextWriter) == 0xc0, "Size mismatch!");
