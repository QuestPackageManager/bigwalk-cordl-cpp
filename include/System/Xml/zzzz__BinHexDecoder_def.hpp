...
// Write type traits
MARK_REF_T(::System::Xml::BinHexDecoder*);
DEFINE_IL2CPP_CLASS(::System::Xml::BinHexDecoder*, "System.Xml", "BinHexDecoder");
...
/// @brief Method Decode, addr 0x181c1e170, size 0x260, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t> Decode(::ArrayW<char16_t>  chars, bool  allowOddChars) ;

/// @brief Method Decode, addr 0x181c1e530, size 0x110, virtual true, abstract: false, final false
inline int32_t Decode(::ArrayW<char16_t>  chars, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x181c1e3d0, size 0x160, virtual false, abstract: false, final false
static inline void Decode(char16_t*  pChars, char16_t*  pCharsEndPos, uint8_t*  pBytes, uint8_t*  pBytesEndPos, ::by_ref<bool>  hasHalfByteCached, ::by_ref<uint8_t>  cachedHalfByte, ::by_ref<int32_t>  charsDecoded, ::by_ref<int32_t>  bytesDecoded) ;
...
/// @brief Method get_IsFull, addr 0x181c1e640, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::BinHexDecoder) == 0x28, "Size mismatch!");
