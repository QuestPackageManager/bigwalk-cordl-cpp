...
// Write type traits
MARK_REF_T(::System::Xml::XmlName*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlName*, "System.Xml", "XmlName");
...
/// @brief Method Create, addr 0x181d1d160, size 0x1e0, virtual false, abstract: false, final false
static inline ::System::Xml::XmlName* Create(::StringW  prefix, ::StringW  localName, ::StringW  ns, int32_t  hashCode, ::System::Xml::XmlDocument*  ownerDoc, ::System::Xml::XmlName*  next, ::System::Xml::Schema::IXmlSchemaInfo*  schemaInfo) ;

/// @brief Method Equals, addr 0x180973cb0, size 0x480, virtual true, abstract: false, final false
inline bool Equals(::System::Xml::Schema::IXmlSchemaInfo*  schemaInfo) ;

/// @brief Method GetHashCode, addr 0x181d1d340, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d1d3b0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_HashCode, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IsNil, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_LocalName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_MemberType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_Name, addr 0x181d1d450, size 0x150, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NamespaceURI, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_OwnerDocument, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_OwnerDocument() ;

/// @brief Method get_Prefix, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SchemaAttribute, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlName) == 0x48, "Size mismatch!");
