...
DEFINE_IL2CPP_CLASS(::System::Xml::BinXmlToken, "System.Xml", "BinXmlToken");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::BinXmlToken, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::BinXmlToken) == 0x4, "Size mismatch!");
