...
/// @brief Field ContentKindMasks, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ContentKindMasks, put=setStaticF_ContentKindMasks)) ::ArrayW<int32_t>  ContentKindMasks;
...
/// @brief Field NodeTypeLetter, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_NodeTypeLetter, put=setStaticF_NodeTypeLetter)) ::ArrayW<char16_t>  NodeTypeLetter;
...
/// @brief Field UniqueIdTbl, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_UniqueIdTbl, put=setStaticF_UniqueIdTbl)) ::ArrayW<char16_t>  UniqueIdTbl;
...
/// @brief Method GetNamespacesInScope, addr 0x181d2e4e0, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method IsText, addr 0x181d2e680, size 0x10, virtual false, abstract: false, final false
static inline bool IsText(::System::Xml::XPath::XPathNodeType  type) ;

/// @brief Method LookupNamespace, addr 0x181d2e690, size 0x170, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181d2e800, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method MoveToNamespace, addr 0x181d2e9f0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method System.ICloneable.Clone, addr 0x18062b520, size 0x20, virtual true, abstract: false, final true
inline ::System::Object* System_ICloneable_Clone() ;

/// @brief Method ToString, addr 0x1818fc850, size 0x20, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValueAs, addr 0x181d2eaa0, size 0x200, virtual true, abstract: false, final false
...
static inline ::ArrayW<char16_t> getStaticF_NodeTypeLetter() ;

static inline ::ArrayW<char16_t> getStaticF_UniqueIdTbl() ;
...
/// @brief Method get_TypedValue, addr 0x181d2ede0, size 0x1f0, virtual true, abstract: false, final false
inline ::System::Object* get_TypedValue() ;

/// @brief Method get_UnderlyingObject, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* get_UnderlyingObject() ;

/// @brief Method get_ValueAsBoolean, addr 0x181d2efd0, size 0x1d0, virtual true, abstract: false, final false
inline bool get_ValueAsBoolean() ;

/// @brief Method get_ValueAsDateTime, addr 0x181d2f1a0, size 0x1d0, virtual true, abstract: false, final false
inline ::System::DateTime get_ValueAsDateTime() ;

/// @brief Method get_ValueAsDouble, addr 0x181d2f370, size 0x1d0, virtual true, abstract: false, final false
inline double_t get_ValueAsDouble() ;

/// @brief Method get_ValueAsInt, addr 0x181d2f540, size 0x1d0, virtual true, abstract: false, final false
inline int32_t get_ValueAsInt() ;

/// @brief Method get_ValueAsLong, addr 0x181d2f710, size 0x1d0, virtual true, abstract: false, final false
inline int64_t get_ValueAsLong() ;

/// @brief Method get_ValueType, addr 0x181d2f8e0, size 0xb0, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlType, addr 0x181d2f990, size 0x80, virtual true, abstract: false, final false
...
static inline void setStaticF_ContentKindMasks(::ArrayW<int32_t>  value) ;

static inline void setStaticF_NodeTypeLetter(::ArrayW<char16_t>  value) ;

static inline void setStaticF_UniqueIdTbl(::ArrayW<char16_t>  value) ;
...
static_assert(sizeof(::System::Xml::XPath::XPathNavigator) == 0x10, "Size mismatch!");
