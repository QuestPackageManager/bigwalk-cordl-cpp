...
// Write type traits
MARK_REF_T(::System::Xml::XPath::XPathItem*);
DEFINE_IL2CPP_CLASS(::System::Xml::XPath::XPathItem*, "System.Xml.XPath", "XPathItem");
...
/// @brief Method ValueAs, addr 0x181d2e260, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XPath::XPathItem) == 0x10, "Size mismatch!");
