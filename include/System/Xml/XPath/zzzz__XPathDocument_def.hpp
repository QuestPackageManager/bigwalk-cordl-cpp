...
/// @brief Method GetXmlNamespaceNode, addr 0x181d2dab0, size 0x30, virtual false, abstract: false, final false
inline int32_t GetXmlNamespaceNode(::by_ref<::ArrayW<::MS::Internal::Xml::Cache::XPathNode>>  pageXmlNmsp) ;

/// @brief Method LookupNamespaces, addr 0x181d2dae0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_HasLineInfo, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
