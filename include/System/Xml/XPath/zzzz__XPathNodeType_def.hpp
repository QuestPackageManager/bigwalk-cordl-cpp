...
DEFINE_IL2CPP_CLASS(::System::Xml::XPath::XPathNodeType, "System.Xml.XPath", "XPathNodeType");
// Dependencies 
namespace System::Xml::XPath {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XPath::XPathNodeType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XPath::XPathNodeType) == 0x4, "Size mismatch!");
