...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTokenizedType, "System.Xml", "XmlTokenizedType");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlTokenizedType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlTokenizedType) == 0x4, "Size mismatch!");
