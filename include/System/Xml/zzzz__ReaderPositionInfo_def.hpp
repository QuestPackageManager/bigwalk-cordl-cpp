...
// Write type traits
MARK_REF_T(::System::Xml::ReaderPositionInfo*);
DEFINE_IL2CPP_CLASS(::System::Xml::ReaderPositionInfo*, "System.Xml", "ReaderPositionInfo");
...
/// @brief Method HasLineInfo, addr 0x181d1c720, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_LineNumber, addr 0x181d1c740, size 0x20, virtual true, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x181d1c760, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::ReaderPositionInfo) == 0x18, "Size mismatch!");
