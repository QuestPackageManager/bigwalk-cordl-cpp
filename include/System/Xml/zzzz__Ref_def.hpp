...
// Write type traits
MARK_REF_T(::System::Xml::Ref*);
DEFINE_IL2CPP_CLASS(::System::Xml::Ref*, "System.Xml", "Ref");
...
public:
// Declarations
/// @brief Method Equal, addr 0x1805a8800, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Ref) == 0x10, "Size mismatch!");
