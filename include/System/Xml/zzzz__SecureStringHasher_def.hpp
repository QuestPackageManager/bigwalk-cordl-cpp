...
// Write type traits
MARK_REF_T(::System::Xml::SecureStringHasher*);
MARK_REF_T(::System::Xml::SecureStringHasher_HashCodeOfStringDelegate*);
DEFINE_IL2CPP_CLASS(::System::Xml::SecureStringHasher*, "System.Xml", "SecureStringHasher");
DEFINE_IL2CPP_CLASS(::System::Xml::SecureStringHasher_HashCodeOfStringDelegate*, "System.Xml", "SecureStringHasher/HashCodeOfStringDelegate");
...
static_assert(sizeof(::System::Xml::SecureStringHasher_HashCodeOfStringDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method Equals, addr 0x181cdbf00, size 0x20, virtual true, abstract: false, final true
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x181cdc0f0, size 0x200, virtual true, abstract: false, final true
inline int32_t GetHashCode(::StringW  key) ;

/// @brief Method GetHashCodeDelegate, addr 0x181cdbf20, size 0x160, virtual false, abstract: false, final false
static inline ::System::Xml::SecureStringHasher_HashCodeOfStringDelegate* GetHashCodeDelegate() ;

/// @brief Method GetHashCodeOfString, addr 0x181cdc080, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cdc2f0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::SecureStringHasher) == 0x18, "Size mismatch!");
