...
/// @brief Method Equals, addr 0x181d1cd00, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method SetIsDefault, addr 0x181d1ceb0, size 0x30, virtual false, abstract: false, final false
inline void SetIsDefault(bool  value) ;

/// @brief Method SetIsNil, addr 0x181d1cee0, size 0x30, virtual false, abstract: false, final false
inline void SetIsNil(bool  value) ;

/// @brief Method SetValidity, addr 0x181d1cf10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d1cf20, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_IsDefault, addr 0x181d1d080, size 0x10, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x181d1d090, size 0x10, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_MemberType, addr 0x1802e0b30, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_SchemaAttribute, addr 0x181d1d0a0, size 0x50, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x181d1d0f0, size 0x50, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x1802e75e0, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x181d1d140, size 0x20, virtual true, abstract: false, final false
