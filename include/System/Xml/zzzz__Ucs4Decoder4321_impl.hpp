...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::System::Xml::Ucs4Decoder4321::*)(::ArrayW<uint8_t>, int32_t, int32_t, ::ArrayW<char16_t>, int32_t)>(&::System::Xml::Ucs4Decoder4321::GetFullChars)> {
  constexpr static std::size_t size = 0x210;
  constexpr static std::size_t addrs = 0x181d2c640;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::System::Xml::Ucs4Decoder4321*>(),
                    {::i2c::class_of<::System::Xml::Ucs4Decoder4321*>(), 14}
                ));
