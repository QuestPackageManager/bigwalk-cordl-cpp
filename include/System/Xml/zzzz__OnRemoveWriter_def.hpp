...
// Write type traits
MARK_REF_T(::System::Xml::OnRemoveWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::OnRemoveWriter*, "System.Xml", "OnRemoveWriter");
...
static_assert(sizeof(::System::Xml::OnRemoveWriter) == 0x80, "Size mismatch!");
