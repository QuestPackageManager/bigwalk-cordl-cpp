...
DEFINE_IL2CPP_CLASS(::System::Xml::ReadContentAsBinaryHelper_State, "System.Xml", "ReadContentAsBinaryHelper/State");
...
static_assert(offsetof(::System::Xml::ReadContentAsBinaryHelper_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::ReadContentAsBinaryHelper_State) == 0x4, "Size mismatch!");
...
/// @brief Method Finish, addr 0x181cdbbd0, size 0x200, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method MoveToNextContentNode, addr 0x181cdbdd0, size 0x120, virtual false, abstract: false, final false
inline bool MoveToNextContentNode(bool  moveIfOnContentNode) ;

/// @brief Method Reset, addr 0x181cdbef0, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;
...
static_assert(sizeof(::System::Xml::ReadContentAsBinaryHelper) == 0x28, "Size mismatch!");
