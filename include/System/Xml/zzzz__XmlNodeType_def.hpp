...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNodeType, "System.Xml", "XmlNodeType");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlNodeType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlNodeType) == 0x4, "Size mismatch!");
