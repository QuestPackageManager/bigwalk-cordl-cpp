...
/// @brief Method PrivateDisposeNodeList, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void PrivateDisposeNodeList() ;

/// @brief Method System.IDisposable.Dispose, addr 0x181163b40, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_ItemOf, addr 0x1818b16a0, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlNodeList) == 0x10, "Size mismatch!");
