...
// Write type traits
MARK_REF_T(::System::Xml::BitStack*);
DEFINE_IL2CPP_CLASS(::System::Xml::BitStack*, "System.Xml", "BitStack");
...
/// @brief Field bitStack, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_bitStack, put=__cordl_internal_set_bitStack)) ::ArrayW<uint32_t>  bitStack;
...
/// @brief Method PeekBit, addr 0x181c21570, size 0x10, virtual false, abstract: false, final false
inline bool PeekBit() ;

/// @brief Method PopBit, addr 0x181c21580, size 0x40, virtual false, abstract: false, final false
inline bool PopBit() ;

/// @brief Method PopCurr, addr 0x181c215c0, size 0x20, virtual false, abstract: false, final false
inline void PopCurr() ;

/// @brief Method PushBit, addr 0x181c215e0, size 0xd0, virtual false, abstract: false, final false
inline void PushBit(bool  bit) ;

/// @brief Method PushCurr, addr 0x181c216b0, size 0xb0, virtual false, abstract: false, final false
inline void PushCurr() ;

constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_bitStack() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_bitStack() ;
...
constexpr void __cordl_internal_set_bitStack(::ArrayW<uint32_t>  value) ;

constexpr void __cordl_internal_set_curr(uint32_t  value) ;

constexpr void __cordl_internal_set_stackPos(int32_t  value) ;

/// @brief Method .ctor, addr 0x181c21760, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::BitStack) == 0x20, "Size mismatch!");
