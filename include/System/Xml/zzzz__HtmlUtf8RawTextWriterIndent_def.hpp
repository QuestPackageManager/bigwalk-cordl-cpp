...
/// @brief Method FlushBuffer, addr 0x181cdaa70, size 0x20, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method Init, addr 0x181cdaa90, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method StartElementContent, addr 0x181cdaae0, size 0xa0, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method WriteDocType, addr 0x181cdab80, size 0x30, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndElement, addr 0x181cdabb0, size 0xe0, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteIndent, addr 0x181cdac90, size 0x50, virtual false, abstract: false, final false
inline void WriteIndent() ;

/// @brief Method WriteStartAttribute, addr 0x181cdace0, size 0xc0, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x181cdada0, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cdafe0, size 0x50, virtual false, abstract: false, final false
