...
// Write type traits
MARK_REF_T(::System::Globalization::GregorianCalendarHelper*);
DEFINE_IL2CPP_CLASS(::System::Globalization::GregorianCalendarHelper*, "System.Globalization", "GregorianCalendarHelper");
// Dependencies System.DateTime, System.Globalization.EraInfo, System.Object
namespace System::Globalization {
// Is value type: false
...
/// @brief Field m_EraInfo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_EraInfo, put=__cordl_internal_set_m_EraInfo)) ::ArrayW<::System::Globalization::EraInfo*>  m_EraInfo;

/// @brief Field m_eras, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_eras, put=__cordl_internal_set_m_eras)) ::ArrayW<int32_t>  m_eras;
...
/// @brief Method CheckTicksRange, addr 0x18168e2e0, size 0x140, virtual false, abstract: false, final false
inline void CheckTicksRange(int64_t  ticks) ;

/// @brief Method DateToTicks, addr 0x18168e420, size 0x180, virtual false, abstract: false, final false
static inline int64_t DateToTicks(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method GetAbsoluteDate, addr 0x18168e5a0, size 0x170, virtual false, abstract: false, final false
static inline int64_t GetAbsoluteDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method GetDatePart, addr 0x18168e710, size 0x180, virtual true, abstract: false, final false
inline int32_t GetDatePart(int64_t  ticks, int32_t  part) ;

/// @brief Method GetDayOfMonth, addr 0x18168e890, size 0x40, virtual false, abstract: false, final false
inline int32_t GetDayOfMonth(::System::DateTime  time) ;

/// @brief Method GetDayOfWeek, addr 0x18168e8d0, size 0x70, virtual false, abstract: false, final false
inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime  time) ;

/// @brief Method GetDaysInMonth, addr 0x18168e940, size 0xe0, virtual false, abstract: false, final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear, addr 0x18168ea20, size 0x90, virtual false, abstract: false, final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetEra, addr 0x18168eab0, size 0xa0, virtual false, abstract: false, final false
inline int32_t GetEra(::System::DateTime  time) ;

/// @brief Method GetGregorianYear, addr 0x18168eb50, size 0x30, virtual false, abstract: false, final false
inline int32_t GetGregorianYear(int32_t  year, int32_t  era) ;

/// @brief Method GetMonth, addr 0x18168eb80, size 0x40, virtual false, abstract: false, final false
inline int32_t GetMonth(::System::DateTime  time) ;

/// @brief Method GetMonthsInYear, addr 0x18168ebc0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetMonthsInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetYear, addr 0x18168ede0, size 0xc0, virtual false, abstract: false, final false
inline int32_t GetYear(::System::DateTime  time) ;

/// @brief Method GetYearOffset, addr 0x18168ebe0, size 0x200, virtual false, abstract: false, final false
inline int32_t GetYearOffset(int32_t  year, int32_t  era, bool  throwOnError) ;

/// @brief Method IsLeapYear, addr 0x18168eea0, size 0x80, virtual false, abstract: false, final false
inline bool IsLeapYear(int32_t  year, int32_t  era) ;

/// @brief Method IsValidYear, addr 0x18168ef20, size 0x20, virtual false, abstract: false, final false
inline bool IsValidYear(int32_t  year, int32_t  era) ;

static inline ::System::Globalization::GregorianCalendarHelper* New_ctor(::System::Globalization::Calendar*  cal, ::ArrayW<::System::Globalization::EraInfo*>  eraInfo) ;

/// @brief Method TimeToTicks, addr 0x18168ef40, size 0x120, virtual false, abstract: false, final false
static inline int64_t TimeToTicks(int32_t  hour, int32_t  minute, int32_t  second, int32_t  millisecond) ;

/// @brief Method ToDateTime, addr 0x18168f060, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x18168f360, size 0x160, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Globalization::EraInfo*> const& __cordl_internal_get_m_EraInfo() const;

constexpr ::ArrayW<::System::Globalization::EraInfo*>& __cordl_internal_get_m_EraInfo() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_eras() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_eras() ;
...
constexpr void __cordl_internal_set_m_EraInfo(::ArrayW<::System::Globalization::EraInfo*>  value) ;

constexpr void __cordl_internal_set_m_eras(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x18168f570, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Globalization::Calendar*  cal, ::ArrayW<::System::Globalization::EraInfo*>  eraInfo) ;

static inline ::ArrayW<int32_t> getStaticF_DaysToMonth365() ;

static inline ::ArrayW<int32_t> getStaticF_DaysToMonth366() ;

/// @brief Method get_Eras, addr 0x18168f5f0, size 0xd0, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_Eras() ;

/// @brief Method get_MaxYear, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::GregorianCalendarHelper) == 0x38, "Size mismatch!");
