...
DEFINE_IL2CPP_CLASS(::System::Globalization::TimeSpanFormat_Pattern, "System.Globalization", "TimeSpanFormat/Pattern");
DEFINE_IL2CPP_CLASS(::System::Globalization::TimeSpanFormat*, "System.Globalization", "TimeSpanFormat");
DEFINE_IL2CPP_CLASS(::System::Globalization::TimeSpanFormat_FormatLiterals, "System.Globalization", "TimeSpanFormat/FormatLiterals");
// Dependencies 
namespace System::Globalization {
// Is value type: true
...
static_assert(offsetof(::System::Globalization::TimeSpanFormat_Pattern, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Globalization::TimeSpanFormat_Pattern) == 0x4, "Size mismatch!");
...
/// @brief Method Init, addr 0x18168deb0, size 0x320, virtual false, abstract: false, final false
inline void Init(::System::ReadOnlySpan_1<char16_t>  format, bool  useInvariantFieldLengths) ;

/// @brief Method InitInvariant, addr 0x18168dd20, size 0x190, virtual false, abstract: false, final false
static inline ::System::Globalization::TimeSpanFormat_FormatLiterals InitInvariant(bool  isNegative) ;

/// @brief Method get_DayHourSep, addr 0x18168e1d0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DayHourSep() ;

/// @brief Method get_End, addr 0x18168e1f0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_End() ;

/// @brief Method get_HourMinuteSep, addr 0x18168e210, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_HourMinuteSep() ;

/// @brief Method get_MinuteSecondSep, addr 0x18168e230, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_MinuteSecondSep() ;

/// @brief Method get_SecondFractionSep, addr 0x18168e250, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_SecondFractionSep() ;

/// @brief Method get_Start, addr 0x18168e270, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::TimeSpanFormat_FormatLiterals) == 0x28, "Size mismatch!");
...
/// @brief Field NegativeInvariantFormatLiterals, offset 0xffffffff, size 0x28 
 __declspec(property(get=getStaticF_NegativeInvariantFormatLiterals, put=setStaticF_NegativeInvariantFormatLiterals)) ::System::Globalization::TimeSpanFormat_FormatLiterals  NegativeInvariantFormatLiterals;

/// @brief Field PositiveInvariantFormatLiterals, offset 0xffffffff, size 0x28 
 __declspec(property(get=getStaticF_PositiveInvariantFormatLiterals, put=setStaticF_PositiveInvariantFormatLiterals)) ::System::Globalization::TimeSpanFormat_FormatLiterals  PositiveInvariantFormatLiterals;

/// @brief Method AppendNonNegativeInt32, addr 0x181691de0, size 0xe0, virtual false, abstract: false, final false
static inline void AppendNonNegativeInt32(::System::Text::StringBuilder*  sb, int32_t  n, int32_t  digits) ;

/// @brief Method Format, addr 0x181692af0, size 0x80, virtual false, abstract: false, final false
static inline ::StringW Format(::System::TimeSpan  value, ::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method FormatCustomized, addr 0x181691ec0, size 0x650, virtual false, abstract: false, final false
...
/// @brief Method FormatStandard, addr 0x181692510, size 0x420, virtual false, abstract: false, final false
static inline ::System::Text::StringBuilder* FormatStandard(::System::TimeSpan  value, bool  isInvariant, ::System::ReadOnlySpan_1<char16_t>  format, ::System::Globalization::TimeSpanFormat_Pattern  pattern) ;

/// @brief Method FormatToBuilder, addr 0x181692930, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method TryFormat, addr 0x181692b70, size 0xc0, virtual false, abstract: false, final false
