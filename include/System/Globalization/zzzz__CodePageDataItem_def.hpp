...
// Write type traits
MARK_REF_T(::System::Globalization::CodePageDataItem*);
DEFINE_IL2CPP_CLASS(::System::Globalization::CodePageDataItem*, "System.Globalization", "CodePageDataItem");
...
/// @brief Method CreateString, addr 0x1816ae100, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816ae1b0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int32_t  dataIndex) ;

static inline ::ArrayW<char16_t> getStaticF_sep() ;

/// @brief Method get_WebName, addr 0x1816ae230, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::CodePageDataItem) == 0x28, "Size mismatch!");
