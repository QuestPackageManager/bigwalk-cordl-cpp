...
static_assert(offsetof(::System::Globalization::GregorianCalendarTypes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Globalization::GregorianCalendarTypes) == 0x4, "Size mismatch!");
