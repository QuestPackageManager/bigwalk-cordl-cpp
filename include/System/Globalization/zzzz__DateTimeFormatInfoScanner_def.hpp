...
DEFINE_IL2CPP_CLASS(::System::Globalization::DateTimeFormatInfoScanner_FoundDatePattern, "System.Globalization", "DateTimeFormatInfoScanner/FoundDatePattern");
...
static_assert(offsetof(::System::Globalization::DateTimeFormatInfoScanner_FoundDatePattern, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Globalization::DateTimeFormatInfoScanner_FoundDatePattern) == 0x4, "Size mismatch!");
...
/// @brief Method AddDateWordOrPostfix, addr 0x181686f00, size 0x190, virtual false, abstract: false, final false
inline void AddDateWordOrPostfix(::StringW  formatPostfix, ::StringW  str) ;

/// @brief Method AddDateWords, addr 0x181687090, size 0x1b0, virtual false, abstract: false, final false
inline int32_t AddDateWords(::StringW  pattern, int32_t  index, ::StringW  formatPostfix) ;

/// @brief Method AddIgnorableSymbols, addr 0x181687240, size 0xf0, virtual false, abstract: false, final false
inline void AddIgnorableSymbols(::StringW  text) ;

/// @brief Method ArrayElementsBeginWithDigit, addr 0x181687330, size 0x180, virtual false, abstract: false, final false
static inline bool ArrayElementsBeginWithDigit(::ArrayW<::StringW>  array) ;

/// @brief Method ArrayElementsHaveSpace, addr 0x1816874b0, size 0x80, virtual false, abstract: false, final false
static inline bool ArrayElementsHaveSpace(::ArrayW<::StringW>  array) ;

/// @brief Method EqualStringArrays, addr 0x181687530, size 0x80, virtual false, abstract: false, final false
static inline bool EqualStringArrays(::ArrayW<::StringW>  array1, ::ArrayW<::StringW>  array2) ;

/// @brief Method GetDateWordsOfDTFI, addr 0x1816875b0, size 0x230, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> GetDateWordsOfDTFI(::System::Globalization::DateTimeFormatInfo*  dtfi) ;

/// @brief Method GetFormatFlagGenitiveMonth, addr 0x1816877e0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseHebrewCalendar, addr 0x181687830, size 0x10, virtual false, abstract: false, final false
static inline ::System::Globalization::FORMATFLAGS GetFormatFlagUseHebrewCalendar(int32_t  calID) ;

/// @brief Method GetFormatFlagUseSpaceInDayNames, addr 0x181687840, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseSpaceInMonthNames, addr 0x181687880, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ScanDateWord, addr 0x181687940, size 0x1d0, virtual false, abstract: false, final false
inline void ScanDateWord(::StringW  pattern) ;

/// @brief Method ScanRepeatChar, addr 0x181687b10, size 0x70, virtual false, abstract: false, final false
static inline int32_t ScanRepeatChar(::StringW  pattern, char16_t  ch, int32_t  index, ::by_ref<int32_t>  count) ;

/// @brief Method SkipWhiteSpacesAndNonLetter, addr 0x181687b80, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_KnownWords, addr 0x181687c20, size 0x300, virtual false, abstract: false, final false
