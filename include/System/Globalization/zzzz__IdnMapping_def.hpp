...
// Write type traits
MARK_REF_T(::System::Globalization::IdnMapping*);
DEFINE_IL2CPP_CLASS(::System::Globalization::IdnMapping*, "System.Globalization", "IdnMapping");
...
/// @brief Method Convert, addr 0x1816c9ce0, size 0x150, virtual false, abstract: false, final false
inline ::StringW Convert(::StringW  input, int32_t  index, int32_t  count, bool  toAscii) ;

/// @brief Method Equals, addr 0x1816c9e30, size 0x40, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetAscii, addr 0x1816c9e70, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetAscii(::StringW  unicode) ;

/// @brief Method GetAscii, addr 0x1816c9ed0, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetAscii(::StringW  unicode, int32_t  index, int32_t  count) ;

/// @brief Method GetHashCode, addr 0x1816c9f40, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetUnicode, addr 0x1816c9fd0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetUnicode(::StringW  ascii) ;

/// @brief Method GetUnicode, addr 0x1816c9f60, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetUnicode(::StringW  ascii, int32_t  index, int32_t  count) ;

/// @brief Method NamePrep, addr 0x1816ca030, size 0x250, virtual false, abstract: false, final false
inline ::StringW NamePrep(::StringW  s, int32_t  offset) ;

static inline ::System::Globalization::IdnMapping* New_ctor() ;

/// @brief Method ToAscii, addr 0x1816ca280, size 0x270, virtual false, abstract: false, final false
inline ::StringW ToAscii(::StringW  s, int32_t  offset) ;

/// @brief Method ToUnicode, addr 0x1816ca4f0, size 0x140, virtual false, abstract: false, final false
inline ::StringW ToUnicode(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyLength, addr 0x1816ca630, size 0xa0, virtual false, abstract: false, final false
inline void VerifyLength(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyProhibitedCharacters, addr 0x1816ca6d0, size 0x1a0, virtual false, abstract: false, final false
inline void VerifyProhibitedCharacters(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyStd3AsciiRules, addr 0x1816ca870, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816caa10, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Globalization::IdnMapping) == 0x20, "Size mismatch!");
