...
/// @brief Method GetAbsoluteDate, addr 0x18168f6c0, size 0x170, virtual false, abstract: false, final false
static inline int64_t GetAbsoluteDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method GetDatePart, addr 0x18168f830, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method GetDaysInMonth, addr 0x18168fa20, size 0x1b0, virtual true, abstract: false, final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear, addr 0x18168fbd0, size 0x140, virtual true, abstract: false, final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetDefaultInstance, addr 0x18168fd10, size 0x90, virtual false, abstract: false, final false
static inline ::System::Globalization::Calendar* GetDefaultInstance() ;

/// @brief Method GetEra, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method GetMonthsInYear, addr 0x18168fde0, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method IsLeapYear, addr 0x18168ff20, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method OnDeserialized, addr 0x181690050, size 0xd0, virtual false, abstract: false, final false
inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method ToDateTime, addr 0x181690120, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x1816901b0, size 0xf0, virtual true, abstract: false, final false
inline int32_t ToFourDigitYear(int32_t  year) ;

/// @brief Method TryToDateTime, addr 0x1816902a0, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181690430, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181690450, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_ID, addr 0x180396ee0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_TwoDigitYearMax, addr 0x181690560, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method set_TwoDigitYearMax, addr 0x1816905b0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::GregorianCalendar) == 0x28, "Size mismatch!");
