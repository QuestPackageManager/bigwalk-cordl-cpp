...
/// @brief Field thaiBuddhistEraInfo, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_thaiBuddhistEraInfo, put=setStaticF_thaiBuddhistEraInfo)) ::ArrayW<::System::Globalization::EraInfo*>  thaiBuddhistEraInfo;
...
/// @brief Method ToFourDigitYear, addr 0x1816c1380, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816c14a0, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<::System::Globalization::EraInfo*> getStaticF_thaiBuddhistEraInfo() ;

/// @brief Method get_Eras, addr 0x1816bdeb0, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<int32_t> get_Eras() ;

/// @brief Method get_ID, addr 0x180feb5f0, size 0x28d50, virtual true, abstract: false, final false
...
/// @brief Method get_TwoDigitYearMax, addr 0x1816c1530, size 0x50, virtual true, abstract: false, final false
inline int32_t get_TwoDigitYearMax() ;

static inline void setStaticF_thaiBuddhistEraInfo(::ArrayW<::System::Globalization::EraInfo*>  value) ;
...
static_assert(sizeof(::System::Globalization::ThaiBuddhistCalendar) == 0x28, "Size mismatch!");
