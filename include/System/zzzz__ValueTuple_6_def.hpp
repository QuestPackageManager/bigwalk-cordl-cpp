...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(ValueTuple_6)
...
// Write type traits
MARK_GEN_VAL_T(::System::ValueTuple_6);
DEFINE_IL2CPP_GEN_CLASS(::System::ValueTuple_6, "System", "ValueTuple`6");
// Dependencies 
namespace System {
// cpp template
template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
// Is value type: true
// CS Name: System.ValueTuple`6<T1,T2,T3,T4,T5,T6>
struct CORDL_TYPE ValueTuple_6 {
public:
// Declarations
...
constexpr operator  ::System::IComparable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>*() ;

/// @brief Convert operator to "::System::IEquatable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>"
constexpr operator  ::System::IEquatable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>*() ;
...
inline int32_t CompareTo(::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>  other) ;

/// @brief Method Equals, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline bool Equals(::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>  other) ;
...
inline void _ctor(T1  item1, T2  item2, T3  item3, T4  item4, T5  item5, T6  item6) ;
...
constexpr ::System::IComparable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>* i___System__IComparable_1___System__ValueTuple_6_T1_T2_T3_T4_T5_T6__() ;

/// @brief Convert to "::System::IEquatable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>"
constexpr ::System::IEquatable_1<::System::ValueTuple_6<T1,T2,T3,T4,T5,T6>>* i___System__IEquatable_1___System__ValueTuple_6_T1_T2_T3_T4_T5_T6__() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ValueTuple_6() ;

// Ctor Parameters [CppParam { name: "Item1", ty: "T1", modifiers: "", def_value: None }, CppParam { name: "Item2", ty: "T2", modifiers: "", def_value: None }, CppParam { name: "Item3", ty: "T3", modifiers: "", def_value: None }, CppParam { name: "Item4", ty: "T4", modifiers: "", def_value: None }, CppParam { name: "Item5", ty: "T5", modifiers: "", def_value: None }, CppParam { name: "Item6", ty: "T6", modifiers: "", def_value: None }]
constexpr ValueTuple_6(T1  Item1, T2  Item2, T3  Item3, T4  Item4, T5  Item5, T6  Item6) noexcept;
