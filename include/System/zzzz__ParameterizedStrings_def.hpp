...
DEFINE_IL2CPP_CLASS(::System::ParameterizedStrings_FormatParam, "System", "ParameterizedStrings/FormatParam");
// Dependencies 
namespace System {
// Is value type: true
...
/// @brief Method .ctor, addr 0x180e0e030, size 0x410, virtual false, abstract: false, final false
inline void _ctor(int32_t  value) ;

/// @brief Method get_Int32, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Int32() ;

/// @brief Method get_Object, addr 0x18174a970, size 0x40, virtual false, abstract: false, final false
inline ::System::Object* get_Object() ;

/// @brief Method get_String, addr 0x18174a9b0, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_String() ;

/// @brief Method op_Implicit, addr 0x180e0e440, size 0x8a50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::ParameterizedStrings_FormatParam) == 0x10, "Size mismatch!");
...
/// @brief Field _arr, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__arr, put=__cordl_internal_set__arr)) ::ArrayW<::System::ParameterizedStrings_FormatParam>  _arr;
...
/// @brief Method Pop, addr 0x18174acb0, size 0x60, virtual false, abstract: false, final false
inline ::System::ParameterizedStrings_FormatParam Pop() ;

/// @brief Method Push, addr 0x18174ad10, size 0xb0, virtual false, abstract: false, final false
inline void Push(::System::ParameterizedStrings_FormatParam  item) ;

constexpr ::ArrayW<::System::ParameterizedStrings_FormatParam> const& __cordl_internal_get__arr() const;

constexpr ::ArrayW<::System::ParameterizedStrings_FormatParam>& __cordl_internal_get__arr() ;

constexpr int32_t const& __cordl_internal_get__count() const;

constexpr int32_t& __cordl_internal_get__count() ;

constexpr void __cordl_internal_set__arr(::ArrayW<::System::ParameterizedStrings_FormatParam>  value) ;

constexpr void __cordl_internal_set__count(int32_t  value) ;

/// @brief Method .ctor, addr 0x18174adc0, size 0x5c0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _arr, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::ParameterizedStrings_FormatParam>  ____arr;
...
/// @brief Method AsBool, addr 0x1816a1270, size 0x10, virtual false, abstract: false, final false
static inline bool AsBool(int32_t  i) ;

/// @brief Method AsInt, addr 0x18145a560, size 0x10, virtual false, abstract: false, final false
static inline int32_t AsInt(bool  b) ;

/// @brief Method Evaluate, addr 0x18174f610, size 0x130, virtual false, abstract: false, final false
static inline ::StringW Evaluate(::StringW  format, ::ArrayW<::System::ParameterizedStrings_FormatParam>  args) ;

/// @brief Method EvaluateInternal, addr 0x18174ea30, size 0xbe0, virtual false, abstract: false, final false
static inline ::StringW EvaluateInternal(::StringW  format, ::by_ref<int32_t>  pos, ::ArrayW<::System::ParameterizedStrings_FormatParam>  args, ::System::ParameterizedStrings_LowLevelStack*  stack, ::by_ref<::ArrayW<::System::ParameterizedStrings_FormatParam>>  dynamicVars, ::by_ref<::ArrayW<::System::ParameterizedStrings_FormatParam>>  staticVars) ;

/// @brief Method FormatPrintF, addr 0x18174f740, size 0x1d0, virtual false, abstract: false, final false
static inline ::StringW FormatPrintF(::StringW  format, ::System::Object*  arg) ;

/// @brief Method GetDynamicOrStaticVariables, addr 0x18174f910, size 0xb0, virtual false, abstract: false, final false
static inline ::ArrayW<::System::ParameterizedStrings_FormatParam> GetDynamicOrStaticVariables(char16_t  c, ::by_ref<::ArrayW<::System::ParameterizedStrings_FormatParam>>  dynamicVars, ::by_ref<::ArrayW<::System::ParameterizedStrings_FormatParam>>  staticVars, ::by_ref<int32_t>  index) ;

/// @brief Method StringFromAsciiBytes, addr 0x18174f9c0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method snprintf, addr 0x18174fa60, size 0xe0, virtual false, abstract: false, final false
static inline int32_t snprintf(uint8_t*  str, ::System::IntPtr  size, ::StringW  format, ::StringW  arg1) ;

/// @brief Method snprintf, addr 0x18174fb40, size 0xc0, virtual false, abstract: false, final false
