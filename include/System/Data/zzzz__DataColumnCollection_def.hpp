...
/// @brief Field ColumnPropertyChanged, offset 0x60, size 0x8 
 ...
 __declspec(property(get=get_ColumnsImplementingIChangeTracking)) ::ArrayW<::System::Data::DataColumn*>  ColumnsImplementingIChangeTracking;
...
/// @brief Field _columnFromName, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnFromName, put=__cordl_internal_set__columnFromName)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Data::DataColumn*>*  _columnFromName;

/// @brief Field _columnsImplementingIChangeTracking, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnsImplementingIChangeTracking, put=__cordl_internal_set__columnsImplementingIChangeTracking)) ::ArrayW<::System::Data::DataColumn*>  _columnsImplementingIChangeTracking;
...
/// @brief Field _delayedAddRangeColumns, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__delayedAddRangeColumns, put=__cordl_internal_set__delayedAddRangeColumns)) ::ArrayW<::System::Data::DataColumn*>  _delayedAddRangeColumns;
...
/// @brief Field _nColumnsImplementingIRevertibleChangeTracking, offset 0x4c, size 0x4 
 __declspec(property(get=__cordl_internal_get__nColumnsImplementingIRevertibleChangeTracking, put=__cordl_internal_set__nColumnsImplementingIRevertibleChangeTracking)) int32_t  _nColumnsImplementingIRevertibleChangeTracking;
...
/// @brief Method Add, addr 0x181b81860, size 0x10, virtual false, abstract: false, final false
inline void Add(::System::Data::DataColumn*  column) ;

/// @brief Method AddAt, addr 0x181b81530, size 0x2b0, virtual false, abstract: false, final false
inline void AddAt(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method AddColumnsImplementingIChangeTrackingList, addr 0x181b817e0, size 0x80, virtual false, abstract: false, final false
inline void AddColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method ArrayAdd, addr 0x181b818b0, size 0x70, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataColumn*  column) ;

/// @brief Method ArrayAdd, addr 0x181b81870, size 0x40, virtual false, abstract: false, final false
inline void ArrayAdd(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method ArrayRemove, addr 0x181b81920, size 0x180, virtual false, abstract: false, final false
inline void ArrayRemove(::System::Data::DataColumn*  column) ;

/// @brief Method AssignName, addr 0x181b81aa0, size 0xe0, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method BaseAdd, addr 0x181b81b80, size 0x280, virtual false, abstract: false, final false
inline void BaseAdd(::System::Data::DataColumn*  column) ;

/// @brief Method BaseGroupSwitch, addr 0x181b81e00, size 0x180, virtual false, abstract: false, final false
inline void BaseGroupSwitch(::ArrayW<::System::Data::DataColumn*>  oldArray, int32_t  oldLength, ::ArrayW<::System::Data::DataColumn*>  newArray, int32_t  newLength) ;

/// @brief Method BaseRemove, addr 0x181b81f80, size 0x110, virtual false, abstract: false, final false
inline void BaseRemove(::System::Data::DataColumn*  column) ;

/// @brief Method CanRegisterName, addr 0x181b82090, size 0x20, virtual false, abstract: false, final false
inline bool CanRegisterName(::StringW  name) ;

/// @brief Method CanRemove, addr 0x181b820b0, size 0x670, virtual false, abstract: false, final false
inline bool CanRemove(::System::Data::DataColumn*  column, bool  fThrowException) ;

/// @brief Method CheckIChangeTracking, addr 0x181b82720, size 0xa0, virtual false, abstract: false, final false
inline void CheckIChangeTracking(::System::Data::DataColumn*  column) ;

/// @brief Method Clear, addr 0x181b827c0, size 0x260, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x181b82ab0, size 0x70, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method Contains, addr 0x181b82a20, size 0x90, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, bool  caseSensitive) ;

/// @brief Method IndexOf, addr 0x181b82c70, size 0xe0, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  columnName) ;

/// @brief Method IndexOfCaseInsensitive, addr 0x181b82b20, size 0x150, virtual false, abstract: false, final false
inline int32_t IndexOfCaseInsensitive(::StringW  name) ;

/// @brief Method MakeName, addr 0x181b82d50, size 0x50, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataColumnCollection* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method OnCollectionChanged, addr 0x181b82da0, size 0x80, virtual false, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x181b82e20, size 0x20, virtual false, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnColumnPropertyChanged, addr 0x181b82e40, size 0x50, virtual false, abstract: false, final false
inline void OnColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterColumnName, addr 0x181b82e90, size 0x1d0, virtual false, abstract: false, final false
inline void RegisterColumnName(::StringW  name, ::System::Data::DataColumn*  column) ;

/// @brief Method Remove, addr 0x181b83110, size 0x130, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataColumn*  column) ;

/// @brief Method RemoveColumnsImplementingIChangeTrackingList, addr 0x181b83060, size 0xb0, virtual false, abstract: false, final false
inline void RemoveColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method UnregisterName, addr 0x181b83240, size 0x130, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Data::DataColumn*> const& __cordl_internal_get__columnsImplementingIChangeTracking() const;

constexpr ::ArrayW<::System::Data::DataColumn*>& __cordl_internal_get__columnsImplementingIChangeTracking() ;
...
constexpr ::ArrayW<::System::Data::DataColumn*> const& __cordl_internal_get__delayedAddRangeColumns() const;

constexpr ::ArrayW<::System::Data::DataColumn*>& __cordl_internal_get__delayedAddRangeColumns() ;
...
constexpr void __cordl_internal_set__columnsImplementingIChangeTracking(::ArrayW<::System::Data::DataColumn*>  value) ;

constexpr void __cordl_internal_set__defaultNameIndex(int32_t  value) ;

constexpr void __cordl_internal_set__delayedAddRangeColumns(::ArrayW<::System::Data::DataColumn*>  value) ;
...
/// @brief Method .ctor, addr 0x181b83370, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method add_CollectionChanged, addr 0x181b83470, size 0x80, virtual false, abstract: false, final false
inline void add_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method add_ColumnPropertyChanged, addr 0x181b834f0, size 0x80, virtual false, abstract: false, final false
inline void add_ColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_ColumnsImplementingIChangeTracking, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> get_ColumnsImplementingIChangeTracking() ;

/// @brief Method get_ColumnsImplementingIChangeTrackingCount, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIChangeTrackingCount() ;

/// @brief Method get_ColumnsImplementingIRevertibleChangeTrackingCount, addr 0x180e25b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIRevertibleChangeTrackingCount() ;

/// @brief Method get_Item, addr 0x181b835e0, size 0x90, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x181b83670, size 0x110, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name) ;

/// @brief Method get_Item, addr 0x181b83570, size 0x70, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name, ::StringW  ns) ;

/// @brief Method get_List, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_CollectionChanged, addr 0x181b83780, size 0x80, virtual false, abstract: false, final false
inline void remove_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method remove_ColumnPropertyChanged, addr 0x181b83800, size 0x80, virtual false, abstract: false, final false
...
/// @brief Field _delayedAddRangeColumns, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::Data::DataColumn*>  ____delayedAddRangeColumns;
...
/// @brief Field _columnsImplementingIChangeTracking, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Data::DataColumn*>  ____columnsImplementingIChangeTracking;
...
static_assert(sizeof(::System::Data::DataColumnCollection) == 0x68, "Size mismatch!");
