...
// Write type traits
MARK_REF_T(::System::Data::SqlTypes::SqlChars*);
DEFINE_IL2CPP_CLASS(::System::Data::SqlTypes::SqlChars*, "System.Data.SqlTypes", "SqlChars");
...
public:
// Declarations
 __declspec(property(get=get_Buffer)) ::ArrayW<char16_t>  Buffer;

 __declspec(property(get=get_IsNull)) bool  IsNull;

 __declspec(property(get=get_Length)) int64_t  Length;

 __declspec(property(get=get_Value)) ::ArrayW<char16_t>  Value;
...
/// @brief Field _rgchBuf, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__rgchBuf, put=__cordl_internal_set__rgchBuf)) ::ArrayW<char16_t>  _rgchBuf;

/// @brief Field _rgchWorkBuf, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__rgchWorkBuf, put=__cordl_internal_set__rgchWorkBuf)) ::ArrayW<char16_t>  _rgchWorkBuf;
...
/// @brief Method CopyStreamToBuffer, addr 0x181bd9df0, size 0x130, virtual false, abstract: false, final false
inline void CopyStreamToBuffer() ;

/// @brief Method FStream, addr 0x181bd94b0, size 0x10, virtual false, abstract: false, final false
inline bool FStream() ;
...
static inline ::System::Data::SqlTypes::SqlChars* New_ctor(::ArrayW<char16_t>  buffer) ;

static inline ::System::Data::SqlTypes::SqlChars* New_ctor(::System::Data::SqlTypes::SqlString  value) ;

/// @brief Method SetBuffer, addr 0x181bd94c0, size 0x60, virtual false, abstract: false, final false
inline void SetBuffer(::ArrayW<char16_t>  buffer) ;

/// @brief Method SetNull, addr 0x181bd9520, size 0x40, virtual false, abstract: false, final false
inline void SetNull() ;
...
/// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x181bd9f60, size 0x100, virtual true, abstract: false, final true
inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader*  r) ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x181bda060, size 0x220, virtual true, abstract: false, final true
...
constexpr ::ArrayW<char16_t> const& __cordl_internal_get__rgchBuf() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get__rgchBuf() ;

constexpr ::ArrayW<char16_t> const& __cordl_internal_get__rgchWorkBuf() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get__rgchWorkBuf() ;
...
constexpr void __cordl_internal_set__rgchBuf(::ArrayW<char16_t>  value) ;

constexpr void __cordl_internal_set__rgchWorkBuf(::ArrayW<char16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181bd9520, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181bd9960, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t>  buffer) ;

/// @brief Method .ctor, addr 0x181bda280, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Data::SqlTypes::SqlString  value) ;

/// @brief Method get_Buffer, addr 0x181bda310, size 0x140, virtual false, abstract: false, final false
inline ::ArrayW<char16_t> get_Buffer() ;

/// @brief Method get_IsNull, addr 0x181bd9b10, size 0x10, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Length, addr 0x181bda450, size 0x70, virtual false, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Null, addr 0x181bda4c0, size 0x90, virtual false, abstract: false, final false
static inline ::System::Data::SqlTypes::SqlChars* get_Null() ;

/// @brief Method get_Value, addr 0x181bda550, size 0x1d0, virtual false, abstract: false, final false
inline ::ArrayW<char16_t> get_Value() ;
...
/// @brief Field _rgchWorkBuf, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<char16_t>  ____rgchWorkBuf;
...
static_assert(sizeof(::System::Data::SqlTypes::SqlChars) == 0x38, "Size mismatch!");
