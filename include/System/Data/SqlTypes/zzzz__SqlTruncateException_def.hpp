...
// Write type traits
MARK_REF_T(::System::Data::SqlTypes::SqlTruncateException*);
DEFINE_IL2CPP_CLASS(::System::Data::SqlTypes::SqlTruncateException*, "System.Data.SqlTypes", "SqlTruncateException");
...
/// @brief Method SqlTruncateExceptionSerialization, addr 0x181bec2b0, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::SerializationInfo* SqlTruncateExceptionSerialization(::System::Runtime::Serialization::SerializationInfo*  si, ::System::Runtime::Serialization::StreamingContext  sc) ;

/// @brief Method .ctor, addr 0x181bec370, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181bec4e0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x181bec350, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  e) ;

/// @brief Method .ctor, addr 0x181bec3a0, size 0x140, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::SqlTypes::SqlTruncateException) == 0x90, "Size mismatch!");
