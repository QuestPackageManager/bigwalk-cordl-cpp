...
static_assert(offsetof(::System::Data::SqlTypes::SqlCompareOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Data::SqlTypes::SqlCompareOptions) == 0x4, "Size mismatch!");
