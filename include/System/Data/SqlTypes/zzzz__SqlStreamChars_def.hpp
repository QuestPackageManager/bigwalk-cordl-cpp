...
// Write type traits
MARK_REF_T(::System::Data::SqlTypes::SqlStreamChars*);
DEFINE_IL2CPP_CLASS(::System::Data::SqlTypes::SqlStreamChars*, "System.Data.SqlTypes", "SqlStreamChars");
...
inline int32_t Read(::ArrayW<char16_t>  buffer, int32_t  offset, int32_t  count) ;
...
static_assert(sizeof(::System::Data::SqlTypes::SqlStreamChars) == 0x10, "Size mismatch!");
