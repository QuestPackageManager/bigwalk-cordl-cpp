...
public:
// Declarations
/// @brief Method GetForeignKeyConstraint, addr 0x181b8fc80, size 0x50, virtual false, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* GetForeignKeyConstraint() ;

/// @brief Method IsValidCandidate, addr 0x181b8fcd0, size 0x60, virtual true, abstract: false, final false
