...
/// @brief Field _delayLoadingRelations, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__delayLoadingRelations, put=__cordl_internal_set__delayLoadingRelations)) ::ArrayW<::System::Data::DataRelation*>  _delayLoadingRelations;
...
/// @brief Method AddCore, addr 0x181b8cb50, size 0x570, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method Clear, addr 0x181b8d0c0, size 0x40, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetDataSet, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method RemoveCore, addr 0x181b8d100, size 0x290, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Data::DataRelation*> const& __cordl_internal_get__delayLoadingRelations() const;

constexpr ::ArrayW<::System::Data::DataRelation*>& __cordl_internal_get__delayLoadingRelations() ;
...
constexpr void __cordl_internal_set__delayLoadingRelations(::ArrayW<::System::Data::DataRelation*>  value) ;

constexpr void __cordl_internal_set__relations(::System::Collections::ArrayList*  value) ;

/// @brief Method .ctor, addr 0x181b8d390, size 0x90, virtual false, abstract: false, final false
...
/// @brief Field _delayLoadingRelations, offset: 0x48, size: 0x8, def value: None
 ::ArrayW<::System::Data::DataRelation*>  ____delayLoadingRelations;
...
static_assert(sizeof(::GlobalNamespace::DataRelationCollection_DataSetRelationCollection) == 0x50, "Size mismatch!");
