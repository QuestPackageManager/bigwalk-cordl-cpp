...
/// @brief Method Add, addr 0x181b84f90, size 0x220, virtual false, abstract: false, final false
inline void Add(::System::Data::DataRelation*  relation) ;

/// @brief Method AddCore, addr 0x181b84d40, size 0x250, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method AssignName, addr 0x181b851b0, size 0x60, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method Clear, addr 0x181b85210, size 0x1d0, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x181b853e0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method InternalIndexOf, addr 0x181b85400, size 0x1d0, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  name) ;

/// @brief Method MakeName, addr 0x181b855d0, size 0x50, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataRelationCollection* New_ctor() ;

/// @brief Method OnCollectionChanged, addr 0x181b85620, size 0x80, virtual true, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x181b856a0, size 0x80, virtual true, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterName, addr 0x181b85720, size 0x1a0, virtual false, abstract: false, final false
inline void RegisterName(::StringW  name) ;

/// @brief Method Remove, addr 0x181b85aa0, size 0x190, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataRelation*  relation) ;

/// @brief Method RemoveAt, addr 0x181b858c0, size 0x70, virtual false, abstract: false, final false
inline void RemoveAt(int32_t  index) ;

/// @brief Method RemoveCore, addr 0x181b85930, size 0x170, virtual true, abstract: false, final false
inline void RemoveCore(::System::Data::DataRelation*  relation) ;

/// @brief Method UnregisterName, addr 0x181b85c30, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b85d80, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_CollectionChanged, addr 0x181b85db0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_ObjectID, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method remove_CollectionChanged, addr 0x181b85e70, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::DataRelationCollection) == 0x38, "Size mismatch!");
