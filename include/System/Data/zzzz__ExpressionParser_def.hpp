...
// Write type traits
MARK_REF_T(::System::Data::ExpressionParser*);
...
public:
// Declarations
/// @brief Method .ctor, addr 0x180bb05e0, size 0x7b0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_word", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_token", ty: "::System::Data::Tokens", modifiers: "", def_value: None }, CppParam { name: "_op", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Data::ExpressionParser_ReservedWords) == 0x10, "Size mismatch!");

} // namespace end def System::Data
// Dependencies System.Data.ExpressionNode, System.Data.ExpressionParser::ReservedWords, System.Data.OperatorInfo, System.Data.Tokens, System.Object
namespace System::Data {
// Is value type: false
...
/// @brief Field _nodeStack, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__nodeStack, put=__cordl_internal_set__nodeStack)) ::ArrayW<::System::Data::ExpressionNode*>  _nodeStack;
...
/// @brief Field _ops, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__ops, put=__cordl_internal_set__ops)) ::ArrayW<::System::Data::OperatorInfo*>  _ops;
...
/// @brief Field _text, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__text, put=__cordl_internal_set__text)) ::ArrayW<char16_t>  _text;
...
/// @brief Field s_reservedwords, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_reservedwords, put=setStaticF_s_reservedwords)) ::ArrayW<::System::Data::ExpressionParser_ReservedWords>  s_reservedwords;

/// @brief Method BuildExpression, addr 0x181b9e370, size 0x260, virtual false, abstract: false, final false
inline void BuildExpression(int32_t  pri) ;

/// @brief Method CheckToken, addr 0x181b9e5d0, size 0x30, virtual false, abstract: false, final false
inline void CheckToken(::System::Data::Tokens  token) ;

/// @brief Method IsAlpha, addr 0x181b9e6a0, size 0x80, virtual false, abstract: false, final false
inline bool IsAlpha(char16_t  ch) ;

/// @brief Method IsAlphaNumeric, addr 0x181b9e600, size 0xa0, virtual false, abstract: false, final false
inline bool IsAlphaNumeric(char16_t  ch) ;

/// @brief Method IsDigit, addr 0x181b9e720, size 0x60, virtual false, abstract: false, final false
inline bool IsDigit(char16_t  ch) ;

/// @brief Method IsWhiteSpace, addr 0x181b9e780, size 0x10, virtual false, abstract: false, final false
inline bool IsWhiteSpace(char16_t  ch) ;

/// @brief Method LoadExpression, addr 0x181b9e790, size 0xc0, virtual false, abstract: false, final false
inline void LoadExpression(::StringW  data) ;

static inline ::System::Data::ExpressionParser* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method NodePeek, addr 0x181b9e850, size 0x20, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* NodePeek() ;

/// @brief Method NodePop, addr 0x181b9e870, size 0x20, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* NodePop() ;

/// @brief Method NodePush, addr 0x181b9e890, size 0x50, virtual false, abstract: false, final false
inline void NodePush(::System::Data::ExpressionNode*  node) ;

/// @brief Method Parse, addr 0x181b9eb80, size 0xd60, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* Parse() ;

/// @brief Method ParseAggregateArgument, addr 0x181b9e8e0, size 0x2a0, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* ParseAggregateArgument(::System::Data::FunctionId  aggregate) ;

/// @brief Method Scan, addr 0x181ba0010, size 0x930, virtual false, abstract: false, final false
inline ::System::Data::Tokens Scan() ;

/// @brief Method ScanBinaryConstant, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void ScanBinaryConstant() ;

/// @brief Method ScanDate, addr 0x181b9f8e0, size 0xe0, virtual false, abstract: false, final false
inline void ScanDate() ;

/// @brief Method ScanName, addr 0x181b9f9c0, size 0xc0, virtual false, abstract: false, final false
inline void ScanName() ;

/// @brief Method ScanName, addr 0x181b9fa80, size 0xf0, virtual false, abstract: false, final false
inline void ScanName(char16_t  chEnd, char16_t  esc, ::StringW  charsToEscape) ;

/// @brief Method ScanNumeric, addr 0x181b9fb70, size 0x190, virtual false, abstract: false, final false
inline void ScanNumeric() ;

/// @brief Method ScanReserved, addr 0x181b9fd00, size 0x1d0, virtual false, abstract: false, final false
inline void ScanReserved() ;

/// @brief Method ScanString, addr 0x181b9fed0, size 0xb0, virtual false, abstract: false, final false
inline void ScanString(char16_t  escape) ;

/// @brief Method ScanToken, addr 0x181b9ff80, size 0x50, virtual false, abstract: false, final false
inline void ScanToken(::System::Data::Tokens  token) ;

/// @brief Method ScanWhite, addr 0x181b9ffd0, size 0x40, virtual false, abstract: false, final false
inline void ScanWhite() ;

/// @brief Method StartScan, addr 0x181ba0940, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Data::ExpressionNode*> const& __cordl_internal_get__nodeStack() const;

constexpr ::ArrayW<::System::Data::ExpressionNode*>& __cordl_internal_get__nodeStack() ;

constexpr int32_t const& __cordl_internal_get__op() const;

constexpr int32_t& __cordl_internal_get__op() ;

constexpr ::ArrayW<::System::Data::OperatorInfo*> const& __cordl_internal_get__ops() const;

constexpr ::ArrayW<::System::Data::OperatorInfo*>& __cordl_internal_get__ops() ;
...
constexpr ::ArrayW<char16_t> const& __cordl_internal_get__text() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get__text() ;
...
constexpr void __cordl_internal_set__nodeStack(::ArrayW<::System::Data::ExpressionNode*>  value) ;

constexpr void __cordl_internal_set__op(int32_t  value) ;

constexpr void __cordl_internal_set__ops(::ArrayW<::System::Data::OperatorInfo*>  value) ;
...
constexpr void __cordl_internal_set__text(::ArrayW<char16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181ba0cd0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

static inline ::ArrayW<::System::Data::ExpressionParser_ReservedWords> getStaticF_s_reservedwords() ;

static inline void setStaticF_s_reservedwords(::ArrayW<::System::Data::ExpressionParser_ReservedWords>  value) ;
...
/// @brief Field _ops, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::System::Data::OperatorInfo*>  ____ops;
...
/// @brief Field _nodeStack, offset: 0x50, size: 0x8, def value: None
 ::ArrayW<::System::Data::ExpressionNode*>  ____nodeStack;
...
static_assert(sizeof(::System::Data::ExpressionParser) == 0x68, "Size mismatch!");
