...
// Write type traits
MARK_REF_T(::System::Data::NewDiffgramGen*);
DEFINE_IL2CPP_CLASS(::System::Data::NewDiffgramGen*, "System.Data", "NewDiffgramGen");
...
/// @brief Method CreateTableHierarchy, addr 0x181bc6370, size 0x260, virtual false, abstract: false, final false
inline void CreateTableHierarchy(::System::Data::DataTable*  dt) ;

/// @brief Method DoAssignments, addr 0x181bc65d0, size 0x250, virtual false, abstract: false, final false
inline void DoAssignments(::System::Collections::ArrayList*  tables) ;

/// @brief Method EmptyData, addr 0x181bc6820, size 0xe0, virtual false, abstract: false, final false
inline bool EmptyData() ;

/// @brief Method GenerateColumn, addr 0x181bc6900, size 0x670, virtual false, abstract: false, final false
inline void GenerateColumn(::System::Data::DataRow*  row, ::System::Data::DataColumn*  col, ::System::Data::DataRowVersion  version) ;

/// @brief Method GenerateRow, addr 0x181bc6f70, size 0x490, virtual false, abstract: false, final false
inline void GenerateRow(::System::Data::DataRow*  row) ;

/// @brief Method GenerateTable, addr 0x181bc7880, size 0x80, virtual false, abstract: false, final false
inline void GenerateTable(::System::Data::DataTable*  table) ;

/// @brief Method GenerateTableErrors, addr 0x181bc7400, size 0x480, virtual false, abstract: false, final false
...
/// @brief Method QualifiedName, addr 0x181bc7900, size 0x20, virtual false, abstract: false, final false
static inline ::StringW QualifiedName(::StringW  prefix, ::StringW  name) ;

/// @brief Method Save, addr 0x181bc7f80, size 0x10, virtual false, abstract: false, final false
inline void Save(::System::Xml::XmlWriter*  xmlw) ;

/// @brief Method Save, addr 0x181bc7920, size 0x660, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181bc8080, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  ds) ;

/// @brief Method .ctor, addr 0x181bc7f90, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::NewDiffgramGen) == 0x50, "Size mismatch!");
