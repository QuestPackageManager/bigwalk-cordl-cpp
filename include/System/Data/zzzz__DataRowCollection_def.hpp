...
// Write type traits
MARK_REF_T(::System::Data::DataRowCollection*);
MARK_REF_T(::System::Data::DataRowCollection_DataRowTree*);
DEFINE_IL2CPP_CLASS(::System::Data::DataRowCollection*, "System.Data", "DataRowCollection");
DEFINE_IL2CPP_CLASS(::System::Data::DataRowCollection_DataRowTree*, "System.Data", "DataRowCollection/DataRowTree");
...
public:
// Declarations
/// @brief Method CompareNode, addr 0x181b89050, size 0x20, virtual true, abstract: false, final false
inline int32_t CompareNode(::System::Data::DataRow*  record1, ::System::Data::DataRow*  record2) ;

/// @brief Method CompareSateliteTreeNode, addr 0x181b89070, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b89090, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x181b88c00, size 0x20, virtual false, abstract: false, final false
inline void Add(::System::Data::DataRow*  row) ;

/// @brief Method AddWithColumnEvents, addr 0x181b88ba0, size 0x60, virtual false, abstract: false, final false
inline ::System::Data::DataRow* AddWithColumnEvents(::ArrayW<::System::Object*>  values) ;

/// @brief Method ArrayAdd, addr 0x181b88c20, size 0x70, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataRow*  row) ;

/// @brief Method ArrayClear, addr 0x181b88c90, size 0x10, virtual false, abstract: false, final false
inline void ArrayClear() ;

/// @brief Method ArrayInsert, addr 0x181b88ca0, size 0x80, virtual false, abstract: false, final false
inline void ArrayInsert(::System::Data::DataRow*  row, int32_t  pos) ;

/// @brief Method ArrayRemove, addr 0x181b88d20, size 0x90, virtual false, abstract: false, final false
inline void ArrayRemove(::System::Data::DataRow*  row) ;

/// @brief Method CopyTo, addr 0x181b88dc0, size 0x10, virtual true, abstract: false, final false
inline void CopyTo(::System::Array*  ar, int32_t  index) ;

/// @brief Method CopyTo, addr 0x181b88db0, size 0x10, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<::System::Data::DataRow*>  array, int32_t  index) ;

/// @brief Method DiffInsertAt, addr 0x181b88dd0, size 0x170, virtual false, abstract: false, final false
inline void DiffInsertAt(::System::Data::DataRow*  row, int32_t  pos) ;

/// @brief Method GetEnumerator, addr 0x181b88f40, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x181b88f50, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b88fc0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method get_Count, addr 0x181b89030, size 0x10, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x181b89040, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::DataRowCollection) == 0x28, "Size mismatch!");
