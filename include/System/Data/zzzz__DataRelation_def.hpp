...
// Declarations
 ...
 __declspec(property(get=get_ChildColumns)) ::ArrayW<::System::Data::DataColumn*>  ChildColumns;

 __declspec(property(get=get_ChildColumnsReference)) ::ArrayW<::System::Data::DataColumn*>  ChildColumnsReference;
 ...
 __declspec(property(get=get_ParentColumns)) ::ArrayW<::System::Data::DataColumn*>  ParentColumns;

 __declspec(property(get=get_ParentColumnsReference)) ::ArrayW<::System::Data::DataColumn*>  ParentColumnsReference;
...
/// @brief Field _childColumnNames, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__childColumnNames, put=__cordl_internal_set__childColumnNames)) ::ArrayW<::StringW>  _childColumnNames;
...
/// @brief Field _parentColumnNames, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__parentColumnNames, put=__cordl_internal_set__parentColumnNames)) ::ArrayW<::StringW>  _parentColumnNames;
...
/// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x181b86060, size 0x1e0, virtual false, abstract: false, final false
inline void CheckNamespaceValidityForNestedRelations(::StringW  ns) ;

/// @brief Method CheckNestedRelations, addr 0x181b86240, size 0x360, virtual false, abstract: false, final false
inline void CheckNestedRelations() ;

/// @brief Method CheckState, addr 0x181b865e0, size 0x180, virtual false, abstract: false, final false
inline void CheckState() ;

/// @brief Method CheckStateForProperty, addr 0x181b865a0, size 0x40, virtual false, abstract: false, final false
inline void CheckStateForProperty() ;

/// @brief Method Clone, addr 0x181b86760, size 0x670, virtual false, abstract: false, final false
inline ::System::Data::DataRelation* Clone(::System::Data::DataSet*  destination) ;

/// @brief Method Create, addr 0x181b86dd0, size 0x210, virtual false, abstract: false, final false
inline void Create(::StringW  relationName, ::ArrayW<::System::Data::DataColumn*>  parentColumns, ::ArrayW<::System::Data::DataColumn*>  childColumns, bool  createConstraints) ;

/// @brief Method GetChildRows, addr 0x181b86fe0, size 0xe0, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Data::DataRow*> GetChildRows(::System::Data::DataKey  parentKey, ::System::Data::DataKey  childKey, ::System::Data::DataRow*  parentRow, ::System::Data::DataRowVersion  version) ;

/// @brief Method GetParentRow, addr 0x181b870c0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method GetParentRows, addr 0x181b87250, size 0xe0, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Data::DataRow*> GetParentRows(::System::Data::DataKey  parentKey, ::System::Data::DataKey  childKey, ::System::Data::DataRow*  childRow, ::System::Data::DataRowVersion  version) ;

/// @brief Method IsAutoGenerated, addr 0x181b87330, size 0x150, virtual false, abstract: false, final false
inline bool IsAutoGenerated(::System::Data::DataColumn*  col) ;

/// @brief Method IsKeyNull, addr 0x181b87480, size 0x60, virtual false, abstract: false, final false
static inline bool IsKeyNull(::ArrayW<::System::Object*>  values) ;
...
static inline ::System::Data::DataRelation* New_ctor(::StringW  relationName, ::ArrayW<::System::Data::DataColumn*>  parentColumns, ::ArrayW<::System::Data::DataColumn*>  childColumns, bool  createConstraints) ;

static inline ::System::Data::DataRelation* New_ctor(::StringW  relationName, ::StringW  parentTableName, ::StringW  childTableName, ::ArrayW<::StringW>  parentColumnNames, ::ArrayW<::StringW>  childColumnNames, bool  nested) ;

static inline ::System::Data::DataRelation* New_ctor(::StringW  relationName, ::StringW  parentTableName, ::StringW  parentTableNamespace, ::StringW  childTableName, ::StringW  childTableNamespace, ::ArrayW<::StringW>  parentColumnNames, ::ArrayW<::StringW>  childColumnNames, bool  nested) ;

/// @brief Method OnPropertyChanging, addr 0x181b874e0, size 0x80, virtual false, abstract: false, final false
inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs*  pcevent) ;

/// @brief Method RaisePropertyChanging, addr 0x181b87560, size 0xa0, virtual false, abstract: false, final false
inline void RaisePropertyChanging(::StringW  name) ;

/// @brief Method SetChildKeyConstraint, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint*  value) ;

/// @brief Method SetDataSet, addr 0x181b87600, size 0x20, virtual false, abstract: false, final false
inline void SetDataSet(::System::Data::DataSet*  dataSet) ;

/// @brief Method SetParentKeyConstraint, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void SetParentKeyConstraint(::System::Data::UniqueConstraint*  value) ;

/// @brief Method ToString, addr 0x181163a30, size 0xb0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateMultipleNestedRelations, addr 0x181b87620, size 0x450, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get__childColumnNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__childColumnNames() ;
...
constexpr ::System::Data::ForeignKeyConstraint* const& __cordl_internal_get__childKeyConstraint() const;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get__parentColumnNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__parentColumnNames() ;
...
constexpr ::System::Data::UniqueConstraint* const& __cordl_internal_get__parentKeyConstraint() const;
...
constexpr void __cordl_internal_set__childColumnNames(::ArrayW<::StringW>  value) ;
...
constexpr void __cordl_internal_set__parentColumnNames(::ArrayW<::StringW>  value) ;
...
/// @brief Method .ctor, addr 0x181b87a70, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b87c80, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  relationName, ::ArrayW<::System::Data::DataColumn*>  parentColumns, ::ArrayW<::System::Data::DataColumn*>  childColumns) ;

/// @brief Method .ctor, addr 0x181b87be0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b87d90, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b87ca0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::StringW  relationName, ::StringW  parentTableName, ::StringW  parentTableNamespace, ::StringW  childTableName, ::StringW  childTableNamespace, ::ArrayW<::StringW>  parentColumnNames, ::ArrayW<::StringW>  childColumnNames, bool  nested) ;

static inline int32_t getStaticF_s_objectTypeCount() ;

/// @brief Method get_CheckMultipleNested, addr 0x181b87e60, size 0x10, virtual false, abstract: false, final false
inline bool get_CheckMultipleNested() ;

/// @brief Method get_ChildColumnNames, addr 0x181b87e70, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_ChildColumnNames() ;

/// @brief Method get_ChildColumns, addr 0x181b87ea0, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> get_ChildColumns() ;

/// @brief Method get_ChildColumnsReference, addr 0x181b87e80, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> get_ChildColumnsReference() ;

/// @brief Method get_ChildKey, addr 0x181b87e80, size 0x20, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ChildKey() ;

/// @brief Method get_ChildKeyConstraint, addr 0x181b87ec0, size 0x20, virtual true, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint() ;

/// @brief Method get_ChildTable, addr 0x181b87ee0, size 0x30, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ChildTable() ;

/// @brief Method get_DataSet, addr 0x181b87f10, size 0x20, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get_DataSet() ;

/// @brief Method get_ExtendedProperties, addr 0x181b87f30, size 0x50, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_Nested, addr 0x181b87f80, size 0x20, virtual true, abstract: false, final false
inline bool get_Nested() ;

/// @brief Method get_ObjectID, addr 0x180371740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method get_ParentColumnNames, addr 0x181b87fa0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_ParentColumnNames() ;

/// @brief Method get_ParentColumns, addr 0x181b87fb0, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> get_ParentColumns() ;

/// @brief Method get_ParentColumnsReference, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> get_ParentColumnsReference() ;

/// @brief Method get_ParentKey, addr 0x181b87ff0, size 0x20, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ParentKey() ;

/// @brief Method get_ParentKeyConstraint, addr 0x181b87fd0, size 0x20, virtual true, abstract: false, final false
inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint() ;

/// @brief Method get_ParentTable, addr 0x181b88010, size 0x30, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ParentTable() ;

/// @brief Method get_RelationName, addr 0x181b88040, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_RelationName() ;

static inline void setStaticF_s_objectTypeCount(int32_t  value) ;

/// @brief Method set_CheckMultipleNested, addr 0x181b88060, size 0x10, virtual false, abstract: false, final false
inline void set_CheckMultipleNested(bool  value) ;

/// @brief Method set_Nested, addr 0x181b88070, size 0xb30, virtual true, abstract: false, final false
...
/// @brief Field _parentColumnNames, offset: 0x48, size: 0x8, def value: None
 ::ArrayW<::StringW>  ____parentColumnNames;

/// @brief Field _childColumnNames, offset: 0x50, size: 0x8, def value: None
 ::ArrayW<::StringW>  ____childColumnNames;
...
static_assert(sizeof(::System::Data::DataRelation) == 0x88, "Size mismatch!");
