...
/// @brief Method CreateChildView, addr 0x181b89250, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataView* CreateChildView(::System::Data::DataRelation*  relation) ;

/// @brief Method CreateChildView, addr 0x181b890b0, size 0x1a0, virtual false, abstract: false, final false
inline ::System::Data::DataView* CreateChildView(::System::Data::DataRelation*  relation, bool  followParent) ;

/// @brief Method EndEdit, addr 0x181b89260, size 0x50, virtual true, abstract: false, final true
inline void EndEdit() ;

/// @brief Method Equals, addr 0x1805a8800, size 0x10, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetColumnValue, addr 0x181b892b0, size 0xd0, virtual false, abstract: false, final false
inline ::System::Object* GetColumnValue(::System::Data::DataColumn*  column) ;

/// @brief Method GetHashCode, addr 0x181b89380, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetRecord, addr 0x181b893a0, size 0x60, virtual false, abstract: false, final false
inline int32_t GetRecord() ;

/// @brief Method HasRecord, addr 0x181b89400, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method RaisePropertyChangedEvent, addr 0x181b89440, size 0x70, virtual false, abstract: false, final false
inline void RaisePropertyChangedEvent(::StringW  propName) ;

/// @brief Method SetColumnValue, addr 0x181b894b0, size 0x90, virtual false, abstract: false, final false
inline void SetColumnValue(::System::Data::DataColumn*  column, ::System::Object*  value) ;

/// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetAttributes, addr 0x181b89540, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetConverter, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetEvents, addr 0x181b89570, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetProperties, addr 0x181b895a0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method System.ComponentModel.ICustomTypeDescriptor.GetPropertyOwner, addr 0x1802e0ba0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_DataView, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataView* get_DataView() ;

/// @brief Method get_IsNew, addr 0x181b89650, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNew() ;

/// @brief Method get_Row, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataRow* get_Row() ;

/// @brief Method get_RowVersionDefault, addr 0x181b89660, size 0x40, virtual false, abstract: false, final false
