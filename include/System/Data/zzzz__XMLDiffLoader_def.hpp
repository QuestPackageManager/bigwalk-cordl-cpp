...
// Write type traits
MARK_REF_T(::System::Data::XMLDiffLoader*);
DEFINE_IL2CPP_CLASS(::System::Data::XMLDiffLoader*, "System.Data", "XMLDiffLoader");
...
/// @brief Method CreateTablesHierarchy, addr 0x181bb0cf0, size 0x260, virtual false, abstract: false, final false
inline void CreateTablesHierarchy(::System::Data::DataTable*  dt) ;

/// @brief Method GetTable, addr 0x181bb0f50, size 0x1e0, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTable(::StringW  tableName, ::StringW  ns) ;

/// @brief Method LoadDiffGram, addr 0x181bb1130, size 0x1a0, virtual false, abstract: false, final false
inline void LoadDiffGram(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  dataTextReader) ;

/// @brief Method LoadDiffGram, addr 0x181bb12d0, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method ProcessDiffs, addr 0x181bb14e0, size 0x300, virtual false, abstract: false, final false
inline void ProcessDiffs(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessDiffs, addr 0x181bb17e0, size 0x2c0, virtual false, abstract: false, final false
inline void ProcessDiffs(::System::Collections::ArrayList*  tableList, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessErrors, addr 0x181bb1f50, size 0x3a0, virtual false, abstract: false, final false
inline void ProcessErrors(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessErrors, addr 0x181bb1aa0, size 0x4b0, virtual false, abstract: false, final false
inline void ProcessErrors(::System::Collections::ArrayList*  dt, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ReadOldRowData, addr 0x181bb22f0, size 0xd00, virtual false, abstract: false, final false
...
/// @brief Method SkipWhitespaces, addr 0x181bb2ff0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::XMLDiffLoader) == 0x28, "Size mismatch!");
