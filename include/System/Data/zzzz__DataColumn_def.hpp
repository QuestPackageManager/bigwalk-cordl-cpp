...
/// @brief Method AddDependentColumn, addr 0x181b68160, size 0xd0, virtual false, abstract: false, final false
inline void AddDependentColumn(::System::Data::DataColumn*  expressionColumn) ;

/// @brief Method CheckColumnConstraint, addr 0x181b68230, size 0xe0, virtual false, abstract: false, final false
inline void CheckColumnConstraint(::System::Data::DataRow*  row, ::System::Data::DataRowAction  action) ;

/// @brief Method CheckMaxLength, addr 0x181b68380, size 0x1d0, virtual false, abstract: false, final false
inline bool CheckMaxLength() ;

/// @brief Method CheckMaxLength, addr 0x181b68310, size 0x70, virtual false, abstract: false, final false
inline void CheckMaxLength(::System::Data::DataRow*  dr) ;

/// @brief Method CheckNotAllowNull, addr 0x181b68550, size 0x240, virtual false, abstract: false, final false
inline void CheckNotAllowNull() ;

/// @brief Method CheckNullable, addr 0x181b68790, size 0x70, virtual false, abstract: false, final false
inline void CheckNullable(::System::Data::DataRow*  row) ;

/// @brief Method CheckUnique, addr 0x181b68800, size 0x50, virtual false, abstract: false, final false
inline void CheckUnique() ;

/// @brief Method Clone, addr 0x181b68850, size 0x500, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* Clone() ;

/// @brief Method Compare, addr 0x181b68ef0, size 0x20, virtual false, abstract: false, final false
inline int32_t Compare(int32_t  record1, int32_t  record2) ;

/// @brief Method CompareValueTo, addr 0x181b68d50, size 0x180, virtual false, abstract: false, final false
inline bool CompareValueTo(int32_t  record1, ::System::Object*  value, bool  checkType) ;

/// @brief Method CompareValueTo, addr 0x181b68ed0, size 0x20, virtual false, abstract: false, final false
inline int32_t CompareValueTo(int32_t  record1, ::System::Object*  value) ;

/// @brief Method ConvertObjectToXml, addr 0x181b68f10, size 0x70, virtual false, abstract: false, final false
inline ::StringW ConvertObjectToXml(::System::Object*  value) ;

/// @brief Method ConvertObjectToXml, addr 0x181b68f80, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ConvertValue, addr 0x181b69010, size 0x20, virtual false, abstract: false, final false
inline ::System::Object* ConvertValue(::System::Object*  value) ;

/// @brief Method ConvertXmlToObject, addr 0x181b69030, size 0x70, virtual false, abstract: false, final false
inline ::System::Object* ConvertXmlToObject(::StringW  s) ;

/// @brief Method ConvertXmlToObject, addr 0x181b690a0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Copy, addr 0x181b69140, size 0x20, virtual false, abstract: false, final false
inline void Copy(int32_t  srcRecordNo, int32_t  dstRecordNo) ;

/// @brief Method CopyValueIntoStore, addr 0x181b69120, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method FreeRecord, addr 0x181b69160, size 0x30, virtual false, abstract: false, final false
inline void FreeRecord(int32_t  record) ;

/// @brief Method GetAggregateValue, addr 0x181b69190, size 0x80, virtual false, abstract: false, final false
inline ::System::Object* GetAggregateValue(::ArrayW<int32_t>  records, ::System::Data::AggregateType  kind) ;

/// @brief Method GetColumnValueAsString, addr 0x181b69210, size 0xc0, virtual false, abstract: false, final false
inline ::StringW GetColumnValueAsString(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method GetDataRow, addr 0x181b692d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataRow* GetDataRow(int32_t  index) ;

/// @brief Method GetEmptyColumnStore, addr 0x181b692e0, size 0x60, virtual false, abstract: false, final false
inline ::System::Object* GetEmptyColumnStore(int32_t  recordCount) ;

/// @brief Method GetStringLength, addr 0x181b69340, size 0x20, virtual false, abstract: false, final false
inline int32_t GetStringLength(int32_t  record) ;

/// @brief Method HandleDependentColumnList, addr 0x181b69360, size 0x1e0, virtual false, abstract: false, final false
inline void HandleDependentColumnList(::System::Data::DataExpression*  oldExpression, ::System::Data::DataExpression*  newExpression) ;

/// @brief Method Init, addr 0x181b69540, size 0xb0, virtual false, abstract: false, final false
inline void Init(int32_t  record) ;

/// @brief Method InitializeRecord, addr 0x181b695f0, size 0x40, virtual false, abstract: false, final false
inline void InitializeRecord(int32_t  record) ;

/// @brief Method InsureStorage, addr 0x181b69630, size 0x50, virtual false, abstract: false, final false
inline void InsureStorage() ;

/// @brief Method InternalUnique, addr 0x1813bddf0, size 0x1ac0, virtual false, abstract: false, final false
inline void InternalUnique(bool  value) ;

/// @brief Method IsAutoIncrementType, addr 0x181b69680, size 0x160, virtual false, abstract: false, final false
static inline bool IsAutoIncrementType(::System::Type*  dataType) ;

/// @brief Method IsInRelation, addr 0x181b697e0, size 0x160, virtual false, abstract: false, final false
inline bool IsInRelation() ;

/// @brief Method IsMaxLengthViolated, addr 0x181b69940, size 0x330, virtual false, abstract: false, final false
inline bool IsMaxLengthViolated() ;

/// @brief Method IsNotAllowDBNullViolated, addr 0x181b69c70, size 0x110, virtual false, abstract: false, final false
inline bool IsNotAllowDBNullViolated() ;

/// @brief Method IsValueCustomTypeInstance, addr 0x181b69d80, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method OnPropertyChanging, addr 0x181b69e00, size 0x30, virtual true, abstract: false, final false
inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs*  pcevent) ;

/// @brief Method OnSetDataSet, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void OnSetDataSet() ;

/// @brief Method RaisePropertyChanging, addr 0x181b69e30, size 0x60, virtual false, abstract: false, final false
inline void RaisePropertyChanging(::StringW  name) ;

/// @brief Method RemoveDependentColumn, addr 0x181b69e90, size 0x60, virtual false, abstract: false, final false
inline void RemoveDependentColumn(::System::Data::DataColumn*  expressionColumn) ;

/// @brief Method SetCapacity, addr 0x181b69ef0, size 0x70, virtual false, abstract: false, final false
inline void SetCapacity(int32_t  capacity) ;

/// @brief Method SetMaxLengthSimpleType, addr 0x181b69f60, size 0xf0, virtual false, abstract: false, final false
inline void SetMaxLengthSimpleType() ;

/// @brief Method SetOrdinalInternal, addr 0x181b6a050, size 0xe0, virtual false, abstract: false, final false
inline void SetOrdinalInternal(int32_t  ordinal) ;

/// @brief Method SetStorage, addr 0x181b6a130, size 0x70, virtual false, abstract: false, final false
inline void SetStorage(::System::Object*  store, ::System::Collections::BitArray*  nullbits) ;

/// @brief Method SetTable, addr 0x181b6a1a0, size 0xc0, virtual false, abstract: false, final false
inline void SetTable(::System::Data::DataTable*  table) ;

/// @brief Method SetValue, addr 0x181b6a260, size 0xc0, virtual false, abstract: false, final false
inline void SetValue(int32_t  record, ::System::Object*  value) ;

/// @brief Method ToString, addr 0x181b6a320, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UpdateColumnType, addr 0x181b6a360, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b6a450, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181b6a420, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  columnName, ::System::Type*  dataType) ;

/// @brief Method .ctor, addr 0x181b6a4a0, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method get_AllowDBNull, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_AllowDBNull() ;

/// @brief Method get_AutoInc, addr 0x181b6a710, size 0xc0, virtual false, abstract: false, final false
inline ::System::Data::AutoIncrementValue* get_AutoInc() ;

/// @brief Method get_AutoIncrement, addr 0x181b6a880, size 0x20, virtual false, abstract: false, final false
inline bool get_AutoIncrement() ;

/// @brief Method get_AutoIncrementCurrent, addr 0x181b6a7d0, size 0x50, virtual false, abstract: false, final false
inline ::System::Object* get_AutoIncrementCurrent() ;

/// @brief Method get_AutoIncrementSeed, addr 0x181b6a820, size 0x30, virtual false, abstract: false, final false
inline int64_t get_AutoIncrementSeed() ;

/// @brief Method get_AutoIncrementStep, addr 0x181b6a850, size 0x30, virtual false, abstract: false, final false
inline int64_t get_AutoIncrementStep() ;

/// @brief Method get_Caption, addr 0x181b6a8a0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Caption() ;

/// @brief Method get_ColumnMapping, addr 0x180371750, size 0x10, virtual true, abstract: false, final false
inline ::System::Data::MappingType get_ColumnMapping() ;

/// @brief Method get_ColumnName, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ColumnName() ;

/// @brief Method get_Computed, addr 0x181b6a8c0, size 0x10, virtual false, abstract: false, final false
inline bool get_Computed() ;

/// @brief Method get_DataExpression, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataExpression* get_DataExpression() ;

/// @brief Method get_DataType, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_DataType() ;

/// @brief Method get_DateTimeMode, addr 0x1803d7410, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataSetDateTime get_DateTimeMode() ;

/// @brief Method get_DefaultValue, addr 0x181b6a8d0, size 0x140, virtual false, abstract: false, final false
inline ::System::Object* get_DefaultValue() ;

/// @brief Method get_DefaultValueIsNull, addr 0x180430a20, size 0x10, virtual false, abstract: false, final false
inline bool get_DefaultValueIsNull() ;

/// @brief Method get_EncodedColumnName, addr 0x181b6aa10, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_EncodedColumnName() ;

/// @brief Method get_Expression, addr 0x181b6aa60, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Expression() ;

/// @brief Method get_ExtendedProperties, addr 0x181b6aa80, size 0x60, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_FormatProvider, addr 0x181b6aae0, size 0x20, virtual false, abstract: false, final false
inline ::System::IFormatProvider* get_FormatProvider() ;

/// @brief Method get_HasData, addr 0x181b6ab00, size 0x10, virtual false, abstract: false, final false
inline bool get_HasData() ;

/// @brief Method get_ImplementsIChangeTracking, addr 0x181b6ab10, size 0x10, virtual false, abstract: false, final false
inline bool get_ImplementsIChangeTracking() ;

/// @brief Method get_ImplementsINullable, addr 0x181b6ab20, size 0x10, virtual false, abstract: false, final false
inline bool get_ImplementsINullable() ;

/// @brief Method get_ImplementsIRevertibleChangeTracking, addr 0x181b6ab30, size 0x10, virtual false, abstract: false, final false
inline bool get_ImplementsIRevertibleChangeTracking() ;

/// @brief Method get_ImplementsIXMLSerializable, addr 0x180430b00, size 0x10, virtual false, abstract: false, final false
inline bool get_ImplementsIXMLSerializable() ;

/// @brief Method get_IsCustomType, addr 0x181b6ab40, size 0x30, virtual false, abstract: false, final false
inline bool get_IsCustomType() ;

/// @brief Method get_IsSqlType, addr 0x180cbfa60, size 0x10, virtual false, abstract: false, final false
inline bool get_IsSqlType() ;

/// @brief Method get_IsValueType, addr 0x181b6ab70, size 0x10, virtual false, abstract: false, final false
inline bool get_IsValueType() ;

/// @brief Method get_Item, addr 0x181b6ab80, size 0x20, virtual false, abstract: false, final false
inline ::System::Object* get_Item(int32_t  record) ;

/// @brief Method get_Locale, addr 0x181b6aba0, size 0x20, virtual false, abstract: false, final false
inline ::System::Globalization::CultureInfo* get_Locale() ;

/// @brief Method get_MaxLength, addr 0x18039fc60, size 0x10, virtual false, abstract: false, final false
inline int32_t get_MaxLength() ;

/// @brief Method get_Namespace, addr 0x181b6abc0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_ObjectID, addr 0x1813efee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method get_Ordinal, addr 0x180de9ef0, size 0x60, virtual false, abstract: false, final false
inline int32_t get_Ordinal() ;

/// @brief Method get_Prefix, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadOnly, addr 0x180347a60, size 0xe0, virtual false, abstract: false, final false
inline bool get_ReadOnly() ;

/// @brief Method get_SimpleType, addr 0x1803b2f10, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::SimpleType* get_SimpleType() ;

/// @brief Method get_SortIndex, addr 0x181b6ac00, size 0xb0, virtual false, abstract: false, final false
inline ::System::Data::Index* get_SortIndex() ;

/// @brief Method get_Table, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Table() ;

/// @brief Method get_Unique, addr 0x1802e56a0, size 0x10, virtual false, abstract: false, final false
inline bool get_Unique() ;

/// @brief Method get_XmlDataType, addr 0x1803459d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_XmlDataType() ;

static inline void setStaticF_s_objectTypeCount(int32_t  value) ;

/// @brief Method set_AllowDBNull, addr 0x181b6acb0, size 0x100, virtual false, abstract: false, final false
inline void set_AllowDBNull(bool  value) ;

/// @brief Method set_AutoIncrement, addr 0x181b6b030, size 0x130, virtual false, abstract: false, final false
inline void set_AutoIncrement(bool  value) ;

/// @brief Method set_AutoIncrementCurrent, addr 0x181b6adb0, size 0x100, virtual false, abstract: false, final false
inline void set_AutoIncrementCurrent(::System::Object*  value) ;

/// @brief Method set_AutoIncrementSeed, addr 0x181b6aeb0, size 0xc0, virtual false, abstract: false, final false
inline void set_AutoIncrementSeed(int64_t  value) ;

/// @brief Method set_AutoIncrementStep, addr 0x181b6af70, size 0xc0, virtual false, abstract: false, final false
inline void set_AutoIncrementStep(int64_t  value) ;

/// @brief Method set_Caption, addr 0x181b6b160, size 0x90, virtual false, abstract: false, final false
inline void set_Caption(::StringW  value) ;

/// @brief Method set_ColumnMapping, addr 0x181b6b1f0, size 0x240, virtual true, abstract: false, final false
inline void set_ColumnMapping(::System::Data::MappingType  value) ;

/// @brief Method set_ColumnName, addr 0x181b6b430, size 0x2f0, virtual false, abstract: false, final false
inline void set_ColumnName(::StringW  value) ;

/// @brief Method set_DataType, addr 0x181b6b720, size 0x950, virtual false, abstract: false, final false
inline void set_DataType(::System::Type*  value) ;

/// @brief Method set_DateTimeMode, addr 0x181b6c070, size 0xf0, virtual false, abstract: false, final false
inline void set_DateTimeMode(::System::Data::DataSetDateTime  value) ;

/// @brief Method set_DefaultValue, addr 0x181b6c160, size 0x240, virtual false, abstract: false, final false
inline void set_DefaultValue(::System::Object*  value) ;

/// @brief Method set_Expression, addr 0x181b6c3a0, size 0x4f0, virtual false, abstract: false, final false
inline void set_Expression(::StringW  value) ;

/// @brief Method set_Item, addr 0x181b6c890, size 0x150, virtual false, abstract: false, final false
inline void set_Item(int32_t  record, ::System::Object*  value) ;

/// @brief Method set_MaxLength, addr 0x181b6c9e0, size 0x2b0, virtual false, abstract: false, final false
inline void set_MaxLength(int32_t  value) ;

/// @brief Method set_Namespace, addr 0x181b6cc90, size 0x120, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_Prefix, addr 0x181b6cdb0, size 0xe0, virtual false, abstract: false, final false
inline void set_Prefix(::StringW  value) ;

/// @brief Method set_ReadOnly, addr 0x181b6ce90, size 0x90, virtual false, abstract: false, final false
inline void set_ReadOnly(bool  value) ;

/// @brief Method set_SimpleType, addr 0x181b6cf20, size 0x50, virtual false, abstract: false, final false
inline void set_SimpleType(::System::Data::SimpleType*  value) ;

/// @brief Method set_Unique, addr 0x181b6cf70, size 0x2d0, virtual false, abstract: false, final false
inline void set_Unique(bool  value) ;

/// @brief Method set_XmlDataType, addr 0x180352c10, size 0x20, virtual false, abstract: false, final false
