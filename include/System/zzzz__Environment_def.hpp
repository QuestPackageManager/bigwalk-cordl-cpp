...
static_assert(offsetof(::System::Environment_SpecialFolder, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Environment_SpecialFolder) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Environment_SpecialFolderOption, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CreateVersionFromString, addr 0x181749550, size 0x180, virtual false, abstract: false, final false
static inline ::System::Version* CreateVersionFromString(::StringW  info) ;

/// @brief Method Exit, addr 0x1817496d0, size 0x10, virtual false, abstract: false, final false
static inline void Exit(int32_t  exitCode) ;

/// @brief Method ExpandEnvironmentVariables, addr 0x1817496e0, size 0x330, virtual false, abstract: false, final false
static inline ::StringW ExpandEnvironmentVariables(::StringW  name) ;

/// @brief Method FailFast, addr 0x181749a10, size 0x10, virtual false, abstract: false, final false
static inline void FailFast(::StringW  message, ::System::Exception*  exception) ;

/// @brief Method FailFast, addr 0x181749a20, size 0x10, virtual false, abstract: false, final false
static inline void FailFast(::StringW  message, ::System::Exception*  exception, ::StringW  errorSource) ;

/// @brief Method GetCommandLineArgs, addr 0x181749a30, size 0x10, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW> GetCommandLineArgs() ;

/// @brief Method GetEnvironmentVariable, addr 0x181749a50, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetEnvironmentVariable(::StringW  variable) ;

/// @brief Method GetEnvironmentVariableNames, addr 0x181749a40, size 0x10, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW> GetEnvironmentVariableNames() ;

/// @brief Method GetEnvironmentVariablesNoCase, addr 0x181749a60, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Collections::Hashtable* GetEnvironmentVariablesNoCase() ;

/// @brief Method GetFolderPath, addr 0x181749b20, size 0x30, virtual false, abstract: false, final false
static inline ::StringW GetFolderPath(::System::Environment_SpecialFolder  folder) ;

/// @brief Method GetFolderPath, addr 0x181749b50, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetMachineConfigPath, addr 0x181749b90, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetMachineConfigPath() ;

/// @brief Method GetNewLine, addr 0x181749ba0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetNewLine() ;

/// @brief Method GetOSVersionString, addr 0x181749bb0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetOSVersionString() ;

/// @brief Method GetPageSize, addr 0x181749bc0, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetPageSize() ;

/// @brief Method GetResourceString, addr 0x1802e0ba0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetResourceString(::StringW  key) ;

/// @brief Method GetResourceString, addr 0x1815c9550, size 0x40, virtual false, abstract: false, final false
static inline ::StringW GetResourceString(::StringW  key, ::ArrayW<::System::Object*>  values) ;

/// @brief Method GetResourceStringEncodingName, addr 0x181749bd0, size 0xc0, virtual false, abstract: false, final false
static inline ::StringW GetResourceStringEncodingName(int32_t  codePage) ;

/// @brief Method GetStackTrace, addr 0x181749c90, size 0x70, virtual false, abstract: false, final false
static inline ::StringW GetStackTrace(::System::Exception*  e, bool  needFileInfo) ;

/// @brief Method GetWindowsFolderPath, addr 0x181749d00, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetWindowsFolderPath(int32_t  folder) ;

/// @brief Method ReadXdgUserDir, addr 0x181749d10, size 0x2a0, virtual false, abstract: false, final false
static inline ::StringW ReadXdgUserDir(::StringW  config_dir, ::StringW  home_dir, ::StringW  key, ::StringW  fallback) ;

/// @brief Method UnixGetFolderPath, addr 0x181749fb0, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentDirectory, addr 0x18174a3a0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_CurrentDirectory() ;

/// @brief Method get_CurrentManagedThreadId, addr 0x18174a3b0, size 0x20, virtual false, abstract: false, final false
static inline int32_t get_CurrentManagedThreadId() ;

/// @brief Method get_HasShutdownStarted, addr 0x18174a3d0, size 0x10, virtual false, abstract: false, final false
static inline bool get_HasShutdownStarted() ;

/// @brief Method get_IsRunningOnWindows, addr 0x18174a3e0, size 0x20, virtual false, abstract: false, final false
static inline bool get_IsRunningOnWindows() ;

/// @brief Method get_IsUnix, addr 0x18174a400, size 0x30, virtual false, abstract: false, final false
static inline bool get_IsUnix() ;

/// @brief Method get_MachineName, addr 0x18174a430, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_MachineName() ;

/// @brief Method get_NewLine, addr 0x18174a440, size 0x60, virtual false, abstract: false, final false
static inline ::StringW get_NewLine() ;

/// @brief Method get_OSVersion, addr 0x18174a4a0, size 0x270, virtual false, abstract: false, final false
static inline ::System::OperatingSystem* get_OSVersion() ;

/// @brief Method get_Platform, addr 0x18174a710, size 0x10, virtual false, abstract: false, final false
static inline ::System::PlatformID get_Platform() ;

/// @brief Method get_ProcessorCount, addr 0x18174a720, size 0x10, virtual false, abstract: false, final false
static inline int32_t get_ProcessorCount() ;

/// @brief Method get_StackTrace, addr 0x18174a730, size 0x50, virtual false, abstract: false, final false
static inline ::StringW get_StackTrace() ;

/// @brief Method get_SystemDirectory, addr 0x18174a780, size 0x110, virtual false, abstract: false, final false
static inline ::StringW get_SystemDirectory() ;

/// @brief Method get_TickCount, addr 0x18174a890, size 0x10, virtual false, abstract: false, final false
static inline int32_t get_TickCount() ;

/// @brief Method get_UserDomainName, addr 0x18174a430, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_UserDomainName() ;

/// @brief Method get_UserName, addr 0x18174a8a0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_UserName() ;

/// @brief Method internalGetEnvironmentVariable, addr 0x18174a8b0, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW internalGetEnvironmentVariable(::StringW  variable) ;

/// @brief Method internalGetEnvironmentVariable_native, addr 0x18174a950, size 0x10, virtual false, abstract: false, final false
static inline ::StringW internalGetEnvironmentVariable_native(::System::IntPtr  variable) ;

/// @brief Method internalGetHome, addr 0x18174a960, size 0x10, virtual false, abstract: false, final false
