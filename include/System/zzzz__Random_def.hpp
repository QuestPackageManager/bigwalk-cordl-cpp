...
/// @brief Method GenerateSeed, addr 0x181723520, size 0x170, virtual false, abstract: false, final false
static inline int32_t GenerateSeed() ;

/// @brief Method GetSampleForLargeRange, addr 0x181723690, size 0x100, virtual false, abstract: false, final false
inline double_t GetSampleForLargeRange() ;

/// @brief Method InternalSample, addr 0x181723790, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x181723790, size 0x80, virtual true, abstract: false, final false
inline int32_t Next() ;

/// @brief Method Next, addr 0x1817239f0, size 0x80, virtual true, abstract: false, final false
inline int32_t Next(int32_t  maxValue) ;

/// @brief Method Next, addr 0x181723830, size 0x1c0, virtual true, abstract: false, final false
inline int32_t Next(int32_t  minValue, int32_t  maxValue) ;

/// @brief Method NextDouble, addr 0x181723810, size 0x20, virtual true, abstract: false, final false
inline double_t NextDouble() ;

/// @brief Method Sample, addr 0x181723a70, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181723b70, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181723ba0, size 0x150, virtual false, abstract: false, final false
