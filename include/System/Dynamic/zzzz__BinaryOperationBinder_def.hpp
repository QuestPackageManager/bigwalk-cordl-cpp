...
// Write type traits
MARK_REF_T(::System::Dynamic::BinaryOperationBinder*);
DEFINE_IL2CPP_CLASS(::System::Dynamic::BinaryOperationBinder*, "System.Dynamic", "BinaryOperationBinder");
...
/// @brief Field <Operation>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__Operation_k__BackingField, put=__cordl_internal_set__Operation_k__BackingField)) ::System::Linq::Expressions::ExpressionType  _Operation_k__BackingField;

/// @brief Method Bind, addr 0x181b20240, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method FallbackBinaryOperation, addr 0x181b202e0, size 0x30, virtual false, abstract: false, final false
...
inline ::System::Dynamic::DynamicMetaObject* FallbackBinaryOperation(::System::Dynamic::DynamicMetaObject*  target, ::System::Dynamic::DynamicMetaObject*  arg, ::System::Dynamic::DynamicMetaObject*  errorSuggestion) ;
...
/// @brief Method get_Operation, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Dynamic::BinaryOperationBinder) == 0x20, "Size mismatch!");
