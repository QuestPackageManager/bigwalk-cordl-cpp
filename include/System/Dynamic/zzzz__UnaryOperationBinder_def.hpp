...
// Write type traits
MARK_REF_T(::System::Dynamic::UnaryOperationBinder*);
DEFINE_IL2CPP_CLASS(::System::Dynamic::UnaryOperationBinder*, "System.Dynamic", "UnaryOperationBinder");
...
public:
// Declarations
/// @brief Method Bind, addr 0x181b3c760, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method FallbackUnaryOperation, addr 0x1815be480, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Dynamic::UnaryOperationBinder) == 0x18, "Size mismatch!");
