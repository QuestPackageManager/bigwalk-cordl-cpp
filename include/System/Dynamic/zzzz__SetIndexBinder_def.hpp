...
// Write type traits
MARK_REF_T(::System::Dynamic::SetIndexBinder*);
DEFINE_IL2CPP_CLASS(::System::Dynamic::SetIndexBinder*, "System.Dynamic", "SetIndexBinder");
...
public:
// Declarations
/// @brief Method Bind, addr 0x181b39340, size 0xf0, virtual true, abstract: false, final true
...
/// @brief Method FallbackSetIndex, addr 0x181b39430, size 0x30, virtual false, abstract: false, final false
inline ::System::Dynamic::DynamicMetaObject* FallbackSetIndex(::System::Dynamic::DynamicMetaObject*  target, ::ArrayW<::System::Dynamic::DynamicMetaObject*>  indexes, ::System::Dynamic::DynamicMetaObject*  value) ;

/// @brief Method FallbackSetIndex, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::System::Dynamic::DynamicMetaObject* FallbackSetIndex(::System::Dynamic::DynamicMetaObject*  target, ::ArrayW<::System::Dynamic::DynamicMetaObject*>  indexes, ::System::Dynamic::DynamicMetaObject*  value, ::System::Dynamic::DynamicMetaObject*  errorSuggestion) ;
...
static_assert(sizeof(::System::Dynamic::SetIndexBinder) == 0x18, "Size mismatch!");
