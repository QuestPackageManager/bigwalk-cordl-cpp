...
/// @brief Field s_paramInfoCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_paramInfoCache, put=setStaticF_s_paramInfoCache)) ::System::Dynamic::Utils::CacheDict_2<::System::Reflection::MethodBase*,::ArrayW<::System::Reflection::ParameterInfo*>>*  s_paramInfoCache;

/// @brief Method GetAnyStaticMethodValidated, addr 0x181b395f0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetParametersCached, addr 0x181b396d0, size 0xd0, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Reflection::ParameterInfo*> GetParametersCached(::System::Reflection::MethodBase*  method) ;

/// @brief Method GetReturnType, addr 0x181b397a0, size 0x90, virtual false, abstract: false, final false
static inline ::System::Type* GetReturnType(::System::Reflection::MethodBase*  mi) ;

/// @brief Method GetTypeCode, addr 0x181b39830, size 0x10, virtual false, abstract: false, final false
static inline ::System::TypeCode GetTypeCode(::System::Type*  type) ;

/// @brief Method MatchesArgumentTypes, addr 0x181b39840, size 0xc0, virtual false, abstract: false, final false
