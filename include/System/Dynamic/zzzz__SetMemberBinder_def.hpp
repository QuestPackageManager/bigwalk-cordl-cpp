...
// Write type traits
MARK_REF_T(::System::Dynamic::SetMemberBinder*);
DEFINE_IL2CPP_CLASS(::System::Dynamic::SetMemberBinder*, "System.Dynamic", "SetMemberBinder");
...
/// @brief Method Bind, addr 0x181b39460, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method FallbackSetMember, addr 0x181b202e0, size 0x30, virtual false, abstract: false, final false
...
inline ::System::Dynamic::DynamicMetaObject* FallbackSetMember(::System::Dynamic::DynamicMetaObject*  target, ::System::Dynamic::DynamicMetaObject*  value, ::System::Dynamic::DynamicMetaObject*  errorSuggestion) ;
...
/// @brief Method .ctor, addr 0x181b35c60, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  ignoreCase) ;

/// @brief Method get_IgnoreCase, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_IgnoreCase() ;

/// @brief Method get_IsStandardBinder, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_ReturnType, addr 0x181806210, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Dynamic::SetMemberBinder) == 0x28, "Size mismatch!");
