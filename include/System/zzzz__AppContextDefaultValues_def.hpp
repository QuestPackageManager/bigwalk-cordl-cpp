...
// Write type traits
MARK_REF_T(::System::AppContextDefaultValues*);
DEFINE_IL2CPP_CLASS(::System::AppContextDefaultValues*, "System", "AppContextDefaultValues");
...
/// @brief Method PopulateDefaultValues, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
static inline void PopulateDefaultValues() ;

/// @brief Method TryGetSwitchOverride, addr 0x181744290, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::AppContextDefaultValues) == 0x10, "Size mismatch!");
