...
/// @brief Method BinarySearch, addr 0x181728810, size 0x110, virtual false, abstract: false, final false
static inline int32_t BinarySearch(::System::Array*  array, ::System::Object*  value) ;

/// @brief Method Equals, addr 0x181728980, size 0x70, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x181728920, size 0x60, virtual true, abstract: false, final false
inline bool Equals(::System::Type*  o) ;

/// @brief Method FilterAttributeImpl, addr 0x1817289f0, size 0x310, virtual false, abstract: false, final false
static inline bool FilterAttributeImpl(::System::Reflection::MemberInfo*  m, ::System::Object*  filterCriteria) ;

/// @brief Method FilterNameIgnoreCaseImpl, addr 0x181728d00, size 0x180, virtual false, abstract: false, final false
static inline bool FilterNameIgnoreCaseImpl(::System::Reflection::MemberInfo*  m, ::System::Object*  filterCriteria) ;

/// @brief Method FilterNameImpl, addr 0x181728e80, size 0x170, virtual false, abstract: false, final false
static inline bool FilterNameImpl(::System::Reflection::MemberInfo*  m, ::System::Object*  filterCriteria) ;

/// @brief Method FormatTypeName, addr 0x181728ff0, size 0x20, virtual false, abstract: false, final false
inline ::StringW FormatTypeName() ;

/// @brief Method FormatTypeName, addr 0x1805b4350, size 0x30, virtual true, abstract: false, final false
inline ::StringW FormatTypeName(bool  serialization) ;

/// @brief Method GetArrayRank, addr 0x18167c280, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method GetConstructor, addr 0x181729090, size 0x70, virtual true, abstract: false, final true
inline ::System::Reflection::ConstructorInfo* GetConstructor(::System::Reflection::BindingFlags  bindingAttr, ::System::Reflection::Binder*  binder, ::System::Reflection::CallingConventions  callConvention, ::ArrayW<::System::Type*>  types, ::ArrayW<::System::Reflection::ParameterModifier>  modifiers) ;

/// @brief Method GetConstructor, addr 0x181729010, size 0x80, virtual true, abstract: false, final true
inline ::System::Reflection::ConstructorInfo* GetConstructor(::System::Reflection::BindingFlags  bindingAttr, ::System::Reflection::Binder*  binder, ::ArrayW<::System::Type*>  types, ::ArrayW<::System::Reflection::ParameterModifier>  modifiers) ;

/// @brief Method GetConstructor, addr 0x181729100, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method GetConstructors, addr 0x181729180, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetEnumData, addr 0x1817291a0, size 0x290, virtual false, abstract: false, final false
inline void GetEnumData(::by_ref<::ArrayW<::StringW>>  enumNames, ::by_ref<::System::Array*>  enumValues) ;

/// @brief Method GetEnumName, addr 0x181729430, size 0x130, virtual true, abstract: false, final false
inline ::StringW GetEnumName(::System::Object*  value) ;

/// @brief Method GetEnumNames, addr 0x181729560, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<::StringW> GetEnumNames() ;

/// @brief Method GetEnumRawConstantValues, addr 0x1817295d0, size 0x30, virtual false, abstract: false, final false
inline ::System::Array* GetEnumRawConstantValues() ;

/// @brief Method GetEnumUnderlyingType, addr 0x181729600, size 0xa0, virtual true, abstract: false, final false
inline ::System::Type* GetEnumUnderlyingType() ;

/// @brief Method GetEnumValues, addr 0x1817296a0, size 0x50, virtual true, abstract: false, final false
inline ::System::Array* GetEnumValues() ;

/// @brief Method GetEvent, addr 0x1817296f0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetField, addr 0x181729710, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetFields, addr 0x181729730, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetGenericParameterConstraints, addr 0x181729750, size 0x40, virtual true, abstract: false, final false
inline ::ArrayW<::System::Type*> GetGenericParameterConstraints() ;

/// @brief Method GetGenericTypeDefinition, addr 0x18167c280, size 0x20, virtual true, abstract: false, final false
inline ::System::Type* GetGenericTypeDefinition() ;

/// @brief Method GetHashCode, addr 0x181729790, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method GetMember, addr 0x181729810, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<::System::Reflection::MemberInfo*> GetMember(::StringW  name) ;

/// @brief Method GetMember, addr 0x1817297e0, size 0x30, virtual true, abstract: false, final false
inline ::ArrayW<::System::Reflection::MemberInfo*> GetMember(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr) ;

/// @brief Method GetMember, addr 0x18167c280, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method GetMethod, addr 0x1817298d0, size 0x60, virtual true, abstract: false, final true
inline ::System::Reflection::MethodInfo* GetMethod(::StringW  name) ;

/// @brief Method GetMethod, addr 0x181729930, size 0x50, virtual true, abstract: false, final true
inline ::System::Reflection::MethodInfo* GetMethod(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr) ;

/// @brief Method GetMethod, addr 0x181729a20, size 0xa0, virtual true, abstract: false, final true
inline ::System::Reflection::MethodInfo* GetMethod(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr, ::System::Reflection::Binder*  binder, ::System::Reflection::CallingConventions  callConvention, ::ArrayW<::System::Type*>  types, ::ArrayW<::System::Reflection::ParameterModifier>  modifiers) ;

/// @brief Method GetMethod, addr 0x181729ac0, size 0xa0, virtual true, abstract: false, final true
inline ::System::Reflection::MethodInfo* GetMethod(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr, ::System::Reflection::Binder*  binder, ::ArrayW<::System::Type*>  types, ::ArrayW<::System::Reflection::ParameterModifier>  modifiers) ;

/// @brief Method GetMethod, addr 0x181729980, size 0xa0, virtual true, abstract: false, final true
inline ::System::Reflection::MethodInfo* GetMethod(::StringW  name, ::ArrayW<::System::Type*>  types) ;

/// @brief Method GetMethod, addr 0x181729830, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method GetMethods, addr 0x181729b60, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetProperties, addr 0x181729b80, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetProperty, addr 0x181729d50, size 0x60, virtual true, abstract: false, final true
inline ::System::Reflection::PropertyInfo* GetProperty(::StringW  name) ;

/// @brief Method GetProperty, addr 0x181729d00, size 0x50, virtual true, abstract: false, final true
inline ::System::Reflection::PropertyInfo* GetProperty(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr) ;

/// @brief Method GetProperty, addr 0x181729c80, size 0x80, virtual true, abstract: false, final true
inline ::System::Reflection::PropertyInfo* GetProperty(::StringW  name, ::System::Reflection::BindingFlags  bindingAttr, ::System::Reflection::Binder*  binder, ::System::Type*  returnType, ::ArrayW<::System::Type*>  types, ::ArrayW<::System::Reflection::ParameterModifier>  modifiers) ;

/// @brief Method GetProperty, addr 0x181729db0, size 0x70, virtual true, abstract: false, final true
inline ::System::Reflection::PropertyInfo* GetProperty(::StringW  name, ::System::Type*  returnType) ;

/// @brief Method GetProperty, addr 0x181729c10, size 0x70, virtual true, abstract: false, final true
inline ::System::Reflection::PropertyInfo* GetProperty(::StringW  name, ::System::Type*  returnType, ::ArrayW<::System::Type*>  types) ;

/// @brief Method GetProperty, addr 0x181729ba0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method GetRootElementType, addr 0x181729e20, size 0x60, virtual false, abstract: false, final false
inline ::System::Type* GetRootElementType() ;

/// @brief Method GetType, addr 0x18172a060, size 0x10, virtual true, abstract: false, final true
inline ::System::Type* GetType() ;

/// @brief Method GetType, addr 0x181729ff0, size 0x40, virtual false, abstract: false, final false
static inline ::System::Type* GetType(::StringW  typeName) ;

/// @brief Method GetType, addr 0x18172a070, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetType, addr 0x181729fc0, size 0x30, virtual false, abstract: false, final false
static inline ::System::Type* GetType(::StringW  typeName, bool  throwOnError) ;

/// @brief Method GetType, addr 0x18172a030, size 0x30, virtual false, abstract: false, final false
static inline ::System::Type* GetType(::StringW  typeName, bool  throwOnError, bool  ignoreCase) ;

/// @brief Method GetTypeCode, addr 0x181729f10, size 0x20, virtual false, abstract: false, final false
static inline ::System::TypeCode GetTypeCode(::System::Type*  type) ;

/// @brief Method GetTypeCodeImpl, addr 0x181729e80, size 0x90, virtual true, abstract: false, final false
inline ::System::TypeCode GetTypeCodeImpl() ;

/// @brief Method GetTypeFromHandle, addr 0x181729f30, size 0x10, virtual false, abstract: false, final false
static inline ::System::Type* GetTypeFromHandle(::System::RuntimeTypeHandle  handle) ;

/// @brief Method GetTypeHandle, addr 0x181729f40, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ImplementInterface, addr 0x18172a0a0, size 0xd0, virtual false, abstract: false, final false
inline bool ImplementInterface(::System::Type*  ifaceType) ;

/// @brief Method InternalGetNameIfAvailable, addr 0x181163ae0, size 0x20, virtual true, abstract: false, final false
inline ::StringW InternalGetNameIfAvailable(::by_ref<::System::Type*>  rootCauseForFailure) ;

/// @brief Method InvokeMember, addr 0x18172a170, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method IsAssignableFrom, addr 0x18172a1c0, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method IsContextfulImpl, addr 0x18172a300, size 0x40, virtual true, abstract: false, final false
inline bool IsContextfulImpl() ;

/// @brief Method IsEnumDefined, addr 0x18172a340, size 0x290, virtual true, abstract: false, final false
inline bool IsEnumDefined(::System::Object*  value) ;

/// @brief Method IsEquivalentTo, addr 0x1805a8800, size 0x10, virtual true, abstract: false, final false
inline bool IsEquivalentTo(::System::Type*  other) ;

/// @brief Method IsInstanceOfType, addr 0x18172a5d0, size 0x40, virtual true, abstract: false, final false
inline bool IsInstanceOfType(::System::Object*  o) ;

/// @brief Method IsIntegerType, addr 0x18172a610, size 0x160, virtual false, abstract: false, final false
static inline bool IsIntegerType(::System::Type*  t) ;

/// @brief Method IsMarshalByRefImpl, addr 0x18172a770, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method IsRuntimeImplemented, addr 0x18172a7b0, size 0x70, virtual false, abstract: false, final false
inline bool IsRuntimeImplemented() ;

/// @brief Method IsSubclassOf, addr 0x18172a820, size 0x50, virtual true, abstract: false, final false
inline bool IsSubclassOf(::System::Type*  c) ;

/// @brief Method IsValueTypeImpl, addr 0x18172a870, size 0x40, virtual true, abstract: false, final false
inline bool IsValueTypeImpl() ;

/// @brief Method MakeArrayType, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* MakeArrayType() ;

/// @brief Method MakeArrayType, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* MakeArrayType(int32_t  rank) ;

/// @brief Method MakeByRefType, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* MakeByRefType() ;

/// @brief Method MakeGenericSignatureType, addr 0x18172a8b0, size 0x50, virtual false, abstract: false, final false
static inline ::System::Type* MakeGenericSignatureType(::System::Type*  genericTypeDefinition, ::ArrayW<::System::Type*>  typeArguments) ;

/// @brief Method MakeGenericType, addr 0x18167c280, size 0x20, virtual true, abstract: false, final false
inline ::System::Type* MakeGenericType(::ArrayW<::System::Type*>  typeArguments) ;

/// @brief Method MakePointerType, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* MakePointerType() ;

static inline ::System::Type* New_ctor() ;

/// @brief Method ToString, addr 0x18172a900, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method get_Attributes, addr 0x18172ab10, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_ContainsGenericParameters, addr 0x18172ab30, size 0x140, virtual true, abstract: false, final false
inline bool get_ContainsGenericParameters() ;

/// @brief Method get_DeclaringMethod, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::MethodBase* get_DeclaringMethod() ;

/// @brief Method get_DeclaringType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* get_DeclaringType() ;

/// @brief Method get_DefaultBinder, addr 0x18172ac70, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_FullNameOrDefault, addr 0x18172ace0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_GenericParameterAttributes, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::GenericParameterAttributes get_GenericParameterAttributes() ;

/// @brief Method get_GenericParameterPosition, addr 0x1816833c0, size 0x20, virtual true, abstract: false, final false
inline int32_t get_GenericParameterPosition() ;

/// @brief Method get_GenericTypeArguments, addr 0x18172ad50, size 0xb0, virtual true, abstract: false, final false
inline ::ArrayW<::System::Type*> get_GenericTypeArguments() ;

/// @brief Method get_HasElementType, addr 0x18172ae00, size 0x20, virtual true, abstract: false, final true
inline bool get_HasElementType() ;

/// @brief Method get_InternalNameIfAvailable, addr 0x18172ae20, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_InternalNameIfAvailable() ;

/// @brief Method get_IsAbstract, addr 0x18172ae50, size 0x30, virtual true, abstract: false, final true
inline bool get_IsAbstract() ;

/// @brief Method get_IsArray, addr 0x18172ae80, size 0x20, virtual true, abstract: false, final true
inline bool get_IsArray() ;

/// @brief Method get_IsByRef, addr 0x1815243f0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsByRef() ;

/// @brief Method get_IsCOMObject, addr 0x18172aea0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsCOMObject() ;

/// @brief Method get_IsClass, addr 0x18172aec0, size 0x50, virtual true, abstract: false, final true
inline bool get_IsClass() ;

/// @brief Method get_IsCollectible, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool get_IsCollectible() ;

/// @brief Method get_IsConstructedGenericType, addr 0x18167c600, size 0x20, virtual true, abstract: false, final false
inline bool get_IsConstructedGenericType() ;

/// @brief Method get_IsContextful, addr 0x18172af10, size 0x20, virtual true, abstract: false, final true
inline bool get_IsContextful() ;

/// @brief Method get_IsEnum, addr 0x18172af30, size 0x40, virtual true, abstract: false, final false
inline bool get_IsEnum() ;

/// @brief Method get_IsExplicitLayout, addr 0x18172af70, size 0x30, virtual true, abstract: false, final true
inline bool get_IsExplicitLayout() ;

/// @brief Method get_IsGenericMethodParameter, addr 0x18172afa0, size 0x50, virtual true, abstract: false, final false
inline bool get_IsGenericMethodParameter() ;

/// @brief Method get_IsGenericParameter, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsGenericParameter() ;

/// @brief Method get_IsGenericType, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsGenericType() ;

/// @brief Method get_IsGenericTypeDefinition, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsGenericTypeDefinition() ;

/// @brief Method get_IsInterface, addr 0x18172aff0, size 0xa0, virtual true, abstract: false, final true
inline bool get_IsInterface() ;

/// @brief Method get_IsMarshalByRef, addr 0x18172b090, size 0x20, virtual true, abstract: false, final true
inline bool get_IsMarshalByRef() ;

/// @brief Method get_IsNested, addr 0x18172b140, size 0x30, virtual false, abstract: false, final false
inline bool get_IsNested() ;

/// @brief Method get_IsNestedAssembly, addr 0x18172b0b0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsNestedAssembly() ;

/// @brief Method get_IsNestedPrivate, addr 0x18172b0e0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsNestedPrivate() ;

/// @brief Method get_IsNestedPublic, addr 0x18172b110, size 0x30, virtual true, abstract: false, final true
inline bool get_IsNestedPublic() ;

/// @brief Method get_IsNotPublic, addr 0x18172b170, size 0x30, virtual true, abstract: false, final true
inline bool get_IsNotPublic() ;

/// @brief Method get_IsPointer, addr 0x18172b1a0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsPointer() ;

/// @brief Method get_IsPrimitive, addr 0x18172b1c0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsPrimitive() ;

/// @brief Method get_IsPublic, addr 0x18172b1e0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsPublic() ;

/// @brief Method get_IsSZArray, addr 0x18167c600, size 0x20, virtual true, abstract: false, final false
inline bool get_IsSZArray() ;

/// @brief Method get_IsSealed, addr 0x18172b210, size 0x30, virtual true, abstract: false, final true
inline bool get_IsSealed() ;

/// @brief Method get_IsSerializable, addr 0x18172b240, size 0x100, virtual true, abstract: false, final false
inline bool get_IsSerializable() ;

/// @brief Method get_IsSignatureType, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsSignatureType() ;

/// @brief Method get_IsSzArray, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsSzArray() ;

/// @brief Method get_IsValueType, addr 0x18172b340, size 0x20, virtual true, abstract: false, final true
inline bool get_IsValueType() ;

/// @brief Method get_IsVariableBoundArray, addr 0x18172b360, size 0x50, virtual true, abstract: false, final false
inline bool get_IsVariableBoundArray() ;

/// @brief Method get_IsVisible, addr 0x18172b3b0, size 0x1d0, virtual false, abstract: false, final false
inline bool get_IsVisible() ;

/// @brief Method get_MemberType, addr 0x1809018a0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_NameOrDefault, addr 0x18172b580, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_ReflectedType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* get_ReflectedType() ;

/// @brief Method get_TypeHandle, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method internal_from_handle, addr 0x18172b5c0, size 0x10, virtual false, abstract: false, final false
