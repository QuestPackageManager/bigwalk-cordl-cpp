...
// Write type traits
MARK_REF_T(::System::UnhandledExceptionEventArgs*);
DEFINE_IL2CPP_CLASS(::System::UnhandledExceptionEventArgs*, "System", "UnhandledExceptionEventArgs");
...
/// @brief Method get_ExceptionObject, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_ExceptionObject() ;

/// @brief Method get_IsTerminating, addr 0x18037a0f0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::UnhandledExceptionEventArgs) == 0x20, "Size mismatch!");
