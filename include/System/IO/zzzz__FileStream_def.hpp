...
// Write type traits
MARK_REF_T(::System::IO::FileStream*);
MARK_REF_T(::System::IO::FileStream_ReadDelegate*);
MARK_REF_T(::System::IO::FileStream_WriteDelegate*);
DEFINE_IL2CPP_CLASS(::System::IO::FileStream*, "System.IO", "FileStream");
DEFINE_IL2CPP_CLASS(::System::IO::FileStream_ReadDelegate*, "System.IO", "FileStream/ReadDelegate");
DEFINE_IL2CPP_CLASS(::System::IO::FileStream_WriteDelegate*, "System.IO", "FileStream/WriteDelegate");
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x1816f0f00, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816f1010, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::IO::FileStream_ReadDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1816f50b0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Field buf_recycle, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_buf_recycle, put=setStaticF_buf_recycle)) ::ArrayW<uint8_t>  buf_recycle;
...
/// @brief Method BeginRead, addr 0x1816e7650, size 0x2b0, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x1816e7900, size 0x370, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1816e7c70, size 0x270, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x1816e7ee0, size 0xe0, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x1816e7fc0, size 0xc0, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method ExposeHandle, addr 0x1816e8080, size 0x30, virtual false, abstract: false, final false
inline void ExposeHandle() ;

/// @brief Method Finalize, addr 0x1805d5280, size 0x20, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Flush, addr 0x1816e8370, size 0x70, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x1816e80b0, size 0x190, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FlushBuffer, addr 0x1816e8250, size 0x120, virtual false, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method FlushBufferIfDirty, addr 0x1816e8240, size 0x10, virtual false, abstract: false, final false
inline void FlushBufferIfDirty() ;

/// @brief Method GetSecureFileName, addr 0x1816e8460, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetSecureFileName(::StringW  filename) ;

/// @brief Method GetSecureFileName, addr 0x1816e83e0, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetSecureFileName(::StringW  filename, bool  full) ;

/// @brief Method Init, addr 0x1816e86c0, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method InitBuffer, addr 0x1816e84d0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x1816e8de0, size 0x280, virtual true, abstract: false, final false
inline int32_t Read(::by_ref<::ArrayW<uint8_t>>  array, int32_t  offset, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x1816e88d0, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method ReadByte, addr 0x1816e8aa0, size 0x100, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method ReadData, addr 0x1816e8ba0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ReadInternal, addr 0x1816e8c60, size 0x130, virtual false, abstract: false, final false
inline int32_t ReadInternal(::ArrayW<uint8_t>  dest, int32_t  offset, int32_t  count) ;

/// @brief Method ReadSegment, addr 0x1816e8d90, size 0x50, virtual false, abstract: false, final false
inline int32_t ReadSegment(::ArrayW<uint8_t>  dest, int32_t  dest_offset, int32_t  count) ;

/// @brief Method RefillBuffer, addr 0x1816e9060, size 0x40, virtual false, abstract: false, final false
inline void RefillBuffer() ;

/// @brief Method Seek, addr 0x1816e90a0, size 0x200, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x1816e92a0, size 0x170, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x1816e98f0, size 0x190, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t>  array, int32_t  offset, int32_t  count) ;

/// @brief Method WriteAsync, addr 0x1816e9410, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method WriteByte, addr 0x1816e95e0, size 0x100, virtual true, abstract: false, final false
inline void WriteByte(uint8_t  value) ;

/// @brief Method WriteInternal, addr 0x1816e96e0, size 0x1a0, virtual false, abstract: false, final false
inline void WriteInternal(::ArrayW<uint8_t>  src, int32_t  offset, int32_t  count) ;

/// @brief Method WriteSegment, addr 0x1816e9880, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816e9b10, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816e9c20, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::IO::FileMode  mode, ::System::IO::FileAccess  access) ;

/// @brief Method .ctor, addr 0x1816ea260, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::IO::FileMode  mode, ::System::IO::FileAccess  access, ::System::IO::FileShare  share) ;

/// @brief Method .ctor, addr 0x1816e9ad0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816e9c70, size 0x5a0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816ea210, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816ea2e0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816ea290, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x1816ea320, size 0x20, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x1816ea340, size 0x10, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x1816ea350, size 0x20, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x1816ea370, size 0xf0, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Name, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Position, addr 0x1816ea460, size 0x100, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_SafeFileHandle, addr 0x1816ea560, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method set_Position, addr 0x1816ea5a0, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::IO::FileStream) == 0x70, "Size mismatch!");
