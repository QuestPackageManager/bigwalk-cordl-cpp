...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextReader_NullTextReader*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextReader_NullTextReader*, "System.IO", "TextReader/NullTextReader");
...
static_assert(sizeof(::GlobalNamespace::TextReader_NullTextReader) == 0x18, "Size mismatch!");
