...
/// @brief Method InternalWriteChar, addr 0x1816e6a00, size 0x20, virtual false, abstract: false, final false
inline void InternalWriteChar(char16_t  val) ;

/// @brief Method InternalWriteChars, addr 0x1816e6a20, size 0x20, virtual false, abstract: false, final false
inline void InternalWriteChars(::ArrayW<char16_t>  buffer, int32_t  n) ;

/// @brief Method InternalWriteString, addr 0x1816e6a40, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x1816e6ac0, size 0x1e0, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x1816e6dd0, size 0x30, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t>  val) ;

/// @brief Method Write, addr 0x1816e6d70, size 0x60, virtual true, abstract: false, final false
inline void Write(::StringW  val) ;

/// @brief Method Write, addr 0x1816e6ca0, size 0xd0, virtual true, abstract: false, final false
inline void Write(char16_t  val) ;

/// @brief Method WriteLine, addr 0x1816e6a60, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816e6e00, size 0x100, virtual false, abstract: false, final false
