...
MARK_VAL_T(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63);
DEFINE_IL2CPP_CLASS(::System::IO::StreamReader*, "System.IO", "StreamReader");
DEFINE_IL2CPP_CLASS(::System::IO::StreamReader__ReadAsyncInternal_d__66, "System.IO", "StreamReader/<ReadAsyncInternal>d__66");
DEFINE_IL2CPP_CLASS(::System::IO::StreamReader__ReadBufferAsync_d__69, "System.IO", "StreamReader/<ReadBufferAsync>d__69");
DEFINE_IL2CPP_CLASS(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, "System.IO", "StreamReader/<ReadToEndAsyncInternal>d__63");
...
/// @brief Method MoveNext, addr 0x1816e1330, size 0x1e0, virtual true, abstract: false, final true
...
static_assert(offsetof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, _sb_5__2) == 0x28, "Offset mismatch!");

static_assert(offsetof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, __u__1) == 0x30, "Offset mismatch!");

static_assert(sizeof(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63) == 0x40, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x1816dfdd0, size 0xba0, virtual true, abstract: false, final true
inline void MoveNext() ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncValueTaskMethodBuilder_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::IO::StreamReader*", modifiers: "", def_value: None }, CppParam { name: "buffer", ty: "::System::Memory_1<char16_t>", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_charsRead_5__2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_readToUserBuffer_5__3", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_tmpByteBuffer_5__4", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "_tmpStream_5__5", ty: "::System::IO::Stream*", modifiers: "", def_value: None }, CppParam { name: "_count_5__6", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<int32_t>", modifiers: "", def_value: None }, CppParam { name: "_n_5__7", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::ConfiguredValueTaskAwaitable_1_ConfiguredValueTaskAwaiter<int32_t>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::IO::StreamReader__ReadAsyncInternal_d__66) == 0x90, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x1816e0990, size 0x9a0, virtual true, abstract: false, final true
inline void MoveNext() ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::IO::StreamReader*", modifiers: "", def_value: None }, CppParam { name: "_tmpByteBuffer_5__2", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "_tmpStream_5__3", ty: "::System::IO::Stream*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredValueTaskAwaitable_1_ConfiguredValueTaskAwaiter<int32_t>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::IO::StreamReader__ReadBufferAsync_d__69) == 0x48, "Size mismatch!");
...
using _ReadToEndAsyncInternal_d__63 = ::System::IO::StreamReader__ReadToEndAsyncInternal_d__63;
...
/// @brief Method CheckAsyncTaskInProgress, addr 0x1816d8f70, size 0x20, virtual false, abstract: false, final false
inline void CheckAsyncTaskInProgress() ;

/// @brief Method Close, addr 0x181633ea0, size 0x20, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method CompressBuffer, addr 0x1816d8f90, size 0x40, virtual false, abstract: false, final false
inline void CompressBuffer(int32_t  n) ;

/// @brief Method DataAvailable, addr 0x1816d8fd0, size 0x10, virtual false, abstract: false, final false
inline bool DataAvailable() ;

/// @brief Method DetectEncoding, addr 0x1816d8fe0, size 0x230, virtual false, abstract: false, final false
inline void DetectEncoding() ;

/// @brief Method Dispose, addr 0x1816d9210, size 0x80, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Init, addr 0x1816d9290, size 0x20, virtual false, abstract: false, final false
inline void Init(::System::IO::Stream*  stream) ;

/// @brief Method Init, addr 0x1816d92b0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method IsPreamble, addr 0x1816d93d0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Peek, addr 0x1816d94b0, size 0xb0, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x1816daae0, size 0xb0, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x1816dab90, size 0x100, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read, addr 0x1816daa60, size 0x80, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadAsync, addr 0x1816d96a0, size 0x2a0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsyncInternal, addr 0x1816d9560, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method ReadBuffer, addr 0x1816d99e0, size 0x360, virtual true, abstract: false, final false
inline int32_t ReadBuffer() ;

/// @brief Method ReadBuffer, addr 0x1816d9d40, size 0x520, virtual false, abstract: false, final false
inline int32_t ReadBuffer(::System::Span_1<char16_t>  userBuffer, ::by_ref<bool>  readToUserBuffer) ;

/// @brief Method ReadBufferAsync, addr 0x1816d9940, size 0xa0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadBufferAsync() ;

/// @brief Method ReadLine, addr 0x1816da260, size 0x210, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadSpan, addr 0x1816da470, size 0x250, virtual false, abstract: false, final false
inline int32_t ReadSpan(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadToEnd, addr 0x1816da940, size 0x120, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadToEndAsync, addr 0x1816da760, size 0x1e0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsync() ;

/// @brief Method ReadToEndAsyncInternal, addr 0x1816da6c0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816db0d0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816dad70, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::StringW  path) ;

/// @brief Method .ctor, addr 0x1816daea0, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x1816db590, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x1816db340, size 0x160, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks, int32_t  bufferSize) ;

/// @brief Method .ctor, addr 0x1816db4a0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream) ;

/// @brief Method .ctor, addr 0x1816db120, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x1816dafe0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x1816db220, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method get_BaseStream, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_CurrentEncoding, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
inline ::System::Text::Encoding* get_CurrentEncoding() ;

/// @brief Method get_LeaveOpen, addr 0x1816db6d0, size 0x10, virtual false, abstract: false, final false
