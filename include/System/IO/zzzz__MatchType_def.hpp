...
DEFINE_IL2CPP_CLASS(::System::IO::MatchType, "System.IO", "MatchType");
// Dependencies 
namespace System::IO {
// Is value type: true
...
static_assert(offsetof(::System::IO::MatchType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::IO::MatchType) == 0x4, "Size mismatch!");
