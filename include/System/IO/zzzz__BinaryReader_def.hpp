...
/// @brief Field m_charBuffer, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_charBuffer, put=__cordl_internal_set_m_charBuffer)) ::ArrayW<char16_t>  m_charBuffer;

/// @brief Field m_charBytes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_charBytes, put=__cordl_internal_set_m_charBytes)) ::ArrayW<uint8_t>  m_charBytes;
...
/// @brief Field m_singleChar, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_singleChar, put=__cordl_internal_set_m_singleChar)) ::ArrayW<char16_t>  m_singleChar;
...
/// @brief Method Dispose, addr 0x1816e4660, size 0xc0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method FillBuffer, addr 0x1816e4720, size 0x100, virtual true, abstract: false, final false
inline void FillBuffer(int32_t  numBytes) ;

/// @brief Method InternalReadChars, addr 0x1816e4820, size 0x2a0, virtual false, abstract: false, final false
inline int32_t InternalReadChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method InternalReadOneChar, addr 0x1816e4ac0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x1816e56d0, size 0x20, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x1816e56f0, size 0x100, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read7BitEncodedInt, addr 0x1816e4cb0, size 0xa0, virtual false, abstract: false, final false
inline int32_t Read7BitEncodedInt() ;

/// @brief Method ReadBoolean, addr 0x1816e4d50, size 0x40, virtual true, abstract: false, final false
inline bool ReadBoolean() ;

/// @brief Method ReadByte, addr 0x1816e4d90, size 0x40, virtual true, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadBytes, addr 0x1816e4dd0, size 0x140, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> ReadBytes(int32_t  count) ;

/// @brief Method ReadChar, addr 0x1816e4f10, size 0x30, virtual true, abstract: false, final false
inline char16_t ReadChar() ;

/// @brief Method ReadChars, addr 0x1816e4f40, size 0x110, virtual true, abstract: false, final false
inline ::ArrayW<char16_t> ReadChars(int32_t  count) ;

/// @brief Method ReadDecimal, addr 0x1816e5050, size 0x110, virtual true, abstract: false, final false
inline ::System::Decimal ReadDecimal() ;

/// @brief Method ReadDouble, addr 0x1816e5160, size 0x40, virtual true, abstract: false, final false
inline double_t ReadDouble() ;

/// @brief Method ReadInt16, addr 0x1816e51a0, size 0x40, virtual true, abstract: false, final false
inline int16_t ReadInt16() ;

/// @brief Method ReadInt32, addr 0x1816e51e0, size 0xc0, virtual true, abstract: false, final false
inline int32_t ReadInt32() ;

/// @brief Method ReadInt64, addr 0x1816e52a0, size 0x90, virtual true, abstract: false, final false
inline int64_t ReadInt64() ;

/// @brief Method ReadSByte, addr 0x1816e5330, size 0x30, virtual true, abstract: false, final false
inline int8_t ReadSByte() ;

/// @brief Method ReadSingle, addr 0x1816e5360, size 0x40, virtual true, abstract: false, final false
inline float_t ReadSingle() ;

/// @brief Method ReadString, addr 0x1816e53a0, size 0x2d0, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ReadUInt16, addr 0x1816e51a0, size 0x40, virtual true, abstract: false, final false
inline uint16_t ReadUInt16() ;

/// @brief Method ReadUInt32, addr 0x1816e5670, size 0x60, virtual true, abstract: false, final false
inline uint32_t ReadUInt32() ;

/// @brief Method ReadUInt64, addr 0x1816e52a0, size 0x90, virtual true, abstract: false, final false
...
constexpr ::ArrayW<char16_t> const& __cordl_internal_get_m_charBuffer() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_m_charBuffer() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_charBytes() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_charBytes() ;
...
constexpr ::ArrayW<char16_t> const& __cordl_internal_get_m_singleChar() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_m_singleChar() ;
...
constexpr void __cordl_internal_set_m_charBuffer(::ArrayW<char16_t>  value) ;

constexpr void __cordl_internal_set_m_charBytes(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_m_singleChar(::ArrayW<char16_t>  value) ;

constexpr void __cordl_internal_set_m_stream(::System::IO::Stream*  value) ;

/// @brief Method .ctor, addr 0x1816e59b0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x1816e5a10, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x1816e57f0, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::System::Text::Encoding*  encoding, bool  leaveOpen) ;

/// @brief Method get_BaseStream, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::IO::BinaryReader) == 0x48, "Size mismatch!");
