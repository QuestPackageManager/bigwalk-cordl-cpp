...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextReader_SyncTextReader*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextReader_SyncTextReader*, "System.IO", "TextReader/SyncTextReader");
...
/// @brief Method Close, addr 0x1816ddb60, size 0x20, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x1816ddb80, size 0x20, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::GlobalNamespace::TextReader_SyncTextReader* New_ctor(::System::IO::TextReader*  t) ;

/// @brief Method Peek, addr 0x1815cf8b0, size 0x20, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x1816ddcd0, size 0x20, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x1816ddcb0, size 0x20, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x1816ddba0, size 0xa0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x1816ddc40, size 0x20, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x1816ddc90, size 0x20, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadToEndAsync, addr 0x1816ddc60, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::TextReader_SyncTextReader) == 0x20, "Size mismatch!");
