...
// Write type traits
MARK_REF_T(::System::IO::Compression::DeflateStreamNative*);
MARK_REF_T(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle*);
MARK_REF_T(::System::IO::Compression::DeflateStreamNative_UnmanagedReadOrWrite*);
...
static_assert(sizeof(::System::IO::Compression::DeflateStreamNative_UnmanagedReadOrWrite) == 0x80, "Size mismatch!");
...
/// @brief Method ReleaseHandle, addr 0x181e1bbb0, size 0x20, virtual true, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle) == 0x20, "Size mismatch!");
...
/// @brief Field io_buffer, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_io_buffer, put=__cordl_internal_set_io_buffer)) ::ArrayW<uint8_t>  io_buffer;
...
/// @brief Method CheckResult, addr 0x181e11be0, size 0x130, virtual false, abstract: false, final false
inline void CheckResult(int32_t  result, ::StringW  where) ;

/// @brief Method CloseZStream, addr 0x181e11d10, size 0x10, virtual false, abstract: false, final false
static inline int32_t CloseZStream(::System::IntPtr  stream) ;

/// @brief Method Create, addr 0x181e11d90, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method CreateZStream, addr 0x181e11d20, size 0x70, virtual false, abstract: false, final false
static inline ::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle* CreateZStream(::System::IO::Compression::CompressionMode  compress, bool  gzip, ::System::IO::Compression::DeflateStreamNative_UnmanagedReadOrWrite*  feeder, ::System::IntPtr  data) ;

/// @brief Method Dispose, addr 0x181e11fd0, size 0xc0, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x181e12090, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Flush, addr 0x181e121c0, size 0x70, virtual false, abstract: false, final false
static inline int32_t Flush(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle*  stream) ;

/// @brief Method Flush, addr 0x181e12130, size 0x90, virtual false, abstract: false, final false
inline void Flush() ;

static inline ::System::IO::Compression::DeflateStreamNative* New_ctor() ;

/// @brief Method ReadZStream, addr 0x181e12230, size 0xa0, virtual false, abstract: false, final false
inline int32_t ReadZStream(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method ReadZStream, addr 0x181e122d0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UnmanagedRead, addr 0x181e12400, size 0xe0, virtual false, abstract: false, final false
inline int32_t UnmanagedRead(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method UnmanagedRead, addr 0x181e12350, size 0xb0, virtual false, abstract: false, final false
static inline int32_t UnmanagedRead(::System::IntPtr  buffer, int32_t  length, ::System::IntPtr  data) ;

/// @brief Method UnmanagedWrite, addr 0x181e124e0, size 0x100, virtual false, abstract: false, final false
inline int32_t UnmanagedWrite(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method UnmanagedWrite, addr 0x181e125e0, size 0xb0, virtual false, abstract: false, final false
static inline int32_t UnmanagedWrite(::System::IntPtr  buffer, int32_t  length, ::System::IntPtr  data) ;

/// @brief Method WriteZStream, addr 0x181e12730, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method WriteZStream, addr 0x181e12690, size 0xa0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_io_buffer() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_io_buffer() ;
...
constexpr void __cordl_internal_set_io_buffer(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::System::IO::Compression::DeflateStreamNative) == 0x48, "Size mismatch!");
