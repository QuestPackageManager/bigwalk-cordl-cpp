...
DEFINE_IL2CPP_GEN_CLASS(::System::Span_1, "System", "Span`1");
...
inline ::by_ref<T> GetPinnableReference() ;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::by_ref<T>  ptr, int32_t  length) ;
...
/// @brief Method op_Implicit, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline ::System::Span_1<T> op_Implicit___System__Span_1_T_(::ArrayW<T>  array) ;
