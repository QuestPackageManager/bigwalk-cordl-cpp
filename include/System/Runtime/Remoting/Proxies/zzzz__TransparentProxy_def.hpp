...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Proxies::TransparentProxy*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Proxies::TransparentProxy*, "System.Runtime.Remoting.Proxies", "TransparentProxy");
...
/// @brief Method GetProxyType, addr 0x181631c20, size 0x80, virtual false, abstract: false, final false
inline ::System::RuntimeType* GetProxyType() ;

/// @brief Method InCurrentContext, addr 0x181631ca0, size 0xc0, virtual false, abstract: false, final false
inline bool InCurrentContext() ;

/// @brief Method LoadRemoteFieldNew, addr 0x181631d60, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method StoreRemoteField, addr 0x181631f80, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method get_IsContextBoundObject, addr 0x181632180, size 0x90, virtual false, abstract: false, final false
inline bool get_IsContextBoundObject() ;

/// @brief Method get_TargetContext, addr 0x181632210, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Proxies::TransparentProxy) == 0x28, "Size mismatch!");
