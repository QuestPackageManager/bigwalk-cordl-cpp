...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Lifetime::LifetimeServices*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Lifetime::LifetimeServices*, "System.Runtime.Remoting.Lifetime", "LifetimeServices");
...
/// @brief Method TrackLifetime, addr 0x181627870, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_LeaseManagerPollTime, addr 0x1816279c0, size 0x40, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_LeaseManagerPollTime() ;

/// @brief Method get_LeaseTime, addr 0x181627a00, size 0x40, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_LeaseTime() ;

/// @brief Method get_RenewOnCallTime, addr 0x181627a40, size 0x40, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_RenewOnCallTime() ;

/// @brief Method get_SponsorshipTimeout, addr 0x181627a80, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_LeaseManagerPollTime, addr 0x181627ac0, size 0x60, virtual false, abstract: false, final false
static inline void set_LeaseManagerPollTime(::System::TimeSpan  value) ;

/// @brief Method set_LeaseTime, addr 0x18161d8a0, size 0x50, virtual false, abstract: false, final false
static inline void set_LeaseTime(::System::TimeSpan  value) ;

/// @brief Method set_RenewOnCallTime, addr 0x18161d8f0, size 0x50, virtual false, abstract: false, final false
static inline void set_RenewOnCallTime(::System::TimeSpan  value) ;

/// @brief Method set_SponsorshipTimeout, addr 0x18161d940, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Lifetime::LifetimeServices) == 0x10, "Size mismatch!");
