...
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Channels::CrossAppDomainSink_ProcessMessageRes, "System.Runtime.Remoting.Channels", "CrossAppDomainSink/ProcessMessageRes");
// Dependencies 
namespace System::Runtime::Remoting::Channels {
// Is value type: true
...
/// @brief Method AsyncProcessMessage, addr 0x18163d3c0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method GetSink, addr 0x18163d460, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method ProcessMessageInDomain, addr 0x18163d6d0, size 0x100, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Channels::CrossAppDomainSink_ProcessMessageRes ProcessMessageInDomain(::ArrayW<uint8_t>  arrRequest, ::System::Runtime::Remoting::Messaging::CADMethodCallMessage*  cadMsg) ;

/// @brief Method SendAsyncMessage, addr 0x18163d7d0, size 0x80, virtual false, abstract: false, final false
inline void SendAsyncMessage(::System::Object*  data) ;

/// @brief Method SyncProcessMessage, addr 0x18163d850, size 0x3b0, virtual true, abstract: false, final false
...
/// @brief Method <AsyncProcessMessage>b__10_0, addr 0x18163dc00, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_TargetDomainId, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
