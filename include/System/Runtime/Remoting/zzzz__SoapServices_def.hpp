...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::SoapServices*);
MARK_REF_T(::System::Runtime::Remoting::SoapServices_TypeInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::SoapServices*, "System.Runtime.Remoting", "SoapServices");
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::SoapServices_TypeInfo*, "System.Runtime.Remoting", "SoapServices/TypeInfo");
...
/// @brief Method CodeXmlNamespaceForClrTypeNamespace, addr 0x181630610, size 0x150, virtual false, abstract: false, final false
static inline ::StringW CodeXmlNamespaceForClrTypeNamespace(::StringW  typeNamespace, ::StringW  assemblyName) ;

/// @brief Method EncodeNs, addr 0x181630760, size 0x50, virtual false, abstract: false, final false
static inline ::StringW EncodeNs(::StringW  ns) ;

/// @brief Method GetAssemblyName, addr 0x1816307b0, size 0xf0, virtual false, abstract: false, final false
static inline ::StringW GetAssemblyName(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetNameKey, addr 0x1816308a0, size 0x20, virtual false, abstract: false, final false
static inline ::StringW GetNameKey(::StringW  name, ::StringW  namspace) ;

/// @brief Method GetXmlElementForInteropType, addr 0x1816308c0, size 0xc0, virtual false, abstract: false, final false
static inline bool GetXmlElementForInteropType(::System::Type*  type, ::by_ref<::StringW>  xmlElement, ::by_ref<::StringW>  xmlNamespace) ;

/// @brief Method GetXmlNamespaceForMethodCall, addr 0x181630980, size 0x60, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodCall(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlNamespaceForMethodResponse, addr 0x181630980, size 0x60, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodResponse(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlTypeForInteropType, addr 0x1816309e0, size 0xb0, virtual false, abstract: false, final false
static inline bool GetXmlTypeForInteropType(::System::Type*  type, ::by_ref<::StringW>  xmlType, ::by_ref<::StringW>  xmlTypeNamespace) ;

/// @brief Method PreLoad, addr 0x181630f30, size 0x60, virtual false, abstract: false, final false
static inline void PreLoad(::System::Reflection::Assembly*  assembly) ;

/// @brief Method PreLoad, addr 0x181630a90, size 0x4a0, virtual false, abstract: false, final false
static inline void PreLoad(::System::Type*  type) ;

/// @brief Method RegisterInteropXmlElement, addr 0x181630f90, size 0x150, virtual false, abstract: false, final false
static inline void RegisterInteropXmlElement(::StringW  xmlElement, ::StringW  xmlNamespace, ::System::Type*  type) ;

/// @brief Method RegisterInteropXmlType, addr 0x1816310e0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_XmlNsForClrTypeWithAssembly, addr 0x1816313a0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithAssembly() ;

/// @brief Method get_XmlNsForClrTypeWithNs, addr 0x1816313c0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithNs() ;

/// @brief Method get_XmlNsForClrTypeWithNsAndAssembly, addr 0x1816313b0, size 0x10, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::Runtime::Remoting::SoapServices) == 0x10, "Size mismatch!");
