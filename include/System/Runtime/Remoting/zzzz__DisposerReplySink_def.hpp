...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::DisposerReplySink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::DisposerReplySink*, "System.Runtime.Remoting", "DisposerReplySink");
...
/// @brief Method SyncProcessMessage, addr 0x181625910, size 0x50, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::DisposerReplySink) == 0x20, "Size mismatch!");
