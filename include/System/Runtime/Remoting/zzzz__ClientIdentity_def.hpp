...
/// @brief Method CreateObjRef, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816209b0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectUri, ::System::Runtime::Remoting::ObjRef*  objRef) ;

/// @brief Method get_ClientProxy, addr 0x181620a40, size 0x70, virtual false, abstract: false, final false
inline ::System::MarshalByRefObject* get_ClientProxy() ;

/// @brief Method get_TargetUri, addr 0x181620ab0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_TargetUri() ;

/// @brief Method set_ClientProxy, addr 0x181620ad0, size 0x60, virtual false, abstract: false, final false
