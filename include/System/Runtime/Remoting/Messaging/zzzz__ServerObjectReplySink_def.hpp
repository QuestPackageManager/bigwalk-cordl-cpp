...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::ServerObjectReplySink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ServerObjectReplySink*, "System.Runtime.Remoting.Messaging", "ServerObjectReplySink");
...
/// @brief Method SyncProcessMessage, addr 0x18164b640, size 0x50, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::ServerObjectReplySink) == 0x20, "Size mismatch!");
