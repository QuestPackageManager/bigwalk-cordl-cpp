...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::ObjRefSurrogate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ObjRefSurrogate*, "System.Runtime.Remoting.Messaging", "ObjRefSurrogate");
...
/// @brief Method GetObjectData, addr 0x181645ab0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method SetObjectData, addr 0x181645b50, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::ObjRefSurrogate) == 0x10, "Size mismatch!");
