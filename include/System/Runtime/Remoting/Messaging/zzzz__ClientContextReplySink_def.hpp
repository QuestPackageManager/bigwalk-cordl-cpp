...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::ClientContextReplySink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ClientContextReplySink*, "System.Runtime.Remoting.Messaging", "ClientContextReplySink");
...
/// @brief Method AsyncProcessMessage, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final true
...
static inline ::System::Runtime::Remoting::Messaging::ClientContextReplySink* New_ctor(::System::Runtime::Remoting::Contexts::Context*  ctx, ::System::Runtime::Remoting::Messaging::IMessageSink*  replySink) ;

/// @brief Method SyncProcessMessage, addr 0x18163ba60, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::ClientContextReplySink) == 0x20, "Size mismatch!");
