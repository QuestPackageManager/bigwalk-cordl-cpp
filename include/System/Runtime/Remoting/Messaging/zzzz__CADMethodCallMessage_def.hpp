...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::CADMethodCallMessage*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::CADMethodCallMessage*, "System.Runtime.Remoting.Messaging", "CADMethodCallMessage");
...
/// @brief Method Create, addr 0x181638a10, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181638c60, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method get_Uri, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::CADMethodCallMessage) == 0x40, "Size mismatch!");
