...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::RemotingSurrogate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::RemotingSurrogate*, "System.Runtime.Remoting.Messaging", "RemotingSurrogate");
...
/// @brief Method GetObjectData, addr 0x18164a340, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method SetObjectData, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* SetObjectData(::System::Object*  obj, ::System::Runtime::Serialization::SerializationInfo*  si, ::System::Runtime::Serialization::StreamingContext  sc, ::System::Runtime::Serialization::ISurrogateSelector*  selector) ;
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::RemotingSurrogate) == 0x10, "Size mismatch!");
