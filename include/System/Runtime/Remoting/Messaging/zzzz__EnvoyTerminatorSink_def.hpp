...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::EnvoyTerminatorSink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::EnvoyTerminatorSink*, "System.Runtime.Remoting.Messaging", "EnvoyTerminatorSink");
...
/// @brief Method AsyncProcessMessage, addr 0x18163e0c0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method SyncProcessMessage, addr 0x18163e110, size 0x40, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::EnvoyTerminatorSink) == 0x10, "Size mismatch!");
