...
/// @brief Method GetArg, addr 0x181643ed0, size 0x20, virtual true, abstract: false, final true
inline ::System::Object* GetArg(int32_t  argNum) ;

/// @brief Method GetObjectData, addr 0x181643ef0, size 0x2b0, virtual true, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method InitMethodProperty, addr 0x1816441a0, size 0x5c0, virtual false, abstract: false, final false
...
static inline ::System::Runtime::Remoting::Messaging::MethodResponse* New_ctor(::System::Runtime::Remoting::Messaging::IMethodCallMessage*  msg, ::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*  retmsg) ;

static inline ::System::Runtime::Remoting::Messaging::MethodResponse* New_ctor(::System::Object*  returnValue, ::ArrayW<::System::Object*>  outArgs, ::System::Runtime::Remoting::Messaging::LogicalCallContext*  callCtx, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  msg) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity, addr 0x18039fe40, size 0x10, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Identity* System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri, addr 0x181644760, size 0x50, virtual true, abstract: false, final true
inline ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity, addr 0x1803d5ad0, size 0x10, virtual true, abstract: false, final true
inline void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(::System::Runtime::Remoting::Identity*  value) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri, addr 0x1802ecc20, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18163cb60, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  msg) ;

/// @brief Method .ctor, addr 0x18163cc20, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x181644850, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816447b0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  returnValue, ::ArrayW<::System::Object*>  outArgs, ::System::Runtime::Remoting::Messaging::LogicalCallContext*  callCtx, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  msg) ;

/// @brief Method get_ArgCount, addr 0x181644b30, size 0x20, virtual true, abstract: false, final true
inline int32_t get_ArgCount() ;

/// @brief Method get_Args, addr 0x1802e0b30, size 0x10, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*> get_Args() ;

/// @brief Method get_Exception, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final true
inline ::System::Exception* get_Exception() ;

/// @brief Method get_LogicalCallContext, addr 0x181644b50, size 0x40, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext() ;

/// @brief Method get_MethodBase, addr 0x181644b90, size 0x80, virtual true, abstract: false, final true
inline ::System::Reflection::MethodBase* get_MethodBase() ;

/// @brief Method get_MethodName, addr 0x181644c10, size 0x50, virtual true, abstract: false, final true
inline ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature, addr 0x181644c60, size 0xb0, virtual true, abstract: false, final true
inline ::System::Object* get_MethodSignature() ;

/// @brief Method get_OutArgs, addr 0x181644d10, size 0x120, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*> get_OutArgs() ;

/// @brief Method get_Properties, addr 0x18163cd20, size 0xf0, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* get_Properties() ;

/// @brief Method get_ReturnValue, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* get_ReturnValue() ;

/// @brief Method get_TypeName, addr 0x181644e30, size 0x50, virtual true, abstract: false, final true
inline ::StringW get_TypeName() ;

/// @brief Method get_Uri, addr 0x181644760, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method set_Uri, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::MethodResponse) == 0x88, "Size mismatch!");
