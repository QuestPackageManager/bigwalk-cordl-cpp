...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::MCMDictionary*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::MCMDictionary*, "System.Runtime.Remoting.Messaging", "MCMDictionary");
...
/// @brief Method .ctor, addr 0x181641510, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::MCMDictionary) == 0x30, "Size mismatch!");
