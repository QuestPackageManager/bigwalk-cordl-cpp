...
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::CallType, "System.Runtime.Remoting.Messaging", "CallType");
// Dependencies 
namespace System::Runtime::Remoting::Messaging {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Remoting::Messaging::CallType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Remoting::Messaging::CallType) == 0x4, "Size mismatch!");
