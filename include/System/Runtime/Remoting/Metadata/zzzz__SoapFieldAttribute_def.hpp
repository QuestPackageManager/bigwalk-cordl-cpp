...
/// @brief Method IsInteropXmlElement, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool IsInteropXmlElement() ;

static inline ::System::Runtime::Remoting::Metadata::SoapFieldAttribute* New_ctor() ;

/// @brief Method SetReflectionObject, addr 0x18164b940, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method get_XmlElementName, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Metadata::SoapFieldAttribute) == 0x38, "Size mismatch!");
