...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Metadata::SoapTypeAttribute*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Metadata::SoapTypeAttribute*, "System.Runtime.Remoting.Metadata", "SoapTypeAttribute");
...
/// @brief Method SetReflectionObject, addr 0x18164bb20, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method get_IsInteropXmlElement, addr 0x18164bcd0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInteropXmlElement() ;

/// @brief Method get_IsInteropXmlType, addr 0x1802f8060, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInteropXmlType() ;

/// @brief Method get_UseAttribute, addr 0x1802f1be0, size 0x10, virtual true, abstract: false, final false
inline bool get_UseAttribute() ;

/// @brief Method get_XmlElementName, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_XmlElementName() ;

/// @brief Method get_XmlNamespace, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_XmlNamespace() ;

/// @brief Method get_XmlTypeName, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_XmlTypeName() ;

/// @brief Method get_XmlTypeNamespace, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Metadata::SoapTypeAttribute) == 0x58, "Size mismatch!");
