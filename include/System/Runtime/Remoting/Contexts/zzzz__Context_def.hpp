...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Contexts::Context*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Contexts::Context*, "System.Runtime.Remoting.Contexts", "Context");
...
// Declarations
 ...
 __declspec(property(get=get_ContextProperties)) ::ArrayW<::System::Runtime::Remoting::Contexts::IContextProperty*>  ContextProperties;
...
/// @brief Field client_context_sink_chain, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_client_context_sink_chain, put=__cordl_internal_set_client_context_sink_chain)) ::System::Runtime::Remoting::Messaging::IMessageSink*  client_context_sink_chain;

/// @brief Field context_dynamic_properties, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_context_dynamic_properties, put=__cordl_internal_set_context_dynamic_properties)) ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*  context_dynamic_properties;
...
/// @brief Field context_properties, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_context_properties, put=__cordl_internal_set_context_properties)) ::System::Collections::Generic::List_1<::System::Runtime::Remoting::Contexts::IContextProperty*>*  context_properties;
...
/// @brief Field global_dynamic_properties, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_global_dynamic_properties, put=setStaticF_global_dynamic_properties)) ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*  global_dynamic_properties;

/// @brief Field local_slots, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_local_slots, put=setStaticF_local_slots)) ::ArrayW<::System::Object*>  local_slots;

/// @brief Field server_context_sink_chain, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_server_context_sink_chain, put=__cordl_internal_set_server_context_sink_chain)) ::System::Runtime::Remoting::Messaging::IMessageSink*  server_context_sink_chain;
...
/// @brief Method AllocateDataSlot, addr 0x181623920, size 0x40, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* AllocateDataSlot() ;

/// @brief Method AllocateNamedDataSlot, addr 0x181623960, size 0x40, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW  name) ;

/// @brief Method CreateEnvoySink, addr 0x1816239a0, size 0xf0, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* CreateEnvoySink(::System::MarshalByRefObject*  serverObject) ;

/// @brief Method CreateNewContext, addr 0x181623a90, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method CreateServerObjectSinkChain, addr 0x181624050, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method DoCallBack, addr 0x181624160, size 0xc0, virtual false, abstract: false, final false
inline void DoCallBack(::System::Runtime::Remoting::Contexts::CrossContextDelegate*  deleg) ;

/// @brief Method Finalize, addr 0x181624220, size 0x10, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FreeNamedDataSlot, addr 0x181624230, size 0x40, virtual false, abstract: false, final false
static inline void FreeNamedDataSlot(::StringW  name) ;

/// @brief Method Freeze, addr 0x181624270, size 0x120, virtual true, abstract: false, final false
inline void Freeze() ;

/// @brief Method GetClientContextSinkChain, addr 0x181624390, size 0x110, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* GetClientContextSinkChain() ;

/// @brief Method GetData, addr 0x1816244a0, size 0x30, virtual false, abstract: false, final false
static inline ::System::Object* GetData(::System::LocalDataStoreSlot*  slot) ;

/// @brief Method GetDynamicPropertyCollection, addr 0x1816244d0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method GetNamedDataSlot, addr 0x181624620, size 0x40, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW  name) ;

/// @brief Method GetProperty, addr 0x181624660, size 0xb0, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::Contexts::IContextProperty* GetProperty(::StringW  name) ;

/// @brief Method GetServerContextSinkChain, addr 0x181624710, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method NotifyDynamicSinks, addr 0x181624860, size 0x90, virtual false, abstract: false, final false
inline void NotifyDynamicSinks(bool  start, ::System::Runtime::Remoting::Messaging::IMessage*  req_msg, bool  client_site, bool  async) ;

/// @brief Method NotifyGlobalDynamicSinks, addr 0x1816248f0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method RegisterContext, addr 0x1816249a0, size 0x10, virtual false, abstract: false, final false
static inline void RegisterContext(::System::Runtime::Remoting::Contexts::Context*  ctx) ;

/// @brief Method RegisterDynamicProperty, addr 0x1816249b0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method ReleaseContext, addr 0x181624b10, size 0x10, virtual false, abstract: false, final false
static inline void ReleaseContext(::System::Runtime::Remoting::Contexts::Context*  ctx) ;

/// @brief Method SetData, addr 0x181624b20, size 0x40, virtual false, abstract: false, final false
static inline void SetData(::System::LocalDataStoreSlot*  slot, ::System::Object*  data) ;

/// @brief Method SetProperty, addr 0x181624b60, size 0xf0, virtual true, abstract: false, final false
inline void SetProperty(::System::Runtime::Remoting::Contexts::IContextProperty*  prop) ;

/// @brief Method SwitchToContext, addr 0x181624c50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x181624c60, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnregisterDynamicProperty, addr 0x181624c90, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181624e50, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::ArrayW<::System::Object*> getStaticF_local_slots() ;

/// @brief Method get_ContextID, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ContextID() ;

/// @brief Method get_ContextProperties, addr 0x181624eb0, size 0x30, virtual true, abstract: false, final false
inline ::ArrayW<::System::Runtime::Remoting::Contexts::IContextProperty*> get_ContextProperties() ;

/// @brief Method get_DefaultContext, addr 0x181624ee0, size 0x10, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* get_DefaultContext() ;

/// @brief Method get_HasDynamicSinks, addr 0x181624ef0, size 0x40, virtual false, abstract: false, final false
inline bool get_HasDynamicSinks() ;

/// @brief Method get_HasExitSinks, addr 0x181624f30, size 0xd0, virtual false, abstract: false, final false
inline bool get_HasExitSinks() ;

/// @brief Method get_HasGlobalDynamicSinks, addr 0x181625000, size 0x60, virtual false, abstract: false, final false
static inline bool get_HasGlobalDynamicSinks() ;

/// @brief Method get_IsDefaultContext, addr 0x181625060, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDefaultContext() ;

/// @brief Method get_MyLocalStore, addr 0x181625070, size 0x130, virtual false, abstract: false, final false
inline ::System::LocalDataStore* get_MyLocalStore() ;

/// @brief Method get_NeedsContextSink, addr 0x1816251a0, size 0xd0, virtual false, abstract: false, final false
...
static inline void setStaticF_local_slots(::ArrayW<::System::Object*>  value) ;
...
static_assert(sizeof(::System::Runtime::Remoting::Contexts::Context) == 0x58, "Size mismatch!");
