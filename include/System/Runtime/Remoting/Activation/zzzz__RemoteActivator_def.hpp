...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Activation::RemoteActivator*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Activation::RemoteActivator*, "System.Runtime.Remoting.Activation", "RemoteActivator");
...
/// @brief Method Activate, addr 0x181649f20, size 0x220, virtual true, abstract: false, final true
...
/// @brief Method get_NextActivator, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Activation::RemoteActivator) == 0x18, "Size mismatch!");
