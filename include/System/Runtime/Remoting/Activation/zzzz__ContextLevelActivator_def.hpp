...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Activation::ContextLevelActivator*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Activation::ContextLevelActivator*, "System.Runtime.Remoting.Activation", "ContextLevelActivator");
...
/// @brief Method Activate, addr 0x18163ce10, size 0x160, virtual true, abstract: false, final true
...
/// @brief Method get_NextActivator, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Activation::ContextLevelActivator) == 0x18, "Size mismatch!");
