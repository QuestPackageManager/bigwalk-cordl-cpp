...
static_assert(offsetof(::System::Runtime::Remoting::CustomErrorsModes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Remoting::CustomErrorsModes) == 0x4, "Size mismatch!");
