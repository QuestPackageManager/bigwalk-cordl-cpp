...
/// @brief Field <>9, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9, put=setStaticF___9)) ::System::Runtime::CompilerServices::CallSite_1___c<T>*  __9;

/// @brief Field <>9__20_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__20_0, put=setStaticF___9__20_0)) ::System::Converter_2<::System::Reflection::ParameterInfo*,::System::Linq::Expressions::ParameterExpression*>*  __9__20_0;

/// @brief Field <>9__20_1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__20_1, put=setStaticF___9__20_1)) ::System::Converter_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Expression*>*  __9__20_1;

/// @brief Field <>9__21_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__21_0, put=setStaticF___9__21_0)) ::System::Converter_2<::System::Reflection::ParameterInfo*,::System::Linq::Expressions::ParameterExpression*>*  __9__21_0;

static inline ::System::Runtime::CompilerServices::CallSite_1___c<T>* New_ctor() ;
...
static inline ::System::Runtime::CompilerServices::CallSite_1___c<T>* getStaticF___9() ;
...
static inline void setStaticF___9(::System::Runtime::CompilerServices::CallSite_1___c<T>*  value) ;
...
// Dependencies System.Runtime.CompilerServices.CallSite
namespace System::Runtime::CompilerServices {
// cpp template
template<typename T>
// Is value type: false
...
public:
// Declarations
using __c = ::System::Runtime::CompilerServices::CallSite_1___c<T>;

/// @brief Field Rules, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_Rules, put=__cordl_internal_set_Rules)) ::ArrayW<T>  Rules;
...
/// @brief Field s_cachedNoMatch, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cachedNoMatch, put=setStaticF_s_cachedNoMatch)) T  s_cachedNoMatch;

/// @brief Field s_cachedUpdate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cachedUpdate, put=setStaticF_s_cachedUpdate)) T  s_cachedUpdate;
...
/// @brief Method GetUpdateDelegate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline T GetUpdateDelegate(::by_ref<T>  addr) ;
...
constexpr ::ArrayW<T> const& __cordl_internal_get_Rules() const;

constexpr ::ArrayW<T>& __cordl_internal_get_Rules() ;

constexpr T const& __cordl_internal_get_Target() const;

constexpr T& __cordl_internal_get_Target() ;

constexpr void __cordl_internal_set_Rules(::ArrayW<T>  value) ;
