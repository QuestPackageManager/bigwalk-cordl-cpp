...
// Write type traits
MARK_REF_T(::System::Runtime::CompilerServices::FormattableStringFactory*);
MARK_REF_T(::System::Runtime::CompilerServices::FormattableStringFactory_ConcreteFormattableString*);
DEFINE_IL2CPP_CLASS(::System::Runtime::CompilerServices::FormattableStringFactory*, "System.Runtime.CompilerServices", "FormattableStringFactory");
DEFINE_IL2CPP_CLASS(::System::Runtime::CompilerServices::FormattableStringFactory_ConcreteFormattableString*, "System.Runtime.CompilerServices", "FormattableStringFactory/ConcreteFormattableString");
// Dependencies System.FormattableString, System.Object
namespace System::Runtime::CompilerServices {
// Is value type: false
...
/// @brief Field _arguments, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__arguments, put=__cordl_internal_set__arguments)) ::ArrayW<::System::Object*>  _arguments;
...
/// @brief Method GetArgument, addr 0x18164a410, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* GetArgument(int32_t  index) ;

/// @brief Method GetArguments, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x1816627e0, size 0x60, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Object*>& __cordl_internal_get__arguments() ;

constexpr ::StringW const& __cordl_internal_get__format() const;

constexpr ::StringW& __cordl_internal_get__format() ;

constexpr void __cordl_internal_set__arguments(::ArrayW<::System::Object*>  value) ;
...
/// @brief Method get_ArgumentCount, addr 0x180df9d80, size 0x600, virtual true, abstract: false, final false
inline int32_t get_ArgumentCount() ;

/// @brief Method get_Format, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Field _arguments, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ____arguments;
...
static_assert(sizeof(::System::Runtime::CompilerServices::FormattableStringFactory_ConcreteFormattableString) == 0x20, "Size mismatch!");
...
/// @brief Method Create, addr 0x181663d10, size 0x90, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::Runtime::CompilerServices::FormattableStringFactory) == 0x10, "Size mismatch!");
