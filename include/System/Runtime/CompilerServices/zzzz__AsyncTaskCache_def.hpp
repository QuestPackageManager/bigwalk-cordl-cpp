...
// Write type traits
MARK_REF_T(::System::Runtime::CompilerServices::AsyncTaskCache*);
DEFINE_IL2CPP_CLASS(::System::Runtime::CompilerServices::AsyncTaskCache*, "System.Runtime.CompilerServices", "AsyncTaskCache");
// Dependencies System.Object, System.Threading.Tasks.Task`1<TResult>
namespace System::Runtime::CompilerServices {
// Is value type: false
...
/// @brief Field FalseTask, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_FalseTask, put=setStaticF_FalseTask)) ::System::Threading::Tasks::Task_1<bool>*  FalseTask;

/// @brief Field Int32Tasks, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Int32Tasks, put=setStaticF_Int32Tasks)) ::ArrayW<::System::Threading::Tasks::Task_1<int32_t>*>  Int32Tasks;

/// @brief Field TrueTask, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_TrueTask, put=setStaticF_TrueTask)) ::System::Threading::Tasks::Task_1<bool>*  TrueTask;
...
/// @brief Method CreateInt32Tasks, addr 0x181661f20, size 0x70, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Threading::Tasks::Task_1<int32_t>*> getStaticF_Int32Tasks() ;
...
static inline void setStaticF_Int32Tasks(::ArrayW<::System::Threading::Tasks::Task_1<int32_t>*>  value) ;
...
static_assert(sizeof(::System::Runtime::CompilerServices::AsyncTaskCache) == 0x10, "Size mismatch!");
