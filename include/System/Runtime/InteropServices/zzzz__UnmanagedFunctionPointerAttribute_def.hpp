...
/// @brief Method get_CallingConvention, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::UnmanagedFunctionPointerAttribute) == 0x18, "Size mismatch!");
