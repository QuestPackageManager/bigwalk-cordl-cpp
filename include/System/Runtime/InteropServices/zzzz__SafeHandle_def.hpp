...
/// @brief Method Close, addr 0x18166ac70, size 0x20, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method DangerousAddRef, addr 0x18166c670, size 0x70, virtual false, abstract: false, final false
inline void DangerousAddRef(::by_ref<bool>  success) ;

/// @brief Method DangerousGetHandle, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::IntPtr DangerousGetHandle() ;

/// @brief Method DangerousRelease, addr 0x18166c780, size 0x10, virtual false, abstract: false, final false
inline void DangerousRelease() ;

/// @brief Method DangerousReleaseInternal, addr 0x18166c6e0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x18166c790, size 0x60, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x18166c7f0, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalDispose, addr 0x18166c840, size 0x40, virtual false, abstract: false, final false
inline void InternalDispose() ;

/// @brief Method InternalFinalize, addr 0x18166c880, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetHandle, addr 0x1804bda40, size 0x10, virtual false, abstract: false, final false
inline void SetHandle(::System::IntPtr  handle) ;

/// @brief Method SetHandleAsInvalid, addr 0x18166c8a0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18166c900, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  invalidHandleValue, bool  ownsHandle) ;

/// @brief Method get_IsClosed, addr 0x18166c940, size 0x10, virtual false, abstract: false, final false
