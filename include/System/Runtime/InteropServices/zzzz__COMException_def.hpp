...
// Write type traits
MARK_REF_T(::System::Runtime::InteropServices::COMException*);
DEFINE_IL2CPP_CLASS(::System::Runtime::InteropServices::COMException*, "System.Runtime.InteropServices", "COMException");
...
/// @brief Method ToString, addr 0x181662630, size 0x160, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::COMException) == 0x90, "Size mismatch!");
