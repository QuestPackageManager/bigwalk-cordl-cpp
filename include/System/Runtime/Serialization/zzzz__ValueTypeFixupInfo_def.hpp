...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ValueTypeFixupInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ValueTypeFixupInfo*, "System.Runtime.Serialization", "ValueTypeFixupInfo");
...
// Declarations
 ...
 __declspec(property(get=get_ParentIndex)) ::ArrayW<int32_t>  ParentIndex;
...
/// @brief Field _parentIndex, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__parentIndex, put=__cordl_internal_set__parentIndex)) ::ArrayW<int32_t>  _parentIndex;

static inline ::System::Runtime::Serialization::ValueTypeFixupInfo* New_ctor(int64_t  containerID, ::System::Reflection::FieldInfo*  member, ::ArrayW<int32_t>  parentIndex) ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__parentIndex() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__parentIndex() ;
...
/// @brief Method .ctor, addr 0x18164c6b0, size 0x130, virtual false, abstract: false, final false
inline void _ctor(int64_t  containerID, ::System::Reflection::FieldInfo*  member, ::ArrayW<int32_t>  parentIndex) ;

/// @brief Method get_ContainerID, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_ContainerID() ;

/// @brief Method get_ParentField, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Reflection::FieldInfo* get_ParentField() ;

/// @brief Method get_ParentIndex, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _parentIndex, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<int32_t>  ____parentIndex;
...
static_assert(sizeof(::System::Runtime::Serialization::ValueTypeFixupInfo) == 0x28, "Size mismatch!");
