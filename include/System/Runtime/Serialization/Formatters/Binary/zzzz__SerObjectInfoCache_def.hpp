...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoCache*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoCache*, "System.Runtime.Serialization.Formatters.Binary", "SerObjectInfoCache");
// Dependencies System.Object, System.Reflection.MemberInfo, System.Type
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field memberInfos, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_memberInfos, put=__cordl_internal_set_memberInfos)) ::ArrayW<::System::Reflection::MemberInfo*>  memberInfos;
...
constexpr ::ArrayW<::System::Reflection::MemberInfo*> const& __cordl_internal_get_memberInfos() const;

constexpr ::ArrayW<::System::Reflection::MemberInfo*>& __cordl_internal_get_memberInfos() ;
...
constexpr void __cordl_internal_set_memberInfos(::ArrayW<::System::Reflection::MemberInfo*>  value) ;
...
/// @brief Method .ctor, addr 0x18165b6b0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Field memberInfos, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::Reflection::MemberInfo*>  ___memberInfos;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoCache) == 0x40, "Size mismatch!");
