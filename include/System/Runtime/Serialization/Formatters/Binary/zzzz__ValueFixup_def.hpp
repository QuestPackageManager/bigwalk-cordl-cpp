...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ValueFixup*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ValueFixup*, "System.Runtime.Serialization.Formatters.Binary", "ValueFixup");
...
/// @brief Field indexMap, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_indexMap, put=__cordl_internal_set_indexMap)) ::ArrayW<int32_t>  indexMap;
...
/// @brief Method Fixup, addr 0x18166d9e0, size 0x250, virtual false, abstract: false, final false
...
static inline ::System::Runtime::Serialization::Formatters::Binary::ValueFixup* New_ctor(::System::Array*  arrayObj, ::ArrayW<int32_t>  indexMap) ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_indexMap() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_indexMap() ;
...
constexpr void __cordl_internal_set_indexMap(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x18166dc30, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Array*  arrayObj, ::ArrayW<int32_t>  indexMap) ;

/// @brief Method .ctor, addr 0x18166dc70, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ValueFixup) == 0x48, "Size mismatch!");
