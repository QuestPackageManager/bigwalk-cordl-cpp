...
static_assert(offsetof(::System::Runtime::Serialization::Formatters::Binary::MessageEnum, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::MessageEnum) == 0x4, "Size mismatch!");
