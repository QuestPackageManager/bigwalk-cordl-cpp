...
/// @brief Field m_crossAppDomainArray, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_crossAppDomainArray, put=__cordl_internal_set_m_crossAppDomainArray)) ::ArrayW<::System::Object*>  m_crossAppDomainArray;
...
/// @brief Method Deserialize, addr 0x18164df70, size 0x20, virtual true, abstract: false, final true
inline ::System::Object* Deserialize(::System::IO::Stream*  serializationStream) ;

/// @brief Method Deserialize, addr 0x18164df50, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method Deserialize, addr 0x18164dd00, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method GetTypeInformation, addr 0x18164df90, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Serialize, addr 0x18164e420, size 0x20, virtual true, abstract: false, final true
inline void Serialize(::System::IO::Stream*  serializationStream, ::System::Object*  graph) ;

/// @brief Method Serialize, addr 0x18164e190, size 0x20, virtual true, abstract: false, final true
inline void Serialize(::System::IO::Stream*  serializationStream, ::System::Object*  graph, ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  headers) ;

/// @brief Method Serialize, addr 0x18164e1b0, size 0x270, virtual false, abstract: false, final false
inline void Serialize(::System::IO::Stream*  serializationStream, ::System::Object*  graph, ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  headers, bool  fCheck) ;
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_m_crossAppDomainArray() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_m_crossAppDomainArray() ;
...
constexpr void __cordl_internal_set_m_crossAppDomainArray(::ArrayW<::System::Object*>  value) ;
...
/// @brief Method .ctor, addr 0x18164e4a0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18164e510, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_AssemblyFormat, addr 0x180393010, size 0x10, virtual false, abstract: false, final false
inline void set_AssemblyFormat(::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle  value) ;

/// @brief Method set_SurrogateSelector, addr 0x180308500, size 0x30, virtual true, abstract: false, final true
...
/// @brief Field m_crossAppDomainArray, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___m_crossAppDomainArray;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryFormatter) == 0x48, "Size mismatch!");
