...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ObjectMapInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ObjectMapInfo*, "System.Runtime.Serialization.Formatters.Binary", "ObjectMapInfo");
...
static inline ::System::Runtime::Serialization::Formatters::Binary::ObjectMapInfo* New_ctor(int32_t  objectId, int32_t  numMembers, ::ArrayW<::StringW>  memberNames, ::ArrayW<::System::Type*>  memberTypes) ;
...
/// @brief Method isCompatible, addr 0x181651a40, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ObjectMapInfo) == 0x28, "Size mismatch!");
