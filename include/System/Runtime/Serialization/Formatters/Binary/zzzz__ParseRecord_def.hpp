...
/// @brief Field PRarrayElementTypeCode, offset 0x7c, size 0x4 
 __declspec(property(get=__cordl_internal_get_PRarrayElementTypeCode, put=__cordl_internal_set_PRarrayElementTypeCode)) ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  PRarrayElementTypeCode;
...
/// @brief Field PRindexMap, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRindexMap, put=__cordl_internal_set_PRindexMap)) ::ArrayW<int32_t>  PRindexMap;
...
/// @brief Field PRlengthA, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRlengthA, put=__cordl_internal_set_PRlengthA)) ::ArrayW<int32_t>  PRlengthA;
...
/// @brief Field PRlowerBoundA, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRlowerBoundA, put=__cordl_internal_set_PRlowerBoundA)) ::ArrayW<int32_t>  PRlowerBoundA;

/// @brief Field PRmemberData, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRmemberData, put=__cordl_internal_set_PRmemberData)) ::ArrayW<::System::Object*>  PRmemberData;
...
/// @brief Field PRmemberTypeEnum, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_PRmemberTypeEnum, put=__cordl_internal_set_PRmemberTypeEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalMemberTypeE  PRmemberTypeEnum;

/// @brief Field PRmemberValueEnum, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_PRmemberValueEnum, put=__cordl_internal_set_PRmemberValueEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalMemberValueE  PRmemberValueEnum;
...
/// @brief Field PRobjectA, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRobjectA, put=__cordl_internal_set_PRobjectA)) ::ArrayW<::System::Object*>  PRobjectA;
...
/// @brief Field PRobjectPositionEnum, offset 0x24, size 0x4 
 __declspec(property(get=__cordl_internal_get_PRobjectPositionEnum, put=__cordl_internal_set_PRobjectPositionEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalObjectPositionE  PRobjectPositionEnum;

/// @brief Field PRobjectTypeEnum, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get_PRobjectTypeEnum, put=__cordl_internal_set_PRobjectTypeEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalObjectTypeE  PRobjectTypeEnum;
...
/// @brief Field PRpositionA, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRpositionA, put=__cordl_internal_set_PRpositionA)) ::ArrayW<int32_t>  PRpositionA;
...
/// @brief Field PRrectangularMap, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRrectangularMap, put=__cordl_internal_set_PRrectangularMap)) ::ArrayW<int32_t>  PRrectangularMap;
...
/// @brief Field PRupperBoundA, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_PRupperBoundA, put=__cordl_internal_set_PRupperBoundA)) ::ArrayW<int32_t>  PRupperBoundA;
...
/// @brief Method Init, addr 0x181666040, size 0x1d0, virtual false, abstract: false, final false
inline void Init() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRindexMap() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRindexMap() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRlengthA() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRlengthA() ;

constexpr int32_t const& __cordl_internal_get_PRlinearlength() const;

constexpr int32_t& __cordl_internal_get_PRlinearlength() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRlowerBoundA() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRlowerBoundA() ;

constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_PRmemberData() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_PRmemberData() ;
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_PRobjectA() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_PRobjectA() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRpositionA() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRpositionA() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRrectangularMap() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRrectangularMap() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_PRupperBoundA() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_PRupperBoundA() ;
...
constexpr void __cordl_internal_set_PRindexMap(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_PRlengthA(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_PRlinearlength(int32_t  value) ;

constexpr void __cordl_internal_set_PRlowerBoundA(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_PRmemberData(::ArrayW<::System::Object*>  value) ;
...
constexpr void __cordl_internal_set_PRobjectA(::ArrayW<::System::Object*>  value) ;
...
constexpr void __cordl_internal_set_PRpositionA(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_PRrectangularMap(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_PRupperBoundA(::ArrayW<int32_t>  value) ;
...
/// @brief Field PRrectangularMap, offset: 0xb8, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___PRrectangularMap;
...
/// @brief Field PRobjectA, offset: 0xf0, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___PRobjectA;
...
/// @brief Field PRmemberData, offset: 0x108, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___PRmemberData;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ParseRecord) == 0x120, "Size mismatch!");
