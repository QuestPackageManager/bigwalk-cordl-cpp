...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString*, "System.Runtime.Serialization.Formatters.Binary", "BinaryObjectString");
...
/// @brief Method Write, addr 0x18164eb40, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectString) == 0x20, "Size mismatch!");
