...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::InternalFE*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::InternalFE*, "System.Runtime.Serialization.Formatters.Binary", "InternalFE");
// Dependencies System.Object, System.Runtime.Serialization.Formatters.Binary.InternalSerializerTypeE, System.Runtime.Serialization.Formatters.FormatterAssemblyStyle, System.Runtime.Serialization.Formatters.FormatterTypeStyle, System.Runtime.Serialization.Formatters.TypeFilterLevel
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field FEserializerTypeEnum, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_FEserializerTypeEnum, put=__cordl_internal_set_FEserializerTypeEnum)) ::System::Runtime::Serialization::Formatters::Binary::InternalSerializerTypeE  FEserializerTypeEnum;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::InternalFE) == 0x20, "Size mismatch!");
