...
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::InternalObjectTypeE, "System.Runtime.Serialization.Formatters.Binary", "InternalObjectTypeE");
// Dependencies 
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Serialization::Formatters::Binary::InternalObjectTypeE, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::InternalObjectTypeE) == 0x4, "Size mismatch!");
