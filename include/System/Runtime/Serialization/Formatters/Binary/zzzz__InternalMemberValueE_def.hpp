...
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::InternalMemberValueE, "System.Runtime.Serialization.Formatters.Binary", "InternalMemberValueE");
// Dependencies 
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Serialization::Formatters::Binary::InternalMemberValueE, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::InternalMemberValueE) == 0x4, "Size mismatch!");
