...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ObjectWriter*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ObjectWriter*, "System.Runtime.Serialization.Formatters.Binary", "ObjectWriter");
// Dependencies System.Object, System.Runtime.Remoting.Messaging.Header, System.Runtime.Serialization.Formatters.Binary.InternalPrimitiveTypeE, System.Runtime.Serialization.StreamingContext
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field crossAppDomainArray, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_crossAppDomainArray, put=__cordl_internal_set_crossAppDomainArray)) ::ArrayW<::System::Object*>  crossAppDomainArray;
...
/// @brief Field headers, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_headers, put=__cordl_internal_set_headers)) ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  headers;
...
/// @brief Field serObjectInfoInit, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_serObjectInfoInit, put=__cordl_internal_set_serObjectInfoInit)) ::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*  serObjectInfoInit;
...
/// @brief Method CheckForNull, addr 0x181655b80, size 0x180, virtual false, abstract: false, final false
inline bool CheckForNull(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  typeNameInfo, ::System::Object*  data) ;

/// @brief Method CheckTypeFormat, addr 0x181655d00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetAssemblyId, addr 0x181655d10, size 0x320, virtual false, abstract: false, final false
inline int64_t GetAssemblyId(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo) ;

/// @brief Method GetNameInfo, addr 0x181656030, size 0x70, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::NameInfo* GetNameInfo() ;

/// @brief Method GetNext, addr 0x1816560a0, size 0x160, virtual false, abstract: false, final false
inline ::System::Object* GetNext(::by_ref<int64_t>  objID) ;

/// @brief Method GetType, addr 0x181656200, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* GetType(::System::Object*  obj) ;

/// @brief Method InternalGetId, addr 0x181656210, size 0xf0, virtual false, abstract: false, final false
inline int64_t InternalGetId(::System::Object*  obj, bool  assignUniqueIdToValueType, ::System::Type*  type, ::by_ref<bool>  isNew) ;

/// @brief Method MemberToNameInfo, addr 0x181656300, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method PutNameInfo, addr 0x181656340, size 0x10, virtual false, abstract: false, final false
inline void PutNameInfo(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo) ;

/// @brief Method Schedule, addr 0x181656480, size 0x120, virtual false, abstract: false, final false
inline int64_t Schedule(::System::Object*  obj, bool  assignUniqueIdToValueType, ::System::Type*  type) ;

/// @brief Method Schedule, addr 0x181656350, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Serialize, addr 0x1816565a0, size 0x540, virtual false, abstract: false, final false
inline void Serialize(::System::Object*  graph, ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  inHeaders, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter*  serWriter, bool  fCheck) ;

/// @brief Method ToCode, addr 0x181656ae0, size 0x70, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE ToCode(::System::Type*  type) ;

/// @brief Method TypeToNameInfo, addr 0x181656d60, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method TypeToNameInfo, addr 0x181656b50, size 0xe0, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::NameInfo* TypeToNameInfo(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo) ;

/// @brief Method TypeToNameInfo, addr 0x181656cd0, size 0x90, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::NameInfo* TypeToNameInfo(::System::Type*  type) ;

/// @brief Method TypeToNameInfo, addr 0x181656c30, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method TypeToNameInfo, addr 0x181656e30, size 0xa0, virtual false, abstract: false, final false
inline void TypeToNameInfo(::System::Type*  type, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo) ;

/// @brief Method Write, addr 0x181659080, size 0x3b0, virtual false, abstract: false, final false
inline void Write(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  typeNameInfo) ;

/// @brief Method Write, addr 0x181658d90, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method WriteArray, addr 0x1816573b0, size 0xc30, virtual false, abstract: false, final false
inline void WriteArray(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, ::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  memberObjectInfo) ;

/// @brief Method WriteArrayMember, addr 0x181656ed0, size 0x4e0, virtual false, abstract: false, final false
inline void WriteArrayMember(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  arrayElemTypeNameInfo, ::System::Object*  data) ;

/// @brief Method WriteKnownValueClass, addr 0x181657fe0, size 0x130, virtual false, abstract: false, final false
inline bool WriteKnownValueClass(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  typeNameInfo, ::System::Object*  data) ;

/// @brief Method WriteMemberSetup, addr 0x181658110, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method WriteMembers, addr 0x181658240, size 0x680, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectRef, addr 0x1816588c0, size 0x10, virtual false, abstract: false, final false
inline void WriteObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo, int64_t  objectId) ;

/// @brief Method WriteRectangle, addr 0x1816588d0, size 0x1a0, virtual false, abstract: false, final false
inline void WriteRectangle(::System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo*  objectInfo, int32_t  rank, ::ArrayW<int32_t>  maxA, ::System::Array*  array, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  arrayElemNameTypeInfo, ::ArrayW<int32_t>  lowerBoundA) ;

/// @brief Method WriteSerializedStreamHeader, addr 0x181658a70, size 0xf0, virtual false, abstract: false, final false
inline void WriteSerializedStreamHeader(int64_t  topId, int64_t  headerId) ;

/// @brief Method WriteString, addr 0x181658b60, size 0x230, virtual false, abstract: false, final false
inline void WriteString(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, ::System::Runtime::Serialization::Formatters::Binary::NameInfo*  typeNameInfo, ::System::Object*  stringObject) ;
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_crossAppDomainArray() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_crossAppDomainArray() ;
...
constexpr ::ArrayW<::System::Runtime::Remoting::Messaging::Header*> const& __cordl_internal_get_headers() const;

constexpr ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>& __cordl_internal_get_headers() ;
...
constexpr void __cordl_internal_set_crossAppDomainArray(::ArrayW<::System::Object*>  value) ;

constexpr void __cordl_internal_set_formatterEnums(::System::Runtime::Serialization::Formatters::Binary::InternalFE*  value) ;

constexpr void __cordl_internal_set_headers(::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  value) ;
...
/// @brief Method .ctor, addr 0x181659430, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::ISurrogateSelector*  selector, ::System::Runtime::Serialization::StreamingContext  context, ::System::Runtime::Serialization::Formatters::Binary::InternalFE*  formatterEnums, ::System::Runtime::Serialization::SerializationBinder*  binder) ;

/// @brief Method get_ObjectManager, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field headers, offset: 0x60, size: 0x8, def value: None
 ::ArrayW<::System::Runtime::Remoting::Messaging::Header*>  ___headers;
...
/// @brief Field crossAppDomainArray, offset: 0x88, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___crossAppDomainArray;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ObjectWriter) == 0xc0, "Size mismatch!");
