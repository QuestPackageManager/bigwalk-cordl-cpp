...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::MemberHolder*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::MemberHolder*, "System.Runtime.Serialization", "MemberHolder");
...
/// @brief Method Equals, addr 0x181641550, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::MemberHolder) == 0x28, "Size mismatch!");
