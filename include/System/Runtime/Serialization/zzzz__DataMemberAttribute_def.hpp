...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::DataMemberAttribute*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::DataMemberAttribute*, "System.Runtime.Serialization", "DataMemberAttribute");
...
/// @brief Method get_EmitDefaultValue, addr 0x181a74790, size 0x10, virtual false, abstract: false, final false
inline bool get_EmitDefaultValue() ;

/// @brief Method get_IsRequired, addr 0x1804bdaf0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsRequired() ;

/// @brief Method get_Name, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Order, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::DataMemberAttribute) == 0x20, "Size mismatch!");
