...
/// @brief Method get_IsReference, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::DataContractAttribute) == 0x18, "Size mismatch!");
