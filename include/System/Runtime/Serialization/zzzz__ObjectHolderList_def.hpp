...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ObjectHolderList*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ObjectHolderList*, "System.Runtime.Serialization", "ObjectHolderList");
// Dependencies System.Object, System.Runtime.Serialization.ObjectHolder
namespace System::Runtime::Serialization {
// Is value type: false
...
/// @brief Method Add, addr 0x181651830, size 0xa0, virtual true, abstract: false, final false
inline void Add(::System::Runtime::Serialization::ObjectHolder*  value) ;

/// @brief Method EnlargeArray, addr 0x1816518d0, size 0x60, virtual false, abstract: false, final false
inline void EnlargeArray() ;

/// @brief Method GetFixupEnumerator, addr 0x181651930, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Runtime::Serialization::ObjectHolder*> const& __cordl_internal_get_m_values() const;

constexpr ::ArrayW<::System::Runtime::Serialization::ObjectHolder*>& __cordl_internal_get_m_values() ;
...
/// @brief Method .ctor, addr 0x181651980, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816519c0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_Version, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_values, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Runtime::Serialization::ObjectHolder*>  ___m_values;
...
static_assert(sizeof(::System::Runtime::Serialization::ObjectHolderList) == 0x20, "Size mismatch!");
