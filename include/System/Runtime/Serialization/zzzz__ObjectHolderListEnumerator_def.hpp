...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ObjectHolderListEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ObjectHolderListEnumerator*, "System.Runtime.Serialization", "ObjectHolderListEnumerator");
...
/// @brief Method MoveNext, addr 0x181651760, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816517d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::ObjectHolderList*  list, bool  isFixupEnumerator) ;

/// @brief Method get_Current, addr 0x181651810, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::ObjectHolderListEnumerator) == 0x28, "Size mismatch!");
