...
static_assert(offsetof(::System::TypeSpec_DisplayNameFormat, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::TypeSpec_DisplayNameFormat) == 0x4, "Size mismatch!");
...
/// @brief Method AddModifier, addr 0x1817665f0, size 0xb0, virtual false, abstract: false, final false
inline void AddModifier(::System::ModifierSpec*  md) ;

/// @brief Method AddName, addr 0x1817666a0, size 0x140, virtual false, abstract: false, final false
inline void AddName(::StringW  type_name) ;

/// @brief Method BoundCheck, addr 0x1817667e0, size 0x30, virtual false, abstract: false, final false
static inline void BoundCheck(int32_t  idx, ::StringW  s) ;

/// @brief Method GetDisplayFullName, addr 0x181766810, size 0x400, virtual false, abstract: false, final false
inline ::StringW GetDisplayFullName(::System::TypeSpec_DisplayNameFormat  flags) ;

/// @brief Method GetModifierString, addr 0x181766c10, size 0x140, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* GetModifierString(::System::Text::StringBuilder*  sb) ;

static inline ::System::TypeSpec* New_ctor() ;

/// @brief Method Parse, addr 0x181766d50, size 0x920, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  name, ::by_ref<int32_t>  p, bool  is_recurse, bool  allow_aqn) ;

/// @brief Method Parse, addr 0x181767670, size 0x70, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  typeName) ;

/// @brief Method ParsedTypeIdentifier, addr 0x1817665a0, size 0x50, virtual false, abstract: false, final false
static inline ::System::TypeIdentifier* ParsedTypeIdentifier(::StringW  displayName) ;

/// @brief Method Resolve, addr 0x1817676e0, size 0x640, virtual false, abstract: false, final false
...
/// @brief Method SkipSpace, addr 0x181767d20, size 0x70, virtual false, abstract: false, final false
static inline void SkipSpace(::StringW  name, ::by_ref<int32_t>  pos) ;

/// @brief Method UnescapeInternalName, addr 0x181767d90, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_DisplayFullName, addr 0x181767e40, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_DisplayFullName() ;

/// @brief Method get_HasModifiers, addr 0x18165b650, size 0x10, virtual false, abstract: false, final false
