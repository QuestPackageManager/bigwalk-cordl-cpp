...
// Write type traits
MARK_REF_T(::GlobalNamespace::UriParser_BuiltInUriParser*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UriParser_BuiltInUriParser*, "System", "UriParser/BuiltInUriParser");
...
/// @brief Method .ctor, addr 0x181dc5ba0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::UriParser_BuiltInUriParser) == 0x28, "Size mismatch!");
