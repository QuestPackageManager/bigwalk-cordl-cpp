...
/// @brief Method Close, addr 0x18177b790, size 0x30, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x18177b790, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18177b7c0, size 0x20, virtual true, abstract: false, final false
inline void Dispose(bool  explicitDisposing) ;

/// @brief Method Init, addr 0x18177b7e0, size 0x60, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method InternalWaitOne, addr 0x18177b840, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method SetHandleInternal, addr 0x18177b8e0, size 0x40, virtual false, abstract: false, final false
inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle*  handle) ;

/// @brief Method ThrowAbandonedMutexException, addr 0x18177b970, size 0x40, virtual false, abstract: false, final false
static inline void ThrowAbandonedMutexException() ;

/// @brief Method ThrowAbandonedMutexException, addr 0x18177b920, size 0x50, virtual false, abstract: false, final false
static inline void ThrowAbandonedMutexException(int32_t  location, ::System::Threading::WaitHandle*  handle) ;

/// @brief Method WaitAny, addr 0x18177ba30, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method WaitAny, addr 0x18177b9b0, size 0x80, virtual false, abstract: false, final false
static inline int32_t WaitAny(::ArrayW<::System::Threading::WaitHandle*>  waitHandles, ::System::TimeSpan  timeout, bool  exitContext) ;

/// @brief Method WaitMultiple, addr 0x18177bc10, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method WaitOne, addr 0x18177c080, size 0x20, virtual true, abstract: false, final false
inline bool WaitOne() ;

/// @brief Method WaitOne, addr 0x18177c060, size 0x20, virtual true, abstract: false, final false
inline bool WaitOne(int32_t  millisecondsTimeout) ;

/// @brief Method WaitOne, addr 0x18177c0a0, size 0x50, virtual true, abstract: false, final false
inline bool WaitOne(int32_t  millisecondsTimeout, bool  exitContext) ;

/// @brief Method WaitOne, addr 0x1815be480, size 0x20, virtual true, abstract: false, final false
inline bool WaitOne(::System::TimeSpan  timeout) ;

/// @brief Method WaitOne, addr 0x18177c1a0, size 0x80, virtual true, abstract: false, final false
inline bool WaitOne(::System::TimeSpan  timeout, bool  exitContext) ;

/// @brief Method WaitOne, addr 0x18177c0f0, size 0xb0, virtual false, abstract: false, final false
inline bool WaitOne(int64_t  timeout, bool  exitContext) ;

/// @brief Method WaitOneNative, addr 0x18177bf10, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method Wait_internal, addr 0x18177c220, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18177b7e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::IntPtr getStaticF_InvalidHandle() ;

/// @brief Method get_SafeWaitHandle, addr 0x18177c260, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method set_Handle, addr 0x18177c2f0, size 0x1c0, virtual true, abstract: false, final false
