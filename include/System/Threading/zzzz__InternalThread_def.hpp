...
// Write type traits
MARK_REF_T(::System::Threading::InternalThread*);
DEFINE_IL2CPP_CLASS(::System::Threading::InternalThread*, "System.Threading", "InternalThread");
...
/// @brief Field _serialized_principal, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__serialized_principal, put=__cordl_internal_set__serialized_principal)) ::ArrayW<uint8_t>  _serialized_principal;
...
/// @brief Method Finalize, addr 0x18176def0, size 0x60, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::System::Threading::InternalThread* New_ctor() ;

/// @brief Method Thread_free_internal, addr 0x18176df50, size 0x10, virtual false, abstract: false, final false
inline void Thread_free_internal() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__serialized_principal() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__serialized_principal() ;
...
constexpr void __cordl_internal_set__serialized_principal(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x18176df60, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _serialized_principal, offset: 0x80, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ____serialized_principal;
...
static_assert(sizeof(::System::Threading::InternalThread) == 0x128, "Size mismatch!");
