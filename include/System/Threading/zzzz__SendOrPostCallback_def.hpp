...
// Write type traits
MARK_REF_T(::System::Threading::SendOrPostCallback*);
DEFINE_IL2CPP_CLASS(::System::Threading::SendOrPostCallback*, "System.Threading", "SendOrPostCallback");
...
static_assert(sizeof(::System::Threading::SendOrPostCallback) == 0x80, "Size mismatch!");
