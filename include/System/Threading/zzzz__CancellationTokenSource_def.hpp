...
/// @brief Method <.cctor>b__4_0, addr 0x181767ec0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Field _registeredCallbacksLists, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__registeredCallbacksLists, put=__cordl_internal_set__registeredCallbacksLists)) ::ArrayW<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*>  _registeredCallbacksLists;
...
/// @brief Method Cancel, addr 0x181759bc0, size 0x20, virtual false, abstract: false, final false
inline void Cancel() ;

/// @brief Method Cancel, addr 0x181759ba0, size 0x20, virtual false, abstract: false, final false
inline void Cancel(bool  throwOnFirstException) ;

/// @brief Method CancelAfter, addr 0x181759a90, size 0x110, virtual false, abstract: false, final false
inline void CancelAfter(int32_t  millisecondsDelay) ;

/// @brief Method CancellationCallbackCoreWork, addr 0x181759c80, size 0x60, virtual false, abstract: false, final false
inline void CancellationCallbackCoreWork(::System::Threading::CancellationCallbackCoreWorkArguments  args) ;

/// @brief Method CancellationCallbackCoreWork_OnSyncContext, addr 0x181759be0, size 0xa0, virtual false, abstract: false, final false
inline void CancellationCallbackCoreWork_OnSyncContext(::System::Object*  obj) ;

/// @brief Method CreateLinkedTokenSource, addr 0x18175a050, size 0x60, virtual false, abstract: false, final false
static inline ::System::Threading::CancellationTokenSource* CreateLinkedTokenSource(::System::Threading::CancellationToken  token) ;

/// @brief Method CreateLinkedTokenSource, addr 0x181759ce0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method CreateLinkedTokenSource, addr 0x181759e90, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x18175a0b0, size 0x70, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExecuteCallbackHandlers, addr 0x18175a120, size 0x390, virtual false, abstract: false, final false
inline void ExecuteCallbackHandlers(bool  throwOnFirstException) ;

/// @brief Method InternalRegister, addr 0x18175a4b0, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method NotifyCancellation, addr 0x18175a770, size 0x80, virtual false, abstract: false, final false
inline void NotifyCancellation(bool  throwOnFirstException) ;

/// @brief Method ThrowIfDisposed, addr 0x18175a7f0, size 0x20, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method ThrowObjectDisposedException, addr 0x18175a810, size 0x50, virtual false, abstract: false, final false
static inline void ThrowObjectDisposedException() ;

/// @brief Method TimerCallbackLogic, addr 0x18175a860, size 0xa0, virtual false, abstract: false, final false
static inline void TimerCallbackLogic(::System::Object*  obj) ;

/// @brief Method WaitForCallbackToComplete, addr 0x18175a900, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18175ac40, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ExecutingCallback, addr 0x1816af680, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::CancellationCallbackInfo* get_ExecutingCallback() ;

/// @brief Method get_IsCancellationCompleted, addr 0x18175ac60, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCancellationCompleted() ;

/// @brief Method get_IsCancellationRequested, addr 0x18175ac70, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCancellationRequested() ;

/// @brief Method get_IsDisposed, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDisposed() ;

/// @brief Method get_ThreadIDExecutingCallbacks, addr 0x18175ac80, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ThreadIDExecutingCallbacks() ;

/// @brief Method get_Token, addr 0x18175ac90, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_ThreadIDExecutingCallbacks, addr 0x18175acc0, size 0x10, virtual false, abstract: false, final false
