...
/// @brief Method CancellationTokenCallback, addr 0x181762340, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1817624b0, size 0x100, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureLockObjectCreated, addr 0x1817625b0, size 0x40, virtual false, abstract: false, final false
inline void EnsureLockObjectCreated() ;

/// @brief Method ExtractStatePortion, addr 0x181762600, size 0x10, virtual false, abstract: false, final false
static inline int32_t ExtractStatePortion(int32_t  state, int32_t  mask) ;

/// @brief Method ExtractStatePortionAndShiftRight, addr 0x1817625f0, size 0x10, virtual false, abstract: false, final false
static inline int32_t ExtractStatePortionAndShiftRight(int32_t  state, int32_t  mask, int32_t  rightBitShiftCount) ;

/// @brief Method Initialize, addr 0x181762610, size 0x70, virtual false, abstract: false, final false
inline void Initialize(bool  initialState, int32_t  spinCount) ;

/// @brief Method LazyInitializeEvent, addr 0x181762680, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x181762880, size 0xc0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Set, addr 0x181762940, size 0x10, virtual false, abstract: false, final false
inline void Set() ;

/// @brief Method Set, addr 0x181762950, size 0x270, virtual false, abstract: false, final false
inline void Set(bool  duringCancellation) ;

/// @brief Method ThrowIfDisposed, addr 0x181762bc0, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method UpdateStateAtomically, addr 0x181762c20, size 0x170, virtual false, abstract: false, final false
inline void UpdateStateAtomically(int32_t  newBits, int32_t  updateBitsMask) ;

/// @brief Method Wait, addr 0x181762da0, size 0x5c0, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Wait, addr 0x181762d90, size 0x10, virtual false, abstract: false, final false
inline void Wait() ;
...
/// @brief Method .ctor, addr 0x1817633c0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(bool  initialState) ;

/// @brief Method .ctor, addr 0x181763470, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_IsSet, addr 0x181763500, size 0x10, virtual false, abstract: false, final false
inline bool get_IsSet() ;

/// @brief Method get_SpinCount, addr 0x181763510, size 0x10, virtual false, abstract: false, final false
inline int32_t get_SpinCount() ;

/// @brief Method get_WaitHandle, addr 0x181763520, size 0x70, virtual false, abstract: false, final false
inline ::System::Threading::WaitHandle* get_WaitHandle() ;

/// @brief Method get_Waiters, addr 0x181763590, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_IsSet, addr 0x1817635a0, size 0x20, virtual false, abstract: false, final false
inline void set_IsSet(bool  value) ;

/// @brief Method set_SpinCount, addr 0x1817635c0, size 0x20, virtual false, abstract: false, final false
inline void set_SpinCount(int32_t  value) ;

/// @brief Method set_Waiters, addr 0x1817635e0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::ManualResetEventSlim) == 0x28, "Size mismatch!");
