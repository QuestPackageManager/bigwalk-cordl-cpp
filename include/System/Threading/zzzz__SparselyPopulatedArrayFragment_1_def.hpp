...
/// @brief Field _elements, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<T>  _elements;
...
constexpr ::ArrayW<T> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<T>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<T>  value) ;
