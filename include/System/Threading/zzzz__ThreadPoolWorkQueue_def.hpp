...
/// @brief Method LocalFindAndPop, addr 0x18177c4b0, size 0x280, virtual false, abstract: false, final false
inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem*  obj) ;

/// @brief Method LocalPop, addr 0x18177c730, size 0x260, virtual false, abstract: false, final false
inline bool LocalPop(::by_ref<::System::Threading::IThreadPoolWorkItem*>  obj) ;

/// @brief Method LocalPush, addr 0x18177c990, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method TrySteal, addr 0x18177cf20, size 0x20, virtual false, abstract: false, final false
inline bool TrySteal(::by_ref<::System::Threading::IThreadPoolWorkItem*>  obj, ::by_ref<bool>  missedSteal) ;

/// @brief Method TrySteal, addr 0x18177cd40, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18177cf40, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CompareExchangeIndexes, addr 0x18176e7a0, size 0x60, virtual false, abstract: false, final false
inline bool CompareExchangeIndexes(::by_ref<int32_t>  prevUpper, int32_t  newUpper, ::by_ref<int32_t>  prevLower, int32_t  newLower) ;

/// @brief Method GetIndexes, addr 0x18176e800, size 0x20, virtual false, abstract: false, final false
inline void GetIndexes(::by_ref<int32_t>  upper, ::by_ref<int32_t>  lower) ;

/// @brief Method IsUsedUp, addr 0x18176e820, size 0x30, virtual false, abstract: false, final false
inline bool IsUsedUp() ;

static inline ::System::Threading::ThreadPoolWorkQueue_QueueSegment* New_ctor() ;

/// @brief Method TryDequeue, addr 0x18176e850, size 0x110, virtual false, abstract: false, final false
inline bool TryDequeue(::by_ref<::System::Threading::IThreadPoolWorkItem*>  node) ;

/// @brief Method TryEnqueue, addr 0x18176e960, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18176ea00, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dequeue, addr 0x181778650, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x181778890, size 0x510, virtual false, abstract: false, final false
static inline bool Dispatch() ;

/// @brief Method Enqueue, addr 0x181778da0, size 0x170, virtual false, abstract: false, final false
inline void Enqueue(::System::Threading::IThreadPoolWorkItem*  callback, bool  forceGlobal) ;

/// @brief Method EnsureCurrentThreadHasQueue, addr 0x181778f10, size 0x1b0, virtual false, abstract: false, final false
inline ::System::Threading::ThreadPoolWorkQueueThreadLocals* EnsureCurrentThreadHasQueue() ;

/// @brief Method EnsureThreadRequested, addr 0x1817790c0, size 0x80, virtual false, abstract: false, final false
inline void EnsureThreadRequested() ;

/// @brief Method LocalFindAndPop, addr 0x181779140, size 0x40, virtual false, abstract: false, final false
inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem*  callback) ;

/// @brief Method MarkThreadRequestSatisfied, addr 0x181779180, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181779230, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
