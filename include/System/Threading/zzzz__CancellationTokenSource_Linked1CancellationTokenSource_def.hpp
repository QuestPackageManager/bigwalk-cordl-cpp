...
// Write type traits
MARK_REF_T(::GlobalNamespace::CancellationTokenSource_Linked1CancellationTokenSource*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CancellationTokenSource_Linked1CancellationTokenSource*, "System.Threading", "CancellationTokenSource/Linked1CancellationTokenSource");
...
/// @brief Method Dispose, addr 0x181761de0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181761e20, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CancellationTokenSource_Linked1CancellationTokenSource) == 0x58, "Size mismatch!");
