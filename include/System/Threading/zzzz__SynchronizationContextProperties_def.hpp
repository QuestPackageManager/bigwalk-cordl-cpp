...
DEFINE_IL2CPP_CLASS(::System::Threading::SynchronizationContextProperties, "System.Threading", "SynchronizationContextProperties");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
static_assert(offsetof(::System::Threading::SynchronizationContextProperties, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::SynchronizationContextProperties) == 0x4, "Size mismatch!");
