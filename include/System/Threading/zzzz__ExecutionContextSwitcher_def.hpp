...
DEFINE_IL2CPP_CLASS(::System::Threading::ExecutionContextSwitcher, "System.Threading", "ExecutionContextSwitcher");
...
public:
// Declarations
/// @brief Method Undo, addr 0x181760d30, size 0xb0, virtual false, abstract: false, final false
inline void Undo() ;

/// @brief Method UndoNoThrow, addr 0x181760ca0, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::ExecutionContextSwitcher) == 0x20, "Size mismatch!");
