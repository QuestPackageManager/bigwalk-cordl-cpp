...
DEFINE_IL2CPP_CLASS(::System::Threading::ReaderWriterLockSlim_TimeoutTracker, "System.Threading", "ReaderWriterLockSlim/TimeoutTracker");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
/// @brief Method .ctor, addr 0x181b394e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  millisecondsTimeout) ;

/// @brief Method get_IsExpired, addr 0x181b39540, size 0x60, virtual false, abstract: false, final false
inline bool get_IsExpired() ;

/// @brief Method get_RemainingMilliseconds, addr 0x181b395a0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::ReaderWriterLockSlim_TimeoutTracker) == 0x8, "Size mismatch!");
...
/// @brief Method ClearUpgraderWaiting, addr 0x181b36d60, size 0x10, virtual false, abstract: false, final false
inline void ClearUpgraderWaiting() ;

/// @brief Method ClearWriterAcquired, addr 0x181b36d70, size 0x10, virtual false, abstract: false, final false
inline void ClearWriterAcquired() ;

/// @brief Method ClearWritersWaiting, addr 0x181b36d80, size 0x10, virtual false, abstract: false, final false
inline void ClearWritersWaiting() ;

/// @brief Method Dispose, addr 0x181b37020, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181b36d90, size 0x290, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnterMyLock, addr 0x181b370c0, size 0x40, virtual false, abstract: false, final false
inline void EnterMyLock() ;

/// @brief Method EnterMyLockSpin, addr 0x181b37030, size 0x90, virtual false, abstract: false, final false
inline void EnterMyLockSpin() ;

/// @brief Method EnterReadLock, addr 0x181b37100, size 0x20, virtual false, abstract: false, final false
inline void EnterReadLock() ;

/// @brief Method EnterUpgradeableReadLock, addr 0x181b37120, size 0x20, virtual false, abstract: false, final false
inline void EnterUpgradeableReadLock() ;

/// @brief Method EnterWriteLock, addr 0x181b37140, size 0x20, virtual false, abstract: false, final false
inline void EnterWriteLock() ;

/// @brief Method ExitAndWakeUpAppropriateReadWaiters, addr 0x181b37160, size 0x70, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateReadWaiters() ;

/// @brief Method ExitAndWakeUpAppropriateWaiters, addr 0x181b37230, size 0x70, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateWaiters() ;

/// @brief Method ExitAndWakeUpAppropriateWaitersPreferringWriters, addr 0x181b371d0, size 0x60, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateWaitersPreferringWriters() ;

/// @brief Method ExitMyLock, addr 0x181b372a0, size 0x10, virtual false, abstract: false, final false
inline void ExitMyLock() ;

/// @brief Method ExitReadLock, addr 0x181b372b0, size 0x190, virtual false, abstract: false, final false
inline void ExitReadLock() ;

/// @brief Method ExitUpgradeableReadLock, addr 0x181b37440, size 0x2a0, virtual false, abstract: false, final false
inline void ExitUpgradeableReadLock() ;

/// @brief Method ExitWriteLock, addr 0x181b376e0, size 0x260, virtual false, abstract: false, final false
inline void ExitWriteLock() ;

/// @brief Method GetNumReaders, addr 0x181b37940, size 0x10, virtual false, abstract: false, final false
inline uint32_t GetNumReaders() ;

/// @brief Method GetThreadRWCount, addr 0x181b347a0, size 0xf0, virtual false, abstract: false, final false
inline ::System::Threading::ReaderWriterCount* GetThreadRWCount(bool  dontAllocate) ;

/// @brief Method InitializeThreadCounts, addr 0x181b37950, size 0x10, virtual false, abstract: false, final false
inline void InitializeThreadCounts() ;

/// @brief Method IsRWEntryEmpty, addr 0x181b37960, size 0x20, virtual false, abstract: false, final false
static inline bool IsRWEntryEmpty(::System::Threading::ReaderWriterCount*  rwc) ;

/// @brief Method IsRwHashEntryChanged, addr 0x181b37980, size 0x10, virtual false, abstract: false, final false
inline bool IsRwHashEntryChanged(::System::Threading::ReaderWriterCount*  lrwc) ;

/// @brief Method IsWriterAcquired, addr 0x181b37990, size 0x10, virtual false, abstract: false, final false
inline bool IsWriterAcquired() ;

/// @brief Method LazyCreateEvent, addr 0x181b379a0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetUpgraderWaiting, addr 0x181b37a70, size 0x10, virtual false, abstract: false, final false
inline void SetUpgraderWaiting() ;

/// @brief Method SetWriterAcquired, addr 0x181b37a80, size 0x10, virtual false, abstract: false, final false
inline void SetWriterAcquired() ;

/// @brief Method SetWritersWaiting, addr 0x181b37a90, size 0x10, virtual false, abstract: false, final false
inline void SetWritersWaiting() ;

/// @brief Method SpinWait, addr 0x181b37aa0, size 0x50, virtual false, abstract: false, final false
static inline void SpinWait(int32_t  SpinCount) ;

/// @brief Method TryEnterReadLock, addr 0x181b381c0, size 0x60, virtual false, abstract: false, final false
inline bool TryEnterReadLock(int32_t  millisecondsTimeout) ;

/// @brief Method TryEnterReadLock, addr 0x181b38220, size 0x10, virtual false, abstract: false, final false
inline bool TryEnterReadLock(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterReadLockCore, addr 0x181b37af0, size 0x6d0, virtual false, abstract: false, final false
inline bool TryEnterReadLockCore(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterUpgradeableReadLock, addr 0x181b38770, size 0x60, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLock(int32_t  millisecondsTimeout) ;

/// @brief Method TryEnterUpgradeableReadLock, addr 0x181b38760, size 0x10, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLock(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterUpgradeableReadLockCore, addr 0x181b38230, size 0x530, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLockCore(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterWriteLock, addr 0x181b38e90, size 0x60, virtual false, abstract: false, final false
inline bool TryEnterWriteLock(int32_t  millisecondsTimeout) ;

/// @brief Method TryEnterWriteLock, addr 0x181b38e80, size 0x10, virtual false, abstract: false, final false
inline bool TryEnterWriteLock(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterWriteLockCore, addr 0x181b387d0, size 0x6b0, virtual false, abstract: false, final false
inline bool TryEnterWriteLockCore(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method WaitOnEvent, addr 0x181b38ef0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b39060, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181b39020, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_IsReadLockHeld, addr 0x181b390a0, size 0x50, virtual false, abstract: false, final false
inline bool get_IsReadLockHeld() ;

/// @brief Method get_IsUpgradeableReadLockHeld, addr 0x181b390f0, size 0x70, virtual false, abstract: false, final false
inline bool get_IsUpgradeableReadLockHeld() ;

/// @brief Method get_IsWriteLockHeld, addr 0x181b39160, size 0x70, virtual false, abstract: false, final false
inline bool get_IsWriteLockHeld() ;

/// @brief Method get_RecursiveReadCount, addr 0x181b391d0, size 0x50, virtual false, abstract: false, final false
inline int32_t get_RecursiveReadCount() ;

/// @brief Method get_RecursiveUpgradeCount, addr 0x181b39220, size 0x90, virtual false, abstract: false, final false
inline int32_t get_RecursiveUpgradeCount() ;

/// @brief Method get_RecursiveWriteCount, addr 0x181b392b0, size 0x90, virtual false, abstract: false, final false
inline int32_t get_RecursiveWriteCount() ;

/// @brief Method get_WaitingReadCount, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_WaitingReadCount() ;

/// @brief Method get_WaitingUpgradeCount, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_WaitingUpgradeCount() ;

/// @brief Method get_WaitingWriteCount, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static constexpr uint32_t  MAX_READER{static_cast<uint32_t>(0xffffffeu)};
...
static constexpr uint32_t  READER_MASK{static_cast<uint32_t>(0xfffffffu)};

/// @brief Field WAITING_UPGRADER offset 0xffffffff size 0x4
static constexpr uint32_t  WAITING_UPGRADER{static_cast<uint32_t>(0x20000000u)};

/// @brief Field WAITING_WRITERS offset 0xffffffff size 0x4
static constexpr uint32_t  WAITING_WRITERS{static_cast<uint32_t>(0x40000000u)};

/// @brief Field WRITER_HELD offset 0xffffffff size 0x4
static constexpr uint32_t  WRITER_HELD{static_cast<uint32_t>(0x80000000u)};
