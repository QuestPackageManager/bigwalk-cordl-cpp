...
// Write type traits
MARK_REF_T(::System::Threading::_ThreadPoolWaitCallback*);
DEFINE_IL2CPP_CLASS(::System::Threading::_ThreadPoolWaitCallback*, "System.Threading", "_ThreadPoolWaitCallback");
...
public:
// Declarations
/// @brief Method PerformWaitCallback, addr 0x18177cfa0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::_ThreadPoolWaitCallback) == 0x10, "Size mismatch!");
