...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::ITaskCompletionAction*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::ITaskCompletionAction*, "System.Threading.Tasks", "ITaskCompletionAction");
// Dependencies 
namespace System::Threading::Tasks {
// Is value type: false
