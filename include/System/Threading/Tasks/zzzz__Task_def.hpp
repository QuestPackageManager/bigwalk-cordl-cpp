...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::Task*);
MARK_REF_T(::System::Threading::Tasks::Task_ContingentProperties*);
MARK_REF_T(::System::Threading::Tasks::Task_SetOnInvokeMres*);
MARK_REF_T(::System::Threading::Tasks::Task___c*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::Task*, "System.Threading.Tasks", "Task");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::Task_ContingentProperties*, "System.Threading.Tasks", "Task/ContingentProperties");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::Task_SetOnInvokeMres*, "System.Threading.Tasks", "Task/SetOnInvokeMres");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::Task___c*, "System.Threading.Tasks", "Task/<>c");
...
/// @brief Field m_exceptionalChildren, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_exceptionalChildren, put=__cordl_internal_set_m_exceptionalChildren)) ::System::Collections::Generic::LowLevelListWithIList_1<::System::Threading::Tasks::Task*>*  m_exceptionalChildren;
...
/// @brief Method SetCompleted, addr 0x18176b700, size 0x20, virtual false, abstract: false, final false
inline void SetCompleted() ;

/// @brief Method UnregisterCancellationCallback, addr 0x18176b720, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18176b7c0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Threading::Tasks::Task_ContingentProperties) == 0x48, "Size mismatch!");
...
/// @brief Method Invoke, addr 0x181770300, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181770310, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_InvokeMayRunArbitraryCode, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method <Delay>b__247_0, addr 0x18177ab20, size 0x40, virtual false, abstract: false, final false
inline void _Delay_b__247_0(::System::Object*  state) ;

/// @brief Method <Delay>b__247_1, addr 0x18177ab20, size 0x40, virtual false, abstract: false, final false
inline void _Delay_b__247_1(::System::Object*  state) ;

/// @brief Method <.cctor>b__271_0, addr 0x18177ac70, size 0x20, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_ContingentProperties* __cctor_b__271_0() ;

/// @brief Method <.cctor>b__271_1, addr 0x18177ac90, size 0x10, virtual false, abstract: false, final false
inline bool __cctor_b__271_1(::System::Threading::Tasks::Task*  t) ;

/// @brief Method <.cctor>b__271_2, addr 0x180973cb0, size 0x480, virtual false, abstract: false, final false
...
/// @brief Field m_contingentProperties, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_contingentProperties, put=__cordl_internal_set_m_contingentProperties)) ::System::Threading::Tasks::Task_ContingentProperties*  m_contingentProperties;
...
/// @brief Field s_IsExceptionObservedByParentPredicate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_IsExceptionObservedByParentPredicate, put=setStaticF_s_IsExceptionObservedByParentPredicate)) ::System::Predicate_1<::System::Threading::Tasks::Task*>*  s_IsExceptionObservedByParentPredicate;

/// @brief Field s_IsTaskContinuationNullPredicate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_IsTaskContinuationNullPredicate, put=setStaticF_s_IsTaskContinuationNullPredicate)) ::System::Predicate_1<::System::Object*>*  s_IsTaskContinuationNullPredicate;
...
/// @brief Field s_createContingentProperties, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_createContingentProperties, put=setStaticF_s_createContingentProperties)) ::System::Func_1<::System::Threading::Tasks::Task_ContingentProperties*>*  s_createContingentProperties;

/// @brief Field s_currentActiveTasks, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_currentActiveTasks, put=setStaticF_s_currentActiveTasks)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Threading::Tasks::Task*>*  s_currentActiveTasks;
...
/// @brief Method AddCompletionAction, addr 0x181772300, size 0x40, virtual false, abstract: false, final false
inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction*  action) ;

/// @brief Method AddCompletionAction, addr 0x181772340, size 0x40, virtual false, abstract: false, final false
inline void AddCompletionAction(::System::Threading::Tasks::ITaskCompletionAction*  action, bool  addBeforeOthers) ;

/// @brief Method AddException, addr 0x181772580, size 0x10, virtual false, abstract: false, final false
inline void AddException(::System::Object*  exceptionObject) ;

/// @brief Method AddException, addr 0x181772380, size 0x200, virtual false, abstract: false, final false
inline void AddException(::System::Object*  exceptionObject, bool  representsCancellation) ;

/// @brief Method AddExceptionsFromChildren, addr 0x181772590, size 0x280, virtual false, abstract: false, final false
inline void AddExceptionsFromChildren() ;

/// @brief Method AddNewChild, addr 0x181772810, size 0x80, virtual false, abstract: false, final false
inline void AddNewChild() ;

/// @brief Method AddTaskContinuation, addr 0x181772af0, size 0xa0, virtual false, abstract: false, final false
inline bool AddTaskContinuation(::System::Object*  tc, bool  addBeforeOthers) ;

/// @brief Method AddTaskContinuationComplex, addr 0x181772890, size 0x260, virtual false, abstract: false, final false
inline bool AddTaskContinuationComplex(::System::Object*  tc, bool  addBeforeOthers) ;

/// @brief Method AddToActiveTasks, addr 0x181772b90, size 0x150, virtual false, abstract: false, final false
static inline bool AddToActiveTasks(::System::Threading::Tasks::Task*  task) ;

/// @brief Method AssignCancellationToken, addr 0x181772ce0, size 0x210, virtual false, abstract: false, final false
inline void AssignCancellationToken(::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::Task*  antecedent, ::System::Threading::Tasks::TaskContinuation*  continuation) ;

/// @brief Method AtomicStateUpdate, addr 0x181772f80, size 0x80, virtual false, abstract: false, final false
inline bool AtomicStateUpdate(int32_t  newBits, int32_t  illegalBits) ;

/// @brief Method AtomicStateUpdate, addr 0x181772ef0, size 0x90, virtual false, abstract: false, final false
inline bool AtomicStateUpdate(int32_t  newBits, int32_t  illegalBits, ::by_ref<int32_t>  oldFlags) ;

/// @brief Method CancellationCleanupLogic, addr 0x181773000, size 0xd0, virtual false, abstract: false, final false
inline void CancellationCleanupLogic() ;

/// @brief Method ConfigureAwait, addr 0x180e39c00, size 0x12d0, virtual false, abstract: false, final false
inline ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable ConfigureAwait(bool  continueOnCapturedContext) ;

/// @brief Method ContinueWith, addr 0x181773320, size 0x130, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>*  continuationAction) ;

/// @brief Method ContinueWith, addr 0x181773450, size 0x1a0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_1<::System::Threading::Tasks::Task*>*  continuationAction, ::System::Threading::Tasks::TaskScheduler*  scheduler, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskContinuationOptions  continuationOptions) ;

/// @brief Method ContinueWith, addr 0x1817732f0, size 0x30, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*,::System::Object*>*  continuationAction, ::System::Object*  state, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskContinuationOptions  continuationOptions, ::System::Threading::Tasks::TaskScheduler*  scheduler) ;

/// @brief Method ContinueWith, addr 0x181773210, size 0xe0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*,::System::Object*>*  continuationAction, ::System::Object*  state, ::System::Threading::Tasks::TaskScheduler*  scheduler) ;

/// @brief Method ContinueWith, addr 0x1817735f0, size 0x1a0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ContinueWith(::System::Action_2<::System::Threading::Tasks::Task*,::System::Object*>*  continuationAction, ::System::Object*  state, ::System::Threading::Tasks::TaskScheduler*  scheduler, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskContinuationOptions  continuationOptions) ;

/// @brief Method ContinueWithCore, addr 0x1817730d0, size 0x140, virtual false, abstract: false, final false
inline void ContinueWithCore(::System::Threading::Tasks::Task*  continuationTask, ::System::Threading::Tasks::TaskScheduler*  scheduler, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskContinuationOptions  options) ;

/// @brief Method CreationOptionsFromContinuationOptions, addr 0x181773790, size 0x90, virtual false, abstract: false, final false
static inline void CreationOptionsFromContinuationOptions(::System::Threading::Tasks::TaskContinuationOptions  continuationOptions, ::by_ref<::System::Threading::Tasks::TaskCreationOptions>  creationOptions, ::by_ref<::System::Threading::Tasks::InternalTaskOptions>  internalOptions) ;

/// @brief Method Delay, addr 0x181773890, size 0x50, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* Delay(::System::TimeSpan  delay) ;

/// @brief Method Delay, addr 0x181773820, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Delay, addr 0x181773880, size 0x10, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* Delay(int32_t  millisecondsDelay) ;

/// @brief Method Delay, addr 0x1817738e0, size 0x4b0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181773e30, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181773d90, size 0xa0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method DisregardChild, addr 0x181773e60, size 0x60, virtual false, abstract: false, final false
inline void DisregardChild() ;

/// @brief Method EnsureContingentPropertiesInitialized, addr 0x181773f60, size 0xb0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_ContingentProperties* EnsureContingentPropertiesInitialized(bool  needsProtection) ;

/// @brief Method EnsureContingentPropertiesInitializedCore, addr 0x181773ec0, size 0xa0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_ContingentProperties* EnsureContingentPropertiesInitializedCore(bool  needsProtection) ;

/// @brief Method Execute, addr 0x181774310, size 0x40, virtual false, abstract: false, final false
inline void Execute() ;

/// @brief Method ExecuteEntry, addr 0x181774010, size 0x140, virtual false, abstract: false, final false
inline bool ExecuteEntry(bool  bPreventDoubleExecution) ;

/// @brief Method ExecuteWithThreadLocal, addr 0x181774150, size 0x1c0, virtual false, abstract: false, final false
inline void ExecuteWithThreadLocal(::by_ref<::System::Threading::Tasks::Task*>  currentTaskSlot) ;

/// @brief Method ExecutionContextCallback, addr 0x181774350, size 0x50, virtual false, abstract: false, final false
static inline void ExecutionContextCallback(::System::Object*  obj) ;

/// @brief Method Finish, addr 0x1817749f0, size 0x150, virtual false, abstract: false, final false
inline void Finish(bool  bUserDelegateExecuted) ;

/// @brief Method FinishContinuations, addr 0x1817743a0, size 0x4b0, virtual false, abstract: false, final false
inline void FinishContinuations() ;

/// @brief Method FinishStageThree, addr 0x181774850, size 0x60, virtual false, abstract: false, final false
inline void FinishStageThree() ;

/// @brief Method FinishStageTwo, addr 0x1817748b0, size 0x140, virtual false, abstract: false, final false
inline void FinishStageTwo() ;

/// @brief Method FromCanceled, addr 0x181774b40, size 0x10, virtual false, abstract: false, final false
...
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* FromCanceled(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FromCancellation, addr 0x181774b50, size 0xb0, virtual false, abstract: false, final false
...
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* FromCancellation(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FromCancellation, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* FromCancellation(::System::OperationCanceledException*  exception) ;

/// @brief Method FromException, addr 0x181774c00, size 0x10, virtual false, abstract: false, final false
...
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* FromException(::System::Exception*  exception) ;

/// @brief Method FromResult, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* FromResult(TResult  result) ;

/// @brief Method GetAwaiter, addr 0x180e3aed0, size 0x3780, virtual false, abstract: false, final false
inline ::System::Runtime::CompilerServices::TaskAwaiter GetAwaiter() ;

/// @brief Method GetCancellationExceptionDispatchInfo, addr 0x181774c10, size 0x20, virtual false, abstract: false, final false
inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo() ;

/// @brief Method GetExceptionDispatchInfos, addr 0x181774c30, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetExceptions, addr 0x181774d20, size 0x130, virtual false, abstract: false, final false
inline ::System::AggregateException* GetExceptions(bool  includeTaskCanceledExceptions) ;

/// @brief Method HandleException, addr 0x181774e50, size 0xc0, virtual false, abstract: false, final false
inline void HandleException(::System::Exception*  unhandledException) ;

/// @brief Method InnerInvoke, addr 0x181774f10, size 0x70, virtual true, abstract: false, final false
inline void InnerInvoke() ;

/// @brief Method InternalCancel, addr 0x181774f80, size 0x220, virtual false, abstract: false, final false
inline bool InternalCancel(bool  bCancelNonExecutingOnly) ;

/// @brief Method InternalCurrentIfAttached, addr 0x1817751a0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method InternalStartNew, addr 0x1817751d0, size 0x100, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* InternalStartNew(::System::Threading::Tasks::Task*  creatingTask, ::System::Delegate*  action, ::System::Object*  state, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskScheduler*  scheduler, ::System::Threading::Tasks::TaskCreationOptions  options, ::System::Threading::Tasks::InternalTaskOptions  internalOptions) ;

/// @brief Method InternalWait, addr 0x1817752d0, size 0x300, virtual false, abstract: false, final false
inline bool InternalWait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method IsCompletedMethod, addr 0x1817755d0, size 0x10, virtual false, abstract: false, final false
static inline bool IsCompletedMethod(int32_t  flags) ;

/// @brief Method LogFinishCompletionNotification, addr 0x180631430, size 0xa670, virtual false, abstract: false, final false
...
/// @brief Method MarkStarted, addr 0x1817755e0, size 0x70, virtual false, abstract: false, final false
...
static inline ::System::Threading::Tasks::Task* New_ctor(::System::Delegate*  action, ::System::Object*  state, ::System::Threading::Tasks::Task*  parent, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskCreationOptions  creationOptions, ::System::Threading::Tasks::InternalTaskOptions  internalOptions, ::System::Threading::Tasks::TaskScheduler*  scheduler) ;
...
/// @brief Method NotifyDebuggerOfWaitCompletion, addr 0x1817756a0, size 0x30, virtual false, abstract: false, final false
inline void NotifyDebuggerOfWaitCompletion() ;

/// @brief Method NotifyDebuggerOfWaitCompletionIfNecessary, addr 0x181775650, size 0x50, virtual false, abstract: false, final false
inline bool NotifyDebuggerOfWaitCompletionIfNecessary() ;

/// @brief Method OptionsMethod, addr 0x1805a9e00, size 0x10, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskCreationOptions OptionsMethod(int32_t  flags) ;

/// @brief Method ProcessChildCompletion, addr 0x1817756d0, size 0x170, virtual false, abstract: false, final false
inline void ProcessChildCompletion(::System::Threading::Tasks::Task*  childTask) ;

/// @brief Method RecordInternalCancellationRequest, addr 0x1817759a0, size 0x60, virtual false, abstract: false, final false
inline void RecordInternalCancellationRequest() ;

/// @brief Method RecordInternalCancellationRequest, addr 0x181775900, size 0xa0, virtual false, abstract: false, final false
inline void RecordInternalCancellationRequest(::System::Threading::CancellationToken  tokenToRecord) ;

/// @brief Method RecordInternalCancellationRequest, addr 0x181775840, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method RemoveContinuation, addr 0x181775a00, size 0x200, virtual false, abstract: false, final false
inline void RemoveContinuation(::System::Object*  continuationObject) ;

/// @brief Method RemoveFromActiveTasks, addr 0x181775c00, size 0xf0, virtual false, abstract: false, final false
static inline void RemoveFromActiveTasks(int32_t  taskId) ;

/// @brief Method Run, addr 0x181775cf0, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* Run(::System::Action*  action) ;

/// @brief Method Run, addr 0x181775dc0, size 0x120, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* Run(::System::Func_1<::System::Threading::Tasks::Task*>*  function) ;

/// @brief Method Run, addr 0x181775ee0, size 0x110, virtual false, abstract: false, final false
...
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* Run(::System::Func_1<::System::Threading::Tasks::Task_1<TResult>*>*  function) ;
...
/// @brief Method Run, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TResult>
static inline ::System::Threading::Tasks::Task_1<TResult>* Run(::System::Func_1<TResult>*  function) ;

/// @brief Method ScheduleAndStart, addr 0x181775ff0, size 0x120, virtual false, abstract: false, final false
inline void ScheduleAndStart(bool  needsProtection) ;

/// @brief Method SetCancellationAcknowledged, addr 0x181776110, size 0x10, virtual false, abstract: false, final false
inline void SetCancellationAcknowledged() ;

/// @brief Method SetContinuationForAwait, addr 0x181776120, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method SetNotificationForWaitCompletion, addr 0x181776310, size 0xc0, virtual false, abstract: false, final false
inline void SetNotificationForWaitCompletion(bool  enabled) ;

/// @brief Method SpinThenBlockingWait, addr 0x1817763d0, size 0x260, virtual false, abstract: false, final false
inline bool SpinThenBlockingWait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method SpinWait, addr 0x181776630, size 0xa0, virtual false, abstract: false, final false
inline bool SpinWait(int32_t  millisecondsTimeout) ;

/// @brief Method System.IAsyncResult.get_AsyncWaitHandle, addr 0x1817766d0, size 0x140, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle() ;

/// @brief Method System.IAsyncResult.get_CompletedSynchronously, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
inline bool System_IAsyncResult_get_CompletedSynchronously() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x181776810, size 0x10, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method TaskCancelCallback, addr 0x181776820, size 0xc0, virtual false, abstract: false, final false
static inline void TaskCancelCallback(::System::Object*  o) ;

/// @brief Method TaskConstructorCore, addr 0x1817768e0, size 0x1c0, virtual false, abstract: false, final false
inline void TaskConstructorCore(::System::Delegate*  action, ::System::Object*  state, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskCreationOptions  creationOptions, ::System::Threading::Tasks::InternalTaskOptions  internalOptions, ::System::Threading::Tasks::TaskScheduler*  scheduler) ;

/// @brief Method ThrowIfExceptional, addr 0x181776aa0, size 0x40, virtual false, abstract: false, final false
inline void ThrowIfExceptional(bool  includeTaskCanceledExceptions) ;

/// @brief Method TrySetCanceled, addr 0x181776ae0, size 0x10, virtual false, abstract: false, final false
inline bool TrySetCanceled(::System::Threading::CancellationToken  tokenToRecord) ;

/// @brief Method TrySetCanceled, addr 0x181776af0, size 0x120, virtual false, abstract: false, final false
inline bool TrySetCanceled(::System::Threading::CancellationToken  tokenToRecord, ::System::Object*  cancellationException) ;

/// @brief Method TrySetException, addr 0x181776c10, size 0xf0, virtual false, abstract: false, final false
inline bool TrySetException(::System::Object*  exceptionObject) ;

/// @brief Method UpdateExceptionObservedStatus, addr 0x181776d00, size 0x50, virtual false, abstract: false, final false
inline void UpdateExceptionObservedStatus() ;

/// @brief Method Wait, addr 0x181776e00, size 0xd0, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Wait, addr 0x181776d50, size 0xb0, virtual false, abstract: false, final false
inline void Wait() ;

/// @brief Method WhenAny, addr 0x181777030, size 0x100, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task*>* WhenAny(::ArrayW<::System::Threading::Tasks::Task*>  tasks) ;

/// @brief Method WhenAny, addr 0x181776ed0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method WrappedTryRunInline, addr 0x181777130, size 0x90, virtual false, abstract: false, final false
inline bool WrappedTryRunInline() ;

/// @brief Method Yield, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817775f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181777690, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  action, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method .ctor, addr 0x181777550, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Delegate*  action, ::System::Object*  state, ::System::Threading::Tasks::Task*  parent, ::System::Threading::CancellationToken  cancellationToken, ::System::Threading::Tasks::TaskCreationOptions  creationOptions, ::System::Threading::Tasks::InternalTaskOptions  internalOptions, ::System::Threading::Tasks::TaskScheduler*  scheduler) ;

/// @brief Method .ctor, addr 0x1817774c0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181777600, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncState, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_CancellationToken, addr 0x1817777b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::CancellationToken get_CancellationToken() ;

/// @brief Method get_CapturedContext, addr 0x1817777c0, size 0x50, virtual false, abstract: false, final false
inline ::System::Threading::ExecutionContext* get_CapturedContext() ;

/// @brief Method get_CompletedEvent, addr 0x181777810, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_CreationOptions, addr 0x1817778f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::TaskCreationOptions get_CreationOptions() ;

/// @brief Method get_CurrentStackGuard, addr 0x181777900, size 0x70, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::StackGuard* get_CurrentStackGuard() ;

/// @brief Method get_Exception, addr 0x1817779a0, size 0x20, virtual false, abstract: false, final false
inline ::System::AggregateException* get_Exception() ;

/// @brief Method get_ExceptionRecorded, addr 0x181777970, size 0x30, virtual false, abstract: false, final false
inline bool get_ExceptionRecorded() ;

/// @brief Method get_ExecutingTaskScheduler, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::TaskScheduler* get_ExecutingTaskScheduler() ;

/// @brief Method get_Factory, addr 0x1817779c0, size 0x40, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskFactory* get_Factory() ;

/// @brief Method get_Id, addr 0x181777a00, size 0x70, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_InternalCurrent, addr 0x1816615e0, size 0x20, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* get_InternalCurrent() ;

/// @brief Method get_IsCanceled, addr 0x181777a70, size 0x20, virtual false, abstract: false, final false
inline bool get_IsCanceled() ;

/// @brief Method get_IsCancellationAcknowledged, addr 0x181777a90, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCancellationAcknowledged() ;

/// @brief Method get_IsCancellationRequested, addr 0x181777aa0, size 0x30, virtual false, abstract: false, final false
inline bool get_IsCancellationRequested() ;

/// @brief Method get_IsCompleted, addr 0x181777af0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsCompleted() ;

/// @brief Method get_IsCompletedSuccessfully, addr 0x181777ad0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsCompletedSuccessfully() ;

/// @brief Method get_IsDelegateInvoked, addr 0x181777b00, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDelegateInvoked() ;

/// @brief Method get_IsExceptionObservedByParent, addr 0x181777b10, size 0x10, virtual false, abstract: false, final false
inline bool get_IsExceptionObservedByParent() ;

/// @brief Method get_IsFaulted, addr 0x181777b20, size 0x10, virtual false, abstract: false, final false
inline bool get_IsFaulted() ;

/// @brief Method get_IsWaitNotificationEnabled, addr 0x181777b50, size 0x10, virtual false, abstract: false, final false
inline bool get_IsWaitNotificationEnabled() ;

/// @brief Method get_IsWaitNotificationEnabledOrNotRanToCompletion, addr 0x181777b30, size 0x20, virtual false, abstract: false, final false
inline bool get_IsWaitNotificationEnabledOrNotRanToCompletion() ;

/// @brief Method get_Options, addr 0x181777b60, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::TaskCreationOptions get_Options() ;

/// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0x181777b50, size 0x10, virtual true, abstract: false, final false
inline bool get_ShouldNotifyDebuggerOfWaitCompletion() ;

/// @brief Method get_Status, addr 0x181777b70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_CapturedContext, addr 0x181777bd0, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::Task) == 0x50, "Size mismatch!");
