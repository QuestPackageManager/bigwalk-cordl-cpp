...
// Write type traits
MARK_REF_T(::GlobalNamespace::Task_DelayPromise*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::Task_DelayPromise*, "System.Threading.Tasks", "Task/DelayPromise");
...
/// @brief Method Complete, addr 0x18176d5c0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18176d6a0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::Task_DelayPromise) == 0x80, "Size mismatch!");
