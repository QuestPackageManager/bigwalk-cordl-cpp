...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::ContinuationTaskFromTask*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::ContinuationTaskFromTask*, "System.Threading.Tasks", "ContinuationTaskFromTask");
...
/// @brief Method InnerInvoke, addr 0x18176b7d0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18176b890, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::ContinuationTaskFromTask) == 0x58, "Size mismatch!");
