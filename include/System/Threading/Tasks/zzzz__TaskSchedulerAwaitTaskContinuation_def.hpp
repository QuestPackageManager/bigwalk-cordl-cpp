...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation*);
...
/// @brief Method <Run>b__2_0, addr 0x18177aba0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation___c) == 0x10, "Size mismatch!");
...
/// @brief Method Run, addr 0x1817716f0, size 0x340, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Threading::Tasks::TaskSchedulerAwaitTaskContinuation) == 0x28, "Size mismatch!");
