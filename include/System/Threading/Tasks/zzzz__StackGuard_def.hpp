...
/// @brief Method EndInliningScope, addr 0x181770320, size 0x10, virtual false, abstract: false, final false
inline void EndInliningScope() ;

static inline ::System::Threading::Tasks::StackGuard* New_ctor() ;

/// @brief Method TryBeginInliningScope, addr 0x181770330, size 0x30, virtual false, abstract: false, final false
