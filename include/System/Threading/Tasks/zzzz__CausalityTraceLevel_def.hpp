...
/// @brief Field Required value: I32(0)
...
static_assert(offsetof(::System::Threading::Tasks::CausalityTraceLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::CausalityTraceLevel) == 0x4, "Size mismatch!");
