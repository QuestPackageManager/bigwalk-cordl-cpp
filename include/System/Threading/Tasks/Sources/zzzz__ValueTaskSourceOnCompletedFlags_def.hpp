...
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::Sources::ValueTaskSourceOnCompletedFlags, "System.Threading.Tasks.Sources", "ValueTaskSourceOnCompletedFlags");
// Dependencies 
namespace System::Threading::Tasks::Sources {
// Is value type: true
...
static_assert(offsetof(::System::Threading::Tasks::Sources::ValueTaskSourceOnCompletedFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::Sources::ValueTaskSourceOnCompletedFlags) == 0x4, "Size mismatch!");
