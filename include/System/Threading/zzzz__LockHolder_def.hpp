...
DEFINE_IL2CPP_CLASS(::System::Threading::LockHolder, "System.Threading", "LockHolder");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
/// @brief Method Dispose, addr 0x181758ac0, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Hold, addr 0x1817622b0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::LockHolder) == 0x8, "Size mismatch!");
