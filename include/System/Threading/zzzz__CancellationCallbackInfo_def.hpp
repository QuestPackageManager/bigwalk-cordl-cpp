...
// Write type traits
MARK_REF_T(::System::Threading::CancellationCallbackInfo*);
DEFINE_IL2CPP_CLASS(::System::Threading::CancellationCallbackInfo*, "System.Threading", "CancellationCallbackInfo");
...
/// @brief Method ExecuteCallback, addr 0x181759320, size 0x250, virtual false, abstract: false, final false
inline void ExecuteCallback() ;

/// @brief Method ExecutionContextCallback, addr 0x181759570, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::CancellationCallbackInfo) == 0x30, "Size mismatch!");
