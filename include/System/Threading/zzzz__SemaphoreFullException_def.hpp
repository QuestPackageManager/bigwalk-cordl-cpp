...
// Write type traits
MARK_REF_T(::System::Threading::SemaphoreFullException*);
DEFINE_IL2CPP_CLASS(::System::Threading::SemaphoreFullException*, "System.Threading", "SemaphoreFullException");
...
/// @brief Method .ctor, addr 0x181763ec0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Threading::SemaphoreFullException) == 0x90, "Size mismatch!");
