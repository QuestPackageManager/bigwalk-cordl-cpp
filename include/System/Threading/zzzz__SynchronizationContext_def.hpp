...
/// @brief Method CreateCopy, addr 0x181766260, size 0x10, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method GetThreadLocalContext, addr 0x181766270, size 0x10, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* GetThreadLocalContext() ;

/// @brief Method IsWaitNotificationRequired, addr 0x181766280, size 0x10, virtual false, abstract: false, final false
inline bool IsWaitNotificationRequired() ;

static inline ::System::Threading::SynchronizationContext* New_ctor() ;

/// @brief Method OperationCompleted, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x181766290, size 0x60, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  d, ::System::Object*  state) ;

/// @brief Method Send, addr 0x1817662f0, size 0x20, virtual true, abstract: false, final false
inline void Send(::System::Threading::SendOrPostCallback*  d, ::System::Object*  state) ;

/// @brief Method SetSynchronizationContext, addr 0x181766310, size 0x50, virtual false, abstract: false, final false
static inline void SetSynchronizationContext(::System::Threading::SynchronizationContext*  syncContext) ;

/// @brief Method Wait, addr 0x1817663a0, size 0x40, virtual true, abstract: false, final false
inline int32_t Wait(::ArrayW<::System::IntPtr>  waitHandles, bool  waitAll, int32_t  millisecondsTimeout) ;

/// @brief Method WaitHelper, addr 0x181766360, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_Current, addr 0x1817663e0, size 0x30, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* get_Current() ;

/// @brief Method get_CurrentExplicit, addr 0x1817663e0, size 0x30, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* get_CurrentExplicit() ;

/// @brief Method get_CurrentNoFlow, addr 0x181766410, size 0x30, virtual false, abstract: false, final false
