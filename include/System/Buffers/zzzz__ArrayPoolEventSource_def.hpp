...
DEFINE_IL2CPP_CLASS(::System::Buffers::ArrayPoolEventSource_BufferAllocatedReason, "System.Buffers", "ArrayPoolEventSource/BufferAllocatedReason");
...
static_assert(offsetof(::System::Buffers::ArrayPoolEventSource_BufferAllocatedReason, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method BufferAllocated, addr 0x1816c3a90, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method BufferRented, addr 0x1816c3b00, size 0x60, virtual false, abstract: false, final false
inline void BufferRented(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId, int32_t  bucketId) ;

/// @brief Method BufferReturned, addr 0x1816c3b60, size 0x30, virtual false, abstract: false, final false
inline void BufferReturned(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId) ;

/// @brief Method BufferTrimPoll, addr 0x1816c3b90, size 0x90, virtual false, abstract: false, final false
inline void BufferTrimPoll(int32_t  milliseconds, int32_t  pressure) ;

/// @brief Method BufferTrimmed, addr 0x1816c3c20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816c3d10, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
