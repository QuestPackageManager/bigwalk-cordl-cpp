...
public:
// Declarations
/// @brief Method ReverseEndianness, addr 0x1816d21f0, size 0x10, virtual false, abstract: false, final false
static inline int32_t ReverseEndianness(int32_t  value) ;

/// @brief Method ReverseEndianness, addr 0x1816d2200, size 0x10, virtual false, abstract: false, final false
