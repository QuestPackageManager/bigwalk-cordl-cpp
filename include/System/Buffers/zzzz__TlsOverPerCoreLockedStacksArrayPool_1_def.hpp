...
template<typename T>
class TlsOverPerCoreLockedStacksArrayPool_1_LockedStack;
}
namespace System::Buffers {
template<typename T>
...
namespace System::Buffers {
template<typename T>
class TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks;
}
...
MARK_GEN_REF_T_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1);
MARK_GEN_REF_T_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack);
MARK_GEN_REF_T_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks);
DEFINE_IL2CPP_GEN_CLASS(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_MemoryPressure, "System.Buffers", "TlsOverPerCoreLockedStacksArrayPool`1/MemoryPressure");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1, "System.Buffers", "TlsOverPerCoreLockedStacksArrayPool`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack, "System.Buffers", "TlsOverPerCoreLockedStacksArrayPool`1/LockedStack");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks, "System.Buffers", "TlsOverPerCoreLockedStacksArrayPool`1/PerCoreLockedStacks");
// Dependencies 
namespace System::Buffers {
// cpp template
template<typename T>
...
/// @brief Field _arrays, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__arrays, put=__cordl_internal_set__arrays)) ::ArrayW<::ArrayW<T>>  _arrays;
...
inline ::ArrayW<T> TryPop() ;

/// @brief Method TryPush, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool TryPush(::ArrayW<T>  array) ;

constexpr ::ArrayW<::ArrayW<T>> const& __cordl_internal_get__arrays() const;

constexpr ::ArrayW<::ArrayW<T>>& __cordl_internal_get__arrays() ;
...
constexpr void __cordl_internal_set__arrays(::ArrayW<::ArrayW<T>>  value) ;
...
// Dependencies System.Buffers.TlsOverPerCoreLockedStacksArrayPool`1::LockedStack<T>, System.Object
namespace System::Buffers {
// cpp template
template<typename T>
// Is value type: false
...
/// @brief Field _perCoreStacks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__perCoreStacks, put=__cordl_internal_set__perCoreStacks)) ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>  _perCoreStacks;

static inline ::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>* New_ctor() ;

/// @brief Method Trim, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool Trim(uint32_t  tickCount, int32_t  id, ::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_MemoryPressure<T>  pressure, ::ArrayW<int32_t>  bucketSizes) ;

/// @brief Method TryPop, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::ArrayW<T> TryPop() ;

/// @brief Method TryPush, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void TryPush(::ArrayW<T>  array) ;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*> const& __cordl_internal_get__perCoreStacks() const;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>& __cordl_internal_get__perCoreStacks() ;

constexpr void __cordl_internal_set__perCoreStacks(::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>  value) ;
...
/// @brief Field _perCoreStacks, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_LockedStack<T>*>  ____perCoreStacks;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
} // namespace end def System::Buffers
// Dependencies System.Buffers.ArrayPool`1<T>, System.Buffers.TlsOverPerCoreLockedStacksArrayPool`1::PerCoreLockedStacks<T>
namespace System::Buffers {
// cpp template
template<typename T>
// Is value type: false
...
/// @brief Field _bucketArraySizes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__bucketArraySizes, put=__cordl_internal_set__bucketArraySizes)) ::ArrayW<int32_t>  _bucketArraySizes;

/// @brief Field _buckets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__buckets, put=__cordl_internal_set__buckets)) ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>  _buckets;
...
/// @brief Field s_allTlsBuckets, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_allTlsBuckets, put=setStaticF_s_allTlsBuckets)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::ArrayW<::ArrayW<T>>,::System::Object*>*  s_allTlsBuckets;
...
/// @brief Field t_tlsBuckets, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_t_tlsBuckets, put=setStaticF_t_tlsBuckets)) ::ArrayW<::ArrayW<T>>  t_tlsBuckets;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__bucketArraySizes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__bucketArraySizes() ;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*> const& __cordl_internal_get__buckets() const;

constexpr ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>& __cordl_internal_get__buckets() ;
...
constexpr void __cordl_internal_set__bucketArraySizes(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set__buckets(::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>  value) ;
...
static inline ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::ArrayW<::ArrayW<T>>,::System::Object*>* getStaticF_s_allTlsBuckets() ;

static inline bool getStaticF_s_trimBuffers() ;

static inline ::ArrayW<::ArrayW<T>> getStaticF_t_tlsBuckets() ;

/// @brief Method get_Id, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline int32_t get_Id() ;

static inline void setStaticF_s_allTlsBuckets(::System::Runtime::CompilerServices::ConditionalWeakTable_2<::ArrayW<::ArrayW<T>>,::System::Object*>*  value) ;

static inline void setStaticF_s_trimBuffers(bool  value) ;

static inline void setStaticF_t_tlsBuckets(::ArrayW<::ArrayW<T>>  value) ;
...
/// @brief Field _bucketArraySizes, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<int32_t>  ____bucketArraySizes;

/// @brief Field _buckets, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Buffers::TlsOverPerCoreLockedStacksArrayPool_1_PerCoreLockedStacks<T>*>  ____buckets;
