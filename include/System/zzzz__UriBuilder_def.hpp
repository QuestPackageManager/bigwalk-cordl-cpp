...
// Write type traits
MARK_REF_T(::System::UriBuilder*);
DEFINE_IL2CPP_CLASS(::System::UriBuilder*, "System", "UriBuilder");
...
/// @brief Method Equals, addr 0x181dc0670, size 0x60, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  rparam) ;

/// @brief Method GetHashCode, addr 0x181dc06d0, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Init, addr 0x181dc0700, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method SetFieldsFromUri, addr 0x181dc08a0, size 0x180, virtual false, abstract: false, final false
inline void SetFieldsFromUri(::System::Uri*  uri) ;

/// @brief Method ToString, addr 0x181dc0a20, size 0x350, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dc0d70, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dc0e90, size 0x150, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  uri) ;

/// @brief Method get_Uri, addr 0x181dc0fe0, size 0x90, virtual false, abstract: false, final false
inline ::System::Uri* get_Uri() ;

/// @brief Method set_Host, addr 0x181dc1070, size 0x90, virtual false, abstract: false, final false
inline void set_Host(::StringW  value) ;

/// @brief Method set_Path, addr 0x181dc1100, size 0x60, virtual false, abstract: false, final false
inline void set_Path(::StringW  value) ;

/// @brief Method set_Port, addr 0x181dc1160, size 0x30, virtual false, abstract: false, final false
inline void set_Port(int32_t  value) ;

/// @brief Method set_Scheme, addr 0x181dc1190, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::UriBuilder) == 0x68, "Size mismatch!");
