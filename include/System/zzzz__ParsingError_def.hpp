...
DEFINE_IL2CPP_CLASS(::System::ParsingError, "System", "ParsingError");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::ParsingError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::ParsingError) == 0x4, "Size mismatch!");
