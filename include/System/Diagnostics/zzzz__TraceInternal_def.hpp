...
// Write type traits
MARK_REF_T(::System::Diagnostics::TraceInternal*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::TraceInternal*, "System.Diagnostics", "TraceInternal");
...
/// @brief Method InitializeSettings, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IndentLevel, addr 0x181de5680, size 0x20, virtual false, abstract: false, final false
static inline int32_t get_IndentLevel() ;

/// @brief Method get_IndentSize, addr 0x181de56a0, size 0x40, virtual false, abstract: false, final false
static inline int32_t get_IndentSize() ;

/// @brief Method get_Listeners, addr 0x181de56e0, size 0x230, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::TraceInternal) == 0x10, "Size mismatch!");
