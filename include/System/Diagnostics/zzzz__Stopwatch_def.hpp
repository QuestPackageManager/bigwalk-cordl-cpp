...
/// @brief Method GetTimestamp, addr 0x18177a950, size 0x10, virtual false, abstract: false, final false
static inline int64_t GetTimestamp() ;

static inline ::System::Diagnostics::Stopwatch* New_ctor() ;

/// @brief Method Reset, addr 0x181de48d0, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Start, addr 0x181de4920, size 0x30, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartNew, addr 0x181de48e0, size 0x40, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Stopwatch* StartNew() ;

/// @brief Method Stop, addr 0x181de4950, size 0x50, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method get_Elapsed, addr 0x181de4af0, size 0xc0, virtual false, abstract: false, final false
inline ::System::TimeSpan get_Elapsed() ;

/// @brief Method get_ElapsedMilliseconds, addr 0x181de49e0, size 0xe0, virtual false, abstract: false, final false
inline int64_t get_ElapsedMilliseconds() ;

/// @brief Method get_ElapsedTicks, addr 0x181de4ac0, size 0x30, virtual false, abstract: false, final false
inline int64_t get_ElapsedTicks() ;

/// @brief Method get_IsRunning, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
