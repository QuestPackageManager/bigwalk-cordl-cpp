...
// Write type traits
MARK_REF_T(::System::Diagnostics::Contracts::Contract*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Contracts::Contract*, "System.Diagnostics.Contracts", "Contract");
...
template<typename T>
static inline bool ForAll(::System::Collections::Generic::IEnumerable_1<T>*  collection, ::System::Predicate_1<T>*  predicate) ;
...
static_assert(sizeof(::System::Diagnostics::Contracts::Contract) == 0x10, "Size mismatch!");
