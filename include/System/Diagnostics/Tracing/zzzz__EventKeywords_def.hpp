...
static_assert(offsetof(::System::Diagnostics::Tracing::EventKeywords, value__) == 0x8, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::Tracing::EventKeywords) == 0x8, "Size mismatch!");
