...
// Write type traits
MARK_REF_T(::System::Diagnostics::SwitchLevelAttribute*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::SwitchLevelAttribute*, "System.Diagnostics", "SwitchLevelAttribute");
...
/// @brief Method .ctor, addr 0x181de4bb0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  switchLevelType) ;

/// @brief Method set_SwitchLevelType, addr 0x181de4bb0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::SwitchLevelAttribute) == 0x18, "Size mismatch!");
