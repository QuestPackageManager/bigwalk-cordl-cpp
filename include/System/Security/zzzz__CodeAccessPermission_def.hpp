...
/// @brief Method CheckPermissionState, addr 0x1815f41e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Demand, addr 0x180631430, size 0xa670, virtual true, abstract: false, final true
inline void Demand() ;

/// @brief Method Equals, addr 0x1815f4260, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method System.Security.IPermission.Demand, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void System_Security_IPermission_Demand() ;

/// @brief Method ToString, addr 0x1815f4350, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::CodeAccessPermission) == 0x10, "Size mismatch!");
