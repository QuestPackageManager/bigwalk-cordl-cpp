...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::RC2Transform*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::RC2Transform*, "System.Security.Cryptography", "RC2Transform");
...
/// @brief Field K, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_K, put=__cordl_internal_set_K)) ::ArrayW<uint16_t>  K;
...
/// @brief Method ECB, addr 0x181616510, size 0x7c0, virtual true, abstract: false, final false
...
constexpr ::ArrayW<uint16_t> const& __cordl_internal_get_K() const;

constexpr ::ArrayW<uint16_t>& __cordl_internal_get_K() ;
...
constexpr void __cordl_internal_set_K(::ArrayW<uint16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181616d30, size 0x3a0, virtual false, abstract: false, final false
...
static inline void setStaticF_pitable(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::System::Security::Cryptography::RC2Transform) == 0x70, "Size mismatch!");
