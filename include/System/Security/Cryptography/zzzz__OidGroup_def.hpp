...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::OidGroup, "System.Security.Cryptography", "OidGroup");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::OidGroup, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::OidGroup) == 0x4, "Size mismatch!");
