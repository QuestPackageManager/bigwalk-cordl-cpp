...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509ExtensionEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509ExtensionEnumerator*, "System.Security.Cryptography.X509Certificates", "X509ExtensionEnumerator");
...
/// @brief Method MoveNext, addr 0x181192f10, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x181192f80, size 0x89a0, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181df7e80, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::ArrayList*  list) ;

/// @brief Method get_Current, addr 0x181df7ec0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509ExtensionEnumerator) == 0x18, "Size mismatch!");
