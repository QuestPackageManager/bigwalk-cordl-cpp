...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509Certificate2*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509Certificate2*, "System.Security.Cryptography.X509Certificates", "X509Certificate2");
...
/// @brief Field lazyRawData, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_lazyRawData, put=__cordl_internal_set_lazyRawData)) ::ArrayW<uint8_t>  lazyRawData;
...
/// @brief Field lazySubjectName, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_lazySubjectName, put=__cordl_internal_set_lazySubjectName)) ::System::Security::Cryptography::X509Certificates::X500DistinguishedName*  lazySubjectName;
...
/// @brief Method CreateCustomExtensionIfAny, addr 0x181df0a10, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method GetCertContentType, addr 0x181df0ba0, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::X509Certificates::X509ContentType GetCertContentType(::ArrayW<uint8_t>  rawData) ;

/// @brief Method GetNameInfo, addr 0x181df0bf0, size 0x90, virtual false, abstract: false, final false
...
static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* New_ctor(::StringW  fileName, ::StringW  password) ;
...
static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* New_ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* New_ctor(::ArrayW<uint8_t>  rawData) ;

static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2* New_ctor(::ArrayW<uint8_t>  rawData, ::StringW  password) ;

/// @brief Method Reset, addr 0x181df0c80, size 0xc0, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ToString, addr 0x181df1740, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x181df0d40, size 0xa00, virtual true, abstract: false, final false
inline ::StringW ToString(bool  verbose) ;

/// @brief Method Verify, addr 0x181df1750, size 0x80, virtual false, abstract: false, final false
inline bool Verify() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_lazyRawData() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_lazyRawData() ;
...
constexpr void __cordl_internal_set_lazyRawData(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x181df18f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181df17e0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate*  certificate) ;

/// @brief Method .ctor, addr 0x181df1900, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  fileName, ::StringW  password) ;

/// @brief Method .ctor, addr 0x181df18e0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2Impl*  impl) ;

/// @brief Method .ctor, addr 0x181df1910, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x181df17f0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  rawData) ;

/// @brief Method .ctor, addr 0x181df17d0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  rawData, ::StringW  password) ;

/// @brief Method get_Extensions, addr 0x181df1940, size 0x2a0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_HasPrivateKey, addr 0x181df1be0, size 0x80, virtual false, abstract: false, final false
inline bool get_HasPrivateKey() ;

/// @brief Method get_Impl, addr 0x181df1c60, size 0x60, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* get_Impl() ;

/// @brief Method get_IssuerName, addr 0x181df1cc0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName() ;

/// @brief Method get_NotAfter, addr 0x181df1d80, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x181df1d90, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_PrivateKey, addr 0x181df1da0, size 0x170, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_PrivateKey() ;

/// @brief Method get_PublicKey, addr 0x181df1f10, size 0x1c0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::PublicKey* get_PublicKey() ;

/// @brief Method get_RawData, addr 0x181df20d0, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_SerialNumber, addr 0x1815f45f0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm, addr 0x181df2180, size 0xc0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::Oid* get_SignatureAlgorithm() ;

/// @brief Method get_SubjectName, addr 0x181df2240, size 0xb0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName() ;

/// @brief Method get_Thumbprint, addr 0x181df22f0, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_Thumbprint() ;

/// @brief Method get_Version, addr 0x181df2320, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2) == 0xa0, "Size mismatch!");
