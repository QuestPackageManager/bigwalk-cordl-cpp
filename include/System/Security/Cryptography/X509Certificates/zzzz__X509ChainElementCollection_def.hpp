...
/// @brief Method Add, addr 0x181df2af0, size 0x80, virtual false, abstract: false, final false
inline void Add(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Clear, addr 0x181bc5e30, size 0x20, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x181df2b70, size 0x110, virtual false, abstract: false, final false
inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method GetEnumerator, addr 0x181df2c80, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181df2c80, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method get_IsSynchronized, addr 0x1816c5970, size 0x20, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_Item, addr 0x181df2cd0, size 0x60, virtual false, abstract: false, final false
