...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509FindType, "System.Security.Cryptography.X509Certificates", "X509FindType");
// Dependencies 
namespace System::Security::Cryptography::X509Certificates {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::X509Certificates::X509FindType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509FindType) == 0x4, "Size mismatch!");
