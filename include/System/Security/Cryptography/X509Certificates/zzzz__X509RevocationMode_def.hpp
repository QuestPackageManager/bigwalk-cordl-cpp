...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509RevocationMode, "System.Security.Cryptography.X509Certificates", "X509RevocationMode");
// Dependencies 
namespace System::Security::Cryptography::X509Certificates {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::X509Certificates::X509RevocationMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509RevocationMode) == 0x4, "Size mismatch!");
