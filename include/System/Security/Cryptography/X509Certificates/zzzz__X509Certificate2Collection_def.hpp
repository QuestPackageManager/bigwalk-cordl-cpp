...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection*, "System.Security.Cryptography.X509Certificates", "X509Certificate2Collection");
...
/// @brief Method Add, addr 0x181dedce0, size 0x40, virtual false, abstract: false, final false
inline int32_t Add(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method AddRange, addr 0x181dedca0, size 0x40, virtual false, abstract: false, final false
inline void AddRange(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection*  certificates) ;

/// @brief Method Contains, addr 0x181dedd20, size 0x190, virtual false, abstract: false, final false
inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Find, addr 0x181dedeb0, size 0xbd0, virtual false, abstract: false, final false
...
/// @brief Method GetEnumerator, addr 0x181deea80, size 0x50, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Enumerator* GetEnumerator() ;

/// @brief Method GetKeyIdentifier, addr 0x181deead0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181deebd0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x181deec30, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection) == 0x18, "Size mismatch!");
