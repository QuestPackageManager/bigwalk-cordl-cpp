...
public:
// Declarations
/// @brief Method CreateChainImpl, addr 0x181df80a0, size 0x150, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::X509Certificates::X509ChainImpl* CreateChainImpl(bool  useMachineContext) ;

/// @brief Method GetInvalidChainContextException, addr 0x181df81f0, size 0x50, virtual false, abstract: false, final false
static inline ::System::Exception* GetInvalidChainContextException() ;

/// @brief Method GetMonoCertificate, addr 0x181df8240, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method ThrowIfContextInvalid, addr 0x181df83f0, size 0x40, virtual false, abstract: false, final false
