...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplUnix*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplUnix*, "System.Security.Cryptography.X509Certificates", "X509Certificate2ImplUnix");
...
/// @brief Method AppendPrivateKeyInfo, addr 0x181df01c0, size 0x60, virtual true, abstract: false, final true
inline void AppendPrivateKeyInfo(::System::Text::StringBuilder*  sb) ;

/// @brief Method EnsureCertData, addr 0x181df0220, size 0x110, virtual false, abstract: false, final false
inline void EnsureCertData() ;

/// @brief Method Export, addr 0x181df0620, size 0x140, virtual true, abstract: false, final true
...
/// @brief Method ExportPkcs12, addr 0x181df0330, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ExportPkcs12(::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password) ;

/// @brief Method ExportPkcs12, addr 0x181df0390, size 0x290, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ExportPkcs12(::StringW  password) ;

/// @brief Method GetNameInfo, addr 0x181df0760, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method get_Extensions, addr 0x181df07a0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_Issuer, addr 0x181df07e0, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Issuer() ;

/// @brief Method get_IssuerName, addr 0x181df07c0, size 0x20, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName() ;

/// @brief Method get_KeyAlgorithm, addr 0x181df0820, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters, addr 0x181df0800, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> get_KeyAlgorithmParameters() ;

/// @brief Method get_NotAfter, addr 0x181df0840, size 0x20, virtual true, abstract: false, final true
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x181df0860, size 0x20, virtual true, abstract: false, final true
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_PublicKeyValue, addr 0x181df0880, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> get_PublicKeyValue() ;

/// @brief Method get_RawData, addr 0x181df08a0, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_SerialNumber, addr 0x181df08c0, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm, addr 0x181df08e0, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_SignatureAlgorithm() ;

/// @brief Method get_Subject, addr 0x181df0920, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Subject() ;

/// @brief Method get_SubjectName, addr 0x181df0900, size 0x20, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName() ;

/// @brief Method get_Thumbprint, addr 0x181df0940, size 0xb0, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> get_Thumbprint() ;

/// @brief Method get_Version, addr 0x181df09f0, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplUnix) == 0xb0, "Size mismatch!");
