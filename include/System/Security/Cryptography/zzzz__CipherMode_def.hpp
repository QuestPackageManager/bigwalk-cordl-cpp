...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::CipherMode, "System.Security.Cryptography", "CipherMode");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::CipherMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::CipherMode) == 0x4, "Size mismatch!");
