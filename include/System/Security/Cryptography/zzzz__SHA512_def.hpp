...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::SHA512*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::SHA512*, "System.Security.Cryptography", "SHA512");
...
public:
// Declarations
/// @brief Method Create, addr 0x18161bd90, size 0x30, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA512* Create() ;

static inline ::System::Security::Cryptography::SHA512* New_ctor() ;

/// @brief Method .ctor, addr 0x18161bdc0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::SHA512) == 0x28, "Size mismatch!");
