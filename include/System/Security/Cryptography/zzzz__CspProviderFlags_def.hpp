...
static_assert(offsetof(::System::Security::Cryptography::CspProviderFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::CspProviderFlags) == 0x4, "Size mismatch!");
