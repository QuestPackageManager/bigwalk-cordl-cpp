...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::AsnDecodeStatus, "System.Security.Cryptography", "AsnDecodeStatus");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::AsnDecodeStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::AsnDecodeStatus) == 0x4, "Size mismatch!");
