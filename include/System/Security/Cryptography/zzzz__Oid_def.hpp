...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::Oid*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::Oid*, "System.Security.Cryptography", "Oid");
// Dependencies System.Object, System.Security.Cryptography.OidGroup
namespace System::Security::Cryptography {
// Is value type: false
...
/// @brief Method FromOidValue, addr 0x181dd9ee0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dda010, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method .ctor, addr 0x181dd9fb0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_FriendlyName, addr 0x181dda060, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::Oid) == 0x28, "Size mismatch!");
