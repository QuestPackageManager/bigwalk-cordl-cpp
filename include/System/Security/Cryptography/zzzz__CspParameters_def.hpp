...
/// @brief Method .ctor, addr 0x181605a20, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816059d0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwTypeIn) ;

/// @brief Method .ctor, addr 0x181605ad0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwTypeIn, ::StringW  strProviderNameIn, ::StringW  strContainerNameIn) ;

/// @brief Method .ctor, addr 0x181605a70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_Flags, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::CspProviderFlags get_Flags() ;

/// @brief Method set_Flags, addr 0x181605b20, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::CspParameters) == 0x30, "Size mismatch!");
