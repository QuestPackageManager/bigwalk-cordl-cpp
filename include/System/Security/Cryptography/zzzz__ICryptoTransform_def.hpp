...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::ICryptoTransform*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::ICryptoTransform*, "System.Security.Cryptography", "ICryptoTransform");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: false
...
/// @brief Method get_CanReuseTransform, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
