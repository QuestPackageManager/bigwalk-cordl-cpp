...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::HMACSHA256*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::HMACSHA256*, "System.Security.Cryptography", "HMACSHA256");
...
/// @brief Method .ctor, addr 0x181607bb0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181607c70, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::HMACSHA256) == 0x68, "Size mismatch!");
