...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::SignatureDescription*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::SignatureDescription*, "System.Security.Cryptography", "SignatureDescription");
...
/// @brief Method set_DeformatterAlgorithm, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_DeformatterAlgorithm(::StringW  value) ;

/// @brief Method set_DigestAlgorithm, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_DigestAlgorithm(::StringW  value) ;

/// @brief Method set_FormatterAlgorithm, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_FormatterAlgorithm(::StringW  value) ;

/// @brief Method set_KeyAlgorithm, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::SignatureDescription) == 0x30, "Size mismatch!");
