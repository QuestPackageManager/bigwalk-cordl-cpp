...
/// @brief Method .ctor, addr 0x181606de0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::DSASignatureFormatter) == 0x18, "Size mismatch!");
