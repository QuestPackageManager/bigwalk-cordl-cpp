...
/// @brief Method Common, addr 0x181614970, size 0x1a0, virtual false, abstract: false, final false
inline void Common(int32_t  dwKeySize, bool  parameters) ;

/// @brief Method Dispose, addr 0x181614b10, size 0x50, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExportParameters, addr 0x181614b60, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method OnKeyGenerated, addr 0x181614c10, size 0x70, virtual false, abstract: false, final false
inline void OnKeyGenerated(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method VerifySignature, addr 0x181614c80, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181614e30, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181614ca0, size 0x190, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

static inline bool getStaticF_useMachineKeyStore() ;

/// @brief Method get_KeySize, addr 0x181614fb0, size 0x20, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x181614fd0, size 0x10, virtual false, abstract: false, final false
