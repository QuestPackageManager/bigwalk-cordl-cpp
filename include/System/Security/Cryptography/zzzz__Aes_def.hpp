...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::Aes*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::Aes*, "System.Security.Cryptography", "Aes");
...
/// @brief Method .ctor, addr 0x181605650, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::Aes) == 0x48, "Size mismatch!");
