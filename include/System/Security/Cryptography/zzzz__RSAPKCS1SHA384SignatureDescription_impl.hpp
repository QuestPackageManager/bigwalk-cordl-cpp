...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Security::Cryptography::RSAPKCS1SHA384SignatureDescription::*)()>(&::System::Security::Cryptography::RSAPKCS1SHA384SignatureDescription::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x181617440;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::Security::Cryptography::RSAPKCS1SHA384SignatureDescription*>(),
                        {".ctor", {}, {}}
                    )));
