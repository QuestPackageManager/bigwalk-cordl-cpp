...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::OidEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::OidEnumerator*, "System.Security.Cryptography", "OidEnumerator");
...
/// @brief Method MoveNext, addr 0x181dd9ea0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181dd9ec0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_Current, addr 0x181dd9ec0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::OidEnumerator) == 0x20, "Size mismatch!");
