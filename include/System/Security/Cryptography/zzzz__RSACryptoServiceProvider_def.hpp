...
/// @brief Method Common, addr 0x18160c3d0, size 0x260, virtual false, abstract: false, final false
inline void Common(int32_t  dwKeySize, bool  parameters) ;

/// @brief Method Common, addr 0x18160c630, size 0xe0, virtual false, abstract: false, final false
inline void Common(::System::Security::Cryptography::CspParameters*  p) ;

/// @brief Method Dispose, addr 0x18160c710, size 0x70, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EncryptValue, addr 0x18160c780, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t>  rgb) ;

/// @brief Method ExportParameters, addr 0x18160c7a0, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method GetHashNameFromOID, addr 0x18160c8e0, size 0x110, virtual false, abstract: false, final false
inline ::StringW GetHashNameFromOID(::StringW  oid) ;

/// @brief Method ImportParameters, addr 0x18160c9f0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method OnKeyGenerated, addr 0x18160ca40, size 0x70, virtual false, abstract: false, final false
inline void OnKeyGenerated(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method VerifyHash, addr 0x18160cab0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18160ce90, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18160cc80, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

/// @brief Method .ctor, addr 0x18160cc90, size 0x100, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize, ::System::Security::Cryptography::CspParameters*  parameters) ;

/// @brief Method .ctor, addr 0x18160cd90, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_KeySize, addr 0x18160ceb0, size 0x30, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x18160cee0, size 0x10, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method get_UseMachineKeyStore, addr 0x18160cef0, size 0x340, virtual false, abstract: false, final false
