...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::DerSequenceReader_DerTag, "System.Security.Cryptography", "DerSequenceReader/DerTag");
...
static_assert(offsetof(::System::Security::Cryptography::DerSequenceReader_DerTag, value__) == 0x1, "Offset mismatch!");
...
/// @brief Method <ReadT61String>b__45_0, addr 0x181de6b70, size 0x30, virtual false, abstract: false, final false
inline ::System::Text::Encoding* _ReadT61String_b__45_0() ;

/// @brief Method <ReadT61String>b__45_1, addr 0x181de6ba0, size 0x10, virtual false, abstract: false, final false
inline ::System::Text::Encoding* _ReadT61String_b__45_1() ;

/// @brief Method <ReadTime>b__51_0, addr 0x181de6bb0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CheckTag, addr 0x181dd77b0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method EatLength, addr 0x181dd78a0, size 0x40, virtual false, abstract: false, final false
inline int32_t EatLength() ;

/// @brief Method EatTag, addr 0x181dd78e0, size 0x70, virtual false, abstract: false, final false
...
static inline ::System::Security::Cryptography::DerSequenceReader* New_ctor(::System::Security::Cryptography::DerSequenceReader_DerTag  tagToEat, ::ArrayW<uint8_t>  data, int32_t  offset, int32_t  length) ;

/// @brief Method PeekTag, addr 0x181dd7950, size 0xb0, virtual false, abstract: false, final false
inline uint8_t PeekTag() ;

/// @brief Method ReadBMPString, addr 0x181dd7a00, size 0x120, virtual false, abstract: false, final false
inline ::StringW ReadBMPString() ;

/// @brief Method ReadBitString, addr 0x181dd7b20, size 0x190, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadBitString() ;

/// @brief Method ReadBoolean, addr 0x181dd7cb0, size 0xf0, virtual false, abstract: false, final false
inline bool ReadBoolean() ;

/// @brief Method ReadCollectionWithTag, addr 0x181dd7da0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ReadContentAsBytes, addr 0x181dd7e60, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadContentAsBytes() ;

/// @brief Method ReadGeneralizedTime, addr 0x181dd7ef0, size 0x20, virtual false, abstract: false, final false
inline ::System::DateTime ReadGeneralizedTime() ;

/// @brief Method ReadIA5String, addr 0x181dd7f10, size 0x120, virtual false, abstract: false, final false
inline ::StringW ReadIA5String() ;

/// @brief Method ReadInteger, addr 0x181dd8120, size 0x120, virtual false, abstract: false, final false
inline int32_t ReadInteger() ;

/// @brief Method ReadIntegerBytes, addr 0x181dd8030, size 0xf0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadIntegerBytes() ;

/// @brief Method ReadNextEncodedValue, addr 0x181dd8240, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadNextEncodedValue() ;

/// @brief Method ReadOctetString, addr 0x181dd82d0, size 0xf0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadOctetString() ;

/// @brief Method ReadOidAsString, addr 0x181dd83c0, size 0x310, virtual false, abstract: false, final false
inline ::StringW ReadOidAsString() ;

/// @brief Method ReadPrintableString, addr 0x181dd86d0, size 0x120, virtual false, abstract: false, final false
inline ::StringW ReadPrintableString() ;

/// @brief Method ReadSequence, addr 0x181dd87f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DerSequenceReader* ReadSequence() ;

/// @brief Method ReadSet, addr 0x181dd8800, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DerSequenceReader* ReadSet() ;

/// @brief Method ReadT61String, addr 0x181dd8810, size 0x300, virtual false, abstract: false, final false
inline ::StringW ReadT61String() ;

/// @brief Method ReadTime, addr 0x181dd8b10, size 0x210, virtual false, abstract: false, final false
inline ::System::DateTime ReadTime(::System::Security::Cryptography::DerSequenceReader_DerTag  timeTag, ::StringW  formatString) ;

/// @brief Method ReadUtcTime, addr 0x181dd8d20, size 0x20, virtual false, abstract: false, final false
inline ::System::DateTime ReadUtcTime() ;

/// @brief Method ReadUtf8String, addr 0x181dd8d40, size 0x120, virtual false, abstract: false, final false
inline ::StringW ReadUtf8String() ;

/// @brief Method ReadX509Date, addr 0x181dd8e60, size 0x90, virtual false, abstract: false, final false
inline ::System::DateTime ReadX509Date() ;

/// @brief Method ScanContentLength, addr 0x181dd8ef0, size 0x270, virtual false, abstract: false, final false
static inline int32_t ScanContentLength(::ArrayW<uint8_t>  data, int32_t  offset, int32_t  end, ::by_ref<int32_t>  bytesConsumed) ;

/// @brief Method SkipValue, addr 0x181dd9160, size 0xa0, virtual false, abstract: false, final false
inline void SkipValue() ;

/// @brief Method TrimTrailingNulls, addr 0x181dd9200, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dd93b0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data) ;

/// @brief Method .ctor, addr 0x181dd93e0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data, int32_t  offset, int32_t  length) ;

/// @brief Method .ctor, addr 0x181dd9270, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method get_HasData, addr 0x181dd9410, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ContentLength, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
