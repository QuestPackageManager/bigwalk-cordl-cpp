...
/// @brief Method IsLegal, addr 0x181609260, size 0x30, virtual false, abstract: false, final false
inline bool IsLegal(int32_t  keySize) ;

/// @brief Method IsLegalKeySize, addr 0x181609200, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_MaxSize, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_MaxSize() ;

/// @brief Method get_MinSize, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_MinSize() ;

/// @brief Method get_SkipSize, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::KeySizes) == 0x20, "Size mismatch!");
