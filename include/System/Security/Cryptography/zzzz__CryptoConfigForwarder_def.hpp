...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::CryptoConfigForwarder*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::CryptoConfigForwarder*, "System.Security.Cryptography", "CryptoConfigForwarder");
...
public:
// Declarations
/// @brief Method CreateFromName, addr 0x181625900, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::CryptoConfigForwarder) == 0x10, "Size mismatch!");
