...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::RSAPKCS1SHA256SignatureDescription*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::RSAPKCS1SHA256SignatureDescription*, "System.Security.Cryptography", "RSAPKCS1SHA256SignatureDescription");
...
/// @brief Method .ctor, addr 0x181617420, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::RSAPKCS1SHA256SignatureDescription) == 0x38, "Size mismatch!");
