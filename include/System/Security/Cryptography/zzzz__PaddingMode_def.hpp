...
static_assert(offsetof(::System::Security::Cryptography::PaddingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::PaddingMode) == 0x4, "Size mismatch!");
