...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::Rijndael*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::Rijndael*, "System.Security.Cryptography", "Rijndael");
...
/// @brief Method .ctor, addr 0x181610a30, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::Rijndael) == 0x48, "Size mismatch!");
