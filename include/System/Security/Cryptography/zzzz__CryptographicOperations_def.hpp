...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::CryptographicOperations*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::CryptographicOperations*, "System.Security.Cryptography", "CryptographicOperations");
...
public:
// Declarations
/// @brief Method ZeroMemory, addr 0x181605920, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::CryptographicOperations) == 0x10, "Size mismatch!");
