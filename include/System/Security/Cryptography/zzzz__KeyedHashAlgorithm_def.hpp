...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::KeyedHashAlgorithm*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::KeyedHashAlgorithm*, "System.Security.Cryptography", "KeyedHashAlgorithm");
...
/// @brief Method Dispose, addr 0x1816092a0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method set_Key, addr 0x1816092f0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::KeyedHashAlgorithm) == 0x30, "Size mismatch!");
