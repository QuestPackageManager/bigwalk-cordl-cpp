...
/// @brief Method CloseToken, addr 0x181633a80, size 0x10, virtual false, abstract: false, final false
static inline bool CloseToken(::System::IntPtr  token) ;

/// @brief Method Dispose, addr 0x181633a90, size 0x80, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DuplicateToken, addr 0x181633b10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method RevertToSelf, addr 0x181633b20, size 0x10, virtual false, abstract: false, final false
static inline bool RevertToSelf() ;

/// @brief Method SetCurrentToken, addr 0x181633b30, size 0x10, virtual false, abstract: false, final false
static inline bool SetCurrentToken(::System::IntPtr  token) ;

/// @brief Method Undo, addr 0x181633b40, size 0x80, virtual false, abstract: false, final false
inline void Undo() ;
...
/// @brief Method .ctor, addr 0x181633bc0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Principal::WindowsImpersonationContext) == 0x20, "Size mismatch!");
