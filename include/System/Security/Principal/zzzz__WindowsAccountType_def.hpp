...
DEFINE_IL2CPP_CLASS(::System::Security::Principal::WindowsAccountType, "System.Security.Principal", "WindowsAccountType");
// Dependencies 
namespace System::Security::Principal {
// Is value type: true
...
static_assert(offsetof(::System::Security::Principal::WindowsAccountType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Principal::WindowsAccountType) == 0x4, "Size mismatch!");
