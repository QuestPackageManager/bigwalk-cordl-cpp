...
DEFINE_IL2CPP_CLASS(::System::Security::Util::Tokenizer_TokenSource, "System.Security.Util", "Tokenizer/TokenSource");
...
static_assert(offsetof(::System::Security::Util::Tokenizer_TokenSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Util::Tokenizer_TokenSource) == 0x4, "Size mismatch!");
...
/// @brief Method CompareStringAndChars, addr 0x1815ff690, size 0x80, virtual false, abstract: false, final false
inline bool CompareStringAndChars(::StringW  str, ::ArrayW<char16_t>  a, int32_t  l) ;

/// @brief Method HashCharArray, addr 0x1815ff710, size 0x40, virtual false, abstract: false, final false
static inline uint32_t HashCharArray(::ArrayW<char16_t>  a, int32_t  l) ;

/// @brief Method HashString, addr 0x1815ff750, size 0x60, virtual false, abstract: false, final false
static inline uint32_t HashString(::StringW  str) ;

/// @brief Method MakeString, addr 0x1815ff7b0, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815ffa30, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Read, addr 0x1815ff620, size 0x40, virtual true, abstract: false, final false
inline int32_t Read() ;
...
/// @brief Method .ctor, addr 0x1815ff660, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::StreamReader*  input) ;

/// @brief Method get_NumCharEncountered, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method BasicInitialization, addr 0x181600070, size 0x50, virtual false, abstract: false, final false
inline void BasicInitialization() ;

/// @brief Method ChangeFormat, addr 0x1816000c0, size 0x240, virtual false, abstract: false, final false
inline void ChangeFormat(::System::Text::Encoding*  encoding) ;

/// @brief Method GetStringToken, addr 0x181600300, size 0x10, virtual false, abstract: false, final false
inline ::StringW GetStringToken() ;

/// @brief Method GetTokens, addr 0x181600310, size 0x7f0, virtual false, abstract: false, final false
...
/// @brief Method Recycle, addr 0x181600b00, size 0x10, virtual false, abstract: false, final false
inline void Recycle() ;
...
/// @brief Method .ctor, addr 0x181600b10, size 0x70, virtual false, abstract: false, final false
