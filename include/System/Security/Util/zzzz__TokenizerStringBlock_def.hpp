...
// Write type traits
MARK_REF_T(::System::Security::Util::TokenizerStringBlock*);
DEFINE_IL2CPP_CLASS(::System::Security::Util::TokenizerStringBlock*, "System.Security.Util", "TokenizerStringBlock");
...
/// @brief Field m_block, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_block, put=__cordl_internal_set_m_block)) ::ArrayW<::StringW>  m_block;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_block() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_block() ;
...
constexpr void __cordl_internal_set_m_block(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set_m_next(::System::Security::Util::TokenizerStringBlock*  value) ;

/// @brief Method .ctor, addr 0x181600040, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Util::TokenizerStringBlock) == 0x20, "Size mismatch!");
