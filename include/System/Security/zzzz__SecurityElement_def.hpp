...
// Write type traits
MARK_REF_T(::System::Security::SecurityElement*);
MARK_REF_T(::System::Security::SecurityElement_SecurityAttribute*);
DEFINE_IL2CPP_CLASS(::System::Security::SecurityElement*, "System.Security", "SecurityElement");
DEFINE_IL2CPP_CLASS(::System::Security::SecurityElement_SecurityAttribute*, "System.Security", "SecurityElement/SecurityAttribute");
...
/// @brief Method .ctor, addr 0x1815fd7c0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Field invalid_attr_name_chars, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_invalid_attr_name_chars, put=setStaticF_invalid_attr_name_chars)) ::ArrayW<char16_t>  invalid_attr_name_chars;

/// @brief Field invalid_attr_value_chars, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_invalid_attr_value_chars, put=setStaticF_invalid_attr_value_chars)) ::ArrayW<char16_t>  invalid_attr_value_chars;

/// @brief Field invalid_chars, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_invalid_chars, put=setStaticF_invalid_chars)) ::ArrayW<char16_t>  invalid_chars;

/// @brief Field invalid_tag_chars, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_invalid_tag_chars, put=setStaticF_invalid_tag_chars)) ::ArrayW<char16_t>  invalid_tag_chars;

/// @brief Field invalid_text_chars, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_invalid_text_chars, put=setStaticF_invalid_text_chars)) ::ArrayW<char16_t>  invalid_text_chars;
...
/// @brief Method AddAttribute, addr 0x1815fe1f0, size 0x200, virtual false, abstract: false, final false
inline void AddAttribute(::StringW  name, ::StringW  value) ;

/// @brief Method AddChild, addr 0x1815fe3f0, size 0x90, virtual false, abstract: false, final false
inline void AddChild(::System::Security::SecurityElement*  child) ;

/// @brief Method Escape, addr 0x1815fe480, size 0x160, virtual false, abstract: false, final false
static inline ::StringW Escape(::StringW  str) ;

/// @brief Method GetAttribute, addr 0x1815fe5e0, size 0x170, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement_SecurityAttribute* GetAttribute(::StringW  name) ;

/// @brief Method IsValidAttributeName, addr 0x1815fe750, size 0x40, virtual false, abstract: false, final false
static inline bool IsValidAttributeName(::StringW  name) ;

/// @brief Method IsValidAttributeValue, addr 0x1815fe790, size 0x40, virtual false, abstract: false, final false
static inline bool IsValidAttributeValue(::StringW  value) ;

/// @brief Method IsValidTag, addr 0x1815fe7d0, size 0x40, virtual false, abstract: false, final false
static inline bool IsValidTag(::StringW  tag) ;

/// @brief Method IsValidText, addr 0x1815fe810, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SearchForChildByTag, addr 0x1815fe850, size 0x100, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* SearchForChildByTag(::StringW  tag) ;

/// @brief Method SearchForTextOfLocalName, addr 0x1815fe950, size 0x140, virtual false, abstract: false, final false
inline ::StringW SearchForTextOfLocalName(::StringW  strLocalName) ;

/// @brief Method ToString, addr 0x1815fea90, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToXml, addr 0x1815feb00, size 0x430, virtual false, abstract: false, final false
inline void ToXml(::by_ref<::System::Text::StringBuilder*>  s, int32_t  level) ;

/// @brief Method Unescape, addr 0x1815fef30, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815ff1b0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::StringW  tag) ;

/// @brief Method .ctor, addr 0x1815ff270, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::StringW  tag, ::StringW  text) ;

static inline ::ArrayW<char16_t> getStaticF_invalid_attr_name_chars() ;

static inline ::ArrayW<char16_t> getStaticF_invalid_attr_value_chars() ;

static inline ::ArrayW<char16_t> getStaticF_invalid_chars() ;

static inline ::ArrayW<char16_t> getStaticF_invalid_tag_chars() ;

static inline ::ArrayW<char16_t> getStaticF_invalid_text_chars() ;

/// @brief Method get_Children, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static inline void setStaticF_invalid_attr_value_chars(::ArrayW<char16_t>  value) ;

static inline void setStaticF_invalid_chars(::ArrayW<char16_t>  value) ;

static inline void setStaticF_invalid_tag_chars(::ArrayW<char16_t>  value) ;

static inline void setStaticF_invalid_text_chars(::ArrayW<char16_t>  value) ;

/// @brief Method set_Text, addr 0x1815ff3b0, size 0xa0, virtual false, abstract: false, final false
inline void set_Text(::StringW  value) ;

/// @brief Method set_m_strText, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::SecurityElement) == 0x30, "Size mismatch!");
