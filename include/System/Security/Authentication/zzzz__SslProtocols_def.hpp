...
static_assert(offsetof(::System::Security::Authentication::SslProtocols, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Authentication::SslProtocols) == 0x4, "Size mismatch!");
