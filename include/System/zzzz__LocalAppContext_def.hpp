...
// Write type traits
MARK_REF_T(::System::LocalAppContext*);
...
/// @brief Method <get_DisableCaching>b__6_0, addr 0x181b7dc50, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::LocalAppContext___c) == 0x10, "Size mismatch!");
...
/// @brief Method GetCachedSwitchValue, addr 0x181b7d9d0, size 0x20, virtual false, abstract: false, final false
static inline bool GetCachedSwitchValue(::StringW  switchName, ::by_ref<int32_t>  switchValue) ;

/// @brief Method GetCachedSwitchValueInternal, addr 0x181b7d890, size 0x140, virtual false, abstract: false, final false
static inline bool GetCachedSwitchValueInternal(::StringW  switchName, ::by_ref<int32_t>  switchValue) ;
...
/// @brief Method get_DisableCaching, addr 0x181b7d9f0, size 0x100, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::LocalAppContext) == 0x10, "Size mismatch!");
