...
/// @brief Method Equals, addr 0x181dfc550, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::ComponentModel::DefaultEventAttribute) == 0x18, "Size mismatch!");
