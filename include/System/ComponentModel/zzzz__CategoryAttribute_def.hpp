...
/// @brief Method Equals, addr 0x181dfa2b0, size 0x130, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x181dfa3e0, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLocalizedString, addr 0x181dfa440, size 0x340, virtual true, abstract: false, final false
inline ::StringW GetLocalizedString(::StringW  value) ;

/// @brief Method IsDefaultAttribute, addr 0x181dfa780, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dfa8a0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x180cba1d0, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::StringW  category) ;

static inline ::System::ComponentModel::CategoryAttribute* getStaticF_defAttr() ;

/// @brief Method get_Category, addr 0x181dfa8d0, size 0x60, virtual false, abstract: false, final false
inline ::StringW get_Category() ;

/// @brief Method get_Default, addr 0x181dfa930, size 0x90, virtual false, abstract: false, final false
