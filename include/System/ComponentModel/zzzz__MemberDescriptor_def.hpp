...
// Write type traits
MARK_REF_T(::System::ComponentModel::MemberDescriptor*);
DEFINE_IL2CPP_CLASS(::System::ComponentModel::MemberDescriptor*, "System.ComponentModel", "MemberDescriptor");
...
public:
// Declarations
 __declspec(property(get=get_AttributeArray, put=set_AttributeArray)) ::ArrayW<::System::Attribute*>  AttributeArray;
...
/// @brief Field attributes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_attributes, put=__cordl_internal_set_attributes)) ::ArrayW<::System::Attribute*>  attributes;
...
/// @brief Field originalAttributes, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_originalAttributes, put=__cordl_internal_set_originalAttributes)) ::ArrayW<::System::Attribute*>  originalAttributes;

/// @brief Method CheckAttributesValid, addr 0x181dffa60, size 0x70, virtual false, abstract: false, final false
inline void CheckAttributesValid() ;

/// @brief Method CreateAttributeCollection, addr 0x181dffad0, size 0x50, virtual true, abstract: false, final false
inline ::System::ComponentModel::AttributeCollection* CreateAttributeCollection() ;

/// @brief Method Equals, addr 0x181dffb20, size 0x220, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method FillAttributes, addr 0x181dffd40, size 0xf0, virtual true, abstract: false, final false
inline void FillAttributes(::System::Collections::IList*  attributeList) ;

/// @brief Method FilterAttributesIfNeeded, addr 0x181dffe30, size 0x400, virtual false, abstract: false, final false
inline void FilterAttributesIfNeeded() ;

/// @brief Method FindMethod, addr 0x181e002d0, size 0x70, virtual false, abstract: false, final false
static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type*  componentClass, ::StringW  name, ::ArrayW<::System::Type*>  args, ::System::Type*  returnType) ;

/// @brief Method FindMethod, addr 0x181e00230, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Reflection::MethodInfo* FindMethod(::System::Type*  componentClass, ::StringW  name, ::ArrayW<::System::Type*>  args, ::System::Type*  returnType, bool  publicOnly) ;

/// @brief Method GetHashCode, addr 0x180396ee0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetInvocationTarget, addr 0x181e00340, size 0x70, virtual true, abstract: false, final false
inline ::System::Object* GetInvocationTarget(::System::Type*  type, ::System::Object*  instance) ;

/// @brief Method GetSite, addr 0x181e003b0, size 0x70, virtual false, abstract: false, final false
static inline ::System::ComponentModel::ISite* GetSite(::System::Object*  component) ;

static inline ::System::ComponentModel::MemberDescriptor* New_ctor(::StringW  name, ::ArrayW<::System::Attribute*>  attributes) ;

static inline ::System::ComponentModel::MemberDescriptor* New_ctor(::System::ComponentModel::MemberDescriptor*  oldMemberDescriptor, ::ArrayW<::System::Attribute*>  newAttributes) ;
...
constexpr ::ArrayW<::System::Attribute*> const& __cordl_internal_get_attributes() const;

constexpr ::ArrayW<::System::Attribute*>& __cordl_internal_get_attributes() ;
...
constexpr ::ArrayW<::System::Attribute*> const& __cordl_internal_get_originalAttributes() const;

constexpr ::ArrayW<::System::Attribute*>& __cordl_internal_get_originalAttributes() ;

constexpr void __cordl_internal_set_attributeCollection(::System::ComponentModel::AttributeCollection*  value) ;

constexpr void __cordl_internal_set_attributes(::ArrayW<::System::Attribute*>  value) ;
...
constexpr void __cordl_internal_set_originalAttributes(::ArrayW<::System::Attribute*>  value) ;

/// @brief Method .ctor, addr 0x181e00740, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::ArrayW<::System::Attribute*>  attributes) ;

/// @brief Method .ctor, addr 0x181e00420, size 0x320, virtual false, abstract: false, final false
inline void _ctor(::System::ComponentModel::MemberDescriptor*  oldMemberDescriptor, ::ArrayW<::System::Attribute*>  newAttributes) ;

/// @brief Method get_AttributeArray, addr 0x181e00840, size 0x80, virtual true, abstract: false, final false
inline ::ArrayW<::System::Attribute*> get_AttributeArray() ;

/// @brief Method get_Attributes, addr 0x181e008c0, size 0x130, virtual true, abstract: false, final false
inline ::System::ComponentModel::AttributeCollection* get_Attributes() ;

/// @brief Method get_DisplayName, addr 0x181e009f0, size 0xd0, virtual true, abstract: false, final false
inline ::StringW get_DisplayName() ;

/// @brief Method get_Name, addr 0x181b98f00, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method set_AttributeArray, addr 0x181e00ac0, size 0xd0, virtual true, abstract: false, final false
inline void set_AttributeArray(::ArrayW<::System::Attribute*>  value) ;
...
/// @brief Field attributes, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::System::Attribute*>  ___attributes;

/// @brief Field originalAttributes, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::System::Attribute*>  ___originalAttributes;
...
static_assert(sizeof(::System::ComponentModel::MemberDescriptor) == 0x60, "Size mismatch!");
