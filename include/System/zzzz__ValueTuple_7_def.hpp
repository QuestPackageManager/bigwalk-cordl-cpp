...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(ValueTuple_7)
...
// Write type traits
MARK_GEN_VAL_T(::System::ValueTuple_7);
DEFINE_IL2CPP_GEN_CLASS(::System::ValueTuple_7, "System", "ValueTuple`7");
// Dependencies 
namespace System {
// cpp template
template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
// Is value type: true
// CS Name: System.ValueTuple`7<T1,T2,T3,T4,T5,T6,T7>
struct CORDL_TYPE ValueTuple_7 {
public:
// Declarations
...
constexpr operator  ::System::IComparable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>*() ;

/// @brief Convert operator to "::System::IEquatable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>"
constexpr operator  ::System::IEquatable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>*() ;
...
inline int32_t CompareTo(::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>  other) ;

/// @brief Method Equals, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline bool Equals(::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>  other) ;
...
inline void _ctor(T1  item1, T2  item2, T3  item3, T4  item4, T5  item5, T6  item6, T7  item7) ;
...
constexpr ::System::IComparable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>* i___System__IComparable_1___System__ValueTuple_7_T1_T2_T3_T4_T5_T6_T7__() ;

/// @brief Convert to "::System::IEquatable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>"
constexpr ::System::IEquatable_1<::System::ValueTuple_7<T1,T2,T3,T4,T5,T6,T7>>* i___System__IEquatable_1___System__ValueTuple_7_T1_T2_T3_T4_T5_T6_T7__() ;
