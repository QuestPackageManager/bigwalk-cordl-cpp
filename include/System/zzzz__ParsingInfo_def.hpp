...
DEFINE_IL2CPP_CLASS(::System::ParsingInfo, "System", "ParsingInfo");
...
public:
// Declarations
/// @brief Method Init, addr 0x18171bf50, size 0x50, virtual false, abstract: false, final false
inline void Init() ;
...
// Ctor Parameters [CppParam { name: "calendar", ty: "::System::Globalization::Calendar*", modifiers: "", def_value: None }, CppParam { name: "dayOfWeek", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "timeMark", ty: "::System::DateTimeParse_TM", modifiers: "", def_value: None }, CppParam { name: "fUseHour12", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "fUseTwoDigitYear", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "fAllowInnerWhite", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "fAllowTrailingWhite", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "fCustomNumberParser", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "parseNumberDelegate", ty: "::System::DateTimeParse_MatchNumberDelegate*", modifiers: "", def_value: None }]
constexpr ParsingInfo(::System::Globalization::Calendar*  calendar, int32_t  dayOfWeek, ::System::DateTimeParse_TM  timeMark, bool  fUseHour12, bool  fUseTwoDigitYear, bool  fAllowInnerWhite, bool  fAllowTrailingWhite, bool  fCustomNumberParser, ::System::DateTimeParse_MatchNumberDelegate*  parseNumberDelegate) noexcept;
...
static_assert(sizeof(::System::ParsingInfo) == 0x20, "Size mismatch!");
