...
MARK_REF_T(::System::UriParser*);
DEFINE_IL2CPP_CLASS(::System::UriParser_UriQuirksVersion, "System", "UriParser/UriQuirksVersion");
DEFINE_IL2CPP_CLASS(::System::UriParser*, "System", "UriParser");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::UriParser_UriQuirksVersion, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::UriParser_UriQuirksVersion) == 0x4, "Size mismatch!");
...
/// @brief Method FindOrFetchAsUnknownV1Syntax, addr 0x181dc2b80, size 0x270, virtual false, abstract: false, final false
static inline ::System::UriParser* FindOrFetchAsUnknownV1Syntax(::StringW  lwrCaseScheme) ;

/// @brief Method GetComponents, addr 0x181dc2df0, size 0x1b0, virtual true, abstract: false, final false
inline ::StringW GetComponents(::System::Uri*  uri, ::System::UriComponents  components, ::System::UriFormat  format) ;

/// @brief Method GetSyntax, addr 0x181dc2fa0, size 0x90, virtual false, abstract: false, final false
static inline ::System::UriParser* GetSyntax(::StringW  lwrCaseScheme) ;

/// @brief Method InFact, addr 0x181dc3030, size 0x40, virtual false, abstract: false, final false
inline bool InFact(::System::UriSyntaxFlags  flags) ;

/// @brief Method InitializeAndValidate, addr 0x181dc3070, size 0x30, virtual true, abstract: false, final false
inline void InitializeAndValidate(::System::Uri*  uri, ::by_ref<::System::UriFormatException*>  parsingError) ;

/// @brief Method InternalGetComponents, addr 0x181dc30a0, size 0x20, virtual false, abstract: false, final false
inline ::StringW InternalGetComponents(::System::Uri*  thisUri, ::System::UriComponents  uriComponents, ::System::UriFormat  uriFormat) ;

/// @brief Method InternalIsBaseOf, addr 0x181dc30c0, size 0x20, virtual false, abstract: false, final false
inline bool InternalIsBaseOf(::System::Uri*  thisBaseUri, ::System::Uri*  uriLink) ;

/// @brief Method InternalIsWellFormedOriginalString, addr 0x181913e90, size 0x20, virtual false, abstract: false, final false
inline bool InternalIsWellFormedOriginalString(::System::Uri*  thisUri) ;

/// @brief Method InternalOnNewUri, addr 0x181dc30e0, size 0x60, virtual false, abstract: false, final false
inline ::System::UriParser* InternalOnNewUri() ;

/// @brief Method InternalResolve, addr 0x181dc3140, size 0x20, virtual false, abstract: false, final false
inline ::StringW InternalResolve(::System::Uri*  thisBaseUri, ::System::Uri*  uriLink, ::by_ref<::System::UriFormatException*>  parsingError) ;

/// @brief Method InternalValidate, addr 0x181dc3160, size 0x20, virtual false, abstract: false, final false
inline void InternalValidate(::System::Uri*  thisUri, ::by_ref<::System::UriFormatException*>  parsingError) ;

/// @brief Method IsAllSet, addr 0x181dc3180, size 0x40, virtual false, abstract: false, final false
inline bool IsAllSet(::System::UriSyntaxFlags  flags) ;

/// @brief Method IsBaseOf, addr 0x181dc31c0, size 0x20, virtual true, abstract: false, final false
inline bool IsBaseOf(::System::Uri*  baseUri, ::System::Uri*  relativeUri) ;

/// @brief Method IsFullMatch, addr 0x181dc31e0, size 0x40, virtual false, abstract: false, final false
inline bool IsFullMatch(::System::UriSyntaxFlags  flags, ::System::UriSyntaxFlags  expected) ;

/// @brief Method IsWellFormedOriginalString, addr 0x181dc3220, size 0x10, virtual true, abstract: false, final false
inline bool IsWellFormedOriginalString(::System::Uri*  uri) ;

static inline ::System::UriParser* New_ctor() ;

static inline ::System::UriParser* New_ctor(::System::UriSyntaxFlags  flags) ;

/// @brief Method NotAny, addr 0x181dc3230, size 0x40, virtual false, abstract: false, final false
inline bool NotAny(::System::UriSyntaxFlags  flags) ;

/// @brief Method OnNewUri, addr 0x1802e0ba0, size 0x10, virtual true, abstract: false, final false
inline ::System::UriParser* OnNewUri() ;

/// @brief Method Resolve, addr 0x181dc3270, size 0x160, virtual true, abstract: false, final false
inline ::StringW Resolve(::System::Uri*  baseUri, ::System::Uri*  relativeUri, ::by_ref<::System::UriFormatException*>  parsingError) ;
...
/// @brief Method .ctor, addr 0x181dc3e20, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dc3df0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_DefaultPort, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IsSimple, addr 0x181dc3e50, size 0x10, virtual false, abstract: false, final false
inline bool get_IsSimple() ;

/// @brief Method get_SchemeName, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SchemeName() ;

/// @brief Method get_ShouldUseLegacyV2Quirks, addr 0x181dc3e60, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::UriParser) == 0x28, "Size mismatch!");
