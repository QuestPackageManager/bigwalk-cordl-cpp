...
/// @brief Method AddMapping, addr 0x1817458d0, size 0xc0, virtual false, abstract: false, final false
inline void AddMapping(::System::TermInfoStrings  key, ::ArrayW<uint8_t>  val) ;

/// @brief Method Match, addr 0x181745990, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method Sort, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void Sort() ;

/// @brief Method StartsWith, addr 0x181745bb0, size 0x50, virtual false, abstract: false, final false
