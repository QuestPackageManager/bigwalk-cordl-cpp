...
// Write type traits
MARK_REF_T(::System::Net::ProtocolViolationException*);
DEFINE_IL2CPP_CLASS(::System::Net::ProtocolViolationException*, "System.Net", "ProtocolViolationException");
...
/// @brief Method .ctor, addr 0x181e32f10, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Net::ProtocolViolationException) == 0x90, "Size mismatch!");
