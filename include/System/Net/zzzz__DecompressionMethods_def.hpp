...
static_assert(offsetof(::System::Net::DecompressionMethods, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::DecompressionMethods) == 0x4, "Size mismatch!");
