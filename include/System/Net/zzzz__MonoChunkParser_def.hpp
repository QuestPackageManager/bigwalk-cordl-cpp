...
DEFINE_IL2CPP_CLASS(::System::Net::MonoChunkParser_State, "System.Net", "MonoChunkParser/State");
...
static_assert(offsetof(::System::Net::MonoChunkParser_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::MonoChunkParser_State) == 0x4, "Size mismatch!");
...
/// @brief Method Read, addr 0x181d86ad0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetChunkSize, addr 0x181d87bf0, size 0x220, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State GetChunkSize(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  offset, int32_t  size) ;

/// @brief Method InternalWrite, addr 0x181d87e10, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x181d88560, size 0x10, virtual false, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadBody, addr 0x181d88030, size 0x110, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadBody(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadCRLF, addr 0x181d88140, size 0x70, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadCRLF(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadFromChunks, addr 0x181d881b0, size 0x1f0, virtual false, abstract: false, final false
inline int32_t ReadFromChunks(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadTrailer, addr 0x181d883a0, size 0x1c0, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadTrailer(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  offset, int32_t  size) ;

/// @brief Method RemoveChunkExtension, addr 0x181d88570, size 0x40, virtual false, abstract: false, final false
static inline ::StringW RemoveChunkExtension(::StringW  input) ;

/// @brief Method ThrowProtocolViolation, addr 0x181d885b0, size 0x50, virtual false, abstract: false, final false
static inline void ThrowProtocolViolation(::StringW  message) ;

/// @brief Method Write, addr 0x181d88600, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d88630, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Net::WebHeaderCollection*  headers) ;

/// @brief Method get_ChunkLeft, addr 0x181d886c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ChunkLeft() ;

/// @brief Method get_DataAvailable, addr 0x181d886d0, size 0xe0, virtual false, abstract: false, final false
inline bool get_DataAvailable() ;

/// @brief Method get_WantMore, addr 0x181d887b0, size 0x20, virtual false, abstract: false, final false
