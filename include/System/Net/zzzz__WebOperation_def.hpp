...
/// @brief Method MoveNext, addr 0x181d90000, size 0x530, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::WebOperation*", modifiers: "", def_value: None }, CppParam { name: "_requestStream_5__2", ty: "::System::Net::WebRequestStream*", modifiers: "", def_value: None }, CppParam { name: "_stream_5__3", ty: "::System::Net::WebResponseStream*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::WebRequestStream*>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Net::WebOperation__Run_d__58) == 0x60, "Size mismatch!");
...
/// @brief Method Abort, addr 0x181d93c90, size 0xc0, virtual false, abstract: false, final false
inline void Abort() ;

/// @brief Method CheckDisposed, addr 0x181d93d50, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method CheckThrowDisposed, addr 0x181d93dc0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x181d93ea0, size 0xd0, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method CompleteRequestWritten, addr 0x181d93f70, size 0x90, virtual false, abstract: false, final false
inline void CompleteRequestWritten(::System::Net::WebRequestStream*  stream, ::System::Exception*  error) ;

/// @brief Method Finish, addr 0x181d94000, size 0x250, virtual false, abstract: false, final false
inline void Finish(bool  ok, ::System::Exception*  error) ;

/// @brief Method GetRequestStreamInternal, addr 0x181d94250, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal() ;

/// @brief Method GetResponseStream, addr 0x181d94260, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method RegisterRequest, addr 0x181d94270, size 0x180, virtual false, abstract: false, final false
inline void RegisterRequest(::System::Net::ServicePoint*  servicePoint, ::System::Net::WebConnection*  connection) ;

/// @brief Method Run, addr 0x181d943f0, size 0x80, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method SetCanceled, addr 0x181d94470, size 0x80, virtual false, abstract: false, final false
inline void SetCanceled() ;

/// @brief Method SetDisposed, addr 0x181d944f0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SetError, addr 0x181d945a0, size 0x60, virtual false, abstract: false, final false
inline void SetError(::System::Exception*  error) ;

/// @brief Method SetPriorityRequest, addr 0x181d94600, size 0xe0, virtual false, abstract: false, final false
inline void SetPriorityRequest(::System::Net::WebOperation*  operation) ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x181d946e0, size 0x70, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed() ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x181d94750, size 0x70, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ThrowIfDisposed, addr 0x181d94820, size 0x70, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method ThrowIfDisposed, addr 0x181d947c0, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method <RegisterRequest>b__48_0, addr 0x181d94890, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d94930, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method get_Aborted, addr 0x181d94a60, size 0x50, virtual false, abstract: false, final false
inline bool get_Aborted() ;

/// @brief Method get_Closed, addr 0x181d94ab0, size 0x50, virtual false, abstract: false, final false
inline bool get_Closed() ;

/// @brief Method get_Connection, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* get_Connection() ;

/// @brief Method get_Finished, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool,::System::Net::WebOperation*>>* get_Finished() ;

/// @brief Method get_IsNtlmChallenge, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ServicePoint, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

/// @brief Method get_WriteBuffer, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::BufferOffsetSize* get_WriteBuffer() ;

/// @brief Method get_WriteStream, addr 0x181d94b00, size 0x70, virtual false, abstract: false, final false
inline ::System::Net::WebRequestStream* get_WriteStream() ;

/// @brief Method set_Connection, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_Connection(::System::Net::WebConnection*  value) ;

/// @brief Method set_ServicePoint, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
