...
DEFINE_IL2CPP_CLASS(::System::Net::Security::AuthenticationLevel, "System.Net.Security", "AuthenticationLevel");
// Dependencies 
namespace System::Net::Security {
// Is value type: true
...
/// @brief Field MutualAuthRequested value: I32(1)
static ::System::Net::Security::AuthenticationLevel const MutualAuthRequested;

/// @brief Field MutualAuthRequired value: I32(2)
...
static_assert(offsetof(::System::Net::Security::AuthenticationLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::Security::AuthenticationLevel) == 0x4, "Size mismatch!");
