...
// Write type traits
MARK_REF_T(::System::Net::Security::SslClientAuthenticationOptions*);
DEFINE_IL2CPP_CLASS(::System::Net::Security::SslClientAuthenticationOptions*, "System.Net.Security", "SslClientAuthenticationOptions");
...
/// @brief Field <ClientCertificates>k__BackingField, offset 0x28, size 0x8 
...
/// @brief Field <TargetHost>k__BackingField, offset 0x20, size 0x8 
...
/// @brief Method .ctor, addr 0x181d4c550, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AllowRenegotiation, addr 0x1804bdaf0, size 0x10, virtual false, abstract: false, final false
inline bool get_AllowRenegotiation() ;

/// @brief Method get_ClientCertificates, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates() ;

/// @brief Method get_EnabledSslProtocols, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Authentication::SslProtocols get_EnabledSslProtocols() ;

/// @brief Method get_TargetHost, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_TargetHost() ;

/// @brief Method set_CertificateRevocationCheckMode, addr 0x181dacd80, size 0x60, virtual false, abstract: false, final false
inline void set_CertificateRevocationCheckMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode  value) ;

/// @brief Method set_ClientCertificates, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_ClientCertificates(::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  value) ;

/// @brief Method set_EnabledSslProtocols, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_EnabledSslProtocols(::System::Security::Authentication::SslProtocols  value) ;

/// @brief Method set_EncryptionPolicy, addr 0x181dacde0, size 0x60, virtual false, abstract: false, final false
inline void set_EncryptionPolicy(::System::Net::Security::EncryptionPolicy  value) ;

/// @brief Method set_TargetHost, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field <TargetHost>k__BackingField, offset: 0x20, size: 0x8, def value: None
 ::StringW  ____TargetHost_k__BackingField;

/// @brief Field <ClientCertificates>k__BackingField, offset: 0x28, size: 0x8, def value: None
...
static_assert(offsetof(::System::Net::Security::SslClientAuthenticationOptions, ____TargetHost_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Net::Security::SslClientAuthenticationOptions, ____ClientCertificates_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(sizeof(::System::Net::Security::SslClientAuthenticationOptions) == 0x30, "Size mismatch!");
