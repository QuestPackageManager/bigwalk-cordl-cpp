...
// Write type traits
MARK_REF_T(::System::Net::Security::AuthenticatedStream*);
DEFINE_IL2CPP_CLASS(::System::Net::Security::AuthenticatedStream*, "System.Net.Security", "AuthenticatedStream");
...
/// @brief Method Dispose, addr 0x181dac1a0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dac200, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  innerStream, bool  leaveInnerStreamOpen) ;

/// @brief Method get_InnerStream, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Security::AuthenticatedStream) == 0x38, "Size mismatch!");
