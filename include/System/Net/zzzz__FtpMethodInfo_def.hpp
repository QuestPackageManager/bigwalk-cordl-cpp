...
// Write type traits
MARK_REF_T(::System::Net::FtpMethodInfo*);
DEFINE_IL2CPP_CLASS(::System::Net::FtpMethodInfo*, "System.Net", "FtpMethodInfo");
...
/// @brief Field s_knownMethodInfo, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_knownMethodInfo, put=setStaticF_s_knownMethodInfo)) ::ArrayW<::System::Net::FtpMethodInfo*>  s_knownMethodInfo;

/// @brief Method GetMethodInfo, addr 0x181e29e30, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Net::FtpMethodInfo* GetMethodInfo(::StringW  method) ;

/// @brief Method HasFlag, addr 0x181e29f00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e2a3b0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  method, ::System::Net::FtpOperation  operation, ::System::Net::FtpMethodFlags  flags, ::StringW  httpCommand) ;

static inline ::ArrayW<::System::Net::FtpMethodInfo*> getStaticF_s_knownMethodInfo() ;

/// @brief Method get_IsCommandOnly, addr 0x181e2a400, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCommandOnly() ;

/// @brief Method get_IsDownload, addr 0x181c21570, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDownload() ;

/// @brief Method get_IsUpload, addr 0x181e2a410, size 0x10, virtual false, abstract: false, final false
inline bool get_IsUpload() ;

/// @brief Method get_ShouldParseForResponseUri, addr 0x181e2a420, size 0x10, virtual false, abstract: false, final false
inline bool get_ShouldParseForResponseUri() ;

static inline void setStaticF_s_knownMethodInfo(::ArrayW<::System::Net::FtpMethodInfo*>  value) ;
...
static_assert(sizeof(::System::Net::FtpMethodInfo) == 0x28, "Size mismatch!");
