...
// Write type traits
MARK_REF_T(::GlobalNamespace::IPAddress_ReadOnlyIPAddress*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IPAddress_ReadOnlyIPAddress*, "System.Net", "IPAddress/ReadOnlyIPAddress");
...
static_assert(sizeof(::GlobalNamespace::IPAddress_ReadOnlyIPAddress) == 0x30, "Size mismatch!");
