...
// Write type traits
MARK_REF_T(::System::Net::BufferOffsetSize*);
DEFINE_IL2CPP_CLASS(::System::Net::BufferOffsetSize*, "System.Net", "BufferOffsetSize");
...
static inline ::System::Net::BufferOffsetSize* New_ctor(::ArrayW<uint8_t>  buffer, bool  copyBuffer) ;

static inline ::System::Net::BufferOffsetSize* New_ctor(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size, bool  copyBuffer) ;
...
/// @brief Method .ctor, addr 0x181e233c0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  buffer, bool  copyBuffer) ;

/// @brief Method .ctor, addr 0x181e23450, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::BufferOffsetSize) == 0x20, "Size mismatch!");
