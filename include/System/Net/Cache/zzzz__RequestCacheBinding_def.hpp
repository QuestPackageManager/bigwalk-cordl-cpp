...
// Write type traits
MARK_REF_T(::System::Net::Cache::RequestCacheBinding*);
DEFINE_IL2CPP_CLASS(::System::Net::Cache::RequestCacheBinding*, "System.Net.Cache", "RequestCacheBinding");
...
/// @brief Method get_Cache, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::Cache::RequestCache* get_Cache() ;

/// @brief Method get_Validator, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Cache::RequestCacheBinding) == 0x20, "Size mismatch!");
