...
// Write type traits
MARK_REF_T(::System::Net::LazyAsyncResult*);
MARK_REF_T(::System::Net::LazyAsyncResult_ThreadContext*);
DEFINE_IL2CPP_CLASS(::System::Net::LazyAsyncResult*, "System.Net", "LazyAsyncResult");
DEFINE_IL2CPP_CLASS(::System::Net::LazyAsyncResult_ThreadContext*, "System.Net", "LazyAsyncResult/ThreadContext");
...
static_assert(sizeof(::System::Net::LazyAsyncResult_ThreadContext) == 0x18, "Size mismatch!");
...
/// @brief Method Cleanup, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Complete, addr 0x181e47110, size 0x1a0, virtual true, abstract: false, final false
inline void Complete(::System::IntPtr  userToken) ;

/// @brief Method InternalWaitForCompletion, addr 0x181e472b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* InternalWaitForCompletion() ;

/// @brief Method InvokeCallback, addr 0x181e472c0, size 0x10, virtual false, abstract: false, final false
inline void InvokeCallback() ;

/// @brief Method InvokeCallback, addr 0x181e472d0, size 0x10, virtual false, abstract: false, final false
inline void InvokeCallback(::System::Object*  result) ;

/// @brief Method LazilyCreateEvent, addr 0x181e472e0, size 0x140, virtual false, abstract: false, final false
inline bool LazilyCreateEvent(::by_ref<::System::Threading::ManualResetEvent*>  waitHandle) ;
...
/// @brief Method ProtectedInvokeCallback, addr 0x181e47420, size 0x130, virtual false, abstract: false, final false
inline void ProtectedInvokeCallback(::System::Object*  result, ::System::IntPtr  userToken) ;

/// @brief Method WaitForCompletion, addr 0x181e47550, size 0x190, virtual false, abstract: false, final false
inline ::System::Object* WaitForCompletion(bool  snap) ;

/// @brief Method WorkerThreadComplete, addr 0x181e476e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e47760, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncCallback, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::AsyncCallback* get_AsyncCallback() ;

/// @brief Method get_AsyncObject, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_AsyncObject() ;

/// @brief Method get_AsyncState, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x181e477f0, size 0xa0, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x181e47890, size 0x30, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_CurrentThreadContext, addr 0x181e478c0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Net::LazyAsyncResult_ThreadContext* get_CurrentThreadContext() ;

/// @brief Method get_EndCalled, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_EndCalled() ;

/// @brief Method get_InternalPeekCompleted, addr 0x181e47920, size 0x10, virtual false, abstract: false, final false
inline bool get_InternalPeekCompleted() ;

/// @brief Method get_IsCompleted, addr 0x181e47930, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method set_EndCalled, addr 0x180c29b80, size 0x2090, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::LazyAsyncResult) == 0x40, "Size mismatch!");
