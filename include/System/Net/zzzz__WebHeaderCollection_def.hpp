...
DEFINE_IL2CPP_CLASS(::System::Net::WebHeaderCollection_RfcChar, "System.Net", "WebHeaderCollection/RfcChar");
...
static_assert(offsetof(::System::Net::WebHeaderCollection_RfcChar, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::System::Net::WebHeaderCollection_RfcChar) == 0x1, "Size mismatch!");
...
/// @brief Field RfcCharMap, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_RfcCharMap, put=setStaticF_RfcCharMap)) ::ArrayW<::System::Net::WebHeaderCollection_RfcChar>  RfcCharMap;
...
/// @brief Method Add, addr 0x181e348c0, size 0x1e0, virtual false, abstract: false, final false
inline void Add(::StringW  header) ;

/// @brief Method Add, addr 0x181e34760, size 0x160, virtual true, abstract: false, final false
inline void Add(::StringW  name, ::StringW  value) ;

/// @brief Method AddInternal, addr 0x181e34700, size 0x60, virtual false, abstract: false, final false
inline void AddInternal(::StringW  name, ::StringW  value) ;

/// @brief Method AllowMultiValues, addr 0x181e34aa0, size 0xe0, virtual false, abstract: false, final false
static inline bool AllowMultiValues(::StringW  name) ;

/// @brief Method ChangeInternal, addr 0x181e34b80, size 0x60, virtual false, abstract: false, final false
inline void ChangeInternal(::StringW  name, ::StringW  value) ;

/// @brief Method CheckBadChars, addr 0x181e34be0, size 0x3a0, virtual false, abstract: false, final false
static inline ::StringW CheckBadChars(::StringW  name, bool  isHeaderValue) ;

/// @brief Method ContainsNonAsciiChars, addr 0x181e34f80, size 0x70, virtual false, abstract: false, final false
static inline bool ContainsNonAsciiChars(::StringW  token) ;

/// @brief Method Get, addr 0x181e35930, size 0x50, virtual true, abstract: false, final false
inline ::StringW Get(int32_t  index) ;

/// @brief Method Get, addr 0x181e35690, size 0x2a0, virtual true, abstract: false, final false
inline ::StringW Get(::StringW  name) ;

/// @brief Method GetAsString, addr 0x181e34ff0, size 0x200, virtual false, abstract: false, final false
static inline ::StringW GetAsString(::System::Collections::Specialized::NameValueCollection*  cc, bool  winInetCompat, bool  forTrace) ;

/// @brief Method GetEnumerator, addr 0x181e351f0, size 0x50, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetKey, addr 0x181e35240, size 0x50, virtual true, abstract: false, final false
inline ::StringW GetKey(int32_t  index) ;

/// @brief Method GetObjectData, addr 0x181e35290, size 0x160, virtual true, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method GetValues, addr 0x181e353f0, size 0x2a0, virtual true, abstract: false, final false
...
/// @brief Method NormalizeCommonHeaders, addr 0x181e35980, size 0xe0, virtual false, abstract: false, final false
inline void NormalizeCommonHeaders() ;

/// @brief Method OnDeserialization, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnDeserialization(::System::Object*  sender) ;

/// @brief Method Remove, addr 0x181e35ab0, size 0x80, virtual false, abstract: false, final false
inline void Remove(::System::Net::HttpRequestHeader  header) ;

/// @brief Method Remove, addr 0x181e35b30, size 0x90, virtual true, abstract: false, final false
inline void Remove(::StringW  name) ;

/// @brief Method RemoveInternal, addr 0x181e35a60, size 0x50, virtual false, abstract: false, final false
inline void RemoveInternal(::StringW  name) ;

/// @brief Method Set, addr 0x181e35d30, size 0x180, virtual true, abstract: false, final false
inline void Set(::StringW  name, ::StringW  value) ;

/// @brief Method SetInternal, addr 0x181e35bc0, size 0x170, virtual false, abstract: false, final false
inline void SetInternal(::StringW  name, ::StringW  value) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x181e35eb0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method ThrowOnRestrictedHeader, addr 0x181e35ee0, size 0x1d0, virtual false, abstract: false, final false
inline void ThrowOnRestrictedHeader(::StringW  headerName) ;

/// @brief Method ToString, addr 0x181e360b0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e365c0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181e363e0, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method .ctor, addr 0x181e36610, size 0xb0, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Net::WebHeaderCollection_RfcChar> getStaticF_RfcCharMap() ;

static inline ::ArrayW<int8_t> getStaticF_s_CommonHeaderHints() ;

static inline ::ArrayW<::StringW> getStaticF_s_CommonHeaderNames() ;

/// @brief Method get_AllowHttpRequestHeader, addr 0x181e366c0, size 0x30, virtual false, abstract: false, final false
inline bool get_AllowHttpRequestHeader() ;

/// @brief Method get_Count, addr 0x181e366f0, size 0x40, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_InnerCollection, addr 0x181e36730, size 0xa0, virtual false, abstract: false, final false
...
static inline void setStaticF_RfcCharMap(::ArrayW<::System::Net::WebHeaderCollection_RfcChar>  value) ;
...
static_assert(sizeof(::System::Net::WebHeaderCollection) == 0x80, "Size mismatch!");
