...
DEFINE_IL2CPP_CLASS(::System::Net::TimerNode_TimerThread_TimerState, "System.Net", "TimerThread/TimerNode/TimerState");
...
/// @brief Method get_Duration, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1818fc850, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x181e49e60, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;

/// @brief Method get_Expiration, addr 0x181e49e80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_StartTime, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e38920, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method CreateTimer, addr 0x181e48780, size 0x280, virtual true, abstract: false, final false
inline ::System::Net::TimerThread_Timer* CreateTimer(::System::Net::TimerThread_Callback*  callback, ::System::Object*  context) ;

/// @brief Method Fire, addr 0x181e48a00, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e48b70, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;
...
public:
// Declarations
/// @brief Method CreateTimer, addr 0x181e470a0, size 0x30, virtual true, abstract: false, final false
inline ::System::Net::TimerThread_Timer* CreateTimer(::System::Net::TimerThread_Callback*  callback, ::System::Object*  context) ;
...
// Non member Declarations
static_assert(offsetof(::System::Net::TimerNode_TimerThread_TimerState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::TimerNode_TimerThread_TimerState) == 0x4, "Size mismatch!");
...
/// @brief Method Cancel, addr 0x181e48370, size 0x130, virtual true, abstract: false, final false
inline bool Cancel() ;

/// @brief Method Fire, addr 0x181e484a0, size 0x220, virtual false, abstract: false, final false
inline bool Fire() ;
...
/// @brief Method .ctor, addr 0x181e486c0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181e486f0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_HasExpired, addr 0x181e48770, size 0x10, virtual true, abstract: false, final false
inline bool get_HasExpired() ;

/// @brief Method get_Next, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::TimerThread_TimerNode* get_Next() ;

/// @brief Method get_Prev, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::TimerThread_TimerNode* get_Prev() ;

/// @brief Method set_Next, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void set_Next(::System::Net::TimerThread_TimerNode*  value) ;

/// @brief Method set_Prev, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Cancel, addr 0x181e470d0, size 0x20, virtual true, abstract: false, final false
inline bool Cancel() ;
...
/// @brief Method .ctor, addr 0x181e470f0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasExpired, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_HasExpired() ;
...
/// @brief Method CreateQueue, addr 0x181e48bf0, size 0x180, virtual false, abstract: false, final false
static inline ::System::Net::TimerThread_Queue* CreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method GetOrCreateQueue, addr 0x181e48d70, size 0x700, virtual false, abstract: false, final false
static inline ::System::Net::TimerThread_Queue* GetOrCreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method IsTickBetween, addr 0x181e49470, size 0x20, virtual false, abstract: false, final false
static inline bool IsTickBetween(int32_t  start, int32_t  end, int32_t  comparand) ;

/// @brief Method OnDomainUnload, addr 0x181e49490, size 0x70, virtual false, abstract: false, final false
static inline void OnDomainUnload(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method Prod, addr 0x181e49500, size 0xc0, virtual false, abstract: false, final false
static inline void Prod() ;

/// @brief Method StopTimerThread, addr 0x181e495c0, size 0x60, virtual false, abstract: false, final false
static inline void StopTimerThread() ;

/// @brief Method ThreadProc, addr 0x181e49620, size 0x610, virtual false, abstract: false, final false
