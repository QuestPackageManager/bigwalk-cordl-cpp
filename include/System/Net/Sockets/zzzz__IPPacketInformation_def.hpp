...
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::IPPacketInformation, "System.Net.Sockets", "IPPacketInformation");
// Dependencies 
namespace System::Net::Sockets {
// Is value type: true
...
public:
// Declarations
/// @brief Method Equals, addr 0x181d97440, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x181d974e0, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Net::Sockets::IPPacketInformation) == 0x10, "Size mismatch!");
