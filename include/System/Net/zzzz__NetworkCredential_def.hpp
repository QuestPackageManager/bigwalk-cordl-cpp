...
// Write type traits
MARK_REF_T(::System::Net::NetworkCredential*);
DEFINE_IL2CPP_CLASS(::System::Net::NetworkCredential*, "System.Net", "NetworkCredential");
...
/// @brief Method GetCredential, addr 0x1802e0ba0, size 0x10, virtual true, abstract: false, final true
inline ::System::Net::NetworkCredential* GetCredential(::System::Uri*  uri, ::StringW  authType) ;

/// @brief Method InternalGetDomain, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW InternalGetDomain() ;

/// @brief Method InternalGetPassword, addr 0x181e32a40, size 0x10, virtual false, abstract: false, final false
inline ::StringW InternalGetPassword() ;

/// @brief Method InternalGetUserName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e32ae0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password) ;

/// @brief Method .ctor, addr 0x181e32a50, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password, ::StringW  domain) ;

/// @brief Method get_Domain, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_Password, addr 0x181e32a40, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Password() ;

/// @brief Method get_UserName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_UserName() ;

/// @brief Convert to "::System::Net::ICredentials"
constexpr ::System::Net::ICredentials* i___System__Net__ICredentials() noexcept;

/// @brief Method set_Domain, addr 0x181e32b80, size 0x30, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Password, addr 0x181e32bb0, size 0x30, virtual false, abstract: false, final false
inline void set_Password(::StringW  value) ;

/// @brief Method set_UserName, addr 0x181e32be0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::NetworkCredential) == 0x28, "Size mismatch!");
