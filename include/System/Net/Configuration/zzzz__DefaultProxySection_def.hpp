...
/// @brief Method Reset, addr 0x181dac360, size 0x20, virtual true, abstract: false, final false
inline void Reset(::System::Configuration::ConfigurationElement*  parentElement) ;

/// @brief Method .ctor, addr 0x181dac380, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x181dac3a0, size 0x20, virtual true, abstract: false, final false
