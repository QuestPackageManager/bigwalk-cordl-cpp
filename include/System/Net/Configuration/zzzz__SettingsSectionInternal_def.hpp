...
/// @brief Method get_Ipv6Enabled, addr 0x1802f6470, size 0x10, virtual false, abstract: false, final false
inline bool get_Ipv6Enabled() ;

/// @brief Method get_Section, addr 0x181d997b0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Configuration::SettingsSectionInternal) == 0x18, "Size mismatch!");
