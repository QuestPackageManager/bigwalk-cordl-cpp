...
// Write type traits
MARK_REF_T(::System::Net::Configuration::DefaultProxySectionInternal*);
DEFINE_IL2CPP_CLASS(::System::Net::Configuration::DefaultProxySectionInternal*, "System.Net.Configuration", "DefaultProxySectionInternal");
...
/// @brief Method GetDefaultProxy_UsingOldMonoCode, addr 0x181d97290, size 0x10, virtual false, abstract: false, final false
static inline ::System::Net::IWebProxy* GetDefaultProxy_UsingOldMonoCode() ;

/// @brief Method GetSection, addr 0x181d972a0, size 0x110, virtual false, abstract: false, final false
static inline ::System::Net::Configuration::DefaultProxySectionInternal* GetSection() ;

/// @brief Method GetSystemWebProxy, addr 0x181d97290, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ClassSyncObject, addr 0x181d973b0, size 0x70, virtual false, abstract: false, final false
static inline ::System::Object* get_ClassSyncObject() ;

/// @brief Method get_WebProxy, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Configuration::DefaultProxySectionInternal) == 0x18, "Size mismatch!");
