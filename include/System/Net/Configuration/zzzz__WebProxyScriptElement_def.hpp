...
/// @brief Method .ctor, addr 0x181dae1e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x181dae200, size 0x20, virtual true, abstract: false, final false
