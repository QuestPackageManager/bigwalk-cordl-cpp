...
// Write type traits
MARK_REF_T(::System::Net::ServicePoint*);
DEFINE_IL2CPP_CLASS(::System::Net::ServicePoint*, "System.Net", "ServicePoint");
...
/// @brief Method CallEndPointDelegate, addr 0x181d8a410, size 0xb0, virtual false, abstract: false, final false
inline bool CallEndPointDelegate(::System::Net::Sockets::Socket*  sock, ::System::Net::IPEndPoint*  remote) ;

/// @brief Method FreeServicePoint, addr 0x181d8a4c0, size 0x20, virtual false, abstract: false, final false
inline void FreeServicePoint() ;

/// @brief Method KeepAliveSetup, addr 0x181d8a4e0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method PutBytes, addr 0x181d8a590, size 0x30, virtual false, abstract: false, final false
static inline void PutBytes(::ArrayW<uint8_t>  bytes, uint32_t  v, int32_t  offset) ;

/// @brief Method SendRequest, addr 0x181d8a5c0, size 0x110, virtual false, abstract: false, final false
inline void SendRequest(::System::Net::WebOperation*  operation, ::StringW  groupName) ;

/// @brief Method SetTcpKeepAlive, addr 0x181d8a6d0, size 0x60, virtual false, abstract: false, final false
inline void SetTcpKeepAlive(bool  enabled, int32_t  keepAliveTime, int32_t  keepAliveInterval) ;

/// @brief Method SetVersion, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void SetVersion(::System::Version*  version) ;

/// @brief Method UpdateClientCertificate, addr 0x181d8a730, size 0x50, virtual false, abstract: false, final false
inline void UpdateClientCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate*  certificate) ;

/// @brief Method UpdateServerCertificate, addr 0x181d8a780, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d8a7d0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method get_ConnectionLimit, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ConnectionLimit() ;

/// @brief Method get_HasTimedOut, addr 0x181d8a990, size 0xa0, virtual false, abstract: false, final false
inline bool get_HasTimedOut() ;

/// @brief Method get_HostEntry, addr 0x181d8aa30, size 0x2c0, virtual false, abstract: false, final false
inline ::System::Net::IPHostEntry* get_HostEntry() ;

/// @brief Method get_Key, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::ServicePointManager_SPKey* get_Key() ;

/// @brief Method get_ProtocolVersion, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
inline ::System::Version* get_ProtocolVersion() ;

/// @brief Method get_Scheduler, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::ServicePointScheduler* get_Scheduler() ;

/// @brief Method get_SendContinue, addr 0x181d8acf0, size 0x70, virtual false, abstract: false, final false
inline bool get_SendContinue() ;

/// @brief Method get_UseConnect, addr 0x18049d830, size 0x10, virtual false, abstract: false, final false
inline bool get_UseConnect() ;

/// @brief Method get_UseNagleAlgorithm, addr 0x180391c90, size 0x10, virtual false, abstract: false, final false
inline bool get_UseNagleAlgorithm() ;

/// @brief Method get_UsesProxy, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_UsesProxy() ;

/// @brief Method set_Expect100Continue, addr 0x18049c420, size 0x10, virtual false, abstract: false, final false
inline void set_Expect100Continue(bool  value) ;

/// @brief Method set_Scheduler, addr 0x1803d5ad0, size 0x10, virtual false, abstract: false, final false
inline void set_Scheduler(::System::Net::ServicePointScheduler*  value) ;

/// @brief Method set_SendContinue, addr 0x18049c420, size 0x10, virtual false, abstract: false, final false
inline void set_SendContinue(bool  value) ;

/// @brief Method set_UseConnect, addr 0x18049d840, size 0x10, virtual false, abstract: false, final false
inline void set_UseConnect(bool  value) ;

/// @brief Method set_UseNagleAlgorithm, addr 0x180391cb0, size 0x10, virtual false, abstract: false, final false
inline void set_UseNagleAlgorithm(bool  value) ;

/// @brief Method set_UsesProxy, addr 0x180499eb0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::ServicePoint) == 0x90, "Size mismatch!");
