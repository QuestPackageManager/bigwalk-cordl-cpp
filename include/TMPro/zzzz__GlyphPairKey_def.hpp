...
public:
// Declarations
/// @brief Method .ctor, addr 0x1821949d0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(uint32_t  firstGlyphIndex, uint32_t  secondGlyphIndex) ;

/// @brief Method .ctor, addr 0x1821949f0, size 0x30, virtual false, abstract: false, final false
