...
DEFINE_IL2CPP_CLASS(::TMPro::AlternateSubstitutionRecord, "TMPro", "AlternateSubstitutionRecord");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(sizeof(::TMPro::AlternateSubstitutionRecord) == 0x1, "Size mismatch!");
