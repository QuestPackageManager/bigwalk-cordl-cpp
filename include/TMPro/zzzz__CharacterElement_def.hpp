...
DEFINE_IL2CPP_CLASS(::TMPro::CharacterElement, "TMPro", "CharacterElement");
// Dependencies 
namespace TMPro {
// Is value type: true
...
/// @brief Method .ctor, addr 0x1821c7730, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::TMPro::TMP_TextElement*  textElement) ;

/// @brief Method get_Unicode, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_Unicode() ;

/// @brief Method set_Unicode, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::CharacterElement) == 0x10, "Size mismatch!");
