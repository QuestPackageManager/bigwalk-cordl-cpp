...
DEFINE_IL2CPP_CLASS(::TMPro::VerticalAlignmentOptions, "TMPro", "VerticalAlignmentOptions");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::VerticalAlignmentOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::VerticalAlignmentOptions) == 0x4, "Size mismatch!");
