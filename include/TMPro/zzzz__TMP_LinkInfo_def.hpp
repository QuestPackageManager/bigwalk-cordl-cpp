...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_LinkInfo, "TMPro", "TMP_LinkInfo");
// Dependencies 
namespace TMPro {
// Is value type: true
...
public:
// Declarations
/// @brief Method GetLink, addr 0x1821e8cb0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetLink() ;

/// @brief Method GetLinkID, addr 0x1821e8bb0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetLinkID() ;

/// @brief Method GetLinkText, addr 0x1821e8c10, size 0xa0, virtual false, abstract: false, final false
inline ::StringW GetLinkText() ;

/// @brief Method SetLinkID, addr 0x1821e8d10, size 0xe0, virtual false, abstract: false, final false
...
constexpr TMP_LinkInfo(::UnityW<::TMPro::TMP_Text>  textComponent, int32_t  hashCode, int32_t  linkIdFirstCharacterIndex, int32_t  linkIdLength, int32_t  linkTextfirstCharacterIndex, int32_t  linkTextLength, ::ArrayW<char16_t>  linkID) noexcept;
...
static_assert(sizeof(::TMPro::TMP_LinkInfo) == 0x28, "Size mismatch!");
