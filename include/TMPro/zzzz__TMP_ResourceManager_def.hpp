...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_ResourceManager_FontAssetRef, "TMPro", "TMP_ResourceManager/FontAssetRef");
// Dependencies 
namespace TMPro {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1821c77e0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_ResourceManager_FontAssetRef) == 0x20, "Size mismatch!");
...
/// @brief Field s_FontAssetReferences, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_FontAssetReferences, put=setStaticF_s_FontAssetReferences)) ::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_ResourceManager_FontAssetRef>*  s_FontAssetReferences;
...
/// @brief Method AddFontAsset, addr 0x1821cdea0, size 0x3e0, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method ClearFontAssetGlyphCache, addr 0x1821ce280, size 0x10, virtual false, abstract: false, final false
static inline void ClearFontAssetGlyphCache() ;

/// @brief Method GetTextSettings, addr 0x1821ce290, size 0x90, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> GetTextSettings() ;

static inline ::TMPro::TMP_ResourceManager* New_ctor() ;

/// @brief Method RebuildFontAssetCache, addr 0x1821ce320, size 0x260, virtual false, abstract: false, final false
static inline void RebuildFontAssetCache() ;

/// @brief Method RemoveFontAsset, addr 0x1821ce580, size 0xd0, virtual false, abstract: false, final false
static inline void RemoveFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method TryGetFontAssetByFamilyName, addr 0x1821ce650, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method TryGetFontAssetByName, addr 0x1821ce6f0, size 0x70, virtual false, abstract: false, final false
