...
/// @brief Method MoveNext, addr 0x1821fde80, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x1821fdf20, size 0xb0, virtual true, abstract: false, final true
inline bool MoveNext() ;
...
/// @brief Method Awake, addr 0x1821f0cb0, size 0x240, virtual true, abstract: false, final false
inline void Awake() ;
...
/// @brief Method ClearMesh, addr 0x1821f0ef0, size 0xa0, virtual true, abstract: false, final false
inline void ClearMesh() ;

/// @brief Method ComputeMarginSize, addr 0x1821f0f90, size 0x100, virtual true, abstract: false, final false
inline void ComputeMarginSize() ;

/// @brief Method Cull, addr 0x1821f1090, size 0x180, virtual true, abstract: false, final false
inline void Cull(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method DelayedGraphicRebuild, addr 0x1821f1210, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DelayedGraphicRebuild() ;

/// @brief Method DelayedMaterialRebuild, addr 0x1821f1260, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method DisableMasking, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void DisableMasking() ;

/// @brief Method EnableMasking, addr 0x1821f1330, size 0x1b0, virtual false, abstract: false, final false
inline void EnableMasking() ;

/// @brief Method ForceMeshUpdate, addr 0x1821f14e0, size 0x60, virtual true, abstract: false, final false
inline void ForceMeshUpdate(bool  ignoreActiveState, bool  forceTextReparsing) ;

/// @brief Method GenerateTextMesh, addr 0x1821dee90, size 0x9490, virtual true, abstract: false, final false
inline void GenerateTextMesh() ;

/// @brief Method GetCanvas, addr 0x1821f1750, size 0xe0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> GetCanvas() ;

/// @brief Method GetCanvasSpaceClippingRect, addr 0x1821f1540, size 0x210, virtual true, abstract: false, final false
inline ::UnityEngine::Rect GetCanvasSpaceClippingRect() ;

/// @brief Method GetCompoundBounds, addr 0x1821f1830, size 0x230, virtual true, abstract: false, final false
inline ::UnityEngine::Bounds GetCompoundBounds() ;

/// @brief Method GetMaterial, addr 0x1821f1a60, size 0x120, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method GetMaterials, addr 0x1821f1b80, size 0x140, virtual true, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Material>> GetMaterials(::ArrayW<::UnityEngine::Material*>  mats) ;

/// @brief Method GetModifiedMaterial, addr 0x1821f1cc0, size 0x100, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetModifiedMaterial(::UnityEngine::Material*  baseMaterial) ;

/// @brief Method GetSharedMaterials, addr 0x1821f1dc0, size 0x100, virtual true, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Material>> GetSharedMaterials() ;

/// @brief Method GetTextContainerLocalCorners, addr 0x1821f1ec0, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3> GetTextContainerLocalCorners() ;

/// @brief Method GetTextInfo, addr 0x1821f1f30, size 0xc0, virtual true, abstract: false, final false
inline ::TMPro::TMP_TextInfo* GetTextInfo(::StringW  text) ;

/// @brief Method InternalCrossFadeAlpha, addr 0x1821f1ff0, size 0xb0, virtual true, abstract: false, final false
inline void InternalCrossFadeAlpha(float_t  alpha, float_t  duration, bool  ignoreTimeScale) ;

/// @brief Method InternalCrossFadeColor, addr 0x1821f20a0, size 0xe0, virtual true, abstract: false, final false
inline void InternalCrossFadeColor(::UnityEngine::Color  targetColor, float_t  duration, bool  ignoreTimeScale, bool  useAlpha) ;

/// @brief Method InternalUpdate, addr 0x1821f2180, size 0x460, virtual true, abstract: false, final false
inline void InternalUpdate() ;

/// @brief Method LoadFontAsset, addr 0x1821f25e0, size 0x3e0, virtual true, abstract: false, final false
inline void LoadFontAsset() ;

static inline ::TMPro::TextMeshProUGUI* New_ctor() ;

/// @brief Method OnCanvasHierarchyChanged, addr 0x1821f29c0, size 0xa0, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDestroy, addr 0x1821f2a60, size 0xf0, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x1821f2b50, size 0x40, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x1821f2b90, size 0x120, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1821f2cb0, size 0x1b0, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPreRenderCanvas, addr 0x1821f2e60, size 0x1e0, virtual false, abstract: false, final false
inline void OnPreRenderCanvas() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x1821f3040, size 0x260, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x1821f32a0, size 0x60, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method Rebuild, addr 0x1821f3300, size 0xa0, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  update) ;

/// @brief Method RecalculateClipping, addr 0x1821d2130, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method SetArraySizes, addr 0x1821f3490, size 0x1ef0, virtual true, abstract: false, final false
inline int32_t SetArraySizes(::ArrayW<::TMPro::TMP_Text_TextProcessingElement>  textProcessingArray) ;

/// @brief Method SetCulling, addr 0x1821f5380, size 0x240, virtual true, abstract: false, final false
inline void SetCulling() ;

/// @brief Method SetFaceColor, addr 0x1821f55c0, size 0x140, virtual true, abstract: false, final false
inline void SetFaceColor(::UnityEngine::Color32  color) ;

/// @brief Method SetLayoutDirty, addr 0x1821f5700, size 0xa0, virtual true, abstract: false, final false
inline void SetLayoutDirty() ;

/// @brief Method SetMaterialDirty, addr 0x1821f57a0, size 0x80, virtual true, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetMeshArrays, addr 0x1821f5820, size 0x50, virtual false, abstract: false, final false
inline void SetMeshArrays(int32_t  size) ;

/// @brief Method SetOutlineColor, addr 0x1821f5870, size 0x140, virtual true, abstract: false, final false
inline void SetOutlineColor(::UnityEngine::Color32  color) ;

/// @brief Method SetOutlineThickness, addr 0x1821f59b0, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method SetShaderDepth, addr 0x1821f5be0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method SetSharedMaterials, addr 0x1821f5c90, size 0x2e0, virtual true, abstract: false, final false
inline void SetSharedMaterials(::ArrayW<::UnityEngine::Material*>  materials) ;

/// @brief Method SetVerticesDirty, addr 0x1821f5f70, size 0x70, virtual true, abstract: false, final false
inline void SetVerticesDirty() ;

/// @brief Method UpdateCulling, addr 0x1821f5fe0, size 0x250, virtual true, abstract: false, final false
inline void UpdateCulling() ;

/// @brief Method UpdateEnvMapMatrix, addr 0x1821f6230, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method UpdateGeometry, addr 0x1821f6450, size 0x60, virtual true, abstract: false, final false
inline void UpdateGeometry(::UnityEngine::Mesh*  mesh, int32_t  index) ;

/// @brief Method UpdateMask, addr 0x1821f64b0, size 0x350, virtual false, abstract: false, final false
inline void UpdateMask() ;

/// @brief Method UpdateMaterial, addr 0x1821f6800, size 0xd0, virtual true, abstract: false, final false
inline void UpdateMaterial() ;

/// @brief Method UpdateMeshPadding, addr 0x1821f68d0, size 0xf0, virtual true, abstract: false, final false
inline void UpdateMeshPadding() ;

/// @brief Method UpdateSDFScale, addr 0x1821f69c0, size 0x1c0, virtual false, abstract: false, final false
inline void UpdateSDFScale(float_t  scaleDelta) ;

/// @brief Method UpdateSubObjectPivot, addr 0x1821f6b80, size 0x90, virtual false, abstract: false, final false
inline void UpdateSubObjectPivot() ;

/// @brief Method UpdateVertexData, addr 0x1821f6d90, size 0x160, virtual true, abstract: false, final false
inline void UpdateVertexData() ;

/// @brief Method UpdateVertexData, addr 0x1821f6c10, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1821f73a0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnPreRenderText, addr 0x1821f7460, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method get_canvasRenderer, addr 0x1821f7510, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CanvasRenderer> get_canvasRenderer() ;

/// @brief Method get_maskOffset, addr 0x1821f7560, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_maskOffset() ;

/// @brief Method get_materialForRendering, addr 0x1821f7570, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method remove_OnPreRenderText, addr 0x1821f75c0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method set_autoSizeTextContainer, addr 0x1821f7660, size 0x50, virtual true, abstract: false, final false
inline void set_autoSizeTextContainer(bool  value) ;

/// @brief Method set_maskOffset, addr 0x1821f76b0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Size padding 0x7d0 - 0x7c8 = 0x8, packed as 0x8
...
static_assert(sizeof(::TMPro::TextMeshProUGUI) == 0x7d0, "Size mismatch!");
