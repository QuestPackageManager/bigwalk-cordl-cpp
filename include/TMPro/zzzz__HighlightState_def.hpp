...
DEFINE_IL2CPP_CLASS(::TMPro::HighlightState, "TMPro", "HighlightState");
...
public:
// Declarations
/// @brief Method Equals, addr 0x182184fb0, size 0x50, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x182185000, size 0xa0, virtual false, abstract: false, final false
inline bool Equals(::TMPro::HighlightState  other) ;

/// @brief Method GetHashCode, addr 0x1821850a0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1821850e0, size 0x90, virtual false, abstract: false, final false
static inline bool op_Equality(::TMPro::HighlightState  lhs, ::TMPro::HighlightState  rhs) ;

/// @brief Method op_Inequality, addr 0x182185170, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::HighlightState) == 0x14, "Size mismatch!");
