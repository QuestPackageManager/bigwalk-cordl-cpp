...
/// @brief Method get_baseMarkGlyphAnchorPoint, addr 0x180a177e0, size 0xf0, virtual false, abstract: false, final false
inline ::TMPro::GlyphAnchorPoint get_baseMarkGlyphAnchorPoint() ;

/// @brief Method get_baseMarkGlyphID, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_baseMarkGlyphID() ;

/// @brief Method get_combiningMarkGlyphID, addr 0x1803bdb30, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_combiningMarkGlyphID() ;

/// @brief Method get_combiningMarkPositionAdjustment, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::TMPro::MarkPositionAdjustment get_combiningMarkPositionAdjustment() ;

/// @brief Method set_baseMarkGlyphAnchorPoint, addr 0x180ded520, size 0x4d0, virtual false, abstract: false, final false
inline void set_baseMarkGlyphAnchorPoint(::TMPro::GlyphAnchorPoint  value) ;

/// @brief Method set_baseMarkGlyphID, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
inline void set_baseMarkGlyphID(uint32_t  value) ;

/// @brief Method set_combiningMarkGlyphID, addr 0x1804bdb30, size 0x10, virtual false, abstract: false, final false
inline void set_combiningMarkGlyphID(uint32_t  value) ;

/// @brief Method set_combiningMarkPositionAdjustment, addr 0x1804bda40, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BaseMarkGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_BaseMarkGlyphAnchorPoint", ty: "::TMPro::GlyphAnchorPoint", modifiers: "", def_value: None }, CppParam { name: "m_CombiningMarkGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_CombiningMarkPositionAdjustment", ty: "::TMPro::MarkPositionAdjustment", modifiers: "", def_value: None }]
