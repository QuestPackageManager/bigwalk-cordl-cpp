...
DEFINE_IL2CPP_CLASS(::TMPro::VertexGradient, "TMPro", "VertexGradient");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1821fd9e0, size 0x310, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::VertexGradient) == 0x40, "Size mismatch!");
