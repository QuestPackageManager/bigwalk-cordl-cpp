...
DEFINE_IL2CPP_CLASS(::TMPro::TextureMappingOptions, "TMPro", "TextureMappingOptions");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TextureMappingOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextureMappingOptions) == 0x4, "Size mismatch!");
