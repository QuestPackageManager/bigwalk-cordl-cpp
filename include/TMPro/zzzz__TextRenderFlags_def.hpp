...
DEFINE_IL2CPP_CLASS(::TMPro::TextRenderFlags, "TMPro", "TextRenderFlags");
// Dependencies 
namespace TMPro {
// Is value type: true
...
/// @brief Field DontRender value: I32(0)
static ::TMPro::TextRenderFlags const DontRender;

/// @brief Field Render value: I32(255)
...
static_assert(offsetof(::TMPro::TextRenderFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextRenderFlags) == 0x4, "Size mismatch!");
