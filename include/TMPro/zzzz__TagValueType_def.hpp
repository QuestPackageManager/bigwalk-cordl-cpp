...
DEFINE_IL2CPP_CLASS(::TMPro::TagValueType, "TMPro", "TagValueType");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TagValueType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TagValueType) == 0x4, "Size mismatch!");
