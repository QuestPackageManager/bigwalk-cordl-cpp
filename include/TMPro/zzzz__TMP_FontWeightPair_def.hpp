...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_FontWeightPair, "TMPro", "TMP_FontWeightPair");
// Dependencies 
namespace TMPro {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "regularTypeface", ty: "::UnityW<::TMPro::TMP_FontAsset>", modifiers: "", def_value: None }, CppParam { name: "italicTypeface", ty: "::UnityW<::TMPro::TMP_FontAsset>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::TMPro::TMP_FontWeightPair) == 0x10, "Size mismatch!");
