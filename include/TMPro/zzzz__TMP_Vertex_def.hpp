...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_Vertex, "TMPro", "TMP_Vertex");
...
/// @brief Method get_zero, addr 0x182194480, size 0x30, virtual false, abstract: false, final false
...
static_assert(offsetof(::TMPro::TMP_Vertex, uv2) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_Vertex, color) == 0x24, "Offset mismatch!");

static_assert(sizeof(::TMPro::TMP_Vertex) == 0x28, "Size mismatch!");
