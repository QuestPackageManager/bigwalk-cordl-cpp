...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_VertexDataUpdateFlags, "TMPro", "TMP_VertexDataUpdateFlags");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TMP_VertexDataUpdateFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TMP_VertexDataUpdateFlags) == 0x4, "Size mismatch!");
