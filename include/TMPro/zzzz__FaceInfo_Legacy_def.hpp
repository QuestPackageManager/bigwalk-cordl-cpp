...
// Write type traits
MARK_REF_T(::TMPro::FaceInfo_Legacy*);
DEFINE_IL2CPP_CLASS(::TMPro::FaceInfo_Legacy*, "TMPro", "FaceInfo_Legacy");
...
static_assert(sizeof(::TMPro::FaceInfo_Legacy) == 0x68, "Size mismatch!");
