...
DEFINE_IL2CPP_CLASS(::TMPro::FontWeight, "TMPro", "FontWeight");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::FontWeight, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::FontWeight) == 0x4, "Size mismatch!");
