...
DEFINE_IL2CPP_CLASS(::TMPro::AtlasPopulationMode, "TMPro", "AtlasPopulationMode");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::AtlasPopulationMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::AtlasPopulationMode) == 0x4, "Size mismatch!");
