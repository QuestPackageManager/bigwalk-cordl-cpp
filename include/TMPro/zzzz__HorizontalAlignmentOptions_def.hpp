...
DEFINE_IL2CPP_CLASS(::TMPro::HorizontalAlignmentOptions, "TMPro", "HorizontalAlignmentOptions");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::HorizontalAlignmentOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::HorizontalAlignmentOptions) == 0x4, "Size mismatch!");
