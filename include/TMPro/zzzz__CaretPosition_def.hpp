...
DEFINE_IL2CPP_CLASS(::TMPro::CaretPosition, "TMPro", "CaretPosition");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::CaretPosition, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::CaretPosition) == 0x4, "Size mismatch!");
