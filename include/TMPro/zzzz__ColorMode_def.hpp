...
DEFINE_IL2CPP_CLASS(::TMPro::ColorMode, "TMPro", "ColorMode");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::ColorMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::ColorMode) == 0x4, "Size mismatch!");
