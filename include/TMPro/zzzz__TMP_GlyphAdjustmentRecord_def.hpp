...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_GlyphAdjustmentRecord, "TMPro", "TMP_GlyphAdjustmentRecord");
...
/// @brief Method .ctor, addr 0x182196990, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord  adjustmentRecord) ;

/// @brief Method .ctor, addr 0x180a16b80, size 0x30, virtual false, abstract: false, final false
inline void _ctor(uint32_t  glyphIndex, ::TMPro::TMP_GlyphValueRecord  glyphValueRecord) ;

/// @brief Method get_glyphIndex, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_glyphIndex() ;

/// @brief Method get_glyphValueRecord, addr 0x180a178d0, size 0x20, virtual false, abstract: false, final false
inline ::TMPro::TMP_GlyphValueRecord get_glyphValueRecord() ;

/// @brief Method set_glyphIndex, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
inline void set_glyphIndex(uint32_t  value) ;

/// @brief Method set_glyphValueRecord, addr 0x180ded510, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_GlyphAdjustmentRecord) == 0x14, "Size mismatch!");
