...
DEFINE_IL2CPP_CLASS(::TMPro::TextContainerAnchors, "TMPro", "TextContainerAnchors");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TextContainerAnchors, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextContainerAnchors) == 0x4, "Size mismatch!");
