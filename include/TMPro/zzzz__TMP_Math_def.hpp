...
// Write type traits
MARK_REF_T(::TMPro::TMP_Math*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_Math*, "TMPro", "TMP_Math");
...
/// @brief Method Approximately, addr 0x1821e8df0, size 0x30, virtual false, abstract: false, final false
static inline bool Approximately(float_t  a, float_t  b) ;

/// @brief Method Mod, addr 0x18049b750, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_Math) == 0x10, "Size mismatch!");
