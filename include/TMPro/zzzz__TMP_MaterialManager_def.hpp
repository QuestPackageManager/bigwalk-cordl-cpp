...
// Write type traits
MARK_REF_T(::TMPro::TMP_MaterialManager*);
MARK_REF_T(::TMPro::TMP_MaterialManager_FallbackMaterial*);
MARK_REF_T(::TMPro::TMP_MaterialManager_MaskingMaterial*);
MARK_REF_T(::TMPro::TMP_MaterialManager___c__DisplayClass11_0*);
MARK_REF_T(::TMPro::TMP_MaterialManager___c__DisplayClass12_0*);
MARK_REF_T(::TMPro::TMP_MaterialManager___c__DisplayClass13_0*);
MARK_REF_T(::TMPro::TMP_MaterialManager___c__DisplayClass9_0*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager*, "TMPro", "TMP_MaterialManager");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager_FallbackMaterial*, "TMPro", "TMP_MaterialManager/FallbackMaterial");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager_MaskingMaterial*, "TMPro", "TMP_MaterialManager/MaskingMaterial");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager___c__DisplayClass11_0*, "TMPro", "TMP_MaterialManager/<>c__DisplayClass11_0");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager___c__DisplayClass12_0*, "TMPro", "TMP_MaterialManager/<>c__DisplayClass12_0");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager___c__DisplayClass13_0*, "TMPro", "TMP_MaterialManager/<>c__DisplayClass13_0");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialManager___c__DisplayClass9_0*, "TMPro", "TMP_MaterialManager/<>c__DisplayClass9_0");
...
static_assert(sizeof(::TMPro::TMP_MaterialManager_FallbackMaterial) == 0x38, "Size mismatch!");
...
static_assert(sizeof(::TMPro::TMP_MaterialManager_MaskingMaterial) == 0x28, "Size mismatch!");
...
/// @brief Method <AddMaskingMaterial>b__0, addr 0x18202cac0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_MaterialManager___c__DisplayClass11_0) == 0x18, "Size mismatch!");
...
/// @brief Method <RemoveStencilMaterial>b__0, addr 0x18202cac0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_MaterialManager___c__DisplayClass12_0) == 0x18, "Size mismatch!");
...
/// @brief Method <ReleaseBaseMaterial>b__0, addr 0x1821d5b80, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_MaterialManager___c__DisplayClass13_0) == 0x18, "Size mismatch!");
...
/// @brief Method <GetBaseMaterial>b__0, addr 0x18202cac0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_MaterialManager___c__DisplayClass9_0) == 0x18, "Size mismatch!");
...
/// @brief Field m_fallbackCleanupList, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_fallbackCleanupList, put=setStaticF_m_fallbackCleanupList)) ::System::Collections::Generic::List_1<::TMPro::TMP_MaterialManager_FallbackMaterial*>*  m_fallbackCleanupList;
...
/// @brief Field m_fallbackMaterials, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_fallbackMaterials, put=setStaticF_m_fallbackMaterials)) ::System::Collections::Generic::Dictionary_2<int64_t,::TMPro::TMP_MaterialManager_FallbackMaterial*>*  m_fallbackMaterials;
...
/// @brief Method AddFallbackMaterialReference, addr 0x1821ca2c0, size 0xb0, virtual false, abstract: false, final false
static inline void AddFallbackMaterialReference(::UnityEngine::Material*  targetMaterial) ;

/// @brief Method AddMaskingMaterial, addr 0x1821ca370, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method CleanupFallbackMaterials, addr 0x1821ca520, size 0x140, virtual false, abstract: false, final false
static inline void CleanupFallbackMaterials() ;

/// @brief Method ClearMaterials, addr 0x1821ca660, size 0xd0, virtual false, abstract: false, final false
static inline void ClearMaterials() ;

/// @brief Method CopyMaterialPresetProperties, addr 0x1821ca730, size 0x290, virtual false, abstract: false, final false
static inline void CopyMaterialPresetProperties(::UnityEngine::Material*  source, ::UnityEngine::Material*  destination) ;

/// @brief Method FindRootSortOverrideCanvas, addr 0x1821ca9c0, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform*  start) ;

/// @brief Method GetBaseMaterial, addr 0x1821caaa0, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetBaseMaterial(::UnityEngine::Material*  stencilMaterial) ;

/// @brief Method GetFallbackMaterial, addr 0x1821caf00, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method GetFallbackMaterial, addr 0x1821cab80, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method GetMaterialForRendering, addr 0x1821cb110, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetStencilID, addr 0x1821cb280, size 0x280, virtual false, abstract: false, final false
static inline int32_t GetStencilID(::UnityEngine::GameObject*  obj) ;

/// @brief Method GetStencilMaterial, addr 0x1821cb500, size 0x2b0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetStencilMaterial(::UnityEngine::Material*  baseMaterial, int32_t  stencilID) ;

/// @brief Method OnPreRender, addr 0x1821cb7b0, size 0x180, virtual false, abstract: false, final false
static inline void OnPreRender() ;

/// @brief Method ReleaseBaseMaterial, addr 0x1821cb930, size 0x2b0, virtual false, abstract: false, final false
static inline void ReleaseBaseMaterial(::UnityEngine::Material*  baseMaterial) ;

/// @brief Method ReleaseFallbackMaterial, addr 0x1821cbbe0, size 0xf0, virtual false, abstract: false, final false
static inline void ReleaseFallbackMaterial(::UnityEngine::Material*  fallbackMaterial) ;

/// @brief Method ReleaseStencilMaterial, addr 0x1821cbcd0, size 0x100, virtual false, abstract: false, final false
static inline void ReleaseStencilMaterial(::UnityEngine::Material*  stencilMaterial) ;

/// @brief Method RemoveFallbackMaterialReference, addr 0x1821cbdd0, size 0xe0, virtual false, abstract: false, final false
static inline void RemoveFallbackMaterialReference(::UnityEngine::Material*  targetMaterial) ;

/// @brief Method RemoveStencilMaterial, addr 0x1821cbeb0, size 0xc0, virtual false, abstract: false, final false
static inline void RemoveStencilMaterial(::UnityEngine::Material*  stencilMaterial) ;

/// @brief Method SetStencil, addr 0x1821cbf70, size 0xa0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::TMPro::TMP_MaterialManager) == 0x10, "Size mismatch!");
