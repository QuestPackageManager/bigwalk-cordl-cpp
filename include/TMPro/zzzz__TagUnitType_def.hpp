...
DEFINE_IL2CPP_CLASS(::TMPro::TagUnitType, "TMPro", "TagUnitType");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TagUnitType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TagUnitType) == 0x4, "Size mismatch!");
