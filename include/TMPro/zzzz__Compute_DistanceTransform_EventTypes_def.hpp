...
DEFINE_IL2CPP_CLASS(::TMPro::Compute_DistanceTransform_EventTypes, "TMPro", "Compute_DistanceTransform_EventTypes");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::Compute_DistanceTransform_EventTypes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::Compute_DistanceTransform_EventTypes) == 0x4, "Size mismatch!");
