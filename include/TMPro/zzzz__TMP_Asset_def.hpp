...
// Write type traits
MARK_REF_T(::TMPro::TMP_Asset*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_Asset*, "TMPro", "TMP_Asset");
...
/// @brief Method get_faceInfo, addr 0x182186430, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method get_hashCode, addr 0x182186470, size 0x40, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_instanceID, addr 0x1821864b0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_instanceID() ;

/// @brief Method get_material, addr 0x1802e5800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_materialHashCode, addr 0x1821864e0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_faceInfo, addr 0x182186540, size 0x70, virtual false, abstract: false, final false
inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo  value) ;

/// @brief Method set_hashCode, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
inline void set_hashCode(int32_t  value) ;

/// @brief Method set_material, addr 0x180374490, size 0x20, virtual false, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_materialHashCode, addr 0x1805d4790, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_Asset) == 0x98, "Size mismatch!");
