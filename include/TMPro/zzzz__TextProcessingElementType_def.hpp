...
// Write type traits
MARK_VAL_T(::TMPro::TextProcessingElementType);
DEFINE_IL2CPP_CLASS(::TMPro::TextProcessingElementType, "TMPro", "TextProcessingElementType");
// Dependencies 
namespace TMPro {
// Is value type: true
// CS Name: TMPro.TextProcessingElementType
...
static ::TMPro::TextProcessingElementType const TextCharacterElement;

/// @brief Field TextMarkupElement value: I32(2)
static ::TMPro::TextProcessingElementType const TextMarkupElement;

/// @brief Field Undefined value: I32(0)
static ::TMPro::TextProcessingElementType const Undefined;
...
static_assert(offsetof(::TMPro::TextProcessingElementType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextProcessingElementType) == 0x4, "Size mismatch!");
