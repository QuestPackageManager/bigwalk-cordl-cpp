...
/// @brief Method .ctor, addr 0x182186710, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1821867a0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color  color) ;

/// @brief Method .ctor, addr 0x1821867f0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_ColorGradient) == 0x60, "Size mismatch!");
