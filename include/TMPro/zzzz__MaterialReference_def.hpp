...
DEFINE_IL2CPP_CLASS(::TMPro::MaterialReference, "TMPro", "MaterialReference");
// Dependencies 
namespace TMPro {
// Is value type: true
...
public:
// Declarations
/// @brief Method AddMaterialReference, addr 0x182186000, size 0x190, virtual false, abstract: false, final false
static inline int32_t AddMaterialReference(::UnityEngine::Material*  material, ::TMPro::TMP_FontAsset*  fontAsset, ::by_ref<::ArrayW<::TMPro::MaterialReference>>  materialReferences, ::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*  materialReferenceIndexLookup) ;

/// @brief Method AddMaterialReference, addr 0x182185e80, size 0x180, virtual false, abstract: false, final false
static inline int32_t AddMaterialReference(::UnityEngine::Material*  material, ::TMPro::TMP_SpriteAsset*  spriteAsset, ::by_ref<::ArrayW<::TMPro::MaterialReference>>  materialReferences, ::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*  materialReferenceIndexLookup) ;

/// @brief Method Contains, addr 0x182186190, size 0x80, virtual false, abstract: false, final false
static inline bool Contains(::ArrayW<::TMPro::MaterialReference>  materialReferences, ::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method .ctor, addr 0x182186210, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::MaterialReference) == 0x38, "Size mismatch!");
