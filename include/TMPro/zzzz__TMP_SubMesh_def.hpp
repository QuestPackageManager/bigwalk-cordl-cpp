...
// Write type traits
MARK_REF_T(::TMPro::TMP_SubMesh*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_SubMesh*, "TMPro", "TMP_SubMesh");
...
/// @brief Method AddSubTextObject, addr 0x1821d2b30, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method DestroySelf, addr 0x1821d2d80, size 0x30, virtual false, abstract: false, final false
inline void DestroySelf() ;

/// @brief Method GetMaterial, addr 0x1821d2db0, size 0x160, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method GetPaddingForMaterial, addr 0x1821d2f10, size 0x60, virtual false, abstract: false, final false
inline float_t GetPaddingForMaterial() ;

/// @brief Method GetSharedMaterial, addr 0x1821d2f70, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetSharedMaterial() ;

static inline ::TMPro::TMP_SubMesh* New_ctor() ;

/// @brief Method OnDestroy, addr 0x1821d2fc0, size 0xc0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x1821d3080, size 0x70, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1821d30f0, size 0x190, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetMaterialDirty, addr 0x1821d3280, size 0x190, virtual false, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetSharedMaterial, addr 0x1821d3410, size 0x90, virtual false, abstract: false, final false
inline void SetSharedMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method SetVerticesDirty, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void SetVerticesDirty() ;

/// @brief Method UpdateMaterial, addr 0x1821d3280, size 0x190, virtual false, abstract: false, final false
inline void UpdateMaterial() ;

/// @brief Method UpdateMeshPadding, addr 0x1821d34a0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_fallbackMaterial, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_fallbackMaterial() ;

/// @brief Method get_fallbackSourceMaterial, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_fallbackSourceMaterial() ;

/// @brief Method get_fontAsset, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_FontAsset> get_fontAsset() ;

/// @brief Method get_isDefaultMaterial, addr 0x1802f8060, size 0x10, virtual false, abstract: false, final false
inline bool get_isDefaultMaterial() ;

/// @brief Method get_material, addr 0x1821d3510, size 0x160, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_mesh, addr 0x1821d3700, size 0x70, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_mesh() ;

/// @brief Method get_meshFilter, addr 0x1821d3670, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter() ;

/// @brief Method get_padding, addr 0x180315260, size 0x10, virtual false, abstract: false, final false
inline float_t get_padding() ;

/// @brief Method get_renderer, addr 0x1821d3770, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Renderer> get_renderer() ;

/// @brief Method get_sharedMaterial, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_sharedMaterial() ;

/// @brief Method get_spriteAsset, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_SpriteAsset> get_spriteAsset() ;

/// @brief Method get_textComponent, addr 0x1821d37c0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_Text> get_textComponent() ;

/// @brief Method set_fallbackMaterial, addr 0x1821d3810, size 0xd0, virtual false, abstract: false, final false
inline void set_fallbackMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_fallbackSourceMaterial, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_fallbackSourceMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_fontAsset, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_fontAsset(::TMPro::TMP_FontAsset*  value) ;

/// @brief Method set_isDefaultMaterial, addr 0x1802f8090, size 0x10, virtual false, abstract: false, final false
inline void set_isDefaultMaterial(bool  value) ;

/// @brief Method set_material, addr 0x1821d38e0, size 0xc0, virtual false, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_mesh, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
inline void set_mesh(::UnityEngine::Mesh*  value) ;

/// @brief Method set_padding, addr 0x1803dccc0, size 0x10, virtual false, abstract: false, final false
inline void set_padding(float_t  value) ;

/// @brief Method set_sharedMaterial, addr 0x1821d39a0, size 0x10, virtual false, abstract: false, final false
inline void set_sharedMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_spriteAsset, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_SubMesh) == 0x80, "Size mismatch!");
