...
DEFINE_IL2CPP_CLASS(::TMPro::SpriteAssetUtilities::SpriteAssetImportFormats, "TMPro.SpriteAssetUtilities", "SpriteAssetImportFormats");
// Dependencies 
namespace TMPro::SpriteAssetUtilities {
// Is value type: true
...
/// @brief Field TexturePackerJsonArray value: I32(1)
...
static_assert(offsetof(::TMPro::SpriteAssetUtilities::SpriteAssetImportFormats, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::SpriteAssetUtilities::SpriteAssetImportFormats) == 0x4, "Size mismatch!");
