...
// Write type traits
MARK_REF_T(::TMPro::KerningPair*);
DEFINE_IL2CPP_CLASS(::TMPro::KerningPair*, "TMPro", "KerningPair");
// Dependencies System.Object, TMPro.GlyphValueRecord_Legacy
namespace TMPro {
// Is value type: false
...
/// @brief Field empty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_empty, put=setStaticF_empty)) ::TMPro::KerningPair*  empty;
...
/// @brief Method ConvertLegacyKerningData, addr 0x182194ac0, size 0x10, virtual false, abstract: false, final false
inline void ConvertLegacyKerningData() ;

static inline ::TMPro::KerningPair* New_ctor() ;

static inline ::TMPro::KerningPair* New_ctor(uint32_t  firstGlyph, ::TMPro::GlyphValueRecord_Legacy  firstGlyphAdjustments, uint32_t  secondGlyph, ::TMPro::GlyphValueRecord_Legacy  secondGlyphAdjustments) ;
...
/// @brief Method .ctor, addr 0x182194b60, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182194b40, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182194b30, size 0x10, virtual false, abstract: false, final false
inline void _ctor(uint32_t  left, uint32_t  right, float_t  offset) ;

static inline ::TMPro::KerningPair* getStaticF_empty() ;

/// @brief Method get_firstGlyph, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_firstGlyph() ;

/// @brief Method get_firstGlyphAdjustments, addr 0x1803e6790, size 0x40, virtual false, abstract: false, final false
inline ::TMPro::GlyphValueRecord_Legacy get_firstGlyphAdjustments() ;

/// @brief Method get_ignoreSpacingAdjustments, addr 0x1803cbf40, size 0x10, virtual false, abstract: false, final false
inline bool get_ignoreSpacingAdjustments() ;

/// @brief Method get_secondGlyph, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_secondGlyph() ;

/// @brief Method get_secondGlyphAdjustments, addr 0x180a26490, size 0x12a0, virtual false, abstract: false, final false
...
/// @brief Method set_firstGlyph, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_firstGlyph(uint32_t  value) ;

/// @brief Method set_secondGlyph, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::KerningPair) == 0x40, "Size mismatch!");
