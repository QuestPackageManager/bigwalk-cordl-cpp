...
DEFINE_IL2CPP_CLASS(::TMPro::SingleSubstitutionRecord, "TMPro", "SingleSubstitutionRecord");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(sizeof(::TMPro::SingleSubstitutionRecord) == 0x1, "Size mismatch!");
