...
// Write type traits
MARK_REF_T(::TMPro::MaterialReferenceManager*);
DEFINE_IL2CPP_CLASS(::TMPro::MaterialReferenceManager*, "TMPro", "MaterialReferenceManager");
...
/// @brief Field m_ColorGradientReferenceLookup, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ColorGradientReferenceLookup, put=__cordl_internal_set_m_ColorGradientReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_ColorGradient>>*  m_ColorGradientReferenceLookup;

/// @brief Field m_FontAssetReferenceLookup, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FontAssetReferenceLookup, put=__cordl_internal_set_m_FontAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_FontAsset>>*  m_FontAssetReferenceLookup;
...
/// @brief Field m_SpriteAssetReferenceLookup, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SpriteAssetReferenceLookup, put=__cordl_internal_set_m_SpriteAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_SpriteAsset>>*  m_SpriteAssetReferenceLookup;
...
/// @brief Method AddColorGradientPreset, addr 0x1821853e0, size 0x60, virtual false, abstract: false, final false
static inline void AddColorGradientPreset(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddColorGradientPreset_Internal, addr 0x182185390, size 0x50, virtual false, abstract: false, final false
inline void AddColorGradientPreset_Internal(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddFontAsset, addr 0x182185540, size 0x100, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontAssetInternal, addr 0x182185440, size 0x100, virtual false, abstract: false, final false
inline void AddFontAssetInternal(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontMaterial, addr 0x182185650, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method AddSpriteAsset, addr 0x1821858d0, size 0xa0, virtual false, abstract: false, final false
static inline void AddSpriteAsset(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAsset, addr 0x1821857f0, size 0xe0, virtual false, abstract: false, final false
static inline void AddSpriteAsset(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x182185760, size 0x90, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x182185690, size 0xd0, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method Contains, addr 0x182185970, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method TryGetColorGradientPreset, addr 0x182185a10, size 0x60, virtual false, abstract: false, final false
static inline bool TryGetColorGradientPreset(int32_t  hashCode, ::by_ref<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetColorGradientPresetInternal, addr 0x1821859c0, size 0x50, virtual false, abstract: false, final false
inline bool TryGetColorGradientPresetInternal(int32_t  hashCode, ::by_ref<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetFontAsset, addr 0x182185ac0, size 0x60, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashCode, ::by_ref<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetFontAssetInternal, addr 0x182185a70, size 0x50, virtual false, abstract: false, final false
inline bool TryGetFontAssetInternal(int32_t  hashCode, ::by_ref<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetMaterial, addr 0x182185b70, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method TryGetSpriteAsset, addr 0x182185c20, size 0x60, virtual false, abstract: false, final false
static inline bool TryGetSpriteAsset(int32_t  hashCode, ::by_ref<::TMPro::TMP_SpriteAsset*>  spriteAsset) ;

/// @brief Method TryGetSpriteAssetInternal, addr 0x182185bd0, size 0x50, virtual false, abstract: false, final false
inline bool TryGetSpriteAssetInternal(int32_t  hashCode, ::by_ref<::TMPro::TMP_SpriteAsset*>  spriteAsset) ;
...
/// @brief Method .ctor, addr 0x182185c80, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::TMPro::MaterialReferenceManager* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x182185d50, size 0x130, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::MaterialReferenceManager) == 0x30, "Size mismatch!");
