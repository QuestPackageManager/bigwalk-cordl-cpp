...
static_assert(offsetof(::TMPro::ColorTween_ColorTweenMode, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method AddOnChangedCallback, addr 0x182184760, size 0x80, virtual false, abstract: false, final false
