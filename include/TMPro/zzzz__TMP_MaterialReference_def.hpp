...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MaterialReference, "TMPro", "TMP_MaterialReference");
// Dependencies 
namespace TMPro {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "referenceCount", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::TMPro::TMP_MaterialReference) == 0x10, "Size mismatch!");
