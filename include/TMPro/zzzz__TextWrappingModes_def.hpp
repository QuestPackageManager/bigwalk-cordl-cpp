...
DEFINE_IL2CPP_CLASS(::TMPro::TextWrappingModes, "TMPro", "TextWrappingModes");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TextWrappingModes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextWrappingModes) == 0x4, "Size mismatch!");
