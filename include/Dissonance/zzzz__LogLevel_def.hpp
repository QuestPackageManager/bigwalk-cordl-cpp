...
// Write type traits
MARK_VAL_T(::Dissonance::LogLevel);
DEFINE_IL2CPP_CLASS(::Dissonance::LogLevel, "Dissonance", "LogLevel");
// Dependencies 
namespace Dissonance {
// Is value type: true
// CS Name: Dissonance.LogLevel
...
static ::Dissonance::LogLevel const Debug;

/// @brief Field Error value: I32(4)
static ::Dissonance::LogLevel const Error;

/// @brief Field Info value: I32(2)
static ::Dissonance::LogLevel const Info;

/// @brief Field Trace value: I32(0)
static ::Dissonance::LogLevel const Trace;

/// @brief Field Warn value: I32(3)
static ::Dissonance::LogLevel const Warn;
...
static_assert(offsetof(::Dissonance::LogLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Dissonance::LogLevel) == 0x4, "Size mismatch!");
