...
// Write type traits
MARK_REF_T(::UnityEngineInternal::TypeInferenceRuleAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::TypeInferenceRuleAttribute*, "UnityEngineInternal", "TypeInferenceRuleAttribute");
...
/// @brief Method .ctor, addr 0x18224c720, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngineInternal::TypeInferenceRuleAttribute) == 0x18, "Size mismatch!");
