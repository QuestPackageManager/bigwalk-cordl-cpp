...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::LightmapType, "UnityEngineInternal", "LightmapType");
// Dependencies 
namespace UnityEngineInternal {
// Is value type: true
...
/// @brief Field NoLightmap value: I32(-1)
static ::UnityEngineInternal::LightmapType const NoLightmap;

/// @brief Field StaticLightmap value: I32(0)
...
static_assert(offsetof(::UnityEngineInternal::LightmapType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngineInternal::LightmapType) == 0x4, "Size mismatch!");
