#pragma once
// IWYU pragma private; include "UnityEngineInternal/TypeInferenceRules.hpp"
...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::TypeInferenceRules, "UnityEngineInternal", "TypeInferenceRules");
// Dependencies 
namespace UnityEngineInternal {
// Is value type: true
...
static_assert(offsetof(::UnityEngineInternal::TypeInferenceRules, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngineInternal::TypeInferenceRules) == 0x4, "Size mismatch!");
