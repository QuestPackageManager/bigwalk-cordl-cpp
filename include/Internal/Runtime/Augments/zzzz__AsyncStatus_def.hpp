...
DEFINE_IL2CPP_CLASS(::Internal::Runtime::Augments::AsyncStatus, "Internal.Runtime.Augments", "AsyncStatus");
// Dependencies 
namespace Internal::Runtime::Augments {
// Is value type: true
...
static_assert(offsetof(::Internal::Runtime::Augments::AsyncStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Internal::Runtime::Augments::AsyncStatus) == 0x4, "Size mismatch!");
