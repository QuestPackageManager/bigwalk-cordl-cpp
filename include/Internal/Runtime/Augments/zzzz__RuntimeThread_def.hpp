...
// Write type traits
MARK_REF_T(::Internal::Runtime::Augments::RuntimeThread*);
DEFINE_IL2CPP_CLASS(::Internal::Runtime::Augments::RuntimeThread*, "Internal.Runtime.Augments", "RuntimeThread");
...
/// @brief Method Create, addr 0x1815dd3a0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentProcessorId, addr 0x1802edd00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Sleep, addr 0x1815dd410, size 0x10, virtual false, abstract: false, final false
static inline void Sleep(int32_t  millisecondsTimeout) ;

/// @brief Method SpinWait, addr 0x1815dd420, size 0x20, virtual false, abstract: false, final false
static inline bool SpinWait(int32_t  iterations) ;

/// @brief Method Start, addr 0x1815dd440, size 0x10, virtual false, abstract: false, final false
inline void Start(::System::Object*  state) ;

/// @brief Method Yield, addr 0x1815dd450, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_IsBackground, addr 0x1815dd490, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Internal::Runtime::Augments::RuntimeThread) == 0x18, "Size mismatch!");
