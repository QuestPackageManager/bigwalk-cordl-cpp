...
// Write type traits
MARK_REF_T(::Internal::Threading::Tasks::Tracing::TaskTrace*);
DEFINE_IL2CPP_CLASS(::Internal::Threading::Tasks::Tracing::TaskTrace*, "Internal.Threading.Tasks.Tracing", "TaskTrace");
...
/// @brief Method TaskScheduled, addr 0x1815e8020, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method TaskWaitBegin_Asynchronous, addr 0x1815e8080, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method TaskWaitBegin_Synchronous, addr 0x1815e80d0, size 0x50, virtual false, abstract: false, final false
static inline void TaskWaitBegin_Synchronous(int32_t  OriginatingTaskSchedulerID, int32_t  OriginatingTaskID, int32_t  TaskID) ;

/// @brief Method TaskWaitEnd, addr 0x1815e8120, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_Enabled, addr 0x1815e8170, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Internal::Threading::Tasks::Tracing::TaskTrace) == 0x10, "Size mismatch!");
