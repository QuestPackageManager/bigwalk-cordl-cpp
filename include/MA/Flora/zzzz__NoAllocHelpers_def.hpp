...
namespace MA::Flora {
template<typename T>
class NoAllocHelpers_ListPrivateFieldAccess_1;
}
...
// Write type traits
MARK_REF_T(::MA::Flora::NoAllocHelpers*);
MARK_GEN_REF_T_PTR(::MA::Flora::NoAllocHelpers_ListPrivateFieldAccess_1);
DEFINE_IL2CPP_CLASS(::MA::Flora::NoAllocHelpers*, "MA.Flora", "NoAllocHelpers");
DEFINE_IL2CPP_GEN_CLASS_PTR(::MA::Flora::NoAllocHelpers_ListPrivateFieldAccess_1, "MA.Flora", "NoAllocHelpers/ListPrivateFieldAccess`1");
// Dependencies System.Object
namespace MA::Flora {
// cpp template
template<typename T>
// Is value type: false
// CS Name: MA.Flora.NoAllocHelpers/ListPrivateFieldAccess`1<T>
...
static inline ::MA::Flora::NoAllocHelpers_ListPrivateFieldAccess_1<T>* New_ctor() ;
...
namespace MA::Flora {
// Is value type: false
// CS Name: MA.Flora.NoAllocHelpers
class CORDL_TYPE NoAllocHelpers : public ::System::Object {
public:
// Declarations
template<typename T>
using ListPrivateFieldAccess_1 = ::MA::Flora::NoAllocHelpers_ListPrivateFieldAccess_1<T>;

/// @brief Method CreateReadOnlySpan, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::ReadOnlySpan_1<T> CreateReadOnlySpan(::System::Collections::Generic::List_1<T>*  list) ;

/// @brief Method CreateSpan, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Span_1<T> CreateSpan(::System::Collections::Generic::List_1<T>*  list) ;
...
template<typename T>
static inline ::ArrayW<T> ExtractArrayFromList(::System::Collections::Generic::List_1<T>*  list) ;

/// @brief Method ObjectAs, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T ObjectAs(::System::Object*  from) ;

/// @brief Method PrepareListForNativeFill, addr 0x181460870, size 0xa0, virtual false, abstract: false, final false
...
template<typename T>
static inline void ResetListContents(::System::Collections::Generic::List_1<T>*  list, ::ArrayW<T>  array) ;

/// @brief Method ResetListContents, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void ResetListContents(::System::Collections::Generic::List_1<T>*  list, ::System::ReadOnlySpan_1<T>  span) ;
...
/// @brief Method SafeLength, addr 0x181460910, size 0x10, virtual false, abstract: false, final false
...
template<typename T>
static inline int32_t SafeLength(::System::Collections::Generic::List_1<T>*  values) ;
...
// Non member Declarations
static_assert(sizeof(::MA::Flora::NoAllocHelpers) == 0x10, "Size mismatch!");
