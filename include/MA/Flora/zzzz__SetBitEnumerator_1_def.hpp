...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(SetBitEnumerator_1)
...
// Write type traits
MARK_GEN_VAL_T(::MA::Flora::SetBitEnumerator_1);
DEFINE_IL2CPP_GEN_CLASS(::MA::Flora::SetBitEnumerator_1, "MA.Flora", "SetBitEnumerator`1");
// Dependencies 
namespace MA::Flora {
// cpp template
template<typename TIndexType>
// Is value type: true
// CS Name: MA.Flora.SetBitEnumerator`1<TIndexType>
struct CORDL_TYPE SetBitEnumerator_1 {
public:
// Declarations
...
inline ::MA::Flora::SetBitEnumerator_1<TIndexType> GetEnumerator() ;
...
constexpr SetBitEnumerator_1(uint64_t*  m_Chunks, int32_t  m_Start, int32_t  m_End, int32_t  m_ChunkIndex, uint64_t  m_Mask, uint64_t  m_RemainingMask, uint64_t  m_UnscannedBitMask, int32_t  m_Index, int32_t  m_BaseBitIndex) noexcept;
