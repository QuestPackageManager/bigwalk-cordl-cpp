...
// Write type traits
MARK_VAL_T(::Shipmate::Porting::Logs::PlatformLogLevel);
DEFINE_IL2CPP_CLASS(::Shipmate::Porting::Logs::PlatformLogLevel, "Shipmate.Porting.Logs", "PlatformLogLevel");
// Dependencies 
namespace Shipmate::Porting::Logs {
// Is value type: true
// CS Name: Shipmate.Porting.Logs.PlatformLogLevel
...
static ::Shipmate::Porting::Logs::PlatformLogLevel const Debug;

/// @brief Field Error value: I32(3)
static ::Shipmate::Porting::Logs::PlatformLogLevel const Error;

/// @brief Field Exception value: I32(4)
static ::Shipmate::Porting::Logs::PlatformLogLevel const Exception;

/// @brief Field Info value: I32(1)
static ::Shipmate::Porting::Logs::PlatformLogLevel const Info;

/// @brief Field Warn value: I32(2)
static ::Shipmate::Porting::Logs::PlatformLogLevel const Warn;
...
static_assert(offsetof(::Shipmate::Porting::Logs::PlatformLogLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Shipmate::Porting::Logs::PlatformLogLevel) == 0x4, "Size mismatch!");
