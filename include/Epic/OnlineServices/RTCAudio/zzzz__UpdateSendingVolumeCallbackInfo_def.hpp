#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCAudio/UpdateSendingVolumeCallbackInfo.hpp"
...
#include <cmath>
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateSendingVolumeCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, "Epic.OnlineServices.RTCAudio", "UpdateSendingVolumeCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.UpdateSendingVolumeCallbackInfo
struct CORDL_TYPE UpdateSendingVolumeCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UpdateSendingVolumeCallbackInfo() ;
...
constexpr UpdateSendingVolumeCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, float_t  _Volume_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo, _Volume_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeCallbackInfo) == 0x28, "Size mismatch!");
