#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCAudio/OnSetOutputDeviceSettingsCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(OnSetOutputDeviceSettingsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo, "Epic.OnlineServices.RTCAudio", "OnSetOutputDeviceSettingsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OnSetOutputDeviceSettingsCallbackInfo
struct CORDL_TYPE OnSetOutputDeviceSettingsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnSetOutputDeviceSettingsCallbackInfo() ;
...
constexpr OnSetOutputDeviceSettingsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RealDeviceId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo, _RealDeviceId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OnSetOutputDeviceSettingsCallbackInfo) == 0x18, "Size mismatch!");
