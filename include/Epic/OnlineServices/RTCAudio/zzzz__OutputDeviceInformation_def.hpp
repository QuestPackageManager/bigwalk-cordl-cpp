...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(OutputDeviceInformation)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation, "Epic.OnlineServices.RTCAudio", "OutputDeviceInformation");
// Dependencies 
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OutputDeviceInformation
struct CORDL_TYPE OutputDeviceInformation {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OutputDeviceInformation() ;
...
constexpr OutputDeviceInformation(bool  _DefaultDevice_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation, _DefaultDevice_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation, _DeviceId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation, _DeviceName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OutputDeviceInformation) == 0x18, "Size mismatch!");
