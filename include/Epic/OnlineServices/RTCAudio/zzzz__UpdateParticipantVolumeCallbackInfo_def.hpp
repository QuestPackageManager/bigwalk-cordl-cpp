...
#include <cmath>
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateParticipantVolumeCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, "Epic.OnlineServices.RTCAudio", "UpdateParticipantVolumeCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.UpdateParticipantVolumeCallbackInfo
struct CORDL_TYPE UpdateParticipantVolumeCallbackInfo {
public:
// Declarations
...
/// @brief Method get_Volume, addr 0x1803f2be0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Volume, addr 0x1803f2c00, size 0x10, virtual false, abstract: false, final false
inline void set_Volume(float_t  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr UpdateParticipantVolumeCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_ParticipantId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_Volume_k__BackingField", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Field <Volume>k__BackingField, offset: 0x28, size: 0x4, def value: None
 float_t  _Volume_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _ParticipantId_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo, _Volume_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::UpdateParticipantVolumeCallbackInfo) == 0x30, "Size mismatch!");
