#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCAudio/OnUnregisterPlatformUserCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(OnUnregisterPlatformUserCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo, "Epic.OnlineServices.RTCAudio", "OnUnregisterPlatformUserCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OnUnregisterPlatformUserCallbackInfo
struct CORDL_TYPE OnUnregisterPlatformUserCallbackInfo {
public:
// Declarations
...
/// @brief Method get_PlatformUserId, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_PlatformUserId, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr OnUnregisterPlatformUserCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_PlatformUserId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr OnUnregisterPlatformUserCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _PlatformUserId_k__BackingField) noexcept;
...
/// @brief Field <PlatformUserId>k__BackingField, offset: 0x10, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _PlatformUserId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo, _PlatformUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OnUnregisterPlatformUserCallbackInfo) == 0x18, "Size mismatch!");
