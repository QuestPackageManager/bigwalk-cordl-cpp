...
#include <cstddef>
CORDL_MODULE_EXPORT(OnQueryInputDevicesInformationCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OnQueryInputDevicesInformationCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OnQueryInputDevicesInformationCallbackInfo, "Epic.OnlineServices.RTCAudio", "OnQueryInputDevicesInformationCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OnQueryInputDevicesInformationCallbackInfo
struct CORDL_TYPE OnQueryInputDevicesInformationCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnQueryInputDevicesInformationCallbackInfo() ;
...
constexpr OnQueryInputDevicesInformationCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnQueryInputDevicesInformationCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnQueryInputDevicesInformationCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OnQueryInputDevicesInformationCallbackInfo) == 0x10, "Size mismatch!");
