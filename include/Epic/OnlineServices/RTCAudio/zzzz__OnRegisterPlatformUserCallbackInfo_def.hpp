...
#include <cstddef>
CORDL_MODULE_EXPORT(OnRegisterPlatformUserCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo, "Epic.OnlineServices.RTCAudio", "OnRegisterPlatformUserCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OnRegisterPlatformUserCallbackInfo
struct CORDL_TYPE OnRegisterPlatformUserCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnRegisterPlatformUserCallbackInfo() ;
...
constexpr OnRegisterPlatformUserCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _PlatformUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo, _PlatformUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OnRegisterPlatformUserCallbackInfo) == 0x18, "Size mismatch!");
