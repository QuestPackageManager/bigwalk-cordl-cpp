...
#include <cstddef>
CORDL_MODULE_EXPORT(OnQueryLeaderboardUserScoresCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Leaderboards::OnQueryLeaderboardUserScoresCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Leaderboards::OnQueryLeaderboardUserScoresCompleteCallbackInfo, "Epic.OnlineServices.Leaderboards", "OnQueryLeaderboardUserScoresCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Leaderboards {
// Is value type: true
// CS Name: Epic.OnlineServices.Leaderboards.OnQueryLeaderboardUserScoresCompleteCallbackInfo
struct CORDL_TYPE OnQueryLeaderboardUserScoresCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnQueryLeaderboardUserScoresCompleteCallbackInfo() ;
...
constexpr OnQueryLeaderboardUserScoresCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Leaderboards::OnQueryLeaderboardUserScoresCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Leaderboards::OnQueryLeaderboardUserScoresCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Leaderboards::OnQueryLeaderboardUserScoresCompleteCallbackInfo) == 0x10, "Size mismatch!");
