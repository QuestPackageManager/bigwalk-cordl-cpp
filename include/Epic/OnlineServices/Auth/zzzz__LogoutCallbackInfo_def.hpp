#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Auth/LogoutCallbackInfo.hpp"
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::LogoutCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::LogoutCallbackInfo, "Epic.OnlineServices.Auth", "LogoutCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.LogoutCallbackInfo
...
constexpr LogoutCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Auth::LogoutCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LogoutCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LogoutCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::LogoutCallbackInfo) == 0x18, "Size mismatch!");
