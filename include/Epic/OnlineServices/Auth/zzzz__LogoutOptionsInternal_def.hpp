...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::LogoutOptionsInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::LogoutOptionsInternal, "Epic.OnlineServices.Auth", "LogoutOptionsInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.LogoutOptionsInternal
...
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Auth::LogoutOptions>*() ;
...
inline void Set(::by_ref<::Epic::OnlineServices::Auth::LogoutOptions>  other) ;

/// @brief Convert to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Auth::LogoutOptions>"
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Auth::LogoutOptions>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__Auth__LogoutOptions_() ;
...
static_assert(offsetof(::Epic::OnlineServices::Auth::LogoutOptionsInternal, m_ApiVersion) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LogoutOptionsInternal, m_LocalUserId) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::LogoutOptionsInternal) == 0x10, "Size mismatch!");
