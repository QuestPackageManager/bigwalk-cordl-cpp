...
#include <cstddef>
CORDL_MODULE_EXPORT(LinkAccountCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, "Epic.OnlineServices.Auth", "LinkAccountCallbackInfo");
// Dependencies Epic.OnlineServices.Auth.PinGrantInfo, Epic.OnlineServices.Result, System.Nullable`1<T>
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.LinkAccountCallbackInfo
struct CORDL_TYPE LinkAccountCallbackInfo {
public:
// Declarations
...
/// @brief Method get_SelectedAccountId, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_SelectedAccountId, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_SelectedAccountId(::Epic::OnlineServices::EpicAccountId*  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr LinkAccountCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_PinGrantInfo_k__BackingField", ty: "::System::Nullable_1<::Epic::OnlineServices::Auth::PinGrantInfo>", modifiers: "", def_value: None }, CppParam { name: "_SelectedAccountId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }]
constexpr LinkAccountCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::Auth::PinGrantInfo>  _PinGrantInfo_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _SelectedAccountId_k__BackingField) noexcept;
...
/// @brief Field <SelectedAccountId>k__BackingField, offset: 0x40, size: 0x8, def value: None
 ::Epic::OnlineServices::EpicAccountId*  _SelectedAccountId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, _PinGrantInfo_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo, _SelectedAccountId_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::LinkAccountCallbackInfo) == 0x48, "Size mismatch!");
