...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::AttributeDataValue);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::AttributeDataValue, "Epic.OnlineServices.Lobby", "AttributeDataValue");
// Dependencies Epic.OnlineServices.AttributeType, System.Nullable`1<T>
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.AttributeDataValue
...
static inline ::Epic::OnlineServices::Lobby::AttributeDataValue op_Implicit___Epic__OnlineServices__Lobby__AttributeDataValue(::Epic::OnlineServices::Utf8String*  value) ;

/// @brief Method op_Implicit, addr 0x1804be850, size 0x50, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Lobby::AttributeDataValue op_Implicit___Epic__OnlineServices__Lobby__AttributeDataValue(::StringW  value) ;

/// @brief Method op_Implicit, addr 0x1804be800, size 0x20, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Lobby::AttributeDataValue op_Implicit___Epic__OnlineServices__Lobby__AttributeDataValue(::System::Nullable_1<bool>  value) ;

/// @brief Method op_Implicit, addr 0x1804be7d0, size 0x30, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Lobby::AttributeDataValue op_Implicit___Epic__OnlineServices__Lobby__AttributeDataValue(::System::Nullable_1<double_t>  value) ;

/// @brief Method op_Implicit, addr 0x1804be820, size 0x30, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Lobby::AttributeDataValue op_Implicit___Epic__OnlineServices__Lobby__AttributeDataValue(::System::Nullable_1<int64_t>  value) ;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::AttributeDataValue, m_AsInt64) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::AttributeDataValue, m_AsDouble) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::AttributeDataValue, m_AsBool) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::AttributeDataValue, m_AsUtf8) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::AttributeDataValue, m_ValueType) == 0x30, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::AttributeDataValue) == 0x38, "Size mismatch!");
