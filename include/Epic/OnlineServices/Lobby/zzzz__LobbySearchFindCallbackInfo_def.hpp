...
#include <cstddef>
CORDL_MODULE_EXPORT(LobbySearchFindCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::LobbySearchFindCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::LobbySearchFindCallbackInfo, "Epic.OnlineServices.Lobby", "LobbySearchFindCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.LobbySearchFindCallbackInfo
struct CORDL_TYPE LobbySearchFindCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LobbySearchFindCallbackInfo() ;
...
constexpr LobbySearchFindCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::LobbySearchFindCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LobbySearchFindCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::LobbySearchFindCallbackInfo) == 0x10, "Size mismatch!");
