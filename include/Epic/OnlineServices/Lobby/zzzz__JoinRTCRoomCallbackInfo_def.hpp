...
#include <cstddef>
CORDL_MODULE_EXPORT(JoinRTCRoomCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo, "Epic.OnlineServices.Lobby", "JoinRTCRoomCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.JoinRTCRoomCallbackInfo
struct CORDL_TYPE JoinRTCRoomCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr JoinRTCRoomCallbackInfo() ;
...
constexpr JoinRTCRoomCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::JoinRTCRoomCallbackInfo) == 0x18, "Size mismatch!");
