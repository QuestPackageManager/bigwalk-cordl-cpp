...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal, "Epic.OnlineServices.Lobby", "QueryInvitesCallbackInfoInternal");
// Dependencies Epic.OnlineServices.Result, System.IntPtr
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.QueryInvitesCallbackInfoInternal
...
constexpr operator  ::Epic::OnlineServices::IGettable_1<::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo>*() ;

/// @brief Method Get, addr 0x1804edb70, size 0xf0, virtual true, abstract: false, final true
inline void Get(::by_ref<::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo>  other) ;
...
constexpr ::Epic::OnlineServices::IGettable_1<::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo>* i___Epic__OnlineServices__IGettable_1___Epic__OnlineServices__Lobby__QueryInvitesCallbackInfo_() ;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal, m_ResultCode) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal, m_ClientData) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal, m_LocalUserId) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfoInternal) == 0x18, "Size mismatch!");
