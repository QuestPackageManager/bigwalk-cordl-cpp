#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Lobby/RejectInviteCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(RejectInviteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo, "Epic.OnlineServices.Lobby", "RejectInviteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.RejectInviteCallbackInfo
struct CORDL_TYPE RejectInviteCallbackInfo {
public:
// Declarations
...
/// @brief Method get_InviteId, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_InviteId, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr RejectInviteCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_InviteId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr RejectInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField) noexcept;
...
/// @brief Field <InviteId>k__BackingField, offset: 0x10, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo, _InviteId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::RejectInviteCallbackInfo) == 0x18, "Size mismatch!");
