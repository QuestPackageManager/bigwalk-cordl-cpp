...
#include <cstddef>
CORDL_MODULE_EXPORT(PromoteMemberCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo, "Epic.OnlineServices.Lobby", "PromoteMemberCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.PromoteMemberCallbackInfo
struct CORDL_TYPE PromoteMemberCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr PromoteMemberCallbackInfo() ;
...
constexpr PromoteMemberCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::PromoteMemberCallbackInfo) == 0x18, "Size mismatch!");
