...
#include <cstddef>
CORDL_MODULE_EXPORT(DestroyLobbyCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo, "Epic.OnlineServices.Lobby", "DestroyLobbyCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.DestroyLobbyCallbackInfo
struct CORDL_TYPE DestroyLobbyCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DestroyLobbyCallbackInfo() ;
...
constexpr DestroyLobbyCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::DestroyLobbyCallbackInfo) == 0x18, "Size mismatch!");
