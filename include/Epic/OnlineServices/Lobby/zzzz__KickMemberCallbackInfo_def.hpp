...
#include <cstddef>
CORDL_MODULE_EXPORT(KickMemberCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo, "Epic.OnlineServices.Lobby", "KickMemberCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.KickMemberCallbackInfo
struct CORDL_TYPE KickMemberCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr KickMemberCallbackInfo() ;
...
constexpr KickMemberCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::KickMemberCallbackInfo) == 0x18, "Size mismatch!");
