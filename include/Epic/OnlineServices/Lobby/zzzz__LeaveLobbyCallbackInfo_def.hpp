...
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveLobbyCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo, "Epic.OnlineServices.Lobby", "LeaveLobbyCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.LeaveLobbyCallbackInfo
struct CORDL_TYPE LeaveLobbyCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LeaveLobbyCallbackInfo() ;
...
constexpr LeaveLobbyCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::LeaveLobbyCallbackInfo) == 0x18, "Size mismatch!");
