...
#include <cstddef>
CORDL_MODULE_EXPORT(HardMuteMemberCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo, "Epic.OnlineServices.Lobby", "HardMuteMemberCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.HardMuteMemberCallbackInfo
struct CORDL_TYPE HardMuteMemberCallbackInfo {
public:
// Declarations
...
/// @brief Method get_LobbyId, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_LobbyId, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr HardMuteMemberCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LobbyId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr HardMuteMemberCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
/// @brief Field <LobbyId>k__BackingField, offset: 0x10, size: 0x8, def value: None
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::HardMuteMemberCallbackInfo) == 0x20, "Size mismatch!");
