...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo, "Epic.OnlineServices.Lobby", "QueryInvitesCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.QueryInvitesCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::QueryInvitesCallbackInfo) == 0x18, "Size mismatch!");
