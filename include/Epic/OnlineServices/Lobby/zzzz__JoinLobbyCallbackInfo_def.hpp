...
#include <cstddef>
CORDL_MODULE_EXPORT(JoinLobbyCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo, "Epic.OnlineServices.Lobby", "JoinLobbyCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.JoinLobbyCallbackInfo
struct CORDL_TYPE JoinLobbyCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr JoinLobbyCallbackInfo() ;
...
constexpr JoinLobbyCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::JoinLobbyCallbackInfo) == 0x18, "Size mismatch!");
