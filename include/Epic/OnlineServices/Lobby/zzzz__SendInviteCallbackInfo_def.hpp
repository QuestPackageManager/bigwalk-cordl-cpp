...
#include <cstddef>
CORDL_MODULE_EXPORT(SendInviteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo, "Epic.OnlineServices.Lobby", "SendInviteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.SendInviteCallbackInfo
struct CORDL_TYPE SendInviteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SendInviteCallbackInfo() ;
...
constexpr SendInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::SendInviteCallbackInfo) == 0x18, "Size mismatch!");
