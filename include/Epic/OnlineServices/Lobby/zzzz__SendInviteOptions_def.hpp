...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::SendInviteOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::SendInviteOptions, "Epic.OnlineServices.Lobby", "SendInviteOptions");
// Dependencies 
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.SendInviteOptions
...
constexpr SendInviteOptions(::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteOptions, _LobbyId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::SendInviteOptions, _TargetUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::SendInviteOptions) == 0x18, "Size mismatch!");
