...
#include <cstddef>
CORDL_MODULE_EXPORT(SessionSearchFindCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::SessionSearchFindCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::SessionSearchFindCallbackInfo, "Epic.OnlineServices.Sessions", "SessionSearchFindCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.SessionSearchFindCallbackInfo
struct CORDL_TYPE SessionSearchFindCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SessionSearchFindCallbackInfo() ;
...
constexpr SessionSearchFindCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionSearchFindCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionSearchFindCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::SessionSearchFindCallbackInfo) == 0x10, "Size mismatch!");
