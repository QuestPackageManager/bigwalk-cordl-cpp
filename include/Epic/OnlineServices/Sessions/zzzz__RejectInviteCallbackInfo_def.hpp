...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::RejectInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::RejectInviteCallbackInfo, "Epic.OnlineServices.Sessions", "RejectInviteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.RejectInviteCallbackInfo
...
constexpr RejectInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::RejectInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::RejectInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::RejectInviteCallbackInfo) == 0x10, "Size mismatch!");
