...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal, "Epic.OnlineServices.Sessions", "GetInviteIdByIndexOptionsInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.GetInviteIdByIndexOptionsInternal
...
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptions>*() ;
...
inline void Set(::by_ref<::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptions>  other) ;

/// @brief Convert to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptions>"
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptions>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__Sessions__GetInviteIdByIndexOptions_() ;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal, m_ApiVersion) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal, m_LocalUserId) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal, m_Index) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::GetInviteIdByIndexOptionsInternal) == 0x18, "Size mismatch!");
