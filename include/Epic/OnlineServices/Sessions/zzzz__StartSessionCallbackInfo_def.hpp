...
#include <cstddef>
CORDL_MODULE_EXPORT(StartSessionCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::StartSessionCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::StartSessionCallbackInfo, "Epic.OnlineServices.Sessions", "StartSessionCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.StartSessionCallbackInfo
struct CORDL_TYPE StartSessionCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr StartSessionCallbackInfo() ;
...
constexpr StartSessionCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::StartSessionCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::StartSessionCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::StartSessionCallbackInfo) == 0x10, "Size mismatch!");
