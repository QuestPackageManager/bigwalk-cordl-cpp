...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::EndSessionOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::EndSessionOptions, "Epic.OnlineServices.Sessions", "EndSessionOptions");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.EndSessionOptions
...
constexpr EndSessionOptions(::Epic::OnlineServices::Utf8String*  _SessionName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::EndSessionOptions, _SessionName_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::EndSessionOptions) == 0x8, "Size mismatch!");
