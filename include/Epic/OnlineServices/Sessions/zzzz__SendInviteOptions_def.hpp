...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(SendInviteOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::SendInviteOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::SendInviteOptions, "Epic.OnlineServices.Sessions", "SendInviteOptions");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.SendInviteOptions
struct CORDL_TYPE SendInviteOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SendInviteOptions() ;

// Ctor Parameters [CppParam { name: "_SessionName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr SendInviteOptions(::Epic::OnlineServices::Utf8String*  _SessionName_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::SendInviteOptions, _SessionName_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SendInviteOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SendInviteOptions, _TargetUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::SendInviteOptions) == 0x18, "Size mismatch!");
