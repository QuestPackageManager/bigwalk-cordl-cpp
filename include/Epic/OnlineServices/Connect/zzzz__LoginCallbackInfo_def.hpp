#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Connect/LoginCallbackInfo.hpp"
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::LoginCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::LoginCallbackInfo, "Epic.OnlineServices.Connect", "LoginCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.LoginCallbackInfo
...
/// @brief Method get_ContinuanceToken, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ContinuanceToken, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_ContinuanceToken_k__BackingField", ty: "::Epic::OnlineServices::ContinuanceToken*", modifiers: "", def_value: None }]
constexpr LoginCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ContinuanceToken*  _ContinuanceToken_k__BackingField) noexcept;
...
/// @brief Field <ContinuanceToken>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::ContinuanceToken*  _ContinuanceToken_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Connect::LoginCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LoginCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LoginCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LoginCallbackInfo, _ContinuanceToken_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::LoginCallbackInfo) == 0x20, "Size mismatch!");
