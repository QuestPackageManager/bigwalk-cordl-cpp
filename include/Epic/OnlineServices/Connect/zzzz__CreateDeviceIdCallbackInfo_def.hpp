...
#include <cstddef>
CORDL_MODULE_EXPORT(CreateDeviceIdCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::CreateDeviceIdCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::CreateDeviceIdCallbackInfo, "Epic.OnlineServices.Connect", "CreateDeviceIdCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.CreateDeviceIdCallbackInfo
struct CORDL_TYPE CreateDeviceIdCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CreateDeviceIdCallbackInfo() ;
...
constexpr CreateDeviceIdCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::CreateDeviceIdCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::CreateDeviceIdCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::CreateDeviceIdCallbackInfo) == 0x10, "Size mismatch!");
