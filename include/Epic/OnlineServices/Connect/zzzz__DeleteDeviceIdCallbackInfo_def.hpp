...
#include <cstddef>
CORDL_MODULE_EXPORT(DeleteDeviceIdCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::DeleteDeviceIdCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::DeleteDeviceIdCallbackInfo, "Epic.OnlineServices.Connect", "DeleteDeviceIdCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.DeleteDeviceIdCallbackInfo
struct CORDL_TYPE DeleteDeviceIdCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DeleteDeviceIdCallbackInfo() ;
...
constexpr DeleteDeviceIdCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::DeleteDeviceIdCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::DeleteDeviceIdCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::DeleteDeviceIdCallbackInfo) == 0x10, "Size mismatch!");
