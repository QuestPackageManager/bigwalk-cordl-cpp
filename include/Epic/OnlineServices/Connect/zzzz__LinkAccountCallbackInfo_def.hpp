#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Connect/LinkAccountCallbackInfo.hpp"
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo, "Epic.OnlineServices.Connect", "LinkAccountCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.LinkAccountCallbackInfo
...
constexpr LinkAccountCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::LinkAccountCallbackInfo) == 0x18, "Size mismatch!");
