...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryProductUserIdMappingsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo, "Epic.OnlineServices.Connect", "QueryProductUserIdMappingsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.QueryProductUserIdMappingsCallbackInfo
struct CORDL_TYPE QueryProductUserIdMappingsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryProductUserIdMappingsCallbackInfo() ;
...
constexpr QueryProductUserIdMappingsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::QueryProductUserIdMappingsCallbackInfo) == 0x18, "Size mismatch!");
