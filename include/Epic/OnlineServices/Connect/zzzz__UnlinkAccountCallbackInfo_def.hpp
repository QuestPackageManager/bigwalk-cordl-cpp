...
#include <cstddef>
CORDL_MODULE_EXPORT(UnlinkAccountCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo, "Epic.OnlineServices.Connect", "UnlinkAccountCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.UnlinkAccountCallbackInfo
struct CORDL_TYPE UnlinkAccountCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UnlinkAccountCallbackInfo() ;
...
constexpr UnlinkAccountCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::UnlinkAccountCallbackInfo) == 0x18, "Size mismatch!");
