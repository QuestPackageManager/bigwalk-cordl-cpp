...
#include <cstddef>
CORDL_MODULE_EXPORT(LogoutCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::LogoutCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::LogoutCallbackInfo, "Epic.OnlineServices.Connect", "LogoutCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.LogoutCallbackInfo
struct CORDL_TYPE LogoutCallbackInfo {
public:
// Declarations
...
constexpr LogoutCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::LogoutCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LogoutCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::LogoutCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::LogoutCallbackInfo) == 0x18, "Size mismatch!");
