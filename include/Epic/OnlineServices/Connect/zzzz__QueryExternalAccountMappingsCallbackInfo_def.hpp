...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryExternalAccountMappingsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo, "Epic.OnlineServices.Connect", "QueryExternalAccountMappingsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.QueryExternalAccountMappingsCallbackInfo
struct CORDL_TYPE QueryExternalAccountMappingsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryExternalAccountMappingsCallbackInfo() ;
...
constexpr QueryExternalAccountMappingsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::QueryExternalAccountMappingsCallbackInfo) == 0x18, "Size mismatch!");
