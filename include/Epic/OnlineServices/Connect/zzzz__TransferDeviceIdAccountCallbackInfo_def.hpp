...
#include <cstddef>
CORDL_MODULE_EXPORT(TransferDeviceIdAccountCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo, "Epic.OnlineServices.Connect", "TransferDeviceIdAccountCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.TransferDeviceIdAccountCallbackInfo
struct CORDL_TYPE TransferDeviceIdAccountCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr TransferDeviceIdAccountCallbackInfo() ;
...
constexpr TransferDeviceIdAccountCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::TransferDeviceIdAccountCallbackInfo) == 0x18, "Size mismatch!");
