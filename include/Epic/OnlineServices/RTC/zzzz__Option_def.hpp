...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::Option);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::Option, "Epic.OnlineServices.RTC", "Option");
// Dependencies 
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.Option
struct CORDL_TYPE Option {
public:
// Declarations
...
constexpr Option(::Epic::OnlineServices::Utf8String*  _Key_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Value_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTC::Option, _Key_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::Option, _Value_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::Option) == 0x10, "Size mismatch!");
