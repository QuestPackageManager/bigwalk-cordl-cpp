...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveRoomOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::LeaveRoomOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::LeaveRoomOptions, "Epic.OnlineServices.RTC", "LeaveRoomOptions");
// Dependencies 
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.LeaveRoomOptions
struct CORDL_TYPE LeaveRoomOptions {
public:
// Declarations
...
constexpr LeaveRoomOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomOptions, _RoomName_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::LeaveRoomOptions) == 0x10, "Size mismatch!");
