...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(ParticipantMetadata)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::ParticipantMetadata);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::ParticipantMetadata, "Epic.OnlineServices.RTC", "ParticipantMetadata");
// Dependencies 
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.ParticipantMetadata
struct CORDL_TYPE ParticipantMetadata {
public:
// Declarations
...
constexpr ParticipantMetadata(::Epic::OnlineServices::Utf8String*  _Key_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Value_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTC::ParticipantMetadata, _Key_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::ParticipantMetadata, _Value_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::ParticipantMetadata) == 0x10, "Size mismatch!");
