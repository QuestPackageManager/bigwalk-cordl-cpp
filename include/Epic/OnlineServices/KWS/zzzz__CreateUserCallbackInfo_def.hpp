...
#include <cstddef>
CORDL_MODULE_EXPORT(CreateUserCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::KWS::CreateUserCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, "Epic.OnlineServices.KWS", "CreateUserCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::KWS {
// Is value type: true
// CS Name: Epic.OnlineServices.KWS.CreateUserCallbackInfo
struct CORDL_TYPE CreateUserCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CreateUserCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_KWSUserId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_IsMinor_k__BackingField", ty: "bool", modifiers: "", def_value: None }]
constexpr CreateUserCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _KWSUserId_k__BackingField, bool  _IsMinor_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, _KWSUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo, _IsMinor_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::KWS::CreateUserCallbackInfo) == 0x28, "Size mismatch!");
