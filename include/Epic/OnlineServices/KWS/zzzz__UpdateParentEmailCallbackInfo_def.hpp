...
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateParentEmailCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo, "Epic.OnlineServices.KWS", "UpdateParentEmailCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::KWS {
// Is value type: true
// CS Name: Epic.OnlineServices.KWS.UpdateParentEmailCallbackInfo
struct CORDL_TYPE UpdateParentEmailCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UpdateParentEmailCallbackInfo() ;
...
constexpr UpdateParentEmailCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::KWS::UpdateParentEmailCallbackInfo) == 0x18, "Size mismatch!");
