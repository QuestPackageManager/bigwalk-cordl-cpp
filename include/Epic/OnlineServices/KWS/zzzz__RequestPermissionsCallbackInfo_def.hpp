...
#include <cstddef>
CORDL_MODULE_EXPORT(RequestPermissionsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo, "Epic.OnlineServices.KWS", "RequestPermissionsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::KWS {
// Is value type: true
// CS Name: Epic.OnlineServices.KWS.RequestPermissionsCallbackInfo
struct CORDL_TYPE RequestPermissionsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr RequestPermissionsCallbackInfo() ;
...
constexpr RequestPermissionsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::KWS::RequestPermissionsCallbackInfo) == 0x18, "Size mismatch!");
