...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryPermissionsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, "Epic.OnlineServices.KWS", "QueryPermissionsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::KWS {
// Is value type: true
// CS Name: Epic.OnlineServices.KWS.QueryPermissionsCallbackInfo
struct CORDL_TYPE QueryPermissionsCallbackInfo {
public:
// Declarations
...
/// @brief Method get_DateOfBirth, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::Utf8String* get_DateOfBirth() ;

/// @brief Method get_IsMinor, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsMinor() ;

/// @brief Method get_KWSUserId, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ParentEmail, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DateOfBirth, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_DateOfBirth(::Epic::OnlineServices::Utf8String*  value) ;

/// @brief Method set_IsMinor, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
inline void set_IsMinor(bool  value) ;

/// @brief Method set_KWSUserId, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ParentEmail, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryPermissionsCallbackInfo() ;
...
constexpr QueryPermissionsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _KWSUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DateOfBirth_k__BackingField, bool  _IsMinor_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ParentEmail_k__BackingField) noexcept;
...
/// @brief Field <KWSUserId>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _KWSUserId_k__BackingField;

/// @brief Field <DateOfBirth>k__BackingField, offset: 0x20, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _DateOfBirth_k__BackingField;

/// @brief Field <IsMinor>k__BackingField, offset: 0x28, size: 0x1, def value: None
 bool  _IsMinor_k__BackingField;

/// @brief Field <ParentEmail>k__BackingField, offset: 0x30, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _ParentEmail_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _KWSUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _DateOfBirth_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _IsMinor_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo, _ParentEmail_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::KWS::QueryPermissionsCallbackInfo) == 0x38, "Size mismatch!");
