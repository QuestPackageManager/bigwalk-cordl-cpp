...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(ShowReportPlayerOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::ShowReportPlayerOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::ShowReportPlayerOptions, "Epic.OnlineServices.UI", "ShowReportPlayerOptions");
// Dependencies 
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.ShowReportPlayerOptions
struct CORDL_TYPE ShowReportPlayerOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ShowReportPlayerOptions() ;
...
constexpr ShowReportPlayerOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::ShowReportPlayerOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowReportPlayerOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::ShowReportPlayerOptions) == 0x10, "Size mismatch!");
