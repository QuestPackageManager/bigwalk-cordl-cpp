...
#include <cstddef>
CORDL_MODULE_EXPORT(ShowFriendsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo, "Epic.OnlineServices.UI", "ShowFriendsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.ShowFriendsCallbackInfo
struct CORDL_TYPE ShowFriendsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ShowFriendsCallbackInfo() ;
...
constexpr ShowFriendsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::ShowFriendsCallbackInfo) == 0x18, "Size mismatch!");
