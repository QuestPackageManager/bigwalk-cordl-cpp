...
#include <cstddef>
CORDL_MODULE_EXPORT(OnShowBlockPlayerCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo, "Epic.OnlineServices.UI", "OnShowBlockPlayerCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.OnShowBlockPlayerCallbackInfo
struct CORDL_TYPE OnShowBlockPlayerCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnShowBlockPlayerCallbackInfo() ;
...
constexpr OnShowBlockPlayerCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::OnShowBlockPlayerCallbackInfo) == 0x20, "Size mismatch!");
