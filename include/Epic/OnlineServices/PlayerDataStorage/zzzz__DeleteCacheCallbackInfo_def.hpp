#pragma once
// IWYU pragma private; include "Epic/OnlineServices/PlayerDataStorage/DeleteCacheCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(DeleteCacheCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo, "Epic.OnlineServices.PlayerDataStorage", "DeleteCacheCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.DeleteCacheCallbackInfo
struct CORDL_TYPE DeleteCacheCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DeleteCacheCallbackInfo() ;
...
constexpr DeleteCacheCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::DeleteCacheCallbackInfo) == 0x18, "Size mismatch!");
