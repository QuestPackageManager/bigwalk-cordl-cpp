...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, "Epic.OnlineServices.PlayerDataStorage", "ReadFileOptions");
// Dependencies 
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.ReadFileOptions
...
// Declarations
 ...
 __declspec(property(get=get_ReadFileDataCallback, put=set_ReadFileDataCallback)) ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback*  ReadFileDataCallback;
...
inline ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback* get_ReadFileDataCallback() ;
...
inline void set_ReadFileDataCallback(::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback*  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr ReadFileOptions() ;

// Ctor Parameters [CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_Filename_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_ReadChunkLengthBytes_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_ReadFileDataCallback_k__BackingField", ty: "::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback*", modifiers: "", def_value: None }, CppParam { name: "_FileTransferProgressCallback_k__BackingField", ty: "::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallback*", modifiers: "", def_value: None }]
constexpr ReadFileOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Filename_k__BackingField, uint32_t  _ReadChunkLengthBytes_k__BackingField, ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback*  _ReadFileDataCallback_k__BackingField, ::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallback*  _FileTransferProgressCallback_k__BackingField) noexcept;
...
/// @brief Field <ReadFileDataCallback>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallback*  _ReadFileDataCallback_k__BackingField;
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, _Filename_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, _ReadChunkLengthBytes_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, _ReadFileDataCallback_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions, _FileTransferProgressCallback_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::ReadFileOptions) == 0x28, "Size mismatch!");
