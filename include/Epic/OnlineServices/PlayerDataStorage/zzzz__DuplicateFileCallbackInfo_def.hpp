...
#include <cstddef>
CORDL_MODULE_EXPORT(DuplicateFileCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo, "Epic.OnlineServices.PlayerDataStorage", "DuplicateFileCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.DuplicateFileCallbackInfo
struct CORDL_TYPE DuplicateFileCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DuplicateFileCallbackInfo() ;
...
constexpr DuplicateFileCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::DuplicateFileCallbackInfo) == 0x18, "Size mismatch!");
