...
#include <cstddef>
CORDL_MODULE_EXPORT(OnIncomingConnectionRequestInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo, "Epic.OnlineServices.P2P", "OnIncomingConnectionRequestInfo");
// Dependencies Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.OnIncomingConnectionRequestInfo
struct CORDL_TYPE OnIncomingConnectionRequestInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnIncomingConnectionRequestInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RemoteUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_SocketId_k__BackingField", ty: "::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>", modifiers: "", def_value: None }]
constexpr OnIncomingConnectionRequestInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _RemoteUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo, _RemoteUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo, _SocketId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::OnIncomingConnectionRequestInfo) == 0x40, "Size mismatch!");
