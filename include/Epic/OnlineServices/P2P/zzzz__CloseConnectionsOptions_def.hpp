...
#include <cstddef>
CORDL_MODULE_EXPORT(CloseConnectionsOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::CloseConnectionsOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::CloseConnectionsOptions, "Epic.OnlineServices.P2P", "CloseConnectionsOptions");
// Dependencies Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.CloseConnectionsOptions
struct CORDL_TYPE CloseConnectionsOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CloseConnectionsOptions() ;
...
constexpr CloseConnectionsOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::P2P::CloseConnectionsOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::CloseConnectionsOptions, _SocketId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::CloseConnectionsOptions) == 0x30, "Size mismatch!");
