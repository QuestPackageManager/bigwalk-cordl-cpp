...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryOwnershipTokenOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions, "Epic.OnlineServices.Ecom", "QueryOwnershipTokenOptions");
// Dependencies Epic.OnlineServices.Utf8String
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.QueryOwnershipTokenOptions
struct CORDL_TYPE QueryOwnershipTokenOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryOwnershipTokenOptions() ;
...
constexpr QueryOwnershipTokenOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::ArrayW<::Epic::OnlineServices::Utf8String*>  _CatalogItemIds_k__BackingField, ::Epic::OnlineServices::Utf8String*  _CatalogNamespace_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions, _CatalogItemIds_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions, _CatalogNamespace_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::QueryOwnershipTokenOptions) == 0x18, "Size mismatch!");
