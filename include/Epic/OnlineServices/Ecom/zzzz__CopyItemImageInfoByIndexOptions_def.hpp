...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(CopyItemImageInfoByIndexOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions, "Epic.OnlineServices.Ecom", "CopyItemImageInfoByIndexOptions");
// Dependencies 
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.CopyItemImageInfoByIndexOptions
struct CORDL_TYPE CopyItemImageInfoByIndexOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CopyItemImageInfoByIndexOptions() ;

// Ctor Parameters [CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_ItemId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_ImageInfoIndex_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr CopyItemImageInfoByIndexOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ItemId_k__BackingField, uint32_t  _ImageInfoIndex_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions, _ItemId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions, _ImageInfoIndex_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::CopyItemImageInfoByIndexOptions) == 0x18, "Size mismatch!");
