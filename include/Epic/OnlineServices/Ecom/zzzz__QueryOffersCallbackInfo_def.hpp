...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryOffersCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo, "Epic.OnlineServices.Ecom", "QueryOffersCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.QueryOffersCallbackInfo
struct CORDL_TYPE QueryOffersCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryOffersCallbackInfo() ;
...
constexpr QueryOffersCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::QueryOffersCallbackInfo) == 0x18, "Size mismatch!");
