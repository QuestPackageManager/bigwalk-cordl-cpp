...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetOfferImageInfoCountOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::GetOfferImageInfoCountOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::GetOfferImageInfoCountOptions, "Epic.OnlineServices.Ecom", "GetOfferImageInfoCountOptions");
// Dependencies 
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.GetOfferImageInfoCountOptions
struct CORDL_TYPE GetOfferImageInfoCountOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr GetOfferImageInfoCountOptions() ;
...
constexpr GetOfferImageInfoCountOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _OfferId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::GetOfferImageInfoCountOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::GetOfferImageInfoCountOptions, _OfferId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::GetOfferImageInfoCountOptions) == 0x10, "Size mismatch!");
