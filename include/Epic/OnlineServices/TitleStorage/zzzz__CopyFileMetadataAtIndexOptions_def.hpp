...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::TitleStorage::CopyFileMetadataAtIndexOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::TitleStorage::CopyFileMetadataAtIndexOptions, "Epic.OnlineServices.TitleStorage", "CopyFileMetadataAtIndexOptions");
// Dependencies 
namespace Epic::OnlineServices::TitleStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.TitleStorage.CopyFileMetadataAtIndexOptions
...
static_assert(offsetof(::Epic::OnlineServices::TitleStorage::CopyFileMetadataAtIndexOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::CopyFileMetadataAtIndexOptions, _Index_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::TitleStorage::CopyFileMetadataAtIndexOptions) == 0x10, "Size mismatch!");
