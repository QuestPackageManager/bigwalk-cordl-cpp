...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo, "Epic.OnlineServices.TitleStorage", "QueryFileListCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::TitleStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.TitleStorage.QueryFileListCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo, _FileCount_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::TitleStorage::QueryFileListCallbackInfo) == 0x20, "Size mismatch!");
