...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, "Epic.OnlineServices.TitleStorage", "FileTransferProgressCallbackInfoInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::TitleStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.TitleStorage.FileTransferProgressCallbackInfoInternal
...
constexpr operator  ::Epic::OnlineServices::IGettable_1<::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfo>*() ;

/// @brief Method Get, addr 0x1804d8d80, size 0x270, virtual true, abstract: false, final true
inline void Get(::by_ref<::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfo>  other) ;
...
constexpr ::Epic::OnlineServices::IGettable_1<::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfo>* i___Epic__OnlineServices__IGettable_1___Epic__OnlineServices__TitleStorage__FileTransferProgressCallbackInfo_() ;
...
static_assert(offsetof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, m_ClientData) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, m_LocalUserId) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, m_Filename) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, m_BytesTransferred) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal, m_TotalFileSizeBytes) == 0x1c, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::TitleStorage::FileTransferProgressCallbackInfoInternal) == 0x20, "Size mismatch!");
