...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo, "Epic.OnlineServices.TitleStorage", "DeleteCacheCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::TitleStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.TitleStorage.DeleteCacheCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::TitleStorage::DeleteCacheCallbackInfo) == 0x18, "Size mismatch!");
