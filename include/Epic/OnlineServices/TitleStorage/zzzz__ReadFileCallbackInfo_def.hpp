...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo, "Epic.OnlineServices.TitleStorage", "ReadFileCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::TitleStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.TitleStorage.ReadFileCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo, _Filename_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::TitleStorage::ReadFileCallbackInfo) == 0x20, "Size mismatch!");
