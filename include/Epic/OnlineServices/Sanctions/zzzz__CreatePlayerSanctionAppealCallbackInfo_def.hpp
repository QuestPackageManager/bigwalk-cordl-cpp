...
#include <cstddef>
CORDL_MODULE_EXPORT(CreatePlayerSanctionAppealCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo, "Epic.OnlineServices.Sanctions", "CreatePlayerSanctionAppealCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sanctions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sanctions.CreatePlayerSanctionAppealCallbackInfo
struct CORDL_TYPE CreatePlayerSanctionAppealCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CreatePlayerSanctionAppealCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_ReferenceId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr CreatePlayerSanctionAppealCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ReferenceId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo, _ReferenceId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sanctions::CreatePlayerSanctionAppealCallbackInfo) == 0x18, "Size mismatch!");
