...
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateModCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Mods::UpdateModCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Mods::UpdateModCallbackInfo, "Epic.OnlineServices.Mods", "UpdateModCallbackInfo");
// Dependencies Epic.OnlineServices.Mods.ModIdentifier, Epic.OnlineServices.Result, System.Nullable`1<T>
namespace Epic::OnlineServices::Mods {
// Is value type: true
// CS Name: Epic.OnlineServices.Mods.UpdateModCallbackInfo
struct CORDL_TYPE UpdateModCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UpdateModCallbackInfo() ;
...
constexpr UpdateModCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::Mods::ModIdentifier>  _Mod_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Mods::UpdateModCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::UpdateModCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::UpdateModCallbackInfo, _ClientData_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::UpdateModCallbackInfo, _Mod_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Mods::UpdateModCallbackInfo) == 0x48, "Size mismatch!");
