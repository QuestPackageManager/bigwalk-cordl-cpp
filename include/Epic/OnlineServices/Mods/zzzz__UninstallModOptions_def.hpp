...
#include <cstddef>
CORDL_MODULE_EXPORT(UninstallModOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Mods::UninstallModOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Mods::UninstallModOptions, "Epic.OnlineServices.Mods", "UninstallModOptions");
// Dependencies Epic.OnlineServices.Mods.ModIdentifier, System.Nullable`1<T>
namespace Epic::OnlineServices::Mods {
// Is value type: true
// CS Name: Epic.OnlineServices.Mods.UninstallModOptions
struct CORDL_TYPE UninstallModOptions {
public:
// Declarations
...
constexpr UninstallModOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::Mods::ModIdentifier>  _Mod_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Mods::UninstallModOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::UninstallModOptions, _Mod_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Mods::UninstallModOptions) == 0x38, "Size mismatch!");
