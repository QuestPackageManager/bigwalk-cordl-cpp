...
#include <cstddef>
CORDL_MODULE_EXPORT(InstallModCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Mods::InstallModCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Mods::InstallModCallbackInfo, "Epic.OnlineServices.Mods", "InstallModCallbackInfo");
// Dependencies Epic.OnlineServices.Mods.ModIdentifier, Epic.OnlineServices.Result, System.Nullable`1<T>
namespace Epic::OnlineServices::Mods {
// Is value type: true
// CS Name: Epic.OnlineServices.Mods.InstallModCallbackInfo
struct CORDL_TYPE InstallModCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr InstallModCallbackInfo() ;
...
constexpr InstallModCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::Mods::ModIdentifier>  _Mod_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Mods::InstallModCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::InstallModCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::InstallModCallbackInfo, _ClientData_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Mods::InstallModCallbackInfo, _Mod_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Mods::InstallModCallbackInfo) == 0x48, "Size mismatch!");
