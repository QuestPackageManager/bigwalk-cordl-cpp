...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::RejectInviteOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::RejectInviteOptions, "Epic.OnlineServices.Friends", "RejectInviteOptions");
// Dependencies 
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.RejectInviteOptions
...
constexpr RejectInviteOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::RejectInviteOptions) == 0x10, "Size mismatch!");
