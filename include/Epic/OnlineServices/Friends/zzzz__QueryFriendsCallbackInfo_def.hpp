...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryFriendsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo, "Epic.OnlineServices.Friends", "QueryFriendsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.QueryFriendsCallbackInfo
struct CORDL_TYPE QueryFriendsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryFriendsCallbackInfo() ;
...
constexpr QueryFriendsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::QueryFriendsCallbackInfo) == 0x18, "Size mismatch!");
