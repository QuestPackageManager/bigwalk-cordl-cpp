...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(AcceptInviteOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::AcceptInviteOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::AcceptInviteOptions, "Epic.OnlineServices.Friends", "AcceptInviteOptions");
// Dependencies 
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.AcceptInviteOptions
struct CORDL_TYPE AcceptInviteOptions {
public:
// Declarations
...
constexpr AcceptInviteOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::AcceptInviteOptions) == 0x10, "Size mismatch!");
