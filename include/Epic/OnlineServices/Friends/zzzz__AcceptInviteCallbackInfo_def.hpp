...
#include <cstddef>
CORDL_MODULE_EXPORT(AcceptInviteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo, "Epic.OnlineServices.Friends", "AcceptInviteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.AcceptInviteCallbackInfo
struct CORDL_TYPE AcceptInviteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr AcceptInviteCallbackInfo() ;
...
constexpr AcceptInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::AcceptInviteCallbackInfo) == 0x20, "Size mismatch!");
