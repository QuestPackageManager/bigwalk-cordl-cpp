...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(CopyPlayerAchievementByIndexOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions, "Epic.OnlineServices.Achievements", "CopyPlayerAchievementByIndexOptions");
// Dependencies 
namespace Epic::OnlineServices::Achievements {
// Is value type: true
// CS Name: Epic.OnlineServices.Achievements.CopyPlayerAchievementByIndexOptions
struct CORDL_TYPE CopyPlayerAchievementByIndexOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CopyPlayerAchievementByIndexOptions() ;

// Ctor Parameters [CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_AchievementIndex_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr CopyPlayerAchievementByIndexOptions(::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, uint32_t  _AchievementIndex_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions, _TargetUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions, _AchievementIndex_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Achievements::CopyPlayerAchievementByIndexOptions) == 0x18, "Size mismatch!");
