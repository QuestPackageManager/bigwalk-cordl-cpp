#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Achievements/OnQueryDefinitionsCompleteCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(OnQueryDefinitionsCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Achievements::OnQueryDefinitionsCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Achievements::OnQueryDefinitionsCompleteCallbackInfo, "Epic.OnlineServices.Achievements", "OnQueryDefinitionsCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Achievements {
// Is value type: true
// CS Name: Epic.OnlineServices.Achievements.OnQueryDefinitionsCompleteCallbackInfo
struct CORDL_TYPE OnQueryDefinitionsCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnQueryDefinitionsCompleteCallbackInfo() ;
...
constexpr OnQueryDefinitionsCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Achievements::OnQueryDefinitionsCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Achievements::OnQueryDefinitionsCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Achievements::OnQueryDefinitionsCompleteCallbackInfo) == 0x10, "Size mismatch!");
