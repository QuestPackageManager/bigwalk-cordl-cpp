...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(QueryPlayerAchievementsOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Achievements::QueryPlayerAchievementsOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Achievements::QueryPlayerAchievementsOptions, "Epic.OnlineServices.Achievements", "QueryPlayerAchievementsOptions");
// Dependencies 
namespace Epic::OnlineServices::Achievements {
// Is value type: true
// CS Name: Epic.OnlineServices.Achievements.QueryPlayerAchievementsOptions
struct CORDL_TYPE QueryPlayerAchievementsOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryPlayerAchievementsOptions() ;
...
constexpr QueryPlayerAchievementsOptions(::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Achievements::QueryPlayerAchievementsOptions, _TargetUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Achievements::QueryPlayerAchievementsOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Achievements::QueryPlayerAchievementsOptions) == 0x10, "Size mismatch!");
