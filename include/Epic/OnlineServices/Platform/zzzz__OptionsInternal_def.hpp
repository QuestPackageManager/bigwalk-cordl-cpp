...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Platform::OptionsInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Platform::OptionsInternal, "Epic.OnlineServices.Platform", "OptionsInternal");
...
namespace Epic::OnlineServices::Platform {
// Is value type: true
// CS Name: Epic.OnlineServices.Platform.OptionsInternal
...
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Platform::Options>*() ;
...
/// @brief Method Set, addr 0x1804fc060, size 0x310, virtual true, abstract: false, final true
inline void Set(::by_ref<::Epic::OnlineServices::Platform::Options>  other) ;

/// @brief Convert to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Platform::Options>"
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Platform::Options>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__Platform__Options_() ;
...
static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_ApiVersion) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_Reserved) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_ProductId) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_SandboxId) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_ClientCredentials) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_IsServer) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_EncryptionKey) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_OverrideCountryCode) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_OverrideLocaleCode) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_DeploymentId) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_Flags) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_CacheDirectory) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_TickBudgetInMilliseconds) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_RTCOptions) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_IntegratedPlatformOptionsContainerHandle) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_SystemSpecificOptions) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::OptionsInternal, m_TaskNetworkTimeoutSeconds) == 0x88, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Platform::OptionsInternal) == 0x90, "Size mismatch!");
