...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Platform::Options);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Platform::Options, "Epic.OnlineServices.Platform", "Options");
// Dependencies Epic.OnlineServices.Platform.ClientCredentials, Epic.OnlineServices.Platform.PlatformFlags, Epic.OnlineServices.Platform.RTCOptions, System.IntPtr, System.Nullable`1<T>
namespace Epic::OnlineServices::Platform {
// Is value type: true
// CS Name: Epic.OnlineServices.Platform.Options
...
// Declarations
 ...
 __declspec(property(get=get_RTCOptions, put=set_RTCOptions)) ::System::Nullable_1<::Epic::OnlineServices::Platform::RTCOptions>  RTCOptions;
...
/// @brief Method get_IntegratedPlatformOptionsContainerHandle, addr 0x1802e5800, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_RTCOptions, addr 0x1804f6750, size 0x20, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Epic::OnlineServices::Platform::RTCOptions> get_RTCOptions() ;
...
/// @brief Method get_SystemSpecificOptions, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::System::IntPtr get_SystemSpecificOptions() ;

/// @brief Method get_TaskNetworkTimeoutSeconds, addr 0x1804f6770, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_IntegratedPlatformOptionsContainerHandle, addr 0x180374490, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_RTCOptions, addr 0x1804f6780, size 0x10, virtual false, abstract: false, final false
inline void set_RTCOptions(::System::Nullable_1<::Epic::OnlineServices::Platform::RTCOptions>  value) ;
...
/// @brief Method set_SystemSpecificOptions, addr 0x1804f6790, size 0x10, virtual false, abstract: false, final false
inline void set_SystemSpecificOptions(::System::IntPtr  value) ;

/// @brief Method set_TaskNetworkTimeoutSeconds, addr 0x1804f67a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field <RTCOptions>k__BackingField, offset: 0x68, size: 0x20, def value: None
 ::System::Nullable_1<::Epic::OnlineServices::Platform::RTCOptions>  _RTCOptions_k__BackingField;

/// @brief Field <IntegratedPlatformOptionsContainerHandle>k__BackingField, offset: 0x88, size: 0x8, def value: None
...
/// @brief Field <SystemSpecificOptions>k__BackingField, offset: 0x90, size: 0x8, def value: None
 ::System::IntPtr  _SystemSpecificOptions_k__BackingField;

/// @brief Field <TaskNetworkTimeoutSeconds>k__BackingField, offset: 0x98, size: 0x10, def value: None
 ::System::Nullable_1<double_t>  _TaskNetworkTimeoutSeconds_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _Reserved_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _ProductId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _SandboxId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _ClientCredentials_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _IsServer_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _EncryptionKey_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _OverrideCountryCode_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _OverrideLocaleCode_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _DeploymentId_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _Flags_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _CacheDirectory_k__BackingField) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _TickBudgetInMilliseconds_k__BackingField) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _RTCOptions_k__BackingField) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _IntegratedPlatformOptionsContainerHandle_k__BackingField) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _SystemSpecificOptions_k__BackingField) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Platform::Options, _TaskNetworkTimeoutSeconds_k__BackingField) == 0x98, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Platform::Options) == 0xa8, "Size mismatch!");
