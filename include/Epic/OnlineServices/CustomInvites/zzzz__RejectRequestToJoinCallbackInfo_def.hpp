...
#include <cstddef>
CORDL_MODULE_EXPORT(RejectRequestToJoinCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo, "Epic.OnlineServices.CustomInvites", "RejectRequestToJoinCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.RejectRequestToJoinCallbackInfo
struct CORDL_TYPE RejectRequestToJoinCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr RejectRequestToJoinCallbackInfo() ;
...
constexpr RejectRequestToJoinCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::RejectRequestToJoinCallbackInfo) == 0x20, "Size mismatch!");
