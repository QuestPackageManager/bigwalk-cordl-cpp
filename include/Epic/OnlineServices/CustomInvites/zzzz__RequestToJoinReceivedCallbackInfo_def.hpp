...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(RequestToJoinReceivedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo, "Epic.OnlineServices.CustomInvites", "RequestToJoinReceivedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.RequestToJoinReceivedCallbackInfo
struct CORDL_TYPE RequestToJoinReceivedCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr RequestToJoinReceivedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_FromUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_ToUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr RequestToJoinReceivedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _FromUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _ToUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo, _FromUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo, _ToUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::RequestToJoinReceivedCallbackInfo) == 0x18, "Size mismatch!");
