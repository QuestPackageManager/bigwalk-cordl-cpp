#pragma once
// IWYU pragma private; include "Epic/OnlineServices/CustomInvites/SendCustomInviteCallbackInfo.hpp"
...
#include <cstddef>
CORDL_MODULE_EXPORT(SendCustomInviteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo, "Epic.OnlineServices.CustomInvites", "SendCustomInviteCallbackInfo");
// Dependencies Epic.OnlineServices.ProductUserId, Epic.OnlineServices.Result
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.SendCustomInviteCallbackInfo
struct CORDL_TYPE SendCustomInviteCallbackInfo {
public:
// Declarations
...
/// @brief Method get_TargetUserIds, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_TargetUserIds, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_TargetUserIds(::ArrayW<::Epic::OnlineServices::ProductUserId*>  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr SendCustomInviteCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserIds_k__BackingField", ty: "::ArrayW<::Epic::OnlineServices::ProductUserId*>", modifiers: "", def_value: None }]
constexpr SendCustomInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::ArrayW<::Epic::OnlineServices::ProductUserId*>  _TargetUserIds_k__BackingField) noexcept;
...
/// @brief Field <TargetUserIds>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::Epic::OnlineServices::ProductUserId*>  _TargetUserIds_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo, _TargetUserIds_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::SendCustomInviteCallbackInfo) == 0x20, "Size mismatch!");
