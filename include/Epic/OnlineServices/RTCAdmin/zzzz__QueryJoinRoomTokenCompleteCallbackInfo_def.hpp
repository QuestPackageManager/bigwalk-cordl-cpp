...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(QueryJoinRoomTokenCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, "Epic.OnlineServices.RTCAdmin", "QueryJoinRoomTokenCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAdmin {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAdmin.QueryJoinRoomTokenCompleteCallbackInfo
struct CORDL_TYPE QueryJoinRoomTokenCompleteCallbackInfo {
public:
// Declarations
 ...
 __declspec(property(get=get_TokenCount, put=set_TokenCount)) uint32_t  TokenCount;
...
/// @brief Method get_ClientBaseUrl, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_QueryId, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_TokenCount, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_TokenCount() ;

/// @brief Convert to "::Epic::OnlineServices::ICallbackInfo"
constexpr ::Epic::OnlineServices::ICallbackInfo* i___Epic__OnlineServices__ICallbackInfo() ;

/// @brief Method set_ClientBaseUrl, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_QueryId, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_TokenCount, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
inline void set_TokenCount(uint32_t  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr QueryJoinRoomTokenCompleteCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_ClientBaseUrl_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_QueryId_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_TokenCount_k__BackingField", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr QueryJoinRoomTokenCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ClientBaseUrl_k__BackingField, uint32_t  _QueryId_k__BackingField, uint32_t  _TokenCount_k__BackingField) noexcept;
...
/// @brief Field <ClientBaseUrl>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _ClientBaseUrl_k__BackingField;

/// @brief Field <QueryId>k__BackingField, offset: 0x20, size: 0x4, def value: None
 uint32_t  _QueryId_k__BackingField;

/// @brief Field <TokenCount>k__BackingField, offset: 0x24, size: 0x4, def value: None
 uint32_t  _TokenCount_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _RoomName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _ClientBaseUrl_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _QueryId_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo, _TokenCount_k__BackingField) == 0x24, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAdmin::QueryJoinRoomTokenCompleteCallbackInfo) == 0x28, "Size mismatch!");
