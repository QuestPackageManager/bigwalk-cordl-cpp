#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCAdmin/SetParticipantHardMuteCompleteCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(SetParticipantHardMuteCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAdmin::SetParticipantHardMuteCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAdmin::SetParticipantHardMuteCompleteCallbackInfo, "Epic.OnlineServices.RTCAdmin", "SetParticipantHardMuteCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAdmin {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAdmin.SetParticipantHardMuteCompleteCallbackInfo
struct CORDL_TYPE SetParticipantHardMuteCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SetParticipantHardMuteCompleteCallbackInfo() ;
...
constexpr SetParticipantHardMuteCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::SetParticipantHardMuteCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::SetParticipantHardMuteCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAdmin::SetParticipantHardMuteCompleteCallbackInfo) == 0x10, "Size mismatch!");
