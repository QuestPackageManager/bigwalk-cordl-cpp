...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(KickOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAdmin::KickOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAdmin::KickOptions, "Epic.OnlineServices.RTCAdmin", "KickOptions");
// Dependencies 
namespace Epic::OnlineServices::RTCAdmin {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAdmin.KickOptions
struct CORDL_TYPE KickOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr KickOptions() ;

// Ctor Parameters [CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr KickOptions(::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::KickOptions, _RoomName_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAdmin::KickOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAdmin::KickOptions) == 0x10, "Size mismatch!");
