...
#include <cstddef>
CORDL_MODULE_EXPORT(SetPresenceCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo, "Epic.OnlineServices.Presence", "SetPresenceCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.SetPresenceCallbackInfo
struct CORDL_TYPE SetPresenceCallbackInfo {
public:
// Declarations
 ...
 __declspec(property(get=get_RichPresenceResultCode, put=set_RichPresenceResultCode)) ::Epic::OnlineServices::Result  RichPresenceResultCode;
...
/// @brief Method get_RichPresenceResultCode, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::Result get_RichPresenceResultCode() ;
...
/// @brief Method set_RichPresenceResultCode, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_RichPresenceResultCode(::Epic::OnlineServices::Result  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr SetPresenceCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_RichPresenceResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }]
constexpr SetPresenceCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Result  _RichPresenceResultCode_k__BackingField) noexcept;
...
/// @brief Field <RichPresenceResultCode>k__BackingField, offset: 0x18, size: 0x4, def value: None
 ::Epic::OnlineServices::Result  _RichPresenceResultCode_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo, _RichPresenceResultCode_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::SetPresenceCallbackInfo) == 0x20, "Size mismatch!");
