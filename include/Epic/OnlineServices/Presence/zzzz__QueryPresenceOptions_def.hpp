#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Presence/QueryPresenceOptions.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(QueryPresenceOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::QueryPresenceOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::QueryPresenceOptions, "Epic.OnlineServices.Presence", "QueryPresenceOptions");
// Dependencies 
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.QueryPresenceOptions
struct CORDL_TYPE QueryPresenceOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryPresenceOptions() ;
...
constexpr QueryPresenceOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::QueryPresenceOptions) == 0x10, "Size mismatch!");
