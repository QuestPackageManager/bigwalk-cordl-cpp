...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetJoinInfoOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::GetJoinInfoOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::GetJoinInfoOptions, "Epic.OnlineServices.Presence", "GetJoinInfoOptions");
// Dependencies 
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.GetJoinInfoOptions
struct CORDL_TYPE GetJoinInfoOptions {
public:
// Declarations
...
constexpr GetJoinInfoOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Presence::GetJoinInfoOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::GetJoinInfoOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::GetJoinInfoOptions) == 0x10, "Size mismatch!");
