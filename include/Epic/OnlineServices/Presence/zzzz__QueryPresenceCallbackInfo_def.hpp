#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Presence/QueryPresenceCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(QueryPresenceCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo, "Epic.OnlineServices.Presence", "QueryPresenceCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.QueryPresenceCallbackInfo
struct CORDL_TYPE QueryPresenceCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryPresenceCallbackInfo() ;
...
constexpr QueryPresenceCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::QueryPresenceCallbackInfo) == 0x20, "Size mismatch!");
