...
#include <cstddef>
CORDL_MODULE_EXPORT(IngestStatCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo, "Epic.OnlineServices.Stats", "IngestStatCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Stats {
// Is value type: true
// CS Name: Epic.OnlineServices.Stats.IngestStatCompleteCallbackInfo
struct CORDL_TYPE IngestStatCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr IngestStatCompleteCallbackInfo() ;
...
constexpr IngestStatCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Stats::IngestStatCompleteCallbackInfo) == 0x20, "Size mismatch!");
