...
#include <cstddef>
CORDL_MODULE_EXPORT(OnQueryStatsCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo, "Epic.OnlineServices.Stats", "OnQueryStatsCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Stats {
// Is value type: true
// CS Name: Epic.OnlineServices.Stats.OnQueryStatsCompleteCallbackInfo
struct CORDL_TYPE OnQueryStatsCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnQueryStatsCompleteCallbackInfo() ;
...
constexpr OnQueryStatsCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Stats::OnQueryStatsCompleteCallbackInfo) == 0x20, "Size mismatch!");
