...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(CopyUserInfoOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UserInfo::CopyUserInfoOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UserInfo::CopyUserInfoOptions, "Epic.OnlineServices.UserInfo", "CopyUserInfoOptions");
// Dependencies 
namespace Epic::OnlineServices::UserInfo {
// Is value type: true
// CS Name: Epic.OnlineServices.UserInfo.CopyUserInfoOptions
struct CORDL_TYPE CopyUserInfoOptions {
public:
// Declarations
...
constexpr CopyUserInfoOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UserInfo::CopyUserInfoOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::CopyUserInfoOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UserInfo::CopyUserInfoOptions) == 0x10, "Size mismatch!");
