...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(CopyBestDisplayNameOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UserInfo::CopyBestDisplayNameOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UserInfo::CopyBestDisplayNameOptions, "Epic.OnlineServices.UserInfo", "CopyBestDisplayNameOptions");
// Dependencies 
namespace Epic::OnlineServices::UserInfo {
// Is value type: true
// CS Name: Epic.OnlineServices.UserInfo.CopyBestDisplayNameOptions
struct CORDL_TYPE CopyBestDisplayNameOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CopyBestDisplayNameOptions() ;
...
constexpr CopyBestDisplayNameOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UserInfo::CopyBestDisplayNameOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::CopyBestDisplayNameOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UserInfo::CopyBestDisplayNameOptions) == 0x10, "Size mismatch!");
