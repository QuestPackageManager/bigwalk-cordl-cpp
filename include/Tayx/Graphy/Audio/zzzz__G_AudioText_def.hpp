...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Audio::G_AudioText*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Audio::G_AudioText*, "Tayx.Graphy.Audio", "G_AudioText");
...
/// @brief Method Awake, addr 0x181e4eb90, size 0xa0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e4eb90, size 0xa0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioText* New_ctor() ;

/// @brief Method Update, addr 0x181e4ec60, size 0x160, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x181e4ec30, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e4edc0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Tayx::Graphy::Audio::G_AudioText) == 0x40, "Size mismatch!");
