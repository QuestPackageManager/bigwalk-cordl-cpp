...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Audio::G_AudioMonitor*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Audio::G_AudioMonitor*, "Tayx.Graphy.Audio", "G_AudioMonitor");
// Dependencies Tayx.Graphy.GraphyManager::LookForAudioListener, UnityEngine.FFTWindow, UnityEngine.MonoBehaviour
namespace Tayx::Graphy::Audio {
// Is value type: false
...
// Declarations
 ...
 __declspec(property(get=get_Spectrum, put=set_Spectrum)) ::ArrayW<float_t>  Spectrum;

 __declspec(property(get=get_SpectrumDataAvailable)) bool  SpectrumDataAvailable;

 __declspec(property(get=get_SpectrumHighestValues, put=set_SpectrumHighestValues)) ::ArrayW<float_t>  SpectrumHighestValues;
...
/// @brief Field <SpectrumHighestValues>k__BackingField, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__SpectrumHighestValues_k__BackingField, put=__cordl_internal_set__SpectrumHighestValues_k__BackingField)) ::ArrayW<float_t>  _SpectrumHighestValues_k__BackingField;

/// @brief Field <Spectrum>k__BackingField, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__Spectrum_k__BackingField, put=__cordl_internal_set__Spectrum_k__BackingField)) ::ArrayW<float_t>  _Spectrum_k__BackingField;
...
/// @brief Method Awake, addr 0x181e4e620, size 0x90, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FindAudioListener, addr 0x181e4e6b0, size 0x60, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioListener> FindAudioListener() ;

/// @brief Method Init, addr 0x181e4e620, size 0x90, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioMonitor* New_ctor() ;

/// @brief Method OnDestroy, addr 0x181e4e710, size 0x50, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnSceneLoaded, addr 0x181e4e760, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x181e4e8e0, size 0x220, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x181e4e7f0, size 0xf0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get__SpectrumHighestValues_k__BackingField() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get__SpectrumHighestValues_k__BackingField() ;

constexpr ::ArrayW<float_t> const& __cordl_internal_get__Spectrum_k__BackingField() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get__Spectrum_k__BackingField() ;
...
constexpr void __cordl_internal_set__SpectrumHighestValues_k__BackingField(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set__Spectrum_k__BackingField(::ArrayW<float_t>  value) ;
...
/// @brief Method .ctor, addr 0x181e4eb00, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method dBNormalized, addr 0x181e4eb20, size 0x20, virtual false, abstract: false, final false
inline float_t dBNormalized(float_t  db) ;

/// @brief Method get_MaxDB, addr 0x180356140, size 0x10, virtual false, abstract: false, final false
inline float_t get_MaxDB() ;

/// @brief Method get_Spectrum, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<float_t> get_Spectrum() ;

/// @brief Method get_SpectrumDataAvailable, addr 0x181e4eb40, size 0x10, virtual false, abstract: false, final false
inline bool get_SpectrumDataAvailable() ;

/// @brief Method get_SpectrumHighestValues, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<float_t> get_SpectrumHighestValues() ;

/// @brief Method lin2dB, addr 0x181e4eb50, size 0x40, virtual false, abstract: false, final false
inline float_t lin2dB(float_t  linear) ;

/// @brief Method set_MaxDB, addr 0x1803561c0, size 0x10, virtual false, abstract: false, final false
inline void set_MaxDB(float_t  value) ;

/// @brief Method set_Spectrum, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_Spectrum(::ArrayW<float_t>  value) ;

/// @brief Method set_SpectrumHighestValues, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field <Spectrum>k__BackingField, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<float_t>  ____Spectrum_k__BackingField;

/// @brief Field <SpectrumHighestValues>k__BackingField, offset: 0x48, size: 0x8, def value: None
 ::ArrayW<float_t>  ____SpectrumHighestValues_k__BackingField;
...
static_assert(sizeof(::Tayx::Graphy::Audio::G_AudioMonitor) == 0x58, "Size mismatch!");
