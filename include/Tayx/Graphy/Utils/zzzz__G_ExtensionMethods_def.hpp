...
public:
// Declarations
/// @brief Method SetAllActive, addr 0x181e4edd0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method SetAllActive, addr 0x181e4ee70, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SetOneActive, addr 0x181e4ef20, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Tayx::Graphy::Utils::G_ExtensionMethods) == 0x10, "Size mismatch!");
