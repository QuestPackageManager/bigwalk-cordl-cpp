...
/// @brief Method Awake, addr 0x181e50ce0, size 0xb0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e50ce0, size 0xb0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor() ;

/// @brief Method SetFpsRelatedTextColor, addr 0x181e50d90, size 0x90, virtual false, abstract: false, final false
inline void SetFpsRelatedTextColor(::UnityEngine::UI::Text*  text, float_t  fps) ;

/// @brief Method Update, addr 0x181e50e50, size 0x4d0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x181e50e20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e51320, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Tayx::Graphy::Fps::G_FpsText) == 0x70, "Size mismatch!");
