...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Advanced::G_AdvancedData*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Advanced::G_AdvancedData*, "Tayx.Graphy.Advanced", "G_AdvancedData");
...
/// @brief Field m_currentModuleState, offset 0xac, size 0x4 
...
/// @brief Field m_deltaTime, offset 0x98, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_deltaTime, put=__cordl_internal_set_m_deltaTime)) float_t  m_deltaTime;

/// @brief Field m_displaySubsystems, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_displaySubsystems, put=__cordl_internal_set_m_displaySubsystems)) ::System::Collections::Generic::List_1<Il2CppObject*>*  m_displaySubsystems;

/// @brief Field m_gameVRResolutionText, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_gameVRResolutionText, put=__cordl_internal_set_m_gameVRResolutionText)) ::UnityW<::UnityEngine::UI::Text>  m_gameVRResolutionText;
...
/// @brief Field m_graphyManager, offset 0x80, size 0x8 
...
/// @brief Field m_origPosition, offset 0x90, size 0x8 
...
/// @brief Field m_previousModuleState, offset 0xa8, size 0x4 
...
/// @brief Field m_rectTransform, offset 0x88, size 0x8 
...
/// @brief Field m_sb, offset 0xa0, size 0x8 
...
/// @brief Field m_updateRate, offset 0x78, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_updateRate, put=__cordl_internal_set_m_updateRate)) float_t  m_updateRate;

/// @brief Field m_vrStrings, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_vrStrings, put=__cordl_internal_set_m_vrStrings)) ::ArrayW<::StringW>  m_vrStrings;

/// @brief Field m_windowStrings, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_windowStrings, put=__cordl_internal_set_m_windowStrings)) ::ArrayW<::StringW>  m_windowStrings;
...
/// @brief Method Awake, addr 0x181e4b2c0, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e4b2d0, size 0xae0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Advanced::G_AdvancedData* New_ctor() ;

/// @brief Method RefreshParameters, addr 0x181e4bdb0, size 0x170, virtual false, abstract: false, final false
inline void RefreshParameters() ;

/// @brief Method RestorePreviousState, addr 0x181e4bf20, size 0xa0, virtual false, abstract: false, final false
inline void RestorePreviousState() ;

/// @brief Method SetPosition, addr 0x181e4bfc0, size 0x480, virtual true, abstract: false, final true
inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition  newModulePosition, ::UnityEngine::Vector2  offset) ;

/// @brief Method SetState, addr 0x181e4c440, size 0xa0, virtual true, abstract: false, final true
inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState  state, bool  silentUpdate) ;

/// @brief Method Update, addr 0x181e4c670, size 0x4a0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x181e4c4e0, size 0x190, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::List_1<Il2CppObject*>* const& __cordl_internal_get_m_displaySubsystems() const;

constexpr ::System::Collections::Generic::List_1<Il2CppObject*>*& __cordl_internal_get_m_displaySubsystems() ;

constexpr ::UnityW<::UnityEngine::UI::Text> const& __cordl_internal_get_m_gameVRResolutionText() const;

constexpr ::UnityW<::UnityEngine::UI::Text>& __cordl_internal_get_m_gameVRResolutionText() ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_vrStrings() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_vrStrings() ;

constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_windowStrings() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_windowStrings() ;
...
constexpr void __cordl_internal_set_m_displaySubsystems(::System::Collections::Generic::List_1<Il2CppObject*>*  value) ;

constexpr void __cordl_internal_set_m_gameVRResolutionText(::UnityW<::UnityEngine::UI::Text>  value) ;
...
constexpr void __cordl_internal_set_m_vrStrings(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set_m_windowStrings(::ArrayW<::StringW>  value) ;

/// @brief Method .ctor, addr 0x181e4cb10, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_gameVRResolutionText, offset: 0x68, size: 0x8, def value: None
 ::UnityW<::UnityEngine::UI::Text>  ___m_gameVRResolutionText;

/// @brief Field m_displaySubsystems, offset: 0x70, size: 0x8, def value: None
 ::System::Collections::Generic::List_1<Il2CppObject*>*  ___m_displaySubsystems;

/// @brief Field m_updateRate, offset: 0x78, size: 0x4, def value: None
 float_t  ___m_updateRate;

/// @brief Field m_graphyManager, offset: 0x80, size: 0x8, def value: None
 ::UnityW<::Tayx::Graphy::GraphyManager>  ___m_graphyManager;

/// @brief Field m_rectTransform, offset: 0x88, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RectTransform>  ___m_rectTransform;

/// @brief Field m_origPosition, offset: 0x90, size: 0x8, def value: None
 ::UnityEngine::Vector2  ___m_origPosition;

/// @brief Field m_deltaTime, offset: 0x98, size: 0x4, def value: None
 float_t  ___m_deltaTime;

/// @brief Field m_sb, offset: 0xa0, size: 0x8, def value: None
 ::System::Text::StringBuilder*  ___m_sb;

/// @brief Field m_previousModuleState, offset: 0xa8, size: 0x4, def value: None
 ::Tayx::Graphy::GraphyManager_ModuleState  ___m_previousModuleState;

/// @brief Field m_currentModuleState, offset: 0xac, size: 0x4, def value: None
 ::Tayx::Graphy::GraphyManager_ModuleState  ___m_currentModuleState;

/// @brief Field m_windowStrings, offset: 0xb0, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___m_windowStrings;

/// @brief Field m_vrStrings, offset: 0xb8, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___m_vrStrings;
...
static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_gameVRResolutionText) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_displaySubsystems) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_updateRate) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_graphyManager) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_rectTransform) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_origPosition) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_deltaTime) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_sb) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_previousModuleState) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_currentModuleState) == 0xac, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_windowStrings) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Advanced::G_AdvancedData, ___m_vrStrings) == 0xb8, "Offset mismatch!");

static_assert(sizeof(::Tayx::Graphy::Advanced::G_AdvancedData) == 0xc0, "Size mismatch!");
