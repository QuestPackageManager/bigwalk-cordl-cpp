...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Ram::G_RamGraph*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Ram::G_RamGraph*, "Tayx.Graphy.Ram", "G_RamGraph");
...
/// @brief Field m_allocatedArray, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_allocatedArray, put=__cordl_internal_set_m_allocatedArray)) ::ArrayW<float_t>  m_allocatedArray;
...
/// @brief Field m_monoArray, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_monoArray, put=__cordl_internal_set_m_monoArray)) ::ArrayW<float_t>  m_monoArray;
...
/// @brief Field m_reservedArray, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_reservedArray, put=__cordl_internal_set_m_reservedArray)) ::ArrayW<float_t>  m_reservedArray;
...
/// @brief Method CreatePoints, addr 0x181e51b80, size 0x7d0, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x181e52350, size 0x180, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamGraph* New_ctor() ;

/// @brief Method Update, addr 0x181723810, size 0x20, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x181e524d0, size 0x320, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x181e527f0, size 0x300, virtual false, abstract: false, final false
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_allocatedArray() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_allocatedArray() ;
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_monoArray() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_monoArray() ;
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_reservedArray() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_reservedArray() ;
...
constexpr void __cordl_internal_set_m_allocatedArray(::ArrayW<float_t>  value) ;
...
constexpr void __cordl_internal_set_m_monoArray(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set_m_ramMonitor(::UnityW<::Tayx::Graphy::Ram::G_RamMonitor>  value) ;

constexpr void __cordl_internal_set_m_reservedArray(::ArrayW<float_t>  value) ;
...
/// @brief Method .ctor, addr 0x181e52af0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Tayx::Graphy::Ram::G_RamGraph) == 0xa0, "Size mismatch!");
