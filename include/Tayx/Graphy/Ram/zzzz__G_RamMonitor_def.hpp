...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Ram::G_RamMonitor*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Ram::G_RamMonitor*, "Tayx.Graphy.Ram", "G_RamMonitor");
...
/// @brief Method Update, addr 0x181e535e0, size 0x70, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method get_AllocatedRam, addr 0x1802f42b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_AllocatedRam() ;

/// @brief Method get_MonoRam, addr 0x1803f2be0, size 0x10, virtual false, abstract: false, final false
inline float_t get_MonoRam() ;

/// @brief Method get_ReservedRam, addr 0x1802f80d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_ReservedRam() ;

/// @brief Method set_AllocatedRam, addr 0x1802f43c0, size 0x10, virtual false, abstract: false, final false
inline void set_AllocatedRam(float_t  value) ;

/// @brief Method set_MonoRam, addr 0x1803f2c00, size 0x10, virtual false, abstract: false, final false
inline void set_MonoRam(float_t  value) ;

/// @brief Method set_ReservedRam, addr 0x1802f81c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Tayx::Graphy::Ram::G_RamMonitor) == 0x30, "Size mismatch!");
