...
CORDL_MODULE_EXPORT(ToggleSleepingOperation)
...
namespace Shipmates::RemotePlayerDebug {
class ToggleSleepingOperation;
}
// Write type traits
MARK_REF_T(::Shipmates::RemotePlayerDebug::ToggleSleepingOperation*);
DEFINE_IL2CPP_CLASS(::Shipmates::RemotePlayerDebug::ToggleSleepingOperation*, "Shipmates.RemotePlayerDebug", "ToggleSleepingOperation");
// Dependencies Shipmates.RemotePlayerDebug.RemotePlayerDebugOperationBase
namespace Shipmates::RemotePlayerDebug {
// Is value type: false
// CS Name: Shipmates.RemotePlayerDebug.ToggleSleepingOperation
class CORDL_TYPE ToggleSleepingOperation : public ::Shipmates::RemotePlayerDebug::RemotePlayerDebugOperationBase {
public:
// Declarations
...
/// @brief Method Execute, addr 0x1803b4df0, size 0x190, virtual true, abstract: false, final false
...
static inline ::Shipmates::RemotePlayerDebug::ToggleSleepingOperation* New_ctor() ;
...
/// @brief Method get_Name, addr 0x1803b4f80, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr ToggleSleepingOperation() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ToggleSleepingOperation", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ToggleSleepingOperation(ToggleSleepingOperation && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ToggleSleepingOperation", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ToggleSleepingOperation(ToggleSleepingOperation const& ) = delete;

/// @brief Field RequestName offset 0xffffffff size 0x8
static constexpr ::ConstString  RequestName{u"toggle-player-sleeping"};
...
static_assert(offsetof(::Shipmates::RemotePlayerDebug::ToggleSleepingOperation, ____currentLandmarksEnabled) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Shipmates::RemotePlayerDebug::ToggleSleepingOperation) == 0x18, "Size mismatch!");
