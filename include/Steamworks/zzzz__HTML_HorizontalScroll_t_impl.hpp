...
#include "Steamworks/zzzz__HTML_HorizontalScroll_t_def.hpp"
...
constexpr ::Steamworks::HTML_HorizontalScroll_t::HTML_HorizontalScroll_t(::Steamworks::HHTMLBrowser  unBrowserHandle, uint32_t  unScrollMax, uint32_t  unScrollCurrent, float_t  flPageScale, bool  bVisible, uint32_t  unPageSize) noexcept  {
...
// Ctor Parameters []
constexpr ::Steamworks::HTML_HorizontalScroll_t::HTML_HorizontalScroll_t()   {
}
