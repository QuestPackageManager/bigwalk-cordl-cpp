...
#include "Steamworks/zzzz__AddUGCDependencyResult_t_def.hpp"
...
constexpr ::Steamworks::AddUGCDependencyResult_t::AddUGCDependencyResult_t(::Steamworks::EResult  m_eResult, ::Steamworks::PublishedFileId_t  m_nPublishedFileId, ::Steamworks::PublishedFileId_t  m_nChildPublishedFileId) noexcept  {
this->m_eResult = m_eResult;
this->m_nPublishedFileId = m_nPublishedFileId;
this->m_nChildPublishedFileId = m_nChildPublishedFileId;
}
// Ctor Parameters []
constexpr ::Steamworks::AddUGCDependencyResult_t::AddUGCDependencyResult_t()   {
}
