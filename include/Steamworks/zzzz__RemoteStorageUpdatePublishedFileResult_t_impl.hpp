...
#include "Steamworks/zzzz__RemoteStorageUpdatePublishedFileResult_t_def.hpp"
...
constexpr ::Steamworks::RemoteStorageUpdatePublishedFileResult_t::RemoteStorageUpdatePublishedFileResult_t(::Steamworks::EResult  m_eResult, ::Steamworks::PublishedFileId_t  m_nPublishedFileId, bool  m_bUserNeedsToAcceptWorkshopLegalAgreement) noexcept  {
...
// Ctor Parameters []
constexpr ::Steamworks::RemoteStorageUpdatePublishedFileResult_t::RemoteStorageUpdatePublishedFileResult_t()   {
}
