...
#include "Steamworks/zzzz__GSStatsStored_t_def.hpp"
...
constexpr ::Steamworks::GSStatsStored_t::GSStatsStored_t(::Steamworks::EResult  m_eResult, ::Steamworks::CSteamID  m_steamIDUser) noexcept  {
this->m_eResult = m_eResult;
this->m_steamIDUser = m_steamIDUser;
}
// Ctor Parameters []
constexpr ::Steamworks::GSStatsStored_t::GSStatsStored_t()   {
}
