...
// Write type traits
MARK_REF_T(::AOT::MonoPInvokeCallbackAttribute*);
DEFINE_IL2CPP_CLASS(::AOT::MonoPInvokeCallbackAttribute*, "AOT", "MonoPInvokeCallbackAttribute");
...
static_assert(sizeof(::AOT::MonoPInvokeCallbackAttribute) == 0x10, "Size mismatch!");
