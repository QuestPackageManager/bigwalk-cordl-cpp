...
static_assert(offsetof(::Unity::Hierarchy::HierarchyPropertyStorageType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Hierarchy::HierarchyPropertyStorageType) == 0x4, "Size mismatch!");
