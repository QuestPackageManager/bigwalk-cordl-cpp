...
/// @brief Method GetEnumerator, addr 0x1822b9ae0, size 0x80, virtual false, abstract: false, final false
inline ::Unity::Hierarchy::HierarchyNodeChildren_Enumerator GetEnumerator() ;

/// @brief Method ThrowIfVersionChanged, addr 0x1822b8280, size 0x30, virtual false, abstract: false, final false
inline void ThrowIfVersionChanged() ;

/// @brief Method .ctor, addr 0x1822b9b60, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x1822b7e80, size 0x10, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x1822b8960, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Hierarchy::HierarchyNodeChildren>  enumerable) ;

/// @brief Method get_Current, addr 0x1822b8170, size 0x40, virtual false, abstract: false, final false
