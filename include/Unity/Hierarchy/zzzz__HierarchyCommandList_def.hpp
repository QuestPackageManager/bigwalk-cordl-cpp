...
// Write type traits
MARK_REF_T(::Unity::Hierarchy::HierarchyCommandList*);
MARK_REF_T(::Unity::Hierarchy::HierarchyCommandList_BindingsMarshaller*);
DEFINE_IL2CPP_CLASS(::Unity::Hierarchy::HierarchyCommandList*, "Unity.Hierarchy", "HierarchyCommandList");
DEFINE_IL2CPP_CLASS(::Unity::Hierarchy::HierarchyCommandList_BindingsMarshaller*, "Unity.Hierarchy", "HierarchyCommandList/BindingsMarshaller");
...
/// @brief Method CreateCommandList, addr 0x1822b8e00, size 0x40, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateCommandList(::System::IntPtr  nativePtr) ;

/// @brief Method Destroy, addr 0x1822b8e40, size 0x10, virtual false, abstract: false, final false
static inline void Destroy(::System::IntPtr  nativePtr) ;

/// @brief Method Dispose, addr 0x1822b8e80, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x1822b8e50, size 0x30, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x1822b8e50, size 0x30, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FromIntPtr, addr 0x1822b8210, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Hierarchy::HierarchyCommandList) == 0x20, "Size mismatch!");
