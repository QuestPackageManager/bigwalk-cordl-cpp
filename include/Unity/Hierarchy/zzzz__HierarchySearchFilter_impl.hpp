...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::by_ref<::Unity::Hierarchy::HierarchySearchFilter> (*)()>(&::Unity::Hierarchy::HierarchySearchFilter::get_Invalid)> {
  ...
  constexpr static std::size_t addrs = 0x1822badc0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Hierarchy::HierarchySearchFilter>(),
                        {"get_Invalid", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Unity::Hierarchy::HierarchySearchFilter::*)()>(&::Unity::Hierarchy::HierarchySearchFilter::get_IsValid)> {
  ...
  constexpr static std::size_t addrs = 0x1822bade0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Unity::Hierarchy::HierarchySearchFilterOperator (::Unity::Hierarchy::HierarchySearchFilter::*)()>(&::Unity::Hierarchy::HierarchySearchFilter::get_Op)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (*)(::Unity::Hierarchy::HierarchySearchFilterOperator)>(&::Unity::Hierarchy::HierarchySearchFilter::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x1822baac0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Hierarchy::HierarchySearchFilter>(),
                        {"ToString", {}, {::i2c::type_of<::Unity::Hierarchy::HierarchySearchFilterOperator>()}}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::Unity::Hierarchy::HierarchySearchFilter::*)()>(&::Unity::Hierarchy::HierarchySearchFilter::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x1822babc0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::Unity::Hierarchy::HierarchySearchFilter>(),
                    {::i2c::class_of<::Unity::Hierarchy::HierarchySearchFilter>(), 3}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (*)(::StringW)>(&::Unity::Hierarchy::HierarchySearchFilter::QuoteStringIfNeeded)> {
  ...
  constexpr static std::size_t addrs = 0x1822baa50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Hierarchy::HierarchySearchFilter>(),
                        {"QuoteStringIfNeeded", {}, {::i2c::type_of<::StringW>()}}
                    )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "_Name_k__BackingField", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "_Value_k__BackingField", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "_NumValue_k__BackingField", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_Op_k__BackingField", ty: "::Unity::Hierarchy::HierarchySearchFilterOperator", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::Hierarchy::HierarchySearchFilter::HierarchySearchFilter(::StringW  _Name_k__BackingField, ::StringW  _Value_k__BackingField, float_t  _NumValue_k__BackingField, ::Unity::Hierarchy::HierarchySearchFilterOperator  _Op_k__BackingField) noexcept  {
