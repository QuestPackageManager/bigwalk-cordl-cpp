...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Collections::NativeSliceDebugView_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Collections::NativeSliceDebugView_1, "Unity.Collections", "NativeSliceDebugView`1");
