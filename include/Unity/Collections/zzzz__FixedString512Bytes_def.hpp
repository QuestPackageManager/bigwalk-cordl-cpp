...
/// @brief Method CheckCapacityInRange, addr 0x181eb1620, size 0x90, virtual false, abstract: false, final false
inline void CheckCapacityInRange(int32_t  capacity) ;

/// @brief Method CheckCopyError, addr 0x181eb16b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method CheckIndexInRange, addr 0x181ea77c0, size 0xd0, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method CheckLengthInRange, addr 0x181eb1720, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetEnumerator, addr 0x181eb17f0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eb1a40, size 0x20, virtual false, abstract: false, final false
inline ::Unity::Collections::CopyError Initialize(::StringW  source) ;

/// @brief Method Initialize, addr 0x181eb1960, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eb19f0, size 0x50, virtual false, abstract: false, final false
inline ::Unity::Collections::FormatError Initialize(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method Initialize, addr 0x181eb1a60, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method TryResize, addr 0x181eb1af0, size 0xa0, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x181eb1d00, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method .ctor, addr 0x181eb1c60, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181eb1b90, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeText>  other) ;

/// @brief Method .ctor, addr 0x181eb19f0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method .ctor, addr 0x181eb1cb0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  source) ;

/// @brief Method get_Capacity, addr 0x180772380, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_UTF8MaxLengthInBytes, addr 0x180772380, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181eb1dc0, size 0x100, virtual false, abstract: false, final false
static inline bool op_Equality(::by_ref<::Unity::Collections::FixedString512Bytes>  a, ::StringW  b) ;
...
/// @brief Method op_Implicit, addr 0x181eb1ec0, size 0x40, virtual false, abstract: false, final false
static inline ::Unity::Collections::FixedString512Bytes op_Implicit___Unity__Collections__FixedString512Bytes(::StringW  b) ;

/// @brief Method op_Inequality, addr 0x181eb1f00, size 0xf0, virtual false, abstract: false, final false
static inline bool op_Inequality(::by_ref<::Unity::Collections::FixedString512Bytes>  a, ::StringW  b) ;
...
/// @brief Method MoveNext, addr 0x181ea73a0, size 0x50, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x181eaef60, size 0x20, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181eaf0a0, size 0x30, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x181eaf0d0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::FixedString512Bytes  other) ;

/// @brief Method get_Current, addr 0x181ea7510, size 0x10, virtual false, abstract: false, final false
