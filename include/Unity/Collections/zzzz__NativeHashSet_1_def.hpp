...
MARK_GEN_VAL_T(::Unity::Collections::NativeHashSet_1_Enumerator);
MARK_GEN_VAL_T(::Unity::Collections::NativeHashSet_1_ReadOnly);
...
public:
// Declarations
using Enumerator = ::Unity::Collections::NativeHashSet_1_Enumerator<T>;

using ReadOnly = ::Unity::Collections::NativeHashSet_1_ReadOnly<T>;
