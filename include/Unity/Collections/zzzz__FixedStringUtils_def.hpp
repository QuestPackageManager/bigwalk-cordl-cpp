...
// Write type traits
MARK_REF_T(::Unity::Collections::FixedStringUtils*);
MARK_VAL_T(::Unity::Collections::FixedStringUtils_UintFloatUnion);
DEFINE_IL2CPP_CLASS(::Unity::Collections::FixedStringUtils*, "Unity.Collections", "FixedStringUtils");
DEFINE_IL2CPP_CLASS(::Unity::Collections::FixedStringUtils_UintFloatUnion, "Unity.Collections", "FixedStringUtils/UintFloatUnion");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
/// @brief Method Base10ToBase2, addr 0x181ebda50, size 0x140, virtual false, abstract: false, final false
static inline ::Unity::Collections::ParseError Base10ToBase2(::by_ref<float_t>  output, uint64_t  mantissa10, int32_t  exponent10) ;

/// @brief Method Base2ToBase10, addr 0x181ebdb90, size 0x130, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::FixedStringUtils) == 0x10, "Size mismatch!");
