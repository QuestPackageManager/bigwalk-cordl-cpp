...
DEFINE_IL2CPP_CLASS(::Unity::Collections::CopyError, "Unity.Collections", "CopyError");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
static_assert(offsetof(::Unity::Collections::CopyError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::CopyError) == 0x4, "Size mismatch!");
