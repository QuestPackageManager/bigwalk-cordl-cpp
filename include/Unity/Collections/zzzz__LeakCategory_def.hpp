...
static_assert(offsetof(::Unity::Collections::LeakCategory, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::LeakCategory) == 0x4, "Size mismatch!");
