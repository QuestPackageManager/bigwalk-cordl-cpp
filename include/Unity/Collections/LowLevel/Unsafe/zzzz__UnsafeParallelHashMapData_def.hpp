...
template<typename TKey,typename TValue>
static inline void AllocateHashMap(int32_t  length, int64_t  bucketLength, ::Unity::Collections::AllocatorManager_AllocatorHandle  label, ::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*>  outBuf) ;
...
/// @brief Method CheckCapacity, addr 0x181ec6d70, size 0x90, virtual false, abstract: false, final false
static inline void CheckCapacity(int32_t  capacity) ;

/// @brief Method CheckHashMapReallocateDoesNotShrink, addr 0x181ec6e00, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method DeallocateHashMap, addr 0x181ec6e20, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetBucketData, addr 0x181ec6e60, size 0x70, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapBucketData GetBucketData() ;

/// @brief Method GetBucketSize, addr 0x181ec6ed0, size 0x10, virtual false, abstract: false, final false
static inline int64_t GetBucketSize(int32_t  capacity) ;

/// @brief Method GetCount, addr 0x181ec6ee0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GrowCapacity, addr 0x181ec6f50, size 0x10, virtual false, abstract: false, final false
static inline int32_t GrowCapacity(int32_t  capacity) ;

/// @brief Method IsEmpty, addr 0x181ec6f60, size 0x30, virtual false, abstract: false, final false
static inline bool IsEmpty(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data) ;

/// @brief Method MoveNext, addr 0x181ec7020, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method MoveNextSearch, addr 0x181ec6f90, size 0x90, virtual false, abstract: false, final false
...
template<typename TKey,typename TValue>
static inline void ReallocateHashMap(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  data, int32_t  newCapacity, int64_t  newBucketCapacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  label) ;
...
/// @brief Method get_firstFreeTLS, addr 0x180ba57b0, size 0x570, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "values", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "keys", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "next", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "buckets", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "keyCapacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "bucketCapacityMask", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "allocatedIndexLength", ty: "int32_t", modifiers: "", def_value: None }]
