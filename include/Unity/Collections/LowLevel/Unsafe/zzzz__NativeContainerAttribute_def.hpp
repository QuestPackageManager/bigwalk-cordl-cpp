...
// Write type traits
MARK_REF_T(::Unity::Collections::LowLevel::Unsafe::NativeContainerAttribute*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::NativeContainerAttribute*, "Unity.Collections.LowLevel.Unsafe", "NativeContainerAttribute");
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::NativeContainerAttribute) == 0x10, "Size mismatch!");
