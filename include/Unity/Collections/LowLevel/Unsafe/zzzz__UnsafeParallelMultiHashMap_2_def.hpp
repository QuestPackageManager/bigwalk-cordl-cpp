...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_Enumerator, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMap`2/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2_KeyValueEnumerator, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMap`2/KeyValueEnumerator");
...
// Ctor Parameters [CppParam { name: "hashmap", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>", modifiers: "", def_value: None }, CppParam { name: "key", ty: "TKey", modifiers: "", def_value: None }, CppParam { name: "isFirst", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "value", ty: "TValue", modifiers: "", def_value: None }, CppParam { name: "iterator", ty: "::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>", modifiers: "", def_value: None }]
constexpr UnsafeParallelMultiHashMap_2_Enumerator(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>  hashmap, TKey  key, bool  isFirst, TValue  value, ::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>  iterator) noexcept;
