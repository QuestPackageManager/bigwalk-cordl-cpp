...
/// @brief Method CheckArgs, addr 0x181ec0ad0, size 0xd0, virtual false, abstract: false, final false
inline void CheckArgs(int32_t  pos, int32_t  numBits) ;

/// @brief Method CheckArgsPosCount, addr 0x181ec0860, size 0x160, virtual false, abstract: false, final false
inline void CheckArgsPosCount(int32_t  begin, int32_t  count, int32_t  numBits) ;

/// @brief Method CheckArgsUlong, addr 0x181ec09c0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x180a16cc0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Alloc, addr 0x181ec5f50, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method AsReadOnly, addr 0x18063d3c0, size 0x2c60, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray_ReadOnly AsReadOnly() ;

/// @brief Method CheckArgs, addr 0x181ec0ad0, size 0xd0, virtual false, abstract: false, final false
inline void CheckArgs(int32_t  pos, int32_t  numBits) ;

/// @brief Method CheckArgsCopy, addr 0x181ec5f80, size 0x150, virtual false, abstract: false, final false
static inline void CheckArgsCopy(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray>  dstBitArray, int32_t  dstPos, ::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeBitArray>  srcBitArray, int32_t  srcPos, int32_t  numBits) ;
...
/// @brief Method CheckSizeMultipleOf8, addr 0x181ec60d0, size 0x80, virtual false, abstract: false, final false
static inline void CheckSizeMultipleOf8(int32_t  sizeInBytes) ;

/// @brief Method Clear, addr 0x181ec6150, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Copy, addr 0x181ec6220, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method Copy, addr 0x181ec6500, size 0x40, virtual false, abstract: false, final false
inline void Copy(int32_t  dstPos, int32_t  srcPos, int32_t  numBits) ;

/// @brief Method CopyUlong, addr 0x181ec61b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181ec6540, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method Free, addr 0x181ec65b0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Realloc, addr 0x181ec6650, size 0xd0, virtual false, abstract: false, final false
inline void Realloc(int32_t  capacityInBits) ;

/// @brief Method Resize, addr 0x181ec6720, size 0x80, virtual false, abstract: false, final false
inline void Resize(int32_t  numBits, ::Unity::Collections::NativeArrayOptions  options) ;

/// @brief Method Set, addr 0x181ec6a80, size 0x80, virtual false, abstract: false, final false
inline void Set(int32_t  pos, bool  value) ;

/// @brief Method Set, addr 0x181ec6a10, size 0x70, virtual false, abstract: false, final false
static inline void Set(uint64_t*  ptr, int32_t  pos, bool  value) ;

/// @brief Method SetBits, addr 0x181ec68d0, size 0x120, virtual false, abstract: false, final false
inline void SetBits(int32_t  pos, bool  value, int32_t  numBits) ;

/// @brief Method SetBits, addr 0x181ec67a0, size 0x130, virtual false, abstract: false, final false
inline void SetBits(int32_t  pos, uint64_t  value, int32_t  numBits) ;

/// @brief Method SetCapacity, addr 0x181ec69f0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method TrimExcess, addr 0x181ec6b00, size 0x20, virtual false, abstract: false, final false
inline void TrimExcess() ;

/// @brief Method .ctor, addr 0x181ec6b60, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ec6b20, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Ptr", ty: "uint64_t*", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
