...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataDispose, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMapDataDispose");
...
public:
// Declarations
/// @brief Method Dispose, addr 0x181ec6cf0, size 0x40, virtual false, abstract: false, final false
inline void Dispose() ;
...
constexpr UnsafeParallelHashMapDataDispose(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*  m_Buffer, ::Unity::Collections::AllocatorManager_AllocatorHandle  m_AllocatorLabel) noexcept;
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataDispose) == 0x10, "Size mismatch!");
