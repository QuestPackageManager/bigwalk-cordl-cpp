...
static inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDebuggerTypeProxy_2<TKey,TValue>* New_ctor(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMap_2<TKey,TValue>  target) ;
