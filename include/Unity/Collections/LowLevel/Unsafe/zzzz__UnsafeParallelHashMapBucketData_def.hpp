...
public:
// Declarations
/// @brief Method .ctor, addr 0x181ec6cc0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapBucketData) == 0x28, "Size mismatch!");
