...
/// @brief Method CheckCapacityInRange, addr 0x181ec78e0, size 0xc0, virtual false, abstract: false, final false
static inline void CheckCapacityInRange(int32_t  value, int32_t  length) ;

/// @brief Method CheckIndexInRange, addr 0x181ec79a0, size 0xe0, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method Clear, addr 0x181ec7a80, size 0x40, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Dispose, addr 0x181ec7ae0, size 0x70, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x181ec7ac0, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ElementAt, addr 0x180cf84f0, size 0x1a0, virtual true, abstract: false, final true
inline ::by_ref<uint8_t> ElementAt(int32_t  index) ;

/// @brief Method Free, addr 0x181ec7b50, size 0x50, virtual false, abstract: false, final false
static inline void Free(::Unity::Collections::LowLevel::Unsafe::UnsafeText*  data) ;

/// @brief Method GetUnsafePtr, addr 0x1803a88d0, size 0x10, virtual true, abstract: false, final true
inline uint8_t* GetUnsafePtr() ;

/// @brief Method ThrowCopyError, addr 0x181ec7ba0, size 0x70, virtual false, abstract: false, final false
inline void ThrowCopyError(::Unity::Collections::CopyError  error, ::StringW  source) ;

/// @brief Method ToString, addr 0x181ec7c10, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryResize, addr 0x181ec7c40, size 0x40, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x181ec7c80, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_Capacity, addr 0x1807723e0, size 0x20, virtual true, abstract: false, final true
inline int32_t get_Capacity() ;

/// @brief Method get_IsCreated, addr 0x181ebd3c0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCreated() ;

/// @brief Method get_IsEmpty, addr 0x181ebd3d0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x180bd49f0, size 0x150, virtual true, abstract: false, final true
inline uint8_t get_Item(int32_t  index) ;

/// @brief Method get_Length, addr 0x180772400, size 0x12f70, virtual true, abstract: false, final true
...
/// @brief Method set_Capacity, addr 0x181ec7d30, size 0x20, virtual true, abstract: false, final true
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Item, addr 0x180bd4ca0, size 0x20, virtual true, abstract: false, final true
inline void set_Item(int32_t  index, uint8_t  value) ;

/// @brief Method set_Length, addr 0x181ec7d50, size 0x40, virtual true, abstract: false, final true
