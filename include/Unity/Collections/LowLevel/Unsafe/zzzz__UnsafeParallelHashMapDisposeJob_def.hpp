...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDisposeJob, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelHashMapDisposeJob");
...
// Ctor Parameters [CppParam { name: "Data", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDisposeJob) == 0x10, "Size mismatch!");
