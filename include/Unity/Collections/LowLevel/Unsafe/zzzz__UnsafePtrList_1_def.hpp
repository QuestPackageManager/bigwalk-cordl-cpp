...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(UnsafePtrList_1)
...
namespace Unity::Collections::LowLevel::Unsafe {
template<typename T>
struct UnsafePtrList_1_ParallelReader;
}
namespace Unity::Collections::LowLevel::Unsafe {
template<typename T>
struct UnsafePtrList_1_ParallelWriter;
}
namespace Unity::Collections::LowLevel::Unsafe {
template<typename T>
struct UnsafePtrList_1_ReadOnly;
}
...
// Write type traits
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1);
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelReader);
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelWriter);
MARK_GEN_VAL_T(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ReadOnly);
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelReader, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ParallelReader");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelWriter, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ParallelWriter");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ReadOnly, "Unity.Collections.LowLevel.Unsafe", "UnsafePtrList`1/ReadOnly");
// Dependencies 
namespace Unity::Collections::LowLevel::Unsafe {
// cpp template
template<typename T>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafePtrList`1/ReadOnly<T>
struct CORDL_TYPE UnsafePtrList_1_ReadOnly {
public:
// Declarations
...
inline int32_t IndexOf(void*  ptr) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafePtrList_1_ReadOnly() ;
...
template<typename T>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafePtrList`1/ParallelReader<T>
struct CORDL_TYPE UnsafePtrList_1_ParallelReader {
public:
// Declarations
/// @brief Method Contains, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool Contains(void*  ptr) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafePtrList_1_ParallelReader() ;
...
template<typename T>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafePtrList`1/ParallelWriter<T>
struct CORDL_TYPE UnsafePtrList_1_ParallelWriter {
public:
// Declarations
...
inline void AddRangeNoResize(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>  list) ;

/// @brief Method AddRangeNoResize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void AddRangeNoResize(T*  ptr, int32_t  count) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(T*  ptr, ::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<::System::IntPtr>*  listData) ;

// Ctor Parameters []
// @brief default ctor
constexpr UnsafePtrList_1_ParallelWriter() ;

// Ctor Parameters [CppParam { name: "Ptr", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "ListData", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<::System::IntPtr>*", modifiers: "", def_value: None }]
...
/// @brief Field ListData, offset: 0x8, size: 0x8, def value: None
 ::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<::System::IntPtr>*  ListData;
...
template<typename T>
// Is value type: true
// CS Name: Unity.Collections.LowLevel.Unsafe.UnsafePtrList`1<T>
struct CORDL_TYPE UnsafePtrList_1 {
public:
// Declarations
using ParallelReader = ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelReader<T>;

using ParallelWriter = ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelWriter<T>;

using ReadOnly = ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ReadOnly<T>;
...
constexpr operator  ::System::Collections::Generic::IEnumerable_1<::System::IntPtr>*() ;
...
inline void Add(::by_ref<::System::IntPtr>  value) ;

/// @brief Method Add, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void Add(void*  value) ;

/// @brief Method AddNoResize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void AddNoResize(void*  value) ;

/// @brief Method AddRange, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void AddRange(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>  list) ;
...
inline ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelReader<T> AsParallelReader() ;

/// @brief Method AsParallelWriter, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ParallelWriter<T> AsParallelWriter() ;

/// @brief Method AsReadOnly, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1_ReadOnly<T> AsReadOnly() ;
...
static inline ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>* Create(int32_t  initialCapacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, ::Unity::Collections::NativeArrayOptions  options) ;

/// @brief Method Create, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline ::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>* Create(T*  ptr, int32_t  length) ;

/// @brief Method Destroy, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void Destroy(::Unity::Collections::LowLevel::Unsafe::UnsafePtrList_1<T>*  listData) ;
...
/// @brief Method System.Collections.Generic.IEnumerable<System.IntPtr>.GetEnumerator, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::System::IntPtr>* System_Collections_Generic_IEnumerable_System_IntPtr__GetEnumerator() ;
...
constexpr ::System::Collections::Generic::IEnumerable_1<::System::IntPtr>* i___System__Collections__Generic__IEnumerable_1___System__IntPtr_() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr UnsafePtrList_1() ;

// Ctor Parameters [CppParam { name: "Ptr", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "m_length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "padding", ty: "int32_t", modifiers: "", def_value: None }]
