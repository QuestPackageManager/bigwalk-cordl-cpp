...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeStream_ConstructJob, "Unity.Collections.LowLevel.Unsafe", "UnsafeStream/ConstructJob");
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeStream_ConstructJobList, "Unity.Collections.LowLevel.Unsafe", "UnsafeStream/ConstructJobList");
...
/// @brief Method AllocateBlock, addr 0x181ec7440, size 0xf0, virtual false, abstract: false, final false
static inline void AllocateBlock(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method AllocateForEach, addr 0x181ec7530, size 0x90, virtual false, abstract: false, final false
inline void AllocateForEach(int32_t  forEachCount) ;

/// @brief Method AsReader, addr 0x181ec75c0, size 0x70, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader AsReader() ;

/// @brief Method AsWriter, addr 0x181ec7630, size 0x90, virtual false, abstract: false, final false
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Writer AsWriter() ;

/// @brief Method Count, addr 0x181ebf650, size 0x40, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method Deallocate, addr 0x181ec76c0, size 0xc0, virtual false, abstract: false, final false
inline void Deallocate() ;

/// @brief Method Dispose, addr 0x181ec7780, size 0xc0, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x181ebf470, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method IsEmpty, addr 0x181ebf750, size 0x50, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method ScheduleConstruct, addr 0x181ec7840, size 0xa0, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream, ::Unity::Collections::NativeArray_1<int32_t>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method ScheduleConstruct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream, ::Unity::Collections::NativeList_1<T>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method .ctor, addr 0x181ebf840, size 0x50, virtual false, abstract: false, final false
inline void _ctor(int32_t  bufferCount, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method get_ForEachCount, addr 0x1816ea9c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x181ebd810, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x181ebd5e0, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "Container", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStream", modifiers: "", def_value: None }, CppParam { name: "List", ty: "::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeList*", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x181ebd600, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "Container", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStream", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
...
/// @brief Method Allocate, addr 0x181ec7f40, size 0x90, virtual false, abstract: false, final false
inline uint8_t* Allocate(int32_t  size) ;

/// @brief Method BeginForEachIndex, addr 0x181ec7fd0, size 0x30, virtual false, abstract: false, final false
inline void BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method EndForEachIndex, addr 0x181ec8000, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ec8070, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BlockData", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: None }, CppParam { name: "m_CurrentBlock", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: None }, CppParam { name: "m_CurrentPtr", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "m_CurrentBlockEnd", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "m_ForeachIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ElementCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_FirstBlock", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: None }, CppParam { name: "m_FirstOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_NumberOfBlocks", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ThreadIndex", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnsafeStream_Writer(::Unity::Collections::AllocatorManager_Block  m_BlockData, ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*  m_CurrentBlock, uint8_t*  m_CurrentPtr, uint8_t*  m_CurrentBlockEnd, int32_t  m_ForeachIndex, int32_t  m_ElementCount, ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*  m_FirstBlock, int32_t  m_FirstOffset, int32_t  m_NumberOfBlocks, int32_t  m_ThreadIndex) noexcept;
...
/// @brief Method BeginForEachIndex, addr 0x181ec14d0, size 0x70, virtual false, abstract: false, final false
inline int32_t BeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method Count, addr 0x181ebf650, size 0x40, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method EndForEachIndex, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void EndForEachIndex() ;
...
/// @brief Method ReadUnsafePtr, addr 0x181ec16a0, size 0x60, virtual false, abstract: false, final false
inline uint8_t* ReadUnsafePtr(int32_t  size) ;

/// @brief Method .ctor, addr 0x181ec1740, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeStream>  stream) ;

/// @brief Method get_ForEachCount, addr 0x1816ea9c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ForEachCount() ;

/// @brief Method get_RemainingItemCount, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BlockData", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: None }, CppParam { name: "m_CurrentBlock", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: None }, CppParam { name: "m_CurrentPtr", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "m_CurrentBlockEnd", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "m_RemainingItemCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_LastBlockSize", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnsafeStream_Reader(::Unity::Collections::AllocatorManager_Block  m_BlockData, ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*  m_CurrentBlock, uint8_t*  m_CurrentPtr, uint8_t*  m_CurrentBlockEnd, int32_t  m_RemainingItemCount, int32_t  m_LastBlockSize) noexcept;
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeStream_Reader) == 0x40, "Size mismatch!");
