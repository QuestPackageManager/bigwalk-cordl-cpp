...
static inline ::Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic_1<T> GetOrCreate(uint32_t  alignment) ;
...
public:
// Declarations
/// @brief Method GetOrCreateSharedStaticInternal, addr 0x18224b520, size 0x60, virtual false, abstract: false, final false
