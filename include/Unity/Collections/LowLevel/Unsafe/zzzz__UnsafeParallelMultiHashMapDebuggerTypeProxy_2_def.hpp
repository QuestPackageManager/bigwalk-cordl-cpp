...
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMapDebuggerTypeProxy_2, "Unity.Collections.LowLevel.Unsafe", "UnsafeParallelMultiHashMapDebuggerTypeProxy`2");
...
static inline ::System::ValueTuple_2<::Unity::Collections::NativeArray_1<TKey>,int32_t> GetUniqueKeyArray(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>>  hashMap, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

static inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMapDebuggerTypeProxy_2<TKey,TValue>* New_ctor(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelMultiHashMap_2<TKey,TValue>  target) ;
