...
template<typename T>
constexpr ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1<T> const& Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>::__cordl_internal_get_Data() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Data;
}
template<typename T>
...
template<typename T>
inline void Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>::_ctor(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1<T>  data)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>*>(),
                        {".ctor", {}, {::i2c::type_of<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1<T>>()}}
                    )));
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, data);
}
template<typename T>
inline ::System::Collections::Generic::List_1<T>* Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>::get_Items()  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>*>(),
                        {"get_Items", {}, {}}
                    )));
...
template<typename T>
inline ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>* Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>::New_ctor(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSet_1<T>  data)  {
...
// Ctor Parameters []
template<typename T>
constexpr ::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashSetDebuggerTypeProxy_1<T>::UnsafeParallelHashSetDebuggerTypeProxy_1()   {
}
