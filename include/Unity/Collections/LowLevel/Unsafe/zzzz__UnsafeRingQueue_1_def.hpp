...
inline bool TryDequeueInternal(::by_ref<T>  item) ;
...
// Ctor Parameters [CppParam { name: "Ptr", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "m_Capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Filled", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Write", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Read", ty: "int32_t", modifiers: "", def_value: None }]
