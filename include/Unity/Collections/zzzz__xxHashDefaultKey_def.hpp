...
// Write type traits
MARK_REF_T(::Unity::Collections::xxHashDefaultKey*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::xxHashDefaultKey*, "Unity.Collections", "xxHashDefaultKey");
...
/// @brief Field kSecret, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kSecret, put=setStaticF_kSecret)) ::ArrayW<uint8_t>  kSecret;

static inline ::ArrayW<uint8_t> getStaticF_kSecret() ;

static inline void setStaticF_kSecret(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::Unity::Collections::xxHashDefaultKey) == 0x10, "Size mismatch!");
