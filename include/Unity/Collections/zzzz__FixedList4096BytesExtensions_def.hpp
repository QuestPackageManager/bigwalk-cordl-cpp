...
// Write type traits
MARK_REF_T(::Unity::Collections::FixedList4096BytesExtensions*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::FixedList4096BytesExtensions*, "Unity.Collections", "FixedList4096BytesExtensions");
...
static inline bool Contains(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>>  list, U  value) ;

/// @brief Method IndexOf, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline int32_t IndexOf(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>>  list, U  value) ;

/// @brief Method Remove, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline bool Remove(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>>  list, U  value) ;

/// @brief Method RemoveSwapBack, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline bool RemoveSwapBack(::by_ref<::Unity::Collections::FixedList4096Bytes_1<T>>  list, U  value) ;
...
static_assert(sizeof(::Unity::Collections::FixedList4096BytesExtensions) == 0x10, "Size mismatch!");
