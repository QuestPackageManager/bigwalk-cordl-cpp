...
DEFINE_IL2CPP_CLASS(::Unity::Collections::CollectionHelper_DummyJob, "Unity.Collections", "CollectionHelper/DummyJob");
DEFINE_IL2CPP_CLASS(::Unity::Collections::CollectionHelper_LongDoubleUnion, "Unity.Collections", "CollectionHelper/LongDoubleUnion");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
/// @brief Method Execute, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Align, addr 0x181eaada0, size 0x20, virtual false, abstract: false, final false
static inline int32_t Align(int32_t  size, int32_t  alignmentPowerOfTwo) ;

/// @brief Method Align, addr 0x181eaade0, size 0x20, virtual false, abstract: false, final false
static inline int64_t Align(int64_t  size, int32_t  alignmentPowerOfTwo) ;

/// @brief Method Align, addr 0x181eaadc0, size 0x20, virtual false, abstract: false, final false
static inline uint64_t Align(uint64_t  size, uint64_t  alignmentPowerOfTwo) ;

/// @brief Method AlignPointer, addr 0x181eaad80, size 0x20, virtual false, abstract: false, final false
static inline void* AlignPointer(void*  ptr, int32_t  alignmentPowerOfTwo) ;

/// @brief Method AssumePositive, addr 0x180543890, size 0x10, virtual false, abstract: false, final false
static inline int32_t AssumePositive(int32_t  value) ;

/// @brief Method CheckAllocator, addr 0x181eaae00, size 0x70, virtual false, abstract: false, final false
static inline void CheckAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method CheckCapacityInRange, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
static inline void CheckCapacityInRange(int32_t  capacity, int32_t  length) ;

/// @brief Method CheckCapacityInRange, addr 0x181eaae70, size 0x130, virtual false, abstract: false, final false
static inline void CheckCapacityInRange(int32_t  capacity, int32_t  maxCapacity, int32_t  length) ;
...
/// @brief Method CheckIndexInRange, addr 0x181eaafa0, size 0x70, virtual false, abstract: false, final false
static inline void CheckIndexInRange(int32_t  index, int32_t  length) ;

/// @brief Method CheckIntPositivePowerOfTwo, addr 0x181eab010, size 0x60, virtual false, abstract: false, final false
...
template<typename T>
static inline void CheckReflectionDataCorrectInternal(::System::IntPtr  reflectionData, ::by_ref<bool>  burstCompiled) ;

/// @brief Method CheckUlongPositivePowerOfTwo, addr 0x181eab070, size 0x70, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Collections::NativeArray_1<T> ConvertExistingDataToNativeArray(void*  dataPointer, int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, bool  setTempMemoryHandle) ;
...
template<typename T>
static inline ::Unity::Collections::NativeArray_1<T> ConvertExistingNativeListToNativeArray(::by_ref<::Unity::Collections::NativeList_1<T>>  nativeList, int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method CreateNativeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Collections::NativeArray_1<T> CreateNativeArray(int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
...
/// @brief Method Hash, addr 0x181eab0e0, size 0x30, virtual false, abstract: false, final false
static inline uint32_t Hash(void*  ptr, int32_t  bytes) ;

/// @brief Method IsAligned, addr 0x181eab110, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Log2Ceil, addr 0x181eab130, size 0x20, virtual false, abstract: false, final false
static inline int32_t Log2Ceil(int32_t  value) ;

/// @brief Method Log2Floor, addr 0x181eab150, size 0x20, virtual false, abstract: false, final false
static inline int32_t Log2Floor(int32_t  value) ;

/// @brief Method ShouldDeallocate, addr 0x181eab170, size 0x20, virtual false, abstract: false, final false
static inline bool ShouldDeallocate(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method WriteLayout, addr 0x181eab190, size 0x1a0, virtual false, abstract: false, final false
