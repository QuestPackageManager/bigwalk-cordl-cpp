...
DEFINE_IL2CPP_CLASS(::Unity::Collections::DoubleRewindableAllocators, "Unity.Collections", "DoubleRewindableAllocators");
...
/// @brief Method CheckIsCreated, addr 0x181eaea30, size 0x30, virtual false, abstract: false, final false
inline void CheckIsCreated() ;

/// @brief Method Dispose, addr 0x181eaea60, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Initialize, addr 0x181eaead0, size 0x100, virtual false, abstract: false, final false
inline void Initialize(::Unity::Collections::AllocatorManager_AllocatorHandle  backingAllocator, int32_t  initialSizeInBytes) ;

/// @brief Method Update, addr 0x181eaebd0, size 0x50, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method .ctor, addr 0x181eaec20, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::AllocatorManager_AllocatorHandle  backingAllocator, int32_t  initialSizeInBytes) ;

/// @brief Method get_Allocator, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::by_ref<::Unity::Collections::RewindableAllocator> get_Allocator() ;

/// @brief Method get_EnableBlockFree, addr 0x181eaec50, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_EnableBlockFree, addr 0x181eaec80, size 0x60, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Pointer", ty: "::Unity::Collections::RewindableAllocator*", modifiers: "", def_value: None }, CppParam { name: "UpdateAllocatorHelper0", ty: "::Unity::Collections::AllocatorHelper_1<::Unity::Collections::RewindableAllocator>", modifiers: "", def_value: None }, CppParam { name: "UpdateAllocatorHelper1", ty: "::Unity::Collections::AllocatorHelper_1<::Unity::Collections::RewindableAllocator>", modifiers: "", def_value: None }]
constexpr DoubleRewindableAllocators(::Unity::Collections::RewindableAllocator*  Pointer, ::Unity::Collections::AllocatorHelper_1<::Unity::Collections::RewindableAllocator>  UpdateAllocatorHelper0, ::Unity::Collections::AllocatorHelper_1<::Unity::Collections::RewindableAllocator>  UpdateAllocatorHelper1) noexcept;
...
static_assert(sizeof(::Unity::Collections::DoubleRewindableAllocators) == 0x28, "Size mismatch!");
