...
/// @brief Method CheckCapacityInRange, addr 0x181eb1ff0, size 0x90, virtual false, abstract: false, final false
inline void CheckCapacityInRange(int32_t  capacity) ;

/// @brief Method CheckCopyError, addr 0x181eb2080, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method CheckIndexInRange, addr 0x181ea7890, size 0xd0, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method CheckLengthInRange, addr 0x181eb20f0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetEnumerator, addr 0x181eb21c0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eb2350, size 0x20, virtual false, abstract: false, final false
inline ::Unity::Collections::CopyError Initialize(::StringW  source) ;

/// @brief Method Initialize, addr 0x181eb22c0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eb2370, size 0x30, virtual false, abstract: false, final false
inline ::Unity::Collections::FormatError Initialize(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method Initialize, addr 0x181eb2240, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method TryResize, addr 0x181eb23a0, size 0xa0, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x181eb2530, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method .ctor, addr 0x181eb2500, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181eb2440, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeText>  other) ;

/// @brief Method .ctor, addr 0x181eb2370, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method .ctor, addr 0x181eb25e0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  source) ;

/// @brief Method get_Capacity, addr 0x180772390, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_UTF8MaxLengthInBytes, addr 0x180772390, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181eb2620, size 0xb0, virtual false, abstract: false, final false
static inline bool op_Equality(::by_ref<::Unity::Collections::FixedString64Bytes>  a, ::StringW  b) ;
...
/// @brief Method op_Implicit, addr 0x181eb26d0, size 0x30, virtual false, abstract: false, final false
static inline ::Unity::Collections::FixedString64Bytes op_Implicit___Unity__Collections__FixedString64Bytes(::StringW  b) ;

/// @brief Method op_Inequality, addr 0x181eb2700, size 0xa0, virtual false, abstract: false, final false
static inline bool op_Inequality(::by_ref<::Unity::Collections::FixedString64Bytes>  a, ::StringW  b) ;
...
/// @brief Method MoveNext, addr 0x181ea7480, size 0x40, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x181eaefa0, size 0x20, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181eaf010, size 0x30, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x181eaf280, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::FixedString64Bytes  other) ;

/// @brief Method get_Current, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
