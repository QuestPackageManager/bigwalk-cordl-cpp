...
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Collections::FixedList512BytesDebugView_1, "Unity.Collections", "FixedList512BytesDebugView`1");
// Dependencies System.Object, Unity.Collections.FixedList512Bytes`1<T>
namespace Unity::Collections {
// cpp template
template<typename T>
// Is value type: false
...
/// @brief Field m_List, offset 0x10, size 0x200 
 __declspec(property(get=__cordl_internal_get_m_List, put=__cordl_internal_set_m_List)) ::Unity::Collections::FixedList512Bytes_1<T>  m_List;

static inline ::Unity::Collections::FixedList512BytesDebugView_1<T>* New_ctor(::Unity::Collections::FixedList512Bytes_1<T>  list) ;

constexpr ::Unity::Collections::FixedList512Bytes_1<T> const& __cordl_internal_get_m_List() const;

constexpr ::Unity::Collections::FixedList512Bytes_1<T>& __cordl_internal_get_m_List() ;

constexpr void __cordl_internal_set_m_List(::Unity::Collections::FixedList512Bytes_1<T>  value) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::FixedList512Bytes_1<T>  list) ;
...
/// @brief Field m_List, offset: 0x10, size: 0x200, def value: None
 ::Unity::Collections::FixedList512Bytes_1<T>  ___m_List;
