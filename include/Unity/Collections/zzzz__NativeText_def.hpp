...
/// @brief Method CheckNull, addr 0x181ec0ba0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x181ec0bc0, size 0x50, virtual true, abstract: false, final true
inline int32_t CompareTo(::StringW  other) ;

/// @brief Method CompareTo, addr 0x181ebf9a0, size 0x170, virtual true, abstract: false, final true
...
/// @brief Method CompareTo, addr 0x181ebfb10, size 0x50, virtual true, abstract: false, final true
inline int32_t CompareTo(::Unity::Collections::NativeText  other) ;

/// @brief Method CompareTo, addr 0x181ec0c10, size 0x20, virtual false, abstract: false, final false
inline int32_t CompareTo(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method ElementAt, addr 0x181ec0c60, size 0x30, virtual true, abstract: false, final true
inline ::by_ref<uint8_t> ElementAt(int32_t  index) ;

/// @brief Method Equals, addr 0x181ec11b0, size 0x50, virtual true, abstract: false, final true
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x181ec0d90, size 0x420, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x181ec0c90, size 0x100, virtual true, abstract: false, final true
...
/// @brief Method Equals, addr 0x181ebfcb0, size 0x20, virtual true, abstract: false, final true
inline bool Equals(::Unity::Collections::NativeText  other) ;

/// @brief Method Equals, addr 0x181ec1200, size 0xe0, virtual false, abstract: false, final false
inline bool Equals(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method ErrorWrite, addr 0x181ec12e0, size 0x30, virtual false, abstract: false, final false
inline void ErrorWrite() ;

/// @brief Method GetEnumerator, addr 0x181e9f040, size 0x20, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeText_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x181ec02c0, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetUnsafePtr, addr 0x180cb5490, size 0x40, virtual true, abstract: false, final true
inline uint8_t* GetUnsafePtr() ;

/// @brief Method ToString, addr 0x181ec0350, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryResize, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_Capacity, addr 0x1807723a0, size 0x20, virtual true, abstract: false, final true
inline int32_t get_Capacity() ;

/// @brief Method get_IsEmpty, addr 0x181ebd300, size 0x30, virtual true, abstract: false, final true
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x181ebd330, size 0x10, virtual true, abstract: false, final true
inline uint8_t get_Item(int32_t  index) ;

/// @brief Method get_Length, addr 0x1807723c0, size 0x20, virtual true, abstract: false, final true
inline int32_t get_Length() ;

/// @brief Method get_Value, addr 0x181ec0350, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181ec0c90, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x181ec14a0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_IsEmpty, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void set_IsEmpty(bool  value) ;

/// @brief Method set_Item, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void set_Item(int32_t  index, uint8_t  value) ;

/// @brief Method set_Length, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x181ebd120, size 0x50, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x181ebd830, size 0x30, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181ebd170, size 0x30, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x181ebd860, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::NativeText  source) ;

/// @brief Method .ctor, addr 0x181ebd860, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::NativeText_ReadOnly  source) ;

/// @brief Method get_Current, addr 0x1803bdb30, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x181ebd1a0, size 0x70, virtual false, abstract: false, final false
inline void Add(::by_ref<uint8_t>  value) ;

/// @brief Method AsReadOnly, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeText_ReadOnly AsReadOnly() ;

/// @brief Method CheckIndexInRange, addr 0x181ebd210, size 0xe0, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method CheckNull, addr 0x181ebf900, size 0x20, virtual false, abstract: false, final false
static inline void CheckNull(void*  dataPtr) ;
...
/// @brief Method CheckWriteAndBumpSecondaryVersion, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckWriteAndBumpSecondaryVersion() ;

/// @brief Method Clear, addr 0x181ebf920, size 0x40, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method CompareTo, addr 0x181ebf960, size 0x40, virtual true, abstract: false, final true
inline int32_t CompareTo(::StringW  other) ;
...
/// @brief Method CompareTo, addr 0x181ebfb60, size 0x30, virtual false, abstract: false, final false
inline int32_t CompareTo(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method Dispose, addr 0x181ebfb90, size 0xb0, virtual true, abstract: false, final true
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x181ebfc40, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ElementAt, addr 0x181ebd2f0, size 0x10, virtual true, abstract: false, final true
inline ::by_ref<uint8_t> ElementAt(int32_t  index) ;

/// @brief Method Equals, addr 0x181ec0170, size 0x150, virtual true, abstract: false, final true
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x181ebfcd0, size 0x3c0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x181ec0090, size 0xe0, virtual true, abstract: false, final true
inline bool Equals(::Unity::Collections::FixedString128Bytes  other) ;
...
/// @brief Method Equals, addr 0x181ebfcb0, size 0x20, virtual false, abstract: false, final false
inline bool Equals(::Unity::Collections::NativeText_ReadOnly  other) ;
...
/// @brief Method ThrowCopyError, addr 0x181ec02e0, size 0x70, virtual false, abstract: false, final false
inline void ThrowCopyError(::Unity::Collections::CopyError  error, ::StringW  source) ;

/// @brief Method ToString, addr 0x181ec0350, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryResize, addr 0x181ec0380, size 0x50, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x181ec03d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::Allocator  allocator) ;

/// @brief Method .ctor, addr 0x181ec0450, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method .ctor, addr 0x181ec0410, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method .ctor, addr 0x181ec05a0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method .ctor, addr 0x181ec0550, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  source, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method .ctor, addr 0x181ec0680, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::StringW  source, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method .ctor, addr 0x181ec0500, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::FixedString128Bytes>  source, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method .ctor, addr 0x181ec0470, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181ec0090, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x181ec07c0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_Capacity, addr 0x181ec07f0, size 0x30, virtual true, abstract: false, final true
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Item, addr 0x181ebd340, size 0x10, virtual true, abstract: false, final true
inline void set_Item(int32_t  index, uint8_t  value) ;

/// @brief Method set_Length, addr 0x181ec0820, size 0x40, virtual true, abstract: false, final true
inline void set_Length(int32_t  value) ;
