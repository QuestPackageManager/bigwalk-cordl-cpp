...
DEFINE_IL2CPP_CLASS(::Unity::Collections::FixedBytes128Align8, "Unity.Collections", "FixedBytes128Align8");
...
static_assert(sizeof(::Unity::Collections::FixedBytes128Align8) == 0x80, "Size mismatch!");
