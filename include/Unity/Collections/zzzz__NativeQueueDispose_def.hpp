...
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeQueueDispose, "Unity.Collections", "NativeQueueDispose");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
public:
// Declarations
/// @brief Method Dispose, addr 0x181ebf370, size 0x20, virtual false, abstract: false, final false
inline void Dispose() ;
...
static_assert(sizeof(::Unity::Collections::NativeQueueDispose) == 0x8, "Size mismatch!");
