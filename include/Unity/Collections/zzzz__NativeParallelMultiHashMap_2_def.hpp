...
namespace Unity::Collections {
template<typename TKey,typename TValue>
struct NativeParallelMultiHashMap_2_KeyValueEnumerator;
}
namespace Unity::Collections {
template<typename TKey,typename TValue>
...
namespace Unity::Collections {
template<typename TKey,typename TValue>
struct NativeParallelMultiHashMap_2_ReadOnly;
}
...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::NativeParallelMultiHashMap_2_Enumerator, "Unity.Collections", "NativeParallelMultiHashMap`2/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::NativeParallelMultiHashMap_2_KeyValueEnumerator, "Unity.Collections", "NativeParallelMultiHashMap`2/KeyValueEnumerator");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::NativeParallelMultiHashMap_2_ParallelWriter, "Unity.Collections", "NativeParallelMultiHashMap`2/ParallelWriter");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::NativeParallelMultiHashMap_2_ReadOnly, "Unity.Collections", "NativeParallelMultiHashMap`2/ReadOnly");
...
// Ctor Parameters [CppParam { name: "hashmap", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<TKey,TValue>", modifiers: "", def_value: None }, CppParam { name: "key", ty: "TKey", modifiers: "", def_value: None }, CppParam { name: "isFirst", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "value", ty: "TValue", modifiers: "", def_value: None }, CppParam { name: "iterator", ty: "::Unity::Collections::NativeParallelMultiHashMapIterator_1<TKey>", modifiers: "", def_value: None }]
