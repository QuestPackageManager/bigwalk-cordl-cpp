...
MARK_GEN_REF_T_PTR(::Unity::Collections::AllocatorManager_AllocatorCache_1);
...
MARK_REF_T(::Unity::Collections::SharedStatics_AllocatorManager_IsAutoDispose*);
MARK_REF_T(::Unity::Collections::SharedStatics_AllocatorManager_IsInstalled*);
MARK_REF_T(::Unity::Collections::SharedStatics_AllocatorManager_TableEntry*);
MARK_REF_T(::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$BurstDirectCall*);
MARK_REF_T(::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$PostfixBurstDelegate*);
MARK_REF_T(::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$BurstDirectCall*);
MARK_REF_T(::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$PostfixBurstDelegate*);
...
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Collections::AllocatorManager_AllocatorCache_1, "Unity.Collections", "AllocatorManager/AllocatorCache`1");
...
DEFINE_IL2CPP_CLASS(::Unity::Collections::SharedStatics_AllocatorManager_IsAutoDispose*, "Unity.Collections", "AllocatorManager/SharedStatics/IsAutoDispose");
DEFINE_IL2CPP_CLASS(::Unity::Collections::SharedStatics_AllocatorManager_IsInstalled*, "Unity.Collections", "AllocatorManager/SharedStatics/IsInstalled");
...
DEFINE_IL2CPP_CLASS(::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$BurstDirectCall*, "Unity.Collections", "AllocatorManager/SlabAllocator/Try_000000B9$BurstDirectCall");
DEFINE_IL2CPP_CLASS(::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$PostfixBurstDelegate*, "Unity.Collections", "AllocatorManager/SlabAllocator/Try_000000B9$PostfixBurstDelegate");
DEFINE_IL2CPP_CLASS(::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$BurstDirectCall*, "Unity.Collections", "AllocatorManager/StackAllocator/Try_000000AB$BurstDirectCall");
DEFINE_IL2CPP_CLASS(::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$PostfixBurstDelegate*, "Unity.Collections", "AllocatorManager/StackAllocator/Try_000000AB$PostfixBurstDelegate");
DEFINE_IL2CPP_CLASS(::Unity::Collections::AllocatorManager_AllocatorHandle, "Unity.Collections", "AllocatorManager/AllocatorHandle");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::AllocatorManager_Array16_1, "Unity.Collections", "AllocatorManager/Array16`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::AllocatorManager_Array256_1, "Unity.Collections", "AllocatorManager/Array256`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::AllocatorManager_Array32768_1, "Unity.Collections", "AllocatorManager/Array32768`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::AllocatorManager_Array4096_1, "Unity.Collections", "AllocatorManager/Array4096`1");
DEFINE_IL2CPP_CLASS(::Unity::Collections::AllocatorManager_Block, "Unity.Collections", "AllocatorManager/Block");
DEFINE_IL2CPP_CLASS(::Unity::Collections::AllocatorManager_BlockHandle, "Unity.Collections", "AllocatorManager/BlockHandle");
DEFINE_IL2CPP_CLASS(::Unity::Collections::AllocatorManager_Range, "Unity.Collections", "AllocatorManager/Range");
...
inline ::System::IAsyncResult* BeginInvoke(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x1804de840, size 0xa0, virtual true, abstract: false, final false
inline int32_t EndInvoke(::by_ref<::Unity::Collections::AllocatorManager_Block>  block, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x1804f6ae0, size 0xc0, virtual true, abstract: false, final false
inline int32_t Invoke(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;
...
/// @brief Method CheckAllocatedSuccessfully, addr 0x181ea7b30, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181ea7b90, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Equals, addr 0x181ea7be0, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x181ea7370, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IncrementVersion, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void IncrementVersion() ;

/// @brief Method Install, addr 0x181ea7c90, size 0x70, virtual false, abstract: false, final false
inline void Install(::Unity::Collections::AllocatorManager_TableEntry  tableEntry) ;

/// @brief Method Rewind, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void Rewind() ;

/// @brief Method Try, addr 0x181ea7d00, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method get_Function, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function() ;

/// @brief Method get_Handle, addr 0x1803474c0, size 0x10, virtual true, abstract: false, final true
inline ::Unity::Collections::AllocatorManager_AllocatorHandle get_Handle() ;

/// @brief Method get_IsAutoDispose, addr 0x181ea7d20, size 0x50, virtual true, abstract: false, final true
inline bool get_IsAutoDispose() ;

/// @brief Method get_IsCustomAllocator, addr 0x181ea7d70, size 0x20, virtual true, abstract: false, final true
inline bool get_IsCustomAllocator() ;

/// @brief Method get_IsInstalled, addr 0x181ea7d90, size 0x50, virtual false, abstract: false, final false
inline bool get_IsInstalled() ;

/// @brief Method get_TableEntry, addr 0x181ea7de0, size 0x40, virtual false, abstract: false, final false
inline ::by_ref<::Unity::Collections::AllocatorManager_TableEntry> get_TableEntry() ;

/// @brief Method get_ToAllocator, addr 0x181ea7e20, size 0x20, virtual true, abstract: false, final true
inline ::Unity::Collections::Allocator get_ToAllocator() ;

/// @brief Method get_Value, addr 0x18052ca80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_GreaterThan, addr 0x181ea7e40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_GreaterThanOrEqual, addr 0x181908620, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x181ea7e50, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_LessThan, addr 0x181ea7e70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_LessThanOrEqual, addr 0x1819084f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Handle, addr 0x180379030, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_AllocatorHandle) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_BlockHandle) == 0x2, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x181ebc000, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;
...
// Ctor Parameters [CppParam { name: "Pointer", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "Items", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_Range) == 0x10, "Size mismatch!");
...
/// @brief Method Allocate, addr 0x181eaab60, size 0x20, virtual false, abstract: false, final false
inline void Allocate() ;

/// @brief Method CheckFailedToAllocate, addr 0x181eaab80, size 0xa0, virtual false, abstract: false, final false
inline void CheckFailedToAllocate(int32_t  error) ;

/// @brief Method CheckFailedToFree, addr 0x181eaac20, size 0xa0, virtual false, abstract: false, final false
inline void CheckFailedToFree(int32_t  error) ;

/// @brief Method Dispose, addr 0x181eaacc0, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Free, addr 0x181eaacc0, size 0x20, virtual false, abstract: false, final false
inline void Free() ;

/// @brief Method TryAllocate, addr 0x181eaab60, size 0x20, virtual false, abstract: false, final false
inline int32_t TryAllocate() ;

/// @brief Method TryFree, addr 0x181eaacc0, size 0x20, virtual false, abstract: false, final false
inline int32_t TryFree() ;

/// @brief Method get_Alignment, addr 0x181eaace0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Alignment() ;

/// @brief Method get_AllocatedBytes, addr 0x181eaad00, size 0x20, virtual false, abstract: false, final false
inline int64_t get_AllocatedBytes() ;

/// @brief Method get_Bytes, addr 0x181eaad20, size 0x20, virtual false, abstract: false, final false
inline int64_t get_Bytes() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() ;

/// @brief Method set_Alignment, addr 0x181eaad40, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Range", ty: "::Unity::Collections::AllocatorManager_Range", modifiers: "", def_value: None }, CppParam { name: "BytesPerItem", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "AllocatedItems", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Log2Alignment", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "Padding0", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "Padding1", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "Padding2", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr AllocatorManager_Block(::Unity::Collections::AllocatorManager_Range  Range, int32_t  BytesPerItem, int32_t  AllocatedItems, uint8_t  Log2Alignment, uint8_t  Padding0, uint16_t  Padding1, uint32_t  Padding2) noexcept;
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_Block) == 0x20, "Size mismatch!");
...
/// @brief Method get_IsAutoDispose, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsAutoDispose() ;
...
// Declarations
/// @brief Method BeginInvoke, addr 0x181ebc910, size 0x80, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block, ::System::AsyncCallback*  _cordl_fixed_empty_name_whitespace, ::System::Object*  _cordl_fixed_empty_name_whitespace_param_3) ;
...
static inline ::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$PostfixBurstDelegate* New_ctor(::System::Object*  _cordl_fixed_empty_name_whitespace, ::System::IntPtr  _cordl_fixed_empty_name_whitespace_param_1) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::StackAllocator_AllocatorManager_Try_000000AB$PostfixBurstDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method GetFunctionPointer, addr 0x181ebcaa0, size 0x100, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFunctionPointer() ;

/// @brief Method GetFunctionPointerDiscard, addr 0x181ebc990, size 0x110, virtual false, abstract: false, final false
static inline void GetFunctionPointerDiscard(::by_ref<::System::IntPtr>  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x181ebc600, size 0x150, virtual false, abstract: false, final false
static inline int32_t Invoke(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;
...
/// @brief Method Initialize, addr 0x181ebc5b0, size 0x50, virtual false, abstract: false, final false
inline void Initialize(::Unity::Collections::AllocatorManager_Block  storage) ;

/// @brief Method Try, addr 0x181ebc600, size 0x150, virtual false, abstract: false, final false
static inline int32_t Try(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method Try, addr 0x181ebc750, size 0xb0, virtual true, abstract: false, final true
inline int32_t Try(::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method Try$BurstManaged, addr 0x181ea7a90, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_Function, addr 0x181ebc800, size 0xd0, virtual true, abstract: false, final true
inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function() ;
...
// Ctor Parameters [CppParam { name: "m_handle", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "m_storage", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: None }, CppParam { name: "m_top", ty: "int64_t", modifiers: "", def_value: None }]
...
static inline ::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$PostfixBurstDelegate* New_ctor(::System::Object*  _cordl_fixed_empty_name_whitespace, ::System::IntPtr  _cordl_fixed_empty_name_whitespace_param_1) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::SlabAllocator_AllocatorManager_Try_000000B9$PostfixBurstDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method GetFunctionPointer, addr 0x181ebccb0, size 0x100, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFunctionPointer() ;

/// @brief Method GetFunctionPointerDiscard, addr 0x181ebcba0, size 0x110, virtual false, abstract: false, final false
static inline void GetFunctionPointerDiscard(::by_ref<::System::IntPtr>  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method Invoke, addr 0x181ebc130, size 0x150, virtual false, abstract: false, final false
static inline int32_t Invoke(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;
...
/// @brief Method Initialize, addr 0x181ebc050, size 0xd0, virtual false, abstract: false, final false
inline void Initialize(::Unity::Collections::AllocatorManager_Block  storage, int32_t  slabSizeInBytes, int64_t  budget) ;

/// @brief Method Try, addr 0x181ebc130, size 0x150, virtual false, abstract: false, final false
static inline int32_t Try(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method Try, addr 0x181ebc280, size 0x1b0, virtual true, abstract: false, final true
inline int32_t Try(::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method Try$BurstManaged, addr 0x181ebc120, size 0x10, virtual false, abstract: false, final false
static inline int32_t Try$BurstManaged(::System::IntPtr  allocatorState, ::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method get_AllocatedBytes, addr 0x181ea7960, size 0x10, virtual false, abstract: false, final false
inline int64_t get_AllocatedBytes() ;

/// @brief Method get_BudgetInBytes, addr 0x181ea7970, size 0x10, virtual false, abstract: false, final false
inline int64_t get_BudgetInBytes() ;

/// @brief Method get_Function, addr 0x181ebc430, size 0xd0, virtual true, abstract: false, final true
inline ::Unity::Collections::AllocatorManager_TryFunction* get_Function() ;
...
/// @brief Method get_SlabSizeInBytes, addr 0x181ebc500, size 0x20, virtual false, abstract: false, final false
inline int32_t get_SlabSizeInBytes() ;

/// @brief Method get_Slabs, addr 0x181ebc520, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_SlabSizeInBytes, addr 0x181ebc540, size 0x70, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_handle", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "Storage", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: None }, CppParam { name: "Log2SlabSizeInBytes", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Occupied", ty: "::Unity::Collections::FixedList4096Bytes_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "budgetInBytes", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "allocatedBytes", ty: "int64_t", modifiers: "", def_value: None }]
constexpr AllocatorManager_SlabAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle  m_handle, ::Unity::Collections::AllocatorManager_Block  Storage, int32_t  Log2SlabSizeInBytes, ::Unity::Collections::FixedList4096Bytes_1<int32_t>  Occupied, int64_t  budgetInBytes, int64_t  allocatedBytes) noexcept;
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_SlabAllocator) == 0x1040, "Size mismatch!");
...
static_assert(sizeof(::Unity::Collections::AllocatorManager_TableEntry) == 0x10, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "f0", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f8", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f9", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f10", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f11", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f12", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f13", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f14", ty: "T", modifiers: "", def_value: None }, CppParam { name: "f15", ty: "T", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f8", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f9", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f10", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f11", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f12", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f13", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f14", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }, CppParam { name: "f15", ty: "::Unity::Collections::AllocatorManager_Array16_1<T>", modifiers: "", def_value: None }]
constexpr AllocatorManager_Array256_1(::Unity::Collections::AllocatorManager_Array16_1<T>  f0, ::Unity::Collections::AllocatorManager_Array16_1<T>  f1, ::Unity::Collections::AllocatorManager_Array16_1<T>  f2, ::Unity::Collections::AllocatorManager_Array16_1<T>  f3, ::Unity::Collections::AllocatorManager_Array16_1<T>  f4, ::Unity::Collections::AllocatorManager_Array16_1<T>  f5, ::Unity::Collections::AllocatorManager_Array16_1<T>  f6, ::Unity::Collections::AllocatorManager_Array16_1<T>  f7, ::Unity::Collections::AllocatorManager_Array16_1<T>  f8, ::Unity::Collections::AllocatorManager_Array16_1<T>  f9, ::Unity::Collections::AllocatorManager_Array16_1<T>  f10, ::Unity::Collections::AllocatorManager_Array16_1<T>  f11, ::Unity::Collections::AllocatorManager_Array16_1<T>  f12, ::Unity::Collections::AllocatorManager_Array16_1<T>  f13, ::Unity::Collections::AllocatorManager_Array16_1<T>  f14, ::Unity::Collections::AllocatorManager_Array16_1<T>  f15) noexcept;
...
// Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f8", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f9", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f10", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f11", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f12", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f13", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f14", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }, CppParam { name: "f15", ty: "::Unity::Collections::AllocatorManager_Array256_1<T>", modifiers: "", def_value: None }]
constexpr AllocatorManager_Array4096_1(::Unity::Collections::AllocatorManager_Array256_1<T>  f0, ::Unity::Collections::AllocatorManager_Array256_1<T>  f1, ::Unity::Collections::AllocatorManager_Array256_1<T>  f2, ::Unity::Collections::AllocatorManager_Array256_1<T>  f3, ::Unity::Collections::AllocatorManager_Array256_1<T>  f4, ::Unity::Collections::AllocatorManager_Array256_1<T>  f5, ::Unity::Collections::AllocatorManager_Array256_1<T>  f6, ::Unity::Collections::AllocatorManager_Array256_1<T>  f7, ::Unity::Collections::AllocatorManager_Array256_1<T>  f8, ::Unity::Collections::AllocatorManager_Array256_1<T>  f9, ::Unity::Collections::AllocatorManager_Array256_1<T>  f10, ::Unity::Collections::AllocatorManager_Array256_1<T>  f11, ::Unity::Collections::AllocatorManager_Array256_1<T>  f12, ::Unity::Collections::AllocatorManager_Array256_1<T>  f13, ::Unity::Collections::AllocatorManager_Array256_1<T>  f14, ::Unity::Collections::AllocatorManager_Array256_1<T>  f15) noexcept;
...
// Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "::Unity::Collections::AllocatorManager_Array4096_1<T>", modifiers: "", def_value: None }]
constexpr AllocatorManager_Array32768_1(::Unity::Collections::AllocatorManager_Array4096_1<T>  f0, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f1, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f2, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f3, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f4, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f5, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f6, ::Unity::Collections::AllocatorManager_Array4096_1<T>  f7) noexcept;
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::SharedStatics_AllocatorManager_IsInstalled) == 0x10, "Size mismatch!");
...
// Declarations
/// @brief Field Ref, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Ref, put=setStaticF_Ref)) ::Unity::Burst::SharedStatic_1<::Unity::Collections::AllocatorManager_Array32768_1<::Unity::Collections::AllocatorManager_TableEntry>>  Ref;
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::SharedStatics_AllocatorManager_IsAutoDispose) == 0x10, "Size mismatch!");
...
/// @brief Method RegisterDelegate, addr 0x181ebbec0, size 0x80, virtual false, abstract: false, final false
static inline void RegisterDelegate(int32_t  index, ::Unity::Collections::AllocatorManager_TryFunction*  function) ;

/// @brief Method UnregisterDelegate, addr 0x181ebbf40, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Allocate, addr 0x181ea7e80, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CheckDelegate, addr 0x181ea7ea0, size 0x10, virtual false, abstract: false, final false
static inline void CheckDelegate(::by_ref<bool>  useDelegate) ;

/// @brief Method CheckFailedToAllocate, addr 0x181ea7eb0, size 0x20, virtual false, abstract: false, final false
static inline void CheckFailedToAllocate(int32_t  error) ;

/// @brief Method CheckFailedToFree, addr 0x181ea7ed0, size 0x20, virtual false, abstract: false, final false
static inline void CheckFailedToFree(int32_t  error) ;

/// @brief Method CheckValid, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
static inline void CheckValid(::Unity::Collections::AllocatorManager_AllocatorHandle  handle) ;

/// @brief Method ConvertToAllocatorHandle, addr 0x181ea7ef0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x181ea7f40, size 0x20, virtual false, abstract: false, final false
static inline void Free(::Unity::Collections::AllocatorManager_AllocatorHandle  handle, void*  pointer) ;

/// @brief Method Free, addr 0x181ea7f10, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Install, addr 0x181ea80b0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Install, addr 0x181ea7f60, size 0x150, virtual false, abstract: false, final false
static inline void Install(::Unity::Collections::AllocatorManager_AllocatorHandle  handle, ::System::IntPtr  allocatorState, ::Unity::Burst::FunctionPointer_1<::Unity::Collections::AllocatorManager_TryFunction*>  functionPointer, ::Unity::Collections::AllocatorManager_TryFunction*  function, bool  IsAutoDispose) ;

/// @brief Method IsCustomAllocator, addr 0x181ea81e0, size 0x10, virtual false, abstract: false, final false
static inline bool IsCustomAllocator(::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method LegacyOf, addr 0x181ea81f0, size 0x10, virtual false, abstract: false, final false
static inline ::Unity::Collections::Allocator LegacyOf(::Unity::Collections::AllocatorManager_AllocatorHandle  handle) ;

/// @brief Method Register, addr 0x181ea8200, size 0x1d0, virtual false, abstract: false, final false
static inline ::Unity::Collections::AllocatorManager_AllocatorHandle Register(::System::IntPtr  allocatorState, ::Unity::Burst::FunctionPointer_1<::Unity::Collections::AllocatorManager_TryFunction*>  functionPointer, bool  IsAutoDispose, bool  isGlobal, int32_t  globalIndex) ;
...
/// @brief Method Try, addr 0x181ea84b0, size 0x1c0, virtual false, abstract: false, final false
static inline int32_t Try(::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method TryLegacy, addr 0x181ea83d0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method UseDelegate, addr 0x1802f6470, size 0x10, virtual false, abstract: false, final false
static inline bool UseDelegate() ;

/// @brief Method allocate_block, addr 0x181ea87b0, size 0x80, virtual false, abstract: false, final false
static inline int32_t allocate_block(::by_ref<::Unity::Collections::AllocatorManager_Block>  block) ;

/// @brief Method forward_mono_allocate_block, addr 0x181ea8830, size 0xc0, virtual false, abstract: false, final false
