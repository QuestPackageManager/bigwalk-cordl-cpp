...
/// @brief Method Execute, addr 0x181ebea20, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
static_assert(sizeof(::Unity::Collections::NativeBitArrayDisposeJob) == 0x10, "Size mismatch!");
