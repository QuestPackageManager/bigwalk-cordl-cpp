...
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeHashMapDisposeJob, "Unity.Collections", "NativeHashMapDisposeJob");
...
/// @brief Method Execute, addr 0x181ebf330, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
static_assert(sizeof(::Unity::Collections::NativeHashMapDisposeJob) == 0x10, "Size mismatch!");
