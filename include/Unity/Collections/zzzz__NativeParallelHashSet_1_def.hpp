...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(NativeParallelHashSet_1)
...
MARK_GEN_VAL_T(::Unity::Collections::NativeParallelHashSet_1_Enumerator);
MARK_GEN_VAL_T(::Unity::Collections::NativeParallelHashSet_1_ParallelWriter);
MARK_GEN_VAL_T(::Unity::Collections::NativeParallelHashSet_1_ReadOnly);
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::NativeParallelHashSet_1, "Unity.Collections", "NativeParallelHashSet`1");
...
/// @brief Field m_Data, offset: 0x0, size: 0x10, def value: None
 ::Unity::Collections::NativeParallelHashMap_2_ParallelWriter<T,bool>  m_Data;
...
public:
// Declarations
using Enumerator = ::Unity::Collections::NativeParallelHashSet_1_Enumerator<T>;

using ParallelWriter = ::Unity::Collections::NativeParallelHashSet_1_ParallelWriter<T>;

using ReadOnly = ::Unity::Collections::NativeParallelHashSet_1_ReadOnly<T>;
...
inline ::Unity::Collections::NativeParallelHashSet_1_ParallelWriter<T> AsParallelWriter() ;

/// @brief Method AsReadOnly, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeParallelHashSet_1_ReadOnly<T> AsReadOnly() ;
...
/// @brief Field m_Data, offset: 0x0, size: 0x10, def value: None
 ::Unity::Collections::NativeParallelHashMap_2<T,bool>  m_Data;
