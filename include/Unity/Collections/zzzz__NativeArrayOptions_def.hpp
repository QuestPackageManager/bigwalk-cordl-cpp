...
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeArrayOptions, "Unity.Collections", "NativeArrayOptions");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
/// @brief Field ClearMemory value: I32(1)
static ::Unity::Collections::NativeArrayOptions const ClearMemory;

/// @brief Field UninitializedMemory value: I32(0)
...
static_assert(offsetof(::Unity::Collections::NativeArrayOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::NativeArrayOptions) == 0x4, "Size mismatch!");
