...
DEFINE_IL2CPP_CLASS(::Unity::Burst::BurstTargetCpu, "Unity.Burst", "BurstTargetCpu");
// Dependencies 
namespace Unity::Burst {
// Is value type: true
...
static_assert(offsetof(::Unity::Burst::BurstTargetCpu, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Burst::BurstTargetCpu) == 0x4, "Size mismatch!");
