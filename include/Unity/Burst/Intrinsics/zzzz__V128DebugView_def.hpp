...
/// @brief Method .ctor, addr 0x180c0b430, size 0x5050, virtual false, abstract: false, final false
inline void _ctor(::Unity::Burst::Intrinsics::v128  value) ;

/// @brief Method get_Byte, addr 0x181e9f550, size 0xa0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Byte() ;

/// @brief Method get_Double, addr 0x181e9f5f0, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<double_t> get_Double() ;

/// @brief Method get_Float, addr 0x181e9f620, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<float_t> get_Float() ;

/// @brief Method get_SByte, addr 0x181e9f660, size 0xa0, virtual false, abstract: false, final false
inline ::ArrayW<int8_t> get_SByte() ;

/// @brief Method get_SInt, addr 0x181e9f700, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_SInt() ;

/// @brief Method get_SLong, addr 0x181e9f740, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<int64_t> get_SLong() ;

/// @brief Method get_SShort, addr 0x181e9f770, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<int16_t> get_SShort() ;

/// @brief Method get_UInt, addr 0x181e9f7e0, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t> get_UInt() ;

/// @brief Method get_ULong, addr 0x181e9f820, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<uint64_t> get_ULong() ;

/// @brief Method get_UShort, addr 0x181e9f850, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Burst::Intrinsics::V128DebugView) == 0x20, "Size mismatch!");
