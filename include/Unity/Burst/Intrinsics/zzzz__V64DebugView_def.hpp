...
/// @brief Method get_Byte, addr 0x181e9fe40, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Byte() ;

/// @brief Method get_Double, addr 0x181e9fea0, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<double_t> get_Double() ;

/// @brief Method get_Float, addr 0x181e9fed0, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<float_t> get_Float() ;

/// @brief Method get_SByte, addr 0x181e9ff00, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<int8_t> get_SByte() ;

/// @brief Method get_SInt, addr 0x181e9ff60, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_SInt() ;

/// @brief Method get_SLong, addr 0x181e9ff90, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<int64_t> get_SLong() ;

/// @brief Method get_SShort, addr 0x181e9ffc0, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<int16_t> get_SShort() ;

/// @brief Method get_UInt, addr 0x181ea0000, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t> get_UInt() ;

/// @brief Method get_ULong, addr 0x181ea0030, size 0x30, virtual false, abstract: false, final false
inline ::ArrayW<uint64_t> get_ULong() ;

/// @brief Method get_UShort, addr 0x181ea0060, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Burst::Intrinsics::V64DebugView) == 0x18, "Size mismatch!");
