...
/// @brief Method GetBlock, addr 0x181e925a0, size 0x20, virtual false, abstract: false, final false
inline uint32_t GetBlock(int32_t  idx) ;

/// @brief Method GetLength, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetLength() ;

/// @brief Method GetU32, addr 0x181e925c0, size 0x20, virtual false, abstract: false, final false
inline uint32_t GetU32() ;

/// @brief Method IsZero, addr 0x181c16480, size 0x20, virtual false, abstract: false, final false
inline bool IsZero() ;

/// @brief Method SetU32, addr 0x181e925e0, size 0x20, virtual false, abstract: false, final false
inline void SetU32(uint32_t  val) ;

/// @brief Method SetU64, addr 0x181e92600, size 0x40, virtual false, abstract: false, final false
inline void SetU64(uint64_t  val) ;

/// @brief Method SetZero, addr 0x1805d77b0, size 0x20, virtual false, abstract: false, final false
inline void SetZero() ;
...
// Non member Declarations
static_assert(offsetof(::Unity::Burst::BurstString_CutoffMode, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::Unity::Burst::BurstString_PrintFloatFormat, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method GetExponent, addr 0x181e92640, size 0x20, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x181e92660, size 0x20, virtual false, abstract: false, final false
inline uint32_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x18175e2d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetExponent, addr 0x181e92680, size 0x20, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x181e926a0, size 0x20, virtual false, abstract: false, final false
inline uint64_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x181e926c0, size 0x20, virtual false, abstract: false, final false
inline bool IsNegative() ;
...
// Non member Declarations
static_assert(offsetof(::Unity::Burst::BurstString_NumberBufferKind, value__) == 0x4, "Offset mismatch!");
...
public:
// Declarations
/// @brief Method GetDigitsPointer, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline uint8_t* GetDigitsPointer() ;

/// @brief Method .ctor, addr 0x181e92050, size 0x80, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::Unity::Burst::BurstString_NumberFormatKind, value__) == 0x1, "Offset mismatch!");
...
/// @brief Method EncodeToRaw, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline int32_t EncodeToRaw() ;

/// @brief Method GetBase, addr 0x181e911d0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetBase() ;

/// @brief Method ToString, addr 0x181e911f0, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method get_Uppercase, addr 0x181c21440, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method AlignLeft, addr 0x181e8c7e0, size 0x40, virtual false, abstract: false, final false
static inline bool AlignLeft(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, int32_t  align, int32_t  length) ;

/// @brief Method AlignRight, addr 0x181e8c820, size 0x40, virtual false, abstract: false, final false
static inline bool AlignRight(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, int32_t  align, int32_t  length) ;

/// @brief Method BigInt_Add, addr 0x181e8c930, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Add_internal, addr 0x181e8c860, size 0xd0, virtual false, abstract: false, final false
static inline void BigInt_Add_internal(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult, ::by_ref<::Unity::Burst::BurstString_tBigInt>  pLarge, ::by_ref<::Unity::Burst::BurstString_tBigInt>  pSmall) ;

/// @brief Method BigInt_Compare, addr 0x181e8c950, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method BigInt_DivideWithRemainder_MaxQuotient9, addr 0x181e8c9b0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x181e8d0c0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x181e8d040, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply10, addr 0x181e8cb70, size 0x40, virtual false, abstract: false, final false
static inline void BigInt_Multiply10(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x181e8cc20, size 0x50, virtual false, abstract: false, final false
static inline void BigInt_Multiply2(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x181e8cbb0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method BigInt_MultiplyPow10, addr 0x181e8cc70, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply_internal, addr 0x181e8cf40, size 0x100, virtual false, abstract: false, final false
static inline void BigInt_Multiply_internal(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult, ::by_ref<::Unity::Burst::BurstString_tBigInt>  pLarge, ::by_ref<::Unity::Burst::BurstString_tBigInt>  pSmall) ;

/// @brief Method BigInt_Pow10, addr 0x181e8d0e0, size 0x230, virtual false, abstract: false, final false
static inline void BigInt_Pow10(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_Pow2, addr 0x181e8d310, size 0x60, virtual false, abstract: false, final false
static inline void BigInt_Pow2(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_ShiftLeft, addr 0x181e8d370, size 0x1a0, virtual false, abstract: false, final false
static inline void BigInt_ShiftLeft(::by_ref<::Unity::Burst::BurstString_tBigInt>  pResult, uint32_t  shift) ;

/// @brief Method ConvertDoubleToString, addr 0x181e8d510, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ConvertFloatToString, addr 0x181e8d7a0, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method ConvertIntegerToString, addr 0x181e8d9f0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method ConvertUnsignedIntegerToString, addr 0x181e8db50, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method CopyFixedString, addr 0x181e8dca0, size 0x40, virtual false, abstract: false, final false
static inline void CopyFixedString(uint8_t*  dest, int32_t  destLength, uint8_t*  src, int32_t  srcLength) ;

/// @brief Method Dragon4, addr 0x181e8dce0, size 0x17a0, virtual false, abstract: false, final false
static inline uint32_t Dragon4(uint64_t  mantissa, int32_t  exponent, uint32_t  mantissaHighBitIdx, bool  hasUnequalMargins, ::Unity::Burst::BurstString_CutoffMode  cutoffMode, uint32_t  cutoffNumber, uint8_t*  pOutBuffer, uint32_t  bufferSize, ::by_ref<int32_t>  pOutExponent) ;

/// @brief Method Format, addr 0x181e901f0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e902f0, size 0x130, virtual false, abstract: false, final false
static inline void Format(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, bool  value, int32_t  formatOptionsRaw) ;

/// @brief Method Format, addr 0x181e8ff70, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e902e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90450, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e901b0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90170, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90420, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90130, size 0x40, virtual false, abstract: false, final false
static inline void Format(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, int8_t  value, int32_t  formatOptionsRaw) ;

/// @brief Method Format, addr 0x181e90110, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e902c0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90100, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x181e90460, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method FormatDecimalOrHexadecimal, addr 0x181e8f480, size 0xb0, virtual false, abstract: false, final false
static inline void FormatDecimalOrHexadecimal(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, ::by_ref<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  zeroPadding, bool  outputPositiveSign) ;

/// @brief Method FormatGeneral, addr 0x181e8f530, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method FormatInfinityNaN, addr 0x181e8f690, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method FormatNumber, addr 0x181e8f7c0, size 0x3e0, virtual false, abstract: false, final false
static inline void FormatNumber(uint8_t*  dest, ::by_ref<int32_t>  destIndex, int32_t  destLength, ::by_ref<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  nMaxDigits, ::Unity::Burst::BurstString_FormatOptions  options) ;

/// @brief Method FormatPositional, addr 0x181e8fba0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method FormatScientific, addr 0x181e8fd70, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method GetLengthForFormatGeneral, addr 0x181e90480, size 0xe0, virtual false, abstract: false, final false
static inline int32_t GetLengthForFormatGeneral(::by_ref<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  nMaxDigits) ;

/// @brief Method GetLengthIntegerToString, addr 0x181e90560, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetLengthIntegerToString(int64_t  value, int32_t  basis, int32_t  zeroPadding) ;

/// @brief Method LogBase2, addr 0x181e90590, size 0x60, virtual false, abstract: false, final false
static inline uint32_t LogBase2(uint32_t  val) ;

/// @brief Method OptsSplit, addr 0x181e905f0, size 0x110, virtual false, abstract: false, final false
static inline void OptsSplit(::StringW  fullFormat, ::by_ref<::StringW>  padding, ::by_ref<::StringW>  format) ;

/// @brief Method ParseFormatToFormatOptions, addr 0x181e90700, size 0x3f0, virtual false, abstract: false, final false
static inline ::Unity::Burst::BurstString_FormatOptions ParseFormatToFormatOptions(::StringW  fullFormat) ;

/// @brief Method RoundNumber, addr 0x181e90af0, size 0xe0, virtual false, abstract: false, final false
static inline void RoundNumber(::by_ref<::Unity::Burst::BurstString_NumberBuffer>  number, int32_t  pos, bool  isCorrectlyRounded) ;

/// @brief Method ShouldRoundUp, addr 0x181e90bd0, size 0x30, virtual false, abstract: false, final false
static inline bool ShouldRoundUp(uint8_t*  dig, int32_t  i, bool  isCorrectlyRounded) ;

/// @brief Method ValueToIntegerChar, addr 0x181e90c00, size 0x30, virtual false, abstract: false, final false
static inline uint8_t ValueToIntegerChar(int32_t  value, bool  uppercase) ;

/// @brief Method g_PowerOf10_Big, addr 0x181e90dd0, size 0x1d0, virtual false, abstract: false, final false
