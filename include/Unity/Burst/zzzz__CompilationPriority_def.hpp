...
DEFINE_IL2CPP_CLASS(::Unity::Burst::CompilationPriority, "Unity.Burst", "CompilationPriority");
// Dependencies 
namespace Unity::Burst {
// Is value type: true
...
static_assert(offsetof(::Unity::Burst::CompilationPriority, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Burst::CompilationPriority) == 0x4, "Size mismatch!");
