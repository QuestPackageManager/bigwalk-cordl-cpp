...
// Write type traits
MARK_REF_T(::Unity::Burst::SharedStatic*);
MARK_REF_T(::Unity::Burst::SharedStatic_PreserveAttribute*);
DEFINE_IL2CPP_CLASS(::Unity::Burst::SharedStatic*, "Unity.Burst", "SharedStatic");
DEFINE_IL2CPP_CLASS(::Unity::Burst::SharedStatic_PreserveAttribute*, "Unity.Burst", "SharedStatic/PreserveAttribute");
...
static_assert(sizeof(::Unity::Burst::SharedStatic_PreserveAttribute) == 0x10, "Size mismatch!");
...
/// @brief Method CheckResult, addr 0x181e92390, size 0x20, virtual false, abstract: false, final false
static inline void CheckResult(void*  result) ;

/// @brief Method CheckSizeOf, addr 0x181e923b0, size 0x30, virtual false, abstract: false, final false
static inline void CheckSizeOf(uint32_t  sizeOf) ;

/// @brief Method GetOrCreateSharedStaticInternal, addr 0x181e923e0, size 0x50, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Unity::Burst::SharedStatic) == 0x10, "Size mismatch!");
