...
// Write type traits
MARK_REF_T(::Unity::Mathematics::DoNotNormalizeAttribute*);
DEFINE_IL2CPP_CLASS(::Unity::Mathematics::DoNotNormalizeAttribute*, "Unity.Mathematics", "DoNotNormalizeAttribute");
...
static_assert(sizeof(::Unity::Mathematics::DoNotNormalizeAttribute) == 0x18, "Size mismatch!");
