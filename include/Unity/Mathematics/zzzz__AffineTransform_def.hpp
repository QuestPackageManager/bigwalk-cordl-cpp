...
/// @brief Method Equals, addr 0x181f1e130, size 0xe0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x181f1d270, size 0x100, virtual true, abstract: false, final true
inline bool Equals(::Unity::Mathematics::AffineTransform  rhs) ;

/// @brief Method GetHashCode, addr 0x181f1d370, size 0xf0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x181f1d650, size 0x240, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x181f1d460, size 0x1f0, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x181ecf020, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Unity::Mathematics::float3x4  m) ;

/// @brief Method .ctor, addr 0x181ecf1f0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::Unity::Mathematics::float4x4  m) ;

/// @brief Method .ctor, addr 0x181ecef70, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Unity::Mathematics::RigidTransform  rigid) ;

/// @brief Method .ctor, addr 0x181ecefe0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Unity::Mathematics::float3x3  rotationScale) ;

/// @brief Method .ctor, addr 0x181ecf2e0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Unity::Mathematics::float3  translation, ::Unity::Mathematics::quaternion  rotation) ;

/// @brief Method .ctor, addr 0x181ecf090, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ecf2b0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x181eee0d0, size 0x50, virtual false, abstract: false, final false
static inline ::Unity::Mathematics::float3x4 op_Implicit___Unity__Mathematics__float3x4(::Unity::Mathematics::AffineTransform  m) ;

/// @brief Method op_Implicit, addr 0x181eefc70, size 0xa0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "rs", ty: "::Unity::Mathematics::float3x3", modifiers: "", def_value: None }, CppParam { name: "t", ty: "::Unity::Mathematics::float3", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Mathematics::AffineTransform) == 0x30, "Size mismatch!");
