...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::ProfilerRecorderOptions, "Unity.Profiling", "ProfilerRecorderOptions");
// Dependencies 
namespace Unity::Profiling {
// Is value type: true
...
static_assert(offsetof(::Unity::Profiling::ProfilerRecorderOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Profiling::ProfilerRecorderOptions) == 0x4, "Size mismatch!");
