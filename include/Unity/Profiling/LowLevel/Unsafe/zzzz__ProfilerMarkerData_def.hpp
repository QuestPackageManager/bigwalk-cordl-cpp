...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::LowLevel::Unsafe::ProfilerMarkerData, "Unity.Profiling.LowLevel.Unsafe", "ProfilerMarkerData");
// Dependencies 
namespace Unity::Profiling::LowLevel::Unsafe {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "Type", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "reserved0", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "reserved1", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "Size", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "Ptr", ty: "void*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Profiling::LowLevel::Unsafe::ProfilerMarkerData) == 0x10, "Size mismatch!");
