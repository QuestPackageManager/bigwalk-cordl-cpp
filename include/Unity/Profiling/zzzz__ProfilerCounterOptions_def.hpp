...
static_assert(offsetof(::Unity::Profiling::ProfilerCounterOptions, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::Unity::Profiling::ProfilerCounterOptions) == 0x2, "Size mismatch!");
