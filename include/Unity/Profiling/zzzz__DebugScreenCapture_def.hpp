...
/// @brief Method set_Height, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_Height(int32_t  value) ;

/// @brief Method set_ImageFormat, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_ImageFormat(::UnityEngine::TextureFormat  value) ;

/// @brief Method set_RawImageDataReference, addr 0x1803bdb10, size 0x20, virtual false, abstract: false, final false
inline void set_RawImageDataReference(::Unity::Collections::NativeArray_1<uint8_t>  value) ;

/// @brief Method set_Width, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
