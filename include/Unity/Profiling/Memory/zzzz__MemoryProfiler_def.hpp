...
/// @brief Method FinalizeSnapshot, addr 0x1822484a0, size 0x70, virtual false, abstract: false, final false
static inline void FinalizeSnapshot(::StringW  path, bool  result) ;

/// @brief Method PrepareMetadata, addr 0x182248510, size 0x210, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t> PrepareMetadata() ;

/// @brief Method SaveScreenshotToDisk, addr 0x182248720, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method WriteIntToByteArray, addr 0x182248830, size 0x40, virtual false, abstract: false, final false
static inline int32_t WriteIntToByteArray(::ArrayW<uint8_t>  array, int32_t  offset, int32_t  value) ;

/// @brief Method WriteStringToByteArray, addr 0x182248870, size 0x70, virtual false, abstract: false, final false
static inline int32_t WriteStringToByteArray(::ArrayW<uint8_t>  array, int32_t  offset, ::StringW  value) ;

/// @brief Method add_CreatingMetadata, addr 0x1822488e0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_CreatingMetadata, addr 0x182248990, size 0xb0, virtual false, abstract: false, final false
