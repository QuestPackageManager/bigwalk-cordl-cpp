...
/// @brief Method get_Count, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "value", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "count", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "refValue", ty: "int64_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Profiling::ProfilerRecorderSample) == 0x18, "Size mismatch!");
