...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::ProfilerMarkerDataUnit, "Unity.Profiling", "ProfilerMarkerDataUnit");
// Dependencies 
namespace Unity::Profiling {
// Is value type: true
...
static_assert(offsetof(::Unity::Profiling::ProfilerMarkerDataUnit, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Unity::Profiling::ProfilerMarkerDataUnit) == 0x1, "Size mismatch!");
