...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::ProfilerCategoryColor, "Unity.Profiling", "ProfilerCategoryColor");
// Dependencies 
namespace Unity::Profiling {
// Is value type: true
...
static_assert(offsetof(::Unity::Profiling::ProfilerCategoryColor, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::Unity::Profiling::ProfilerCategoryColor) == 0x2, "Size mismatch!");
