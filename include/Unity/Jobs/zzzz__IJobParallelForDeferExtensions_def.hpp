...
MARK_GEN_REF_T_PTR(::Unity::Jobs::JobParallelForDeferProducer_1_IJobParallelForDeferExtensions_ExecuteJobFunction);
MARK_GEN_VAL_T(::Unity::Jobs::IJobParallelForDeferExtensions_JobParallelForDeferProducer_1);
DEFINE_IL2CPP_CLASS(::Unity::Jobs::IJobParallelForDeferExtensions*, "Unity.Jobs", "IJobParallelForDeferExtensions");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Jobs::JobParallelForDeferProducer_1_IJobParallelForDeferExtensions_ExecuteJobFunction, "Unity.Jobs", "IJobParallelForDeferExtensions/JobParallelForDeferProducer`1/ExecuteJobFunction");
...
inline ::System::IAsyncResult* BeginInvoke(::by_ref<T>  jobData, ::System::IntPtr  additionalPtr, ::System::IntPtr  bufferRangePatchData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, int32_t  jobIndex, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void EndInvoke(::by_ref<T>  jobData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, ::System::IAsyncResult*  result) ;
...
template<typename T>
static inline ::Unity::Jobs::JobHandle Schedule(T  jobData, int32_t*  forEachCount, int32_t  innerloopBatchCount, ::Unity::Jobs::JobHandle  dependsOn) ;
...
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleByRef(::by_ref<T>  jobData, int32_t*  forEachCount, int32_t  innerloopBatchCount, ::Unity::Jobs::JobHandle  dependsOn) ;

/// @brief Method ScheduleByRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline ::Unity::Jobs::JobHandle ScheduleByRef(::by_ref<T>  jobData, ::Unity::Collections::NativeList_1<U>  list, int32_t  innerloopBatchCount, ::Unity::Jobs::JobHandle  dependsOn) ;

/// @brief Method ScheduleInternal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleInternal(::by_ref<T>  jobData, int32_t  innerloopBatchCount, void*  forEachListPtr, void*  atomicSafetyHandlePtr, ::Unity::Jobs::JobHandle  dependsOn) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Jobs::IJobParallelForDeferExtensions) == 0x10, "Size mismatch!");
