...
// Write type traits
MARK_REF_T(::Unity::Jobs::RegisterGenericJobTypeAttribute*);
DEFINE_IL2CPP_CLASS(::Unity::Jobs::RegisterGenericJobTypeAttribute*, "Unity.Jobs", "RegisterGenericJobTypeAttribute");
...
static_assert(sizeof(::Unity::Jobs::RegisterGenericJobTypeAttribute) == 0x18, "Size mismatch!");
