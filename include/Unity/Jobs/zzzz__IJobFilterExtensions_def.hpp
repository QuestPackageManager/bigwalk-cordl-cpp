...
MARK_GEN_REF_T_PTR(::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_ExecuteJobFunction);
...
DEFINE_IL2CPP_CLASS(::Unity::Jobs::IJobFilterExtensions*, "Unity.Jobs", "IJobFilterExtensions");
...
// Ctor Parameters [CppParam { name: "outputIndices", ty: "::Unity::Collections::NativeList_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "appendCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "JobData", ty: "T", modifiers: "", def_value: None }]
...
inline ::System::IAsyncResult* BeginInvoke(::by_ref<::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_JobWrapper<T>>  jobWrapper, ::System::IntPtr  additionalPtr, ::System::IntPtr  bufferRangePatchData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, int32_t  jobIndex, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void EndInvoke(::by_ref<::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_JobWrapper<T>>  jobWrapper, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Invoke(::by_ref<::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_JobWrapper<T>>  jobWrapper, ::System::IntPtr  additionalPtr, ::System::IntPtr  bufferRangePatchData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, int32_t  jobIndex) ;
...
static inline void Execute(::by_ref<::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_JobWrapper<T>>  jobWrapper, ::System::IntPtr  additionalPtr, ::System::IntPtr  bufferRangePatchData, ::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobRanges>  ranges, int32_t  jobIndex) ;

/// @brief Method ExecuteAppend, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void ExecuteAppend(::by_ref<::Unity::Jobs::JobFilterProducer_1_IJobFilterExtensions_JobWrapper<T>>  jobWrapper, ::System::IntPtr  bufferRangePatchData) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Jobs::IJobFilterExtensions) == 0x10, "Size mismatch!");
