...
/// @brief Method AddEarlyInitFunction, addr 0x181eaece0, size 0xf0, virtual false, abstract: false, final false
static inline void AddEarlyInitFunction(::Unity::Jobs::EarlyInitHelpers_EarlyInitFunction*  func) ;

/// @brief Method FlushEarlyInits, addr 0x181eaedd0, size 0xf0, virtual false, abstract: false, final false
static inline void FlushEarlyInits() ;

/// @brief Method JobReflectionDataCreationFailed, addr 0x181eaeec0, size 0x30, virtual false, abstract: false, final false
