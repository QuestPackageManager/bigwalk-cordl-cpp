...
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleAppend(T  jobData, ::Unity::Collections::NativeList_1<int32_t>  indices, int32_t  arrayLength, int32_t  innerloopBatchCount, ::Unity::Jobs::JobHandle  dependsOn) ;
...
static_assert(sizeof(::Unity::Jobs::JobParallelIndexListExtensions) == 0x10, "Size mismatch!");
