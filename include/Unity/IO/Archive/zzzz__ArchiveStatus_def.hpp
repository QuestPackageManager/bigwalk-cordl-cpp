...
static_assert(offsetof(::Unity::IO::Archive::ArchiveStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::IO::Archive::ArchiveStatus) == 0x4, "Size mismatch!");
