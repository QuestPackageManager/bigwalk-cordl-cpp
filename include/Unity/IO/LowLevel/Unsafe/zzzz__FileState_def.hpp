...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::FileState, "Unity.IO.LowLevel.Unsafe", "FileState");
// Dependencies 
namespace Unity::IO::LowLevel::Unsafe {
// Is value type: true
...
static_assert(offsetof(::Unity::IO::LowLevel::Unsafe::FileState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::FileState) == 0x4, "Size mismatch!");
