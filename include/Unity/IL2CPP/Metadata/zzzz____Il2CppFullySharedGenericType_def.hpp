...
// Write type traits
MARK_REF_T(::Unity::IL2CPP::Metadata::__Il2CppFullySharedGenericType*);
DEFINE_IL2CPP_CLASS(::Unity::IL2CPP::Metadata::__Il2CppFullySharedGenericType*, "Unity.IL2CPP.Metadata", "__Il2CppFullySharedGenericType");
...
static_assert(sizeof(::Unity::IL2CPP::Metadata::__Il2CppFullySharedGenericType) == 0x8, "Size mismatch!");
