...
DEFINE_IL2CPP_CLASS(::Unity::Properties::VisitExceptionKind, "Unity.Properties", "VisitExceptionKind");
// Dependencies 
namespace Unity::Properties {
// Is value type: true
...
static_assert(offsetof(::Unity::Properties::VisitExceptionKind, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Properties::VisitExceptionKind) == 0x4, "Size mismatch!");
