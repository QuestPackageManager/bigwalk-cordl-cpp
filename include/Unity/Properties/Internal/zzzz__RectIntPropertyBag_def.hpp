...
/// @brief Method GetValue, addr 0x1821a4ed0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetValue(::by_ref<::UnityEngine::RectInt>  container) ;

static inline ::Unity::Properties::Internal::RectIntPropertyBag_HeightProperty* New_ctor() ;

/// @brief Method SetValue, addr 0x182305010, size 0x10, virtual true, abstract: false, final false
inline void SetValue(::by_ref<::UnityEngine::RectInt>  container, int32_t  value) ;
...
/// @brief Method .ctor, addr 0x18230a720, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
