...
// Write type traits
MARK_REF_T(::Unity::Properties::Internal::ReflectedPropertyBagProvider*);
MARK_REF_T(::Unity::Properties::Internal::ReflectedPropertyBagProvider__GetPropertyMembers_d__22*);
MARK_REF_T(::Unity::Properties::Internal::ReflectedPropertyBagProvider___c*);
...
/// @brief Method <GetPropertyMembers>b__22_0, addr 0x180972170, size 0x1b40, virtual false, abstract: false, final false
inline int32_t _GetPropertyMembers_b__22_0(::System::Reflection::MemberInfo*  x) ;

/// @brief Method <.ctor>b__10_0, addr 0x18230ccc0, size 0x70, virtual false, abstract: false, final false
...
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_System_Reflection_MemberInfo__get_Current)) ::System::Reflection::MemberInfo*  System_Collections_Generic_IEnumerator_System_Reflection_MemberInfo__Current;
...
/// @brief Field <field>5__9, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__field_5__9, put=__cordl_internal_set__field_5__9)) ::System::Reflection::FieldInfo*  _field_5__9;
...
/// @brief Field <hasSerializeReferenceAttribute>5__8, offset 0x54, size 0x1 
 __declspec(property(get=__cordl_internal_get__hasSerializeReferenceAttribute_5__8, put=__cordl_internal_set__hasSerializeReferenceAttribute_5__8)) bool  _hasSerializeReferenceAttribute_5__8;
...
/// @brief Method MoveNext, addr 0x18230c3d0, size 0x780, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerable<System.Reflection.MemberInfo>.GetEnumerator, addr 0x18230cb50, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<System.Reflection.MemberInfo>.get_Current, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::System::Reflection::MemberInfo* System_Collections_Generic_IEnumerator_System_Reflection_MemberInfo__get_Current() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x18230cb50, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x18230cbc0, size 0x80, virtual true, abstract: false, final true
...
constexpr ::System::Reflection::FieldInfo* const& __cordl_internal_get__field_5__9() const;

constexpr ::System::Reflection::FieldInfo*& __cordl_internal_get__field_5__9() ;
...
constexpr bool const& __cordl_internal_get__hasSerializeReferenceAttribute_5__8() const;

constexpr bool& __cordl_internal_get__hasSerializeReferenceAttribute_5__8() ;
...
constexpr void __cordl_internal_set__field_5__9(::System::Reflection::FieldInfo*  value) ;
...
constexpr void __cordl_internal_set__hasSerializeReferenceAttribute_5__8(bool  value) ;
...
/// @brief Method <>m__Finally1, addr 0x1818289d0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field <hasSerializeReferenceAttribute>5__8, offset: 0x54, size: 0x1, def value: None
 bool  ____hasSerializeReferenceAttribute_5__8;

/// @brief Field <field>5__9, offset: 0x58, size: 0x8, def value: None
 ::System::Reflection::FieldInfo*  ____field_5__9;
...
static_assert(offsetof(::Unity::Properties::Internal::ReflectedPropertyBagProvider__GetPropertyMembers_d__22, ____hasSerializeReferenceAttribute_5__8) == 0x54, "Offset mismatch!");

static_assert(offsetof(::Unity::Properties::Internal::ReflectedPropertyBagProvider__GetPropertyMembers_d__22, ____field_5__9) == 0x58, "Offset mismatch!");
...
/// @brief Field m_CreateArrayPropertyBagMethod, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateArrayPropertyBagMethod, put=__cordl_internal_set_m_CreateArrayPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateArrayPropertyBagMethod;

/// @brief Field m_CreateDictionaryPropertyBagMethod, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateDictionaryPropertyBagMethod, put=__cordl_internal_set_m_CreateDictionaryPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateDictionaryPropertyBagMethod;

/// @brief Field m_CreateHashSetPropertyBagMethod, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateHashSetPropertyBagMethod, put=__cordl_internal_set_m_CreateHashSetPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateHashSetPropertyBagMethod;

/// @brief Field m_CreateIndexedCollectionPropertyBagMethod, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateIndexedCollectionPropertyBagMethod, put=__cordl_internal_set_m_CreateIndexedCollectionPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateIndexedCollectionPropertyBagMethod;

/// @brief Field m_CreateKeyValueCollectionPropertyBagMethod, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateKeyValueCollectionPropertyBagMethod, put=__cordl_internal_set_m_CreateKeyValueCollectionPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateKeyValueCollectionPropertyBagMethod;

/// @brief Field m_CreateKeyValuePairPropertyBagMethod, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateKeyValuePairPropertyBagMethod, put=__cordl_internal_set_m_CreateKeyValuePairPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateKeyValuePairPropertyBagMethod;

/// @brief Field m_CreateListPropertyBagMethod, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreateListPropertyBagMethod, put=__cordl_internal_set_m_CreateListPropertyBagMethod)) ::System::Reflection::MethodInfo*  m_CreateListPropertyBagMethod;
...
template<typename TElement>
inline ::Unity::Properties::IPropertyBag_1<::ArrayW<TElement>>* CreateArrayPropertyBag() ;

/// @brief Method CreateDictionaryPropertyBag, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TKey,typename TValue>
inline ::Unity::Properties::IPropertyBag_1<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>* CreateDictionaryPropertyBag() ;

/// @brief Method CreateHashSetPropertyBag, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TElement>
inline ::Unity::Properties::IPropertyBag_1<::System::Collections::Generic::HashSet_1<TElement>*>* CreateHashSetPropertyBag() ;
...
template<typename TKey,typename TValue>
inline ::Unity::Properties::IPropertyBag_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>* CreateKeyValuePairPropertyBag() ;

/// @brief Method CreateListPropertyBag, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TElement>
inline ::Unity::Properties::IPropertyBag_1<::System::Collections::Generic::List_1<TElement>*>* CreateListPropertyBag() ;

/// @brief Method CreateProperty, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer,typename TValue>
inline void CreateProperty(::Unity::Properties::IMemberInfo*  member, ::Unity::Properties::Internal::ReflectedPropertyBag_1<TContainer>*  propertyBag) ;

/// @brief Method CreatePropertyBag, addr 0x18230a880, size 0xd0, virtual false, abstract: false, final false
...
template<typename TContainer>
inline ::Unity::Properties::IPropertyBag_1<TContainer>* CreatePropertyBag() ;
...
/// @brief Method GetPropertyMembers, addr 0x18230a950, size 0x50, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IEnumerable_1<::System::Reflection::MemberInfo*>* GetPropertyMembers(::System::Type*  type) ;

/// @brief Method IsValidMember, addr 0x18230a9a0, size 0x110, virtual false, abstract: false, final false
static inline bool IsValidMember(::System::Reflection::MemberInfo*  memberInfo) ;

/// @brief Method IsValidPropertyType, addr 0x18230aab0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18230ab50, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Unity::Properties::Internal::ReflectedPropertyBagProvider) == 0x60, "Size mismatch!");
