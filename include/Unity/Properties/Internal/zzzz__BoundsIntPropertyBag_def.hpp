...
// Write type traits
MARK_REF_T(::Unity::Properties::Internal::BoundsIntPropertyBag*);
MARK_REF_T(::Unity::Properties::Internal::BoundsIntPropertyBag_PositionProperty*);
MARK_REF_T(::Unity::Properties::Internal::BoundsIntPropertyBag_SizeProperty*);
DEFINE_IL2CPP_CLASS(::Unity::Properties::Internal::BoundsIntPropertyBag*, "Unity.Properties.Internal", "BoundsIntPropertyBag");
DEFINE_IL2CPP_CLASS(::Unity::Properties::Internal::BoundsIntPropertyBag_PositionProperty*, "Unity.Properties.Internal", "BoundsIntPropertyBag/PositionProperty");
DEFINE_IL2CPP_CLASS(::Unity::Properties::Internal::BoundsIntPropertyBag_SizeProperty*, "Unity.Properties.Internal", "BoundsIntPropertyBag/SizeProperty");
...
static_assert(sizeof(::Unity::Properties::Internal::BoundsIntPropertyBag_PositionProperty) == 0x18, "Size mismatch!");
...
/// @brief Method get_Name, addr 0x18230aee0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Name() ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Properties::Internal::BoundsIntPropertyBag_SizeProperty) == 0x18, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x182303e80, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Properties::Internal::BoundsIntPropertyBag) == 0x28, "Size mismatch!");
