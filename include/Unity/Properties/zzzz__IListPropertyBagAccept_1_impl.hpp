...
inline void Unity::Properties::IListPropertyBagAccept_1<TContainer>::Accept(::Unity::Properties::IListPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container)  {
auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                            reinterpret_cast<Il2CppObject*>(this)->klass,
                            {::i2c::class_of<::Unity::Properties::IListPropertyBagAccept_1<TContainer>*>(), 0}
                        )));
