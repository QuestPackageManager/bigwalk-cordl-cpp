...
namespace Unity::Properties {
template<typename TKey,typename TValue>
class KeyValuePairPropertyBag_2__GetPropertiesEnumerable_d__4;
}
namespace Unity::Properties {
template<typename TKey,typename TValue>
class KeyValuePairPropertyBag_2___c;
}
namespace Unity::Properties {
template<typename TContainer>
...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::KeyValuePairPropertyBag_2);
MARK_GEN_REF_T_PTR(::Unity::Properties::KeyValuePairPropertyBag_2__GetPropertiesEnumerable_d__4);
MARK_GEN_REF_T_PTR(::Unity::Properties::KeyValuePairPropertyBag_2___c);
...
inline TKey __cctor_b__7_0(::by_ref<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  container) ;

/// @brief Method <.cctor>b__7_1, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline TValue __cctor_b__7_1(::by_ref<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  container) ;
...
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_Unity_Properties_IProperty_System_Collections_Generic_KeyValuePair_TKey_TValue____get_Current)) ::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  System_Collections_Generic_IEnumerator_Unity_Properties_IProperty_System_Collections_Generic_KeyValuePair_TKey_TValue____Current;
...
/// @brief Field <>2__current, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get___2__current, put=__cordl_internal_set___2__current)) ::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  __2__current;
...
/// @brief Method System.Collections.Generic.IEnumerable<Unity.Properties.IProperty<System.Collections.Generic.KeyValuePair<TKey,TValue>>>.GetEnumerator, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*>* System_Collections_Generic_IEnumerable_Unity_Properties_IProperty_System_Collections_Generic_KeyValuePair_TKey_TValue____GetEnumerator() ;

/// @brief Method System.Collections.Generic.IEnumerator<Unity.Properties.IProperty<System.Collections.Generic.KeyValuePair<TKey,TValue>>>.get_Current, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline ::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>* System_Collections_Generic_IEnumerator_Unity_Properties_IProperty_System_Collections_Generic_KeyValuePair_TKey_TValue____get_Current() ;
...
constexpr ::System::Collections::Generic::IEnumerable_1<::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*>* i___System__Collections__Generic__IEnumerable_1___Unity__Properties__IProperty_1___System__Collections__Generic__KeyValuePair_2_TKey_TValue____() noexcept;
...
constexpr ::System::Collections::Generic::IEnumerator_1<::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*>* i___System__Collections__Generic__IEnumerator_1___Unity__Properties__IProperty_1___System__Collections__Generic__KeyValuePair_2_TKey_TValue____() noexcept;
...
/// @brief Field s_KeyProperty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_KeyProperty, put=setStaticF_s_KeyProperty)) ::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TKey>*  s_KeyProperty;

/// @brief Field s_ValueProperty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ValueProperty, put=setStaticF_s_ValueProperty)) ::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TValue>*  s_ValueProperty;
...
/// @brief Method GetProperties, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Unity::Properties::PropertyCollection_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>> GetProperties(::by_ref<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  container) ;
...
inline bool TryGetProperty(::by_ref<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  container, ::StringW  name, ::by_ref<::Unity::Properties::IProperty_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*>  property) ;
...
constexpr ::Unity::Properties::INamedProperties_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>* i___Unity__Properties__INamedProperties_1___System__Collections__Generic__KeyValuePair_2_TKey_TValue__() noexcept;
