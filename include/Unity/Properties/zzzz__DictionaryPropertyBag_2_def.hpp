...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::DictionaryPropertyBag_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::DictionaryPropertyBag_2, "Unity.Properties", "DictionaryPropertyBag`2");
