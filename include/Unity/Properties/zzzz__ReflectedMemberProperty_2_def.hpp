...
class ReflectedMemberProperty_2_GetClassValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class ReflectedMemberProperty_2_GetStructValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class ReflectedMemberProperty_2_SetClassValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class ReflectedMemberProperty_2_SetStructValueAction;
}
...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::ReflectedMemberProperty_2);
MARK_GEN_REF_T_PTR(::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction);
MARK_GEN_REF_T_PTR(::Unity::Properties::ReflectedMemberProperty_2_GetStructValueAction);
MARK_GEN_REF_T_PTR(::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction);
MARK_GEN_REF_T_PTR(::Unity::Properties::ReflectedMemberProperty_2_SetStructValueAction);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ReflectedMemberProperty_2, "Unity.Properties", "ReflectedMemberProperty`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction, "Unity.Properties", "ReflectedMemberProperty`2/GetClassValueAction");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ReflectedMemberProperty_2_GetStructValueAction, "Unity.Properties", "ReflectedMemberProperty`2/GetStructValueAction");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction, "Unity.Properties", "ReflectedMemberProperty`2/SetClassValueAction");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ReflectedMemberProperty_2_SetStructValueAction, "Unity.Properties", "ReflectedMemberProperty`2/SetStructValueAction");
...
inline TValue Invoke(::by_ref<TContainer>  container) ;
...
/// @brief Field m_GetClassValueAction, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetClassValueAction, put=__cordl_internal_set_m_GetClassValueAction)) ::Unity::Properties::ReflectedMemberProperty_2_GetClassValueAction<TContainer,TValue>*  m_GetClassValueAction;

/// @brief Field m_GetStructValueAction, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetStructValueAction, put=__cordl_internal_set_m_GetStructValueAction)) ::Unity::Properties::ReflectedMemberProperty_2_GetStructValueAction<TContainer,TValue>*  m_GetStructValueAction;
...
/// @brief Field m_SetClassValueAction, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SetClassValueAction, put=__cordl_internal_set_m_SetClassValueAction)) ::Unity::Properties::ReflectedMemberProperty_2_SetClassValueAction<TContainer,TValue>*  m_SetClassValueAction;

/// @brief Field m_SetStructValueAction, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SetStructValueAction, put=__cordl_internal_set_m_SetStructValueAction)) ::Unity::Properties::ReflectedMemberProperty_2_SetStructValueAction<TContainer,TValue>*  m_SetStructValueAction;
