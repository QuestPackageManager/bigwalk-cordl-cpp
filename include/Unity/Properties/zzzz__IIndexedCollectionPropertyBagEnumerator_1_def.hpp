...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1, "Unity.Properties", "IIndexedCollectionPropertyBagEnumerator`1");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename TContainer>
...
inline int32_t GetCount(::by_ref<TContainer>  container) ;
