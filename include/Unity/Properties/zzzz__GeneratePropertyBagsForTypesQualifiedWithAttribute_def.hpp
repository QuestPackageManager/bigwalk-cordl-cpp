...
/// @brief Method .ctor, addr 0x182304df0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::GeneratePropertyBagsForTypesQualifiedWithAttribute) == 0x20, "Size mismatch!");
