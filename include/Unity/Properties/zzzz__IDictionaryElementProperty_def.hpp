...
// Write type traits
MARK_REF_T(::Unity::Properties::IDictionaryElementProperty*);
DEFINE_IL2CPP_CLASS(::Unity::Properties::IDictionaryElementProperty*, "Unity.Properties", "IDictionaryElementProperty");
// Dependencies 
namespace Unity::Properties {
// Is value type: false
