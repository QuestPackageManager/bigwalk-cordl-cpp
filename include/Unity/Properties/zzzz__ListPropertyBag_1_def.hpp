...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::ListPropertyBag_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ListPropertyBag_1, "Unity.Properties", "ListPropertyBag`1");
