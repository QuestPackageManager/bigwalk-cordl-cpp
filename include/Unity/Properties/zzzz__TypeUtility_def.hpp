...
namespace Unity::Properties {
template<typename T>
class TypeUtility_TypeConstructor_1;
}
namespace Unity::Properties {
...
// Write type traits
MARK_REF_T(::Unity::Properties::TypeUtility*);
MARK_REF_T(::Unity::Properties::TypeUtility_ITypeConstructor*);
MARK_GEN_REF_T_PTR(::Unity::Properties::TypeUtility_ITypeConstructor_1);
MARK_REF_T(::Unity::Properties::TypeUtility_NonConstructable*);
MARK_REF_T(::Unity::Properties::TypeUtility_TypeConstructorVisitor*);
MARK_GEN_REF_T_PTR(::Unity::Properties::TypeUtility_TypeConstructor_1);
MARK_REF_T(::Unity::Properties::TypeUtility___c*);
MARK_GEN_VAL_T(::Unity::Properties::TypeUtility_Cache_1);
DEFINE_IL2CPP_CLASS(::Unity::Properties::TypeUtility*, "Unity.Properties", "TypeUtility");
DEFINE_IL2CPP_CLASS(::Unity::Properties::TypeUtility_ITypeConstructor*, "Unity.Properties", "TypeUtility/ITypeConstructor");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::TypeUtility_ITypeConstructor_1, "Unity.Properties", "TypeUtility/ITypeConstructor`1");
DEFINE_IL2CPP_CLASS(::Unity::Properties::TypeUtility_NonConstructable*, "Unity.Properties", "TypeUtility/NonConstructable");
DEFINE_IL2CPP_CLASS(::Unity::Properties::TypeUtility_TypeConstructorVisitor*, "Unity.Properties", "TypeUtility/TypeConstructorVisitor");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::TypeUtility_TypeConstructor_1, "Unity.Properties", "TypeUtility/TypeConstructor`1");
DEFINE_IL2CPP_CLASS(::Unity::Properties::TypeUtility___c*, "Unity.Properties", "TypeUtility/<>c");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Properties::TypeUtility_Cache_1, "Unity.Properties", "TypeUtility/Cache`1");
// Dependencies 
namespace Unity::Properties {
// Is value type: false
...
/// @brief Method Instantiate, addr 0x182305120, size 0x20, virtual true, abstract: false, final true
inline ::System::Object* Instantiate() ;

static inline ::Unity::Properties::TypeUtility_NonConstructable* New_ctor() ;

/// @brief Method Unity.Properties.TypeUtility.ITypeConstructor.get_CanBeInstantiated, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
inline bool Unity_Properties_TypeUtility_ITypeConstructor_get_CanBeInstantiated() ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Properties::TypeUtility_NonConstructable) == 0x10, "Size mismatch!");
...
/// @brief Method <.cctor>b__11_0, addr 0x18230cc70, size 0x30, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* __cctor_b__11_0() ;

/// @brief Method <.cctor>b__11_1, addr 0x18230cca0, size 0x10, virtual false, abstract: false, final false
inline void __cctor_b__11_1(::System::Text::StringBuilder*  sb) ;

/// @brief Method <.cctor>b__11_2, addr 0x180393520, size 0x20, virtual false, abstract: false, final false
...
// Declarations
template<typename T>
using Cache_1 = ::Unity::Properties::TypeUtility_Cache_1<T>;

using ITypeConstructor = ::Unity::Properties::TypeUtility_ITypeConstructor;

template<typename T>
using ITypeConstructor_1 = ::Unity::Properties::TypeUtility_ITypeConstructor_1<T>;
...
template<typename T>
using TypeConstructor_1 = ::Unity::Properties::TypeUtility_TypeConstructor_1<T>;
...
/// @brief Field s_CachedResolvedName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_CachedResolvedName, put=setStaticF_s_CachedResolvedName)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::StringW>*  s_CachedResolvedName;
...
/// @brief Field s_TypeConstructors, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_TypeConstructors, put=setStaticF_s_TypeConstructors)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::TypeUtility_ITypeConstructor*>*  s_TypeConstructors;
...
template<typename T>
static inline bool CanBeInstantiated() ;

/// @brief Method CanBeInstantiated, addr 0x18230b440, size 0x90, virtual false, abstract: false, final false
static inline bool CanBeInstantiated(::System::Type*  type) ;

/// @brief Method CheckCanBeInstantiated, addr 0x18230b4d0, size 0x80, virtual false, abstract: false, final false
...
template<typename T>
static inline void CheckCanBeInstantiated(::Unity::Properties::TypeUtility_ITypeConstructor_1<T>*  constructor) ;

/// @brief Method CheckIsAssignableFrom, addr 0x18230b550, size 0x100, virtual false, abstract: false, final false
static inline void CheckIsAssignableFrom(::System::Type*  type, ::System::Type*  derivedType) ;

/// @brief Method CreateTypeConstructor, addr 0x18230b650, size 0x1c0, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Properties::TypeUtility_ITypeConstructor_1<T>* CreateTypeConstructor() ;

/// @brief Method GetRootType, addr 0x18230b810, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Type* GetRootType(::System::Type*  type) ;

/// @brief Method GetTypeConstructor, addr 0x18230b8e0, size 0x70, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Properties::TypeUtility_ITypeConstructor_1<T>* GetTypeConstructor() ;

/// @brief Method GetTypeDisplayName, addr 0x18230b950, size 0xc0, virtual false, abstract: false, final false
static inline ::StringW GetTypeDisplayName(::System::Type*  type) ;

/// @brief Method GetTypeDisplayName, addr 0x18230ba10, size 0x670, virtual false, abstract: false, final false
...
/// @brief Method Instantiate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T Instantiate(::System::Type*  derivedType) ;

/// @brief Method InstantiateArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TArray>
static inline TArray InstantiateArray(int32_t  count) ;

/// @brief Method InstantiateArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TArray>
static inline TArray InstantiateArray(::System::Type*  derivedType, int32_t  count) ;

/// @brief Method SetExplicitInstantiationMethod, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void SetExplicitInstantiationMethod(::System::Func_1<T>*  constructor) ;

/// @brief Method TryInstantiate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool TryInstantiate(::System::Type*  derivedType, ::by_ref<T>  value) ;

/// @brief Method TryInstantiate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool TryInstantiate(::by_ref<T>  instance) ;

/// @brief Method TryInstantiateArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TArray>
static inline bool TryInstantiateArray(int32_t  count, ::by_ref<TArray>  instance) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Properties::TypeUtility) == 0x10, "Size mismatch!");
