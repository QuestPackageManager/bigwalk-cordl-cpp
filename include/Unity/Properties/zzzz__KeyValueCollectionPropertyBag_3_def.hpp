...
MARK_GEN_REF_T_PTR(::Unity::Properties::KeyValueCollectionPropertyBag_3);
MARK_GEN_REF_T_PTR(::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty);
MARK_GEN_VAL_T(::Unity::Properties::KeyValueCollectionPropertyBag_3_Enumerable);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::Enumerable_KeyValueCollectionPropertyBag_3_Enumerator, "Unity.Properties", "KeyValueCollectionPropertyBag`3/Enumerable/Enumerator");
...
inline ::System::Collections::Generic::KeyValuePair_2<TKey,TValue> GetValue(::by_ref<TDictionary>  container) ;
...
inline void SetValue(::by_ref<TDictionary>  container, ::System::Collections::Generic::KeyValuePair_2<TKey,TValue>  value) ;
...
/// @brief Field m_Property, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Property, put=__cordl_internal_set_m_Property)) ::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty<TDictionary,TKey,TValue>*  m_Property;
...
static inline ::Unity::Properties::Enumerable_KeyValueCollectionPropertyBag_3_Enumerator<TDictionary,TKey,TValue>* New_ctor(TDictionary  dictionary, ::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty<TDictionary,TKey,TValue>*  property) ;
...
constexpr ::System::Collections::Generic::IEnumerator_1<::Unity::Properties::IProperty_1<TDictionary>*>* i___System__Collections__Generic__IEnumerator_1___Unity__Properties__IProperty_1_TDictionary___() noexcept;
...
// Ctor Parameters [CppParam { name: "m_Dictionary", ty: "TDictionary", modifiers: "", def_value: None }, CppParam { name: "m_Property", ty: "::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty<TDictionary,TKey,TValue>*", modifiers: "", def_value: None }]
...
/// @brief Field m_KeyValuePairProperty, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_KeyValuePairProperty, put=__cordl_internal_set_m_KeyValuePairProperty)) ::Unity::Properties::KeyValueCollectionPropertyBag_3_KeyValuePairProperty<TDictionary,TKey,TValue>*  m_KeyValuePairProperty;
...
/// @brief Method GetProperties, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Unity::Properties::PropertyCollection_1<TDictionary> GetProperties(::by_ref<TDictionary>  container) ;
...
inline void Unity_Properties_ICollectionPropertyBagAccept_TDictionary__Accept(::Unity::Properties::ICollectionPropertyBagVisitor*  visitor, ::by_ref<TDictionary>  container) ;
...
inline void Unity_Properties_IDictionaryPropertyBagAccept_TDictionary__Accept(::Unity::Properties::IDictionaryPropertyBagVisitor*  visitor, ::by_ref<TDictionary>  container) ;
...
inline bool Unity_Properties_IKeyedProperties_TDictionary_System_Object__TryGetProperty(::by_ref<TDictionary>  container, ::System::Object*  key, ::by_ref<::Unity::Properties::IProperty_1<TDictionary>*>  property) ;
...
constexpr ::Unity::Properties::ICollectionPropertyBag_2<TDictionary,::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>* i___Unity__Properties__ICollectionPropertyBag_2_TDictionary___System__Collections__Generic__KeyValuePair_2_TKey_TValue__() noexcept;
