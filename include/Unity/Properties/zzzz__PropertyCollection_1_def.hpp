...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Properties::PropertyCollection_1_EnumeratorType, "Unity.Properties", "PropertyCollection`1/EnumeratorType");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Properties::PropertyCollection_1, "Unity.Properties", "PropertyCollection`1");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Properties::PropertyCollection_1_Enumerator, "Unity.Properties", "PropertyCollection`1/Enumerator");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename TContainer>
...
// Ctor Parameters [CppParam { name: "m_Type", ty: "::Unity::Properties::PropertyCollection_1_EnumeratorType<TContainer>", modifiers: "", def_value: None }, CppParam { name: "m_Enumerator", ty: "::System::Collections::Generic::IEnumerator_1<::Unity::Properties::IProperty_1<TContainer>*>*", modifiers: "", def_value: None }, CppParam { name: "m_Properties", ty: "::System::Collections::Generic::List_1_Enumerator<::Unity::Properties::IProperty_1<TContainer>*>", modifiers: "", def_value: None }, CppParam { name: "m_IndexedCollectionPropertyBag", ty: "::Unity::Properties::IndexedCollectionPropertyBagEnumerator_1<TContainer>", modifiers: "", def_value: None }, CppParam { name: "_Current_k__BackingField", ty: "::Unity::Properties::IProperty_1<TContainer>*", modifiers: "", def_value: None }]
constexpr PropertyCollection_1_Enumerator(::Unity::Properties::PropertyCollection_1_EnumeratorType<TContainer>  m_Type, ::System::Collections::Generic::IEnumerator_1<::Unity::Properties::IProperty_1<TContainer>*>*  m_Enumerator, ::System::Collections::Generic::List_1_Enumerator<::Unity::Properties::IProperty_1<TContainer>*>  m_Properties, ::Unity::Properties::IndexedCollectionPropertyBagEnumerator_1<TContainer>  m_IndexedCollectionPropertyBag, ::Unity::Properties::IProperty_1<TContainer>*  _Current_k__BackingField) noexcept;
...
// Ctor Parameters [CppParam { name: "m_Type", ty: "::Unity::Properties::PropertyCollection_1_EnumeratorType<TContainer>", modifiers: "", def_value: None }, CppParam { name: "m_Enumerable", ty: "::System::Collections::Generic::IEnumerable_1<::Unity::Properties::IProperty_1<TContainer>*>*", modifiers: "", def_value: None }, CppParam { name: "m_Properties", ty: "::System::Collections::Generic::List_1<::Unity::Properties::IProperty_1<TContainer>*>*", modifiers: "", def_value: None }, CppParam { name: "m_IndexedCollectionPropertyBag", ty: "::Unity::Properties::IndexedCollectionPropertyBagEnumerable_1<TContainer>", modifiers: "", def_value: None }]
constexpr PropertyCollection_1(::Unity::Properties::PropertyCollection_1_EnumeratorType<TContainer>  m_Type, ::System::Collections::Generic::IEnumerable_1<::Unity::Properties::IProperty_1<TContainer>*>*  m_Enumerable, ::System::Collections::Generic::List_1<::Unity::Properties::IProperty_1<TContainer>*>*  m_Properties, ::Unity::Properties::IndexedCollectionPropertyBagEnumerable_1<TContainer>  m_IndexedCollectionPropertyBag) noexcept;
