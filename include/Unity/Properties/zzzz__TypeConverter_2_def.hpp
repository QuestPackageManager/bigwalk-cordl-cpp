...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::TypeConverter_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::TypeConverter_2, "Unity.Properties", "TypeConverter`2");
...
inline TDestination Invoke(::by_ref<TSource>  value) ;
