...
// Write type traits
MARK_REF_T(::Unity::Properties::MissingPropertyBagException*);
DEFINE_IL2CPP_CLASS(::Unity::Properties::MissingPropertyBagException*, "Unity.Properties", "MissingPropertyBagException");
...
/// @brief Method GetMessageForType, addr 0x182305070, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823050b0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::MissingPropertyBagException) == 0x98, "Size mismatch!");
