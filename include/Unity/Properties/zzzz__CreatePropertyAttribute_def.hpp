...
/// @brief Method get_ReadOnly, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_ReadOnly() ;

/// @brief Method set_ReadOnly, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::CreatePropertyAttribute) == 0x18, "Size mismatch!");
