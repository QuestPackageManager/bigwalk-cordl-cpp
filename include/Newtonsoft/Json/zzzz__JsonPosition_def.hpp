...
/// @brief Method BuildPath, addr 0x1817805f0, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method CalculateLength, addr 0x181780980, size 0x60, virtual false, abstract: false, final false
inline int32_t CalculateLength() ;

/// @brief Method FormatMessage, addr 0x1817809e0, size 0x1a0, virtual false, abstract: false, final false
static inline ::StringW FormatMessage(::Newtonsoft::Json::IJsonLineInfo*  lineInfo, ::StringW  path, ::StringW  message) ;

/// @brief Method TypeHasIndex, addr 0x181780b80, size 0x10, virtual false, abstract: false, final false
static inline bool TypeHasIndex(::Newtonsoft::Json::JsonContainerType  type) ;

/// @brief Method WriteTo, addr 0x181780b90, size 0x1c0, virtual false, abstract: false, final false
inline void WriteTo(::System::Text::StringBuilder*  sb, ::by_ref<::System::IO::StringWriter*>  writer, ::by_ref<::ArrayW<char16_t>>  buffer) ;

/// @brief Method .ctor, addr 0x181780db0, size 0x40, virtual false, abstract: false, final false
