...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::MemberSerialization, "Newtonsoft.Json", "MemberSerialization");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::MemberSerialization, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::MemberSerialization) == 0x4, "Size mismatch!");
