...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::JsonConverter*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonConverter*, "Newtonsoft.Json", "JsonConverter");
...
static_assert(sizeof(::Newtonsoft::Json::JsonConverter) == 0x10, "Size mismatch!");
