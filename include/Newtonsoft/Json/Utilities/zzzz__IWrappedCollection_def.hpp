...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::IWrappedCollection*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::IWrappedCollection*, "Newtonsoft.Json.Utilities", "IWrappedCollection");
// Dependencies 
namespace Newtonsoft::Json::Utilities {
// Is value type: false
