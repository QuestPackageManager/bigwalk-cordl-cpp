...
public:
// Declarations
 __declspec(property(get=get_InternalBuffer)) ::ArrayW<char16_t>  InternalBuffer;

 __declspec(property(get=get_IsEmpty)) bool  IsEmpty;

 __declspec(property(get=get_Position, put=set_Position)) int32_t  Position;

/// @brief Method Append, addr 0x1817e4f30, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Append, addr 0x1817e4e70, size 0xc0, virtual false, abstract: false, final false
inline void Append(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, char16_t  value) ;

/// @brief Method Clear, addr 0x1817e5010, size 0x60, virtual false, abstract: false, final false
inline void Clear(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool) ;

/// @brief Method EnsureSize, addr 0x1817e5070, size 0x80, virtual false, abstract: false, final false
inline void EnsureSize(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  appendLength) ;

/// @brief Method ToString, addr 0x1817e50f0, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x1817e5120, size 0x30, virtual false, abstract: false, final false
inline ::StringW ToString(int32_t  start, int32_t  length) ;

/// @brief Method .ctor, addr 0x1817e51a0, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t>  buffer) ;

/// @brief Method .ctor, addr 0x1817e5150, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  initalSize) ;

/// @brief Method get_InternalBuffer, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<char16_t> get_InternalBuffer() ;

/// @brief Method get_IsEmpty, addr 0x181649c50, size 0x50, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Position, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Position() ;

/// @brief Method set_Position, addr 0x1804bd900, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::StringBuffer) == 0x10, "Size mismatch!");
