...
/// @brief Method FallbackSetMember, addr 0x1817c68c0, size 0xf0, virtual true, abstract: false, final false
...
constexpr ::System::Dynamic::SetMemberBinder* const& __cordl_internal_get__innerBinder() const;
...
/// @brief Method .ctor, addr 0x1817c6870, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::NoThrowSetBinderMember) == 0x30, "Size mismatch!");
