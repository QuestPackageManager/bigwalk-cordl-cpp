...
// Write type traits
MARK_GEN_REF_T_PTR(::Newtonsoft::Json::Utilities::Creator_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Newtonsoft::Json::Utilities::Creator_1, "Newtonsoft.Json.Utilities", "Creator`1");
