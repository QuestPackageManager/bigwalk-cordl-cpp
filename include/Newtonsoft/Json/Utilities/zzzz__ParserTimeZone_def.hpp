...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ParserTimeZone, "Newtonsoft.Json.Utilities", "ParserTimeZone");
// Dependencies 
namespace Newtonsoft::Json::Utilities {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Utilities::ParserTimeZone, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Utilities::ParserTimeZone) == 0x4, "Size mismatch!");
