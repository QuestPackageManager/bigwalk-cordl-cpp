...
/// @brief Method <GetChildPrivateFields>b__41_0, addr 0x1817e65f0, size 0x20, virtual false, abstract: false, final false
inline bool _GetChildPrivateFields_b__41_0(::System::Reflection::FieldInfo*  f) ;

/// @brief Method <GetDefaultConstructor>b__11_0, addr 0x1817e6610, size 0x40, virtual false, abstract: false, final false
inline bool _GetDefaultConstructor_b__11_0(::System::Reflection::ConstructorInfo*  c) ;

/// @brief Method <GetFieldsAndProperties>b__31_0, addr 0x181537740, size 0x30, virtual false, abstract: false, final false
inline ::StringW _GetFieldsAndProperties_b__31_0(::System::Reflection::MemberInfo*  m) ;

/// @brief Method <GetMemberInfoFromType>b__39_0, addr 0x1817e69f0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method <GetFieldsAndProperties>b__1, addr 0x1817e6ae0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method <GetChildPrivateProperties>b__0, addr 0x1817e6b80, size 0x70, virtual false, abstract: false, final false
inline bool _GetChildPrivateProperties_b__0(::System::Reflection::PropertyInfo*  p) ;

/// @brief Method <GetChildPrivateProperties>b__1, addr 0x1817e6bf0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method <GetChildPrivateProperties>b__2, addr 0x1817e6cd0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method <IsMethodOverridden>b__0, addr 0x1817e6e00, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method CanReadMemberValue, addr 0x1817c7140, size 0x130, virtual false, abstract: false, final false
static inline bool CanReadMemberValue(::System::Reflection::MemberInfo*  member, bool  nonPublic) ;

/// @brief Method CanSetMemberValue, addr 0x1817c7270, size 0x170, virtual false, abstract: false, final false
static inline bool CanSetMemberValue(::System::Reflection::MemberInfo*  member, bool  nonPublic, bool  canSetReadOnly) ;

/// @brief Method EnsureNotByRefType, addr 0x1817c73e0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Type* EnsureNotByRefType(::System::Type*  t) ;

/// @brief Method EnsureNotNullableType, addr 0x1817c7440, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Type* EnsureNotNullableType(::System::Type*  t) ;

/// @brief Method GetAssemblyDelimiterIndex, addr 0x1817c74f0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetAttributes, addr 0x1817c7590, size 0x3e0, virtual false, abstract: false, final false
...
/// @brief Method GetBaseDefinition, addr 0x1817c7970, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Reflection::MethodInfo* GetBaseDefinition(::System::Reflection::PropertyInfo*  propertyInfo) ;

/// @brief Method GetChildPrivateFields, addr 0x1817c7a40, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method GetChildPrivateProperties, addr 0x1817c7bc0, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method GetCollectionItemType, addr 0x1817c7ef0, size 0x1a0, virtual false, abstract: false, final false
static inline ::System::Type* GetCollectionItemType(::System::Type*  type) ;

/// @brief Method GetDefaultConstructor, addr 0x1817c8180, size 0x30, virtual false, abstract: false, final false
static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type*  t) ;

/// @brief Method GetDefaultConstructor, addr 0x1817c8090, size 0xf0, virtual false, abstract: false, final false
static inline ::System::Reflection::ConstructorInfo* GetDefaultConstructor(::System::Type*  t, bool  nonPublic) ;

/// @brief Method GetDefaultValue, addr 0x1817c81b0, size 0x240, virtual false, abstract: false, final false
static inline ::System::Object* GetDefaultValue(::System::Type*  type) ;

/// @brief Method GetDictionaryKeyValueTypes, addr 0x1817c83f0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method GetFields, addr 0x1817c8a90, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method GetFieldsAndProperties, addr 0x1817c85a0, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method GetFullyQualifiedTypeName, addr 0x1817c8c80, size 0x120, virtual false, abstract: false, final false
static inline ::StringW GetFullyQualifiedTypeName(::System::Type*  t, ::Newtonsoft::Json::Serialization::ISerializationBinder*  binder) ;

/// @brief Method GetMemberInfoFromType, addr 0x1817c8da0, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method GetMemberUnderlyingType, addr 0x1817c8fd0, size 0x200, virtual false, abstract: false, final false
static inline ::System::Type* GetMemberUnderlyingType(::System::Reflection::MemberInfo*  member) ;

/// @brief Method GetMemberValue, addr 0x1817c91d0, size 0x290, virtual false, abstract: false, final false
static inline ::System::Object* GetMemberValue(::System::Reflection::MemberInfo*  member, ::System::Object*  target) ;

/// @brief Method GetObjectType, addr 0x1817c9460, size 0x10, virtual false, abstract: false, final false
static inline ::System::Type* GetObjectType(::System::Object*  v) ;

/// @brief Method GetProperties, addr 0x1817c9470, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method GetTypeName, addr 0x1817c9690, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method HasDefaultConstructor, addr 0x1817c98f0, size 0x80, virtual false, abstract: false, final false
static inline bool HasDefaultConstructor(::System::Type*  t, bool  nonPublic) ;

/// @brief Method ImplementsGenericDefinition, addr 0x1817c9b30, size 0x50, virtual false, abstract: false, final false
static inline bool ImplementsGenericDefinition(::System::Type*  type, ::System::Type*  genericInterfaceDefinition) ;

/// @brief Method ImplementsGenericDefinition, addr 0x1817c9970, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method InheritsGenericDefinition, addr 0x1817c9d90, size 0x160, virtual false, abstract: false, final false
static inline bool InheritsGenericDefinition(::System::Type*  type, ::System::Type*  genericClassDefinition) ;

/// @brief Method InheritsGenericDefinition, addr 0x1817c9c50, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method InheritsGenericDefinitionInternal, addr 0x1817c9b80, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method IsByRefLikeType, addr 0x1817c9ef0, size 0xe0, virtual false, abstract: false, final false
static inline bool IsByRefLikeType(::System::Type*  type) ;

/// @brief Method IsGenericDefinition, addr 0x1817c9fd0, size 0x70, virtual false, abstract: false, final false
static inline bool IsGenericDefinition(::System::Type*  type, ::System::Type*  genericInterfaceDefinition) ;

/// @brief Method IsIndexedProperty, addr 0x1817ca040, size 0x50, virtual false, abstract: false, final false
static inline bool IsIndexedProperty(::System::Reflection::PropertyInfo*  property) ;

/// @brief Method IsMethodOverridden, addr 0x1817ca090, size 0xd0, virtual false, abstract: false, final false
static inline bool IsMethodOverridden(::System::Type*  currentType, ::System::Type*  methodDeclaringType, ::StringW  method) ;

/// @brief Method IsNullable, addr 0x1817ca1e0, size 0xb0, virtual false, abstract: false, final false
static inline bool IsNullable(::System::Type*  t) ;

/// @brief Method IsNullableType, addr 0x1817ca160, size 0x80, virtual false, abstract: false, final false
static inline bool IsNullableType(::System::Type*  t) ;

/// @brief Method IsOverridenGenericMember, addr 0x1817ca290, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method IsPublic, addr 0x1817ca430, size 0xa0, virtual false, abstract: false, final false
static inline bool IsPublic(::System::Reflection::PropertyInfo*  property) ;

/// @brief Method IsVirtual, addr 0x1817ca4d0, size 0xd0, virtual false, abstract: false, final false
static inline bool IsVirtual(::System::Reflection::PropertyInfo*  propertyInfo) ;

/// @brief Method RemoveAssemblyDetails, addr 0x1817ca5a0, size 0x110, virtual false, abstract: false, final false
static inline ::StringW RemoveAssemblyDetails(::StringW  fullyQualifiedTypeName) ;

/// @brief Method RemoveFlag, addr 0x1817ca6b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetMemberValue, addr 0x1817ca6d0, size 0x1c0, virtual false, abstract: false, final false
static inline void SetMemberValue(::System::Reflection::MemberInfo*  member, ::System::Object*  target, ::System::Object*  value) ;

/// @brief Method SplitFullyQualifiedTypeName, addr 0x1817ca890, size 0x110, virtual false, abstract: false, final false
