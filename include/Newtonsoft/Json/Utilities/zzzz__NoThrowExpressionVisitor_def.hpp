...
/// @brief Method VisitConditional, addr 0x1817c6670, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::NoThrowExpressionVisitor) == 0x10, "Size mismatch!");
