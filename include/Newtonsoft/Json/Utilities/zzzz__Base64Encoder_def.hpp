...
/// @brief Method MoveNext, addr 0x1817cac00, size 0x3c0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Newtonsoft::Json::Utilities::Base64Encoder*", modifiers: "", def_value: None }, CppParam { name: "buffer", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "count", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_num4_5__2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_length_5__3", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
...
/// @brief Method Encode, addr 0x1817b7c50, size 0x1f0, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method EncodeAsync, addr 0x1817b7b50, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Flush, addr 0x1817b7f20, size 0x80, virtual false, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x1817b7e40, size 0xe0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FulfillFromLeftover, addr 0x1817b7fa0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method StoreLeftOverBytes, addr 0x1817b8030, size 0xd0, virtual false, abstract: false, final false
inline void StoreLeftOverBytes(::ArrayW<uint8_t>  buffer, int32_t  index, ::by_ref<int32_t>  count) ;

/// @brief Method ValidateEncode, addr 0x1817b8100, size 0x60, virtual false, abstract: false, final false
inline void ValidateEncode(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteChars, addr 0x1817b81f0, size 0x30, virtual false, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  chars, int32_t  index, int32_t  count) ;

/// @brief Method WriteCharsAsync, addr 0x1817b8160, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817b8220, size 0x60, virtual false, abstract: false, final false
