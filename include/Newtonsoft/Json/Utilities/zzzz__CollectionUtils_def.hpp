...
template<typename T>
class CollectionUtils_EmptyArrayContainer_1;
}
...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::CollectionUtils*);
...
/// @brief Field Empty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Empty, put=setStaticF_Empty)) ::ArrayW<T>  Empty;

static inline ::ArrayW<T> getStaticF_Empty() ;

static inline void setStaticF_Empty(::ArrayW<T>  value) ;
...
// Declarations
template<typename T>
using EmptyArrayContainer_1 = ::Newtonsoft::Json::Utilities::CollectionUtils_EmptyArrayContainer_1<T>;

/// @brief Method AddDistinct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool AddDistinct(::System::Collections::Generic::IList_1<T>*  list, T  value) ;

/// @brief Method AddDistinct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool AddDistinct(::System::Collections::Generic::IList_1<T>*  list, T  value, ::System::Collections::Generic::IEqualityComparer_1<T>*  comparer) ;

/// @brief Method AddRange, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void AddRange(::System::Collections::Generic::IList_1<T>*  initial, ::System::Collections::Generic::IEnumerable_1<T>*  collection) ;

/// @brief Method AddRangeDistinct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool AddRangeDistinct(::System::Collections::Generic::IList_1<T>*  list, ::System::Collections::Generic::IEnumerable_1<T>*  values, ::System::Collections::Generic::IEqualityComparer_1<T>*  comparer) ;

/// @brief Method ArrayEmpty, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T> ArrayEmpty() ;

/// @brief Method Contains, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool Contains(::System::Collections::Generic::List_1<T>*  list, T  value, ::System::Collections::IEqualityComparer*  comparer) ;
...
/// @brief Method CopyFromJaggedToMultidimensionalArray, addr 0x1817b9a60, size 0x1b0, virtual false, abstract: false, final false
...
template<typename T>
static inline void FastReverse(::System::Collections::Generic::List_1<T>*  list) ;

/// @brief Method GetDimensions, addr 0x1817b9c10, size 0x340, virtual false, abstract: false, final false
...
template<typename T>
static inline int32_t IndexOf(::System::Collections::Generic::IEnumerable_1<T>*  collection, ::System::Func_2<T,bool>*  predicate) ;
...
/// @brief Method IsDictionaryType, addr 0x1817b9f50, size 0x120, virtual false, abstract: false, final false
...
template<typename T>
static inline bool IsNullOrEmpty(::System::Collections::Generic::ICollection_1<T>*  collection) ;

/// @brief Method JaggedArrayGetValue, addr 0x1817ba070, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Object* JaggedArrayGetValue(::System::Collections::IList*  values, ::ArrayW<int32_t>  indices) ;

/// @brief Method ResolveEnumerableCollectionConstructor, addr 0x1817ba140, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ResolveEnumerableCollectionConstructor, addr 0x1817ba1e0, size 0x1e0, virtual false, abstract: false, final false
static inline ::System::Reflection::ConstructorInfo* ResolveEnumerableCollectionConstructor(::System::Type*  collectionType, ::System::Type*  collectionItemType, ::System::Type*  constructorArgumentType) ;

/// @brief Method ToMultidimensionalArray, addr 0x1817ba3c0, size 0x200, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Newtonsoft::Json::Utilities::CollectionUtils) == 0x10, "Size mismatch!");
