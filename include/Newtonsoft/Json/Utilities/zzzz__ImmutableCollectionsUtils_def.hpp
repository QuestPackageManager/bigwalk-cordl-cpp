...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils*);
MARK_REF_T(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils_ImmutableCollectionTypeInfo*);
MARK_REF_T(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c*);
MARK_REF_T(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass24_0*);
MARK_REF_T(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass25_0*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils*, "Newtonsoft.Json.Utilities", "ImmutableCollectionsUtils");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils_ImmutableCollectionTypeInfo*, "Newtonsoft.Json.Utilities", "ImmutableCollectionsUtils/ImmutableCollectionTypeInfo");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c*, "Newtonsoft.Json.Utilities", "ImmutableCollectionsUtils/<>c");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass24_0*, "Newtonsoft.Json.Utilities", "ImmutableCollectionsUtils/<>c__DisplayClass24_0");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass25_0*, "Newtonsoft.Json.Utilities", "ImmutableCollectionsUtils/<>c__DisplayClass25_0");
...
/// @brief Method get_BuilderTypeName, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_BuilderTypeName() ;

/// @brief Method get_ContractTypeName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ContractTypeName() ;

/// @brief Method get_CreatedTypeName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CreatedTypeName() ;

/// @brief Method set_BuilderTypeName, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_BuilderTypeName(::StringW  value) ;

/// @brief Method set_ContractTypeName, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_ContractTypeName(::StringW  value) ;

/// @brief Method set_CreatedTypeName, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils_ImmutableCollectionTypeInfo) == 0x28, "Size mismatch!");
...
/// @brief Method <TryBuildImmutableForArrayContract>b__24_1, addr 0x1817cb130, size 0x70, virtual false, abstract: false, final false
inline bool _TryBuildImmutableForArrayContract_b__24_1(::System::Reflection::MethodInfo*  m) ;

/// @brief Method <TryBuildImmutableForDictionaryContract>b__25_1, addr 0x1817cb1a0, size 0x120, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c) == 0x10, "Size mismatch!");
...
/// @brief Method <TryBuildImmutableForArrayContract>b__0, addr 0x1817cb410, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass24_0) == 0x18, "Size mismatch!");
...
/// @brief Method <TryBuildImmutableForDictionaryContract>b__0, addr 0x1817cb410, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils___c__DisplayClass25_0) == 0x18, "Size mismatch!");
...
/// @brief Method TryBuildImmutableForArrayContract, addr 0x1817c2870, size 0x390, virtual false, abstract: false, final false
static inline bool TryBuildImmutableForArrayContract(::System::Type*  underlyingType, ::System::Type*  collectionItemType, ::by_ref<::System::Type*>  createdType, ::by_ref<::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>*>  parameterizedCreator) ;

/// @brief Method TryBuildImmutableForDictionaryContract, addr 0x1817c2c00, size 0x3b0, virtual false, abstract: false, final false
static inline bool TryBuildImmutableForDictionaryContract(::System::Type*  underlyingType, ::System::Type*  keyItemType, ::System::Type*  valueItemType, ::by_ref<::System::Type*>  createdType, ::by_ref<::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>*>  parameterizedCreator) ;
...
// Non member Declarations
static_assert(sizeof(::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils) == 0x10, "Size mismatch!");
