...
static_assert(offsetof(::Newtonsoft::Json::Utilities::StringUtils_SeparatedCaseState, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CreateStringWriter, addr 0x1817e55f0, size 0x70, virtual false, abstract: false, final false
static inline ::System::IO::StringWriter* CreateStringWriter(int32_t  capacity) ;

/// @brief Method EndsWith, addr 0x1817e5660, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x1817e5860, size 0x90, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0) ;

/// @brief Method FormatWith, addr 0x1817e58f0, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0, ::System::Object*  arg1) ;

/// @brief Method FormatWith, addr 0x1817e57a0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x1817e56d0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x1817e56a0, size 0x30, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::ArrayW<::System::Object*>  args) ;

/// @brief Method IndexOf, addr 0x1817e59a0, size 0x20, virtual false, abstract: false, final false
static inline int32_t IndexOf(::StringW  s, char16_t  c) ;

/// @brief Method IsHighSurrogate, addr 0x1817e59c0, size 0x10, virtual false, abstract: false, final false
static inline bool IsHighSurrogate(char16_t  c) ;

/// @brief Method IsLowSurrogate, addr 0x1817e59d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method IsWhiteSpace, addr 0x1817e59f0, size 0x70, virtual false, abstract: false, final false
static inline bool IsWhiteSpace(::StringW  s) ;

/// @brief Method Replace, addr 0x1817e5a60, size 0x20, virtual false, abstract: false, final false
static inline ::StringW Replace(::StringW  s, ::StringW  oldValue, ::StringW  newValue) ;

/// @brief Method StartsWith, addr 0x1817e5a80, size 0x40, virtual false, abstract: false, final false
static inline bool StartsWith(::StringW  source, char16_t  value) ;

/// @brief Method ToCamelCase, addr 0x1817e5ac0, size 0x150, virtual false, abstract: false, final false
static inline ::StringW ToCamelCase(::StringW  s) ;

/// @brief Method ToCharAsUnicode, addr 0x1817e5c10, size 0x80, virtual false, abstract: false, final false
static inline void ToCharAsUnicode(char16_t  c, ::ArrayW<char16_t>  buffer) ;

/// @brief Method ToKebabCase, addr 0x1817e5c90, size 0x10, virtual false, abstract: false, final false
static inline ::StringW ToKebabCase(::StringW  s) ;

/// @brief Method ToLower, addr 0x1817e5ca0, size 0x30, virtual false, abstract: false, final false
static inline char16_t ToLower(char16_t  c) ;

/// @brief Method ToSeparatedCase, addr 0x1817e5cd0, size 0x1f0, virtual false, abstract: false, final false
static inline ::StringW ToSeparatedCase(::StringW  s, char16_t  separator) ;

/// @brief Method ToSnakeCase, addr 0x1817e5ec0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW ToSnakeCase(::StringW  s) ;

/// @brief Method Trim, addr 0x1817e5ed0, size 0xf0, virtual false, abstract: false, final false
