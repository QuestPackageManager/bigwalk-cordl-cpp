...
/// @brief Method Add, addr 0x181829030, size 0x90, virtual false, abstract: false, final false
inline void Add(::Newtonsoft::Json::Bson::BsonToken*  token) ;

/// @brief Method GetEnumerator, addr 0x1818290c0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1818290c0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181829110, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Type, addr 0x181829160, size 0x10, virtual true, abstract: false, final false
