...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Bson::BsonProperty*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonProperty*, "Newtonsoft.Json.Bson", "BsonProperty");
...
/// @brief Method set_Value, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonProperty) == 0x20, "Size mismatch!");
