...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Bson::BsonBoolean*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonBoolean*, "Newtonsoft.Json.Bson", "BsonBoolean");
...
/// @brief Method .ctor, addr 0x18182a8a0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonBoolean) == 0x30, "Size mismatch!");
