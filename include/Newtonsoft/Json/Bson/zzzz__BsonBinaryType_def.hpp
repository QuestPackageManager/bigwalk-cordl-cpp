...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonBinaryType, "Newtonsoft.Json.Bson", "BsonBinaryType");
// Dependencies 
namespace Newtonsoft::Json::Bson {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Bson::BsonBinaryType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Bson::BsonBinaryType) == 0x1, "Size mismatch!");
