...
/// @brief Method Add, addr 0x18182a9d0, size 0x110, virtual false, abstract: false, final false
inline void Add(::StringW  name, ::Newtonsoft::Json::Bson::BsonToken*  token) ;

/// @brief Method GetEnumerator, addr 0x18182aae0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x18182aae0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18182ab30, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Type, addr 0x18182ab80, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonObject) == 0x28, "Size mismatch!");
