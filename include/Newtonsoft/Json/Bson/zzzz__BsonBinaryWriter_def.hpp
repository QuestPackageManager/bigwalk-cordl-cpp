...
/// @brief Method CalculateSize, addr 0x181829180, size 0x10, virtual false, abstract: false, final false
inline int32_t CalculateSize(int32_t  stringByteCount) ;

/// @brief Method CalculateSize, addr 0x181829190, size 0x5f0, virtual false, abstract: false, final false
inline int32_t CalculateSize(::Newtonsoft::Json::Bson::BsonToken*  t) ;

/// @brief Method CalculateSizeWithLength, addr 0x181829170, size 0x10, virtual false, abstract: false, final false
inline int32_t CalculateSizeWithLength(int32_t  stringByteCount, bool  includeSize) ;

/// @brief Method Close, addr 0x181829780, size 0x30, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Flush, addr 0x1818297b0, size 0x30, virtual false, abstract: false, final false
inline void Flush() ;

static inline ::Newtonsoft::Json::Bson::BsonBinaryWriter* New_ctor(::System::IO::BinaryWriter*  writer) ;

/// @brief Method WriteString, addr 0x1818297e0, size 0x1c0, virtual false, abstract: false, final false
inline void WriteString(::StringW  s, int32_t  byteCount, ::System::Nullable_1<int32_t>  calculatedlengthPrefix) ;

/// @brief Method WriteToken, addr 0x18182a550, size 0x30, virtual false, abstract: false, final false
inline void WriteToken(::Newtonsoft::Json::Bson::BsonToken*  t) ;

/// @brief Method WriteTokenInternal, addr 0x1818299a0, size 0xbb0, virtual false, abstract: false, final false
inline void WriteTokenInternal(::Newtonsoft::Json::Bson::BsonToken*  t) ;

/// @brief Method WriteUtf8Bytes, addr 0x18182a580, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18182a760, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IO::BinaryWriter*  writer) ;

static inline ::System::Text::Encoding* getStaticF_Encoding() ;

/// @brief Method get_DateTimeKindHandling, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTimeKind get_DateTimeKindHandling() ;

static inline void setStaticF_Encoding(::System::Text::Encoding*  value) ;

/// @brief Method set_DateTimeKindHandling, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
