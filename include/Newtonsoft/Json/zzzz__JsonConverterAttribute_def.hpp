...
/// @brief Field <ConverterParameters>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__ConverterParameters_k__BackingField, put=__cordl_internal_set__ConverterParameters_k__BackingField)) ::ArrayW<::System::Object*>  _ConverterParameters_k__BackingField;
...
constexpr ::ArrayW<::System::Object*>& __cordl_internal_get__ConverterParameters_k__BackingField() ;
...
constexpr void __cordl_internal_set__ConverterParameters_k__BackingField(::ArrayW<::System::Object*>  value) ;

constexpr void __cordl_internal_set__converterType(::System::Type*  value) ;

/// @brief Method .ctor, addr 0x1817804a0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  converterType) ;

/// @brief Method .ctor, addr 0x181780430, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  converterType, ::ArrayW<::System::Object*>  converterParameters) ;

/// @brief Method get_ConverterParameters, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*> get_ConverterParameters() ;

/// @brief Method get_ConverterType, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::JsonConverterAttribute) == 0x20, "Size mismatch!");
