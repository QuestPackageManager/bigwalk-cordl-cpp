...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::JsonNameTable*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonNameTable*, "Newtonsoft.Json", "JsonNameTable");
...
static_assert(sizeof(::Newtonsoft::Json::JsonNameTable) == 0x10, "Size mismatch!");
