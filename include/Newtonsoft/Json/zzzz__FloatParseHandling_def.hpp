...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::FloatParseHandling, "Newtonsoft.Json", "FloatParseHandling");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::FloatParseHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::FloatParseHandling) == 0x4, "Size mismatch!");
