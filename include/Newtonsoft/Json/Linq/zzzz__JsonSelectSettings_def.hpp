...
/// @brief Method get_ErrorWhenNoMatch, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_ErrorWhenNoMatch() ;

/// @brief Method get_RegexMatchTimeout, addr 0x1802e5810, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::TimeSpan> get_RegexMatchTimeout() ;

/// @brief Method set_ErrorWhenNoMatch, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_ErrorWhenNoMatch(bool  value) ;

/// @brief Method set_RegexMatchTimeout, addr 0x180c0b430, size 0x5050, virtual false, abstract: false, final false
