...
// Write type traits
MARK_GEN_REF_T_PTR(::Newtonsoft::Json::Linq::IJEnumerable_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Newtonsoft::Json::Linq::IJEnumerable_1, "Newtonsoft.Json.Linq", "IJEnumerable`1");
// Dependencies 
namespace Newtonsoft::Json::Linq {
// cpp template
template<typename T>
