...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JTokenType, "Newtonsoft.Json.Linq", "JTokenType");
// Dependencies 
namespace Newtonsoft::Json::Linq {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Linq::JTokenType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::JTokenType) == 0x4, "Size mismatch!");
