...
static_assert(offsetof(::Newtonsoft::Json::Linq::MergeNullValueHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::MergeNullValueHandling) == 0x4, "Size mismatch!");
