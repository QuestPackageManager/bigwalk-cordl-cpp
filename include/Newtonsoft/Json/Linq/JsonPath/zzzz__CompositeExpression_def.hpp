...
/// @brief Method IsMatch, addr 0x181816b50, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181816cc0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator  _cordl_operator) ;

/// @brief Method get_Expressions, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions() ;

/// @brief Method set_Expressions, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
