...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter*);
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter__ExecuteFilter_d__2*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter*, "Newtonsoft.Json.Linq.JsonPath", "ArrayMultipleIndexFilter");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter__ExecuteFilter_d__2*, "Newtonsoft.Json.Linq.JsonPath", "ArrayMultipleIndexFilter/<ExecuteFilter>d__2");
...
/// @brief Method MoveNext, addr 0x181826380, size 0x280, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter__ExecuteFilter_d__2* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x1818281f0, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1818281f0, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x181828730, size 0xf0, virtual true, abstract: false, final true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter__ExecuteFilter_d__2) == 0x78, "Size mismatch!");
...
/// @brief Method ExecuteFilter, addr 0x181815010, size 0x90, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter) == 0x18, "Size mismatch!");
