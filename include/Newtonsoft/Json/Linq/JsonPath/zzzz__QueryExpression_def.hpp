...
/// @brief Method IsMatch, addr 0x181824e40, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryExpression) == 0x18, "Size mismatch!");
