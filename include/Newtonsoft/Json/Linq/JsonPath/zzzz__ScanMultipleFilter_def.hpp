...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ScanMultipleFilter*);
...
/// @brief Method MoveNext, addr 0x181827b60, size 0x420, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Newtonsoft::Json::Linq::JsonPath::ScanMultipleFilter__ExecuteFilter_d__2* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x181827f80, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181827f80, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x1818283e0, size 0xf0, virtual true, abstract: false, final true
...
/// @brief Method ExecuteFilter, addr 0x181825ab0, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ScanMultipleFilter) == 0x18, "Size mismatch!");
