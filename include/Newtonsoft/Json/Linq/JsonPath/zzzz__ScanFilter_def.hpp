...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ScanFilter*);
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::ScanFilter__ExecuteFilter_d__2*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ScanFilter*, "Newtonsoft.Json.Linq.JsonPath", "ScanFilter");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::ScanFilter__ExecuteFilter_d__2*, "Newtonsoft.Json.Linq.JsonPath", "ScanFilter/<ExecuteFilter>d__2");
...
/// @brief Method MoveNext, addr 0x181826c00, size 0x3a0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Newtonsoft::Json::Linq::JsonPath::ScanFilter__ExecuteFilter_d__2* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x181828160, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181828160, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x181828950, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ScanFilter__ExecuteFilter_d__2) == 0x58, "Size mismatch!");
...
/// @brief Method ExecuteFilter, addr 0x181825a40, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::ScanFilter) == 0x18, "Size mismatch!");
