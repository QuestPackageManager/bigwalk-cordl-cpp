...
/// @brief Method AddKey, addr 0x181806230, size 0x50, virtual false, abstract: false, final false
inline void AddKey(::StringW  key, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method ChangeItemKey, addr 0x181806280, size 0x1a0, virtual false, abstract: false, final false
inline void ChangeItemKey(::Newtonsoft::Json::Linq::JToken*  item, ::StringW  newKey) ;

/// @brief Method ClearItems, addr 0x181806420, size 0x30, virtual true, abstract: false, final false
inline void ClearItems() ;

/// @brief Method Compare, addr 0x181806450, size 0x250, virtual false, abstract: false, final false
inline bool Compare(::Newtonsoft::Json::Linq::JPropertyKeyedCollection*  other) ;

/// @brief Method Contains, addr 0x181806720, size 0x40, virtual false, abstract: false, final false
inline bool Contains(::StringW  key) ;

/// @brief Method ContainsItem, addr 0x1818066a0, size 0x80, virtual false, abstract: false, final false
inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method EnsureDictionary, addr 0x181806760, size 0x90, virtual false, abstract: false, final false
inline void EnsureDictionary() ;

/// @brief Method GetKeyForItem, addr 0x1818067f0, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetKeyForItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method IndexOfReference, addr 0x181806870, size 0x60, virtual false, abstract: false, final false
inline int32_t IndexOfReference(::Newtonsoft::Json::Linq::JToken*  t) ;

/// @brief Method InsertItem, addr 0x1818068d0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x181806a80, size 0x70, virtual false, abstract: false, final false
inline bool Remove(::StringW  key) ;

/// @brief Method RemoveItem, addr 0x181806980, size 0xe0, virtual true, abstract: false, final false
inline void RemoveItem(int32_t  index) ;

/// @brief Method RemoveKey, addr 0x181806a60, size 0x20, virtual false, abstract: false, final false
inline void RemoveKey(::StringW  key) ;

/// @brief Method SetItem, addr 0x181806af0, size 0x1c0, virtual true, abstract: false, final false
inline void SetItem(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method TryGetValue, addr 0x181806cb0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181806d50, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::IEqualityComparer_1<::StringW>* getStaticF_Comparer() ;

/// @brief Method get_Item, addr 0x181806da0, size 0x80, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* get_Item(::StringW  key) ;

/// @brief Method get_Keys, addr 0x181806e20, size 0x30, virtual false, abstract: false, final false
inline ::System::Collections::Generic::ICollection_1<::StringW>* get_Keys() ;

/// @brief Method get_Values, addr 0x181806e50, size 0x30, virtual false, abstract: false, final false
