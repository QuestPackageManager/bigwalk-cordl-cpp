...
/// @brief Method MoveNext, addr 0x1817fd490, size 0x4b0, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x1817fdf90, size 0x360, virtual true, abstract: false, final true
inline void MoveNext() ;
...
/// @brief Method Add, addr 0x1817e7860, size 0x20, virtual true, abstract: false, final true
inline void Add(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method Clear, addr 0x1817e7880, size 0x20, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method CloneToken, addr 0x1817e78a0, size 0x80, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* CloneToken(::Newtonsoft::Json::Linq::JsonCloneSettings*  settings) ;

/// @brief Method Contains, addr 0x1817e7920, size 0x20, virtual true, abstract: false, final true
inline bool Contains(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method CopyTo, addr 0x1817e7940, size 0x20, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::Newtonsoft::Json::Linq::JToken*>  array, int32_t  arrayIndex) ;

/// @brief Method DeepEquals, addr 0x1817e7960, size 0x40, virtual true, abstract: false, final false
inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken*  node) ;

/// @brief Method FromObject, addr 0x1817e79a0, size 0x110, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JArray* FromObject(::System::Object*  o) ;

/// @brief Method FromObject, addr 0x1817e7ab0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetEnumerator, addr 0x1817e7bc0, size 0x40, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x1817e7c20, size 0x20, virtual true, abstract: false, final true
inline int32_t IndexOf(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method IndexOfItem, addr 0x1817e7c00, size 0x20, virtual true, abstract: false, final false
inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method Insert, addr 0x1817e7c40, size 0x30, virtual true, abstract: false, final true
inline void Insert(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method Load, addr 0x1817e7ff0, size 0x10, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JArray* Load(::Newtonsoft::Json::JsonReader*  reader) ;

/// @brief Method Load, addr 0x1817e7e30, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method LoadAsync, addr 0x1817e7c70, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method LoadAsync, addr 0x1817e7d50, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method MergeItem, addr 0x1817e8000, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x1817e81e0, size 0x10, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JArray* Parse(::StringW  json) ;

/// @brief Method Parse, addr 0x1817e80c0, size 0x120, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JArray* Parse(::StringW  json, ::Newtonsoft::Json::Linq::JsonLoadSettings*  settings) ;

/// @brief Method Remove, addr 0x1817e8210, size 0x20, virtual true, abstract: false, final true
inline bool Remove(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method RemoveAt, addr 0x1817e81f0, size 0x20, virtual true, abstract: false, final true
inline void RemoveAt(int32_t  index) ;

/// @brief Method WriteTo, addr 0x1817e8330, size 0xe0, virtual true, abstract: false, final false
inline void WriteTo(::Newtonsoft::Json::JsonWriter*  writer, ::ArrayW<::Newtonsoft::Json::JsonConverter*>  converters) ;

/// @brief Method WriteToAsync, addr 0x1817e8230, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817e8410, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1817e8460, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::Object*>  content) ;

/// @brief Method .ctor, addr 0x1817e8460, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  content) ;

/// @brief Method .ctor, addr 0x1817e84e0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Linq::JArray*  other) ;

/// @brief Method .ctor, addr 0x1817e8550, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x1817e8680, size 0x20, virtual true, abstract: false, final true
inline ::Newtonsoft::Json::Linq::JToken* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x1817e85c0, size 0xc0, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* get_Item(::System::Object*  key) ;

/// @brief Method get_Type, addr 0x1802edfe0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_Item, addr 0x1817e86a0, size 0x20, virtual true, abstract: false, final true
inline void set_Item(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  value) ;

/// @brief Method set_Item, addr 0x1817e86c0, size 0xd0, virtual true, abstract: false, final false
