...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::ReferenceLoopHandling, "Newtonsoft.Json", "ReferenceLoopHandling");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::ReferenceLoopHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::ReferenceLoopHandling) == 0x4, "Size mismatch!");
