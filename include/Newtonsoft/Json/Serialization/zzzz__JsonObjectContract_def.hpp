...
/// @brief Method GetUninitializedObject, addr 0x1817d7770, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817d7820, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_CreatorParameters, addr 0x1817d7890, size 0x80, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_CreatorParameters() ;

/// @brief Method get_ExtensionDataGetter, addr 0x180371810, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ExtensionDataGetter* get_ExtensionDataGetter() ;

/// @brief Method get_ExtensionDataNameResolver, addr 0x180337100, size 0x10, virtual false, abstract: false, final false
inline ::System::Func_2<::StringW,::StringW>* get_ExtensionDataNameResolver() ;

/// @brief Method get_ExtensionDataSetter, addr 0x180474bf0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ExtensionDataSetter* get_ExtensionDataSetter() ;

/// @brief Method get_ExtensionDataValueType, addr 0x180337120, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_ExtensionDataValueType() ;

/// @brief Method get_HasRequiredOrDefaultValueProperties, addr 0x1817d7910, size 0x210, virtual false, abstract: false, final false
inline bool get_HasRequiredOrDefaultValueProperties() ;

/// @brief Method get_ItemNullValueHandling, addr 0x1817d7b20, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::NullValueHandling> get_ItemNullValueHandling() ;

/// @brief Method get_ItemRequired, addr 0x1817d7b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::Required> get_ItemRequired() ;

/// @brief Method get_MemberSerialization, addr 0x1813abaa0, size 0x20, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method get_MissingMemberHandling, addr 0x1817d7b40, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::MissingMemberHandling> get_MissingMemberHandling() ;

/// @brief Method get_OverrideCreator, addr 0x1803370c0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator() ;

/// @brief Method get_ParameterizedCreator, addr 0x1803370d0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator() ;

/// @brief Method get_Properties, addr 0x1803459d0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_Properties() ;

/// @brief Method set_ExtensionDataGetter, addr 0x180cbfd10, size 0x100, virtual false, abstract: false, final false
inline void set_ExtensionDataGetter(::Newtonsoft::Json::Serialization::ExtensionDataGetter*  value) ;

/// @brief Method set_ExtensionDataNameResolver, addr 0x1803371f0, size 0x20, virtual false, abstract: false, final false
inline void set_ExtensionDataNameResolver(::System::Func_2<::StringW,::StringW>*  value) ;

/// @brief Method set_ExtensionDataSetter, addr 0x180474ca0, size 0x20, virtual false, abstract: false, final false
inline void set_ExtensionDataSetter(::Newtonsoft::Json::Serialization::ExtensionDataSetter*  value) ;

/// @brief Method set_ExtensionDataValueType, addr 0x1817d7b50, size 0x90, virtual false, abstract: false, final false
inline void set_ExtensionDataValueType(::System::Type*  value) ;

/// @brief Method set_ItemNullValueHandling, addr 0x1817d7be0, size 0x10, virtual false, abstract: false, final false
inline void set_ItemNullValueHandling(::System::Nullable_1<::Newtonsoft::Json::NullValueHandling>  value) ;

/// @brief Method set_ItemRequired, addr 0x1817d7bf0, size 0x10, virtual false, abstract: false, final false
inline void set_ItemRequired(::System::Nullable_1<::Newtonsoft::Json::Required>  value) ;

/// @brief Method set_MemberSerialization, addr 0x1813f0070, size 0x10, virtual false, abstract: false, final false
inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization  value) ;

/// @brief Method set_MissingMemberHandling, addr 0x1817d7c00, size 0x10, virtual false, abstract: false, final false
inline void set_MissingMemberHandling(::System::Nullable_1<::Newtonsoft::Json::MissingMemberHandling>  value) ;

/// @brief Method set_OverrideCreator, addr 0x180337170, size 0x20, virtual false, abstract: false, final false
inline void set_OverrideCreator(::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>*  value) ;

/// @brief Method set_ParameterizedCreator, addr 0x180337190, size 0x20, virtual false, abstract: false, final false
...
/// @brief Size padding 0x128 - 0x120 = 0x8, packed as 0x8
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonObjectContract) == 0x128, "Size mismatch!");
