...
/// @brief Method <GetCreator>b__22_1, addr 0x1817fd940, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method <GetCreator>b__0, addr 0x1817fda90, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method CanTypeDescriptorConvertString, addr 0x1817f9770, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method CreateJsonConverterInstance, addr 0x1817f98c0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CreateNamingStrategyInstance, addr 0x1817f9980, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetAssociateMetadataTypeFromAttribute, addr 0x1817f9a40, size 0x1e0, virtual false, abstract: false, final false
static inline ::System::Type* GetAssociateMetadataTypeFromAttribute(::System::Type*  type) ;

/// @brief Method GetAssociatedMetadataType, addr 0x1817f9c20, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetContainerNamingStrategy, addr 0x1817f9c80, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetCreator, addr 0x1817f9da0, size 0x110, virtual false, abstract: false, final false
static inline ::System::Func_2<::ArrayW<::System::Object*>,::System::Object*>* GetCreator(::System::Type*  type) ;

/// @brief Method GetDataContractAttribute, addr 0x1817f9eb0, size 0x70, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::DataContractAttribute* GetDataContractAttribute(::System::Type*  type) ;

/// @brief Method GetDataMemberAttribute, addr 0x1817f9f20, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method GetJsonConverter, addr 0x1817fa120, size 0xd0, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::JsonConverter* GetJsonConverter(::System::Object*  attributeProvider) ;

/// @brief Method GetObjectMemberSerialization, addr 0x1817fa1f0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method IsNonSerializable, addr 0x1817fa300, size 0x40, virtual false, abstract: false, final false
static inline bool IsNonSerializable(::System::Object*  provider) ;

/// @brief Method IsSerializable, addr 0x1817fa340, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_DynamicCodeGeneration, addr 0x1817fa480, size 0x70, virtual false, abstract: false, final false
static inline bool get_DynamicCodeGeneration() ;

/// @brief Method get_FullyTrusted, addr 0x1817fa4f0, size 0xb0, virtual false, abstract: false, final false
static inline bool get_FullyTrusted() ;

/// @brief Method get_ReflectionDelegateFactory, addr 0x1817c5ce0, size 0x40, virtual false, abstract: false, final false
