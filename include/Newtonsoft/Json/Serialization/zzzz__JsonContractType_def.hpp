...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::JsonContractType, "Newtonsoft.Json.Serialization", "JsonContractType");
// Dependencies 
namespace Newtonsoft::Json::Serialization {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Serialization::JsonContractType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonContractType) == 0x4, "Size mismatch!");
