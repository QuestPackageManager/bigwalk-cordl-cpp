...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::ExtensionDataGetter*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::ExtensionDataGetter*, "Newtonsoft.Json.Serialization", "ExtensionDataGetter");
...
/// @brief Method .ctor, addr 0x1817d4490, size 0x130, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::ExtensionDataGetter) == 0x80, "Size mismatch!");
