...
// Write type traits
MARK_GEN_REF_T_PTR(::Newtonsoft::Json::Serialization::ObjectConstructor_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Newtonsoft::Json::Serialization::ObjectConstructor_1, "Newtonsoft.Json.Serialization", "ObjectConstructor`1");
