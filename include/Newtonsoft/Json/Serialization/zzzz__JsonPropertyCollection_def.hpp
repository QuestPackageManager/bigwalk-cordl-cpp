...
/// @brief Method AddProperty, addr 0x1817d7ef0, size 0x250, virtual false, abstract: false, final false
inline void AddProperty(::Newtonsoft::Json::Serialization::JsonProperty*  property) ;

/// @brief Method GetClosestMatchProperty, addr 0x1817d8140, size 0xc0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonProperty* GetClosestMatchProperty(::StringW  propertyName) ;

/// @brief Method GetKeyForItem, addr 0x1817d8200, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetKeyForItem(::Newtonsoft::Json::Serialization::JsonProperty*  item) ;

/// @brief Method GetProperty, addr 0x1817d8220, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method TryGetProperty, addr 0x1817d8380, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817d8450, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonPropertyCollection) == 0x40, "Size mismatch!");
