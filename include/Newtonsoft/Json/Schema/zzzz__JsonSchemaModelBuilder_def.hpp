...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Schema::JsonSchemaModelBuilder*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Schema::JsonSchemaModelBuilder*, "Newtonsoft.Json.Schema", "JsonSchemaModelBuilder");
...
/// @brief Field _nodeModels, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__nodeModels, put=__cordl_internal_set__nodeModels)) ::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Schema::JsonSchemaNode*,::Newtonsoft::Json::Schema::JsonSchemaModel*>*  _nodeModels;
...
/// @brief Method AddAdditionalItems, addr 0x1817ed760, size 0x40, virtual false, abstract: false, final false
inline void AddAdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaNode*  parentNode, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method AddAdditionalProperties, addr 0x1817ed7a0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method AddItem, addr 0x1817ed7e0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method AddProperties, addr 0x1817ed8c0, size 0x2e0, virtual false, abstract: false, final false
inline void AddProperties(::System::Collections::Generic::IDictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchema*>*  source, ::System::Collections::Generic::IDictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>*  target) ;

/// @brief Method AddProperty, addr 0x1817edba0, size 0x160, virtual false, abstract: false, final false
inline void AddProperty(::System::Collections::Generic::IDictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>*  target, ::StringW  propertyName, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method AddSchema, addr 0x1817edd00, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method Build, addr 0x1817ee700, size 0xb0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaModel* Build(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method BuildNodeModel, addr 0x1817ee2c0, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817ee7b0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Newtonsoft::Json::Schema::JsonSchemaModelBuilder) == 0x28, "Size mismatch!");
