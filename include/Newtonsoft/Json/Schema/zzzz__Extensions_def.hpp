...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Schema::Extensions*);
MARK_REF_T(::Newtonsoft::Json::Schema::Extensions___c__DisplayClass0_0*);
MARK_REF_T(::Newtonsoft::Json::Schema::Extensions___c__DisplayClass1_0*);
...
/// @brief Method <IsValid>b__0, addr 0x18159e620, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <IsValid>b__0, addr 0x1817fd9c0, size 0xd0, virtual false, abstract: false, final false
inline void _IsValid_b__0(::System::Object*  sender, ::Newtonsoft::Json::Schema::ValidationEventArgs*  args) ;
...
/// @brief Method IsValid, addr 0x1817e7530, size 0x80, virtual false, abstract: false, final false
static inline bool IsValid(::Newtonsoft::Json::Linq::JToken*  source, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method IsValid, addr 0x1817e7450, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Validate, addr 0x1817e77f0, size 0x10, virtual false, abstract: false, final false
static inline void Validate(::Newtonsoft::Json::Linq::JToken*  source, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method Validate, addr 0x1817e7680, size 0x170, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Newtonsoft::Json::Schema::Extensions) == 0x10, "Size mismatch!");
