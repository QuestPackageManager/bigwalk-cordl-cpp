...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Schema::JsonSchemaResolver*);
...
/// @brief Method <GetSchema>b__0, addr 0x1817fddf0, size 0x30, virtual false, abstract: false, final false
inline bool _GetSchema_b__0(::Newtonsoft::Json::Schema::JsonSchema*  s) ;

/// @brief Method <GetSchema>b__1, addr 0x1817fde20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetSchema, addr 0x1817ef250, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817ef320, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LoadedSchemas, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::JsonSchema*>* get_LoadedSchemas() ;

/// @brief Method set_LoadedSchemas, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Schema::JsonSchemaResolver) == 0x18, "Size mismatch!");
