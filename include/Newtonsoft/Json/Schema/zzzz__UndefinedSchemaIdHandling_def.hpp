...
static_assert(offsetof(::Newtonsoft::Json::Schema::UndefinedSchemaIdHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Schema::UndefinedSchemaIdHandling) == 0x4, "Size mismatch!");
