...
/// @brief Method get_ParentNode, addr 0x18182f530, size 0xc0, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Text, addr 0x18182f5f0, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XComment* get_Text() ;

/// @brief Method get_Value, addr 0x18182f640, size 0x60, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x18182f6a0, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Converters::XCommentWrapper) == 0x18, "Size mismatch!");
