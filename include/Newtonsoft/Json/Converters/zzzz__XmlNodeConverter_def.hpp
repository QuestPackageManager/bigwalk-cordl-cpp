...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Converters::XmlNodeConverter*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Converters::XmlNodeConverter*, "Newtonsoft.Json.Converters", "XmlNodeConverter");
...
/// @brief Field <DeserializeRootElementName>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__DeserializeRootElementName_k__BackingField, put=__cordl_internal_set__DeserializeRootElementName_k__BackingField)) ::StringW  _DeserializeRootElementName_k__BackingField;

/// @brief Field <EncodeSpecialCharacters>k__BackingField, offset 0x1a, size 0x1 
 __declspec(property(get=__cordl_internal_get__EncodeSpecialCharacters_k__BackingField, put=__cordl_internal_set__EncodeSpecialCharacters_k__BackingField)) bool  _EncodeSpecialCharacters_k__BackingField;
...
/// @brief Method AddAttribute, addr 0x181832030, size 0x1a0, virtual false, abstract: false, final false
static inline void AddAttribute(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode, ::StringW  propertyName, ::StringW  attributeName, ::System::Xml::XmlNamespaceManager*  manager, ::StringW  attributePrefix) ;

/// @brief Method AddJsonArrayAttribute, addr 0x1818321d0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method AllSameName, addr 0x181832360, size 0xf0, virtual false, abstract: false, final false
static inline bool AllSameName(::Newtonsoft::Json::Converters::IXmlNode*  node) ;

/// @brief Method CanConvert, addr 0x181832450, size 0x80, virtual true, abstract: false, final false
inline bool CanConvert(::System::Type*  valueType) ;

/// @brief Method ConvertTokenToXmlValue, addr 0x1818324d0, size 0x4d0, virtual false, abstract: false, final false
static inline ::StringW ConvertTokenToXmlValue(::Newtonsoft::Json::JsonReader*  reader) ;

/// @brief Method CreateDocumentType, addr 0x1818329a0, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method CreateElement, addr 0x181833020, size 0xf0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlElement* CreateElement(::StringW  elementName, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::StringW  elementPrefix, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method CreateElement, addr 0x181832c90, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method CreateInstruction, addr 0x181833110, size 0x2c0, virtual false, abstract: false, final false
inline void CreateInstruction(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode, ::StringW  propertyName) ;

/// @brief Method DeserializeNode, addr 0x1818333d0, size 0xc90, virtual false, abstract: false, final false
inline void DeserializeNode(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::System::Xml::XmlNamespaceManager*  manager, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode) ;

/// @brief Method DeserializeValue, addr 0x181834060, size 0x240, virtual false, abstract: false, final false
inline void DeserializeValue(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::System::Xml::XmlNamespaceManager*  manager, ::StringW  propertyName, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode) ;

/// @brief Method GetPropertyName, addr 0x1818342a0, size 0x2e0, virtual false, abstract: false, final false
inline ::StringW GetPropertyName(::Newtonsoft::Json::Converters::IXmlNode*  node, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method IsArray, addr 0x181834580, size 0x110, virtual false, abstract: false, final false
inline bool IsArray(::Newtonsoft::Json::Converters::IXmlNode*  node) ;

/// @brief Method IsNamespaceAttribute, addr 0x181834690, size 0xe0, virtual false, abstract: false, final false
inline bool IsNamespaceAttribute(::StringW  attributeName, ::by_ref<::StringW>  prefix) ;

/// @brief Method IsXObject, addr 0x181834770, size 0x50, virtual false, abstract: false, final false
inline bool IsXObject(::System::Type*  valueType) ;

/// @brief Method IsXmlNode, addr 0x1818347c0, size 0x50, virtual false, abstract: false, final false
inline bool IsXmlNode(::System::Type*  valueType) ;

static inline ::Newtonsoft::Json::Converters::XmlNodeConverter* New_ctor() ;

/// @brief Method PushParentNamespaces, addr 0x181834810, size 0x3e0, virtual false, abstract: false, final false
inline void PushParentNamespaces(::Newtonsoft::Json::Converters::IXmlNode*  node, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method ReadArrayElements, addr 0x181834bf0, size 0x200, virtual false, abstract: false, final false
inline void ReadArrayElements(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::StringW  propertyName, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method ReadAttributeElements, addr 0x181834df0, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method ReadElement, addr 0x181835370, size 0x370, virtual false, abstract: false, final false
inline void ReadElement(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Converters::IXmlDocument*  document, ::Newtonsoft::Json::Converters::IXmlNode*  currentNode, ::StringW  propertyName, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method ReadJson, addr 0x1818356e0, size 0x500, virtual true, abstract: false, final false
inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader*  reader, ::System::Type*  objectType, ::System::Object*  existingValue, ::Newtonsoft::Json::JsonSerializer*  serializer) ;

/// @brief Method ResolveFullName, addr 0x181835be0, size 0x140, virtual false, abstract: false, final false
inline ::StringW ResolveFullName(::Newtonsoft::Json::Converters::IXmlNode*  node, ::System::Xml::XmlNamespaceManager*  manager) ;

/// @brief Method SerializeGroupedNodes, addr 0x181835d20, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method SerializeNode, addr 0x1818362e0, size 0xd70, virtual false, abstract: false, final false
...
/// @brief Method ShouldReadInto, addr 0x181837050, size 0x90, virtual false, abstract: false, final false
inline bool ShouldReadInto(::Newtonsoft::Json::JsonReader*  reader) ;

/// @brief Method ValueAttributes, addr 0x1818370e0, size 0x100, virtual false, abstract: false, final false
inline bool ValueAttributes(::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>*  c) ;

/// @brief Method WrapXml, addr 0x1818371e0, size 0xa0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* WrapXml(::System::Object*  value) ;

/// @brief Method WriteGroupedNodes, addr 0x181837280, size 0x140, virtual false, abstract: false, final false
inline void WriteGroupedNodes(::Newtonsoft::Json::JsonWriter*  writer, ::System::Xml::XmlNamespaceManager*  manager, bool  writePropertyName, ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>*  groupedNodes, ::StringW  elementNames) ;

/// @brief Method WriteGroupedNodes, addr 0x1818373c0, size 0xf0, virtual false, abstract: false, final false
inline void WriteGroupedNodes(::Newtonsoft::Json::JsonWriter*  writer, ::System::Xml::XmlNamespaceManager*  manager, bool  writePropertyName, ::Newtonsoft::Json::Converters::IXmlNode*  node, ::StringW  elementNames) ;

/// @brief Method WriteJson, addr 0x1818374b0, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method get_DeserializeRootElementName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_DeserializeRootElementName() ;

/// @brief Method get_EncodeSpecialCharacters, addr 0x1805c5560, size 0x10, virtual false, abstract: false, final false
inline bool get_EncodeSpecialCharacters() ;

/// @brief Method get_OmitRootObject, addr 0x1814f8710, size 0x10, virtual false, abstract: false, final false
inline bool get_OmitRootObject() ;

/// @brief Method get_WriteArrayAttribute, addr 0x18037a0f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DeserializeRootElementName, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_DeserializeRootElementName(::StringW  value) ;

/// @brief Method set_EncodeSpecialCharacters, addr 0x1805c55e0, size 0x10, virtual false, abstract: false, final false
inline void set_EncodeSpecialCharacters(bool  value) ;

/// @brief Method set_OmitRootObject, addr 0x1818376c0, size 0x10, virtual false, abstract: false, final false
inline void set_OmitRootObject(bool  value) ;

/// @brief Method set_WriteArrayAttribute, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Converters::XmlNodeConverter) == 0x20, "Size mismatch!");
