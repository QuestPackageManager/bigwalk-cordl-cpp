...
/// @brief Method AppendChild, addr 0x181830990, size 0x40, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* AppendChild(::Newtonsoft::Json::Converters::IXmlNode*  newChild) ;

/// @brief Method GetPrefixOfNamespace, addr 0x1818309d0, size 0x80, virtual true, abstract: false, final true
inline ::StringW GetPrefixOfNamespace(::StringW  namespaceUri) ;

/// @brief Method HasImplicitNamespaceAttribute, addr 0x181830a50, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method SetAttributeNode, addr 0x181830d10, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method get_Attributes, addr 0x181830dd0, size 0x3f0, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes() ;

/// @brief Method get_Element, addr 0x1818311c0, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XElement* get_Element() ;

/// @brief Method get_IsEmpty, addr 0x181831210, size 0x60, virtual true, abstract: false, final true
inline bool get_IsEmpty() ;

/// @brief Method get_LocalName, addr 0x181831270, size 0x60, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x1818312d0, size 0x60, virtual true, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_Value, addr 0x181831330, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method set_Value, addr 0x181831390, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Converters::XElementWrapper) == 0x28, "Size mismatch!");
