...
/// @brief Method get_ParentNode, addr 0x181831600, size 0xc0, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Text, addr 0x1818316c0, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XText* get_Text() ;

/// @brief Method get_Value, addr 0x181831710, size 0x60, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x181831770, size 0x80, virtual true, abstract: false, final false
