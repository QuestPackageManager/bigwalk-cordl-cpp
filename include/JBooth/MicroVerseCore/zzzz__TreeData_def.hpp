...
// Write type traits
MARK_REF_T(::JBooth::MicroVerseCore::TreeData*);
DEFINE_IL2CPP_CLASS(::JBooth::MicroVerseCore::TreeData*, "JBooth.MicroVerseCore", "TreeData");
// Dependencies JBooth.MicroVerseCore.StampData
namespace JBooth::MicroVerseCore {
// Is value type: false
// CS Name: JBooth.MicroVerseCore.TreeData
class CORDL_TYPE TreeData : public ::JBooth::MicroVerseCore::StampData {
public:
// Declarations
...
/// @brief Field treeClearMap, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_treeClearMap, put=__cordl_internal_set_treeClearMap)) ::UnityW<::UnityEngine::RenderTexture>  treeClearMap;

static inline ::JBooth::MicroVerseCore::TreeData* New_ctor(::UnityEngine::Terrain*  terrain, ::UnityEngine::RenderTexture*  height, ::UnityEngine::RenderTexture*  normal, ::UnityEngine::RenderTexture*  curve, ::UnityEngine::RenderTexture*  flow, ::UnityEngine::RenderTexture*  clearMap, ::JBooth::MicroVerseCore::MicroVerse_DataCache*  dataCache) ;
...
constexpr ::UnityW<::UnityEngine::RenderTexture> const& __cordl_internal_get_treeClearMap() const;

constexpr ::UnityW<::UnityEngine::RenderTexture>& __cordl_internal_get_treeClearMap() ;
...
constexpr void __cordl_internal_set_treeClearMap(::UnityW<::UnityEngine::RenderTexture>  value) ;
...
// Ctor Parameters [CppParam { name: "", ty: "TreeData", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
TreeData(TreeData && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "TreeData", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
TreeData(TreeData const& ) = delete;
...
/// @brief Field treeClearMap, offset: 0x38, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ___treeClearMap;
...
static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___heightMap) == 0x18, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___normalMap) == 0x20, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___curveMap) == 0x28, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___flowMap) == 0x30, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___treeClearMap) == 0x38, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___dataCache) == 0x40, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::TreeData, ___layerIndex) == 0x48, "Offset mismatch!");

static_assert(sizeof(::JBooth::MicroVerseCore::TreeData) == 0x50, "Size mismatch!");
