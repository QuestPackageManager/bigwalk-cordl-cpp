...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(ReadOnlyAsyncReactiveProperty_1)
...
namespace Cysharp::Threading::Tasks {
template<typename T>
class ReadOnlyAsyncReactiveProperty_1_Enumerator;
}
namespace Cysharp::Threading::Tasks {
template<typename T>
class ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource;
}
namespace Cysharp::Threading::Tasks {
template<typename T>
class ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable;
}
namespace Cysharp::Threading::Tasks {
template<typename T>
...
namespace Cysharp::Threading::Tasks {
template<typename T>
class WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c;
}
...
// Write type traits
MARK_GEN_REF_T_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1);
MARK_GEN_REF_T_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_Enumerator);
MARK_GEN_REF_T_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource);
MARK_GEN_REF_T_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable);
MARK_GEN_REF_T_PTR(::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c);
MARK_GEN_VAL_T(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1__ConsumeEnumerator_d__7);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_Enumerator, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1/Enumerator");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1/WaitAsyncSource");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1/WithoutCurrentEnumerable");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1/WaitAsyncSource/<>c");
DEFINE_IL2CPP_GEN_CLASS(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1__ConsumeEnumerator_d__7, "Cysharp.Threading.Tasks", "ReadOnlyAsyncReactiveProperty`1/<ConsumeEnumerator>d__7");
// Dependencies System.Object
namespace Cysharp::Threading::Tasks {
// cpp template
template<typename T>
// Is value type: false
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1/WaitAsyncSource/<>c<T>
class CORDL_TYPE WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c : public ::System::Object {
public:
// Declarations
/// @brief Field <>9, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9, put=setStaticF___9)) ::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c<T>*  __9;

static inline ::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c<T>* New_ctor() ;
...
static inline ::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c<T>* getStaticF___9() ;

static inline void setStaticF___9(::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c<T>*  value) ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c(WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c(WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c const& ) = delete;
...
template<typename T>
// Is value type: false
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1/WaitAsyncSource<T>
class CORDL_TYPE ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource : public ::System::Object {
public:
// Declarations
using __c = ::Cysharp::Threading::Tasks::WaitAsyncSource_ReadOnlyAsyncReactiveProperty_1___c<T>;

 __declspec(property(get=Cysharp_Threading_Tasks_ITaskPoolNode_Cysharp_Threading_Tasks_ReadOnlyAsyncReactiveProperty_T__WaitAsyncSource__get_NextNode)) ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*  Cysharp_Threading_Tasks_ITaskPoolNode_Cysharp_Threading_Tasks_ReadOnlyAsyncReactiveProperty_T__WaitAsyncSource__NextNode;
...
/// @brief Field nextNode, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_nextNode, put=__cordl_internal_set_nextNode)) ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*  nextNode;

/// @brief Field parent, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_parent, put=__cordl_internal_set_parent)) ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent;

/// @brief Field pool, offset 0xffffffff, size 0x10 
 __declspec(property(get=getStaticF_pool, put=setStaticF_pool)) ::Cysharp::Threading::Tasks::TaskPool_1<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*>  pool;
...
constexpr operator  ::Cysharp::Threading::Tasks::ITaskPoolNode_1<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*>*() noexcept;
...
static inline ::Cysharp::Threading::Tasks::IUniTaskSource_1<T>* Create(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent, ::System::Threading::CancellationToken  cancellationToken, ::by_ref<int16_t>  token) ;

/// @brief Method Cysharp.Threading.Tasks.ITaskPoolNode<Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty<T>.WaitAsyncSource>.get_NextNode, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline ::by_ref<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*> Cysharp_Threading_Tasks_ITaskPoolNode_Cysharp_Threading_Tasks_ReadOnlyAsyncReactiveProperty_T__WaitAsyncSource__get_NextNode() ;
...
static inline ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>* New_ctor() ;
...
constexpr ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>* const& __cordl_internal_get_nextNode() const;

constexpr ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*& __cordl_internal_get_nextNode() ;

constexpr ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>* const& __cordl_internal_get_parent() const;

constexpr ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*& __cordl_internal_get_parent() ;
...
constexpr void __cordl_internal_set_nextNode(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*  value) ;

constexpr void __cordl_internal_set_parent(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  value) ;
...
static inline ::Cysharp::Threading::Tasks::TaskPool_1<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*> getStaticF_pool() ;
...
constexpr ::Cysharp::Threading::Tasks::ITaskPoolNode_1<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*>* i___Cysharp__Threading__Tasks__ITaskPoolNode_1___Cysharp__Threading__Tasks__ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource_T___() noexcept;
...
static inline void setStaticF_pool(::Cysharp::Threading::Tasks::TaskPool_1<::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*>  value) ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource(ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource(ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource const& ) = delete;

/// @brief IL2CPP Metadata Type Index
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{14170};

/// @brief Field nextNode, offset: 0x10, size: 0x8, def value: None
 ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>*  ___nextNode;

/// @brief Field parent, offset: 0x18, size: 0x8, def value: None
 ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  ___parent;
...
template<typename T>
// Is value type: false
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1/WithoutCurrentEnumerable<T>
class CORDL_TYPE ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable : public ::System::Object {
public:
// Declarations
...
static inline ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable<T>* New_ctor(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent) ;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable(ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable(ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable const& ) = delete;
...
template<typename T>
// Is value type: false
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1/Enumerator<T>
class CORDL_TYPE ReadOnlyAsyncReactiveProperty_1_Enumerator : public ::Cysharp::Threading::Tasks::MoveNextSource {
public:
// Declarations
...
static inline ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_Enumerator<T>* New_ctor(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent, ::System::Threading::CancellationToken  cancellationToken, bool  publishCurrentValue) ;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  parent, ::System::Threading::CancellationToken  cancellationToken, bool  publishCurrentValue) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ReadOnlyAsyncReactiveProperty_1_Enumerator() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_Enumerator", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ReadOnlyAsyncReactiveProperty_1_Enumerator(ReadOnlyAsyncReactiveProperty_1_Enumerator && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1_Enumerator", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ReadOnlyAsyncReactiveProperty_1_Enumerator(ReadOnlyAsyncReactiveProperty_1_Enumerator const& ) = delete;
...
template<typename T>
// Is value type: true
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1/<ConsumeEnumerator>d__7<T>
struct CORDL_TYPE ReadOnlyAsyncReactiveProperty_1__ConsumeEnumerator_d__7 {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ReadOnlyAsyncReactiveProperty_1__ConsumeEnumerator_d__7() ;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*", modifiers: "", def_value: None }, CppParam { name: "source", ty: "::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__7__wrap1", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::Cysharp::Threading::Tasks::UniTask_1_Awaiter<bool>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::Cysharp::Threading::Tasks::UniTask_Awaiter", modifiers: "", def_value: None }]
...
/// @brief Field <>4__this, offset: 0x10, size: 0x8, def value: None
 ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  __4__this;
...
template<typename T>
// Is value type: false
// CS Name: Cysharp.Threading.Tasks.ReadOnlyAsyncReactiveProperty`1<T>
class CORDL_TYPE ReadOnlyAsyncReactiveProperty_1 : public ::System::Object {
public:
// Declarations
using Enumerator = ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_Enumerator<T>;

using WaitAsyncSource = ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WaitAsyncSource<T>;

using WithoutCurrentEnumerable = ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1_WithoutCurrentEnumerable<T>;

using _ConsumeEnumerator_d__7 = ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1__ConsumeEnumerator_d__7<T>;

 __declspec(property(get=get_Value)) T  Value;

/// @brief Field enumerator, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_enumerator, put=__cordl_internal_set_enumerator)) ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerator_1<T>*  enumerator;
...
inline ::Cysharp::Threading::Tasks::UniTaskVoid ConsumeEnumerator(::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*  source, ::System::Threading::CancellationToken  cancellationToken) ;
...
static inline ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>* New_ctor(T  initialValue, ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*  source, ::System::Threading::CancellationToken  cancellationToken) ;

static inline ::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>* New_ctor(::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*  source, ::System::Threading::CancellationToken  cancellationToken) ;
...
constexpr ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerator_1<T>* const& __cordl_internal_get_enumerator() const;

constexpr ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerator_1<T>*& __cordl_internal_get_enumerator() ;
...
constexpr void __cordl_internal_set_enumerator(::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerator_1<T>*  value) ;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(T  initialValue, ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*  source, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerable_1<T>*  source, ::System::Threading::CancellationToken  cancellationToken) ;
...
static inline T op_Implicit_T(::Cysharp::Threading::Tasks::ReadOnlyAsyncReactiveProperty_1<T>*  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ReadOnlyAsyncReactiveProperty_1() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ReadOnlyAsyncReactiveProperty_1(ReadOnlyAsyncReactiveProperty_1 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ReadOnlyAsyncReactiveProperty_1", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ReadOnlyAsyncReactiveProperty_1(ReadOnlyAsyncReactiveProperty_1 const& ) = delete;
...
/// @brief Field enumerator, offset: 0x30, size: 0x8, def value: None
 ::Cysharp::Threading::Tasks::IUniTaskAsyncEnumerator_1<T>*  ___enumerator;
