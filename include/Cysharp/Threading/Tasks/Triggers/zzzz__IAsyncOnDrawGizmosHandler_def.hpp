...
public:
// Declarations
/// @brief Method OnDrawGizmosAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnDrawGizmosAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnDrawGizmosHandler", modifiers: "const&", def_value: None }]
