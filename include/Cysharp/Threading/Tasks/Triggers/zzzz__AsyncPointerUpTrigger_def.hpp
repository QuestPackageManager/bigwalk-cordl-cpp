...
/// @brief Method GetOnPointerUpAsyncHandler, addr 0x181e751b0, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnPointerUpHandler* GetOnPointerUpAsyncHandler() ;

/// @brief Method GetOnPointerUpAsyncHandler, addr 0x181e75150, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnPointerUpAsync, addr 0x181e79520, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::EventSystems::PointerEventData*> OnPointerUpAsync() ;

/// @brief Method OnPointerUpAsync, addr 0x181e794a0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.EventSystems.IPointerUpHandler.OnPointerUp, addr 0x181e752d0, size 0x10, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncPointerUpTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncPointerUpTrigger(AsyncPointerUpTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncPointerUpTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncPointerUpTrigger) == 0x40, "Size mismatch!");
