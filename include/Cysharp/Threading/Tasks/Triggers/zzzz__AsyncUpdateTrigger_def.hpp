...
public:
// Declarations
/// @brief Method GetUpdateAsyncHandler, addr 0x181e746e0, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncUpdateHandler* GetUpdateAsyncHandler() ;

/// @brief Method GetUpdateAsyncHandler, addr 0x181e74720, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x181e74860, size 0x20, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateAsync, addr 0x181e7c480, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask UpdateAsync() ;

/// @brief Method UpdateAsync, addr 0x181e7c4e0, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncUpdateTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncUpdateTrigger(AsyncUpdateTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncUpdateTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncUpdateTrigger) == 0x40, "Size mismatch!");
