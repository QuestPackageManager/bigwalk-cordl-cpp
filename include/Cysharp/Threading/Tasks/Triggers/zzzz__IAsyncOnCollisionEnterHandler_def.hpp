...
public:
// Declarations
/// @brief Method OnCollisionEnterAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::Collision*> OnCollisionEnterAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnCollisionEnterHandler", modifiers: "const&", def_value: None }]
