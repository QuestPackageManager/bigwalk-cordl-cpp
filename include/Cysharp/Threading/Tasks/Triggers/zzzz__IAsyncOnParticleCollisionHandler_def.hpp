...
public:
// Declarations
/// @brief Method OnParticleCollisionAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityW<::UnityEngine::GameObject>> OnParticleCollisionAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnParticleCollisionHandler", modifiers: "const&", def_value: None }]
