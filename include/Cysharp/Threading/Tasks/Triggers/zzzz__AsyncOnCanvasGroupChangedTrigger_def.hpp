...
public:
// Declarations
/// @brief Method GetOnCanvasGroupChangedAsyncHandler, addr 0x181e746e0, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnCanvasGroupChangedHandler* GetOnCanvasGroupChangedAsyncHandler() ;

/// @brief Method GetOnCanvasGroupChangedAsyncHandler, addr 0x181e74720, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnCanvasGroupChanged, addr 0x181e74860, size 0x20, virtual false, abstract: false, final false
inline void OnCanvasGroupChanged() ;

/// @brief Method OnCanvasGroupChangedAsync, addr 0x181e783f0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnCanvasGroupChangedAsync() ;

/// @brief Method OnCanvasGroupChangedAsync, addr 0x181e78370, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncOnCanvasGroupChangedTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncOnCanvasGroupChangedTrigger(AsyncOnCanvasGroupChangedTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncOnCanvasGroupChangedTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncOnCanvasGroupChangedTrigger) == 0x40, "Size mismatch!");
