...
public:
// Declarations
/// @brief Method OnAnimatorMoveAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnAnimatorMoveAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnAnimatorMoveHandler", modifiers: "const&", def_value: None }]
