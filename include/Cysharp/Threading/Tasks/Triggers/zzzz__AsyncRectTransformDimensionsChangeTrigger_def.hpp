...
public:
// Declarations
/// @brief Method GetOnRectTransformDimensionsChangeAsyncHandler, addr 0x181e746e0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetOnRectTransformDimensionsChangeAsyncHandler, addr 0x181e74720, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnRectTransformDimensionsChange, addr 0x181e74860, size 0x20, virtual false, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnRectTransformDimensionsChangeAsync, addr 0x181e79820, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnRectTransformDimensionsChangeAsync() ;

/// @brief Method OnRectTransformDimensionsChangeAsync, addr 0x181e79880, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncRectTransformDimensionsChangeTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncRectTransformDimensionsChangeTrigger(AsyncRectTransformDimensionsChangeTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncRectTransformDimensionsChangeTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncRectTransformDimensionsChangeTrigger) == 0x40, "Size mismatch!");
