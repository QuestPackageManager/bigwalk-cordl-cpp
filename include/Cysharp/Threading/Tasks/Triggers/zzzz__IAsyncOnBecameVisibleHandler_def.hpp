...
public:
// Declarations
/// @brief Method OnBecameVisibleAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnBecameVisibleAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnBecameVisibleHandler", modifiers: "const&", def_value: None }]
