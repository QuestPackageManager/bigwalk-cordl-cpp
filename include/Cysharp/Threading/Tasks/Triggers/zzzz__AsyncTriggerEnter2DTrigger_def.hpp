...
public:
// Declarations
/// @brief Method GetOnTriggerEnter2DAsyncHandler, addr 0x181e7a450, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnTriggerEnter2DHandler* GetOnTriggerEnter2DAsyncHandler() ;

/// @brief Method GetOnTriggerEnter2DAsyncHandler, addr 0x181e7a3f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnTriggerEnter2D, addr 0x181e7a570, size 0x10, virtual false, abstract: false, final false
inline void OnTriggerEnter2D(::UnityEngine::Collider2D*  other) ;

/// @brief Method OnTriggerEnter2DAsync, addr 0x181e7a510, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityW<::UnityEngine::Collider2D>> OnTriggerEnter2DAsync() ;

/// @brief Method OnTriggerEnter2DAsync, addr 0x181e7a490, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncTriggerEnter2DTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncTriggerEnter2DTrigger(AsyncTriggerEnter2DTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncTriggerEnter2DTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncTriggerEnter2DTrigger) == 0x40, "Size mismatch!");
