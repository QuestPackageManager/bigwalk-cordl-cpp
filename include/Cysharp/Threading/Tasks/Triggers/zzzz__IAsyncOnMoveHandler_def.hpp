...
public:
// Declarations
/// @brief Method OnMoveAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::EventSystems::AxisEventData*> OnMoveAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnMoveHandler", modifiers: "const&", def_value: None }]
