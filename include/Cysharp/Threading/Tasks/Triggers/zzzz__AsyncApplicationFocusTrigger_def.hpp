...
public:
// Declarations
/// @brief Method GetOnApplicationFocusAsyncHandler, addr 0x181e74880, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnApplicationFocusHandler* GetOnApplicationFocusAsyncHandler() ;

/// @brief Method GetOnApplicationFocusAsyncHandler, addr 0x181e748c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationFocus, addr 0x181e74a00, size 0x10, virtual false, abstract: false, final false
inline void OnApplicationFocus(bool  hasFocus) ;

/// @brief Method OnApplicationFocusAsync, addr 0x181e749a0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<bool> OnApplicationFocusAsync() ;

/// @brief Method OnApplicationFocusAsync, addr 0x181e74920, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncApplicationFocusTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncApplicationFocusTrigger(AsyncApplicationFocusTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncApplicationFocusTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncApplicationFocusTrigger) == 0x40, "Size mismatch!");
