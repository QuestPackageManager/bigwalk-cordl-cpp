...
CORDL_MODULE_EXPORT(ModerationSilenceConfirmMenu)
...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModerationSilenceConfirmMenu*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModerationSilenceConfirmMenu*, "", "ModerationSilenceConfirmMenu");
// Dependencies UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
// CS Name: ModerationSilenceConfirmMenu
class CORDL_TYPE ModerationSilenceConfirmMenu : public ::UnityEngine::MonoBehaviour {
public:
// Declarations
...
/// @brief Method ActionSilence, addr 0x180438b40, size 0x1c0, virtual false, abstract: false, final false
inline void ActionSilence() ;

/// @brief Method GoBack, addr 0x180437000, size 0x70, virtual false, abstract: false, final false
inline void GoBack() ;

static inline ::GlobalNamespace::ModerationSilenceConfirmMenu* New_ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ModerationSilenceConfirmMenu() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ModerationSilenceConfirmMenu", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ModerationSilenceConfirmMenu(ModerationSilenceConfirmMenu && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ModerationSilenceConfirmMenu", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ModerationSilenceConfirmMenu(ModerationSilenceConfirmMenu const& ) = delete;
...
static_assert(offsetof(::GlobalNamespace::ModerationSilenceConfirmMenu, ___candidatePlayer) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ModerationSilenceConfirmMenu, ___playerNameText) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ModerationSilenceConfirmMenu, ___encounteredGroup) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ModerationSilenceConfirmMenu, ___unencounteredGroup) == 0x38, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::ModerationSilenceConfirmMenu) == 0x40, "Size mismatch!");
