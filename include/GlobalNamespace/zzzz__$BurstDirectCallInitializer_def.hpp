...
CORDL_MODULE_EXPORT($BurstDirectCallInitializer)
// Forward declare root types
namespace GlobalNamespace {
class $BurstDirectCallInitializer;
}
// Write type traits
MARK_REF_T(::GlobalNamespace::$BurstDirectCallInitializer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::$BurstDirectCallInitializer*, "", "$BurstDirectCallInitializer");
...
public:
// Declarations
/// @brief Method Initialize, addr 0x1804a6180, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::$BurstDirectCallInitializer) == 0x10, "Size mismatch!");
