...
// Ctor Parameters [CppParam { name: "FilePathsData", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "TypesData", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "TotalTypes", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "TotalFiles", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "IsEditorOnly", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method Get, addr 0x181ebcfc0, size 0xb0, virtual false, abstract: false, final false
