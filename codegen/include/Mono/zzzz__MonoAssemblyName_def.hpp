...
static_assert(sizeof(::Mono::MonoAssemblyName__public_key_token_e__FixedBuffer) == 0x11, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "name", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "culture", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "hash_value", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "public_key", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "public_key_token", ty: "::Mono::MonoAssemblyName__public_key_token_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "hash_alg", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "hash_len", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "major", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "minor", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "build", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "revision", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "arch", ty: "uint16_t", modifiers: "", def_value: None }]
constexpr MonoAssemblyName(::System::IntPtr  name, ::System::IntPtr  culture, ::System::IntPtr  hash_value, ::System::IntPtr  public_key, ::Mono::MonoAssemblyName__public_key_token_e__FixedBuffer  public_key_token, uint32_t  hash_alg, uint32_t  hash_len, uint32_t  flags, uint16_t  major, uint16_t  minor, uint16_t  build, uint16_t  revision, uint16_t  arch) noexcept;
