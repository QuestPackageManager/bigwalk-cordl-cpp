...
public:
// Declarations
/// @brief Method ConvertProtocolVersion, addr 0x181b508d0, size 0x30, virtual false, abstract: false, final false
static inline ::Mono::Security::Interface::TlsProtocols ConvertProtocolVersion(::Mono::Unity::UnityTls_unitytls_protocol  protocol) ;

/// @brief Method GetMaxProtocol, addr 0x181b50900, size 0x40, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_protocol GetMaxProtocol(::System::Security::Authentication::SslProtocols  protocols) ;

/// @brief Method GetMinProtocol, addr 0x181b50940, size 0x40, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_protocol GetMinProtocol(::System::Security::Authentication::SslProtocols  protocols) ;

/// @brief Method VerifyResultToAlertDescription, addr 0x181b50980, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method VerifyResultToChainStatus, addr 0x181b509e0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method VerifyResultToPolicyErrror, addr 0x181b50a20, size 0x30, virtual false, abstract: false, final false
