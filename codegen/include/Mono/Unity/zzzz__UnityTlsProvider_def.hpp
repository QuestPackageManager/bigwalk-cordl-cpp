...
/// @brief Method CreateSslStream, addr 0x181b50a50, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method ValidateCertificate, addr 0x181b50c20, size 0x8d0, virtual true, abstract: false, final false
...
/// @brief Method get_ID, addr 0x181b514f0, size 0x40, virtual true, abstract: false, final false
inline ::System::Guid get_ID() ;

/// @brief Method get_Name, addr 0x181b51530, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method x509verify_callback, addr 0x181b51540, size 0x80, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_x509verify_result x509verify_callback(void*  userData, ::Mono::Unity::UnityTls_unitytls_x509_ref  cert, ::Mono::Unity::UnityTls_unitytls_x509verify_result  result, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;
