...
// Write type traits
MARK_REF_T(::Mono::Unity::UnityTlsStream*);
DEFINE_IL2CPP_CLASS(::Mono::Unity::UnityTlsStream*, "Mono.Unity", "UnityTlsStream");
...
public:
// Declarations
/// @brief Method CreateContext, addr 0x181b515c0, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::Unity::UnityTlsStream) == 0xb0, "Size mismatch!");
