...
/// @brief Method CertificateCallback, addr 0x181b4e260, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method CertificateCallback, addr 0x181b4e570, size 0xf0, virtual false, abstract: false, final false
static inline void CertificateCallback(void*  userData, ::Mono::Unity::UnityTls_unitytls_tlsctx*  ctx, uint8_t*  cn, ::System::IntPtr  cnLen, ::Mono::Unity::UnityTls_unitytls_x509name*  caList, ::System::IntPtr  caListLen, ::Mono::Unity::UnityTls_unitytls_x509list_ref*  chain, ::Mono::Unity::UnityTls_unitytls_key_ref*  key, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;

/// @brief Method Dispose, addr 0x181b4e660, size 0x100, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x181b4e760, size 0x260, virtual false, abstract: false, final false
static inline void ExtractNativeKeyAndChainFromManagedCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate*  cert, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState, ::by_ref<::Mono::Unity::UnityTls_unitytls_x509list*>  nativeCertChain, ::by_ref<::Mono::Unity::UnityTls_unitytls_key*>  nativeKey) ;

/// @brief Method FinishHandshake, addr 0x181b4e9c0, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method PendingRenegotiation, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool PendingRenegotiation() ;

/// @brief Method ProcessHandshake, addr 0x181b4eb10, size 0x2d0, virtual true, abstract: false, final false
inline bool ProcessHandshake() ;

/// @brief Method Read, addr 0x181b4f0f0, size 0x190, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Read(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadCallback, addr 0x181b4eed0, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method ReadCallback, addr 0x181b4ede0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method Shutdown, addr 0x181b4f280, size 0x140, virtual true, abstract: false, final false
inline void Shutdown() ;

/// @brief Method StartHandshake, addr 0x181b4f3c0, size 0x2b0, virtual true, abstract: false, final false
inline void StartHandshake() ;

/// @brief Method VerifyCallback, addr 0x181b4f670, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method VerifyCallback, addr 0x181b4f900, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x181b4fc30, size 0x180, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Write(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteCallback, addr 0x181b4f9d0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method WriteCallback, addr 0x181b4fb40, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b4fdb0, size 0xb20, virtual false, abstract: false, final false
...
/// @brief Method get_IsAuthenticated, addr 0x1803b2c80, size 0x10, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_LocalClientCertificate, addr 0x180312ea0, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate() ;

/// @brief Method get_RemoteCertificate, addr 0x1802ec4b0, size 0x10, virtual true, abstract: false, final false
