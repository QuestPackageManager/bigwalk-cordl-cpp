...
// Write type traits
MARK_REF_T(::Mono::DependencyInjector*);
DEFINE_IL2CPP_CLASS(::Mono::DependencyInjector*, "Mono", "DependencyInjector");
...
/// @brief Method ReflectionLoad, addr 0x1815c1900, size 0xc0, virtual false, abstract: false, final false
static inline ::Mono::ISystemDependencyProvider* ReflectionLoad() ;

/// @brief Method Register, addr 0x1815c19c0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_SystemProvider, addr 0x1815c1b50, size 0x300, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::DependencyInjector) == 0x10, "Size mismatch!");
