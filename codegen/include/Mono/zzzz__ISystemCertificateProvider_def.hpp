...
// Write type traits
MARK_REF_T(::Mono::ISystemCertificateProvider*);
DEFINE_IL2CPP_CLASS(::Mono::ISystemCertificateProvider*, "Mono", "ISystemCertificateProvider");
// Dependencies 
namespace Mono {
// Is value type: false
...
/// @brief Method Import, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Import(::ArrayW<uint8_t>  data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags, ::Mono::CertificateImportFlags  importFlags) ;
