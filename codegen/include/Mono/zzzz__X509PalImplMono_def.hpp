...
// Write type traits
MARK_REF_T(::Mono::X509PalImplMono*);
DEFINE_IL2CPP_CLASS(::Mono::X509PalImplMono*, "Mono", "X509PalImplMono");
...
public:
// Declarations
/// @brief Method Import, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Import, addr 0x181b51d00, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method Import, addr 0x181b51d60, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::X509PalImplMono) == 0x10, "Size mismatch!");
