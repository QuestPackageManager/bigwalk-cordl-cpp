...
/// @brief Method Add, addr 0x1815c1030, size 0xc0, virtual false, abstract: false, final false
inline void Add(::StringW  name, ::StringW  value) ;

/// @brief Method Clear, addr 0x1815c10f0, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetName, addr 0x180ca89d0, size 0xcac0, virtual true, abstract: false, final true
inline ::StringW GetName(int32_t  i) ;

/// @brief Method GetValue, addr 0x180dfa380, size 0x5780, virtual true, abstract: false, final true
inline ::StringW GetValue(int32_t  i) ;

/// @brief Method GetValue, addr 0x1815c1150, size 0x90, virtual true, abstract: false, final true
inline ::StringW GetValue(::StringW  name) ;
...
/// @brief Method .ctor, addr 0x1815c11e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Length, addr 0x1809d15e0, size 0x4e0, virtual true, abstract: false, final true
inline int32_t get_Length() ;

/// @brief Method get_Names, addr 0x1815c1260, size 0x10, virtual true, abstract: false, final true
inline ::ArrayW<::StringW> get_Names() ;

/// @brief Method get_Values, addr 0x1815c1270, size 0x10, virtual true, abstract: false, final true
inline ::ArrayW<::StringW> get_Values() ;
...
/// @brief Method Cleanup, addr 0x1815cf1b0, size 0xe0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Error, addr 0x1815cf290, size 0xb0, virtual false, abstract: false, final false
inline ::System::Exception* Error(::StringW  msg) ;

/// @brief Method Expect, addr 0x1815cf340, size 0xf0, virtual false, abstract: false, final false
inline void Expect(int32_t  c) ;

/// @brief Method HandleBufferedContent, addr 0x1815cf430, size 0x80, virtual false, abstract: false, final false
inline void HandleBufferedContent() ;

/// @brief Method HandleWhitespaces, addr 0x1815cf4b0, size 0xe0, virtual false, abstract: false, final false
inline void HandleWhitespaces() ;

/// @brief Method IsNameChar, addr 0x1815cf590, size 0xc0, virtual false, abstract: false, final false
inline bool IsNameChar(char16_t  c, bool  start) ;

/// @brief Method IsWhitespace, addr 0x1815cf650, size 0x20, virtual false, abstract: false, final false
inline bool IsWhitespace(int32_t  c) ;

static inline ::Mono::Xml::SmallXmlParser* New_ctor() ;

/// @brief Method Parse, addr 0x1815cf670, size 0x240, virtual false, abstract: false, final false
inline void Parse(::System::IO::TextReader*  input, ::Mono::Xml::SmallXmlParser_IContentHandler*  handler) ;

/// @brief Method Peek, addr 0x1815cf8b0, size 0x20, virtual false, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x1815d1190, size 0x50, virtual false, abstract: false, final false
inline int32_t Read() ;

/// @brief Method ReadAttribute, addr 0x1815cf8d0, size 0x360, virtual false, abstract: false, final false
inline void ReadAttribute(::Mono::Xml::SmallXmlParser_AttrListImpl*  a) ;

/// @brief Method ReadCDATASection, addr 0x1815cfc30, size 0x140, virtual false, abstract: false, final false
inline void ReadCDATASection() ;

/// @brief Method ReadCharacterReference, addr 0x1815cfd70, size 0x1a0, virtual false, abstract: false, final false
inline int32_t ReadCharacterReference() ;

/// @brief Method ReadCharacters, addr 0x1815cff10, size 0x100, virtual false, abstract: false, final false
inline void ReadCharacters() ;

/// @brief Method ReadComment, addr 0x1815d0010, size 0x120, virtual false, abstract: false, final false
inline void ReadComment() ;

/// @brief Method ReadContent, addr 0x1815d0130, size 0xc20, virtual false, abstract: false, final false
inline void ReadContent() ;

/// @brief Method ReadName, addr 0x1815d0d50, size 0x1b0, virtual false, abstract: false, final false
inline ::StringW ReadName() ;

/// @brief Method ReadReference, addr 0x1815d0f00, size 0x170, virtual false, abstract: false, final false
inline void ReadReference() ;

/// @brief Method ReadUntil, addr 0x1815d1070, size 0x120, virtual false, abstract: false, final false
inline ::StringW ReadUntil(char16_t  until, bool  handleReferences) ;

/// @brief Method SkipWhitespaces, addr 0x1815d11e0, size 0x80, virtual false, abstract: false, final false
inline void SkipWhitespaces() ;

/// @brief Method SkipWhitespaces, addr 0x1815d1260, size 0xc0, virtual false, abstract: false, final false
inline void SkipWhitespaces(bool  expected) ;

/// @brief Method UnexpectedEndError, addr 0x1815d1320, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815d13b0, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;
