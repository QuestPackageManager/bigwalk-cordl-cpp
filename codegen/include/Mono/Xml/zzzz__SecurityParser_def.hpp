...
/// @brief Method LoadXml, addr 0x1815c9710, size 0x80, virtual false, abstract: false, final false
inline void LoadXml(::StringW  xml) ;

static inline ::Mono::Xml::SecurityParser* New_ctor() ;

/// @brief Method OnChars, addr 0x1815c9790, size 0x30, virtual true, abstract: false, final true
inline void OnChars(::StringW  ch) ;

/// @brief Method OnEndElement, addr 0x1815c97c0, size 0x90, virtual true, abstract: false, final true
inline void OnEndElement(::StringW  name) ;

/// @brief Method OnEndParsing, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method OnStartElement, addr 0x1815c9850, size 0x2c0, virtual true, abstract: false, final true
...
/// @brief Method ToXml, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815c9b10, size 0x170, virtual false, abstract: false, final false
inline void _ctor() ;
