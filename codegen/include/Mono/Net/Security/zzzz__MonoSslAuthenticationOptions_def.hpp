...
/// @brief Method get_AllowRenegotiation, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
...
/// @brief Method get_ServerCertSelectionDelegate, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
