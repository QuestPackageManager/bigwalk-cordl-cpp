...
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::AsyncOperationStatus, "Mono.Net.Security", "AsyncOperationStatus");
// Dependencies 
namespace Mono::Net::Security {
// Is value type: true
...
static_assert(offsetof(::Mono::Net::Security::AsyncOperationStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Net::Security::AsyncOperationStatus) == 0x4, "Size mismatch!");
