...
// Write type traits
MARK_REF_T(::Mono::Net::Security::MobileTlsProvider*);
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::MobileTlsProvider*, "Mono.Net.Security", "MobileTlsProvider");
...
static_assert(sizeof(::Mono::Net::Security::MobileTlsProvider) == 0x10, "Size mismatch!");
