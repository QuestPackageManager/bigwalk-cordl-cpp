...
// Write type traits
MARK_REF_T(::Mono::Net::Security::MonoSslClientAuthenticationOptions*);
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::MonoSslClientAuthenticationOptions*, "Mono.Net.Security", "MonoSslClientAuthenticationOptions");
...
public:
// Declarations
 __declspec(property(get=get_AllowRenegotiation)) bool  AllowRenegotiation;
...
/// @brief Field <Options>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Options_k__BackingField, put=__cordl_internal_set__Options_k__BackingField)) ::System::Net::Security::SslClientAuthenticationOptions*  _Options_k__BackingField;
...
/// @brief Method .ctor, addr 0x181b49260, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AllowRenegotiation, addr 0x181b492a0, size 0x20, virtual true, abstract: false, final false
inline bool get_AllowRenegotiation() ;

/// @brief Method get_ClientCertificateRequired, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline bool get_ClientCertificateRequired() ;

/// @brief Method get_ClientCertificates, addr 0x181830080, size 0x20, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates() ;

/// @brief Method get_EnabledSslProtocols, addr 0x1802f1400, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_ServerCertificate, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_ServerCertificate() ;

/// @brief Method get_ServerMode, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_ServerMode() ;

/// @brief Method get_TargetHost, addr 0x18182ff70, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_TargetHost() ;

/// @brief Method set_CertificateRevocationCheckMode, addr 0x181b492c0, size 0x20, virtual true, abstract: false, final false
inline void set_CertificateRevocationCheckMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode  value) ;

/// @brief Method set_ClientCertificateRequired, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline void set_ClientCertificateRequired(bool  value) ;

/// @brief Method set_ClientCertificates, addr 0x181b492e0, size 0x30, virtual true, abstract: false, final false
inline void set_ClientCertificates(::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  value) ;

/// @brief Method set_EnabledSslProtocols, addr 0x181b49310, size 0x20, virtual true, abstract: false, final false
inline void set_EnabledSslProtocols(::System::Security::Authentication::SslProtocols  value) ;

/// @brief Method set_EncryptionPolicy, addr 0x181b49330, size 0x20, virtual true, abstract: false, final false
inline void set_EncryptionPolicy(::System::Net::Security::EncryptionPolicy  value) ;

/// @brief Method set_ServerCertificate, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline void set_ServerCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate*  value) ;

/// @brief Method set_TargetHost, addr 0x18182ffe0, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::Net::Security::MonoSslClientAuthenticationOptions) == 0x20, "Size mismatch!");
