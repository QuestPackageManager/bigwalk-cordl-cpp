...
// Write type traits
MARK_REF_T(::Mono::Net::Security::SystemCertificateValidator*);
DEFINE_IL2CPP_CLASS(::Mono::Net::Security::SystemCertificateValidator*, "Mono.Net.Security", "SystemCertificateValidator");
...
/// @brief Method NeedsChain, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Net::Security::SystemCertificateValidator) == 0x10, "Size mismatch!");
