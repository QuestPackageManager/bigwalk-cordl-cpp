...
// Write type traits
MARK_REF_T(::Mono::Http::NtlmClient*);
...
/// @brief Field <>9__1_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__1_0, put=setStaticF___9__1_0)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2_CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*  __9__1_0;

static inline ::Mono::Http::NtlmClient___c* New_ctor() ;

/// @brief Method <Authenticate>b__1_0, addr 0x181b4e050, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Http::NtlmClient___c) == 0x10, "Size mismatch!");
...
/// @brief Method Authenticate, addr 0x181b4a920, size 0x320, virtual true, abstract: false, final true
...
/// @brief Method PreAuthenticate, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_AuthenticationType, addr 0x181b4ac90, size 0x10, virtual true, abstract: false, final true
...
// Non member Declarations
static_assert(sizeof(::Mono::Http::NtlmClient) == 0x10, "Size mismatch!");
