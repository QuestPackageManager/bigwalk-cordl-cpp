...
// Write type traits
MARK_REF_T(::Mono::Http::NtlmSession*);
DEFINE_IL2CPP_CLASS(::Mono::Http::NtlmSession*, "Mono.Http", "NtlmSession");
...
/// @brief Method Authenticate, addr 0x181b4aca0, size 0x3f0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Http::NtlmSession) == 0x18, "Size mismatch!");
