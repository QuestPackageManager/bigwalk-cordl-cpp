...
// Write type traits
MARK_REF_T(::Mono::Security::Protocol::Ntlm::Type2Message*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::Type2Message*, "Mono.Security.Protocol.Ntlm", "Type2Message");
...
public:
// Declarations
 __declspec(property(get=get_Nonce)) ::ArrayW<uint8_t>  Nonce;

 __declspec(property(get=get_TargetInfo)) ::ArrayW<uint8_t>  TargetInfo;

 __declspec(property(get=get_TargetName)) ::StringW  TargetName;

/// @brief Field _nonce, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__nonce, put=__cordl_internal_set__nonce)) ::ArrayW<uint8_t>  _nonce;

/// @brief Field _targetInfo, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__targetInfo, put=__cordl_internal_set__targetInfo)) ::ArrayW<uint8_t>  _targetInfo;
...
/// @brief Method Decode, addr 0x1815beab0, size 0x170, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t>  message) ;

/// @brief Method Finalize, addr 0x1815bec20, size 0x30, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x1815bec50, size 0x90, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> GetBytes() ;

static inline ::Mono::Security::Protocol::Ntlm::Type2Message* New_ctor(::ArrayW<uint8_t>  message) ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__nonce() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__nonce() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__targetInfo() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__targetInfo() ;

constexpr ::StringW const& __cordl_internal_get__targetName() const;

constexpr ::StringW& __cordl_internal_get__targetName() ;

constexpr void __cordl_internal_set__nonce(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set__targetInfo(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set__targetName(::StringW  value) ;

/// @brief Method .ctor, addr 0x1815bece0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  message) ;

/// @brief Method get_Nonce, addr 0x1815bed40, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Nonce() ;

/// @brief Method get_TargetInfo, addr 0x1815beda0, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_TargetInfo() ;

/// @brief Method get_TargetName, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::Type2Message) == 0x30, "Size mismatch!");
