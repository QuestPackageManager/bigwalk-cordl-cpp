...
// Write type traits
MARK_REF_T(::Mono::Security::Protocol::Ntlm::Type1Message*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::Type1Message*, "Mono.Security.Protocol.Ntlm", "Type1Message");
...
/// @brief Method Decode, addr 0x1815be6c0, size 0x120, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t>  message) ;

/// @brief Method GetBytes, addr 0x1815be7e0, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815be9a0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_Domain, addr 0x1815be9f0, size 0x60, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Host, addr 0x1815bea50, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::Type1Message) == 0x28, "Size mismatch!");
