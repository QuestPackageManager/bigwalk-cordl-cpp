...
// Write type traits
MARK_REF_T(::Mono::Security::Protocol::Ntlm::MessageBase*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::MessageBase*, "Mono.Security.Protocol.Ntlm", "MessageBase");
...
/// @brief Field header, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_header, put=setStaticF_header)) ::ArrayW<uint8_t>  header;

/// @brief Method CheckHeader, addr 0x1815b7d80, size 0xa0, virtual false, abstract: false, final false
inline bool CheckHeader(::ArrayW<uint8_t>  message) ;

/// @brief Method Decode, addr 0x1815b7e20, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method PrepareMessage, addr 0x1815b7fc0, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> PrepareMessage(int32_t  messageSize) ;
...
static inline ::ArrayW<uint8_t> getStaticF_header() ;

/// @brief Method get_Flags, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
...
static inline void setStaticF_header(::ArrayW<uint8_t>  value) ;

/// @brief Method set_Flags, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::MessageBase) == 0x18, "Size mismatch!");
