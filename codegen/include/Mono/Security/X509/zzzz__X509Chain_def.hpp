...
/// @brief Method Build, addr 0x1815ab460, size 0x4b0, virtual false, abstract: false, final false
inline bool Build(::Mono::Security::X509::X509Certificate*  leaf) ;

/// @brief Method FindCertificateParent, addr 0x1815ab910, size 0x200, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* FindCertificateParent(::Mono::Security::X509::X509Certificate*  child) ;

/// @brief Method FindCertificateRoot, addr 0x1815abb10, size 0x270, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* FindCertificateRoot(::Mono::Security::X509::X509Certificate*  potentialRoot) ;

/// @brief Method IsParent, addr 0x1815abd80, size 0x290, virtual false, abstract: false, final false
inline bool IsParent(::Mono::Security::X509::X509Certificate*  child, ::Mono::Security::X509::X509Certificate*  parent) ;

/// @brief Method IsTrusted, addr 0x1815ac010, size 0x170, virtual false, abstract: false, final false
inline bool IsTrusted(::Mono::Security::X509::X509Certificate*  potentialTrusted) ;

/// @brief Method IsValid, addr 0x1815ac180, size 0xe0, virtual false, abstract: false, final false
inline bool IsValid(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method LoadCertificates, addr 0x1815ac260, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x1815ac280, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x1815ac2d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TrustAnchors, addr 0x1815ac310, size 0x80, virtual false, abstract: false, final false
