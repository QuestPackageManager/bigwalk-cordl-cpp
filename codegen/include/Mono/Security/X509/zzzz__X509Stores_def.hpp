...
/// @brief Method Open, addr 0x1815af080, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_TrustedRoot, addr 0x1815af140, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::X509::X509Stores) == 0x28, "Size mismatch!");
