...
// Declarations
 ...
 __declspec(property(put=set_Password)) ::ArrayW<uint8_t>  Password;

 __declspec(property(put=set_Salt)) ::ArrayW<uint8_t>  Salt;
...
/// @brief Method Adjust, addr 0x18159ddb0, size 0x90, virtual false, abstract: false, final false
inline void Adjust(::ArrayW<uint8_t>  a, int32_t  aOff, ::ArrayW<uint8_t>  b) ;

/// @brief Method Derive, addr 0x18159dea0, size 0x470, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> Derive(::ArrayW<uint8_t>  diversifier, int32_t  n) ;

/// @brief Method DeriveIV, addr 0x18159de40, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> DeriveIV(int32_t  size) ;

/// @brief Method DeriveKey, addr 0x18159de60, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> DeriveKey(int32_t  size) ;

/// @brief Method DeriveMAC, addr 0x18159de80, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_HashName, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_HashName(::StringW  value) ;

/// @brief Method set_IterationCount, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_IterationCount(int32_t  value) ;

/// @brief Method set_Password, addr 0x18159e420, size 0xc0, virtual false, abstract: false, final false
inline void set_Password(::ArrayW<uint8_t>  value) ;

/// @brief Method set_Salt, addr 0x18159e4e0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method AddCertificate, addr 0x18159e9f0, size 0x10, virtual false, abstract: false, final false
inline void AddCertificate(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method AddCertificate, addr 0x18159ea00, size 0x290, virtual false, abstract: false, final false
inline void AddCertificate(::Mono::Security::X509::X509Certificate*  cert, ::System::Collections::IDictionary*  attributes) ;

/// @brief Method AddPkcs8ShroudedKeyBag, addr 0x18159ec90, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method AddPrivateKey, addr 0x18159eff0, size 0x270, virtual false, abstract: false, final false
inline void AddPrivateKey(::Mono::Security::Cryptography::PKCS8_PrivateKeyInfo*  pki) ;

/// @brief Method CertificateSafeBag, addr 0x18159f260, size 0x920, virtual false, abstract: false, final false
...
/// @brief Method Clone, addr 0x18159fb80, size 0x110, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method Compare, addr 0x18159fd50, size 0x60, virtual false, abstract: false, final false
inline bool Compare(::ArrayW<uint8_t>  expected, ::ArrayW<uint8_t>  actual) ;

/// @brief Method CompareAsymmetricAlgorithm, addr 0x18159fc90, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Decode, addr 0x18159fdb0, size 0x6a0, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t>  data) ;

/// @brief Method Decrypt, addr 0x1815a0570, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Decrypt, addr 0x1815a0450, size 0x120, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> Decrypt(::Mono::Security::PKCS7_EncryptedData*  ed) ;

/// @brief Method Encrypt, addr 0x1815a0650, size 0xf0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> Encrypt(::StringW  algorithmOid, ::ArrayW<uint8_t>  salt, int32_t  iterationCount, ::ArrayW<uint8_t>  data) ;

/// @brief Method EncryptedContentInfo, addr 0x1815a0740, size 0x650, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_ContentInfo* EncryptedContentInfo(::Mono::Security::ASN1*  safeBags, ::StringW  algorithmOid) ;

/// @brief Method Finalize, addr 0x1815a0d90, size 0x40, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x1815a0dd0, size 0x23e0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetBytes() ;

/// @brief Method GetExistingParameters, addr 0x1815a31b0, size 0x2c0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DSAParameters GetExistingParameters(::by_ref<bool>  found) ;

/// @brief Method GetSymmetricAlgorithm, addr 0x1815a3470, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method MAC, addr 0x1815a39f0, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method Pkcs8ShroudedKeyBagSafeBag, addr 0x1815a3c30, size 0xa60, virtual false, abstract: false, final false
...
/// @brief Method ReadSafeBag, addr 0x1815a4690, size 0x5c0, virtual false, abstract: false, final false
inline void ReadSafeBag(::Mono::Security::ASN1*  safeBag) ;

/// @brief Method RemoveCertificate, addr 0x1815a5200, size 0x10, virtual false, abstract: false, final false
inline void RemoveCertificate(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method RemoveCertificate, addr 0x1815a4c50, size 0x5b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815a52f0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815a5290, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data) ;

/// @brief Method .ctor, addr 0x1815a5240, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data, ::StringW  password) ;

static inline int32_t getStaticF_password_max_length() ;

/// @brief Method get_Certificates, addr 0x1815a53c0, size 0x330, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_IterationCount, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Keys, addr 0x1815a56f0, size 0x590, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Keys() ;

/// @brief Method get_MaximumPasswordLength, addr 0x1815a5c80, size 0x20, virtual false, abstract: false, final false
static inline int32_t get_MaximumPasswordLength() ;

/// @brief Method get_RNG, addr 0x1815a5ca0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_IterationCount, addr 0x180393010, size 0x10, virtual false, abstract: false, final false
inline void set_IterationCount(int32_t  value) ;

/// @brief Method set_Password, addr 0x1815a5ce0, size 0x140, virtual false, abstract: false, final false
