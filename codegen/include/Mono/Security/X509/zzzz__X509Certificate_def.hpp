...
// Write type traits
MARK_REF_T(::Mono::Security::X509::X509Certificate*);
DEFINE_IL2CPP_CLASS(::Mono::Security::X509::X509Certificate*, "Mono.Security.X509", "X509Certificate");
...
// Declarations
 ...
 __declspec(property(get=get_KeyAlgorithmParameters, put=set_KeyAlgorithmParameters)) ::ArrayW<uint8_t>  KeyAlgorithmParameters;
...
/// @brief Field m_encodedcert, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_encodedcert, put=__cordl_internal_set_m_encodedcert)) ::ArrayW<uint8_t>  m_encodedcert;
...
/// @brief Field m_keyalgoparams, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_keyalgoparams, put=__cordl_internal_set_m_keyalgoparams)) ::ArrayW<uint8_t>  m_keyalgoparams;

/// @brief Field m_publickey, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_publickey, put=__cordl_internal_set_m_publickey)) ::ArrayW<uint8_t>  m_publickey;
...
/// @brief Field m_signaturealgoparams, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_signaturealgoparams, put=__cordl_internal_set_m_signaturealgoparams)) ::ArrayW<uint8_t>  m_signaturealgoparams;
...
/// @brief Field serialnumber, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_serialnumber, put=__cordl_internal_set_serialnumber)) ::ArrayW<uint8_t>  serialnumber;
...
/// @brief Method GetObjectData, addr 0x1815a9780, size 0x30, virtual true, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method GetUnsignedBigInteger, addr 0x1815a97b0, size 0x80, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetUnsignedBigInteger(::ArrayW<uint8_t>  integer) ;

static inline ::Mono::Security::X509::X509Certificate* New_ctor(::ArrayW<uint8_t>  data) ;

/// @brief Method PEM, addr 0x1815a9830, size 0xd0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t> PEM(::StringW  type, ::ArrayW<uint8_t>  data) ;

/// @brief Method Parse, addr 0x1815a9900, size 0x8a0, virtual false, abstract: false, final false
inline void Parse(::ArrayW<uint8_t>  data) ;

/// @brief Method VerifySignature, addr 0x1815aa1a0, size 0x140, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method VerifySignature, addr 0x1815aa3d0, size 0xa0, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method VerifySignature, addr 0x1815aa2e0, size 0xf0, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::RSA*  rsa) ;

/// @brief Method WasCurrent, addr 0x1815aa470, size 0x70, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_encodedcert() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_encodedcert() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_keyalgoparams() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_keyalgoparams() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_publickey() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_publickey() ;

constexpr ::StringW const& __cordl_internal_get_m_signaturealgo() const;

constexpr ::StringW& __cordl_internal_get_m_signaturealgo() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_signaturealgoparams() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_signaturealgoparams() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_serialnumber() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_serialnumber() ;
...
constexpr void __cordl_internal_set_m_encodedcert(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_m_keyalgoparams(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_m_publickey(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_m_signaturealgo(::StringW  value) ;

constexpr void __cordl_internal_set_m_signaturealgoparams(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_serialnumber(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x1815aa520, size 0x180, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data) ;

static inline ::StringW getStaticF_encoding_error() ;

/// @brief Method get_DSA, addr 0x1815aa6a0, size 0x340, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DSA* get_DSA() ;

/// @brief Method get_Extensions, addr 0x1803d9940, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_Hash, addr 0x1815aa9e0, size 0x200, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method get_IsCurrent, addr 0x1815aabe0, size 0x80, virtual false, abstract: false, final false
inline bool get_IsCurrent() ;

/// @brief Method get_IsSelfSigned, addr 0x1815aac60, size 0x90, virtual false, abstract: false, final false
inline bool get_IsSelfSigned() ;

/// @brief Method get_IssuerName, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_KeyAlgorithm, addr 0x1802e5850, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters, addr 0x1815aacf0, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_KeyAlgorithmParameters() ;

/// @brief Method get_PublicKey, addr 0x1815aad60, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_PublicKey() ;

/// @brief Method get_RSA, addr 0x1815aadd0, size 0x1f0, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSA* get_RSA() ;

/// @brief Method get_RawData, addr 0x1815aafc0, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_SerialNumber, addr 0x1815ab030, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_Signature, addr 0x1815ab0a0, size 0x320, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_Signature() ;

/// @brief Method get_SubjectName, addr 0x1802e75e0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_SubjectName() ;

/// @brief Method get_ValidFrom, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
inline ::System::DateTime get_ValidFrom() ;

/// @brief Method get_ValidUntil, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
inline ::System::DateTime get_ValidUntil() ;

/// @brief Method get_Version, addr 0x1805d4740, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DSA, addr 0x1815ab3c0, size 0x50, virtual false, abstract: false, final false
inline void set_DSA(::System::Security::Cryptography::DSA*  value) ;

/// @brief Method set_KeyAlgorithmParameters, addr 0x1802e5e30, size 0x10, virtual true, abstract: false, final false
inline void set_KeyAlgorithmParameters(::ArrayW<uint8_t>  value) ;

/// @brief Method set_RSA, addr 0x1815ab410, size 0x50, virtual true, abstract: false, final false
...
/// @brief Field m_encodedcert, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___m_encodedcert;
...
/// @brief Field m_keyalgoparams, offset: 0x48, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___m_keyalgoparams;
...
/// @brief Field m_signaturealgoparams, offset: 0x78, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___m_signaturealgoparams;
...
/// @brief Field serialnumber, offset: 0xa0, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___serialnumber;
...
static_assert(sizeof(::Mono::Security::X509::X509Certificate) == 0xc0, "Size mismatch!");
