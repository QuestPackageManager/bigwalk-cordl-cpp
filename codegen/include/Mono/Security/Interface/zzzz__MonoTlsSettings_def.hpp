...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::MonoTlsSettings*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::MonoTlsSettings*, "Mono.Security.Interface", "MonoTlsSettings");
// Dependencies Mono.Security.Interface.CipherSuiteCode, Mono.Security.Interface.TlsProtocols, System.DateTime, System.Nullable`1<T>, System.Object
namespace Mono::Security::Interface {
// Is value type: false
...
// Declarations
 ...
 __declspec(property(get=get_CertificateSearchPaths, put=set_CertificateSearchPaths)) ::ArrayW<::StringW>  CertificateSearchPaths;
 ...
 __declspec(property(get=get_ClientCertificateSelectionCallback, put=set_ClientCertificateSelectionCallback)) ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*  ClientCertificateSelectionCallback;
 ...
 __declspec(property(get=get_RemoteCertificateValidationCallback, put=set_RemoteCertificateValidationCallback)) ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*  RemoteCertificateValidationCallback;
...
/// @brief Field <CertificateSearchPaths>k__BackingField, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__CertificateSearchPaths_k__BackingField, put=__cordl_internal_set__CertificateSearchPaths_k__BackingField)) ::ArrayW<::StringW>  _CertificateSearchPaths_k__BackingField;

/// @brief Field <CertificateValidationTime>k__BackingField, offset 0x20, size 0x10 
 __declspec(property(get=__cordl_internal_get__CertificateValidationTime_k__BackingField, put=__cordl_internal_set__CertificateValidationTime_k__BackingField)) ::System::Nullable_1<::System::DateTime>  _CertificateValidationTime_k__BackingField;

/// @brief Field <ClientCertificateIssuers>k__BackingField, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__ClientCertificateIssuers_k__BackingField, put=__cordl_internal_set__ClientCertificateIssuers_k__BackingField)) ::ArrayW<::StringW>  _ClientCertificateIssuers_k__BackingField;

/// @brief Field <ClientCertificateSelectionCallback>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__ClientCertificateSelectionCallback_k__BackingField, put=__cordl_internal_set__ClientCertificateSelectionCallback_k__BackingField)) ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*  _ClientCertificateSelectionCallback_k__BackingField;

/// @brief Field <DisallowUnauthenticatedCertificateRequest>k__BackingField, offset 0x58, size 0x1 
 __declspec(property(get=__cordl_internal_get__DisallowUnauthenticatedCertificateRequest_k__BackingField, put=__cordl_internal_set__DisallowUnauthenticatedCertificateRequest_k__BackingField)) bool  _DisallowUnauthenticatedCertificateRequest_k__BackingField;

/// @brief Field <EnabledCiphers>k__BackingField, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__EnabledCiphers_k__BackingField, put=__cordl_internal_set__EnabledCiphers_k__BackingField)) ::ArrayW<::Mono::Security::Interface::CipherSuiteCode>  _EnabledCiphers_k__BackingField;

/// @brief Field <EnabledProtocols>k__BackingField, offset 0x5c, size 0x8 
 __declspec(property(get=__cordl_internal_get__EnabledProtocols_k__BackingField, put=__cordl_internal_set__EnabledProtocols_k__BackingField)) ::System::Nullable_1<::Mono::Security::Interface::TlsProtocols>  _EnabledProtocols_k__BackingField;

/// @brief Field <RemoteCertificateValidationCallback>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__RemoteCertificateValidationCallback_k__BackingField, put=__cordl_internal_set__RemoteCertificateValidationCallback_k__BackingField)) ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*  _RemoteCertificateValidationCallback_k__BackingField;
...
/// @brief Field <TrustAnchors>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__TrustAnchors_k__BackingField, put=__cordl_internal_set__TrustAnchors_k__BackingField)) ::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  _TrustAnchors_k__BackingField;
...
/// @brief Method Clone, addr 0x1815b90e0, size 0x40, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::MonoTlsSettings* Clone() ;

/// @brief Method CloneWithValidator, addr 0x1815b9060, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CopyDefaultSettings, addr 0x1815b9120, size 0x90, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get__CertificateSearchPaths_k__BackingField() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__CertificateSearchPaths_k__BackingField() ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get__ClientCertificateIssuers_k__BackingField() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__ClientCertificateIssuers_k__BackingField() ;
...
constexpr ::ArrayW<::Mono::Security::Interface::CipherSuiteCode> const& __cordl_internal_get__EnabledCiphers_k__BackingField() const;

constexpr ::ArrayW<::Mono::Security::Interface::CipherSuiteCode>& __cordl_internal_get__EnabledCiphers_k__BackingField() ;
...
constexpr void __cordl_internal_set__CertificateSearchPaths_k__BackingField(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set__CertificateValidationTime_k__BackingField(::System::Nullable_1<::System::DateTime>  value) ;

constexpr void __cordl_internal_set__ClientCertificateIssuers_k__BackingField(::ArrayW<::StringW>  value) ;
...
constexpr void __cordl_internal_set__EnabledCiphers_k__BackingField(::ArrayW<::Mono::Security::Interface::CipherSuiteCode>  value) ;
...
/// @brief Method .ctor, addr 0x1815b9310, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815b91b0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_CallbackNeedsCertificateChain, addr 0x1815b9320, size 0x10, virtual false, abstract: false, final false
inline bool get_CallbackNeedsCertificateChain() ;

/// @brief Method get_CertificateSearchPaths, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_CertificateSearchPaths() ;

/// @brief Method get_CertificateValidationTime, addr 0x1802f41b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_CertificateValidationTime() ;

/// @brief Method get_CertificateValidator, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::ICertificateValidator* get_CertificateValidator() ;

/// @brief Method get_ClientCertificateIssuers, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_ClientCertificateIssuers() ;

/// @brief Method get_ClientCertificateSelectionCallback, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback* get_ClientCertificateSelectionCallback() ;

/// @brief Method get_DefaultSettings, addr 0x1815b9330, size 0x60, virtual false, abstract: false, final false
static inline ::Mono::Security::Interface::MonoTlsSettings* get_DefaultSettings() ;

/// @brief Method get_DisallowUnauthenticatedCertificateRequest, addr 0x1803151e0, size 0x10, virtual false, abstract: false, final false
inline bool get_DisallowUnauthenticatedCertificateRequest() ;

/// @brief Method get_EnabledCiphers, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::Mono::Security::Interface::CipherSuiteCode> get_EnabledCiphers() ;

/// @brief Method get_EnabledProtocols, addr 0x1815b9390, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Mono::Security::Interface::TlsProtocols> get_EnabledProtocols() ;

/// @brief Method get_RemoteCertificateValidationCallback, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback* get_RemoteCertificateValidationCallback() ;

/// @brief Method get_SendCloseNotify, addr 0x1802fdd10, size 0x10, virtual false, abstract: false, final false
inline bool get_SendCloseNotify() ;

/// @brief Method get_TrustAnchors, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_TrustAnchors() ;

/// @brief Method get_UseServicePointManagerCallback, addr 0x1815b93a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<bool> get_UseServicePointManagerCallback() ;

/// @brief Method get_UserSettings, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_CertificateSearchPaths, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_CertificateSearchPaths(::ArrayW<::StringW>  value) ;

/// @brief Method set_CertificateValidationTime, addr 0x1815b93b0, size 0x10, virtual false, abstract: false, final false
inline void set_CertificateValidationTime(::System::Nullable_1<::System::DateTime>  value) ;

/// @brief Method set_ClientCertificateIssuers, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
inline void set_ClientCertificateIssuers(::ArrayW<::StringW>  value) ;

/// @brief Method set_ClientCertificateSelectionCallback, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_ClientCertificateSelectionCallback(::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*  value) ;

/// @brief Method set_DisallowUnauthenticatedCertificateRequest, addr 0x1803de5b0, size 0x10, virtual false, abstract: false, final false
inline void set_DisallowUnauthenticatedCertificateRequest(bool  value) ;

/// @brief Method set_EnabledCiphers, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
inline void set_EnabledCiphers(::ArrayW<::Mono::Security::Interface::CipherSuiteCode>  value) ;

/// @brief Method set_EnabledProtocols, addr 0x1815b93c0, size 0x10, virtual false, abstract: false, final false
inline void set_EnabledProtocols(::System::Nullable_1<::Mono::Security::Interface::TlsProtocols>  value) ;

/// @brief Method set_RemoteCertificateValidationCallback, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_SendCloseNotify, addr 0x180503b70, size 0x10, virtual false, abstract: false, final false
inline void set_SendCloseNotify(bool  value) ;

/// @brief Method set_TrustAnchors, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_TrustAnchors(::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  value) ;

/// @brief Method set_UseServicePointManagerCallback, addr 0x1815b93d0, size 0x10, virtual false, abstract: false, final false
inline void set_UseServicePointManagerCallback(::System::Nullable_1<bool>  value) ;

/// @brief Method set_UserSettings, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Interface::MonoTlsSettings) == 0x80, "Size mismatch!");
