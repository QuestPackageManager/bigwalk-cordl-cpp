...
static inline ::Mono::Security::Interface::TlsException* New_ctor(::Mono::Security::Interface::Alert*  alert) ;

static inline ::Mono::Security::Interface::TlsException* New_ctor(::Mono::Security::Interface::Alert*  alert, ::StringW  message) ;

static inline ::Mono::Security::Interface::TlsException* New_ctor(::Mono::Security::Interface::AlertDescription  description) ;
...
/// @brief Method .ctor, addr 0x1815be640, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::Alert*  alert) ;

/// @brief Method .ctor, addr 0x1815be4f0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::Alert*  alert, ::StringW  message) ;

/// @brief Method .ctor, addr 0x1815be5b0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::AlertDescription  description) ;

/// @brief Method .ctor, addr 0x1815be530, size 0x80, virtual false, abstract: false, final false
