...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::MonoTlsProvider*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::MonoTlsProvider*, "Mono.Security.Interface", "MonoTlsProvider");
...
static_assert(sizeof(::Mono::Security::Interface::MonoTlsProvider) == 0x10, "Size mismatch!");
