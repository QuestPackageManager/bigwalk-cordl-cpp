...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::ICertificateValidator*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::ICertificateValidator*, "Mono.Security.Interface", "ICertificateValidator");
// Dependencies 
namespace Mono::Security::Interface {
// Is value type: false
