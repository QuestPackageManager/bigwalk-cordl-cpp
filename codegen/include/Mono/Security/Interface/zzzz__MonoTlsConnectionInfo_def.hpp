...
/// @brief Method ToString, addr 0x1815b8fa0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method get_CipherSuiteCode, addr 0x1804bd9a0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::CipherSuiteCode get_CipherSuiteCode() ;

/// @brief Method get_ProtocolVersion, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::TlsProtocols get_ProtocolVersion() ;

/// @brief Method set_CipherSuiteCode, addr 0x1804bd9b0, size 0x10, virtual false, abstract: false, final false
inline void set_CipherSuiteCode(::Mono::Security::Interface::CipherSuiteCode  value) ;

/// @brief Method set_PeerDomainName, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_PeerDomainName(::StringW  value) ;

/// @brief Method set_ProtocolVersion, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
