...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::SymmetricTransform*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::SymmetricTransform*, "Mono.Security.Cryptography", "SymmetricTransform");
// Dependencies System.Object, System.Security.Cryptography.PaddingMode
namespace Mono::Security::Cryptography {
// Is value type: false
...
/// @brief Field temp, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_temp, put=__cordl_internal_set_temp)) ::ArrayW<uint8_t>  temp;

/// @brief Field temp2, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_temp2, put=__cordl_internal_set_temp2)) ::ArrayW<uint8_t>  temp2;

/// @brief Field workBuff, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_workBuff, put=__cordl_internal_set_workBuff)) ::ArrayW<uint8_t>  workBuff;

/// @brief Field workout, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_workout, put=__cordl_internal_set_workout)) ::ArrayW<uint8_t>  workout;
...
/// @brief Method CBC, addr 0x1815e6a90, size 0x110, virtual true, abstract: false, final false
inline void CBC(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method CFB, addr 0x1815e6ba0, size 0x1a0, virtual true, abstract: false, final false
inline void CFB(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method CTS, addr 0x1815e6d40, size 0x50, virtual true, abstract: false, final false
inline void CTS(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method CheckInput, addr 0x1815e6d90, size 0x90, virtual false, abstract: false, final false
inline void CheckInput(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method Dispose, addr 0x1815e6e20, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method FinalDecrypt, addr 0x1815e6e90, size 0x2c0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> FinalDecrypt(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method FinalEncrypt, addr 0x1815e7150, size 0x2e0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> FinalEncrypt(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method Finalize, addr 0x1815e7430, size 0x20, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalTransformBlock, addr 0x1815e7450, size 0x1e0, virtual false, abstract: false, final false
...
static inline ::Mono::Security::Cryptography::SymmetricTransform* New_ctor(::System::Security::Cryptography::SymmetricAlgorithm*  symmAlgo, bool  encryption, ::ArrayW<uint8_t>  rgbIV) ;

/// @brief Method OFB, addr 0x1815e7630, size 0x50, virtual true, abstract: false, final false
inline void OFB(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method Random, addr 0x1815e7680, size 0xb0, virtual false, abstract: false, final false
inline void Random(::ArrayW<uint8_t>  buffer, int32_t  start, int32_t  length) ;

/// @brief Method System.IDisposable.Dispose, addr 0x1815e7730, size 0x30, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;

/// @brief Method ThrowBadPaddingException, addr 0x1815e7760, size 0x130, virtual false, abstract: false, final false
inline void ThrowBadPaddingException(::System::Security::Cryptography::PaddingMode  padding, int32_t  length, int32_t  position) ;

/// @brief Method Transform, addr 0x1815e7c90, size 0x130, virtual true, abstract: false, final false
inline void Transform(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method TransformBlock, addr 0x1815e7890, size 0x2e0, virtual true, abstract: false, final false
...
/// @brief Method TransformFinalBlock, addr 0x1815e7b70, size 0x120, virtual true, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_temp() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_temp() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_temp2() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_temp2() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_workBuff() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_workBuff() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_workout() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_workout() ;
...
constexpr void __cordl_internal_set_temp(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_temp2(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_workBuff(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_workout(::ArrayW<uint8_t>  value) ;

/// @brief Method .ctor, addr 0x1815e7dc0, size 0x240, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::SymmetricAlgorithm*  symmAlgo, bool  encryption, ::ArrayW<uint8_t>  rgbIV) ;

/// @brief Method get_CanReuseTransform, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_CanReuseTransform() ;

/// @brief Method get_CanTransformMultipleBlocks, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize, addr 0x1802f42c0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_InputBlockSize() ;

/// @brief Method get_KeepLastBlock, addr 0x1815e8000, size 0x20, virtual false, abstract: false, final false
inline bool get_KeepLastBlock() ;

/// @brief Method get_OutputBlockSize, addr 0x1802f42c0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::SymmetricTransform) == 0x58, "Size mismatch!");
