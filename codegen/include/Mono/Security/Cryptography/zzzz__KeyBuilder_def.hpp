...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::KeyBuilder*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::KeyBuilder*, "Mono.Security.Cryptography", "KeyBuilder");
...
/// @brief Method IV, addr 0x1815c36a0, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t> IV(int32_t  size) ;

/// @brief Method Key, addr 0x1815c36a0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_Rng, addr 0x1815c3730, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::KeyBuilder) == 0x10, "Size mismatch!");
