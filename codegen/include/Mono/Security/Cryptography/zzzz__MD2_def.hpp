...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::MD2*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::MD2*, "Mono.Security.Cryptography", "MD2");
...
public:
// Declarations
/// @brief Method Create, addr 0x1815c5610, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::MD2) == 0x28, "Size mismatch!");
