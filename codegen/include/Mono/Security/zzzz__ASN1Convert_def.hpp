...
public:
// Declarations
/// @brief Method FromInt32, addr 0x181599490, size 0x260, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromInt32(int32_t  value) ;

/// @brief Method FromOid, addr 0x1815996f0, size 0x60, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromOid(::StringW  oid) ;

/// @brief Method FromUnsignedBigInteger, addr 0x181599750, size 0xa0, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromUnsignedBigInteger(::ArrayW<uint8_t>  big) ;

/// @brief Method ToDateTime, addr 0x1815997f0, size 0x340, virtual false, abstract: false, final false
static inline ::System::DateTime ToDateTime(::Mono::Security::ASN1*  time) ;

/// @brief Method ToInt32, addr 0x181599b30, size 0x190, virtual false, abstract: false, final false
static inline int32_t ToInt32(::Mono::Security::ASN1*  asn1) ;

/// @brief Method ToOid, addr 0x181599cc0, size 0x1d0, virtual false, abstract: false, final false
