...
/// @brief Method Close, addr 0x1815af360, size 0x50, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method GetHash, addr 0x1815af3b0, size 0x460, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetHash(::System::Security::Cryptography::HashAlgorithm*  hash) ;

/// @brief Method GetSecurityEntry, addr 0x1815af810, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetSecurityEntry() ;

static inline ::Mono::Security::Authenticode::AuthenticodeBase* New_ctor() ;

/// @brief Method Open, addr 0x1815af8c0, size 0xb0, virtual false, abstract: false, final false
inline void Open(::StringW  filename) ;

/// @brief Method Open, addr 0x1815af970, size 0x90, virtual false, abstract: false, final false
inline void Open(::ArrayW<uint8_t>  rawdata) ;

/// @brief Method ProcessFirstBlock, addr 0x1815afa00, size 0x250, virtual false, abstract: false, final false
inline int32_t ProcessFirstBlock() ;

/// @brief Method ReadFirstBlock, addr 0x1815afc50, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815afcf0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PEOffset, addr 0x1815afd20, size 0x30, virtual false, abstract: false, final false
