...
DEFINE_IL2CPP_CLASS(::Mono::CertificateImportFlags, "Mono", "CertificateImportFlags");
// Dependencies 
namespace Mono {
// Is value type: true
...
static_assert(offsetof(::Mono::CertificateImportFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::CertificateImportFlags) == 0x4, "Size mismatch!");
