...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::SortKeyBuffer*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SortKeyBuffer*, "Mono.Globalization.Unicode", "SortKeyBuffer");
...
/// @brief Field l1b, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_l1b, put=__cordl_internal_set_l1b)) ::ArrayW<uint8_t>  l1b;
...
/// @brief Field l2b, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_l2b, put=__cordl_internal_set_l2b)) ::ArrayW<uint8_t>  l2b;
...
/// @brief Field l3b, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_l3b, put=__cordl_internal_set_l3b)) ::ArrayW<uint8_t>  l3b;
...
/// @brief Field l4kb, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_l4kb, put=__cordl_internal_set_l4kb)) ::ArrayW<uint8_t>  l4kb;
...
/// @brief Field l4sb, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_l4sb, put=__cordl_internal_set_l4sb)) ::ArrayW<uint8_t>  l4sb;
...
/// @brief Field l4tb, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_l4tb, put=__cordl_internal_set_l4tb)) ::ArrayW<uint8_t>  l4tb;
...
/// @brief Field l4wb, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_l4wb, put=__cordl_internal_set_l4wb)) ::ArrayW<uint8_t>  l4wb;
...
/// @brief Field l5b, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_l5b, put=__cordl_internal_set_l5b)) ::ArrayW<uint8_t>  l5b;
...
/// @brief Method AppendBufferPrimitive, addr 0x1815d1500, size 0x70, virtual false, abstract: false, final false
inline void AppendBufferPrimitive(uint8_t  value, ::by_ref<::ArrayW<uint8_t>>  buf, ::by_ref<int32_t>  bidx) ;

/// @brief Method AppendCJKExtension, addr 0x1815d1570, size 0x270, virtual false, abstract: false, final false
inline void AppendCJKExtension(uint8_t  lv1msb, uint8_t  lv1lsb) ;

/// @brief Method AppendKana, addr 0x1815d17e0, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method AppendLevel5, addr 0x1815d19c0, size 0x1e0, virtual false, abstract: false, final false
inline void AppendLevel5(uint8_t  category, uint8_t  lv1) ;

/// @brief Method AppendNormal, addr 0x1815d1ba0, size 0x160, virtual false, abstract: false, final false
inline void AppendNormal(uint8_t  category, uint8_t  lv1, uint8_t  lv2, uint8_t  lv3) ;

/// @brief Method GetOptimizedLength, addr 0x1815d1d00, size 0x30, virtual false, abstract: false, final false
inline int32_t GetOptimizedLength(::ArrayW<uint8_t>  data, int32_t  len, uint8_t  defaultValue) ;

/// @brief Method GetResult, addr 0x1815d1d60, size 0x550, virtual false, abstract: false, final false
inline ::System::Globalization::SortKey* GetResult() ;

/// @brief Method GetResultAndReset, addr 0x1815d1d30, size 0x30, virtual false, abstract: false, final false
inline ::System::Globalization::SortKey* GetResultAndReset() ;

/// @brief Method Initialize, addr 0x1815d22b0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x1815d2480, size 0x20, virtual false, abstract: false, final false
inline void Reset() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l1b() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l1b() ;

constexpr int32_t const& __cordl_internal_get_l2() const;

constexpr int32_t& __cordl_internal_get_l2() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l2b() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l2b() ;

constexpr int32_t const& __cordl_internal_get_l3() const;

constexpr int32_t& __cordl_internal_get_l3() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l3b() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l3b() ;

constexpr int32_t const& __cordl_internal_get_l4k() const;

constexpr int32_t& __cordl_internal_get_l4k() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l4kb() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l4kb() ;

constexpr int32_t const& __cordl_internal_get_l4s() const;

constexpr int32_t& __cordl_internal_get_l4s() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l4sb() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l4sb() ;

constexpr int32_t const& __cordl_internal_get_l4t() const;

constexpr int32_t& __cordl_internal_get_l4t() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l4tb() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l4tb() ;

constexpr int32_t const& __cordl_internal_get_l4w() const;

constexpr int32_t& __cordl_internal_get_l4w() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l4wb() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l4wb() ;

constexpr int32_t const& __cordl_internal_get_l5() const;

constexpr int32_t& __cordl_internal_get_l5() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_l5b() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_l5b() ;
...
constexpr void __cordl_internal_set_l1b(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l2(int32_t  value) ;

constexpr void __cordl_internal_set_l2b(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l3(int32_t  value) ;

constexpr void __cordl_internal_set_l3b(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l4k(int32_t  value) ;

constexpr void __cordl_internal_set_l4kb(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l4s(int32_t  value) ;

constexpr void __cordl_internal_set_l4sb(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l4t(int32_t  value) ;

constexpr void __cordl_internal_set_l4tb(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l4w(int32_t  value) ;

constexpr void __cordl_internal_set_l4wb(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_l5(int32_t  value) ;

constexpr void __cordl_internal_set_l5b(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::Mono::Globalization::Unicode::SortKeyBuffer) == 0x88, "Size mismatch!");
