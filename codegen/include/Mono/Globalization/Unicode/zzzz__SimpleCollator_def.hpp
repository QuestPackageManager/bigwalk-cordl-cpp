...
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SimpleCollator_ExtenderType, "Mono.Globalization.Unicode", "SimpleCollator/ExtenderType");
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SimpleCollator*, "Mono.Globalization.Unicode", "SimpleCollator");
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SimpleCollator_Context, "Mono.Globalization.Unicode", "SimpleCollator/Context");
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SimpleCollator_Escape, "Mono.Globalization.Unicode", "SimpleCollator/Escape");
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::SimpleCollator_PreviousInfo, "Mono.Globalization.Unicode", "SimpleCollator/PreviousInfo");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1815c1750, size 0x70, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Option", ty: "::System::Globalization::CompareOptions", modifiers: "", def_value: None }, CppParam { name: "NeverMatchFlags", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "AlwaysMatchFlags", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "Buffer1", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "Buffer2", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "PrevCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "PrevSortKey", ty: "uint8_t*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Mono::Globalization::Unicode::SimpleCollator_Context) == 0x38, "Size mismatch!");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x1815c8d00, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Globalization::Unicode::SimpleCollator_PreviousInfo) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::Mono::Globalization::Unicode::SimpleCollator_Escape) == 0x18, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::Mono::Globalization::Unicode::SimpleCollator_ExtenderType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Mono::Globalization::Unicode::SimpleCollator_ExtenderType) == 0x4, "Size mismatch!");
...
/// @brief Method Category, addr 0x1815c9c80, size 0x70, virtual false, abstract: false, final false
inline uint8_t Category(int32_t  cp) ;

/// @brief Method ClearBuffer, addr 0x1815c9cf0, size 0x20, virtual false, abstract: false, final false
inline void ClearBuffer(uint8_t*  buffer, int32_t  size) ;

/// @brief Method Compare, addr 0x1815cae60, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method CompareFlagPair, addr 0x1815c9d10, size 0x20, virtual false, abstract: false, final false
inline int32_t CompareFlagPair(bool  b1, bool  b2) ;

/// @brief Method CompareInternal, addr 0x1815c9d30, size 0x1130, virtual false, abstract: false, final false
inline int32_t CompareInternal(::StringW  s1, int32_t  idx1, int32_t  len1, ::StringW  s2, int32_t  idx2, int32_t  len2, ::by_ref<bool>  targetConsumed, ::by_ref<bool>  sourceConsumed, bool  skipHeadingExtenders, bool  immediateBreakup, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method FillSortKeyRaw, addr 0x1815caf50, size 0x440, virtual false, abstract: false, final false
inline void FillSortKeyRaw(int32_t  i, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::Mono::Globalization::Unicode::SortKeyBuffer*  buf, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method FillSurrogateSortKeyRaw, addr 0x1815cb390, size 0xc0, virtual false, abstract: false, final false
inline void FillSurrogateSortKeyRaw(int32_t  i, ::Mono::Globalization::Unicode::SortKeyBuffer*  buf) ;

/// @brief Method FilterExtender, addr 0x1815cb450, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method FilterOptions, addr 0x1815cb640, size 0x280, virtual false, abstract: false, final false
inline int32_t FilterOptions(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method GetContraction, addr 0x1815cb9a0, size 0xb0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetContraction, addr 0x1815cb8c0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetExtenderType, addr 0x1815cba50, size 0xc0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType GetExtenderType(int32_t  i) ;

/// @brief Method GetNeutralCulture, addr 0x1815cbb10, size 0x90, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo*  info) ;

/// @brief Method GetSortKey, addr 0x1815cbf70, size 0xb0, virtual true, abstract: false, final true
inline ::System::Globalization::SortKey* GetSortKey(::StringW  s, ::System::Globalization::CompareOptions  options) ;

/// @brief Method GetSortKey, addr 0x1815cbba0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetSortKey, addr 0x1815cbc70, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method GetTailContraction, addr 0x1815cc1f0, size 0xb0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetTailContraction, addr 0x1815cc020, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x1815cca60, size 0x240, virtual true, abstract: false, final true
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IndexOf, addr 0x1815cc490, size 0x5d0, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, uint8_t*  targetSortKey, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IndexOfOrdinal, addr 0x1815cc2a0, size 0xc0, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfOrdinal, addr 0x1815cc360, size 0x70, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, char16_t  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfSortKey, addr 0x1815cc3d0, size 0xc0, virtual false, abstract: false, final false
inline int32_t IndexOfSortKey(::StringW  s, int32_t  start, int32_t  length, uint8_t*  sortkey, char16_t  target, int32_t  ti, bool  noLv4, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IsHalfKana, addr 0x1815ccca0, size 0x50, virtual false, abstract: false, final false
static inline bool IsHalfKana(int32_t  cp, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsIgnorable, addr 0x1815cccf0, size 0x70, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x1815cce10, size 0xe0, virtual false, abstract: false, final false
inline bool IsPrefix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x1815ccd60, size 0x80, virtual false, abstract: false, final false
inline bool IsPrefix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, bool  skipHeadingExtenders, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IsPrefix, addr 0x1815ccde0, size 0x30, virtual true, abstract: false, final true
inline bool IsPrefix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSafe, addr 0x1815ccef0, size 0x50, virtual false, abstract: false, final false
inline bool IsSafe(int32_t  i) ;

/// @brief Method IsSuffix, addr 0x1815ccf40, size 0xc0, virtual false, abstract: false, final false
inline bool IsSuffix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSuffix, addr 0x1815cd000, size 0xb0, virtual true, abstract: false, final true
inline bool IsSuffix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x1815cd920, size 0x130, virtual true, abstract: false, final true
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x1815cd2b0, size 0x670, virtual false, abstract: false, final false
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, uint8_t*  targetSortKey, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method LastIndexOfOrdinal, addr 0x1815cd0b0, size 0x130, virtual false, abstract: false, final false
inline int32_t LastIndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method LastIndexOfSortKey, addr 0x1815cd1e0, size 0xd0, virtual false, abstract: false, final false
inline int32_t LastIndexOfSortKey(::StringW  s, int32_t  start, int32_t  orgStart, int32_t  length, uint8_t*  sortkey, int32_t  ti, bool  noLv4, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method Level1, addr 0x1815cda50, size 0x70, virtual false, abstract: false, final false
inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x1815cdac0, size 0x110, virtual false, abstract: false, final false
inline uint8_t Level2(int32_t  cp, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext) ;

/// @brief Method MatchesBackward, addr 0x1815ce1a0, size 0x1d0, virtual false, abstract: false, final false
inline bool MatchesBackward(::StringW  s, ::by_ref<int32_t>  idx, int32_t  end, int32_t  orgStart, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesBackwardCore, addr 0x1815cdbd0, size 0x5d0, virtual false, abstract: false, final false
inline bool MatchesBackwardCore(::StringW  s, ::by_ref<int32_t>  idx, int32_t  end, int32_t  orgStart, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::by_ref<::Mono::Globalization::Unicode::Contraction*>  ct, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesForward, addr 0x1815ce760, size 0x1c0, virtual false, abstract: false, final false
inline bool MatchesForward(::StringW  s, ::by_ref<int32_t>  idx, int32_t  end, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesForwardCore, addr 0x1815ce370, size 0x3f0, virtual false, abstract: false, final false
inline bool MatchesForwardCore(::StringW  s, ::by_ref<int32_t>  idx, int32_t  end, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::by_ref<::Mono::Globalization::Unicode::Contraction*>  ct, ::by_ref<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesPrimitive, addr 0x1815ce920, size 0x160, virtual false, abstract: false, final false
inline bool MatchesPrimitive(::System::Globalization::CompareOptions  opt, uint8_t*  source, int32_t  si, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, uint8_t*  target, int32_t  ti, bool  noLv4) ;

static inline ::Mono::Globalization::Unicode::SimpleCollator* New_ctor(::System::Globalization::CultureInfo*  culture) ;

/// @brief Method QuickIndexOf, addr 0x1815cea80, size 0x150, virtual false, abstract: false, final false
inline int32_t QuickIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::by_ref<bool>  testWasUnable) ;

/// @brief Method SetCJKTable, addr 0x1815cebd0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x1815cece0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method ToDashTypeValue, addr 0x1815cecf0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815ced80, size 0x390, virtual false, abstract: false, final false
