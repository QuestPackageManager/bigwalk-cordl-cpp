...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::Level2Map*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::Level2Map*, "Mono.Globalization.Unicode", "Level2Map");
...
static_assert(sizeof(::Mono::Globalization::Unicode::Level2Map) == 0x18, "Size mismatch!");
