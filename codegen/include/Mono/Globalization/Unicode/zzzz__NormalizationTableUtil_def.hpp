...
/// @brief Method MapIdx, addr 0x1815c8370, size 0xa0, virtual false, abstract: false, final false
static inline int32_t MapIdx(int32_t  cp) ;

/// @brief Method PropIdx, addr 0x1815c8410, size 0xa0, virtual false, abstract: false, final false
