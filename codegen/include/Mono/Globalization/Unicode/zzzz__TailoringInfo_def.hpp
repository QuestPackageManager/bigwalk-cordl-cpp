...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::TailoringInfo*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::TailoringInfo*, "Mono.Globalization.Unicode", "TailoringInfo");
...
/// @brief Method .ctor, addr 0x180e83610, size 0x1a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Globalization::Unicode::TailoringInfo) == 0x20, "Size mismatch!");
