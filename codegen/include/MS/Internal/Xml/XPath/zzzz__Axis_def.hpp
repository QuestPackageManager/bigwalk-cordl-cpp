...
static_assert(offsetof(::MS::Internal::Xml::XPath::Axis_AxisType, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method .ctor, addr 0x181ccca80, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::Axis_AxisType  axisType, ::MS::Internal::Xml::XPath::AstNode*  input) ;

/// @brief Method .ctor, addr 0x181ccc9f0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_AbbrAxis, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_AbbrAxis() ;

/// @brief Method get_Input, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_NodeType, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ReturnType, addr 0x1802ee400, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::MS::Internal::Xml::XPath::AstNode_AstType get_Type() ;

/// @brief Method get_TypeOfAxis, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::Axis_AxisType get_TypeOfAxis() ;

/// @brief Method get_Urn, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Urn() ;

/// @brief Method set_Input, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_Input(::MS::Internal::Xml::XPath::AstNode*  value) ;

/// @brief Method set_Urn, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
