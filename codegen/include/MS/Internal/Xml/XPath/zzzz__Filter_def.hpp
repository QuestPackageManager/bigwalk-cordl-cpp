...
// Write type traits
MARK_REF_T(::MS::Internal::Xml::XPath::Filter*);
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Filter*, "MS.Internal.Xml.XPath", "Filter");
...
static_assert(sizeof(::MS::Internal::Xml::XPath::Filter) == 0x20, "Size mismatch!");
