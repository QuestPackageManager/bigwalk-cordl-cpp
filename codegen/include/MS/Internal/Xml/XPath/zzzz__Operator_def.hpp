...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Operator_Op, "MS.Internal.Xml.XPath", "Operator/Op");
...
static_assert(offsetof(::MS::Internal::Xml::XPath::Operator_Op, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::MS::Internal::Xml::XPath::Operator_Op) == 0x4, "Size mismatch!");
...
/// @brief Field s_invertOp, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_invertOp, put=setStaticF_s_invertOp)) ::ArrayW<::MS::Internal::Xml::XPath::Operator_Op>  s_invertOp;
...
/// @brief Method get_ReturnType, addr 0x181cccea0, size 0x20, virtual true, abstract: false, final false
