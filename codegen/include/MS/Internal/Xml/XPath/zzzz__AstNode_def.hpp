...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::AstNode_AstType, "MS.Internal.Xml.XPath", "AstNode/AstType");
...
static_assert(offsetof(::MS::Internal::Xml::XPath::AstNode_AstType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::MS::Internal::Xml::XPath::AstNode_AstType) == 0x4, "Size mismatch!");
