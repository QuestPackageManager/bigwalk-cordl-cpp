...
// Write type traits
MARK_REF_T(::MS::Internal::Xml::Cache::XPathNodeInfoAtom*);
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::Cache::XPathNodeInfoAtom*, "MS.Internal.Xml.Cache", "XPathNodeInfoAtom");
...
// Declarations
 ...
 __declspec(property(get=get_ParentPage)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>  ParentPage;

 __declspec(property(get=get_Prefix)) ::StringW  Prefix;

 __declspec(property(get=get_SiblingPage)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>  SiblingPage;
...
/// @brief Field _pageSibling, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__pageSibling, put=__cordl_internal_set__pageSibling)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>  _pageSibling;
...
constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> const& __cordl_internal_get__pageSibling() const;

constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>& __cordl_internal_get__pageSibling() ;
...
constexpr void __cordl_internal_set__pageSibling(::ArrayW<::MS::Internal::Xml::Cache::XPathNode>  value) ;
...
/// @brief Method get_LineNumberBase, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LineNumberBase() ;

/// @brief Method get_LinePositionBase, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_NamespaceUri, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_PageInfo, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo() ;

/// @brief Method get_ParentPage, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> get_ParentPage() ;

/// @brief Method get_Prefix, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SiblingPage, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> get_SiblingPage() ;
...
/// @brief Field _pageSibling, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>  ____pageSibling;
...
static_assert(sizeof(::MS::Internal::Xml::Cache::XPathNodeInfoAtom) == 0x50, "Size mismatch!");
