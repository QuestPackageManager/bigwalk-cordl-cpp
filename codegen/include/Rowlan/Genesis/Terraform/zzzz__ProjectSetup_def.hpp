#pragma once
// IWYU pragma private; include "Rowlan/Genesis/Terraform/ProjectSetup.hpp"
...
// Write type traits
MARK_REF_T(::Rowlan::Genesis::Terraform::ProjectSetup*);
DEFINE_IL2CPP_CLASS(::Rowlan::Genesis::Terraform::ProjectSetup*, "Rowlan.Genesis.Terraform", "ProjectSetup");
// Dependencies System.Object
namespace Rowlan::Genesis::Terraform {
// Is value type: false
// CS Name: Rowlan.Genesis.Terraform.ProjectSetup
...
static constexpr ::ConstString  MENU{u"Window/Genesis for MicroVerse/Terraform"};
...
static constexpr ::ConstString  SETTINGS_FILENAME{u"Terraform Settings.asset"};
...
static_assert(sizeof(::Rowlan::Genesis::Terraform::ProjectSetup) == 0x10, "Size mismatch!");
