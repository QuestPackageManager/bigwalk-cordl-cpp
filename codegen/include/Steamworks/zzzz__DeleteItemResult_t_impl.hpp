...
#include "Steamworks/zzzz__DeleteItemResult_t_def.hpp"
...
constexpr ::Steamworks::DeleteItemResult_t::DeleteItemResult_t(::Steamworks::EResult  m_eResult, ::Steamworks::PublishedFileId_t  m_nPublishedFileId) noexcept  {
this->m_eResult = m_eResult;
this->m_nPublishedFileId = m_nPublishedFileId;
}
// Ctor Parameters []
constexpr ::Steamworks::DeleteItemResult_t::DeleteItemResult_t()   {
}
