...
#include "Steamworks/zzzz__RemoveAppDependencyResult_t_def.hpp"
...
constexpr ::Steamworks::RemoveAppDependencyResult_t::RemoveAppDependencyResult_t(::Steamworks::EResult  m_eResult, ::Steamworks::PublishedFileId_t  m_nPublishedFileId, ::Steamworks::AppId_t  m_nAppID) noexcept  {
this->m_eResult = m_eResult;
this->m_nPublishedFileId = m_nPublishedFileId;
this->m_nAppID = m_nAppID;
}
// Ctor Parameters []
constexpr ::Steamworks::RemoveAppDependencyResult_t::RemoveAppDependencyResult_t()   {
}
