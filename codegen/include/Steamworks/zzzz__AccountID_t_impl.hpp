...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Steamworks::AccountID_t::*)(::System::Object*)>(&::Steamworks::AccountID_t::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x1805a8270;
...
//  Writing Method size for method: ::Steamworks::AccountID_t.op_Inequality
template<>

struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::Steamworks::AccountID_t, ::Steamworks::AccountID_t)>(&::Steamworks::AccountID_t::op_Inequality)> {
  constexpr static std::size_t size = 0x10;
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Steamworks::AccountID_t>(),
                        {"op_Inequality", {}, {::i2c::type_of<::Steamworks::AccountID_t>(), ::i2c::type_of<::Steamworks::AccountID_t>()}}
                    )));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::Steamworks::AccountID_t.op_Explicit___Steamworks__AccountID_t
template<>

struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Steamworks::AccountID_t (*)(uint32_t)>(&::Steamworks::AccountID_t::op_Explicit___Steamworks__AccountID_t)> {
  constexpr static std::size_t size = 0x10;
...
inline bool Steamworks::AccountID_t::op_Inequality(::Steamworks::AccountID_t  x, ::Steamworks::AccountID_t  y)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Steamworks::AccountID_t>(),
                        {"op_Inequality", {}, {::i2c::type_of<::Steamworks::AccountID_t>(), ::i2c::type_of<::Steamworks::AccountID_t>()}}
                    )));
...
inline ::Steamworks::AccountID_t Steamworks::AccountID_t::op_Explicit___Steamworks__AccountID_t(uint32_t  value)  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Steamworks::AccountID_t>(),
                        {"op_Explicit", {}, {::i2c::type_of<uint32_t>()}}
                    )));
return ::cordl_internals::RunMethodRethrow<::Steamworks::AccountID_t>(nullptr, ___internal_method, value);
}
...
// Ctor Parameters [CppParam { name: "m_AccountID", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
