...
#include "Steamworks/zzzz__CreateItemResult_t_def.hpp"
...
constexpr ::Steamworks::CreateItemResult_t::CreateItemResult_t(::Steamworks::EResult  m_eResult, ::Steamworks::PublishedFileId_t  m_nPublishedFileId, bool  m_bUserNeedsToAcceptWorkshopLegalAgreement) noexcept  {
...
// Ctor Parameters []
constexpr ::Steamworks::CreateItemResult_t::CreateItemResult_t()   {
}
