...
// Ctor Parameters [CppParam { name: "m_unAppID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_ulOrderID", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "m_bAuthorized", ty: "uint8_t", modifiers: "", def_value: None }]
...
/// @brief Field m_bAuthorized, offset: 0x10, size: 0x1, def value: None
...
static_assert(offsetof(::Steamworks::MicroTxnAuthorizationResponse_t, m_ulOrderID) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Steamworks::MicroTxnAuthorizationResponse_t, m_bAuthorized) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Steamworks::MicroTxnAuthorizationResponse_t) == 0x18, "Size mismatch!");
