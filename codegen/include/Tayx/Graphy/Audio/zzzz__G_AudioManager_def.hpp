...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Audio::G_AudioManager*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Audio::G_AudioManager*, "Tayx.Graphy.Audio", "G_AudioManager");
...
/// @brief Field m_childrenGameObjects, offset 0x68, size 0x8 
...
/// @brief Field m_currentModuleState, offset 0x74, size 0x4 
...
/// @brief Field m_origPosition, offset 0x60, size 0x8 
...
/// @brief Field m_previousModuleState, offset 0x70, size 0x4 
...
/// @brief Method Awake, addr 0x181e4dad0, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e4dae0, size 0x330, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor() ;

/// @brief Method RefreshParameters, addr 0x181e4de10, size 0x110, virtual false, abstract: false, final false
inline void RefreshParameters() ;

/// @brief Method RestorePreviousState, addr 0x181e4df20, size 0x10, virtual false, abstract: false, final false
inline void RestorePreviousState() ;

/// @brief Method SetGraphActive, addr 0x181e4df30, size 0x50, virtual false, abstract: false, final false
inline void SetGraphActive(bool  active) ;

/// @brief Method SetPosition, addr 0x181e4df80, size 0x2a0, virtual true, abstract: false, final true
inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition  newModulePosition, ::UnityEngine::Vector2  offset) ;

/// @brief Method SetState, addr 0x181e4e220, size 0x250, virtual true, abstract: false, final true
inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState  state, bool  silentUpdate) ;

/// @brief Method Start, addr 0x181e4e470, size 0x10, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateParameters, addr 0x181e4e480, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e4e590, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_origPosition, offset: 0x60, size: 0x8, def value: None
 ::UnityEngine::Vector2  ___m_origPosition;

/// @brief Field m_childrenGameObjects, offset: 0x68, size: 0x8, def value: None
 ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*  ___m_childrenGameObjects;

/// @brief Field m_previousModuleState, offset: 0x70, size: 0x4, def value: None
 ::Tayx::Graphy::GraphyManager_ModuleState  ___m_previousModuleState;

/// @brief Field m_currentModuleState, offset: 0x74, size: 0x4, def value: None
...
static_assert(offsetof(::Tayx::Graphy::Audio::G_AudioManager, ___m_origPosition) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Audio::G_AudioManager, ___m_childrenGameObjects) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Audio::G_AudioManager, ___m_previousModuleState) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Audio::G_AudioManager, ___m_currentModuleState) == 0x74, "Offset mismatch!");

static_assert(sizeof(::Tayx::Graphy::Audio::G_AudioManager) == 0x78, "Size mismatch!");
