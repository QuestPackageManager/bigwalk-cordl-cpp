...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Audio::G_AudioGraph*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Audio::G_AudioGraph*, "Tayx.Graphy.Audio", "G_AudioGraph");
...
/// @brief Field m_graphArray, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_graphArray, put=__cordl_internal_set_m_graphArray)) ::ArrayW<float_t>  m_graphArray;

/// @brief Field m_graphArrayHighestValue, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_graphArrayHighestValue, put=__cordl_internal_set_m_graphArrayHighestValue)) ::ArrayW<float_t>  m_graphArrayHighestValue;
...
/// @brief Method CreatePoints, addr 0x181e4ccd0, size 0x550, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x181e4d220, size 0x130, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor() ;

/// @brief Method OnEnable, addr 0x181e4d350, size 0x30, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x181e4da70, size 0x50, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x181e4d380, size 0x4f0, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x181e4d870, size 0x200, virtual false, abstract: false, final false
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_graphArray() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_graphArray() ;

constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_graphArrayHighestValue() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_graphArrayHighestValue() ;
...
constexpr void __cordl_internal_set_m_graphArray(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set_m_graphArrayHighestValue(::ArrayW<float_t>  value) ;
...
/// @brief Method .ctor, addr 0x181e4dac0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_graphArray, offset: 0x70, size: 0x8, def value: None
 ::ArrayW<float_t>  ___m_graphArray;

/// @brief Field m_graphArrayHighestValue, offset: 0x78, size: 0x8, def value: None
 ::ArrayW<float_t>  ___m_graphArrayHighestValue;
...
static_assert(sizeof(::Tayx::Graphy::Audio::G_AudioGraph) == 0x80, "Size mismatch!");
