...
/// @brief Method Dispose, addr 0x181e517b0, size 0x80, virtual false, abstract: false, final false
static inline void Dispose() ;

/// @brief Method Init, addr 0x181e51830, size 0x1f0, virtual false, abstract: false, final false
static inline void Init(int32_t  minNegativeValue, int32_t  maxPositiveValue) ;

/// @brief Method ToStringNonAlloc, addr 0x181e51a20, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_MaxValue, addr 0x181e51b20, size 0x30, virtual false, abstract: false, final false
static inline int32_t get_MaxValue() ;

/// @brief Method get_MinValue, addr 0x181e51b50, size 0x30, virtual false, abstract: false, final false
