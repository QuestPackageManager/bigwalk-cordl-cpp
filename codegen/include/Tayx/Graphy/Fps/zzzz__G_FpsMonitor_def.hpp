...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Fps::G_FpsMonitor*);
...
/// @brief Method <Update>b__25_0, addr 0x1813d8740, size 0x9cc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Tayx::Graphy::Fps::G_FpsMonitor___c) == 0x10, "Size mismatch!");
...
/// @brief Field m_fpsSamples, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_fpsSamples, put=__cordl_internal_set_m_fpsSamples)) ::ArrayW<int16_t>  m_fpsSamples;
...
/// @brief Field m_fpsSamplesSorted, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_fpsSamplesSorted, put=__cordl_internal_set_m_fpsSamplesSorted)) ::ArrayW<int16_t>  m_fpsSamplesSorted;
...
/// @brief Method Awake, addr 0x181e508e0, size 0x90, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e508e0, size 0x90, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsMonitor* New_ctor() ;

/// @brief Method Update, addr 0x181e509b0, size 0x290, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x181e50970, size 0x40, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int16_t> const& __cordl_internal_get_m_fpsSamples() const;

constexpr ::ArrayW<int16_t>& __cordl_internal_get_m_fpsSamples() ;
...
constexpr ::ArrayW<int16_t> const& __cordl_internal_get_m_fpsSamplesSorted() const;

constexpr ::ArrayW<int16_t>& __cordl_internal_get_m_fpsSamplesSorted() ;
...
constexpr void __cordl_internal_set_m_fpsSamples(::ArrayW<int16_t>  value) ;
...
constexpr void __cordl_internal_set_m_fpsSamplesSorted(::ArrayW<int16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181e50c40, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AverageFPS, addr 0x181e50c60, size 0x10, virtual false, abstract: false, final false
inline int16_t get_AverageFPS() ;

/// @brief Method get_CurrentFPS, addr 0x181e50c70, size 0x10, virtual false, abstract: false, final false
inline int16_t get_CurrentFPS() ;

/// @brief Method get_OnePercentFPS, addr 0x181e50c80, size 0x10, virtual false, abstract: false, final false
inline int16_t get_OnePercentFPS() ;

/// @brief Method get_Zero1PercentFps, addr 0x181e50c90, size 0x10, virtual false, abstract: false, final false
inline int16_t get_Zero1PercentFps() ;

/// @brief Method set_AverageFPS, addr 0x181e50ca0, size 0x10, virtual false, abstract: false, final false
inline void set_AverageFPS(int16_t  value) ;

/// @brief Method set_CurrentFPS, addr 0x181e50cb0, size 0x10, virtual false, abstract: false, final false
inline void set_CurrentFPS(int16_t  value) ;

/// @brief Method set_OnePercentFPS, addr 0x181e50cc0, size 0x10, virtual false, abstract: false, final false
inline void set_OnePercentFPS(int16_t  value) ;

/// @brief Method set_Zero1PercentFps, addr 0x181e50cd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_fpsSamples, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<int16_t>  ___m_fpsSamples;

/// @brief Field m_fpsSamplesSorted, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<int16_t>  ___m_fpsSamplesSorted;
...
static_assert(sizeof(::Tayx::Graphy::Fps::G_FpsMonitor) == 0x48, "Size mismatch!");
