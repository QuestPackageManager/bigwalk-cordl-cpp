...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Fps::G_FpsGraph*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Fps::G_FpsGraph*, "Tayx.Graphy.Fps", "G_FpsGraph");
...
/// @brief Field m_fpsArray, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_fpsArray, put=__cordl_internal_set_m_fpsArray)) ::ArrayW<int32_t>  m_fpsArray;
...
/// @brief Method CreatePoints, addr 0x181e4f560, size 0x190, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x181e4f6f0, size 0xe0, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method UpdateGraph, addr 0x181e4f7d0, size 0x440, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x181e4fc10, size 0x120, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_fpsArray() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_fpsArray() ;
...
constexpr void __cordl_internal_set_m_fpsArray(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x181e4fd30, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::Tayx::Graphy::Fps::G_FpsGraph) == 0x70, "Size mismatch!");
