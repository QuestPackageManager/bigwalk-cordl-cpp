...
// Write type traits
MARK_REF_T(::Tayx::Graphy::Fps::G_FpsManager*);
DEFINE_IL2CPP_CLASS(::Tayx::Graphy::Fps::G_FpsManager*, "Tayx.Graphy.Fps", "G_FpsManager");
...
/// @brief Method Awake, addr 0x181e4fd40, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x181e4fd50, size 0x330, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsManager* New_ctor() ;

/// @brief Method RefreshParameters, addr 0x181e50080, size 0x140, virtual false, abstract: false, final false
inline void RefreshParameters() ;

/// @brief Method RestorePreviousState, addr 0x181e501c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetPosition, addr 0x181e501d0, size 0x290, virtual true, abstract: false, final true
inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition  newModulePosition, ::UnityEngine::Vector2  offset) ;

/// @brief Method SetState, addr 0x181e50460, size 0x270, virtual true, abstract: false, final true
inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState  state, bool  silentUpdate) ;

/// @brief Method Start, addr 0x181e506d0, size 0x10, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateParameters, addr 0x181e506e0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e50820, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::Tayx::Graphy::Fps::G_FpsManager, ___m_origPosition) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Fps::G_FpsManager, ___m_childrenGameObjects) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Fps::G_FpsManager, ___m_previousModuleState) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Tayx::Graphy::Fps::G_FpsManager, ___m_currentModuleState) == 0x74, "Offset mismatch!");

static_assert(sizeof(::Tayx::Graphy::Fps::G_FpsManager) == 0x78, "Size mismatch!");
