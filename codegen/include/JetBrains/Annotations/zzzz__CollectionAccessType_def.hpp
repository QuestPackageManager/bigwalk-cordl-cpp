...
static_assert(offsetof(::JetBrains::Annotations::CollectionAccessType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::JetBrains::Annotations::CollectionAccessType) == 0x4, "Size mismatch!");
