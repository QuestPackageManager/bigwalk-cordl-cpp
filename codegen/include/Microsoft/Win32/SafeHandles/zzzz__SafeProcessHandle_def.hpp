...
/// @brief Method ReleaseHandle, addr 0x181dbfdb0, size 0x10, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method .ctor, addr 0x181dbfe50, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  existingHandle, bool  ownsHandle) ;

/// @brief Method .ctor, addr 0x181dbfe20, size 0x30, virtual false, abstract: false, final false
