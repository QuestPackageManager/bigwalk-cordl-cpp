...
public:
// Declarations
/// @brief Method CreateJobReflectionData, addr 0x1820bc800, size 0x210, virtual false, abstract: false, final false
static inline void CreateJobReflectionData() ;

/// @brief Method EarlyInit, addr 0x1820bca10, size 0x10, virtual false, abstract: false, final false
