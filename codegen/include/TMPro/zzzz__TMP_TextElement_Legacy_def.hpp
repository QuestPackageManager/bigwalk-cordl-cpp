...
// Write type traits
MARK_REF_T(::TMPro::TMP_TextElement_Legacy*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_TextElement_Legacy*, "TMPro", "TMP_TextElement_Legacy");
...
static_assert(sizeof(::TMPro::TMP_TextElement_Legacy) == 0x38, "Size mismatch!");
