...
DEFINE_IL2CPP_CLASS(::TMPro::TextOverflowModes, "TMPro", "TextOverflowModes");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TextOverflowModes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextOverflowModes) == 0x4, "Size mismatch!");
