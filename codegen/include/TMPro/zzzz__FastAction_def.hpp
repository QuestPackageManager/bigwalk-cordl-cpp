...
// Write type traits
MARK_REF_T(::TMPro::FastAction*);
DEFINE_IL2CPP_CLASS(::TMPro::FastAction*, "TMPro", "FastAction");
...
/// @brief Field lookup, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_lookup, put=__cordl_internal_set_lookup)) ::System::Collections::Generic::Dictionary_2<::System::Action*,::System::Collections::Generic::LinkedListNode_1<::System::Action*>*>*  lookup;

/// @brief Method Add, addr 0x1821849c0, size 0x70, virtual false, abstract: false, final false
inline void Add(::System::Action*  rhs) ;

/// @brief Method Call, addr 0x182184a30, size 0x50, virtual false, abstract: false, final false
inline void Call() ;

static inline ::TMPro::FastAction* New_ctor() ;

/// @brief Method Remove, addr 0x182184a80, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182184af0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::TMPro::FastAction) == 0x20, "Size mismatch!");
