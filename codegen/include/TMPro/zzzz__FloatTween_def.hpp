...
// Write type traits
MARK_REF_T(::TMPro::FloatTween_FloatTweenCallback*);
MARK_VAL_T(::TMPro::FloatTween);
DEFINE_IL2CPP_CLASS(::TMPro::FloatTween_FloatTweenCallback*, "TMPro", "FloatTween/FloatTweenCallback");
DEFINE_IL2CPP_CLASS(::TMPro::FloatTween, "TMPro", "FloatTween");
...
static_assert(sizeof(::TMPro::FloatTween_FloatTweenCallback) == 0x30, "Size mismatch!");
...
/// @brief Method AddOnChangedCallback, addr 0x182184b60, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::FloatTween) == 0x18, "Size mismatch!");
