...
/// @brief Method InternalRegisterCanvasElementForGraphicRebuild, addr 0x1821ee4b0, size 0x120, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalRegisterCanvasElementForLayoutRebuild, addr 0x1821ee5d0, size 0x120, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild, addr 0x1821ee6f0, size 0xa0, virtual false, abstract: false, final false
inline void InternalUnRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild, addr 0x1821ee790, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method PerformUpdateForCanvasRendererObjects, addr 0x1821ee830, size 0x200, virtual false, abstract: false, final false
inline void PerformUpdateForCanvasRendererObjects() ;

/// @brief Method PerformUpdateForMeshRendererObjects, addr 0x1821eea30, size 0x10, virtual false, abstract: false, final false
inline void PerformUpdateForMeshRendererObjects() ;

/// @brief Method RegisterCanvasElementForGraphicRebuild, addr 0x1821eea40, size 0x100, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method RegisterCanvasElementForLayoutRebuild, addr 0x1821eeb40, size 0x100, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method UnRegisterCanvasElementForRebuild, addr 0x1821eec40, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1821eed80, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::TMPro::TMP_UpdateRegistry* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x1821eee80, size 0x160, virtual false, abstract: false, final false
