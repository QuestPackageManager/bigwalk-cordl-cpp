...
// Write type traits
MARK_REF_T(::TMPro::TMP_InputValidator*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_InputValidator*, "TMPro", "TMP_InputValidator");
...
static_assert(sizeof(::TMPro::TMP_InputValidator) == 0x18, "Size mismatch!");
