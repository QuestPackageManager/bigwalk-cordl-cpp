...
DEFINE_IL2CPP_CLASS(::TMPro::MarkToBaseAdjustmentRecord, "TMPro", "MarkToBaseAdjustmentRecord");
...
// Ctor Parameters [CppParam { name: "m_BaseGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_BaseGlyphAnchorPoint", ty: "::TMPro::GlyphAnchorPoint", modifiers: "", def_value: None }, CppParam { name: "m_MarkGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_MarkPositionAdjustment", ty: "::TMPro::MarkPositionAdjustment", modifiers: "", def_value: None }]
constexpr MarkToBaseAdjustmentRecord(uint32_t  m_BaseGlyphID, ::TMPro::GlyphAnchorPoint  m_BaseGlyphAnchorPoint, uint32_t  m_MarkGlyphID, ::TMPro::MarkPositionAdjustment  m_MarkPositionAdjustment) noexcept;
...
static_assert(sizeof(::TMPro::MarkToBaseAdjustmentRecord) == 0x18, "Size mismatch!");
