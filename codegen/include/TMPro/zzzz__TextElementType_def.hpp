...
DEFINE_IL2CPP_CLASS(::TMPro::TextElementType, "TMPro", "TextElementType");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::TextElementType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::TMPro::TextElementType) == 0x1, "Size mismatch!");
