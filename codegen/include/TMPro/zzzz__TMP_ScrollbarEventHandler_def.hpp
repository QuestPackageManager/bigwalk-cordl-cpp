...
// Write type traits
MARK_REF_T(::TMPro::TMP_ScrollbarEventHandler*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_ScrollbarEventHandler*, "TMPro", "TMP_ScrollbarEventHandler");
...
/// @brief Method OnDeselect, addr 0x1821ce8c0, size 0x30, virtual true, abstract: false, final true
inline void OnDeselect(::UnityEngine::EventSystems::BaseEventData*  eventData) ;

/// @brief Method OnPointerClick, addr 0x1821ce8f0, size 0x10, virtual true, abstract: false, final true
inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnSelect, addr 0x1821ce900, size 0x30, virtual true, abstract: false, final true
...
static_assert(sizeof(::TMPro::TMP_ScrollbarEventHandler) == 0x28, "Size mismatch!");
