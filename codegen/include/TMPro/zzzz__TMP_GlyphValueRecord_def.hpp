...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_GlyphValueRecord, "TMPro", "TMP_GlyphValueRecord");
// Dependencies 
namespace TMPro {
// Is value type: true
...
/// @brief Method .ctor, addr 0x182194a20, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method set_yAdvance, addr 0x18051eaf0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_GlyphValueRecord) == 0x10, "Size mismatch!");
