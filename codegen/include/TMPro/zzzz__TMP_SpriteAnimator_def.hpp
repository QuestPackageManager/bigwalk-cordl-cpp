...
// Write type traits
MARK_REF_T(::TMPro::TMP_SpriteAnimator*);
MARK_REF_T(::TMPro::TMP_SpriteAnimator__DoSpriteAnimationInternal_d__7*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_SpriteAnimator*, "TMPro", "TMP_SpriteAnimator");
DEFINE_IL2CPP_CLASS(::TMPro::TMP_SpriteAnimator__DoSpriteAnimationInternal_d__7*, "TMPro", "TMP_SpriteAnimator/<DoSpriteAnimationInternal>d__7");
// Dependencies System.Object, TMPro.TMP_CharacterInfo, TMPro.TMP_MeshInfo
namespace TMPro {
// Is value type: false
...
/// @brief Method MoveNext, addr 0x1821d4ed0, size 0xa80, virtual true, abstract: false, final true
...
static_assert(sizeof(::TMPro::TMP_SpriteAnimator__DoSpriteAnimationInternal_d__7) == 0x228, "Size mismatch!");
...
/// @brief Method Awake, addr 0x1821cf630, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DoSpriteAnimation, addr 0x1821cf6f0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method DoSpriteAnimationInternal, addr 0x1821cf660, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method StopAllAnimations, addr 0x1821cf7b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1821cf7d0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::TMPro::TMP_SpriteAnimator) == 0x30, "Size mismatch!");
