...
DEFINE_IL2CPP_CLASS(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_Frame, "TMPro.SpriteAssetUtilities", "TexturePacker_JsonArray/Frame");
DEFINE_IL2CPP_CLASS(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_Meta, "TMPro.SpriteAssetUtilities", "TexturePacker_JsonArray/Meta");
DEFINE_IL2CPP_CLASS(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteFrame, "TMPro.SpriteAssetUtilities", "TexturePacker_JsonArray/SpriteFrame");
DEFINE_IL2CPP_CLASS(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize, "TMPro.SpriteAssetUtilities", "TexturePacker_JsonArray/SpriteSize");
// Dependencies 
namespace TMPro::SpriteAssetUtilities {
// Is value type: true
...
public:
// Declarations
/// @brief Method ToString, addr 0x1821fdcf0, size 0x120, virtual true, abstract: false, final false
...
static_assert(sizeof(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteFrame) == 0x10, "Size mismatch!");
...
public:
// Declarations
/// @brief Method ToString, addr 0x1821fde10, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
static_assert(sizeof(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize) == 0x8, "Size mismatch!");
...
static_assert(sizeof(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_Frame) == 0x40, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "app", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "version", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "image", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "format", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "size", ty: "::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize", modifiers: "", def_value: None }, CppParam { name: "scale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "smartupdate", ty: "::StringW", modifiers: "", def_value: None }]
constexpr TexturePacker_JsonArray_Meta(::StringW  app, ::StringW  version, ::StringW  image, ::StringW  format, ::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_SpriteSize  size, float_t  scale, ::StringW  smartupdate) noexcept;
...
static_assert(sizeof(::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_Meta) == 0x38, "Size mismatch!");
...
/// @brief Field frames, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_frames, put=__cordl_internal_set_frames)) ::System::Collections::Generic::List_1<::TMPro::SpriteAssetUtilities::TexturePacker_JsonArray_Frame>*  frames;
