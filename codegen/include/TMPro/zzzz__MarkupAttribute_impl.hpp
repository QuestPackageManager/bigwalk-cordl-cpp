...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::TMPro::MarkupAttribute::*)()>(&::TMPro::MarkupAttribute::get_NameHashCode)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::TMPro::MarkupAttribute>(),
                        {"get_NameHashCode", {}, {}}
                    )));
...
// Ctor Parameters [CppParam { name: "m_NameHashCode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ValueHashCode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ValueStartIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ValueLength", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
