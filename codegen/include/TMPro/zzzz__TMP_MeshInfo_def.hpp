...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_MeshInfo, "TMPro", "TMP_MeshInfo");
// Dependencies UnityEngine.Bounds, UnityEngine.Color32, UnityEngine.Vector2, UnityEngine.Vector3, UnityEngine.Vector4
namespace TMPro {
// Is value type: true
...
/// @brief Method Clear, addr 0x1821cc240, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Clear, addr 0x1821cc2b0, size 0xe0, virtual false, abstract: false, final false
inline void Clear(bool  uploadChanges) ;

/// @brief Method ClearUnusedVertices, addr 0x1821cc210, size 0x30, virtual false, abstract: false, final false
inline void ClearUnusedVertices() ;

/// @brief Method ClearUnusedVertices, addr 0x1821cc170, size 0x30, virtual false, abstract: false, final false
inline void ClearUnusedVertices(int32_t  startIndex) ;

/// @brief Method ClearUnusedVertices, addr 0x1821cc1a0, size 0x70, virtual false, abstract: false, final false
inline void ClearUnusedVertices(int32_t  startIndex, bool  updateMesh) ;

/// @brief Method ResizeMeshInfo, addr 0x1821cc390, size 0x320, virtual false, abstract: false, final false
inline void ResizeMeshInfo(int32_t  size) ;

/// @brief Method ResizeMeshInfo, addr 0x1821cc6b0, size 0x6a0, virtual false, abstract: false, final false
inline void ResizeMeshInfo(int32_t  size, bool  isVolumetric) ;

/// @brief Method SortGeometry, addr 0x1821ccd50, size 0x90, virtual false, abstract: false, final false
inline void SortGeometry(::TMPro::VertexSortingOrder  order) ;

/// @brief Method SortGeometry, addr 0x1821ccde0, size 0x130, virtual false, abstract: false, final false
inline void SortGeometry(::System::Collections::Generic::IList_1<int32_t>*  sortingOrder) ;

/// @brief Method SwapVertexData, addr 0x1821ccf10, size 0x440, virtual false, abstract: false, final false
inline void SwapVertexData(int32_t  src, int32_t  dst) ;

/// @brief Method .ctor, addr 0x1821cd3e0, size 0x3e0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Mesh*  mesh, int32_t  size) ;

/// @brief Method .ctor, addr 0x1821cd7c0, size 0x6e0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "mesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: None }, CppParam { name: "vertexCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "vertices", ty: "::ArrayW<::UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "normals", ty: "::ArrayW<::UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "tangents", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "uvs0", ty: "::ArrayW<::UnityEngine::Vector4>", modifiers: "", def_value: None }, CppParam { name: "uvs2", ty: "::ArrayW<::UnityEngine::Vector2>", modifiers: "", def_value: None }, CppParam { name: "colors32", ty: "::ArrayW<::UnityEngine::Color32>", modifiers: "", def_value: None }, CppParam { name: "triangles", ty: "::ArrayW<int32_t>", modifiers: "", def_value: None }, CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }]
constexpr TMP_MeshInfo(::UnityW<::UnityEngine::Mesh>  mesh, int32_t  vertexCount, ::ArrayW<::UnityEngine::Vector3>  vertices, ::ArrayW<::UnityEngine::Vector3>  normals, ::ArrayW<::UnityEngine::Vector4>  tangents, ::ArrayW<::UnityEngine::Vector4>  uvs0, ::ArrayW<::UnityEngine::Vector2>  uvs2, ::ArrayW<::UnityEngine::Color32>  colors32, ::ArrayW<int32_t>  triangles, ::UnityW<::UnityEngine::Material>  material) noexcept;
...
static_assert(sizeof(::TMPro::TMP_MeshInfo) == 0x50, "Size mismatch!");
