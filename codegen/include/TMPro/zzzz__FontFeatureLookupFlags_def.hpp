...
DEFINE_IL2CPP_CLASS(::TMPro::FontFeatureLookupFlags, "TMPro", "FontFeatureLookupFlags");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::FontFeatureLookupFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::FontFeatureLookupFlags) == 0x4, "Size mismatch!");
