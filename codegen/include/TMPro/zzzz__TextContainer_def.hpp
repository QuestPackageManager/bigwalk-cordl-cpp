...
/// @brief Field m_worldCorners, offset 0x50, size 0x8 
 ...
 __declspec(property(get=get_worldCorners)) ::ArrayW<::UnityEngine::Vector3>  worldCorners;

/// @brief Method Awake, addr 0x1821eff90, size 0x50, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetAnchorPosition, addr 0x1821effe0, size 0x210, virtual false, abstract: false, final false
inline ::TMPro::TextContainerAnchors GetAnchorPosition(::UnityEngine::Vector2  pivot) ;

/// @brief Method GetPivot, addr 0x1821f01f0, size 0xe0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetPivot(::TMPro::TextContainerAnchors  anchor) ;

static inline ::TMPro::TextContainer* New_ctor() ;

/// @brief Method OnContainerChanged, addr 0x1821f02d0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x1821f0490, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x1821f04a0, size 0x200, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method SetRect, addr 0x1821f06a0, size 0x50, virtual false, abstract: false, final false
inline void SetRect(::UnityEngine::Vector2  size) ;

/// @brief Method UpdateCorners, addr 0x1821f06f0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1821f0820, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Vector2 getStaticF_k_defaultSize() ;

/// @brief Method get_anchorPosition, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline ::TMPro::TextContainerAnchors get_anchorPosition() ;

/// @brief Method get_corners, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3> get_corners() ;

/// @brief Method get_hasChanged, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_hasChanged() ;

/// @brief Method get_height, addr 0x1802e2d90, size 0x10, virtual false, abstract: false, final false
inline float_t get_height() ;

/// @brief Method get_isAutoFitting, addr 0x1818e79f0, size 0x10, virtual false, abstract: false, final false
inline bool get_isAutoFitting() ;

/// @brief Method get_isDefaultHeight, addr 0x180391c80, size 0x10, virtual false, abstract: false, final false
inline bool get_isDefaultHeight() ;

/// @brief Method get_isDefaultWidth, addr 0x180391c90, size 0x10, virtual false, abstract: false, final false
inline bool get_isDefaultWidth() ;

/// @brief Method get_margins, addr 0x181454250, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_margins() ;

/// @brief Method get_pivot, addr 0x1821f0890, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_pivot() ;

/// @brief Method get_rect, addr 0x1802e30e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rect() ;

/// @brief Method get_rectTransform, addr 0x1821f08a0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_size, addr 0x18143b850, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_size() ;

/// @brief Method get_textMeshPro, addr 0x1821f08f0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TextMeshPro> get_textMeshPro() ;

/// @brief Method get_width, addr 0x1802f7fd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_width() ;

/// @brief Method get_worldCorners, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3> get_worldCorners() ;

static inline void setStaticF_k_defaultSize(::UnityEngine::Vector2  value) ;

/// @brief Method set_anchorPosition, addr 0x1821f0940, size 0xd0, virtual false, abstract: false, final false
inline void set_anchorPosition(::TMPro::TextContainerAnchors  value) ;

/// @brief Method set_hasChanged, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_hasChanged(bool  value) ;

/// @brief Method set_height, addr 0x1821f0a10, size 0x50, virtual false, abstract: false, final false
inline void set_height(float_t  value) ;

/// @brief Method set_isAutoFitting, addr 0x181c85a10, size 0x10, virtual false, abstract: false, final false
inline void set_isAutoFitting(bool  value) ;

/// @brief Method set_margins, addr 0x1821f0a60, size 0x90, virtual false, abstract: false, final false
inline void set_margins(::UnityEngine::Vector4  value) ;

/// @brief Method set_pivot, addr 0x1821f0af0, size 0x80, virtual false, abstract: false, final false
inline void set_pivot(::UnityEngine::Vector2  value) ;

/// @brief Method set_rect, addr 0x1821f0b70, size 0x60, virtual false, abstract: false, final false
inline void set_rect(::UnityEngine::Rect  value) ;

/// @brief Method set_size, addr 0x1821f0bd0, size 0x90, virtual false, abstract: false, final false
inline void set_size(::UnityEngine::Vector2  value) ;

/// @brief Method set_width, addr 0x1821f0c60, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TextContainer) == 0x78, "Size mismatch!");
