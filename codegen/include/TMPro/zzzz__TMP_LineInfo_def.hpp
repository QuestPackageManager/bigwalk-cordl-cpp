...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_LineInfo, "TMPro", "TMP_LineInfo");
...
static_assert(offsetof(::TMPro::TMP_LineInfo, visibleSpaceCount) == 0x10, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, wordCount) == 0x14, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, firstCharacterIndex) == 0x18, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, firstVisibleCharacterIndex) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, lastCharacterIndex) == 0x20, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, lastVisibleCharacterIndex) == 0x24, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, length) == 0x28, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, lineHeight) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, ascender) == 0x30, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, baseline) == 0x34, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, descender) == 0x38, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, maxAdvance) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, width) == 0x40, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, marginLeft) == 0x44, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, marginRight) == 0x48, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, alignment) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::TMPro::TMP_LineInfo, lineExtents) == 0x50, "Offset mismatch!");

static_assert(sizeof(::TMPro::TMP_LineInfo) == 0x60, "Size mismatch!");
