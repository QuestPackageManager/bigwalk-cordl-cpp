...
DEFINE_IL2CPP_CLASS(::TMPro::MaskingTypes, "TMPro", "MaskingTypes");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::MaskingTypes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::MaskingTypes) == 0x4, "Size mismatch!");
