...
/// @brief Method <SortCharacterTable>b__33_0, addr 0x182194540, size 0x10, virtual false, abstract: false, final false
inline uint32_t _SortCharacterTable_b__33_0(::TMPro::TMP_SpriteCharacter*  c) ;

/// @brief Method <SortGlyphTable>b__32_0, addr 0x180a21260, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x1821cf830, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetDefaultSpriteMaterial, addr 0x1821cf880, size 0xa0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetDefaultSpriteMaterial() ;

/// @brief Method GetSpriteIndexFromHashcode, addr 0x1821cf920, size 0x60, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromHashcode(int32_t  hashCode) ;

/// @brief Method GetSpriteIndexFromName, addr 0x1821cf980, size 0x80, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromName(::StringW  name) ;

/// @brief Method GetSpriteIndexFromUnicode, addr 0x1821cfa00, size 0x70, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromUnicode(uint32_t  unicode) ;

static inline ::TMPro::TMP_SpriteAsset* New_ctor() ;

/// @brief Method SearchForSpriteByHashCode, addr 0x1821cfc30, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x1821cfa70, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x1821cfb40, size 0xf0, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_SpriteAsset> SearchForSpriteByHashCodeInternal(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_SpriteAsset>>*  spriteAssets, int32_t  hashCode, bool  searchFallbacks, ::by_ref<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicode, addr 0x1821d0090, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x1821cffc0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x1821cfed0, size 0xf0, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_SpriteAsset> SearchForSpriteByUnicodeInternal(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_SpriteAsset>>*  spriteAssets, uint32_t  unicode, bool  includeFallbacks, ::by_ref<int32_t>  spriteIndex) ;

/// @brief Method SortCharacterTable, addr 0x1821d0210, size 0x110, virtual false, abstract: false, final false
inline void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables, addr 0x1821d0320, size 0x1e0, virtual false, abstract: false, final false
inline void SortGlyphAndCharacterTables() ;

/// @brief Method SortGlyphTable, addr 0x1821d0500, size 0x110, virtual false, abstract: false, final false
inline void SortGlyphTable() ;

/// @brief Method UpdateLookupTables, addr 0x1821d0610, size 0x3b0, virtual false, abstract: false, final false
inline void UpdateLookupTables() ;

/// @brief Method UpgradeSpriteAsset, addr 0x1821d09c0, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1821d0d50, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::HashSet_1<int32_t>* getStaticF_k_searchedSpriteAssets() ;

/// @brief Method get_spriteCharacterLookupTable, addr 0x1821d0de0, size 0x40, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterLookupTable() ;

/// @brief Method get_spriteCharacterTable, addr 0x1821d0e20, size 0x40, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterTable() ;

/// @brief Method get_spriteGlyphTable, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_spriteCharacterLookupTable, addr 0x1803d9970, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_spriteCharacterTable, addr 0x180322790, size 0x20, virtual false, abstract: false, final false
inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>*  value) ;

/// @brief Method set_spriteGlyphTable, addr 0x1803d3a10, size 0x20, virtual false, abstract: false, final false
