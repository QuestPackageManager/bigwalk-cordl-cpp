...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_WordInfo, "TMPro", "TMP_WordInfo");
// Dependencies 
namespace TMPro {
// Is value type: true
...
public:
// Declarations
/// @brief Method GetWord, addr 0x1821eefe0, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_WordInfo) == 0x18, "Size mismatch!");
