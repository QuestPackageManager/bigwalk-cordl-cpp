...
DEFINE_IL2CPP_CLASS(::TMPro::MarkupTag, "TMPro", "MarkupTag");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::MarkupTag, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::MarkupTag) == 0x4, "Size mismatch!");
