...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (::TMPro::MarkToMarkAdjustmentRecord::*)()>(&::TMPro::MarkToMarkAdjustmentRecord::get_baseMarkGlyphID)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::TMPro::MarkToMarkAdjustmentRecord>(),
                        {"get_baseMarkGlyphID", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::TMPro::MarkToMarkAdjustmentRecord::*)(::TMPro::GlyphAnchorPoint)>(&::TMPro::MarkToMarkAdjustmentRecord::set_baseMarkGlyphAnchorPoint)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::TMPro::MarkToMarkAdjustmentRecord>(),
                        {"set_baseMarkGlyphAnchorPoint", {}, {::i2c::type_of<::TMPro::GlyphAnchorPoint>()}}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::TMPro::MarkPositionAdjustment (::TMPro::MarkToMarkAdjustmentRecord::*)()>(&::TMPro::MarkToMarkAdjustmentRecord::get_combiningMarkPositionAdjustment)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::TMPro::MarkToMarkAdjustmentRecord::*)(::TMPro::MarkPositionAdjustment)>(&::TMPro::MarkToMarkAdjustmentRecord::set_combiningMarkPositionAdjustment)> {
  constexpr static std::size_t size = 0x10;
...
// Ctor Parameters [CppParam { name: "m_BaseMarkGlyphID", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_BaseMarkGlyphAnchorPoint", ty: "::TMPro::GlyphAnchorPoint", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_CombiningMarkGlyphID", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_CombiningMarkPositionAdjustment", ty: "::TMPro::MarkPositionAdjustment", modifiers: "", def_value: Some("{}") }]
constexpr ::TMPro::MarkToMarkAdjustmentRecord::MarkToMarkAdjustmentRecord(uint32_t  m_BaseMarkGlyphID, ::TMPro::GlyphAnchorPoint  m_BaseMarkGlyphAnchorPoint, uint32_t  m_CombiningMarkGlyphID, ::TMPro::MarkPositionAdjustment  m_CombiningMarkPositionAdjustment) noexcept  {
