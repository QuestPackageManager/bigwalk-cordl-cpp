...
// Write type traits
MARK_REF_T(::TMPro::TMP_TextInfo*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_TextInfo*, "TMPro", "TMP_TextInfo");
// Dependencies System.Object, TMPro.TMP_CharacterInfo, TMPro.TMP_LineInfo, TMPro.TMP_LinkInfo, TMPro.TMP_MeshInfo, TMPro.TMP_PageInfo, TMPro.TMP_WordInfo, UnityEngine.Vector2
namespace TMPro {
// Is value type: false
...
/// @brief Field characterInfo, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_characterInfo, put=__cordl_internal_set_characterInfo)) ::ArrayW<::TMPro::TMP_CharacterInfo>  characterInfo;
...
/// @brief Field lineInfo, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_lineInfo, put=__cordl_internal_set_lineInfo)) ::ArrayW<::TMPro::TMP_LineInfo>  lineInfo;
...
/// @brief Field linkInfo, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_linkInfo, put=__cordl_internal_set_linkInfo)) ::ArrayW<::TMPro::TMP_LinkInfo>  linkInfo;

/// @brief Field m_CachedMeshInfo, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CachedMeshInfo, put=__cordl_internal_set_m_CachedMeshInfo)) ::ArrayW<::TMPro::TMP_MeshInfo>  m_CachedMeshInfo;
...
/// @brief Field meshInfo, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_meshInfo, put=__cordl_internal_set_meshInfo)) ::ArrayW<::TMPro::TMP_MeshInfo>  meshInfo;
...
/// @brief Field pageInfo, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_pageInfo, put=__cordl_internal_set_pageInfo)) ::ArrayW<::TMPro::TMP_PageInfo>  pageInfo;
...
/// @brief Field wordInfo, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_wordInfo, put=__cordl_internal_set_wordInfo)) ::ArrayW<::TMPro::TMP_WordInfo>  wordInfo;

/// @brief Method Clear, addr 0x1821d3fd0, size 0x50, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearAllData, addr 0x1821d39b0, size 0xf0, virtual false, abstract: false, final false
inline void ClearAllData() ;

/// @brief Method ClearAllMeshInfo, addr 0x1821d3aa0, size 0x130, virtual false, abstract: false, final false
inline void ClearAllMeshInfo() ;

/// @brief Method ClearLineInfo, addr 0x1821d3bd0, size 0x180, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x1821d3d50, size 0x70, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x1821d3dc0, size 0x1b0, virtual false, abstract: false, final false
inline void ClearPageInfo() ;

/// @brief Method ClearUnusedVertices, addr 0x1821d3f70, size 0x60, virtual false, abstract: false, final false
inline void ClearUnusedVertices(::ArrayW<::TMPro::MaterialReference>  materials) ;

/// @brief Method CopyMeshInfoVertexData, addr 0x1821d4020, size 0x2f0, virtual false, abstract: false, final false
inline ::ArrayW<::TMPro::TMP_MeshInfo> CopyMeshInfoVertexData() ;
...
/// @brief Method ResetVertexLayout, addr 0x1821d4310, size 0x70, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::TMPro::TMP_CharacterInfo> const& __cordl_internal_get_characterInfo() const;

constexpr ::ArrayW<::TMPro::TMP_CharacterInfo>& __cordl_internal_get_characterInfo() ;

constexpr int32_t const& __cordl_internal_get_lineCount() const;

constexpr int32_t& __cordl_internal_get_lineCount() ;

constexpr ::ArrayW<::TMPro::TMP_LineInfo> const& __cordl_internal_get_lineInfo() const;

constexpr ::ArrayW<::TMPro::TMP_LineInfo>& __cordl_internal_get_lineInfo() ;

constexpr int32_t const& __cordl_internal_get_linkCount() const;

constexpr int32_t& __cordl_internal_get_linkCount() ;

constexpr ::ArrayW<::TMPro::TMP_LinkInfo> const& __cordl_internal_get_linkInfo() const;

constexpr ::ArrayW<::TMPro::TMP_LinkInfo>& __cordl_internal_get_linkInfo() ;

constexpr ::ArrayW<::TMPro::TMP_MeshInfo> const& __cordl_internal_get_m_CachedMeshInfo() const;

constexpr ::ArrayW<::TMPro::TMP_MeshInfo>& __cordl_internal_get_m_CachedMeshInfo() ;

constexpr int32_t const& __cordl_internal_get_materialCount() const;

constexpr int32_t& __cordl_internal_get_materialCount() ;

constexpr ::ArrayW<::TMPro::TMP_MeshInfo> const& __cordl_internal_get_meshInfo() const;

constexpr ::ArrayW<::TMPro::TMP_MeshInfo>& __cordl_internal_get_meshInfo() ;

constexpr int32_t const& __cordl_internal_get_pageCount() const;

constexpr int32_t& __cordl_internal_get_pageCount() ;

constexpr ::ArrayW<::TMPro::TMP_PageInfo> const& __cordl_internal_get_pageInfo() const;

constexpr ::ArrayW<::TMPro::TMP_PageInfo>& __cordl_internal_get_pageInfo() ;
...
constexpr ::ArrayW<::TMPro::TMP_WordInfo> const& __cordl_internal_get_wordInfo() const;

constexpr ::ArrayW<::TMPro::TMP_WordInfo>& __cordl_internal_get_wordInfo() ;

constexpr void __cordl_internal_set_characterCount(int32_t  value) ;

constexpr void __cordl_internal_set_characterInfo(::ArrayW<::TMPro::TMP_CharacterInfo>  value) ;

constexpr void __cordl_internal_set_lineCount(int32_t  value) ;

constexpr void __cordl_internal_set_lineInfo(::ArrayW<::TMPro::TMP_LineInfo>  value) ;

constexpr void __cordl_internal_set_linkCount(int32_t  value) ;

constexpr void __cordl_internal_set_linkInfo(::ArrayW<::TMPro::TMP_LinkInfo>  value) ;

constexpr void __cordl_internal_set_m_CachedMeshInfo(::ArrayW<::TMPro::TMP_MeshInfo>  value) ;

constexpr void __cordl_internal_set_materialCount(int32_t  value) ;

constexpr void __cordl_internal_set_meshInfo(::ArrayW<::TMPro::TMP_MeshInfo>  value) ;

constexpr void __cordl_internal_set_pageCount(int32_t  value) ;

constexpr void __cordl_internal_set_pageInfo(::ArrayW<::TMPro::TMP_PageInfo>  value) ;
...
constexpr void __cordl_internal_set_wordInfo(::ArrayW<::TMPro::TMP_WordInfo>  value) ;

/// @brief Method .ctor, addr 0x1821d43d0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1821d45e0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(int32_t  characterCount) ;

/// @brief Method .ctor, addr 0x1821d44b0, size 0x130, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_TextInfo) == 0x70, "Size mismatch!");
