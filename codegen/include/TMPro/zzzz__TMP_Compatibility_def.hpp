...
DEFINE_IL2CPP_CLASS(::TMPro::TMP_Compatibility_AnchorPositions, "TMPro", "TMP_Compatibility/AnchorPositions");
...
static_assert(offsetof(::TMPro::TMP_Compatibility_AnchorPositions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::TMP_Compatibility_AnchorPositions) == 0x4, "Size mismatch!");
...
/// @brief Method ConvertTextAlignmentEnumValues, addr 0x182186860, size 0x110, virtual false, abstract: false, final false
