...
public:
// Declarations
/// @brief Method ArrayToString, addr 0x1821ef7d0, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW ArrayToString(::ArrayW<char16_t>  chars) ;

/// @brief Method Compare, addr 0x180646bf0, size 0x40, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Color  a, ::UnityEngine::Color  b) ;

/// @brief Method Compare, addr 0x1802daa60, size 0x40, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Color32  a, ::UnityEngine::Color32  b) ;

/// @brief Method Compare, addr 0x1821ef8a0, size 0xd0, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Quaternion  q1, ::UnityEngine::Quaternion  q2, int32_t  accuracy) ;

/// @brief Method Compare, addr 0x1821ef970, size 0x90, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Vector3  v1, ::UnityEngine::Vector3  v2, int32_t  accuracy) ;

/// @brief Method CompareRGB, addr 0x180646c30, size 0x30, virtual false, abstract: false, final false
static inline bool CompareRGB(::UnityEngine::Color  a, ::UnityEngine::Color  b) ;

/// @brief Method CompareRGB, addr 0x1821ef870, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GammaToLinear, addr 0x1821efab0, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 GammaToLinear(::UnityEngine::Color32  c) ;

/// @brief Method GammaToLinear, addr 0x1821efa00, size 0xb0, virtual false, abstract: false, final false
static inline uint8_t GammaToLinear(uint8_t  value) ;

/// @brief Method IntToString, addr 0x1821efb00, size 0x60, virtual false, abstract: false, final false
static inline ::StringW IntToString(::ArrayW<int32_t>  unicodes) ;

/// @brief Method IntToString, addr 0x1821efb60, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Multiply, addr 0x1821efc40, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Multiply(::UnityEngine::Color32  c1, ::UnityEngine::Color32  c2) ;

/// @brief Method TagToInt, addr 0x1821efd20, size 0xa0, virtual false, abstract: false, final false
static inline int32_t TagToInt(::StringW  s) ;

/// @brief Method Tint, addr 0x1821efc40, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Tint(::UnityEngine::Color32  c1, ::UnityEngine::Color32  c2) ;

/// @brief Method Tint, addr 0x1821efdc0, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Tint(::UnityEngine::Color32  c1, float_t  tint) ;

/// @brief Method ToIntArray, addr 0x1821efea0, size 0x80, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t> ToIntArray(::StringW  text) ;

/// @brief Method UintToString, addr 0x1821eff20, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMPro_ExtensionMethods) == 0x10, "Size mismatch!");
