...
DEFINE_IL2CPP_CLASS(::TMPro::FontStyles, "TMPro", "FontStyles");
// Dependencies 
namespace TMPro {
// Is value type: true
...
static_assert(offsetof(::TMPro::FontStyles, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::TMPro::FontStyles) == 0x4, "Size mismatch!");
