...
// Write type traits
MARK_VAL_T(::Rewired::Config::LogLevel);
DEFINE_IL2CPP_CLASS(::Rewired::Config::LogLevel, "Rewired.Config", "LogLevel");
// Dependencies 
namespace Rewired::Config {
// Is value type: true
// CS Name: Rewired.Config.LogLevel
...
/// @brief Field Debug value: I32(3)
static ::Rewired::Config::LogLevel const Debug;

/// @brief Field Error value: I32(2)
static ::Rewired::Config::LogLevel const Error;

/// @brief Field Info value: I32(0)
static ::Rewired::Config::LogLevel const Info;

/// @brief Field Warning value: I32(1)
static ::Rewired::Config::LogLevel const Warning;
...
static_assert(offsetof(::Rewired::Config::LogLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Rewired::Config::LogLevel) == 0x4, "Size mismatch!");
