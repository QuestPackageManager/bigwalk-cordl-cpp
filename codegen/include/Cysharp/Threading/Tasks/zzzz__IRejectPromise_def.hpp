...
public:
// Declarations
/// @brief Method TrySetException, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline bool TrySetException(::System::Exception*  exception) ;

// Ctor Parameters [CppParam { name: "", ty: "IRejectPromise", modifiers: "const&", def_value: None }]
