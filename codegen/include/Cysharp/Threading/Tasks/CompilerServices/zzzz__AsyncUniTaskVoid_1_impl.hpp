...
template<typename TStateMachine>
constexpr  Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskVoid_1<TStateMachine>::operator ::System::Threading::Tasks::Sources::IValueTaskSource*() noexcept {
...
template<typename TStateMachine>
constexpr ::System::Threading::Tasks::Sources::IValueTaskSource* Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskVoid_1<TStateMachine>::i___System__Threading__Tasks__Sources__IValueTaskSource() noexcept {
return static_cast<::System::Threading::Tasks::Sources::IValueTaskSource*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename TStateMachine>
