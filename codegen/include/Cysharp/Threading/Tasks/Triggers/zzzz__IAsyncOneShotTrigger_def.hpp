...
public:
// Declarations
/// @brief Method OneShotAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OneShotAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOneShotTrigger", modifiers: "const&", def_value: None }]
