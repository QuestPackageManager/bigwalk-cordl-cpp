...
public:
// Declarations
/// @brief Method OnPreRenderAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnPreRenderAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnPreRenderHandler", modifiers: "const&", def_value: None }]
