...
public:
// Declarations
/// @brief Method GetOnTriggerStay2DAsyncHandler, addr 0x181e7a450, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnTriggerStay2DHandler* GetOnTriggerStay2DAsyncHandler() ;

/// @brief Method GetOnTriggerStay2DAsyncHandler, addr 0x181e7a3f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnTriggerStay2D, addr 0x181e7a570, size 0x10, virtual false, abstract: false, final false
inline void OnTriggerStay2D(::UnityEngine::Collider2D*  other) ;

/// @brief Method OnTriggerStay2DAsync, addr 0x181e7bdc0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityW<::UnityEngine::Collider2D>> OnTriggerStay2DAsync() ;

/// @brief Method OnTriggerStay2DAsync, addr 0x181e7be20, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncTriggerStay2DTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncTriggerStay2DTrigger(AsyncTriggerStay2DTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncTriggerStay2DTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncTriggerStay2DTrigger) == 0x40, "Size mismatch!");
