...
public:
// Declarations
/// @brief Method OnCollisionExitAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::Collision*> OnCollisionExitAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnCollisionExitHandler", modifiers: "const&", def_value: None }]
