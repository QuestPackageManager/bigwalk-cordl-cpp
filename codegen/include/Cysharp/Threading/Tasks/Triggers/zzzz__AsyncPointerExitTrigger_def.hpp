...
/// @brief Method GetOnPointerExitAsyncHandler, addr 0x181e751b0, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnPointerExitHandler* GetOnPointerExitAsyncHandler() ;

/// @brief Method GetOnPointerExitAsyncHandler, addr 0x181e75150, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnPointerExitAsync, addr 0x181e793c0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::EventSystems::PointerEventData*> OnPointerExitAsync() ;

/// @brief Method OnPointerExitAsync, addr 0x181e79420, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.EventSystems.IPointerExitHandler.OnPointerExit, addr 0x181e752d0, size 0x10, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncPointerExitTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncPointerExitTrigger(AsyncPointerExitTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncPointerExitTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncPointerExitTrigger) == 0x40, "Size mismatch!");
