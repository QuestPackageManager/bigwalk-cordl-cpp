...
public:
// Declarations
/// @brief Method GetOnPreRenderAsyncHandler, addr 0x181e746e0, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnPreRenderHandler* GetOnPreRenderAsyncHandler() ;

/// @brief Method GetOnPreRenderAsyncHandler, addr 0x181e74720, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnPreRender, addr 0x181e74860, size 0x20, virtual false, abstract: false, final false
inline void OnPreRender() ;

/// @brief Method OnPreRenderAsync, addr 0x181e79740, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnPreRenderAsync() ;

/// @brief Method OnPreRenderAsync, addr 0x181e797a0, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncPreRenderTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncPreRenderTrigger(AsyncPreRenderTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncPreRenderTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncPreRenderTrigger) == 0x40, "Size mismatch!");
