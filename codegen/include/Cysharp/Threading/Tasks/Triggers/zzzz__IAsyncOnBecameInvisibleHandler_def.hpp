...
public:
// Declarations
/// @brief Method OnBecameInvisibleAsync, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask OnBecameInvisibleAsync() ;

// Ctor Parameters [CppParam { name: "", ty: "IAsyncOnBecameInvisibleHandler", modifiers: "const&", def_value: None }]
