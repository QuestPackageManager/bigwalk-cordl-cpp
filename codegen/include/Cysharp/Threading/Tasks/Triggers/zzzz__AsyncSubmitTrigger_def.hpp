...
/// @brief Method GetOnSubmitAsyncHandler, addr 0x181e75340, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnSubmitHandler* GetOnSubmitAsyncHandler() ;

/// @brief Method GetOnSubmitAsyncHandler, addr 0x181e752e0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnSubmitAsync, addr 0x181e7a1d0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<::UnityEngine::EventSystems::BaseEventData*> OnSubmitAsync() ;

/// @brief Method OnSubmitAsync, addr 0x181e7a150, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.EventSystems.ISubmitHandler.OnSubmit, addr 0x181e75460, size 0x10, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncSubmitTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncSubmitTrigger(AsyncSubmitTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncSubmitTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncSubmitTrigger) == 0x40, "Size mismatch!");
