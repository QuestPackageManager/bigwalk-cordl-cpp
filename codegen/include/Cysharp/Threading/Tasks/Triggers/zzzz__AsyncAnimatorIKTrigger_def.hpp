...
public:
// Declarations
/// @brief Method GetOnAnimatorIKAsyncHandler, addr 0x181e74550, size 0x40, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::Triggers::IAsyncOnAnimatorIKHandler* GetOnAnimatorIKAsyncHandler() ;

/// @brief Method GetOnAnimatorIKAsyncHandler, addr 0x181e74590, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnAnimatorIK, addr 0x181e746d0, size 0x10, virtual false, abstract: false, final false
inline void OnAnimatorIK(int32_t  layerIndex) ;

/// @brief Method OnAnimatorIKAsync, addr 0x181e745f0, size 0x60, virtual false, abstract: false, final false
inline ::Cysharp::Threading::Tasks::UniTask_1<int32_t> OnAnimatorIKAsync() ;

/// @brief Method OnAnimatorIKAsync, addr 0x181e74650, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AsyncAnimatorIKTrigger", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AsyncAnimatorIKTrigger(AsyncAnimatorIKTrigger && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AsyncAnimatorIKTrigger", modifiers: "const&", def_value: None }]
...
static_assert(sizeof(::Cysharp::Threading::Tasks::Triggers::AsyncAnimatorIKTrigger) == 0x40, "Size mismatch!");
