...
// Write type traits
MARK_REF_T(::JBooth::MicroVerseCore::MaskData*);
DEFINE_IL2CPP_CLASS(::JBooth::MicroVerseCore::MaskData*, "JBooth.MicroVerseCore", "MaskData");
// Dependencies JBooth.MicroVerseCore.StampData
namespace JBooth::MicroVerseCore {
// Is value type: false
// CS Name: JBooth.MicroVerseCore.MaskData
class CORDL_TYPE MaskData : public ::JBooth::MicroVerseCore::StampData {
public:
// Declarations
...
static inline ::JBooth::MicroVerseCore::MaskData* New_ctor(::UnityEngine::Terrain*  terrain, ::UnityEngine::RenderTexture*  heightMap, ::UnityEngine::RenderTexture*  normalMap, ::UnityEngine::RenderTexture*  curveMap, ::UnityEngine::RenderTexture*  flowMap, ::UnityEngine::RenderTexture*  indexMap, ::UnityEngine::RenderTexture*  weightMap) ;

/// @brief Method ProcessMasks, addr 0x1814076a0, size 0x5b0, virtual false, abstract: false, final false
static inline void ProcessMasks(::ArrayW<::UnityEngine::Terrain*>  terrains, ::JBooth::MicroVerseCore::MicroVerse_DataCache*  dataCache) ;
...
/// @brief Method .ctor, addr 0x181407c50, size 0xc0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "MaskData", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
MaskData(MaskData && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "MaskData", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
MaskData(MaskData const& ) = delete;
...
static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___heightMap) == 0x18, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___normalMap) == 0x20, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___curveMap) == 0x28, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___flowMap) == 0x30, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___placementMask) == 0x38, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___indexMap) == 0x40, "Offset mismatch!");

static_assert(offsetof(::JBooth::MicroVerseCore::MaskData, ___weightMap) == 0x48, "Offset mismatch!");

static_assert(sizeof(::JBooth::MicroVerseCore::MaskData) == 0x50, "Size mismatch!");
