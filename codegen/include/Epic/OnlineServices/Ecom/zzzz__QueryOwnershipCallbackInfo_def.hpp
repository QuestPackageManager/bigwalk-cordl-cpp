...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryOwnershipCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo, "Epic.OnlineServices.Ecom", "QueryOwnershipCallbackInfo");
// Dependencies Epic.OnlineServices.Ecom.ItemOwnership, Epic.OnlineServices.Result
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.QueryOwnershipCallbackInfo
struct CORDL_TYPE QueryOwnershipCallbackInfo {
public:
// Declarations
 __declspec(property(get=get_ClientData, put=set_ClientData)) ::System::Object*  ClientData;

 __declspec(property(get=get_ItemOwnership, put=set_ItemOwnership)) ::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership>  ItemOwnership;
...
/// @brief Method get_ItemOwnership, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership> get_ItemOwnership() ;
...
/// @brief Method set_ItemOwnership, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_ItemOwnership(::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership>  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryOwnershipCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_ItemOwnership_k__BackingField", ty: "::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership>", modifiers: "", def_value: None }]
constexpr QueryOwnershipCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership>  _ItemOwnership_k__BackingField) noexcept;
...
/// @brief Field <ItemOwnership>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::Epic::OnlineServices::Ecom::ItemOwnership>  _ItemOwnership_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo, _ItemOwnership_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::QueryOwnershipCallbackInfo) == 0x20, "Size mismatch!");
