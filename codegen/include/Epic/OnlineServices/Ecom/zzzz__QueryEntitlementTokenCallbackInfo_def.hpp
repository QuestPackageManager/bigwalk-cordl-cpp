...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryEntitlementTokenCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo, "Epic.OnlineServices.Ecom", "QueryEntitlementTokenCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.QueryEntitlementTokenCallbackInfo
struct CORDL_TYPE QueryEntitlementTokenCallbackInfo {
public:
// Declarations
 __declspec(property(get=get_ClientData, put=set_ClientData)) ::System::Object*  ClientData;

 __declspec(property(get=get_EntitlementToken, put=set_EntitlementToken)) ::Epic::OnlineServices::Utf8String*  EntitlementToken;
...
/// @brief Method get_EntitlementToken, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::Utf8String* get_EntitlementToken() ;
...
/// @brief Method set_EntitlementToken, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_EntitlementToken(::Epic::OnlineServices::Utf8String*  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryEntitlementTokenCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_EntitlementToken_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr QueryEntitlementTokenCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _EntitlementToken_k__BackingField) noexcept;
...
/// @brief Field <EntitlementToken>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _EntitlementToken_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo, _EntitlementToken_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::QueryEntitlementTokenCallbackInfo) == 0x20, "Size mismatch!");
