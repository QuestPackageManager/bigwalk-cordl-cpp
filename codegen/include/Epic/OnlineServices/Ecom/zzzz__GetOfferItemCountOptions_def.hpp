...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetOfferItemCountOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::GetOfferItemCountOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::GetOfferItemCountOptions, "Epic.OnlineServices.Ecom", "GetOfferItemCountOptions");
// Dependencies 
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.GetOfferItemCountOptions
struct CORDL_TYPE GetOfferItemCountOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr GetOfferItemCountOptions() ;
...
constexpr GetOfferItemCountOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _OfferId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::GetOfferItemCountOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::GetOfferItemCountOptions, _OfferId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::GetOfferItemCountOptions) == 0x10, "Size mismatch!");
