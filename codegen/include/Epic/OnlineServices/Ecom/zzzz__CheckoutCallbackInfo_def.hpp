#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Ecom/CheckoutCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(CheckoutCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo, "Epic.OnlineServices.Ecom", "CheckoutCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.CheckoutCallbackInfo
struct CORDL_TYPE CheckoutCallbackInfo {
public:
// Declarations
...
/// @brief Method get_TransactionId, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_TransactionId, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_TransactionId(::Epic::OnlineServices::Utf8String*  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr CheckoutCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_TransactionId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr CheckoutCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _TransactionId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo, _TransactionId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::CheckoutCallbackInfo) == 0x20, "Size mismatch!");
