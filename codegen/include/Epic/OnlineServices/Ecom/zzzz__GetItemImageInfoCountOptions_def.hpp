...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetItemImageInfoCountOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::GetItemImageInfoCountOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::GetItemImageInfoCountOptions, "Epic.OnlineServices.Ecom", "GetItemImageInfoCountOptions");
// Dependencies 
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.GetItemImageInfoCountOptions
struct CORDL_TYPE GetItemImageInfoCountOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr GetItemImageInfoCountOptions() ;
...
constexpr GetItemImageInfoCountOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ItemId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::GetItemImageInfoCountOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::GetItemImageInfoCountOptions, _ItemId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::GetItemImageInfoCountOptions) == 0x10, "Size mismatch!");
