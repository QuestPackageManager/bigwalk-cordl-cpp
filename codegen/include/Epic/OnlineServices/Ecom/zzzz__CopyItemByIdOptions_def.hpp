...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(CopyItemByIdOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Ecom::CopyItemByIdOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Ecom::CopyItemByIdOptions, "Epic.OnlineServices.Ecom", "CopyItemByIdOptions");
// Dependencies 
namespace Epic::OnlineServices::Ecom {
// Is value type: true
// CS Name: Epic.OnlineServices.Ecom.CopyItemByIdOptions
struct CORDL_TYPE CopyItemByIdOptions {
public:
// Declarations
...
constexpr CopyItemByIdOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _ItemId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Ecom::CopyItemByIdOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Ecom::CopyItemByIdOptions, _ItemId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Ecom::CopyItemByIdOptions) == 0x10, "Size mismatch!");
