...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryUserInfoByDisplayNameCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, "Epic.OnlineServices.UserInfo", "QueryUserInfoByDisplayNameCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::UserInfo {
// Is value type: true
// CS Name: Epic.OnlineServices.UserInfo.QueryUserInfoByDisplayNameCallbackInfo
struct CORDL_TYPE QueryUserInfoByDisplayNameCallbackInfo {
public:
// Declarations
...
/// @brief Method get_DisplayName, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DisplayName, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryUserInfoByDisplayNameCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_DisplayName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr QueryUserInfoByDisplayNameCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DisplayName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo, _DisplayName_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UserInfo::QueryUserInfoByDisplayNameCallbackInfo) == 0x28, "Size mismatch!");
