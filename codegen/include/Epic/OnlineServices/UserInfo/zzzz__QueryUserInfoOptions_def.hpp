#pragma once
// IWYU pragma private; include "Epic/OnlineServices/UserInfo/QueryUserInfoOptions.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(QueryUserInfoOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UserInfo::QueryUserInfoOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UserInfo::QueryUserInfoOptions, "Epic.OnlineServices.UserInfo", "QueryUserInfoOptions");
// Dependencies 
namespace Epic::OnlineServices::UserInfo {
// Is value type: true
// CS Name: Epic.OnlineServices.UserInfo.QueryUserInfoOptions
struct CORDL_TYPE QueryUserInfoOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryUserInfoOptions() ;
...
constexpr QueryUserInfoOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UserInfo::QueryUserInfoOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UserInfo::QueryUserInfoOptions) == 0x10, "Size mismatch!");
