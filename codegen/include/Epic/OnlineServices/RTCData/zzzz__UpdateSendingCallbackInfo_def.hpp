#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCData/UpdateSendingCallbackInfo.hpp"
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, "Epic.OnlineServices.RTCData", "UpdateSendingCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCData {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCData.UpdateSendingCallbackInfo
...
/// @brief Method get_DataEnabled, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DataEnabled, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_DataEnabled_k__BackingField", ty: "bool", modifiers: "", def_value: None }]
constexpr UpdateSendingCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, bool  _DataEnabled_k__BackingField) noexcept;
...
/// @brief Field <DataEnabled>k__BackingField, offset: 0x20, size: 0x1, def value: None
 bool  _DataEnabled_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo, _DataEnabled_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCData::UpdateSendingCallbackInfo) == 0x28, "Size mismatch!");
