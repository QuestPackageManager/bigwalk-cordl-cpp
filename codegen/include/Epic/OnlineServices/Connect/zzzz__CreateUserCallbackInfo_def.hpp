...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::CreateUserCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::CreateUserCallbackInfo, "Epic.OnlineServices.Connect", "CreateUserCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.CreateUserCallbackInfo
...
constexpr CreateUserCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::CreateUserCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::CreateUserCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::CreateUserCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::CreateUserCallbackInfo) == 0x18, "Size mismatch!");
