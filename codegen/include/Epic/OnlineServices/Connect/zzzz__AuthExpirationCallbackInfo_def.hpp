#pragma once
// IWYU pragma private; include "Epic/OnlineServices/Connect/AuthExpirationCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(AuthExpirationCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::AuthExpirationCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::AuthExpirationCallbackInfo, "Epic.OnlineServices.Connect", "AuthExpirationCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.AuthExpirationCallbackInfo
struct CORDL_TYPE AuthExpirationCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr AuthExpirationCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr AuthExpirationCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::AuthExpirationCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Connect::AuthExpirationCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::AuthExpirationCallbackInfo) == 0x10, "Size mismatch!");
