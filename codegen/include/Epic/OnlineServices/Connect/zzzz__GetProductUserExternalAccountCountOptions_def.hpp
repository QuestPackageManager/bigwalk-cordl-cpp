...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetProductUserExternalAccountCountOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Connect::GetProductUserExternalAccountCountOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Connect::GetProductUserExternalAccountCountOptions, "Epic.OnlineServices.Connect", "GetProductUserExternalAccountCountOptions");
// Dependencies 
namespace Epic::OnlineServices::Connect {
// Is value type: true
// CS Name: Epic.OnlineServices.Connect.GetProductUserExternalAccountCountOptions
struct CORDL_TYPE GetProductUserExternalAccountCountOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr GetProductUserExternalAccountCountOptions() ;
...
constexpr GetProductUserExternalAccountCountOptions(::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Connect::GetProductUserExternalAccountCountOptions, _TargetUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Connect::GetProductUserExternalAccountCountOptions) == 0x8, "Size mismatch!");
