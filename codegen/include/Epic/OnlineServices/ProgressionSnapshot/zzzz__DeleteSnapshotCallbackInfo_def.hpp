...
#include <cstddef>
CORDL_MODULE_EXPORT(DeleteSnapshotCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo, "Epic.OnlineServices.ProgressionSnapshot", "DeleteSnapshotCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::ProgressionSnapshot {
// Is value type: true
// CS Name: Epic.OnlineServices.ProgressionSnapshot.DeleteSnapshotCallbackInfo
struct CORDL_TYPE DeleteSnapshotCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DeleteSnapshotCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }]
constexpr DeleteSnapshotCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo, _ClientData_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::ProgressionSnapshot::DeleteSnapshotCallbackInfo) == 0x18, "Size mismatch!");
