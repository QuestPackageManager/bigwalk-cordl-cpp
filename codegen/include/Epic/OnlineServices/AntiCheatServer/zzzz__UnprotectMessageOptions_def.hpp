...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions, "Epic.OnlineServices.AntiCheatServer", "UnprotectMessageOptions");
// Dependencies System.ArraySegment`1<T>, System.IntPtr
namespace Epic::OnlineServices::AntiCheatServer {
// Is value type: true
// CS Name: Epic.OnlineServices.AntiCheatServer.UnprotectMessageOptions
...
constexpr UnprotectMessageOptions(::System::IntPtr  _ClientHandle_k__BackingField, ::System::ArraySegment_1<uint8_t>  _Data_k__BackingField, uint32_t  _OutBufferSizeBytes_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions, _ClientHandle_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions, _Data_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions, _OutBufferSizeBytes_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::AntiCheatServer::UnprotectMessageOptions) == 0x20, "Size mismatch!");
