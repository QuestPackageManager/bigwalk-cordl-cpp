...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::AntiCheatServer::GetProtectMessageOutputLengthOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::AntiCheatServer::GetProtectMessageOutputLengthOptions, "Epic.OnlineServices.AntiCheatServer", "GetProtectMessageOutputLengthOptions");
// Dependencies 
namespace Epic::OnlineServices::AntiCheatServer {
// Is value type: true
// CS Name: Epic.OnlineServices.AntiCheatServer.GetProtectMessageOutputLengthOptions
...
static_assert(offsetof(::Epic::OnlineServices::AntiCheatServer::GetProtectMessageOutputLengthOptions, _DataLengthBytes_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::AntiCheatServer::GetProtectMessageOutputLengthOptions) == 0x4, "Size mismatch!");
