...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(SessionInviteReceivedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo, "Epic.OnlineServices.Sessions", "SessionInviteReceivedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.SessionInviteReceivedCallbackInfo
struct CORDL_TYPE SessionInviteReceivedCallbackInfo {
public:
// Declarations
...
/// @brief Method get_InviteId, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_InviteId, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr SessionInviteReceivedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_InviteId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr SessionInviteReceivedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField) noexcept;
...
/// @brief Field <InviteId>k__BackingField, offset: 0x18, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo, _TargetUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo, _InviteId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::SessionInviteReceivedCallbackInfo) == 0x20, "Size mismatch!");
