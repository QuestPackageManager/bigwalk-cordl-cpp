...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(SessionInviteAcceptedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, "Epic.OnlineServices.Sessions", "SessionInviteAcceptedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.SessionInviteAcceptedCallbackInfo
struct CORDL_TYPE SessionInviteAcceptedCallbackInfo {
public:
// Declarations
...
/// @brief Method get_InviteId, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_SessionId, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_InviteId, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_SessionId, addr 0x180378fe0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr SessionInviteAcceptedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_SessionId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_InviteId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr SessionInviteAcceptedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _SessionId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField) noexcept;
...
/// @brief Field <SessionId>k__BackingField, offset: 0x8, size: 0x8, def value: None
...
/// @brief Field <InviteId>k__BackingField, offset: 0x20, size: 0x8, def value: None
 ::Epic::OnlineServices::Utf8String*  _InviteId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, _SessionId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo, _InviteId_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::SessionInviteAcceptedCallbackInfo) == 0x28, "Size mismatch!");
