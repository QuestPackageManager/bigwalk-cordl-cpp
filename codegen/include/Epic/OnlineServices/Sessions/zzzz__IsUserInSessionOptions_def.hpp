...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(IsUserInSessionOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::IsUserInSessionOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::IsUserInSessionOptions, "Epic.OnlineServices.Sessions", "IsUserInSessionOptions");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.IsUserInSessionOptions
struct CORDL_TYPE IsUserInSessionOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr IsUserInSessionOptions() ;

// Ctor Parameters [CppParam { name: "_SessionName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr IsUserInSessionOptions(::Epic::OnlineServices::Utf8String*  _SessionName_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::IsUserInSessionOptions, _SessionName_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::IsUserInSessionOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::IsUserInSessionOptions) == 0x10, "Size mismatch!");
