...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveSessionRequestedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo, "Epic.OnlineServices.Sessions", "LeaveSessionRequestedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.LeaveSessionRequestedCallbackInfo
struct CORDL_TYPE LeaveSessionRequestedCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LeaveSessionRequestedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_SessionName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr LeaveSessionRequestedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _SessionName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo, _SessionName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::LeaveSessionRequestedCallbackInfo) == 0x18, "Size mismatch!");
