...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(StartSessionOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::StartSessionOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::StartSessionOptions, "Epic.OnlineServices.Sessions", "StartSessionOptions");
// Dependencies 
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.StartSessionOptions
struct CORDL_TYPE StartSessionOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr StartSessionOptions() ;

// Ctor Parameters [CppParam { name: "_SessionName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr StartSessionOptions(::Epic::OnlineServices::Utf8String*  _SessionName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::StartSessionOptions, _SessionName_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::StartSessionOptions) == 0x8, "Size mismatch!");
