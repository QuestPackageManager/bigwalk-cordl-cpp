...
#include <cstddef>
CORDL_MODULE_EXPORT(DestroySessionCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::DestroySessionCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::DestroySessionCallbackInfo, "Epic.OnlineServices.Sessions", "DestroySessionCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.DestroySessionCallbackInfo
struct CORDL_TYPE DestroySessionCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DestroySessionCallbackInfo() ;
...
constexpr DestroySessionCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::DestroySessionCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::DestroySessionCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::DestroySessionCallbackInfo) == 0x10, "Size mismatch!");
