...
#include <cstddef>
CORDL_MODULE_EXPORT(EndSessionCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::EndSessionCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::EndSessionCallbackInfo, "Epic.OnlineServices.Sessions", "EndSessionCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.EndSessionCallbackInfo
struct CORDL_TYPE EndSessionCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr EndSessionCallbackInfo() ;
...
constexpr EndSessionCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::EndSessionCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::EndSessionCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::EndSessionCallbackInfo) == 0x10, "Size mismatch!");
