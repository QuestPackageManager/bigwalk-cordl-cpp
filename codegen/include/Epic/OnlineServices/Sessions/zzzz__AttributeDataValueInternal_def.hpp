...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::AttributeDataValueInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::AttributeDataValueInternal, "Epic.OnlineServices.Sessions", "AttributeDataValueInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.AttributeDataValueInternal
...
constexpr operator  ::Epic::OnlineServices::IGettable_2<::Epic::OnlineServices::Sessions::AttributeDataValue,::Epic::OnlineServices::AttributeType>*() ;

/// @brief Convert operator to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::AttributeDataValue>"
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::AttributeDataValue>*() ;

/// @brief Convert operator to "::System::IDisposable"
constexpr operator  ::System::IDisposable*() ;

/// @brief Method Dispose, addr 0x1804be470, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Get, addr 0x1804be4b0, size 0x120, virtual true, abstract: false, final true
inline void Get(::by_ref<::Epic::OnlineServices::Sessions::AttributeDataValue>  other, ::Epic::OnlineServices::AttributeType  enumValue, ::System::Nullable_1<int32_t>  arrayLength) ;

/// @brief Method Set, addr 0x1804be5d0, size 0x110, virtual true, abstract: false, final true
inline void Set(::by_ref<::Epic::OnlineServices::Sessions::AttributeDataValue>  other) ;
...
constexpr ::Epic::OnlineServices::IGettable_2<::Epic::OnlineServices::Sessions::AttributeDataValue,::Epic::OnlineServices::AttributeType>* i___Epic__OnlineServices__IGettable_2___Epic__OnlineServices__Sessions__AttributeDataValue___Epic__OnlineServices__AttributeType_() ;

/// @brief Convert to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::AttributeDataValue>"
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Sessions::AttributeDataValue>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__Sessions__AttributeDataValue_() ;
...
static_assert(sizeof(::Epic::OnlineServices::Sessions::AttributeDataValueInternal) == 0x8, "Size mismatch!");
