...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryInvitesCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo, "Epic.OnlineServices.Sessions", "QueryInvitesCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sessions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sessions.QueryInvitesCallbackInfo
struct CORDL_TYPE QueryInvitesCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryInvitesCallbackInfo() ;
...
constexpr QueryInvitesCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sessions::QueryInvitesCallbackInfo) == 0x18, "Size mismatch!");
