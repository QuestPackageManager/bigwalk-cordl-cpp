...
#include <cstddef>
CORDL_MODULE_EXPORT(SendPlayerBehaviorReportCompleteCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Reports::SendPlayerBehaviorReportCompleteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Reports::SendPlayerBehaviorReportCompleteCallbackInfo, "Epic.OnlineServices.Reports", "SendPlayerBehaviorReportCompleteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Reports {
// Is value type: true
// CS Name: Epic.OnlineServices.Reports.SendPlayerBehaviorReportCompleteCallbackInfo
struct CORDL_TYPE SendPlayerBehaviorReportCompleteCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SendPlayerBehaviorReportCompleteCallbackInfo() ;
...
constexpr SendPlayerBehaviorReportCompleteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Reports::SendPlayerBehaviorReportCompleteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Reports::SendPlayerBehaviorReportCompleteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Reports::SendPlayerBehaviorReportCompleteCallbackInfo) == 0x10, "Size mismatch!");
