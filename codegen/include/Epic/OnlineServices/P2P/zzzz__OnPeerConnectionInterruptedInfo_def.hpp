...
#include <cstddef>
CORDL_MODULE_EXPORT(OnPeerConnectionInterruptedInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo, "Epic.OnlineServices.P2P", "OnPeerConnectionInterruptedInfo");
// Dependencies Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.OnPeerConnectionInterruptedInfo
struct CORDL_TYPE OnPeerConnectionInterruptedInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnPeerConnectionInterruptedInfo() ;
...
constexpr OnPeerConnectionInterruptedInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _RemoteUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo, _RemoteUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo, _SocketId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::OnPeerConnectionInterruptedInfo) == 0x40, "Size mismatch!");
