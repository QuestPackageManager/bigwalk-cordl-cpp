...
#include <cstddef>
CORDL_MODULE_EXPORT(OnRemoteConnectionClosedInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, "Epic.OnlineServices.P2P", "OnRemoteConnectionClosedInfo");
// Dependencies Epic.OnlineServices.P2P.ConnectionClosedReason, Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.OnRemoteConnectionClosedInfo
struct CORDL_TYPE OnRemoteConnectionClosedInfo {
public:
// Declarations
 ...
 __declspec(property(get=get_Reason, put=set_Reason)) ::Epic::OnlineServices::P2P::ConnectionClosedReason  Reason;
...
/// @brief Method get_Reason, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::P2P::ConnectionClosedReason get_Reason() ;
...
/// @brief Method set_Reason, addr 0x180511530, size 0x10, virtual false, abstract: false, final false
inline void set_Reason(::Epic::OnlineServices::P2P::ConnectionClosedReason  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr OnRemoteConnectionClosedInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RemoteUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_SocketId_k__BackingField", ty: "::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>", modifiers: "", def_value: None }, CppParam { name: "_Reason_k__BackingField", ty: "::Epic::OnlineServices::P2P::ConnectionClosedReason", modifiers: "", def_value: None }]
constexpr OnRemoteConnectionClosedInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _RemoteUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField, ::Epic::OnlineServices::P2P::ConnectionClosedReason  _Reason_k__BackingField) noexcept;
...
/// @brief Field <Reason>k__BackingField, offset: 0x40, size: 0x4, def value: None
 ::Epic::OnlineServices::P2P::ConnectionClosedReason  _Reason_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, _RemoteUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, _SocketId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo, _Reason_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::OnRemoteConnectionClosedInfo) == 0x48, "Size mismatch!");
