...
#include <cstddef>
CORDL_MODULE_EXPORT(AddNotifyPeerConnectionClosedOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::AddNotifyPeerConnectionClosedOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::AddNotifyPeerConnectionClosedOptions, "Epic.OnlineServices.P2P", "AddNotifyPeerConnectionClosedOptions");
// Dependencies Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.AddNotifyPeerConnectionClosedOptions
struct CORDL_TYPE AddNotifyPeerConnectionClosedOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr AddNotifyPeerConnectionClosedOptions() ;
...
constexpr AddNotifyPeerConnectionClosedOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::P2P::AddNotifyPeerConnectionClosedOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::AddNotifyPeerConnectionClosedOptions, _SocketId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::AddNotifyPeerConnectionClosedOptions) == 0x30, "Size mismatch!");
