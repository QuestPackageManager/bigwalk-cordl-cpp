...
#include <cstddef>
CORDL_MODULE_EXPORT(CloseConnectionOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::P2P::CloseConnectionOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::P2P::CloseConnectionOptions, "Epic.OnlineServices.P2P", "CloseConnectionOptions");
// Dependencies Epic.OnlineServices.P2P.SocketId, System.Nullable`1<T>
namespace Epic::OnlineServices::P2P {
// Is value type: true
// CS Name: Epic.OnlineServices.P2P.CloseConnectionOptions
struct CORDL_TYPE CloseConnectionOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CloseConnectionOptions() ;
...
constexpr CloseConnectionOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _RemoteUserId_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::P2P::SocketId>  _SocketId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::P2P::CloseConnectionOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::CloseConnectionOptions, _RemoteUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::P2P::CloseConnectionOptions, _SocketId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::P2P::CloseConnectionOptions) == 0x38, "Size mismatch!");
