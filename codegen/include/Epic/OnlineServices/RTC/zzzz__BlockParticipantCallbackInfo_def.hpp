...
#include <cstddef>
CORDL_MODULE_EXPORT(BlockParticipantCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, "Epic.OnlineServices.RTC", "BlockParticipantCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.BlockParticipantCallbackInfo
struct CORDL_TYPE BlockParticipantCallbackInfo {
public:
// Declarations
...
/// @brief Method get_Blocked, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Blocked, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field <Blocked>k__BackingField, offset: 0x28, size: 0x1, def value: None
 bool  _Blocked_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _ParticipantId_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo, _Blocked_k__BackingField) == 0x28, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::BlockParticipantCallbackInfo) == 0x30, "Size mismatch!");
