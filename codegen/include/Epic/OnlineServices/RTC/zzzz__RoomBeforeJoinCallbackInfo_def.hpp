#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTC/RoomBeforeJoinCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(RoomBeforeJoinCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo, "Epic.OnlineServices.RTC", "RoomBeforeJoinCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.RoomBeforeJoinCallbackInfo
struct CORDL_TYPE RoomBeforeJoinCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr RoomBeforeJoinCallbackInfo() ;
...
constexpr RoomBeforeJoinCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo, _RoomName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::RoomBeforeJoinCallbackInfo) == 0x18, "Size mismatch!");
