...
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveRoomCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo, "Epic.OnlineServices.RTC", "LeaveRoomCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.LeaveRoomCallbackInfo
struct CORDL_TYPE LeaveRoomCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LeaveRoomCallbackInfo() ;
...
constexpr LeaveRoomCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::LeaveRoomCallbackInfo) == 0x20, "Size mismatch!");
