...
#include <cstddef>
CORDL_MODULE_EXPORT(JoinRoomCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, "Epic.OnlineServices.RTC", "JoinRoomCallbackInfo");
// Dependencies Epic.OnlineServices.RTC.Option, Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTC {
// Is value type: true
// CS Name: Epic.OnlineServices.RTC.JoinRoomCallbackInfo
struct CORDL_TYPE JoinRoomCallbackInfo {
public:
// Declarations
 ...
 __declspec(property(get=get_RoomOptions, put=set_RoomOptions)) ::ArrayW<::Epic::OnlineServices::RTC::Option>  RoomOptions;
...
/// @brief Method get_RoomOptions, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::Epic::OnlineServices::RTC::Option> get_RoomOptions() ;
...
/// @brief Method set_RoomOptions, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_RoomOptions(::ArrayW<::Epic::OnlineServices::RTC::Option>  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr JoinRoomCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_RoomOptions_k__BackingField", ty: "::ArrayW<::Epic::OnlineServices::RTC::Option>", modifiers: "", def_value: None }]
constexpr JoinRoomCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, ::ArrayW<::Epic::OnlineServices::RTC::Option>  _RoomOptions_k__BackingField) noexcept;
...
/// @brief Field <RoomOptions>k__BackingField, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::Epic::OnlineServices::RTC::Option>  _RoomOptions_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, _RoomName_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo, _RoomOptions_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTC::JoinRoomCallbackInfo) == 0x28, "Size mismatch!");
