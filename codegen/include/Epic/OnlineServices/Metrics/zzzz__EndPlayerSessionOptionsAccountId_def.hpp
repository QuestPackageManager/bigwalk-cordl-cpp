...
#include <cstddef>
CORDL_MODULE_EXPORT(EndPlayerSessionOptionsAccountId)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId, "Epic.OnlineServices.Metrics", "EndPlayerSessionOptionsAccountId");
// Dependencies Epic.OnlineServices.Metrics.MetricsAccountIdType
namespace Epic::OnlineServices::Metrics {
// Is value type: true
// CS Name: Epic.OnlineServices.Metrics.EndPlayerSessionOptionsAccountId
struct CORDL_TYPE EndPlayerSessionOptionsAccountId {
public:
// Declarations
...
static inline ::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId op_Implicit___Epic__OnlineServices__Metrics__EndPlayerSessionOptionsAccountId(::Epic::OnlineServices::EpicAccountId*  value) ;

/// @brief Method op_Implicit, addr 0x180504420, size 0x30, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId op_Implicit___Epic__OnlineServices__Metrics__EndPlayerSessionOptionsAccountId(::Epic::OnlineServices::Utf8String*  value) ;

/// @brief Method op_Implicit, addr 0x180504390, size 0x50, virtual false, abstract: false, final false
static inline ::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId op_Implicit___Epic__OnlineServices__Metrics__EndPlayerSessionOptionsAccountId(::StringW  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr EndPlayerSessionOptionsAccountId() ;
...
constexpr EndPlayerSessionOptionsAccountId(::Epic::OnlineServices::EpicAccountId*  m_Epic, ::Epic::OnlineServices::Utf8String*  m_External, ::Epic::OnlineServices::Metrics::MetricsAccountIdType  m_AccountIdType) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId, m_Epic) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId, m_External) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId, m_AccountIdType) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId) == 0x18, "Size mismatch!");
