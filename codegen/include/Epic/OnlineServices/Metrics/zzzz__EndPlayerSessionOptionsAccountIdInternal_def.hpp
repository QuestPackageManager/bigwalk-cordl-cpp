...
#include <cstddef>
CORDL_MODULE_EXPORT(EndPlayerSessionOptionsAccountIdInternal)
...
namespace Epic::OnlineServices::Metrics {
struct EndPlayerSessionOptionsAccountIdInternal;
}
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountIdInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountIdInternal, "Epic.OnlineServices.Metrics", "EndPlayerSessionOptionsAccountIdInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::Metrics {
// Is value type: true
// CS Name: Epic.OnlineServices.Metrics.EndPlayerSessionOptionsAccountIdInternal
struct CORDL_TYPE EndPlayerSessionOptionsAccountIdInternal {
public:
// Declarations
...
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId>*() ;
...
inline void Set(::by_ref<::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId>  other) ;
...
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountId>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__Metrics__EndPlayerSessionOptionsAccountId_() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr EndPlayerSessionOptionsAccountIdInternal() ;
...
constexpr EndPlayerSessionOptionsAccountIdInternal(::System::IntPtr  m_Epic, ::System::IntPtr  m_External) noexcept;
...
static_assert(sizeof(::Epic::OnlineServices::Metrics::EndPlayerSessionOptionsAccountIdInternal) == 0x8, "Size mismatch!");
