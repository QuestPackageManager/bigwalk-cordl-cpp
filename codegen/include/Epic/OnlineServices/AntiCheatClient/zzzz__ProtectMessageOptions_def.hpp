...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::AntiCheatClient::ProtectMessageOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::AntiCheatClient::ProtectMessageOptions, "Epic.OnlineServices.AntiCheatClient", "ProtectMessageOptions");
// Dependencies System.ArraySegment`1<T>
namespace Epic::OnlineServices::AntiCheatClient {
// Is value type: true
// CS Name: Epic.OnlineServices.AntiCheatClient.ProtectMessageOptions
...
constexpr ProtectMessageOptions(::System::ArraySegment_1<uint8_t>  _Data_k__BackingField, uint32_t  _OutBufferSizeBytes_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::AntiCheatClient::ProtectMessageOptions, _Data_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::AntiCheatClient::ProtectMessageOptions, _OutBufferSizeBytes_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::AntiCheatClient::ProtectMessageOptions) == 0x18, "Size mismatch!");
