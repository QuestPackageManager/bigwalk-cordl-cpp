...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::SendInviteOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::SendInviteOptions, "Epic.OnlineServices.Friends", "SendInviteOptions");
// Dependencies 
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.SendInviteOptions
...
constexpr SendInviteOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::SendInviteOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::SendInviteOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::SendInviteOptions) == 0x10, "Size mismatch!");
