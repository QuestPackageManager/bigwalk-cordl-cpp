...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo, "Epic.OnlineServices.Friends", "RejectInviteCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Friends {
// Is value type: true
// CS Name: Epic.OnlineServices.Friends.RejectInviteCallbackInfo
...
constexpr RejectInviteCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Friends::RejectInviteCallbackInfo) == 0x20, "Size mismatch!");
