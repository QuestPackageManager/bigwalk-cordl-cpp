...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveRTCRoomOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::LeaveRTCRoomOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::LeaveRTCRoomOptions, "Epic.OnlineServices.Lobby", "LeaveRTCRoomOptions");
// Dependencies 
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.LeaveRTCRoomOptions
struct CORDL_TYPE LeaveRTCRoomOptions {
public:
// Declarations
...
constexpr LeaveRTCRoomOptions(::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveRTCRoomOptions, _LobbyId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveRTCRoomOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::LeaveRTCRoomOptions) == 0x10, "Size mismatch!");
