...
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateLobbyCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo, "Epic.OnlineServices.Lobby", "UpdateLobbyCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.UpdateLobbyCallbackInfo
struct CORDL_TYPE UpdateLobbyCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UpdateLobbyCallbackInfo() ;
...
constexpr UpdateLobbyCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::UpdateLobbyCallbackInfo) == 0x18, "Size mismatch!");
