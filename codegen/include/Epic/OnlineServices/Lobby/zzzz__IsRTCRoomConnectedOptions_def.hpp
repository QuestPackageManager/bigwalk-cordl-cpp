...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(IsRTCRoomConnectedOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::IsRTCRoomConnectedOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::IsRTCRoomConnectedOptions, "Epic.OnlineServices.Lobby", "IsRTCRoomConnectedOptions");
// Dependencies 
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.IsRTCRoomConnectedOptions
struct CORDL_TYPE IsRTCRoomConnectedOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr IsRTCRoomConnectedOptions() ;
...
constexpr IsRTCRoomConnectedOptions(::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::IsRTCRoomConnectedOptions, _LobbyId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::IsRTCRoomConnectedOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::IsRTCRoomConnectedOptions) == 0x10, "Size mismatch!");
