...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(LobbyMemberUpdateReceivedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo, "Epic.OnlineServices.Lobby", "LobbyMemberUpdateReceivedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.LobbyMemberUpdateReceivedCallbackInfo
struct CORDL_TYPE LobbyMemberUpdateReceivedCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LobbyMemberUpdateReceivedCallbackInfo() ;
...
constexpr LobbyMemberUpdateReceivedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo, _LobbyId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo, _TargetUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::LobbyMemberUpdateReceivedCallbackInfo) == 0x18, "Size mismatch!");
