...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(GetRTCRoomNameOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::GetRTCRoomNameOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::GetRTCRoomNameOptions, "Epic.OnlineServices.Lobby", "GetRTCRoomNameOptions");
// Dependencies 
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.GetRTCRoomNameOptions
struct CORDL_TYPE GetRTCRoomNameOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr GetRTCRoomNameOptions() ;
...
constexpr GetRTCRoomNameOptions(::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::GetRTCRoomNameOptions, _LobbyId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::GetRTCRoomNameOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::GetRTCRoomNameOptions) == 0x10, "Size mismatch!");
