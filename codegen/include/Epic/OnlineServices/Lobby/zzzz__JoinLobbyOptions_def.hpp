...
#include <cstddef>
CORDL_MODULE_EXPORT(JoinLobbyOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::JoinLobbyOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::JoinLobbyOptions, "Epic.OnlineServices.Lobby", "JoinLobbyOptions");
...
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.JoinLobbyOptions
struct CORDL_TYPE JoinLobbyOptions {
public:
// Declarations
 __declspec(property(get=get_CrossplayOptOut, put=set_CrossplayOptOut)) bool  CrossplayOptOut;

 __declspec(property(get=get_LobbyDetailsHandle, put=set_LobbyDetailsHandle)) ::Epic::OnlineServices::Lobby::LobbyDetails*  LobbyDetailsHandle;
...
/// @brief Method get_LobbyDetailsHandle, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::Lobby::LobbyDetails* get_LobbyDetailsHandle() ;
...
/// @brief Method set_LobbyDetailsHandle, addr 0x180378fd0, size 0x10, virtual false, abstract: false, final false
inline void set_LobbyDetailsHandle(::Epic::OnlineServices::Lobby::LobbyDetails*  value) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr JoinLobbyOptions() ;

// Ctor Parameters [CppParam { name: "_LobbyDetailsHandle_k__BackingField", ty: "::Epic::OnlineServices::Lobby::LobbyDetails*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_PresenceEnabled_k__BackingField", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_LocalRTCOptions_k__BackingField", ty: "::System::Nullable_1<::Epic::OnlineServices::Lobby::LocalRTCOptions>", modifiers: "", def_value: None }, CppParam { name: "_CrossplayOptOut_k__BackingField", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_RTCRoomJoinActionType_k__BackingField", ty: "::Epic::OnlineServices::Lobby::LobbyRTCRoomJoinActionType", modifiers: "", def_value: None }]
constexpr JoinLobbyOptions(::Epic::OnlineServices::Lobby::LobbyDetails*  _LobbyDetailsHandle_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, bool  _PresenceEnabled_k__BackingField, ::System::Nullable_1<::Epic::OnlineServices::Lobby::LocalRTCOptions>  _LocalRTCOptions_k__BackingField, bool  _CrossplayOptOut_k__BackingField, ::Epic::OnlineServices::Lobby::LobbyRTCRoomJoinActionType  _RTCRoomJoinActionType_k__BackingField) noexcept;
...
/// @brief Field <LobbyDetailsHandle>k__BackingField, offset: 0x0, size: 0x8, def value: None
 ::Epic::OnlineServices::Lobby::LobbyDetails*  _LobbyDetailsHandle_k__BackingField;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _LobbyDetailsHandle_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _PresenceEnabled_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _LocalRTCOptions_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _CrossplayOptOut_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::JoinLobbyOptions, _RTCRoomJoinActionType_k__BackingField) == 0x34, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::JoinLobbyOptions) == 0x38, "Size mismatch!");
