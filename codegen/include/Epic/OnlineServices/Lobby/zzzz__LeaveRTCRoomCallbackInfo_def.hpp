...
#include <cstddef>
CORDL_MODULE_EXPORT(LeaveRTCRoomCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo, "Epic.OnlineServices.Lobby", "LeaveRTCRoomCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.LeaveRTCRoomCallbackInfo
struct CORDL_TYPE LeaveRTCRoomCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr LeaveRTCRoomCallbackInfo() ;
...
constexpr LeaveRTCRoomCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::LeaveRTCRoomCallbackInfo) == 0x18, "Size mismatch!");
