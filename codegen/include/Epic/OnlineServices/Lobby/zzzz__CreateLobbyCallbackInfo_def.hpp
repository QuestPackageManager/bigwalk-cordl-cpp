...
#include <cstddef>
CORDL_MODULE_EXPORT(CreateLobbyCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo, "Epic.OnlineServices.Lobby", "CreateLobbyCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Lobby {
// Is value type: true
// CS Name: Epic.OnlineServices.Lobby.CreateLobbyCallbackInfo
struct CORDL_TYPE CreateLobbyCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CreateLobbyCallbackInfo() ;
...
constexpr CreateLobbyCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LobbyId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo, _LobbyId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Lobby::CreateLobbyCallbackInfo) == 0x18, "Size mismatch!");
