...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(OnCustomInviteReceivedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, "Epic.OnlineServices.CustomInvites", "OnCustomInviteReceivedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.OnCustomInviteReceivedCallbackInfo
struct CORDL_TYPE OnCustomInviteReceivedCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnCustomInviteReceivedCallbackInfo() ;
...
constexpr OnCustomInviteReceivedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _CustomInviteId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Payload_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, _CustomInviteId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo, _Payload_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::OnCustomInviteReceivedCallbackInfo) == 0x28, "Size mismatch!");
