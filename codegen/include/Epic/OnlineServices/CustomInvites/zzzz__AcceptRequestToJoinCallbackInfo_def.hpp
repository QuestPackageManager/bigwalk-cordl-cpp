...
#include <cstddef>
CORDL_MODULE_EXPORT(AcceptRequestToJoinCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo, "Epic.OnlineServices.CustomInvites", "AcceptRequestToJoinCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.AcceptRequestToJoinCallbackInfo
struct CORDL_TYPE AcceptRequestToJoinCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr AcceptRequestToJoinCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ResultCode_k__BackingField", ty: "::Epic::OnlineServices::Result", modifiers: "", def_value: None }, CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_TargetUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr AcceptRequestToJoinCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::AcceptRequestToJoinCallbackInfo) == 0x20, "Size mismatch!");
