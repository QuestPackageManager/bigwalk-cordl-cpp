...
#include <cstddef>
CORDL_MODULE_EXPORT(SendRequestToJoinCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo, "Epic.OnlineServices.CustomInvites", "SendRequestToJoinCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.SendRequestToJoinCallbackInfo
struct CORDL_TYPE SendRequestToJoinCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr SendRequestToJoinCallbackInfo() ;
...
constexpr SendRequestToJoinCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::SendRequestToJoinCallbackInfo) == 0x20, "Size mismatch!");
