...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(CustomInviteRejectedCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, "Epic.OnlineServices.CustomInvites", "CustomInviteRejectedCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::CustomInvites {
// Is value type: true
// CS Name: Epic.OnlineServices.CustomInvites.CustomInviteRejectedCallbackInfo
struct CORDL_TYPE CustomInviteRejectedCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr CustomInviteRejectedCallbackInfo() ;
...
constexpr CustomInviteRejectedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _CustomInviteId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Payload_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, _CustomInviteId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo, _Payload_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::CustomInvites::CustomInviteRejectedCallbackInfo) == 0x28, "Size mismatch!");
