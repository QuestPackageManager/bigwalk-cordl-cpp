#pragma once
// IWYU pragma private; include "Epic/OnlineServices/IntegratedPlatform/UserPreLogoutCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(UserPreLogoutCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, "Epic.OnlineServices.IntegratedPlatform", "UserPreLogoutCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::IntegratedPlatform {
// Is value type: true
// CS Name: Epic.OnlineServices.IntegratedPlatform.UserPreLogoutCallbackInfo
struct CORDL_TYPE UserPreLogoutCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UserPreLogoutCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_PlatformType_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_LocalPlatformUserId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_AccountId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_ProductUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }]
constexpr UserPreLogoutCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::Utf8String*  _PlatformType_k__BackingField, ::Epic::OnlineServices::Utf8String*  _LocalPlatformUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _AccountId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _ProductUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, _PlatformType_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, _LocalPlatformUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, _AccountId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo, _ProductUserId_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::IntegratedPlatform::UserPreLogoutCallbackInfo) == 0x28, "Size mismatch!");
