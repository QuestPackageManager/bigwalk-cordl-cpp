...
#include <cstddef>
CORDL_MODULE_EXPORT(VerifyUserAuthCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::VerifyUserAuthCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::VerifyUserAuthCallbackInfo, "Epic.OnlineServices.Auth", "VerifyUserAuthCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.VerifyUserAuthCallbackInfo
struct CORDL_TYPE VerifyUserAuthCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr VerifyUserAuthCallbackInfo() ;
...
constexpr VerifyUserAuthCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Auth::VerifyUserAuthCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::VerifyUserAuthCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::VerifyUserAuthCallbackInfo) == 0x10, "Size mismatch!");
