...
#include <cstddef>
CORDL_MODULE_EXPORT(DeletePersistentAuthCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::DeletePersistentAuthCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::DeletePersistentAuthCallbackInfo, "Epic.OnlineServices.Auth", "DeletePersistentAuthCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.DeletePersistentAuthCallbackInfo
struct CORDL_TYPE DeletePersistentAuthCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr DeletePersistentAuthCallbackInfo() ;
...
constexpr DeletePersistentAuthCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Auth::DeletePersistentAuthCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::DeletePersistentAuthCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::DeletePersistentAuthCallbackInfo) == 0x10, "Size mismatch!");
