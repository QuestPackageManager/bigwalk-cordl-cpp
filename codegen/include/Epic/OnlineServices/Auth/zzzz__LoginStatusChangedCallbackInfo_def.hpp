...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo, "Epic.OnlineServices.Auth", "LoginStatusChangedCallbackInfo");
// Dependencies Epic.OnlineServices.LoginStatus
namespace Epic::OnlineServices::Auth {
// Is value type: true
// CS Name: Epic.OnlineServices.Auth.LoginStatusChangedCallbackInfo
...
// Declarations
 ...
 __declspec(property(get=get_PrevStatus, put=set_PrevStatus)) ::Epic::OnlineServices::LoginStatus  PrevStatus;
...
/// @brief Method get_PrevStatus, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::Epic::OnlineServices::LoginStatus get_PrevStatus() ;
...
/// @brief Method set_PrevStatus, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_PrevStatus(::Epic::OnlineServices::LoginStatus  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr LoginStatusChangedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::EpicAccountId*", modifiers: "", def_value: None }, CppParam { name: "_PrevStatus_k__BackingField", ty: "::Epic::OnlineServices::LoginStatus", modifiers: "", def_value: None }, CppParam { name: "_CurrentStatus_k__BackingField", ty: "::Epic::OnlineServices::LoginStatus", modifiers: "", def_value: None }]
constexpr LoginStatusChangedCallbackInfo(::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::LoginStatus  _PrevStatus_k__BackingField, ::Epic::OnlineServices::LoginStatus  _CurrentStatus_k__BackingField) noexcept;
...
/// @brief Field <PrevStatus>k__BackingField, offset: 0x10, size: 0x4, def value: None
 ::Epic::OnlineServices::LoginStatus  _PrevStatus_k__BackingField;
...
static_assert(offsetof(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo, _PrevStatus_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo, _CurrentStatus_k__BackingField) == 0x14, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Auth::LoginStatusChangedCallbackInfo) == 0x18, "Size mismatch!");
