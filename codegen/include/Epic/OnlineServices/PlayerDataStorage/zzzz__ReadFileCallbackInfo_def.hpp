...
#include <cstddef>
CORDL_MODULE_EXPORT(ReadFileCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo, "Epic.OnlineServices.PlayerDataStorage", "ReadFileCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.ReadFileCallbackInfo
struct CORDL_TYPE ReadFileCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ReadFileCallbackInfo() ;
...
constexpr ReadFileCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _Filename_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo, _Filename_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::ReadFileCallbackInfo) == 0x20, "Size mismatch!");
