...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal, "Epic.OnlineServices.PlayerDataStorage", "QueryFileOptionsInternal");
// Dependencies System.IntPtr
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.QueryFileOptionsInternal
...
constexpr operator  ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::PlayerDataStorage::QueryFileOptions>*() ;
...
inline void Set(::by_ref<::Epic::OnlineServices::PlayerDataStorage::QueryFileOptions>  other) ;

/// @brief Convert to "::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::PlayerDataStorage::QueryFileOptions>"
constexpr ::Epic::OnlineServices::ISettable_1<::Epic::OnlineServices::PlayerDataStorage::QueryFileOptions>* i___Epic__OnlineServices__ISettable_1___Epic__OnlineServices__PlayerDataStorage__QueryFileOptions_() ;
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal, m_ApiVersion) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal, m_LocalUserId) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal, m_Filename) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::QueryFileOptionsInternal) == 0x18, "Size mismatch!");
