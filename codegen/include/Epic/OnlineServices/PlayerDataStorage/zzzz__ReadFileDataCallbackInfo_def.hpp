...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, "Epic.OnlineServices.PlayerDataStorage", "ReadFileDataCallbackInfo");
// Dependencies System.ArraySegment`1<T>
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.ReadFileDataCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _Filename_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _TotalFileSizeBytes_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _IsLastChunk_k__BackingField) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo, _DataChunk_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::ReadFileDataCallbackInfo) == 0x30, "Size mismatch!");
