...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, "Epic.OnlineServices.PlayerDataStorage", "FileTransferProgressCallbackInfo");
// Dependencies 
namespace Epic::OnlineServices::PlayerDataStorage {
// Is value type: true
// CS Name: Epic.OnlineServices.PlayerDataStorage.FileTransferProgressCallbackInfo
...
static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, _Filename_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, _BytesTransferred_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo, _TotalFileSizeBytes_k__BackingField) == 0x1c, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::PlayerDataStorage::FileTransferProgressCallbackInfo) == 0x20, "Size mismatch!");
