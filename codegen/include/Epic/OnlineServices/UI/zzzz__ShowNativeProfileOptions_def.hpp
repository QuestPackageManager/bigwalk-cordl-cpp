#pragma once
// IWYU pragma private; include "Epic/OnlineServices/UI/ShowNativeProfileOptions.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(ShowNativeProfileOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::ShowNativeProfileOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::ShowNativeProfileOptions, "Epic.OnlineServices.UI", "ShowNativeProfileOptions");
// Dependencies 
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.ShowNativeProfileOptions
struct CORDL_TYPE ShowNativeProfileOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ShowNativeProfileOptions() ;
...
constexpr ShowNativeProfileOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::ShowNativeProfileOptions) == 0x10, "Size mismatch!");
