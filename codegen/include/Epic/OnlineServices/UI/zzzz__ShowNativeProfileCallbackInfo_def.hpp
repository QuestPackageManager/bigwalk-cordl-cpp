...
#include <cstddef>
CORDL_MODULE_EXPORT(ShowNativeProfileCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo, "Epic.OnlineServices.UI", "ShowNativeProfileCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.ShowNativeProfileCallbackInfo
struct CORDL_TYPE ShowNativeProfileCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr ShowNativeProfileCallbackInfo() ;
...
constexpr ShowNativeProfileCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo, _TargetUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::ShowNativeProfileCallbackInfo) == 0x20, "Size mismatch!");
