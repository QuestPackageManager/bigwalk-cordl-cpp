...
#include <cstddef>
CORDL_MODULE_EXPORT(HideFriendsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::UI::HideFriendsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::UI::HideFriendsCallbackInfo, "Epic.OnlineServices.UI", "HideFriendsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::UI {
// Is value type: true
// CS Name: Epic.OnlineServices.UI.HideFriendsCallbackInfo
struct CORDL_TYPE HideFriendsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr HideFriendsCallbackInfo() ;
...
constexpr HideFriendsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::UI::HideFriendsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::HideFriendsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::UI::HideFriendsCallbackInfo, _LocalUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::UI::HideFriendsCallbackInfo) == 0x18, "Size mismatch!");
