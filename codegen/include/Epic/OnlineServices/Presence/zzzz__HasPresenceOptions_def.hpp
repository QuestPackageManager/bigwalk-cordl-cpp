...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(HasPresenceOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::HasPresenceOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::HasPresenceOptions, "Epic.OnlineServices.Presence", "HasPresenceOptions");
// Dependencies 
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.HasPresenceOptions
struct CORDL_TYPE HasPresenceOptions {
public:
// Declarations
...
constexpr HasPresenceOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Presence::HasPresenceOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::HasPresenceOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::HasPresenceOptions) == 0x10, "Size mismatch!");
