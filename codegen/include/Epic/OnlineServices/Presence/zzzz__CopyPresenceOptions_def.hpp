...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(CopyPresenceOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Presence::CopyPresenceOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Presence::CopyPresenceOptions, "Epic.OnlineServices.Presence", "CopyPresenceOptions");
// Dependencies 
namespace Epic::OnlineServices::Presence {
// Is value type: true
// CS Name: Epic.OnlineServices.Presence.CopyPresenceOptions
struct CORDL_TYPE CopyPresenceOptions {
public:
// Declarations
...
constexpr CopyPresenceOptions(::Epic::OnlineServices::EpicAccountId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::EpicAccountId*  _TargetUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Presence::CopyPresenceOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Presence::CopyPresenceOptions, _TargetUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Presence::CopyPresenceOptions) == 0x10, "Size mismatch!");
