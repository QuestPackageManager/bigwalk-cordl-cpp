...
#include <cmath>
#include <cstddef>
CORDL_MODULE_EXPORT(UpdateSendingVolumeOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions, "Epic.OnlineServices.RTCAudio", "UpdateSendingVolumeOptions");
// Dependencies 
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.UpdateSendingVolumeOptions
struct CORDL_TYPE UpdateSendingVolumeOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr UpdateSendingVolumeOptions() ;
...
constexpr UpdateSendingVolumeOptions(::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _RoomName_k__BackingField, float_t  _Volume_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions, _LocalUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions, _RoomName_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions, _Volume_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::UpdateSendingVolumeOptions) == 0x18, "Size mismatch!");
