#pragma once
// IWYU pragma private; include "Epic/OnlineServices/RTCAudio/OnQueryOutputDevicesInformationCallbackInfo.hpp"
#include "beatsaber-hook/shared/types.hpp"
#include "../../../cordl_internals/cordl_internals.hpp"
CORDL_MODULE_INIT
#include "Epic/OnlineServices/zzzz__Result_def.hpp"
#include <cstddef>
CORDL_MODULE_EXPORT(OnQueryOutputDevicesInformationCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::OnQueryOutputDevicesInformationCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::OnQueryOutputDevicesInformationCallbackInfo, "Epic.OnlineServices.RTCAudio", "OnQueryOutputDevicesInformationCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.OnQueryOutputDevicesInformationCallbackInfo
struct CORDL_TYPE OnQueryOutputDevicesInformationCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr OnQueryOutputDevicesInformationCallbackInfo() ;
...
constexpr OnQueryOutputDevicesInformationCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnQueryOutputDevicesInformationCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::OnQueryOutputDevicesInformationCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::OnQueryOutputDevicesInformationCallbackInfo) == 0x10, "Size mismatch!");
