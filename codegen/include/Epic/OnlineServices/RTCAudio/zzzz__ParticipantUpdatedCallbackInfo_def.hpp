...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, "Epic.OnlineServices.RTCAudio", "ParticipantUpdatedCallbackInfo");
// Dependencies Epic.OnlineServices.RTCAudio.RTCAudioStatus
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.ParticipantUpdatedCallbackInfo
...
// Declarations
 ...
 __declspec(property(get=get_Speaking, put=set_Speaking)) bool  Speaking;
...
/// @brief Method get_AudioStatus, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Speaking, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_Speaking() ;

/// @brief Convert to "::Epic::OnlineServices::ICallbackInfo"
constexpr ::Epic::OnlineServices::ICallbackInfo* i___Epic__OnlineServices__ICallbackInfo() ;

/// @brief Method set_AudioStatus, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Speaking, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_Speaking(bool  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr ParticipantUpdatedCallbackInfo() ;

// Ctor Parameters [CppParam { name: "_ClientData_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_LocalUserId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_RoomName_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }, CppParam { name: "_ParticipantId_k__BackingField", ty: "::Epic::OnlineServices::ProductUserId*", modifiers: "", def_value: None }, CppParam { name: "_Speaking_k__BackingField", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_AudioStatus_k__BackingField", ty: "::Epic::OnlineServices::RTCAudio::RTCAudioStatus", modifiers: "", def_value: None }]
...
/// @brief Field <Speaking>k__BackingField, offset: 0x20, size: 0x1, def value: None
 bool  _Speaking_k__BackingField;

/// @brief Field <AudioStatus>k__BackingField, offset: 0x24, size: 0x4, def value: None
 ::Epic::OnlineServices::RTCAudio::RTCAudioStatus  _AudioStatus_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _RoomName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _ParticipantId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _Speaking_k__BackingField) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo, _AudioStatus_k__BackingField) == 0x24, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::ParticipantUpdatedCallbackInfo) == 0x28, "Size mismatch!");
