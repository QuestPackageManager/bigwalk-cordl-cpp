...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(InputDeviceInformation)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::InputDeviceInformation);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::InputDeviceInformation, "Epic.OnlineServices.RTCAudio", "InputDeviceInformation");
// Dependencies 
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.InputDeviceInformation
struct CORDL_TYPE InputDeviceInformation {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr InputDeviceInformation() ;
...
constexpr InputDeviceInformation(bool  _DefaultDevice_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::InputDeviceInformation, _DefaultDevice_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::InputDeviceInformation, _DeviceId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::InputDeviceInformation, _DeviceName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::InputDeviceInformation) == 0x18, "Size mismatch!");
