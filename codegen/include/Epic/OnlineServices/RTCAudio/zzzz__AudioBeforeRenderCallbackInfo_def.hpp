...
#include <cstddef>
CORDL_MODULE_EXPORT(AudioBeforeRenderCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, "Epic.OnlineServices.RTCAudio", "AudioBeforeRenderCallbackInfo");
// Dependencies Epic.OnlineServices.RTCAudio.AudioBuffer, System.Nullable`1<T>
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.AudioBeforeRenderCallbackInfo
struct CORDL_TYPE AudioBeforeRenderCallbackInfo {
public:
// Declarations
...
/// @brief Method get_ParticipantId, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ParticipantId, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field <ParticipantId>k__BackingField, offset: 0x30, size: 0x8, def value: None
 ::Epic::OnlineServices::ProductUserId*  _ParticipantId_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, _ClientData_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, _LocalUserId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, _RoomName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, _Buffer_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo, _ParticipantId_k__BackingField) == 0x30, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::AudioBeforeRenderCallbackInfo) == 0x38, "Size mismatch!");
