...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(RegisterPlatformUserOptions)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::RegisterPlatformUserOptions);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::RegisterPlatformUserOptions, "Epic.OnlineServices.RTCAudio", "RegisterPlatformUserOptions");
// Dependencies 
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.RegisterPlatformUserOptions
struct CORDL_TYPE RegisterPlatformUserOptions {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr RegisterPlatformUserOptions() ;

// Ctor Parameters [CppParam { name: "_PlatformUserId_k__BackingField", ty: "::Epic::OnlineServices::Utf8String*", modifiers: "", def_value: None }]
constexpr RegisterPlatformUserOptions(::Epic::OnlineServices::Utf8String*  _PlatformUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::RegisterPlatformUserOptions, _PlatformUserId_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::RegisterPlatformUserOptions) == 0x8, "Size mismatch!");
