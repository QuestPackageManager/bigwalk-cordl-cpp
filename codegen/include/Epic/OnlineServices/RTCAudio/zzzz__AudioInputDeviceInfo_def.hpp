...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(AudioInputDeviceInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo, "Epic.OnlineServices.RTCAudio", "AudioInputDeviceInfo");
// Dependencies 
namespace Epic::OnlineServices::RTCAudio {
// Is value type: true
// CS Name: Epic.OnlineServices.RTCAudio.AudioInputDeviceInfo
struct CORDL_TYPE AudioInputDeviceInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr AudioInputDeviceInfo() ;
...
constexpr AudioInputDeviceInfo(bool  _DefaultDevice_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceId_k__BackingField, ::Epic::OnlineServices::Utf8String*  _DeviceName_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo, _DefaultDevice_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo, _DeviceId_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo, _DeviceName_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::RTCAudio::AudioInputDeviceInfo) == 0x18, "Size mismatch!");
