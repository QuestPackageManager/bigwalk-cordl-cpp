...
#include <cstddef>
CORDL_MODULE_EXPORT(QueryActivePlayerSanctionsCallbackInfo)
...
// Write type traits
MARK_VAL_T(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo);
DEFINE_IL2CPP_CLASS(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo, "Epic.OnlineServices.Sanctions", "QueryActivePlayerSanctionsCallbackInfo");
// Dependencies Epic.OnlineServices.Result
namespace Epic::OnlineServices::Sanctions {
// Is value type: true
// CS Name: Epic.OnlineServices.Sanctions.QueryActivePlayerSanctionsCallbackInfo
struct CORDL_TYPE QueryActivePlayerSanctionsCallbackInfo {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryActivePlayerSanctionsCallbackInfo() ;
...
constexpr QueryActivePlayerSanctionsCallbackInfo(::Epic::OnlineServices::Result  _ResultCode_k__BackingField, ::System::Object*  _ClientData_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _TargetUserId_k__BackingField, ::Epic::OnlineServices::ProductUserId*  _LocalUserId_k__BackingField) noexcept;
...
static_assert(offsetof(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo, _ResultCode_k__BackingField) == 0x0, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo, _ClientData_k__BackingField) == 0x8, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo, _TargetUserId_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo, _LocalUserId_k__BackingField) == 0x18, "Offset mismatch!");

static_assert(sizeof(::Epic::OnlineServices::Sanctions::QueryActivePlayerSanctionsCallbackInfo) == 0x20, "Size mismatch!");
