...
// Write type traits
MARK_REF_T(::Internal::Runtime::Augments::RuntimeAugments*);
DEFINE_IL2CPP_CLASS(::Internal::Runtime::Augments::RuntimeAugments*, "Internal.Runtime.Augments", "RuntimeAugments");
...
/// @brief Method ReportUnhandledException, addr 0x1815dd300, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_Callbacks, addr 0x1815dd360, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Internal::Runtime::Augments::RuntimeAugments) == 0x10, "Size mismatch!");
