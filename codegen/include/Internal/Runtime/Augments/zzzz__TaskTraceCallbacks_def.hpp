...
// Write type traits
MARK_REF_T(::Internal::Runtime::Augments::TaskTraceCallbacks*);
DEFINE_IL2CPP_CLASS(::Internal::Runtime::Augments::TaskTraceCallbacks*, "Internal.Runtime.Augments", "TaskTraceCallbacks");
...
static_assert(sizeof(::Internal::Runtime::Augments::TaskTraceCallbacks) == 0x10, "Size mismatch!");
