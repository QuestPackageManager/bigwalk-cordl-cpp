...
DEFINE_IL2CPP_CLASS(::UnityEngine::TouchScreenKeyboard_InternalConstructorHelperArguments, "UnityEngine", "TouchScreenKeyboard_InternalConstructorHelperArguments");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TouchScreenKeyboard_InternalConstructorHelperArguments) == 0x18, "Size mismatch!");
