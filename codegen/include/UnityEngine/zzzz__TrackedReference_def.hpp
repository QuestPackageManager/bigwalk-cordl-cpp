...
// Write type traits
MARK_REF_T(::UnityEngine::TrackedReference*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TrackedReference*, "UnityEngine", "TrackedReference");
...
/// @brief Method Equals, addr 0x18227a410, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x180303b50, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x18227a490, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TrackedReference) == 0x18, "Size mismatch!");
