...
DEFINE_IL2CPP_CLASS(::UnityEngine::RenderingPath, "UnityEngine", "RenderingPath");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RenderingPath, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RenderingPath) == 0x4, "Size mismatch!");
