...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioVelocityUpdateMode, "UnityEngine", "AudioVelocityUpdateMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AudioVelocityUpdateMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AudioVelocityUpdateMode) == 0x4, "Size mismatch!");
