...
// Write type traits
MARK_REF_T(::UnityEngine::GUIScrollGroup*);
DEFINE_IL2CPP_CLASS(::UnityEngine::GUIScrollGroup*, "UnityEngine", "GUIScrollGroup");
...
/// @brief Method CalcHeight, addr 0x1822d4d50, size 0x100, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x1822d4e50, size 0xa0, virtual true, abstract: false, final false
inline void CalcWidth() ;

static inline ::UnityEngine::GUIScrollGroup* New_ctor() ;

/// @brief Method SetHorizontal, addr 0x1822d4ef0, size 0x130, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x1822d5020, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822d5210, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::GUIScrollGroup) == 0xc0, "Size mismatch!");
