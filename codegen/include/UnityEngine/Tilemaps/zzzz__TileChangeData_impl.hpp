...
// Ctor Parameters [CppParam { name: "m_Position", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_TileAsset", ty: "::UnityW<::UnityEngine::Object>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Color", ty: "::UnityEngine::Color", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Transform", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Tilemaps::TileChangeData::TileChangeData(::UnityEngine::Vector3Int  m_Position, ::UnityW<::UnityEngine::Object>  m_TileAsset, ::UnityEngine::Color  m_Color, ::UnityEngine::Matrix4x4  m_Transform) noexcept  {
