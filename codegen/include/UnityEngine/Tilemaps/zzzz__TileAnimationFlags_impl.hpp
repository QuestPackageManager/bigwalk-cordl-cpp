...
constexpr ::UnityEngine::Tilemaps::TileAnimationFlags  UnityEngine::Tilemaps::TileAnimationFlags::UnscaledTime{static_cast<int32_t>(0x8)};
constexpr ::UnityEngine::Tilemaps::TileAnimationFlags  UnityEngine::Tilemaps::TileAnimationFlags::SyncAnimation{static_cast<int32_t>(0x10)};
