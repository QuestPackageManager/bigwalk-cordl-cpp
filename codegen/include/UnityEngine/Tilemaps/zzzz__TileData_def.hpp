...
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::TileData, "UnityEngine.Tilemaps", "TileData");
...
/// @brief Method CreateDefault, addr 0x18235bc30, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method set_colliderType, addr 0x180503ba0, size 0x10, virtual false, abstract: false, final false
inline void set_colliderType(::UnityEngine::Tilemaps::Tile_ColliderType  value) ;

/// @brief Method set_color, addr 0x180ded510, size 0x10, virtual false, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_flags, addr 0x1802e0d10, size 0x10, virtual false, abstract: false, final false
inline void set_flags(::UnityEngine::Tilemaps::TileFlags  value) ;

/// @brief Method set_gameObject, addr 0x18235bd80, size 0x60, virtual false, abstract: false, final false
inline void set_gameObject(::UnityEngine::GameObject*  value) ;

/// @brief Method set_sprite, addr 0x18224d020, size 0x80, virtual false, abstract: false, final false
inline void set_sprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_transform, addr 0x18235bde0, size 0x60, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Sprite", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "m_Transform", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_GameObject", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::Tilemaps::TileFlags", modifiers: "", def_value: None }, CppParam { name: "m_ColliderType", ty: "::UnityEngine::Tilemaps::Tile_ColliderType", modifiers: "", def_value: None }]
constexpr TileData(int32_t  m_Sprite, ::UnityEngine::Color  m_Color, ::UnityEngine::Matrix4x4  m_Transform, int32_t  m_GameObject, ::UnityEngine::Tilemaps::TileFlags  m_Flags, ::UnityEngine::Tilemaps::Tile_ColliderType  m_ColliderType) noexcept;
...
static_assert(sizeof(::UnityEngine::Tilemaps::TileData) == 0x60, "Size mismatch!");
