...
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::TileDataNative, "UnityEngine.Tilemaps", "TileDataNative");
...
constexpr TileDataNative(int32_t  m_Sprite, ::UnityEngine::Color  m_Color, ::UnityEngine::Matrix4x4  m_Transform, int32_t  m_GameObject, ::UnityEngine::Tilemaps::TileFlags  m_Flags, ::UnityEngine::Tilemaps::Tile_ColliderType  m_ColliderType) noexcept;
...
static_assert(sizeof(::UnityEngine::Tilemaps::TileDataNative) == 0x60, "Size mismatch!");
