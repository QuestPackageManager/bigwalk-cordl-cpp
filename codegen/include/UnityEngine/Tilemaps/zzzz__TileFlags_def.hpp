...
DEFINE_IL2CPP_CLASS(::UnityEngine::Tilemaps::TileFlags, "UnityEngine.Tilemaps", "TileFlags");
// Dependencies 
namespace UnityEngine::Tilemaps {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Tilemaps::TileFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Tilemaps::TileFlags) == 0x4, "Size mismatch!");
