...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidScreenLayoutLong, "UnityEngine.Android", "AndroidScreenLayoutLong");
// Dependencies 
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Android::AndroidScreenLayoutLong, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Android::AndroidScreenLayoutLong) == 0x4, "Size mismatch!");
