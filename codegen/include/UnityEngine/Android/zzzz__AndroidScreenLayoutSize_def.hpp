...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidScreenLayoutSize, "UnityEngine.Android", "AndroidScreenLayoutSize");
// Dependencies 
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Android::AndroidScreenLayoutSize, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Android::AndroidScreenLayoutSize) == 0x4, "Size mismatch!");
