...
DEFINE_IL2CPP_CLASS(::UnityEngine::EventType, "UnityEngine", "EventType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::EventType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::EventType) == 0x4, "Size mismatch!");
