...
public:
// Declarations
 __declspec(property(get=get_Result)) ::ArrayW<::UnityW<::UnityEngine::Object>>  Result;
...
/// @brief Field s_GlobalCancellation, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_GlobalCancellation, put=setStaticF_s_GlobalCancellation)) ::System::Threading::CancellationTokenSource*  s_GlobalCancellation;

/// @brief Method CreateResultArray, addr 0x18226d2f0, size 0x30, virtual true, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Object>> CreateResultArray(int32_t  size) ;

/// @brief Method IsCancellationRequested, addr 0x18226d320, size 0x10, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::UnityEngine::Object>> const& __cordl_internal_get_m_Result() const;

constexpr ::ArrayW<::UnityW<::UnityEngine::Object>>& __cordl_internal_get_m_Result() ;
...
static inline ::System::Threading::CancellationTokenSource* getStaticF_s_GlobalCancellation() ;

/// @brief Method get_Result, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Object>> get_Result() ;

static inline void setStaticF_s_GlobalCancellation(::System::Threading::CancellationTokenSource*  value) ;
...
static_assert(sizeof(::UnityEngine::AsyncInstantiateOperation) == 0x30, "Size mismatch!");
