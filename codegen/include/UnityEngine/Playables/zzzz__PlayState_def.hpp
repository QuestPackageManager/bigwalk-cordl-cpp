...
DEFINE_IL2CPP_CLASS(::UnityEngine::Playables::PlayState, "UnityEngine.Playables", "PlayState");
// Dependencies 
namespace UnityEngine::Playables {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Playables::PlayState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Playables::PlayState) == 0x4, "Size mismatch!");
