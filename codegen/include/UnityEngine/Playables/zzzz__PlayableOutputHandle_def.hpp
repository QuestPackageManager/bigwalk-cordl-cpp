...
/// @brief Method AddNotificationReceiver, addr 0x1822819d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x1822819f0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method GetPlayableOutputType, addr 0x182281a80, size 0x20, virtual false, abstract: false, final false
inline ::System::Type* GetPlayableOutputType() ;

/// @brief Method GetSourceOutputPort, addr 0x182281aa0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetSourceOutputPort() ;

/// @brief Method GetSourcePlayable, addr 0x182281ad0, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle GetSourcePlayable() ;

/// @brief Method GetSourcePlayable_Injected, addr 0x182281ac0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x182281b30, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method SetReferenceObject, addr 0x182281b60, size 0x30, virtual false, abstract: false, final false
inline void SetReferenceObject(::UnityEngine::Object*  target) ;

/// @brief Method SetReferenceObject_Injected, addr 0x182281b50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetSourcePlayable, addr 0x182281ba0, size 0x40, virtual false, abstract: false, final false
inline void SetSourcePlayable(::UnityEngine::Playables::PlayableHandle  target, int32_t  port) ;

/// @brief Method SetSourcePlayable_Injected, addr 0x182281b90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetUserData, addr 0x182281be0, size 0x20, virtual false, abstract: false, final false
inline void SetUserData(::UnityEngine::Object*  target) ;

/// @brief Method SetWeight, addr 0x182281c00, size 0x20, virtual false, abstract: false, final false
inline void SetWeight(float_t  weight) ;

static inline ::UnityEngine::Playables::PlayableOutputHandle getStaticF_m_Null() ;

/// @brief Method get_Null, addr 0x182281c50, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Playables::PlayableOutputHandle) == 0x10, "Size mismatch!");
