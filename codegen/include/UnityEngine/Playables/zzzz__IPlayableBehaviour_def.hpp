...
// Write type traits
MARK_REF_T(::UnityEngine::Playables::IPlayableBehaviour*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Playables::IPlayableBehaviour*, "UnityEngine.Playables", "IPlayableBehaviour");
// Dependencies 
namespace UnityEngine::Playables {
// Is value type: false
