...
// Write type traits
MARK_REF_T(::UnityEngine::Playables::PlayableBinding_CreateOutputMethod*);
...
public:
// Declarations
/// @brief Method Invoke, addr 0x18227e8f0, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18227ea10, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Playables::PlayableBinding_CreateOutputMethod) == 0x80, "Size mismatch!");
...
/// @brief Field None, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_None, put=setStaticF_None)) ::ArrayW<::UnityEngine::Playables::PlayableBinding>  None;

 __declspec(property(get=get_outputTargetType)) ::System::Type*  outputTargetType;
...
/// @brief Method get_outputTargetType, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_outputTargetType() ;

/// @brief Method get_sourceObject, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_sourceObject() ;

/// @brief Method get_streamName, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_streamName() ;

static inline void setStaticF_DefaultDuration(double_t  value) ;

static inline void setStaticF_None(::ArrayW<::UnityEngine::Playables::PlayableBinding>  value) ;
...
static_assert(sizeof(::UnityEngine::Playables::PlayableBinding) == 0x20, "Size mismatch!");
