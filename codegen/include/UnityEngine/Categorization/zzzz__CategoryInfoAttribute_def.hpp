...
/// @brief Method .ctor, addr 0x18227d4b0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Categorization::CategoryInfoAttribute) == 0x20, "Size mismatch!");

} // namespace end def UnityEngine::Categorization
