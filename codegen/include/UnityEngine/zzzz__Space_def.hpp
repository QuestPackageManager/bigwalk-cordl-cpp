...
DEFINE_IL2CPP_CLASS(::UnityEngine::Space, "UnityEngine", "Space");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Space, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Space) == 0x4, "Size mismatch!");
