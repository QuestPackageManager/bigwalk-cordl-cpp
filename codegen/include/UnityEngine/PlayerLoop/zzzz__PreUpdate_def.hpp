...
MARK_VAL_T(::UnityEngine::PlayerLoop::PreUpdate_PhysicsUpdate);
MARK_VAL_T(::UnityEngine::PlayerLoop::PreUpdate_SendMouseEvents);
MARK_VAL_T(::UnityEngine::PlayerLoop::PreUpdate_UpdateVideo);
MARK_VAL_T(::UnityEngine::PlayerLoop::PreUpdate_WindUpdate);
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate, "UnityEngine.PlayerLoop", "PreUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_AIUpdate, "UnityEngine.PlayerLoop", "PreUpdate/AIUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_CheckTexFieldInput, "UnityEngine.PlayerLoop", "PreUpdate/CheckTexFieldInput");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_IMGUISendQueuedEvents, "UnityEngine.PlayerLoop", "PreUpdate/IMGUISendQueuedEvents");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_InputForUIUpdate, "UnityEngine.PlayerLoop", "PreUpdate/InputForUIUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_NewInputUpdate, "UnityEngine.PlayerLoop", "PreUpdate/NewInputUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_Physics2DUpdate, "UnityEngine.PlayerLoop", "PreUpdate/Physics2DUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_PhysicsClothUpdate, "UnityEngine.PlayerLoop", "PreUpdate/PhysicsClothUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::PreUpdate_PhysicsUpdate, "UnityEngine.PlayerLoop", "PreUpdate/PhysicsUpdate");
...
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_PhysicsUpdate {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_Physics2DUpdate {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
namespace UnityEngine::PlayerLoop {
// Is value type: true
// CS Name: UnityEngine.PlayerLoop.PreUpdate/PhysicsClothUpdate
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_PhysicsClothUpdate {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_IMGUISendQueuedEvents {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_WindUpdate {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
#pragma pack(push, 0)
struct CORDL_TYPE PreUpdate_NewInputUpdate {
public:
// Declarations
// Ctor Parameters []
// @brief default ctor
...
public:
// Declarations
using AIUpdate = ::UnityEngine::PlayerLoop::PreUpdate_AIUpdate;
...
using Physics2DUpdate = ::UnityEngine::PlayerLoop::PreUpdate_Physics2DUpdate;

using PhysicsClothUpdate = ::UnityEngine::PlayerLoop::PreUpdate_PhysicsClothUpdate;

using PhysicsUpdate = ::UnityEngine::PlayerLoop::PreUpdate_PhysicsUpdate;

using SendMouseEvents = ::UnityEngine::PlayerLoop::PreUpdate_SendMouseEvents;

using UpdateVideo = ::UnityEngine::PlayerLoop::PreUpdate_UpdateVideo;

using WindUpdate = ::UnityEngine::PlayerLoop::PreUpdate_WindUpdate;
