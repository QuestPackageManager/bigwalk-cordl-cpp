...
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::Initialization_AsyncUploadTimeSlicedUpdate, "UnityEngine.PlayerLoop", "Initialization/AsyncUploadTimeSlicedUpdate");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::Initialization_DirectorSampleTime, "UnityEngine.PlayerLoop", "Initialization/DirectorSampleTime");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::Initialization_ProfilerStartFrame, "UnityEngine.PlayerLoop", "Initialization/ProfilerStartFrame");
DEFINE_IL2CPP_CLASS(::UnityEngine::PlayerLoop::Initialization_SynchronizeInputs, "UnityEngine.PlayerLoop", "Initialization/SynchronizeInputs");
