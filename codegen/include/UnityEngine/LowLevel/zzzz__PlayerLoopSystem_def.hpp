...
// Write type traits
MARK_REF_T(::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction*);
MARK_VAL_T(::UnityEngine::LowLevel::PlayerLoopSystem);
DEFINE_IL2CPP_CLASS(::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction*, "UnityEngine.LowLevel", "PlayerLoopSystem/UpdateFunction");
DEFINE_IL2CPP_CLASS(::UnityEngine::LowLevel::PlayerLoopSystem, "UnityEngine.LowLevel", "PlayerLoopSystem");
...
/// @brief Method ToString, addr 0x1822832f0, size 0x60, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "type", ty: "::System::Type*", modifiers: "", def_value: None }, CppParam { name: "subSystemList", ty: "::ArrayW<::UnityEngine::LowLevel::PlayerLoopSystem>", modifiers: "", def_value: None }, CppParam { name: "updateDelegate", ty: "::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction*", modifiers: "", def_value: None }, CppParam { name: "updateFunction", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "loopConditionFunction", ty: "::System::IntPtr", modifiers: "", def_value: None }]
constexpr PlayerLoopSystem(::System::Type*  type, ::ArrayW<::UnityEngine::LowLevel::PlayerLoopSystem>  subSystemList, ::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction*  updateDelegate, ::System::IntPtr  updateFunction, ::System::IntPtr  loopConditionFunction) noexcept;
...
static_assert(sizeof(::UnityEngine::LowLevel::PlayerLoopSystem) == 0x28, "Size mismatch!");
