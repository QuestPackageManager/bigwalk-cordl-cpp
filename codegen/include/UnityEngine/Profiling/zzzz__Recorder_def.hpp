...
/// @brief Method Finalize, addr 0x1822839c0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method SetEnabled, addr 0x1822839f0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182283aa0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_elapsedNanoseconds, addr 0x182283b60, size 0x30, virtual false, abstract: false, final false
inline int64_t get_elapsedNanoseconds() ;

/// @brief Method get_enabled, addr 0x182249670, size 0x10, virtual false, abstract: false, final false
inline bool get_enabled() ;

/// @brief Method get_gpuElapsedNanoseconds, addr 0x182283b90, size 0x30, virtual false, abstract: false, final false
inline int64_t get_gpuElapsedNanoseconds() ;

/// @brief Method get_gpuSampleBlockCount, addr 0x182283bc0, size 0x60, virtual false, abstract: false, final false
inline int32_t get_gpuSampleBlockCount() ;

/// @brief Method get_sampleBlockCount, addr 0x182283c20, size 0x60, virtual false, abstract: false, final false
inline int32_t get_sampleBlockCount() ;

static inline void setStaticF_s_InvalidRecorder(::UnityEngine::Profiling::Recorder*  value) ;

/// @brief Method set_enabled, addr 0x1822839f0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Profiling::Recorder) == 0x20, "Size mismatch!");
