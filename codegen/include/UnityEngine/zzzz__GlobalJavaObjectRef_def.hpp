...
// Write type traits
MARK_REF_T(::UnityEngine::GlobalJavaObjectRef*);
DEFINE_IL2CPP_CLASS(::UnityEngine::GlobalJavaObjectRef*, "UnityEngine", "GlobalJavaObjectRef");
...
/// @brief Method Dispose, addr 0x18222b9a0, size 0x30, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Finalize, addr 0x18222b9a0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18222b9d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  jobject) ;

/// @brief Method op_Implicit, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::GlobalJavaObjectRef) == 0x20, "Size mismatch!");
