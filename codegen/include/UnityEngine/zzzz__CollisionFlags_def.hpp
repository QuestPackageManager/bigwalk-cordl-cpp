...
DEFINE_IL2CPP_CLASS(::UnityEngine::CollisionFlags, "UnityEngine", "CollisionFlags");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CollisionFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CollisionFlags) == 0x4, "Size mismatch!");
