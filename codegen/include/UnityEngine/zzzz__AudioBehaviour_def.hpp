...
// Write type traits
MARK_REF_T(::UnityEngine::AudioBehaviour*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioBehaviour*, "UnityEngine", "AudioBehaviour");
...
static_assert(sizeof(::UnityEngine::AudioBehaviour) == 0x18, "Size mismatch!");
