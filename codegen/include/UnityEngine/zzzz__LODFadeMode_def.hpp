...
DEFINE_IL2CPP_CLASS(::UnityEngine::LODFadeMode, "UnityEngine", "LODFadeMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::LODFadeMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::LODFadeMode) == 0x4, "Size mismatch!");
