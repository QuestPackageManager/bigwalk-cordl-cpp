...
DEFINE_IL2CPP_CLASS(::UnityEngine::ScreenCapture_StereoScreenCaptureMode, "UnityEngine", "ScreenCapture/StereoScreenCaptureMode");
...
static_assert(offsetof(::UnityEngine::ScreenCapture_StereoScreenCaptureMode, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CaptureScreenshot, addr 0x18230d3b0, size 0x10, virtual false, abstract: false, final false
static inline void CaptureScreenshot(::StringW  filename) ;

/// @brief Method CaptureScreenshot, addr 0x18230d2a0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method CaptureScreenshot_Injected, addr 0x18230d290, size 0x10, virtual false, abstract: false, final false
