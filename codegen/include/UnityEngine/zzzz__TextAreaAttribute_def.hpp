...
/// @brief Method .ctor, addr 0x182279fb0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field minLines, offset: 0x14, size: 0x4, def value: None
 int32_t  ___minLines;

/// @brief Field maxLines, offset: 0x18, size: 0x4, def value: None
 int32_t  ___maxLines;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::TextAreaAttribute, ___minLines) == 0x14, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::TextAreaAttribute, ___maxLines) == 0x18, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextAreaAttribute) == 0x20, "Size mismatch!");
