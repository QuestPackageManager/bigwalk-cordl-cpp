...
DEFINE_IL2CPP_CLASS(::UnityEngine::MaterialGlobalIlluminationFlags, "UnityEngine", "MaterialGlobalIlluminationFlags");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
/// @brief Field RealtimeEmissive value: I32(1)
...
static_assert(offsetof(::UnityEngine::MaterialGlobalIlluminationFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::MaterialGlobalIlluminationFlags) == 0x4, "Size mismatch!");
