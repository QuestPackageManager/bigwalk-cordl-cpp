...
DEFINE_IL2CPP_CLASS(::UnityEngine::SceneManagement::LoadSceneMode, "UnityEngine.SceneManagement", "LoadSceneMode");
// Dependencies 
namespace UnityEngine::SceneManagement {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::SceneManagement::LoadSceneMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::SceneManagement::LoadSceneMode) == 0x4, "Size mismatch!");
