...
DEFINE_IL2CPP_CLASS(::UnityEngine::SceneManagement::UnloadSceneOptions, "UnityEngine.SceneManagement", "UnloadSceneOptions");
// Dependencies 
namespace UnityEngine::SceneManagement {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::SceneManagement::UnloadSceneOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::SceneManagement::UnloadSceneOptions) == 0x4, "Size mismatch!");
