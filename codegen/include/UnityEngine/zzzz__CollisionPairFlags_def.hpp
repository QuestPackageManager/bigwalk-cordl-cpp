...
DEFINE_IL2CPP_CLASS(::UnityEngine::CollisionPairFlags, "UnityEngine", "CollisionPairFlags");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CollisionPairFlags, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CollisionPairFlags) == 0x2, "Size mismatch!");
