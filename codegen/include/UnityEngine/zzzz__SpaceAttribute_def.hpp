...
/// @brief Method .ctor, addr 0x182279500, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x180cb9e10, size 0x3c0, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::SpaceAttribute, ___height) == 0x14, "Offset mismatch!");
