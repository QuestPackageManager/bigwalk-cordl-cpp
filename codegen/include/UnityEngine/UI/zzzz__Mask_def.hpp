...
/// @brief Method GetModifiedMaterial, addr 0x1825247d0, size 0x2d0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetModifiedMaterial(::UnityEngine::Material*  baseMaterial) ;

/// @brief Method IsRaycastLocationValid, addr 0x182524aa0, size 0x90, virtual true, abstract: false, final false
inline bool IsRaycastLocationValid(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method MaskEnabled, addr 0x182524b30, size 0x70, virtual true, abstract: false, final false
inline bool MaskEnabled() ;

static inline ::UnityEngine::UI::Mask* New_ctor() ;

/// @brief Method OnDisable, addr 0x182524ba0, size 0x250, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182524df0, size 0x1d0, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSiblingGraphicEnabledDisabled, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182524fc0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_graphic, addr 0x182524fd0, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic() ;

/// @brief Method get_rectTransform, addr 0x182525020, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_showMaskGraphic, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_showMaskGraphic, addr 0x182525070, size 0xa0, virtual false, abstract: false, final false
