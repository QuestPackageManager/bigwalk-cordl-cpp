...
/// @brief Method <ActiveToggles>b__14_0, addr 0x182535ab0, size 0x10, virtual false, abstract: false, final false
inline bool _ActiveToggles_b__14_0(::UnityEngine::UI::Toggle*  x) ;

/// @brief Method <AnyTogglesOn>b__13_0, addr 0x182535ab0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ActiveToggles, addr 0x1825349f0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UI::Toggle>>* ActiveToggles() ;

/// @brief Method AnyTogglesOn, addr 0x182534ab0, size 0xc0, virtual false, abstract: false, final false
inline bool AnyTogglesOn() ;

/// @brief Method EnsureValidState, addr 0x182534b70, size 0x300, virtual false, abstract: false, final false
inline void EnsureValidState() ;

/// @brief Method GetFirstActiveToggle, addr 0x182534e70, size 0x40, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Toggle> GetFirstActiveToggle() ;

static inline ::UnityEngine::UI::ToggleGroup* New_ctor() ;

/// @brief Method NotifyToggleOn, addr 0x182534eb0, size 0x140, virtual false, abstract: false, final false
inline void NotifyToggleOn(::UnityEngine::UI::Toggle*  toggle, bool  sendCallback) ;

/// @brief Method OnEnable, addr 0x182534ff0, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterToggle, addr 0x182535000, size 0x90, virtual false, abstract: false, final false
inline void RegisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method SetAllTogglesOff, addr 0x182535090, size 0xd0, virtual false, abstract: false, final false
inline void SetAllTogglesOff(bool  sendCallback) ;

/// @brief Method Start, addr 0x182534ff0, size 0x10, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterToggle, addr 0x182535160, size 0x50, virtual false, abstract: false, final false
inline void UnregisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method ValidateToggleIsInGroup, addr 0x1825351b0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182535260, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowSwitchOff, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_allowSwitchOff() ;

/// @brief Method set_allowSwitchOff, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
