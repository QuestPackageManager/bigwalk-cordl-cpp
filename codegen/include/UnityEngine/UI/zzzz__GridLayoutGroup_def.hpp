...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::GridLayoutGroup_Axis, "UnityEngine.UI", "GridLayoutGroup/Axis");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::GridLayoutGroup_Constraint, "UnityEngine.UI", "GridLayoutGroup/Constraint");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::GridLayoutGroup_Corner, "UnityEngine.UI", "GridLayoutGroup/Corner");
...
static_assert(offsetof(::UnityEngine::UI::GridLayoutGroup_Corner, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::GridLayoutGroup_Corner) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::GridLayoutGroup_Axis, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::GridLayoutGroup_Axis) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::GridLayoutGroup_Constraint, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x182516a00, size 0x150, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x182516b50, size 0x160, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::UnityEngine::UI::GridLayoutGroup* New_ctor() ;

/// @brief Method SetCellsAlongAxis, addr 0x182516cb0, size 0x750, virtual false, abstract: false, final false
inline void SetCellsAlongAxis(int32_t  axis) ;

/// @brief Method SetLayoutHorizontal, addr 0x182517400, size 0x10, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x182517410, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182517420, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cellSize, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_cellSize() ;

/// @brief Method get_constraint, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GridLayoutGroup_Constraint get_constraint() ;

/// @brief Method get_constraintCount, addr 0x180371740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_constraintCount() ;

/// @brief Method get_spacing, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_spacing() ;

/// @brief Method get_startAxis, addr 0x180de9ef0, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GridLayoutGroup_Axis get_startAxis() ;

/// @brief Method get_startCorner, addr 0x18039fc60, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GridLayoutGroup_Corner get_startCorner() ;

/// @brief Method set_cellSize, addr 0x182517450, size 0x20, virtual false, abstract: false, final false
inline void set_cellSize(::UnityEngine::Vector2  value) ;

/// @brief Method set_constraint, addr 0x182517490, size 0x20, virtual false, abstract: false, final false
inline void set_constraint(::UnityEngine::UI::GridLayoutGroup_Constraint  value) ;

/// @brief Method set_constraintCount, addr 0x182517470, size 0x20, virtual false, abstract: false, final false
inline void set_constraintCount(int32_t  value) ;

/// @brief Method set_spacing, addr 0x1825174b0, size 0x20, virtual false, abstract: false, final false
inline void set_spacing(::UnityEngine::Vector2  value) ;

/// @brief Method set_startAxis, addr 0x1825174d0, size 0x20, virtual false, abstract: false, final false
inline void set_startAxis(::UnityEngine::UI::GridLayoutGroup_Axis  value) ;

/// @brief Method set_startCorner, addr 0x1825174f0, size 0x20, virtual false, abstract: false, final false
