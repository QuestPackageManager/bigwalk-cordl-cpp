...
// Write type traits
MARK_REF_T(::UnityEngine::UI::VertexHelper*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::VertexHelper*, "UnityEngine.UI", "VertexHelper");
...
/// @brief Method AddTriangle, addr 0x182535b00, size 0xc0, virtual false, abstract: false, final false
inline void AddTriangle(int32_t  idx0, int32_t  idx1, int32_t  idx2) ;

/// @brief Method AddUIVertexQuad, addr 0x182535bc0, size 0x170, virtual false, abstract: false, final false
inline void AddUIVertexQuad(::ArrayW<::UnityEngine::UIVertex>  verts) ;

/// @brief Method AddUIVertexStream, addr 0x182535d30, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method AddUIVertexTriangleStream, addr 0x182535dd0, size 0x80, virtual false, abstract: false, final false
inline void AddUIVertexTriangleStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  verts) ;

/// @brief Method AddVert, addr 0x182535e50, size 0x120, virtual false, abstract: false, final false
inline void AddVert(::UnityEngine::Vector3  position, ::UnityEngine::Color32  color, ::UnityEngine::Vector4  uv0) ;

/// @brief Method AddVert, addr 0x182535f70, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AddVert, addr 0x1825360e0, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method AddVert, addr 0x182536030, size 0xb0, virtual false, abstract: false, final false
inline void AddVert(::UnityEngine::UIVertex  v) ;

/// @brief Method Clear, addr 0x182536380, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x1825363f0, size 0x1a0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FillMesh, addr 0x182536590, size 0x100, virtual false, abstract: false, final false
inline void FillMesh(::UnityEngine::Mesh*  mesh) ;

/// @brief Method GetUIVertexStream, addr 0x182536690, size 0x80, virtual false, abstract: false, final false
inline void GetUIVertexStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  stream) ;

/// @brief Method InitializeListIfRequired, addr 0x182536710, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method PopulateUIVertex, addr 0x182536880, size 0xf0, virtual false, abstract: false, final false
inline void PopulateUIVertex(::by_ref<::UnityEngine::UIVertex>  vertex, int32_t  i) ;

/// @brief Method SetUIVertex, addr 0x182536970, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182536ae0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method get_currentIndexCount, addr 0x181644b30, size 0x20, virtual false, abstract: false, final false
inline int32_t get_currentIndexCount() ;

/// @brief Method get_currentVertCount, addr 0x1803a9050, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::VertexHelper) == 0x60, "Size mismatch!");
