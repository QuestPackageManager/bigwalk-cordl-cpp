...
public:
// Declarations
/// @brief Method CalculateLayoutInputHorizontal, addr 0x182517510, size 0x30, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x182517540, size 0x10, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::UnityEngine::UI::HorizontalLayoutGroup* New_ctor() ;

/// @brief Method SetLayoutHorizontal, addr 0x182517550, size 0x10, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x182517560, size 0x10, virtual true, abstract: false, final false
