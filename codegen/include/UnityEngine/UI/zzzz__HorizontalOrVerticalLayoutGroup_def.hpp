...
/// @brief Method CalcAlongAxis, addr 0x182517580, size 0x2e0, virtual false, abstract: false, final false
inline void CalcAlongAxis(int32_t  axis, bool  isVertical) ;

/// @brief Method GetChildSizes, addr 0x182517860, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method SetChildrenAlongAxis, addr 0x182517a60, size 0x7a0, virtual false, abstract: false, final false
...
/// @brief Method get_childControlHeight, addr 0x181b9c200, size 0x10, virtual false, abstract: false, final false
inline bool get_childControlHeight() ;

/// @brief Method get_childControlWidth, addr 0x181b9c210, size 0x10, virtual false, abstract: false, final false
inline bool get_childControlWidth() ;

/// @brief Method get_childForceExpandHeight, addr 0x181b9ca00, size 0x10, virtual false, abstract: false, final false
inline bool get_childForceExpandHeight() ;

/// @brief Method get_childForceExpandWidth, addr 0x182152290, size 0x10, virtual false, abstract: false, final false
inline bool get_childForceExpandWidth() ;

/// @brief Method get_childScaleHeight, addr 0x1805d8ab0, size 0x10, virtual false, abstract: false, final false
inline bool get_childScaleHeight() ;

/// @brief Method get_childScaleWidth, addr 0x180347a60, size 0xe0, virtual false, abstract: false, final false
inline bool get_childScaleWidth() ;

/// @brief Method get_reverseArrangement, addr 0x181ce7d50, size 0x10, virtual false, abstract: false, final false
inline bool get_reverseArrangement() ;

/// @brief Method get_spacing, addr 0x18046fae0, size 0x10, virtual false, abstract: false, final false
inline float_t get_spacing() ;

/// @brief Method set_childControlHeight, addr 0x182518200, size 0x10, virtual false, abstract: false, final false
inline void set_childControlHeight(bool  value) ;

/// @brief Method set_childControlWidth, addr 0x182518210, size 0x10, virtual false, abstract: false, final false
inline void set_childControlWidth(bool  value) ;

/// @brief Method set_childForceExpandHeight, addr 0x182518220, size 0x10, virtual false, abstract: false, final false
inline void set_childForceExpandHeight(bool  value) ;

/// @brief Method set_childForceExpandWidth, addr 0x182518230, size 0x10, virtual false, abstract: false, final false
inline void set_childForceExpandWidth(bool  value) ;

/// @brief Method set_childScaleHeight, addr 0x182518240, size 0x10, virtual false, abstract: false, final false
inline void set_childScaleHeight(bool  value) ;

/// @brief Method set_childScaleWidth, addr 0x182518250, size 0x10, virtual false, abstract: false, final false
inline void set_childScaleWidth(bool  value) ;

/// @brief Method set_reverseArrangement, addr 0x182518260, size 0x10, virtual false, abstract: false, final false
inline void set_reverseArrangement(bool  value) ;

/// @brief Method set_spacing, addr 0x182518270, size 0x10, virtual false, abstract: false, final false
