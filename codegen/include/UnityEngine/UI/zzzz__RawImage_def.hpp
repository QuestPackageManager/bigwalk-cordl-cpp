...
/// @brief Method OnPopulateMesh, addr 0x182527b00, size 0x340, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  vh) ;

/// @brief Method SetNativeSize, addr 0x182527e40, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182527f60, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mainTexture, addr 0x182527f90, size 0x120, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_texture, addr 0x1803459d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_texture() ;

/// @brief Method get_uvRect, addr 0x181e56d90, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_uvRect() ;

/// @brief Method set_texture, addr 0x1825280b0, size 0x70, virtual false, abstract: false, final false
inline void set_texture(::UnityEngine::Texture*  value) ;

/// @brief Method set_uvRect, addr 0x182528120, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::RawImage) == 0xf8, "Size mismatch!");
