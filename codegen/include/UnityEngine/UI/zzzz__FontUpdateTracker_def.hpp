...
// Write type traits
MARK_REF_T(::UnityEngine::UI::FontUpdateTracker*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::FontUpdateTracker*, "UnityEngine.UI", "FontUpdateTracker");
...
/// @brief Field m_Tracked, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_Tracked, put=setStaticF_m_Tracked)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Font>,::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::UI::Text>>*>*  m_Tracked;

/// @brief Method RebuildForFont, addr 0x182363c80, size 0x110, virtual false, abstract: false, final false
static inline void RebuildForFont(::UnityEngine::Font*  f) ;

/// @brief Method TrackText, addr 0x182363d90, size 0x150, virtual false, abstract: false, final false
static inline void TrackText(::UnityEngine::UI::Text*  t) ;

/// @brief Method UntrackText, addr 0x182363ee0, size 0x130, virtual false, abstract: false, final false
...
static inline void setStaticF_m_Tracked(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Font>,::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::UI::Text>>*>*  value) ;
...
static_assert(sizeof(::UnityEngine::UI::FontUpdateTracker) == 0x10, "Size mismatch!");
