...
static_assert(offsetof(::UnityEngine::UI::Navigation_Mode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::Navigation_Mode) == 0x4, "Size mismatch!");
...
/// @brief Method Equals, addr 0x182527480, size 0xc0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::Navigation  other) ;

/// @brief Method get_defaultNavigation, addr 0x182527540, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_selectOnDown, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnDown() ;

/// @brief Method get_selectOnLeft, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnLeft() ;

/// @brief Method get_selectOnRight, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnRight() ;

/// @brief Method get_selectOnUp, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnUp() ;

/// @brief Method get_wrapAround, addr 0x1804bda20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_selectOnDown, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_selectOnDown(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnLeft, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_selectOnLeft(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnRight, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_selectOnRight(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnUp, addr 0x180378fe0, size 0x10, virtual false, abstract: false, final false
inline void set_selectOnUp(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_wrapAround, addr 0x1804bda30, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Mode", ty: "::UnityEngine::UI::Navigation_Mode", modifiers: "", def_value: None }, CppParam { name: "m_WrapAround", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnUp", ty: "::UnityW<::UnityEngine::UI::Selectable>", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnDown", ty: "::UnityW<::UnityEngine::UI::Selectable>", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnLeft", ty: "::UnityW<::UnityEngine::UI::Selectable>", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnRight", ty: "::UnityW<::UnityEngine::UI::Selectable>", modifiers: "", def_value: None }]
constexpr Navigation(::UnityEngine::UI::Navigation_Mode  m_Mode, bool  m_WrapAround, ::UnityW<::UnityEngine::UI::Selectable>  m_SelectOnUp, ::UnityW<::UnityEngine::UI::Selectable>  m_SelectOnDown, ::UnityW<::UnityEngine::UI::Selectable>  m_SelectOnLeft, ::UnityW<::UnityEngine::UI::Selectable>  m_SelectOnRight) noexcept;
