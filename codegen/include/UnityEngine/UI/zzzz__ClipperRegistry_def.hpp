...
// Write type traits
MARK_REF_T(::UnityEngine::UI::ClipperRegistry*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::ClipperRegistry*, "UnityEngine.UI", "ClipperRegistry");
...
/// @brief Method Cull, addr 0x18235d880, size 0xd0, virtual false, abstract: false, final false
inline void Cull() ;

/// @brief Method Disable, addr 0x18235d950, size 0x30, virtual false, abstract: false, final false
static inline void Disable(::UnityEngine::UI::IClipper*  c) ;

static inline ::UnityEngine::UI::ClipperRegistry* New_ctor() ;

/// @brief Method Register, addr 0x18235d980, size 0x30, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::UI::IClipper*  c) ;

/// @brief Method Unregister, addr 0x18235d9b0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18235d9e0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UI::ClipperRegistry* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x18235da30, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::ClipperRegistry) == 0x18, "Size mismatch!");
