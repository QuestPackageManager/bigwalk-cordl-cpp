...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::AspectRatioFitter_AspectMode, "UnityEngine.UI", "AspectRatioFitter/AspectMode");
...
static_assert(offsetof(::UnityEngine::UI::AspectRatioFitter_AspectMode, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method DoesParentExists, addr 0x18049c410, size 0x10, virtual false, abstract: false, final false
inline bool DoesParentExists() ;

/// @brief Method GetParentSize, addr 0x182515880, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetParentSize() ;

/// @brief Method GetSizeDeltaToProduceSize, addr 0x182515930, size 0x140, virtual false, abstract: false, final false
inline float_t GetSizeDeltaToProduceSize(float_t  size, int32_t  axis) ;

/// @brief Method IsAspectModeValid, addr 0x182515a70, size 0x20, virtual false, abstract: false, final false
inline bool IsAspectModeValid() ;

/// @brief Method IsComponentValidOnObject, addr 0x182515a90, size 0x60, virtual false, abstract: false, final false
inline bool IsComponentValidOnObject() ;

static inline ::UnityEngine::UI::AspectRatioFitter* New_ctor() ;

/// @brief Method OnDisable, addr 0x182515af0, size 0x70, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182515b60, size 0x70, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x182515bd0, size 0x10, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x182515b60, size 0x70, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x182515bd0, size 0x10, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetLayoutHorizontal, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method Start, addr 0x182515be0, size 0x80, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x182515f50, size 0x20, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRect, addr 0x182515c60, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182515f70, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_aspectMode, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::AspectRatioFitter_AspectMode get_aspectMode() ;

/// @brief Method get_aspectRatio, addr 0x1802f80d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_aspectRatio() ;

/// @brief Method get_rectTransform, addr 0x182515f80, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_aspectMode, addr 0x182515fd0, size 0x40, virtual false, abstract: false, final false
inline void set_aspectMode(::UnityEngine::UI::AspectRatioFitter_AspectMode  value) ;

/// @brief Method set_aspectRatio, addr 0x182516010, size 0x40, virtual false, abstract: false, final false
