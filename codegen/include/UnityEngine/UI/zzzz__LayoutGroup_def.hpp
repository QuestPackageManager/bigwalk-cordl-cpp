...
/// @brief Method MoveNext, addr 0x182525cf0, size 0x70, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "", ty: "LayoutGroup__DelayedSetDirty_d__57", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
LayoutGroup__DelayedSetDirty_d__57(LayoutGroup__DelayedSetDirty_d__57 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "LayoutGroup__DelayedSetDirty_d__57", modifiers: "const&", def_value: None }]
...
/// @brief Field m_RectChildren, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RectChildren, put=__cordl_internal_set_m_RectChildren)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RectTransform>>*  m_RectChildren;
...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x182521200, size 0x280, virtual true, abstract: false, final false
...
/// @brief Method DelayedSetDirty, addr 0x182521480, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DelayedSetDirty(::UnityEngine::RectTransform*  rectTransform) ;

/// @brief Method GetAlignmentOnAxis, addr 0x1825214d0, size 0x50, virtual false, abstract: false, final false
inline float_t GetAlignmentOnAxis(int32_t  axis) ;

/// @brief Method GetStartOffset, addr 0x182521520, size 0x140, virtual false, abstract: false, final false
inline float_t GetStartOffset(int32_t  axis, float_t  requiredSpaceWithoutPadding) ;

/// @brief Method GetTotalFlexibleSize, addr 0x182521660, size 0x40, virtual false, abstract: false, final false
inline float_t GetTotalFlexibleSize(int32_t  axis) ;

/// @brief Method GetTotalMinSize, addr 0x1825216a0, size 0x40, virtual false, abstract: false, final false
inline float_t GetTotalMinSize(int32_t  axis) ;

/// @brief Method GetTotalPreferredSize, addr 0x1825216e0, size 0x40, virtual false, abstract: false, final false
inline float_t GetTotalPreferredSize(int32_t  axis) ;

static inline ::UnityEngine::UI::LayoutGroup* New_ctor() ;

/// @brief Method OnChildRectTransformDimensionsChange, addr 0x182521720, size 0x30, virtual true, abstract: false, final false
inline void OnChildRectTransformDimensionsChange() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x182521750, size 0x10, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x182521760, size 0xb0, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182521810, size 0x60, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x182521870, size 0x90, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformChildrenChanged, addr 0x182521750, size 0x10, virtual true, abstract: false, final false
inline void OnTransformChildrenChanged() ;

/// @brief Method SetChildAlongAxis, addr 0x182521ba0, size 0x70, virtual false, abstract: false, final false
inline void SetChildAlongAxis(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos) ;

/// @brief Method SetChildAlongAxis, addr 0x182521c10, size 0x80, virtual false, abstract: false, final false
inline void SetChildAlongAxis(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos, float_t  size) ;

/// @brief Method SetChildAlongAxisWithScale, addr 0x182521a70, size 0x130, virtual false, abstract: false, final false
inline void SetChildAlongAxisWithScale(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos, float_t  scaleFactor) ;

/// @brief Method SetChildAlongAxisWithScale, addr 0x182521900, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method SetDirty, addr 0x182521c90, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SetLayoutInputForAxis, addr 0x182521da0, size 0x50, virtual false, abstract: false, final false
...
template<typename T>
inline void SetProperty(::by_ref<T>  currentValue, T  newValue) ;
...
constexpr ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RectTransform>>* const& __cordl_internal_get_m_RectChildren() const;
...
/// @brief Method .ctor, addr 0x182521df0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_childAlignment, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextAnchor get_childAlignment() ;

/// @brief Method get_flexibleHeight, addr 0x182521eb0, size 0x10, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x182521ec0, size 0x10, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_isRootLayoutGroup, addr 0x182521ed0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_minHeight, addr 0x182521f50, size 0x10, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x182521f60, size 0x10, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_padding, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::RectOffset* get_padding() ;

/// @brief Method get_preferredHeight, addr 0x182521f70, size 0x10, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x182521f80, size 0x10, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_rectChildren, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RectTransform>>* get_rectChildren() ;

/// @brief Method get_rectTransform, addr 0x182521f90, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_childAlignment, addr 0x182521fe0, size 0x20, virtual false, abstract: false, final false
inline void set_childAlignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_padding, addr 0x182522000, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::LayoutGroup) == 0x60, "Size mismatch!");
