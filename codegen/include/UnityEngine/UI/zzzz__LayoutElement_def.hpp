...
/// @brief Method OnBeforeTransformParentChanged, addr 0x182520f50, size 0x70, virtual true, abstract: false, final false
inline void OnBeforeTransformParentChanged() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x182520f50, size 0x70, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x182520f50, size 0x70, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182520f50, size 0x70, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x182520f50, size 0x70, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x182520f50, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182520fc0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_flexibleHeight, addr 0x1802f7fd0, size 0x10, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x1802e2da0, size 0x10, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_ignoreLayout, addr 0x1803a7410, size 0x10, virtual true, abstract: false, final false
inline bool get_ignoreLayout() ;

/// @brief Method get_layoutPriority, addr 0x1803231b0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x1803f2be0, size 0x10, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x1802f80d0, size 0x10, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_preferredHeight, addr 0x1803f68d0, size 0x10, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x18049a530, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_flexibleHeight, addr 0x182521000, size 0x40, virtual true, abstract: false, final false
inline void set_flexibleHeight(float_t  value) ;

/// @brief Method set_flexibleWidth, addr 0x182521040, size 0x40, virtual true, abstract: false, final false
inline void set_flexibleWidth(float_t  value) ;

/// @brief Method set_ignoreLayout, addr 0x182521080, size 0x40, virtual true, abstract: false, final false
inline void set_ignoreLayout(bool  value) ;

/// @brief Method set_layoutPriority, addr 0x1825210c0, size 0x40, virtual true, abstract: false, final false
inline void set_layoutPriority(int32_t  value) ;

/// @brief Method set_minHeight, addr 0x182521100, size 0x40, virtual true, abstract: false, final false
inline void set_minHeight(float_t  value) ;

/// @brief Method set_minWidth, addr 0x182521140, size 0x40, virtual true, abstract: false, final false
inline void set_minWidth(float_t  value) ;

/// @brief Method set_preferredHeight, addr 0x182521180, size 0x40, virtual true, abstract: false, final false
inline void set_preferredHeight(float_t  value) ;

/// @brief Method set_preferredWidth, addr 0x1825211c0, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UI::LayoutElement) == 0x40, "Size mismatch!");
