...
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Slider_Axis, "UnityEngine.UI", "Slider/Axis");
DEFINE_IL2CPP_CLASS(::UnityEngine::UI::Slider_Direction, "UnityEngine.UI", "Slider/Direction");
...
static_assert(offsetof(::UnityEngine::UI::Slider_Direction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UI::Slider_Direction) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UI::Slider_Axis, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method ClampValue, addr 0x182531340, size 0x30, virtual false, abstract: false, final false
inline float_t ClampValue(float_t  input) ;

/// @brief Method FindSelectableOnDown, addr 0x182531370, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown() ;

/// @brief Method FindSelectableOnLeft, addr 0x1825313a0, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft() ;

/// @brief Method FindSelectableOnRight, addr 0x1825313d0, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight() ;

/// @brief Method FindSelectableOnUp, addr 0x182531400, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method OnDidApplyAnimationProperties, addr 0x182531430, size 0x1c0, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x18252e060, size 0x10, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x1825315f0, size 0x70, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x182531660, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method OnMove, addr 0x1825316b0, size 0x390, virtual true, abstract: false, final false
inline void OnMove(::UnityEngine::EventSystems::AxisEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x182531a40, size 0x1f0, virtual true, abstract: false, final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x182531c30, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method Set, addr 0x182531de0, size 0xc0, virtual true, abstract: false, final false
inline void Set(float_t  input, bool  sendCallback) ;

/// @brief Method SetDirection, addr 0x182531c70, size 0x150, virtual false, abstract: false, final false
inline void SetDirection(::UnityEngine::UI::Slider_Direction  direction, bool  includeRectLayouts) ;

/// @brief Method SetValueWithoutNotify, addr 0x182531dc0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x1825325b0, size 0x50, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCachedReferences, addr 0x182531ea0, size 0x260, virtual false, abstract: false, final false
inline void UpdateCachedReferences() ;

/// @brief Method UpdateDrag, addr 0x182532100, size 0x230, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData, ::UnityEngine::Camera*  cam) ;

/// @brief Method UpdateVisuals, addr 0x182532330, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182532600, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_axis, addr 0x182532670, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_Axis get_axis() ;

/// @brief Method get_direction, addr 0x182193f70, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_Direction get_direction() ;

/// @brief Method get_fillRect, addr 0x1803370a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_fillRect() ;

/// @brief Method get_handleRect, addr 0x1803370c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_handleRect() ;

/// @brief Method get_maxValue, addr 0x1824e5920, size 0x10, virtual false, abstract: false, final false
inline float_t get_maxValue() ;

/// @brief Method get_minValue, addr 0x1821d28c0, size 0x10, virtual false, abstract: false, final false
inline float_t get_minValue() ;

/// @brief Method get_normalizedValue, addr 0x182532690, size 0xf0, virtual false, abstract: false, final false
inline float_t get_normalizedValue() ;

/// @brief Method get_onValueChanged, addr 0x180337110, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_SliderEvent* get_onValueChanged() ;

/// @brief Method get_reverseValue, addr 0x182532780, size 0x20, virtual false, abstract: false, final false
inline bool get_reverseValue() ;

/// @brief Method get_stepSize, addr 0x1825327a0, size 0x30, virtual false, abstract: false, final false
inline float_t get_stepSize() ;

/// @brief Method get_value, addr 0x1825327d0, size 0x20, virtual true, abstract: false, final false
inline float_t get_value() ;

/// @brief Method get_wholeNumbers, addr 0x1805d37d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x1825327f0, size 0x40, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UI::Slider_Direction  value) ;

/// @brief Method set_fillRect, addr 0x182532830, size 0x40, virtual false, abstract: false, final false
inline void set_fillRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_handleRect, addr 0x182532870, size 0x40, virtual false, abstract: false, final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_maxValue, addr 0x1825328b0, size 0x60, virtual false, abstract: false, final false
inline void set_maxValue(float_t  value) ;

/// @brief Method set_minValue, addr 0x182532910, size 0x60, virtual false, abstract: false, final false
inline void set_minValue(float_t  value) ;

/// @brief Method set_normalizedValue, addr 0x182532970, size 0x50, virtual false, abstract: false, final false
inline void set_normalizedValue(float_t  value) ;

/// @brief Method set_onValueChanged, addr 0x180337210, size 0x20, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::Slider_SliderEvent*  value) ;

/// @brief Method set_value, addr 0x1825329c0, size 0x20, virtual true, abstract: false, final false
inline void set_value(float_t  value) ;

/// @brief Method set_wholeNumbers, addr 0x1825329e0, size 0x60, virtual false, abstract: false, final false
