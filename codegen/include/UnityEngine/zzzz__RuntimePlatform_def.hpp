...
DEFINE_IL2CPP_CLASS(::UnityEngine::RuntimePlatform, "UnityEngine", "RuntimePlatform");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RuntimePlatform, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RuntimePlatform) == 0x4, "Size mismatch!");
