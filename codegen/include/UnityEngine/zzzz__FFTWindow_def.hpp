...
DEFINE_IL2CPP_CLASS(::UnityEngine::FFTWindow, "UnityEngine", "FFTWindow");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::FFTWindow, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::FFTWindow) == 0x4, "Size mismatch!");
