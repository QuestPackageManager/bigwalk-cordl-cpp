...
// Write type traits
MARK_REF_T(::UnityEngine::Scripting::RequiredMemberAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Scripting::RequiredMemberAttribute*, "UnityEngine.Scripting", "RequiredMemberAttribute");
...
static_assert(sizeof(::UnityEngine::Scripting::RequiredMemberAttribute) == 0x10, "Size mismatch!");
