...
/// @brief Method .ctor, addr 0x18227f6a0, size 0x130, virtual false, abstract: false, final false
inline void _ctor(bool  autoUpdateAPI, ::StringW  sourceNamespace, ::StringW  sourceAssembly, ::StringW  sourceClassName) ;

/// @brief Method .ctor, addr 0x18227f7d0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Scripting::APIUpdating::MovedFromAttribute) == 0x30, "Size mismatch!");
