...
/// @brief Method .ctor, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  optional) ;

/// @brief Method set_GenerateProxy, addr 0x1818376c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Optional, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Scripting::RequiredByNativeCodeAttribute) == 0x20, "Size mismatch!");
