...
DEFINE_IL2CPP_CLASS(::UnityEngine::TouchPhase, "UnityEngine", "TouchPhase");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TouchPhase, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TouchPhase) == 0x4, "Size mismatch!");
