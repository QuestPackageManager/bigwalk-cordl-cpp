...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Events::CachedInvokableCall_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Events::CachedInvokableCall_1, "UnityEngine.Events", "CachedInvokableCall`1");
