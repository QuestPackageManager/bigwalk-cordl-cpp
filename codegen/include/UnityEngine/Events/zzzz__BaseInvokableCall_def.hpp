...
// Write type traits
MARK_REF_T(::UnityEngine::Events::BaseInvokableCall*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::BaseInvokableCall*, "UnityEngine.Events", "BaseInvokableCall");
...
public:
// Declarations
/// @brief Method AllowInvoke, addr 0x18227d210, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18227d260, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Events::BaseInvokableCall) == 0x10, "Size mismatch!");
