...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TagValueType, "UnityEngine.TextCore.Text", "TagValueType");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::TagValueType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::TagValueType) == 0x4, "Size mismatch!");
