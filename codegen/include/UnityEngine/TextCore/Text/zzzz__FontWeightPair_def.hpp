...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::FontWeightPair, "UnityEngine.TextCore.Text", "FontWeightPair");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "regularTypeface", ty: "::UnityW<::UnityEngine::TextCore::Text::FontAsset>", modifiers: "", def_value: None }, CppParam { name: "italicTypeface", ty: "::UnityW<::UnityEngine::TextCore::Text::FontAsset>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::TextCore::Text::FontWeightPair) == 0x10, "Size mismatch!");
