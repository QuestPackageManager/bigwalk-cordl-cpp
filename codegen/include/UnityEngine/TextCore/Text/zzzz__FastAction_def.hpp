...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::FastAction*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::FastAction*, "UnityEngine.TextCore.Text", "FastAction");
...
static_assert(sizeof(::UnityEngine::TextCore::Text::FastAction) == 0x20, "Size mismatch!");
