...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::Character*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::Character*, "UnityEngine.TextCore.Text", "Character");
...
/// @brief Method .ctor, addr 0x182317ff0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182318010, size 0x80, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::UnityEngine::TextCore::Text::FontAsset*  fontAsset, ::UnityEngine::TextCore::Glyph*  glyph) ;

/// @brief Method .ctor, addr 0x182317f90, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::Character) == 0x30, "Size mismatch!");
