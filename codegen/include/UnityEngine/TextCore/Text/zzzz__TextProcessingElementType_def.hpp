...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextProcessingElementType, "UnityEngine.TextCore.Text", "TextProcessingElementType");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::TextProcessingElementType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::TextProcessingElementType) == 0x4, "Size mismatch!");
