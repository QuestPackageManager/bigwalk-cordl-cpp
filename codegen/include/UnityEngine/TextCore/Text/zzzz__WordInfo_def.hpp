...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::WordInfo, "UnityEngine.TextCore.Text", "WordInfo");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::WordInfo) == 0xc, "Size mismatch!");
