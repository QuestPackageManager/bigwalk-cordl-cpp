...
public:
// Declarations
/// @brief Method CompareColors, addr 0x182318090, size 0x40, virtual false, abstract: false, final false
static inline bool CompareColors(::UnityEngine::Color32  a, ::UnityEngine::Color32  b) ;

/// @brief Method MultiplyColors, addr 0x1823180d0, size 0x2d0, virtual false, abstract: false, final false
