...
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::TextCore::Text::TextProcessingStack_1, "UnityEngine.TextCore.Text", "TextProcessingStack`1");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// cpp template
template<typename T>
...
/// @brief Method SetDefault, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void SetDefault(::ArrayW<::UnityEngine::TextCore::Text::TextProcessingStack_1<T>>  stack, T  item) ;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<T>  stack) ;
