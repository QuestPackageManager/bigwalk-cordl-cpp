...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::SpriteGlyph*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::SpriteGlyph*, "UnityEngine.TextCore.Text", "SpriteGlyph");
...
static_assert(sizeof(::UnityEngine::TextCore::Text::SpriteGlyph) == 0x50, "Size mismatch!");
