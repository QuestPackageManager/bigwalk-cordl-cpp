...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::CharacterSubstitution, "UnityEngine.TextCore.Text", "CharacterSubstitution");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::CharacterSubstitution) == 0x8, "Size mismatch!");
