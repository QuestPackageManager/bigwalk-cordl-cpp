...
/// @brief Method LoadLineBreakingRules, addr 0x182359180, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method get_followingCharactersLookup, addr 0x1823592b0, size 0x30, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<uint32_t>* get_followingCharactersLookup() ;

/// @brief Method get_leadingCharactersLookup, addr 0x1823592e0, size 0x30, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<uint32_t>* get_leadingCharactersLookup() ;

/// @brief Method get_useModernHangulLineBreakingRules, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
