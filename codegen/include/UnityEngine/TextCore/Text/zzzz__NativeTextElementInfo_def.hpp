...
// Ctor Parameters [CppParam { name: "glyphID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "bottomLeft", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: None }, CppParam { name: "topLeft", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: None }, CppParam { name: "topRight", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: None }, CppParam { name: "bottomRight", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: None }]
constexpr NativeTextElementInfo(int32_t  glyphID, ::UnityEngine::TextCore::Text::TextCoreVertex  bottomLeft, ::UnityEngine::TextCore::Text::TextCoreVertex  topLeft, ::UnityEngine::TextCore::Text::TextCoreVertex  topRight, ::UnityEngine::TextCore::Text::TextCoreVertex  bottomRight) noexcept;
...
static_assert(sizeof(::UnityEngine::TextCore::Text::NativeTextElementInfo) == 0x84, "Size mismatch!");
