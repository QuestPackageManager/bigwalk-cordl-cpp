...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextAlignment, "UnityEngine.TextCore.Text", "TextAlignment");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::TextAlignment, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::TextAlignment) == 0x4, "Size mismatch!");
