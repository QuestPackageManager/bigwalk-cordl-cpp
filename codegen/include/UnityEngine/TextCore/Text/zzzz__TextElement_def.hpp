...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextElement*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextElement*, "UnityEngine.TextCore.Text", "TextElement");
...
/// @brief Method get_elementType, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextElementType get_elementType() ;

/// @brief Method get_glyph, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Glyph* get_glyph() ;

/// @brief Method get_glyphIndex, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_glyphIndex() ;

/// @brief Method get_scale, addr 0x18049a530, size 0x10, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_textAsset, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::TextCore::Text::TextAsset> get_textAsset() ;

/// @brief Method get_unicode, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_unicode() ;

/// @brief Method set_glyph, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_glyph(::UnityEngine::TextCore::Glyph*  value) ;

/// @brief Method set_glyphIndex, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
inline void set_glyphIndex(uint32_t  value) ;

/// @brief Method set_scale, addr 0x180bb44a0, size 0x3450, virtual false, abstract: false, final false
inline void set_scale(float_t  value) ;

/// @brief Method set_textAsset, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_textAsset(::UnityEngine::TextCore::Text::TextAsset*  value) ;

/// @brief Method set_unicode, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextElement) == 0x30, "Size mismatch!");
