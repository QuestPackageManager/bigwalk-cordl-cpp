...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextEventManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextEventManager*, "UnityEngine.TextCore.Text", "TextEventManager");
...
/// @brief Field COLOR_GRADIENT_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_COLOR_GRADIENT_PROPERTY_EVENT, put=setStaticF_COLOR_GRADIENT_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_1<::UnityW<::UnityEngine::Object>>*  COLOR_GRADIENT_PROPERTY_EVENT;

/// @brief Field DRAG_AND_DROP_MATERIAL_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_DRAG_AND_DROP_MATERIAL_EVENT, put=setStaticF_DRAG_AND_DROP_MATERIAL_EVENT)) ::UnityEngine::TextCore::Text::FastAction_3<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Material>>*  DRAG_AND_DROP_MATERIAL_EVENT;

/// @brief Field FONT_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_FONT_PROPERTY_EVENT, put=setStaticF_FONT_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  FONT_PROPERTY_EVENT;

/// @brief Field MATERIAL_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_MATERIAL_PROPERTY_EVENT, put=setStaticF_MATERIAL_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_2<bool,::UnityW<::UnityEngine::Material>>*  MATERIAL_PROPERTY_EVENT;
...
/// @brief Field SPRITE_ASSET_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SPRITE_ASSET_PROPERTY_EVENT, put=setStaticF_SPRITE_ASSET_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  SPRITE_ASSET_PROPERTY_EVENT;

/// @brief Field TEXTMESHPRO_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_TEXTMESHPRO_PROPERTY_EVENT, put=setStaticF_TEXTMESHPRO_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  TEXTMESHPRO_PROPERTY_EVENT;

/// @brief Field TEXTMESHPRO_UGUI_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_TEXTMESHPRO_UGUI_PROPERTY_EVENT, put=setStaticF_TEXTMESHPRO_UGUI_PROPERTY_EVENT)) ::UnityEngine::TextCore::Text::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  TEXTMESHPRO_UGUI_PROPERTY_EVENT;
...
/// @brief Method ON_FONT_PROPERTY_CHANGED, addr 0x18234ae60, size 0x50, virtual false, abstract: false, final false
...
static inline ::UnityEngine::TextCore::Text::FastAction_3<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Material>>* getStaticF_DRAG_AND_DROP_MATERIAL_EVENT() ;
...
static inline void setStaticF_DRAG_AND_DROP_MATERIAL_EVENT(::UnityEngine::TextCore::Text::FastAction_3<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Material>>*  value) ;
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextEventManager) == 0x10, "Size mismatch!");
