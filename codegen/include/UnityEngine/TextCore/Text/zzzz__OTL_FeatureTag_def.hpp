#pragma once
// IWYU pragma private; include "UnityEngine/TextCore/Text/OTL_FeatureTag.hpp"
...
// Write type traits
MARK_VAL_T(::UnityEngine::TextCore::Text::OTL_FeatureTag);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::OTL_FeatureTag, "UnityEngine.TextCore.Text", "OTL_FeatureTag");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
// CS Name: UnityEngine.TextCore.Text.OTL_FeatureTag
...
static ::UnityEngine::TextCore::Text::OTL_FeatureTag const kern;

/// @brief Field liga value: U32(1818847073)
static ::UnityEngine::TextCore::Text::OTL_FeatureTag const liga;

/// @brief Field mark value: U32(1835102827)
static ::UnityEngine::TextCore::Text::OTL_FeatureTag const mark;

/// @brief Field mkmk value: U32(1835756907)
static ::UnityEngine::TextCore::Text::OTL_FeatureTag const mkmk;
...
static_assert(offsetof(::UnityEngine::TextCore::Text::OTL_FeatureTag, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::OTL_FeatureTag) == 0x4, "Size mismatch!");
