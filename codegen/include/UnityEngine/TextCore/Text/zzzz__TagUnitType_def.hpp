...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TagUnitType, "UnityEngine.TextCore.Text", "TagUnitType");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::Text::TagUnitType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::Text::TagUnitType) == 0x4, "Size mismatch!");
