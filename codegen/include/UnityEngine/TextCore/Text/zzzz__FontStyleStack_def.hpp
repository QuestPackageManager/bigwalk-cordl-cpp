...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::FontStyleStack, "UnityEngine.TextCore.Text", "FontStyleStack");
// Dependencies 
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
public:
// Declarations
/// @brief Method Add, addr 0x1821e8990, size 0xc0, virtual false, abstract: false, final false
inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles  style) ;

/// @brief Method Clear, addr 0x1821e8a50, size 0x20, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x1821e8a70, size 0x140, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::FontStyleStack) == 0xa, "Size mismatch!");
