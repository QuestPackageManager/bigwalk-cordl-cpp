...
/// @brief Method get_ascentLine, addr 0x1803f2be0, size 0x10, virtual false, abstract: false, final false
inline float_t get_ascentLine() ;

/// @brief Method get_baseline, addr 0x1802e2da0, size 0x10, virtual false, abstract: false, final false
inline float_t get_baseline() ;

/// @brief Method get_capLine, addr 0x18049a530, size 0x10, virtual false, abstract: false, final false
inline float_t get_capLine() ;

/// @brief Method get_descentLine, addr 0x1802f7fd0, size 0x10, virtual false, abstract: false, final false
inline float_t get_descentLine() ;

/// @brief Method get_faceIndex, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_faceIndex() ;

/// @brief Method get_familyName, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_familyName() ;

/// @brief Method get_lineHeight, addr 0x1802f80d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_lineHeight() ;

/// @brief Method get_meanLine, addr 0x1803f68d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_meanLine() ;

/// @brief Method get_pointSize, addr 0x18048d8a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_strikethroughOffset, addr 0x180315260, size 0x10, virtual false, abstract: false, final false
inline float_t get_strikethroughOffset() ;

/// @brief Method get_styleName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_styleName() ;

/// @brief Method get_subscriptOffset, addr 0x1802e2d80, size 0x10, virtual false, abstract: false, final false
inline float_t get_subscriptOffset() ;

/// @brief Method get_subscriptSize, addr 0x1802f8050, size 0x10, virtual false, abstract: false, final false
inline float_t get_subscriptSize() ;

/// @brief Method get_superscriptOffset, addr 0x1802e2d90, size 0x10, virtual false, abstract: false, final false
inline float_t get_superscriptOffset() ;

/// @brief Method get_superscriptSize, addr 0x1802e2b90, size 0x10, virtual false, abstract: false, final false
inline float_t get_superscriptSize() ;

/// @brief Method get_tabWidth, addr 0x18046fb00, size 0x10, virtual false, abstract: false, final false
inline float_t get_tabWidth() ;

/// @brief Method get_underlineOffset, addr 0x1802f8070, size 0x10, virtual false, abstract: false, final false
inline float_t get_underlineOffset() ;

/// @brief Method get_underlineThickness, addr 0x180356140, size 0x10, virtual false, abstract: false, final false
inline float_t get_underlineThickness() ;

/// @brief Method get_unitsPerEM, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_unitsPerEM() ;

/// @brief Method set_capLine, addr 0x180bb44a0, size 0x3450, virtual false, abstract: false, final false
inline void set_capLine(float_t  value) ;

/// @brief Method set_meanLine, addr 0x18046fb30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_strikethroughOffset, addr 0x1803dccc0, size 0x10, virtual false, abstract: false, final false
inline void set_strikethroughOffset(float_t  value) ;

/// @brief Method set_unitsPerEM, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_FaceIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_FamilyName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_StyleName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_PointSize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Scale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_UnitsPerEM", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_LineHeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_AscentLine", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_CapLine", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_MeanLine", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Baseline", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_DescentLine", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SuperscriptOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SuperscriptSize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SubscriptOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SubscriptSize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_UnderlineOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_UnderlineThickness", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_StrikethroughOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_StrikethroughThickness", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_TabWidth", ty: "float_t", modifiers: "", def_value: None }]
