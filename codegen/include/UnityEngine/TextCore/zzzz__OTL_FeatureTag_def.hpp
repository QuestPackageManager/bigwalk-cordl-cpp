...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::OTL_FeatureTag, "UnityEngine.TextCore", "OTL_FeatureTag");
// Dependencies 
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextCore::OTL_FeatureTag, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextCore::OTL_FeatureTag) == 0x4, "Size mismatch!");
