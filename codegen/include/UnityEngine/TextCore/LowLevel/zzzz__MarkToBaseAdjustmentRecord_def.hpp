...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::LowLevel::MarkToBaseAdjustmentRecord, "UnityEngine.TextCore.LowLevel", "MarkToBaseAdjustmentRecord");
...
public:
// Declarations
 __declspec(property(get=get_baseGlyphAnchorPoint, put=set_baseGlyphAnchorPoint)) ::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint  baseGlyphAnchorPoint;
...
/// @brief Method get_baseGlyphAnchorPoint, addr 0x180a177e0, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint get_baseGlyphAnchorPoint() ;

/// @brief Method get_baseGlyphID, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_baseGlyphID() ;

/// @brief Method get_markGlyphID, addr 0x1803bdb30, size 0x10, virtual false, abstract: false, final false
inline uint32_t get_markGlyphID() ;

/// @brief Method get_markPositionAdjustment, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::MarkPositionAdjustment get_markPositionAdjustment() ;

/// @brief Method set_baseGlyphAnchorPoint, addr 0x180ded520, size 0x4d0, virtual false, abstract: false, final false
inline void set_baseGlyphAnchorPoint(::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint  value) ;

/// @brief Method set_baseGlyphID, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
inline void set_baseGlyphID(uint32_t  value) ;

/// @brief Method set_markGlyphID, addr 0x1804bdb30, size 0x10, virtual false, abstract: false, final false
inline void set_markGlyphID(uint32_t  value) ;

/// @brief Method set_markPositionAdjustment, addr 0x1804bda40, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BaseGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_BaseGlyphAnchorPoint", ty: "::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint", modifiers: "", def_value: None }, CppParam { name: "m_MarkGlyphID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_MarkPositionAdjustment", ty: "::UnityEngine::TextCore::LowLevel::MarkPositionAdjustment", modifiers: "", def_value: None }]
constexpr MarkToBaseAdjustmentRecord(uint32_t  m_BaseGlyphID, ::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint  m_BaseGlyphAnchorPoint, uint32_t  m_MarkGlyphID, ::UnityEngine::TextCore::LowLevel::MarkPositionAdjustment  m_MarkPositionAdjustment) noexcept;
...
static_assert(sizeof(::UnityEngine::TextCore::LowLevel::MarkToBaseAdjustmentRecord) == 0x18, "Size mismatch!");
