...
public:
// Declarations
/// @brief Field lines, offset 0x14, size 0x4 
...
/// @brief Method .ctor, addr 0x182274ac0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field lines, offset: 0x14, size: 0x4, def value: None
 int32_t  ___lines;
...
static_assert(offsetof(::UnityEngine::MultilineAttribute, ___lines) == 0x14, "Offset mismatch!");
