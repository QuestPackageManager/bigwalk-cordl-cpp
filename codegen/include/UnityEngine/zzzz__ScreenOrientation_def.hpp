...
DEFINE_IL2CPP_CLASS(::UnityEngine::ScreenOrientation, "UnityEngine", "ScreenOrientation");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ScreenOrientation, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ScreenOrientation) == 0x4, "Size mismatch!");
