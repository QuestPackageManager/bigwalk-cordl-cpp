...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::GradientSettingsAtlas*);
MARK_VAL_T(::UnityEngine::UIElements::UIR::GradientSettingsAtlas_RawTexture);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::GradientSettingsAtlas*, "UnityEngine.UIElements.UIR", "GradientSettingsAtlas");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::GradientSettingsAtlas_RawTexture, "UnityEngine.UIElements.UIR", "GradientSettingsAtlas/RawTexture");
...
public:
// Declarations
/// @brief Method WriteRawFloat4Packed, addr 0x182433c00, size 0xa0, virtual false, abstract: false, final false
inline void WriteRawFloat4Packed(float_t  f0, float_t  f1, float_t  f2, float_t  f3, int32_t  destX, int32_t  destY) ;

/// @brief Method WriteRawInt2Packed, addr 0x182433ca0, size 0x1a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GradientSettingsAtlas_RawTexture) == 0x10, "Size mismatch!");
...
/// @brief Method Add, addr 0x18242f0d0, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Add(int32_t  count) ;

/// @brief Method Commit, addr 0x18242f180, size 0x150, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method Dispose, addr 0x180e6eca0, size 0x5510, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18242f2d0, size 0x30, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::UnityEngine::UIElements::UIR::GradientSettingsAtlas* New_ctor(int32_t  length) ;

/// @brief Method PrepareAtlas, addr 0x18242f300, size 0x110, virtual false, abstract: false, final false
inline void PrepareAtlas() ;

/// @brief Method Remove, addr 0x18242f410, size 0x40, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::UIElements::UIR::Alloc  alloc) ;

/// @brief Method Reset, addr 0x18242f450, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Write, addr 0x18242f4d0, size 0x420, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18242f960, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_MustCommit, addr 0x18049a520, size 0x10, virtual false, abstract: false, final false
inline bool get_MustCommit() ;

/// @brief Method get_atlas, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_MustCommit, addr 0x18049a540, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GradientSettingsAtlas) == 0x40, "Size mismatch!");
