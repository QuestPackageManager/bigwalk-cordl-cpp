...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::NudgeJobData, "UnityEngine.UIElements.UIR", "NudgeJobData");
...
// Ctor Parameters [CppParam { name: "headSrc", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "headDst", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "headCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "tailSrc", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "tailDst", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "tailCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "transform", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "keepZ", ty: "int32_t", modifiers: "", def_value: None }]
constexpr NudgeJobData(::System::IntPtr  headSrc, ::System::IntPtr  headDst, int32_t  headCount, ::System::IntPtr  tailSrc, ::System::IntPtr  tailDst, int32_t  tailCount, ::UnityEngine::Matrix4x4  transform, int32_t  keepZ) noexcept;
