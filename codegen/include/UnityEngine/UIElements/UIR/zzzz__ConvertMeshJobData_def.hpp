...
// Ctor Parameters [CppParam { name: "vertSrc", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "vertDst", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "vertCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "transform", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "xformClipPages", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "ids", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "addFlags", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "opacityPage", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "textCoreSettingsPage", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "usesTextCoreSettings", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "textureId", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "gradientSettingsIndexOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "indexSrc", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "indexDst", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "indexCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "indexOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "flipIndices", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "forceZ", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "positionZ", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "remapUVs", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "atlasRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "layoutSize", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }]
constexpr ConvertMeshJobData(::System::IntPtr  vertSrc, ::System::IntPtr  vertDst, int32_t  vertCount, ::UnityEngine::Matrix4x4  transform, ::UnityEngine::Color32  xformClipPages, ::UnityEngine::Color32  ids, ::UnityEngine::Color32  addFlags, ::UnityEngine::Color32  opacityPage, ::UnityEngine::Color32  textCoreSettingsPage, int32_t  usesTextCoreSettings, float_t  textureId, int32_t  gradientSettingsIndexOffset, ::System::IntPtr  indexSrc, ::System::IntPtr  indexDst, int32_t  indexCount, int32_t  indexOffset, int32_t  flipIndices, int32_t  forceZ, float_t  positionZ, int32_t  remapUVs, ::UnityEngine::Rect  atlasRect, ::UnityEngine::Vector2  layoutSize) noexcept;
