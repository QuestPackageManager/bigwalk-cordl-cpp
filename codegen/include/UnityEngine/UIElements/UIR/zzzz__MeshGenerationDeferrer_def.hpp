...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer*);
MARK_VAL_T(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer*, "UnityEngine.UIElements.UIR", "MeshGenerationDeferrer");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo, "UnityEngine.UIElements.UIR", "MeshGenerationDeferrer/CallbackInfo");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "callback", ty: "::UnityEngine::UIElements::UIR::MeshGenerationCallback*", modifiers: "", def_value: None }, CppParam { name: "userData", ty: "::System::Object*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo) == 0x10, "Size mismatch!");
...
/// @brief Field m_Fork, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Fork, put=__cordl_internal_set_m_Fork)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_Fork;

/// @brief Field m_JobDependentFork, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_JobDependentFork, put=__cordl_internal_set_m_JobDependentFork)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_JobDependentFork;

/// @brief Field m_JobDependentWork, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_JobDependentWork, put=__cordl_internal_set_m_JobDependentWork)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_JobDependentWork;

/// @brief Field m_JobDependentWorkThenFork, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_JobDependentWorkThenFork, put=__cordl_internal_set_m_JobDependentWorkThenFork)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_JobDependentWorkThenFork;

/// @brief Field m_Work, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Work, put=__cordl_internal_set_m_Work)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_Work;

/// @brief Field m_WorkThenFork, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_WorkThenFork, put=__cordl_internal_set_m_WorkThenFork)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::UIR::MeshGenerationDeferrer_CallbackInfo>*  m_WorkThenFork;

/// @brief Convert operator to "::System::IDisposable"
constexpr operator  ::System::IDisposable*() noexcept;

/// @brief Method AddMeshGenerationCallback, addr 0x182430470, size 0x160, virtual false, abstract: false, final false
inline void AddMeshGenerationCallback(::UnityEngine::UIElements::UIR::MeshGenerationCallback*  callback, ::System::Object*  userData, ::UnityEngine::UIElements::MeshGenerationCallbackType  callbackType, bool  isJobDependent) ;

/// @brief Method AddMeshGenerationJob, addr 0x1824305d0, size 0x30, virtual false, abstract: false, final false
inline void AddMeshGenerationJob(::Unity::Jobs::JobHandle  jobHandle) ;

/// @brief Method Dispose, addr 0x182430600, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x182430670, size 0x60, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Invoke, addr 0x1824306d0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ProcessDeferredWork, addr 0x182430750, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182430a10, size 0x210, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_disposed, addr 0x1802f8090, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::MeshGenerationDeferrer) == 0x58, "Size mismatch!");
