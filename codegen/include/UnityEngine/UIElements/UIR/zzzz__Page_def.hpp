...
/// @brief Field gpuData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_gpuData, put=__cordl_internal_set_gpuData)) ::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>*  gpuData;
...
/// @brief Field updateRanges, offset 0x30, size 0x10 
 __declspec(property(get=__cordl_internal_get_updateRanges, put=__cordl_internal_set_updateRanges)) ::Unity::Collections::NativeArray_1<::UnityEngine::UIElements::UIR::GfxUpdateBufferRange>  updateRanges;
...
static inline ::UnityEngine::UIElements::UIR::Page_DataSet_1<T>* New_ctor(::UnityEngine::UIElements::UIR::Utility_GPUBufferType  bufferType, uint32_t  totalCount, uint32_t  maxQueuedFrameCount, uint32_t  updateRangePoolSize) ;
...
constexpr ::UnityEngine::UIElements::UIR::GPUBufferAllocator* const& __cordl_internal_get_allocator() const;
...
constexpr ::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>* const& __cordl_internal_get_gpuData() const;

constexpr ::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>*& __cordl_internal_get_gpuData() ;
...
constexpr void __cordl_internal_set_gpuData(::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>*  value) ;
...
/// @brief Field gpuData, offset: 0x18, size: 0x8, def value: None
 ::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>*  ___gpuData;
...
/// @brief Field indices, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_indices, put=__cordl_internal_set_indices)) ::UnityEngine::UIElements::UIR::Page_DataSet_1<uint16_t>*  indices;
...
/// @brief Field vertices, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_vertices, put=__cordl_internal_set_vertices)) ::UnityEngine::UIElements::UIR::Page_DataSet_1<::UnityEngine::UIElements::Vertex>*  vertices;
...
/// @brief Method Dispose, addr 0x182427090, size 0x40, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;
...
constexpr ::UnityEngine::UIElements::UIR::Page_DataSet_1<uint16_t>* const& __cordl_internal_get_indices() const;

constexpr ::UnityEngine::UIElements::UIR::Page_DataSet_1<uint16_t>*& __cordl_internal_get_indices() ;

constexpr ::UnityEngine::UIElements::UIR::Page* const& __cordl_internal_get_next() const;

constexpr ::UnityEngine::UIElements::UIR::Page*& __cordl_internal_get_next() ;

constexpr ::UnityEngine::UIElements::UIR::Page_DataSet_1<::UnityEngine::UIElements::Vertex>* const& __cordl_internal_get_vertices() const;

constexpr ::UnityEngine::UIElements::UIR::Page_DataSet_1<::UnityEngine::UIElements::Vertex>*& __cordl_internal_get_vertices() ;

constexpr void __cordl_internal_set__disposed_k__BackingField(bool  value) ;

constexpr void __cordl_internal_set_framesEmpty(int32_t  value) ;

constexpr void __cordl_internal_set_indices(::UnityEngine::UIElements::UIR::Page_DataSet_1<uint16_t>*  value) ;
...
/// @brief Method .ctor, addr 0x1824270d0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_isEmpty, addr 0x1824271b0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Field vertices, offset: 0x18, size: 0x8, def value: None
 ::UnityEngine::UIElements::UIR::Page_DataSet_1<::UnityEngine::UIElements::Vertex>*  ___vertices;

/// @brief Field indices, offset: 0x20, size: 0x8, def value: None
 ::UnityEngine::UIElements::UIR::Page_DataSet_1<uint16_t>*  ___indices;
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Page) == 0x38, "Size mismatch!");
