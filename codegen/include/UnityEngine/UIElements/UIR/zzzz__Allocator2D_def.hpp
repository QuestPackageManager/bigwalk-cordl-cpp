...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::Allocator2D*);
MARK_REF_T(::UnityEngine::UIElements::UIR::Allocator2D_Area*);
MARK_REF_T(::UnityEngine::UIElements::UIR::Allocator2D_Row*);
MARK_VAL_T(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::Allocator2D*, "UnityEngine.UIElements.UIR", "Allocator2D");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::Allocator2D_Area*, "UnityEngine.UIElements.UIR", "Allocator2D/Area");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::Allocator2D_Row*, "UnityEngine.UIElements.UIR", "Allocator2D/Row");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D, "UnityEngine.UIElements.UIR", "Allocator2D/Alloc2D");
...
/// @brief Method .ctor, addr 0x18240ddc0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Allocator2D_Area) == 0x28, "Size mismatch!");
...
/// @brief Method Create, addr 0x182411340, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x182411350, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Allocator2D_Row) == 0x58, "Size mismatch!");
...
public:
// Declarations
/// @brief Method .ctor, addr 0x18240d310, size 0x120, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "rect", ty: "::UnityEngine::RectInt", modifiers: "", def_value: None }, CppParam { name: "row", ty: "::UnityEngine::UIElements::UIR::Allocator2D_Row*", modifiers: "", def_value: None }, CppParam { name: "alloc", ty: "::UnityEngine::UIElements::UIR::Alloc", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D) == 0x30, "Size mismatch!");

} // namespace end def UnityEngine::UIElements::UIR
// Dependencies System.Object, UnityEngine.UIElements.UIR.Allocator2D::Row, UnityEngine.Vector2Int
namespace UnityEngine::UIElements::UIR {
// Is value type: false
...
/// @brief Method BuildAreas, addr 0x18240d430, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method BuildRowArray, addr 0x18240d630, size 0x20, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::UIElements::UIR::Allocator2D_Row*> BuildRowArray(int32_t  maxRowHeight, int32_t  rowHeightBias) ;

/// @brief Method ComputeMaxAllocSize, addr 0x18240d650, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x18240d6c0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method TryAllocate, addr 0x18240d7e0, size 0x450, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIElements::UIR::Allocator2D_Row*> const& __cordl_internal_get_m_Rows() const;

constexpr ::ArrayW<::UnityEngine::UIElements::UIR::Allocator2D_Row*>& __cordl_internal_get_m_Rows() ;
...
/// @brief Method .ctor, addr 0x18240dc30, size 0x190, virtual false, abstract: false, final false
...
/// @brief Field m_Rows, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::UIElements::UIR::Allocator2D_Row*>  ___m_Rows;
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::Allocator2D) == 0x40, "Size mismatch!");
