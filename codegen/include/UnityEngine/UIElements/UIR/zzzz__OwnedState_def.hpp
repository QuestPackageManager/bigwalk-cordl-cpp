...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::OwnedState, "UnityEngine.UIElements.UIR", "OwnedState");
// Dependencies 
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::UIR::OwnedState, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UIR::OwnedState) == 0x1, "Size mismatch!");
