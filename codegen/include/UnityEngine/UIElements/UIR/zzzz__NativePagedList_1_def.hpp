...
namespace UnityEngine::UIElements::UIR {
template<typename T>
struct NativePagedList_1_NativeArrayAllocator;
}
...
// Ctor Parameters [CppParam { name: "m_Allocator", ty: "::Unity::Collections::Allocator", modifiers: "", def_value: None }, CppParam { name: "m_MemoryLabel", ty: "::Unity::Collections::MemoryLabel", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "m_NativePagedList", ty: "::UnityEngine::UIElements::UIR::NativePagedList_1<T>*", modifiers: "", def_value: None }, CppParam { name: "m_CurrentPage", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: None }, CppParam { name: "m_IndexInCurrentPage", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_IndexOfCurrentPage", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CountInCurrentPage", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field m_FirstPageAllocator, offset 0x38, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_FirstPageAllocator, put=__cordl_internal_set_m_FirstPageAllocator)) ::UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>  m_FirstPageAllocator;
...
/// @brief Field m_OtherPagesAllocator, offset 0x50, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_OtherPagesAllocator, put=__cordl_internal_set_m_OtherPagesAllocator)) ::UnityEngine::UIElements::UIR::NativePagedList_1_NativeArrayAllocator<T>  m_OtherPagesAllocator;
...
static inline ::UnityEngine::UIElements::UIR::NativePagedList_1<T>* New_ctor(int32_t  poolCapacity, ::StringW  profilerName, ::Unity::Collections::Allocator  firstPageAllocator, ::Unity::Collections::Allocator  otherPagesAllocator) ;
