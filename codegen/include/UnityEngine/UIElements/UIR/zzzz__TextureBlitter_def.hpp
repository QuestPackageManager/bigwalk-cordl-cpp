...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo, "UnityEngine.UIElements.UIR", "TextureBlitter/BlitInfo");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo) == 0x38, "Size mismatch!");
...
/// @brief Field m_PendingBlits, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PendingBlits, put=__cordl_internal_set_m_PendingBlits)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo>*  m_PendingBlits;
...
/// @brief Field m_SingleBlit, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SingleBlit, put=__cordl_internal_set_m_SingleBlit)) ::ArrayW<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo>  m_SingleBlit;
...
/// @brief Method BeginBlit, addr 0x182447ac0, size 0x170, virtual false, abstract: false, final false
inline void BeginBlit(::UnityEngine::RenderTexture*  dst) ;

/// @brief Method BlitOneNow, addr 0x182447c30, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method Commit, addr 0x182447d90, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x182447e80, size 0x40, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method DoBlit, addr 0x182447ec0, size 0x5d0, virtual false, abstract: false, final false
...
/// @brief Method EndBlit, addr 0x182448490, size 0x60, virtual false, abstract: false, final false
inline void EndBlit() ;

static inline ::UnityEngine::UIElements::UIR::TextureBlitter* New_ctor(int32_t  capacity) ;

/// @brief Method QueueBlit, addr 0x1824484f0, size 0x150, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo> const& __cordl_internal_get_m_SingleBlit() const;

constexpr ::ArrayW<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo>& __cordl_internal_get_m_SingleBlit() ;
...
constexpr void __cordl_internal_set_m_SingleBlit(::ArrayW<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo>  value) ;

constexpr void __cordl_internal_set_m_Viewport(::UnityEngine::RectInt  value) ;

/// @brief Method .ctor, addr 0x182448720, size 0x80, virtual false, abstract: false, final false
...
/// @brief Field m_SingleBlit, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::UIElements::UIR::TextureBlitter_BlitInfo>  ___m_SingleBlit;
