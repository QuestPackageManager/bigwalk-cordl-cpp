...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::GradientRemapPool*);
...
/// @brief Method <.ctor>b__0_0, addr 0x182449080, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::GradientRemap* __ctor_b__0_0() ;

/// @brief Method <.ctor>b__0_1, addr 0x1824490f0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GradientRemapPool___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x18243d510, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UIR::GradientRemapPool) == 0x38, "Size mismatch!");
