...
// Dependencies Unity.Profiling.ProfilerMarker, UnityEngine.UIElements.TextureId, UnityEngine.UIElements.UIR.CommandFlags, UnityEngine.UIElements.UIR.CommandType, UnityEngine.UIElements.UIR.LinkedPoolItem`1<T>
namespace UnityEngine::UIElements::UIR {
// Is value type: false
...
/// @brief Method CombineScissorRects, addr 0x1824271f0, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect CombineScissorRects(::UnityEngine::Rect  r0, ::UnityEngine::Rect  r1) ;

/// @brief Method ExecuteNonDrawMesh, addr 0x182427270, size 0x5f0, virtual false, abstract: false, final false
...
/// @brief Method PopScissor, addr 0x182427860, size 0x140, virtual false, abstract: false, final false
static inline void PopScissor(::UnityEngine::UIElements::UIR::DrawParams*  drawParams, float_t  pixelsPerPoint) ;

/// @brief Method PushScissor, addr 0x1824279a0, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method RectPointsToPixelsAndFlipYAxis, addr 0x182427b40, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityEngine::RectInt RectPointsToPixelsAndFlipYAxis(::UnityEngine::Rect  rect, float_t  pixelsPerPoint) ;

/// @brief Method Reset, addr 0x182427c00, size 0xc0, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x182427c00, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
