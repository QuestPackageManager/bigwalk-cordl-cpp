...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::VectorImageManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::VectorImageManager*, "UnityEngine.UIElements.UIR", "VectorImageManager");
...
/// @brief Field m_GradientSettingsAtlas, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GradientSettingsAtlas, put=__cordl_internal_set_m_GradientSettingsAtlas)) ::UnityEngine::UIElements::UIR::GradientSettingsAtlas*  m_GradientSettingsAtlas;
...
/// @brief Field m_Registered, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Registered, put=__cordl_internal_set_m_Registered)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::UIElements::VectorImage>,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*  m_Registered;
...
/// @brief Method AddUser, addr 0x18244b4b0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Commit, addr 0x18244b580, size 0x30, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method Dispose, addr 0x180e6eca0, size 0x5510, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18244b5b0, size 0x80, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::UnityEngine::UIElements::UIR::VectorImageManager* New_ctor(::UnityEngine::UIElements::AtlasBase*  atlas) ;

/// @brief Method Register, addr 0x18244b630, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method RemoveUser, addr 0x18244b9b0, size 0x150, virtual false, abstract: false, final false
inline void RemoveUser(::UnityEngine::UIElements::VectorImage*  vi) ;

/// @brief Method Unregister, addr 0x18244bb00, size 0xe0, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::UIElements::VectorImage>,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>* const& __cordl_internal_get_m_Registered() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::UIElements::VectorImage>,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*& __cordl_internal_get_m_Registered() ;
...
constexpr void __cordl_internal_set_m_Registered(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::UIElements::VectorImage>,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*  value) ;

constexpr void __cordl_internal_set_m_RenderInfoPool(::UnityEngine::UIElements::UIR::VectorImageRenderInfoPool*  value) ;

/// @brief Method .ctor, addr 0x18244bca0, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method get_atlas, addr 0x18244c020, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> get_atlas() ;

/// @brief Method get_disposed, addr 0x18049a520, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_disposed, addr 0x18049a540, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::VectorImageManager) == 0x40, "Size mismatch!");
