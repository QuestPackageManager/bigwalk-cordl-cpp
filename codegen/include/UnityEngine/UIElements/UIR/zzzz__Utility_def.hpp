...
static_assert(offsetof(::UnityEngine::UIElements::UIR::Utility_GPUBufferType, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method AllocateBuffer, addr 0x182413270, size 0x10, virtual false, abstract: false, final false
static inline ::System::IntPtr AllocateBuffer(int32_t  elementCount, int32_t  elementStride, bool  vertexBuffer) ;

/// @brief Method AllocateShaderPropertySheet, addr 0x182413280, size 0x10, virtual false, abstract: false, final false
static inline ::System::IntPtr AllocateShaderPropertySheet() ;

/// @brief Method ApplyShaderPropertySheet, addr 0x182413290, size 0x10, virtual false, abstract: false, final false
static inline void ApplyShaderPropertySheet(::System::IntPtr  shaderPropertySheet) ;

/// @brief Method CPUFencePassed, addr 0x1824132a0, size 0x10, virtual false, abstract: false, final false
static inline bool CPUFencePassed(uint32_t  fence) ;

/// @brief Method CreateStencilState, addr 0x1824132c0, size 0x20, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState(::UnityEngine::Rendering::StencilState  stencilState) ;

/// @brief Method CreateStencilState_Injected, addr 0x1824132b0, size 0x10, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState_Injected(::by_ref<::UnityEngine::Rendering::StencilState>  stencilState) ;

/// @brief Method DisableScissor, addr 0x1824132e0, size 0x10, virtual false, abstract: false, final false
static inline void DisableScissor() ;

/// @brief Method DrawRanges, addr 0x1824132f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method FreeBuffer, addr 0x182413300, size 0x10, virtual false, abstract: false, final false
static inline void FreeBuffer(::System::IntPtr  buffer) ;

/// @brief Method GetActiveViewport, addr 0x182413320, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::RectInt GetActiveViewport() ;

/// @brief Method GetActiveViewport_Injected, addr 0x182413310, size 0x10, virtual false, abstract: false, final false
static inline void GetActiveViewport_Injected(::by_ref<::UnityEngine::RectInt>  ret) ;

/// @brief Method GetUnityProjectionMatrix, addr 0x182413350, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix() ;

/// @brief Method GetUnityProjectionMatrix_Injected, addr 0x182413340, size 0x10, virtual false, abstract: false, final false
static inline void GetUnityProjectionMatrix_Injected(::by_ref<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method GetVertexDeclaration, addr 0x182413390, size 0x70, virtual false, abstract: false, final false
static inline ::System::IntPtr GetVertexDeclaration(::ArrayW<::UnityEngine::Rendering::VertexAttributeDescriptor>  vertexAttributes) ;

/// @brief Method GetVertexDeclaration_Injected, addr 0x182413380, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method HasMappedBufferRange, addr 0x182413400, size 0x10, virtual false, abstract: false, final false
static inline bool HasMappedBufferRange() ;

/// @brief Method InsertCPUFence, addr 0x182413410, size 0x10, virtual false, abstract: false, final false
static inline uint32_t InsertCPUFence() ;

/// @brief Method NotifyOfUIREvents, addr 0x182413420, size 0x10, virtual false, abstract: false, final false
static inline void NotifyOfUIREvents(bool  subscribe) ;

/// @brief Method ProfileDrawChainBegin, addr 0x182413430, size 0x10, virtual false, abstract: false, final false
static inline void ProfileDrawChainBegin() ;

/// @brief Method ProfileDrawChainEnd, addr 0x182413440, size 0x10, virtual false, abstract: false, final false
static inline void ProfileDrawChainEnd() ;

/// @brief Method RaiseEngineUpdate, addr 0x182413450, size 0x30, virtual false, abstract: false, final false
static inline void RaiseEngineUpdate() ;

/// @brief Method RaiseFlushPendingResources, addr 0x182413480, size 0x30, virtual false, abstract: false, final false
static inline void RaiseFlushPendingResources() ;

/// @brief Method RaiseGraphicsResourcesRecreate, addr 0x1824134b0, size 0x30, virtual false, abstract: false, final false
static inline void RaiseGraphicsResourcesRecreate(bool  recreate) ;

/// @brief Method ReleasePropertySheet, addr 0x1824134e0, size 0x10, virtual false, abstract: false, final false
static inline void ReleasePropertySheet(::System::IntPtr  shaderPropertySheet) ;

/// @brief Method SetAllTextures, addr 0x1824134f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetPropertyBlock, addr 0x182413510, size 0x20, virtual false, abstract: false, final false
static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock*  props) ;

/// @brief Method SetPropertyBlock_Injected, addr 0x182413500, size 0x10, virtual false, abstract: false, final false
static inline void SetPropertyBlock_Injected(::System::IntPtr  props) ;

/// @brief Method SetScissorRect, addr 0x182413540, size 0x10, virtual false, abstract: false, final false
static inline void SetScissorRect(::UnityEngine::RectInt  scissorRect) ;

/// @brief Method SetScissorRect_Injected, addr 0x182413530, size 0x10, virtual false, abstract: false, final false
static inline void SetScissorRect_Injected(::by_ref<::UnityEngine::RectInt>  scissorRect) ;

/// @brief Method SetStencilState, addr 0x182413550, size 0x10, virtual false, abstract: false, final false
static inline void SetStencilState(::System::IntPtr  stencilState, int32_t  stencilRef) ;

/// @brief Method SetVectorArray, addr 0x1824135f0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetVectorArray, addr 0x182413570, size 0x80, virtual false, abstract: false, final false
static inline void SetVectorArray(::System::IntPtr  shaderPropertySheet, int32_t  nameID, ::ArrayW<::UnityEngine::Vector4>  vector4s) ;

/// @brief Method SetVectorArray_Injected, addr 0x182413560, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SyncRenderThread, addr 0x182413680, size 0x10, virtual false, abstract: false, final false
static inline void SyncRenderThread() ;

/// @brief Method UpdateBufferRanges, addr 0x182413690, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method WaitForCPUFencePassed, addr 0x1824136a0, size 0x10, virtual false, abstract: false, final false
static inline void WaitForCPUFencePassed(uint32_t  fence) ;

/// @brief Method add_EngineUpdate, addr 0x1824136f0, size 0x90, virtual false, abstract: false, final false
static inline void add_EngineUpdate(::System::Action*  value) ;

/// @brief Method add_FlushPendingResources, addr 0x182413780, size 0x90, virtual false, abstract: false, final false
static inline void add_FlushPendingResources(::System::Action*  value) ;

/// @brief Method add_GraphicsResourcesRecreate, addr 0x182413810, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_EngineUpdate, addr 0x1824138c0, size 0x90, virtual false, abstract: false, final false
static inline void remove_EngineUpdate(::System::Action*  value) ;

/// @brief Method remove_FlushPendingResources, addr 0x182413950, size 0x90, virtual false, abstract: false, final false
static inline void remove_FlushPendingResources(::System::Action*  value) ;

/// @brief Method remove_GraphicsResourcesRecreate, addr 0x1824139e0, size 0xb0, virtual false, abstract: false, final false
