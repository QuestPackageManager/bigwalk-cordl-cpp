...
public:
// Declarations
 __declspec(property(get=UnityEngine_UIElements_IPointerEventInternal_get_compatibilityMouseEvent)) ::UnityEngine::UIElements::IMouseEvent*  UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent;
...
/// @brief Field <compatibilityMouseEvent>k__BackingField, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__compatibilityMouseEvent_k__BackingField, put=__cordl_internal_set__compatibilityMouseEvent_k__BackingField)) ::UnityEngine::UIElements::IMouseEvent*  _compatibilityMouseEvent_k__BackingField;
...
/// @brief Field <recomputeTopElementUnderPointer>k__BackingField, offset 0xf4, size 0x1 
 __declspec(property(get=__cordl_internal_get__recomputeTopElementUnderPointer_k__BackingField, put=__cordl_internal_set__recomputeTopElementUnderPointer_k__BackingField)) bool  _recomputeTopElementUnderPointer_k__BackingField;
