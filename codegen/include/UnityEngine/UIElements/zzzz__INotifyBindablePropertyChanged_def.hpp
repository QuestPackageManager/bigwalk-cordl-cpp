...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::INotifyBindablePropertyChanged*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::INotifyBindablePropertyChanged*, "UnityEngine.UIElements", "INotifyBindablePropertyChanged");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: false
