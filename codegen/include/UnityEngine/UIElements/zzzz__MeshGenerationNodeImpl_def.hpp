...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::MeshGenerationNodeImpl*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MeshGenerationNodeImpl*, "UnityEngine.UIElements", "MeshGenerationNodeImpl");
...
/// @brief Method Dispose, addr 0x18250a9a0, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18250a960, size 0x40, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method DrawGradients, addr 0x18250a9e0, size 0xa0, virtual false, abstract: false, final false
inline void DrawGradients(::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>  vertices, ::Unity::Collections::NativeSlice_1<uint16_t>  indices, ::UnityEngine::UIElements::VectorImage*  gradientsOwner) ;

/// @brief Method DrawMesh, addr 0x18250aa80, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetNode, addr 0x181a43ca0, size 0x20, virtual false, abstract: false, final false
inline void GetNode(::by_ref<::UnityEngine::UIElements::MeshGenerationNode>  node) ;

/// @brief Method GetParentEntry, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Entry* GetParentEntry() ;

/// @brief Method GetUnsafeNode, addr 0x181a43ca0, size 0x20, virtual false, abstract: false, final false
inline void GetUnsafeNode(::by_ref<::UnityEngine::UIElements::UnsafeMeshGenerationNode>  node) ;

/// @brief Method Init, addr 0x18250ab20, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x18250ab90, size 0x60, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x18250abf0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disposed, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::MeshGenerationNodeImpl) == 0x30, "Size mismatch!");
