...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Manipulator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Manipulator*, "UnityEngine.UIElements", "Manipulator");
...
/// @brief Method get_target, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_target, addr 0x182509e40, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::UIElements::Manipulator) == 0x18, "Size mismatch!");
