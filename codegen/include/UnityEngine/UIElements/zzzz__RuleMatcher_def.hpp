...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RuleMatcher, "UnityEngine.UIElements", "RuleMatcher");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
public:
// Declarations
/// @brief Method ToString, addr 0x1823fa340, size 0x60, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "sheet", ty: "::UnityW<::UnityEngine::UIElements::StyleSheet>", modifiers: "", def_value: None }, CppParam { name: "complexSelector", ty: "::UnityEngine::UIElements::StyleComplexSelector*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::RuleMatcher) == 0x10, "Size mismatch!");
