...
/// @brief Method SetDragZone, addr 0x1824c6bf0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::BaseFieldMouseDragger) == 0x10, "Size mismatch!");
