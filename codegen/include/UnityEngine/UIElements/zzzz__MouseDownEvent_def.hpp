...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7320, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x1824d3270, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method MakeFromPointerEvent, addr 0x1824d32f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824d3380, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::MouseDownEvent) == 0xb8, "Size mismatch!");
