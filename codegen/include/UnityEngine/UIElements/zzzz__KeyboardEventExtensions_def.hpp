...
public:
// Declarations
/// @brief Method ShouldSendNavigationMoveEvent, addr 0x1824d30a0, size 0x50, virtual false, abstract: false, final false
static inline bool ShouldSendNavigationMoveEvent(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method ShouldSendNavigationMoveEventRuntime, addr 0x1824d3060, size 0x40, virtual false, abstract: false, final false
