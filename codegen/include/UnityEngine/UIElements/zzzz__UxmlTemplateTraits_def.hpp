...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlTemplateTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlTemplateTraits*, "UnityEngine.UIElements", "UxmlTemplateTraits");
...
/// @brief Method .ctor, addr 0x18240aeb0, size 0x190, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlTemplateTraits) == 0x30, "Size mismatch!");
