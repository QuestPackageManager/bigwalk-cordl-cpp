...
/// @brief Method Blur, addr 0x1824d1bc0, size 0x50, virtual true, abstract: false, final false
inline void Blur() ;

/// @brief Method BlurImmediately, addr 0x1824d1b70, size 0x50, virtual false, abstract: false, final false
inline void BlurImmediately() ;

/// @brief Method Focus, addr 0x1824d1c10, size 0x100, virtual true, abstract: false, final false
inline void Focus() ;

/// @brief Method GetFirstFocusableChild, addr 0x1824d1d10, size 0x130, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetFocusDelegate, addr 0x1824d1e40, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824d21b0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_canGrabFocus, addr 0x18167c4c0, size 0x20, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_delegatesFocus, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_delegatesFocus() ;

/// @brief Method get_excludeFromFocusRing, addr 0x180503cd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_isEligibleToReceiveFocusFromDisabledChild, addr 0x180503cc0, size 0x10, virtual false, abstract: false, final false
inline bool get_isEligibleToReceiveFocusFromDisabledChild() ;

/// @brief Method get_tabIndex, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_delegatesFocus, addr 0x1824d2230, size 0x60, virtual false, abstract: false, final false
inline void set_delegatesFocus(bool  value) ;

/// @brief Method set_excludeFromFocusRing, addr 0x1824d2290, size 0x80, virtual false, abstract: false, final false
inline void set_excludeFromFocusRing(bool  value) ;

/// @brief Method set_focusable, addr 0x1824d2310, size 0x50, virtual true, abstract: false, final false
inline void set_focusable(bool  value) ;

/// @brief Method set_isEligibleToReceiveFocusFromDisabledChild, addr 0x180503cf0, size 0x10, virtual false, abstract: false, final false
inline void set_isEligibleToReceiveFocusFromDisabledChild(bool  value) ;

/// @brief Method set_tabIndex, addr 0x1824d2360, size 0x90, virtual false, abstract: false, final false
