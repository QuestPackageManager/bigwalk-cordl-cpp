...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PickingMode, "UnityEngine.UIElements", "PickingMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::PickingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::PickingMode) == 0x4, "Size mismatch!");
