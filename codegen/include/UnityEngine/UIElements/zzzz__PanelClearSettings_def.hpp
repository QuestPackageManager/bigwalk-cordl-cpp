...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PanelClearSettings, "UnityEngine.UIElements", "PanelClearSettings");
...
static_assert(sizeof(::UnityEngine::UIElements::PanelClearSettings) == 0x14, "Size mismatch!");
