...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Vector3IntField*);
MARK_REF_T(::UnityEngine::UIElements::Vector3IntField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Vector3IntField_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::Vector3IntField___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector3IntField*, "UnityEngine.UIElements", "Vector3IntField");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector3IntField_UxmlFactory*, "UnityEngine.UIElements", "Vector3IntField/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector3IntField_UxmlTraits*, "UnityEngine.UIElements", "Vector3IntField/UxmlTraits");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector3IntField___c*, "UnityEngine.UIElements", "Vector3IntField/<>c");
...
/// @brief Method .ctor, addr 0x18246dae0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::Vector3IntField_UxmlFactory) == 0x18, "Size mismatch!");
...
/// @brief Method Init, addr 0x18246f7e0, size 0x1e0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182470210, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Vector3IntField_UxmlTraits, ___m_XValue) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Vector3IntField_UxmlTraits, ___m_YValue) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Vector3IntField_UxmlTraits, ___m_ZValue) == 0xa8, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Vector3IntField_UxmlTraits) == 0xb0, "Size mismatch!");
...
/// @brief Field <>9__0_1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_1, put=setStaticF___9__0_1)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  __9__0_1;
...
/// @brief Field <>9__0_3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_3, put=setStaticF___9__0_3)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  __9__0_3;
...
/// @brief Field <>9__0_5, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_5, put=setStaticF___9__0_5)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  __9__0_5;

static inline ::UnityEngine::UIElements::Vector3IntField___c* New_ctor() ;

/// @brief Method <DescribeFields>b__0_0, addr 0x181191150, size 0x19d0, virtual false, abstract: false, final false
inline int32_t _DescribeFields_b__0_0(::UnityEngine::Vector3Int  r) ;

/// @brief Method <DescribeFields>b__0_1, addr 0x18230d230, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_1(::by_ref<::UnityEngine::Vector3Int>  r, int32_t  v) ;

/// @brief Method <DescribeFields>b__0_2, addr 0x18230d250, size 0x10, virtual false, abstract: false, final false
inline int32_t _DescribeFields_b__0_2(::UnityEngine::Vector3Int  r) ;

/// @brief Method <DescribeFields>b__0_3, addr 0x18230d260, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_3(::by_ref<::UnityEngine::Vector3Int>  r, int32_t  v) ;

/// @brief Method <DescribeFields>b__0_4, addr 0x18230d200, size 0x10, virtual false, abstract: false, final false
inline int32_t _DescribeFields_b__0_4(::UnityEngine::Vector3Int  r) ;

/// @brief Method <DescribeFields>b__0_5, addr 0x18230d210, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_5(::by_ref<::UnityEngine::Vector3Int>  r, int32_t  v) ;
...
static inline void setStaticF___9__0_1(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  value) ;

static inline void setStaticF___9__0_2(::System::Func_2<::UnityEngine::Vector3Int,int32_t>*  value) ;

static inline void setStaticF___9__0_3(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  value) ;

static inline void setStaticF___9__0_4(::System::Func_2<::UnityEngine::Vector3Int,int32_t>*  value) ;

static inline void setStaticF___9__0_5(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Vector3IntField___c) == 0x10, "Size mismatch!");
...
/// @brief Method DescribeFields, addr 0x182471a60, size 0x3f0, virtual true, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::BaseCompositeField_3_FieldDescription<::UnityEngine::Vector3Int,::UnityEngine::UIElements::IntegerField*,int32_t>> DescribeFields() ;
...
/// @brief Method .ctor, addr 0x182471f30, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182471f40, size 0xa0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Vector3IntField) == 0x370, "Size mismatch!");
