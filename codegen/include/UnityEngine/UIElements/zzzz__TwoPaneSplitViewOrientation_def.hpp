...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TwoPaneSplitViewOrientation, "UnityEngine.UIElements", "TwoPaneSplitViewOrientation");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::TwoPaneSplitViewOrientation, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::TwoPaneSplitViewOrientation) == 0x4, "Size mismatch!");
