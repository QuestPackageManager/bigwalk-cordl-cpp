...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder, "UnityEngine.UIElements", "VisualElementFocusRing/DefaultFocusOrder");
...
static_assert(offsetof(::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder) == 0x4, "Size mismatch!");
...
/// @brief Field <defaultFocusOrder>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__defaultFocusOrder_k__BackingField, put=__cordl_internal_set__defaultFocusOrder_k__BackingField)) ::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder  _defaultFocusOrder_k__BackingField;
...
/// @brief Method BuildRingForScopeRecursive, addr 0x182415770, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method DoUpdate, addr 0x1824159a0, size 0x1b0, virtual false, abstract: false, final false
inline void DoUpdate() ;

/// @brief Method FocusRingAutoIndexSort, addr 0x182415b50, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method FocusRingSort, addr 0x182415d90, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetFocusChangeDirection, addr 0x182415e60, size 0x1c0, virtual true, abstract: false, final true
...
/// @brief Method GetFocusableInternalIndex, addr 0x182416020, size 0x50, virtual false, abstract: false, final false
inline int32_t GetFocusableInternalIndex(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method GetNextElementDepthFirst, addr 0x182416070, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetNextElementDepthFirst(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetNextFocusable, addr 0x182416520, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method GetNextFocusableInSequence, addr 0x1824160c0, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method GetNextFocusableInTree, addr 0x182416450, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetNextFocusableInTree(::UnityEngine::UIElements::VisualElement*  currentFocusable) ;

/// @brief Method GetPreviousElementDepthFirst, addr 0x182416600, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetPreviousElementDepthFirst(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetPreviousFocusableInTree, addr 0x1824166a0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SortAndFlattenScopeLists, addr 0x182416750, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182416880, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_defaultFocusOrder, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder get_defaultFocusOrder() ;

/// @brief Method get_focusController, addr 0x18165ba70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_defaultFocusOrder, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
