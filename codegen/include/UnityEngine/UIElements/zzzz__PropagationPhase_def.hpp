...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PropagationPhase, "UnityEngine.UIElements", "PropagationPhase");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::PropagationPhase, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::PropagationPhase) == 0x4, "Size mismatch!");
