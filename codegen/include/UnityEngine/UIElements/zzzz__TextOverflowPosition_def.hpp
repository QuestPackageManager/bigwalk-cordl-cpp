...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TextOverflowPosition, "UnityEngine.UIElements", "TextOverflowPosition");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::TextOverflowPosition, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::TextOverflowPosition) == 0x4, "Size mismatch!");
