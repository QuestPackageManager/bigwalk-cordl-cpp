...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TextureRegistry_TextureInfo, "UnityEngine.UIElements", "TextureRegistry/TextureInfo");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::TextureRegistry_TextureInfo) == 0x10, "Size mismatch!");
...
/// @brief Field m_Textures, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Textures, put=__cordl_internal_set_m_Textures)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TextureRegistry_TextureInfo>*  m_Textures;

/// @brief Method Acquire, addr 0x18250f650, size 0xe0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId Acquire(::UnityEngine::Texture*  tex) ;

/// @brief Method AllocAndAcquire, addr 0x18250f740, size 0x220, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId AllocAndAcquire(::UnityEngine::Texture*  texture, bool  dynamic) ;

/// @brief Method AllocAndAcquireDynamic, addr 0x18250f730, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId AllocAndAcquireDynamic() ;

/// @brief Method GetTexture, addr 0x18250f960, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x18250fa00, size 0x140, virtual false, abstract: false, final false
inline void Release(::UnityEngine::UIElements::TextureId  id) ;

/// @brief Method UpdateDynamic, addr 0x18250fb40, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18250fd50, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::TextureRegistry* getStaticF__instance_k__BackingField() ;

/// @brief Method get_instance, addr 0x18236f870, size 0x40, virtual false, abstract: false, final false
