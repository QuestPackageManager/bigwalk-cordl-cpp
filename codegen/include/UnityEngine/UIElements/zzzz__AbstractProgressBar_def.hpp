...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::AbstractProgressBar*);
...
/// @brief Method Init, addr 0x18249fc90, size 0x3f0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824a04c0, size 0x160, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::AbstractProgressBar_UxmlTraits) == 0xb0, "Size mismatch!");
...
/// @brief Method CalculateOppositeProgressWidth, addr 0x18248ace0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method OnGeometryChanged, addr 0x18248aea0, size 0x30, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  e) ;

/// @brief Method SetProgress, addr 0x18248aed0, size 0x120, virtual false, abstract: false, final false
inline void SetProgress(float_t  p) ;

/// @brief Method SetValueWithoutNotify, addr 0x18248aff0, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18248b520, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_highValue, addr 0x18248b810, size 0x10, virtual false, abstract: false, final false
inline float_t get_highValue() ;

/// @brief Method get_lowValue, addr 0x1821b85b0, size 0x10, virtual false, abstract: false, final false
inline float_t get_lowValue() ;

/// @brief Method get_title, addr 0x18248b820, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_title() ;

/// @brief Method get_value, addr 0x18248b840, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_highValue, addr 0x18248b850, size 0xd0, virtual false, abstract: false, final false
inline void set_highValue(float_t  value) ;

/// @brief Method set_lowValue, addr 0x18248b920, size 0xd0, virtual false, abstract: false, final false
inline void set_lowValue(float_t  value) ;

/// @brief Method set_title, addr 0x18248b9f0, size 0xc0, virtual false, abstract: false, final false
inline void set_title(::StringW  value) ;

/// @brief Method set_value, addr 0x18248bab0, size 0x240, virtual true, abstract: false, final false
