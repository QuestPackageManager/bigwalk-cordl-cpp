...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::NavigationDeviceType, "UnityEngine.UIElements", "NavigationDeviceType");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::NavigationDeviceType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::NavigationDeviceType) == 0x4, "Size mismatch!");
