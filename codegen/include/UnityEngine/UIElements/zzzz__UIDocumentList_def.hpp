...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIDocumentList*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIDocumentList*, "UnityEngine.UIElements", "UIDocumentList");
...
/// @brief Method AddToListAndToVisualTree, addr 0x1824e7c10, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method RemoveFromListAndFromVisualTree, addr 0x1824e7e20, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824e7e60, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::UIDocumentList) == 0x18, "Size mismatch!");
