...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7a90, size 0x40, virtual false, abstract: false, final false
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{3693};
...
/// @brief Method Dispatch, addr 0x1824cbd60, size 0x70, virtual true, abstract: false, final false
inline void Dispatch(::UnityEngine::UIElements::BaseVisualElementPanel*  panel) ;

/// @brief Method GetPooled, addr 0x1824d26d0, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IMGUIEvent* GetPooled(::UnityEngine::Event*  systemEvent) ;

/// @brief Method Init, addr 0x1824d2790, size 0x20, virtual true, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x1824d2830, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
