...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventCategory, "UnityEngine.UIElements", "EventCategory");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::EventCategory, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::EventCategory) == 0x4, "Size mismatch!");
