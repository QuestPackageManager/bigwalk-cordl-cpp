...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ScrollViewMode, "UnityEngine.UIElements", "ScrollViewMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Field VerticalAndHorizontal value: I32(2)
...
static_assert(offsetof(::UnityEngine::UIElements::ScrollViewMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ScrollViewMode) == 0x4, "Size mismatch!");
