...
// Dependencies UnityEngine.Color, UnityEngine.UIElements.Cursor, UnityEngine.UIElements.OverflowClipBox, UnityEngine.UIElements.SliceType, UnityEngine.UIElements.TextOverflow, UnityEngine.UIElements.TextOverflowPosition
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x1812f91c0, size 0x1810, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::RareData Copy() ;

/// @brief Method CopyFrom, addr 0x1823c3e00, size 0x40, virtual true, abstract: false, final true
inline void CopyFrom(::by_ref<::UnityEngine::UIElements::RareData>  other) ;

/// @brief Method Equals, addr 0x1823c3e40, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823c3ee0, size 0x270, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::RareData  other) ;

/// @brief Method GetHashCode, addr 0x1823c4150, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1823c4250, size 0x150, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "cursor", ty: "::UnityEngine::UIElements::Cursor", modifiers: "", def_value: None }, CppParam { name: "textOverflow", ty: "::UnityEngine::UIElements::TextOverflow", modifiers: "", def_value: None }, CppParam { name: "unityBackgroundImageTintColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "unityOverflowClipBox", ty: "::UnityEngine::UIElements::OverflowClipBox", modifiers: "", def_value: None }, CppParam { name: "unitySliceBottom", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "unitySliceLeft", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "unitySliceRight", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "unitySliceScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "unitySliceTop", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "unitySliceType", ty: "::UnityEngine::UIElements::SliceType", modifiers: "", def_value: None }, CppParam { name: "unityTextOverflowPosition", ty: "::UnityEngine::UIElements::TextOverflowPosition", modifiers: "", def_value: None }]
