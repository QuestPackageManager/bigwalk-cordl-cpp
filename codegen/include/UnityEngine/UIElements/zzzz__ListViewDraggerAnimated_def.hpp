...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ListViewDraggerAnimated*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ListViewDraggerAnimated*, "UnityEngine.UIElements", "ListViewDraggerAnimated");
...
/// @brief Method Animate, addr 0x1824b61a0, size 0x370, virtual false, abstract: false, final false
inline void Animate(::UnityEngine::UIElements::ReusableCollectionItem*  element, float_t  paddingTop) ;

/// @brief Method ClearDragAndDropUI, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x1824b6510, size 0x3a0, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition, ::UnityEngine::EventModifiers  modifiers) ;

/// @brief Method StartDrag, addr 0x1824b68b0, size 0x970, virtual true, abstract: false, final false
...
/// @brief Method TryGetDragPosition, addr 0x1824b7220, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x1824b7260, size 0x710, virtual true, abstract: false, final false
...
/// @brief Method get_draggedItem, addr 0x1802ec4d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* get_draggedItem() ;

/// @brief Method get_isDragging, addr 0x18030d8a0, size 0x10, virtual false, abstract: false, final false
inline bool get_isDragging() ;

/// @brief Method get_supportsDragEvents, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_supportsDragEvents() ;

/// @brief Method set_isDragging, addr 0x18140a480, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ListViewDraggerAnimated) == 0xb8, "Size mismatch!");
