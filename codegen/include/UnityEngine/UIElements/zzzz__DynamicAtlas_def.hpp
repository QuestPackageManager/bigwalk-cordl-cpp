...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DynamicAtlas*);
MARK_REF_T(::UnityEngine::UIElements::DynamicAtlas_TextureInfo*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DynamicAtlas*, "UnityEngine.UIElements", "DynamicAtlas");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DynamicAtlas_TextureInfo*, "UnityEngine.UIElements", "DynamicAtlas/TextureInfo");
...
/// @brief Method Create, addr 0x182383f40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x182383f50, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::DynamicAtlas_TextureInfo) == 0x68, "Size mismatch!");
...
/// @brief Field m_Database, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Database, put=__cordl_internal_set_m_Database)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Texture>,::UnityEngine::UIElements::DynamicAtlas_TextureInfo*>*  m_Database;
...
/// @brief Method DestroyPages, addr 0x18237f4d0, size 0x60, virtual false, abstract: false, final false
inline void DestroyPages() ;

/// @brief Method InitPages, addr 0x18237f530, size 0x130, virtual false, abstract: false, final false
inline void InitPages() ;

/// @brief Method IsTextureFormatSupported, addr 0x18237f660, size 0x90, virtual false, abstract: false, final false
static inline bool IsTextureFormatSupported(::UnityEngine::TextureFormat  format) ;

/// @brief Method IsTextureValid, addr 0x18237f6f0, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method OnAssignedToPanel, addr 0x18237f8a0, size 0x70, virtual true, abstract: false, final false
inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnRemovedFromPanel, addr 0x18237f910, size 0x90, virtual true, abstract: false, final false
inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnUpdateDynamicTextures, addr 0x18237f9a0, size 0x70, virtual true, abstract: false, final false
inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method Reset, addr 0x18237fa10, size 0x150, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnAtlas, addr 0x18237fb60, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method TryGetAtlas, addr 0x18237fc30, size 0x440, virtual true, abstract: false, final false
inline bool TryGetAtlas(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::Texture2D*  src, ::by_ref<::UnityEngine::UIElements::TextureId>  atlas, ::by_ref<::UnityEngine::RectInt>  atlasRect) ;
...
/// @brief Method .ctor, addr 0x182380070, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultFilters, addr 0x1818c5820, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method get_isInitialized, addr 0x182380140, size 0x20, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_maxSubTextureSize, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxSubTextureSize() ;

/// @brief Method set_activeFilters, addr 0x182380160, size 0x20, virtual false, abstract: false, final false
inline void set_activeFilters(::UnityEngine::UIElements::DynamicAtlasFilters  value) ;

/// @brief Method set_customFilter, addr 0x182380180, size 0x60, virtual false, abstract: false, final false
inline void set_customFilter(::UnityEngine::UIElements::DynamicAtlasCustomFilter*  value) ;

/// @brief Method set_maxAtlasSize, addr 0x1823801e0, size 0x20, virtual false, abstract: false, final false
inline void set_maxAtlasSize(int32_t  value) ;

/// @brief Method set_maxSubTextureSize, addr 0x182380200, size 0x20, virtual false, abstract: false, final false
inline void set_maxSubTextureSize(int32_t  value) ;

/// @brief Method set_minAtlasSize, addr 0x182380220, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::DynamicAtlas) == 0x58, "Size mismatch!");
