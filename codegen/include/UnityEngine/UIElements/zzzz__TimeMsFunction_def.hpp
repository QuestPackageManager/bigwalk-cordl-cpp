...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TimeMsFunction*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TimeMsFunction*, "UnityEngine.UIElements", "TimeMsFunction");
...
static_assert(sizeof(::UnityEngine::UIElements::TimeMsFunction) == 0x80, "Size mismatch!");
