...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::ColumnResizer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::ColumnResizer*, "UnityEngine.UIElements.Internal", "ColumnResizer");
...
public:
// Declarations
/// @brief Field <columnLayout>k__BackingField, offset 0x48, size 0x8 
...
/// @brief Field <preview>k__BackingField, offset 0x50, size 0x1 
...
/// @brief Field m_Column, offset 0x38, size 0x8 
...
/// @brief Method BeginDragResize, addr 0x182481100, size 0x50, virtual false, abstract: false, final false
inline void BeginDragResize(float_t  pos) ;

/// @brief Method DragResize, addr 0x182481150, size 0x50, virtual false, abstract: false, final false
inline void DragResize(float_t  pos) ;

/// @brief Method EndDragResize, addr 0x1824811a0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x182481210, size 0x60, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerDown, addr 0x182481270, size 0x2d0, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  e) ;

/// @brief Method OnPointerMove, addr 0x182481540, size 0x110, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  e) ;

/// @brief Method OnPointerUp, addr 0x182481650, size 0x150, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  e) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x1824817a0, size 0x140, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x1824818e0, size 0x140, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdatePreviewPosition, addr 0x182481a20, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182481b10, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method get_columnLayout, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_preview, addr 0x1803151e0, size 0x10, virtual false, abstract: false, final false
inline bool get_preview() ;

/// @brief Method set_columnLayout, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_preview, addr 0x1803de5b0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field m_Resizing, offset: 0x2d, size: 0x1, def value: None
 bool  ___m_Resizing;
...
/// @brief Field m_Column, offset: 0x38, size: 0x8, def value: None
...
/// @brief Field <preview>k__BackingField, offset: 0x50, size: 0x1, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_Start) == 0x24, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_Active) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_Resizing) == 0x2d, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_Header) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_Column) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ___m_PreviewElement) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ____columnLayout_k__BackingField) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Internal::ColumnResizer, ____preview_k__BackingField) == 0x50, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Internal::ColumnResizer) == 0x60, "Size mismatch!");
