...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnMoveLocationPreview*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnMoveLocationPreview*, "UnityEngine.UIElements.Internal", "MultiColumnHeaderColumnMoveLocationPreview");
...
/// @brief Method .ctor, addr 0x1824860d0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
