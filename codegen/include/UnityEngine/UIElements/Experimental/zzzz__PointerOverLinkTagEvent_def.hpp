...
/// @brief Method <.cctor>b__0_0, addr 0x182489960, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x182474ad0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182474bf0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent, ____linkID_k__BackingField) == 0x118, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent, ____linkText_k__BackingField) == 0x120, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent) == 0x130, "Size mismatch!");
