...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent*);
MARK_REF_T(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent*, "UnityEngine.UIElements.Experimental", "PointerDownLinkTagEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent___c*, "UnityEngine.UIElements.Experimental", "PointerDownLinkTagEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x182489a10, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method GetPooled, addr 0x1824889e0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182488ad0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_linkID, addr 0x180337230, size 0x20, virtual false, abstract: false, final false
inline void set_linkID(::StringW  value) ;

/// @brief Method set_linkText, addr 0x180337210, size 0x20, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent, ____linkID_k__BackingField) == 0x118, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent, ____linkText_k__BackingField) == 0x120, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Experimental::PointerDownLinkTagEvent) == 0x130, "Size mismatch!");
