...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::UxmlTypeAttributeDescription_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UxmlTypeAttributeDescription_1, "UnityEngine.UIElements", "UxmlTypeAttributeDescription`1");
