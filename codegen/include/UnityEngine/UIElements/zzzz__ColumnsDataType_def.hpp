...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ColumnsDataType, "UnityEngine.UIElements", "ColumnsDataType");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::ColumnsDataType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ColumnsDataType) == 0x4, "Size mismatch!");
