...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Position, "UnityEngine.UIElements", "Position");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Position, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Position) == 0x4, "Size mismatch!");
