...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::MatchResultInfo, "UnityEngine.UIElements.StyleSheets", "MatchResultInfo");
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::MatchResultInfo) == 0xc, "Size mismatch!");
