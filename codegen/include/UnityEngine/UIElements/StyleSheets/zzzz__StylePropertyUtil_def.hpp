...
/// @brief Field s_AnimatableProperties, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_AnimatableProperties, put=setStaticF_s_AnimatableProperties)) ::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*  s_AnimatableProperties;

/// @brief Field s_AnimatableWithUsageHintProperties, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_AnimatableWithUsageHintProperties, put=setStaticF_s_AnimatableWithUsageHintProperties)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::UnityEngine::UIElements::UsageHints>*  s_AnimatableWithUsageHintProperties;
...
/// @brief Field s_IdToName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_IdToName, put=setStaticF_s_IdToName)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::StringW>*  s_IdToName;

/// @brief Field s_NameToId, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_NameToId, put=setStaticF_s_NameToId)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::StylePropertyId>*  s_NameToId;
...
/// @brief Method IsAnimatable, addr 0x182458840, size 0x50, virtual false, abstract: false, final false
static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId  id) ;

/// @brief Method IsMatchingShorthand, addr 0x182458890, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method TryGetEnumIntValue, addr 0x1824589f0, size 0xed0, virtual false, abstract: false, final false
...
static inline ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::UnityEngine::UIElements::UsageHints>* getStaticF_s_AnimatableWithUsageHintProperties() ;
...
/// @brief Method get_propertyNameToStylePropertyId, addr 0x18245cdc0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_stylePropertyIdToPropertyName, addr 0x18245ce00, size 0x40, virtual false, abstract: false, final false
...
static inline void setStaticF_s_AnimatableWithUsageHintProperties(::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::UnityEngine::UIElements::UsageHints>*  value) ;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::StylePropertyUtil) == 0x10, "Size mismatch!");
