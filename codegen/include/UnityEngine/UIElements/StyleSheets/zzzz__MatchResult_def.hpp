...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::MatchResult, "UnityEngine.UIElements.StyleSheets", "MatchResult");
...
/// @brief Method get_success, addr 0x181c16480, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::MatchResult) == 0x10, "Size mismatch!");
