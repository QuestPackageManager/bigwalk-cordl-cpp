...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::Syntax::DataType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::DataType) == 0x4, "Size mismatch!");
