...
/// @brief Field m_CombinatorStack, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CombinatorStack, put=__cordl_internal_set_m_CombinatorStack)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionCombinator>*  m_CombinatorStack;

/// @brief Field m_ExpressionStack, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ExpressionStack, put=__cordl_internal_set_m_ExpressionStack)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*  m_ExpressionStack;

/// @brief Field m_ParsedExpressionCache, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ParsedExpressionCache, put=__cordl_internal_set_m_ParsedExpressionCache)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*  m_ParsedExpressionCache;

/// @brief Field m_ProcessExpressionList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ProcessExpressionList, put=__cordl_internal_set_m_ProcessExpressionList)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*  m_ProcessExpressionList;

/// @brief Method EatSpace, addr 0x18247cbe0, size 0x90, virtual false, abstract: false, final false
static inline void EatSpace(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer*  tokenizer) ;

/// @brief Method IsCombinator, addr 0x18247cc70, size 0x10, virtual false, abstract: false, final false
static inline bool IsCombinator(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken  token) ;

/// @brief Method IsExpressionEnd, addr 0x18247cc80, size 0x20, virtual false, abstract: false, final false
static inline bool IsExpressionEnd(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken  token) ;

/// @brief Method IsMultiplier, addr 0x18247cca0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x18247e430, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::Expression* Parse(::StringW  syntax) ;

/// @brief Method ParseCombinatorType, addr 0x18247ccc0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method ParseDataType, addr 0x18247ce80, size 0x500, virtual false, abstract: false, final false
...
/// @brief Method ParseExpression, addr 0x18247d380, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method ParseGroup, addr 0x18247d580, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method ParseLimits, addr 0x18247d800, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method ParseMultiplier, addr 0x18247da40, size 0x2a0, virtual false, abstract: false, final false
inline void ParseMultiplier(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer*  tokenizer, ::by_ref<::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplier>  multiplier) ;

/// @brief Method ParseNonTerminalValue, addr 0x18247dce0, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::Expression* ParseNonTerminalValue(::StringW  syntax) ;

/// @brief Method ParseProperty, addr 0x18247ddf0, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method ParseRanges, addr 0x18247e110, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ParseTerm, addr 0x18247e280, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method ProcessCombinatorStack, addr 0x18247e540, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18247e740, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxParser) == 0x30, "Size mismatch!");
