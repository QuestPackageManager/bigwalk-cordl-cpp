...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionCombinator, "UnityEngine.UIElements.StyleSheets.Syntax", "ExpressionCombinator");
// Dependencies 
namespace UnityEngine::UIElements::StyleSheets::Syntax {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionCombinator, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionCombinator) == 0x4, "Size mismatch!");
