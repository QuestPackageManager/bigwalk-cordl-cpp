...
/// @brief Method GlobCharacter, addr 0x18247e8e0, size 0x60, virtual false, abstract: false, final false
static inline int32_t GlobCharacter(::StringW  s, int32_t  index, char16_t  c) ;

/// @brief Method IsNextCharacter, addr 0x18247e940, size 0x40, virtual false, abstract: false, final false
static inline bool IsNextCharacter(::StringW  s, int32_t  index, char16_t  c) ;

/// @brief Method IsNextLetterOrDash, addr 0x18247e980, size 0x80, virtual false, abstract: false, final false
static inline bool IsNextLetterOrDash(::StringW  s, int32_t  index) ;

/// @brief Method IsNextNumber, addr 0x18247ea00, size 0x30, virtual false, abstract: false, final false
static inline bool IsNextNumber(::StringW  s, int32_t  index) ;

/// @brief Method MoveNext, addr 0x18247ea30, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method PeekNext, addr 0x18247eb40, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken PeekNext() ;

/// @brief Method Tokenize, addr 0x18247ebe0, size 0x6c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18247f2a0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_current, addr 0x18247f2f0, size 0xa0, virtual false, abstract: false, final false
