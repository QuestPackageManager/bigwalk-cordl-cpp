...
public:
// Declarations
/// @brief Method .ctor, addr 0x18247e860, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType  t) ;

/// @brief Method .ctor, addr 0x18247e810, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType  type, float_t  number) ;

/// @brief Method .ctor, addr 0x18247e8a0, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType", modifiers: "", def_value: None }, CppParam { name: "text", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "number", ty: "float_t", modifiers: "", def_value: None }]
