...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType, "UnityEngine.UIElements.StyleSheets.Syntax", "ExpressionType");
// Dependencies 
namespace UnityEngine::UIElements::StyleSheets::Syntax {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType) == 0x4, "Size mismatch!");
