...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::GetViewDataDictionary*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::GetViewDataDictionary*, "UnityEngine.UIElements", "GetViewDataDictionary");
...
static_assert(sizeof(::UnityEngine::UIElements::GetViewDataDictionary) == 0x80, "Size mismatch!");
