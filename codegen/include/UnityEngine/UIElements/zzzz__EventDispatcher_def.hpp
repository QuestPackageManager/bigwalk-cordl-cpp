...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventDispatcher_DispatchContext, "UnityEngine.UIElements", "EventDispatcher/DispatchContext");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventDispatcher_EventRecord, "UnityEngine.UIElements", "EventDispatcher/EventRecord");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "m_Event", ty: "::UnityEngine::UIElements::EventBase*", modifiers: "", def_value: None }, CppParam { name: "m_Panel", ty: "::UnityEngine::UIElements::BaseVisualElementPanel*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::EventDispatcher_EventRecord) == 0x10, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "m_GateCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_Queue", ty: "::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>*", modifiers: "", def_value: None }]
...
/// @brief Method <.cctor>b__35_0, addr 0x1824d7d40, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field k_EventQueuePool, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_EventQueuePool, put=setStaticF_k_EventQueuePool)) ::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>*>*  k_EventQueuePool;
...
/// @brief Field m_DispatchContexts, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DispatchContexts, put=__cordl_internal_set_m_DispatchContexts)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::EventDispatcher_DispatchContext>*  m_DispatchContexts;
...
/// @brief Method CloseGate, addr 0x1824cd3a0, size 0x10, virtual false, abstract: false, final false
inline void CloseGate() ;

/// @brief Method CreateDefault, addr 0x1824cd3b0, size 0xf0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::EventDispatcher* CreateDefault() ;

/// @brief Method Dispatch, addr 0x1824cd4a0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method HandleRecursiveState, addr 0x1824c6560, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method OpenGate, addr 0x1824cd5f0, size 0xc0, virtual false, abstract: false, final false
inline void OpenGate() ;

/// @brief Method ProcessEvent, addr 0x1824cd8d0, size 0x250, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::BaseVisualElementPanel*  panel) ;

/// @brief Method ProcessEventQueue, addr 0x1824cd6b0, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824cdbe0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_dispatchImmediately, addr 0x1824cdcc0, size 0x50, virtual false, abstract: false, final false
inline bool get_dispatchImmediately() ;

/// @brief Method get_pointerState, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_processingEvents, addr 0x180503bb0, size 0x10, virtual false, abstract: false, final false
