...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutPositionType, "UnityEngine.UIElements.Layout", "LayoutPositionType");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutPositionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutPositionType) == 0x4, "Size mismatch!");
