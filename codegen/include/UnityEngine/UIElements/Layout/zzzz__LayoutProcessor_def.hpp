...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Layout::LayoutProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutProcessor*, "UnityEngine.UIElements.Layout", "LayoutProcessor");
...
/// @brief Method CalculateLayout, addr 0x182455170, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutProcessor) == 0x10, "Size mismatch!");
