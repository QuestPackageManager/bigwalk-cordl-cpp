...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Layout::LayoutProcessorNative*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutProcessorNative*, "UnityEngine.UIElements.Layout", "LayoutProcessorNative");
...
/// @brief Method UnityEngine.UIElements.Layout.ILayoutProcessor.CalculateLayout, addr 0x182454ff0, size 0x100, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1824550f0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutProcessorNative) == 0x38, "Size mismatch!");
