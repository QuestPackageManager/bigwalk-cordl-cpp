...
/// @brief Method InvokeBaselineFunction, addr 0x182451220, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method InvokeMeasureFunction, addr 0x182451450, size 0x290, virtual false, abstract: false, final false
static inline void InvokeMeasureFunction(::by_ref<::UnityEngine::UIElements::Layout::LayoutNode>  node, float_t  width, ::UnityEngine::UIElements::Layout::LayoutMeasureMode  widthMode, float_t  height, ::UnityEngine::UIElements::Layout::LayoutMeasureMode  heightMode, ::by_ref<::System::IntPtr>  exception, ::by_ref<::UnityEngine::UIElements::Layout::LayoutSize>  result) ;
