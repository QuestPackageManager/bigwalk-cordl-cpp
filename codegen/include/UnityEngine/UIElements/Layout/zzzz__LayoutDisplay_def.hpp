...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutDisplay, "UnityEngine.UIElements.Layout", "LayoutDisplay");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutDisplay, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutDisplay) == 0x4, "Size mismatch!");
