...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutState, "UnityEngine.UIElements.Layout", "LayoutState");
...
public:
// Declarations
/// @brief Method get_Default, addr 0x182455330, size 0x60, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "measureFunctionCallback", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "baselineFunctionCallback", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "unusedExceptionPointer", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "depth", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "currentGenerationCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "error", ty: "bool", modifiers: "", def_value: None }]
constexpr LayoutState(::System::IntPtr  measureFunctionCallback, ::System::IntPtr  baselineFunctionCallback, ::System::IntPtr  unusedExceptionPointer, uint32_t  depth, uint32_t  currentGenerationCount, bool  error) noexcept;
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutState) == 0x28, "Size mismatch!");
