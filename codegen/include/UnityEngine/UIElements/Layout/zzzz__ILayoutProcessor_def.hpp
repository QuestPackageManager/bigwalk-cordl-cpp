...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Layout::ILayoutProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::ILayoutProcessor*, "UnityEngine.UIElements.Layout", "ILayoutProcessor");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: false
