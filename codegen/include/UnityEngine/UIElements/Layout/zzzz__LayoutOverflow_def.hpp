...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutOverflow, "UnityEngine.UIElements.Layout", "LayoutOverflow");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutOverflow, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutOverflow) == 0x4, "Size mismatch!");
