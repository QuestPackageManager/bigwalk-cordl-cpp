...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutJustify, "UnityEngine.UIElements.Layout", "LayoutJustify");
// Dependencies 
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutJustify, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutJustify) == 0x4, "Size mismatch!");
