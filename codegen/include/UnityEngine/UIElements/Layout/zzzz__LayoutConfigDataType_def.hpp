...
static_assert(offsetof(::UnityEngine::UIElements::Layout::LayoutConfigDataType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutConfigDataType) == 0x4, "Size mismatch!");
