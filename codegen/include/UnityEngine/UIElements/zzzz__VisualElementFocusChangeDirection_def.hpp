...
/// @brief Method get_left, addr 0x18240d290, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::FocusChangeDirection* get_left() ;

/// @brief Method get_right, addr 0x18240d2d0, size 0x40, virtual false, abstract: false, final false
