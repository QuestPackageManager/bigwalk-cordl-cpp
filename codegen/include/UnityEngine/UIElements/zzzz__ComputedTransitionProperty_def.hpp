...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ComputedTransitionProperty, "UnityEngine.UIElements", "ComputedTransitionProperty");
...
static_assert(sizeof(::UnityEngine::UIElements::ComputedTransitionProperty) == 0x18, "Size mismatch!");
