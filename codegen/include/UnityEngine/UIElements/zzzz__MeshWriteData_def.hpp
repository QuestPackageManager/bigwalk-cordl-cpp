...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::MeshWriteData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MeshWriteData*, "UnityEngine.UIElements", "MeshWriteData");
...
static_assert(sizeof(::UnityEngine::UIElements::MeshWriteData) == 0x38, "Size mismatch!");
