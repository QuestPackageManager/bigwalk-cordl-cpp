...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TimeUnit, "UnityEngine.UIElements", "TimeUnit");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::TimeUnit, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::TimeUnit) == 0x4, "Size mismatch!");
