...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::UxmlNamespaceDefinition (*)()>(&::UnityEngine::UIElements::UxmlNamespaceDefinition::get_Empty)> {
  ...
  constexpr static std::size_t addrs = 0x182409ef0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::UxmlNamespaceDefinition>(),
                        {"get_Empty", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::UnityEngine::UIElements::UxmlNamespaceDefinition, ::UnityEngine::UIElements::UxmlNamespaceDefinition)>(&::UnityEngine::UIElements::UxmlNamespaceDefinition::op_Equality)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x182409f10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::UIElements::UxmlNamespaceDefinition::*)(::UnityEngine::UIElements::UxmlNamespaceDefinition)>(&::UnityEngine::UIElements::UxmlNamespaceDefinition::Equals)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x182409dd0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::UIElements::UxmlNamespaceDefinition::*)(::System::Object*)>(&::UnityEngine::UIElements::UxmlNamespaceDefinition::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x182409d50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::UIElements::UxmlNamespaceDefinition>(),
                    {::i2c::class_of<::UnityEngine::UIElements::UxmlNamespaceDefinition>(), 0}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::UIElements::UxmlNamespaceDefinition::*)()>(&::UnityEngine::UIElements::UxmlNamespaceDefinition::GetHashCode)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::UIElements::UxmlNamespaceDefinition>(),
                    {::i2c::class_of<::UnityEngine::UIElements::UxmlNamespaceDefinition>(), 2}
                ));
    return ___internal_method;
  }
};
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::UxmlNamespaceDefinition, "<Empty>k__BackingField", ::UnityEngine::UIElements::UxmlNamespaceDefinition>(std::forward<::UnityEngine::UIElements::UxmlNamespaceDefinition>(value));
}
...
constexpr ::System::IEquatable_1<::UnityEngine::UIElements::UxmlNamespaceDefinition>* UnityEngine::UIElements::UxmlNamespaceDefinition::i___System__IEquatable_1___UnityEngine__UIElements__UxmlNamespaceDefinition_()  {
return static_cast<::System::IEquatable_1<::UnityEngine::UIElements::UxmlNamespaceDefinition>*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
