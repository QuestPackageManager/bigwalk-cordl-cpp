...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PropertyBag_Scale_ValueProperty*);
MARK_REF_T(::UnityEngine::UIElements::Scale_PropertyBag*);
MARK_VAL_T(::UnityEngine::UIElements::Scale);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PropertyBag_Scale_ValueProperty*, "UnityEngine.UIElements", "Scale/PropertyBag/ValueProperty");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Scale_PropertyBag*, "UnityEngine.UIElements", "Scale/PropertyBag");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Scale, "UnityEngine.UIElements", "Scale");
...
/// @brief Method Equals, addr 0x1823d55b0, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1823d5530, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::Scale  other) ;

/// @brief Method GetHashCode, addr 0x1823d5660, size 0x70, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x1823d56d0, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Scale Initial() ;

/// @brief Method None, addr 0x1823d5700, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Scale None() ;

/// @brief Method ToString, addr 0x1823d5740, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method get_value, addr 0x1802d5330, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x1823d5780, size 0x60, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::Scale  lhs, ::UnityEngine::UIElements::Scale  rhs) ;

/// @brief Method op_Inequality, addr 0x1823d57e0, size 0x50, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::UIElements::Scale  lhs, ::UnityEngine::UIElements::Scale  rhs) ;

/// @brief Method set_value, addr 0x1802d5400, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Scale) == 0x10, "Size mismatch!");
...
inline ::UnityEngine::Vector3 GetValue(::by_ref<::UnityEngine::UIElements::Scale>  container) ;
...
inline void SetValue(::by_ref<::UnityEngine::UIElements::Scale>  container, ::UnityEngine::Vector3  value) ;
...
static_assert(sizeof(::UnityEngine::UIElements::PropertyBag_Scale_ValueProperty) == 0x28, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1823d4b20, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Scale_PropertyBag) == 0x28, "Size mismatch!");
