...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ClickEvent___c::*)()>(&::UnityEngine::UIElements::ClickEvent___c::_ctor)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::ClickEvent___c*>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::ClickEvent* (::UnityEngine::UIElements::ClickEvent___c::*)()>(&::UnityEngine::UIElements::ClickEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x1824d73a0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::Init)> {
  ...
  constexpr static std::size_t addrs = 0x1824c6e70;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::UIElements::ClickEvent*>(),
                    {::i2c::class_of<::UnityEngine::UIElements::ClickEvent*>(), 13}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::LocalInit)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1824c6e90;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1824c6f20;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::ClickEvent* (*)(::UnityEngine::UIElements::IPointerEvent*, int32_t)>(&::UnityEngine::UIElements::ClickEvent::GetPooled)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x1824c6e50;
