...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::MouseLeaveWindowEvent*);
MARK_REF_T(::UnityEngine::UIElements::MouseLeaveWindowEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseLeaveWindowEvent*, "UnityEngine.UIElements", "MouseLeaveWindowEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseLeaveWindowEvent___c*, "UnityEngine.UIElements", "MouseLeaveWindowEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d73e0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::MouseLeaveWindowEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method Dispatch, addr 0x1824d3490, size 0x40, virtual true, abstract: false, final false
inline void Dispatch(::UnityEngine::UIElements::BaseVisualElementPanel*  panel) ;

/// @brief Method GetPooled, addr 0x1824d3850, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* GetPooled(::UnityEngine::Event*  systemEvent) ;

/// @brief Method Init, addr 0x1824d38c0, size 0x30, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x1824d38f0, size 0x10, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* New_ctor() ;

/// @brief Method PostDispatch, addr 0x1824d3900, size 0xb0, virtual true, abstract: false, final false
inline void PostDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method .ctor, addr 0x1824d3a30, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
