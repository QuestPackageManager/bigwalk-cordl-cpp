...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ExecuteCommandEvent___c::*)()>(&::UnityEngine::UIElements::ExecuteCommandEvent___c::_ctor)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::ExecuteCommandEvent___c*>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::ExecuteCommandEvent* (::UnityEngine::UIElements::ExecuteCommandEvent___c::*)()>(&::UnityEngine::UIElements::ExecuteCommandEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x1824d77c0;
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::ExecuteCommandEvent___c*, "<>9", ::UnityEngine::UIElements::ExecuteCommandEvent___c*>(std::forward<::UnityEngine::UIElements::ExecuteCommandEvent___c*>(value));
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::ExecuteCommandEvent::*)()>(&::UnityEngine::UIElements::ExecuteCommandEvent::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1824cdd90;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::UIElements::ExecuteCommandEvent*>(),
                        {".ctor", {}, {}}
                    )));
    return ___internal_method;
  }
