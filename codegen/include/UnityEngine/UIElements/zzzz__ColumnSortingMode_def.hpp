...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ColumnSortingMode, "UnityEngine.UIElements", "ColumnSortingMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::ColumnSortingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ColumnSortingMode) == 0x4, "Size mismatch!");
