...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Tab*);
MARK_REF_T(::UnityEngine::UIElements::Tab_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Tab_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::Tab___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Tab*, "UnityEngine.UIElements", "Tab");
...
/// @brief Method .ctor, addr 0x1824b08b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x1824b0d00, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b22d0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__67_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__67_0, put=setStaticF___9__67_0)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::TooltipEvent*>*  __9__67_0;

static inline ::UnityEngine::UIElements::Tab___c* New_ctor() ;

/// @brief Method <.ctor>b__67_0, addr 0x1824b0490, size 0x10, virtual false, abstract: false, final false
inline void __ctor_b__67_0(::UnityEngine::UIElements::TooltipEvent*  evt) ;
...
static inline ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::TooltipEvent*>* getStaticF___9__67_0() ;

static inline void setStaticF___9(::UnityEngine::UIElements::Tab___c*  value) ;

static inline void setStaticF___9__67_0(::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::TooltipEvent*>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Tab___c) == 0x10, "Size mismatch!");
...
/// @brief Field <dragger>k__BackingField, offset 0x340, size 0x8 
...
/// @brief Field <index>k__BackingField, offset 0x348, size 0x4 
...
/// @brief Field closed, offset 0x2d8, size 0x8 
...
/// @brief Field closing, offset 0x2d0, size 0x8 
...
/// @brief Field m_CloseButton, offset 0x320, size 0x8 
...
/// @brief Field m_DragHandle, offset 0x318, size 0x8 
...
/// @brief Field m_IconImage, offset 0x2e8, size 0x20 
...
/// @brief Field m_TabHeaderImage, offset 0x330, size 0x8 
...
/// @brief Field m_TabHeaderLabel, offset 0x338, size 0x8 
...
/// @brief Field selected, offset 0x2c8, size 0x8 
...
/// @brief Method AddCloseButton, addr 0x1824ae1a0, size 0x20, virtual false, abstract: false, final false
inline void AddCloseButton() ;

/// @brief Method AddDragHandles, addr 0x1824ae1c0, size 0x20, virtual false, abstract: false, final false
inline void AddDragHandles() ;

/// @brief Method EnableTabCloseButton, addr 0x1824ae1e0, size 0x60, virtual false, abstract: false, final false
inline void EnableTabCloseButton(bool  enable) ;

/// @brief Method EnableTabDragHandles, addr 0x1824ae240, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method OnCloseButtonClicked, addr 0x1824ae2b0, size 0x70, virtual false, abstract: false, final false
inline void OnCloseButtonClicked(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnTabClicked, addr 0x1824ae320, size 0x20, virtual false, abstract: false, final false
inline void OnTabClicked(::UnityEngine::UIElements::PointerDownEvent*  _) ;

/// @brief Method RemoveCloseButton, addr 0x1824ae340, size 0x50, virtual false, abstract: false, final false
inline void RemoveCloseButton() ;

/// @brief Method RemoveDragHandles, addr 0x1824ae390, size 0x50, virtual false, abstract: false, final false
inline void RemoveDragHandles() ;

/// @brief Method SetActive, addr 0x1824ae3e0, size 0x30, virtual false, abstract: false, final false
inline void SetActive() ;

/// @brief Method SetInactive, addr 0x1824ae410, size 0x30, virtual false, abstract: false, final false
inline void SetInactive() ;

/// @brief Method UpdateTooltip, addr 0x1824ae440, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824af770, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1824aec50, size 0xb20, virtual false, abstract: false, final false
inline void _ctor(::StringW  label, ::UnityEngine::UIElements::Background  iconImage) ;

/// @brief Method add_closed, addr 0x1824af7c0, size 0xa0, virtual false, abstract: false, final false
inline void add_closed(::System::Action_1<::UnityEngine::UIElements::Tab*>*  value) ;

/// @brief Method add_selected, addr 0x1824af860, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_closeable, addr 0x1824af900, size 0x10, virtual false, abstract: false, final false
inline bool get_closeable() ;

/// @brief Method get_contentContainer, addr 0x182485ae0, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_iconImage, addr 0x1824af910, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Background get_iconImage() ;

/// @brief Method get_index, addr 0x1824af930, size 0x10, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_label, addr 0x1821a37f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_label() ;

/// @brief Method get_tabHeader, addr 0x180fc27a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_tabHeader() ;

/// @brief Method remove_closed, addr 0x1824af940, size 0xa0, virtual false, abstract: false, final false
inline void remove_closed(::System::Action_1<::UnityEngine::UIElements::Tab*>*  value) ;

/// @brief Method remove_selected, addr 0x1824af9e0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method set_closeable, addr 0x1824afa80, size 0xe0, virtual false, abstract: false, final false
inline void set_closeable(bool  value) ;

/// @brief Method set_iconImage, addr 0x1824afb60, size 0x2e0, virtual false, abstract: false, final false
inline void set_iconImage(::UnityEngine::UIElements::Background  value) ;

/// @brief Method set_index, addr 0x1824afe40, size 0x10, virtual false, abstract: false, final false
inline void set_index(int32_t  value) ;

/// @brief Method set_label, addr 0x1824afe50, size 0x120, virtual false, abstract: false, final false
...
/// @brief Field selected, offset: 0x2c8, size: 0x8, def value: None
 ::System::Action_1<::UnityEngine::UIElements::Tab*>*  ___selected;

/// @brief Field closing, offset: 0x2d0, size: 0x8, def value: None
 ::System::Func_1<bool>*  ___closing;

/// @brief Field closed, offset: 0x2d8, size: 0x8, def value: None
 ::System::Action_1<::UnityEngine::UIElements::Tab*>*  ___closed;

/// @brief Field m_Label, offset: 0x2e0, size: 0x8, def value: None
 ::StringW  ___m_Label;

/// @brief Field m_IconImage, offset: 0x2e8, size: 0x20, def value: None
 ::UnityEngine::UIElements::Background  ___m_IconImage;

/// @brief Field m_Closeable, offset: 0x308, size: 0x1, def value: None
 bool  ___m_Closeable;

/// @brief Field m_ContentContainer, offset: 0x310, size: 0x8, def value: None
 ::UnityEngine::UIElements::VisualElement*  ___m_ContentContainer;

/// @brief Field m_DragHandle, offset: 0x318, size: 0x8, def value: None
 ::UnityEngine::UIElements::VisualElement*  ___m_DragHandle;

/// @brief Field m_CloseButton, offset: 0x320, size: 0x8, def value: None
 ::UnityEngine::UIElements::VisualElement*  ___m_CloseButton;

/// @brief Field m_TabHeader, offset: 0x328, size: 0x8, def value: None
 ::UnityEngine::UIElements::VisualElement*  ___m_TabHeader;

/// @brief Field m_TabHeaderImage, offset: 0x330, size: 0x8, def value: None
 ::UnityEngine::UIElements::Image*  ___m_TabHeaderImage;

/// @brief Field m_TabHeaderLabel, offset: 0x338, size: 0x8, def value: None
 ::UnityEngine::UIElements::Label*  ___m_TabHeaderLabel;

/// @brief Field <dragger>k__BackingField, offset: 0x340, size: 0x8, def value: None
 ::UnityEngine::UIElements::TabDragger*  ____dragger_k__BackingField;

/// @brief Field <index>k__BackingField, offset: 0x348, size: 0x4, def value: None
 int32_t  ____index_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Tab, ___selected) == 0x2c8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___closing) == 0x2d0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___closed) == 0x2d8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_Label) == 0x2e0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_IconImage) == 0x2e8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_Closeable) == 0x308, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_ContentContainer) == 0x310, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_DragHandle) == 0x318, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_CloseButton) == 0x320, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_TabHeader) == 0x328, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_TabHeaderImage) == 0x330, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ___m_TabHeaderLabel) == 0x338, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ____dragger_k__BackingField) == 0x340, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Tab, ____index_k__BackingField) == 0x348, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Tab) == 0x350, "Size mismatch!");
