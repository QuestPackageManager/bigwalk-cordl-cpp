...
/// @brief Field m_PointerUpCallback, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PointerUpCallback, put=__cordl_internal_set_m_PointerUpCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerUpEvent*>*  m_PointerUpCallback;
...
/// @brief Field m_ToggleGeometryChangedCallback, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ToggleGeometryChangedCallback, put=__cordl_internal_set_m_ToggleGeometryChangedCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::GeometryChangedEvent*>*  m_ToggleGeometryChangedCallback;

/// @brief Field m_ToggleValueChangedCallback, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ToggleValueChangedCallback, put=__cordl_internal_set_m_ToggleValueChangedCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  m_ToggleValueChangedCallback;
...
/// @brief Field onToggleValueChanged, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_onToggleValueChanged, put=__cordl_internal_set_onToggleValueChanged)) ::System::Action_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  onToggleValueChanged;

 __declspec(property(get=get_rootElement)) ::UnityEngine::UIElements::VisualElement*  rootElement;

/// @brief Method DetachElement, addr 0x182398b20, size 0x110, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Indent, addr 0x182398c30, size 0x20, virtual false, abstract: false, final false
inline void Indent(int32_t  depth) ;

/// @brief Method Init, addr 0x182399020, size 0xc0, virtual true, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  item) ;

/// @brief Method InitExpandHierarchy, addr 0x182398c50, size 0x3d0, virtual false, abstract: false, final false
...
/// @brief Method OnPointerUp, addr 0x1823990e0, size 0x20, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnToggleGeometryChanged, addr 0x182399100, size 0xc0, virtual false, abstract: false, final false
inline void OnToggleGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnToggleValueChanged, addr 0x1823991c0, size 0x20, virtual false, abstract: false, final false
inline void OnToggleValueChanged(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method PreAttachElement, addr 0x1823991e0, size 0x110, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetExpandedWithoutNotify, addr 0x1823992f0, size 0x20, virtual false, abstract: false, final false
inline void SetExpandedWithoutNotify(bool  expanded) ;

/// @brief Method SetToggleVisibility, addr 0x182399310, size 0x20, virtual false, abstract: false, final false
inline void SetToggleVisibility(bool  visible) ;

/// @brief Method UpdateIndentLayout, addr 0x182399330, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method add_onPointerUp, addr 0x182399490, size 0x90, virtual false, abstract: false, final false
inline void add_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method add_onToggleValueChanged, addr 0x182399520, size 0x90, virtual false, abstract: false, final false
inline void add_onToggleValueChanged(::System::Action_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  value) ;

/// @brief Method get_indentWidth, addr 0x1823995b0, size 0x20, virtual false, abstract: false, final false
inline float_t get_indentWidth() ;

/// @brief Method get_rootElement, addr 0x1823995d0, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootElement() ;

/// @brief Method remove_onPointerUp, addr 0x1823995e0, size 0x90, virtual false, abstract: false, final false
inline void remove_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method remove_onToggleValueChanged, addr 0x182399670, size 0x90, virtual false, abstract: false, final false
