...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventCallbackRegistry_DynamicCallbackList, "UnityEngine.UIElements", "EventCallbackRegistry/DynamicCallbackList");
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x1824c61b0, size 0x10, virtual false, abstract: false, final false
inline void BeginInvoke() ;

/// @brief Method Create, addr 0x1824c9660, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x1824c61c0, size 0x1b0, virtual false, abstract: false, final false
inline void EndInvoke() ;

/// @brief Method GetCallbackListForReading, addr 0x1824c9700, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventCallbackList* GetCallbackListForReading() ;

/// @brief Method GetCallbackListForWriting, addr 0x1824c9720, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventCallbackList* GetCallbackListForWriting() ;

/// @brief Method Invoke, addr 0x1824c97d0, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method UnregisterCallback, addr 0x1824c99f0, size 0x210, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::EventCallbackRegistry_DynamicCallbackList) == 0x28, "Size mismatch!");
...
/// @brief Method GetCallbackList, addr 0x1824cb320, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method GetDynamicCallbackList, addr 0x1824cb4b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method RegisterCallback, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TEventType,typename TCallbackArgs>
inline void RegisterCallback(::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*  callback, TCallbackArgs  userArgs, ::UnityEngine::UIElements::CallbackOptions  callbackOptions) ;

/// @brief Method ReleaseCallbackList, addr 0x1824cb4d0, size 0x70, virtual false, abstract: false, final false
...
template<typename TEventType>
inline bool UnregisterCallback(::UnityEngine::UIElements::EventCallback_1<TEventType>*  callback, ::UnityEngine::UIElements::CallbackOptions  callbackOptions) ;

/// @brief Method UnregisterCallback, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TEventType,typename TCallbackArgs>
inline bool UnregisterCallback(::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*  callback, ::UnityEngine::UIElements::CallbackOptions  callbackOptions) ;
...
/// @brief Method .ctor, addr 0x1824cb5c0, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;
