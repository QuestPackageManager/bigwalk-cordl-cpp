...
/// @brief Method get_childIndex, addr 0x180303b50, size 0x10, virtual true, abstract: false, final true
inline int32_t get_childIndex() ;

/// @brief Method get_dragAndDropData, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropData* get_dragAndDropData() ;

/// @brief Method get_dragAndDropPosition, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropPosition get_dragAndDropPosition() ;

/// @brief Method get_insertAtIndex, addr 0x1802f1880, size 0x10, virtual true, abstract: false, final true
inline int32_t get_insertAtIndex() ;

/// @brief Method get_parentId, addr 0x1803bdb30, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_childIndex, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_childIndex(int32_t  value) ;

/// @brief Method set_dragAndDropData, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_dragAndDropData(::UnityEngine::UIElements::DragAndDropData*  value) ;

/// @brief Method set_dragAndDropPosition, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
inline void set_dragAndDropPosition(::UnityEngine::UIElements::DragAndDropPosition  value) ;

/// @brief Method set_insertAtIndex, addr 0x1804bd900, size 0x10, virtual false, abstract: false, final false
inline void set_insertAtIndex(int32_t  value) ;

/// @brief Method set_modifiers, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
inline void set_modifiers(::UnityEngine::EventModifiers  value) ;

/// @brief Method set_parentId, addr 0x1804bdb30, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_target_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "_insertAtIndex_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_parentId_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_childIndex_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_dragAndDropPosition_k__BackingField", ty: "::UnityEngine::UIElements::DragAndDropPosition", modifiers: "", def_value: None }, CppParam { name: "_dragAndDropData_k__BackingField", ty: "::UnityEngine::UIElements::DragAndDropData*", modifiers: "", def_value: None }, CppParam { name: "_modifiers_k__BackingField", ty: "::UnityEngine::EventModifiers", modifiers: "", def_value: None }]
