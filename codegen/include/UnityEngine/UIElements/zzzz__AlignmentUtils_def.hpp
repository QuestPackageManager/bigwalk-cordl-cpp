...
public:
// Declarations
/// @brief Method CeilToPixelGrid, addr 0x18236f8b0, size 0x30, virtual false, abstract: false, final false
static inline float_t CeilToPixelGrid(float_t  v, float_t  pixelsPerPoint, float_t  offset) ;

/// @brief Method RoundToPanelPixelSize, addr 0x18236f8e0, size 0x50, virtual false, abstract: false, final false
static inline float_t RoundToPanelPixelSize(::UnityEngine::UIElements::VisualElement*  ve, float_t  v) ;

/// @brief Method RoundToPixelGrid, addr 0x18236f930, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::AlignmentUtils) == 0x10, "Size mismatch!");
