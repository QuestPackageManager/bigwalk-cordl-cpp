...
static_assert(offsetof(::UnityEngine::UIElements::UxmlSerializedData_UxmlAttributeFlags, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UxmlSerializedData_UxmlAttributeFlags) == 0x1, "Size mismatch!");
...
/// @brief Field s_CurrentDeserializeFlags, offset 0xffffffff, size 0x1 
 __declspec(property(get=getStaticF_s_CurrentDeserializeFlags, put=setStaticF_s_CurrentDeserializeFlags)) ::UnityEngine::UIElements::UxmlSerializedData_UxmlAttributeFlags  s_CurrentDeserializeFlags;
