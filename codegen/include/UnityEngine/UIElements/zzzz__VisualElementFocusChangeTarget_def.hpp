...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::VisualElementFocusChangeTarget*);
...
/// @brief Method <.cctor>b__9_0, addr 0x1824120c0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::VisualElementFocusChangeTarget___c) == 0x10, "Size mismatch!");
...
/// @brief Method ApplyTo, addr 0x182415560, size 0x40, virtual true, abstract: false, final false
inline void ApplyTo(::UnityEngine::UIElements::FocusController*  focusController, ::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method Dispose, addr 0x1824155a0, size 0x60, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetPooled, addr 0x182415600, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182415720, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_target, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::VisualElementFocusChangeTarget) == 0x20, "Size mismatch!");
