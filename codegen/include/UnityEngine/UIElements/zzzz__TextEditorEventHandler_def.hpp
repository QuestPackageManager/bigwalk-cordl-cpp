...
/// @brief Method RegisterCallbacksOnTarget, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget(::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
