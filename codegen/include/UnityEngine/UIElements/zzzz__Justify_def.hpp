...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Justify, "UnityEngine.UIElements", "Justify");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Justify, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Justify) == 0x4, "Size mismatch!");
