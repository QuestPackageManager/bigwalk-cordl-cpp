...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::KeyDownEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d79b0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::KeyDownEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method PostDispatch, addr 0x1824d2990, size 0x80, virtual true, abstract: false, final false
inline void PostDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method SendEquivalentNavigationEventIfAny, addr 0x1824d2a10, size 0x530, virtual false, abstract: false, final false
inline void SendEquivalentNavigationEventIfAny(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method .ctor, addr 0x1824d2fc0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::KeyDownEvent) == 0x78, "Size mismatch!");
