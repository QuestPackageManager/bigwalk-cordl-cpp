...
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::UQueryState_1_ListQueryMatcher_1);
MARK_GEN_VAL_T(::UnityEngine::UIElements::UQueryState_1);
MARK_GEN_VAL_T(::UnityEngine::UIElements::UQueryState_1_Enumerator);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UQueryState_1_ActionQueryMatcher, "UnityEngine.UIElements", "UQueryState`1/ActionQueryMatcher");
...
/// @brief Field <matches>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__matches_k__BackingField, put=__cordl_internal_set__matches_k__BackingField)) ::System::Collections::Generic::List_1<TElement>*  _matches_k__BackingField;
...
/// @brief Field s_EnumerationList, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_EnumerationList, put=setStaticF_s_EnumerationList)) ::UnityEngine::UIElements::UQueryState_1_ListQueryMatcher_1<T,::UnityEngine::UIElements::VisualElement*>*  s_EnumerationList;
