...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BindingMode, "UnityEngine.UIElements", "BindingMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::BindingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::BindingMode) == 0x4, "Size mismatch!");
