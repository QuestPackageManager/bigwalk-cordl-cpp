...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::FocusInEvent*);
MARK_REF_T(::UnityEngine::UIElements::FocusInEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::FocusInEvent*, "UnityEngine.UIElements", "FocusInEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::FocusInEvent___c*, "UnityEngine.UIElements", "FocusInEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7a10, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::FocusInEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method Init, addr 0x1824d1960, size 0x20, virtual true, abstract: false, final false
inline void Init() ;
...
/// @brief Method PostDispatch, addr 0x1824d1980, size 0x40, virtual true, abstract: false, final false
inline void PostDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method .ctor, addr 0x1824d1a40, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::FocusInEvent) == 0x88, "Size mismatch!");
