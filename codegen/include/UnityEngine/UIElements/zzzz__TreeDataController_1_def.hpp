...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::TreeDataController_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::TreeDataController_1, "UnityEngine.UIElements", "TreeDataController`1");
...
/// @brief Field m_ItemStack, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ItemStack, put=__cordl_internal_set_m_ItemStack)) ::System::Collections::Generic::Stack_1<::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::TreeViewItemData_1<T>>*>*  m_ItemStack;
...
/// @brief Field m_NodeToItemDataDictionary, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_NodeToItemDataDictionary, put=__cordl_internal_set_m_NodeToItemDataDictionary)) ::System::Collections::Generic::Dictionary_2<::Unity::Hierarchy::HierarchyNode,::UnityEngine::UIElements::TreeViewItemData_1<T>>*  m_NodeToItemDataDictionary;
...
inline void ConvertTreeViewItemDataToHierarchy(::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::TreeViewItemData_1<T>>*  list, ::System::Func_2<::Unity::Hierarchy::HierarchyNode,::Unity::Hierarchy::HierarchyNode>*  createNode, ::System::Action_2<int32_t,::Unity::Hierarchy::HierarchyNode>*  updateDictionary) ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::Unity::Hierarchy::HierarchyNode,::UnityEngine::UIElements::TreeViewItemData_1<T>>* const& __cordl_internal_get_m_NodeToItemDataDictionary() const;
...
constexpr void __cordl_internal_set_m_NodeToItemDataDictionary(::System::Collections::Generic::Dictionary_2<::Unity::Hierarchy::HierarchyNode,::UnityEngine::UIElements::TreeViewItemData_1<T>>*  value) ;
