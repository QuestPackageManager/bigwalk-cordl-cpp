...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EasingMode, "UnityEngine.UIElements", "EasingMode");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::EasingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::EasingMode) == 0x4, "Size mismatch!");
