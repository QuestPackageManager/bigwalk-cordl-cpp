...
static_assert(offsetof(::UnityEngine::UIElements::RenderHints, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::RenderHints) == 0x4, "Size mismatch!");
