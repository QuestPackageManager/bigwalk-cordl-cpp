...
/// @brief Method .ctor, addr 0x18249f100, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method NotifyPropertyChanged, addr 0x18249df70, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18249e3b0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(int32_t  columnIndex, ::UnityEngine::UIElements::SortDirection  direction) ;

/// @brief Method .ctor, addr 0x18249e2b0, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::StringW  columnName, ::UnityEngine::UIElements::SortDirection  direction) ;

/// @brief Method add_changed, addr 0x18249e490, size 0x90, virtual false, abstract: false, final false
inline void add_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>*  value) ;

/// @brief Method add_propertyChanged, addr 0x18249e520, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method get_column, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Column* get_column() ;

/// @brief Method get_columnIndex, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_columnIndex() ;

/// @brief Method get_columnName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_columnName() ;

/// @brief Method get_direction, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method remove_changed, addr 0x18249e5b0, size 0x90, virtual false, abstract: false, final false
inline void remove_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>*  value) ;

/// @brief Method remove_propertyChanged, addr 0x18249e640, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method set_column, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_column(::UnityEngine::UIElements::Column*  value) ;

/// @brief Method set_columnIndex, addr 0x18249e6d0, size 0x70, virtual false, abstract: false, final false
inline void set_columnIndex(int32_t  value) ;

/// @brief Method set_columnName, addr 0x18249e740, size 0x90, virtual false, abstract: false, final false
inline void set_columnName(::StringW  value) ;

/// @brief Method set_direction, addr 0x18249e7d0, size 0x70, virtual false, abstract: false, final false
