...
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::StyleValuePropertyBag_2_KeywordProperty);
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::StyleValuePropertyBag_2_ValueProperty);
...
/// @brief Method GetValue, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::StyleKeyword GetValue(::by_ref<TContainer>  container) ;

static inline ::UnityEngine::UIElements::StyleValuePropertyBag_2_KeywordProperty<TContainer,TValue>* New_ctor() ;

/// @brief Method SetValue, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void SetValue(::by_ref<TContainer>  container, ::UnityEngine::UIElements::StyleKeyword  value) ;
