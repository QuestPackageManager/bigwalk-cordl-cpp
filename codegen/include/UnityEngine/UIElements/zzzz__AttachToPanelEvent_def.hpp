...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::AttachToPanelEvent*);
MARK_REF_T(::UnityEngine::UIElements::AttachToPanelEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AttachToPanelEvent*, "UnityEngine.UIElements", "AttachToPanelEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AttachToPanelEvent___c*, "UnityEngine.UIElements", "AttachToPanelEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7760, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::AttachToPanelEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824c6be0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::AttachToPanelEvent) == 0x78, "Size mismatch!");
