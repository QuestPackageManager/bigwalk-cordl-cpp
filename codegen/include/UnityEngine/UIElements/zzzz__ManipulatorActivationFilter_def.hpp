...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ManipulatorActivationFilter, "UnityEngine.UIElements", "ManipulatorActivationFilter");
// Dependencies UnityEngine.EventModifiers, UnityEngine.UIElements.MouseButton
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Equals, addr 0x182509af0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x182509b80, size 0x80, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method HasModifiers, addr 0x182509c00, size 0xe0, virtual false, abstract: false, final false
inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method MatchModifiers, addr 0x182509ce0, size 0xa0, virtual false, abstract: false, final false
inline bool MatchModifiers(bool  alt, bool  ctrl, bool  shift, bool  command) ;

/// @brief Method Matches, addr 0x182509d80, size 0xc0, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method get_button, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseButton get_button() ;

/// @brief Method get_clickCount, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_button, addr 0x180379030, size 0x10, virtual false, abstract: false, final false
inline void set_button(::UnityEngine::UIElements::MouseButton  value) ;

/// @brief Method set_modifiers, addr 0x1803bda60, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ManipulatorActivationFilter) == 0xc, "Size mismatch!");
