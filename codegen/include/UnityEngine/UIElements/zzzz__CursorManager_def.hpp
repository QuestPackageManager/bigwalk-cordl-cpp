...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::CursorManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::CursorManager*, "UnityEngine.UIElements", "CursorManager");
...
/// @brief Method ResetCursor, addr 0x1824b3710, size 0x40, virtual true, abstract: false, final true
inline void ResetCursor() ;

/// @brief Method SetCursor, addr 0x1824b3750, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method get_isCursorOverriden, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_isCursorOverriden, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::CursorManager) == 0x18, "Size mismatch!");
