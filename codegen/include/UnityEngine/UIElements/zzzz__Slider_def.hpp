...
/// @brief Method .ctor, addr 0x1824b0880, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x1824b0f60, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b23c0, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x1824a9520, size 0x100, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, float_t  startValue) ;

/// @brief Method ComputeValueFromKey, addr 0x1824a9620, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x1824a97b0, size 0x80, virtual true, abstract: false, final false
inline float_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x1824a9830, size 0x140, virtual true, abstract: false, final false
inline float_t SliderLerpUnclamped(float_t  a, float_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x1824a9970, size 0x90, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method SliderRange, addr 0x1824a9a00, size 0x40, virtual true, abstract: false, final false
inline float_t SliderRange() ;

/// @brief Method .ctor, addr 0x1824a9bd0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1824a9b20, size 0xb0, virtual false, abstract: false, final false
