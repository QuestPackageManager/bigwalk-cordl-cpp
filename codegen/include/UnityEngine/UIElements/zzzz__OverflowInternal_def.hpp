...
static_assert(offsetof(::UnityEngine::UIElements::OverflowInternal, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::OverflowInternal) == 0x4, "Size mismatch!");
