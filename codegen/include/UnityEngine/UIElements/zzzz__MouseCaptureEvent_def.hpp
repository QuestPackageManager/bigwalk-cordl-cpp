...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::MouseCaptureEvent*);
MARK_REF_T(::UnityEngine::UIElements::MouseCaptureEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseCaptureEvent*, "UnityEngine.UIElements", "MouseCaptureEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::MouseCaptureEvent___c*, "UnityEngine.UIElements", "MouseCaptureEvent/<>c");
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7290, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::MouseCaptureEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824d3170, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::MouseCaptureEvent) == 0x78, "Size mismatch!");
