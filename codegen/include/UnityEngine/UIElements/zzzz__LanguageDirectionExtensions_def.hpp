...
CORDL_MODULE_EXPORT(LanguageDirectionExtensions)
...
namespace UnityEngine::UIElements {
class LanguageDirectionExtensions;
}
// Write type traits
...
public:
// Declarations
/// @brief Method toTextCore, addr 0x182410f30, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::LanguageDirectionExtensions) == 0x10, "Size mismatch!");
