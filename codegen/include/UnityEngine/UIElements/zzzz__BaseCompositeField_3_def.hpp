...
namespace UnityEngine::UIElements {
template<typename TValueType,typename TField,typename TFieldValue>
class BaseCompositeField_3___c__DisplayClass23_0;
}
namespace UnityEngine::UIElements {
template<typename T>
class ChangeEvent_1;
...
inline void Invoke(::by_ref<TValueType>  val, TFieldValue  fieldValue) ;
...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ussName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "read", ty: "::System::Func_2<TValueType,TFieldValue>*", modifiers: "", def_value: None }, CppParam { name: "write", ty: "::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<TValueType,TField,TFieldValue>*", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "", ty: "BaseCompositeField_3___c__DisplayClass23_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
BaseCompositeField_3___c__DisplayClass23_0(BaseCompositeField_3___c__DisplayClass23_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "BaseCompositeField_3___c__DisplayClass23_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
