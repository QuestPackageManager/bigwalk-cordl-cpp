...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::NavigationCancelEvent*);
...
/// @brief Method <.cctor>b__0_0, addr 0x1824d7c40, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::NavigationCancelEvent___c) == 0x10, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x1824d3e50, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::NavigationCancelEvent) == 0x70, "Size mismatch!");
