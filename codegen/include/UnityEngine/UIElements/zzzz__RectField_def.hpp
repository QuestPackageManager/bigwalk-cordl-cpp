...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::RectField*);
MARK_REF_T(::UnityEngine::UIElements::RectField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::RectField_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::RectField___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RectField*, "UnityEngine.UIElements", "RectField");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RectField_UxmlFactory*, "UnityEngine.UIElements", "RectField/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RectField_UxmlTraits*, "UnityEngine.UIElements", "RectField/UxmlTraits");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::RectField___c*, "UnityEngine.UIElements", "RectField/<>c");
...
/// @brief Method .ctor, addr 0x18246dab0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::RectField_UxmlFactory) == 0x18, "Size mismatch!");
...
/// @brief Method Init, addr 0x18246ede0, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182470870, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::RectField_UxmlTraits, ___m_XValue) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::RectField_UxmlTraits, ___m_YValue) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::RectField_UxmlTraits, ___m_WValue) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::RectField_UxmlTraits, ___m_HValue) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::RectField_UxmlTraits) == 0xb8, "Size mismatch!");
...
/// @brief Field <>9__0_1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_1, put=setStaticF___9__0_1)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Rect,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_1;
...
/// @brief Field <>9__0_3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_3, put=setStaticF___9__0_3)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Rect,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_3;
...
/// @brief Field <>9__0_5, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_5, put=setStaticF___9__0_5)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Rect,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_5;
...
/// @brief Field <>9__0_7, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_7, put=setStaticF___9__0_7)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Rect,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_7;
...
inline void _DescribeFields_b__0_1(::by_ref<::UnityEngine::Rect>  r, float_t  v) ;
...
inline void _DescribeFields_b__0_3(::by_ref<::UnityEngine::Rect>  r, float_t  v) ;
...
inline void _DescribeFields_b__0_5(::by_ref<::UnityEngine::Rect>  r, float_t  v) ;
...
inline void _DescribeFields_b__0_7(::by_ref<::UnityEngine::Rect>  r, float_t  v) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::RectField___c) == 0x10, "Size mismatch!");
...
/// @brief Method DescribeFields, addr 0x18246a900, size 0x530, virtual true, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::BaseCompositeField_3_FieldDescription<::UnityEngine::Rect,::UnityEngine::UIElements::FloatField*,float_t>> DescribeFields() ;
...
/// @brief Method .ctor, addr 0x18246af10, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18246aff0, size 0xf0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::RectField) == 0x370, "Size mismatch!");
