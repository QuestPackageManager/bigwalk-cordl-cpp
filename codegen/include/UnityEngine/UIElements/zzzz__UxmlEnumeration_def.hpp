...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlEnumeration*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlEnumeration*, "UnityEngine.UIElements", "UxmlEnumeration");
...
/// @brief Method Equals, addr 0x1824092a0, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method set_values, addr 0x1824093a0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlEnumeration) == 0x18, "Size mismatch!");
