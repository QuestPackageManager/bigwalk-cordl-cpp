...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ReusableCollectionItem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ReusableCollectionItem*, "UnityEngine.UIElements", "ReusableCollectionItem");
...
/// @brief Method DestroyElement, addr 0x1823978a0, size 0x20, virtual true, abstract: false, final false
inline void DestroyElement() ;

/// @brief Method DetachElement, addr 0x1823978c0, size 0xf0, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Init, addr 0x180308500, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method OnGeometryChanged, addr 0x1823979b0, size 0x70, virtual true, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method PreAttachElement, addr 0x182397a20, size 0xa0, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetDragGhost, addr 0x182397ac0, size 0x1b0, virtual true, abstract: false, final false
inline void SetDragGhost(bool  dragGhost) ;

/// @brief Method SetSelected, addr 0x182397c70, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method add_onDestroy, addr 0x182397dc0, size 0x90, virtual false, abstract: false, final false
inline void add_onDestroy(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method add_onGeometryChanged, addr 0x182397e50, size 0x90, virtual false, abstract: false, final false
inline void add_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method get_animator, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>* get_animator() ;

/// @brief Method get_bindableElement, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_bindableElement() ;

/// @brief Method get_id, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_index, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_isDragGhost, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method remove_onDestroy, addr 0x182397ee0, size 0x90, virtual false, abstract: false, final false
inline void remove_onDestroy(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method remove_onGeometryChanged, addr 0x182397f70, size 0x90, virtual false, abstract: false, final false
inline void remove_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method set_animator, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_bindableElement, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_bindableElement(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_id, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
inline void set_id(int32_t  value) ;

/// @brief Method set_index, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
inline void set_index(int32_t  value) ;

/// @brief Method set_isDragGhost, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ReusableCollectionItem) == 0x48, "Size mismatch!");
