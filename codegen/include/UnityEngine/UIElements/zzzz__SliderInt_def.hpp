...
/// @brief Method .ctor, addr 0x1824b0870, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x1824b08d0, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b2830, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x1824a8bc0, size 0x100, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int32_t  startValue) ;

/// @brief Method ComputeValueAndDirectionFromClick, addr 0x1824a8cc0, size 0x290, virtual true, abstract: false, final false
...
/// @brief Method ComputeValueFromKey, addr 0x1824a8f50, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x1824a9100, size 0x80, virtual true, abstract: false, final false
inline int32_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x1824a9180, size 0x30, virtual true, abstract: false, final false
inline int32_t SliderLerpUnclamped(int32_t  a, int32_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x1824a91b0, size 0x40, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(int32_t  currentValue, int32_t  lowerValue, int32_t  higherValue) ;

/// @brief Method SliderRange, addr 0x1824a91f0, size 0x40, virtual true, abstract: false, final false
inline int32_t SliderRange() ;

/// @brief Method .ctor, addr 0x1824a9310, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1824a93e0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_pageSize, addr 0x1824a94e0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_pageSize, addr 0x1824a94f0, size 0x30, virtual true, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::SliderInt) == 0x3c8, "Size mismatch!");
