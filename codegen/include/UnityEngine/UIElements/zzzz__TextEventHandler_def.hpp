...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TextEventHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TextEventHandler*, "UnityEngine.UIElements", "TextEventHandler");
...
/// @brief Field m_ATagOnPointerMove, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ATagOnPointerMove, put=__cordl_internal_set_m_ATagOnPointerMove)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerMoveEvent*>*  m_ATagOnPointerMove;

/// @brief Field m_ATagOnPointerOut, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ATagOnPointerOut, put=__cordl_internal_set_m_ATagOnPointerOut)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerOutEvent*>*  m_ATagOnPointerOut;

/// @brief Field m_ATagOnPointerOver, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ATagOnPointerOver, put=__cordl_internal_set_m_ATagOnPointerOver)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerOverEvent*>*  m_ATagOnPointerOver;

/// @brief Field m_ATagOnPointerUp, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ATagOnPointerUp, put=__cordl_internal_set_m_ATagOnPointerUp)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerUpEvent*>*  m_ATagOnPointerUp;
...
/// @brief Method ATagOnPointerMove, addr 0x1823f4070, size 0x210, virtual false, abstract: false, final false
inline void ATagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method ATagOnPointerOut, addr 0x1823e6ea0, size 0x10, virtual false, abstract: false, final false
inline void ATagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  evt) ;

/// @brief Method ATagOnPointerOver, addr 0x1823e6ea0, size 0x10, virtual false, abstract: false, final false
inline void ATagOnPointerOver(::UnityEngine::UIElements::PointerOverEvent*  _) ;

/// @brief Method ATagOnPointerUp, addr 0x1823f4280, size 0x170, virtual false, abstract: false, final false
inline void ATagOnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  pue) ;

/// @brief Method AllocateATagCallbacks, addr 0x1823f43f0, size 0x100, virtual false, abstract: false, final false
inline void AllocateATagCallbacks() ;

/// @brief Method AllocateLinkCallbacks, addr 0x1823f44f0, size 0x100, virtual false, abstract: false, final false
inline void AllocateLinkCallbacks() ;

/// @brief Method HandleATag, addr 0x1823f45f0, size 0xd0, virtual false, abstract: false, final false
inline void HandleATag() ;

/// @brief Method HandleLinkAndATagCallbacks, addr 0x1823f46c0, size 0x410, virtual false, abstract: false, final false
inline void HandleLinkAndATagCallbacks() ;

/// @brief Method HandleLinkTag, addr 0x1823f4ad0, size 0xd0, virtual false, abstract: false, final false
inline void HandleLinkTag() ;

/// @brief Method HasAllocatedATagCallbacks, addr 0x180d8de60, size 0x1780, virtual false, abstract: false, final false
inline bool HasAllocatedATagCallbacks() ;

/// @brief Method HasAllocatedLinkCallbacks, addr 0x1809d1ac0, size 0x4e0, virtual false, abstract: false, final false
inline bool HasAllocatedLinkCallbacks() ;

/// @brief Method LinkTagOnPointerDown, addr 0x1823f4ba0, size 0x270, virtual false, abstract: false, final false
inline void LinkTagOnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  pde) ;

/// @brief Method LinkTagOnPointerMove, addr 0x1823f4e10, size 0x440, virtual false, abstract: false, final false
inline void LinkTagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method LinkTagOnPointerOut, addr 0x1823e7870, size 0x110, virtual false, abstract: false, final false
inline void LinkTagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  poe) ;

/// @brief Method LinkTagOnPointerUp, addr 0x1823f5250, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x1823f54c0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823f55c0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  textElement) ;

/// @brief Method get_textInfo, addr 0x1823f55e0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TextEventHandler) == 0x68, "Size mismatch!");
