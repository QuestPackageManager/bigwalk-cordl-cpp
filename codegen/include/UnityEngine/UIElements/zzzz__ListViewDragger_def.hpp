...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ListViewDragger_DragPosition, "UnityEngine.UIElements", "ListViewDragger/DragPosition");
...
/// @brief Method Equals, addr 0x1824b5490, size 0xc0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1824b5550, size 0x90, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::ListViewDragger_DragPosition  other) ;

/// @brief Method GetHashCode, addr 0x1824b55e0, size 0xc0, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "insertAtIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "parentId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "childIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "recycledItem", ty: "::UnityEngine::UIElements::ReusableCollectionItem*", modifiers: "", def_value: None }, CppParam { name: "dropPosition", ty: "::UnityEngine::UIElements::DragAndDropPosition", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::UIElements::ListViewDragger_DragPosition) == 0x20, "Size mismatch!");
...
/// @brief Method ApplyDragAndDropUI, addr 0x1824b7c80, size 0x7e0, virtual false, abstract: false, final false
inline void ApplyDragAndDropUI(::UnityEngine::UIElements::ListViewDragger_DragPosition  dragPosition) ;

/// @brief Method CanStartDrag, addr 0x1824b8460, size 0x360, virtual true, abstract: false, final false
inline bool CanStartDrag(::UnityEngine::Vector3  pointerPosition, ::UnityEngine::EventModifiers  modifiers) ;

/// @brief Method ClearDragAndDropUI, addr 0x1824b87c0, size 0x320, virtual true, abstract: false, final false
inline void ClearDragAndDropUI(bool  dragCancelled) ;

/// @brief Method GetHoverBarTopPosition, addr 0x1824b8ae0, size 0xf0, virtual false, abstract: false, final false
inline float_t GetHoverBarTopPosition(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method GetPreviousAndNextItemsIgnoringDraggedItems, addr 0x1824b8bd0, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method GetRecycledItem, addr 0x1824b8de0, size 0x1c0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* GetRecycledItem(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method GetVisualMode, addr 0x1824b8fa0, size 0x1b0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DragVisualMode GetVisualMode(::UnityEngine::Vector3  pointerPosition, ::UnityEngine::EventModifiers  modifiers, ::by_ref<::UnityEngine::UIElements::ListViewDragger_DragPosition>  dragPosition) ;

/// @brief Method HandleAutoExpansion, addr 0x1824b9150, size 0xe0, virtual false, abstract: false, final false
inline void HandleAutoExpansion(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleDragAndScroll, addr 0x1824b9230, size 0x340, virtual false, abstract: false, final false
inline void HandleDragAndScroll(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleSiblingInsertionAtAvailableDepthsAndChangeTargetIfNeeded, addr 0x1824b9570, size 0x670, virtual false, abstract: false, final false
...
/// @brief Method HandleTreePosition, addr 0x1824b9be0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method IsDraggingDisabled, addr 0x1824b9d10, size 0xd0, virtual false, abstract: false, final false
inline bool IsDraggingDisabled() ;

/// @brief Method MakeDragAndDropArgs, addr 0x1824b9de0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x1824b9f20, size 0x250, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition, ::UnityEngine::EventModifiers  modifiers) ;

/// @brief Method PlaceHoverBarAt, addr 0x1824ba290, size 0x670, virtual false, abstract: false, final false
inline void PlaceHoverBarAt(float_t  top, float_t  indentationPadding, float_t  siblingBottom) ;

/// @brief Method PlaceHoverBarAtElement, addr 0x1824ba170, size 0x120, virtual false, abstract: false, final false
inline void PlaceHoverBarAtElement(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method StartDrag, addr 0x1824ba900, size 0x400, virtual true, abstract: false, final false
...
/// @brief Method TryGetDragPosition, addr 0x1824bad00, size 0x500, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x1824bb330, size 0x490, virtual true, abstract: false, final false
inline void UpdateDrag(::UnityEngine::Vector3  pointerPosition, ::UnityEngine::EventModifiers  modifiers) ;

/// @brief Method <ApplyDragAndDropUI>g__GeometryChangedCallback|31_0, addr 0x1824bb200, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b7970, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  listView) ;

/// @brief Method get_dragAndDropController, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ICollectionDragAndDropController* get_dragAndDropController() ;

/// @brief Method get_enabled, addr 0x180352b00, size 0x10, virtual false, abstract: false, final false
inline bool get_enabled() ;

/// @brief Method get_targetScrollView, addr 0x1824bb7c0, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ScrollView* get_targetScrollView() ;

/// @brief Method get_targetView, addr 0x1824bb810, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_targetView() ;

/// @brief Method set_dragAndDropController, addr 0x1803f5420, size 0x10, virtual false, abstract: false, final false
inline void set_dragAndDropController(::UnityEngine::UIElements::ICollectionDragAndDropController*  value) ;

/// @brief Method set_enabled, addr 0x1824bb860, size 0x270, virtual false, abstract: false, final false
