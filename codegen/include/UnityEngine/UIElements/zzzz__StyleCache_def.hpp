...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::StyleCache*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleCache*, "UnityEngine.UIElements", "StyleCache");
...
/// @brief Field s_ComputedStyleCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ComputedStyleCache, put=setStaticF_s_ComputedStyleCache)) ::System::Collections::Generic::Dictionary_2<int64_t,::UnityEngine::UIElements::ComputedStyle>*  s_ComputedStyleCache;

/// @brief Field s_ComputedTransitionsCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ComputedTransitionsCache, put=setStaticF_s_ComputedTransitionsCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty>>*  s_ComputedTransitionsCache;

/// @brief Field s_StyleVariableContextCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_StyleVariableContextCache, put=setStaticF_s_StyleVariableContextCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::StyleVariableContext*>*  s_StyleVariableContextCache;

/// @brief Method ClearStyleCache, addr 0x1824114d0, size 0x170, virtual false, abstract: false, final false
static inline void ClearStyleCache() ;

/// @brief Method SetValue, addr 0x182411730, size 0x60, virtual false, abstract: false, final false
static inline void SetValue(int32_t  hash, ::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty>  data) ;

/// @brief Method SetValue, addr 0x1824116d0, size 0x60, virtual false, abstract: false, final false
static inline void SetValue(int32_t  hash, ::UnityEngine::UIElements::StyleVariableContext*  data) ;

/// @brief Method SetValue, addr 0x182411640, size 0x90, virtual false, abstract: false, final false
static inline void SetValue(int64_t  hash, ::by_ref<::UnityEngine::UIElements::ComputedStyle>  data) ;

/// @brief Method TryGetValue, addr 0x1824117f0, size 0x60, virtual false, abstract: false, final false
static inline bool TryGetValue(int32_t  hash, ::by_ref<::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty>>  data) ;

/// @brief Method TryGetValue, addr 0x182411790, size 0x60, virtual false, abstract: false, final false
static inline bool TryGetValue(int32_t  hash, ::by_ref<::UnityEngine::UIElements::StyleVariableContext*>  data) ;

/// @brief Method TryGetValue, addr 0x182411850, size 0x60, virtual false, abstract: false, final false
...
static inline ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty>>* getStaticF_s_ComputedTransitionsCache() ;
...
static inline void setStaticF_s_ComputedTransitionsCache(::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty>>*  value) ;
...
static_assert(sizeof(::UnityEngine::UIElements::StyleCache) == 0x10, "Size mismatch!");
