...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIEventRegistration*);
...
/// @brief Method <.cctor>b__1_0, addr 0x1823fde10, size 0xc0, virtual false, abstract: false, final false
inline void __cctor_b__1_0() ;

/// @brief Method <.cctor>b__1_1, addr 0x1823fded0, size 0xc0, virtual false, abstract: false, final false
inline void __cctor_b__1_1() ;

/// @brief Method <.cctor>b__1_2, addr 0x1823fdf90, size 0x180, virtual false, abstract: false, final false
inline bool __cctor_b__1_2(int32_t  i, ::System::IntPtr  ptr) ;

/// @brief Method <.cctor>b__1_3, addr 0x1823fe110, size 0xc0, virtual false, abstract: false, final false
inline void __cctor_b__1_3() ;

/// @brief Method <.cctor>b__1_4, addr 0x1823fe1d0, size 0x170, virtual false, abstract: false, final false
inline bool __cctor_b__1_4(::System::Exception*  exception) ;

/// @brief Method <.cctor>b__1_5, addr 0x1823fe340, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CleanupRoots, addr 0x182404bd0, size 0xa0, virtual false, abstract: false, final false
static inline void CleanupRoots() ;

/// @brief Method EndContainerGUIFromException, addr 0x182404c70, size 0x150, virtual false, abstract: false, final false
static inline bool EndContainerGUIFromException(::System::Exception*  exception) ;

/// @brief Method MakeCurrentIMGUIContainerDirty, addr 0x182404dc0, size 0xa0, virtual false, abstract: false, final false
static inline void MakeCurrentIMGUIContainerDirty() ;

/// @brief Method ProcessEvent, addr 0x182404e60, size 0x160, virtual false, abstract: false, final false
static inline bool ProcessEvent(int32_t  instanceID, ::System::IntPtr  nativeEventPtr) ;

/// @brief Method RegisterUIElementSystem, addr 0x182404fc0, size 0x50, virtual false, abstract: false, final false
static inline void RegisterUIElementSystem(::UnityEngine::UIElements::IUIElementsUtility*  utility) ;

/// @brief Method ReleaseCapture, addr 0x182405010, size 0xa0, virtual false, abstract: false, final false
static inline void ReleaseCapture() ;

/// @brief Method TakeCapture, addr 0x1824050b0, size 0xa0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UIEventRegistration) == 0x10, "Size mismatch!");
