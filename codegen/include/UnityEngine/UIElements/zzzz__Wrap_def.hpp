...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Wrap, "UnityEngine.UIElements", "Wrap");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::Wrap, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Wrap) == 0x4, "Size mismatch!");
