...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::ScrollerVisibility, "UnityEngine.UIElements", "ScrollerVisibility");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::ScrollerVisibility, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::ScrollerVisibility) == 0x4, "Size mismatch!");
