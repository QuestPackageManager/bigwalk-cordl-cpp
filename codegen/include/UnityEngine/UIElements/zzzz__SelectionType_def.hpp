...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::SelectionType, "UnityEngine.UIElements", "SelectionType");
// Dependencies 
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::UIElements::SelectionType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::SelectionType) == 0x4, "Size mismatch!");
