...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TabDragger*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TabDragger*, "UnityEngine.UIElements", "TabDragger");
...
/// @brief Field m_LocationPreviewElement, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_LocationPreviewElement, put=__cordl_internal_set_m_LocationPreviewElement)) ::UnityEngine::UIElements::TabDragLocationPreview*  m_LocationPreviewElement;
...
/// @brief Method BeginDragMove, addr 0x1824a9fa0, size 0x400, virtual false, abstract: false, final false
inline void BeginDragMove(float_t  pos) ;

/// @brief Method DragMove, addr 0x1824aa3a0, size 0x10, virtual false, abstract: false, final false
inline void DragMove(float_t  pos) ;

/// @brief Method EndDragMove, addr 0x1824aa3b0, size 0x190, virtual false, abstract: false, final false
inline void EndDragMove(bool  cancelled) ;

static inline ::UnityEngine::UIElements::TabDragger* New_ctor() ;

/// @brief Method OnKeyDown, addr 0x1824aa540, size 0x80, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerCancel, addr 0x1824aa5c0, size 0x50, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x1824aa610, size 0x20, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x1824aa630, size 0x80, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x1824aa6b0, size 0x150, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x1824aa800, size 0xb0, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method ProcessCancelEvent, addr 0x1824aa8b0, size 0x90, virtual false, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x1824aa940, size 0x210, virtual false, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x1824aab50, size 0x120, virtual false, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x1824aac70, size 0x90, virtual false, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x1824aad00, size 0x1d0, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x1824aaed0, size 0x1d0, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdateMoveLocation, addr 0x1824ab0a0, size 0x130, virtual false, abstract: false, final false
inline void UpdateMoveLocation() ;

/// @brief Method UpdatePreviewPosition, addr 0x1824ab1d0, size 0x670, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824ab840, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_active, addr 0x1802e56a0, size 0x10, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_isVertical, addr 0x1802e56b0, size 0x10, virtual false, abstract: false, final false
inline bool get_isVertical() ;

/// @brief Method get_moving, addr 0x1803561b0, size 0x10, virtual false, abstract: false, final false
inline bool get_moving() ;

/// @brief Method get_tabLayout, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TabLayout* get_tabLayout() ;

/// @brief Method set_active, addr 0x1813bddf0, size 0x1ac0, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_isVertical, addr 0x1805d4c80, size 0x10, virtual false, abstract: false, final false
inline void set_isVertical(bool  value) ;

/// @brief Method set_moving, addr 0x1824ab8e0, size 0x70, virtual false, abstract: false, final false
inline void set_moving(bool  value) ;

/// @brief Method set_tabLayout, addr 0x1803f5420, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::TabDragger) == 0x88, "Size mismatch!");
