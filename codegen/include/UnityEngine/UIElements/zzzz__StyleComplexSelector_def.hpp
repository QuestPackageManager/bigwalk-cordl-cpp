...
public:
// Declarations
/// @brief Method .ctor, addr 0x180a16bb0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method <CalculateHashes>b__26_0, addr 0x1823e15c0, size 0x20, virtual false, abstract: false, final false
inline bool _CalculateHashes_b__26_0(::UnityEngine::UIElements::StyleSelectorPart  p) ;

/// @brief Method <ToString>b__23_0, addr 0x1823e1620, size 0x20, virtual false, abstract: false, final false
...
/// @brief Field s_PseudoStates, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_PseudoStates, put=setStaticF_s_PseudoStates)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector_PseudoStateData>*  s_PseudoStates;
...
/// @brief Method CachePseudoStateMasks, addr 0x1823d6c30, size 0x460, virtual false, abstract: false, final false
inline void CachePseudoStateMasks(::UnityEngine::UIElements::StyleSheet*  styleSheet) ;

/// @brief Method CalculateHashes, addr 0x1823d7090, size 0x360, virtual false, abstract: false, final false
inline void CalculateHashes() ;

static inline ::UnityEngine::UIElements::StyleComplexSelector* New_ctor() ;

/// @brief Method StyleSelectorPartCompare, addr 0x1823d73f0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x1823d7420, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1823d7590, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_isSimple, addr 0x1823d7610, size 0x20, virtual false, abstract: false, final false
inline bool get_isSimple() ;

/// @brief Method get_rule, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleRule* get_rule() ;

/// @brief Method get_selectors, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::StyleSelector*> get_selectors() ;

/// @brief Method get_specificity, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_rule, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_rule(::UnityEngine::UIElements::StyleRule*  value) ;

/// @brief Method set_selectors, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_selectors(::ArrayW<::UnityEngine::UIElements::StyleSelector*>  value) ;

/// @brief Method set_specificity, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
