...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlAttributeOverridesTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlAttributeOverridesTraits*, "UnityEngine.UIElements", "UxmlAttributeOverridesTraits");
...
/// @brief Method .ctor, addr 0x182408e10, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlAttributeOverridesTraits) == 0x20, "Size mismatch!");
