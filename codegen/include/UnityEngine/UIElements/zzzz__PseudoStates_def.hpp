...
static_assert(offsetof(::UnityEngine::UIElements::PseudoStates, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::PseudoStates) == 0x4, "Size mismatch!");
