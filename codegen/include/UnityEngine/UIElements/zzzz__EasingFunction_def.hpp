...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::EasingFunction_PropertyBag*);
MARK_REF_T(::UnityEngine::UIElements::PropertyBag_EasingFunction_ModeProperty*);
MARK_VAL_T(::UnityEngine::UIElements::EasingFunction);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EasingFunction_PropertyBag*, "UnityEngine.UIElements", "EasingFunction/PropertyBag");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PropertyBag_EasingFunction_ModeProperty*, "UnityEngine.UIElements", "EasingFunction/PropertyBag/ModeProperty");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EasingFunction, "UnityEngine.UIElements", "EasingFunction");
...
/// @brief Method Equals, addr 0x182508aa0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x182508b10, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::EasingFunction) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::UIElements::PropertyBag_EasingFunction_ModeProperty) == 0x28, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x18250ee00, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::EasingFunction_PropertyBag) == 0x28, "Size mismatch!");
