...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlAttributeDescription_Use, "UnityEngine.UIElements", "UxmlAttributeDescription/Use");
...
static_assert(offsetof(::UnityEngine::UIElements::UxmlAttributeDescription_Use, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UxmlAttributeDescription_Use) == 0x4, "Size mismatch!");
...
/// @brief Method TryFindValueInAttributeOverrides, addr 0x182408470, size 0x2a0, virtual false, abstract: false, final false
inline bool TryFindValueInAttributeOverrides(::StringW  elementName, ::UnityEngine::UIElements::CreationContext  cc, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>*  attributeOverrides, ::by_ref<::StringW>  value) ;

/// @brief Method TryGetAttributeOverrideValueFromBagAsString, addr 0x182408710, size 0x3a0, virtual false, abstract: false, final false
...
/// @brief Method TryGetValueFromBagAsString, addr 0x182408cf0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method TryGetValueFromBagAsString, addr 0x182408ab0, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method ValidateName, addr 0x182408d40, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182408d80, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_obsoleteNames, addr 0x182408da0, size 0x50, virtual false, abstract: false, final false
inline void set_obsoleteNames(::System::Collections::Generic::IEnumerable_1<::StringW>*  value) ;

/// @brief Method set_restriction, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void set_restriction(::UnityEngine::UIElements::UxmlTypeRestriction*  value) ;

/// @brief Method set_type, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_type(::StringW  value) ;

/// @brief Method set_typeNamespace, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_typeNamespace(::StringW  value) ;

/// @brief Method set_use, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
