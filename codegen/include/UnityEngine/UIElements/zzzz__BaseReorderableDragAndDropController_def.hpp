...
/// @brief Method CanDrop, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool CanDrop() ;

/// @brief Method CanStartDrag, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool CanStartDrag(::System::Collections::Generic::IEnumerable_1<int32_t>*  itemIds) ;

/// @brief Method CompareId, addr 0x181190bc0, size 0x590, virtual true, abstract: false, final false
inline int32_t CompareId(int32_t  id1, int32_t  id2) ;

/// @brief Method DragCleanup, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void DragCleanup() ;

/// @brief Method GetSortedSelectedIds, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* GetSortedSelectedIds() ;

/// @brief Method HandleAutoExpand, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::UIElements::IListDragAndDropArgs*  args) ;

/// @brief Method SetupDragAndDrop, addr 0x1824b30e0, size 0x3a0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824b3480, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  view) ;

/// @brief Method get_enableReordering, addr 0x1803a7410, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_enableReordering, addr 0x1803a7480, size 0x10, virtual true, abstract: false, final false
