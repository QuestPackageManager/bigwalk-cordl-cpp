...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerEventHelper*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerEventHelper*, "UnityEngine.UIElements", "PointerEventHelper");
...
public:
// Declarations
/// @brief Method GetPooled, addr 0x1824d57a0, size 0x160, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::EventBase* GetPooled(::UnityEngine::EventType  eventType, ::UnityEngine::Vector3  mousePosition, ::UnityEngine::Vector2  delta, int32_t  button, int32_t  clickCount, ::UnityEngine::EventModifiers  modifiers, int32_t  displayIndex) ;
...
static_assert(sizeof(::UnityEngine::UIElements::PointerEventHelper) == 0x10, "Size mismatch!");
