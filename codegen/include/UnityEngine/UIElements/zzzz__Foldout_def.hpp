...
/// @brief Method .ctor, addr 0x18246db10, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x18246ddb0, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18246ffa0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Apply, addr 0x182461320, size 0x100, virtual false, abstract: false, final false
inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op) ;

/// @brief Method Apply, addr 0x182461420, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method OnAttachToPanel, addr 0x182461530, size 0x140, virtual false, abstract: false, final false
inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x182461670, size 0x40, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method SetValueWithoutNotify, addr 0x1824616b0, size 0x110, virtual true, abstract: false, final true
...
/// @brief Method <.ctor>b__39_0, addr 0x1824617c0, size 0x50, virtual false, abstract: false, final false
inline void __ctor_b__39_0(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method .ctor, addr 0x182461d10, size 0x330, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_focusable, addr 0x1803a7410, size 0x10, virtual true, abstract: false, final false
inline bool get_focusable() ;

/// @brief Method get_text, addr 0x182462040, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method get_toggle, addr 0x1823ed5f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Toggle* get_toggle() ;

/// @brief Method get_toggleOnLabelClick, addr 0x182462050, size 0x10, virtual false, abstract: false, final false
inline bool get_toggleOnLabelClick() ;

/// @brief Method get_value, addr 0x182462060, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_focusable, addr 0x182462070, size 0x50, virtual true, abstract: false, final false
inline void set_focusable(bool  value) ;

/// @brief Method set_text, addr 0x1824620c0, size 0x130, virtual false, abstract: false, final false
inline void set_text(::StringW  value) ;

/// @brief Method set_toggleOnLabelClick, addr 0x1824621f0, size 0x70, virtual false, abstract: false, final false
inline void set_toggleOnLabelClick(bool  value) ;

/// @brief Method set_value, addr 0x182462260, size 0x150, virtual true, abstract: false, final true
