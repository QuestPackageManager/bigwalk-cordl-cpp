...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Vector4Field*);
MARK_REF_T(::UnityEngine::UIElements::Vector4Field_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Vector4Field_UxmlTraits*);
MARK_REF_T(::UnityEngine::UIElements::Vector4Field___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector4Field*, "UnityEngine.UIElements", "Vector4Field");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector4Field_UxmlFactory*, "UnityEngine.UIElements", "Vector4Field/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector4Field_UxmlTraits*, "UnityEngine.UIElements", "Vector4Field/UxmlTraits");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Vector4Field___c*, "UnityEngine.UIElements", "Vector4Field/<>c");
...
/// @brief Method .ctor, addr 0x18246da10, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::UIElements::Vector4Field_UxmlFactory) == 0x18, "Size mismatch!");
...
public:
// Declarations
/// @brief Field m_WValue, offset 0xb0, size 0x8 
...
/// @brief Method Init, addr 0x18246db60, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18246fc50, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_ZValue, offset: 0xa8, size: 0x8, def value: None
 ::UnityEngine::UIElements::UxmlFloatAttributeDescription*  ___m_ZValue;

/// @brief Field m_WValue, offset: 0xb0, size: 0x8, def value: None
 ::UnityEngine::UIElements::UxmlFloatAttributeDescription*  ___m_WValue;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Vector4Field_UxmlTraits, ___m_XValue) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Vector4Field_UxmlTraits, ___m_YValue) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Vector4Field_UxmlTraits, ___m_ZValue) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Vector4Field_UxmlTraits, ___m_WValue) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::Vector4Field_UxmlTraits) == 0xb8, "Size mismatch!");
...
/// @brief Field <>9__0_1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_1, put=setStaticF___9__0_1)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_1;
...
/// @brief Field <>9__0_3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_3, put=setStaticF___9__0_3)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_3;
...
/// @brief Field <>9__0_5, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_5, put=setStaticF___9__0_5)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_5;
...
/// @brief Field <>9__0_7, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_7, put=setStaticF___9__0_7)) ::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  __9__0_7;

static inline ::UnityEngine::UIElements::Vector4Field___c* New_ctor() ;

/// @brief Method <DescribeFields>b__0_0, addr 0x180971ff0, size 0x40, virtual false, abstract: false, final false
inline float_t _DescribeFields_b__0_0(::UnityEngine::Vector4  r) ;

/// @brief Method <DescribeFields>b__0_1, addr 0x18230a700, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_1(::by_ref<::UnityEngine::Vector4>  r, float_t  v) ;

/// @brief Method <DescribeFields>b__0_2, addr 0x182304dc0, size 0x10, virtual false, abstract: false, final false
inline float_t _DescribeFields_b__0_2(::UnityEngine::Vector4  r) ;

/// @brief Method <DescribeFields>b__0_3, addr 0x182304dd0, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_3(::by_ref<::UnityEngine::Vector4>  r, float_t  v) ;

/// @brief Method <DescribeFields>b__0_4, addr 0x182303e50, size 0x10, virtual false, abstract: false, final false
inline float_t _DescribeFields_b__0_4(::UnityEngine::Vector4  r) ;

/// @brief Method <DescribeFields>b__0_5, addr 0x182303e60, size 0x10, virtual false, abstract: false, final false
inline void _DescribeFields_b__0_5(::by_ref<::UnityEngine::Vector4>  r, float_t  v) ;

/// @brief Method <DescribeFields>b__0_6, addr 0x182303c50, size 0x10, virtual false, abstract: false, final false
inline float_t _DescribeFields_b__0_6(::UnityEngine::Vector4  r) ;

/// @brief Method <DescribeFields>b__0_7, addr 0x182303c60, size 0x10, virtual false, abstract: false, final false
...
static inline void setStaticF___9__0_1(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  value) ;

static inline void setStaticF___9__0_2(::System::Func_2<::UnityEngine::Vector4,float_t>*  value) ;

static inline void setStaticF___9__0_3(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  value) ;

static inline void setStaticF___9__0_4(::System::Func_2<::UnityEngine::Vector4,float_t>*  value) ;

static inline void setStaticF___9__0_5(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  value) ;

static inline void setStaticF___9__0_6(::System::Func_2<::UnityEngine::Vector4,float_t>*  value) ;

static inline void setStaticF___9__0_7(::UnityEngine::UIElements::FieldDescription_BaseCompositeField_3_WriteDelegate<::UnityEngine::Vector4,::UnityEngine::UIElements::FloatField*,float_t>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::Vector4Field___c) == 0x10, "Size mismatch!");
...
/// @brief Method DescribeFields, addr 0x182471fe0, size 0x530, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1824725f0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182472690, size 0xe0, virtual false, abstract: false, final false
