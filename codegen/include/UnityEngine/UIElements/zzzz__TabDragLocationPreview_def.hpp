...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::TabDragLocationPreview*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TabDragLocationPreview*, "UnityEngine.UIElements", "TabDragLocationPreview");
...
/// @brief Method .ctor, addr 0x1824a9df0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_preview, addr 0x180e4a190, size 0xd960, virtual false, abstract: false, final false
