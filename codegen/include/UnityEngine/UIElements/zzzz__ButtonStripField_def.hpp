...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ButtonStripField*);
MARK_REF_T(::UnityEngine::UIElements::ButtonStripField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::ButtonStripField_UxmlTraits*);
...
/// @brief Method .ctor, addr 0x18246da70, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x1824709a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::ButtonStripField_UxmlTraits) == 0x98, "Size mismatch!");
...
/// @brief Method RefreshButtonsState, addr 0x18245da20, size 0x90, virtual false, abstract: false, final false
inline void RefreshButtonsState() ;

/// @brief Method SetValueWithoutNotify, addr 0x18245dab0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18245db70, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
