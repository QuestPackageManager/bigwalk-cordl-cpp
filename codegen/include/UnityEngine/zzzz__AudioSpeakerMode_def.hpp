...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioSpeakerMode, "UnityEngine", "AudioSpeakerMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AudioSpeakerMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AudioSpeakerMode) == 0x4, "Size mismatch!");
