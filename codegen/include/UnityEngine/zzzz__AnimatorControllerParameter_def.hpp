...
/// @brief Field m_Type, offset 0x18, size 0x4 
 ...
 __declspec(property(get=get_nameHash)) int32_t  nameHash;

 __declspec(property(get=get_type)) ::UnityEngine::AnimatorControllerParameterType  type;

/// @brief Method Equals, addr 0x182231d70, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method get_nameHash, addr 0x182231e10, size 0xb0, virtual false, abstract: false, final false
inline int32_t get_nameHash() ;

/// @brief Method get_type, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::AnimatorControllerParameterType get_type() ;
...
static_assert(sizeof(::UnityEngine::AnimatorControllerParameter) == 0x28, "Size mismatch!");
