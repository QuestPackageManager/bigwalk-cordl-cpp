...
DEFINE_IL2CPP_CLASS(::UnityEngine::QueryTriggerInteraction, "UnityEngine", "QueryTriggerInteraction");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::QueryTriggerInteraction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::QueryTriggerInteraction) == 0x4, "Size mismatch!");
