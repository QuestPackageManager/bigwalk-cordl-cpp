...
DEFINE_IL2CPP_CLASS(::UnityEngine::RangeInt, "UnityEngine", "RangeInt");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
/// @brief Method get_end, addr 0x1820af4a0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::RangeInt) == 0x8, "Size mismatch!");
