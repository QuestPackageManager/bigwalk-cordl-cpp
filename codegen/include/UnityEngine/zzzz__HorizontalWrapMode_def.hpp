...
DEFINE_IL2CPP_CLASS(::UnityEngine::HorizontalWrapMode, "UnityEngine", "HorizontalWrapMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::HorizontalWrapMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::HorizontalWrapMode) == 0x4, "Size mismatch!");
