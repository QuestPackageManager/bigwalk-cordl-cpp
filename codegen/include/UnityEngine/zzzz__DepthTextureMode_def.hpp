...
DEFINE_IL2CPP_CLASS(::UnityEngine::DepthTextureMode, "UnityEngine", "DepthTextureMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::DepthTextureMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::DepthTextureMode) == 0x4, "Size mismatch!");
