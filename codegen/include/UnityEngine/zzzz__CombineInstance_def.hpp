...
DEFINE_IL2CPP_CLASS(::UnityEngine::CombineInstance, "UnityEngine", "CombineInstance");
...
// Declarations
 ...
 __declspec(property(put=set_realtimeLightmapScaleOffset)) ::UnityEngine::Vector4  realtimeLightmapScaleOffset;

 __declspec(property(put=set_transform)) ::UnityEngine::Matrix4x4  transform;

/// @brief Method set_lightmapScaleOffset, addr 0x1817eed60, size 0x10, virtual false, abstract: false, final false
inline void set_lightmapScaleOffset(::UnityEngine::Vector4  value) ;

/// @brief Method set_mesh, addr 0x18224d020, size 0x80, virtual false, abstract: false, final false
inline void set_mesh(::UnityEngine::Mesh*  value) ;

/// @brief Method set_realtimeLightmapScaleOffset, addr 0x181a73fe0, size 0x10, virtual false, abstract: false, final false
inline void set_realtimeLightmapScaleOffset(::UnityEngine::Vector4  value) ;

/// @brief Method set_transform, addr 0x18224d0a0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::CombineInstance) == 0x68, "Size mismatch!");
