...
/// @brief Method Equals, addr 0x180645ca0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method Equals, addr 0x180645c90, size 0x10, virtual false, abstract: false, final false
inline bool Equals(::by_ref<::UnityEngine::Color32>  other) ;

/// @brief Method GetHashCode, addr 0x1805a8300, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x182261d90, size 0x20, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x180c4d500, size 0x310, virtual true, abstract: false, final true
...
/// @brief Method op_Implicit, addr 0x182261db0, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Color op_Implicit___UnityEngine__Color(::UnityEngine::Color32  c) ;

/// @brief Method op_Implicit, addr 0x181417f30, size 0xf0, virtual false, abstract: false, final false
