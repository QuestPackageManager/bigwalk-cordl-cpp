...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioConfiguration, "UnityEngine", "AudioConfiguration");
...
static_assert(sizeof(::UnityEngine::AudioConfiguration) == 0x14, "Size mismatch!");
