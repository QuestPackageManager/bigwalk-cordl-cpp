...
static_assert(offsetof(::UnityEngine::RenderTextureCreationFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RenderTextureCreationFlags) == 0x4, "Size mismatch!");
