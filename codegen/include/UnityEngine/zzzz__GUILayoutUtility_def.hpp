...
/// @brief Method ResetCursor, addr 0x1822d1fe0, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822d21e0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Begin, addr 0x1822bfcf0, size 0x1c0, virtual false, abstract: false, final false
static inline void Begin(int32_t  instanceID) ;

/// @brief Method BeginContainer, addr 0x1822bf490, size 0x160, virtual false, abstract: false, final false
static inline void BeginContainer(::UnityEngine::GUILayoutUtility_LayoutCache*  cache) ;

/// @brief Method BeginLayoutArea, addr 0x1822bf5f0, size 0x240, virtual false, abstract: false, final false
static inline ::UnityEngine::GUILayoutGroup* BeginLayoutArea(::UnityEngine::GUIStyle*  style, ::System::Type*  layoutType) ;

/// @brief Method BeginLayoutGroup, addr 0x1822bf830, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method BeginWindow, addr 0x1822bfaa0, size 0x250, virtual false, abstract: false, final false
static inline void BeginWindow(int32_t  windowID, ::UnityEngine::GUIStyle*  style, ::ArrayW<::UnityEngine::GUILayoutOption*>  options) ;

/// @brief Method CreateGUILayoutGroupInstanceOfType, addr 0x1822bfeb0, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::GUILayoutGroup* CreateGUILayoutGroupInstanceOfType(::System::Type*  LayoutType) ;

/// @brief Method DoGetRect, addr 0x1822c0120, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method DoGetRect, addr 0x1822bff50, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method EndLayoutArea, addr 0x1822c0510, size 0x150, virtual false, abstract: false, final false
static inline void EndLayoutArea() ;

/// @brief Method EndLayoutGroup, addr 0x1822c0660, size 0x210, virtual false, abstract: false, final false
static inline void EndLayoutGroup() ;

/// @brief Method GetLastRect, addr 0x1822c0870, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect GetLastRect() ;

/// @brief Method GetLayoutCache, addr 0x1822c0940, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::GUILayoutUtility_LayoutCache* GetLayoutCache(int32_t  instanceID, bool  isWindow) ;

/// @brief Method GetRect, addr 0x1822c0b80, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetRect, addr 0x1822c09d0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method Internal_GetWindowRect, addr 0x1822c0bb0, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect Internal_GetWindowRect(int32_t  windowID) ;

/// @brief Method Internal_GetWindowRect_Injected, addr 0x1822c0ba0, size 0x10, virtual false, abstract: false, final false
static inline void Internal_GetWindowRect_Injected(int32_t  windowID, ::by_ref<::UnityEngine::Rect>  ret) ;

/// @brief Method Internal_MoveWindow, addr 0x1822c0bf0, size 0x10, virtual false, abstract: false, final false
static inline void Internal_MoveWindow(int32_t  windowID, ::UnityEngine::Rect  r) ;

/// @brief Method Internal_MoveWindow_Injected, addr 0x1822c0be0, size 0x10, virtual false, abstract: false, final false
static inline void Internal_MoveWindow_Injected(int32_t  windowID, ::by_ref<::UnityEngine::Rect>  r) ;

/// @brief Method Layout, addr 0x1822c1100, size 0x1a0, virtual false, abstract: false, final false
static inline void Layout() ;

/// @brief Method LayoutFreeGroup, addr 0x1822c0c00, size 0xe0, virtual false, abstract: false, final false
static inline void LayoutFreeGroup(::UnityEngine::GUILayoutGroup*  toplevel) ;

/// @brief Method LayoutFromContainer, addr 0x1822c0ce0, size 0x130, virtual false, abstract: false, final false
static inline void LayoutFromContainer(float_t  w, float_t  h) ;

/// @brief Method LayoutFromEditorWindow, addr 0x1822c0e10, size 0x160, virtual false, abstract: false, final false
static inline void LayoutFromEditorWindow() ;

/// @brief Method LayoutSingleGroup, addr 0x1822c0f70, size 0x190, virtual false, abstract: false, final false
static inline void LayoutSingleGroup(::UnityEngine::GUILayoutGroup*  i) ;

/// @brief Method RemoveSelectedIdList, addr 0x1822c12a0, size 0x90, virtual false, abstract: false, final false
static inline void RemoveSelectedIdList(int32_t  instanceID, bool  isWindow) ;

/// @brief Method SelectIDList, addr 0x1822c1330, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method get_spaceStyle, addr 0x1822c15c0, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityEngine::GUIStyle* get_spaceStyle() ;

/// @brief Method get_unbalancedgroupscount, addr 0x1822c1690, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_unbalancedgroupscount, addr 0x1822c16d0, size 0x50, virtual false, abstract: false, final false
