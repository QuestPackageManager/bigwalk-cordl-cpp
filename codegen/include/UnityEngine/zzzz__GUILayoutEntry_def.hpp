...
/// @brief Method ApplyOptions, addr 0x1822d24d0, size 0x350, virtual true, abstract: false, final false
inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*>  options) ;

/// @brief Method ApplyStyleSettings, addr 0x1822d2820, size 0xa0, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::UnityEngine::GUIStyle*  style) ;

/// @brief Method CalcHeight, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
static inline ::UnityEngine::GUILayoutEntry* New_ctor(float_t  _minWidth, float_t  _maxWidth, float_t  _minHeight, float_t  _maxHeight, ::UnityEngine::GUIStyle*  _style, ::ArrayW<::UnityEngine::GUILayoutOption*>  options) ;

/// @brief Method SetHorizontal, addr 0x1822d28c0, size 0x10, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x1822d28d0, size 0x10, virtual true, abstract: false, final false
inline void SetVertical(float_t  y, float_t  height) ;

/// @brief Method ToString, addr 0x1822d28e0, size 0x2e0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822d2c00, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(float_t  _minWidth, float_t  _maxWidth, float_t  _minHeight, float_t  _maxHeight, ::UnityEngine::GUIStyle*  _style) ;

/// @brief Method .ctor, addr 0x1822d2cd0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_marginBottom, addr 0x1822d2db0, size 0x20, virtual true, abstract: false, final false
inline int32_t get_marginBottom() ;

/// @brief Method get_marginHorizontal, addr 0x1822d2dd0, size 0x50, virtual false, abstract: false, final false
inline int32_t get_marginHorizontal() ;

/// @brief Method get_marginLeft, addr 0x1822d2e20, size 0x20, virtual true, abstract: false, final false
inline int32_t get_marginLeft() ;

/// @brief Method get_marginRight, addr 0x1822d2e40, size 0x20, virtual true, abstract: false, final false
inline int32_t get_marginRight() ;

/// @brief Method get_marginTop, addr 0x1822d2e60, size 0x20, virtual true, abstract: false, final false
inline int32_t get_marginTop() ;

/// @brief Method get_marginVertical, addr 0x1822d2e80, size 0x50, virtual false, abstract: false, final false
inline int32_t get_marginVertical() ;

/// @brief Method get_style, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_style, addr 0x1822d2ed0, size 0x50, virtual false, abstract: false, final false
