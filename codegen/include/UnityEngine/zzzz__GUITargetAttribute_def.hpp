...
// Write type traits
MARK_REF_T(::UnityEngine::GUITargetAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::GUITargetAttribute*, "UnityEngine", "GUITargetAttribute");
...
/// @brief Method GetGUITargetAttrValue, addr 0x1822c8a50, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::GUITargetAttribute) == 0x18, "Size mismatch!");
