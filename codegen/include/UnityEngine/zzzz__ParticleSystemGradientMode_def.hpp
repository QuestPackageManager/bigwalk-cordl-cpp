...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemGradientMode, "UnityEngine", "ParticleSystemGradientMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ParticleSystemGradientMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ParticleSystemGradientMode) == 0x4, "Size mismatch!");
