...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextGenerationError, "UnityEngine", "TextGenerationError");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextGenerationError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextGenerationError) == 0x4, "Size mismatch!");
