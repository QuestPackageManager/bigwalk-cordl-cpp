...
// Write type traits
MARK_REF_T(::UnityEngine::PreferBinarySerialization*);
DEFINE_IL2CPP_CLASS(::UnityEngine::PreferBinarySerialization*, "UnityEngine", "PreferBinarySerialization");
...
static_assert(sizeof(::UnityEngine::PreferBinarySerialization) == 0x10, "Size mismatch!");
