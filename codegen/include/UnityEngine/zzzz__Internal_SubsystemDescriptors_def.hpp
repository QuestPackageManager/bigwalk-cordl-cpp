...
// Write type traits
MARK_REF_T(::UnityEngine::Internal_SubsystemDescriptors*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Internal_SubsystemDescriptors*, "UnityEngine", "Internal_SubsystemDescriptors");
...
public:
// Declarations
/// @brief Method Internal_AddDescriptor, addr 0x18230d9f0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Internal_SubsystemDescriptors) == 0x10, "Size mismatch!");
