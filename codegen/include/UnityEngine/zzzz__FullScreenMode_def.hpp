...
DEFINE_IL2CPP_CLASS(::UnityEngine::FullScreenMode, "UnityEngine", "FullScreenMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::FullScreenMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::FullScreenMode) == 0x4, "Size mismatch!");
