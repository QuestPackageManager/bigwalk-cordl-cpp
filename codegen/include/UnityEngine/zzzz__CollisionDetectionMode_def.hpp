...
DEFINE_IL2CPP_CLASS(::UnityEngine::CollisionDetectionMode, "UnityEngine", "CollisionDetectionMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CollisionDetectionMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CollisionDetectionMode) == 0x4, "Size mismatch!");
