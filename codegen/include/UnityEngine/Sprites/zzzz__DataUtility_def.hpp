...
public:
// Declarations
/// @brief Method GetInnerUV, addr 0x1822a8030, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetInnerUV(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetMinSize, addr 0x1822a8050, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetMinSize(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetOuterUV, addr 0x1822a80d0, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetOuterUV(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetPadding, addr 0x1822a80f0, size 0x20, virtual false, abstract: false, final false
