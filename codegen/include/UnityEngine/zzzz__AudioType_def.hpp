...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioType, "UnityEngine", "AudioType");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::AudioType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AudioType) == 0x4, "Size mismatch!");
