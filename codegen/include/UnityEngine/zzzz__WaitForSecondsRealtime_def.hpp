...
// Write type traits
MARK_REF_T(::UnityEngine::WaitForSecondsRealtime*);
DEFINE_IL2CPP_CLASS(::UnityEngine::WaitForSecondsRealtime*, "UnityEngine", "WaitForSecondsRealtime");
...
/// @brief Method Reset, addr 0x18228d6c0, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x18228d6d0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  time) ;

/// @brief Method get_keepWaiting, addr 0x18228d6e0, size 0x90, virtual true, abstract: false, final false
inline bool get_keepWaiting() ;

/// @brief Method get_waitTime, addr 0x180346a80, size 0x10, virtual false, abstract: false, final false
inline float_t get_waitTime() ;

/// @brief Method set_waitTime, addr 0x180346aa0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::WaitForSecondsRealtime) == 0x18, "Size mismatch!");
