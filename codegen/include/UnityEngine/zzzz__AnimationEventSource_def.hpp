...
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimationEventSource, "UnityEngine", "AnimationEventSource");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
/// @brief Field Animator value: I32(2)
...
/// @brief Field NoSource value: I32(0)
...
static_assert(offsetof(::UnityEngine::AnimationEventSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::AnimationEventSource) == 0x4, "Size mismatch!");
