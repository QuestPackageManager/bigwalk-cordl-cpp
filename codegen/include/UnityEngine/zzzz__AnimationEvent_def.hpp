...
public:
// Declarations
 __declspec(property(get=get_functionName)) ::StringW  functionName;
...
/// @brief Method .ctor, addr 0x18222ff10, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_functionName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_functionName() ;

/// @brief Method get_time, addr 0x180346a80, size 0x10, virtual false, abstract: false, final false
