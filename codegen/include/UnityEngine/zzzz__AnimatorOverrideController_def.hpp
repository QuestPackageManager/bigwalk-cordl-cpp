...
// Write type traits
MARK_REF_T(::UnityEngine::AnimatorOverrideController*);
MARK_REF_T(::UnityEngine::AnimatorOverrideController_OnOverrideControllerDirtyCallback*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimatorOverrideController*, "UnityEngine", "AnimatorOverrideController");
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimatorOverrideController_OnOverrideControllerDirtyCallback*, "UnityEngine", "AnimatorOverrideController/OnOverrideControllerDirtyCallback");
...
/// @brief Method OnInvalidateOverrideController, addr 0x182233ef0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AnimatorOverrideController) == 0x20, "Size mismatch!");
