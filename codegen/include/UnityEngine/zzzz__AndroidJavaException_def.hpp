...
// Write type traits
MARK_REF_T(::UnityEngine::AndroidJavaException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AndroidJavaException*, "UnityEngine", "AndroidJavaException");
...
/// @brief Method .ctor, addr 0x182229850, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  javaStackTrace) ;

/// @brief Method get_StackTrace, addr 0x182229890, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AndroidJavaException) == 0x98, "Size mismatch!");
