...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReflectionProbeMode, "UnityEngine.Rendering", "ReflectionProbeMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ReflectionProbeMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ReflectionProbeMode) == 0x4, "Size mismatch!");
