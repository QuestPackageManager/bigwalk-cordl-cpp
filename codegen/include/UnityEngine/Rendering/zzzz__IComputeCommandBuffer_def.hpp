...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IComputeCommandBuffer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IComputeCommandBuffer*, "UnityEngine.Rendering", "IComputeCommandBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Method SetComputeParamsFromMaterial, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
...
/// @brief Method SetRayTracingShaderPass, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
