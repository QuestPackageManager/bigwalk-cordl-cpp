...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::VolumeParameter_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::VolumeParameter_1, "UnityEngine.Rendering", "VolumeParameter`1");
