...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::CameraSwitcher*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CameraSwitcher*, "UnityEngine.Rendering", "CameraSwitcher");
// Dependencies UnityEngine.Camera, UnityEngine.GUIContent, UnityEngine.MonoBehaviour, UnityEngine.Quaternion, UnityEngine.Vector3
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field m_CameraIndices, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CameraIndices, put=__cordl_internal_set_m_CameraIndices)) ::ArrayW<int32_t>  m_CameraIndices;

/// @brief Field m_CameraNames, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CameraNames, put=__cordl_internal_set_m_CameraNames)) ::ArrayW<::UnityEngine::GUIContent*>  m_CameraNames;
...
/// @brief Method GetCameraCount, addr 0x181fd43d0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetCameraCount() ;

/// @brief Method GetNextCamera, addr 0x181fd43e0, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> GetNextCamera() ;

static inline ::UnityEngine::Rendering::CameraSwitcher* New_ctor() ;

/// @brief Method OnDisable, addr 0x181fd4400, size 0x70, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x181fd4470, size 0x380, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetCameraIndex, addr 0x181fd47f0, size 0x1b0, virtual false, abstract: false, final false
inline void SetCameraIndex(int32_t  index) ;

/// @brief Method <OnEnable>b__10_0, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline int32_t _OnEnable_b__10_0() ;

/// @brief Method <OnEnable>b__10_1, addr 0x181fd47f0, size 0x1b0, virtual false, abstract: false, final false
inline void _OnEnable_b__10_1(int32_t  value) ;

/// @brief Method <OnEnable>b__10_2, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline int32_t _OnEnable_b__10_2() ;

/// @brief Method <OnEnable>b__10_3, addr 0x180511560, size 0x10, virtual false, abstract: false, final false
inline void _OnEnable_b__10_3(int32_t  value) ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_CameraIndices() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_CameraIndices() ;

constexpr ::ArrayW<::UnityEngine::GUIContent*> const& __cordl_internal_get_m_CameraNames() const;

constexpr ::ArrayW<::UnityEngine::GUIContent*>& __cordl_internal_get_m_CameraNames() ;
...
constexpr void __cordl_internal_set_m_CameraIndices(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_CameraNames(::ArrayW<::UnityEngine::GUIContent*>  value) ;
...
/// @brief Method .ctor, addr 0x181fd49a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_CameraNames, offset: 0x60, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::GUIContent*>  ___m_CameraNames;

/// @brief Field m_CameraIndices, offset: 0x68, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___m_CameraIndices;
...
static_assert(sizeof(::UnityEngine::Rendering::CameraSwitcher) == 0x80, "Size mismatch!");
