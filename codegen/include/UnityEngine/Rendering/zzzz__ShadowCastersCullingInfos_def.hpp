...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShadowCastersCullingInfos, "UnityEngine.Rendering", "ShadowCastersCullingInfos");
...
static_assert(sizeof(::UnityEngine::Rendering::ShadowCastersCullingInfos) == 0x20, "Size mismatch!");
