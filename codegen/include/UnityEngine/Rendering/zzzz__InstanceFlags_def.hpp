...
static_assert(offsetof(::UnityEngine::Rendering::InstanceFlags, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::InstanceFlags) == 0x1, "Size mismatch!");
