...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FieldPacking, "UnityEngine.Rendering", "FieldPacking");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::FieldPacking, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::FieldPacking) == 0x4, "Size mismatch!");
