...
/// @brief Method Equals, addr 0x1822b6d80, size 0xe0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822b6e60, size 0x260, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::VisibleReflectionProbe  other) ;

/// @brief Method GetHashCode, addr 0x1822b70c0, size 0x1b0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_blendDistance, addr 0x180474bc0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_hdrData, addr 0x181454250, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_hdrData() ;

/// @brief Method get_importance, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_importance() ;

/// @brief Method get_isBoxProjection, addr 0x1822b7270, size 0x20, virtual false, abstract: false, final false
inline bool get_isBoxProjection() ;

/// @brief Method get_localToWorldMatrix, addr 0x1812aeee0, size 0x13a0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_reflectionProbe, addr 0x1822b7290, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ReflectionProbe> get_reflectionProbe() ;

/// @brief Method get_texture, addr 0x1822b72e0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::VisibleReflectionProbe) == 0x88, "Size mismatch!");
