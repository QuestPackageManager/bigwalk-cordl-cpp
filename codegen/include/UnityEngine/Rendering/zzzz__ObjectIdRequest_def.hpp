...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ObjectIdRequest*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ObjectIdRequest*, "UnityEngine.Rendering", "ObjectIdRequest");
...
/// @brief Field <destination>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__destination_k__BackingField, put=__cordl_internal_set__destination_k__BackingField)) ::UnityW<::UnityEngine::RenderTexture>  _destination_k__BackingField;
...
/// @brief Method get_destination, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ObjectIdRequest) == 0x18, "Size mismatch!");
