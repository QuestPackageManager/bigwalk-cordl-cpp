...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalDrawCallChunk*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalDrawCallChunk*, "UnityEngine.Rendering.Universal", "DecalDrawCallChunk");
...
/// @brief Method Dispose, addr 0x1820cf750, size 0x60, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalDrawCallChunk* New_ctor() ;

/// @brief Method RemoveAtSwapBack, addr 0x1820cf7b0, size 0x90, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x1820cf840, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method get_subCallCount, addr 0x1820cf8a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_subCallCount() ;

/// @brief Method set_subCallCount, addr 0x1820cf8b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalDrawCallChunk) == 0x78, "Size mismatch!");
