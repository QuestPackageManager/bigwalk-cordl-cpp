...
/// @brief Method CalculateJitter, addr 0x18212b950, size 0x50, virtual false, abstract: false, final false
static inline void CalculateJitter(int32_t  frameIndex, ::by_ref<::UnityEngine::Vector2>  jitter, ::by_ref<bool>  allowScaling) ;

/// @brief Method Execute, addr 0x18212b9a0, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method PopulateStpConfig, addr 0x18212bbe0, size 0x700, virtual false, abstract: false, final false
