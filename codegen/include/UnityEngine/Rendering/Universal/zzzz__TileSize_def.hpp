...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::TileSize, "UnityEngine.Rendering.Universal", "TileSize");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::TileSize, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::TileSize) == 0x4, "Size mismatch!");
