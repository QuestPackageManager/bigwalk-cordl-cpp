...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugLightingFeatureFlags, "UnityEngine.Rendering.Universal", "DebugLightingFeatureFlags");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugLightingFeatureFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugLightingFeatureFlags) == 0x4, "Size mismatch!");
