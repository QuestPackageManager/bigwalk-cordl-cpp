...
// Dependencies Unity.Collections.NativeArray`1<T>, UnityEngine.Jobs.TransformAccessArray, UnityEngine.Rendering.Universal.DecalChunk, UnityEngine.Rendering.Universal.DecalEntity, UnityEngine.Rendering.Universal.DecalProjector
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Method Dispose, addr 0x1820d0de0, size 0x50, virtual true, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method RemoveAtSwapBack, addr 0x1820d0e30, size 0x60, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x1820d0e90, size 0xe0, virtual true, abstract: false, final false
