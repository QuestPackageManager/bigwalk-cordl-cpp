...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DBufferSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DBufferSettings*, "UnityEngine.Rendering.Universal", "DBufferSettings");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DBufferSettings) == 0x18, "Size mismatch!");
