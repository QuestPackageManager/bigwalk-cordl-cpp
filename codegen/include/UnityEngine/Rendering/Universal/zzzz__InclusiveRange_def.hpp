...
/// @brief Method Clamp, addr 0x182125f60, size 0x30, virtual false, abstract: false, final false
inline void Clamp(int16_t  min, int16_t  max) ;

/// @brief Method Contains, addr 0x182125f90, size 0x20, virtual false, abstract: false, final false
inline bool Contains(int16_t  index) ;

/// @brief Method Expand, addr 0x182125fb0, size 0x30, virtual false, abstract: false, final false
inline void Expand(int16_t  index) ;

/// @brief Method Merge, addr 0x182125fe0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x182126010, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method get_empty, addr 0x182126080, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::Universal::InclusiveRange get_empty() ;

/// @brief Method get_isEmpty, addr 0x182126090, size 0x20, virtual false, abstract: false, final false
