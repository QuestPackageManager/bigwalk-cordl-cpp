...
static_assert(offsetof(::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData_Version, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method <UpdateCameraStack>b__50_0, addr 0x18143d030, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetOrCreateVolumeStack, addr 0x182135090, size 0x1b0, virtual false, abstract: false, final false
inline void GetOrCreateVolumeStack() ;

/// @brief Method GetRawRenderer, addr 0x182135240, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x182135300, size 0x1c0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDrawGizmos, addr 0x1821354c0, size 0x100, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method OnValidate, addr 0x1821355c0, size 0x50, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetRenderer, addr 0x180393000, size 0x10, virtual false, abstract: false, final false
inline void SetRenderer(int32_t  index) ;

/// @brief Method Start, addr 0x182135610, size 0x60, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x182135670, size 0x40, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x1821356b0, size 0x20, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method UpdateCameraStack, addr 0x1821356d0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182135880, size 0x1b0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_allowHDROutput, addr 0x1802e09d0, size 0x10, virtual false, abstract: false, final false
inline bool get_allowHDROutput() ;

/// @brief Method get_allowXRRendering, addr 0x182135a30, size 0x10, virtual false, abstract: false, final false
inline bool get_allowXRRendering() ;

/// @brief Method get_antialiasing, addr 0x1803d7410, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::AntialiasingMode get_antialiasing() ;

/// @brief Method get_antialiasingQuality, addr 0x180497940, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::AntialiasingQuality get_antialiasingQuality() ;

/// @brief Method get_camera, addr 0x182135b30, size 0x50, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_camera() ;

/// @brief Method get_cameraStack, addr 0x182135a40, size 0xf0, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Camera>>* get_cameraStack() ;

/// @brief Method get_clearDepth, addr 0x181acf320, size 0x10, virtual false, abstract: false, final false
inline bool get_clearDepth() ;

/// @brief Method get_defaultAdditionalCameraData, addr 0x182135b80, size 0x230, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData> get_defaultAdditionalCameraData() ;

/// @brief Method get_dithering, addr 0x18165d5a0, size 0x10, virtual false, abstract: false, final false
inline bool get_dithering() ;

/// @brief Method get_history, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ICameraHistoryReadAccess* get_history() ;

/// @brief Method get_historyManager, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::UniversalCameraHistory* get_historyManager() ;

/// @brief Method get_motionVectorsPersistentData, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::MotionVectorsPersistentData* get_motionVectorsPersistentData() ;

/// @brief Method get_renderPostProcessing, addr 0x1804a5a20, size 0x10, virtual false, abstract: false, final false
inline bool get_renderPostProcessing() ;

/// @brief Method get_renderShadows, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_renderShadows() ;

/// @brief Method get_renderType, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraRenderType get_renderType() ;

/// @brief Method get_requiresColorOption, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraOverrideOption get_requiresColorOption() ;

/// @brief Method get_requiresColorTexture, addr 0x182135db0, size 0x30, virtual false, abstract: false, final false
inline bool get_requiresColorTexture() ;

/// @brief Method get_requiresDepthOption, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraOverrideOption get_requiresDepthOption() ;

/// @brief Method get_requiresDepthTexture, addr 0x182135de0, size 0x30, virtual false, abstract: false, final false
inline bool get_requiresDepthTexture() ;

/// @brief Method get_requiresVolumeFrameworkUpdate, addr 0x182135e10, size 0x30, virtual false, abstract: false, final false
inline bool get_requiresVolumeFrameworkUpdate() ;

/// @brief Method get_resetHistory, addr 0x181e43050, size 0x10, virtual false, abstract: false, final false
inline bool get_resetHistory() ;

/// @brief Method get_screenCoordScaleBias, addr 0x1817f1380, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_screenCoordScaleBias() ;

/// @brief Method get_screenSizeOverride, addr 0x181788310, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_screenSizeOverride() ;

/// @brief Method get_scriptableRenderer, addr 0x182135e40, size 0x1d0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::ScriptableRenderer* get_scriptableRenderer() ;

/// @brief Method get_stopNaN, addr 0x1803151e0, size 0x10, virtual false, abstract: false, final false
inline bool get_stopNaN() ;

/// @brief Method get_taaSettings, addr 0x182136010, size 0x10, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::Universal::TemporalAA_Settings> get_taaSettings() ;

/// @brief Method get_useScreenCoordOverride, addr 0x1802e09e0, size 0x10, virtual false, abstract: false, final false
inline bool get_useScreenCoordOverride() ;

/// @brief Method get_version, addr 0x182136020, size 0x10, virtual false, abstract: false, final false
inline float_t get_version() ;

/// @brief Method get_volumeFrameworkUpdateMode, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::VolumeFrameworkUpdateMode get_volumeFrameworkUpdateMode() ;

/// @brief Method get_volumeLayerMask, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_volumeLayerMask() ;

/// @brief Method get_volumeStack, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VolumeStack* get_volumeStack() ;

/// @brief Method get_volumeTrigger, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_allowHDROutput, addr 0x18051e980, size 0x10, virtual false, abstract: false, final false
inline void set_allowHDROutput(bool  value) ;

/// @brief Method set_allowXRRendering, addr 0x182136030, size 0x10, virtual false, abstract: false, final false
inline void set_allowXRRendering(bool  value) ;

/// @brief Method set_antialiasing, addr 0x1803d75f0, size 0x10, virtual false, abstract: false, final false
inline void set_antialiasing(::UnityEngine::Rendering::Universal::AntialiasingMode  value) ;

/// @brief Method set_antialiasingQuality, addr 0x180497a90, size 0x10, virtual false, abstract: false, final false
inline void set_antialiasingQuality(::UnityEngine::Rendering::Universal::AntialiasingQuality  value) ;

/// @brief Method set_dithering, addr 0x1817eed40, size 0x10, virtual false, abstract: false, final false
inline void set_dithering(bool  value) ;

/// @brief Method set_renderPostProcessing, addr 0x1804a5a50, size 0x10, virtual false, abstract: false, final false
inline void set_renderPostProcessing(bool  value) ;

/// @brief Method set_renderShadows, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_renderShadows(bool  value) ;

/// @brief Method set_renderType, addr 0x1803914d0, size 0x10, virtual false, abstract: false, final false
inline void set_renderType(::UnityEngine::Rendering::Universal::CameraRenderType  value) ;

/// @brief Method set_requiresColorOption, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
inline void set_requiresColorOption(::UnityEngine::Rendering::Universal::CameraOverrideOption  value) ;

/// @brief Method set_requiresColorTexture, addr 0x182136040, size 0x10, virtual false, abstract: false, final false
inline void set_requiresColorTexture(bool  value) ;

/// @brief Method set_requiresDepthOption, addr 0x180396f00, size 0x10, virtual false, abstract: false, final false
inline void set_requiresDepthOption(::UnityEngine::Rendering::Universal::CameraOverrideOption  value) ;

/// @brief Method set_requiresDepthTexture, addr 0x182136050, size 0x10, virtual false, abstract: false, final false
inline void set_requiresDepthTexture(bool  value) ;

/// @brief Method set_resetHistory, addr 0x182136060, size 0x40, virtual false, abstract: false, final false
inline void set_resetHistory(bool  value) ;

/// @brief Method set_screenCoordScaleBias, addr 0x1817f1410, size 0x10, virtual false, abstract: false, final false
inline void set_screenCoordScaleBias(::UnityEngine::Vector4  value) ;

/// @brief Method set_screenSizeOverride, addr 0x1817f1420, size 0x10, virtual false, abstract: false, final false
inline void set_screenSizeOverride(::UnityEngine::Vector4  value) ;

/// @brief Method set_stopNaN, addr 0x1803de5b0, size 0x10, virtual false, abstract: false, final false
inline void set_stopNaN(bool  value) ;

/// @brief Method set_useScreenCoordOverride, addr 0x18051e960, size 0x10, virtual false, abstract: false, final false
inline void set_useScreenCoordOverride(bool  value) ;

/// @brief Method set_volumeFrameworkUpdateMode, addr 0x1803d4ea0, size 0x10, virtual false, abstract: false, final false
inline void set_volumeFrameworkUpdateMode(::UnityEngine::Rendering::Universal::VolumeFrameworkUpdateMode  value) ;

/// @brief Method set_volumeLayerMask, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_volumeLayerMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_volumeStack, addr 0x1821360a0, size 0x130, virtual false, abstract: false, final false
inline void set_volumeStack(::UnityEngine::Rendering::VolumeStack*  value) ;

/// @brief Method set_volumeTrigger, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
