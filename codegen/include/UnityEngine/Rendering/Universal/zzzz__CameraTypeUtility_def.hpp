...
/// @brief Method GetName, addr 0x182125e50, size 0x70, virtual false, abstract: false, final false
...
static inline void setStaticF_s_CameraTypeNames(::ArrayW<::StringW>  value) ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::CameraTypeUtility) == 0x10, "Size mismatch!");
