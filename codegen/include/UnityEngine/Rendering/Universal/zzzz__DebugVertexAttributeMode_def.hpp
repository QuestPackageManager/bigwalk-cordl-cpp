...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugVertexAttributeMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugVertexAttributeMode) == 0x4, "Size mismatch!");
