...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::Internal::ForwardLights*);
MARK_REF_T(::UnityEngine::Rendering::Universal::Internal::ForwardLights_LightConstantBuffer*);
MARK_REF_T(::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::Internal::ForwardLights___c*);
MARK_VAL_T(::UnityEngine::Rendering::Universal::Internal::ForwardLights_InitParams);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::ForwardLights*, "UnityEngine.Rendering.Universal.Internal", "ForwardLights");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::ForwardLights_LightConstantBuffer*, "UnityEngine.Rendering.Universal.Internal", "ForwardLights/LightConstantBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*, "UnityEngine.Rendering.Universal.Internal", "ForwardLights/SetupLightPassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::ForwardLights___c*, "UnityEngine.Rendering.Universal.Internal", "ForwardLights/<>c");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::ForwardLights_InitParams, "UnityEngine.Rendering.Universal.Internal", "ForwardLights/InitParams");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::ForwardLights_LightConstantBuffer) == 0x10, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Create, addr 0x182159a10, size 0x120, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "lightCookieManager", ty: "::UnityEngine::Rendering::Universal::LightCookieManager*", modifiers: "", def_value: None }, CppParam { name: "forwardPlus", ty: "bool", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::ForwardLights_InitParams) == 0x10, "Size mismatch!");
...
/// @brief Field <>9__45_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__45_0, put=setStaticF___9__45_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>*  __9__45_0;

static inline ::UnityEngine::Rendering::Universal::Internal::ForwardLights___c* New_ctor() ;

/// @brief Method <SetupRenderGraphLights>b__45_0, addr 0x18215cef0, size 0x40, virtual false, abstract: false, final false
inline void _SetupRenderGraphLights_b__45_0(::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*  data, ::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*  rgContext) ;
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>* getStaticF___9__45_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::Internal::ForwardLights___c*  value) ;

static inline void setStaticF___9__45_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::ForwardLights___c) == 0x10, "Size mismatch!");

} // namespace end def UnityEngine::Rendering::Universal::Internal
// Dependencies System.Object, Unity.Collections.NativeArray`1<T>, Unity.Jobs.JobHandle, Unity.Mathematics.int2, UnityEngine.Rendering.Universal.MixedLightingSetup, UnityEngine.Rendering.Universal.ReflectionProbeManager, UnityEngine.Vector4
namespace UnityEngine::Rendering::Universal::Internal {
// Is value type: false
...
/// @brief Field m_AdditionalLightAttenuations, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightAttenuations, put=__cordl_internal_set_m_AdditionalLightAttenuations)) ::ArrayW<::UnityEngine::Vector4>  m_AdditionalLightAttenuations;

/// @brief Field m_AdditionalLightColors, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightColors, put=__cordl_internal_set_m_AdditionalLightColors)) ::ArrayW<::UnityEngine::Vector4>  m_AdditionalLightColors;

/// @brief Field m_AdditionalLightOcclusionProbeChannels, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightOcclusionProbeChannels, put=__cordl_internal_set_m_AdditionalLightOcclusionProbeChannels)) ::ArrayW<::UnityEngine::Vector4>  m_AdditionalLightOcclusionProbeChannels;

/// @brief Field m_AdditionalLightPositions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightPositions, put=__cordl_internal_set_m_AdditionalLightPositions)) ::ArrayW<::UnityEngine::Vector4>  m_AdditionalLightPositions;

/// @brief Field m_AdditionalLightSpotDirections, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightSpotDirections, put=__cordl_internal_set_m_AdditionalLightSpotDirections)) ::ArrayW<::UnityEngine::Vector4>  m_AdditionalLightSpotDirections;
...
/// @brief Field m_ReflectionProbeManager, offset 0xb0, size 0x90 
 __declspec(property(get=__cordl_internal_get_m_ReflectionProbeManager, put=__cordl_internal_set_m_ReflectionProbeManager)) ::UnityEngine::Rendering::Universal::ReflectionProbeManager  m_ReflectionProbeManager;
...
/// @brief Method AlignByteCount, addr 0x182155f60, size 0x20, virtual false, abstract: false, final false
static inline int32_t AlignByteCount(int32_t  count, int32_t  align) ;

/// @brief Method Cleanup, addr 0x182155f80, size 0xd0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateForwardPlusBuffers, addr 0x182156050, size 0x170, virtual false, abstract: false, final false
inline void CreateForwardPlusBuffers() ;

/// @brief Method GetViewParams, addr 0x1821561c0, size 0x1d0, virtual false, abstract: false, final false
static inline void GetViewParams(bool  isOrthographic, ::Unity::Mathematics::float4x4  viewToClip, ::by_ref<float_t>  viewPlaneBot, ::by_ref<float_t>  viewPlaneTop, ::by_ref<::Unity::Mathematics::float4>  viewToViewportScaleBias) ;

/// @brief Method InitializeLightConstants, addr 0x182156390, size 0x1a0, virtual false, abstract: false, final false
inline void InitializeLightConstants(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleLight>  lights, int32_t  lightIndex, bool  supportsLightLayers, ::by_ref<::UnityEngine::Vector4>  lightPos, ::by_ref<::UnityEngine::Vector4>  lightColor, ::by_ref<::UnityEngine::Vector4>  lightAttenuation, ::by_ref<::UnityEngine::Vector4>  lightSpotDir, ::by_ref<::UnityEngine::Vector4>  lightOcclusionProbeChannel, ::by_ref<uint32_t>  lightLayerMask, ::by_ref<bool>  isSubtractive) ;
...
/// @brief Method PreSetup, addr 0x182156530, size 0x760, virtual false, abstract: false, final false
inline void PreSetup(::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method ScheduleClusteringJobs, addr 0x182156c90, size 0x1100, virtual false, abstract: false, final false
...
/// @brief Method SetupAdditionalLightConstants, addr 0x182157d90, size 0x4f0, virtual false, abstract: false, final false
inline void SetupAdditionalLightConstants(::UnityEngine::Rendering::UnsafeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method SetupLights, addr 0x182158280, size 0x790, virtual false, abstract: false, final false
inline void SetupLights(::UnityEngine::Rendering::UnsafeCommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method SetupMainLightConstants, addr 0x182158a10, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method SetupPerObjectLightIndices, addr 0x182158c80, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method SetupRenderGraphLights, addr 0x182158f80, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method SetupShaderLightConstants, addr 0x182159220, size 0x60, virtual false, abstract: false, final false
inline void SetupShaderLightConstants(::UnityEngine::Rendering::UnsafeCommandBuffer*  cmd, ::by_ref<::UnityEngine::Rendering::CullingResults>  cullResults, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method <ScheduleClusteringJobs>g__IsProbeGreater|41_0, addr 0x182159280, size 0x150, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_AdditionalLightAttenuations() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_AdditionalLightAttenuations() ;

constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_AdditionalLightColors() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_AdditionalLightColors() ;

constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_AdditionalLightOcclusionProbeChannels() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_AdditionalLightOcclusionProbeChannels() ;

constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_AdditionalLightPositions() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_AdditionalLightPositions() ;

constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_AdditionalLightSpotDirections() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_AdditionalLightSpotDirections() ;
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_m_AdditionalLightsLayerMasks() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_m_AdditionalLightsLayerMasks() ;
...
constexpr void __cordl_internal_set_m_AdditionalLightAttenuations(::ArrayW<::UnityEngine::Vector4>  value) ;

constexpr void __cordl_internal_set_m_AdditionalLightColors(::ArrayW<::UnityEngine::Vector4>  value) ;

constexpr void __cordl_internal_set_m_AdditionalLightOcclusionProbeChannels(::ArrayW<::UnityEngine::Vector4>  value) ;

constexpr void __cordl_internal_set_m_AdditionalLightPositions(::ArrayW<::UnityEngine::Vector4>  value) ;

constexpr void __cordl_internal_set_m_AdditionalLightSpotDirections(::ArrayW<::UnityEngine::Vector4>  value) ;
...
constexpr void __cordl_internal_set_m_AdditionalLightsLayerMasks(::ArrayW<float_t>  value) ;
...
/// @brief Method .ctor, addr 0x182159560, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182159640, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method get_reflectionProbeManager, addr 0x1821599a0, size 0x70, virtual false, abstract: false, final false
