...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitType, "UnityEngine.Rendering.Universal.Internal", "FinalBlitPass/BlitType");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitMaterialData, "UnityEngine.Rendering.Universal.Internal", "FinalBlitPass/BlitMaterialData");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitType) == 0x4, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "nearestSamplerPass", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "bilinearSamplerPass", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitMaterialData) == 0x10, "Size mismatch!");
...
/// @brief Field blitMaterialData, offset 0x48, size 0x10 
 __declspec(property(get=__cordl_internal_get_blitMaterialData, put=__cordl_internal_set_blitMaterialData)) ::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitMaterialData  blitMaterialData;
...
/// @brief Field <>9__15_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__15_0, put=setStaticF___9__15_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__15_0;

static inline ::UnityEngine::Rendering::Universal::Internal::FinalBlitPass___c* New_ctor() ;

/// @brief Method <Render>b__15_0, addr 0x18215c810, size 0x350, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__15_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::Internal::FinalBlitPass___c*  value) ;

static inline void setStaticF___9__15_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
/// @brief Field m_BlitMaterialData, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_BlitMaterialData, put=__cordl_internal_set_m_BlitMaterialData)) ::ArrayW<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitMaterialData>  m_BlitMaterialData;
...
/// @brief Method ExecutePass, addr 0x182155420, size 0x2a0, virtual false, abstract: false, final false
static inline void ExecutePass(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_PassData*  data, ::UnityEngine::Rendering::RTHandle*  source, ::UnityEngine::Rendering::RTHandle*  destination, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Vector4  scaleBias) ;

/// @brief Method InitPassData, addr 0x1821556c0, size 0xa0, virtual false, abstract: false, final false
inline void InitPassData(::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::by_ref<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_PassData*>  passData, ::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitType  blitType, bool  enableAlphaOutput, bool  useFullScreenViewport) ;
...
/// @brief Method Render, addr 0x182155760, size 0x600, virtual false, abstract: false, final false
inline void Render(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::ContextContainer*  frameData, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  src, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  dest, ::UnityEngine::Rendering::RenderGraphModule::TextureHandle  overlayUITexture, bool  useFullScreenViewport) ;
...
/// @brief Method Setup, addr 0x182155de0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetupHDROutput, addr 0x182155d60, size 0x80, virtual false, abstract: false, final false
static inline void SetupHDROutput(::UnityEngine::ColorGamut  hdrDisplayColorGamut, ::UnityEngine::Material*  material, ::UnityEngine::Rendering::HDROutputUtils_Operation  hdrOperation, ::UnityEngine::Vector4  hdrOutputParameters, bool  rendersOverlayUI) ;

constexpr ::ArrayW<::UnityEngine::Rendering::Universal::Internal::FinalBlitPass_BlitMaterialData> const& __cordl_internal_get_m_BlitMaterialData() const;
...
/// @brief Method .ctor, addr 0x182155e30, size 0x130, virtual false, abstract: false, final false
