...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::TonemappingMode, "UnityEngine.Rendering.Universal", "TonemappingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::TonemappingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::TonemappingMode) == 0x4, "Size mismatch!");
