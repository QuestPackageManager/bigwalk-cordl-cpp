...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugPostProcessingMode, "UnityEngine.Rendering.Universal", "DebugPostProcessingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugPostProcessingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugPostProcessingMode) == 0x4, "Size mismatch!");
