...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderPassEvent, "UnityEngine.Rendering.Universal", "RenderPassEvent");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RenderPassEvent, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderPassEvent) == 0x4, "Size mismatch!");
