...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::UniversalShadowData::*)()>(&::UnityEngine::Rendering::Universal::UniversalShadowData::Reset)> {
  ...
  constexpr static std::size_t addrs = 0x1820f3a30;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::Universal::UniversalShadowData*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::Universal::UniversalShadowData*>(), 4}
                ));
...
constexpr ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos>& UnityEngine::Rendering::Universal::UniversalShadowData::__cordl_internal_get_visibleLightsShadowCullingInfos()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___visibleLightsShadowCullingInfos;
}
constexpr ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos> const& UnityEngine::Rendering::Universal::UniversalShadowData::__cordl_internal_get_visibleLightsShadowCullingInfos() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___visibleLightsShadowCullingInfos;
}
constexpr void UnityEngine::Rendering::Universal::UniversalShadowData::__cordl_internal_set_visibleLightsShadowCullingInfos(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::Universal::UniversalShadowData*>());
}
// Ctor Parameters []
