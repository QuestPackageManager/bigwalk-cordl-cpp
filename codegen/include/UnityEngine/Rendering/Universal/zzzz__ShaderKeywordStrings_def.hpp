...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ShaderKeywordStrings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShaderKeywordStrings*, "UnityEngine.Rendering.Universal", "ShaderKeywordStrings");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ShaderKeywordStrings) == 0x10, "Size mismatch!");
