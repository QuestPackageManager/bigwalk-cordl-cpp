...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::AntialiasingMode, "UnityEngine.Rendering.Universal", "AntialiasingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::AntialiasingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::AntialiasingMode) == 0x4, "Size mismatch!");
