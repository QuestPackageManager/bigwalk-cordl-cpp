...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::HDRDebugMode, "UnityEngine.Rendering.Universal", "HDRDebugMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::HDRDebugMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::HDRDebugMode) == 0x4, "Size mismatch!");
