...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShaderPathID, "UnityEngine.Rendering.Universal", "ShaderPathID");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ShaderPathID, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ShaderPathID) == 0x4, "Size mismatch!");
