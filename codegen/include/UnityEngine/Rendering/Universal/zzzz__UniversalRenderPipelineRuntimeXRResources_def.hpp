...
/// @brief Method get_valid, addr 0x182123790, size 0x50, virtual false, abstract: false, final false
inline bool get_valid() ;

/// @brief Method get_version, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
inline int32_t get_version() ;

/// @brief Method get_xrMirrorViewPS, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_xrMirrorViewPS() ;

/// @brief Method get_xrMotionVector, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_xrMotionVector() ;

/// @brief Method get_xrOcclusionMeshPS, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_xrMirrorViewPS, addr 0x1821237e0, size 0x30, virtual false, abstract: false, final false
inline void set_xrMirrorViewPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_xrMotionVector, addr 0x182123810, size 0x30, virtual false, abstract: false, final false
inline void set_xrMotionVector(::UnityEngine::Shader*  value) ;

/// @brief Method set_xrOcclusionMeshPS, addr 0x182123840, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalRenderPipelineRuntimeXRResources) == 0x28, "Size mismatch!");
