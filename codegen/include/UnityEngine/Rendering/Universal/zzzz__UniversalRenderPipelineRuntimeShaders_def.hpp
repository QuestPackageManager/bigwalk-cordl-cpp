...
/// @brief Method ClearOriginalTerrainDetailShaders, addr 0x1821232b0, size 0x50, virtual false, abstract: false, final false
inline void ClearOriginalTerrainDetailShaders() ;

/// @brief Method GetOriginalTerrainDetailGrassBillboardShader, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> GetOriginalTerrainDetailGrassBillboardShader() ;

/// @brief Method GetOriginalTerrainDetailGrassShader, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> GetOriginalTerrainDetailGrassShader() ;

/// @brief Method GetOriginalTerrainDetailLitShader, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_blitHDROverlay, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_blitHDROverlay() ;

/// @brief Method get_coreBlitColorAndDepthPS, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_coreBlitColorAndDepthPS() ;

/// @brief Method get_coreBlitPS, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_coreBlitPS() ;

/// @brief Method get_fallbackErrorShader, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_fallbackErrorShader() ;

/// @brief Method get_samplingPS, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_samplingPS() ;

/// @brief Method get_terrainDetailGrassBillboardShader, addr 0x1820c7fc0, size 0x40, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_terrainDetailGrassBillboardShader() ;

/// @brief Method get_terrainDetailGrassShader, addr 0x1820c8000, size 0x40, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_terrainDetailGrassShader() ;

/// @brief Method get_terrainDetailLitShader, addr 0x1820c8040, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_blitHDROverlay, addr 0x182123300, size 0x30, virtual false, abstract: false, final false
inline void set_blitHDROverlay(::UnityEngine::Shader*  value) ;

/// @brief Method set_coreBlitColorAndDepthPS, addr 0x182123330, size 0x30, virtual false, abstract: false, final false
inline void set_coreBlitColorAndDepthPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_coreBlitPS, addr 0x182123360, size 0x30, virtual false, abstract: false, final false
inline void set_coreBlitPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_fallbackErrorShader, addr 0x182123390, size 0x30, virtual false, abstract: false, final false
inline void set_fallbackErrorShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_samplingPS, addr 0x1821233c0, size 0x30, virtual false, abstract: false, final false
inline void set_samplingPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_terrainDetailGrassBillboardShader, addr 0x1821233f0, size 0x50, virtual false, abstract: false, final false
inline void set_terrainDetailGrassBillboardShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_terrainDetailGrassShader, addr 0x182123440, size 0x50, virtual false, abstract: false, final false
inline void set_terrainDetailGrassShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_terrainDetailLitShader, addr 0x182123490, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalRenderPipelineRuntimeShaders) == 0x58, "Size mismatch!");
