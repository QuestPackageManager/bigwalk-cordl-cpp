...
public:
// Declarations
/// @brief Method GetPassIndex, addr 0x1820cf9e0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820cf9f0, size 0x20, virtual false, abstract: false, final false
