...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalTechnique, "UnityEngine.Rendering.Universal", "DecalTechnique");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalTechnique, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalTechnique) == 0x4, "Size mismatch!");
