...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass*, "UnityEngine.Rendering.Universal", "DecalScreenSpaceRenderPass");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*, "UnityEngine.Rendering.Universal", "DecalScreenSpaceRenderPass/PassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass___c*, "UnityEngine.Rendering.Universal", "DecalScreenSpaceRenderPass/<>c");
...
/// @brief Field <>9__10_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__10_0, put=setStaticF___9__10_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__10_0;

static inline ::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass___c* New_ctor() ;

/// @brief Method <RecordRenderGraph>b__10_0, addr 0x1820dd490, size 0x180, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__10_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass___c*  value) ;

static inline void setStaticF___9__10_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass___c) == 0x10, "Size mismatch!");
...
/// @brief Method CreateRenderListParams, addr 0x1820d5e00, size 0x1e0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RendererListParams CreateRenderListParams(::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method ExecutePass, addr 0x1820d5fe0, size 0x120, virtual false, abstract: false, final false
static inline void ExecutePass(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass_PassData*  passData, ::UnityEngine::Rendering::RendererList  rendererList) ;

/// @brief Method InitPassData, addr 0x1820d6100, size 0x90, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::Universal::DecalScreenSpaceRenderPass* New_ctor(::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings*  settings, ::UnityEngine::Rendering::Universal::DecalDrawScreenSpaceSystem*  drawSystem, bool  decalLayers) ;
...
/// @brief Method RecordRenderGraph, addr 0x1820d6190, size 0x8f0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d6a80, size 0x1e0, virtual false, abstract: false, final false
