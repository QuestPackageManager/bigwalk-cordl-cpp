...
/// @brief Method IsActive, addr 0x1820f6a00, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1820f6ab0, size 0x190, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ColorAdjustments) == 0x60, "Size mismatch!");
