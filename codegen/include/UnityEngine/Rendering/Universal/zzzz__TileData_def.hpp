...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::TileData, "UnityEngine.Rendering.Universal", "TileData");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "tileID", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "listBitMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "relLightOffset", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "unused", ty: "uint32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::TileData) == 0x10, "Size mismatch!");
