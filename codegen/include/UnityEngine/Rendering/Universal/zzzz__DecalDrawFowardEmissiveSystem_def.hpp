...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalDrawFowardEmissiveSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalDrawFowardEmissiveSystem*, "UnityEngine.Rendering.Universal", "DecalDrawFowardEmissiveSystem");
...
public:
// Declarations
/// @brief Method GetPassIndex, addr 0x1820cf9b0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820cf9c0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalDrawFowardEmissiveSystem) == 0x40, "Size mismatch!");
