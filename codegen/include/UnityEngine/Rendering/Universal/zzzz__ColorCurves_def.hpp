...
/// @brief Method IsActive, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1820f6c40, size 0x680, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ColorCurves) == 0x78, "Size mismatch!");
