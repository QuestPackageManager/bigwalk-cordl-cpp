...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalUpdateCulledSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalUpdateCulledSystem*, "UnityEngine.Rendering.Universal", "DecalUpdateCulledSystem");
...
/// @brief Method Execute, addr 0x1820d7370, size 0xd0, virtual false, abstract: false, final false
inline void Execute() ;

/// @brief Method Execute, addr 0x1820d7440, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d74a0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalUpdateCulledSystem) == 0x20, "Size mismatch!");
