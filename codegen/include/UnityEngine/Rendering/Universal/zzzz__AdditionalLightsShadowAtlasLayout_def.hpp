...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShadowResolutionRequest_AdditionalLightsShadowAtlasLayout_SettingsOptions, "UnityEngine.Rendering.Universal", "AdditionalLightsShadowAtlasLayout/ShadowResolutionRequest/SettingsOptions");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest, "UnityEngine.Rendering.Universal", "AdditionalLightsShadowAtlasLayout/ShadowResolutionRequest");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ShadowResolutionRequest_AdditionalLightsShadowAtlasLayout_SettingsOptions, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ShadowResolutionRequest_AdditionalLightsShadowAtlasLayout_SettingsOptions) == 0x2, "Size mismatch!");
...
/// @brief Method get_pointLightShadow, addr 0x18210ba50, size 0x20, virtual false, abstract: false, final false
inline bool get_pointLightShadow() ;

/// @brief Method get_softShadow, addr 0x18210ba70, size 0x20, virtual false, abstract: false, final false
inline bool get_softShadow() ;

/// @brief Method set_pointLightShadow, addr 0x18210ba90, size 0x30, virtual false, abstract: false, final false
inline void set_pointLightShadow(bool  value) ;

/// @brief Method set_softShadow, addr 0x18210bac0, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "visibleLightIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "perLightShadowSliceIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "requestedResolution", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "offsetX", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "offsetY", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "allocatedResolution", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "m_ShadowProperties", ty: "::UnityEngine::Rendering::Universal::ShadowResolutionRequest_AdditionalLightsShadowAtlasLayout_SettingsOptions", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest) == 0xe, "Size mismatch!");
...
/// @brief Field <>9__24_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__24_0, put=setStaticF___9__24_0)) ::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>*  __9__24_0;

static inline ::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout___c* New_ctor() ;

/// @brief Method <CreateCompareShadowResolutionRequesPredicate>b__24_0, addr 0x18210ccc0, size 0x130, virtual false, abstract: false, final false
inline int32_t _CreateCompareShadowResolutionRequesPredicate_b__24_0(::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest  curr, ::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest  other) ;
...
static inline ::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>* getStaticF___9__24_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout___c*  value) ;

static inline void setStaticF___9__24_0(::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>*  value) ;
...
/// @brief Field s_CompareShadowResolutionRequest, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_CompareShadowResolutionRequest, put=setStaticF_s_CompareShadowResolutionRequest)) ::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>*  s_CompareShadowResolutionRequest;

/// @brief Field s_ShadowResolutionRequests, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ShadowResolutionRequests, put=setStaticF_s_ShadowResolutionRequests)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>*  s_ShadowResolutionRequests;

/// @brief Field s_SortedShadowResolutionRequests, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SortedShadowResolutionRequests, put=setStaticF_s_SortedShadowResolutionRequests)) ::ArrayW<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>  s_SortedShadowResolutionRequests;
...
/// @brief Method ClearStaticCaches, addr 0x1820f4570, size 0xe0, virtual false, abstract: false, final false
static inline void ClearStaticCaches() ;

/// @brief Method CreateCompareShadowResolutionRequesPredicate, addr 0x1820f4650, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>* CreateCompareShadowResolutionRequesPredicate() ;

/// @brief Method EstimateScaleFactorNeededToFitAllShadowsInAtlas, addr 0x1820f4700, size 0x80, virtual false, abstract: false, final false
static inline int32_t EstimateScaleFactorNeededToFitAllShadowsInAtlas(::by_ref<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>>  shadowResolutionRequests, int32_t  endIndex, int32_t  atlasSize) ;

/// @brief Method GetAtlasSize, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetAtlasSize() ;

/// @brief Method GetShadowSlicesScaleFactor, addr 0x1803914b0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetShadowSlicesScaleFactor() ;

/// @brief Method GetSliceShadowResolutionRequest, addr 0x1820f4780, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetSortedShadowResolutionRequest, addr 0x180bf9d60, size 0x116d0, virtual false, abstract: false, final false
...
/// @brief Method GetTotalShadowResolutionRequestCount, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetTotalShadowResolutionRequestCount() ;

/// @brief Method GetTotalShadowSlicesCount, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetTotalShadowSlicesCount() ;

/// @brief Method HasSpaceForLight, addr 0x1820f4800, size 0x20, virtual false, abstract: false, final false
inline bool HasSpaceForLight(int32_t  originalVisibleLightIndex) ;

/// @brief Method HasTooManyShadowMaps, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool HasTooManyShadowMaps() ;

/// @brief Method .ctor, addr 0x1820f4820, size 0xd10, virtual false, abstract: false, final false
...
static inline ::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>* getStaticF_s_CompareShadowResolutionRequest() ;
...
static inline ::ArrayW<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest> getStaticF_s_SortedShadowResolutionRequests() ;
...
static inline void setStaticF_s_CompareShadowResolutionRequest(::System::Func_3<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,int32_t>*  value) ;

static inline void setStaticF_s_ShadowResolutionRequests(::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>*  value) ;

static inline void setStaticF_s_SortedShadowResolutionRequests(::ArrayW<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>  value) ;
...
// Ctor Parameters [CppParam { name: "m_SortedShadowResolutionRequests", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>", modifiers: "", def_value: None }, CppParam { name: "m_VisibleLightIndexToSortedShadowResolutionRequestsFirstSliceIndex", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_TotalShadowSlicesCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_TotalShadowResolutionRequestCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_TooManyShadowMaps", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_ShadowSlicesScaleFactor", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_AtlasSize", ty: "int32_t", modifiers: "", def_value: None }]
