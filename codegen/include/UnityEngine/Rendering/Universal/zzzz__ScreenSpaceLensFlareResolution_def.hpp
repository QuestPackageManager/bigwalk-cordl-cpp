...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceLensFlareResolution, "UnityEngine.Rendering.Universal", "ScreenSpaceLensFlareResolution");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceLensFlareResolution, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceLensFlareResolution) == 0x4, "Size mismatch!");
