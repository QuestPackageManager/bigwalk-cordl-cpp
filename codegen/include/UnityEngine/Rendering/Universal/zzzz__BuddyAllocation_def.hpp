...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::BuddyAllocation, "UnityEngine.Rendering.Universal", "BuddyAllocation");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
/// @brief Method get_index2D, addr 0x1820f5580, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::BuddyAllocation) == 0x8, "Size mismatch!");
