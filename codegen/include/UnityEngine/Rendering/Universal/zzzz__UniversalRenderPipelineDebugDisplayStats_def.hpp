...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplayStats*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplayStats*, "UnityEngine.Rendering.Universal", "UniversalRenderPipelineDebugDisplayStats");
...
/// @brief Field m_RecordedSamplers, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RecordedSamplers, put=__cordl_internal_set_m_RecordedSamplers)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::URPProfileId>*  m_RecordedSamplers;

/// @brief Method DisableProfilingRecorders, addr 0x1820de5d0, size 0x90, virtual true, abstract: false, final false
inline void DisableProfilingRecorders() ;

/// @brief Method EnableProfilingRecorders, addr 0x1820de660, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method RegisterDebugUI, addr 0x1820de690, size 0x260, virtual true, abstract: false, final false
inline void RegisterDebugUI(::System::Collections::Generic::List_1<::UnityEngine::Rendering::DebugUI_Widget*>*  list) ;

/// @brief Method Update, addr 0x1820de8f0, size 0x30, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method <RegisterDebugUI>b__4_0, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool _RegisterDebugUI_b__4_0() ;

/// @brief Method <RegisterDebugUI>b__4_1, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
inline void _RegisterDebugUI_b__4_1(bool  value) ;

/// @brief Method <RegisterDebugUI>b__4_2, addr 0x180503cd0, size 0x10, virtual false, abstract: false, final false
inline bool _RegisterDebugUI_b__4_2() ;

/// @brief Method <RegisterDebugUI>b__4_3, addr 0x180503d00, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820de920, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplayStats) == 0x40, "Size mismatch!");
