...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalSkipCulledSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalSkipCulledSystem*, "UnityEngine.Rendering.Universal", "DecalSkipCulledSystem");
...
/// @brief Method Execute, addr 0x1820d6c60, size 0x110, virtual false, abstract: false, final false
inline void Execute(::UnityEngine::Camera*  camera) ;

/// @brief Method Execute, addr 0x1820d6d70, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d6e10, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalSkipCulledSystem) == 0x28, "Size mismatch!");
