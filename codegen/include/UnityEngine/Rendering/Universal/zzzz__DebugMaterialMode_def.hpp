...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugMaterialMode, "UnityEngine.Rendering.Universal", "DebugMaterialMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugMaterialMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugMaterialMode) == 0x4, "Size mismatch!");
