...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::MixedLightingSetup, "UnityEngine.Rendering.Universal", "MixedLightingSetup");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
/// @brief Field ShadowMask value: I32(1)
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::MixedLightingSetup, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::MixedLightingSetup) == 0x4, "Size mismatch!");
