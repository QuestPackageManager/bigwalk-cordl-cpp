...
/// @brief Method IsActive, addr 0x1820f7560, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1820f75d0, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DepthOfField) == 0x90, "Size mismatch!");
