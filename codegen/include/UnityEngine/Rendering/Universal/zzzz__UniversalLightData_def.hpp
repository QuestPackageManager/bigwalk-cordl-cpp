...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::UniversalLightData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalLightData*, "UnityEngine.Rendering.Universal", "UniversalLightData");
...
/// @brief Method Reset, addr 0x1820e6d50, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;
