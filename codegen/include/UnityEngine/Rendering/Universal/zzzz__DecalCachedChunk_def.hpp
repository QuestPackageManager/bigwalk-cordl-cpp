...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalCachedChunk*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalCachedChunk*, "UnityEngine.Rendering.Universal", "DecalCachedChunk");
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Mathematics.float2, Unity.Mathematics.float3, Unity.Mathematics.float4, Unity.Mathematics.float4x4, Unity.Mathematics.quaternion, UnityEngine.BoundingSphere, UnityEngine.Rendering.Universal.DecalChunk, UnityEngine.Rendering.Universal.DecalScaleMode
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Field boundingSphereArray, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get_boundingSphereArray, put=__cordl_internal_set_boundingSphereArray)) ::ArrayW<::UnityEngine::BoundingSphere>  boundingSphereArray;
...
/// @brief Field scaleModes, offset 0xe8, size 0x10 
 __declspec(property(get=__cordl_internal_get_scaleModes, put=__cordl_internal_set_scaleModes)) ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::DecalScaleMode>  scaleModes;
...
/// @brief Method Dispose, addr 0x1820cec50, size 0x100, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalCachedChunk* New_ctor() ;

/// @brief Method RemoveAtSwapBack, addr 0x1820ced50, size 0x1f0, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x1820cef40, size 0x130, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::BoundingSphere> const& __cordl_internal_get_boundingSphereArray() const;
...
constexpr void __cordl_internal_set_boundingSphereArray(::ArrayW<::UnityEngine::BoundingSphere>  value) ;
...
/// @brief Field boundingSphereArray, offset: 0x148, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::BoundingSphere>  ___boundingSphereArray;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalCachedChunk) == 0x150, "Size mismatch!");
