...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalNormalBlend, "UnityEngine.Rendering.Universal", "DecalNormalBlend");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalNormalBlend, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalNormalBlend) == 0x4, "Size mismatch!");
