...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RenderQueueType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderQueueType) == 0x4, "Size mismatch!");
