...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalTechniqueOption, "UnityEngine.Rendering.Universal", "DecalTechniqueOption");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalTechniqueOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalTechniqueOption) == 0x4, "Size mismatch!");
