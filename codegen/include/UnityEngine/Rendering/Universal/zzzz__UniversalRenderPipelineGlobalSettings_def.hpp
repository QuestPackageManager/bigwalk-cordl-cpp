...
class CORDL_TYPE UniversalRenderPipelineGlobalSettings : public ::UnityEngine::Rendering::RenderPipelineGlobalSettings_2<::UnityW<::UnityEngine::Rendering::Universal::UniversalRenderPipelineGlobalSettings>,::UnityEngine::Rendering::Universal::UniversalRenderPipeline*> {
public:
// Declarations
...
/// @brief Field m_ObsoleteDefaultVolumeProfile, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ObsoleteDefaultVolumeProfile, put=__cordl_internal_set_m_ObsoleteDefaultVolumeProfile)) ::UnityW<::UnityEngine::Rendering::VolumeProfile>  m_ObsoleteDefaultVolumeProfile;

/// @brief Field m_RenderingLayerNames, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RenderingLayerNames, put=__cordl_internal_set_m_RenderingLayerNames)) ::ArrayW<::StringW>  m_RenderingLayerNames;
...
/// @brief Field m_ShaderStrippingSetting, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ShaderStrippingSetting, put=__cordl_internal_set_m_ShaderStrippingSetting)) ::UnityEngine::Rendering::ShaderStrippingSetting*  m_ShaderStrippingSetting;
...
/// @brief Field m_URPShaderStrippingSetting, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_URPShaderStrippingSetting, put=__cordl_internal_set_m_URPShaderStrippingSetting)) ::UnityEngine::Rendering::Universal::URPShaderStrippingSetting*  m_URPShaderStrippingSetting;
...
/// @brief Method GetOrCreateAPVSceneData, addr 0x1820e6d90, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeVolumeSceneData* GetOrCreateAPVSceneData() ;

/// @brief Method GetOrCreateDefaultVolumeProfile, addr 0x1802e0ba0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method IsAtLastVersion, addr 0x1820e6e10, size 0x10, virtual false, abstract: false, final false
inline bool IsAtLastVersion() ;

static inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineGlobalSettings* New_ctor() ;

/// @brief Method Reset, addr 0x1820e6e70, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ResetRenderingLayerNames, addr 0x1820e6e20, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_m_RenderingLayerNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_m_RenderingLayerNames() ;
...
constexpr void __cordl_internal_set_m_RenderingLayerNames(::ArrayW<::StringW>  value) ;
...
/// @brief Method .ctor, addr 0x1820e6e80, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lightLayerNames, addr 0x1820c7be0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_lightLayerNames() ;

/// @brief Method get_prefixedLightLayerNames, addr 0x1820c7be0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_prefixedLightLayerNames() ;

/// @brief Method get_settingsList, addr 0x1820e6f70, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>* get_settingsList() ;

/// @brief Method get_stripUnusedLODCrossFadeVariants, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
inline bool get_stripUnusedLODCrossFadeVariants() ;

/// @brief Method set_stripUnusedLODCrossFadeVariants, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalRenderPipelineGlobalSettings) == 0xb0, "Size mismatch!");
