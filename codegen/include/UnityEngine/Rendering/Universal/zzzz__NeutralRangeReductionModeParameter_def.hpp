...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::NeutralRangeReductionModeParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::NeutralRangeReductionModeParameter*, "UnityEngine.Rendering.Universal", "NeutralRangeReductionModeParameter");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::NeutralRangeReductionModeParameter) == 0x20, "Size mismatch!");
