...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass*, "UnityEngine.Rendering.Universal", "DecalForwardEmissivePass");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*, "UnityEngine.Rendering.Universal", "DecalForwardEmissivePass/PassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*, "UnityEngine.Rendering.Universal", "DecalForwardEmissivePass/<>c");
...
/// @brief Field <>9__8_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__8_0, put=setStaticF___9__8_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__8_0;

static inline ::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c* New_ctor() ;

/// @brief Method <RecordRenderGraph>b__8_0, addr 0x1820dd900, size 0x90, virtual false, abstract: false, final false
inline void _RecordRenderGraph_b__8_0(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*  data, ::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext  rgContext) ;
...
static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__8_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c*  value) ;

static inline void setStaticF___9__8_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass___c) == 0x10, "Size mismatch!");
...
static inline void ExecutePass(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*  passData, ::UnityEngine::Rendering::RendererList  rendererList) ;

/// @brief Method InitPassData, addr 0x1820d3060, size 0x20, virtual false, abstract: false, final false
inline void InitPassData(::by_ref<::UnityEngine::Rendering::Universal::DecalForwardEmissivePass_PassData*>  passData) ;

/// @brief Method InitRendererListParams, addr 0x1820d3080, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method RecordRenderGraph, addr 0x1820d3260, size 0x680, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d38e0, size 0x200, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass, ___m_FilteringSettings) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass, ___m_ShaderTagIdList) == 0x80, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass, ___m_DrawSystem) == 0x88, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalForwardEmissivePass) == 0x90, "Size mismatch!");
