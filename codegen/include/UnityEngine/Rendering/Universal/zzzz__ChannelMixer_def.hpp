...
/// @brief Method IsActive, addr 0x1820f6570, size 0x170, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1820f66e0, size 0x280, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ChannelMixer) == 0x80, "Size mismatch!");
