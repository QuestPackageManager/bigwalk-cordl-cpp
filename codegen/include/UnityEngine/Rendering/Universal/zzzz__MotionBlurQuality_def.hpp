...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::MotionBlurQuality, "UnityEngine.Rendering.Universal", "MotionBlurQuality");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::MotionBlurQuality, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::MotionBlurQuality) == 0x4, "Size mismatch!");
