...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos, "UnityEngine.Rendering.Universal", "URPLightShadowCullingInfos");
...
public:
// Declarations
/// @brief Method IsSliceValid, addr 0x182134f90, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos) == 0x18, "Size mismatch!");
