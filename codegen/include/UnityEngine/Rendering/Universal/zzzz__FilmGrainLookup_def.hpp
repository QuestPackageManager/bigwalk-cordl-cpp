...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::FilmGrainLookup, "UnityEngine.Rendering.Universal", "FilmGrainLookup");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::FilmGrainLookup, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::FilmGrainLookup) == 0x4, "Size mismatch!");
