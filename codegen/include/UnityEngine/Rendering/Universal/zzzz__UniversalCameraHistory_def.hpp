...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item, "UnityEngine.Rendering.Universal", "UniversalCameraHistory/Item");
...
public:
// Declarations
/// @brief Method Reset, addr 0x18213db90, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;
...
// Ctor Parameters [CppParam { name: "storage", ty: "::UnityEngine::Rendering::ContextItem*", modifiers: "", def_value: None }, CppParam { name: "requestVersion", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "writeVersion", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field m_Items, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Items, put=__cordl_internal_set_m_Items)) ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>  m_Items;
...
/// @brief Method Dispose, addr 0x182136520, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GatherHistoryRequests, addr 0x182136580, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x1821365c0, size 0x20, virtual false, abstract: false, final false
inline bool IsValid(int32_t  i) ;

/// @brief Method IsValidRequest, addr 0x1821365a0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ReleaseUnusedHistory, addr 0x1821365e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method SwapAndSetReferenceSize, addr 0x182136660, size 0x10, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item> const& __cordl_internal_get_m_Items() const;

constexpr ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>& __cordl_internal_get_m_Items() ;
...
constexpr void __cordl_internal_set_m_Items(::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>  value) ;

constexpr void __cordl_internal_set_m_Version(int32_t  value) ;

/// @brief Method .ctor, addr 0x182136670, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnGatherHistoryRequests, addr 0x182136700, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method remove_OnGatherHistoryRequests, addr 0x182136780, size 0x80, virtual true, abstract: false, final true
...
/// @brief Field m_Items, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>  ___m_Items;
