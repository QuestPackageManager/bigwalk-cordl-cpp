...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ForwardRendererData*);
...
// Dependencies UnityEngine.LayerMask, UnityEngine.Rendering.Universal.DepthPrimingMode, UnityEngine.Rendering.Universal.RenderingMode, UnityEngine.Rendering.Universal.ScriptableRendererData, UnityEngine.Rendering.Universal.TileSize
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Method Create, addr 0x1820e2960, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820e29a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_accurateGbufferNormals, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline bool get_accurateGbufferNormals() ;

/// @brief Method get_defaultStencilState, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::StencilStateData* get_defaultStencilState() ;

/// @brief Method get_opaqueLayerMask, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_opaqueLayerMask() ;

/// @brief Method get_renderingMode, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::RenderingMode get_renderingMode() ;

/// @brief Method get_shadowTransparentReceive, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline bool get_shadowTransparentReceive() ;

/// @brief Method get_transparentLayerMask, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_transparentLayerMask() ;

/// @brief Method set_accurateGbufferNormals, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline void set_accurateGbufferNormals(bool  value) ;

/// @brief Method set_defaultStencilState, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline void set_defaultStencilState(::UnityEngine::Rendering::Universal::StencilStateData*  value) ;

/// @brief Method set_opaqueLayerMask, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline void set_opaqueLayerMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_renderingMode, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline void set_renderingMode(::UnityEngine::Rendering::Universal::RenderingMode  value) ;

/// @brief Method set_shadowTransparentReceive, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
inline void set_shadowTransparentReceive(bool  value) ;

/// @brief Method set_transparentLayerMask, addr 0x1820e29b0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ForwardRendererData) == 0x88, "Size mismatch!");
