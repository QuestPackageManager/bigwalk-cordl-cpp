...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugSceneOverrideMode, "UnityEngine.Rendering.Universal", "DebugSceneOverrideMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::DebugSceneOverrideMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugSceneOverrideMode) == 0x4, "Size mismatch!");
