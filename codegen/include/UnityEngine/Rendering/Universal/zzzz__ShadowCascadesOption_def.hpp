...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ShadowCascadesOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ShadowCascadesOption) == 0x4, "Size mismatch!");
