...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ReflectionProbeMinMaxZJob, "UnityEngine.Rendering.Universal", "ReflectionProbeMinMaxZJob");
...
/// @brief Method Execute, addr 0x1821267f0, size 0x5c0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "worldToViews", ty: "::UnityEngine::Rendering::Universal::Fixed2_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "reflectionProbes", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleReflectionProbe>", modifiers: "", def_value: None }, CppParam { name: "reflectionProbeRotation", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "minMaxZs", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>", modifiers: "", def_value: None }]
constexpr ReflectionProbeMinMaxZJob(::UnityEngine::Rendering::Universal::Fixed2_1<::Unity::Mathematics::float4x4>  worldToViews, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleReflectionProbe>  reflectionProbes, bool  reflectionProbeRotation, ::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>  minMaxZs) noexcept;
