...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderingMode, "UnityEngine.Rendering.Universal", "RenderingMode");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RenderingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderingMode) == 0x4, "Size mismatch!");
