...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOMethodOptions, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/AOMethodOptions");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOSampleOption, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/AOSampleOption");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_BlurQualityOptions, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/BlurQualityOptions");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_DepthSource, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/DepthSource");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_NormalQuality, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/NormalQuality");
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_DepthSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_DepthSource) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_NormalQuality, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_NormalQuality) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOSampleOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOSampleOption) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOMethodOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOMethodOptions) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_BlurQualityOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_BlurQualityOptions) == 0x4, "Size mismatch!");
...
/// @brief Field NormalSamples, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_NormalSamples, put=__cordl_internal_set_NormalSamples)) ::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_NormalQuality  NormalSamples;
...
/// @brief Method .ctor, addr 0x18211c8b0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
