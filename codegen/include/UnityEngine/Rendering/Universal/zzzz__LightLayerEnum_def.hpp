...
static_assert(offsetof(::UnityEngine::Rendering::Universal::LightLayerEnum, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::LightLayerEnum) == 0x4, "Size mismatch!");
