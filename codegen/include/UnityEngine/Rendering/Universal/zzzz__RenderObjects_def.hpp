...
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjects*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjects_FilterSettings*);
MARK_REF_T(::UnityEngine::Rendering::Universal::RenderObjects_RenderObjectsSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjectsSettings_RenderObjects_OverrideMaterialMode, "UnityEngine.Rendering.Universal", "RenderObjects/RenderObjectsSettings/OverrideMaterialMode");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjects*, "UnityEngine.Rendering.Universal", "RenderObjects");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*, "UnityEngine.Rendering.Universal", "RenderObjects/CustomCameraSettings");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjects_FilterSettings*, "UnityEngine.Rendering.Universal", "RenderObjects/FilterSettings");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::RenderObjects_RenderObjectsSettings*, "UnityEngine.Rendering.Universal", "RenderObjects/RenderObjectsSettings");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::RenderObjectsSettings_RenderObjects_OverrideMaterialMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderObjectsSettings_RenderObjects_OverrideMaterialMode) == 0x4, "Size mismatch!");

} // namespace end def UnityEngine::Rendering::Universal
// Dependencies System.Object, UnityEngine.Rendering.CompareFunction, UnityEngine.Rendering.Universal.RenderObjects::RenderObjectsSettings::OverrideMaterialMode, UnityEngine.Rendering.Universal.RenderPassEvent
namespace UnityEngine::Rendering::Universal {
// Is value type: false
...
/// @brief Field overrideMode, offset 0x44, size 0x4 
 __declspec(property(get=__cordl_internal_get_overrideMode, put=__cordl_internal_set_overrideMode)) ::UnityEngine::Rendering::Universal::RenderObjectsSettings_RenderObjects_OverrideMaterialMode  overrideMode;
...
/// @brief Method .ctor, addr 0x182113440, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderObjects_RenderObjectsSettings) == 0x68, "Size mismatch!");
...
/// @brief Field PassNames, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_PassNames, put=__cordl_internal_set_PassNames)) ::ArrayW<::StringW>  PassNames;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_PassNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_PassNames() ;
...
constexpr void __cordl_internal_set_PassNames(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set_RenderQueueType(::UnityEngine::Rendering::Universal::RenderQueueType  value) ;

/// @brief Method .ctor, addr 0x18210e2e0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderObjects_FilterSettings) == 0x20, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x18210e280, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddRenderPasses, addr 0x182113510, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method Create, addr 0x182113570, size 0x1f0, virtual true, abstract: false, final false
inline void Create() ;
...
/// @brief Method .ctor, addr 0x182113760, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::RenderObjects) == 0x30, "Size mismatch!");
