...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::SampleCount, "UnityEngine.Rendering.Universal", "SampleCount");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::SampleCount, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::SampleCount) == 0x4, "Size mismatch!");
