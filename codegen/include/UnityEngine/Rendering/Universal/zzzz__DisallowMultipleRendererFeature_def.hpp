...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature*, "UnityEngine.Rendering.Universal", "DisallowMultipleRendererFeature");
...
/// @brief Method get_customTitle, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_customTitle() ;

/// @brief Method set_customTitle, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature) == 0x18, "Size mismatch!");
