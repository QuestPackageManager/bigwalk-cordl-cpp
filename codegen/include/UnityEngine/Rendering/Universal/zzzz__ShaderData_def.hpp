...
/// @brief Method Dispose, addr 0x182127420, size 0xb0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeBuffer, addr 0x1821273e0, size 0x40, virtual false, abstract: false, final false
inline void DisposeBuffer(::by_ref<::UnityEngine::ComputeBuffer*>  buffer) ;

/// @brief Method GetAdditionalLightShadowParamsStructuredBuffer, addr 0x1821274d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowParamsStructuredBuffer(int32_t  size) ;

/// @brief Method GetAdditionalLightShadowSliceMatricesStructuredBuffer, addr 0x1821274e0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowSliceMatricesStructuredBuffer(int32_t  size) ;

/// @brief Method GetLightDataBuffer, addr 0x182127500, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetLightDataBuffer(int32_t  size) ;

/// @brief Method GetLightIndicesBuffer, addr 0x182127520, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_instance, addr 0x182127530, size 0x60, virtual false, abstract: false, final false
