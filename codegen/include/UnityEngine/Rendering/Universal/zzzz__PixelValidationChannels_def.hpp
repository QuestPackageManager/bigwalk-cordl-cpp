...
static_assert(offsetof(::UnityEngine::Rendering::Universal::PixelValidationChannels, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::PixelValidationChannels) == 0x4, "Size mismatch!");
