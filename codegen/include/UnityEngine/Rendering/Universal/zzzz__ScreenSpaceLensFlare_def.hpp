...
/// @brief Field chromaticAbberationIntensity, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_chromaticAbberationIntensity, put=__cordl_internal_set_chromaticAbberationIntensity)) ::UnityEngine::Rendering::ClampedFloatParameter*  chromaticAbberationIntensity;
...
/// @brief Method IsActive, addr 0x1820f6960, size 0x30, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsStreaksActive, addr 0x18210b290, size 0x30, virtual false, abstract: false, final false
inline bool IsStreaksActive() ;

/// @brief Method IsTileCompatible, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18210b2c0, size 0x4a0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ScreenSpaceLensFlare) == 0xc8, "Size mismatch!");
