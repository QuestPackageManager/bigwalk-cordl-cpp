...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CameraRenderType, "UnityEngine.Rendering.Universal", "CameraRenderType");
// Dependencies 
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::CameraRenderType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::Universal::CameraRenderType) == 0x4, "Size mismatch!");
