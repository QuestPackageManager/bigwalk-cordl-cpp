...
/// @brief Method DistanceBetweenQuaternions, addr 0x1820def00, size 0x60, virtual false, abstract: false, final false
inline float_t DistanceBetweenQuaternions(::Unity::Mathematics::quaternion  a, ::Unity::Mathematics::quaternion  b) ;

/// @brief Method Execute, addr 0x1820def60, size 0x810, virtual true, abstract: false, final true
inline void Execute(int32_t  index, ::UnityEngine::Jobs::TransformAccess  transform) ;

/// @brief Method GetDecalProjectBoundingSphere, addr 0x1820df770, size 0x210, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalUpdateCachedSystem_UpdateTransformsJob) == 0x98, "Size mismatch!");
...
/// @brief Method Execute, addr 0x1820d7080, size 0x260, virtual false, abstract: false, final false
inline void Execute() ;

/// @brief Method Execute, addr 0x1820d6e90, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820d72e0, size 0x90, virtual false, abstract: false, final false
