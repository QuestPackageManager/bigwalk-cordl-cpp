...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalDrawErrorSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalDrawErrorSystem*, "UnityEngine.Rendering.Universal", "DecalDrawErrorSystem");
...
/// @brief Method GetMaterial, addr 0x1820cf8f0, size 0x50, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Rendering::Universal::DecalEntityChunk*  decalEntityChunk) ;

/// @brief Method GetPassIndex, addr 0x1820cf940, size 0x40, virtual true, abstract: false, final false
inline int32_t GetPassIndex(::UnityEngine::Rendering::Universal::DecalCachedChunk*  decalCachedChunk) ;

static inline ::UnityEngine::Rendering::Universal::DecalDrawErrorSystem* New_ctor(::UnityEngine::Rendering::Universal::DecalEntityManager*  entityManager, ::UnityEngine::Rendering::Universal::DecalTechnique  technique) ;
...
/// @brief Method .ctor, addr 0x1820cf980, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalDrawErrorSystem) == 0x48, "Size mismatch!");
