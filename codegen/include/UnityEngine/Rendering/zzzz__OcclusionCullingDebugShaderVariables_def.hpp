...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables___OccluderMipBounds_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingDebugShaderVariables/<_OccluderMipBounds>e__FixedBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
