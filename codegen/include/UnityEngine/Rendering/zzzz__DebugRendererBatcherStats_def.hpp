...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugRendererBatcherStats*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugRendererBatcherStats*, "UnityEngine.Rendering", "DebugRendererBatcherStats");
// Dependencies System.Object, Unity.Collections.NativeList`1<T>, UnityEngine.Rendering.DebugOccluderStats, UnityEngine.Rendering.InstanceCullerViewStats, UnityEngine.Rendering.InstanceOcclusionEventStats
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field instanceCullerStats, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_instanceCullerStats, put=__cordl_internal_set_instanceCullerStats)) ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::InstanceCullerViewStats>  instanceCullerStats;

/// @brief Field instanceOcclusionEventStats, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_instanceOcclusionEventStats, put=__cordl_internal_set_instanceOcclusionEventStats)) ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::InstanceOcclusionEventStats>  instanceOcclusionEventStats;

/// @brief Field occluderStats, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_occluderStats, put=__cordl_internal_set_occluderStats)) ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DebugOccluderStats>  occluderStats;
...
/// @brief Method Dispose, addr 0x18208bf40, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FinalizeInstanceCullerViewStats, addr 0x18208bf90, size 0x1e0, virtual false, abstract: false, final false
inline void FinalizeInstanceCullerViewStats() ;

/// @brief Method GetLastInstanceOcclusionEventStatsForView, addr 0x18208c170, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18208c210, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::DebugRendererBatcherStats) == 0x38, "Size mismatch!");
