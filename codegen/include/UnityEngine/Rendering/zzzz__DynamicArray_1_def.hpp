...
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::DynamicArray_1_Iterator, "UnityEngine.Rendering", "DynamicArray`1/Iterator");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::DynamicArray_1_RangeEnumerable, "UnityEngine.Rendering", "DynamicArray`1/RangeEnumerable");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::RangeEnumerable_DynamicArray_1_RangeIterator, "UnityEngine.Rendering", "DynamicArray`1/RangeEnumerable/RangeIterator");
// Dependencies 
namespace UnityEngine::Rendering {
// cpp template
template<typename T>
...
// Ctor Parameters [CppParam { name: "owner", ty: "::UnityEngine::Rendering::DynamicArray_1<T>*", modifiers: "", def_value: None }, CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "owner", ty: "::UnityEngine::Rendering::DynamicArray_1<T>*", modifiers: "", def_value: None }, CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "first", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "last", ty: "int32_t", modifiers: "", def_value: None }]
