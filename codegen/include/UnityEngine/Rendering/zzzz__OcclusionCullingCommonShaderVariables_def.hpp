...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___FacingDirWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_FacingDirWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___OccluderMipBounds_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_OccluderMipBounds>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___RadialDirWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_RadialDirWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewOriginWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_ViewOriginWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewProjMatrix_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_ViewProjMatrix>e__FixedBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___FacingDirWorldSpace_e__FixedBuffer) == 0x60, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___OccluderMipBounds_e__FixedBuffer) == 0x80, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___RadialDirWorldSpace_e__FixedBuffer) == 0x60, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewOriginWorldSpace_e__FixedBuffer) == 0x60, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewProjMatrix_e__FixedBuffer) == 0x180, "Size mismatch!");
...
inline void _ctor(::by_ref<::UnityEngine::Rendering::OccluderContext>  occluderCtx, ::by_ref<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, bool  occlusionOverlayCountVisible, bool  overrideOcclusionTestToAlwaysPass) ;

// Ctor Parameters []
// @brief default ctor
constexpr OcclusionCullingCommonShaderVariables() ;

// Ctor Parameters [CppParam { name: "_OccluderMipBounds", ty: "::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___OccluderMipBounds_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "_ViewProjMatrix", ty: "::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewProjMatrix_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "_ViewOriginWorldSpace", ty: "::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewOriginWorldSpace_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "_FacingDirWorldSpace", ty: "::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___FacingDirWorldSpace_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "_RadialDirWorldSpace", ty: "::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___RadialDirWorldSpace_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "_DepthSizeInOccluderPixels", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_OccluderDepthPyramidSize", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_OccluderMipLayoutSizeX", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_OccluderMipLayoutSizeY", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_OcclusionTestDebugFlags", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_OcclusionCullingCommonPad0", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_OcclusionTestCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_OccluderSubviewIndices", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_CullingSplitIndices", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_CullingSplitMask", ty: "int32_t", modifiers: "", def_value: None }]
constexpr OcclusionCullingCommonShaderVariables(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___OccluderMipBounds_e__FixedBuffer  _OccluderMipBounds, ::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewProjMatrix_e__FixedBuffer  _ViewProjMatrix, ::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewOriginWorldSpace_e__FixedBuffer  _ViewOriginWorldSpace, ::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___FacingDirWorldSpace_e__FixedBuffer  _FacingDirWorldSpace, ::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___RadialDirWorldSpace_e__FixedBuffer  _RadialDirWorldSpace, ::UnityEngine::Vector4  _DepthSizeInOccluderPixels, ::UnityEngine::Vector4  _OccluderDepthPyramidSize, uint32_t  _OccluderMipLayoutSizeX, uint32_t  _OccluderMipLayoutSizeY, uint32_t  _OcclusionTestDebugFlags, uint32_t  _OcclusionCullingCommonPad0, int32_t  _OcclusionTestCount, int32_t  _OccluderSubviewIndices, int32_t  _CullingSplitIndices, int32_t  _CullingSplitMask) noexcept;
