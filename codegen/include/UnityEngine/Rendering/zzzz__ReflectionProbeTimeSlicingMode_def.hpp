...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReflectionProbeTimeSlicingMode, "UnityEngine.Rendering", "ReflectionProbeTimeSlicingMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ReflectionProbeTimeSlicingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ReflectionProbeTimeSlicingMode) == 0x4, "Size mismatch!");
