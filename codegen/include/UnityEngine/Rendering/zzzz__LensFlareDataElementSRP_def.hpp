...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::LensFlareDataElementSRP*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareDataElementSRP*, "UnityEngine.Rendering", "LensFlareDataElementSRP");
// Dependencies System.Object, UnityEngine.Color, UnityEngine.Rendering.SRPLensFlareBlendMode, UnityEngine.Rendering.SRPLensFlareColorType, UnityEngine.Rendering.SRPLensFlareDistribution, UnityEngine.Rendering.SRPLensFlareType, UnityEngine.Vector2
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Method Clone, addr 0x1820238b0, size 0x600, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182023eb0, size 0x7e0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_count, addr 0x1803fa740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_count() ;

/// @brief Method get_edgeOffset, addr 0x180468f70, size 0x10, virtual false, abstract: false, final false
inline float_t get_edgeOffset() ;

/// @brief Method get_fallOff, addr 0x18040c370, size 0x10, virtual false, abstract: false, final false
inline float_t get_fallOff() ;

/// @brief Method get_intensityVariation, addr 0x180371800, size 0x10, virtual false, abstract: false, final false
inline float_t get_intensityVariation() ;

/// @brief Method get_localIntensity, addr 0x180356140, size 0x10, virtual false, abstract: false, final false
inline float_t get_localIntensity() ;

/// @brief Method get_sdfRoundness, addr 0x180474c50, size 0x10, virtual false, abstract: false, final false
inline float_t get_sdfRoundness() ;

/// @brief Method get_sideCount, addr 0x1812fdd20, size 0xa600, virtual false, abstract: false, final false
inline int32_t get_sideCount() ;

/// @brief Method set_count, addr 0x182024690, size 0x10, virtual false, abstract: false, final false
inline void set_count(int32_t  value) ;

/// @brief Method set_edgeOffset, addr 0x1820246a0, size 0x30, virtual false, abstract: false, final false
inline void set_edgeOffset(float_t  value) ;

/// @brief Method set_fallOff, addr 0x1820246d0, size 0x30, virtual false, abstract: false, final false
inline void set_fallOff(float_t  value) ;

/// @brief Method set_intensityVariation, addr 0x182024700, size 0x20, virtual false, abstract: false, final false
inline void set_intensityVariation(float_t  value) ;

/// @brief Method set_localIntensity, addr 0x182024720, size 0x10, virtual false, abstract: false, final false
inline void set_localIntensity(float_t  value) ;

/// @brief Method set_sdfRoundness, addr 0x182024730, size 0x30, virtual false, abstract: false, final false
inline void set_sdfRoundness(float_t  value) ;

/// @brief Method set_sideCount, addr 0x182024760, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::LensFlareDataElementSRP) == 0x120, "Size mismatch!");
