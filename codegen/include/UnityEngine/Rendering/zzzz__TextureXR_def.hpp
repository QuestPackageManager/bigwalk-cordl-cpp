...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::TextureXR*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TextureXR*, "UnityEngine.Rendering", "TextureXR");
...
/// @brief Method CreateBlackTexture3D, addr 0x182040180, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture3D> CreateBlackTexture3D(::StringW  name) ;

/// @brief Method CreateBlackUIntTextureArray, addr 0x182040230, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method CreateBlackUintTexture, addr 0x1820403c0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method CreateTexture2DArrayFromTexture2D, addr 0x182040530, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetBlackTexture, addr 0x182040690, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture() ;

/// @brief Method GetBlackTexture3D, addr 0x182040650, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture3D() ;

/// @brief Method GetBlackTextureArray, addr 0x182040670, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTextureArray() ;

/// @brief Method GetBlackUIntTexture, addr 0x182040700, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackUIntTexture() ;

/// @brief Method GetClearTexture, addr 0x182040770, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetClearTexture() ;

/// @brief Method GetMagentaTexture, addr 0x1820407e0, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetMagentaTexture() ;

/// @brief Method GetWhiteTexture, addr 0x182040850, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetWhiteTexture() ;

/// @brief Method Initialize, addr 0x1820408c0, size 0x1120, virtual false, abstract: false, final false
...
/// @brief Method get_dimension, addr 0x182041a10, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::TextureDimension get_dimension() ;

/// @brief Method get_slices, addr 0x181fd3cf0, size 0x20, virtual false, abstract: false, final false
static inline int32_t get_slices() ;

/// @brief Method get_useTexArray, addr 0x182041a70, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_maxViews, addr 0x182041ac0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::TextureXR) == 0x10, "Size mismatch!");
