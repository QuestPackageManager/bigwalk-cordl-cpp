...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool*);
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool*);
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool___c*);
...
/// @brief Field pool, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_pool, put=__cordl_internal_set_pool)) ::System::Collections::Generic::Stack_1<::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBuffer*>*  pool;
...
/// @brief Method CompareTo, addr 0x18202af20, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18202afa0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18202af40, size 0x60, virtual false, abstract: false, final false
...
constexpr ::System::IComparable_1<::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool*>* i___System__IComparable_1___UnityEngine__Rendering__ProbeVolumeScratchBufferPool_ScratchBufferPool__() noexcept;
...
/// @brief Method <AllocateScratchBuffer>b__26_0, addr 0x18202c1b0, size 0x20, virtual false, abstract: false, final false
inline bool _AllocateScratchBuffer_b__26_0(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool*  o) ;

/// @brief Method <ReleaseScratchBuffer>b__27_0, addr 0x18202c1b0, size 0x20, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool___c) == 0x10, "Size mismatch!");
...
/// @brief Field m_Layouts, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Layouts, put=__cordl_internal_set_m_Layouts)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBufferLayout>*  m_Layouts;

/// @brief Field m_Pools, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Pools, put=__cordl_internal_set_m_Pools)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool*>*  m_Pools;
...
/// @brief Method AllocateScratchBuffer, addr 0x1820257f0, size 0x310, virtual false, abstract: false, final false
inline bool AllocateScratchBuffer(int32_t  chunkCount, ::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBuffer*>  scratchBuffer, ::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBufferLayout>  layout, bool  allocateGraphicsBuffers) ;

/// @brief Method Cleanup, addr 0x182025b00, size 0xe0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateScratchBuffer, addr 0x182025be0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetOrCreateScratchBufferLayout, addr 0x182025c60, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method ReleaseScratchBuffer, addr 0x182025f90, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182026090, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_allocatedMemory, addr 0x182026180, size 0x10, virtual false, abstract: false, final false
inline int32_t get_allocatedMemory() ;

/// @brief Method get_chunkSize, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_chunkSize() ;

/// @brief Method get_maxChunkCount, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxChunkCount() ;

static inline void setStaticF_s_ChunkCount(int32_t  value) ;

/// @brief Method set_chunkSize, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_chunkSize(int32_t  value) ;

/// @brief Method set_maxChunkCount, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool) == 0x50, "Size mismatch!");
