...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CullMode, "UnityEngine.Rendering", "CullMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::CullMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CullMode) == 0x4, "Size mismatch!");
