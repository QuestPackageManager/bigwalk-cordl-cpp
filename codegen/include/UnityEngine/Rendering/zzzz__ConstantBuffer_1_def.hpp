...
inline void PushGlobal(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, ::by_ref<CBType>  data, int32_t  shaderId) ;
...
inline void UpdateData(::UnityEngine::Rendering::BaseCommandBuffer*  cmd, ::by_ref<CBType>  data) ;
