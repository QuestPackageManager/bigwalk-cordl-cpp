...
static_assert(offsetof(::UnityEngine::Rendering::OcclusionCullingCommonConfig, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::OcclusionCullingCommonConfig) == 0x4, "Size mismatch!");
