...
/// @brief Field <inlineSampler>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__inlineSampler_k__BackingField, put=__cordl_internal_set__inlineSampler_k__BackingField)) ::UnityEngine::Profiling::CustomSampler*  _inlineSampler_k__BackingField;
...
/// @brief Method Begin, addr 0x181ff2190, size 0x60, virtual false, abstract: false, final false
inline void Begin(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method End, addr 0x181ff21f0, size 0x60, virtual false, abstract: false, final false
inline void End(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TEnum>
static inline ::UnityEngine::Rendering::ProfilingSampler* Get(TEnum  marker) ;

/// @brief Method IsValid, addr 0x1819fe570, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method .ctor, addr 0x181ff2250, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_cpuElapsedTime, addr 0x181ff2320, size 0x50, virtual false, abstract: false, final false
inline float_t get_cpuElapsedTime() ;

/// @brief Method get_cpuSampleCount, addr 0x181ff2370, size 0x30, virtual false, abstract: false, final false
inline int32_t get_cpuSampleCount() ;

/// @brief Method get_gpuElapsedTime, addr 0x181ff23a0, size 0x50, virtual false, abstract: false, final false
inline float_t get_gpuElapsedTime() ;

/// @brief Method get_gpuSampleCount, addr 0x181ff23f0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_gpuSampleCount() ;

/// @brief Method get_inlineCpuElapsedTime, addr 0x181ff2420, size 0x50, virtual false, abstract: false, final false
inline float_t get_inlineCpuElapsedTime() ;

/// @brief Method get_inlineCpuSampleCount, addr 0x181ff2470, size 0x30, virtual false, abstract: false, final false
inline int32_t get_inlineCpuSampleCount() ;

/// @brief Method get_inlineSampler, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_sampler, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Profiling::CustomSampler* get_sampler() ;

/// @brief Method set_enableRecording, addr 0x181ff24a0, size 0x40, virtual false, abstract: false, final false
inline void set_enableRecording(bool  value) ;

/// @brief Method set_inlineSampler, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_sampler, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProfilingSampler) == 0x38, "Size mismatch!");
