...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MSAASamples, "UnityEngine.Rendering", "MSAASamples");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::MSAASamples, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::MSAASamples) == 0x4, "Size mismatch!");
