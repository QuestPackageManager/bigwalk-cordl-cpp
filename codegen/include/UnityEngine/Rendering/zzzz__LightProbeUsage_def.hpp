...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LightProbeUsage, "UnityEngine.Rendering", "LightProbeUsage");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::LightProbeUsage, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::LightProbeUsage) == 0x4, "Size mismatch!");
