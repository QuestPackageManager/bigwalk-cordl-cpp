...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchDrawCommandProceduralIndirect, "UnityEngine.Rendering", "BatchDrawCommandProceduralIndirect");
...
static_assert(sizeof(::UnityEngine::Rendering::BatchDrawCommandProceduralIndirect) == 0x34, "Size mismatch!");
