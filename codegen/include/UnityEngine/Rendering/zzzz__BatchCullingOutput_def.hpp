...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchCullingOutput, "UnityEngine.Rendering", "BatchCullingOutput");
...
// Ctor Parameters [CppParam { name: "drawCommands", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::BatchCullingOutputDrawCommands>", modifiers: "", def_value: None }, CppParam { name: "customCullingResult", ty: "::Unity::Collections::NativeArray_1<::System::IntPtr>", modifiers: "", def_value: None }]
constexpr BatchCullingOutput(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::BatchCullingOutputDrawCommands>  drawCommands, ::Unity::Collections::NativeArray_1<::System::IntPtr>  customCullingResult) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::BatchCullingOutput) == 0x20, "Size mismatch!");
