...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BinningConfig, "UnityEngine.Rendering", "BinningConfig");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method get_visibilityConfigCount, addr 0x182089500, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "viewCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "supportsCrossFade", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "supportsMotionCheck", ty: "bool", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::BinningConfig) == 0x8, "Size mismatch!");
