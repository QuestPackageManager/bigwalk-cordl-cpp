...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::TextureGradient*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TextureGradient*, "UnityEngine.Rendering", "TextureGradient");
...
/// @brief Method Evaluate, addr 0x18204f170, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Color Evaluate(float_t  time) ;

/// @brief Method GetTexture, addr 0x18204f1b0, size 0x200, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> GetTexture() ;

/// @brief Method GetTextureFormat, addr 0x180308dd0, size 0x10, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::TextureGradient* New_ctor(::ArrayW<::UnityEngine::GradientColorKey>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method Rebuild, addr 0x18204f3b0, size 0x3b0, virtual false, abstract: false, final false
inline void Rebuild(::ArrayW<::UnityEngine::GradientColorKey>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method Release, addr 0x18204f760, size 0x60, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method SetDirty, addr 0x18199b240, size 0x10, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetKeys, addr 0x18204f7c0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18204f890, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Gradient*  baseCurve) ;

/// @brief Method .ctor, addr 0x18204f860, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::GradientColorKey>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method get_alphaKeys, addr 0x18204f970, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientAlphaKey> get_alphaKeys() ;

/// @brief Method get_colorKeys, addr 0x18204f990, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientColorKey> get_colorKeys() ;

/// @brief Method get_textureSize, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_textureSize() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_textureSize, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::TextureGradient) == 0x38, "Size mismatch!");
