...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::AtlasAllocator*);
MARK_REF_T(::UnityEngine::Rendering::AtlasAllocator_AtlasNode*);
MARK_REF_T(::UnityEngine::Rendering::AtlasAllocator___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AtlasAllocator*, "UnityEngine.Rendering", "AtlasAllocator");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AtlasAllocator_AtlasNode*, "UnityEngine.Rendering", "AtlasAllocator/AtlasNode");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AtlasAllocator___c*, "UnityEngine.Rendering", "AtlasAllocator/<>c");
...
/// @brief Method Allocate, addr 0x18202d0f0, size 0x270, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::AtlasAllocator_AtlasNode* Allocate(::by_ref<::UnityEngine::Rendering::ObjectPool_1<::UnityEngine::Rendering::AtlasAllocator_AtlasNode*>*>  pool, int32_t  width, int32_t  height, bool  powerOfTwoPadding) ;

static inline ::UnityEngine::Rendering::AtlasAllocator_AtlasNode* New_ctor() ;

/// @brief Method Release, addr 0x18202d360, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18202d3f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <.ctor>b__6_0, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void __ctor_b__6_0(::UnityEngine::Rendering::AtlasAllocator_AtlasNode*  _) ;

/// @brief Method <.ctor>b__6_1, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::AtlasAllocator___c) == 0x10, "Size mismatch!");
...
/// @brief Field m_NodePool, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_NodePool, put=__cordl_internal_set_m_NodePool)) ::UnityEngine::Rendering::ObjectPool_1<::UnityEngine::Rendering::AtlasAllocator_AtlasNode*>*  m_NodePool;
...
/// @brief Method Allocate, addr 0x18202cea0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x18202cef0, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x18202cf40, size 0x1b0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::AtlasAllocator) == 0x30, "Size mismatch!");
