...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchDrawCommandProcedural, "UnityEngine.Rendering", "BatchDrawCommandProcedural");
...
static_assert(sizeof(::UnityEngine::Rendering::BatchDrawCommandProcedural) == 0x30, "Size mismatch!");
