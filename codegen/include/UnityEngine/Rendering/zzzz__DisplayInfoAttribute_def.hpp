...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DisplayInfoAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DisplayInfoAttribute*, "UnityEngine.Rendering", "DisplayInfoAttribute");
...
static_assert(sizeof(::UnityEngine::Rendering::DisplayInfoAttribute) == 0x20, "Size mismatch!");
