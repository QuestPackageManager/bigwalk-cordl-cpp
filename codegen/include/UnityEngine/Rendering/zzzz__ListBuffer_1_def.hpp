...
// Ctor Parameters [CppParam { name: "m_BufferPtr", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "m_Capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CountPtr", ty: "int32_t*", modifiers: "", def_value: None }]
