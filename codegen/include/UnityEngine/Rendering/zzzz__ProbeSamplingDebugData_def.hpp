...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeSamplingDebugData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeSamplingDebugData*, "UnityEngine.Rendering", "ProbeSamplingDebugData");
...
/// @brief Method .ctor, addr 0x1820137f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeSamplingDebugData) == 0x38, "Size mismatch!");
