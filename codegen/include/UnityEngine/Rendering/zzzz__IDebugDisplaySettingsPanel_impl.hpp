...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::UnityEngine::Rendering::IDebugDisplaySettingsPanel::*)()>(&::UnityEngine::Rendering::IDebugDisplaySettingsPanel::get_PanelName)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::IDebugDisplaySettingsPanel*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<::UnityEngine::Rendering::DebugUI_Widget*> (::UnityEngine::Rendering::IDebugDisplaySettingsPanel::*)()>(&::UnityEngine::Rendering::IDebugDisplaySettingsPanel::get_Widgets)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::DebugUI_Flags (::UnityEngine::Rendering::IDebugDisplaySettingsPanel::*)()>(&::UnityEngine::Rendering::IDebugDisplaySettingsPanel::get_Flags)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
