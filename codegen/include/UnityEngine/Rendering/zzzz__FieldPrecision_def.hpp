...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FieldPrecision, "UnityEngine.Rendering", "FieldPrecision");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::FieldPrecision, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::FieldPrecision) == 0x4, "Size mismatch!");
