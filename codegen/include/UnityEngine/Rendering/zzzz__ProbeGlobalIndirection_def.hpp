...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeGlobalIndirection*);
MARK_VAL_T(::UnityEngine::Rendering::ProbeGlobalIndirection_IndexMetaData);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeGlobalIndirection*, "UnityEngine.Rendering", "ProbeGlobalIndirection");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeGlobalIndirection_IndexMetaData, "UnityEngine.Rendering", "ProbeGlobalIndirection/IndexMetaData");
...
/// @brief Method Pack, addr 0x18200d840, size 0x120, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "minLocalIdx", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: None }, CppParam { name: "maxLocalIdxPlusOne", ty: "::UnityEngine::Vector3Int", modifiers: "", def_value: None }, CppParam { name: "firstChunkIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minSubdiv", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeGlobalIndirection_IndexMetaData) == 0x20, "Size mismatch!");
...
/// @brief Field m_IndexOfIndicesData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_IndexOfIndicesData, put=__cordl_internal_set_m_IndexOfIndicesData)) ::ArrayW<uint32_t>  m_IndexOfIndicesData;
...
/// @brief Method Cleanup, addr 0x182012f40, size 0x30, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method GetFlatIdxForEntry, addr 0x182012f70, size 0x70, virtual false, abstract: false, final false
inline int32_t GetFlatIdxForEntry(::UnityEngine::Vector3Int  entryPosition) ;

/// @brief Method GetFlatIndex, addr 0x182012fe0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetFlatIndex(::UnityEngine::Vector3Int  normalizedPos) ;

/// @brief Method GetFlatIndicesForCell, addr 0x182013000, size 0x1f0, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> GetFlatIndicesForCell(::UnityEngine::Vector3Int  cellPosition) ;

/// @brief Method GetGlobalIndirectionDimension, addr 0x1803f2bc0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int GetGlobalIndirectionDimension() ;

/// @brief Method GetGlobalIndirectionMinEntry, addr 0x1820131f0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int GetGlobalIndirectionMinEntry() ;

/// @brief Method GetMinMaxEntry, addr 0x182013210, size 0x30, virtual false, abstract: false, final false
inline void GetMinMaxEntry(::by_ref<::UnityEngine::Vector3Int>  minEntry, ::by_ref<::UnityEngine::Vector3Int>  maxEntry) ;

/// @brief Method GetRuntimeResources, addr 0x182013240, size 0x50, virtual false, abstract: false, final false
inline void GetRuntimeResources(::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method MarkEntriesAsUnloaded, addr 0x182013290, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method PushComputeData, addr 0x182013300, size 0x30, virtual false, abstract: false, final false
inline void PushComputeData() ;

/// @brief Method UpdateCell, addr 0x182013330, size 0x220, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_m_IndexOfIndicesData() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_m_IndexOfIndicesData() ;
...
constexpr void __cordl_internal_set_m_IndexOfIndicesData(::ArrayW<uint32_t>  value) ;

constexpr void __cordl_internal_set_m_NeedUpdateComputeBuffer(bool  value) ;

/// @brief Method .ctor, addr 0x182013550, size 0x230, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3Int  cellMin, ::UnityEngine::Vector3Int  cellMax, int32_t  cellSizeInMinBricks) ;

/// @brief Method get_entriesPerCellDimension, addr 0x182013780, size 0x40, virtual false, abstract: false, final false
inline int32_t get_entriesPerCellDimension() ;

/// @brief Method get_entrySizeInBricks, addr 0x1820137c0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field m_IndexOfIndicesData, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<uint32_t>  ___m_IndexOfIndicesData;
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeGlobalIndirection) == 0x58, "Size mismatch!");
