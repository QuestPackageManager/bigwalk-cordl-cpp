...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BuiltinShaderDefine, "UnityEngine.Rendering", "BuiltinShaderDefine");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::BuiltinShaderDefine, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BuiltinShaderDefine) == 0x4, "Size mismatch!");
