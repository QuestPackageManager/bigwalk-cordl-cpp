...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerHBox*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerHBox*, "UnityEngine.Rendering.UI", "DebugUIHandlerHBox");
...
/// @brief Method Next, addr 0x18207f990, size 0x90, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next() ;

/// @brief Method OnSelection, addr 0x18207fa20, size 0x80, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x18207faa0, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerHBox) == 0x68, "Size mismatch!");
