...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerMessageBox*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerMessageBox*, "UnityEngine.Rendering.UI", "DebugUIHandlerMessageBox");
...
/// @brief Method OnSelection, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x182080140, size 0x170, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Update, addr 0x1820802b0, size 0x40, virtual false, abstract: false, final false
inline void Update() ;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerMessageBox) == 0x70, "Size mismatch!");
