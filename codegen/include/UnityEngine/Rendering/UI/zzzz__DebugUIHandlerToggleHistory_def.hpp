...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory*);
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory__RefreshAfterSanitization_d__4*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory*, "UnityEngine.Rendering.UI", "DebugUIHandlerToggleHistory");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory__RefreshAfterSanitization_d__4*, "UnityEngine.Rendering.UI", "DebugUIHandlerToggleHistory/<RefreshAfterSanitization>d__4");
...
/// @brief Method MoveNext, addr 0x182088040, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory__RefreshAfterSanitization_d__4) == 0x28, "Size mismatch!");

} // namespace end def UnityEngine::Rendering::UI
// Dependencies UnityEngine.Rendering.UI.DebugUIHandlerToggle, UnityEngine.UI.Toggle
namespace UnityEngine::Rendering::UI {
// Is value type: false
...
/// @brief Field historyToggles, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_historyToggles, put=__cordl_internal_set_historyToggles)) ::ArrayW<::UnityW<::UnityEngine::UI::Toggle>>  historyToggles;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory* New_ctor() ;

/// @brief Method RefreshAfterSanitization, addr 0x182081be0, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* RefreshAfterSanitization() ;

/// @brief Method SetWidget, addr 0x182081c30, size 0x490, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x1820820c0, size 0x180, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Toggle>>& __cordl_internal_get_historyToggles() ;
...
/// @brief Field historyToggles, offset: 0x80, size: 0x8, def value: None
 ::ArrayW<::UnityW<::UnityEngine::UI::Toggle>>  ___historyToggles;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerToggleHistory) == 0x88, "Size mismatch!");
