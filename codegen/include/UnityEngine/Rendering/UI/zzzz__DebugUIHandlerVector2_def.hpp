...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerVector2*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerVector2*, "UnityEngine.Rendering.UI", "DebugUIHandlerVector2");
...
/// @brief Method Next, addr 0x182082da0, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method OnSelection, addr 0x182082e50, size 0xa0, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetValue, addr 0x182082ef0, size 0x90, virtual false, abstract: false, final false
inline void SetValue(float_t  v, bool  x, bool  y) ;

/// @brief Method SetWidget, addr 0x182082f80, size 0x1d0, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method SetupSettings, addr 0x182083150, size 0xf0, virtual false, abstract: false, final false
inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*  field) ;

/// @brief Method <SetWidget>b__6_0, addr 0x182083240, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__6_0() ;

/// @brief Method <SetWidget>b__6_1, addr 0x182083270, size 0x60, virtual false, abstract: false, final false
inline void _SetWidget_b__6_1(float_t  x) ;

/// @brief Method <SetWidget>b__6_2, addr 0x1820832d0, size 0x30, virtual false, abstract: false, final false
inline float_t _SetWidget_b__6_2() ;

/// @brief Method <SetWidget>b__6_3, addr 0x182083300, size 0x60, virtual false, abstract: false, final false
inline void _SetWidget_b__6_3(float_t  x) ;

/// @brief Method <SetupSettings>b__8_0, addr 0x182083360, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__8_0() ;

/// @brief Method <SetupSettings>b__8_1, addr 0x182083370, size 0x10, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__8_1() ;

/// @brief Method <SetupSettings>b__8_2, addr 0x182083380, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerVector2) == 0x90, "Size mismatch!");
