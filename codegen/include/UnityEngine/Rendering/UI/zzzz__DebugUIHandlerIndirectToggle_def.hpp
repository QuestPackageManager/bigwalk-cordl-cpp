...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectToggle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectToggle*, "UnityEngine.Rendering.UI", "DebugUIHandlerIndirectToggle");
...
/// @brief Method Init, addr 0x18207fc90, size 0xa0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerIndirectToggle* New_ctor() ;

/// @brief Method OnAction, addr 0x18207fd30, size 0x90, virtual true, abstract: false, final false
inline void OnAction() ;

/// @brief Method OnDeselection, addr 0x18207fdc0, size 0x60, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnSelection, addr 0x18207fe20, size 0x60, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method OnToggleValueChanged, addr 0x18207fe80, size 0x30, virtual false, abstract: false, final false
inline void OnToggleValueChanged(bool  value) ;

/// @brief Method UpdateValueLabel, addr 0x18207feb0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectToggle) == 0x90, "Size mismatch!");
