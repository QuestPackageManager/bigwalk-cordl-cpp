...
/// @brief Method GetValue, addr 0x18207baf0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SetValue, addr 0x18207bd00, size 0x130, virtual false, abstract: false, final false
inline void SetValue(int32_t  index, bool  value) ;

/// @brief Method SetWidget, addr 0x18207be30, size 0x280, virtual true, abstract: false, final false
