...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*, "UnityEngine.Rendering.UI", "DebugUIHandlerIndirectFloatField");
...
/// @brief Method ChangeValue, addr 0x18207fae0, size 0xc0, virtual false, abstract: false, final false
inline void ChangeValue(bool  fast, float_t  multiplier) ;

/// @brief Method Init, addr 0x18207fba0, size 0x10, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField* New_ctor() ;

/// @brief Method OnDecrement, addr 0x18207fbb0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method OnIncrement, addr 0x18207fbc0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method UpdateValueLabel, addr 0x18207fbd0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField) == 0x98, "Size mismatch!");
