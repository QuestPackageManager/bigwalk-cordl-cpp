...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerToggle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerToggle*, "UnityEngine.Rendering.UI", "DebugUIHandlerToggle");
...
/// @brief Method OnAction, addr 0x182082240, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method OnToggleValueChanged, addr 0x182082290, size 0x20, virtual false, abstract: false, final false
inline void OnToggleValueChanged(bool  value) ;

/// @brief Method SetWidget, addr 0x1820822b0, size 0xd0, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x182082380, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerToggle) == 0x80, "Size mismatch!");
