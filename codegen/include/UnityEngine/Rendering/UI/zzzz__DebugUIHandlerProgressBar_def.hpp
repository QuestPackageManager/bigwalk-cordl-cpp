...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerProgressBar*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerProgressBar*, "UnityEngine.Rendering.UI", "DebugUIHandlerProgressBar");
...
/// @brief Method SetWidget, addr 0x1820810d0, size 0x70, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Update, addr 0x182081250, size 0x70, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateValue, addr 0x182081140, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerProgressBar) == 0x88, "Size mismatch!");
