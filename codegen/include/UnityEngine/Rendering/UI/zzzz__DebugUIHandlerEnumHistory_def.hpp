...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerEnumHistory*);
...
/// @brief Method MoveNext, addr 0x1820880c0, size 0xe0, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerEnumHistory__RefreshAfterSanitization_d__4) == 0x28, "Size mismatch!");

} // namespace end def UnityEngine::Rendering::UI
// Dependencies UnityEngine.Rendering.UI.DebugUIHandlerEnumField, UnityEngine.UI.Text
namespace UnityEngine::Rendering::UI {
// Is value type: false
...
/// @brief Field historyValues, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_historyValues, put=__cordl_internal_set_historyValues)) ::ArrayW<::UnityW<::UnityEngine::UI::Text>>  historyValues;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerEnumHistory* New_ctor() ;

/// @brief Method RefreshAfterSanitization, addr 0x18207ea10, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* RefreshAfterSanitization() ;

/// @brief Method SetWidget, addr 0x18207ea60, size 0x2a0, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x18207ed00, size 0x1d0, virtual true, abstract: false, final false
inline void UpdateValueLabel() ;

constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Text>> const& __cordl_internal_get_historyValues() const;

constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Text>>& __cordl_internal_get_historyValues() ;
...
/// @brief Field historyValues, offset: 0x88, size: 0x8, def value: None
 ::ArrayW<::UnityW<::UnityEngine::UI::Text>>  ___historyValues;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerEnumHistory) == 0x90, "Size mismatch!");
