...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerObject*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerObject*, "UnityEngine.Rendering.UI", "DebugUIHandlerObject");
...
/// @brief Method SetWidget, addr 0x182080600, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerObject) == 0x70, "Size mismatch!");
