...
/// @brief Field <nextUIHandler>k__BackingField, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__nextUIHandler_k__BackingField, put=__cordl_internal_set__nextUIHandler_k__BackingField)) ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>  _nextUIHandler_k__BackingField;

/// @brief Field <parentUIHandler>k__BackingField, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__parentUIHandler_k__BackingField, put=__cordl_internal_set__parentUIHandler_k__BackingField)) ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>  _parentUIHandler_k__BackingField;

/// @brief Field <previousUIHandler>k__BackingField, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__previousUIHandler_k__BackingField, put=__cordl_internal_set__previousUIHandler_k__BackingField)) ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>  _previousUIHandler_k__BackingField;
...
/// @brief Method GetWidget, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x182084490, size 0xa0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next() ;

/// @brief Method OnAction, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnAction() ;

/// @brief Method OnDecrement, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnDeselection, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnEnable, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnIncrement, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method OnSelection, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method Previous, addr 0x182084530, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Previous() ;

/// @brief Method SetWidget, addr 0x1802f8080, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_nextUIHandler, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_nextUIHandler() ;

/// @brief Method get_parentUIHandler, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_parentUIHandler() ;

/// @brief Method get_previousUIHandler, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_previousUIHandler() ;

/// @brief Method set_nextUIHandler, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
inline void set_nextUIHandler(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  value) ;

/// @brief Method set_parentUIHandler, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_parentUIHandler(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  value) ;

/// @brief Method set_previousUIHandler, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerWidget) == 0x60, "Size mismatch!");
