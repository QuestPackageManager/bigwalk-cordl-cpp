...
/// @brief Method <ActivatePanel>b__15_0, addr 0x1820881a0, size 0x20, virtual false, abstract: false, final false
inline void _ActivatePanel_b__15_0(::UnityEngine::Rendering::UI::DebugUIHandlerPanel*  p) ;

/// @brief Method <Rebuild>b__12_0, addr 0x1820881c0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method <GetWidgetFromPath>b__0, addr 0x182088200, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ActivatePanel, addr 0x18207c190, size 0x180, virtual false, abstract: false, final false
inline void ActivatePanel(int32_t  index, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  selectedWidget) ;

/// @brief Method ActivateSelection, addr 0x18207c310, size 0x40, virtual false, abstract: false, final false
inline void ActivateSelection() ;

/// @brief Method ChangeSelection, addr 0x18207c3e0, size 0x190, virtual false, abstract: false, final false
inline void ChangeSelection(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget, bool  fromNext) ;

/// @brief Method ChangeSelectionValue, addr 0x18207c350, size 0x90, virtual false, abstract: false, final false
inline void ChangeSelectionValue(float_t  multiplier) ;

/// @brief Method GetWidgetFromPath, addr 0x18207c570, size 0xc0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetWidgetFromPath(::StringW  queryPath) ;

/// @brief Method HandleInput, addr 0x18207c630, size 0x230, virtual false, abstract: false, final false
inline void HandleInput() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerCanvas* New_ctor() ;

/// @brief Method OnEnable, addr 0x18207c860, size 0xd0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Rebuild, addr 0x18207c930, size 0x4e0, virtual false, abstract: false, final false
inline void Rebuild() ;

/// @brief Method RequestHierarchyReset, addr 0x1803b6220, size 0x10, virtual false, abstract: false, final false
inline void RequestHierarchyReset() ;

/// @brief Method ResetAllHierarchy, addr 0x18207ce10, size 0x1c0, virtual false, abstract: false, final false
inline void ResetAllHierarchy() ;

/// @brief Method SelectNextItem, addr 0x18207cfd0, size 0x70, virtual false, abstract: false, final false
inline void SelectNextItem() ;

/// @brief Method SelectNextPanel, addr 0x18207d040, size 0x40, virtual false, abstract: false, final false
inline void SelectNextPanel() ;

/// @brief Method SelectPreviousItem, addr 0x18207d080, size 0x70, virtual false, abstract: false, final false
inline void SelectPreviousItem() ;

/// @brief Method SelectPreviousPanel, addr 0x18207d0f0, size 0x50, virtual false, abstract: false, final false
inline void SelectPreviousPanel() ;

/// @brief Method SetScrollTarget, addr 0x18207d140, size 0x70, virtual false, abstract: false, final false
inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget) ;

/// @brief Method Traverse, addr 0x18207d1b0, size 0x3f0, virtual false, abstract: false, final false
inline void Traverse(::UnityEngine::Rendering::DebugUI_IContainer*  container, ::UnityEngine::Transform*  parentTransform, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  parentUIHandler, ::by_ref<::UnityEngine::Rendering::UI::DebugUIHandlerWidget*>  selectedHandler) ;

/// @brief Method Update, addr 0x18207d5a0, size 0x1e0, virtual false, abstract: false, final false
inline void Update() ;
