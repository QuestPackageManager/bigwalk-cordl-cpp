...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField*, "UnityEngine.Rendering.UI", "DebugUIHandlerUIntField");
...
/// @brief Field m_Field, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Field, put=__cordl_internal_set_m_Field)) ::UnityEngine::Rendering::DebugUI_UIntField*  m_Field;
...
/// @brief Method ChangeValue, addr 0x1820823d0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method OnDecrement, addr 0x182082450, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method OnIncrement, addr 0x1820824c0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method SetWidget, addr 0x182082520, size 0x70, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x182082590, size 0x80, virtual false, abstract: false, final false
inline void UpdateValueLabel() ;

constexpr ::UnityEngine::Rendering::DebugUI_UIntField* const& __cordl_internal_get_m_Field() const;

constexpr ::UnityEngine::Rendering::DebugUI_UIntField*& __cordl_internal_get_m_Field() ;
...
constexpr void __cordl_internal_set_m_Field(::UnityEngine::Rendering::DebugUI_UIntField*  value) ;
...
/// @brief Field m_Field, offset: 0x70, size: 0x8, def value: None
 ::UnityEngine::Rendering::DebugUI_UIntField*  ___m_Field;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField, ___nameLabel) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField, ___valueLabel) == 0x68, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField, ___m_Field) == 0x70, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerUIntField) == 0x78, "Size mismatch!");
