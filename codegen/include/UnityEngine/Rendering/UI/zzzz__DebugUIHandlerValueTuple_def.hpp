...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerValueTuple*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerValueTuple*, "UnityEngine.Rendering.UI", "DebugUIHandlerValueTuple");
// Dependencies UnityEngine.Color, UnityEngine.Rendering.UI.DebugUIHandlerWidget, UnityEngine.UI.Text
namespace UnityEngine::Rendering::UI {
// Is value type: false
...
/// @brief Field valueElements, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_valueElements, put=__cordl_internal_set_valueElements)) ::ArrayW<::UnityW<::UnityEngine::UI::Text>>  valueElements;
...
/// @brief Method OnEnable, addr 0x1813aa340, size 0x1760, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSelection, addr 0x18207c0f0, size 0x40, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x182082610, size 0x320, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Update, addr 0x182082ae0, size 0x90, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateValueLabels, addr 0x182082930, size 0x1b0, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Text>> const& __cordl_internal_get_valueElements() const;

constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Text>>& __cordl_internal_get_valueElements() ;
...
constexpr void __cordl_internal_set_valueElements(::ArrayW<::UnityW<::UnityEngine::UI::Text>>  value) ;
...
/// @brief Field valueElements, offset: 0x78, size: 0x8, def value: None
 ::ArrayW<::UnityW<::UnityEngine::UI::Text>>  ___valueElements;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerValueTuple) == 0x88, "Size mismatch!");
