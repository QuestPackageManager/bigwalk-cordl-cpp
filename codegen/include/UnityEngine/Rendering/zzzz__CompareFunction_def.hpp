...
static_assert(offsetof(::UnityEngine::Rendering::CompareFunction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CompareFunction) == 0x4, "Size mismatch!");
