...
public:
// Declarations
/// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x1820aa320, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CPUInstanceToGPUInstance, addr 0x1820aa3e0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method .ctor, addr 0x1820aade0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x18209edd0, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method AsReadOnly, addr 0x1802e2d70, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly AsReadOnly() ;

/// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x1820a1360, size 0x90, virtual false, abstract: false, final false
inline void CPUInstanceArrayToGPUInstanceArray(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>  gpuInstanceIndices) ;

/// @brief Method CPUInstanceToGPUInstance, addr 0x1820a1460, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method CPUInstanceToGPUInstance, addr 0x1820a13f0, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::by_ref<::Unity::Collections::NativeArray_1<int32_t>>  instancesNumPrefixSum, ::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method Dispose, addr 0x1820a14d0, size 0x100, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GPUInstanceToCPUInstance, addr 0x1820a15d0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetGpuAddress, addr 0x1820a16d0, size 0x60, virtual false, abstract: false, final false
inline int32_t GetGpuAddress(int32_t  propertyID, bool  assertOnFail) ;

/// @brief Method GetGpuAddress, addr 0x1820a1670, size 0x60, virtual false, abstract: false, final false
inline int32_t GetGpuAddress(::StringW  strName, bool  assertOnFail) ;

/// @brief Method GetPropertyIndex, addr 0x1820a1730, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method NextVersion, addr 0x1820a1770, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_valid, addr 0x181458390, size 0x20, virtual false, abstract: false, final false
