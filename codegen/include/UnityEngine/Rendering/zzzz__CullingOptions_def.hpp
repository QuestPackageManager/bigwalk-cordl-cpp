...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CullingOptions, "UnityEngine.Rendering", "CullingOptions");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::CullingOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CullingOptions) == 0x4, "Size mismatch!");
