...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MetadataValue, "UnityEngine.Rendering", "MetadataValue");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::MetadataValue) == 0x8, "Size mismatch!");
