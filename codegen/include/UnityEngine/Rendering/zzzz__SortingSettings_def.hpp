...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SortingSettings, "UnityEngine.Rendering", "SortingSettings");
...
/// @brief Method Equals, addr 0x1822b5020, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822b4ef0, size 0x130, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::SortingSettings  other) ;

/// @brief Method GetHashCode, addr 0x1822b50d0, size 0xe0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1822b51b0, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Camera*  camera) ;

/// @brief Method get_criteria, addr 0x1802e0b20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_criteria, addr 0x1802e0d10, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_WorldToCameraMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_CameraPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "m_CustomAxis", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "m_Criteria", ty: "::UnityEngine::Rendering::SortingCriteria", modifiers: "", def_value: None }, CppParam { name: "m_DistanceMetric", ty: "::UnityEngine::Rendering::DistanceMetric", modifiers: "", def_value: None }]
constexpr SortingSettings(::UnityEngine::Matrix4x4  m_WorldToCameraMatrix, ::UnityEngine::Vector3  m_CameraPosition, ::UnityEngine::Vector3  m_CustomAxis, ::UnityEngine::Rendering::SortingCriteria  m_Criteria, ::UnityEngine::Rendering::DistanceMetric  m_DistanceMetric) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::SortingSettings) == 0x60, "Size mismatch!");
