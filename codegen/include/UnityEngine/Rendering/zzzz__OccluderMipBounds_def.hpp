...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OccluderMipBounds, "UnityEngine.Rendering", "OccluderMipBounds");
...
static_assert(sizeof(::UnityEngine::Rendering::OccluderMipBounds) == 0x10, "Size mismatch!");
