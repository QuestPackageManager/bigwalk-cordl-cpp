...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OcclusionTestComputeShader, "UnityEngine.Rendering", "OcclusionTestComputeShader");
...
public:
// Declarations
/// @brief Method Init, addr 0x1820b5a30, size 0xb0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "cs", ty: "::UnityW<::UnityEngine::ComputeShader>", modifiers: "", def_value: None }, CppParam { name: "occlusionDebugKeyword", ty: "::UnityEngine::Rendering::LocalKeyword", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::OcclusionTestComputeShader) == 0x20, "Size mismatch!");
