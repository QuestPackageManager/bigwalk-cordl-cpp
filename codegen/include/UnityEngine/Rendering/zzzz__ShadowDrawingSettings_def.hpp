...
/// @brief Method Equals, addr 0x1822b4300, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822b40c0, size 0x240, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ShadowDrawingSettings  other) ;

/// @brief Method GetHashCode, addr 0x1822b4400, size 0x100, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1822b4500, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method set_useRenderingLayerMaskTest, addr 0x1822a92b0, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_CullingResults", ty: "::UnityEngine::Rendering::CullingResults", modifiers: "", def_value: None }, CppParam { name: "m_LightIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_SplitIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_UseRenderingLayerMaskTest", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_BatchLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_SplitData", ty: "::UnityEngine::Rendering::ShadowSplitData", modifiers: "", def_value: None }, CppParam { name: "m_ObjectsFilter", ty: "::UnityEngine::ShadowObjectsFilter", modifiers: "", def_value: None }, CppParam { name: "m_ProjectionType", ty: "::UnityEngine::Rendering::BatchCullingProjectionType", modifiers: "", def_value: None }]
constexpr ShadowDrawingSettings(::UnityEngine::Rendering::CullingResults  m_CullingResults, int32_t  m_LightIndex, int32_t  m_SplitIndex, int32_t  m_UseRenderingLayerMaskTest, uint32_t  m_BatchLayerMask, ::UnityEngine::Rendering::ShadowSplitData  m_SplitData, ::UnityEngine::ShadowObjectsFilter  m_ObjectsFilter, ::UnityEngine::Rendering::BatchCullingProjectionType  m_ProjectionType) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::ShadowDrawingSettings) == 0x128, "Size mismatch!");
