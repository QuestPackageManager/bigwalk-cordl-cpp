...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IndirectBufferLimits, "UnityEngine.Rendering", "IndirectBufferLimits");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::IndirectBufferLimits) == 0x8, "Size mismatch!");
