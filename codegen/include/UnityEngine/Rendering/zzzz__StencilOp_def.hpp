...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::StencilOp, "UnityEngine.Rendering", "StencilOp");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::StencilOp, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::StencilOp) == 0x4, "Size mismatch!");
