...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer, "UnityEngine.Rendering", "SpeedTreeWindParamsBufferIterator/<uintParamOffsets>e__FixedBuffer");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "bufferPtr", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "uintParamOffsets", ty: "::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "uintStride", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "elementOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "elementsCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr SpeedTreeWindParamsBufferIterator(::System::IntPtr  bufferPtr, ::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer  uintParamOffsets, int32_t  uintStride, int32_t  elementOffset, int32_t  elementsCount) noexcept;
