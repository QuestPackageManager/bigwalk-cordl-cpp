...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BottleneckHistogram, "UnityEngine.Rendering", "BottleneckHistogram");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "PresentLimited", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "CPU", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "GPU", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "Balanced", ty: "float_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::BottleneckHistogram) == 0x10, "Size mismatch!");
