...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DistanceMetric, "UnityEngine.Rendering", "DistanceMetric");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DistanceMetric, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DistanceMetric) == 0x4, "Size mismatch!");
