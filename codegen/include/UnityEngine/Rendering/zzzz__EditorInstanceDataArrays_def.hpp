...
static_assert(sizeof(::UnityEngine::Rendering::EditorInstanceDataArrays_ReadOnly) == 0x1, "Size mismatch!");
...
/// @brief Method Grow, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void Remove(int32_t  index, int32_t  lastIndex) ;

/// @brief Method SetDefault, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
