...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::AABB, "UnityEngine.Rendering", "AABB");
...
/// @brief Method RotateExtents, addr 0x1814e2c50, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x182088740, size 0x90, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Transform, addr 0x1820887d0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method get_max, addr 0x182088990, size 0x80, virtual false, abstract: false, final false
inline ::Unity::Mathematics::float3 get_max() ;

/// @brief Method get_min, addr 0x182088a10, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::AABB) == 0x18, "Size mismatch!");
