...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchBufferTarget, "UnityEngine.Rendering", "BatchBufferTarget");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::BatchBufferTarget, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BatchBufferTarget) == 0x4, "Size mismatch!");
