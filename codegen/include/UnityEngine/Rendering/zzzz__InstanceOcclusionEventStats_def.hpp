...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::InstanceOcclusionEventStats, "UnityEngine.Rendering", "InstanceOcclusionEventStats");
...
// Ctor Parameters [CppParam { name: "viewInstanceID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "eventType", ty: "::UnityEngine::Rendering::InstanceOcclusionEventType", modifiers: "", def_value: None }, CppParam { name: "occluderVersion", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "subviewMask", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "occlusionTest", ty: "::UnityEngine::Rendering::OcclusionTest", modifiers: "", def_value: None }, CppParam { name: "visibleInstances", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "culledInstances", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "visiblePrimitives", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "culledPrimitives", ty: "int32_t", modifiers: "", def_value: None }]
