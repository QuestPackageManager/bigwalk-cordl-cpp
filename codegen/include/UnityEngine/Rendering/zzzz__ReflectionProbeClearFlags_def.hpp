...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReflectionProbeClearFlags, "UnityEngine.Rendering", "ReflectionProbeClearFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ReflectionProbeClearFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ReflectionProbeClearFlags) == 0x4, "Size mismatch!");
