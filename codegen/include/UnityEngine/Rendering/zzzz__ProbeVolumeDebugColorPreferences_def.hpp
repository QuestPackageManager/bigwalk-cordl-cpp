...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeVolumeDebugColorPreferences*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeDebugColorPreferences*, "UnityEngine.Rendering", "ProbeVolumeDebugColorPreferences");
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeDebugColorPreferences) == 0x10, "Size mismatch!");
