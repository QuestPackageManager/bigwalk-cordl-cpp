...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUInstanceDataBufferUploader_GPUResources, "UnityEngine.Rendering", "GPUInstanceDataBufferUploader/GPUResources");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUInstanceDataBufferUploader_WriteInstanceDataParameterJob, "UnityEngine.Rendering", "GPUInstanceDataBufferUploader/WriteInstanceDataParameterJob");
...
/// @brief Method CreateResources, addr 0x1820a1810, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1820a19e0, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method LoadShaders, addr 0x1820a1ad0, size 0xc0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "instanceData", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "instanceIndices", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "inputComponentOffsets", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "validComponentIndices", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "cs", ty: "::UnityW<::UnityEngine::ComputeShader>", modifiers: "", def_value: None }, CppParam { name: "kernelId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_InstanceDataByteSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_InstanceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ComponentCounts", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ValidComponentIndicesCount", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x1820acba0, size 0x110, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "gatherData", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "parameterIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "uintPerParameter", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "uintPerInstance", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "componentDataIndex", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "gatherIndices", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instanceData", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "tmpDataBuffer", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::GPUInstanceDataBufferUploader_WriteInstanceDataParameterJob) == 0x50, "Size mismatch!");
...
/// @brief Method AllocateUploadHandles, addr 0x1804bd900, size 0x10, virtual false, abstract: false, final false
inline void AllocateUploadHandles(int32_t  handlesLength) ;

/// @brief Method Dispose, addr 0x1820a0b40, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetParamUIntOffset, addr 0x1820a0bd0, size 0x20, virtual false, abstract: false, final false
inline int32_t GetParamUIntOffset(int32_t  parameterIndex) ;

/// @brief Method GetUIntPerInstance, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetUIntPerInstance() ;

/// @brief Method GetUploadBufferPtr, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SubmitToGpu, addr 0x1820a0bf0, size 0x3a0, virtual false, abstract: false, final false
inline void SubmitToGpu(::UnityEngine::Rendering::GPUInstanceDataBuffer*  instanceDataBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>  gpuInstanceIndices, ::by_ref<::UnityEngine::Rendering::GPUInstanceDataBufferUploader_GPUResources>  gpuResources, bool  submitOnlyWrittenParams) ;

/// @brief Method SubmitToGpu, addr 0x1820a0f90, size 0x170, virtual false, abstract: false, final false
inline void SubmitToGpu(::UnityEngine::Rendering::GPUInstanceDataBuffer*  instanceDataBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::by_ref<::UnityEngine::Rendering::GPUInstanceDataBufferUploader_GPUResources>  gpuResources, bool  submitOnlyWrittenParams) ;
...
/// @brief Method .ctor, addr 0x1820a1100, size 0x260, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceComponentDesc>>  descriptions, int32_t  capacity, ::UnityEngine::Rendering::InstanceType  instanceType) ;
...
// Ctor Parameters [CppParam { name: "m_UintPerInstance", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Capacity", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_InstanceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ComponentIsInstanced", ty: "::Unity::Collections::NativeArray_1<bool>", modifiers: "", def_value: None }, CppParam { name: "m_ComponentDataIndex", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_DescriptionsUintSize", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_TmpDataBuffer", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "m_WritenComponentIndices", ty: "::Unity::Collections::NativeList_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_DummyArray", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
