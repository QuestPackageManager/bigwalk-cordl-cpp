...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DefaultReflectionMode, "UnityEngine.Rendering", "DefaultReflectionMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DefaultReflectionMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DefaultReflectionMode) == 0x4, "Size mismatch!");
