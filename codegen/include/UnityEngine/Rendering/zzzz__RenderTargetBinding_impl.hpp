...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier> (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_colorRenderTargets)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1803a88d0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEngine::Rendering::RenderTargetBinding>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::RenderTargetIdentifier (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_depthRenderTarget)> {
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction> (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_colorLoadActions)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction> (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_colorStoreActions)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::RenderBufferLoadAction (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_depthLoadAction)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::RenderBufferStoreAction (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_depthStoreAction)> {
  constexpr static std::size_t size = 0x10;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::Rendering::RenderTargetFlags (::UnityEngine::Rendering::RenderTargetBinding::*)()>(&::UnityEngine::Rendering::RenderTargetBinding::get_flags)> {
  constexpr static std::size_t size = 0x10;
...
// Ctor Parameters [CppParam { name: "m_ColorRenderTargets", ty: "::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_DepthRenderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ColorLoadActions", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ColorStoreActions", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_DepthLoadAction", ty: "::UnityEngine::Rendering::RenderBufferLoadAction", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_DepthStoreAction", ty: "::UnityEngine::Rendering::RenderBufferStoreAction", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Flags", ty: "::UnityEngine::Rendering::RenderTargetFlags", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::RenderTargetBinding::RenderTargetBinding(::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier>  m_ColorRenderTargets, ::UnityEngine::Rendering::RenderTargetIdentifier  m_DepthRenderTarget, ::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction>  m_ColorLoadActions, ::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction>  m_ColorStoreActions, ::UnityEngine::Rendering::RenderBufferLoadAction  m_DepthLoadAction, ::UnityEngine::Rendering::RenderBufferStoreAction  m_DepthStoreAction, ::UnityEngine::Rendering::RenderTargetFlags  m_Flags) noexcept  {
