...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::HDRRangeReduction, "UnityEngine.Rendering", "HDRRangeReduction");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::HDRRangeReduction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::HDRRangeReduction) == 0x4, "Size mismatch!");
