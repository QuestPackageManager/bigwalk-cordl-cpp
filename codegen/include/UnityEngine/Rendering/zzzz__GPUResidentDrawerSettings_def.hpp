...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUResidentDrawerSettings, "UnityEngine.Rendering", "GPUResidentDrawerSettings");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUResidentDrawerSettings) == 0x18, "Size mismatch!");
