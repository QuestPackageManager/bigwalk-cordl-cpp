...
// Dependencies System.IntPtr, Unity.Jobs.JobHandle, UnityEngine.Matrix4x4, UnityEngine.Rendering.BatchCullingFlags, UnityEngine.Rendering.BatchCullingProjectionType, UnityEngine.Rendering.BatchCullingViewType
namespace UnityEngine::Rendering {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "cullingJobsFence", ty: "::Unity::Jobs::JobHandle", modifiers: "", def_value: None }, CppParam { name: "localToWorldMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "cullingPlanes", ty: "::UnityEngine::Plane*", modifiers: "", def_value: None }, CppParam { name: "cullingPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "receiverPlaneOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "receiverPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cullingSplits", ty: "::UnityEngine::Rendering::CullingSplit*", modifiers: "", def_value: None }, CppParam { name: "cullingSplitCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "viewType", ty: "::UnityEngine::Rendering::BatchCullingViewType", modifiers: "", def_value: None }, CppParam { name: "projectionType", ty: "::UnityEngine::Rendering::BatchCullingProjectionType", modifiers: "", def_value: None }, CppParam { name: "cullingFlags", ty: "::UnityEngine::Rendering::BatchCullingFlags", modifiers: "", def_value: None }, CppParam { name: "viewID", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cullingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "splitExclusionMask", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "sceneCullingMask", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "drawCommands", ty: "::UnityEngine::Rendering::BatchCullingOutputDrawCommands*", modifiers: "", def_value: None }, CppParam { name: "brgId", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "occlusionBuffer", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "customCullingResult", ty: "::System::IntPtr", modifiers: "", def_value: None }]
constexpr BatchRendererCullingOutput(::Unity::Jobs::JobHandle  cullingJobsFence, ::UnityEngine::Matrix4x4  localToWorldMatrix, ::UnityEngine::Plane*  cullingPlanes, int32_t  cullingPlaneCount, int32_t  receiverPlaneOffset, int32_t  receiverPlaneCount, ::UnityEngine::Rendering::CullingSplit*  cullingSplits, int32_t  cullingSplitCount, ::UnityEngine::Rendering::BatchCullingViewType  viewType, ::UnityEngine::Rendering::BatchCullingProjectionType  projectionType, ::UnityEngine::Rendering::BatchCullingFlags  cullingFlags, uint64_t  viewID, uint32_t  cullingLayerMask, uint8_t  splitExclusionMask, uint64_t  sceneCullingMask, ::UnityEngine::Rendering::BatchCullingOutputDrawCommands*  drawCommands, uint32_t  brgId, ::System::IntPtr  occlusionBuffer, ::System::IntPtr  customCullingResult) noexcept;
...
/// @brief Field splitExclusionMask, offset: 0x8c, size: 0x1, def value: None
 uint8_t  splitExclusionMask;
...
/// @brief Field brgId, offset: 0xa0, size: 0x4, def value: None
 uint32_t  brgId;

/// @brief Field occlusionBuffer, offset: 0xa8, size: 0x8, def value: None
 ::System::IntPtr  occlusionBuffer;

/// @brief Field customCullingResult, offset: 0xb0, size: 0x8, def value: None
...
static_assert(offsetof(::UnityEngine::Rendering::BatchRendererCullingOutput, splitExclusionMask) == 0x8c, "Offset mismatch!");
...
static_assert(offsetof(::UnityEngine::Rendering::BatchRendererCullingOutput, brgId) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::BatchRendererCullingOutput, occlusionBuffer) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::BatchRendererCullingOutput, customCullingResult) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BatchRendererCullingOutput) == 0xb8, "Size mismatch!");
