...
/// @brief Method Equals, addr 0x1822a23d0, size 0x140, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x1822a2510, size 0x130, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::SphericalHarmonicsL2  other) ;

/// @brief Method Equals, addr 0x1822a2510, size 0x130, virtual false, abstract: false, final false
inline bool Equals(::by_ref<::UnityEngine::Rendering::SphericalHarmonicsL2>  other) ;

/// @brief Method Evaluate, addr 0x1822a2760, size 0x70, virtual false, abstract: false, final false
inline void Evaluate(::ArrayW<::UnityEngine::Vector3>  directions, ::ArrayW<::UnityEngine::Color>  results) ;

/// @brief Method EvaluateInternal, addr 0x1822a2650, size 0x110, virtual false, abstract: false, final false
static inline void EvaluateInternal(::by_ref<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::ArrayW<::UnityEngine::Vector3>  directions, ::by_ref<::ArrayW<::UnityEngine::Color>>  results) ;

/// @brief Method EvaluateInternal_Injected, addr 0x1822a2640, size 0x10, virtual false, abstract: false, final false
static inline void EvaluateInternal_Injected(::by_ref<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  directions, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper>  results) ;

/// @brief Method GetHashCode, addr 0x1822a27d0, size 0x1e0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_Item, addr 0x1822a29b0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x180651850, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x1822a2ba0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x1822a2c60, size 0x1f0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::SphericalHarmonicsL2) == 0x6c, "Size mismatch!");
