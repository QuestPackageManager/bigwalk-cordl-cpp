...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::PerformanceBottleneck, "UnityEngine.Rendering", "PerformanceBottleneck");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::PerformanceBottleneck, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::PerformanceBottleneck) == 0x4, "Size mismatch!");
