...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DefaultMaterialType, "UnityEngine.Rendering", "DefaultMaterialType");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::DefaultMaterialType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DefaultMaterialType) == 0x4, "Size mismatch!");
