...
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ObjectPool_1, "UnityEngine.Rendering", "ObjectPool`1");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::ObjectPool_1_PooledObject, "UnityEngine.Rendering", "ObjectPool`1/PooledObject");
// Dependencies 
namespace UnityEngine::Rendering {
// cpp template
template<typename T>
...
// Ctor Parameters [CppParam { name: "m_ToReturn", ty: "T", modifiers: "", def_value: None }, CppParam { name: "m_Pool", ty: "::UnityEngine::Rendering::ObjectPool_1<T>*", modifiers: "", def_value: None }]
...
inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> Get(::by_ref<T>  v) ;

/// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline T Get() ;

static inline ::UnityEngine::Rendering::ObjectPool_1<T>* New_ctor(::UnityEngine::Events::UnityAction_1<T>*  actionOnGet, ::UnityEngine::Events::UnityAction_1<T>*  actionOnRelease, bool  collectionCheck) ;
