...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IDebugDisplaySettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IDebugDisplaySettings*, "UnityEngine.Rendering", "IDebugDisplaySettings");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
// Declarations
/// @brief Method Add, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
