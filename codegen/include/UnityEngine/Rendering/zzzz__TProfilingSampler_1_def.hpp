...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::TProfilingSampler_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::TProfilingSampler_1, "UnityEngine.Rendering", "TProfilingSampler`1");
