...
/// @brief Method .ctor, addr 0x1822b0d40, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_isValid, addr 0x1822b0d60, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "context", ty: "::System::UIntPtr", modifiers: "", def_value: None }, CppParam { name: "index", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "frame", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "type", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "contextID", ty: "uint32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::RendererList) == 0x18, "Size mismatch!");
