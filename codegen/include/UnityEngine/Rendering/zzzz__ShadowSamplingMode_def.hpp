...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShadowSamplingMode, "UnityEngine.Rendering", "ShadowSamplingMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Field CompareDepths value: I32(0)
...
/// @brief Field RawDepth value: I32(1)
...
static_assert(offsetof(::UnityEngine::Rendering::ShadowSamplingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ShadowSamplingMode) == 0x4, "Size mismatch!");
