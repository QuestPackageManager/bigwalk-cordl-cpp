...
public:
// Declarations
/// @brief Method FromFloat4x4, addr 0x1820a9c10, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::PackedMatrix FromFloat4x4(::by_ref<::Unity::Mathematics::float4x4>  m) ;

/// @brief Method FromMatrix4x4, addr 0x1820a9c10, size 0x50, virtual false, abstract: false, final false
