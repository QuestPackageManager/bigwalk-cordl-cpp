...
static_assert(sizeof(::UnityEngine::Rendering::LODGroupData__screenRelativeTransitionHeights_e__FixedBuffer) == 0x20, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "valid", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "lodCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "rendererCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "screenRelativeTransitionHeights", ty: "::UnityEngine::Rendering::LODGroupData__screenRelativeTransitionHeights_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "fadeTransitionWidth", ty: "::UnityEngine::Rendering::LODGroupData__fadeTransitionWidth_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr LODGroupData(bool  valid, int32_t  lodCount, int32_t  rendererCount, ::UnityEngine::Rendering::LODGroupData__screenRelativeTransitionHeights_e__FixedBuffer  screenRelativeTransitionHeights, ::UnityEngine::Rendering::LODGroupData__fadeTransitionWidth_e__FixedBuffer  fadeTransitionWidth) noexcept;
