...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::TextureParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TextureParameter*, "UnityEngine.Rendering", "TextureParameter");
...
/// @brief Method .ctor, addr 0x18204f9b0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  value, ::UnityEngine::Rendering::TextureDimension  dimension, bool  overrideState) ;

/// @brief Method .ctor, addr 0x18204f9e0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::TextureParameter) == 0x28, "Size mismatch!");
