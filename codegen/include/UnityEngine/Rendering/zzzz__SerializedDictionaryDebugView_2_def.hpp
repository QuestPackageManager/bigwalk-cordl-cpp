...
class SerializedDictionaryDebugView_2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::SerializedDictionaryDebugView_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::SerializedDictionaryDebugView_2, "UnityEngine.Rendering", "SerializedDictionaryDebugView`2");
