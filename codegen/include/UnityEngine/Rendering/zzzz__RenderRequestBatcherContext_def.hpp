...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderRequestBatcherContext, "UnityEngine.Rendering", "RenderRequestBatcherContext");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::RenderRequestBatcherContext) == 0x8, "Size mismatch!");
