...
/// @brief Method ParallelSort, addr 0x1820b5fe0, size 0x500, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ParallelSort(::Unity::Collections::NativeArray_1<int32_t>  array) ;

/// @brief Method <ParallelSort>g__Swap|2_0, addr 0x1820b64e0, size 0x10, virtual false, abstract: false, final false
