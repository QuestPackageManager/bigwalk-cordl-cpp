...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SilhouettePlaneCache_Slot, "UnityEngine.Rendering", "SilhouettePlaneCache/Slot");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "isActive", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "viewInstanceID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "planeCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lastUsedFrameIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::SilhouettePlaneCache_Slot) == 0x10, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x1820b9c30, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FreeUnusedSlots, addr 0x1820b9c80, size 0xe0, virtual false, abstract: false, final false
inline void FreeUnusedSlots(int32_t  frameIndex, int32_t  maximumAge) ;

/// @brief Method GetSubArray, addr 0x1820b9d60, size 0xe0, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Plane> GetSubArray(int32_t  viewInstanceID) ;

/// @brief Method Init, addr 0x1820b9e40, size 0xf0, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method Update, addr 0x1820b9f30, size 0x1d0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_SubviewIDToIndexMap", ty: "::Unity::Collections::NativeParallelHashMap_2<int32_t,int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_SlotFreeList", ty: "::Unity::Collections::NativeList_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_Slots", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::SilhouettePlaneCache_Slot>", modifiers: "", def_value: None }, CppParam { name: "m_PlaneStorage", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Plane>", modifiers: "", def_value: None }]
