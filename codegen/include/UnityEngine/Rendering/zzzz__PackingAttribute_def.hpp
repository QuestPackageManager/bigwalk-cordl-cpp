...
/// @brief Field range, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_range, put=__cordl_internal_set_range)) ::ArrayW<float_t>  range;
...
static inline ::UnityEngine::Rendering::PackingAttribute* New_ctor(::StringW  displayName, ::UnityEngine::Rendering::FieldPacking  packingScheme, int32_t  bitSize, int32_t  offsetInSource, float_t  minValue, float_t  maxValue, bool  isDirection, bool  sRGBDisplay, bool  checkIsNormalized, ::StringW  preprocessor) ;

static inline ::UnityEngine::Rendering::PackingAttribute* New_ctor(::ArrayW<::StringW>  displayNames, ::UnityEngine::Rendering::FieldPacking  packingScheme, int32_t  bitSize, int32_t  offsetInSource, float_t  minValue, float_t  maxValue, bool  isDirection, bool  sRGBDisplay, bool  checkIsNormalized, ::StringW  preprocessor) ;
...
constexpr ::ArrayW<float_t> const& __cordl_internal_get_range() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_range() ;
...
constexpr void __cordl_internal_set_range(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set_sRGBDisplay(bool  value) ;

constexpr void __cordl_internal_set_sizeInBits(int32_t  value) ;

/// @brief Method .ctor, addr 0x182036c50, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::UnityEngine::Rendering::FieldPacking  packingScheme, int32_t  bitSize, int32_t  offsetInSource, float_t  minValue, float_t  maxValue, bool  isDirection, bool  sRGBDisplay, bool  checkIsNormalized, ::StringW  preprocessor) ;

/// @brief Method .ctor, addr 0x182036ba0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::StringW>  displayNames, ::UnityEngine::Rendering::FieldPacking  packingScheme, int32_t  bitSize, int32_t  offsetInSource, float_t  minValue, float_t  maxValue, bool  isDirection, bool  sRGBDisplay, bool  checkIsNormalized, ::StringW  preprocessor) ;
...
static_assert(sizeof(::UnityEngine::Rendering::PackingAttribute) == 0x38, "Size mismatch!");
