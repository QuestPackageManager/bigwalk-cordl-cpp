...
static_assert(offsetof(::UnityEngine::Rendering::LensFlareOcclusionPermutation, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::LensFlareOcclusionPermutation) == 0x4, "Size mismatch!");
