...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LightShadowResolution, "UnityEngine.Rendering", "LightShadowResolution");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::LightShadowResolution, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::LightShadowResolution) == 0x4, "Size mismatch!");
