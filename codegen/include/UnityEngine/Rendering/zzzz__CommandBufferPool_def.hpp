...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::CommandBufferPool*);
...
/// @brief Method <.cctor>b__4_0, addr 0x181fdc3d0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::CommandBufferPool___c) == 0x10, "Size mismatch!");
...
/// @brief Method Get, addr 0x181fd4c50, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::CommandBuffer* Get() ;

/// @brief Method Get, addr 0x181fd4cb0, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::CommandBuffer* Get(::StringW  name) ;

/// @brief Method Release, addr 0x181fd4d10, size 0x50, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::CommandBufferPool) == 0x10, "Size mismatch!");
