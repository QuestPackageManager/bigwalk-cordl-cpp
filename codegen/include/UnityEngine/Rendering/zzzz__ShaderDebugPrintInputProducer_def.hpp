...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ShaderDebugPrintInputProducer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShaderDebugPrintInputProducer*, "UnityEngine.Rendering", "ShaderDebugPrintInputProducer");
...
public:
// Declarations
/// @brief Method Get, addr 0x182017ed0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ShaderDebugPrintInputProducer) == 0x10, "Size mismatch!");
