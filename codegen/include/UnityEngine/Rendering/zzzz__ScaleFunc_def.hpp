...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ScaleFunc*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ScaleFunc*, "UnityEngine.Rendering", "ScaleFunc");
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x18203e120, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1813c4a10, size 0xc30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ScaleFunc) == 0x80, "Size mismatch!");
