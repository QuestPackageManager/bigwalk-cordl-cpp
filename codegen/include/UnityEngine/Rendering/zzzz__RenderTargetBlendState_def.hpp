...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderTargetBlendState, "UnityEngine.Rendering", "RenderTargetBlendState");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Equals, addr 0x1822af3f0, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1822af390, size 0x60, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RenderTargetBlendState  other) ;

/// @brief Method GetHashCode, addr 0x1822af4c0, size 0xc0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x1822af580, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ColorWriteMask  writeMask, ::UnityEngine::Rendering::BlendMode  sourceColorBlendMode, ::UnityEngine::Rendering::BlendMode  destinationColorBlendMode, ::UnityEngine::Rendering::BlendMode  sourceAlphaBlendMode, ::UnityEngine::Rendering::BlendMode  destinationAlphaBlendMode, ::UnityEngine::Rendering::BlendOp  colorBlendOperation, ::UnityEngine::Rendering::BlendOp  alphaBlendOperation) ;

/// @brief Method get_defaultValue, addr 0x1822af5d0, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_WriteMask", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_SourceColorBlendMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_DestinationColorBlendMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_SourceAlphaBlendMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_DestinationAlphaBlendMode", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_ColorBlendOperation", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_AlphaBlendOperation", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_Padding", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr RenderTargetBlendState(uint8_t  m_WriteMask, uint8_t  m_SourceColorBlendMode, uint8_t  m_DestinationColorBlendMode, uint8_t  m_SourceAlphaBlendMode, uint8_t  m_DestinationAlphaBlendMode, uint8_t  m_ColorBlendOperation, uint8_t  m_AlphaBlendOperation, uint8_t  m_Padding) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderTargetBlendState) == 0x8, "Size mismatch!");
