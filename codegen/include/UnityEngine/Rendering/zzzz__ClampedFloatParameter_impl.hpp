...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::UnityEngine::Rendering::ClampedFloatParameter::*)()>(&::UnityEngine::Rendering::ClampedFloatParameter::get_value)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 14}
                ));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::ClampedFloatParameter::*)(float_t)>(&::UnityEngine::Rendering::ClampedFloatParameter::set_value)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(),
                    {::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 15}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::ClampedFloatParameter::*)(float_t, float_t, float_t, bool)>(&::UnityEngine::Rendering::ClampedFloatParameter::_ctor)> {
