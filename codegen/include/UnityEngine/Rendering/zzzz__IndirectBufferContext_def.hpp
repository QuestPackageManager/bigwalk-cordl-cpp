...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IndirectBufferContext_BufferState, "UnityEngine.Rendering", "IndirectBufferContext/BufferState");
...
static_assert(offsetof(::UnityEngine::Rendering::IndirectBufferContext_BufferState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::IndirectBufferContext_BufferState) == 0x4, "Size mismatch!");
...
/// @brief Method Matches, addr 0x1820b0310, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x180f27be0, size 0xbf0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "cullingJobHandle", ty: "::Unity::Jobs::JobHandle", modifiers: "", def_value: None }, CppParam { name: "bufferState", ty: "::UnityEngine::Rendering::IndirectBufferContext_BufferState", modifiers: "", def_value: None }, CppParam { name: "occluderVersion", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "subviewMask", ty: "int32_t", modifiers: "", def_value: None }]
constexpr IndirectBufferContext(::Unity::Jobs::JobHandle  cullingJobHandle, ::UnityEngine::Rendering::IndirectBufferContext_BufferState  bufferState, int32_t  occluderVersion, int32_t  subviewMask) noexcept;
