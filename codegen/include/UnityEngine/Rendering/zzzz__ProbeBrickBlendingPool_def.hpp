...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ProbeBrickBlendingPool*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeBrickBlendingPool*, "UnityEngine.Rendering", "ProbeBrickBlendingPool");
// Dependencies System.Object, UnityEngine.Rendering.ProbeVolumeSHBands, UnityEngine.Rendering.ProbeVolumeTextureMemoryBudget, UnityEngine.Vector4
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field m_ChunkList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ChunkList, put=__cordl_internal_set_m_ChunkList)) ::ArrayW<::UnityEngine::Vector4>  m_ChunkList;
...
/// @brief Method Allocate, addr 0x18200df00, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method AllocateResourcesIfNeeded, addr 0x18200ddb0, size 0x150, virtual false, abstract: false, final false
inline void AllocateResourcesIfNeeded() ;

/// @brief Method BlendChunks, addr 0x18200e090, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x18200e190, size 0x40, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x18200e1d0, size 0x40, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Deallocate, addr 0x18200e210, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method EnsureTextureValidity, addr 0x18200e230, size 0xa0, virtual false, abstract: false, final false
inline void EnsureTextureValidity() ;

/// @brief Method GetPoolDepth, addr 0x18200e2d0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPoolDepth() ;

/// @brief Method GetPoolHeight, addr 0x18200e2e0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPoolHeight() ;

/// @brief Method GetPoolWidth, addr 0x18200e2f0, size 0x10, virtual false, abstract: false, final false
inline int32_t GetPoolWidth() ;

/// @brief Method Initialize, addr 0x18200e300, size 0xb0, virtual false, abstract: false, final false
static inline void Initialize() ;

static inline ::UnityEngine::Rendering::ProbeBrickBlendingPool* New_ctor(::UnityEngine::Rendering::ProbeVolumeBlendingTextureMemoryBudget  memoryBudget, ::UnityEngine::Rendering::ProbeVolumeSHBands  shBands, bool  probeOcclusion) ;

/// @brief Method PerformBlending, addr 0x18200e3b0, size 0xb40, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x18200ef90, size 0x130, virtual false, abstract: false, final false
inline void Update(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBuffer*  dataBuffer, ::UnityEngine::Rendering::ProbeReferenceVolume_CellStreamingScratchBufferLayout  layout, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ProbeBrickPool_BrickChunkAlloc>*  dstLocations, ::UnityEngine::Rendering::ProbeVolumeSHBands  bands, int32_t  state, ::UnityEngine::Texture*  validityTexture, bool  skyOcclusion, ::UnityEngine::Texture*  skyOcclusionTexture, bool  skyShadingDirections, ::UnityEngine::Texture*  skyShadingDirectionsTexture, bool  probeOcclusion) ;

/// @brief Method Update, addr 0x18200eef0, size 0xa0, virtual false, abstract: false, final false
inline void Update(::UnityEngine::Rendering::ProbeBrickPool_DataLocation  source, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ProbeBrickPool_BrickChunkAlloc>*  srcLocations, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::ProbeBrickPool_BrickChunkAlloc>*  dstLocations, int32_t  destStartIndex, ::UnityEngine::Rendering::ProbeVolumeSHBands  bands, int32_t  state) ;

constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get_m_ChunkList() const;

constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get_m_ChunkList() ;
...
constexpr void __cordl_internal_set_m_ChunkList(::ArrayW<::UnityEngine::Vector4>  value) ;
...
/// @brief Method .ctor, addr 0x18200f320, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_estimatedVMemCost, addr 0x18200f330, size 0x120, virtual false, abstract: false, final false
inline int32_t get_estimatedVMemCost() ;

/// @brief Method get_isAllocated, addr 0x1802ed970, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeBrickBlendingPool) == 0x40, "Size mismatch!");
