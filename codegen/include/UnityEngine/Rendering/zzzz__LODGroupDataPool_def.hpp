...
MARK_REF_T(::UnityEngine::Rendering::LODGroupDataPool_LodGroupShaderIDs*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LODGroupDataPool*, "UnityEngine.Rendering", "LODGroupDataPool");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LODGroupDataPool_LodGroupShaderIDs*, "UnityEngine.Rendering", "LODGroupDataPool/LodGroupShaderIDs");
...
static_assert(sizeof(::UnityEngine::Rendering::LODGroupDataPool_LodGroupShaderIDs) == 0x10, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x1820b1510, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FreeLODGroupData, addr 0x1820b1550, size 0x40, virtual false, abstract: false, final false
inline void FreeLODGroupData(::Unity::Collections::NativeArray_1<::UnityEngine::EntityId>  destroyedLODGroupsID) ;
...
/// @brief Method UpdateLODGroupData, addr 0x1820b1590, size 0x330, virtual false, abstract: false, final false
inline void UpdateLODGroupData(::by_ref<::UnityEngine::Rendering::GPUDrivenLODGroupData>  inputData) ;

/// @brief Method UpdateLODGroupTransformData, addr 0x1820b18c0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820b19b0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_activeLodGroupCount, addr 0x18209d470, size 0x20, virtual false, abstract: false, final false
inline int32_t get_activeLodGroupCount() ;

/// @brief Method get_crossfadedRendererCount, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_crossfadedRendererCount() ;

/// @brief Method get_lodGroupCullingData, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData> get_lodGroupCullingData() ;

/// @brief Method get_lodGroupDataHash, addr 0x1802e2d70, size 0x10, virtual false, abstract: false, final false
