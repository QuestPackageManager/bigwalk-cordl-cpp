...
static_assert(offsetof(::UnityEngine::Rendering::OcclusionTestDebugFlag, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::OcclusionTestDebugFlag) == 0x4, "Size mismatch!");
