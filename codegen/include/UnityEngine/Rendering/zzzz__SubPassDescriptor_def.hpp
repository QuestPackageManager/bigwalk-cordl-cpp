...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SubPassDescriptor, "UnityEngine.Rendering", "SubPassDescriptor");
...
static_assert(sizeof(::UnityEngine::Rendering::SubPassDescriptor) == 0x4c, "Size mismatch!");
