...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeHashMap`2<TKey, TValue>, Unity.Collections.NativeList`1<T>, UnityEngine.Rendering.IndirectBufferAllocInfo, UnityEngine.Rendering.IndirectBufferContext, UnityEngine.Rendering.IndirectBufferLimits, UnityEngine.Rendering.IndirectDrawInfo, UnityEngine.Rendering.IndirectInstanceInfo
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method AllocateDrawBuffers, addr 0x1820af650, size 0x140, virtual false, abstract: false, final false
inline void AllocateDrawBuffers(int32_t  maxDrawCount) ;

/// @brief Method AllocateInstanceBuffers, addr 0x1820af790, size 0x100, virtual false, abstract: false, final false
inline void AllocateInstanceBuffers(int32_t  maxInstanceCount) ;

/// @brief Method ClearContextsAndGrowBuffers, addr 0x1820af890, size 0x80, virtual false, abstract: false, final false
inline void ClearContextsAndGrowBuffers() ;

/// @brief Method CopyFromStaging, addr 0x1820af910, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1820af9c0, size 0xb0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FreeDrawBuffers, addr 0x1820afa70, size 0x50, virtual false, abstract: false, final false
inline void FreeDrawBuffers() ;

/// @brief Method FreeInstanceBuffers, addr 0x1820afac0, size 0x50, virtual false, abstract: false, final false
inline void FreeInstanceBuffers() ;

/// @brief Method GetAllocInfo, addr 0x1820afb70, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::IndirectBufferAllocInfo GetAllocInfo(int32_t  contextIndex) ;

/// @brief Method GetAllocInfoSubArray, addr 0x1820afb10, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetBufferContext, addr 0x1820afbd0, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::IndirectBufferContext GetBufferContext(int32_t  contextIndex) ;

/// @brief Method GetLimits, addr 0x1820afc40, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::IndirectBufferLimits GetLimits(int32_t  contextIndex) ;

/// @brief Method GrowBuffers, addr 0x1820afc60, size 0x150, virtual false, abstract: false, final false
inline void GrowBuffers() ;

/// @brief Method ImportBuffers, addr 0x1820afdb0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x1820afef0, size 0x140, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method ResetAllocators, addr 0x1820b0030, size 0x70, virtual false, abstract: false, final false
inline void ResetAllocators() ;

/// @brief Method SetBufferContext, addr 0x1820b00a0, size 0x60, virtual false, abstract: false, final false
inline void SetBufferContext(int32_t  contextIndex, ::UnityEngine::Rendering::IndirectBufferContext  ctx) ;

/// @brief Method SyncContexts, addr 0x1820b0100, size 0x80, virtual false, abstract: false, final false
inline void SyncContexts() ;

/// @brief Method TryAllocateContext, addr 0x1820b0180, size 0xb0, virtual false, abstract: false, final false
inline int32_t TryAllocateContext(int32_t  viewID) ;

/// @brief Method TryGetContextIndex, addr 0x1820b0230, size 0x70, virtual false, abstract: false, final false
inline int32_t TryGetContextIndex(int32_t  viewID) ;

/// @brief Method get_allocationCounters, addr 0x181115440, size 0x30, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<int32_t> get_allocationCounters() ;

/// @brief Method get_dispatchArgsBuffer, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_dispatchArgsBuffer() ;

/// @brief Method get_drawArgsBuffer, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_drawArgsBuffer() ;

/// @brief Method get_drawInfoBuffer, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_drawInfoBuffer() ;

/// @brief Method get_drawInfoGlobalArray, addr 0x18052ca40, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectDrawInfo> get_drawInfoGlobalArray() ;

/// @brief Method get_indirectDrawArgsBufferHandle, addr 0x1820b02a0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBufferHandle get_indirectDrawArgsBufferHandle() ;

/// @brief Method get_instanceBuffer, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_instanceBuffer() ;

/// @brief Method get_instanceInfoBuffer, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_instanceInfoBuffer() ;

/// @brief Method get_instanceInfoGlobalArray, addr 0x1802e2d70, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectInstanceInfo> get_instanceInfoGlobalArray() ;

/// @brief Method get_visibleInstanceBufferHandle, addr 0x1820b02c0, size 0x50, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BufferLimits", ty: "::UnityEngine::Rendering::IndirectBufferLimits", modifiers: "", def_value: None }, CppParam { name: "m_InstanceBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_InstanceInfoBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_InstanceInfoStaging", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectInstanceInfo>", modifiers: "", def_value: None }, CppParam { name: "m_DispatchArgsBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_DrawArgsBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_DrawInfoBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_DrawInfoStaging", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectDrawInfo>", modifiers: "", def_value: None }, CppParam { name: "m_ContextAllocCounter", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ContextIndexFromViewID", ty: "::Unity::Collections::NativeHashMap_2<int32_t,int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_Contexts", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::IndirectBufferContext>", modifiers: "", def_value: None }, CppParam { name: "m_ContextAllocInfo", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectBufferAllocInfo>", modifiers: "", def_value: None }, CppParam { name: "m_AllocationCounters", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
constexpr IndirectBufferContextStorage(::UnityEngine::Rendering::IndirectBufferLimits  m_BufferLimits, ::UnityEngine::GraphicsBuffer*  m_InstanceBuffer, ::UnityEngine::GraphicsBuffer*  m_InstanceInfoBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectInstanceInfo>  m_InstanceInfoStaging, ::UnityEngine::GraphicsBuffer*  m_DispatchArgsBuffer, ::UnityEngine::GraphicsBuffer*  m_DrawArgsBuffer, ::UnityEngine::GraphicsBuffer*  m_DrawInfoBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectDrawInfo>  m_DrawInfoStaging, int32_t  m_ContextAllocCounter, ::Unity::Collections::NativeHashMap_2<int32_t,int32_t>  m_ContextIndexFromViewID, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::IndirectBufferContext>  m_Contexts, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectBufferAllocInfo>  m_ContextAllocInfo, ::Unity::Collections::NativeArray_1<int32_t>  m_AllocationCounters) noexcept;
