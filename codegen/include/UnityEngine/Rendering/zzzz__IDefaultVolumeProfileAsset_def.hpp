...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IDefaultVolumeProfileAsset*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IDefaultVolumeProfileAsset*, "UnityEngine.Rendering", "IDefaultVolumeProfileAsset");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: false
