...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderBufferLoadAction, "UnityEngine.Rendering", "RenderBufferLoadAction");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RenderBufferLoadAction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderBufferLoadAction) == 0x4, "Size mismatch!");
