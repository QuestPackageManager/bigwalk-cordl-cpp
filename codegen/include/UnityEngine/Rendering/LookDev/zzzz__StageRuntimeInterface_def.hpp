...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::LookDev::StageRuntimeInterface*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LookDev::StageRuntimeInterface*, "UnityEngine.Rendering.LookDev", "StageRuntimeInterface");
...
/// @brief Method AddGameObject, addr 0x182087f00, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> AddGameObject(bool  persistent) ;

static inline ::UnityEngine::Rendering::LookDev::StageRuntimeInterface* New_ctor(::System::Func_2<bool,::UnityW<::UnityEngine::GameObject>>*  AddGameObject, ::System::Func_1<::UnityW<::UnityEngine::Camera>>*  GetCamera, ::System::Func_1<::UnityW<::UnityEngine::Light>>*  GetSunLight) ;
...
inline void _ctor(::System::Func_2<bool,::UnityW<::UnityEngine::GameObject>>*  AddGameObject, ::System::Func_1<::UnityW<::UnityEngine::Camera>>*  GetCamera, ::System::Func_1<::UnityW<::UnityEngine::Light>>*  GetSunLight) ;

/// @brief Method get_camera, addr 0x182087f20, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_camera() ;

/// @brief Method get_sunLight, addr 0x182087f40, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::LookDev::StageRuntimeInterface) == 0x30, "Size mismatch!");
