...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LookDev::Sky, "UnityEngine.Rendering.LookDev", "Sky");
// Dependencies 
namespace UnityEngine::Rendering::LookDev {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "cubemap", ty: "::UnityW<::UnityEngine::Cubemap>", modifiers: "", def_value: None }, CppParam { name: "longitudeOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "exposure", ty: "float_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::LookDev::Sky) == 0x10, "Size mismatch!");
