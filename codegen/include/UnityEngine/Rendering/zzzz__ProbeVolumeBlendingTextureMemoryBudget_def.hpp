...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeBlendingTextureMemoryBudget, "UnityEngine.Rendering", "ProbeVolumeBlendingTextureMemoryBudget");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolumeBlendingTextureMemoryBudget, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBlendingTextureMemoryBudget) == 0x4, "Size mismatch!");
