...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RendererListStatus, "UnityEngine.Rendering", "RendererListStatus");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RendererListStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RendererListStatus) == 0x4, "Size mismatch!");
