...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugDisplaySettingsPanel*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugDisplaySettingsPanel*, "UnityEngine.Rendering", "DebugDisplaySettingsPanel");
...
/// @brief Method AddWidget, addr 0x181fe7770, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181fe77e0, size 0x30, virtual true, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x181fe7810, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Flags, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Flags get_Flags() ;

/// @brief Method get_Order, addr 0x181fe78c0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_Order() ;

/// @brief Method get_PanelName, addr 0x181fe78d0, size 0x30, virtual true, abstract: false, final false
inline ::StringW get_PanelName() ;

/// @brief Method get_Widgets, addr 0x181fe7900, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::DebugDisplaySettingsPanel) == 0x20, "Size mismatch!");
