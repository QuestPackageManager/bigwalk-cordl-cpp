...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::MemoryUtilities*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MemoryUtilities*, "UnityEngine.Rendering", "MemoryUtilities");
...
static_assert(sizeof(::UnityEngine::Rendering::MemoryUtilities) == 0x10, "Size mismatch!");
