...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CopyTextureSupport, "UnityEngine.Rendering", "CopyTextureSupport");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::CopyTextureSupport, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CopyTextureSupport) == 0x4, "Size mismatch!");
