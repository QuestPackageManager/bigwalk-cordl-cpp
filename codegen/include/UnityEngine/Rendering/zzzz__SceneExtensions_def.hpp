...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::SceneExtensions*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SceneExtensions*, "UnityEngine.Rendering", "SceneExtensions");
...
/// @brief Method GetGUID, addr 0x182017db0, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::SceneExtensions) == 0x10, "Size mismatch!");
