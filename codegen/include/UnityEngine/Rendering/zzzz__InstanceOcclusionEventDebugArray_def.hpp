...
public:
// Declarations
/// @brief Method HasVersion, addr 0x182094380, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x1820978e0, size 0xd0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Init, addr 0x1820979b0, size 0xe0, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MoveToDebugStatsAndClear, addr 0x182097a90, size 0x400, virtual false, abstract: false, final false
inline void MoveToDebugStatsAndClear(::UnityEngine::Rendering::DebugRendererBatcherStats*  debugStats) ;

/// @brief Method TryAdd, addr 0x182097e90, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_CounterBuffer, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
