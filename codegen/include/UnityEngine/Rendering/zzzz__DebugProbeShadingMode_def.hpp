...
static_assert(offsetof(::UnityEngine::Rendering::DebugProbeShadingMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::DebugProbeShadingMode) == 0x4, "Size mismatch!");
