...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ReceiverPlanes, "UnityEngine.Rendering", "ReceiverPlanes");
...
static_assert(sizeof(::UnityEngine::Rendering::ReceiverPlanes) == 0x10, "Size mismatch!");
