...
/// @brief Method Equals, addr 0x18202d400, size 0xf0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x18202d4f0, size 0x220, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::BatchRendererGroupGlobals  other) ;

/// @brief Method GetHashCode, addr 0x18202d710, size 0xb0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline int32_t getStaticF_kGlobalsPropertyId() ;

/// @brief Method get_Default, addr 0x18202d7f0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x18202d9a0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x18202da30, size 0x90, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "ProbesOcclusion", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "SpecCube0_HDR", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "SpecCube1_HDR", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "SHCoefficients", ty: "::UnityEngine::Rendering::SHCoefficients", modifiers: "", def_value: None }]
constexpr BatchRendererGroupGlobals(::UnityEngine::Vector4  ProbesOcclusion, ::UnityEngine::Vector4  SpecCube0_HDR, ::UnityEngine::Vector4  SpecCube1_HDR, ::UnityEngine::Rendering::SHCoefficients  SHCoefficients) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::BatchRendererGroupGlobals) == 0xb0, "Size mismatch!");
