...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::DebugOverlay*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DebugOverlay*, "UnityEngine.Rendering", "DebugOverlay");
...
/// @brief Method Next, addr 0x181fed2b0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rect Next(float_t  aspect) ;

/// @brief Method SetViewport, addr 0x181fed330, size 0x60, virtual false, abstract: false, final false
inline void SetViewport(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method StartOverlay, addr 0x181fed390, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_overlaySize, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_overlaySize() ;

/// @brief Method get_x, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_x() ;

/// @brief Method get_y, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_y() ;

/// @brief Method set_overlaySize, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_overlaySize(int32_t  value) ;

/// @brief Method set_x, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_x(int32_t  value) ;

/// @brief Method set_y, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::DebugOverlay) == 0x28, "Size mismatch!");
