...
/// @brief Method .ctor, addr 0x1822a43d0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int32_t  numAttachments) ;

static inline ::UnityEngine::Rendering::AttachmentIndexArray getStaticF_Emtpy() ;

/// @brief Method get_Item, addr 0x1822a4460, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x1822a4520, size 0xc0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "a0", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a1", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a3", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a4", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a5", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a6", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "a7", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "activeAttachments", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::AttachmentIndexArray) == 0x24, "Size mismatch!");
