...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SubPassFlags, "UnityEngine.Rendering", "SubPassFlags");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::SubPassFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::SubPassFlags) == 0x4, "Size mismatch!");
