...
// Ctor Parameters [CppParam { name: "_DrawInfoAllocIndex", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_DrawInfoCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_InstanceInfoAllocIndex", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_InstanceInfoCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "_BoundingSphereInstanceDataAddress", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_DebugCounterIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_InstanceMultiplierShift", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_InstanceOcclusionCullerPad0", ty: "int32_t", modifiers: "", def_value: None }]
constexpr InstanceOcclusionCullerShaderVariables(uint32_t  _DrawInfoAllocIndex, uint32_t  _DrawInfoCount, uint32_t  _InstanceInfoAllocIndex, uint32_t  _InstanceInfoCount, int32_t  _BoundingSphereInstanceDataAddress, int32_t  _DebugCounterIndex, int32_t  _InstanceMultiplierShift, int32_t  _InstanceOcclusionCullerPad0) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::InstanceOcclusionCullerShaderVariables) == 0x20, "Size mismatch!");
