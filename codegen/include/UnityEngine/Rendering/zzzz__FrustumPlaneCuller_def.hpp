...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4, "UnityEngine.Rendering", "FrustumPlaneCuller/PlanePacket4");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo, "UnityEngine.Rendering", "FrustumPlaneCuller/SplitInfo");
...
// Ctor Parameters [CppParam { name: "nx", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "ny", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "nz", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "d", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "nxAbs", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "nyAbs", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }, CppParam { name: "nzAbs", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4) == 0x70, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo) == 0x4, "Size mismatch!");
...
/// @brief Method ComputeSplitVisibilityMask, addr 0x18208e950, size 0x200, virtual false, abstract: false, final false
static inline uint32_t ComputeSplitVisibilityMask(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>  planePackets, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo>  splitInfos, ::by_ref<::UnityEngine::Rendering::AABB>  bounds) ;

/// @brief Method Create, addr 0x18208eb50, size 0x450, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::FrustumPlaneCuller Create(::by_ref<::UnityEngine::Rendering::BatchCullingContext>  cc, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  receiverPlanes, ::by_ref<::UnityEngine::Rendering::ReceiverSphereCuller>  receiverSphereCuller, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method Dispose, addr 0x18208efa0, size 0x80, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "planePackets", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>", modifiers: "", def_value: None }, CppParam { name: "splitInfos", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo>", modifiers: "", def_value: None }]
constexpr FrustumPlaneCuller(::Unity::Collections::NativeList_1<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>  planePackets, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo>  splitInfos) noexcept;
