...
/// @brief Method FromInternalContext, addr 0x180378fd0, size 0x10, virtual true, abstract: false, final true
inline void FromInternalContext(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  context) ;

/// @brief Method GetTextureUVOrigin, addr 0x1802dd520, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IDerivedRendergraphContext.GetTextureUVOrigin, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_cmd, addr 0x181ccf1f0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CommandBuffer* get_cmd() ;

/// @brief Method get_defaultResources, addr 0x182054470, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources() ;

/// @brief Method get_renderContext, addr 0x1815c9400, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ScriptableRenderContext get_renderContext() ;

/// @brief Method get_renderGraphPool, addr 0x181ccf250, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphContext) == 0x8, "Size mismatch!");
