...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourceType");
// Dependencies 
namespace UnityEngine::Rendering::RenderGraphModule {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType) == 0x4, "Size mismatch!");
