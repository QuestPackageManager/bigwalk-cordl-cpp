...
public:
// Declarations
/// @brief Method .ctor, addr 0x18207a3c0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureAccess>  access, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  handle) ;

/// @brief Method .ctor, addr 0x18207a390, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  handle, ::UnityEngine::Rendering::RenderGraphModule::AccessFlags  flags, int32_t  mipLevel, int32_t  depthSlice) ;

// Ctor Parameters []
// @brief default ctor
constexpr TextureAccess() ;

// Ctor Parameters [CppParam { name: "textureHandle", ty: "::UnityEngine::Rendering::RenderGraphModule::TextureHandle", modifiers: "", def_value: None }, CppParam { name: "mipLevel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "depthSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::RenderGraphModule::AccessFlags", modifiers: "", def_value: None }]
constexpr TextureAccess(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  textureHandle, int32_t  mipLevel, int32_t  depthSlice, ::UnityEngine::Rendering::RenderGraphModule::AccessFlags  flags) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::TextureAccess) == 0x1c, "Size mismatch!");
