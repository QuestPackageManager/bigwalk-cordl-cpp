...
public:
// Declarations
/// @brief Field cachedHash, offset 0x1c, size 0x4 
...
/// @brief Field readCount, offset 0x18, size 0x4 
...
/// @brief Field sharedResourceLastFrameUsed, offset 0x24, size 0x4 
...
/// @brief Field transientPassIndex, offset 0x20, size 0x4 
...
/// @brief Method CreateGraphicsResource, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void CreateGraphicsResource() ;

/// @brief Method CreatePooledGraphicsResource, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void CreatePooledGraphicsResource(int32_t  frameIndex, int32_t  executionCount) ;

/// @brief Method GetDescHashCode, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline int32_t GetDescHashCode() ;

/// @brief Method GetName, addr 0x18146d2d0, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetName() ;

/// @brief Method GetSortIndex, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline int32_t GetSortIndex() ;

/// @brief Method IncrementReadCount, addr 0x1809ba810, size 0x5910, virtual true, abstract: false, final false
inline void IncrementReadCount() ;

/// @brief Method IncrementWriteCount, addr 0x182068f30, size 0x10, virtual true, abstract: false, final false
inline uint32_t IncrementWriteCount() ;

/// @brief Method IsCreated, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool IsCreated() ;

/// @brief Method LogCreation, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void LogCreation(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger*  logger) ;

/// @brief Method LogRelease, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void LogRelease(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger*  logger) ;

/// @brief Method NeedsFallBack, addr 0x182068f40, size 0x20, virtual true, abstract: false, final false
inline bool NeedsFallBack() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource* New_ctor() ;

/// @brief Method ReleaseGraphicsResource, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void ReleaseGraphicsResource() ;

/// @brief Method ReleasePooledGraphicsResource, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void ReleasePooledGraphicsResource(int32_t  frameIndex, int32_t  executionCount) ;

/// @brief Method Reset, addr 0x182068f60, size 0x70, virtual true, abstract: false, final false
inline void Reset(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool*  _) ;

/// @brief Method UpdateGraphicsResource, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Field readCount, offset: 0x18, size: 0x4, def value: None
 uint32_t  ___readCount;

/// @brief Field cachedHash, offset: 0x1c, size: 0x4, def value: None
 int32_t  ___cachedHash;

/// @brief Field transientPassIndex, offset: 0x20, size: 0x4, def value: None
 int32_t  ___transientPassIndex;

/// @brief Field sharedResourceLastFrameUsed, offset: 0x24, size: 0x4, def value: None
...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource, ___writeCount) == 0x14, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource, ___readCount) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource, ___cachedHash) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource, ___transientPassIndex) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource, ___sharedResourceLastFrameUsed) == 0x24, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource) == 0x28, "Size mismatch!");
