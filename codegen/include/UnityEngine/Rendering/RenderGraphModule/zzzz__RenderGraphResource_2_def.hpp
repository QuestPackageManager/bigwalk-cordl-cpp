...
public:
// Declarations
/// @brief Field desc, offset 0x28, size 0x8 
...
/// @brief Field m_Pool, offset 0x40, size 0x8 
...
/// @brief Field validDesc, offset 0x30, size 0x1 
...
/// @brief Field desc, offset: 0x28, size: 0x8, def value: None
 DescType  ___desc;

/// @brief Field validDesc, offset: 0x30, size: 0x1, def value: None
 bool  ___validDesc;

/// @brief Field graphicsResource, offset: 0x38, size: 0x8, def value: None
 ResType  ___graphicsResource;

/// @brief Field m_Pool, offset: 0x40, size: 0x8, def value: None
