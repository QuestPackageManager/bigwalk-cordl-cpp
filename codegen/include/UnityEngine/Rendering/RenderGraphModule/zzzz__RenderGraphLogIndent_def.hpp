...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogIndent, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphLogIndent");
// Dependencies 
namespace UnityEngine::Rendering::RenderGraphModule {
// Is value type: true
...
/// @brief Method Dispose, addr 0x18205a7f0, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18205a7a0, size 0x50, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method .ctor, addr 0x18205a830, size 0x70, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Indentation", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Logger", ty: "::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger*", modifiers: "", def_value: None }, CppParam { name: "m_Disposed", ty: "bool", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogIndent) == 0x18, "Size mismatch!");
