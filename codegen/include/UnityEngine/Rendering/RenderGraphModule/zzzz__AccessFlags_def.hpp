...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::AccessFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::AccessFlags) == 0x4, "Size mismatch!");
