...
static_assert(offsetof(::UnityEngine::Rendering::RenderGraphModule::Util::RenderGraphUtilsResources_Version, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method get_coreCopyPS, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_coreCopyPS, addr 0x182077410, size 0x30, virtual false, abstract: false, final false
