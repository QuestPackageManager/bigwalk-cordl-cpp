...
/// @brief Field renderFunc, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_renderFunc, put=__cordl_internal_set_renderFunc)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<PassData,TRenderGraphContext>*  renderFunc;
...
inline void Initialize(int32_t  passIndex, PassData  passData, ::StringW  passName, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphPassType  passType, ::UnityEngine::Rendering::ProfilingSampler*  sampler) ;
