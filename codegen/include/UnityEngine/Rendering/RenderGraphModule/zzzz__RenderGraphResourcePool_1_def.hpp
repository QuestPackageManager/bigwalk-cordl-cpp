...
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1___c);
MARK_GEN_VAL_T(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourcePool`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1___c, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourcePool`1/<>c");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourcePool`1/ResourceLogInfo");
// Dependencies 
namespace UnityEngine::Rendering::RenderGraphModule {
// cpp template
template<typename Type>
...
/// @brief Field <>9__15_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__15_0, put=setStaticF___9__15_0)) ::System::Comparison_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo<Type>>*  __9__15_0;
...
inline int32_t _LogResources_b__15_0(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo<Type>  a, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo<Type>  b) ;
...
/// @brief Field m_FrameAllocatedResources, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FrameAllocatedResources, put=__cordl_internal_set_m_FrameAllocatedResources)) ::System::Collections::Generic::List_1<::System::ValueTuple_2<int32_t,Type>>*  m_FrameAllocatedResources;

/// @brief Field m_ResourcePool, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ResourcePool, put=__cordl_internal_set_m_ResourcePool)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::UnityEngine::Rendering::RenderGraphModule::PooledResourceEntry_1<Type>>*>*  m_ResourcePool;
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::UnityEngine::Rendering::RenderGraphModule::PooledResourceEntry_1<Type>>*>* const& __cordl_internal_get_m_ResourcePool() const;

constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::UnityEngine::Rendering::RenderGraphModule::PooledResourceEntry_1<Type>>*>*& __cordl_internal_get_m_ResourcePool() ;
...
constexpr void __cordl_internal_set_m_ResourcePool(::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::UnityEngine::Rendering::RenderGraphModule::PooledResourceEntry_1<Type>>*>*  value) ;
...
/// @brief Field m_ResourcePool, offset: 0x18, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::UnityEngine::Rendering::RenderGraphModule::PooledResourceEntry_1<Type>>*>*  ___m_ResourcePool;
