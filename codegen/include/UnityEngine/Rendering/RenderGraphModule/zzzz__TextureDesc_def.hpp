...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::TextureDesc, "UnityEngine.Rendering.RenderGraphModule", "TextureDesc");
// Dependencies UnityEngine.Color, UnityEngine.Experimental.Rendering.GraphicsFormat, UnityEngine.FilterMode, UnityEngine.RenderTextureMemoryless, UnityEngine.Rendering.MSAASamples, UnityEngine.Rendering.RenderGraphModule.FastMemoryDesc, UnityEngine.Rendering.RenderGraphModule.TextureSizeMode, UnityEngine.Rendering.TextureDimension, UnityEngine.TextureWrapMode, UnityEngine.VRTextureUsage, UnityEngine.Vector2
namespace UnityEngine::Rendering::RenderGraphModule {
// Is value type: true
...
/// @brief Method CalculateFinalDimensions, addr 0x18207a470, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int CalculateFinalDimensions() ;

/// @brief Method GetHashCode, addr 0x18207a4e0, size 0x1a0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method InitDefaultValues, addr 0x18207a680, size 0x70, virtual false, abstract: false, final false
inline void InitDefaultValues(bool  dynamicResolution, bool  xrReady) ;

/// @brief Method .ctor, addr 0x18207a850, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ScaleFunc*  func, bool  dynamicResolution, bool  xrReady) ;

/// @brief Method .ctor, addr 0x18207a6f0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::RenderTexture*  input) ;

/// @brief Method .ctor, addr 0x18207aa80, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::RenderTextureDescriptor  input) ;

/// @brief Method .ctor, addr 0x18207a9d0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RenderGraphModule::TextureDesc  input) ;

/// @brief Method .ctor, addr 0x18207a920, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector2  scale, bool  dynamicResolution, bool  xrReady) ;

/// @brief Method .ctor, addr 0x18207a7b0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(int32_t  width, int32_t  height, bool  dynamicResolution, bool  xrReady) ;

/// @brief Method get_colorFormat, addr 0x18207abf0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_colorFormat() ;

/// @brief Method get_depthBufferBits, addr 0x18207ac30, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DepthBits get_depthBufferBits() ;

/// @brief Method set_colorFormat, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
inline void set_colorFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  value) ;

/// @brief Method set_depthBufferBits, addr 0x18207ac50, size 0x330, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "sizeMode", ty: "::UnityEngine::Rendering::RenderGraphModule::TextureSizeMode", modifiers: "", def_value: None }, CppParam { name: "width", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "height", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "slices", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "scale", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "func", ty: "::UnityEngine::Rendering::ScaleFunc*", modifiers: "", def_value: None }, CppParam { name: "format", ty: "::UnityEngine::Experimental::Rendering::GraphicsFormat", modifiers: "", def_value: None }, CppParam { name: "filterMode", ty: "::UnityEngine::FilterMode", modifiers: "", def_value: None }, CppParam { name: "wrapMode", ty: "::UnityEngine::TextureWrapMode", modifiers: "", def_value: None }, CppParam { name: "dimension", ty: "::UnityEngine::Rendering::TextureDimension", modifiers: "", def_value: None }, CppParam { name: "enableRandomWrite", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "useMipMap", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "autoGenerateMips", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isShadowMap", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "anisoLevel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "mipMapBias", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "msaaSamples", ty: "::UnityEngine::Rendering::MSAASamples", modifiers: "", def_value: None }, CppParam { name: "bindTextureMS", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "useDynamicScale", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "useDynamicScaleExplicit", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "memoryless", ty: "::UnityEngine::RenderTextureMemoryless", modifiers: "", def_value: None }, CppParam { name: "vrUsage", ty: "::UnityEngine::VRTextureUsage", modifiers: "", def_value: None }, CppParam { name: "enableShadingRate", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "fastMemoryDesc", ty: "::UnityEngine::Rendering::RenderGraphModule::FastMemoryDesc", modifiers: "", def_value: None }, CppParam { name: "fallBackToBlackTexture", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "disableFallBackToImportedTexture", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "clearBuffer", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "clearColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "discardBuffer", ty: "bool", modifiers: "", def_value: None }]
constexpr TextureDesc(::UnityEngine::Rendering::RenderGraphModule::TextureSizeMode  sizeMode, int32_t  width, int32_t  height, int32_t  slices, ::UnityEngine::Vector2  scale, ::UnityEngine::Rendering::ScaleFunc*  func, ::UnityEngine::Experimental::Rendering::GraphicsFormat  format, ::UnityEngine::FilterMode  filterMode, ::UnityEngine::TextureWrapMode  wrapMode, ::UnityEngine::Rendering::TextureDimension  dimension, bool  enableRandomWrite, bool  useMipMap, bool  autoGenerateMips, bool  isShadowMap, int32_t  anisoLevel, float_t  mipMapBias, ::UnityEngine::Rendering::MSAASamples  msaaSamples, bool  bindTextureMS, bool  useDynamicScale, bool  useDynamicScaleExplicit, ::UnityEngine::RenderTextureMemoryless  memoryless, ::UnityEngine::VRTextureUsage  vrUsage, bool  enableShadingRate, ::StringW  name, ::UnityEngine::Rendering::RenderGraphModule::FastMemoryDesc  fastMemoryDesc, bool  fallBackToBlackTexture, bool  disableFallBackToImportedTexture, bool  clearBuffer, ::UnityEngine::Color  clearColor, bool  discardBuffer) noexcept;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::TextureDesc) == 0x80, "Size mismatch!");
