...
/// @brief Field defaultResources, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_defaultResources, put=__cordl_internal_set_defaultResources)) ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources*  defaultResources;
