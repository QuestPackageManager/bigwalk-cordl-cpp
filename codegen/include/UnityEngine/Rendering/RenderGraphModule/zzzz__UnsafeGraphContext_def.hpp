...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*, "UnityEngine.Rendering.RenderGraphModule", "UnsafeGraphContext");
...
/// @brief Method FromInternalContext, addr 0x182062d90, size 0xb0, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext) == 0x20, "Size mismatch!");
