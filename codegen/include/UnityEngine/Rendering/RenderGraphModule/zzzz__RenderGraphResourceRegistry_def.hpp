...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_RenderGraphResourcesData*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourceRegistry/RenderGraphResourcesData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_ResourceCallback*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourceRegistry/ResourceCallback");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_ResourceCreateCallback*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourceRegistry/ResourceCreateCallback");
...
inline ::System::IAsyncResult* BeginInvoke(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  rgContext, ::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*  res, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
...
/// @brief Method .ctor, addr 0x1813d1200, size 0x1a10, virtual false, abstract: false, final false
...
/// @brief Field createResourceCallback, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_createResourceCallback, put=__cordl_internal_set_createResourceCallback)) ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_ResourceCreateCallback*  createResourceCallback;
...
/// @brief Field releaseResourceCallback, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_releaseResourceCallback, put=__cordl_internal_set_releaseResourceCallback)) ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_ResourceCallback*  releaseResourceCallback;

/// @brief Field resourceArray, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_resourceArray, put=__cordl_internal_set_resourceArray)) ::UnityEngine::Rendering::DynamicArray_1<::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*>*  resourceArray;
...
/// @brief Method Cleanup, addr 0x1820772c0, size 0x80, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x182077340, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method PurgeUnusedGraphicsResources, addr 0x181a9eb10, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1820773b0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_ActiveRendererLists, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ActiveRendererLists, put=__cordl_internal_set_m_ActiveRendererLists)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::RendererList>*  m_ActiveRendererLists;
...
/// @brief Field m_RenderGraphDebug, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RenderGraphDebug, put=__cordl_internal_set_m_RenderGraphDebug)) ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDebugParams*  m_RenderGraphDebug;

/// @brief Field m_RenderGraphResources, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RenderGraphResources, put=__cordl_internal_set_m_RenderGraphResources)) ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry_RenderGraphResourcesData*>  m_RenderGraphResources;

/// @brief Field m_RendererListLegacyResources, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RendererListLegacyResources, put=__cordl_internal_set_m_RendererListLegacyResources)) ::UnityEngine::Rendering::DynamicArray_1<::UnityEngine::Rendering::RenderGraphModule::RendererListLegacyResource>*  m_RendererListLegacyResources;

/// @brief Field m_RendererListResources, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RendererListResources, put=__cordl_internal_set_m_RendererListResources)) ::UnityEngine::Rendering::DynamicArray_1<::UnityEngine::Rendering::RenderGraphModule::RendererListResource>*  m_RendererListResources;
...
/// @brief Method BeginExecute, addr 0x182073140, size 0x140, virtual false, abstract: false, final false
inline void BeginExecute(int32_t  currentFrameIndex) ;

/// @brief Method BeginRenderGraph, addr 0x182073280, size 0xb0, virtual false, abstract: false, final false
inline void BeginRenderGraph(int32_t  executionCount) ;

/// @brief Method CheckBufferResource, addr 0x182073330, size 0x70, virtual false, abstract: false, final false
inline void CheckBufferResource(::UnityEngine::Rendering::RenderGraphModule::BufferResource*  bufferResource) ;

/// @brief Method CheckHandleValidity, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckHandleValidity(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method CheckHandleValidity, addr 0x1820733a0, size 0x120, virtual false, abstract: false, final false
inline void CheckHandleValidity(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType  type, int32_t  index) ;

/// @brief Method CheckTextureResource, addr 0x1820734c0, size 0x80, virtual false, abstract: false, final false
inline void CheckTextureResource(::UnityEngine::Rendering::RenderGraphModule::TextureResource*  texResource) ;

/// @brief Method Cleanup, addr 0x182073540, size 0xc0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x182073750, size 0x1b0, virtual false, abstract: false, final false
inline void Clear(bool  onException) ;

/// @brief Method ClearResource, addr 0x182073600, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ClearTexture, addr 0x182073690, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CreateBuffer, addr 0x182073900, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method CreateGizmoRendererList, addr 0x1820739e0, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateGizmoRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Camera*>  camera, ::by_ref<::UnityEngine::Rendering::GizmoSubset>  gizmoSubset) ;

/// @brief Method CreatePooledResource, addr 0x182073a70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CreatePooledResource, addr 0x182073a90, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method CreateRendererList, addr 0x182073b90, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method CreateRendererList, addr 0x182073ca0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method CreateRendererLists, addr 0x182073e70, size 0x190, virtual false, abstract: false, final false
inline void CreateRendererLists(::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*  rendererLists, ::UnityEngine::Rendering::ScriptableRenderContext  context, bool  manualDispatch) ;

/// @brief Method CreateShadowRendererList, addr 0x182074000, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateShadowRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Rendering::ShadowDrawingSettings>  shadowDrawinSettings) ;

/// @brief Method CreateSharedTexture, addr 0x182074080, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method CreateSkyboxRendererList, addr 0x182074290, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CreateSkyboxRendererList, addr 0x182074470, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateSkyboxRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Camera*>  camera, ::UnityEngine::Matrix4x4  projectionMatrix, ::UnityEngine::Matrix4x4  viewMatrix) ;

/// @brief Method CreateSkyboxRendererList, addr 0x182074310, size 0x160, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateSkyboxRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Camera*>  camera, ::UnityEngine::Matrix4x4  projectionMatrixL, ::UnityEngine::Matrix4x4  viewMatrixL, ::UnityEngine::Matrix4x4  projectionMatrixR, ::UnityEngine::Matrix4x4  viewMatrixR) ;

/// @brief Method CreateTexture, addr 0x182074660, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method CreateTextureCallback, addr 0x182074570, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method CreateUIOverlayRendererList, addr 0x1820747a0, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateUIOverlayRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Camera*>  camera, ::by_ref<::UnityEngine::Rendering::UISubset>  uiSubset) ;

/// @brief Method CreateWireOverlayRendererList, addr 0x182074830, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateWireOverlayRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::by_ref<::UnityEngine::Camera*>  camera) ;

/// @brief Method EnableIntraFrameMemoryAliasing, addr 0x1820748b0, size 0x60, virtual false, abstract: false, final false
inline void EnableIntraFrameMemoryAliasing(bool  enabled) ;

/// @brief Method EndExecute, addr 0x182074910, size 0x50, virtual false, abstract: false, final false
inline void EndExecute() ;

/// @brief Method FlushLogs, addr 0x182074960, size 0x10, virtual false, abstract: false, final false
inline void FlushLogs() ;

/// @brief Method GetBuffer, addr 0x182074b70, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* GetBuffer(::by_ref<::UnityEngine::Rendering::RenderGraphModule::BufferHandle>  handle) ;

/// @brief Method GetBuffer, addr 0x182074b00, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* GetBuffer(int32_t  index) ;

/// @brief Method GetBufferResource, addr 0x182074a90, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GetBufferResource, addr 0x182074a20, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::BufferResource* GetBufferResource(int32_t  index) ;

/// @brief Method GetBufferResourceCount, addr 0x182074970, size 0x10, virtual false, abstract: false, final false
inline int32_t GetBufferResourceCount() ;

/// @brief Method GetBufferResourceDesc, addr 0x182074980, size 0xa0, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::RenderGraphModule::BufferDesc> GetBufferResourceDesc(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle, bool  noThrowOnInvalidDesc) ;

/// @brief Method GetFormat, addr 0x182074c10, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  color, ::UnityEngine::Experimental::Rendering::GraphicsFormat  depthStencil) ;

/// @brief Method GetLatestVersionHandle, addr 0x182074c20, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetRayTracingAccelerationStructure, addr 0x182074cf0, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RayTracingAccelerationStructure* GetRayTracingAccelerationStructure(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureHandle>  handle) ;

/// @brief Method GetRayTracingAccelerationStructureResource, addr 0x182074c80, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureResource* GetRayTracingAccelerationStructureResource(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle) ;

/// @brief Method GetRayTracingAccelerationStructureResourceCount, addr 0x182074c70, size 0x10, virtual false, abstract: false, final false
inline int32_t GetRayTracingAccelerationStructureResourceCount() ;

/// @brief Method GetRenderGraphResourceName, addr 0x182074dd0, size 0x40, virtual false, abstract: false, final false
inline ::StringW GetRenderGraphResourceName(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method GetRenderGraphResourceName, addr 0x182074d90, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetRenderGraphResourceTransientIndex, addr 0x182074e10, size 0x30, virtual false, abstract: false, final false
inline int32_t GetRenderGraphResourceTransientIndex(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method GetRenderTargetInfo, addr 0x182074e40, size 0x4d0, virtual false, abstract: false, final false
...
/// @brief Method GetRendererList, addr 0x182075310, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetResourceCount, addr 0x182075400, size 0x20, virtual false, abstract: false, final false
inline int32_t GetResourceCount(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType  type) ;

/// @brief Method GetResourceLowLevel, addr 0x182075420, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetSharedResourceCount, addr 0x182075450, size 0x10, virtual false, abstract: false, final false
inline int32_t GetSharedResourceCount(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType  type) ;

/// @brief Method GetTexture, addr 0x1820755f0, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetTexture(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  handle) ;

/// @brief Method GetTexture, addr 0x182075690, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetTexture(int32_t  index) ;

/// @brief Method GetTextureResource, addr 0x182075580, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GetTextureResource, addr 0x182075510, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::TextureResource* GetTextureResource(int32_t  index) ;

/// @brief Method GetTextureResourceCount, addr 0x182075460, size 0x10, virtual false, abstract: false, final false
inline int32_t GetTextureResourceCount() ;

/// @brief Method GetTextureResourceDesc, addr 0x182075470, size 0xa0, virtual false, abstract: false, final false
inline ::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureDesc> GetTextureResourceDesc(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle, bool  noThrowOnInvalidDesc) ;

/// @brief Method GetZeroVersionHandle, addr 0x182075700, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle GetZeroVersionHandle(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method ImportBackbuffer, addr 0x182075720, size 0x1c0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportBackbuffer(::UnityEngine::Rendering::RenderTargetIdentifier  rt, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::RenderTargetInfo>  info, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams>  importParams) ;

/// @brief Method ImportBuffer, addr 0x1820758e0, size 0xc0, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::BufferHandle ImportBuffer(::UnityEngine::GraphicsBuffer*  graphicsBuffer) ;

/// @brief Method ImportRayTracingAccelerationStructure, addr 0x1820759a0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method ImportTexture, addr 0x182075cd0, size 0x260, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportTexture(::by_ref<::UnityEngine::Rendering::RTHandle*>  rt, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams>  importParams, bool  isBuiltin) ;

/// @brief Method ImportTexture, addr 0x182075a80, size 0x210, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle ImportTexture(::by_ref<::UnityEngine::Rendering::RTHandle*>  rt, ::UnityEngine::Rendering::RenderGraphModule::RenderTargetInfo  info, ::by_ref<::UnityEngine::Rendering::RenderGraphModule::ImportResourceParams>  importParams) ;

/// @brief Method ImportTexture, addr 0x182075c90, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method IncrementReadCount, addr 0x182075f30, size 0x40, virtual false, abstract: false, final false
inline void IncrementReadCount(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method IncrementWriteCount, addr 0x182075f70, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle IncrementWriteCount(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method IsGraphicsResourceCreated, addr 0x182075fd0, size 0x40, virtual false, abstract: false, final false
inline bool IsGraphicsResourceCreated(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method IsRenderGraphResourceImported, addr 0x182076040, size 0x30, virtual false, abstract: false, final false
inline bool IsRenderGraphResourceImported(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method IsRenderGraphResourceImported, addr 0x182076010, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method IsRenderGraphResourceShared, addr 0x182076070, size 0x20, virtual false, abstract: false, final false
inline bool IsRenderGraphResourceShared(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method IsRenderGraphResourceShared, addr 0x182076090, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IsRendererListCreated, addr 0x1820760b0, size 0x90, virtual false, abstract: false, final false
inline bool IsRendererListCreated(::by_ref<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>  res) ;

/// @brief Method LogResources, addr 0x182076140, size 0x110, virtual false, abstract: false, final false
inline void LogResources() ;

/// @brief Method ManageSharedRenderGraphResources, addr 0x182076250, size 0x100, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry* New_ctor(::UnityEngine::Rendering::RenderGraphModule::RenderGraphDebugParams*  renderGraphDebug, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger*  frameInformationLogger) ;

/// @brief Method PurgeUnusedGraphicsResources, addr 0x182076350, size 0x60, virtual false, abstract: false, final false
inline void PurgeUnusedGraphicsResources() ;

/// @brief Method RefreshSharedTextureDesc, addr 0x1820763b0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method ReleasePooledResource, addr 0x1820764a0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ReleasePooledResource, addr 0x1820764c0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ReleaseSharedTexture, addr 0x182076580, size 0xb0, virtual false, abstract: false, final false
inline void ReleaseSharedTexture(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  texture) ;

/// @brief Method ReleaseTextureCallback, addr 0x182076630, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetTextureAsMemoryLess, addr 0x182076700, size 0x90, virtual false, abstract: false, final false
inline void SetTextureAsMemoryLess(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle) ;

/// @brief Method TextureNeedsFallback, addr 0x182076790, size 0xb0, virtual false, abstract: false, final false
inline bool TextureNeedsFallback(::by_ref<::UnityEngine::Rendering::RenderGraphModule::TextureHandle>  handle) ;

/// @brief Method UpdateSharedResourceLastFrameIndex, addr 0x182076880, size 0x40, virtual false, abstract: false, final false
inline void UpdateSharedResourceLastFrameIndex(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  handle) ;

/// @brief Method UpdateSharedResourceLastFrameIndex, addr 0x182076840, size 0x40, virtual false, abstract: false, final false
inline void UpdateSharedResourceLastFrameIndex(int32_t  type, int32_t  index) ;

/// @brief Method ValidateBufferDesc, addr 0x1820768c0, size 0x80, virtual false, abstract: false, final false
inline void ValidateBufferDesc(::by_ref<::UnityEngine::Rendering::RenderGraphModule::BufferDesc>  desc) ;

/// @brief Method ValidateFormat, addr 0x182076940, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method ValidateRenderTarget, addr 0x1820769a0, size 0x70, virtual false, abstract: false, final false
inline void ValidateRenderTarget(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res) ;

/// @brief Method ValidateRendererListDesc, addr 0x182076a10, size 0x160, virtual false, abstract: false, final false
inline void ValidateRendererListDesc(::by_ref<::UnityEngine::Rendering::RendererUtils::RendererListDesc>  desc) ;

/// @brief Method ValidateTextureDesc, addr 0x182076b70, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182076d20, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x182076e20, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method get_current, addr 0x182077230, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x182077270, size 0x50, virtual false, abstract: false, final false
