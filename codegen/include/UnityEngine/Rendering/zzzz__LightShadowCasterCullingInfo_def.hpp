...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LightShadowCasterCullingInfo, "UnityEngine.Rendering", "LightShadowCasterCullingInfo");
...
static_assert(sizeof(::UnityEngine::Rendering::LightShadowCasterCullingInfo) == 0x10, "Size mismatch!");
