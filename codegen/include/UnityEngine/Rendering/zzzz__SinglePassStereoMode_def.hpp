...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SinglePassStereoMode, "UnityEngine.Rendering", "SinglePassStereoMode");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Field Instancing value: I32(2)
static ::UnityEngine::Rendering::SinglePassStereoMode const Instancing;

/// @brief Field Multiview value: I32(3)
...
/// @brief Field SideBySide value: I32(1)
...
static_assert(offsetof(::UnityEngine::Rendering::SinglePassStereoMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::SinglePassStereoMode) == 0x4, "Size mismatch!");
