...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CoreProfileId, "UnityEngine.Rendering", "CoreProfileId");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::CoreProfileId, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::CoreProfileId) == 0x4, "Size mismatch!");
