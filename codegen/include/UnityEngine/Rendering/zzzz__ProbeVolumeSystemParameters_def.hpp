...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ProbeVolumeSystemParameters, "UnityEngine.Rendering", "ProbeVolumeSystemParameters");
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeSystemParameters) == 0x60, "Size mismatch!");
