...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::GenericPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::GenericPool_1, "UnityEngine.Rendering", "GenericPool`1");
...
static inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> Get(::by_ref<T>  value) ;
