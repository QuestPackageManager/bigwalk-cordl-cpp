...
static inline ::UnityEngine::Rendering::SurfaceDataAttributes* New_ctor(::ArrayW<::StringW>  displayNames, bool  isDirection, bool  sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision  precision, bool  checkIsNormalized, ::StringW  preprocessor) ;
...
/// @brief Method .ctor, addr 0x18203e220, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18203e2c0, size 0x60, virtual false, abstract: false, final false
