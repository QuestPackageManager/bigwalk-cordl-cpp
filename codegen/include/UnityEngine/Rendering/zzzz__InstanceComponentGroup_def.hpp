...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::InstanceComponentGroup, "UnityEngine.Rendering", "InstanceComponentGroup");
// Dependencies 
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::InstanceComponentGroup, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::InstanceComponentGroup) == 0x4, "Size mismatch!");
