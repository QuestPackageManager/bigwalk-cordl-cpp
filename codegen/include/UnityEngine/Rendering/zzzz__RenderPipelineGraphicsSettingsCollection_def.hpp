...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsCollection*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsCollection*, "UnityEngine.Rendering", "RenderPipelineGraphicsSettingsCollection");
...
/// @brief Method .ctor, addr 0x1822a1e40, size 0x3c0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_settingsList, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderPipelineGraphicsSettingsCollection) == 0x18, "Size mismatch!");
