...
/// @brief Method ClearStaticCache, addr 0x1822beb80, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method SetTextWithoutNotify, addr 0x1822becf0, size 0x70, virtual false, abstract: false, final false
inline void SetTextWithoutNotify(::StringW  value) ;

/// @brief Method Temp, addr 0x1822bed60, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::GUIContent* Temp(::StringW  t) ;

/// @brief Method ToString, addr 0x1822bee40, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822bf260, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1822bf1b0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GUIContent*  src) ;

/// @brief Method .ctor, addr 0x1822bf2d0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  text) ;

/// @brief Method .ctor, addr 0x1822bf0d0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, ::UnityEngine::Texture*  image, ::StringW  tooltip) ;

/// @brief Method .ctor, addr 0x1822bf190, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, ::StringW  tooltip) ;

/// @brief Method add_OnTextChanged, addr 0x18062eaa0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_textWithWhitespace, addr 0x1822bf300, size 0x60, virtual false, abstract: false, final false
inline ::StringW get_textWithWhitespace() ;

/// @brief Method get_tooltip, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_tooltip() ;

/// @brief Method remove_OnTextChanged, addr 0x18062ec30, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method set_text, addr 0x1822bf3c0, size 0xd0, virtual false, abstract: false, final false
inline void set_text(::StringW  value) ;

/// @brief Method set_textWithWhitespace, addr 0x1822bf360, size 0x60, virtual false, abstract: false, final false
inline void set_textWithWhitespace(::StringW  value) ;

/// @brief Method set_tooltip, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::GUIContent) == 0x38, "Size mismatch!");
