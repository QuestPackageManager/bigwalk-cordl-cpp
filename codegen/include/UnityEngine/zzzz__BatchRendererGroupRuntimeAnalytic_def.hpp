...
/// @brief Method CreateBatchRendererGroupRuntimeAnalytic, addr 0x18223ffd0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182240020, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::BatchRendererGroupRuntimeAnalytic) == 0x38, "Size mismatch!");
