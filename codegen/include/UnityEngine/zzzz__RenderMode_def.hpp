...
DEFINE_IL2CPP_CLASS(::UnityEngine::RenderMode, "UnityEngine", "RenderMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::RenderMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::RenderMode) == 0x4, "Size mismatch!");
