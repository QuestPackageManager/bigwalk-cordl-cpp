...
DEFINE_IL2CPP_CLASS(::UnityEngine::Bindings::CodegenOptions, "UnityEngine.Bindings", "CodegenOptions");
// Dependencies 
namespace UnityEngine::Bindings {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Bindings::CodegenOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Bindings::CodegenOptions) == 0x4, "Size mismatch!");
