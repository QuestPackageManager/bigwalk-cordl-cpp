...
/// @brief Method .ctor, addr 0x18230d710, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFreeFunction) ;

/// @brief Method .ctor, addr 0x18230d600, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFreeFunction, bool  isThreadSafe) ;

/// @brief Method set_HasExplicitThis, addr 0x1819b9510, size 0x10, virtual true, abstract: false, final true
inline void set_HasExplicitThis(bool  value) ;

/// @brief Method set_IsFreeFunction, addr 0x1818376c0, size 0x10, virtual true, abstract: false, final true
inline void set_IsFreeFunction(bool  value) ;

/// @brief Method set_IsThreadSafe, addr 0x1803a7530, size 0x10, virtual true, abstract: false, final true
inline void set_IsThreadSafe(bool  value) ;

/// @brief Method set_Name, addr 0x180308500, size 0x30, virtual true, abstract: false, final true
inline void set_Name(::StringW  value) ;

/// @brief Method set_ThrowsException, addr 0x1805c55e0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Bindings::NativeMethodAttribute) == 0x20, "Size mismatch!");
