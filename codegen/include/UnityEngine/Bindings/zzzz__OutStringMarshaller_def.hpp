...
public:
// Declarations
/// @brief Method GetStringAndDispose, addr 0x18227f970, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Bindings::OutStringMarshaller) == 0x1, "Size mismatch!");
