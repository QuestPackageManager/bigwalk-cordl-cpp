...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::CommandEvent_Command, "UnityEngine.InputForUI", "CommandEvent/Command");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::CommandEvent_Type, "UnityEngine.InputForUI", "CommandEvent/Type");
...
static_assert(offsetof(::UnityEngine::InputForUI::CommandEvent_Type, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputForUI::CommandEvent_Type) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::InputForUI::CommandEvent_Command, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method ToString, addr 0x1822e4030, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_eventModifiers, addr 0x1802f41a0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x180303b50, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_eventModifiers, addr 0x1802f4390, size 0x10, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x1804bda50, size 0x10, virtual false, abstract: false, final false
