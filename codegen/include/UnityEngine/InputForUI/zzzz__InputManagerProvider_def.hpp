...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::InputManagerProvider_ButtonEventsIterator, "UnityEngine.InputForUI", "InputManagerProvider/ButtonEventsIterator");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::InputManagerProvider_Configuration, "UnityEngine.InputForUI", "InputManagerProvider/Configuration");
// Dependencies 
namespace UnityEngine::InputForUI {
// Is value type: true
...
/// @brief Method FromState, addr 0x1822e3d10, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x1822e3d70, size 0x40, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x1822e3db0, size 0x20, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1822e3dd0, size 0x40, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method get_Current, addr 0x1822e3e10, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputForUI::InputManagerProvider_ButtonEventsIterator) == 0x8, "Size mismatch!");
...
public:
// Declarations
/// @brief Method GetDefaultConfiguration, addr 0x1822e40a0, size 0x440, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "HorizontalAxis", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "VerticalAxis", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "SubmitButton", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "CancelButton", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "NavigateNextButton", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "NavigatePreviousButton", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "InputActionsPerSecond", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "RepeatDelay", ty: "float_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::UnityEngine::InputForUI::InputManagerProvider_Configuration) == 0x38, "Size mismatch!");
...
/// @brief Method GetAxisRaw, addr 0x1822ea2b0, size 0x10, virtual true, abstract: false, final true
inline float_t GetAxisRaw(::StringW  axis) ;

/// @brief Method GetButtonDown, addr 0x181abfb30, size 0x10, virtual true, abstract: false, final true
inline bool GetButtonDown(::StringW  button) ;

/// @brief Method GetKey, addr 0x1822ea2c0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method GetMouseButton, addr 0x1822ea310, size 0x10, virtual true, abstract: false, final true
inline bool GetMouseButton(int32_t  button) ;
...
/// @brief Method get_compositionString, addr 0x1822ea320, size 0x10, virtual true, abstract: false, final true
inline ::StringW get_compositionString() ;
...
/// @brief Method get_mouseScrollDelta, addr 0x1802fb3c0, size 0x10, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 get_mouseScrollDelta() ;

/// @brief Method get_touchCount, addr 0x181883c50, size 0x10, virtual true, abstract: false, final true
inline int32_t get_touchCount() ;

/// @brief Method get_touchSupported, addr 0x1822ea340, size 0x10, virtual true, abstract: false, final true
inline bool get_touchSupported() ;
...
/// @brief Method get_timeAsRational, addr 0x1822eb4e0, size 0x20, virtual true, abstract: false, final true
inline ::Unity::IntegerTime::RationalTime get_timeAsRational() ;
...
/// @brief Method AzimuthAndAlitutudeToTilt, addr 0x180cbd580, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 AzimuthAndAlitutudeToTilt(float_t  altitude, float_t  azimuth) ;

/// @brief Method CheckIfIMEChanged, addr 0x1822e7440, size 0x210, virtual false, abstract: false, final false
inline void CheckIfIMEChanged(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method CheckMouseEvents, addr 0x1822e7650, size 0x560, virtual false, abstract: false, final false
inline void CheckMouseEvents(::Unity::IntegerTime::DiscreteTime  currentTime, bool  muted) ;

/// @brief Method CheckMouseScroll, addr 0x1822e7bb0, size 0x300, virtual false, abstract: false, final false
inline void CheckMouseScroll(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method CheckPenEvent, addr 0x1822e7eb0, size 0x3b0, virtual false, abstract: false, final false
inline bool CheckPenEvent(::Unity::IntegerTime::DiscreteTime  currentTime, ::by_ref<::UnityEngine::PenData>  currentPenData) ;

/// @brief Method CheckTouchEvents, addr 0x1822e8260, size 0x5e0, virtual false, abstract: false, final false
inline bool CheckTouchEvents(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method DetectPen, addr 0x1822e8840, size 0xa0, virtual false, abstract: false, final false
inline void DetectPen() ;

/// @brief Method DirectionNavigation, addr 0x1822e88e0, size 0x320, virtual false, abstract: false, final false
inline void DirectionNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method GetEventSourceFromPressedKey, addr 0x1822e8c00, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::EventSource GetEventSourceFromPressedKey() ;

/// @brief Method Initialize, addr 0x1822e8ca0, size 0x1a0, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method InputManagerGetAxisRawOrDefault, addr 0x1822e8e40, size 0xb0, virtual false, abstract: false, final false
inline float_t InputManagerGetAxisRawOrDefault(::StringW  axisName) ;

/// @brief Method InputManagerGetButtonDownOrDefault, addr 0x1822e8ef0, size 0xc0, virtual false, abstract: false, final false
inline bool InputManagerGetButtonDownOrDefault(::StringW  axisName) ;

/// @brief Method InputManagerJoystickWasPressed, addr 0x1822e8fb0, size 0x60, virtual false, abstract: false, final false
inline bool InputManagerJoystickWasPressed() ;

/// @brief Method InputManagerKeyboardWasPressed, addr 0x1822e9010, size 0x50, virtual false, abstract: false, final false
inline bool InputManagerKeyboardWasPressed() ;

/// @brief Method MultiDisplayBottomLeftToPanelPosition, addr 0x1822e9060, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method NextPreviousNavigation, addr 0x1822e9310, size 0x180, virtual false, abstract: false, final false
inline void NextPreviousNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method OnFocusChanged, addr 0x1822e9490, size 0x30, virtual true, abstract: false, final true
inline void OnFocusChanged(bool  focus) ;

/// @brief Method PenStatusToButton, addr 0x1822e94c0, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::InputForUI::PointerEvent_Button PenStatusToButton(::UnityEngine::PenStatus  status) ;

/// @brief Method ReadCurrentNavigationMoveVector, addr 0x1822e94e0, size 0x100, virtual false, abstract: false, final false
inline ::System::ValueTuple_2<::UnityEngine::Vector2,bool> ReadCurrentNavigationMoveVector() ;

/// @brief Method ScreenBottomLeftToPanelDelta, addr 0x1822e95e0, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelDelta(::UnityEngine::Vector2  delta) ;

/// @brief Method ScreenBottomLeftToPanelPosition, addr 0x1822e9600, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2  position, int32_t  targetDisplay) ;

/// @brief Method Shutdown, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void Shutdown() ;

/// @brief Method SubmitCancelNavigation, addr 0x1822e96a0, size 0x220, virtual false, abstract: false, final false
inline void SubmitCancelNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method TiltToAltitude, addr 0x180cbf5e0, size 0x50, virtual false, abstract: false, final false
static inline float_t TiltToAltitude(::UnityEngine::Vector2  tilt) ;

/// @brief Method TiltToAzimuth, addr 0x180cbf630, size 0x230, virtual false, abstract: false, final false
static inline float_t TiltToAzimuth(::UnityEngine::Vector2  tilt) ;

/// @brief Method ToIMECompositionEvent, addr 0x1822e98c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x1822e9920, size 0x7b0, virtual true, abstract: false, final true
inline void Update() ;
...
/// @brief Method .ctor, addr 0x1822ea0d0, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get__eventModifiers, addr 0x1822ea2a0, size 0x10, virtual false, abstract: false, final false
