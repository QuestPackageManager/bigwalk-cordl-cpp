...
// Write type traits
MARK_REF_T(::UnityEngine::InputForUI::NavigationEventRepeatHelper*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputForUI::NavigationEventRepeatHelper*, "UnityEngine.InputForUI", "NavigationEventRepeatHelper");
...
/// @brief Method Reset, addr 0x1822ea430, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ShouldSendMoveEvent, addr 0x1822ea480, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1822ea4e0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::InputForUI::NavigationEventRepeatHelper) == 0x30, "Size mismatch!");
