...
static_assert(offsetof(::UnityEngine::InputForUI::EventModifiers_Modifiers, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method Append, addr 0x1822e44e0, size 0x50, virtual false, abstract: false, final false
static inline void Append(::by_ref<::StringW>  str, ::StringW  value) ;

/// @brief Method IsPressed, addr 0x1822e3ce0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetPressed, addr 0x181e0ed10, size 0x20, virtual false, abstract: false, final false
inline void SetPressed(::UnityEngine::InputForUI::EventModifiers_Modifiers  modifier, bool  pressed) ;

/// @brief Method ToString, addr 0x1822e4530, size 0x3c0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_isAltPressed, addr 0x1822e48f0, size 0x20, virtual false, abstract: false, final false
inline bool get_isAltPressed() ;

/// @brief Method get_isCapsLockEnabled, addr 0x1822e4910, size 0x20, virtual false, abstract: false, final false
inline bool get_isCapsLockEnabled() ;

/// @brief Method get_isCtrlPressed, addr 0x1822e4930, size 0x20, virtual false, abstract: false, final false
inline bool get_isCtrlPressed() ;

/// @brief Method get_isFunctionKeyPressed, addr 0x1822e4950, size 0x20, virtual false, abstract: false, final false
inline bool get_isFunctionKeyPressed() ;

/// @brief Method get_isMetaPressed, addr 0x1822e4970, size 0x20, virtual false, abstract: false, final false
inline bool get_isMetaPressed() ;

/// @brief Method get_isNumericPressed, addr 0x1822e4990, size 0x20, virtual false, abstract: false, final false
inline bool get_isNumericPressed() ;

/// @brief Method get_isShiftPressed, addr 0x1822e49b0, size 0x20, virtual false, abstract: false, final false
