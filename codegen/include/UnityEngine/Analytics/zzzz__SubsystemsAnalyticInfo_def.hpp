...
// Write type traits
MARK_REF_T(::UnityEngine::Analytics::SubsystemsAnalyticInfo*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Analytics::SubsystemsAnalyticInfo*, "UnityEngine.Analytics", "SubsystemsAnalyticInfo");
...
/// @brief Method CreateSubsystemsAnalyticInfo, addr 0x182548410, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182548460, size 0x270, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEngine::Analytics::SubsystemsAnalyticInfo) == 0x58, "Size mismatch!");
