...
/// @brief Method CreateShaderRuntimeInfoAnalytic, addr 0x182287190, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182287240, size 0x280, virtual false, abstract: false, final false
inline void _ctor() ;
