...
/// @brief Method .ctor, addr 0x182548300, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Analytics::SubsystemsAnalyticBase) == 0x38, "Size mismatch!");
