...
DEFINE_IL2CPP_CLASS(::UnityEngine::Analytics::SendEventOptions, "UnityEngine.Analytics", "SendEventOptions");
// Dependencies 
namespace UnityEngine::Analytics {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Analytics::SendEventOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Analytics::SendEventOptions) == 0x4, "Size mismatch!");
