...
DEFINE_IL2CPP_CLASS(::UnityEngine::CubemapFace, "UnityEngine", "CubemapFace");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::CubemapFace, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::CubemapFace) == 0x4, "Size mismatch!");
