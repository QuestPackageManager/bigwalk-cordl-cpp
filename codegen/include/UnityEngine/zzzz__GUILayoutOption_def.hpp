...
DEFINE_IL2CPP_CLASS(::UnityEngine::GUILayoutOption_Type, "UnityEngine", "GUILayoutOption/Type");
...
static_assert(offsetof(::UnityEngine::GUILayoutOption_Type, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::GUILayoutOption_Type) == 0x4, "Size mismatch!");
