...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextAlignment, "UnityEngine", "TextAlignment");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::TextAlignment, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::TextAlignment) == 0x4, "Size mismatch!");
