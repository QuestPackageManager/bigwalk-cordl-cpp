...
/// @brief Method PostRegisteredAtlas, addr 0x1822b52d0, size 0x30, virtual false, abstract: false, final false
static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register, addr 0x1822b5310, size 0x20, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register_Injected, addr 0x1822b5300, size 0x10, virtual false, abstract: false, final false
static inline void Register_Injected(::System::IntPtr  spriteAtlas) ;

/// @brief Method RequestAtlas, addr 0x1822b5330, size 0x80, virtual false, abstract: false, final false
static inline bool RequestAtlas(::StringW  tag) ;

/// @brief Method add_atlasRegistered, addr 0x1822b53b0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasRegistered, addr 0x1822b5460, size 0xb0, virtual false, abstract: false, final false
