...
/// @brief Method GetPosition, addr 0x1821843c0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method get_SideCount, addr 0x180309580, size 0x10, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "", ty: "Square", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
Square(Square && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "Square", modifiers: "const&", def_value: None }]
