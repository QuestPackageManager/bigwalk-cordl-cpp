...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::ConnectionChangeType, "UnityEngine.XR", "ConnectionChangeType");
// Dependencies 
namespace UnityEngine::XR {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::XR::ConnectionChangeType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::XR::ConnectionChangeType) == 0x4, "Size mismatch!");
