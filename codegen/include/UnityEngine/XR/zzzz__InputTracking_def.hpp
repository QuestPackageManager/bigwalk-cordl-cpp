...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::InputTracking_TrackingStateEventType, "UnityEngine.XR", "InputTracking/TrackingStateEventType");
...
static_assert(offsetof(::UnityEngine::XR::InputTracking_TrackingStateEventType, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method InvokeTrackingEvent, addr 0x18254e550, size 0x150, virtual false, abstract: false, final false
