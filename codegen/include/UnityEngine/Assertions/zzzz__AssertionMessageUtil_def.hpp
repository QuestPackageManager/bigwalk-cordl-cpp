...
public:
// Declarations
/// @brief Method BooleanFailureMessage, addr 0x18227ca10, size 0x60, virtual false, abstract: false, final false
static inline ::StringW BooleanFailureMessage(bool  expected) ;

/// @brief Method GetEqualityMessage, addr 0x18227ca70, size 0x90, virtual false, abstract: false, final false
static inline ::StringW GetEqualityMessage(::System::Object*  actual, ::System::Object*  expected, bool  expectEqual) ;

/// @brief Method GetMessage, addr 0x18227cbb0, size 0x20, virtual false, abstract: false, final false
static inline ::StringW GetMessage(::StringW  failureMessage) ;

/// @brief Method GetMessage, addr 0x18227cb00, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW GetMessage(::StringW  failureMessage, ::StringW  expected) ;

/// @brief Method NullFailureMessage, addr 0x18227cbd0, size 0x70, virtual false, abstract: false, final false
