...
DEFINE_IL2CPP_CLASS(::UnityEngine::PenStatus, "UnityEngine", "PenStatus");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::PenStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::PenStatus) == 0x4, "Size mismatch!");
