...
/// @brief Method get_fullPathHash, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AnimatorTransitionInfo) == 0x20, "Size mismatch!");
