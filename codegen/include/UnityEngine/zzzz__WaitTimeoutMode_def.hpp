...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(WaitTimeoutMode)
// Forward declare root types
namespace UnityEngine {
struct WaitTimeoutMode;
}
// Write type traits
MARK_VAL_T(::UnityEngine::WaitTimeoutMode);
DEFINE_IL2CPP_CLASS(::UnityEngine::WaitTimeoutMode, "UnityEngine", "WaitTimeoutMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::WaitTimeoutMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::WaitTimeoutMode) == 0x4, "Size mismatch!");
