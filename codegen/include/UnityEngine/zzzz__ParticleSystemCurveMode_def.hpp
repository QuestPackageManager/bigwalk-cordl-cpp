...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemCurveMode, "UnityEngine", "ParticleSystemCurveMode");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::ParticleSystemCurveMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ParticleSystemCurveMode) == 0x4, "Size mismatch!");
