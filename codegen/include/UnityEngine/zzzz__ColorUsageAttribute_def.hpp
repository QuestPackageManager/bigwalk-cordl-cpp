...
public:
// Declarations
/// @brief Field hdr, offset 0x12, size 0x1 
...
/// @brief Field showAlpha, offset 0x11, size 0x1 
...
/// @brief Method .ctor, addr 0x18226f980, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  showAlpha) ;

/// @brief Method .ctor, addr 0x18226f950, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field showAlpha, offset: 0x11, size: 0x1, def value: None
 bool  ___showAlpha;

/// @brief Field hdr, offset: 0x12, size: 0x1, def value: None
 bool  ___hdr;
...
static_assert(offsetof(::UnityEngine::ColorUsageAttribute, ___showAlpha) == 0x11, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::ColorUsageAttribute, ___hdr) == 0x12, "Offset mismatch!");
...
static_assert(sizeof(::UnityEngine::ColorUsageAttribute) == 0x30, "Size mismatch!");
