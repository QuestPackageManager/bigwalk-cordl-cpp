...
DEFINE_IL2CPP_CLASS(::UnityEngine::DrivenTransformProperties, "UnityEngine", "DrivenTransformProperties");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::DrivenTransformProperties, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::DrivenTransformProperties) == 0x4, "Size mismatch!");
