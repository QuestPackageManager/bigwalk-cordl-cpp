...
DEFINE_IL2CPP_CLASS(::UnityEngine::FontStyle, "UnityEngine", "FontStyle");
// Dependencies 
namespace UnityEngine {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::FontStyle, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::FontStyle) == 0x4, "Size mismatch!");
