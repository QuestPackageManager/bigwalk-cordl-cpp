...
// Declarations
 ...
 __declspec(property(put=set_from)) ::UnityEngine::Vector3  from;

 __declspec(property(put=set_physicsScene)) ::UnityEngine::PhysicsScene  physicsScene;

/// @brief Method ScheduleBatch, addr 0x182302900, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method ScheduleRaycastBatch, addr 0x182302a70, size 0x70, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleRaycastBatch(::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, void*  commands, int32_t  commandLen, void*  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits) ;

/// @brief Method ScheduleRaycastBatch_Injected, addr 0x182302a60, size 0x10, virtual false, abstract: false, final false
static inline void ScheduleRaycastBatch_Injected(::by_ref<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, void*  commands, int32_t  commandLen, void*  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits, ::by_ref<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method .ctor, addr 0x182302ae0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x1802d5410, size 0x10, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::Vector3  value) ;

/// @brief Method set_distance, addr 0x1802f43c0, size 0x10, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_from, addr 0x1802d5400, size 0x10, virtual false, abstract: false, final false
inline void set_from(::UnityEngine::Vector3  value) ;

/// @brief Method set_physicsScene, addr 0x1803bda70, size 0x10, virtual false, abstract: false, final false
