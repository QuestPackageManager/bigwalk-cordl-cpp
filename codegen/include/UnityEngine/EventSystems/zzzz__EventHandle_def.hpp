...
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::EventHandle, "UnityEngine.EventSystems", "EventHandle");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::EventSystems::EventHandle, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::EventSystems::EventHandle) == 0x4, "Size mismatch!");
