...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IEndDragHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IEndDragHandler*, "UnityEngine.EventSystems", "IEndDragHandler");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: false
...
/// @brief Method OnEndDrag, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
