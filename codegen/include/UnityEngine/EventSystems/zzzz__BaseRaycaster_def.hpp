...
/// @brief Method OnCanvasHierarchyChanged, addr 0x180e97890, size 0x140, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDisable, addr 0x182537b30, size 0x70, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x182537ba0, size 0xc0, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x180e97890, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x182537c60, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method get_renderOrderPriority, addr 0x182537df0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_rootRaycaster, addr 0x182537e00, size 0x60, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> get_rootRaycaster() ;

/// @brief Method get_sortOrderPriority, addr 0x182537df0, size 0x10, virtual true, abstract: false, final false
