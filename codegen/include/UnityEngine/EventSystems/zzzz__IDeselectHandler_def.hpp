...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IDeselectHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IDeselectHandler*, "UnityEngine.EventSystems", "IDeselectHandler");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: false
