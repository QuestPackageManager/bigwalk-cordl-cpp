...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IBeginDragHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IBeginDragHandler*, "UnityEngine.EventSystems", "IBeginDragHandler");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: false
