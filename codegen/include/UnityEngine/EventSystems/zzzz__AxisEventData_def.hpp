...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::AxisEventData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::AxisEventData*, "UnityEngine.EventSystems", "AxisEventData");
// Dependencies UnityEngine.EventSystems.BaseEventData, UnityEngine.EventSystems.MoveDirection, UnityEngine.Vector2
namespace UnityEngine::EventSystems {
// Is value type: false
...
/// @brief Method .ctor, addr 0x182536ce0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method get_moveDir, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::MoveDirection get_moveDir() ;

/// @brief Method get_moveVector, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_moveVector() ;

/// @brief Method set_moveDir, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
inline void set_moveDir(::UnityEngine::EventSystems::MoveDirection  value) ;

/// @brief Method set_moveVector, addr 0x1804f6740, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::EventSystems::AxisEventData) == 0x30, "Size mismatch!");
