...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IPointerDownHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IPointerDownHandler*, "UnityEngine.EventSystems", "IPointerDownHandler");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: false
