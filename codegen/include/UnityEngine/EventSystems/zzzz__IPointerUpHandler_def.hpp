...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IPointerUpHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IPointerUpHandler*, "UnityEngine.EventSystems", "IPointerUpHandler");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: false
