...
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::MoveDirection, "UnityEngine.EventSystems", "MoveDirection");
// Dependencies 
namespace UnityEngine::EventSystems {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::EventSystems::MoveDirection, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::EventSystems::MoveDirection) == 0x4, "Size mismatch!");
