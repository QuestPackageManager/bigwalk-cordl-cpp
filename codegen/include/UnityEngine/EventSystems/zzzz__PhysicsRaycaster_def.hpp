...
/// @brief Method Compare, addr 0x182540770, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method ComputeRayAndDistance, addr 0x18253d5b0, size 0x300, virtual false, abstract: false, final false
inline bool ComputeRayAndDistance(::UnityEngine::EventSystems::PointerEventData*  eventData, ::by_ref<::UnityEngine::Ray>  ray, ::by_ref<int32_t>  eventDisplayIndex, ::by_ref<float_t>  distanceToClipPlane) ;

static inline ::UnityEngine::EventSystems::PhysicsRaycaster* New_ctor() ;

/// @brief Method Raycast, addr 0x18253d8b0, size 0x420, virtual true, abstract: false, final false
...
/// @brief Method get_depth, addr 0x18253dcd0, size 0x70, virtual true, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_eventCamera, addr 0x18253dd40, size 0x70, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_eventMask, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_eventMask() ;

/// @brief Method get_finalEventMask, addr 0x18253ddb0, size 0x80, virtual false, abstract: false, final false
inline int32_t get_finalEventMask() ;

/// @brief Method get_maxRayIntersections, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_maxRayIntersections() ;

/// @brief Method set_eventMask, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
inline void set_eventMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_maxRayIntersections, addr 0x180393010, size 0x10, virtual false, abstract: false, final false
