...
// Write type traits
MARK_REF_T(::UnityEngine::Experimental::Rendering::XROcclusionMesh*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::XROcclusionMesh*, "UnityEngine.Experimental.Rendering", "XROcclusionMesh");
...
/// @brief Method CreateOcclusionMeshCombined, addr 0x181fdfcc0, size 0x3a0, virtual false, abstract: false, final false
inline void CreateOcclusionMeshCombined() ;

/// @brief Method IsOcclusionMeshSupported, addr 0x181fe0060, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method RenderOcclusionMesh, addr 0x181fe0080, size 0x320, virtual false, abstract: false, final false
inline void RenderOcclusionMesh(::UnityEngine::Rendering::CommandBuffer*  cmd, float_t  occlusionMeshScale, bool  yFlip) ;

/// @brief Method SetMaterial, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void SetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method TryGetOcclusionMeshCombinedHashCode, addr 0x181fe03a0, size 0xc0, virtual false, abstract: false, final false
inline bool TryGetOcclusionMeshCombinedHashCode(::by_ref<int32_t>  hashCode) ;

/// @brief Method UpdateCombinedMesh, addr 0x181fe0460, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method get_hasValidOcclusionMesh, addr 0x181fe05d0, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Experimental::Rendering::XROcclusionMesh) == 0x30, "Size mismatch!");
