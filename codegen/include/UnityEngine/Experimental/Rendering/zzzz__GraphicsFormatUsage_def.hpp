...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::GraphicsFormatUsage, "UnityEngine.Experimental.Rendering", "GraphicsFormatUsage");
// Dependencies 
namespace UnityEngine::Experimental::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::Rendering::GraphicsFormatUsage, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::Rendering::GraphicsFormatUsage) == 0x4, "Size mismatch!");
