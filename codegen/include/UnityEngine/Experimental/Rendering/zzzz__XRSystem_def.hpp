...
/// @brief Method BuildPass, addr 0x181fe24b0, size 0x3d0, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::Rendering::XRPassCreateInfo BuildPass(::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass  xrRenderPass, ::UnityEngine::Rendering::ScriptableCullingParameters  cullingParameters, ::UnityEngine::Experimental::Rendering::XRLayout*  layout, bool  isLastPass) ;

/// @brief Method BuildView, addr 0x181fe2880, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method CanUseSinglePass, addr 0x181fe2aa0, size 0x160, virtual false, abstract: false, final false
static inline bool CanUseSinglePass(::UnityEngine::Camera*  camera, ::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass  renderPass) ;

/// @brief Method CreateDefaultLayout, addr 0x181fe2c00, size 0x7c0, virtual false, abstract: false, final false
static inline void CreateDefaultLayout(::UnityEngine::Camera*  camera, ::UnityEngine::Experimental::Rendering::XRLayout*  layout) ;

/// @brief Method Dispose, addr 0x181fe33c0, size 0x100, virtual false, abstract: false, final false
static inline void Dispose() ;

/// @brief Method EndLayout, addr 0x181fe34c0, size 0x190, virtual false, abstract: false, final false
static inline void EndLayout() ;

/// @brief Method GetActiveDisplay, addr 0x181fe3650, size 0x40, virtual false, abstract: false, final false
static inline Il2CppObject* GetActiveDisplay() ;

/// @brief Method GetDisplayMSAASamples, addr 0x181fe3690, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::MSAASamples GetDisplayMSAASamples() ;

/// @brief Method GetDynamicResolutionScale, addr 0x181fe36d0, size 0x40, virtual false, abstract: false, final false
static inline float_t GetDynamicResolutionScale() ;

/// @brief Method GetMirrorViewMode, addr 0x181fe3710, size 0x50, virtual false, abstract: false, final false
static inline int32_t GetMirrorViewMode() ;

/// @brief Method GetOcclusionMeshScale, addr 0x181fe3760, size 0x40, virtual false, abstract: false, final false
static inline float_t GetOcclusionMeshScale() ;

/// @brief Method GetRenderViewportScale, addr 0x181fe37a0, size 0x40, virtual false, abstract: false, final false
static inline float_t GetRenderViewportScale() ;

/// @brief Method GetUseVisibilityMesh, addr 0x181fe37e0, size 0x40, virtual false, abstract: false, final false
static inline bool GetUseVisibilityMesh() ;

/// @brief Method Initialize, addr 0x181fe3820, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method NewLayout, addr 0x181fe3a80, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::Rendering::XRLayout* NewLayout() ;

/// @brief Method ReconfigurePass, addr 0x181fe3b10, size 0x480, virtual false, abstract: false, final false
static inline void ReconfigurePass(::UnityEngine::Experimental::Rendering::XRPass*  xrPass, ::UnityEngine::Camera*  camera) ;

/// @brief Method RefreshDeviceInfo, addr 0x181fe3f90, size 0x160, virtual false, abstract: false, final false
static inline void RefreshDeviceInfo() ;

/// @brief Method RenderMirrorView, addr 0x181fe40f0, size 0x60, virtual false, abstract: false, final false
static inline void RenderMirrorView(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Camera*  camera) ;

/// @brief Method ScaleTextureHeightForXR, addr 0x181fe4150, size 0x40, virtual false, abstract: false, final false
static inline int32_t ScaleTextureHeightForXR(::UnityEngine::RenderTexture*  texture) ;

/// @brief Method ScaleTextureWidthForXR, addr 0x181fe4190, size 0x40, virtual false, abstract: false, final false
static inline int32_t ScaleTextureWidthForXR(::UnityEngine::RenderTexture*  texture) ;

/// @brief Method SetDisplayMSAASamples, addr 0x181fe41d0, size 0x100, virtual false, abstract: false, final false
static inline void SetDisplayMSAASamples(::UnityEngine::Rendering::MSAASamples  msaaSamples) ;

/// @brief Method SetDisplayZRange, addr 0x181fe42d0, size 0x80, virtual false, abstract: false, final false
static inline void SetDisplayZRange(float_t  zNear, float_t  zFar) ;

/// @brief Method SetLayoutOverride, addr 0x181fe4350, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SetMirrorViewMode, addr 0x181fe43b0, size 0x50, virtual false, abstract: false, final false
static inline void SetMirrorViewMode(int32_t  mirrorBlitMode) ;

/// @brief Method SetOcclusionMeshScale, addr 0x181fe4400, size 0x60, virtual false, abstract: false, final false
static inline void SetOcclusionMeshScale(float_t  occlusionMeshScale) ;

/// @brief Method SetRenderScale, addr 0x181fe4460, size 0xe0, virtual false, abstract: false, final false
static inline void SetRenderScale(float_t  renderScale) ;

/// @brief Method SetUseVisibilityMesh, addr 0x181fe4540, size 0x50, virtual false, abstract: false, final false
static inline void SetUseVisibilityMesh(bool  useVisibilityMesh) ;

/// @brief Method XRSystemInit, addr 0x181fe49b0, size 0x30, virtual false, abstract: false, final false
static inline void XRSystemInit() ;

/// @brief Method XrRenderTextureDescToUnityRenderTextureDesc, addr 0x181fe49e0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method <CreateDefaultLayout>g__AddViewToPass|50_0, addr 0x181fe4590, size 0x420, virtual false, abstract: false, final false
...
/// @brief Method get_displayActive, addr 0x181fe4cf0, size 0x50, virtual false, abstract: false, final false
static inline bool get_displayActive() ;

/// @brief Method get_dumpDebugInfo, addr 0x181fe4d40, size 0x40, virtual false, abstract: false, final false
static inline bool get_dumpDebugInfo() ;

/// @brief Method get_foveatedRenderingCaps, addr 0x181fe4d80, size 0x40, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::FoveatedRenderingCaps get_foveatedRenderingCaps() ;

/// @brief Method get_isHDRDisplayOutputActive, addr 0x181fe4dc0, size 0x80, virtual false, abstract: false, final false
static inline bool get_isHDRDisplayOutputActive() ;

/// @brief Method get_singlePassAllowed, addr 0x181fe4e40, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_dumpDebugInfo, addr 0x181fe4e80, size 0x50, virtual false, abstract: false, final false
static inline void set_dumpDebugInfo(bool  value) ;

/// @brief Method set_foveatedRenderingCaps, addr 0x181fe4ed0, size 0x50, virtual false, abstract: false, final false
static inline void set_foveatedRenderingCaps(::UnityEngine::Rendering::FoveatedRenderingCaps  value) ;

/// @brief Method set_singlePassAllowed, addr 0x181fe4f20, size 0x50, virtual false, abstract: false, final false
