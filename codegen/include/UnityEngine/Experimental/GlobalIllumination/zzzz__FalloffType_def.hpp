...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::FalloffType, "UnityEngine.Experimental.GlobalIllumination", "FalloffType");
// Dependencies 
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::FalloffType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::FalloffType) == 0x1, "Size mismatch!");
