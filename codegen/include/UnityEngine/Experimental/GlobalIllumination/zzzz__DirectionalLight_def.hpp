...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::DirectionalLight, "UnityEngine.Experimental.GlobalIllumination", "DirectionalLight");
// Dependencies UnityEngine.EntityId, UnityEngine.Experimental.GlobalIllumination.LightMode, UnityEngine.Experimental.GlobalIllumination.LinearColor, UnityEngine.Quaternion, UnityEngine.Vector3
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
constexpr DirectionalLight(::UnityEngine::EntityId  entityId, bool  shadow, ::UnityEngine::Experimental::GlobalIllumination::LightMode  mode, ::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  orientation, ::UnityEngine::Experimental::GlobalIllumination::LinearColor  color, ::UnityEngine::Experimental::GlobalIllumination::LinearColor  indirectColor, float_t  penumbraWidthRadian, ::UnityEngine::Vector3  direction) noexcept;
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::DirectionalLight, entityId) == 0x0, "Offset mismatch!");
...
static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::DirectionalLight) == 0x54, "Size mismatch!");
