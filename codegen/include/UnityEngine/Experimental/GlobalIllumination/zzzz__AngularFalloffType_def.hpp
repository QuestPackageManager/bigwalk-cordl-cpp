...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::AngularFalloffType, "UnityEngine.Experimental.GlobalIllumination", "AngularFalloffType");
// Dependencies 
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Experimental::GlobalIllumination::AngularFalloffType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::AngularFalloffType) == 0x1, "Size mismatch!");
