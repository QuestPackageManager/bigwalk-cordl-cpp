...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoRenderMode, "UnityEngine.Video", "VideoRenderMode");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Video::VideoRenderMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoRenderMode) == 0x4, "Size mismatch!");
