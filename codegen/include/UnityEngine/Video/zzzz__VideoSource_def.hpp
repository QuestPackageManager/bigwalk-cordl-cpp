...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoSource, "UnityEngine.Video", "VideoSource");
// Dependencies 
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Video::VideoSource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoSource) == 0x4, "Size mismatch!");
