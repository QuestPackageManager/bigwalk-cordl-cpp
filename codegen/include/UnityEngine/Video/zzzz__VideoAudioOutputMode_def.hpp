...
static_assert(offsetof(::UnityEngine::Video::VideoAudioOutputMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Video::VideoAudioOutputMode) == 0x4, "Size mismatch!");
