...
::cordl_internals::setStaticField<::UnityEngine::Color32, "s_DefaultColor", ::UnityEngine::UIVertex>(std::forward<::UnityEngine::Color32>(value));
}
inline ::UnityEngine::Color32 UnityEngine::UIVertex::getStaticF_s_DefaultColor()  {
return ::cordl_internals::getStaticField<::UnityEngine::Color32, "s_DefaultColor", ::UnityEngine::UIVertex>();
}
inline void UnityEngine::UIVertex::setStaticF_s_DefaultTangent(::UnityEngine::Vector4  value)  {
::cordl_internals::setStaticField<::UnityEngine::Vector4, "s_DefaultTangent", ::UnityEngine::UIVertex>(std::forward<::UnityEngine::Vector4>(value));
}
inline ::UnityEngine::Vector4 UnityEngine::UIVertex::getStaticF_s_DefaultTangent()  {
return ::cordl_internals::getStaticField<::UnityEngine::Vector4, "s_DefaultTangent", ::UnityEngine::UIVertex>();
}
inline void UnityEngine::UIVertex::setStaticF_simpleVert(::UnityEngine::UIVertex  value)  {
::cordl_internals::setStaticField<::UnityEngine::UIVertex, "simpleVert", ::UnityEngine::UIVertex>(std::forward<::UnityEngine::UIVertex>(value));
}
inline ::UnityEngine::UIVertex UnityEngine::UIVertex::getStaticF_simpleVert()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIVertex, "simpleVert", ::UnityEngine::UIVertex>();
}
