...
// Write type traits
MARK_REF_T(::System::FormattableString*);
DEFINE_IL2CPP_CLASS(::System::FormattableString*, "System", "FormattableString");
...
/// @brief Method System.IFormattable.ToString, addr 0x1817088d0, size 0x20, virtual true, abstract: false, final true
inline ::StringW System_IFormattable_ToString(::StringW  ignored, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method ToString, addr 0x1817088f0, size 0x30, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::FormattableString) == 0x10, "Size mismatch!");
