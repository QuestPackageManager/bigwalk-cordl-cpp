...
DEFINE_IL2CPP_CLASS(::System::Buffers::MemoryHandle, "System.Buffers", "MemoryHandle");
...
/// @brief Method Dispose, addr 0x1816d6800, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x1816d6860, size 0x60, virtual false, abstract: false, final false
inline void _ctor(void*  pointer, ::System::Runtime::InteropServices::GCHandle  handle, ::System::Buffers::IPinnable*  pinnable) ;

/// @brief Method get_Pointer, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Buffers::MemoryHandle) == 0x18, "Size mismatch!");
