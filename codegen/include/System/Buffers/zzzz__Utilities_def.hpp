...
public:
// Declarations
/// @brief Method GetMaxSizeForBucket, addr 0x1816e4030, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetMaxSizeForBucket(int32_t  binIndex) ;

/// @brief Method SelectBucketIndex, addr 0x180e630e0, size 0x9cf0, virtual false, abstract: false, final false
