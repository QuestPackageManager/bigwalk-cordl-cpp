...
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::SchemaTypes, "System.Xml.Serialization", "SchemaTypes");
// Dependencies 
namespace System::Xml::Serialization {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Serialization::SchemaTypes, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Serialization::SchemaTypes) == 0x4, "Size mismatch!");
