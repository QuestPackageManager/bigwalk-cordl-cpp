...
/// @brief Method AddKeyHash, addr 0x181d429e0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1812fa9d0, size 0x3350, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1818f3820, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_IsNullable, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_Namespace, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method set_DataType, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_DataType(::StringW  value) ;

/// @brief Method set_ElementName, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_ElementName(::StringW  value) ;

/// @brief Method set_IsNullable, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
inline void set_IsNullable(bool  value) ;

/// @brief Method set_Namespace, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlRootAttribute) == 0x30, "Size mismatch!");
