...
/// @brief Method AddKeyHash, addr 0x181d3b9c0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_MemberName, addr 0x181d2fa80, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlChoiceIdentifierAttribute) == 0x18, "Size mismatch!");
