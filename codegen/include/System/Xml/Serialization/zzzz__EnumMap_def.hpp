...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::EnumMap*);
MARK_REF_T(::System::Xml::Serialization::EnumMap_EnumMapMember*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::EnumMap*, "System.Xml.Serialization", "EnumMap");
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::EnumMap_EnumMapMember*, "System.Xml.Serialization", "EnumMap/EnumMapMember");
...
/// @brief Method .ctor, addr 0x181d55bd0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  xmlName, ::StringW  enumName, int64_t  value) ;

/// @brief Method get_EnumName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_EnumName() ;

/// @brief Method get_Value, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_Value() ;

/// @brief Method get_XmlName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::EnumMap_EnumMapMember) == 0x28, "Size mismatch!");

} // namespace end def System::Xml::Serialization
// Dependencies System.Xml.Serialization.EnumMap::EnumMapMember, System.Xml.Serialization.ObjectMap
namespace System::Xml::Serialization {
// Is value type: false
...
using EnumMapMember = ::System::Xml::Serialization::EnumMap_EnumMapMember;
 ...
 __declspec(property(get=get_EnumNames)) ::ArrayW<::StringW>  EnumNames;

 __declspec(property(get=get_IsFlags)) bool  IsFlags;

 __declspec(property(get=get_Values)) ::ArrayW<int64_t>  Values;

 __declspec(property(get=get_XmlNames)) ::ArrayW<::StringW>  XmlNames;

/// @brief Field _enumNames, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__enumNames, put=__cordl_internal_set__enumNames)) ::ArrayW<::StringW>  _enumNames;
...
/// @brief Field _members, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__members, put=__cordl_internal_set__members)) ::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*>  _members;
...
/// @brief Field _xmlNames, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__xmlNames, put=__cordl_internal_set__xmlNames)) ::ArrayW<::StringW>  _xmlNames;

/// @brief Method GetEnumName, addr 0x181d55c20, size 0x240, virtual false, abstract: false, final false
inline ::StringW GetEnumName(::StringW  typeName, ::StringW  xmlName) ;

/// @brief Method GetXmlName, addr 0x181d55e60, size 0x280, virtual false, abstract: false, final false
inline ::StringW GetXmlName(::StringW  typeName, ::System::Object*  enumValue) ;

static inline ::System::Xml::Serialization::EnumMap* New_ctor(::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*>  members, bool  isFlags) ;

constexpr ::ArrayW<::StringW> const& __cordl_internal_get__enumNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__enumNames() ;

constexpr bool const& __cordl_internal_get__isFlags() const;

constexpr bool& __cordl_internal_get__isFlags() ;

constexpr ::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*> const& __cordl_internal_get__members() const;

constexpr ::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*>& __cordl_internal_get__members() ;

constexpr ::ArrayW<int64_t> const& __cordl_internal_get__values() const;

constexpr ::ArrayW<int64_t>& __cordl_internal_get__values() ;

constexpr ::ArrayW<::StringW> const& __cordl_internal_get__xmlNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get__xmlNames() ;

constexpr void __cordl_internal_set__enumNames(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set__isFlags(bool  value) ;

constexpr void __cordl_internal_set__members(::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*>  value) ;

constexpr void __cordl_internal_set__values(::ArrayW<int64_t>  value) ;

constexpr void __cordl_internal_set__xmlNames(::ArrayW<::StringW>  value) ;

/// @brief Method .ctor, addr 0x181d560e0, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::Xml::Serialization::EnumMap_EnumMapMember*>  members, bool  isFlags) ;

/// @brief Method get_EnumNames, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_EnumNames() ;

/// @brief Method get_IsFlags, addr 0x18037a0f0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsFlags() ;

/// @brief Method get_Values, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<int64_t> get_Values() ;

/// @brief Method get_XmlNames, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_XmlNames() ;
...
static_assert(sizeof(::System::Xml::Serialization::EnumMap) == 0x38, "Size mismatch!");
