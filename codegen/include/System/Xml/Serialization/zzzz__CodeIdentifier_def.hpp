...
/// @brief Method IsValid, addr 0x181d25ae0, size 0x70, virtual false, abstract: false, final false
static inline bool IsValid(char16_t  c) ;

/// @brief Method IsValidStart, addr 0x181d25ac0, size 0x20, virtual false, abstract: false, final false
static inline bool IsValidStart(char16_t  c) ;

/// @brief Method MakePascal, addr 0x181d25b50, size 0x200, virtual false, abstract: false, final false
static inline ::StringW MakePascal(::StringW  identifier) ;

/// @brief Method MakeValid, addr 0x181d25d50, size 0x160, virtual false, abstract: false, final false
