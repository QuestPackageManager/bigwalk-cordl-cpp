...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlReflectionImporter*);
...
/// @brief Method <ImportClassMapping>b__28_0, addr 0x181d39e00, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlReflectionImporter___c) == 0x10, "Size mismatch!");
...
/// @brief Method CanBeNull, addr 0x181d3d350, size 0x30, virtual false, abstract: false, final false
inline bool CanBeNull(::System::Xml::Serialization::TypeData*  type) ;

/// @brief Method CreateMapMember, addr 0x181d3d380, size 0x880, virtual false, abstract: false, final false
...
/// @brief Method CreateTypeMapping, addr 0x181d3dc00, size 0x390, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* CreateTypeMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultXmlType, ::StringW  defaultNamespace) ;

/// @brief Method GetDefaultValue, addr 0x181d3df90, size 0x100, virtual false, abstract: false, final false
inline ::System::Object* GetDefaultValue(::System::Xml::Serialization::TypeData*  typeData, ::System::Object*  defaultValue) ;

/// @brief Method GetReflectionMembers, addr 0x181d3e090, size 0xa20, virtual false, abstract: false, final false
...
/// @brief Method GetTypeNamespace, addr 0x181d3eab0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method ImportAnyElementInfo, addr 0x181d3ebb0, size 0x370, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* ImportAnyElementInfo(::StringW  defaultNamespace, ::System::Xml::Serialization::XmlReflectionMember*  rmember, ::System::Xml::Serialization::XmlTypeMapMemberElement*  member, ::System::Xml::Serialization::XmlAttributes*  atts) ;

/// @brief Method ImportClassMapping, addr 0x181d3ef20, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ImportClassMapping, addr 0x181d3efa0, size 0xba0, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportClassMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace, bool  isBaseType) ;

/// @brief Method ImportElementInfo, addr 0x181d3fb40, size 0xb20, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* ImportElementInfo(::System::Type*  cls, ::StringW  defaultName, ::StringW  defaultNamespace, ::System::Type*  defaultType, ::System::Xml::Serialization::XmlTypeMapMemberElement*  member, ::System::Xml::Serialization::XmlAttributes*  atts) ;

/// @brief Method ImportEnumMapping, addr 0x181d40660, size 0x490, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportEnumMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace) ;

/// @brief Method ImportIncludedTypes, addr 0x181d40af0, size 0xd0, virtual false, abstract: false, final false
inline void ImportIncludedTypes(::System::Type*  type, ::StringW  defaultNamespace) ;

/// @brief Method ImportListMapping, addr 0x181d40bc0, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportListMapping(::System::Type*  type, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace, ::System::Xml::Serialization::XmlAttributes*  atts, int32_t  nestingLevel) ;

/// @brief Method ImportListMapping, addr 0x181d40c30, size 0xa60, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportListMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace, ::System::Xml::Serialization::XmlAttributes*  atts, int32_t  nestingLevel) ;

/// @brief Method ImportPrimitiveMapping, addr 0x181d41690, size 0x180, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportPrimitiveMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace) ;

/// @brief Method ImportTextElementInfo, addr 0x181d41810, size 0x200, virtual false, abstract: false, final false
inline void ImportTextElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList*  list, ::System::Type*  defaultType, ::System::Xml::Serialization::XmlTypeMapMemberElement*  member, ::System::Xml::Serialization::XmlAttributes*  atts, ::StringW  defaultNamespace) ;

/// @brief Method ImportTypeMapping, addr 0x181d41e30, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportTypeMapping(::System::Type*  type) ;

/// @brief Method ImportTypeMapping, addr 0x181d41e50, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportTypeMapping(::System::Type*  type, ::StringW  defaultNamespace) ;

/// @brief Method ImportTypeMapping, addr 0x181d41e70, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method ImportTypeMapping, addr 0x181d41a10, size 0x420, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportTypeMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace) ;

/// @brief Method ImportXmlNodeMapping, addr 0x181d41f70, size 0x240, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportXmlNodeMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace) ;

/// @brief Method ImportXmlSerializableMapping, addr 0x181d421b0, size 0x190, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* ImportXmlSerializableMapping(::System::Xml::Serialization::TypeData*  typeData, ::System::Xml::Serialization::XmlRootAttribute*  root, ::StringW  defaultNamespace) ;

/// @brief Method IncludeType, addr 0x181d42340, size 0x340, virtual false, abstract: false, final false
...
/// @brief Method RegisterDerivedMap, addr 0x181d42680, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d42810, size 0x110, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlReflectionImporter) == 0x48, "Size mismatch!");
