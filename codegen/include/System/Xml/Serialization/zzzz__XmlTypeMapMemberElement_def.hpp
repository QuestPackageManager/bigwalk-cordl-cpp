...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTypeMapMemberElement*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTypeMapMemberElement*, "System.Xml.Serialization", "XmlTypeMapMemberElement");
...
/// @brief Method FindElement, addr 0x181d61550, size 0x420, virtual false, abstract: false, final false
...
/// @brief Method SetChoice, addr 0x181d61970, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_ChoiceMember, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ChoiceMember() ;

/// @brief Method get_ChoiceTypeData, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::TypeData* get_ChoiceTypeData() ;

/// @brief Method get_ElementInfo, addr 0x181d61ac0, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ElementInfo() ;

/// @brief Method get_IsXmlTextCollector, addr 0x180347a60, size 0xe0, virtual false, abstract: false, final false
inline bool get_IsXmlTextCollector() ;

/// @brief Method set_ChoiceMember, addr 0x1803d49a0, size 0x10, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ChoiceTypeData, addr 0x1803d5ad0, size 0x10, virtual false, abstract: false, final false
inline void set_ChoiceTypeData(::System::Xml::Serialization::TypeData*  value) ;

/// @brief Method set_ElementInfo, addr 0x1802f8080, size 0x10, virtual false, abstract: false, final false
inline void set_ElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList*  value) ;

/// @brief Method set_IsXmlTextCollector, addr 0x180452bb0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlTypeMapMemberElement) == 0x78, "Size mismatch!");
