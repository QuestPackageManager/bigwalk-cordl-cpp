...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTypeMapElementInfoList*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTypeMapElementInfoList*, "System.Xml.Serialization", "XmlTypeMapElementInfoList");
...
/// @brief Method .ctor, addr 0x181d60dc0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Serialization::XmlTypeMapElementInfoList) == 0x28, "Size mismatch!");
