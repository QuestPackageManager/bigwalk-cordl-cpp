...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlSerializableMapping*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlSerializableMapping*, "System.Xml.Serialization", "XmlSerializableMapping");
...
/// @brief Method .ctor, addr 0x181d5c250, size 0x770, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlSerializableMapping) == 0x90, "Size mismatch!");
