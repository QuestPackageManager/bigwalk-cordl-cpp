...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTypeMapElementInfo*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTypeMapElementInfo*, "System.Xml.Serialization", "XmlTypeMapElementInfo");
...
/// @brief Method Equals, addr 0x181d60dd0, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d60ee0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Serialization::XmlTypeMapMember*  member, ::System::Xml::Serialization::TypeData*  type) ;

/// @brief Method get_ChoiceValue, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_ChoiceValue() ;

/// @brief Method get_DataTypeName, addr 0x181d60f70, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DataTypeName() ;

/// @brief Method get_DataTypeNamespace, addr 0x181d60f90, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_DataTypeNamespace() ;

/// @brief Method get_ElementName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ElementName() ;

/// @brief Method get_ExplicitOrder, addr 0x180497940, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ExplicitOrder() ;

/// @brief Method get_Form, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaForm get_Form() ;

/// @brief Method get_IsNullable, addr 0x1803023c0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_IsTextElement, addr 0x181d60fc0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsTextElement() ;

/// @brief Method get_IsUnnamedAnyElement, addr 0x181d60fe0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsUnnamedAnyElement() ;

/// @brief Method get_MappedType, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* get_MappedType() ;

/// @brief Method get_Member, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapMember* get_Member() ;

/// @brief Method get_MultiReferenceType, addr 0x181d61000, size 0x20, virtual false, abstract: false, final false
inline bool get_MultiReferenceType() ;

/// @brief Method get_Namespace, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_TypeData, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::TypeData* get_TypeData() ;

/// @brief Method get_WrappedElement, addr 0x1802f8060, size 0x10, virtual false, abstract: false, final false
inline bool get_WrappedElement() ;

/// @brief Method set_ChoiceValue, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_ChoiceValue(::System::Object*  value) ;

/// @brief Method set_ElementName, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_ElementName(::StringW  value) ;

/// @brief Method set_ExplicitOrder, addr 0x180497a90, size 0x10, virtual false, abstract: false, final false
inline void set_ExplicitOrder(int32_t  value) ;

/// @brief Method set_Form, addr 0x1803164e0, size 0x10, virtual false, abstract: false, final false
inline void set_Form(::System::Xml::Schema::XmlSchemaForm  value) ;

/// @brief Method set_IsNullable, addr 0x180323260, size 0x10, virtual false, abstract: false, final false
inline void set_IsNullable(bool  value) ;

/// @brief Method set_IsTextElement, addr 0x181d61020, size 0x60, virtual false, abstract: false, final false
inline void set_IsTextElement(bool  value) ;

/// @brief Method set_IsUnnamedAnyElement, addr 0x181d61080, size 0x60, virtual false, abstract: false, final false
inline void set_IsUnnamedAnyElement(bool  value) ;

/// @brief Method set_MappedType, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_MappedType(::System::Xml::Serialization::XmlTypeMapping*  value) ;

/// @brief Method set_Namespace, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_NestingLevel, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_NestingLevel(int32_t  value) ;

/// @brief Method set_WrappedElement, addr 0x1802f8090, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlTypeMapElementInfo) == 0x58, "Size mismatch!");
