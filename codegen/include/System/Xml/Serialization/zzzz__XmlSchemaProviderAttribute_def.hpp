...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlSchemaProviderAttribute*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlSchemaProviderAttribute*, "System.Xml.Serialization", "XmlSchemaProviderAttribute");
...
/// @brief Method get_IsAny, addr 0x18037a0f0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsAny() ;

/// @brief Method get_MethodName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_MethodName() ;

/// @brief Method set_IsAny, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlSchemaProviderAttribute) == 0x20, "Size mismatch!");
