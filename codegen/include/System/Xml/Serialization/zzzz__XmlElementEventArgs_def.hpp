...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlElementEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlElementEventArgs*, "System.Xml.Serialization", "XmlElementEventArgs");
...
/// @brief Method .ctor, addr 0x181d2ff10, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlElementEventArgs) == 0x30, "Size mismatch!");
