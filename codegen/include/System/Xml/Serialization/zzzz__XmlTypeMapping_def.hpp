...
// Write type traits
MARK_REF_T(::System::Xml::Serialization::XmlTypeMapping*);
DEFINE_IL2CPP_CLASS(::System::Xml::Serialization::XmlTypeMapping*, "System.Xml.Serialization", "XmlTypeMapping");
...
/// @brief Method GetRealElementMap, addr 0x181d62930, size 0x1e0, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* GetRealElementMap(::StringW  name, ::StringW  ens) ;

/// @brief Method GetRealTypeMap, addr 0x181d62b10, size 0x120, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* GetRealTypeMap(::System::Type*  objectType) ;

static inline ::System::Xml::Serialization::XmlTypeMapping* New_ctor(::StringW  elementName, ::StringW  ns, ::System::Xml::Serialization::TypeData*  typeData, ::StringW  xmlType, ::StringW  xmlTypeNamespace) ;

/// @brief Method UpdateRoot, addr 0x181d62c30, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d62c80, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_BaseMap, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* get_BaseMap() ;

/// @brief Method get_DerivedTypes, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_DerivedTypes() ;

/// @brief Method get_HasXmlTypeNamespace, addr 0x181d62d40, size 0x10, virtual false, abstract: false, final false
inline bool get_HasXmlTypeNamespace() ;

/// @brief Method get_IsAny, addr 0x181d62d50, size 0x10, virtual false, abstract: false, final false
inline bool get_IsAny() ;

/// @brief Method get_IsNullable, addr 0x181ce7d50, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_MultiReferenceType, addr 0x180347a60, size 0xe0, virtual false, abstract: false, final false
inline bool get_MultiReferenceType() ;

/// @brief Method get_TypeData, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::TypeData* get_TypeData() ;

/// @brief Method get_TypeFullName, addr 0x181d62d60, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_TypeFullName() ;

/// @brief Method get_XmlType, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_XmlType() ;

/// @brief Method get_XmlTypeNamespace, addr 0x181d62d70, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_XmlTypeNamespace() ;

/// @brief Method set_BaseMap, addr 0x1803d49a0, size 0x10, virtual false, abstract: false, final false
inline void set_BaseMap(::System::Xml::Serialization::XmlTypeMapping*  value) ;

/// @brief Method set_IncludeInSchema, addr 0x1805d8d40, size 0x10, virtual false, abstract: false, final false
inline void set_IncludeInSchema(bool  value) ;

/// @brief Method set_IsAny, addr 0x181d62d90, size 0x10, virtual false, abstract: false, final false
inline void set_IsAny(bool  value) ;

/// @brief Method set_IsNullable, addr 0x181ce7f80, size 0x10, virtual false, abstract: false, final false
inline void set_IsNullable(bool  value) ;

/// @brief Method set_XmlType, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_XmlType(::StringW  value) ;

/// @brief Method set_XmlTypeNamespace, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Serialization::XmlTypeMapping) == 0x78, "Size mismatch!");
