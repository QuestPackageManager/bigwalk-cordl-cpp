...
DEFINE_IL2CPP_CLASS(::System::Xml::NewLineHandling, "System.Xml", "NewLineHandling");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::NewLineHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::NewLineHandling) == 0x4, "Size mismatch!");
