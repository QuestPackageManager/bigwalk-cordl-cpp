...
DEFINE_IL2CPP_CLASS(::System::Xml::WriteState, "System.Xml", "WriteState");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::WriteState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::WriteState) == 0x4, "Size mismatch!");
