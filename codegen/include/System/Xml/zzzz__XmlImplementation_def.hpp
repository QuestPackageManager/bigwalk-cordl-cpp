...
// Write type traits
MARK_REF_T(::System::Xml::XmlImplementation*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlImplementation*, "System.Xml", "XmlImplementation");
...
/// @brief Method CreateDocument, addr 0x181d06d40, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d06d80, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::XmlImplementation) == 0x18, "Size mismatch!");
