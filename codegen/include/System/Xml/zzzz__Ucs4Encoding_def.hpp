...
// Write type traits
MARK_REF_T(::System::Xml::Ucs4Encoding*);
DEFINE_IL2CPP_CLASS(::System::Xml::Ucs4Encoding*, "System.Xml", "Ucs4Encoding");
...
/// @brief Method GetByteCount, addr 0x181d2ce40, size 0x40, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetBytes, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x181d2ce80, size 0x20, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetChars, addr 0x181d2cea0, size 0x20, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t>  chars, int32_t  charIndex) ;

/// @brief Method GetDecoder, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetMaxByteCount, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x181d2cec0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d2ced0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CodePage, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline int32_t get_CodePage() ;

/// @brief Method get_UCS4_2143, addr 0x181d2cee0, size 0x80, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* get_UCS4_2143() ;

/// @brief Method get_UCS4_3412, addr 0x181d2cf60, size 0x80, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* get_UCS4_3412() ;

/// @brief Method get_UCS4_Bigendian, addr 0x181d2cfe0, size 0x80, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* get_UCS4_Bigendian() ;

/// @brief Method get_UCS4_Littleendian, addr 0x181d2d060, size 0x80, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* get_UCS4_Littleendian() ;

/// @brief Method get_WebName, addr 0x181163ae0, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Ucs4Encoding) == 0x40, "Size mismatch!");
