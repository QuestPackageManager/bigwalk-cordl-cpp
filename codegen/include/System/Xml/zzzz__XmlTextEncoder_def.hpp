...
// Write type traits
MARK_REF_T(::System::Xml::XmlTextEncoder*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextEncoder*, "System.Xml", "XmlTextEncoder");
...
/// @brief Method EndAttribute, addr 0x181cea990, size 0x40, virtual false, abstract: false, final false
inline void EndAttribute() ;

static inline ::System::Xml::XmlTextEncoder* New_ctor(::System::IO::TextWriter*  textWriter) ;

/// @brief Method StartAttribute, addr 0x181cea9d0, size 0x70, virtual false, abstract: false, final false
inline void StartAttribute(bool  cacheAttrValue) ;

/// @brief Method Write, addr 0x181ceb660, size 0x310, virtual false, abstract: false, final false
inline void Write(::ArrayW<char16_t>  array, int32_t  offset, int32_t  count) ;

/// @brief Method Write, addr 0x181ceb1a0, size 0x4c0, virtual false, abstract: false, final false
inline void Write(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181ceab50, size 0xc0, virtual false, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteCharEntityImpl, addr 0x181ceaa40, size 0xa0, virtual false, abstract: false, final false
inline void WriteCharEntityImpl(char16_t  ch) ;

/// @brief Method WriteCharEntityImpl, addr 0x181ceaae0, size 0x70, virtual false, abstract: false, final false
inline void WriteCharEntityImpl(::StringW  strVal) ;

/// @brief Method WriteEntityRef, addr 0x181ceac80, size 0xb0, virtual false, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteEntityRefImpl, addr 0x181ceac10, size 0x70, virtual false, abstract: false, final false
inline void WriteEntityRefImpl(::StringW  name) ;

/// @brief Method WriteRaw, addr 0x181ceae90, size 0xc0, virtual false, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  array, int32_t  offset, int32_t  count) ;

/// @brief Method WriteRawWithSurrogateChecking, addr 0x181cead30, size 0x160, virtual false, abstract: false, final false
inline void WriteRawWithSurrogateChecking(::StringW  text) ;

/// @brief Method WriteStringFragment, addr 0x181ceaf50, size 0xa0, virtual false, abstract: false, final false
inline void WriteStringFragment(::StringW  str, int32_t  offset, int32_t  count, ::ArrayW<char16_t>  helperBuffer) ;

/// @brief Method WriteSurrogateChar, addr 0x181ceb110, size 0x90, virtual false, abstract: false, final false
inline void WriteSurrogateChar(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181ceaff0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ceb970, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  textWriter) ;

/// @brief Method get_AttributeValue, addr 0x181ceb9b0, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_AttributeValue() ;

/// @brief Method set_QuoteChar, addr 0x181a74770, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlTextEncoder) == 0x38, "Size mismatch!");
