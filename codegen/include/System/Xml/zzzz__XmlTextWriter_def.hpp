...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_NamespaceState, "System.Xml", "XmlTextWriter/NamespaceState");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_SpecialAttr, "System.Xml", "XmlTextWriter/SpecialAttr");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_State, "System.Xml", "XmlTextWriter/State");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_Token, "System.Xml", "XmlTextWriter/Token");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter*, "System.Xml", "XmlTextWriter");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_Namespace, "System.Xml", "XmlTextWriter/Namespace");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlTextWriter_TagInfo, "System.Xml", "XmlTextWriter/TagInfo");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlTextWriter_NamespaceState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlTextWriter_NamespaceState) == 0x4, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Init, addr 0x181cecd20, size 0x210, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "prefix", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "defaultNs", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "defaultNsState", ty: "::System::Xml::XmlTextWriter_NamespaceState", modifiers: "", def_value: None }, CppParam { name: "xmlSpace", ty: "::System::Xml::XmlSpace", modifiers: "", def_value: None }, CppParam { name: "xmlLang", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "prevNsTop", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "mixed", ty: "bool", modifiers: "", def_value: None }]
constexpr XmlTextWriter_TagInfo(::StringW  name, ::StringW  prefix, ::StringW  defaultNs, ::System::Xml::XmlTextWriter_NamespaceState  defaultNsState, ::System::Xml::XmlSpace  xmlSpace, ::StringW  xmlLang, int32_t  prevNsTop, int32_t  prefixCount, bool  mixed) noexcept;
...
static_assert(sizeof(::System::Xml::XmlTextWriter_TagInfo) == 0x38, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Set, addr 0x181cec2d0, size 0x110, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "prefix", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ns", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "declared", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "prevNsIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Xml::XmlTextWriter_Namespace) == 0x18, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlTextWriter_SpecialAttr, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlTextWriter_SpecialAttr) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlTextWriter_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlTextWriter_State) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlTextWriter_Token, value__) == 0x4, "Offset mismatch!");
...
/// @brief Field nsStack, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_nsStack, put=__cordl_internal_set_nsStack)) ::ArrayW<::System::Xml::XmlTextWriter_Namespace>  nsStack;
...
/// @brief Field stack, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_stack, put=__cordl_internal_set_stack)) ::ArrayW<::System::Xml::XmlTextWriter_TagInfo>  stack;
...
/// @brief Field stateTable, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateTable, put=__cordl_internal_set_stateTable)) ::ArrayW<::System::Xml::XmlTextWriter_State>  stateTable;

/// @brief Field stateTableDefault, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_stateTableDefault, put=setStaticF_stateTableDefault)) ::ArrayW<::System::Xml::XmlTextWriter_State>  stateTableDefault;

/// @brief Field stateTableDocument, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_stateTableDocument, put=setStaticF_stateTableDocument)) ::ArrayW<::System::Xml::XmlTextWriter_State>  stateTableDocument;
...
/// @brief Method AddNamespace, addr 0x181ced0a0, size 0x1d0, virtual false, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method AddToNamespaceHashtable, addr 0x181ced270, size 0x90, virtual false, abstract: false, final false
inline void AddToNamespaceHashtable(int32_t  namespaceIndex) ;

/// @brief Method AutoComplete, addr 0x181ced360, size 0x420, virtual false, abstract: false, final false
inline void AutoComplete(::System::Xml::XmlTextWriter_Token  token) ;

/// @brief Method AutoCompleteAll, addr 0x181ced300, size 0x60, virtual false, abstract: false, final false
inline void AutoCompleteAll() ;

/// @brief Method Close, addr 0x181ced780, size 0x110, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method FindPrefix, addr 0x181ced890, size 0xc0, virtual false, abstract: false, final false
inline ::StringW FindPrefix(::StringW  ns) ;

/// @brief Method Flush, addr 0x181ced990, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushEncoders, addr 0x181ced950, size 0x40, virtual false, abstract: false, final false
inline void FlushEncoders() ;

/// @brief Method GeneratePrefix, addr 0x181ced9b0, size 0xa0, virtual false, abstract: false, final false
inline ::StringW GeneratePrefix() ;

/// @brief Method HandleSpecialAttribute, addr 0x181ceda50, size 0x160, virtual false, abstract: false, final false
inline void HandleSpecialAttribute() ;

/// @brief Method Indent, addr 0x181cedbb0, size 0xc0, virtual false, abstract: false, final false
inline void Indent(bool  beforeEndElement) ;

/// @brief Method InternalWriteEndElement, addr 0x181cedc70, size 0x230, virtual false, abstract: false, final false
inline void InternalWriteEndElement(bool  longFormat) ;

/// @brief Method InternalWriteProcessingInstruction, addr 0x181cedea0, size 0xc0, virtual false, abstract: false, final false
inline void InternalWriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method LookupNamespace, addr 0x181cee040, size 0xb0, virtual false, abstract: false, final false
inline int32_t LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceInCurrentScope, addr 0x181cedf60, size 0xe0, virtual false, abstract: false, final false
inline int32_t LookupNamespaceInCurrentScope(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181cee0f0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method PopNamespaces, addr 0x181cee190, size 0xa0, virtual false, abstract: false, final false
inline void PopNamespaces(int32_t  indexFrom, int32_t  indexTo) ;

/// @brief Method PushNamespace, addr 0x181cee230, size 0x340, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method PushStack, addr 0x181cee570, size 0xf0, virtual false, abstract: false, final false
inline void PushStack() ;

/// @brief Method StartDocument, addr 0x181cee660, size 0x1f0, virtual false, abstract: false, final false
inline void StartDocument(int32_t  standalone) ;

/// @brief Method ValidateName, addr 0x181cee850, size 0x140, virtual false, abstract: false, final false
inline void ValidateName(::StringW  name, bool  isNCName) ;

/// @brief Method VerifyPrefixXml, addr 0x181cee990, size 0xf0, virtual false, abstract: false, final false
inline void VerifyPrefixXml(::StringW  prefix, ::StringW  ns) ;

/// @brief Method WriteBase64, addr 0x181ceea80, size 0x2a0, virtual true, abstract: false, final false
inline void WriteBase64(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteBinHex, addr 0x181ceed20, size 0x270, virtual true, abstract: false, final false
inline void WriteBinHex(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteCData, addr 0x181ceef90, size 0xf0, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181cef080, size 0x250, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x181cef2d0, size 0x270, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x181cef540, size 0x110, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteDocType, addr 0x181cef650, size 0x290, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x181cefa60, size 0x210, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndAttributeQuote, addr 0x181cef8e0, size 0x180, virtual false, abstract: false, final false
inline void WriteEndAttributeQuote() ;

/// @brief Method WriteEndDocument, addr 0x181cefc70, size 0x100, virtual true, abstract: false, final false
inline void WriteEndDocument() ;

/// @brief Method WriteEndElement, addr 0x181cefd70, size 0x10, virtual true, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteEndStartTag, addr 0x181cefd80, size 0x290, virtual false, abstract: false, final false
inline void WriteEndStartTag(bool  empty) ;

/// @brief Method WriteEntityRef, addr 0x181cf0010, size 0x260, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x181cf0270, size 0x10, virtual true, abstract: false, final false
inline void WriteFullEndElement() ;

/// @brief Method WriteProcessingInstruction, addr 0x181cf0280, size 0x110, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x181cf0390, size 0x270, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cf0600, size 0x250, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteStartAttribute, addr 0x181cf0850, size 0x570, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartDocument, addr 0x181cf0dd0, size 0x10, virtual true, abstract: false, final false
inline void WriteStartDocument() ;

/// @brief Method WriteStartDocument, addr 0x181cf0dc0, size 0x10, virtual true, abstract: false, final false
inline void WriteStartDocument(bool  standalone) ;

/// @brief Method WriteStartElement, addr 0x181cf0de0, size 0x4b0, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteString, addr 0x181cf1290, size 0x270, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181cf1500, size 0x270, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x181cf1770, size 0x2a0, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::XmlTextWriter_Namespace> const& __cordl_internal_get_nsStack() const;

constexpr ::ArrayW<::System::Xml::XmlTextWriter_Namespace>& __cordl_internal_get_nsStack() ;
...
constexpr ::ArrayW<::System::Xml::XmlTextWriter_TagInfo> const& __cordl_internal_get_stack() const;

constexpr ::ArrayW<::System::Xml::XmlTextWriter_TagInfo>& __cordl_internal_get_stack() ;

constexpr ::ArrayW<::System::Xml::XmlTextWriter_State> const& __cordl_internal_get_stateTable() const;

constexpr ::ArrayW<::System::Xml::XmlTextWriter_State>& __cordl_internal_get_stateTable() ;
...
constexpr void __cordl_internal_set_nsStack(::ArrayW<::System::Xml::XmlTextWriter_Namespace>  value) ;
...
constexpr void __cordl_internal_set_stack(::ArrayW<::System::Xml::XmlTextWriter_TagInfo>  value) ;

constexpr void __cordl_internal_set_stateTable(::ArrayW<::System::Xml::XmlTextWriter_State>  value) ;
...
/// @brief Method .ctor, addr 0x181cf1d30, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181cf1f00, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::StringW  filename, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x181cf2010, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  w, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x181cf1e60, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  w) ;

static inline ::ArrayW<::StringW> getStaticF_stateName() ;

static inline ::ArrayW<::System::Xml::XmlTextWriter_State> getStaticF_stateTableDefault() ;

static inline ::ArrayW<::System::Xml::XmlTextWriter_State> getStaticF_stateTableDocument() ;

static inline ::ArrayW<::StringW> getStaticF_tokenName() ;

/// @brief Method get_BaseStream, addr 0x181cf20f0, size 0x50, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_WriteState, addr 0x181cf2140, size 0x70, virtual true, abstract: false, final false
inline ::System::Xml::WriteState get_WriteState() ;

static inline void setStaticF_stateName(::ArrayW<::StringW>  value) ;

static inline void setStaticF_stateTableDefault(::ArrayW<::System::Xml::XmlTextWriter_State>  value) ;

static inline void setStaticF_stateTableDocument(::ArrayW<::System::Xml::XmlTextWriter_State>  value) ;

static inline void setStaticF_tokenName(::ArrayW<::StringW>  value) ;

/// @brief Method set_Formatting, addr 0x181cf21b0, size 0x10, virtual false, abstract: false, final false
inline void set_Formatting(::System::Xml::Formatting  value) ;

/// @brief Method set_Namespaces, addr 0x181cf21c0, size 0x40, virtual false, abstract: false, final false
inline void set_Namespaces(bool  value) ;

/// @brief Method set_QuoteChar, addr 0x181cf2200, size 0x50, virtual false, abstract: false, final false
...
/// @brief Field nsStack, offset: 0x88, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlTextWriter_Namespace>  ___nsStack;
