...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNamespaceScope, "System.Xml", "XmlNamespaceScope");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlNamespaceScope, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlNamespaceScope) == 0x4, "Size mismatch!");
