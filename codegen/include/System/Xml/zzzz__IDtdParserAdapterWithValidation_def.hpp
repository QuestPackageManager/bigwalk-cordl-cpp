...
// Write type traits
MARK_REF_T(::System::Xml::IDtdParserAdapterWithValidation*);
DEFINE_IL2CPP_CLASS(::System::Xml::IDtdParserAdapterWithValidation*, "System.Xml", "IDtdParserAdapterWithValidation");
// Dependencies 
namespace System::Xml {
// Is value type: false
