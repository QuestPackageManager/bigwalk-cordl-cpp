...
// Write type traits
MARK_REF_T(::System::Xml::Bits*);
DEFINE_IL2CPP_CLASS(::System::Xml::Bits*, "System.Xml", "Bits");
...
/// @brief Method Count, addr 0x181c21770, size 0x60, virtual false, abstract: false, final false
static inline int32_t Count(uint32_t  num) ;

/// @brief Method LeastPosition, addr 0x181c217d0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Bits) == 0x10, "Size mismatch!");
