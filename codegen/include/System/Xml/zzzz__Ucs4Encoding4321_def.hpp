...
/// @brief Method GetPreamble, addr 0x181d2cdb0, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding4321* New_ctor() ;

/// @brief Method .ctor, addr 0x181d2cdd0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x181d2ce30, size 0x10, virtual true, abstract: false, final false
