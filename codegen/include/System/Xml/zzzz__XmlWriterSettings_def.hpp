...
// Write type traits
MARK_REF_T(::System::Xml::XmlWriterSettings*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWriterSettings*, "System.Xml", "XmlWriterSettings");
...
/// @brief Method CheckReadOnly, addr 0x181d0af00, size 0xa0, virtual false, abstract: false, final false
inline void CheckReadOnly(::StringW  propertyName) ;

/// @brief Method Clone, addr 0x181d0afa0, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriterSettings* Clone() ;

/// @brief Method CreateWriter, addr 0x181d0b020, size 0x330, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::Stream*  output) ;

/// @brief Method CreateWriter, addr 0x181d0b350, size 0x220, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::TextWriter*  output) ;

/// @brief Method Initialize, addr 0x181d0b570, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d0b660, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Async, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_Async() ;

/// @brief Method get_AutoXmlDeclaration, addr 0x181a3a570, size 0x10, virtual false, abstract: false, final false
inline bool get_AutoXmlDeclaration() ;

/// @brief Method get_CDataSectionElements, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::System::Xml::XmlQualifiedName*>* get_CDataSectionElements() ;

/// @brief Method get_CheckCharacters, addr 0x1804a5a20, size 0x10, virtual false, abstract: false, final false
inline bool get_CheckCharacters() ;

/// @brief Method get_CloseOutput, addr 0x180391c80, size 0x10, virtual false, abstract: false, final false
inline bool get_CloseOutput() ;

/// @brief Method get_ConformanceLevel, addr 0x1803d4dd0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::ConformanceLevel get_ConformanceLevel() ;

/// @brief Method get_DoNotEscapeUriAttributes, addr 0x1802e75b0, size 0x10, virtual false, abstract: false, final false
inline bool get_DoNotEscapeUriAttributes() ;

/// @brief Method get_DocTypePublic, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_DocTypePublic() ;

/// @brief Method get_DocTypeSystem, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Indent, addr 0x181d0b780, size 0x10, virtual false, abstract: false, final false
inline bool get_Indent() ;

/// @brief Method get_IndentChars, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_IndentChars() ;

/// @brief Method get_IndentInternal, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::TriState get_IndentInternal() ;

/// @brief Method get_IsQuerySpecific, addr 0x181d0b790, size 0x30, virtual false, abstract: false, final false
inline bool get_IsQuerySpecific() ;

/// @brief Method get_MediaType, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_MediaType() ;

/// @brief Method get_MergeCDataSections, addr 0x1815f5410, size 0x10, virtual false, abstract: false, final false
inline bool get_MergeCDataSections() ;

/// @brief Method get_NamespaceHandling, addr 0x180511540, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::NamespaceHandling get_NamespaceHandling() ;

/// @brief Method get_NewLineChars, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NewLineChars() ;

/// @brief Method get_NewLineHandling, addr 0x180396ef0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::NewLineHandling get_NewLineHandling() ;

/// @brief Method get_NewLineOnAttributes, addr 0x180391c90, size 0x10, virtual false, abstract: false, final false
inline bool get_NewLineOnAttributes() ;

/// @brief Method get_OmitXmlDeclaration, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_OmitXmlDeclaration() ;

/// @brief Method get_OutputMethod, addr 0x1803d7410, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlOutputMethod get_OutputMethod() ;

/// @brief Method get_Standalone, addr 0x180371760, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlStandalone get_Standalone() ;

/// @brief Method get_WriteEndDocumentOnClose, addr 0x1804a5a30, size 0x10, virtual false, abstract: false, final false
inline bool get_WriteEndDocumentOnClose() ;

/// @brief Method set_ConformanceLevel, addr 0x181d0b7c0, size 0x50, virtual false, abstract: false, final false
inline void set_ConformanceLevel(::System::Xml::ConformanceLevel  value) ;

/// @brief Method set_Indent, addr 0x181d0b810, size 0x30, virtual false, abstract: false, final false
inline void set_Indent(bool  value) ;

/// @brief Method set_NamespaceHandling, addr 0x181d0b840, size 0x50, virtual false, abstract: false, final false
inline void set_NamespaceHandling(::System::Xml::NamespaceHandling  value) ;

/// @brief Method set_OmitXmlDeclaration, addr 0x181d0b890, size 0x30, virtual false, abstract: false, final false
inline void set_OmitXmlDeclaration(bool  value) ;

/// @brief Method set_OutputMethod, addr 0x1803d75f0, size 0x10, virtual false, abstract: false, final false
inline void set_OutputMethod(::System::Xml::XmlOutputMethod  value) ;

/// @brief Method set_ReadOnly, addr 0x181d0b8c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlWriterSettings) == 0x88, "Size mismatch!");
