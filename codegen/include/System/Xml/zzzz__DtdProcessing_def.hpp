...
DEFINE_IL2CPP_CLASS(::System::Xml::DtdProcessing, "System.Xml", "DtdProcessing");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::DtdProcessing, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::DtdProcessing) == 0x4, "Size mismatch!");
