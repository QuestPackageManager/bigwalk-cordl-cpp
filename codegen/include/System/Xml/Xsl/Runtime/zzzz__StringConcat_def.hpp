...
/// @brief Method Clear, addr 0x181d5a870, size 0x20, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ConcatNoDelimiter, addr 0x181d5a890, size 0x2b0, virtual false, abstract: false, final false
inline void ConcatNoDelimiter(::StringW  s) ;

/// @brief Method GetResult, addr 0x181d5ab40, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Xsl::Runtime::StringConcat) == 0x38, "Size mismatch!");
