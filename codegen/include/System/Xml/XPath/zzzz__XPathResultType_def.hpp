...
DEFINE_IL2CPP_CLASS(::System::Xml::XPath::XPathResultType, "System.Xml.XPath", "XPathResultType");
// Dependencies 
namespace System::Xml::XPath {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XPath::XPathResultType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XPath::XPathResultType) == 0x4, "Size mismatch!");
