...
// Write type traits
MARK_REF_T(::System::Xml::AttributePSVIInfo*);
DEFINE_IL2CPP_CLASS(::System::Xml::AttributePSVIInfo*, "System.Xml", "AttributePSVIInfo");
...
/// @brief Method Reset, addr 0x181cfba10, size 0x70, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181cfba80, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::AttributePSVIInfo) == 0x30, "Size mismatch!");
