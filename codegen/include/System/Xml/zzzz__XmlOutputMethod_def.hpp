...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlOutputMethod, "System.Xml", "XmlOutputMethod");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlOutputMethod, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlOutputMethod) == 0x4, "Size mismatch!");
