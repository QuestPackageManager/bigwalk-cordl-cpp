...
// Write type traits
MARK_REF_T(::System::Xml::HtmlEncodedRawTextWriterIndent*);
DEFINE_IL2CPP_CLASS(::System::Xml::HtmlEncodedRawTextWriterIndent*, "System.Xml", "HtmlEncodedRawTextWriterIndent");
// Dependencies System.Xml.HtmlEncodedRawTextWriter
namespace System::Xml {
// Is value type: false
...
/// @brief Method FlushBuffer, addr 0x181c22010, size 0x20, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method Init, addr 0x181c22030, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method StartElementContent, addr 0x181c22080, size 0xa0, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method WriteDocType, addr 0x181c22120, size 0x180, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndElement, addr 0x181c222a0, size 0x190, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteIndent, addr 0x181c22430, size 0x60, virtual false, abstract: false, final false
inline void WriteIndent() ;

/// @brief Method WriteStartAttribute, addr 0x181c22490, size 0x180, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x181c22610, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c22790, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x181c227f0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::HtmlEncodedRawTextWriterIndent) == 0x108, "Size mismatch!");
