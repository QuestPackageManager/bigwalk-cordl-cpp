...
// Write type traits
MARK_REF_T(::System::Xml::XmlLinkedNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlLinkedNode*, "System.Xml", "XmlLinkedNode");
...
/// @brief Method .ctor, addr 0x181d06dc0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_NextSibling, addr 0x181d06df0, size 0x60, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* get_NextSibling() ;

/// @brief Method get_PreviousSibling, addr 0x181d06e50, size 0x90, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlLinkedNode) == 0x20, "Size mismatch!");
