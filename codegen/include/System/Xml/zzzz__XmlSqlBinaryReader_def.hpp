...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlSqlBinaryReader_ScanState, "System.Xml", "XmlSqlBinaryReader/ScanState");
...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlSqlBinaryReader_AttrInfo, "System.Xml", "XmlSqlBinaryReader/AttrInfo");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlSqlBinaryReader_ElemInfo, "System.Xml", "XmlSqlBinaryReader/ElemInfo");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlSqlBinaryReader_QName, "System.Xml", "XmlSqlBinaryReader/QName");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlSqlBinaryReader_SymbolTables, "System.Xml", "XmlSqlBinaryReader/SymbolTables");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlSqlBinaryReader_ScanState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlSqlBinaryReader_ScanState) == 0x4, "Size mismatch!");
...
public:
// Declarations
/// @brief Method CheckPrefixNS, addr 0x181c24f50, size 0xf0, virtual false, abstract: false, final false
inline void CheckPrefixNS(::StringW  prefix, ::StringW  namespaceUri) ;

/// @brief Method Clear, addr 0x181c25040, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Equals, addr 0x181c250b0, size 0xf0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x181c251a0, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNSHashCode, addr 0x181c25200, size 0x60, virtual false, abstract: false, final false
inline int32_t GetNSHashCode(::System::Xml::SecureStringHasher*  hasher) ;

/// @brief Method MatchNs, addr 0x181c1dbb0, size 0x60, virtual false, abstract: false, final false
inline bool MatchNs(::StringW  lname, ::StringW  nsUri) ;

/// @brief Method MatchPrefix, addr 0x181c25260, size 0x60, virtual false, abstract: false, final false
inline bool MatchPrefix(::StringW  prefix, ::StringW  lname) ;

/// @brief Method Set, addr 0x18053eeb0, size 0xa0, virtual false, abstract: false, final false
inline void Set(::StringW  prefix, ::StringW  lname, ::StringW  nsUri) ;

/// @brief Method ToString, addr 0x181c252c0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181c252f0, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlSqlBinaryReader_QName) == 0x18, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Clear, addr 0x181c21f10, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::XmlSqlBinaryReader_NamespaceDecl* Clear() ;

/// @brief Method Set, addr 0x181c21f50, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlSqlBinaryReader_ElemInfo) == 0x30, "Size mismatch!");
...
public:
// Declarations
/// @brief Method AdjustPosition, addr 0x181c1da50, size 0x20, virtual false, abstract: false, final false
inline void AdjustPosition(int32_t  adj) ;

/// @brief Method GetLocalnameAndNamespaceUri, addr 0x181c1daf0, size 0x50, virtual false, abstract: false, final false
inline void GetLocalnameAndNamespaceUri(::by_ref<::StringW>  localname, ::by_ref<::StringW>  namespaceUri) ;

/// @brief Method GetLocalnameAndNamespaceUriAndHash, addr 0x181c1da70, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method MatchHashNS, addr 0x181c1db40, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x181c1dc10, size 0x80, virtual false, abstract: false, final false
inline void Set(::System::Xml::XmlSqlBinaryReader_QName  n, int32_t  pos) ;

/// @brief Method Set, addr 0x181c1dc90, size 0x220, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlSqlBinaryReader_AttrInfo) == 0x30, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x181c24e70, size 0x80, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Init, addr 0x181c25450, size 0xc0, virtual false, abstract: false, final false
inline void Init() ;
...
// Ctor Parameters [CppParam { name: "symtable", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "symCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "qnametable", ty: "::ArrayW<::System::Xml::XmlSqlBinaryReader_QName>", modifiers: "", def_value: None }, CppParam { name: "qnameCount", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field qnametable, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlSqlBinaryReader_QName>  qnametable;
...
static_assert(sizeof(::System::Xml::XmlSqlBinaryReader_SymbolTables) == 0x20, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x181c24ef0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Field attributes, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_attributes, put=__cordl_internal_set_attributes)) ::ArrayW<::System::Xml::XmlSqlBinaryReader_AttrInfo>  attributes;
...
/// @brief Field elementStack, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_elementStack, put=__cordl_internal_set_elementStack)) ::ArrayW<::System::Xml::XmlSqlBinaryReader_ElemInfo>  elementStack;
...
/// @brief Method AddInitNamespace, addr 0x181c25580, size 0xe0, virtual false, abstract: false, final false
inline void AddInitNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method AddName, addr 0x181c25660, size 0x100, virtual false, abstract: false, final false
inline void AddName() ;

/// @brief Method AddQName, addr 0x181c25760, size 0x240, virtual false, abstract: false, final false
inline void AddQName() ;

/// @brief Method CDATAValue, addr 0x181c259a0, size 0x110, virtual false, abstract: false, final false
inline ::StringW CDATAValue() ;

/// @brief Method CheckAllowContent, addr 0x181c25ab0, size 0x50, virtual false, abstract: false, final false
inline void CheckAllowContent() ;

/// @brief Method CheckText, addr 0x181c25b70, size 0x1c0, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckText(bool  attr) ;

/// @brief Method CheckTextIsWS, addr 0x181c25b00, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckTextIsWS() ;

/// @brief Method CheckValueTokenBounds, addr 0x181c25d30, size 0x50, virtual false, abstract: false, final false
inline void CheckValueTokenBounds() ;

/// @brief Method ClearAttributes, addr 0x181c25d80, size 0x20, virtual false, abstract: false, final false
inline void ClearAttributes() ;

/// @brief Method Close, addr 0x181c25da0, size 0xc0, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Fill, addr 0x181c260b0, size 0x80, virtual false, abstract: false, final false
inline void Fill(int32_t  require) ;

/// @brief Method FillAllowEOF, addr 0x181c25e60, size 0x1e0, virtual false, abstract: false, final false
inline bool FillAllowEOF() ;

/// @brief Method Fill_, addr 0x181c26040, size 0x70, virtual false, abstract: false, final false
inline void Fill_(int32_t  require) ;

/// @brief Method FinishCDATA, addr 0x181c26130, size 0x90, virtual false, abstract: false, final false
inline void FinishCDATA() ;

/// @brief Method FinishEndElement, addr 0x181c261c0, size 0xd0, virtual false, abstract: false, final false
inline void FinishEndElement() ;

/// @brief Method GenerateImpliedXmlnsAttrs, addr 0x181c26290, size 0x180, virtual false, abstract: false, final false
inline void GenerateImpliedXmlnsAttrs() ;

/// @brief Method GenerateTokenTypeMap, addr 0x181c26410, size 0x550, virtual false, abstract: false, final false
inline void GenerateTokenTypeMap() ;

/// @brief Method GetAttribute, addr 0x181c26a80, size 0x60, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x181c26bf0, size 0x70, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x181c26ae0, size 0x110, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method GetAttributeText, addr 0x181c26960, size 0x120, virtual false, abstract: false, final false
inline ::StringW GetAttributeText(int32_t  i) ;

/// @brief Method GetDouble, addr 0x181c26c60, size 0x70, virtual false, abstract: false, final false
inline double_t GetDouble(int32_t  offset) ;

/// @brief Method GetInt16, addr 0x181c26cd0, size 0x20, virtual false, abstract: false, final false
inline int16_t GetInt16(int32_t  pos) ;

/// @brief Method GetInt32, addr 0x181c26cf0, size 0x30, virtual false, abstract: false, final false
inline int32_t GetInt32(int32_t  pos) ;

/// @brief Method GetInt64, addr 0x181c26d20, size 0x70, virtual false, abstract: false, final false
inline int64_t GetInt64(int32_t  pos) ;

/// @brief Method GetSingle, addr 0x181c26d90, size 0x40, virtual false, abstract: false, final false
inline float_t GetSingle(int32_t  offset) ;

/// @brief Method GetString, addr 0x181c26e00, size 0x160, virtual false, abstract: false, final false
inline ::StringW GetString(int32_t  pos, int32_t  cch) ;

/// @brief Method GetStringAligned, addr 0x181c26dd0, size 0x30, virtual false, abstract: false, final false
inline ::StringW GetStringAligned(::ArrayW<uint8_t>  data, int32_t  offset, int32_t  cch) ;

/// @brief Method GetUInt16, addr 0x181c26cd0, size 0x20, virtual false, abstract: false, final false
inline uint16_t GetUInt16(int32_t  pos) ;

/// @brief Method GetUInt32, addr 0x181c26cf0, size 0x30, virtual false, abstract: false, final false
inline uint32_t GetUInt32(int32_t  pos) ;

/// @brief Method GetUInt64, addr 0x181c26d20, size 0x70, virtual false, abstract: false, final false
inline uint64_t GetUInt64(int32_t  pos) ;

/// @brief Method GetValueType, addr 0x181c26f60, size 0x70, virtual false, abstract: false, final false
inline ::System::Type* GetValueType(::System::Xml::BinXmlToken  token) ;

/// @brief Method GetXsdKatmaiTokenLength, addr 0x181c26fd0, size 0x1c0, virtual false, abstract: false, final false
inline int32_t GetXsdKatmaiTokenLength(::System::Xml::BinXmlToken  token) ;

/// @brief Method GrowAttributes, addr 0x181c27190, size 0x70, virtual false, abstract: false, final false
inline void GrowAttributes() ;

/// @brief Method GrowElements, addr 0x181c27200, size 0x80, virtual false, abstract: false, final false
inline void GrowElements() ;

/// @brief Method HashCheckForDuplicateAttributes, addr 0x181c27280, size 0x260, virtual false, abstract: false, final false
inline void HashCheckForDuplicateAttributes() ;

/// @brief Method ImplReadCDATA, addr 0x181c274e0, size 0x80, virtual false, abstract: false, final false
inline void ImplReadCDATA() ;

/// @brief Method ImplReadComment, addr 0x181c27560, size 0x40, virtual false, abstract: false, final false
inline void ImplReadComment() ;

/// @brief Method ImplReadData, addr 0x181c275a0, size 0x1b0, virtual false, abstract: false, final false
inline void ImplReadData(::System::Xml::BinXmlToken  tokenType) ;

/// @brief Method ImplReadDoctype, addr 0x181c27750, size 0x370, virtual false, abstract: false, final false
inline void ImplReadDoctype() ;

/// @brief Method ImplReadElement, addr 0x181c27ac0, size 0x4d0, virtual false, abstract: false, final false
inline void ImplReadElement() ;

/// @brief Method ImplReadEndElement, addr 0x181c27f90, size 0xc0, virtual false, abstract: false, final false
inline void ImplReadEndElement() ;

/// @brief Method ImplReadEndNest, addr 0x181c28050, size 0x60, virtual false, abstract: false, final false
inline void ImplReadEndNest() ;

/// @brief Method ImplReadNest, addr 0x181c280b0, size 0x100, virtual false, abstract: false, final false
inline void ImplReadNest() ;

/// @brief Method ImplReadPI, addr 0x181c281b0, size 0x70, virtual false, abstract: false, final false
inline void ImplReadPI() ;

/// @brief Method ImplReadXmlText, addr 0x181c28220, size 0x300, virtual false, abstract: false, final false
inline void ImplReadXmlText() ;

/// @brief Method LocateAttribute, addr 0x181c285b0, size 0xb0, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name) ;

/// @brief Method LocateAttribute, addr 0x181c28520, size 0x90, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method LookupNamespace, addr 0x181c28660, size 0x70, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x181c28740, size 0x90, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x181c286d0, size 0x70, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x181c287d0, size 0x120, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x181c288f0, size 0x80, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x181c28970, size 0xa0, virtual true, abstract: false, final false
inline bool MoveToNextAttribute() ;

/// @brief Method NameFlush, addr 0x181c28a10, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method NextToken, addr 0x181c28d20, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken() ;

/// @brief Method NextToken1, addr 0x181c28a60, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken1() ;

/// @brief Method NextToken2, addr 0x181c28ac0, size 0x260, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken2(::System::Xml::BinXmlToken  token) ;

/// @brief Method ParseMB32, addr 0x181c28fc0, size 0x90, virtual false, abstract: false, final false
inline int32_t ParseMB32() ;

/// @brief Method ParseMB32, addr 0x181c29050, size 0xc0, virtual false, abstract: false, final false
inline int32_t ParseMB32(int32_t  pos) ;

/// @brief Method ParseMB32_, addr 0x181c28da0, size 0x220, virtual false, abstract: false, final false
inline int32_t ParseMB32_(uint8_t  b) ;

/// @brief Method ParseMB64, addr 0x181c28fc0, size 0x90, virtual false, abstract: false, final false
inline int32_t ParseMB64() ;

/// @brief Method ParseText, addr 0x181c29110, size 0xc0, virtual false, abstract: false, final false
inline ::StringW ParseText() ;

/// @brief Method PeekNextToken, addr 0x181c291d0, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekNextToken() ;

/// @brief Method PeekToken, addr 0x181c291f0, size 0x210, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekToken() ;

/// @brief Method PopNamespaces, addr 0x181c29400, size 0xa0, virtual false, abstract: false, final false
inline void PopNamespaces(::System::Xml::XmlSqlBinaryReader_NamespaceDecl*  firstInScopeChain) ;

/// @brief Method PositionOnAttribute, addr 0x181c294a0, size 0xc0, virtual false, abstract: false, final false
inline void PositionOnAttribute(int32_t  i) ;

/// @brief Method PushNamespace, addr 0x181c29560, size 0x1f0, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  implied) ;

/// @brief Method ReScanOverValue, addr 0x181c29750, size 0x20, virtual false, abstract: false, final false
inline void ReScanOverValue(::System::Xml::BinXmlToken  token) ;

/// @brief Method Read, addr 0x181c2ab20, size 0x160, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x181c29770, size 0x1b0, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadByte, addr 0x181c29920, size 0x70, virtual false, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadDoc, addr 0x181c29990, size 0x900, virtual false, abstract: false, final false
inline bool ReadDoc() ;

/// @brief Method ReadInit, addr 0x181c2a290, size 0x4f0, virtual false, abstract: false, final false
inline bool ReadInit(bool  skipXmlDecl) ;

/// @brief Method ReadNameRef, addr 0x181c2a780, size 0x80, virtual false, abstract: false, final false
inline int32_t ReadNameRef() ;

/// @brief Method ReadQNameRef, addr 0x181c2a800, size 0x80, virtual false, abstract: false, final false
inline int32_t ReadQNameRef() ;

/// @brief Method ReadToken, addr 0x181c2a880, size 0x210, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken ReadToken() ;

/// @brief Method ReadUShort, addr 0x181c2aa90, size 0x90, virtual false, abstract: false, final false
inline uint16_t ReadUShort() ;

/// @brief Method RescanNextToken, addr 0x181c2ac80, size 0x380, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken RescanNextToken() ;

/// @brief Method ResolveEntity, addr 0x1802eb7d0, size 0x10, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method ScanAttributes, addr 0x181c2b000, size 0x5b0, virtual false, abstract: false, final false
inline void ScanAttributes() ;

/// @brief Method ScanOverAnyValue, addr 0x181c2b5b0, size 0x4e0, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverAnyValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanOverValue, addr 0x181c2ba90, size 0x1f0, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanText, addr 0x181c2bc80, size 0x130, virtual false, abstract: false, final false
inline int32_t ScanText(::by_ref<int32_t>  start) ;

/// @brief Method SimpleCheckForDuplicateAttributes, addr 0x181c2bdb0, size 0x140, virtual false, abstract: false, final false
inline void SimpleCheckForDuplicateAttributes() ;

/// @brief Method SkipExtn, addr 0x181c2bef0, size 0xb0, virtual false, abstract: false, final false
inline void SkipExtn() ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x181c2bfa0, size 0x250, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x181c2c1f0, size 0x180, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW  namespaceName) ;

/// @brief Method ThrowNotSupported, addr 0x181c2c370, size 0x50, virtual false, abstract: false, final false
inline ::System::Exception* ThrowNotSupported(::StringW  res) ;

/// @brief Method ThrowUnexpectedToken, addr 0x181c2c3c0, size 0x50, virtual false, abstract: false, final false
inline ::System::Exception* ThrowUnexpectedToken(::System::Xml::BinXmlToken  token) ;

/// @brief Method ThrowXmlException, addr 0x181c2c4b0, size 0x50, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res) ;

/// @brief Method ThrowXmlException, addr 0x181c2c410, size 0xa0, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res, ::StringW  arg1, ::StringW  arg2) ;

/// @brief Method UpdateFromTextReader, addr 0x181c2c610, size 0x20, virtual false, abstract: false, final false
inline bool UpdateFromTextReader(bool  needUpdate) ;

/// @brief Method UpdateFromTextReader, addr 0x181c2c500, size 0x110, virtual false, abstract: false, final false
inline void UpdateFromTextReader() ;

/// @brief Method ValueAsDateTimeString, addr 0x181c2c630, size 0x810, virtual false, abstract: false, final false
inline ::StringW ValueAsDateTimeString() ;

/// @brief Method ValueAsDecimal, addr 0x181c2ce40, size 0x380, virtual false, abstract: false, final false
inline ::System::Decimal ValueAsDecimal() ;

/// @brief Method ValueAsDouble, addr 0x181c2d1c0, size 0x230, virtual false, abstract: false, final false
inline double_t ValueAsDouble() ;

/// @brief Method ValueAsLong, addr 0x181c2d3f0, size 0x320, virtual false, abstract: false, final false
inline int64_t ValueAsLong() ;

/// @brief Method ValueAsString, addr 0x181c2d710, size 0x7e0, virtual false, abstract: false, final false
inline ::StringW ValueAsString(::System::Xml::BinXmlToken  token) ;

/// @brief Method ValueAsULong, addr 0x181c2def0, size 0xe0, virtual false, abstract: false, final false
inline uint64_t ValueAsULong() ;

/// @brief Method VerifyVersion, addr 0x181c2dfd0, size 0x30, virtual false, abstract: false, final false
inline void VerifyVersion(int32_t  requiredVersion, ::System::Xml::BinXmlToken  token) ;

/// @brief Method XmlDeclValue, addr 0x181c2e000, size 0x100, virtual false, abstract: false, final false
inline ::StringW XmlDeclValue() ;

/// @brief Method XsdKatmaiTimeScaleToValueLength, addr 0x181c2e100, size 0x70, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::XmlSqlBinaryReader_AttrInfo> const& __cordl_internal_get_attributes() const;

constexpr ::ArrayW<::System::Xml::XmlSqlBinaryReader_AttrInfo>& __cordl_internal_get_attributes() ;
...
constexpr ::ArrayW<::System::Xml::XmlSqlBinaryReader_ElemInfo> const& __cordl_internal_get_elementStack() const;

constexpr ::ArrayW<::System::Xml::XmlSqlBinaryReader_ElemInfo>& __cordl_internal_get_elementStack() ;
...
constexpr void __cordl_internal_set_attributes(::ArrayW<::System::Xml::XmlSqlBinaryReader_AttrInfo>  value) ;
...
constexpr void __cordl_internal_set_elementStack(::ArrayW<::System::Xml::XmlSqlBinaryReader_ElemInfo>  value) ;
...
/// @brief Method .ctor, addr 0x181c2e2d0, size 0x4e0, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x181c2e7b0, size 0x50, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x1802e5800, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_Depth, addr 0x181c2e800, size 0xd0, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_EOF, addr 0x181c2e8d0, size 0x10, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_HasValue, addr 0x181c2e8e0, size 0x40, virtual true, abstract: false, final false
inline bool get_HasValue() ;

/// @brief Method get_IsEmptyElement, addr 0x181c2e920, size 0x20, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x180322750, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NameTable, addr 0x1803a74d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x180322760, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x180cbfa00, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x1802ec4d0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadState, addr 0x181c2e940, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Settings, addr 0x181c2e960, size 0xe0, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_Value, addr 0x181c2ea40, size 0x330, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_ValueType, addr 0x1803370d0, size 0x10, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlLang, addr 0x181c2ed70, size 0x70, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x181c2ede0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Field elementStack, offset: 0xd8, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlSqlBinaryReader_ElemInfo>  ___elementStack;
...
/// @brief Field attributes, offset: 0xe8, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlSqlBinaryReader_AttrInfo>  ___attributes;
