...
DEFINE_IL2CPP_CLASS(::System::Xml::ConformanceLevel, "System.Xml", "ConformanceLevel");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::ConformanceLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::ConformanceLevel) == 0x4, "Size mismatch!");
