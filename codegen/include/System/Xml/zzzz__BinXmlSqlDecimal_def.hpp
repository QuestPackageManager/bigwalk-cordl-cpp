...
DEFINE_IL2CPP_CLASS(::System::Xml::BinXmlSqlDecimal, "System.Xml", "BinXmlSqlDecimal");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
/// @brief Field rgCLenFromPrec, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_rgCLenFromPrec, put=setStaticF_rgCLenFromPrec)) ::ArrayW<uint8_t>  rgCLenFromPrec;
...
/// @brief Field x_rgulShiftBase, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_x_rgulShiftBase, put=setStaticF_x_rgulShiftBase)) ::ArrayW<uint32_t>  x_rgulShiftBase;
...
/// @brief Method ToDecimal, addr 0x181c20c10, size 0xd0, virtual false, abstract: false, final false
inline ::System::Decimal ToDecimal() ;

/// @brief Method ToString, addr 0x181c20ce0, size 0x200, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TrimTrailingZeros, addr 0x181c20ee0, size 0x170, virtual false, abstract: false, final false
inline void TrimTrailingZeros() ;

/// @brief Method UIntFromByteArray, addr 0x18165bad0, size 0x30, virtual false, abstract: false, final false
static inline uint32_t UIntFromByteArray(::ArrayW<uint8_t>  data, int32_t  offset) ;

/// @brief Method .ctor, addr 0x181c21210, size 0x230, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  data, int32_t  offset, bool  trim) ;
...
static inline ::ArrayW<uint8_t> getStaticF_rgCLenFromPrec() ;
...
static inline ::ArrayW<uint32_t> getStaticF_x_rgulShiftBase() ;

static inline uint64_t getStaticF_x_ulInt32Base() ;

static inline uint64_t getStaticF_x_ulInt32BaseForMod() ;

/// @brief Method get_IsPositive, addr 0x181c21440, size 0x20, virtual false, abstract: false, final false
...
static inline void setStaticF_rgCLenFromPrec(::ArrayW<uint8_t>  value) ;
...
static inline void setStaticF_x_rgulShiftBase(::ArrayW<uint32_t>  value) ;
...
// Ctor Parameters [CppParam { name: "m_bLen", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_bPrec", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_bScale", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_bSign", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_data1", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_data2", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_data3", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_data4", ty: "uint32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Xml::BinXmlSqlDecimal) == 0x14, "Size mismatch!");
