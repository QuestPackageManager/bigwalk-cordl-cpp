...
static_assert(offsetof(::System::Xml::XsdCachingReader_CachingReaderState, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method AddAttribute, addr 0x181d0c700, size 0x100, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* AddAttribute(int32_t  attIndex) ;

/// @brief Method AddContent, addr 0x181d0c800, size 0xf0, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* AddContent(::System::Xml::XmlNodeType  nodeType) ;

/// @brief Method ClearAttributesInfo, addr 0x181d0c8f0, size 0x10, virtual false, abstract: false, final false
inline void ClearAttributesInfo() ;

/// @brief Method Close, addr 0x181d0c900, size 0x30, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method CreateDummyTextNode, addr 0x181d0c930, size 0x90, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW  attributeValue, int32_t  depth) ;

/// @brief Method GetAttribute, addr 0x181d0cb10, size 0x40, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x181d0cc30, size 0x70, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x181d0cb50, size 0xe0, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method GetAttributeIndexWithPrefix, addr 0x181d0c9c0, size 0xa0, virtual false, abstract: false, final false
inline int32_t GetAttributeIndexWithPrefix(::StringW  name) ;

/// @brief Method GetAttributeIndexWithoutPrefix, addr 0x181d0ca60, size 0xb0, virtual false, abstract: false, final false
inline int32_t GetAttributeIndexWithoutPrefix(::StringW  name) ;

/// @brief Method GetCoreReader, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlReader* GetCoreReader() ;

/// @brief Method GetLineInfo, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::IXmlLineInfo* GetLineInfo() ;

/// @brief Method Init, addr 0x181d0cca0, size 0x170, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method LookupNamespace, addr 0x181bc5dd0, size 0x20, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x181d0ce50, size 0x80, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x181d0ce10, size 0x40, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x181d0ced0, size 0x50, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x181d0cf20, size 0x40, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x181d0cf60, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method Read, addr 0x181d0d070, size 0x2f0, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x181d0cfa0, size 0xb0, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadOriginalContentAsString, addr 0x181d0d050, size 0x20, virtual false, abstract: false, final false
inline ::StringW ReadOriginalContentAsString() ;

/// @brief Method RecordAttributes, addr 0x181d0d360, size 0x260, virtual false, abstract: false, final false
inline void RecordAttributes() ;

/// @brief Method RecordEndElementNode, addr 0x181d0d5c0, size 0x110, virtual false, abstract: false, final false
inline void RecordEndElementNode() ;

/// @brief Method RecordTextNode, addr 0x181d0d6d0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x181d0d740, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method SetToReplayMode, addr 0x181d0d770, size 0x30, virtual false, abstract: false, final false
inline void SetToReplayMode() ;

/// @brief Method Skip, addr 0x181d0d7a0, size 0x110, virtual true, abstract: false, final false
inline void Skip() ;

/// @brief Method SwitchTextNodeAndEndElement, addr 0x181d0d8b0, size 0xd0, virtual false, abstract: false, final false
inline void SwitchTextNodeAndEndElement(::StringW  textValue, ::StringW  originalStringValue) ;

/// @brief Method System.Xml.IXmlLineInfo.HasLineInfo, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IXmlLineInfo_HasLineInfo() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LineNumber, addr 0x181d0d980, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IXmlLineInfo_get_LineNumber() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LinePosition, addr 0x181d0d990, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181d0d9a0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x1803eb0e0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x181bc5ef0, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_Depth, addr 0x181d0da40, size 0x10, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_EOF, addr 0x181d0da50, size 0x30, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_HasValue, addr 0x181d0da80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_IsEmptyElement, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x181d0da90, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x181d0daa0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x181d0dab0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x181d0dac0, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x181d0dad0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_QuoteChar, addr 0x18165ba50, size 0x20, virtual true, abstract: false, final false
inline char16_t get_QuoteChar() ;

/// @brief Method get_ReadState, addr 0x181bc5ff0, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Settings, addr 0x181ade720, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_Value, addr 0x181d0dae0, size 0x20, virtual true, abstract: false, final false
