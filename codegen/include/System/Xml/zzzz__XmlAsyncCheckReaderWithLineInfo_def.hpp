...
// Write type traits
MARK_REF_T(::System::Xml::XmlAsyncCheckReaderWithLineInfo*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlAsyncCheckReaderWithLineInfo*, "System.Xml", "XmlAsyncCheckReaderWithLineInfo");
...
/// @brief Method HasLineInfo, addr 0x181cdcd40, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cdcd60, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlReader*  reader) ;

/// @brief Method get_LineNumber, addr 0x181cdce30, size 0x20, virtual true, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x181cdce50, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlAsyncCheckReaderWithLineInfo) == 0x28, "Size mismatch!");
