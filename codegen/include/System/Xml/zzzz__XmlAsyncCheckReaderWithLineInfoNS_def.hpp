...
/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x181cdcc50, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x181cdcc70, size 0x20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x181cdcc90, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181cdccb0, size 0x90, virtual false, abstract: false, final false
