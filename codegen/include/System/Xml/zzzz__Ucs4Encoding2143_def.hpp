...
// Write type traits
MARK_REF_T(::System::Xml::Ucs4Encoding2143*);
DEFINE_IL2CPP_CLASS(::System::Xml::Ucs4Encoding2143*, "System.Xml", "Ucs4Encoding2143");
...
/// @brief Method GetPreamble, addr 0x181d2cc90, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding2143* New_ctor() ;

/// @brief Method .ctor, addr 0x181d2ccb0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x181d2cd10, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Ucs4Encoding2143) == 0x40, "Size mismatch!");
