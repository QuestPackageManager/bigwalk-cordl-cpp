...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlNodeReaderNavigator_VirtualAttribute, "System.Xml", "XmlNodeReaderNavigator/VirtualAttribute");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(sizeof(::System::Xml::XmlNodeReaderNavigator_VirtualAttribute) == 0x10, "Size mismatch!");
...
/// @brief Field decNodeAttributes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_decNodeAttributes, put=__cordl_internal_set_decNodeAttributes)) ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  decNodeAttributes;
...
/// @brief Field docTypeNodeAttributes, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_docTypeNodeAttributes, put=__cordl_internal_set_docTypeNodeAttributes)) ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  docTypeNodeAttributes;
...
/// @brief Method CheckIndexCondition, addr 0x181d1e0d0, size 0x30, virtual false, abstract: false, final false
inline void CheckIndexCondition(int32_t  attributeIndex) ;

/// @brief Method DefaultLookupNamespace, addr 0x181d1e100, size 0x100, virtual false, abstract: false, final false
inline ::StringW DefaultLookupNamespace(::StringW  prefix) ;

/// @brief Method GetAttribute, addr 0x181d1e700, size 0x200, virtual false, abstract: false, final false
inline ::StringW GetAttribute(int32_t  attributeIndex) ;

/// @brief Method GetAttribute, addr 0x181d1e2a0, size 0x230, virtual false, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x181d1e4d0, size 0x230, virtual false, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method GetAttributeFromElement, addr 0x181d1e250, size 0x50, virtual false, abstract: false, final false
inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name) ;

/// @brief Method GetAttributeFromElement, addr 0x181d1e200, size 0x50, virtual false, abstract: false, final false
inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name, ::StringW  ns) ;

/// @brief Method GetDecAttrInd, addr 0x181d1e900, size 0x80, virtual false, abstract: false, final false
inline int32_t GetDecAttrInd(::StringW  name) ;

/// @brief Method GetDeclarationAttr, addr 0x181d1e9c0, size 0x90, virtual false, abstract: false, final false
inline ::StringW GetDeclarationAttr(::System::Xml::XmlDeclaration*  decl, ::StringW  name) ;

/// @brief Method GetDeclarationAttr, addr 0x181d1e980, size 0x40, virtual false, abstract: false, final false
inline ::StringW GetDeclarationAttr(int32_t  i) ;

/// @brief Method GetDocTypeAttrInd, addr 0x181d1ea50, size 0x80, virtual false, abstract: false, final false
inline int32_t GetDocTypeAttrInd(::StringW  name) ;

/// @brief Method GetDocumentTypeAttr, addr 0x181d1eb10, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetDocumentTypeAttr(::System::Xml::XmlDocumentType*  docType, ::StringW  name) ;

/// @brief Method GetDocumentTypeAttr, addr 0x181d1ead0, size 0x40, virtual false, abstract: false, final false
inline ::StringW GetDocumentTypeAttr(int32_t  i) ;

/// @brief Method GetNamespacesInScope, addr 0x181d1eb80, size 0x460, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method InitDecAttr, addr 0x181d1efe0, size 0x160, virtual false, abstract: false, final false
inline void InitDecAttr() ;

/// @brief Method InitDocTypeAttr, addr 0x181d1f140, size 0x110, virtual false, abstract: false, final false
inline void InitDocTypeAttr() ;

/// @brief Method IsLocalNameEmpty, addr 0x181d1f250, size 0x50, virtual false, abstract: false, final false
inline bool IsLocalNameEmpty(::System::Xml::XmlNodeType  nt) ;

/// @brief Method LogMove, addr 0x181d1f2a0, size 0x50, virtual false, abstract: false, final false
inline void LogMove(int32_t  level) ;

/// @brief Method LookupNamespace, addr 0x181d1f2f0, size 0x290, virtual false, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181d1f580, size 0x3c0, virtual false, abstract: false, final false
inline ::StringW LookupPrefix(::StringW  namespaceName) ;

/// @brief Method MoveToAttribute, addr 0x181d1fdd0, size 0x20, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x181d1fc00, size 0x1d0, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method MoveToAttribute, addr 0x181d1fa10, size 0x1f0, virtual false, abstract: false, final false
inline void MoveToAttribute(int32_t  attributeIndex) ;

/// @brief Method MoveToAttributeFromElement, addr 0x181d1f940, size 0xd0, virtual false, abstract: false, final false
inline bool MoveToAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name, ::StringW  ns) ;

/// @brief Method MoveToElement, addr 0x181d1fdf0, size 0x80, virtual false, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstChild, addr 0x181d1fe70, size 0x50, virtual false, abstract: false, final false
inline bool MoveToFirstChild() ;

/// @brief Method MoveToNext, addr 0x181d200e0, size 0x80, virtual false, abstract: false, final false
inline bool MoveToNext() ;

/// @brief Method MoveToNextAttribute, addr 0x181d1fec0, size 0x1c0, virtual false, abstract: false, final false
inline bool MoveToNextAttribute(::by_ref<int32_t>  level) ;

/// @brief Method MoveToNextSibling, addr 0x181d20080, size 0x60, virtual false, abstract: false, final false
inline bool MoveToNextSibling(::System::Xml::XmlNode*  node) ;

/// @brief Method MoveToParent, addr 0x181d20160, size 0x50, virtual false, abstract: false, final false
inline bool MoveToParent() ;

static inline ::System::Xml::XmlNodeReaderNavigator* New_ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method ReadAttributeValue, addr 0x181d201b0, size 0x1f0, virtual false, abstract: false, final false
inline bool ReadAttributeValue(::by_ref<int32_t>  level, ::by_ref<bool>  bResolveEntity, ::by_ref<::System::Xml::XmlNodeType>  nt) ;

/// @brief Method ResetMove, addr 0x181d203a0, size 0x250, virtual false, abstract: false, final false
inline void ResetMove(::by_ref<int32_t>  level, ::by_ref<::System::Xml::XmlNodeType>  nt) ;

/// @brief Method ResetToAttribute, addr 0x181d205f0, size 0xe0, virtual false, abstract: false, final false
inline void ResetToAttribute(::by_ref<int32_t>  level) ;

/// @brief Method RollBackMove, addr 0x181d206d0, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute> const& __cordl_internal_get_decNodeAttributes() const;

constexpr ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>& __cordl_internal_get_decNodeAttributes() ;
...
constexpr ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute> const& __cordl_internal_get_docTypeNodeAttributes() const;

constexpr ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>& __cordl_internal_get_docTypeNodeAttributes() ;
...
constexpr void __cordl_internal_set_decNodeAttributes(::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  value) ;

constexpr void __cordl_internal_set_doc(::System::Xml::XmlDocument*  value) ;

constexpr void __cordl_internal_set_docTypeNodeAttributes(::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  value) ;
...
/// @brief Method .ctor, addr 0x181d20720, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method get_AttributeCount, addr 0x181d20a10, size 0x110, virtual false, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x181bc5f10, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CreatedOnAttribute, addr 0x181d20b20, size 0x10, virtual false, abstract: false, final false
inline bool get_CreatedOnAttribute() ;

/// @brief Method get_Document, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_Document() ;

/// @brief Method get_HasValue, addr 0x181d20b30, size 0x60, virtual false, abstract: false, final false
inline bool get_HasValue() ;

/// @brief Method get_IsDefault, addr 0x181d20b90, size 0x90, virtual false, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x181d20c20, size 0x90, virtual false, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_IsOnDeclOrDocType, addr 0x181d20cb0, size 0x40, virtual false, abstract: false, final false
inline bool get_IsOnDeclOrDocType() ;

/// @brief Method get_LocalName, addr 0x181d20cf0, size 0xb0, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x181d20da0, size 0xf0, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x181bc5eb0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x181d20e90, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x181bc5f50, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SchemaInfo, addr 0x181bc5ed0, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_Value, addr 0x181d20ed0, size 0x1e0, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x181d210b0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x181d210d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Field decNodeAttributes, offset: 0x58, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  ___decNodeAttributes;

/// @brief Field docTypeNodeAttributes, offset: 0x60, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>  ___docTypeNodeAttributes;
