...
DEFINE_IL2CPP_CLASS(::System::Xml::DtdParser_LiteralType, "System.Xml", "DtdParser/LiteralType");
DEFINE_IL2CPP_CLASS(::System::Xml::DtdParser_ScanningFunction, "System.Xml", "DtdParser/ScanningFunction");
DEFINE_IL2CPP_CLASS(::System::Xml::DtdParser_Token, "System.Xml", "DtdParser/Token");
...
static_assert(offsetof(::System::Xml::DtdParser_Token, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::DtdParser_Token) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::DtdParser_ScanningFunction, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::DtdParser_ScanningFunction) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::DtdParser_LiteralType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::DtdParser_LiteralType) == 0x4, "Size mismatch!");
...
/// @brief Method .ctor, addr 0x181d2d0e0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d261d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AddUndeclaredNotation, addr 0x181d12000, size 0x150, virtual false, abstract: false, final false
inline void AddUndeclaredNotation(::StringW  notationName) ;

/// @brief Method Create, addr 0x181d12150, size 0xe0, virtual false, abstract: false, final false
static inline ::System::Xml::IDtdParser* Create() ;

/// @brief Method EatPublicKeyword, addr 0x181d12230, size 0xb0, virtual false, abstract: false, final false
inline bool EatPublicKeyword() ;

/// @brief Method EatSystemKeyword, addr 0x181d122e0, size 0xb0, virtual false, abstract: false, final false
inline bool EatSystemKeyword() ;

/// @brief Method GetNameQualified, addr 0x181d12390, size 0x160, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* GetNameQualified(bool  canHavePrefix) ;

/// @brief Method GetNameString, addr 0x181d124f0, size 0x30, virtual false, abstract: false, final false
inline ::StringW GetNameString() ;

/// @brief Method GetNmtokenString, addr 0x181d124f0, size 0x30, virtual false, abstract: false, final false
inline ::StringW GetNmtokenString() ;

/// @brief Method GetToken, addr 0x181d12520, size 0x1420, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token GetToken(bool  needWhiteSpace) ;

/// @brief Method GetValue, addr 0x181d139c0, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetValue() ;

/// @brief Method GetValueWithStrippedSpaces, addr 0x181d13940, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetValueWithStrippedSpaces() ;

/// @brief Method HandleEntityEnd, addr 0x181d13a30, size 0x130, virtual false, abstract: false, final false
inline bool HandleEntityEnd(bool  inLiteral) ;

/// @brief Method HandleEntityReference, addr 0x181d13b60, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method HandleEntityReference, addr 0x181d13dc0, size 0x70, virtual false, abstract: false, final false
inline bool HandleEntityReference(bool  paramEntity, bool  inLiteral, bool  inAttribute) ;

/// @brief Method Initialize, addr 0x181d14150, size 0x230, virtual false, abstract: false, final false
inline void Initialize(::System::Xml::IDtdParserAdapter*  readerAdapter) ;

/// @brief Method InitializeFreeFloatingDtd, addr 0x181d13e30, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method IsAttributeValueType, addr 0x181d14380, size 0x10, virtual false, abstract: false, final false
inline bool IsAttributeValueType(::System::Xml::DtdParser_Token  token) ;

/// @brief Method LoadParsingBuffer, addr 0x181d14390, size 0xd0, virtual false, abstract: false, final false
inline void LoadParsingBuffer() ;

static inline ::System::Xml::DtdParser* New_ctor() ;

/// @brief Method OnUnexpectedError, addr 0x181d14460, size 0x40, virtual false, abstract: false, final false
inline void OnUnexpectedError() ;

/// @brief Method Parse, addr 0x181d170f0, size 0x310, virtual false, abstract: false, final false
inline void Parse(bool  saveInternalSubset) ;

/// @brief Method ParseAttlistDecl, addr 0x181d144a0, size 0x440, virtual false, abstract: false, final false
inline void ParseAttlistDecl() ;

/// @brief Method ParseAttlistDefault, addr 0x181d148e0, size 0x1e0, virtual false, abstract: false, final false
inline void ParseAttlistDefault(::System::Xml::Schema::SchemaAttDef*  attrDef, bool  ignoreErrors) ;

/// @brief Method ParseAttlistType, addr 0x181d14ac0, size 0x610, virtual false, abstract: false, final false
...
/// @brief Method ParseComment, addr 0x181d150d0, size 0x110, virtual false, abstract: false, final false
inline void ParseComment() ;

/// @brief Method ParseCondSection, addr 0x181d151e0, size 0x260, virtual false, abstract: false, final false
inline void ParseCondSection() ;

/// @brief Method ParseElementDecl, addr 0x181d15440, size 0x310, virtual false, abstract: false, final false
inline void ParseElementDecl() ;

/// @brief Method ParseElementMixedContent, addr 0x181d15750, size 0x270, virtual false, abstract: false, final false
inline void ParseElementMixedContent(::System::Xml::Schema::ParticleContentValidator*  pcv, int32_t  startParenEntityId) ;

/// @brief Method ParseElementOnlyContent, addr 0x181d159c0, size 0x300, virtual false, abstract: false, final false
inline void ParseElementOnlyContent(::System::Xml::Schema::ParticleContentValidator*  pcv, int32_t  startParenEntityId) ;

/// @brief Method ParseEntityDecl, addr 0x181d15cc0, size 0x350, virtual false, abstract: false, final false
inline void ParseEntityDecl() ;

/// @brief Method ParseExternalId, addr 0x181d16010, size 0x4d0, virtual false, abstract: false, final false
inline void ParseExternalId(::System::Xml::DtdParser_Token  idTokenType, ::System::Xml::DtdParser_Token  declType, ::by_ref<::StringW>  publicId, ::by_ref<::StringW>  systemId) ;

/// @brief Method ParseExternalSubset, addr 0x181d164e0, size 0x140, virtual false, abstract: false, final false
inline void ParseExternalSubset() ;

/// @brief Method ParseFreeFloatingDtd, addr 0x181d16620, size 0x60, virtual false, abstract: false, final false
inline void ParseFreeFloatingDtd() ;

/// @brief Method ParseHowMany, addr 0x181d16680, size 0x60, virtual false, abstract: false, final false
inline void ParseHowMany(::System::Xml::Schema::ParticleContentValidator*  pcv) ;

/// @brief Method ParseInDocumentDtd, addr 0x181d166e0, size 0x190, virtual false, abstract: false, final false
inline void ParseInDocumentDtd(bool  saveInternalSubset) ;

/// @brief Method ParseInternalSubset, addr 0x181d16870, size 0x10, virtual false, abstract: false, final false
inline void ParseInternalSubset() ;

/// @brief Method ParseNotationDecl, addr 0x181d16880, size 0x1f0, virtual false, abstract: false, final false
inline void ParseNotationDecl() ;

/// @brief Method ParsePI, addr 0x181d16a70, size 0xa0, virtual false, abstract: false, final false
inline void ParsePI() ;

/// @brief Method ParseSubset, addr 0x181d16b10, size 0x4f0, virtual false, abstract: false, final false
inline void ParseSubset() ;

/// @brief Method ParseUnexpectedToken, addr 0x181d17000, size 0xf0, virtual false, abstract: false, final false
inline ::StringW ParseUnexpectedToken(int32_t  startPos) ;

/// @brief Method ReadData, addr 0x181d17470, size 0x50, virtual false, abstract: false, final false
inline int32_t ReadData() ;

/// @brief Method ReadDataInName, addr 0x181d17400, size 0x70, virtual false, abstract: false, final false
inline bool ReadDataInName() ;

/// @brief Method SaveParsingBuffer, addr 0x181d17550, size 0x10, virtual false, abstract: false, final false
inline void SaveParsingBuffer() ;

/// @brief Method SaveParsingBuffer, addr 0x181d174c0, size 0x90, virtual false, abstract: false, final false
inline void SaveParsingBuffer(int32_t  internalSubsetValueEndPos) ;

/// @brief Method ScanAttlist1, addr 0x181d17560, size 0x90, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist1() ;

/// @brief Method ScanAttlist2, addr 0x181d175f0, size 0x540, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist2() ;

/// @brief Method ScanAttlist3, addr 0x181d17b30, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist3() ;

/// @brief Method ScanAttlist4, addr 0x181d17b80, size 0x160, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist4() ;

/// @brief Method ScanAttlist5, addr 0x181d17ce0, size 0x160, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist5() ;

/// @brief Method ScanAttlist6, addr 0x181d17e40, size 0x2f0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist6() ;

/// @brief Method ScanAttlist7, addr 0x181d18130, size 0x150, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanAttlist7() ;

/// @brief Method ScanClosingTag, addr 0x181d18280, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanClosingTag() ;

/// @brief Method ScanCondSection1, addr 0x181d182c0, size 0x230, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanCondSection1() ;

/// @brief Method ScanCondSection2, addr 0x181d184f0, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanCondSection2() ;

/// @brief Method ScanCondSection3, addr 0x181d18530, size 0x580, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanCondSection3() ;

/// @brief Method ScanDoctype1, addr 0x181d18ab0, size 0x140, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanDoctype1() ;

/// @brief Method ScanDoctype2, addr 0x181d18bf0, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanDoctype2() ;

/// @brief Method ScanElement1, addr 0x181d18c70, size 0x1b0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement1() ;

/// @brief Method ScanElement2, addr 0x181d18e20, size 0x160, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement2() ;

/// @brief Method ScanElement3, addr 0x181d18f80, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement3() ;

/// @brief Method ScanElement4, addr 0x181d18ff0, size 0xa0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement4() ;

/// @brief Method ScanElement5, addr 0x181d19090, size 0xc0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement5() ;

/// @brief Method ScanElement6, addr 0x181d19150, size 0x160, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement6() ;

/// @brief Method ScanElement7, addr 0x181d192b0, size 0x30, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanElement7() ;

/// @brief Method ScanEntity1, addr 0x181d192e0, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanEntity1() ;

/// @brief Method ScanEntity2, addr 0x181d19340, size 0x140, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanEntity2() ;

/// @brief Method ScanEntity3, addr 0x181d19480, size 0xe0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanEntity3() ;

/// @brief Method ScanEntityName, addr 0x181d19560, size 0xc0, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* ScanEntityName() ;

/// @brief Method ScanLiteral, addr 0x181d19620, size 0xae0, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanLiteral(::System::Xml::DtdParser_LiteralType  literalType) ;

/// @brief Method ScanName, addr 0x181d1a130, size 0x10, virtual false, abstract: false, final false
inline void ScanName() ;

/// @brief Method ScanNameExpected, addr 0x181d1a100, size 0x30, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanNameExpected() ;

/// @brief Method ScanNmtoken, addr 0x181d1a270, size 0x120, virtual false, abstract: false, final false
inline void ScanNmtoken() ;

/// @brief Method ScanNmtokenExpected, addr 0x181d1a140, size 0x130, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanNmtokenExpected() ;

/// @brief Method ScanNotation1, addr 0x181d1a390, size 0x100, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanNotation1() ;

/// @brief Method ScanPublicId1, addr 0x181d1a490, size 0x140, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanPublicId1() ;

/// @brief Method ScanPublicId2, addr 0x181d1a5d0, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanPublicId2() ;

/// @brief Method ScanQName, addr 0x181d1a890, size 0x10, virtual false, abstract: false, final false
inline void ScanQName() ;

/// @brief Method ScanQName, addr 0x181d1a660, size 0x230, virtual false, abstract: false, final false
inline void ScanQName(bool  isQName) ;

/// @brief Method ScanQNameExpected, addr 0x181d1a630, size 0x30, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanQNameExpected() ;

/// @brief Method ScanSubsetContent, addr 0x181d1a8a0, size 0x610, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanSubsetContent() ;

/// @brief Method ScanSystemId, addr 0x181d1aeb0, size 0x140, virtual false, abstract: false, final false
inline ::System::Xml::DtdParser_Token ScanSystemId() ;

/// @brief Method SendValidationEvent, addr 0x181d1aff0, size 0x120, virtual false, abstract: false, final false
inline void SendValidationEvent(int32_t  pos, ::System::Xml::Schema::XmlSeverityType  severity, ::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x181d1b110, size 0x120, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSeverityType  severity, ::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x181d1b230, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IDtdParser.ParseFreeFloatingDtd, addr 0x181d1b2f0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IDtdParser.ParseInternalDtd, addr 0x181d1b340, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method Throw, addr 0x181d1b5b0, size 0x30, virtual false, abstract: false, final false
inline void Throw(int32_t  curPos, ::StringW  res) ;

/// @brief Method Throw, addr 0x181d1b5e0, size 0x110, virtual false, abstract: false, final false
inline void Throw(int32_t  curPos, ::StringW  res, ::StringW  arg) ;

/// @brief Method Throw, addr 0x181d1b7d0, size 0x110, virtual false, abstract: false, final false
inline void Throw(int32_t  curPos, ::StringW  res, ::ArrayW<::StringW>  args) ;

/// @brief Method Throw, addr 0x181d1b6f0, size 0xe0, virtual false, abstract: false, final false
inline void Throw(::StringW  res, ::StringW  arg, int32_t  lineNo, int32_t  linePos) ;

/// @brief Method ThrowInvalidChar, addr 0x181d1b380, size 0x50, virtual false, abstract: false, final false
inline void ThrowInvalidChar(::ArrayW<char16_t>  data, int32_t  length, int32_t  invCharPos) ;

/// @brief Method ThrowInvalidChar, addr 0x181d1b3d0, size 0x50, virtual false, abstract: false, final false
inline void ThrowInvalidChar(int32_t  pos, ::StringW  data, int32_t  invCharPos) ;

/// @brief Method ThrowUnexpectedToken, addr 0x181d1b420, size 0xa0, virtual false, abstract: false, final false
inline void ThrowUnexpectedToken(int32_t  pos, ::StringW  expectedToken) ;

/// @brief Method ThrowUnexpectedToken, addr 0x181d1b4c0, size 0xf0, virtual false, abstract: false, final false
inline void ThrowUnexpectedToken(int32_t  pos, ::StringW  expectedToken1, ::StringW  expectedToken2) ;

/// @brief Method VerifyEntityReference, addr 0x181d1b8e0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d1ba50, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseUriStr, addr 0x181d1bb20, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_BaseUriStr() ;

/// @brief Method get_IgnoreEntityReferences, addr 0x181d1bb90, size 0x10, virtual false, abstract: false, final false
inline bool get_IgnoreEntityReferences() ;

/// @brief Method get_LineNo, addr 0x181d1bba0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_LineNo() ;

/// @brief Method get_LinePos, addr 0x181d1bbc0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_LinePos() ;

/// @brief Method get_Normalize, addr 0x1802fdd10, size 0x10, virtual false, abstract: false, final false
inline bool get_Normalize() ;

/// @brief Method get_ParsingInternalSubset, addr 0x181d1bbf0, size 0x10, virtual false, abstract: false, final false
inline bool get_ParsingInternalSubset() ;

/// @brief Method get_ParsingTopLevelMarkup, addr 0x181d1bc00, size 0x20, virtual false, abstract: false, final false
inline bool get_ParsingTopLevelMarkup() ;

/// @brief Method get_SaveInternalSubsetValue, addr 0x181d1bc20, size 0x40, virtual false, abstract: false, final false
inline bool get_SaveInternalSubsetValue() ;

/// @brief Method get_SupportNamespaces, addr 0x181878a60, size 0x10, virtual false, abstract: false, final false
