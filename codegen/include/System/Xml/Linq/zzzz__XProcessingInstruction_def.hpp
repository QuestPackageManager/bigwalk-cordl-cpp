...
// Write type traits
MARK_REF_T(::System::Xml::Linq::XProcessingInstruction*);
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::XProcessingInstruction*, "System.Xml.Linq", "XProcessingInstruction");
...
/// @brief Method CloneNode, addr 0x181c36ee0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method ValidateName, addr 0x181c36f50, size 0x60, virtual false, abstract: false, final false
static inline void ValidateName(::StringW  name) ;

/// @brief Method WriteTo, addr 0x181c36fb0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c37000, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::StringW  target, ::StringW  data) ;

/// @brief Method get_Data, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Data() ;

/// @brief Method get_NodeType, addr 0x180feb5f0, size 0x28d50, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Target, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Target() ;

/// @brief Method set_Data, addr 0x181c370b0, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Linq::XProcessingInstruction) == 0x38, "Size mismatch!");
