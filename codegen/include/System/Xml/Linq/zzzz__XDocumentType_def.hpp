...
// Write type traits
MARK_REF_T(::System::Xml::Linq::XDocumentType*);
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::XDocumentType*, "System.Xml.Linq", "XDocumentType");
...
/// @brief Method CloneNode, addr 0x181c33840, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x181c338d0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c339b0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::StringW  internalSubset) ;

/// @brief Method .ctor, addr 0x181c33930, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDocumentType*  other) ;

/// @brief Method get_InternalSubset, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_PublicId, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PublicId() ;

/// @brief Method get_SystemId, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Linq::XDocumentType) == 0x48, "Size mismatch!");
