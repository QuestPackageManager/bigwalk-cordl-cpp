...
// Write type traits
MARK_REF_T(::System::Xml::Linq::XStreamingElement*);
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::XStreamingElement*, "System.Xml.Linq", "XStreamingElement");
...
static_assert(sizeof(::System::Xml::Linq::XStreamingElement) == 0x20, "Size mismatch!");
