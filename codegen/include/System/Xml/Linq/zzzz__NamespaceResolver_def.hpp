...
// Write type traits
MARK_REF_T(::System::Xml::Linq::NamespaceResolver_NamespaceDeclaration*);
MARK_VAL_T(::System::Xml::Linq::NamespaceResolver);
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::NamespaceResolver_NamespaceDeclaration*, "System.Xml.Linq", "NamespaceResolver/NamespaceDeclaration");
DEFINE_IL2CPP_CLASS(::System::Xml::Linq::NamespaceResolver, "System.Xml.Linq", "NamespaceResolver");
...
static_assert(sizeof(::System::Xml::Linq::NamespaceResolver_NamespaceDeclaration) == 0x30, "Size mismatch!");
...
/// @brief Method Add, addr 0x181c308d0, size 0xd0, virtual false, abstract: false, final false
inline void Add(::StringW  prefix, ::System::Xml::Linq::XNamespace*  ns) ;

/// @brief Method AddFirst, addr 0x181c30800, size 0xd0, virtual false, abstract: false, final false
inline void AddFirst(::StringW  prefix, ::System::Xml::Linq::XNamespace*  ns) ;

/// @brief Method GetPrefixOfNamespace, addr 0x181c309a0, size 0x100, virtual false, abstract: false, final false
inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace*  ns, bool  allowDefaultNamespace) ;

/// @brief Method PopScope, addr 0x181c30aa0, size 0xa0, virtual false, abstract: false, final false
inline void PopScope() ;

/// @brief Method PushScope, addr 0x181c30b40, size 0x40, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_scope", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_declaration", ty: "::System::Xml::Linq::NamespaceResolver_NamespaceDeclaration*", modifiers: "", def_value: None }, CppParam { name: "_rover", ty: "::System::Xml::Linq::NamespaceResolver_NamespaceDeclaration*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Xml::Linq::NamespaceResolver) == 0x18, "Size mismatch!");
