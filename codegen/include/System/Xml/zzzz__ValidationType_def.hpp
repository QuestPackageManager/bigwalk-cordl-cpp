...
DEFINE_IL2CPP_CLASS(::System::Xml::ValidationType, "System.Xml", "ValidationType");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::ValidationType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::ValidationType) == 0x4, "Size mismatch!");
