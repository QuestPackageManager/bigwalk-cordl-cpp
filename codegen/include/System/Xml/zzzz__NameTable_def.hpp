...
// Write type traits
MARK_REF_T(::System::Xml::NameTable*);
MARK_REF_T(::System::Xml::NameTable_Entry*);
DEFINE_IL2CPP_CLASS(::System::Xml::NameTable*, "System.Xml", "NameTable");
DEFINE_IL2CPP_CLASS(::System::Xml::NameTable_Entry*, "System.Xml", "NameTable/Entry");
...
static_assert(sizeof(::System::Xml::NameTable_Entry) == 0x28, "Size mismatch!");

} // namespace end def System::Xml
// Dependencies System.Xml.NameTable::Entry, System.Xml.XmlNameTable
namespace System::Xml {
// Is value type: false
...
/// @brief Field entries, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_entries, put=__cordl_internal_set_entries)) ::ArrayW<::System::Xml::NameTable_Entry*>  entries;
...
/// @brief Method Add, addr 0x181d1c250, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW Add(::ArrayW<char16_t>  key, int32_t  start, int32_t  len) ;

/// @brief Method Add, addr 0x181d1c140, size 0x110, virtual true, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x181d1bfc0, size 0x180, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x181d1c3f0, size 0x100, virtual true, abstract: false, final false
inline ::StringW Get(::StringW  value) ;

/// @brief Method Grow, addr 0x181d1c4f0, size 0x100, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::System::Xml::NameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x181d1c5f0, size 0x80, virtual false, abstract: false, final false
static inline bool TextEquals(::StringW  str1, ::ArrayW<char16_t>  str2, int32_t  str2Start, int32_t  str2Length) ;

constexpr int32_t const& __cordl_internal_get_count() const;

constexpr int32_t& __cordl_internal_get_count() ;

constexpr ::ArrayW<::System::Xml::NameTable_Entry*> const& __cordl_internal_get_entries() const;

constexpr ::ArrayW<::System::Xml::NameTable_Entry*>& __cordl_internal_get_entries() ;
...
constexpr void __cordl_internal_set_entries(::ArrayW<::System::Xml::NameTable_Entry*>  value) ;
...
/// @brief Method .ctor, addr 0x181d1c670, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field entries, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Xml::NameTable_Entry*>  ___entries;
...
static_assert(sizeof(::System::Xml::NameTable) == 0x28, "Size mismatch!");
