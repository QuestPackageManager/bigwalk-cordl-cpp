...
DEFINE_IL2CPP_CLASS(::System::Xml::XmlStandalone, "System.Xml", "XmlStandalone");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlStandalone, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlStandalone) == 0x4, "Size mismatch!");
