...
MARK_REF_T(::System::Xml::AttributeValueCache_XmlWellFormedWriter_BufferChunk*);
MARK_REF_T(::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*);
MARK_REF_T(::System::Xml::XmlWellFormedWriter*);
MARK_REF_T(::System::Xml::XmlWellFormedWriter_AttributeValueCache*);
MARK_REF_T(::System::Xml::XmlWellFormedWriter_NamespaceResolverProxy*);
...
DEFINE_IL2CPP_CLASS(::System::Xml::AttributeValueCache_XmlWellFormedWriter_ItemType, "System.Xml", "XmlWellFormedWriter/AttributeValueCache/ItemType");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_NamespaceKind, "System.Xml", "XmlWellFormedWriter/NamespaceKind");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_SpecialAttribute, "System.Xml", "XmlWellFormedWriter/SpecialAttribute");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_State, "System.Xml", "XmlWellFormedWriter/State");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_Token, "System.Xml", "XmlWellFormedWriter/Token");
DEFINE_IL2CPP_CLASS(::System::Xml::AttributeValueCache_XmlWellFormedWriter_BufferChunk*, "System.Xml", "XmlWellFormedWriter/AttributeValueCache/BufferChunk");
DEFINE_IL2CPP_CLASS(::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*, "System.Xml", "XmlWellFormedWriter/AttributeValueCache/Item");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter*, "System.Xml", "XmlWellFormedWriter");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_AttributeValueCache*, "System.Xml", "XmlWellFormedWriter/AttributeValueCache");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_NamespaceResolverProxy*, "System.Xml", "XmlWellFormedWriter/NamespaceResolverProxy");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_AttrName, "System.Xml", "XmlWellFormedWriter/AttrName");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_ElementScope, "System.Xml", "XmlWellFormedWriter/ElementScope");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlWellFormedWriter_Namespace, "System.Xml", "XmlWellFormedWriter/Namespace");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::XmlWellFormedWriter_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlWellFormedWriter_State) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlWellFormedWriter_Token, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlWellFormedWriter_Token) == 0x4, "Size mismatch!");
...
/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x1805b4350, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x181cfd220, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x181cfd230, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter_NamespaceResolverProxy) == 0x18, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Set, addr 0x181cfcfb0, size 0x90, virtual false, abstract: false, final false
inline void Set(::StringW  prefix, ::StringW  localName, ::StringW  namespaceUri, int32_t  prevNSTop) ;

/// @brief Method WriteEndElement, addr 0x181cfd040, size 0x40, virtual false, abstract: false, final false
inline void WriteEndElement(::System::Xml::XmlRawWriter*  rawWriter) ;

/// @brief Method WriteFullEndElement, addr 0x181cfd080, size 0x1a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter_ElementScope) == 0x30, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlWellFormedWriter_NamespaceKind, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlWellFormedWriter_NamespaceKind) == 0x4, "Size mismatch!");
...
public:
// Declarations
/// @brief Method Set, addr 0x181cfd250, size 0x60, virtual false, abstract: false, final false
inline void Set(::StringW  prefix, ::StringW  namespaceUri, ::System::Xml::XmlWellFormedWriter_NamespaceKind  kind) ;

/// @brief Method WriteDecl, addr 0x181cfd2b0, size 0x190, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "prefix", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "namespaceUri", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "kind", ty: "::System::Xml::XmlWellFormedWriter_NamespaceKind", modifiers: "", def_value: None }, CppParam { name: "prevNsIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter_Namespace) == 0x18, "Size mismatch!");
...
public:
// Declarations
/// @brief Method IsDuplicate, addr 0x181cfb820, size 0xa0, virtual false, abstract: false, final false
inline bool IsDuplicate(::StringW  prefix, ::StringW  localName, ::StringW  namespaceUri) ;

/// @brief Method Set, addr 0x181cfb8c0, size 0x150, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter_AttrName) == 0x20, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::XmlWellFormedWriter_SpecialAttribute, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::XmlWellFormedWriter_SpecialAttribute) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::AttributeValueCache_XmlWellFormedWriter_ItemType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::AttributeValueCache_XmlWellFormedWriter_ItemType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item) == 0x20, "Size mismatch!");
...
/// @brief Field buffer, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_buffer, put=__cordl_internal_set_buffer)) ::ArrayW<char16_t>  buffer;
...
static inline ::System::Xml::AttributeValueCache_XmlWellFormedWriter_BufferChunk* New_ctor(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

constexpr ::ArrayW<char16_t> const& __cordl_internal_get_buffer() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_buffer() ;
...
constexpr void __cordl_internal_set_buffer(::ArrayW<char16_t>  value) ;
...
static_assert(sizeof(::System::Xml::AttributeValueCache_XmlWellFormedWriter_BufferChunk) == 0x20, "Size mismatch!");

} // namespace end def System::Xml
// Dependencies System.Object, System.Xml.XmlWellFormedWriter::AttributeValueCache::Item
namespace System::Xml {
// Is value type: false
...
/// @brief Field items, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_items, put=__cordl_internal_set_items)) ::ArrayW<::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*>  items;
...
/// @brief Method AddItem, addr 0x181cfbac0, size 0x100, virtual false, abstract: false, final false
inline void AddItem(::System::Xml::AttributeValueCache_XmlWellFormedWriter_ItemType  type, ::System::Object*  data) ;

/// @brief Method Clear, addr 0x181cfbbc0, size 0x40, virtual false, abstract: false, final false
inline void Clear() ;

static inline ::System::Xml::XmlWellFormedWriter_AttributeValueCache* New_ctor() ;

/// @brief Method Replay, addr 0x181cfbc00, size 0x390, virtual false, abstract: false, final false
inline void Replay(::System::Xml::XmlWriter*  writer) ;

/// @brief Method StartComplexValue, addr 0x181cfbf90, size 0x50, virtual false, abstract: false, final false
inline void StartComplexValue() ;

/// @brief Method Trim, addr 0x181cfbfe0, size 0x3b0, virtual false, abstract: false, final false
inline void Trim() ;

/// @brief Method WriteCharEntity, addr 0x181cfc390, size 0xa0, virtual false, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x181cfc430, size 0xd0, virtual false, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteEntityRef, addr 0x181cfc500, size 0x140, virtual false, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteRaw, addr 0x181cfc6c0, size 0xd0, virtual false, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cfc640, size 0x80, virtual false, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteString, addr 0x181cfc790, size 0xa0, virtual false, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181cfc830, size 0xb0, virtual false, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteValue, addr 0x181cfc8e0, size 0x80, virtual false, abstract: false, final false
inline void WriteValue(::StringW  value) ;

/// @brief Method WriteWhitespace, addr 0x181cfc960, size 0x80, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*> const& __cordl_internal_get_items() const;

constexpr ::ArrayW<::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*>& __cordl_internal_get_items() ;
...
constexpr void __cordl_internal_set_items(::ArrayW<::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*>  value) ;
...
/// @brief Method .ctor, addr 0x181cfc9e0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_StringValue, addr 0x181cfca30, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field items, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Xml::AttributeValueCache_XmlWellFormedWriter_Item*>  ___items;
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter_AttributeValueCache) == 0x30, "Size mismatch!");

} // namespace end def System::Xml
// Dependencies System.Xml.ConformanceLevel, System.Xml.WriteState, System.Xml.XmlCharType, System.Xml.XmlWellFormedWriter::AttrName, System.Xml.XmlWellFormedWriter::ElementScope, System.Xml.XmlWellFormedWriter::Namespace, System.Xml.XmlWellFormedWriter::SpecialAttribute, System.Xml.XmlWellFormedWriter::State, System.Xml.XmlWriter
namespace System::Xml {
// Is value type: false
...
/// @brief Field StateTableAuto, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_StateTableAuto, put=setStaticF_StateTableAuto)) ::ArrayW<::System::Xml::XmlWellFormedWriter_State>  StateTableAuto;

/// @brief Field StateTableDocument, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_StateTableDocument, put=setStaticF_StateTableDocument)) ::ArrayW<::System::Xml::XmlWellFormedWriter_State>  StateTableDocument;
...
/// @brief Field attrStack, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_attrStack, put=__cordl_internal_set_attrStack)) ::ArrayW<::System::Xml::XmlWellFormedWriter_AttrName>  attrStack;
...
/// @brief Field elemScopeStack, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_elemScopeStack, put=__cordl_internal_set_elemScopeStack)) ::ArrayW<::System::Xml::XmlWellFormedWriter_ElementScope>  elemScopeStack;
...
/// @brief Field nsStack, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_nsStack, put=__cordl_internal_set_nsStack)) ::ArrayW<::System::Xml::XmlWellFormedWriter_Namespace>  nsStack;
...
/// @brief Field state2WriteState, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_state2WriteState, put=setStaticF_state2WriteState)) ::ArrayW<::System::Xml::WriteState>  state2WriteState;
...
/// @brief Field stateTable, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateTable, put=__cordl_internal_set_stateTable)) ::ArrayW<::System::Xml::XmlWellFormedWriter_State>  stateTable;
...
/// @brief Method AddAttribute, addr 0x181cf70f0, size 0x280, virtual false, abstract: false, final false
inline void AddAttribute(::StringW  prefix, ::StringW  localName, ::StringW  namespaceName) ;

/// @brief Method AddNamespace, addr 0x181cf7370, size 0x1d0, virtual false, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  ns, ::System::Xml::XmlWellFormedWriter_NamespaceKind  kind) ;

/// @brief Method AddToAttrHashTable, addr 0x181cf7540, size 0xd0, virtual false, abstract: false, final false
inline void AddToAttrHashTable(int32_t  attributeIndex) ;

/// @brief Method AddToNamespaceHashtable, addr 0x181cf7610, size 0x80, virtual false, abstract: false, final false
inline void AddToNamespaceHashtable(int32_t  namespaceIndex) ;

/// @brief Method AdvanceState, addr 0x181cf7690, size 0x360, virtual false, abstract: false, final false
inline void AdvanceState(::System::Xml::XmlWellFormedWriter_Token  token) ;

/// @brief Method CheckNCName, addr 0x181cf79f0, size 0xc0, virtual false, abstract: false, final false
inline void CheckNCName(::StringW  ncname) ;

/// @brief Method Close, addr 0x181cf7ab0, size 0x140, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method DupAttrException, addr 0x181cf7bf0, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Xml::XmlException* DupAttrException(::StringW  prefix, ::StringW  localName) ;

/// @brief Method Flush, addr 0x181cf7ca0, size 0x50, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GeneratePrefix, addr 0x181cf7cf0, size 0x150, virtual false, abstract: false, final false
inline ::StringW GeneratePrefix() ;

/// @brief Method GetStateName, addr 0x181cf7e40, size 0x30, virtual false, abstract: false, final false
static inline ::StringW GetStateName(::System::Xml::XmlWellFormedWriter_State  state) ;

/// @brief Method InvalidCharsException, addr 0x181cf7e70, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Exception* InvalidCharsException(::StringW  name, int32_t  badCharIndex) ;

/// @brief Method LookupLocalNamespace, addr 0x181cf7f20, size 0xa0, virtual false, abstract: false, final false
inline ::StringW LookupLocalNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespace, addr 0x181cf8070, size 0xc0, virtual false, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceIndex, addr 0x181cf7fc0, size 0xb0, virtual false, abstract: false, final false
inline int32_t LookupNamespaceIndex(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181cf8130, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method PopNamespaces, addr 0x181cf8240, size 0x90, virtual false, abstract: false, final false
inline void PopNamespaces(int32_t  indexFrom, int32_t  indexTo) ;

/// @brief Method PushNamespaceExplicit, addr 0x181cf82d0, size 0x390, virtual false, abstract: false, final false
inline bool PushNamespaceExplicit(::StringW  prefix, ::StringW  ns) ;

/// @brief Method PushNamespaceImplicit, addr 0x181cf8660, size 0x2d0, virtual false, abstract: false, final false
inline void PushNamespaceImplicit(::StringW  prefix, ::StringW  ns) ;

/// @brief Method SetSpecialAttribute, addr 0x181cf8930, size 0x80, virtual false, abstract: false, final false
inline void SetSpecialAttribute(::System::Xml::XmlWellFormedWriter_SpecialAttribute  special) ;

/// @brief Method StartElementContent, addr 0x181cf89b0, size 0xd0, virtual false, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method StartFragment, addr 0x181cf8a80, size 0x10, virtual false, abstract: false, final false
inline void StartFragment() ;

/// @brief Method ThrowInvalidStateTransition, addr 0x181cf8a90, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method WriteBase64, addr 0x181cf8bb0, size 0xf0, virtual true, abstract: false, final false
inline void WriteBase64(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteBinHex, addr 0x181cf8ca0, size 0xc0, virtual true, abstract: false, final false
inline void WriteBinHex(::ArrayW<uint8_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteCData, addr 0x181cf8d60, size 0x90, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181cf8df0, size 0xc0, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x181cf8eb0, size 0x120, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x181cf8fd0, size 0x90, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteDocType, addr 0x181cf9060, size 0x2d0, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x181cf9330, size 0x550, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndDocument, addr 0x181cf9880, size 0xd0, virtual true, abstract: false, final false
inline void WriteEndDocument() ;

/// @brief Method WriteEndElement, addr 0x181cf9950, size 0x150, virtual true, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteEntityRef, addr 0x181cf9aa0, size 0xd0, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x181cf9b70, size 0x150, virtual true, abstract: false, final false
inline void WriteFullEndElement() ;

/// @brief Method WriteProcessingInstruction, addr 0x181cf9cc0, size 0x1a0, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x181cf9ef0, size 0x120, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cf9e60, size 0x90, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteStartAttribute, addr 0x181cfa010, size 0x4d0, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  namespaceName) ;

/// @brief Method WriteStartDocument, addr 0x181cfa600, size 0x10, virtual true, abstract: false, final false
inline void WriteStartDocument() ;

/// @brief Method WriteStartDocument, addr 0x181cfa5e0, size 0x20, virtual true, abstract: false, final false
inline void WriteStartDocument(bool  standalone) ;

/// @brief Method WriteStartDocumentImpl, addr 0x181cfa4e0, size 0x100, virtual false, abstract: false, final false
inline void WriteStartDocumentImpl(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteStartElement, addr 0x181cfa610, size 0x290, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteString, addr 0x181cfa8a0, size 0x90, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181cfa930, size 0xd0, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteValue, addr 0x181cfabf0, size 0xa0, virtual true, abstract: false, final false
inline void WriteValue(::StringW  value) ;

/// @brief Method WriteValue, addr 0x181cfae70, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(::System::DateTime  value) ;

/// @brief Method WriteValue, addr 0x181cfad10, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(::System::Decimal  value) ;

/// @brief Method WriteValue, addr 0x181cfad90, size 0xe0, virtual true, abstract: false, final false
inline void WriteValue(::System::Object*  value) ;

/// @brief Method WriteValue, addr 0x181cfaaf0, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(bool  value) ;

/// @brief Method WriteValue, addr 0x181cfac90, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(double_t  value) ;

/// @brief Method WriteValue, addr 0x181cfaa00, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(float_t  value) ;

/// @brief Method WriteValue, addr 0x181cfaa80, size 0x70, virtual true, abstract: false, final false
inline void WriteValue(int32_t  value) ;

/// @brief Method WriteValue, addr 0x181cfab70, size 0x80, virtual true, abstract: false, final false
inline void WriteValue(int64_t  value) ;

/// @brief Method WriteWhitespace, addr 0x181cfaef0, size 0xf0, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;
...
constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_AttrName> const& __cordl_internal_get_attrStack() const;

constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_AttrName>& __cordl_internal_get_attrStack() ;
...
constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_ElementScope> const& __cordl_internal_get_elemScopeStack() const;

constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_ElementScope>& __cordl_internal_get_elemScopeStack() ;
...
constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_Namespace> const& __cordl_internal_get_nsStack() const;

constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_Namespace>& __cordl_internal_get_nsStack() ;
...
constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_State> const& __cordl_internal_get_stateTable() const;

constexpr ::ArrayW<::System::Xml::XmlWellFormedWriter_State>& __cordl_internal_get_stateTable() ;
...
constexpr void __cordl_internal_set_attrStack(::ArrayW<::System::Xml::XmlWellFormedWriter_AttrName>  value) ;
...
constexpr void __cordl_internal_set_elemScopeStack(::ArrayW<::System::Xml::XmlWellFormedWriter_ElementScope>  value) ;
...
constexpr void __cordl_internal_set_nsStack(::ArrayW<::System::Xml::XmlWellFormedWriter_Namespace>  value) ;
...
constexpr void __cordl_internal_set_stateTable(::ArrayW<::System::Xml::XmlWellFormedWriter_State>  value) ;
...
/// @brief Method .ctor, addr 0x181cfb420, size 0x390, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Xml::XmlWellFormedWriter_State> getStaticF_StateTableDocument() ;

static inline ::ArrayW<::System::Xml::WriteState> getStaticF_state2WriteState() ;

static inline ::ArrayW<::StringW> getStaticF_stateName() ;

static inline ::ArrayW<::StringW> getStaticF_tokenName() ;

/// @brief Method get_InBase64, addr 0x181cfb7b0, size 0x20, virtual false, abstract: false, final false
inline bool get_InBase64() ;

/// @brief Method get_IsClosedOrErrorState, addr 0x181cfb7d0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsClosedOrErrorState() ;

/// @brief Method get_RawWriter, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlRawWriter* get_RawWriter() ;

/// @brief Method get_SaveAttrValue, addr 0x181c5df90, size 0x10, virtual false, abstract: false, final false
inline bool get_SaveAttrValue() ;

/// @brief Method get_WriteState, addr 0x181cfb7e0, size 0x30, virtual true, abstract: false, final false
...
static inline void setStaticF_StateTableDocument(::ArrayW<::System::Xml::XmlWellFormedWriter_State>  value) ;

static inline void setStaticF_state2WriteState(::ArrayW<::System::Xml::WriteState>  value) ;
...
/// @brief Field nsStack, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlWellFormedWriter_Namespace>  ___nsStack;
...
/// @brief Field elemScopeStack, offset: 0x50, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlWellFormedWriter_ElementScope>  ___elemScopeStack;

/// @brief Field elemTop, offset: 0x58, size: 0x4, def value: None
 int32_t  ___elemTop;

/// @brief Field attrStack, offset: 0x60, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlWellFormedWriter_AttrName>  ___attrStack;
...
/// @brief Field stateTable, offset: 0x90, size: 0x8, def value: None
 ::ArrayW<::System::Xml::XmlWellFormedWriter_State>  ___stateTable;
...
static_assert(sizeof(::System::Xml::XmlWellFormedWriter) == 0xb8, "Size mismatch!");
