...
// Write type traits
MARK_REF_T(::System::Xml::AsyncHelper*);
DEFINE_IL2CPP_CLASS(::System::Xml::AsyncHelper*, "System.Xml", "AsyncHelper");
...
static_assert(sizeof(::System::Xml::AsyncHelper) == 0x10, "Size mismatch!");
