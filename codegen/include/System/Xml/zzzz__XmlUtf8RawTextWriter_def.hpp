...
// Write type traits
MARK_REF_T(::System::Xml::XmlUtf8RawTextWriter*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlUtf8RawTextWriter*, "System.Xml", "XmlUtf8RawTextWriter");
...
/// @brief Method AmpEntity, addr 0x181cf3210, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* AmpEntity(uint8_t*  pDst) ;

/// @brief Method CarriageReturnEntity, addr 0x181cf3220, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* CarriageReturnEntity(uint8_t*  pDst) ;

/// @brief Method CharEntity, addr 0x181cf3230, size 0x90, virtual false, abstract: false, final false
static inline uint8_t* CharEntity(uint8_t*  pDst, char16_t  ch) ;

/// @brief Method CharToUTF8, addr 0x181cf32c0, size 0xb0, virtual false, abstract: false, final false
static inline void CharToUTF8(::by_ref<char16_t*>  pSrc, char16_t*  pSrcEnd, ::by_ref<uint8_t*>  pDst) ;

/// @brief Method Close, addr 0x181cf3370, size 0x60, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EncodeChar, addr 0x181cf33d0, size 0xe0, virtual false, abstract: false, final false
inline void EncodeChar(::by_ref<char16_t*>  pSrc, char16_t*  pSrcEnd, ::by_ref<uint8_t*>  pDst) ;

/// @brief Method EncodeMultibyteUTF8, addr 0x181cf34b0, size 0x50, virtual false, abstract: false, final false
static inline uint8_t* EncodeMultibyteUTF8(int32_t  ch, uint8_t*  pDst) ;

/// @brief Method EncodeSurrogate, addr 0x181cf3500, size 0xf0, virtual false, abstract: false, final false
static inline uint8_t* EncodeSurrogate(char16_t*  pSrc, char16_t*  pSrcEnd, uint8_t*  pDst) ;

/// @brief Method Flush, addr 0x181cf3760, size 0x50, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushBuffer, addr 0x181cf35f0, size 0x170, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method FlushEncoder, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void FlushEncoder() ;

/// @brief Method GtEntity, addr 0x181cf37b0, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* GtEntity(uint8_t*  pDst) ;

/// @brief Method InvalidXmlChar, addr 0x181cf37c0, size 0x120, virtual false, abstract: false, final false
inline uint8_t* InvalidXmlChar(int32_t  ch, uint8_t*  pDst, bool  entitize) ;

/// @brief Method IsSurrogateByte, addr 0x181cf38e0, size 0x10, virtual false, abstract: false, final false
static inline bool IsSurrogateByte(uint8_t  b) ;

/// @brief Method LineFeedEntity, addr 0x181cf38f0, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* LineFeedEntity(uint8_t*  pDst) ;

/// @brief Method LtEntity, addr 0x181cf3900, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method QuoteEntity, addr 0x181cf3910, size 0x20, virtual false, abstract: false, final false
static inline uint8_t* QuoteEntity(uint8_t*  pDst) ;

/// @brief Method RawEndCData, addr 0x181cf3930, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* RawEndCData(uint8_t*  pDst) ;

/// @brief Method RawStartCData, addr 0x181cf3940, size 0x20, virtual false, abstract: false, final false
static inline uint8_t* RawStartCData(uint8_t*  pDst) ;

/// @brief Method RawText, addr 0x181cf39a0, size 0x200, virtual false, abstract: false, final false
inline void RawText(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method RawText, addr 0x181cf3960, size 0x40, virtual false, abstract: false, final false
inline void RawText(::StringW  s) ;

/// @brief Method StartElementContent, addr 0x181cf3ba0, size 0x20, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method TabEntity, addr 0x181cf3bc0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method WriteAttributeTextBlock, addr 0x181cf3bd0, size 0x320, virtual false, abstract: false, final false
inline void WriteAttributeTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteCData, addr 0x181cf4290, size 0x130, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCDataSection, addr 0x181cf3ef0, size 0x3a0, virtual false, abstract: false, final false
inline void WriteCDataSection(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x181cf43c0, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method WriteComment, addr 0x181cf48b0, size 0xb0, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteCommentOrPi, addr 0x181cf44f0, size 0x3c0, virtual false, abstract: false, final false
inline void WriteCommentOrPi(::StringW  text, int32_t  stopChar) ;

/// @brief Method WriteDocType, addr 0x181cf4960, size 0x210, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteElementTextBlock, addr 0x181cf4b70, size 0x340, virtual false, abstract: false, final false
inline void WriteElementTextBlock(char16_t*  pSrc, char16_t*  pSrcEnd) ;

/// @brief Method WriteEndAttribute, addr 0x181cf4eb0, size 0x20, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x181cf4ed0, size 0xf0, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteEndNamespaceDeclaration, addr 0x181cf4fc0, size 0x20, virtual true, abstract: false, final false
inline void WriteEndNamespaceDeclaration() ;

/// @brief Method WriteEntityRef, addr 0x181cf4fe0, size 0x90, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x181cf5070, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method WriteNewLine, addr 0x181cf5140, size 0x80, virtual false, abstract: false, final false
inline uint8_t* WriteNewLine(uint8_t*  pDst) ;

/// @brief Method WriteProcessingInstruction, addr 0x181cf51c0, size 0xd0, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x181cf5570, size 0x30, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x181cf55a0, size 0x50, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteRawWithCharChecking, addr 0x181cf5290, size 0x2e0, virtual false, abstract: false, final false
inline void WriteRawWithCharChecking(char16_t*  pSrcBegin, char16_t*  pSrcEnd) ;

/// @brief Method WriteStartAttribute, addr 0x181cf55f0, size 0xe0, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x181cf56d0, size 0xb0, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartNamespaceDeclaration, addr 0x181cf5780, size 0xe0, virtual true, abstract: false, final false
inline void WriteStartNamespaceDeclaration(::StringW  prefix) ;

/// @brief Method WriteString, addr 0x181cf5860, size 0x60, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x181cf58c0, size 0xd0, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x181cf5860, size 0x60, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteXmlDeclaration, addr 0x181cf5990, size 0x1b0, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x181cf5b40, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cf5d50, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x181cf5b70, size 0x1e0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlUtf8RawTextWriter) == 0x90, "Size mismatch!");
