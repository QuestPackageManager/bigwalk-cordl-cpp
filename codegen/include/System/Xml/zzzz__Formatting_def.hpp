...
DEFINE_IL2CPP_CLASS(::System::Xml::Formatting, "System.Xml", "Formatting");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Formatting, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Formatting) == 0x4, "Size mismatch!");
