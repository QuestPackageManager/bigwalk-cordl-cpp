...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaMaxLengthFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaMaxLengthFacet*, "System.Xml.Schema", "XmlSchemaMaxLengthFacet");
...
/// @brief Method .ctor, addr 0x181c9c1e0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaMaxLengthFacet) == 0x60, "Size mismatch!");
