...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_doubleXdr*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_doubleXdr*, "System.Xml.Schema", "Datatype_doubleXdr");
...
/// @brief Method ParseValue, addr 0x181d6c660, size 0x150, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_doubleXdr) == 0x38, "Size mismatch!");
