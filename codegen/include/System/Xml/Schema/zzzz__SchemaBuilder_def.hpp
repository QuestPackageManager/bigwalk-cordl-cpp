...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SchemaBuilder*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaBuilder*, "System.Xml.Schema", "SchemaBuilder");
...
static_assert(sizeof(::System::Xml::Schema::SchemaBuilder) == 0x10, "Size mismatch!");
