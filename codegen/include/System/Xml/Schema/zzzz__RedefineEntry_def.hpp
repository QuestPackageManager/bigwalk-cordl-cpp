...
// Write type traits
MARK_REF_T(::System::Xml::Schema::RedefineEntry*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::RedefineEntry*, "System.Xml.Schema", "RedefineEntry");
...
static_assert(sizeof(::System::Xml::Schema::RedefineEntry) == 0x20, "Size mismatch!");
