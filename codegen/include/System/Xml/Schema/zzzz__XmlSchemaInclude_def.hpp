...
/// @brief Method AddAnnotation, addr 0x1802e5a20, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c9beb0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
