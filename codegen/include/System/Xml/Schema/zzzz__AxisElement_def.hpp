...
// Write type traits
MARK_REF_T(::System::Xml::Schema::AxisElement*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::AxisElement*, "System.Xml.Schema", "AxisElement");
...
/// @brief Method MoveToChild, addr 0x181d4ffa0, size 0x130, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth, ::System::Xml::Schema::ForwardAxis*  parent) ;

/// @brief Method MoveToParent, addr 0x181d500d0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method SetDepth, addr 0x181d501c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d501d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::DoubleLinkAxis*  node, int32_t  depth) ;

/// @brief Method get_CurNode, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::AxisElement) == 0x28, "Size mismatch!");
