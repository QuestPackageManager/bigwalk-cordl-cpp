...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_normalizedStringV1Compat*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_normalizedStringV1Compat*, "System.Xml.Schema", "Datatype_normalizedStringV1Compat");
...
static_assert(sizeof(::System::Xml::Schema::Datatype_normalizedStringV1Compat) == 0x38, "Size mismatch!");
