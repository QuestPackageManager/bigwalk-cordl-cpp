...
// Write type traits
MARK_REF_T(::System::Xml::Schema::LeafNode*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::LeafNode*, "System.Xml.Schema", "LeafNode");
...
/// @brief Method ConstructPos, addr 0x181d56b10, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method ExpandTree, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_IsNullable, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_Pos, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Pos() ;

/// @brief Method set_Pos, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::LeafNode) == 0x18, "Size mismatch!");
