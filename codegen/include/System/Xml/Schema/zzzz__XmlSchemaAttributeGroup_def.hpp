...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaAttributeGroup*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaAttributeGroup*, "System.Xml.Schema", "XmlSchemaAttributeGroup");
...
/// @brief Method Clone, addr 0x181c97260, size 0xc0, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* Clone() ;

static inline ::System::Xml::Schema::XmlSchemaAttributeGroup* New_ctor() ;

/// @brief Method SetQualifiedName, addr 0x1802e5a20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c97320, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AnyAttribute, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute() ;

/// @brief Method get_AttributeUses, addr 0x181c973a0, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeUses() ;

/// @brief Method get_AttributeWildcard, addr 0x1802ec4c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AttributeWildcard() ;

/// @brief Method get_Attributes, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_QualifiedName, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_QualifiedName() ;

/// @brief Method get_Redefined, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttributeGroup* get_Redefined() ;

/// @brief Method get_RedefinedAttributeGroup, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttributeGroup* get_RedefinedAttributeGroup() ;

/// @brief Method get_SelfReferenceCount, addr 0x180310fd0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_SelfReferenceCount() ;

/// @brief Method set_AnyAttribute, addr 0x1803d49a0, size 0x10, virtual false, abstract: false, final false
inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute*  value) ;

/// @brief Method set_AttributeWildcard, addr 0x1803117a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Redefined, addr 0x1803d5ad0, size 0x10, virtual false, abstract: false, final false
inline void set_Redefined(::System::Xml::Schema::XmlSchemaAttributeGroup*  value) ;

/// @brief Method set_SelfReferenceCount, addr 0x1803f4230, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaAttributeGroup) == 0x90, "Size mismatch!");
