...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaForm, "System.Xml.Schema", "XmlSchemaForm");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaForm, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaForm) == 0x4, "Size mismatch!");
