...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaDocumentation*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaDocumentation*, "System.Xml.Schema", "XmlSchemaDocumentation");
...
/// @brief Method set_Language, addr 0x181c9a9f0, size 0xd0, virtual false, abstract: false, final false
inline void set_Language(::StringW  value) ;

/// @brief Method set_Markup, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_Markup(::ArrayW<::System::Xml::XmlNode*>  value) ;

/// @brief Method set_Source, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaDocumentation) == 0x50, "Size mismatch!");
