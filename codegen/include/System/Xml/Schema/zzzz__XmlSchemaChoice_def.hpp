...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaChoice*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaChoice*, "System.Xml.Schema", "XmlSchemaChoice");
...
/// @brief Method get_IsEmpty, addr 0x181c97650, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaChoice) == 0x80, "Size mismatch!");
