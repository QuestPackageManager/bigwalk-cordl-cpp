...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdDateTime_DateTimeTypeCode, "System.Xml.Schema", "XsdDateTime/DateTimeTypeCode");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdDateTime_XsdDateTimeKind, "System.Xml.Schema", "XsdDateTime/XsdDateTimeKind");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdDateTime, "System.Xml.Schema", "XsdDateTime");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XsdDateTime_Parser, "System.Xml.Schema", "XsdDateTime/Parser");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XsdDateTime_DateTimeTypeCode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XsdDateTime_DateTimeTypeCode) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Xml::Schema::XsdDateTime_XsdDateTimeKind, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XsdDateTime_XsdDateTimeKind) == 0x4, "Size mismatch!");
...
/// @brief Method Parse, addr 0x181ccd680, size 0xa10, virtual false, abstract: false, final false
inline bool Parse(::StringW  text, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method Parse2Dig, addr 0x181cccec0, size 0x90, virtual false, abstract: false, final false
inline bool Parse2Dig(int32_t  start, ::by_ref<int32_t>  num) ;

/// @brief Method Parse4Dig, addr 0x181cccf50, size 0xe0, virtual false, abstract: false, final false
inline bool Parse4Dig(int32_t  start, ::by_ref<int32_t>  num) ;

/// @brief Method ParseChar, addr 0x181ccd030, size 0x40, virtual false, abstract: false, final false
inline bool ParseChar(int32_t  start, char16_t  ch) ;

/// @brief Method ParseDate, addr 0x181ccd070, size 0x180, virtual false, abstract: false, final false
inline bool ParseDate(int32_t  start) ;

/// @brief Method ParseTime, addr 0x181ccd290, size 0x280, virtual false, abstract: false, final false
inline bool ParseTime(::by_ref<int32_t>  start) ;

/// @brief Method ParseTimeAndWhitespace, addr 0x181ccd1f0, size 0x50, virtual false, abstract: false, final false
inline bool ParseTimeAndWhitespace(int32_t  start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x181ccd240, size 0x50, virtual false, abstract: false, final false
inline bool ParseTimeAndZoneAndWhitespace(int32_t  start) ;

/// @brief Method ParseZoneAndWhitespace, addr 0x181ccd510, size 0x170, virtual false, abstract: false, final false
inline bool ParseZoneAndWhitespace(int32_t  start) ;

/// @brief Method Test, addr 0x181cce090, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "typeCode", ty: "::System::Xml::Schema::XsdDateTime_DateTimeTypeCode", modifiers: "", def_value: None }, CppParam { name: "year", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "month", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "day", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "hour", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minute", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "second", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fraction", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kind", ty: "::System::Xml::Schema::XsdDateTime_XsdDateTimeKind", modifiers: "", def_value: None }, CppParam { name: "zoneHour", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "zoneMinute", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "text", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: None }]
constexpr XsdDateTime_Parser(::System::Xml::Schema::XsdDateTime_DateTimeTypeCode  typeCode, int32_t  year, int32_t  month, int32_t  day, int32_t  hour, int32_t  minute, int32_t  second, int32_t  fraction, ::System::Xml::Schema::XsdDateTime_XsdDateTimeKind  kind, int32_t  zoneHour, int32_t  zoneMinute, ::StringW  text, int32_t  length) noexcept;
...
static_assert(sizeof(::System::Xml::Schema::XsdDateTime_Parser) == 0x40, "Size mismatch!");
...
/// @brief Method InitiateXsdDateTime, addr 0x181cd2e40, size 0xd0, virtual false, abstract: false, final false
inline void InitiateXsdDateTime(::System::Xml::Schema::XsdDateTime_Parser  parser) ;

/// @brief Method IntToCharArray, addr 0x181cd2f10, size 0x90, virtual false, abstract: false, final false
inline void IntToCharArray(::ArrayW<char16_t>  text, int32_t  start, int32_t  value, int32_t  digits) ;

/// @brief Method PrintDate, addr 0x181cd2fa0, size 0x200, virtual false, abstract: false, final false
inline void PrintDate(::System::Text::StringBuilder*  sb) ;

/// @brief Method PrintTime, addr 0x181cd31a0, size 0x300, virtual false, abstract: false, final false
inline void PrintTime(::System::Text::StringBuilder*  sb) ;

/// @brief Method PrintZone, addr 0x181cd34a0, size 0x270, virtual false, abstract: false, final false
inline void PrintZone(::System::Text::StringBuilder*  sb) ;

/// @brief Method ShortToCharArray, addr 0x181cd3710, size 0x70, virtual false, abstract: false, final false
inline void ShortToCharArray(::ArrayW<char16_t>  text, int32_t  start, int32_t  value) ;

/// @brief Method ToString, addr 0x181cd3780, size 0x480, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryParse, addr 0x181cd3c00, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181cd4430, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::DateTime  dateTime, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method .ctor, addr 0x181cd4510, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::DateTimeOffset  dateTimeOffset) ;

/// @brief Method .ctor, addr 0x181cd4020, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::DateTimeOffset  dateTimeOffset, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method .ctor, addr 0x181cd4320, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XsdDateTime_Parser  parser) ;

/// @brief Method .ctor, addr 0x181cd4120, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method get_Day, addr 0x181cd4560, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Day() ;

/// @brief Method get_Fraction, addr 0x181cd4580, size 0xf0, virtual false, abstract: false, final false
inline int32_t get_Fraction() ;

/// @brief Method get_Hour, addr 0x181cd4670, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Hour() ;

/// @brief Method get_InternalKind, addr 0x181699680, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XsdDateTime_XsdDateTimeKind get_InternalKind() ;

/// @brief Method get_InternalTypeCode, addr 0x181cd4690, size 0x20, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XsdDateTime_DateTimeTypeCode get_InternalTypeCode() ;

/// @brief Method get_Minute, addr 0x181cd46b0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Minute() ;

/// @brief Method get_Month, addr 0x181cd46d0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Month() ;

/// @brief Method get_Second, addr 0x181cd46f0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Second() ;

/// @brief Method get_Year, addr 0x181cd4710, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Year() ;

/// @brief Method get_ZoneHour, addr 0x1803bd9f0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ZoneHour() ;

/// @brief Method get_ZoneMinute, addr 0x1803bd9e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ZoneMinute() ;

/// @brief Method op_Implicit, addr 0x181cd4730, size 0x3a0, virtual false, abstract: false, final false
static inline ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime  xdt) ;

/// @brief Method op_Implicit, addr 0x181cd4ad0, size 0x210, virtual false, abstract: false, final false
