...
// Write type traits
MARK_REF_T(::System::Xml::Schema::LocatedActiveAxis*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::LocatedActiveAxis*, "System.Xml.Schema", "LocatedActiveAxis");
...
/// @brief Method Reactivate, addr 0x181d57680, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d576a0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::Asttree*  astfield, ::System::Xml::Schema::KeySequence*  ks, int32_t  column) ;

/// @brief Method get_Column, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::LocatedActiveAxis) == 0x38, "Size mismatch!");
