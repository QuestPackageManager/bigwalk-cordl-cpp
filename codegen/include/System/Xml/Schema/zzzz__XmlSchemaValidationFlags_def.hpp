...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaValidationFlags, "System.Xml.Schema", "XmlSchemaValidationFlags");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::XmlSchemaValidationFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::XmlSchemaValidationFlags) == 0x4, "Size mismatch!");
