...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SchemaNamespaceManager*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaNamespaceManager*, "System.Xml.Schema", "SchemaNamespaceManager");
...
/// @brief Method LookupNamespace, addr 0x181c8a6d0, size 0x120, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x181c8a7f0, size 0x200, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SchemaNamespaceManager) == 0x58, "Size mismatch!");
