...
/// @brief Method Clone, addr 0x181ca8f80, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ca9040, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
