...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_ENTITY*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_ENTITY*, "System.Xml.Schema", "Datatype_ENTITY");
...
/// @brief Method get_TokenizedType, addr 0x180309580, size 0x10, virtual true, abstract: false, final false
inline ::System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method get_TypeCode, addr 0x181d69540, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_ENTITY) == 0x38, "Size mismatch!");
