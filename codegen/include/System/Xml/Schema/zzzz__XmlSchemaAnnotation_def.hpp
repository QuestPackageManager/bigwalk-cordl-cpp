...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaAnnotation*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaAnnotation*, "System.Xml.Schema", "XmlSchemaAnnotation");
...
/// @brief Method .ctor, addr 0x181c96a50, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Items, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaAnnotation) == 0x50, "Size mismatch!");
