...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Compositor, "System.Xml.Schema", "Compositor");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
static_assert(offsetof(::System::Xml::Schema::Compositor, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::Compositor) == 0x4, "Size mismatch!");
