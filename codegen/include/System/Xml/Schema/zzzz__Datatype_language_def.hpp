...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_language*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_language*, "System.Xml.Schema", "Datatype_language");
...
/// @brief Method get_TypeCode, addr 0x1818c4dd0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_language) == 0x38, "Size mismatch!");
