...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ListFacetsChecker*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ListFacetsChecker*, "System.Xml.Schema", "ListFacetsChecker");
...
public:
// Declarations
/// @brief Method CheckValueFacets, addr 0x181c49dd0, size 0x200, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ListFacetsChecker) == 0x10, "Size mismatch!");
