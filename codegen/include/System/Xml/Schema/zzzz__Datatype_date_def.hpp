...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_date*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_date*, "System.Xml.Schema", "Datatype_date");
...
/// @brief Method .ctor, addr 0x181d6c0d0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TypeCode, addr 0x1809019f0, size 0xd0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_date) == 0x40, "Size mismatch!");
