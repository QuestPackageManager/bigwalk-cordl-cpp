...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaContentModel*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaContentModel*, "System.Xml.Schema", "XmlSchemaContentModel");
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaContentModel) == 0x50, "Size mismatch!");
