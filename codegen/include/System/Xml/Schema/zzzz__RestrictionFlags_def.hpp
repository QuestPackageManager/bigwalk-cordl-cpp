...
static_assert(offsetof(::System::Xml::Schema::RestrictionFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::Schema::RestrictionFlags) == 0x4, "Size mismatch!");
