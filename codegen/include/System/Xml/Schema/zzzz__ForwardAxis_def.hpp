...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ForwardAxis*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ForwardAxis*, "System.Xml.Schema", "ForwardAxis");
...
/// @brief Method .ctor, addr 0x181d56210, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::DoubleLinkAxis*  axis, bool  isdesorself) ;

/// @brief Method get_IsAttribute, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_IsAttribute() ;

/// @brief Method get_IsDss, addr 0x1803a7440, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDss() ;

/// @brief Method get_IsSelfAxis, addr 0x1803a7450, size 0x10, virtual false, abstract: false, final false
inline bool get_IsSelfAxis() ;

/// @brief Method get_RootNode, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::DoubleLinkAxis* get_RootNode() ;

/// @brief Method get_TopNode, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ForwardAxis) == 0x28, "Size mismatch!");
