...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaWhiteSpaceFacet*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaWhiteSpaceFacet*, "System.Xml.Schema", "XmlSchemaWhiteSpaceFacet");
...
/// @brief Method .ctor, addr 0x181c9c650, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaWhiteSpaceFacet) == 0x60, "Size mismatch!");
