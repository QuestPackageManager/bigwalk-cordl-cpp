...
/// @brief Method AddName, addr 0x181d5ac30, size 0x100, virtual false, abstract: false, final false
inline int32_t AddName(::System::Xml::XmlQualifiedName*  name, ::System::Object*  particle) ;

/// @brief Method AddNamespaceList, addr 0x181d5ad30, size 0x210, virtual false, abstract: false, final false
inline void AddNamespaceList(::System::Xml::Schema::NamespaceList*  list, ::System::Object*  particle, bool  allowLocal) ;

/// @brief Method AddWildcard, addr 0x181d5af40, size 0x130, virtual false, abstract: false, final false
inline void AddWildcard(::StringW  wildcard, ::System::Object*  particle) ;

/// @brief Method Exists, addr 0x181d5b070, size 0x30, virtual false, abstract: false, final false
inline bool Exists(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method GetNamespaceListSymbols, addr 0x181d5b0a0, size 0x560, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* GetNamespaceListSymbols(::System::Xml::Schema::NamespaceList*  list) ;

/// @brief Method GetParticle, addr 0x181d5b600, size 0x30, virtual false, abstract: false, final false
inline ::System::Object* GetParticle(int32_t  symbol) ;

/// @brief Method NameOf, addr 0x181d5b630, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d5b9c0, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Count, addr 0x181d5ba30, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsUpaEnforced, addr 0x1803023c0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsUpaEnforced() ;

/// @brief Method get_Item, addr 0x181d5ba40, size 0xc0, virtual false, abstract: false, final false
inline int32_t get_Item(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method set_IsUpaEnforced, addr 0x180323260, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SymbolsDictionary) == 0x40, "Size mismatch!");
