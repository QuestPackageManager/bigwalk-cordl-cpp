...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaSimpleContentExtension*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaSimpleContentExtension*, "System.Xml.Schema", "XmlSchemaSimpleContentExtension");
...
/// @brief Method SetAttributes, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ca8d30, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AnyAttribute, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute() ;

/// @brief Method get_Attributes, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Attributes() ;

/// @brief Method get_BaseTypeName, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_BaseTypeName() ;

/// @brief Method set_AnyAttribute, addr 0x1802f8080, size 0x10, virtual false, abstract: false, final false
inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute*  value) ;

/// @brief Method set_BaseTypeName, addr 0x181ca8db0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaSimpleContentExtension) == 0x68, "Size mismatch!");
