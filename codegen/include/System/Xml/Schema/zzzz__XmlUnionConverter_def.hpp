...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlUnionConverter*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlUnionConverter*, "System.Xml.Schema", "XmlUnionConverter");
// Dependencies System.Xml.Schema.XmlBaseConverter, System.Xml.Schema.XmlValueConverter
namespace System::Xml::Schema {
// Is value type: false
...
/// @brief Field converters, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_converters, put=__cordl_internal_set_converters)) ::ArrayW<::System::Xml::Schema::XmlValueConverter*>  converters;
...
/// @brief Method ChangeType, addr 0x181cbd880, size 0x2d0, virtual true, abstract: false, final false
inline ::System::Object* ChangeType(::System::Object*  value, ::System::Type*  destinationType, ::System::Xml::IXmlNamespaceResolver*  nsResolver) ;

/// @brief Method Create, addr 0x181cbdb50, size 0x40, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::Schema::XmlValueConverter*> const& __cordl_internal_get_converters() const;

constexpr ::ArrayW<::System::Xml::Schema::XmlValueConverter*>& __cordl_internal_get_converters() ;
...
constexpr void __cordl_internal_set_converters(::ArrayW<::System::Xml::Schema::XmlValueConverter*>  value) ;
...
/// @brief Method .ctor, addr 0x181cbdb90, size 0x1a0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::XmlUnionConverter) == 0x38, "Size mismatch!");
