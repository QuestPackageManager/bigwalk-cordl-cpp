...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SchemaEntity*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaEntity*, "System.Xml.Schema", "SchemaEntity");
...
/// @brief Method IsPredefinedEntity, addr 0x181c85860, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IDtdEntityInfo.get_BaseUriString, addr 0x181c858e0, size 0x20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdEntityInfo_get_BaseUriString() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_DeclaredUriString, addr 0x181c85900, size 0x20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdEntityInfo_get_DeclaredUriString() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsDeclaredInExternal, addr 0x1816d8020, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdEntityInfo_get_IsDeclaredInExternal() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsExternal, addr 0x180391c80, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdEntityInfo_get_IsExternal() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsParameterEntity, addr 0x180391c90, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdEntityInfo_get_IsParameterEntity() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsUnparsedEntity, addr 0x181c85920, size 0x20, virtual true, abstract: false, final true
inline bool System_Xml_IDtdEntityInfo_get_IsUnparsedEntity() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_LineNumber, addr 0x180392fe0, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IDtdEntityInfo_get_LineNumber() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_LinePosition, addr 0x1803231b0, size 0x10, virtual true, abstract: false, final true
inline int32_t System_Xml_IDtdEntityInfo_get_LinePosition() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_Name, addr 0x181050e30, size 0x25b20, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdEntityInfo_get_Name() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_PublicId, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdEntityInfo_get_PublicId() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_SystemId, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdEntityInfo_get_SystemId() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_Text, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181c85940, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlQualifiedName*  qname, bool  isParameter) ;

/// @brief Method get_BaseURI, addr 0x181c859c0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_DeclaredInExternal, addr 0x1816d8020, size 0x10, virtual false, abstract: false, final false
inline bool get_DeclaredInExternal() ;

/// @brief Method get_DeclaredURI, addr 0x181c859e0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_DeclaredURI() ;

/// @brief Method get_IsExternal, addr 0x180391c80, size 0x10, virtual false, abstract: false, final false
inline bool get_IsExternal() ;

/// @brief Method get_Line, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Line() ;

/// @brief Method get_NData, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ParsingInProgress, addr 0x1818e79f0, size 0x10, virtual false, abstract: false, final false
inline bool get_ParsingInProgress() ;

/// @brief Method get_Pos, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Pos() ;

/// @brief Method get_Pubid, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Pubid() ;

/// @brief Method get_Text, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method get_Url, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_BaseURI, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void set_BaseURI(::StringW  value) ;

/// @brief Method set_DeclaredInExternal, addr 0x181c85a00, size 0x10, virtual false, abstract: false, final false
inline void set_DeclaredInExternal(bool  value) ;

/// @brief Method set_DeclaredURI, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
inline void set_DeclaredURI(::StringW  value) ;

/// @brief Method set_IsExternal, addr 0x180391ca0, size 0x10, virtual false, abstract: false, final false
inline void set_IsExternal(bool  value) ;

/// @brief Method set_Line, addr 0x180393000, size 0x10, virtual false, abstract: false, final false
inline void set_Line(int32_t  value) ;

/// @brief Method set_NData, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_NData(::System::Xml::XmlQualifiedName*  value) ;

/// @brief Method set_ParsingInProgress, addr 0x181c85a10, size 0x10, virtual false, abstract: false, final false
inline void set_ParsingInProgress(bool  value) ;

/// @brief Method set_Pos, addr 0x180323270, size 0x10, virtual false, abstract: false, final false
inline void set_Pos(int32_t  value) ;

/// @brief Method set_Pubid, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_Pubid(::StringW  value) ;

/// @brief Method set_Text, addr 0x181c85a20, size 0x20, virtual false, abstract: false, final false
inline void set_Text(::StringW  value) ;

/// @brief Method set_Url, addr 0x181c85a40, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SchemaEntity) == 0x58, "Size mismatch!");
