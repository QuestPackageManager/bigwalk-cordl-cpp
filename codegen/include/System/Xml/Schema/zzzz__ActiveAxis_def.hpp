...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ActiveAxis*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ActiveAxis*, "System.Xml.Schema", "ActiveAxis");
...
/// @brief Method EndElement, addr 0x181d4ec90, size 0x130, virtual true, abstract: false, final false
inline bool EndElement(::StringW  localname, ::StringW  URN) ;

/// @brief Method MoveToAttribute, addr 0x181d4edc0, size 0x130, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  localname, ::StringW  URN) ;

/// @brief Method MoveToStartElement, addr 0x181d4eef0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method Reactivate, addr 0x181d4f040, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d4f050, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::Asttree*  axisTree) ;

/// @brief Method get_CurrentDepth, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ActiveAxis) == 0x28, "Size mismatch!");
