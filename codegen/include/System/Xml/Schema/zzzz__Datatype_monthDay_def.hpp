...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_monthDay*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_monthDay*, "System.Xml.Schema", "Datatype_monthDay");
...
/// @brief Method .ctor, addr 0x181d6dc60, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TypeCode, addr 0x1816c26a0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_monthDay) == 0x40, "Size mismatch!");
