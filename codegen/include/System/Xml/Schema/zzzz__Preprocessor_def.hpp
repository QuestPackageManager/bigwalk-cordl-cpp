...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Preprocessor*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Preprocessor*, "System.Xml.Schema", "Preprocessor");
...
/// @brief Method BuildRefNamespaces, addr 0x181c4caa0, size 0x210, virtual false, abstract: false, final false
inline void BuildRefNamespaces(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method BuildSchemaList, addr 0x181c4ccb0, size 0x150, virtual false, abstract: false, final false
inline void BuildSchemaList(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CheckRefinedAttributeGroup, addr 0x181c4ce00, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method CheckRefinedGroup, addr 0x181c4d260, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x181c4d440, size 0xc0, virtual false, abstract: false, final false
inline void Cleanup(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CleanupRedefine, addr 0x181c4d3d0, size 0x70, virtual false, abstract: false, final false
inline void CleanupRedefine(::System::Xml::Schema::XmlSchemaExternal*  include) ;

/// @brief Method CopyIncludedComponents, addr 0x181c4d500, size 0xc90, virtual false, abstract: false, final false
inline void CopyIncludedComponents(::System::Xml::Schema::XmlSchema*  includedSchema, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CountGroupSelfReference, addr 0x181c4e190, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x181c4e420, size 0x4e0, virtual false, abstract: false, final false
inline bool Execute(::System::Xml::Schema::XmlSchema*  schema, ::StringW  targetNamespace, bool  loadExternals) ;

/// @brief Method GetBuildInSchema, addr 0x181c4e900, size 0x4a0, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchema* GetBuildInSchema() ;

/// @brief Method GetChameleonSchema, addr 0x181c4eda0, size 0x120, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* GetChameleonSchema(::StringW  targetNamespace, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method GetIncludedSet, addr 0x181c4eec0, size 0x120, virtual false, abstract: false, final false
inline void GetIncludedSet(::System::Xml::Schema::XmlSchema*  schema, ::System::Collections::ArrayList*  includesList) ;

/// @brief Method GetParentSchema, addr 0x181c4efe0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchema* GetParentSchema(::System::Xml::Schema::XmlSchemaObject*  currentSchemaObject) ;

/// @brief Method GetSchemaEntity, addr 0x181c4f040, size 0x30, virtual false, abstract: false, final false
inline ::System::Object* GetSchemaEntity(::System::Uri*  ruri) ;

/// @brief Method LoadExternals, addr 0x181c4f070, size 0xaa0, virtual false, abstract: false, final false
inline void LoadExternals(::System::Xml::Schema::XmlSchema*  schema) ;

static inline ::System::Xml::Schema::Preprocessor* New_ctor(::System::Xml::XmlNameTable*  nameTable, ::System::Xml::Schema::SchemaNames*  schemaNames, ::System::Xml::Schema::ValidationEventHandler*  eventHandler, ::System::Xml::Schema::XmlSchemaCompilationSettings*  compilationSettings) ;

/// @brief Method ParseUri, addr 0x181c4fb10, size 0x90, virtual false, abstract: false, final false
inline void ParseUri(::StringW  uri, ::StringW  code, ::System::Xml::Schema::XmlSchemaObject*  sourceSchemaObject) ;

/// @brief Method Preprocess, addr 0x181c53a60, size 0x1360, virtual false, abstract: false, final false
inline void Preprocess(::System::Xml::Schema::XmlSchema*  schema, ::StringW  targetNamespace, ::System::Collections::ArrayList*  imports) ;

/// @brief Method PreprocessAnnotation, addr 0x181c4fc40, size 0x80, virtual false, abstract: false, final false
inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaAnnotation*  annotation) ;

/// @brief Method PreprocessAnnotation, addr 0x181c4fba0, size 0xa0, virtual false, abstract: false, final false
inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaObject*  schemaObject) ;

/// @brief Method PreprocessAttribute, addr 0x181c50000, size 0x120, virtual false, abstract: false, final false
inline void PreprocessAttribute(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessAttributeContent, addr 0x181c4fcc0, size 0x200, virtual false, abstract: false, final false
inline void PreprocessAttributeContent(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessAttributeGroup, addr 0x181c4fec0, size 0x140, virtual false, abstract: false, final false
inline void PreprocessAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup*  attributeGroup) ;

/// @brief Method PreprocessAttributes, addr 0x181c50120, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method PreprocessComplexType, addr 0x181c50440, size 0x910, virtual false, abstract: false, final false
inline void PreprocessComplexType(::System::Xml::Schema::XmlSchemaComplexType*  complexType, bool  local) ;

/// @brief Method PreprocessElement, addr 0x181c510d0, size 0x1f0, virtual false, abstract: false, final false
inline void PreprocessElement(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessElementContent, addr 0x181c50d50, size 0x380, virtual false, abstract: false, final false
inline void PreprocessElementContent(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessGroup, addr 0x181c512c0, size 0x160, virtual false, abstract: false, final false
inline void PreprocessGroup(::System::Xml::Schema::XmlSchemaGroup*  group) ;

/// @brief Method PreprocessIdentityConstraint, addr 0x181c51420, size 0x340, virtual false, abstract: false, final false
inline void PreprocessIdentityConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint*  constraint) ;

/// @brief Method PreprocessLocalAttribute, addr 0x181c51760, size 0x150, virtual false, abstract: false, final false
inline void PreprocessLocalAttribute(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessLocalElement, addr 0x181c518b0, size 0x2f0, virtual false, abstract: false, final false
inline void PreprocessLocalElement(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessNotation, addr 0x181c51ba0, size 0x200, virtual false, abstract: false, final false
inline void PreprocessNotation(::System::Xml::Schema::XmlSchemaNotation*  notation) ;

/// @brief Method PreprocessParticle, addr 0x181c51da0, size 0xa20, virtual false, abstract: false, final false
inline void PreprocessParticle(::System::Xml::Schema::XmlSchemaParticle*  particle) ;

/// @brief Method PreprocessRedefine, addr 0x181c527c0, size 0xc30, virtual false, abstract: false, final false
inline void PreprocessRedefine(::System::Xml::Schema::RedefineEntry*  redefineEntry) ;

/// @brief Method PreprocessSimpleType, addr 0x181c533f0, size 0x670, virtual false, abstract: false, final false
inline void PreprocessSimpleType(::System::Xml::Schema::XmlSchemaSimpleType*  simpleType, bool  local) ;

/// @brief Method ResolveSchemaLocationUri, addr 0x181c54dc0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method SetSchemaDefaults, addr 0x181c54e00, size 0xd0, virtual false, abstract: false, final false
inline void SetSchemaDefaults(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method ValidateIdAttribute, addr 0x181c54ed0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method ValidateQNameAttribute, addr 0x181c55230, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181c55380, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_RootSchema, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ChameleonSchemas, addr 0x1803117a0, size 0x10, virtual false, abstract: false, final false
inline void set_ChameleonSchemas(::System::Collections::Hashtable*  value) ;

/// @brief Method set_ReaderSettings, addr 0x1802ec810, size 0x20, virtual false, abstract: false, final false
inline void set_ReaderSettings(::System::Xml::XmlReaderSettings*  value) ;

/// @brief Method set_SchemaLocations, addr 0x1803f5420, size 0x10, virtual false, abstract: false, final false
inline void set_SchemaLocations(::System::Collections::Hashtable*  value) ;

/// @brief Method set_XmlResolver, addr 0x1803d9970, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Preprocessor) == 0xc0, "Size mismatch!");
