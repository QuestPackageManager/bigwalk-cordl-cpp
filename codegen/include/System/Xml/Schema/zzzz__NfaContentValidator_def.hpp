...
// Write type traits
MARK_REF_T(::System::Xml::Schema::NfaContentValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::NfaContentValidator*, "System.Xml.Schema", "NfaContentValidator");
...
/// @brief Method CompleteValidation, addr 0x181d76c00, size 0x30, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x181d76c30, size 0x170, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x181d76da0, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d77090, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::BitSet*  firstpos, ::ArrayW<::System::Xml::Schema::BitSet*>  followpos, ::System::Xml::Schema::SymbolsDictionary*  symbols, ::System::Xml::Schema::Positions*  positions, int32_t  endMarkerPos, ::System::Xml::Schema::XmlSchemaContentType  contentType, bool  isOpen, bool  isEmptiable) ;
...
static_assert(sizeof(::System::Xml::Schema::NfaContentValidator) == 0x40, "Size mismatch!");
