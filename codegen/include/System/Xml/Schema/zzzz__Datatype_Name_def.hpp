...
// Write type traits
MARK_REF_T(::System::Xml::Schema::Datatype_Name*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::Datatype_Name*, "System.Xml.Schema", "Datatype_Name");
...
/// @brief Method get_TypeCode, addr 0x1818c4000, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::Datatype_Name) == 0x38, "Size mismatch!");
