...
// Write type traits
MARK_REF_T(::System::Xml::Schema::ValidationEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::ValidationEventArgs*, "System.Xml.Schema", "ValidationEventArgs");
...
/// @brief Method get_Severity, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::ValidationEventArgs) == 0x20, "Size mismatch!");
