...
// Write type traits
MARK_REF_T(::System::Xml::Schema::XmlSchemaContent*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::XmlSchemaContent*, "System.Xml.Schema", "XmlSchemaContent");
...
static_assert(sizeof(::System::Xml::Schema::XmlSchemaContent) == 0x50, "Size mismatch!");
