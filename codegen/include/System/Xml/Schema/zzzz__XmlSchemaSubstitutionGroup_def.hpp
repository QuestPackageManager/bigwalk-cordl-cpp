...
/// @brief Method .ctor, addr 0x181ca9420, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Examplar, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_Examplar() ;

/// @brief Method get_Members, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Members() ;

/// @brief Method set_Examplar, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
