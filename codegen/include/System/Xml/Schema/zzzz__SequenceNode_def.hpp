...
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SequenceNode_SequenceConstructPosContext, "System.Xml.Schema", "SequenceNode/SequenceConstructPosContext");
// Dependencies 
namespace System::Xml::Schema {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x181d5a150, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SequenceNode_SequenceConstructPosContext) == 0x28, "Size mismatch!");
...
/// @brief Method ConstructPos, addr 0x181d5a210, size 0x490, virtual true, abstract: false, final false
...
/// @brief Method get_IsNullable, addr 0x181d5a6a0, size 0x140, virtual true, abstract: false, final false
