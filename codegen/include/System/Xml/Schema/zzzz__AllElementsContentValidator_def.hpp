...
// Write type traits
MARK_REF_T(::System::Xml::Schema::AllElementsContentValidator*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::AllElementsContentValidator*, "System.Xml.Schema", "AllElementsContentValidator");
// Dependencies System.Object, System.Xml.Schema.ContentValidator
namespace System::Xml::Schema {
// Is value type: false
...
/// @brief Method AddElement, addr 0x181d62da0, size 0xf0, virtual false, abstract: false, final false
inline bool AddElement(::System::Xml::XmlQualifiedName*  name, ::System::Object*  particle, bool  isEmptiable) ;

/// @brief Method CompleteValidation, addr 0x181d62e90, size 0x50, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x181d62ee0, size 0x2c0, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x181d631a0, size 0x320, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x181d634c0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x181d63530, size 0x100, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_particles() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_particles() ;
...
/// @brief Method .ctor, addr 0x181d63630, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType, int32_t  size, bool  isEmptiable) ;

/// @brief Method get_IsEmptiable, addr 0x181d636e0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Field particles, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___particles;
...
static_assert(sizeof(::System::Xml::Schema::AllElementsContentValidator) == 0x38, "Size mismatch!");
