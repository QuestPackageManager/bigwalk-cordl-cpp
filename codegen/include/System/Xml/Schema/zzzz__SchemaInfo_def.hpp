...
// Write type traits
MARK_REF_T(::System::Xml::Schema::SchemaInfo*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::SchemaInfo*, "System.Xml.Schema", "SchemaInfo");
// Dependencies System.Object, System.Xml.Schema.SchemaType
namespace System::Xml::Schema {
// Is value type: false
...
// Declarations
 ...
 __declspec(property(get=get_UndeclaredElementDecls)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaElementDecl*>*  UndeclaredElementDecls;

/// @brief Field attributeDecls, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_attributeDecls, put=__cordl_internal_set_attributeDecls)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaAttDef*>*  attributeDecls;
...
/// @brief Field elementDecls, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_elementDecls, put=__cordl_internal_set_elementDecls)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaElementDecl*>*  elementDecls;

/// @brief Field elementDeclsByType, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_elementDeclsByType, put=__cordl_internal_set_elementDeclsByType)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaElementDecl*>*  elementDeclsByType;
...
/// @brief Field generalEntities, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_generalEntities, put=__cordl_internal_set_generalEntities)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaEntity*>*  generalEntities;
...
/// @brief Field notations, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_notations, put=__cordl_internal_set_notations)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Xml::Schema::SchemaNotation*>*  notations;

/// @brief Field parameterEntities, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_parameterEntities, put=__cordl_internal_set_parameterEntities)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaEntity*>*  parameterEntities;
...
/// @brief Field undeclaredElementDecls, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_undeclaredElementDecls, put=__cordl_internal_set_undeclaredElementDecls)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaElementDecl*>*  undeclaredElementDecls;

/// @brief Convert operator to "::System::Xml::IDtdInfo"
constexpr operator  ::System::Xml::IDtdInfo*() noexcept;

/// @brief Method Add, addr 0x181c85a60, size 0x440, virtual false, abstract: false, final false
inline void Add(::System::Xml::Schema::SchemaInfo*  sinfo, ::System::Xml::Schema::ValidationEventHandler*  eventhandler) ;

/// @brief Method Contains, addr 0x181c85ea0, size 0x10, virtual false, abstract: false, final false
inline bool Contains(::StringW  ns) ;

/// @brief Method Finish, addr 0x181c85eb0, size 0xc0, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method GetAttributeXdr, addr 0x181c85f70, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetAttributeXsd, addr 0x181c86200, size 0x220, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaAttDef* GetAttributeXsd(::System::Xml::Schema::SchemaElementDecl*  ed, ::System::Xml::XmlQualifiedName*  qname, ::System::Xml::Schema::XmlSchemaObject*  partialValidationType, ::by_ref<::System::Xml::Schema::AttributeMatchState>  attributeMatchState) ;

/// @brief Method GetAttributeXsd, addr 0x181c860e0, size 0x120, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaAttDef* GetAttributeXsd(::System::Xml::Schema::SchemaElementDecl*  ed, ::System::Xml::XmlQualifiedName*  qname, ::by_ref<bool>  skip) ;

/// @brief Method GetElement, addr 0x181c86460, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* GetElement(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method GetElementDecl, addr 0x181c86420, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* GetElementDecl(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method GetTypeDecl, addr 0x181c864b0, size 0x40, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* GetTypeDecl(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method HasSchema, addr 0x181c85ea0, size 0x10, virtual false, abstract: false, final false
inline bool HasSchema(::StringW  ns) ;

static inline ::System::Xml::Schema::SchemaInfo* New_ctor() ;

/// @brief Method System.Xml.IDtdInfo.LookupAttributeList, addr 0x181c864f0, size 0xa0, virtual true, abstract: false, final true
inline ::System::Xml::IDtdAttributeListInfo* System_Xml_IDtdInfo_LookupAttributeList(::StringW  prefix, ::StringW  localName) ;

/// @brief Method System.Xml.IDtdInfo.LookupEntity, addr 0x181c86590, size 0xa0, virtual true, abstract: false, final true
inline ::System::Xml::IDtdEntityInfo* System_Xml_IDtdInfo_LookupEntity(::StringW  name) ;

/// @brief Method System.Xml.IDtdInfo.get_HasDefaultAttributes, addr 0x180391c80, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdInfo_get_HasDefaultAttributes() ;

/// @brief Method System.Xml.IDtdInfo.get_HasNonCDataAttributes, addr 0x180391c90, size 0x10, virtual true, abstract: false, final true
inline bool System_Xml_IDtdInfo_get_HasNonCDataAttributes() ;

/// @brief Method System.Xml.IDtdInfo.get_InternalDtdSubset, addr 0x1802d9800, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IDtdInfo_get_InternalDtdSubset() ;

/// @brief Method System.Xml.IDtdInfo.get_Name, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181c86630, size 0x160, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AttributeDecls, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_DocTypeName, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_DocTypeName() ;

/// @brief Method get_ElementDecls, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ElementDeclsByType, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ErrorCount, addr 0x1802e0b20, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ErrorCount() ;

/// @brief Method get_GeneralEntities, addr 0x181c86790, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_Notations, addr 0x181c867f0, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::System::Xml::Schema::SchemaNotation*>* get_Notations() ;

/// @brief Method get_ParameterEntities, addr 0x181c86850, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_SchemaType, addr 0x180503b40, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType get_SchemaType() ;

/// @brief Method get_TargetNamespaces, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,bool>* get_TargetNamespaces() ;

/// @brief Method get_UndeclaredElementDecls, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_DocTypeName, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
inline void set_DocTypeName(::System::Xml::XmlQualifiedName*  value) ;

/// @brief Method set_ErrorCount, addr 0x1802e0d10, size 0x10, virtual false, abstract: false, final false
inline void set_ErrorCount(int32_t  value) ;

/// @brief Method set_InternalDtdSubset, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void set_InternalDtdSubset(::StringW  value) ;

/// @brief Method set_SchemaType, addr 0x180503ba0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::SchemaInfo) == 0x70, "Size mismatch!");
