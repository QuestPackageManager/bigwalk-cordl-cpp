...
/// @brief Method AddParticleToExpected, addr 0x181d55360, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method AddParticleToExpected, addr 0x181d55110, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method CompleteValidation, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x181d55380, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d554c0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType) ;

/// @brief Method .ctor, addr 0x181d554d0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ContentType, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType() ;

/// @brief Method get_IsEmptiable, addr 0x1804e67f0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsEmptiable() ;

/// @brief Method get_IsOpen, addr 0x181d554e0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsOpen() ;

/// @brief Method get_PreserveWhitespace, addr 0x181d55500, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_IsOpen, addr 0x18039e7c0, size 0x10, virtual false, abstract: false, final false
