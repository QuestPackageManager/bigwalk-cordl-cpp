...
// Write type traits
MARK_REF_T(::System::Xml::Schema::TypedObject*);
MARK_REF_T(::System::Xml::Schema::TypedObject_DecimalStruct*);
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::TypedObject*, "System.Xml.Schema", "TypedObject");
DEFINE_IL2CPP_CLASS(::System::Xml::Schema::TypedObject_DecimalStruct*, "System.Xml.Schema", "TypedObject/DecimalStruct");
...
public:
// Declarations
 __declspec(property(get=get_Dvalue)) ::ArrayW<::System::Decimal>  Dvalue;

 __declspec(property(get=get_IsDecimal, put=set_IsDecimal)) bool  IsDecimal;

/// @brief Field dvalue, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_dvalue, put=__cordl_internal_set_dvalue)) ::ArrayW<::System::Decimal>  dvalue;
...
constexpr ::ArrayW<::System::Decimal> const& __cordl_internal_get_dvalue() const;

constexpr ::ArrayW<::System::Decimal>& __cordl_internal_get_dvalue() ;

constexpr bool const& __cordl_internal_get_isDecimal() const;

constexpr bool& __cordl_internal_get_isDecimal() ;

constexpr void __cordl_internal_set_dvalue(::ArrayW<::System::Decimal>  value) ;

constexpr void __cordl_internal_set_isDecimal(bool  value) ;

/// @brief Method .ctor, addr 0x181d55550, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181d55520, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  dim) ;

/// @brief Method get_Dvalue, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Decimal> get_Dvalue() ;

/// @brief Method get_IsDecimal, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDecimal() ;

/// @brief Method set_IsDecimal, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field dvalue, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Decimal>  ___dvalue;
...
static_assert(sizeof(::System::Xml::Schema::TypedObject_DecimalStruct) == 0x20, "Size mismatch!");
...
/// @brief Method Equals, addr 0x181d5bb00, size 0x2c0, virtual false, abstract: false, final false
inline bool Equals(::System::Xml::Schema::TypedObject*  other) ;

/// @brief Method ListDValueEquals, addr 0x181d5bdc0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetDecimal, addr 0x181d5be50, size 0x250, virtual false, abstract: false, final false
inline void SetDecimal() ;

/// @brief Method ToString, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d5c0a0, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  obj, ::StringW  svalue, ::System::Xml::Schema::XmlSchemaDatatype*  xsdtype) ;

/// @brief Method get_Dim, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Dim() ;

/// @brief Method get_Dvalue, addr 0x181632210, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<::System::Decimal> get_Dvalue() ;

/// @brief Method get_IsDecimal, addr 0x181d5c1d0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDecimal() ;

/// @brief Method get_IsList, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_IsList() ;

/// @brief Method get_Type, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::Schema::TypedObject) == 0x38, "Size mismatch!");
