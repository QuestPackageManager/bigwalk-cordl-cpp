...
// Write type traits
MARK_REF_T(::System::Xml::IDtdParserAdapter*);
DEFINE_IL2CPP_CLASS(::System::Xml::IDtdParserAdapter*, "System.Xml", "IDtdParserAdapter");
// Dependencies 
namespace System::Xml {
// Is value type: false
...
// Declarations
 ...
 __declspec(property(get=get_ParsingBuffer)) ::ArrayW<char16_t>  ParsingBuffer;
