...
DEFINE_IL2CPP_CLASS(::System::Xml::EntityHandling, "System.Xml", "EntityHandling");
// Dependencies 
namespace System::Xml {
// Is value type: true
...
static_assert(offsetof(::System::Xml::EntityHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Xml::EntityHandling) == 0x4, "Size mismatch!");
