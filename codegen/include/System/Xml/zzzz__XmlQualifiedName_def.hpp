...
// Write type traits
MARK_REF_T(::System::Xml::XmlQualifiedName*);
MARK_REF_T(::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate*);
DEFINE_IL2CPP_CLASS(::System::Xml::XmlQualifiedName*, "System.Xml", "XmlQualifiedName");
DEFINE_IL2CPP_CLASS(::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate*, "System.Xml", "XmlQualifiedName/HashCodeOfStringDelegate");
...
/// @brief Method .ctor, addr 0x181cda9b0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method Atomize, addr 0x181d37fc0, size 0x70, virtual false, abstract: false, final false
inline void Atomize(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method Clone, addr 0x181d38030, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* Clone() ;

/// @brief Method Equals, addr 0x181d38080, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x181d38270, size 0x210, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCodeDelegate, addr 0x181d38110, size 0x160, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName_HashCodeOfStringDelegate* GetHashCodeDelegate() ;

/// @brief Method GetHashCodeOfString, addr 0x180e741b0, size 0x6a70, virtual false, abstract: false, final false
static inline int32_t GetHashCodeOfString(::StringW  s, int32_t  length, int64_t  additionalEntropy) ;

/// @brief Method Init, addr 0x181d38480, size 0x40, virtual false, abstract: false, final false
inline void Init(::StringW  name, ::StringW  ns) ;

/// @brief Method IsRandomizedHashingDisabled, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x181d384c0, size 0x250, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName* Parse(::StringW  s, ::System::Xml::IXmlNamespaceResolver*  nsmgr, ::by_ref<::StringW>  prefix) ;

/// @brief Method SetNamespace, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void SetNamespace(::StringW  ns) ;

/// @brief Method ToString, addr 0x181d38710, size 0x30, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x181d38740, size 0x30, virtual false, abstract: false, final false
static inline ::StringW ToString(::StringW  name, ::StringW  ns) ;

/// @brief Method Verify, addr 0x181d38770, size 0xb0, virtual false, abstract: false, final false
inline void Verify() ;
...
/// @brief Method .ctor, addr 0x181d389d0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181d38900, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x181d38960, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_IsEmpty, addr 0x181d38a30, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181d38a50, size 0x70, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Xml::XmlQualifiedName*  a, ::System::Xml::XmlQualifiedName*  b) ;

/// @brief Method op_Inequality, addr 0x181d38ac0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Xml::XmlQualifiedName) == 0x28, "Size mismatch!");
