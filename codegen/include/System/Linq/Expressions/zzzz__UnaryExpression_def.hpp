...
/// @brief Method Accept, addr 0x181b04c90, size 0x20, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

/// @brief Method FunctionalOp, addr 0x181b04cb0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x181b05670, size 0x70, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Reduce() ;

/// @brief Method ReduceIndex, addr 0x181b04d90, size 0x400, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceIndex() ;

/// @brief Method ReduceMember, addr 0x181b05190, size 0x330, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceMember() ;

/// @brief Method ReduceVariable, addr 0x181b054c0, size 0x1b0, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceVariable() ;

/// @brief Method Update, addr 0x181b056e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b05760, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_CanReduce, addr 0x181b057c0, size 0x30, virtual true, abstract: false, final false
inline bool get_CanReduce() ;

/// @brief Method get_IsLifted, addr 0x181b05830, size 0x1c0, virtual false, abstract: false, final false
inline bool get_IsLifted() ;

/// @brief Method get_IsLiftedToNull, addr 0x181b057f0, size 0x40, virtual false, abstract: false, final false
inline bool get_IsLiftedToNull() ;

/// @brief Method get_IsPrefix, addr 0x181b059f0, size 0x50, virtual false, abstract: false, final false
inline bool get_IsPrefix() ;

/// @brief Method get_Method, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Method() ;

/// @brief Method get_NodeType, addr 0x1802f41a0, size 0x10, virtual true, abstract: false, final true
inline ::System::Linq::Expressions::ExpressionType get_NodeType() ;

/// @brief Method get_Operand, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
