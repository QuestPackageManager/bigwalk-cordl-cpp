...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::StackGuard*);
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::StackGuard___c__3_2);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::StackGuard*, "System.Linq.Expressions", "StackGuard");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::StackGuard___c__3_2, "System.Linq.Expressions", "StackGuard/<>c__3`2");
...
// Declarations
template<typename T1,typename T2>
using __c__3_2 = ::System::Linq::Expressions::StackGuard___c__3_2<T1, T2>;
...
template<typename T1,typename T2>
inline void RunOnEmptyStack(::System::Action_2<T1,T2>*  action, T1  arg1, T2  arg2) ;

/// @brief Method RunOnEmptyStackCore, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename R>
inline R RunOnEmptyStackCore(::System::Func_2<::System::Object*,R>*  action, ::System::Object*  state) ;

/// @brief Method TryEnterOnCurrentStack, addr 0x181b03930, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::StackGuard) == 0x18, "Size mismatch!");
