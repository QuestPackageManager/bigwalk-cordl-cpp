...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::BranchLabel*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::BranchLabel*, "System.Linq.Expressions.Interpreter", "BranchLabel");
...
/// @brief Method AddBranch, addr 0x181af5fd0, size 0xc0, virtual false, abstract: false, final false
inline void AddBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method FixupBranch, addr 0x181af6090, size 0x20, virtual false, abstract: false, final false
inline void FixupBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method Mark, addr 0x181af60b0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method ToRuntimeLabel, addr 0x181af6180, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181af61a0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasRuntimeLabel, addr 0x181af61c0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasRuntimeLabel() ;

/// @brief Method get_LabelIndex, addr 0x1803914a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LabelIndex() ;

/// @brief Method get_TargetIndex, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_TargetIndex() ;

/// @brief Method set_LabelIndex, addr 0x1803914c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::BranchLabel) == 0x30, "Size mismatch!");
