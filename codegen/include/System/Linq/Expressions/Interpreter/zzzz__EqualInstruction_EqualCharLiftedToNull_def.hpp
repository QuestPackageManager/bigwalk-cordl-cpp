...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualCharLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualCharLiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualCharLiftedToNull");
...
/// @brief Method Run, addr 0x181af9400, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualCharLiftedToNull) == 0x10, "Size mismatch!");
