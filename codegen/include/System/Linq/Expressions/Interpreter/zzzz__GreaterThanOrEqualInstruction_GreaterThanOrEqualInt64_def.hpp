...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64*, "System.Linq.Expressions.Interpreter", "GreaterThanOrEqualInstruction/GreaterThanOrEqualInt64");
...
/// @brief Method Run, addr 0x181b09320, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt64) == 0x18, "Size mismatch!");
