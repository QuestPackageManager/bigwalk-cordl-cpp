...
// Write type traits
MARK_REF_T(::GlobalNamespace::IncrementInstruction_IncrementInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IncrementInstruction_IncrementInt64*, "System.Linq.Expressions.Interpreter", "IncrementInstruction/IncrementInt64");
...
/// @brief Method Run, addr 0x181b0a270, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IncrementInstruction_IncrementInt64) == 0x10, "Size mismatch!");
