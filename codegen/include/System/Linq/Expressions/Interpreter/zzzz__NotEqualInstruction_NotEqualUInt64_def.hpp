...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualUInt64");
...
/// @brief Method Run, addr 0x181b2dfb0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualUInt64) == 0x10, "Size mismatch!");
