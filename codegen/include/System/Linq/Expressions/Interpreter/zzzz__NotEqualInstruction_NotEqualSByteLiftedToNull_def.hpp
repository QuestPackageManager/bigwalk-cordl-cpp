...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualSByteLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualSByteLiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualSByteLiftedToNull");
...
/// @brief Method Run, addr 0x181b2d920, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualSByteLiftedToNull) == 0x10, "Size mismatch!");
