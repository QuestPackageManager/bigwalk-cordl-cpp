...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotInstruction_NotUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotInstruction_NotUInt64*, "System.Linq.Expressions.Interpreter", "NotInstruction/NotUInt64");
...
/// @brief Method Run, addr 0x181b2e6e0, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotInstruction_NotUInt64) == 0x10, "Size mismatch!");
