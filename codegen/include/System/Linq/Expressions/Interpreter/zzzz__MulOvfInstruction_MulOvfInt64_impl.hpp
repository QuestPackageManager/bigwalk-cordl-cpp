...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::MulOvfInstruction_MulOvfInt64::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::MulOvfInstruction_MulOvfInt64::Run)> {
  constexpr static std::size_t size = 0x1c0;
  constexpr static std::size_t addrs = 0x181b2ad70;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::MulOvfInstruction_MulOvfInt64*>(),
                    {::i2c::class_of<::GlobalNamespace::MulOvfInstruction_MulOvfInt64*>(), 8}
                ));
