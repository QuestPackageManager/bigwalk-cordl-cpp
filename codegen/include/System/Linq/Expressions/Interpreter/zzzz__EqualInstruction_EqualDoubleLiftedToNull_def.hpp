...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualDoubleLiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualDoubleLiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualDoubleLiftedToNull");
...
/// @brief Method Run, addr 0x181af9570, size 0xd0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualDoubleLiftedToNull) == 0x10, "Size mismatch!");
