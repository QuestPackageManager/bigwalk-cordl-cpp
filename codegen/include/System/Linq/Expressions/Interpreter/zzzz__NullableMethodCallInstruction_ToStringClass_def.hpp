...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_ToStringClass*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_ToStringClass*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/ToStringClass");
...
/// @brief Method Run, addr 0x181b32e60, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_ToStringClass) == 0x10, "Size mismatch!");
