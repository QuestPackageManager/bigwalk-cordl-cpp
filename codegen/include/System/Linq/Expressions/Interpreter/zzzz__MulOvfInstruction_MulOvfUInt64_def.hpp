...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulOvfInstruction_MulOvfUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulOvfInstruction_MulOvfUInt64*, "System.Linq.Expressions.Interpreter", "MulOvfInstruction/MulOvfUInt64");
...
/// @brief Method Run, addr 0x181b2b2f0, size 0x180, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MulOvfInstruction_MulOvfUInt64) == 0x10, "Size mismatch!");
