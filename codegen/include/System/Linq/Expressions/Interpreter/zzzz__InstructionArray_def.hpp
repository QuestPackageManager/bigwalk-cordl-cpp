...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::InstructionArray_DebugView*);
...
/// @brief Method .ctor, addr 0x181b0a630, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(int32_t  maxStackDepth, int32_t  maxContinuationDepth, ::ArrayW<::System::Linq::Expressions::Interpreter::Instruction*>  instructions, ::ArrayW<::System::Object*>  objects, ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>  labels, ::System::Collections::Generic::List_1<::System::Collections::Generic::KeyValuePair_2<int32_t,::System::Object*>>*  debugCookies) ;

// Ctor Parameters []
// @brief default ctor
constexpr InstructionArray() ;

// Ctor Parameters [CppParam { name: "MaxStackDepth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "MaxContinuationDepth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Instructions", ty: "::ArrayW<::System::Linq::Expressions::Interpreter::Instruction*>", modifiers: "", def_value: None }, CppParam { name: "Objects", ty: "::ArrayW<::System::Object*>", modifiers: "", def_value: None }, CppParam { name: "Labels", ty: "::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>", modifiers: "", def_value: None }, CppParam { name: "DebugCookies", ty: "::System::Collections::Generic::List_1<::System::Collections::Generic::KeyValuePair_2<int32_t,::System::Object*>>*", modifiers: "", def_value: None }]
constexpr InstructionArray(int32_t  MaxStackDepth, int32_t  MaxContinuationDepth, ::ArrayW<::System::Linq::Expressions::Interpreter::Instruction*>  Instructions, ::ArrayW<::System::Object*>  Objects, ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel>  Labels, ::System::Collections::Generic::List_1<::System::Collections::Generic::KeyValuePair_2<int32_t,::System::Object*>>*  DebugCookies) noexcept;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::InstructionArray) == 0x28, "Size mismatch!");
...
/// @brief Method GetInstructionViews, addr 0x181b06900, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method <GetInstructionViews>b__4_0, addr 0x181b06990, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b069a0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::InstructionArray_DebugView) == 0x38, "Size mismatch!");
