...
// Write type traits
MARK_REF_T(::GlobalNamespace::RightShiftInstruction_RightShiftByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RightShiftInstruction_RightShiftByte*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction/RightShiftByte");
...
/// @brief Method Run, addr 0x181b30170, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RightShiftInstruction_RightShiftByte) == 0x10, "Size mismatch!");
