...
/// @brief Method MoveNext, addr 0x181b1fac0, size 0x160, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerable<System.Linq.Expressions.Interpreter.InterpretedFrameInfo>.GetEnumerator, addr 0x181b1fc20, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Interpreter.InterpretedFrameInfo>.get_Current, addr 0x1802e2d70, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181b1fc20, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181b1fca0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method Dup, addr 0x181b0e060, size 0x40, virtual false, abstract: false, final false
inline void Dup() ;

/// @brief Method Enter, addr 0x181b0e0a0, size 0x60, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::InterpretedFrame* Enter() ;

/// @brief Method GetDebugInfo, addr 0x181b0e100, size 0xa0, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::DebugInfo* GetDebugInfo(int32_t  instructionIndex) ;

/// @brief Method GetStackTraceDebugInfo, addr 0x181b0e1a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Goto, addr 0x181b0e1f0, size 0x100, virtual false, abstract: false, final false
inline int32_t Goto(int32_t  labelIndex, ::System::Object*  value, bool  gotoExceptionHandler) ;

/// @brief Method IsJumpHappened, addr 0x181b0e2f0, size 0x10, virtual false, abstract: false, final false
inline bool IsJumpHappened() ;

/// @brief Method Leave, addr 0x181b0e300, size 0x40, virtual false, abstract: false, final false
inline void Leave(::System::Linq::Expressions::Interpreter::InterpretedFrame*  prevFrame) ;

static inline ::System::Linq::Expressions::Interpreter::InterpretedFrame* New_ctor(::System::Linq::Expressions::Interpreter::Interpreter*  interpreter, ::ArrayW<::System::Runtime::CompilerServices::IStrongBox*>  closure) ;

/// @brief Method Peek, addr 0x181b0e340, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* Peek() ;

/// @brief Method Pop, addr 0x181b0e3d0, size 0x20, virtual false, abstract: false, final false
inline ::System::Object* Pop() ;

/// @brief Method PopPendingContinuation, addr 0x181b0e350, size 0x80, virtual false, abstract: false, final false
inline void PopPendingContinuation() ;

/// @brief Method Push, addr 0x181b0e4c0, size 0x30, virtual false, abstract: false, final false
inline void Push(::System::Object*  value) ;

/// @brief Method Push, addr 0x181b0e630, size 0x90, virtual false, abstract: false, final false
inline void Push(bool  value) ;

/// @brief Method Push, addr 0x181b0e4f0, size 0x50, virtual false, abstract: false, final false
inline void Push(int16_t  value) ;

/// @brief Method Push, addr 0x181b0e5e0, size 0x50, virtual false, abstract: false, final false
inline void Push(int32_t  value) ;

/// @brief Method Push, addr 0x181b0e590, size 0x50, virtual false, abstract: false, final false
inline void Push(int8_t  value) ;

/// @brief Method Push, addr 0x181b0e6c0, size 0x50, virtual false, abstract: false, final false
inline void Push(uint16_t  value) ;

/// @brief Method Push, addr 0x181b0e540, size 0x50, virtual false, abstract: false, final false
inline void Push(uint8_t  value) ;

/// @brief Method PushContinuation, addr 0x181b0e3f0, size 0x20, virtual false, abstract: false, final false
inline void PushContinuation(int32_t  continuation) ;

/// @brief Method PushPendingContinuation, addr 0x181b0e410, size 0xb0, virtual false, abstract: false, final false
inline void PushPendingContinuation() ;

/// @brief Method RemoveContinuation, addr 0x180e7ac30, size 0x1f0, virtual false, abstract: false, final false
inline void RemoveContinuation() ;

/// @brief Method SaveTraceToException, addr 0x181b0e710, size 0x1f0, virtual false, abstract: false, final false
inline void SaveTraceToException(::System::Exception*  exception) ;

/// @brief Method SetStackDepth, addr 0x181b0e900, size 0x10, virtual false, abstract: false, final false
inline void SetStackDepth(int32_t  depth) ;

/// @brief Method YieldToCurrentContinuation, addr 0x181b0e910, size 0x50, virtual false, abstract: false, final false
inline int32_t YieldToCurrentContinuation() ;

/// @brief Method YieldToPendingContinuation, addr 0x181b0e960, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b0ea80, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_Name, addr 0x181b0eb60, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Parent, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
