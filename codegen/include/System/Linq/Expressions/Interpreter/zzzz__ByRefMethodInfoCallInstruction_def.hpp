...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::ByRefMethodInfoCallInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::ByRefMethodInfoCallInstruction*, "System.Linq.Expressions.Interpreter", "ByRefMethodInfoCallInstruction");
// Dependencies System.Linq.Expressions.Interpreter.ByRefUpdater, System.Linq.Expressions.Interpreter.MethodInfoCallInstruction
namespace System::Linq::Expressions::Interpreter {
// Is value type: false
...
static inline ::System::Linq::Expressions::Interpreter::ByRefMethodInfoCallInstruction* New_ctor(::System::Reflection::MethodInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*>  byrefArgs) ;

/// @brief Method Run, addr 0x181af62b0, size 0x380, virtual true, abstract: false, final true
...
inline void _ctor(::System::Reflection::MethodInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*>  byrefArgs) ;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::ByRefMethodInfoCallInstruction) == 0x28, "Size mismatch!");
