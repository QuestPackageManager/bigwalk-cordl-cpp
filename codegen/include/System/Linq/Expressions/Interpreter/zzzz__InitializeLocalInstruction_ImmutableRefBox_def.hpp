...
// Write type traits
MARK_REF_T(::GlobalNamespace::InitializeLocalInstruction_ImmutableRefBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::InitializeLocalInstruction_ImmutableRefBox*, "System.Linq.Expressions.Interpreter", "InitializeLocalInstruction/ImmutableRefBox");
...
/// @brief Method Run, addr 0x181b26900, size 0x50, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  index) ;

/// @brief Method get_InstructionName, addr 0x181b268f0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::InitializeLocalInstruction_ImmutableRefBox) == 0x18, "Size mismatch!");
