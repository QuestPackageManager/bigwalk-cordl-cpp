...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubOvfInstruction_SubOvfInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubOvfInstruction_SubOvfInt16*, "System.Linq.Expressions.Interpreter", "SubOvfInstruction/SubOvfInt16");
...
/// @brief Method Run, addr 0x181b31c80, size 0x260, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubOvfInstruction_SubOvfInt16) == 0x10, "Size mismatch!");
