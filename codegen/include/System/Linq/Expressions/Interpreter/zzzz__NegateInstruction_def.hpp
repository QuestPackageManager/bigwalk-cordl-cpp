...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NegateInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NegateInstruction*, "System.Linq.Expressions.Interpreter", "NegateInstruction");
...
/// @brief Method Create, addr 0x181b2bf10, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2c150, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NegateInstruction) == 0x10, "Size mismatch!");
