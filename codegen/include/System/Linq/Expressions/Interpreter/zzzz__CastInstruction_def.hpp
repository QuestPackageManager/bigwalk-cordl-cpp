...
namespace GlobalNamespace {
template<typename T>
class CastInstruction_CastInstructionT_1;
}
...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::CastInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::CastInstruction*, "System.Linq.Expressions.Interpreter", "CastInstruction");
...
template<typename T>
using CastInstructionT_1 = ::GlobalNamespace::CastInstruction_CastInstructionT_1<T>;
...
/// @brief Method Create, addr 0x181b20ad0, size 0x650, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b21120, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::CastInstruction) == 0x10, "Size mismatch!");
