...
// Write type traits
MARK_REF_T(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*, "System.Linq.Expressions.Interpreter", "NegateCheckedInstruction/NegateCheckedInt16");
...
/// @brief Method Run, addr 0x181b2bb50, size 0x150, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16) == 0x10, "Size mismatch!");
