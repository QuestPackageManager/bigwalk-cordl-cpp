...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddInstruction_AddInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddInstruction_AddInt16*, "System.Linq.Expressions.Interpreter", "AddInstruction/AddInt16");
...
/// @brief Method Run, addr 0x181af3380, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddInstruction_AddInt16) == 0x10, "Size mismatch!");
