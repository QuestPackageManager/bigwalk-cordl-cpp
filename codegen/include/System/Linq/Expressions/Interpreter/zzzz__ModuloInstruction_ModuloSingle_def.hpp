...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModuloInstruction_ModuloSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModuloInstruction_ModuloSingle*, "System.Linq.Expressions.Interpreter", "ModuloInstruction/ModuloSingle");
...
/// @brief Method Run, addr 0x181b29bb0, size 0x100, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ModuloInstruction_ModuloSingle) == 0x10, "Size mismatch!");
