...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_GetValue*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_GetValue*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/GetValue");
...
/// @brief Method Run, addr 0x181b26810, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_GetValue) == 0x10, "Size mismatch!");
