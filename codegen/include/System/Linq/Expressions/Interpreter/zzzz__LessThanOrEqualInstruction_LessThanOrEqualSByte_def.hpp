...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSByte*, "System.Linq.Expressions.Interpreter", "LessThanOrEqualInstruction/LessThanOrEqualSByte");
...
/// @brief Method Run, addr 0x181b12720, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualSByte) == 0x18, "Size mismatch!");
