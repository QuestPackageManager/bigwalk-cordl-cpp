...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotInstruction_NotUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotInstruction_NotUInt32*, "System.Linq.Expressions.Interpreter", "NotInstruction/NotUInt32");
...
/// @brief Method Run, addr 0x181b2e670, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotInstruction_NotUInt32) == 0x10, "Size mismatch!");
