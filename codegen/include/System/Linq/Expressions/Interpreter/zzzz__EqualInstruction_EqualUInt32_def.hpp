...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualUInt32*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualUInt32");
...
/// @brief Method Run, addr 0x181afa9b0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualUInt32) == 0x10, "Size mismatch!");
