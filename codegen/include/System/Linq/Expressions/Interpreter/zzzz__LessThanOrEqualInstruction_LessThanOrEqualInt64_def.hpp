...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt64*, "System.Linq.Expressions.Interpreter", "LessThanOrEqualInstruction/LessThanOrEqualInt64");
...
/// @brief Method Run, addr 0x181b12640, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanOrEqualInstruction_LessThanOrEqualInt64) == 0x18, "Size mismatch!");
