...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubOvfInstruction_SubOvfUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubOvfInstruction_SubOvfUInt64*, "System.Linq.Expressions.Interpreter", "SubOvfInstruction/SubOvfUInt64");
...
/// @brief Method Run, addr 0x181b32630, size 0x170, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubOvfInstruction_SubOvfUInt64) == 0x10, "Size mismatch!");
