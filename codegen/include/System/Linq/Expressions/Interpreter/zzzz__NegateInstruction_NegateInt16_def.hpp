...
// Write type traits
MARK_REF_T(::GlobalNamespace::NegateInstruction_NegateInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NegateInstruction_NegateInt16*, "System.Linq.Expressions.Interpreter", "NegateInstruction/NegateInt16");
...
/// @brief Method Run, addr 0x181b2c160, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NegateInstruction_NegateInt16) == 0x10, "Size mismatch!");
