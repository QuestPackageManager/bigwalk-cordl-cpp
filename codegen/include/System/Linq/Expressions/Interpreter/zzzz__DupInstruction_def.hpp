...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::DupInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::DupInstruction*, "System.Linq.Expressions.Interpreter", "DupInstruction");
...
/// @brief Method Run, addr 0x181b234b0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b23510, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::DupInstruction) == 0x10, "Size mismatch!");
