...
// Write type traits
MARK_REF_T(::GlobalNamespace::RightShiftInstruction_RightShiftInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RightShiftInstruction_RightShiftInt32*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction/RightShiftInt32");
...
/// @brief Method Run, addr 0x181b30650, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RightShiftInstruction_RightShiftInt32) == 0x10, "Size mismatch!");
