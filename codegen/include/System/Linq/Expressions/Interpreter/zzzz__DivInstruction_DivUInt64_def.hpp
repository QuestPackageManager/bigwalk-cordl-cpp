...
// Write type traits
MARK_REF_T(::GlobalNamespace::DivInstruction_DivUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DivInstruction_DivUInt64*, "System.Linq.Expressions.Interpreter", "DivInstruction/DivUInt64");
...
/// @brief Method Run, addr 0x181af86c0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DivInstruction_DivUInt64) == 0x10, "Size mismatch!");
