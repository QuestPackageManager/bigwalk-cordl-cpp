...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NullCheckInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NullCheckInstruction*, "System.Linq.Expressions.Interpreter", "NullCheckInstruction");
...
/// @brief Method Run, addr 0x181b2e760, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2e800, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NullCheckInstruction) == 0x10, "Size mismatch!");
