...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubInstruction_SubSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubInstruction_SubSingle*, "System.Linq.Expressions.Interpreter", "SubInstruction/SubSingle");
...
/// @brief Method Run, addr 0x181b327a0, size 0x100, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubInstruction_SubSingle) == 0x10, "Size mismatch!");
