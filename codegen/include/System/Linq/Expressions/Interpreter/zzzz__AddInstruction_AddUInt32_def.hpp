...
// Write type traits
MARK_REF_T(::GlobalNamespace::AddInstruction_AddUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AddInstruction_AddUInt32*, "System.Linq.Expressions.Interpreter", "AddInstruction/AddUInt32");
...
/// @brief Method Run, addr 0x181af45b0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AddInstruction_AddUInt32) == 0x10, "Size mismatch!");
