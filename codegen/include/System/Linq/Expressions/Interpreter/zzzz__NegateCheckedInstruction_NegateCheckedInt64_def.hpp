...
// Write type traits
MARK_REF_T(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt64*, "System.Linq.Expressions.Interpreter", "NegateCheckedInstruction/NegateCheckedInt64");
...
/// @brief Method Run, addr 0x181b2bda0, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt64) == 0x10, "Size mismatch!");
