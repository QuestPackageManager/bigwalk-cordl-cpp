...
// Write type traits
MARK_REF_T(::GlobalNamespace::ModuloInstruction_ModuloUInt64*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ModuloInstruction_ModuloUInt64*, "System.Linq.Expressions.Interpreter", "ModuloInstruction/ModuloUInt64");
...
/// @brief Method Run, addr 0x181b29e90, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ModuloInstruction_ModuloUInt64) == 0x10, "Size mismatch!");
