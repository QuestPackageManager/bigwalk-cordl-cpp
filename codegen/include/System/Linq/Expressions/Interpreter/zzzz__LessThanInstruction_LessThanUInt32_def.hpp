...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanUInt32*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanUInt32");
...
/// @brief Method Run, addr 0x181b12e40, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanUInt32) == 0x18, "Size mismatch!");
