...
// Write type traits
MARK_REF_T(::GlobalNamespace::RightShiftInstruction_RightShiftUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RightShiftInstruction_RightShiftUInt16*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction/RightShiftUInt16");
...
/// @brief Method Run, addr 0x181b30890, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RightShiftInstruction_RightShiftUInt16) == 0x10, "Size mismatch!");
