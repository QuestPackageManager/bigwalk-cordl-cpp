...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualChar*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualChar*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualChar");
...
/// @brief Method Run, addr 0x181b2c990, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualChar) == 0x10, "Size mismatch!");
