...
// Write type traits
MARK_REF_T(::GlobalNamespace::IncrementInstruction_IncrementDouble*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IncrementInstruction_IncrementDouble*, "System.Linq.Expressions.Interpreter", "IncrementInstruction/IncrementDouble");
...
/// @brief Method Run, addr 0x181b09cc0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::IncrementInstruction_IncrementDouble) == 0x10, "Size mismatch!");
