...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::DecrementInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::DecrementInstruction*, "System.Linq.Expressions.Interpreter", "DecrementInstruction");
...
/// @brief Method Create, addr 0x181af7580, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181af78d0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::DecrementInstruction) == 0x10, "Size mismatch!");
