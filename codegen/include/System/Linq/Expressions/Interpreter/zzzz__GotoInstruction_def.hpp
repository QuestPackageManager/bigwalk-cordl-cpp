...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::GotoInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::GotoInstruction*, "System.Linq.Expressions.Interpreter", "GotoInstruction");
...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::GotoInstruction*>  s_cache;

/// @brief Method Create, addr 0x181b00e90, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x181b00f90, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b01090, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  targetIndex, bool  hasResult, bool  hasValue, bool  labelTargetGetsValue) ;

static inline ::ArrayW<::System::Linq::Expressions::Interpreter::GotoInstruction*> getStaticF_s_cache() ;

/// @brief Method get_ConsumedStack, addr 0x181af5fa0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x181b010b0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x181af5fc0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_ProducedStack() ;

static inline void setStaticF_s_cache(::ArrayW<::System::Linq::Expressions::Interpreter::GotoInstruction*>  value) ;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::GotoInstruction) == 0x20, "Size mismatch!");
