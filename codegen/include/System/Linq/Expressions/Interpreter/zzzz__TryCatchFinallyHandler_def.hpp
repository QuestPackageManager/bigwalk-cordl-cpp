...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler*, "System.Linq.Expressions.Interpreter", "TryCatchFinallyHandler");
// Dependencies System.Linq.Expressions.Interpreter.ExceptionHandler, System.Object
namespace System::Linq::Expressions::Interpreter {
// Is value type: false
...
/// @brief Field GotoEndTargetIndex, offset 0x20, size 0x4 
 ...
 __declspec(property(get=get_Handlers)) ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  Handlers;
...
/// @brief Method FilterPasses, addr 0x181b1f7c0, size 0x150, virtual false, abstract: false, final false
static inline bool FilterPasses(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame, ::by_ref<::System::Object*>  exception, ::System::Linq::Expressions::Interpreter::ExceptionFilter*  filter) ;

/// @brief Method HasHandler, addr 0x181b1f910, size 0x140, virtual false, abstract: false, final false
inline bool HasHandler(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame, ::System::Exception*  exception, ::by_ref<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  handler, ::by_ref<::System::Object*>  unwrappedException) ;

static inline ::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* New_ctor(int32_t  tryStart, int32_t  tryEnd, int32_t  gotoEndLabelIndex, int32_t  finallyStart, int32_t  finallyEnd, ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  handlers) ;

static inline ::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* New_ctor(int32_t  tryStart, int32_t  tryEnd, int32_t  gotoEndTargetIndex, ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  handlers) ;
...
constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> const& __cordl_internal_get__handlers() const;

constexpr ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>& __cordl_internal_get__handlers() ;
...
/// @brief Method .ctor, addr 0x181b1fa50, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  tryStart, int32_t  tryEnd, int32_t  gotoEndLabelIndex, int32_t  finallyStart, int32_t  finallyEnd, ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  handlers) ;

/// @brief Method .ctor, addr 0x181b1fa80, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Handlers, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*> get_Handlers() ;

/// @brief Method get_IsCatchBlockExist, addr 0x181610d30, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCatchBlockExist() ;

/// @brief Method get_IsFinallyBlockExist, addr 0x181b1fab0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _handlers, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::Linq::Expressions::Interpreter::ExceptionHandler*>  ____handlers;
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler) == 0x30, "Size mismatch!");
