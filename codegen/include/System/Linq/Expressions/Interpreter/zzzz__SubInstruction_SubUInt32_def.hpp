...
// Write type traits
MARK_REF_T(::GlobalNamespace::SubInstruction_SubUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SubInstruction_SubUInt32*, "System.Linq.Expressions.Interpreter", "SubInstruction/SubUInt32");
...
/// @brief Method Run, addr 0x181b32990, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SubInstruction_SubUInt32) == 0x10, "Size mismatch!");
