...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::EnterExceptionFilterInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::EnterExceptionFilterInstruction*, "System.Linq.Expressions.Interpreter", "EnterExceptionFilterInstruction");
...
/// @brief Method get_InstructionName, addr 0x181af8810, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::EnterExceptionFilterInstruction) == 0x10, "Size mismatch!");
