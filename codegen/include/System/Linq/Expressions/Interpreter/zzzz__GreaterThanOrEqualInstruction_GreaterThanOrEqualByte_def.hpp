...
// Write type traits
MARK_REF_T(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualByte*, "System.Linq.Expressions.Interpreter", "GreaterThanOrEqualInstruction/GreaterThanOrEqualByte");
...
/// @brief Method Run, addr 0x181b082b0, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GreaterThanOrEqualInstruction_GreaterThanOrEqualByte) == 0x18, "Size mismatch!");
