...
// Write type traits
MARK_REF_T(::GlobalNamespace::DivInstruction_DivInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DivInstruction_DivInt16*, "System.Linq.Expressions.Interpreter", "DivInstruction/DivInt16");
...
/// @brief Method Run, addr 0x181af8120, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DivInstruction_DivInt16) == 0x10, "Size mismatch!");
