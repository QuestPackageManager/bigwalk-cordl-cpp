...
// Write type traits
MARK_REF_T(::GlobalNamespace::LessThanInstruction_LessThanByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LessThanInstruction_LessThanByte*, "System.Linq.Expressions.Interpreter", "LessThanInstruction/LessThanByte");
...
/// @brief Method Run, addr 0x181b10460, size 0xe0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LessThanInstruction_LessThanByte) == 0x18, "Size mismatch!");
