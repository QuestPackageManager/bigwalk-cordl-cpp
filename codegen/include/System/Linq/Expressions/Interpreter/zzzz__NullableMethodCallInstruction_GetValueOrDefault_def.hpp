...
// Write type traits
MARK_REF_T(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/GetValueOrDefault");
...
/// @brief Method Run, addr 0x181b26770, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b267d0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NullableMethodCallInstruction_GetValueOrDefault) == 0x18, "Size mismatch!");
