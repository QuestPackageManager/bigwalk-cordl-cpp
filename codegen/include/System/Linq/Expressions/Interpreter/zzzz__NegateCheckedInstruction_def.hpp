...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::NegateCheckedInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::NegateCheckedInstruction*, "System.Linq.Expressions.Interpreter", "NegateCheckedInstruction");
...
/// @brief Method Create, addr 0x181b2b9f0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2bb40, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::NegateCheckedInstruction) == 0x10, "Size mismatch!");
