...
// Write type traits
MARK_REF_T(::GlobalNamespace::EqualInstruction_EqualInt64LiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EqualInstruction_EqualInt64LiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualInt64LiftedToNull");
...
/// @brief Method Run, addr 0x181afa2d0, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EqualInstruction_EqualInt64LiftedToNull) == 0x10, "Size mismatch!");
