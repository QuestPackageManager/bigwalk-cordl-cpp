...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::SubOvfInstruction_SubOvfUInt64::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::SubOvfInstruction_SubOvfUInt64::Run)> {
  constexpr static std::size_t size = 0x170;
  constexpr static std::size_t addrs = 0x181b32630;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::SubOvfInstruction_SubOvfUInt64*>(),
                    {::i2c::class_of<::GlobalNamespace::SubOvfInstruction_SubOvfUInt64*>(), 8}
                ));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SubOvfInstruction_SubOvfUInt64::*)()>(&::GlobalNamespace::SubOvfInstruction_SubOvfUInt64::_ctor)> {
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::SubOvfInstruction_SubOvfUInt64*>());
}
// Ctor Parameters []
