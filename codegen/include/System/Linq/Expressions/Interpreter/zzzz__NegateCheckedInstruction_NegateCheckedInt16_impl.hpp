...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::Run)> {
  constexpr static std::size_t size = 0x150;
  constexpr static std::size_t addrs = 0x181b2bb50;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*>(),
                    {::i2c::class_of<::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*>(), 8}
                ));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::*)()>(&::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16::_ctor)> {
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NegateCheckedInstruction_NegateCheckedInt16*>());
}
// Ctor Parameters []
