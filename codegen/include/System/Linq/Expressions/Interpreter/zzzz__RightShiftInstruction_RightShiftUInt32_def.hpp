...
// Write type traits
MARK_REF_T(::GlobalNamespace::RightShiftInstruction_RightShiftUInt32*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RightShiftInstruction_RightShiftUInt32*, "System.Linq.Expressions.Interpreter", "RightShiftInstruction/RightShiftUInt32");
...
/// @brief Method Run, addr 0x181b30950, size 0xc0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RightShiftInstruction_RightShiftUInt32) == 0x10, "Size mismatch!");
