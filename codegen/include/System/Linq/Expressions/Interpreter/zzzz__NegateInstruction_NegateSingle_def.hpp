...
// Write type traits
MARK_REF_T(::GlobalNamespace::NegateInstruction_NegateSingle*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NegateInstruction_NegateSingle*, "System.Linq.Expressions.Interpreter", "NegateInstruction/NegateSingle");
...
/// @brief Method Run, addr 0x181b2c2c0, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NegateInstruction_NegateSingle) == 0x10, "Size mismatch!");
