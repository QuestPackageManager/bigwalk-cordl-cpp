...
// Write type traits
MARK_REF_T(::GlobalNamespace::MulInstruction_MulUInt16*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MulInstruction_MulUInt16*, "System.Linq.Expressions.Interpreter", "MulInstruction/MulUInt16");
...
/// @brief Method Run, addr 0x181b2b570, size 0xf0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MulInstruction_MulUInt16) == 0x10, "Size mismatch!");
