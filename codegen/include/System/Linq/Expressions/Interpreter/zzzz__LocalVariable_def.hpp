...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::LocalVariable*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::LocalVariable*, "System.Linq.Expressions.Interpreter", "LocalVariable");
...
/// @brief Method ToString, addr 0x181b28c90, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b28d10, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, bool  closure) ;

/// @brief Method get_InClosure, addr 0x181b28d20, size 0x10, virtual false, abstract: false, final false
inline bool get_InClosure() ;

/// @brief Method get_IsBoxed, addr 0x181b28d30, size 0x10, virtual false, abstract: false, final false
inline bool get_IsBoxed() ;

/// @brief Method set_IsBoxed, addr 0x181b28d40, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::LocalVariable) == 0x18, "Size mismatch!");
