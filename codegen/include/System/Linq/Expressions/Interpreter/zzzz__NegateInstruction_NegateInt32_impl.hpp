...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::GlobalNamespace::NegateInstruction_NegateInt32::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::NegateInstruction_NegateInt32::Run)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x181b2c1d0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::NegateInstruction_NegateInt32*>(),
                    {::i2c::class_of<::GlobalNamespace::NegateInstruction_NegateInt32*>(), 8}
                ));
