...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualSByte*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualSByte*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualSByte");
...
/// @brief Method Run, addr 0x181b2d9e0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualSByte) == 0x10, "Size mismatch!");
