...
/// @brief Method Run, addr 0x181b2b660, size 0xf0, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulUInt32", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
MulInstruction_MulUInt32(MulInstruction_MulUInt32 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "MulInstruction_MulUInt32", modifiers: "const&", def_value: None }]
