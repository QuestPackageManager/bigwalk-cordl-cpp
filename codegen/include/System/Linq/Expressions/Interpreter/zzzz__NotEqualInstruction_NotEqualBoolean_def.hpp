...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualBoolean*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualBoolean*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualBoolean");
...
/// @brief Method Run, addr 0x181b2c6b0, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualBoolean) == 0x10, "Size mismatch!");
