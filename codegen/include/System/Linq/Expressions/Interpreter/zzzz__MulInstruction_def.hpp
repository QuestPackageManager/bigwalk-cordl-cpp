...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Interpreter::MulInstruction*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Interpreter::MulInstruction*, "System.Linq.Expressions.Interpreter", "MulInstruction");
...
/// @brief Method Create, addr 0x181b2a080, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method get_InstructionName, addr 0x181b2a3d0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Interpreter::MulInstruction) == 0x10, "Size mismatch!");
