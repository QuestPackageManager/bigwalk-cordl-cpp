...
// Write type traits
MARK_REF_T(::GlobalNamespace::NotEqualInstruction_NotEqualInt32LiftedToNull*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NotEqualInstruction_NotEqualInt32LiftedToNull*, "System.Linq.Expressions.Interpreter", "NotEqualInstruction/NotEqualInt32LiftedToNull");
...
/// @brief Method Run, addr 0x181b2d600, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NotEqualInstruction_NotEqualInt32LiftedToNull) == 0x10, "Size mismatch!");
