...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpression3*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpression3*, "System.Linq.Expressions", "MethodCallExpression3");
...
/// @brief Method GetArgument, addr 0x181b02240, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x181b02290, size 0xd0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpression3) == 0x30, "Size mismatch!");
