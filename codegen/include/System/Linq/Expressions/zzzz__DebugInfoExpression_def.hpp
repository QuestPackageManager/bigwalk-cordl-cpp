...
/// @brief Method get_Document, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::SymbolDocumentInfo* get_Document() ;

/// @brief Method get_EndLine, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final false
inline int32_t get_EndLine() ;

/// @brief Method get_IsClear, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final false
inline bool get_IsClear() ;

/// @brief Method get_StartLine, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final false
