...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::RuntimeVariablesExpression*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::RuntimeVariablesExpression*, "System.Linq.Expressions", "RuntimeVariablesExpression");
...
/// @brief Field <Variables>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Variables_k__BackingField, put=__cordl_internal_set__Variables_k__BackingField)) ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*  _Variables_k__BackingField;
...
/// @brief Method get_Variables, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::RuntimeVariablesExpression) == 0x18, "Size mismatch!");
