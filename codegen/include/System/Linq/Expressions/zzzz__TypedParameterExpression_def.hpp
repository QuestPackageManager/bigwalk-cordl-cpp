...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::TypedParameterExpression*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::TypedParameterExpression*, "System.Linq.Expressions", "TypedParameterExpression");
...
/// @brief Method get_Type, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Linq::Expressions::TypedParameterExpression) == 0x20, "Size mismatch!");
