...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::FullExpression_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::FullExpression_1, "System.Linq.Expressions", "FullExpression`1");
...
static inline ::System::Linq::Expressions::FullExpression_1<TDelegate>* New_ctor(::System::Linq::Expressions::Expression*  body, ::StringW  name, bool  tailCall, ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>*  parameters) ;
...
inline void _ctor(::System::Linq::Expressions::Expression*  body, ::StringW  name, bool  tailCall, ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>*  parameters) ;
