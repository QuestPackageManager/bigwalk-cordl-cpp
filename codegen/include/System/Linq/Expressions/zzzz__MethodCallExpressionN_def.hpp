...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MethodCallExpressionN*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MethodCallExpressionN*, "System.Linq.Expressions", "MethodCallExpressionN");
...
/// @brief Method GetArgument, addr 0x181b02700, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x181b02720, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method get_ArgumentCount, addr 0x181b02740, size 0x20, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::MethodCallExpressionN) == 0x20, "Size mismatch!");
