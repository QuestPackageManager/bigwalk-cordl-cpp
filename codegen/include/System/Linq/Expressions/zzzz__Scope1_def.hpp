...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::Scope1*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::Scope1*, "System.Linq.Expressions", "Scope1");
...
/// @brief Method GetExpression, addr 0x181b03550, size 0x40, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x181b03590, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>* GetOrMakeExpressions() ;

static inline ::System::Linq::Expressions::Scope1* New_ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>*  variables, ::System::Linq::Expressions::Expression*  body) ;
...
/// @brief Method Rewrite, addr 0x181b035a0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::Scope1) == 0x20, "Size mismatch!");
