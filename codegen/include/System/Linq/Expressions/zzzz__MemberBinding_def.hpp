...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::MemberBinding*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::MemberBinding*, "System.Linq.Expressions", "MemberBinding");
// Dependencies System.Linq.Expressions.MemberBindingType, System.Object
namespace System::Linq::Expressions {
// Is value type: false
...
/// @brief Field <BindingType>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__BindingType_k__BackingField, put=__cordl_internal_set__BindingType_k__BackingField)) ::System::Linq::Expressions::MemberBindingType  _BindingType_k__BackingField;
...
constexpr ::System::Reflection::MemberInfo* const& __cordl_internal_get__Member_k__BackingField() const;
...
/// @brief Method get_BindingType, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::MemberBindingType get_BindingType() ;

/// @brief Method get_Member, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::MemberBinding) == 0x20, "Size mismatch!");
