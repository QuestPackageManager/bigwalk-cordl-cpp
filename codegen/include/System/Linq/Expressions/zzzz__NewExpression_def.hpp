...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::NewExpression*);
DEFINE_IL2CPP_CLASS(::System::Linq::Expressions::NewExpression*, "System.Linq.Expressions", "NewExpression");
...
/// @brief Field <Constructor>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Constructor_k__BackingField, put=__cordl_internal_set__Constructor_k__BackingField)) ::System::Reflection::ConstructorInfo*  _Constructor_k__BackingField;
...
/// @brief Method get_Constructor, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Linq::Expressions::NewExpression) == 0x20, "Size mismatch!");
