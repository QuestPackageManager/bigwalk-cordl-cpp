...
// Write type traits
MARK_REF_T(::System::Linq::Expressions::BlockExpressionList*);
...
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_System_Linq_Expressions_Expression__get_Current)) ::System::Linq::Expressions::Expression*  System_Collections_Generic_IEnumerator_System_Linq_Expressions_Expression__Current;
...
/// @brief Method MoveNext, addr 0x181b04bb0, size 0xe0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::System::Linq::Expressions::BlockExpressionList__GetEnumerator_d__18* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Linq.Expressions.Expression>.get_Current, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::IEnumerator_1<::System::Linq::Expressions::Expression*>* i___System__Collections__Generic__IEnumerator_1___System__Linq__Expressions__Expression__() noexcept;
...
/// @brief Method Add, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
inline void Add(::System::Linq::Expressions::Expression*  item) ;

/// @brief Method Clear, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x181af5780, size 0xa0, virtual true, abstract: false, final true
inline bool Contains(::System::Linq::Expressions::Expression*  item) ;

/// @brief Method CopyTo, addr 0x181af5820, size 0x130, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::System::Linq::Expressions::Expression*>  array, int32_t  index) ;

/// @brief Method GetEnumerator, addr 0x181af5950, size 0x50, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::System::Linq::Expressions::Expression*>* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x181af59a0, size 0xb0, virtual true, abstract: false, final true
inline int32_t IndexOf(::System::Linq::Expressions::Expression*  item) ;

/// @brief Method Insert, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
inline bool Remove(::System::Linq::Expressions::Expression*  item) ;

/// @brief Method RemoveAt, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
inline void RemoveAt(int32_t  index) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181af5950, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method get_Count, addr 0x18165ba90, size 0x20, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Item, addr 0x181af5a50, size 0x30, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::ICollection_1<::System::Linq::Expressions::Expression*>* i___System__Collections__Generic__ICollection_1___System__Linq__Expressions__Expression__() noexcept;

/// @brief Convert to "::System::Collections::Generic::IEnumerable_1<::System::Linq::Expressions::Expression*>"
constexpr ::System::Collections::Generic::IEnumerable_1<::System::Linq::Expressions::Expression*>* i___System__Collections__Generic__IEnumerable_1___System__Linq__Expressions__Expression__() noexcept;
...
/// @brief Method set_Item, addr 0x18139c290, size 0x4e0, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Linq::Expressions::BlockExpressionList) == 0x20, "Size mismatch!");
