...
#include <cstdint>
CORDL_MODULE_EXPORT(Expression3_1)
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::Expressions::Expression3_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Linq::Expressions::Expression3_1, "System.Linq.Expressions", "Expression3`1");
// Dependencies System.Linq.Expressions.Expression`1<TDelegate>
namespace System::Linq::Expressions {
// cpp template
template<typename TDelegate>
// Is value type: false
// CS Name: System.Linq.Expressions.Expression3`1<TDelegate>
class CORDL_TYPE Expression3_1 : public ::System::Linq::Expressions::Expression_1<TDelegate> {
public:
// Declarations
...
/// @brief Field _par2, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__par2, put=__cordl_internal_set__par2)) ::System::Linq::Expressions::ParameterExpression*  _par2;
...
static inline ::System::Linq::Expressions::Expression3_1<TDelegate>* New_ctor(::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::ParameterExpression*  par0, ::System::Linq::Expressions::ParameterExpression*  par1, ::System::Linq::Expressions::ParameterExpression*  par2) ;
...
constexpr ::System::Linq::Expressions::ParameterExpression* const& __cordl_internal_get__par2() const;

constexpr ::System::Linq::Expressions::ParameterExpression*& __cordl_internal_get__par2() ;
...
constexpr void __cordl_internal_set__par2(::System::Linq::Expressions::ParameterExpression*  value) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  body, ::System::Linq::Expressions::ParameterExpression*  par0, ::System::Linq::Expressions::ParameterExpression*  par1, ::System::Linq::Expressions::ParameterExpression*  par2) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr Expression3_1() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "Expression3_1", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
Expression3_1(Expression3_1 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "Expression3_1", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
Expression3_1(Expression3_1 const& ) = delete;
...
/// @brief Field _par2, offset: 0x28, size: 0x8, def value: None
 ::System::Linq::Expressions::ParameterExpression*  ____par2;
