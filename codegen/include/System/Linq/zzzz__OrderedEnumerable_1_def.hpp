...
namespace System::Linq {
template<typename TElement>
class OrderedEnumerable_1__GetEnumerator_d__1;
}
namespace System {
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Linq::OrderedEnumerable_1);
...
/// @brief Field <map>5__3, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__map_5__3, put=__cordl_internal_set__map_5__3)) ::ArrayW<int32_t>  _map_5__3;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__map_5__3() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__map_5__3() ;
