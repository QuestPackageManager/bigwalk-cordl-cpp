...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Runtime::CompilerServices::TrueReadOnlyCollection_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Runtime::CompilerServices::TrueReadOnlyCollection_1, "System.Runtime.CompilerServices", "TrueReadOnlyCollection`1");
...
public:
// Declarations
static inline ::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>* New_ctor(::ArrayW<T>  list) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<T>  list) ;
