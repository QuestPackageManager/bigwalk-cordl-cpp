...
/// @brief Method Create, addr 0x180cd1680, size 0x40, virtual false, abstract: false, final false
static inline ::System::Runtime::CompilerServices::AsyncValueTaskMethodBuilder Create() ;

/// @brief Method SetException, addr 0x1816620a0, size 0x20, virtual false, abstract: false, final false
inline void SetException(::System::Exception*  exception) ;

/// @brief Method SetResult, addr 0x1816621b0, size 0x70, virtual false, abstract: false, final false
inline void SetResult() ;

/// @brief Method SetStateMachine, addr 0x180534dc0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_Task, addr 0x181662220, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::CompilerServices::AsyncValueTaskMethodBuilder) == 0x20, "Size mismatch!");
