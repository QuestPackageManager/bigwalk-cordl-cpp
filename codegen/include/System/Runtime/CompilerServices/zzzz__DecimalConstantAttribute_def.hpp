...
/// @brief Method .ctor, addr 0x181662d60, size 0x50, virtual false, abstract: false, final false
inline void _ctor(uint8_t  scale, uint8_t  sign, uint32_t  hi, uint32_t  mid, uint32_t  low) ;

/// @brief Method get_Value, addr 0x1802e5810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::CompilerServices::DecimalConstantAttribute) == 0x20, "Size mismatch!");
