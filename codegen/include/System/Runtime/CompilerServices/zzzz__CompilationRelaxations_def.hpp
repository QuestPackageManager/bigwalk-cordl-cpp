...
static_assert(offsetof(::System::Runtime::CompilerServices::CompilationRelaxations, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::CompilerServices::CompilationRelaxations) == 0x4, "Size mismatch!");
