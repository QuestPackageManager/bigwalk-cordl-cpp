...
/// @brief Method .ctor, addr 0x1816644c0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  assemblyName) ;

/// @brief Method set_AllInternalsVisible, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
