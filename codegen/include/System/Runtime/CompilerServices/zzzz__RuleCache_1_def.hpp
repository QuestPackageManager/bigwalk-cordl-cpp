...
/// @brief Field _rules, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__rules, put=__cordl_internal_set__rules)) ::ArrayW<T>  _rules;

/// @brief Method AddOrInsert, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline ::ArrayW<T> AddOrInsert(::ArrayW<T>  rules, T  item) ;
...
constexpr ::System::Object* const& __cordl_internal_get__cacheLock() const;

constexpr ::System::Object*& __cordl_internal_get__cacheLock() ;

constexpr ::ArrayW<T> const& __cordl_internal_get__rules() const;

constexpr ::ArrayW<T>& __cordl_internal_get__rules() ;

constexpr void __cordl_internal_set__cacheLock(::System::Object*  value) ;

constexpr void __cordl_internal_set__rules(::ArrayW<T>  value) ;
