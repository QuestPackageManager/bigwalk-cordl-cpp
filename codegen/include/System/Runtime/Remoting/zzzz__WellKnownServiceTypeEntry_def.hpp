...
/// @brief Method ToString, addr 0x1816330a0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181633130, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method get_Mode, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_ObjectUri, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::WellKnownServiceTypeEntry) == 0x38, "Size mismatch!");
