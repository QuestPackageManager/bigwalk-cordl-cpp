...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Lifetime::Lease*);
MARK_REF_T(::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Lifetime::Lease*, "System.Runtime.Remoting.Lifetime", "Lease");
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate*, "System.Runtime.Remoting.Lifetime", "Lease/RenewalDelegate");
...
static_assert(sizeof(::System::Runtime::Remoting::Lifetime::Lease_RenewalDelegate) == 0x80, "Size mismatch!");
...
/// @brief Method Activate, addr 0x181626fc0, size 0x10, virtual false, abstract: false, final false
inline void Activate() ;

/// @brief Method CheckNextSponsor, addr 0x181626fd0, size 0x310, virtual false, abstract: false, final false
inline void CheckNextSponsor() ;

static inline ::System::Runtime::Remoting::Lifetime::Lease* New_ctor() ;

/// @brief Method ProcessSponsorResponse, addr 0x1816272e0, size 0x1a0, virtual false, abstract: false, final false
inline void ProcessSponsorResponse(::System::Object*  state, bool  timedOut) ;

/// @brief Method Renew, addr 0x181627480, size 0x70, virtual true, abstract: false, final true
inline ::System::TimeSpan Renew(::System::TimeSpan  renewalTime) ;

/// @brief Method Unregister, addr 0x1816274f0, size 0x120, virtual true, abstract: false, final true
inline void Unregister(::System::Runtime::Remoting::Lifetime::ISponsor*  obj) ;

/// @brief Method UpdateState, addr 0x181627610, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181627760, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CurrentLeaseTime, addr 0x181627840, size 0x30, virtual true, abstract: false, final true
inline ::System::TimeSpan get_CurrentLeaseTime() ;

/// @brief Method get_CurrentState, addr 0x180396ee0, size 0x10, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Lifetime::LeaseState get_CurrentState() ;

/// @brief Method get_RenewOnCallTime, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Lifetime::Lease) == 0x58, "Size mismatch!");
