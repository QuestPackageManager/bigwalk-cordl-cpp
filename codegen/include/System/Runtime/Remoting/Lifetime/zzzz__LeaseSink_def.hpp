...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Lifetime::LeaseSink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Lifetime::LeaseSink*, "System.Runtime.Remoting.Lifetime", "LeaseSink");
...
/// @brief Method AsyncProcessMessage, addr 0x181626dd0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method RenewLease, addr 0x181626e20, size 0x160, virtual false, abstract: false, final false
inline void RenewLease(::System::Runtime::Remoting::Messaging::IMessage*  msg) ;

/// @brief Method SyncProcessMessage, addr 0x181626f80, size 0x40, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Lifetime::LeaseSink) == 0x18, "Size mismatch!");
