...
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Lifetime::LeaseState, "System.Runtime.Remoting.Lifetime", "LeaseState");
// Dependencies 
namespace System::Runtime::Remoting::Lifetime {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Remoting::Lifetime::LeaseState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Remoting::Lifetime::LeaseState) == 0x4, "Size mismatch!");
