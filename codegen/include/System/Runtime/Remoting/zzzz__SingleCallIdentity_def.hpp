...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::SingleCallIdentity*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::SingleCallIdentity*, "System.Runtime.Remoting", "SingleCallIdentity");
...
public:
// Declarations
/// @brief Method AsyncObjectProcessMessage, addr 0x1816301d0, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method SyncObjectProcessMessage, addr 0x181630310, size 0x130, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::SingleCallIdentity) == 0x70, "Size mismatch!");
