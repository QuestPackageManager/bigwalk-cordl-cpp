...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::ProviderData*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::ProviderData*, "System.Runtime.Remoting", "ProviderData");
...
/// @brief Method CopyFrom, addr 0x181628430, size 0x530, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::ProviderData) == 0x38, "Size mismatch!");
