...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::ChannelInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::ChannelInfo*, "System.Runtime.Remoting", "ChannelInfo");
...
/// @brief Field channelData, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_channelData, put=__cordl_internal_set_channelData)) ::ArrayW<::System::Object*>  channelData;
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_channelData() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_channelData() ;

constexpr void __cordl_internal_set_channelData(::ArrayW<::System::Object*>  value) ;

/// @brief Method .ctor, addr 0x18161e5f0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x18161e620, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  remoteChannelData) ;

/// @brief Method get_ChannelData, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Field channelData, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___channelData;
...
static_assert(sizeof(::System::Runtime::Remoting::ChannelInfo) == 0x18, "Size mismatch!");
