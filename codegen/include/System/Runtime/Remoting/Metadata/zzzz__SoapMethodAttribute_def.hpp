...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Metadata::SoapMethodAttribute*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Metadata::SoapMethodAttribute*, "System.Runtime.Remoting.Metadata", "SoapMethodAttribute");
...
/// @brief Method SetReflectionObject, addr 0x18164b9c0, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method get_UseAttribute, addr 0x1802fdd10, size 0x10, virtual true, abstract: false, final false
inline bool get_UseAttribute() ;

/// @brief Method get_XmlNamespace, addr 0x1802e0b30, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Metadata::SoapMethodAttribute) == 0x58, "Size mismatch!");
