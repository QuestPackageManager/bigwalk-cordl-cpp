...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::CADObjRef*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::CADObjRef*, "System.Runtime.Remoting.Messaging", "CADObjRef");
...
/// @brief Field TypeInfo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_TypeInfo, put=__cordl_internal_set_TypeInfo)) ::ArrayW<uint8_t>  TypeInfo;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_TypeInfo() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_TypeInfo() ;
...
constexpr void __cordl_internal_set_TypeInfo(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_objref(::System::Runtime::Remoting::ObjRef*  value) ;

/// @brief Method .ctor, addr 0x1816397d0, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::CADObjRef) == 0x28, "Size mismatch!");
