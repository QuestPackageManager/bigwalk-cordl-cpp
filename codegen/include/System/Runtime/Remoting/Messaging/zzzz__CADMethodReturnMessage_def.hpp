...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*, "System.Runtime.Remoting.Messaging", "CADMethodReturnMessage");
// Dependencies System.Runtime.Remoting.Messaging.CADMessageBase, System.Type
namespace System::Runtime::Remoting::Messaging {
// Is value type: false
...
/// @brief Method Create, addr 0x181639430, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetArgs, addr 0x181638b60, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*> GetArgs(::System::Collections::ArrayList*  args) ;

/// @brief Method GetArguments, addr 0x181638b70, size 0xf0, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* GetArguments() ;

/// @brief Method GetException, addr 0x181639480, size 0x80, virtual false, abstract: false, final false
inline ::System::Exception* GetException(::System::Collections::ArrayList*  args) ;

/// @brief Method GetReturnValue, addr 0x181639500, size 0x10, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get__sig() const;

constexpr ::ArrayW<::System::Type*>& __cordl_internal_get__sig() ;
...
/// @brief Method .ctor, addr 0x181639510, size 0x2c0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Remoting::Messaging::IMethodReturnMessage*  retMsg) ;

/// @brief Method get_PropertiesCount, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::CADMethodReturnMessage) == 0x50, "Size mismatch!");
