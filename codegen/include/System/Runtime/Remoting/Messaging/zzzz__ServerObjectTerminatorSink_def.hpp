...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::ServerObjectTerminatorSink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ServerObjectTerminatorSink*, "System.Runtime.Remoting.Messaging", "ServerObjectTerminatorSink");
...
/// @brief Method AsyncProcessMessage, addr 0x18164b690, size 0x150, virtual true, abstract: false, final true
...
/// @brief Method SyncProcessMessage, addr 0x18164b7e0, size 0xe0, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::ServerObjectTerminatorSink) == 0x18, "Size mismatch!");
