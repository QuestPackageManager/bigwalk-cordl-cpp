...
/// @brief Method GetArg, addr 0x18164a410, size 0x10, virtual true, abstract: false, final true
...
static inline ::System::Runtime::Remoting::Messaging::ReturnMessage* New_ctor(::System::Object*  ret, ::ArrayW<::System::Object*>  outArgs, int32_t  outArgsCount, ::System::Runtime::Remoting::Messaging::LogicalCallContext*  callCtx, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  mcm) ;
...
/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri, addr 0x1802d9830, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x18164a420, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  mcm) ;

/// @brief Method .ctor, addr 0x18164a4c0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  ret, ::ArrayW<::System::Object*>  outArgs, int32_t  outArgsCount, ::System::Runtime::Remoting::Messaging::LogicalCallContext*  callCtx, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  mcm) ;

/// @brief Method get_ArgCount, addr 0x180df9d80, size 0x600, virtual true, abstract: false, final true
...
/// @brief Method get_LogicalCallContext, addr 0x18164a590, size 0x40, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext() ;

/// @brief Method get_MethodBase, addr 0x1802e5850, size 0x10, virtual true, abstract: false, final true
inline ::System::Reflection::MethodBase* get_MethodBase() ;

/// @brief Method get_MethodName, addr 0x18164a5d0, size 0x60, virtual true, abstract: false, final true
inline ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature, addr 0x18164a630, size 0xf0, virtual true, abstract: false, final true
inline ::System::Object* get_MethodSignature() ;

/// @brief Method get_OutArgs, addr 0x18164a720, size 0xa0, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*> get_OutArgs() ;

/// @brief Method get_Properties, addr 0x18164a7c0, size 0xb0, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* get_Properties() ;

/// @brief Method get_ReturnValue, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* get_ReturnValue() ;

/// @brief Method get_TypeName, addr 0x18164a870, size 0x70, virtual true, abstract: false, final true
inline ::StringW get_TypeName() ;

/// @brief Method get_Uri, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method set_Uri, addr 0x1802d9830, size 0x10, virtual false, abstract: false, final false
