...
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ArgInfoType, "System.Runtime.Remoting.Messaging", "ArgInfoType");
// Dependencies 
namespace System::Runtime::Remoting::Messaging {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Remoting::Messaging::ArgInfoType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Remoting::Messaging::ArgInfoType) == 0x1, "Size mismatch!");
