...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Runtime::Remoting::Messaging::CADObjRef::*)(::System::Runtime::Remoting::ObjRef*, int32_t)>(&::System::Runtime::Remoting::Messaging::CADObjRef::_ctor)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x1816397d0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::Runtime::Remoting::Messaging::CADObjRef*>(),
                        {".ctor", {}, {::i2c::type_of<::System::Runtime::Remoting::ObjRef*>(), ::i2c::type_of<int32_t>()}}
                    )));
...
constexpr ::System::Runtime::Remoting::ObjRef* const& System::Runtime::Remoting::Messaging::CADObjRef::__cordl_internal_get_objref() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___objref;
}
...
constexpr ::ArrayW<uint8_t>& System::Runtime::Remoting::Messaging::CADObjRef::__cordl_internal_get_TypeInfo()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___TypeInfo;
}
constexpr ::ArrayW<uint8_t> const& System::Runtime::Remoting::Messaging::CADObjRef::__cordl_internal_get_TypeInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___TypeInfo;
}
constexpr void System::Runtime::Remoting::Messaging::CADObjRef::__cordl_internal_set_TypeInfo(::ArrayW<uint8_t>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, o, sourceDomain);
}
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::System::Runtime::Remoting::Messaging::CADObjRef*>(o, sourceDomain));
}
// Ctor Parameters []
