...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Messaging::ClientContextTerminatorSink*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Messaging::ClientContextTerminatorSink*, "System.Runtime.Remoting.Messaging", "ClientContextTerminatorSink");
...
/// @brief Method AsyncProcessMessage, addr 0x18163bad0, size 0x160, virtual true, abstract: false, final true
...
/// @brief Method SyncProcessMessage, addr 0x18163bc30, size 0x120, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Messaging::ClientContextTerminatorSink) == 0x18, "Size mismatch!");
