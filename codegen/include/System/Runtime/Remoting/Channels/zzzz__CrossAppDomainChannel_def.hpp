...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Channels::CrossAppDomainChannel*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Channels::CrossAppDomainChannel*, "System.Runtime.Remoting.Channels", "CrossAppDomainChannel");
...
/// @brief Method CreateMessageSink, addr 0x18163d0f0, size 0xd0, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* CreateMessageSink(::StringW  url, ::System::Object*  data, ::by_ref<::StringW>  uri) ;

static inline ::System::Runtime::Remoting::Channels::CrossAppDomainChannel* New_ctor() ;

/// @brief Method RegisterCrossAppDomainChannel, addr 0x18163d1c0, size 0xd0, virtual false, abstract: false, final false
static inline void RegisterCrossAppDomainChannel() ;

/// @brief Method StartListening, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_ChannelData, addr 0x18163d2d0, size 0x80, virtual true, abstract: false, final false
inline ::System::Object* get_ChannelData() ;

/// @brief Method get_ChannelName, addr 0x18163d350, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_ChannelName() ;

/// @brief Method get_ChannelPriority, addr 0x180908b70, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Channels::CrossAppDomainChannel) == 0x10, "Size mismatch!");
