...
/// @brief Method .ctor, addr 0x18164b8c0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Children, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Channels::SinkProviderData) == 0x28, "Size mismatch!");
