...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Channels::CrossAppDomainData*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Channels::CrossAppDomainData*, "System.Runtime.Remoting.Channels", "CrossAppDomainData");
...
/// @brief Method .ctor, addr 0x18163d360, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  domainId) ;

/// @brief Method get_DomainID, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_DomainID() ;

/// @brief Method get_ProcessID, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::Channels::CrossAppDomainData) == 0x28, "Size mismatch!");
