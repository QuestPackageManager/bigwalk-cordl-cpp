...
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::WellKnownObjectMode, "System.Runtime.Remoting", "WellKnownObjectMode");
// Dependencies 
namespace System::Runtime::Remoting {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Remoting::WellKnownObjectMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Remoting::WellKnownObjectMode) == 0x4, "Size mismatch!");
