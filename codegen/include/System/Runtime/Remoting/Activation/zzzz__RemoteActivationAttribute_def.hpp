...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::Activation::RemoteActivationAttribute*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::Activation::RemoteActivationAttribute*, "System.Runtime.Remoting.Activation", "RemoteActivationAttribute");
...
/// @brief Method GetPropertiesForNewContext, addr 0x181649ca0, size 0x280, virtual true, abstract: false, final true
inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage*  ctor) ;

/// @brief Method IsContextOK, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Remoting::Activation::RemoteActivationAttribute) == 0x18, "Size mismatch!");
