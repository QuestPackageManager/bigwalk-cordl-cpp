...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::TypeInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::TypeInfo*, "System.Runtime.Remoting", "TypeInfo");
...
/// @brief Field interfacesImplemented, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_interfacesImplemented, put=__cordl_internal_set_interfacesImplemented)) ::ArrayW<::StringW>  interfacesImplemented;

/// @brief Field serverHierarchy, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_serverHierarchy, put=__cordl_internal_set_serverHierarchy)) ::ArrayW<::StringW>  serverHierarchy;
...
/// @brief Method CanCastTo, addr 0x181632710, size 0x1b0, virtual true, abstract: false, final true
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_interfacesImplemented() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_interfacesImplemented() ;

constexpr ::ArrayW<::StringW> const& __cordl_internal_get_serverHierarchy() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_serverHierarchy() ;

constexpr ::StringW const& __cordl_internal_get_serverType() const;

constexpr ::StringW& __cordl_internal_get_serverType() ;

constexpr void __cordl_internal_set_interfacesImplemented(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set_serverHierarchy(::ArrayW<::StringW>  value) ;

constexpr void __cordl_internal_set_serverType(::StringW  value) ;

/// @brief Method .ctor, addr 0x1816328c0, size 0x350, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type) ;

/// @brief Method get_TypeName, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Field serverHierarchy, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___serverHierarchy;

/// @brief Field interfacesImplemented, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___interfacesImplemented;
...
static_assert(sizeof(::System::Runtime::Remoting::TypeInfo) == 0x28, "Size mismatch!");
