...
// Write type traits
MARK_REF_T(::System::Runtime::Remoting::WellKnownClientTypeEntry*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Remoting::WellKnownClientTypeEntry*, "System.Runtime.Remoting", "WellKnownClientTypeEntry");
...
/// @brief Method ToString, addr 0x181632f50, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181632f90, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  assemblyName, ::StringW  objectUrl) ;

/// @brief Method get_ApplicationUrl, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_ApplicationUrl() ;

/// @brief Method get_ObjectType, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_ObjectType() ;

/// @brief Method get_ObjectUrl, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Remoting::WellKnownClientTypeEntry) == 0x38, "Size mismatch!");
