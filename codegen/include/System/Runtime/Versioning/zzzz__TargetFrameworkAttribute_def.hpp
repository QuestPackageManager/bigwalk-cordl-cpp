...
/// @brief Method .ctor, addr 0x18164c4d0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  frameworkName) ;

/// @brief Method set_FrameworkDisplayName, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
