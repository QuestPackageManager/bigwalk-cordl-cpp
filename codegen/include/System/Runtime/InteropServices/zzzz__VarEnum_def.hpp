...
static_assert(offsetof(::System::Runtime::InteropServices::VarEnum, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::InteropServices::VarEnum) == 0x4, "Size mismatch!");
