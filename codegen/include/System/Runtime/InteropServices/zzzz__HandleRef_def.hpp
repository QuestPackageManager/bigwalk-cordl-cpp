...
/// @brief Method get_Handle, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::HandleRef) == 0x10, "Size mismatch!");
