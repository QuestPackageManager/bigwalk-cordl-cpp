...
DEFINE_IL2CPP_CLASS(::System::Runtime::InteropServices::DllImportSearchPath, "System.Runtime.InteropServices", "DllImportSearchPath");
// Dependencies 
namespace System::Runtime::InteropServices {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::InteropServices::DllImportSearchPath, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::InteropServices::DllImportSearchPath) == 0x4, "Size mismatch!");
