...
// Write type traits
MARK_REF_T(::System::Runtime::InteropServices::SafeBuffer*);
DEFINE_IL2CPP_CLASS(::System::Runtime::InteropServices::SafeBuffer*, "System.Runtime.InteropServices", "SafeBuffer");
...
/// @brief Method AcquirePointer, addr 0x18166c4b0, size 0xb0, virtual false, abstract: false, final false
inline void AcquirePointer(::by_ref<uint8_t*>  pointer) ;

/// @brief Method NotInitialized, addr 0x18166c560, size 0x30, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* NotInitialized() ;

/// @brief Method ReleasePointer, addr 0x18166c590, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::InteropServices::SafeBuffer) == 0x28, "Size mismatch!");
