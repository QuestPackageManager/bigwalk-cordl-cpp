...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::SerializationObjectManager*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::SerializationObjectManager*, "System.Runtime.Serialization", "SerializationObjectManager");
...
/// @brief Field _objectSeenTable, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__objectSeenTable, put=__cordl_internal_set__objectSeenTable)) ::System::Collections::Generic::Dictionary_2<::System::Object*,::System::Object*>*  _objectSeenTable;

/// @brief Field _onSerializedHandler, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__onSerializedHandler, put=__cordl_internal_set__onSerializedHandler)) ::System::Runtime::Serialization::SerializationEventHandler*  _onSerializedHandler;

/// @brief Method AddOnSerialized, addr 0x18164b2d0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method RaiseOnSerializedEvent, addr 0x18164b330, size 0x40, virtual false, abstract: false, final false
inline void RaiseOnSerializedEvent() ;

/// @brief Method RegisterObject, addr 0x18164b370, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18164b470, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::SerializationObjectManager) == 0x30, "Size mismatch!");
