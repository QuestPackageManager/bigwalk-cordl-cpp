...
static_assert(offsetof(::System::Runtime::Serialization::StreamingContextStates, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Serialization::StreamingContextStates) == 0x4, "Size mismatch!");
