...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::SafeSerializationEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::SafeSerializationEventArgs*, "System.Runtime.Serialization", "SafeSerializationEventArgs");
...
/// @brief Method .ctor, addr 0x18165aa80, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method get_SerializedStates, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::SafeSerializationEventArgs) == 0x28, "Size mismatch!");
