...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::SerializationEventsCache*);
...
/// @brief Method <GetSerializationEventsForType>b__1_0, addr 0x18164c500, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::SerializationEventsCache___c) == 0x10, "Size mismatch!");
...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::System::Runtime::Serialization::SerializationEvents*>*  s_cache;

/// @brief Method GetSerializationEventsForType, addr 0x18164a940, size 0xf0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::Runtime::Serialization::SerializationEventsCache) == 0x10, "Size mismatch!");
