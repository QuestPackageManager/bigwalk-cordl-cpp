...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ObjectNull*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ObjectNull*, "System.Runtime.Serialization.Formatters.Binary", "ObjectNull");
...
/// @brief Method Read, addr 0x181652360, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SetNullCount, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void SetNullCount(int32_t  nullCount) ;

/// @brief Method Write, addr 0x1816523c0, size 0xa0, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ObjectNull) == 0x18, "Size mismatch!");
