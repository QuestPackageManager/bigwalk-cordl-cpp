...
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ValueFixupEnum, "System.Runtime.Serialization.Formatters.Binary", "ValueFixupEnum");
// Dependencies 
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: true
...
static_assert(offsetof(::System::Runtime::Serialization::Formatters::Binary::ValueFixupEnum, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ValueFixupEnum) == 0x4, "Size mismatch!");
