...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped*, "System.Runtime.Serialization.Formatters.Binary", "BinaryObjectWithMapTyped");
// Dependencies System.Object, System.Runtime.Serialization.Formatters.Binary.BinaryHeaderEnum, System.Runtime.Serialization.Formatters.Binary.BinaryTypeEnum
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field memberAssemIds, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_memberAssemIds, put=__cordl_internal_set_memberAssemIds)) ::ArrayW<int32_t>  memberAssemIds;
...
/// @brief Method Read, addr 0x18164ebb0, size 0x220, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x18164edd0, size 0xa0, virtual false, abstract: false, final false
inline void Set(int32_t  objectId, ::StringW  name, int32_t  numMembers, ::ArrayW<::StringW>  memberNames, ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>  binaryTypeEnumA, ::ArrayW<::System::Object*>  typeInformationA, ::ArrayW<int32_t>  memberAssemIds, int32_t  assemId) ;

/// @brief Method Write, addr 0x18164ee70, size 0x1a0, virtual true, abstract: false, final true
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_memberAssemIds() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_memberAssemIds() ;
...
constexpr void __cordl_internal_set_memberAssemIds(::ArrayW<int32_t>  value) ;
...
/// @brief Field memberAssemIds, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___memberAssemIds;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped) == 0x50, "Size mismatch!");
