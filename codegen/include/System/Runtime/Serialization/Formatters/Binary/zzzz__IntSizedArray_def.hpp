...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray*, "System.Runtime.Serialization.Formatters.Binary", "IntSizedArray");
...
/// @brief Field negObjects, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_negObjects, put=__cordl_internal_set_negObjects)) ::ArrayW<int32_t>  negObjects;

/// @brief Field objects, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_objects, put=__cordl_internal_set_objects)) ::ArrayW<int32_t>  objects;

/// @brief Convert operator to "::System::ICloneable"
constexpr operator  ::System::ICloneable*() noexcept;

/// @brief Method Clone, addr 0x1816640b0, size 0xe0, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method IncreaseCapacity, addr 0x181664190, size 0x130, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_negObjects() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_negObjects() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_objects() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_objects() ;

constexpr void __cordl_internal_set_negObjects(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_objects(::ArrayW<int32_t>  value) ;

/// @brief Method .ctor, addr 0x181664390, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816642c0, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray*  sizedArray) ;

/// @brief Method get_Item, addr 0x1816643e0, size 0x50, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  index) ;

/// @brief Convert to "::System::ICloneable"
constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

/// @brief Method set_Item, addr 0x181664430, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray) == 0x20, "Size mismatch!");
