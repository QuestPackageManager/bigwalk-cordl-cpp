...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ObjectMap*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ObjectMap*, "System.Runtime.Serialization.Formatters.Binary", "ObjectMap");
// Dependencies System.Object, System.Runtime.Serialization.Formatters.Binary.BinaryTypeEnum, System.Type
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field binaryTypeEnumA, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_binaryTypeEnumA, put=__cordl_internal_set_binaryTypeEnumA)) ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>  binaryTypeEnumA;
...
/// @brief Field memberTypes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_memberTypes, put=__cordl_internal_set_memberTypes)) ::ArrayW<::System::Type*>  memberTypes;
...
/// @brief Method Create, addr 0x181651bc0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x181651b30, size 0x90, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::Formatters::Binary::ObjectMap* Create(::StringW  name, ::System::Type*  objectType, ::ArrayW<::StringW>  memberNames, ::System::Runtime::Serialization::Formatters::Binary::ObjectReader*  objectReader, int32_t  objectId, ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*  assemblyInfo) ;

/// @brief Method CreateObjectInfo, addr 0x181651af0, size 0x40, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* CreateObjectInfo(::by_ref<::System::Runtime::Serialization::SerializationInfo*>  si, ::by_ref<::ArrayW<::System::Object*>>  memberData) ;
...
constexpr ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum> const& __cordl_internal_get_binaryTypeEnumA() const;

constexpr ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>& __cordl_internal_get_binaryTypeEnumA() ;
...
constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get_memberTypes() const;

constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_memberTypes() ;
...
constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_typeInformationA() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_typeInformationA() ;

constexpr void __cordl_internal_set_assemblyInfo(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*  value) ;

constexpr void __cordl_internal_set_binaryTypeEnumA(::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>  value) ;
...
/// @brief Method .ctor, addr 0x181651c80, size 0x3b0, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectName, ::ArrayW<::StringW>  memberNames, ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>  binaryTypeEnumA, ::ArrayW<::System::Object*>  typeInformationA, ::ArrayW<int32_t>  memberAssemIds, ::System::Runtime::Serialization::Formatters::Binary::ObjectReader*  objectReader, int32_t  objectId, ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*  assemblyInfo, ::System::Runtime::Serialization::Formatters::Binary::SizedArray*  assemIdToAssemblyTable) ;

/// @brief Method .ctor, addr 0x181652030, size 0x330, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectName, ::System::Type*  objectType, ::ArrayW<::StringW>  memberNames, ::System::Runtime::Serialization::Formatters::Binary::ObjectReader*  objectReader, int32_t  objectId, ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*  assemblyInfo) ;
...
/// @brief Field binaryTypeEnumA, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>  ___binaryTypeEnumA;

/// @brief Field typeInformationA, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ___typeInformationA;

/// @brief Field memberTypes, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::System::Type*>  ___memberTypes;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ObjectMap) == 0x68, "Size mismatch!");
