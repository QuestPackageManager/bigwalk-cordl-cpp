...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray*, "System.Runtime.Serialization.Formatters.Binary", "PrimitiveArray");
...
/// @brief Field booleanA, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_booleanA, put=__cordl_internal_set_booleanA)) ::ArrayW<bool>  booleanA;

/// @brief Field charA, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_charA, put=__cordl_internal_set_charA)) ::ArrayW<char16_t>  charA;
...
/// @brief Field doubleA, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_doubleA, put=__cordl_internal_set_doubleA)) ::ArrayW<double_t>  doubleA;

/// @brief Field int16A, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_int16A, put=__cordl_internal_set_int16A)) ::ArrayW<int16_t>  int16A;

/// @brief Field int32A, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_int32A, put=__cordl_internal_set_int32A)) ::ArrayW<int32_t>  int32A;

/// @brief Field int64A, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_int64A, put=__cordl_internal_set_int64A)) ::ArrayW<int64_t>  int64A;

/// @brief Field sbyteA, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_sbyteA, put=__cordl_internal_set_sbyteA)) ::ArrayW<int8_t>  sbyteA;

/// @brief Field singleA, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_singleA, put=__cordl_internal_set_singleA)) ::ArrayW<float_t>  singleA;

/// @brief Field uint16A, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_uint16A, put=__cordl_internal_set_uint16A)) ::ArrayW<uint16_t>  uint16A;

/// @brief Field uint32A, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_uint32A, put=__cordl_internal_set_uint32A)) ::ArrayW<uint32_t>  uint32A;
...
/// @brief Method Init, addr 0x181666240, size 0x520, virtual false, abstract: false, final false
inline void Init(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code, ::System::Array*  array) ;

static inline ::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray* New_ctor(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code, ::System::Array*  array) ;

/// @brief Method SetValue, addr 0x181666760, size 0x2a0, virtual false, abstract: false, final false
inline void SetValue(::StringW  value, int32_t  index) ;

constexpr ::ArrayW<bool> const& __cordl_internal_get_booleanA() const;

constexpr ::ArrayW<bool>& __cordl_internal_get_booleanA() ;

constexpr ::ArrayW<char16_t> const& __cordl_internal_get_charA() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_charA() ;
...
constexpr ::ArrayW<double_t> const& __cordl_internal_get_doubleA() const;

constexpr ::ArrayW<double_t>& __cordl_internal_get_doubleA() ;

constexpr ::ArrayW<int16_t> const& __cordl_internal_get_int16A() const;

constexpr ::ArrayW<int16_t>& __cordl_internal_get_int16A() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_int32A() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_int32A() ;

constexpr ::ArrayW<int64_t> const& __cordl_internal_get_int64A() const;

constexpr ::ArrayW<int64_t>& __cordl_internal_get_int64A() ;

constexpr ::ArrayW<int8_t> const& __cordl_internal_get_sbyteA() const;

constexpr ::ArrayW<int8_t>& __cordl_internal_get_sbyteA() ;

constexpr ::ArrayW<float_t> const& __cordl_internal_get_singleA() const;

constexpr ::ArrayW<float_t>& __cordl_internal_get_singleA() ;

constexpr ::ArrayW<uint16_t> const& __cordl_internal_get_uint16A() const;

constexpr ::ArrayW<uint16_t>& __cordl_internal_get_uint16A() ;

constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_uint32A() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_uint32A() ;

constexpr ::ArrayW<uint64_t> const& __cordl_internal_get_uint64A() const;

constexpr ::ArrayW<uint64_t>& __cordl_internal_get_uint64A() ;

constexpr void __cordl_internal_set_booleanA(::ArrayW<bool>  value) ;

constexpr void __cordl_internal_set_charA(::ArrayW<char16_t>  value) ;

constexpr void __cordl_internal_set_code(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  value) ;

constexpr void __cordl_internal_set_doubleA(::ArrayW<double_t>  value) ;

constexpr void __cordl_internal_set_int16A(::ArrayW<int16_t>  value) ;

constexpr void __cordl_internal_set_int32A(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_int64A(::ArrayW<int64_t>  value) ;

constexpr void __cordl_internal_set_sbyteA(::ArrayW<int8_t>  value) ;

constexpr void __cordl_internal_set_singleA(::ArrayW<float_t>  value) ;

constexpr void __cordl_internal_set_uint16A(::ArrayW<uint16_t>  value) ;

constexpr void __cordl_internal_set_uint32A(::ArrayW<uint32_t>  value) ;

constexpr void __cordl_internal_set_uint64A(::ArrayW<uint64_t>  value) ;

/// @brief Method .ctor, addr 0x181666a00, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::PrimitiveArray) == 0x70, "Size mismatch!");
