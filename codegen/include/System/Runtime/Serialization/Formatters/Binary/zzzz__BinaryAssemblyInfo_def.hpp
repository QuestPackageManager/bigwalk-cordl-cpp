...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo*, "System.Runtime.Serialization.Formatters.Binary", "BinaryAssemblyInfo");
...
/// @brief Method GetAssembly, addr 0x18164cf30, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo) == 0x20, "Size mismatch!");
