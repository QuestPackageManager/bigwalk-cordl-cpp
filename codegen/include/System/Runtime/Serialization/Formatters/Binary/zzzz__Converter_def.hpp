...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::Converter*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::Converter*, "System.Runtime.Serialization.Formatters.Binary", "Converter");
// Dependencies System.Object, System.Runtime.Serialization.Formatters.Binary.InternalPrimitiveTypeE, System.Type, System.TypeCode
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field arrayTypeA, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_arrayTypeA, put=setStaticF_arrayTypeA)) ::ArrayW<::System::Type*>  arrayTypeA;

/// @brief Field codeA, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_codeA, put=setStaticF_codeA)) ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE>  codeA;
...
/// @brief Field typeA, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_typeA, put=setStaticF_typeA)) ::ArrayW<::System::Type*>  typeA;

/// @brief Field typeCodeA, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_typeCodeA, put=setStaticF_typeCodeA)) ::ArrayW<::System::TypeCode>  typeCodeA;
...
/// @brief Field valueA, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_valueA, put=setStaticF_valueA)) ::ArrayW<::StringW>  valueA;

/// @brief Method CreatePrimitiveArray, addr 0x18164f2b0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method FromString, addr 0x18164f420, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method InitArrayTypeA, addr 0x18164f580, size 0x2a0, virtual false, abstract: false, final false
static inline void InitArrayTypeA() ;

/// @brief Method InitCodeA, addr 0x18164f820, size 0xd0, virtual false, abstract: false, final false
static inline void InitCodeA() ;

/// @brief Method InitTypeA, addr 0x18164f8f0, size 0x290, virtual false, abstract: false, final false
static inline void InitTypeA() ;

/// @brief Method InitTypeCodeA, addr 0x18164fb80, size 0xe0, virtual false, abstract: false, final false
static inline void InitTypeCodeA() ;

/// @brief Method InitValueA, addr 0x18164fc60, size 0x1d0, virtual false, abstract: false, final false
static inline void InitValueA() ;

/// @brief Method IsPrimitiveArray, addr 0x18164fe30, size 0x180, virtual false, abstract: false, final false
static inline bool IsPrimitiveArray(::System::Type*  type, ::by_ref<::System::Object*>  typeInformation) ;

/// @brief Method IsWriteAsByteArray, addr 0x18164ffb0, size 0x70, virtual false, abstract: false, final false
static inline bool IsWriteAsByteArray(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method ToArrayType, addr 0x181650020, size 0x60, virtual false, abstract: false, final false
static inline ::System::Type* ToArrayType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method ToCode, addr 0x181650080, size 0x1c0, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE ToCode(::System::Type*  type) ;

/// @brief Method ToComType, addr 0x181650240, size 0x60, virtual false, abstract: false, final false
static inline ::StringW ToComType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method ToPrimitiveTypeEnum, addr 0x1816502a0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method ToType, addr 0x181650500, size 0x60, virtual false, abstract: false, final false
static inline ::System::Type* ToType(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method ToTypeCode, addr 0x1816503d0, size 0x130, virtual false, abstract: false, final false
static inline ::System::TypeCode ToTypeCode(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method TypeLength, addr 0x181650560, size 0x90, virtual false, abstract: false, final false
static inline int32_t TypeLength(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

static inline ::ArrayW<::System::Type*> getStaticF_arrayTypeA() ;

static inline ::ArrayW<::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE> getStaticF_codeA() ;

static inline int32_t getStaticF_primitiveTypeEnumLength() ;

static inline ::ArrayW<::System::Type*> getStaticF_typeA() ;

static inline ::ArrayW<::System::TypeCode> getStaticF_typeCodeA() ;
...
static inline ::ArrayW<::StringW> getStaticF_valueA() ;

static inline void setStaticF_arrayTypeA(::ArrayW<::System::Type*>  value) ;

static inline void setStaticF_codeA(::ArrayW<::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE>  value) ;

static inline void setStaticF_primitiveTypeEnumLength(int32_t  value) ;

static inline void setStaticF_typeA(::ArrayW<::System::Type*>  value) ;

static inline void setStaticF_typeCodeA(::ArrayW<::System::TypeCode>  value) ;
...
static inline void setStaticF_valueA(::ArrayW<::StringW>  value) ;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::Converter) == 0x10, "Size mismatch!");
