...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::BinaryObject*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::BinaryObject*, "System.Runtime.Serialization.Formatters.Binary", "BinaryObject");
...
/// @brief Method Read, addr 0x18164dca0, size 0x40, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x1805f5cb0, size 0x10, virtual false, abstract: false, final false
inline void Set(int32_t  objectId, int32_t  mapId) ;

/// @brief Method Write, addr 0x18164f240, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::BinaryObject) == 0x18, "Size mismatch!");
