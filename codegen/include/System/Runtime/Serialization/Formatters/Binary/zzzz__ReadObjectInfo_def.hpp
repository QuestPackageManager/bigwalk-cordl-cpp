...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo*, "System.Runtime.Serialization.Formatters.Binary", "ReadObjectInfo");
// Dependencies System.Object, System.Runtime.Serialization.StreamingContext, System.Type
namespace System::Runtime::Serialization::Formatters::Binary {
// Is value type: false
...
/// @brief Field wireMemberNames, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_wireMemberNames, put=__cordl_internal_set_wireMemberNames)) ::ArrayW<::StringW>  wireMemberNames;
...
/// @brief Method AddValue, addr 0x181659580, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x181659750, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x181659660, size 0xf0, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* Create(::System::Type*  objectType, ::System::Runtime::Serialization::ISurrogateSelector*  surrogateSelector, ::System::Runtime::Serialization::StreamingContext  context, ::System::Runtime::Serialization::ObjectManager*  objectManager, ::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*  serObjectInfoInit, ::System::Runtime::Serialization::IFormatterConverter*  converter, bool  bSimpleAssembly) ;

/// @brief Method GetMemberInfo, addr 0x181659890, size 0x200, virtual false, abstract: false, final false
inline ::System::Reflection::MemberInfo* GetMemberInfo(::StringW  name) ;

/// @brief Method GetMemberType, addr 0x181659a90, size 0x190, virtual false, abstract: false, final false
inline ::System::Type* GetMemberType(::System::Reflection::MemberInfo*  objMember) ;

/// @brief Method GetMemberTypes, addr 0x181659c20, size 0x390, virtual false, abstract: false, final false
inline ::ArrayW<::System::Type*> GetMemberTypes(::ArrayW<::StringW>  inMemberNames, ::System::Type*  objectType) ;

/// @brief Method GetObjectInfo, addr 0x181659fb0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetType, addr 0x181659ff0, size 0x130, virtual false, abstract: false, final false
inline ::System::Type* GetType(::StringW  name) ;

/// @brief Method Init, addr 0x18165a750, size 0x110, virtual false, abstract: false, final false
inline void Init(::System::Type*  objectType, ::ArrayW<::StringW>  memberNames, ::ArrayW<::System::Type*>  memberTypes, ::System::Runtime::Serialization::ISurrogateSelector*  surrogateSelector, ::System::Runtime::Serialization::StreamingContext  context, ::System::Runtime::Serialization::ObjectManager*  objectManager, ::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*  serObjectInfoInit, ::System::Runtime::Serialization::IFormatterConverter*  converter, bool  bSimpleAssembly) ;

/// @brief Method Init, addr 0x18165a690, size 0xc0, virtual false, abstract: false, final false
inline void Init(::System::Type*  objectType, ::System::Runtime::Serialization::ISurrogateSelector*  surrogateSelector, ::System::Runtime::Serialization::StreamingContext  context, ::System::Runtime::Serialization::ObjectManager*  objectManager, ::System::Runtime::Serialization::Formatters::Binary::SerObjectInfoInit*  serObjectInfoInit, ::System::Runtime::Serialization::IFormatterConverter*  converter, bool  bSimpleAssembly) ;

/// @brief Method InitDataStore, addr 0x18165a120, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method InitMemberInfo, addr 0x18165a1f0, size 0x1b0, virtual false, abstract: false, final false
inline void InitMemberInfo() ;

/// @brief Method InitNoMembers, addr 0x18165a3a0, size 0x80, virtual false, abstract: false, final false
inline void InitNoMembers() ;

/// @brief Method InitReadConstructor, addr 0x18165a420, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method InitSiRead, addr 0x18165a630, size 0x60, virtual false, abstract: false, final false
inline void InitSiRead() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* New_ctor() ;

/// @brief Method ObjectEnd, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void ObjectEnd() ;

/// @brief Method PopulateObjectMembers, addr 0x18165a860, size 0x60, virtual false, abstract: false, final false
inline void PopulateObjectMembers(::System::Object*  obj, ::ArrayW<::System::Object*>  memberData) ;

/// @brief Method Position, addr 0x18165a8c0, size 0x110, virtual false, abstract: false, final false
inline int32_t Position(::StringW  name) ;

/// @brief Method PrepareForReuse, addr 0x18165a9d0, size 0x10, virtual false, abstract: false, final false
inline void PrepareForReuse() ;

/// @brief Method RecordFixup, addr 0x18165a9e0, size 0xa0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_wireMemberNames() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_wireMemberNames() ;

constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get_wireMemberTypes() const;

constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_wireMemberTypes() ;
...
constexpr void __cordl_internal_set_wireMemberNames(::ArrayW<::StringW>  value) ;
...
/// @brief Field wireMemberNames, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___wireMemberNames;

/// @brief Field wireMemberTypes, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Type*>  ___wireMemberTypes;
...
static_assert(sizeof(::System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo) == 0x80, "Size mismatch!");
