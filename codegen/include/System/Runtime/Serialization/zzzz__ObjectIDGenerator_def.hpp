...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ObjectIDGenerator*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ObjectIDGenerator*, "System.Runtime.Serialization", "ObjectIDGenerator");
...
/// @brief Field m_ids, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ids, put=__cordl_internal_set_m_ids)) ::ArrayW<int64_t>  m_ids;

/// @brief Field m_objs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_objs, put=__cordl_internal_set_m_objs)) ::ArrayW<::System::Object*>  m_objs;
...
/// @brief Method FindElement, addr 0x181646710, size 0xb0, virtual false, abstract: false, final false
inline int32_t FindElement(::System::Object*  obj, ::by_ref<bool>  found) ;

/// @brief Method GetId, addr 0x1816467c0, size 0xf0, virtual true, abstract: false, final false
inline int64_t GetId(::System::Object*  obj, ::by_ref<bool>  firstTime) ;

/// @brief Method HasId, addr 0x1816468b0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method Rehash, addr 0x181646940, size 0x210, virtual false, abstract: false, final false
inline void Rehash() ;
...
constexpr ::ArrayW<int64_t> const& __cordl_internal_get_m_ids() const;

constexpr ::ArrayW<int64_t>& __cordl_internal_get_m_ids() ;

constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get_m_objs() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get_m_objs() ;
...
constexpr void __cordl_internal_set_m_ids(::ArrayW<int64_t>  value) ;

constexpr void __cordl_internal_set_m_objs(::ArrayW<::System::Object*>  value) ;

/// @brief Method .ctor, addr 0x181646bb0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Runtime::Serialization::ObjectIDGenerator) == 0x28, "Size mismatch!");
