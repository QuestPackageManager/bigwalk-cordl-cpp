...
// Write type traits
MARK_REF_T(::System::Runtime::Serialization::ObjectHolder*);
DEFINE_IL2CPP_CLASS(::System::Runtime::Serialization::ObjectHolder*, "System.Runtime.Serialization", "ObjectHolder");
...
/// @brief Method AddDependency, addr 0x181645b70, size 0x70, virtual false, abstract: false, final false
inline void AddDependency(int64_t  dependentObject) ;

/// @brief Method AddFixup, addr 0x181645be0, size 0xa0, virtual false, abstract: false, final false
inline void AddFixup(::System::Runtime::Serialization::FixupHolder*  fixup, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method DecrementFixupsRemaining, addr 0x181645c80, size 0x20, virtual false, abstract: false, final false
inline void DecrementFixupsRemaining(::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method IncrementDescendentFixups, addr 0x181645ca0, size 0x10, virtual false, abstract: false, final false
inline void IncrementDescendentFixups(int32_t  amount) ;

/// @brief Method MarkForCompletionWhenAvailable, addr 0x181645cb0, size 0x10, virtual false, abstract: false, final false
inline void MarkForCompletionWhenAvailable() ;

static inline ::System::Runtime::Serialization::ObjectHolder* New_ctor(::StringW  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t>  arrayIndex) ;

static inline ::System::Runtime::Serialization::ObjectHolder* New_ctor(::System::Object*  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t>  arrayIndex) ;

static inline ::System::Runtime::Serialization::ObjectHolder* New_ctor(int64_t  objID) ;

/// @brief Method RemoveDependency, addr 0x181645cc0, size 0x10, virtual false, abstract: false, final false
inline void RemoveDependency(int64_t  id) ;

/// @brief Method SetFlags, addr 0x181645cd0, size 0x70, virtual false, abstract: false, final false
inline void SetFlags() ;

/// @brief Method SetObjectValue, addr 0x181645d40, size 0x100, virtual false, abstract: false, final false
inline void SetObjectValue(::System::Object*  obj, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method UpdateData, addr 0x181645e40, size 0x1b0, virtual false, abstract: false, final false
inline void UpdateData(::System::Object*  obj, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainer, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t>  arrayIndex, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method UpdateDescendentDependencyChain, addr 0x181645ff0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181646430, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::StringW  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t>  arrayIndex) ;

/// @brief Method .ctor, addr 0x1816461a0, size 0x290, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t>  arrayIndex) ;

/// @brief Method .ctor, addr 0x181646110, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int64_t  objID) ;

/// @brief Method get_CanObjectValueChange, addr 0x181646520, size 0x60, virtual false, abstract: false, final false
inline bool get_CanObjectValueChange() ;

/// @brief Method get_CanSurrogatedObjectValueChange, addr 0x181646580, size 0x50, virtual false, abstract: false, final false
inline bool get_CanSurrogatedObjectValueChange() ;

/// @brief Method get_CompletelyFixed, addr 0x1816465d0, size 0x20, virtual false, abstract: false, final false
inline bool get_CompletelyFixed() ;

/// @brief Method get_ContainerID, addr 0x1816465f0, size 0x20, virtual false, abstract: false, final false
inline int64_t get_ContainerID() ;

/// @brief Method get_DependentObjects, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::LongList* get_DependentObjects() ;

/// @brief Method get_DirectlyDependentObjects, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_DirectlyDependentObjects() ;

/// @brief Method get_HasISerializable, addr 0x181646610, size 0x10, virtual false, abstract: false, final false
inline bool get_HasISerializable() ;

/// @brief Method get_HasSurrogate, addr 0x181646620, size 0x10, virtual false, abstract: false, final false
inline bool get_HasSurrogate() ;

/// @brief Method get_IsIncompleteObjectReference, addr 0x181646630, size 0x10, virtual false, abstract: false, final false
inline bool get_IsIncompleteObjectReference() ;

/// @brief Method get_ObjectValue, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_ObjectValue() ;

/// @brief Method get_Reachable, addr 0x180347a60, size 0xe0, virtual false, abstract: false, final false
inline bool get_Reachable() ;

/// @brief Method get_RequiresDelayedFixup, addr 0x181646640, size 0x10, virtual false, abstract: false, final false
inline bool get_RequiresDelayedFixup() ;

/// @brief Method get_RequiresSerInfoFixup, addr 0x181646650, size 0x20, virtual false, abstract: false, final false
inline bool get_RequiresSerInfoFixup() ;

/// @brief Method get_RequiresValueTypeFixup, addr 0x181646670, size 0x10, virtual false, abstract: false, final false
inline bool get_RequiresValueTypeFixup() ;

/// @brief Method get_SerializationInfo, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::SerializationInfo* get_SerializationInfo() ;

/// @brief Method get_Surrogate, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ISerializationSurrogate* get_Surrogate() ;

/// @brief Method get_TotalDependentObjects, addr 0x1815efa30, size 0x10, virtual false, abstract: false, final false
inline int32_t get_TotalDependentObjects() ;

/// @brief Method get_TypeLoadException, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::TypeLoadExceptionHolder* get_TypeLoadException() ;

/// @brief Method get_TypeLoadExceptionReachable, addr 0x181646680, size 0x10, virtual false, abstract: false, final false
inline bool get_TypeLoadExceptionReachable() ;

/// @brief Method get_ValueFixup, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ValueTypeFixupInfo* get_ValueFixup() ;

/// @brief Method get_ValueTypeFixupPerformed, addr 0x181646690, size 0x30, virtual false, abstract: false, final false
inline bool get_ValueTypeFixupPerformed() ;

/// @brief Method set_DependentObjects, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
inline void set_DependentObjects(::System::Runtime::Serialization::LongList*  value) ;

/// @brief Method set_IsIncompleteObjectReference, addr 0x1816466c0, size 0x20, virtual false, abstract: false, final false
inline void set_IsIncompleteObjectReference(bool  value) ;

/// @brief Method set_Reachable, addr 0x180452bb0, size 0x10, virtual false, abstract: false, final false
inline void set_Reachable(bool  value) ;

/// @brief Method set_RequiresSerInfoFixup, addr 0x1816466e0, size 0x20, virtual false, abstract: false, final false
inline void set_RequiresSerInfoFixup(bool  value) ;

/// @brief Method set_SerializationInfo, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_SerializationInfo(::System::Runtime::Serialization::SerializationInfo*  value) ;

/// @brief Method set_TypeLoadException, addr 0x1803d49a0, size 0x10, virtual false, abstract: false, final false
inline void set_TypeLoadException(::System::Runtime::Serialization::TypeLoadExceptionHolder*  value) ;

/// @brief Method set_ValueTypeFixupPerformed, addr 0x181646700, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Runtime::Serialization::ObjectHolder) == 0x70, "Size mismatch!");
