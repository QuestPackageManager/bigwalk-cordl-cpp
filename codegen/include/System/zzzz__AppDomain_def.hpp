...
/// @brief Field FirstChanceException, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_FirstChanceException, put=__cordl_internal_set_FirstChanceException)) ::System::EventHandler_1<::System::Runtime::ExceptionServices::FirstChanceExceptionEventArgs*>*  FirstChanceException;
...
/// @brief Field assembly_resolve_in_progress, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_assembly_resolve_in_progress, put=setStaticF_assembly_resolve_in_progress)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Object*>*  assembly_resolve_in_progress;

/// @brief Field assembly_resolve_in_progress_refonly, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_assembly_resolve_in_progress_refonly, put=setStaticF_assembly_resolve_in_progress_refonly)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Object*>*  assembly_resolve_in_progress_refonly;
...
/// @brief Field type_resolve_in_progress, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_type_resolve_in_progress, put=setStaticF_type_resolve_in_progress)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Object*>*  type_resolve_in_progress;

/// @brief Method DoAssemblyLoad, addr 0x181744380, size 0x70, virtual false, abstract: false, final false
inline void DoAssemblyLoad(::System::Reflection::Assembly*  assembly) ;

/// @brief Method DoAssemblyResolve, addr 0x1817443f0, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method DoDomainUnload, addr 0x1817446a0, size 0x30, virtual false, abstract: false, final false
inline void DoDomainUnload() ;

/// @brief Method DoResourceResolve, addr 0x1817446d0, size 0x100, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* DoResourceResolve(::StringW  name, ::System::Reflection::Assembly*  requesting) ;

/// @brief Method DoTypeResolve, addr 0x1817447d0, size 0x230, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* DoTypeResolve(::StringW  name) ;

/// @brief Method GetAssemblies, addr 0x181744a00, size 0x10, virtual true, abstract: false, final true
inline ::ArrayW<::System::Reflection::Assembly*> GetAssemblies() ;

/// @brief Method GetAssemblies, addr 0x181744a10, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Reflection::Assembly*> GetAssemblies(bool  refOnly) ;

/// @brief Method GetCurrentThreadId, addr 0x181744a20, size 0x10, virtual false, abstract: false, final false
static inline int32_t GetCurrentThreadId() ;

/// @brief Method GetData, addr 0x181744a30, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* GetData(::StringW  name) ;

/// @brief Method GetMarshalledDomainObjRef, addr 0x181744a40, size 0x80, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetMarshalledDomainObjRef() ;

/// @brief Method GetProcessGuid, addr 0x181744ac0, size 0x90, virtual false, abstract: false, final false
static inline ::StringW GetProcessGuid() ;

/// @brief Method InitializeLifetimeService, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* InitializeLifetimeService() ;

/// @brief Method InternalGetContext, addr 0x181744b50, size 0x10, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetContext() ;

/// @brief Method InternalGetDefaultContext, addr 0x181744b50, size 0x10, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetDefaultContext() ;

/// @brief Method InternalGetProcessGuid, addr 0x181744b60, size 0x10, virtual false, abstract: false, final false
static inline ::StringW InternalGetProcessGuid(::StringW  newguid) ;

/// @brief Method InternalIsFinalizingForUnload, addr 0x1815c4100, size 0x10, virtual false, abstract: false, final false
static inline bool InternalIsFinalizingForUnload(int32_t  domain_id) ;

/// @brief Method InternalPopDomainRef, addr 0x181744b70, size 0x10, virtual false, abstract: false, final false
static inline void InternalPopDomainRef() ;

/// @brief Method InternalPushDomainRefByID, addr 0x181744b80, size 0x10, virtual false, abstract: false, final false
static inline void InternalPushDomainRefByID(int32_t  domain_id) ;

/// @brief Method InternalSetContext, addr 0x181744b90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method InternalSetDomain, addr 0x181744bb0, size 0x10, virtual false, abstract: false, final false
static inline ::System::AppDomain* InternalSetDomain(::System::AppDomain*  context) ;

/// @brief Method InternalSetDomainByID, addr 0x181744ba0, size 0x10, virtual false, abstract: false, final false
static inline ::System::AppDomain* InternalSetDomainByID(int32_t  domain_id) ;

/// @brief Method InvokeInDomainByID, addr 0x181744bc0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method IsAppXModel, addr 0x1802e2bd0, size 0x10, virtual false, abstract: false, final false
static inline bool IsAppXModel() ;

/// @brief Method IsFinalizingForUnload, addr 0x181744d10, size 0x20, virtual false, abstract: false, final false
inline bool IsFinalizingForUnload() ;

/// @brief Method Load, addr 0x181744f10, size 0xc0, virtual true, abstract: false, final true
inline ::System::Reflection::Assembly* Load(::StringW  assemblyString) ;

/// @brief Method Load, addr 0x181744e70, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Load, addr 0x181744e10, size 0x60, virtual true, abstract: false, final true
inline ::System::Reflection::Assembly* Load(::ArrayW<uint8_t>  rawAssembly) ;

/// @brief Method Load, addr 0x181744db0, size 0x60, virtual true, abstract: false, final true
inline ::System::Reflection::Assembly* Load(::ArrayW<uint8_t>  rawAssembly, ::ArrayW<uint8_t>  rawSymbolStore, ::System::Security::Policy::Evidence*  securityEvidence) ;

/// @brief Method Load, addr 0x181744d50, size 0x60, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* Load(::ArrayW<uint8_t>  rawAssembly, ::ArrayW<uint8_t>  rawSymbolStore, ::System::Security::Policy::Evidence*  securityEvidence, bool  refonly) ;

/// @brief Method LoadAssembly, addr 0x181744d40, size 0x10, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* LoadAssembly(::StringW  assemblyRef, ::System::Security::Policy::Evidence*  securityEvidence, bool  refOnly, ::by_ref<::System::Threading::StackCrawlMark>  stackMark) ;

/// @brief Method LoadAssemblyRaw, addr 0x181744d30, size 0x10, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* LoadAssemblyRaw(::ArrayW<uint8_t>  rawAssembly, ::ArrayW<uint8_t>  rawSymbolStore, ::System::Security::Policy::Evidence*  securityEvidence, bool  refonly) ;

static inline ::System::AppDomain* New_ctor() ;

/// @brief Method ProcessMessageInDomain, addr 0x181744fd0, size 0xf0, virtual false, abstract: false, final false
inline void ProcessMessageInDomain(::ArrayW<uint8_t>  arrRequest, ::System::Runtime::Remoting::Messaging::CADMethodCallMessage*  cadMsg, ::by_ref<::ArrayW<uint8_t>>  arrResponse, ::by_ref<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*>  cadMrm) ;

/// @brief Method ToString, addr 0x1817450c0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method add_DomainUnload, addr 0x1817450d0, size 0x150, virtual true, abstract: false, final true
inline void add_DomainUnload(::System::EventHandler*  value) ;

/// @brief Method add_ProcessExit, addr 0x181745220, size 0x150, virtual true, abstract: false, final true
inline void add_ProcessExit(::System::EventHandler*  value) ;

/// @brief Method add_UnhandledException, addr 0x181745370, size 0x150, virtual true, abstract: false, final true
inline void add_UnhandledException(::System::UnhandledExceptionEventHandler*  value) ;

/// @brief Method getCurDomain, addr 0x1817454c0, size 0x10, virtual false, abstract: false, final false
static inline ::System::AppDomain* getCurDomain() ;

/// @brief Method getDomainID, addr 0x1817454d0, size 0x10, virtual false, abstract: false, final false
inline int32_t getDomainID() ;

/// @brief Method getFriendlyName, addr 0x1817450c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentDomain, addr 0x1817454c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IsHomogenous, addr 0x1802f6470, size 0x10, virtual false, abstract: false, final false
inline bool get_IsHomogenous() ;

/// @brief Method remove_DomainUnload, addr 0x1817454e0, size 0x130, virtual true, abstract: false, final true
inline void remove_DomainUnload(::System::EventHandler*  value) ;

/// @brief Method remove_ProcessExit, addr 0x181745610, size 0x130, virtual true, abstract: false, final true
inline void remove_ProcessExit(::System::EventHandler*  value) ;

/// @brief Method remove_UnhandledException, addr 0x181745740, size 0x160, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::AppDomain) == 0xa0, "Size mismatch!");
