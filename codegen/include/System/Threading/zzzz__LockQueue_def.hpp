...
// Write type traits
MARK_REF_T(::System::Threading::LockQueue*);
DEFINE_IL2CPP_CLASS(::System::Threading::LockQueue*, "System.Threading", "LockQueue");
...
/// @brief Method Pulse, addr 0x18176df90, size 0x90, virtual false, abstract: false, final false
inline void Pulse() ;

/// @brief Method Wait, addr 0x18176e020, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method get_IsEmpty, addr 0x18176e150, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::LockQueue) == 0x20, "Size mismatch!");
