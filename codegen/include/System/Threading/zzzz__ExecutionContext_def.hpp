...
static_assert(offsetof(::System::Threading::ExecutionContext_Flags, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method DangerousGetRawExecutionContext, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::ExecutionContext* DangerousGetRawExecutionContext() ;

/// @brief Method HasSameLocalValues, addr 0x181763d40, size 0x30, virtual false, abstract: false, final false
inline bool HasSameLocalValues(::System::Threading::ExecutionContext*  other) ;

/// @brief Method IsDefaultFTContext, addr 0x181763d70, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_IsFlowSuppressed, addr 0x181758ad0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_LogicalCallContext, addr 0x181763de0, size 0x70, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext_Reader get_LogicalCallContext() ;

/// @brief Method get_SynchronizationContext, addr 0x181763e70, size 0x50, virtual false, abstract: false, final false
inline ::System::Threading::SynchronizationContext* get_SynchronizationContext() ;

/// @brief Method get_SynchronizationContextNoFlow, addr 0x181763e50, size 0x20, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::System::Threading::ExecutionContext_CaptureOptions, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method Capture, addr 0x181760fd0, size 0x10, virtual false, abstract: false, final false
static inline ::System::Threading::ExecutionContext* Capture() ;

/// @brief Method Capture, addr 0x181760de0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method CreateCopy, addr 0x181760fe0, size 0x100, virtual false, abstract: false, final false
inline ::System::Threading::ExecutionContext* CreateCopy() ;

/// @brief Method CreateMutableCopy, addr 0x1817610e0, size 0x100, virtual false, abstract: false, final false
inline ::System::Threading::ExecutionContext* CreateMutableCopy() ;

/// @brief Method Dispose, addr 0x180631430, size 0xa670, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method EstablishCopyOnWriteScope, addr 0x181761250, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method EstablishCopyOnWriteScope, addr 0x1817611e0, size 0x70, virtual false, abstract: false, final false
static inline void EstablishCopyOnWriteScope(::by_ref<::System::Threading::ExecutionContextSwitcher>  ecsw) ;

/// @brief Method FastCapture, addr 0x1817612b0, size 0x20, virtual false, abstract: false, final false
static inline ::System::Threading::ExecutionContext* FastCapture() ;

/// @brief Method GetObjectData, addr 0x1817612d0, size 0x70, virtual true, abstract: false, final true
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method IsDefaultFTContext, addr 0x181761340, size 0x50, virtual false, abstract: false, final false
inline bool IsDefaultFTContext(bool  ignoreSyncCtx) ;

/// @brief Method IsFlowSuppressed, addr 0x181761390, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method OnAsyncLocalContextChanged, addr 0x1817613c0, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method RestoreFlow, addr 0x181761650, size 0x50, virtual false, abstract: false, final false
static inline void RestoreFlow() ;

/// @brief Method Run, addr 0x1817618b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x1817618a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method RunInternal, addr 0x181761880, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method RunInternal, addr 0x1817616a0, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method SetExecutionContext, addr 0x181761920, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SuppressFlow, addr 0x181761a30, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181761b80, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x181761b70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IllogicalCallContext, addr 0x181761c60, size 0x40, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IllogicalCallContext* get_IllogicalCallContext() ;

/// @brief Method get_IsPreAllocatedDefault, addr 0x181761ca0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsPreAllocatedDefault() ;

/// @brief Method get_LogicalCallContext, addr 0x18164a590, size 0x40, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext() ;

/// @brief Method get_SynchronizationContext, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::SynchronizationContext* get_SynchronizationContext() ;

/// @brief Method get_SynchronizationContextNoFlow, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::SynchronizationContext* get_SynchronizationContextNoFlow() ;

/// @brief Method get_isFlowSuppressed, addr 0x181761cb0, size 0x10, virtual false, abstract: false, final false
inline bool get_isFlowSuppressed() ;

/// @brief Method get_isNewCapture, addr 0x181761cc0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_IllogicalCallContext, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_IllogicalCallContext(::System::Runtime::Remoting::Messaging::IllogicalCallContext*  value) ;

/// @brief Method set_LogicalCallContext, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void set_LogicalCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext*  value) ;

/// @brief Method set_SynchronizationContext, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_SynchronizationContext(::System::Threading::SynchronizationContext*  value) ;

/// @brief Method set_SynchronizationContextNoFlow, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_SynchronizationContextNoFlow(::System::Threading::SynchronizationContext*  value) ;

/// @brief Method set_isFlowSuppressed, addr 0x181761cd0, size 0x20, virtual false, abstract: false, final false
inline void set_isFlowSuppressed(bool  value) ;

/// @brief Method set_isNewCapture, addr 0x181761cf0, size 0xb0, virtual false, abstract: false, final false
