...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x181766490, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1817664a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x181767fb0, size 0x630, virtual true, abstract: false, final true
...
/// @brief Method CancellationTokenCanceledEventHandler, addr 0x181763ed0, size 0x170, virtual false, abstract: false, final false
static inline void CancellationTokenCanceledEventHandler(::System::Object*  obj) ;

/// @brief Method CheckDispose, addr 0x181764040, size 0x70, virtual false, abstract: false, final false
inline void CheckDispose() ;

/// @brief Method CreateAndAddAsyncWaiter, addr 0x1817640b0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181764150, size 0x80, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetResourceString, addr 0x1807cb5a0, size 0x8b80, virtual false, abstract: false, final false
...
/// @brief Method QueueWaiterTask, addr 0x1817641d0, size 0x10, virtual false, abstract: false, final false
static inline void QueueWaiterTask(::System::Threading::SemaphoreSlim_TaskNode*  waiterTask) ;

/// @brief Method Release, addr 0x181764550, size 0x10, virtual false, abstract: false, final false
inline int32_t Release() ;

/// @brief Method Release, addr 0x1817641e0, size 0x370, virtual false, abstract: false, final false
inline int32_t Release(int32_t  releaseCount) ;

/// @brief Method RemoveAsyncWaiter, addr 0x181764560, size 0xd0, virtual false, abstract: false, final false
inline bool RemoveAsyncWaiter(::System::Threading::SemaphoreSlim_TaskNode*  task) ;

/// @brief Method Wait, addr 0x181764c00, size 0x620, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Wait, addr 0x181765220, size 0x10, virtual false, abstract: false, final false
inline void Wait() ;

/// @brief Method WaitAsync, addr 0x181764630, size 0x10, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WaitAsync() ;

/// @brief Method WaitAsync, addr 0x181764640, size 0x450, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeout, addr 0x181764b70, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeoutAsync, addr 0x181764a90, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181765350, size 0x150, virtual false, abstract: false, final false
