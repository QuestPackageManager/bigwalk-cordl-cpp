...
/// @brief Method DoCallBack, addr 0x18176f060, size 0xd0, virtual false, abstract: false, final false
inline void DoCallBack(::System::Object*  timedOut) ;

static inline ::System::Threading::RegisteredWaitHandle* New_ctor(::System::Threading::WaitHandle*  waitObject, ::System::Threading::WaitOrTimerCallback*  callback, ::System::Object*  state, ::System::TimeSpan  timeout, bool  executeOnlyOnce) ;

/// @brief Method Unregister, addr 0x18176f130, size 0xe0, virtual false, abstract: false, final false
inline bool Unregister(::System::Threading::WaitHandle*  waitObject) ;

/// @brief Method Wait, addr 0x18176f210, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18176f610, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::RegisteredWaitHandle) == 0x50, "Size mismatch!");
