...
DEFINE_IL2CPP_CLASS(::System::Threading::StackCrawlMark, "System.Threading", "StackCrawlMark");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
static_assert(offsetof(::System::Threading::StackCrawlMark, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::StackCrawlMark) == 0x4, "Size mismatch!");
