...
// Write type traits
MARK_REF_T(::System::Threading::ThreadPoolWorkQueueThreadLocals*);
DEFINE_IL2CPP_CLASS(::System::Threading::ThreadPoolWorkQueueThreadLocals*, "System.Threading", "ThreadPoolWorkQueueThreadLocals");
...
/// @brief Method CleanUp, addr 0x181778400, size 0xc0, virtual false, abstract: false, final false
inline void CleanUp() ;

/// @brief Method Finalize, addr 0x1817784c0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181778500, size 0x150, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::ThreadPoolWorkQueueThreadLocals) == 0x28, "Size mismatch!");
