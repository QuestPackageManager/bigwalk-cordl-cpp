...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::ThreadPoolTaskScheduler*);
...
/// @brief Method <.cctor>b__10_0, addr 0x18177ac00, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::ThreadPoolTaskScheduler___c) == 0x10, "Size mismatch!");
...
/// @brief Method NotifyWorkItemProgress, addr 0x181778050, size 0x70, virtual true, abstract: false, final false
inline void NotifyWorkItemProgress() ;

/// @brief Method QueueTask, addr 0x1817780c0, size 0x180, virtual true, abstract: false, final false
inline void QueueTask(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryDequeue, addr 0x181778240, size 0x70, virtual true, abstract: false, final false
inline bool TryDequeue(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryExecuteTaskInline, addr 0x1817782b0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method get_RequiresAtomicStartTransition, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::Threading::Tasks::ThreadPoolTaskScheduler) == 0x18, "Size mismatch!");
