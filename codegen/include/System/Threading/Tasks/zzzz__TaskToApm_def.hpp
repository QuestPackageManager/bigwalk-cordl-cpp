...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::TaskToApm*);
MARK_REF_T(::System::Threading::Tasks::TaskToApm_TaskWrapperAsyncResult*);
MARK_REF_T(::System::Threading::Tasks::TaskToApm___c__DisplayClass3_0*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskToApm*, "System.Threading.Tasks", "TaskToApm");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskToApm_TaskWrapperAsyncResult*, "System.Threading.Tasks", "TaskToApm/TaskWrapperAsyncResult");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskToApm___c__DisplayClass3_0*, "System.Threading.Tasks", "TaskToApm/<>c__DisplayClass3_0");
...
/// @brief Method System.IAsyncResult.get_AsyncState, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* System_IAsyncResult_get_AsyncState() ;

/// @brief Method System.IAsyncResult.get_AsyncWaitHandle, addr 0x181772240, size 0xa0, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* System_IAsyncResult_get_AsyncWaitHandle() ;

/// @brief Method System.IAsyncResult.get_CompletedSynchronously, addr 0x1803a7410, size 0x10, virtual true, abstract: false, final true
inline bool System_IAsyncResult_get_CompletedSynchronously() ;

/// @brief Method System.IAsyncResult.get_IsCompleted, addr 0x1817722e0, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Threading::Tasks::TaskToApm_TaskWrapperAsyncResult) == 0x28, "Size mismatch!");
...
/// @brief Method <InvokeCallbackWhenTaskCompletes>b__0, addr 0x18176df70, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::TaskToApm___c__DisplayClass3_0) == 0x20, "Size mismatch!");
...
/// @brief Method Begin, addr 0x181771f40, size 0x180, virtual false, abstract: false, final false
...
static inline TResult End(::System::IAsyncResult*  asyncResult) ;

/// @brief Method End, addr 0x1817720c0, size 0xb0, virtual false, abstract: false, final false
static inline void End(::System::IAsyncResult*  asyncResult) ;

/// @brief Method InvokeCallbackWhenTaskCompletes, addr 0x181772170, size 0xd0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::Threading::Tasks::TaskToApm) == 0x10, "Size mismatch!");
