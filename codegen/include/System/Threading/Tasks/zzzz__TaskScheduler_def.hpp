...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::TaskScheduler*);
MARK_REF_T(::System::Threading::Tasks::TaskScheduler_SystemThreadingTasks_TaskSchedulerDebugView*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskScheduler*, "System.Threading.Tasks", "TaskScheduler");
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskScheduler_SystemThreadingTasks_TaskSchedulerDebugView*, "System.Threading.Tasks", "TaskScheduler/SystemThreadingTasks_TaskSchedulerDebugView");
...
/// @brief Field _unobservedTaskException, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__unobservedTaskException, put=setStaticF__unobservedTaskException)) ::System::EventHandler_1<::System::Threading::Tasks::UnobservedTaskExceptionEventArgs*>*  _unobservedTaskException;
...
/// @brief Method FromCurrentSynchronizationContext, addr 0x181771a60, size 0x50, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* FromCurrentSynchronizationContext() ;

static inline ::System::Threading::Tasks::TaskScheduler* New_ctor() ;

/// @brief Method NotifyWorkItemProgress, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final false
inline void NotifyWorkItemProgress() ;

/// @brief Method PublishUnobservedTaskException, addr 0x181771ab0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method TryDequeue, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool TryDequeue(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryExecuteTask, addr 0x181771ba0, size 0x30, virtual false, abstract: false, final false
inline bool TryExecuteTask(::System::Threading::Tasks::Task*  task) ;
...
/// @brief Method TryRunInline, addr 0x181771bd0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method get_Current, addr 0x181771e30, size 0x60, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Current() ;

/// @brief Method get_Default, addr 0x180879330, size 0x19d40, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Default() ;

/// @brief Method get_Id, addr 0x181771e90, size 0x70, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_InternalCurrent, addr 0x181771f00, size 0x40, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent() ;

/// @brief Method get_RequiresAtomicStartTransition, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::TaskScheduler) == 0x18, "Size mismatch!");
