...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::TaskContinuation*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskContinuation*, "System.Threading.Tasks", "TaskContinuation");
...
public:
// Declarations
/// @brief Method InlineIfPossibleOrElseQueue, addr 0x1817709d0, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::TaskContinuation) == 0x10, "Size mismatch!");
