...
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::InternalTaskOptions, "System.Threading.Tasks", "InternalTaskOptions");
// Dependencies 
namespace System::Threading::Tasks {
// Is value type: true
...
static_assert(offsetof(::System::Threading::Tasks::InternalTaskOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::InternalTaskOptions) == 0x4, "Size mismatch!");
