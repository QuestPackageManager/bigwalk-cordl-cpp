...
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::TaskStatus, "System.Threading.Tasks", "TaskStatus");
// Dependencies 
namespace System::Threading::Tasks {
// Is value type: true
...
static_assert(offsetof(::System::Threading::Tasks::TaskStatus, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::TaskStatus) == 0x4, "Size mismatch!");
