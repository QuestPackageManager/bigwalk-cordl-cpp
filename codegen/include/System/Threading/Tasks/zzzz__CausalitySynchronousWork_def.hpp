...
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::CausalitySynchronousWork, "System.Threading.Tasks", "CausalitySynchronousWork");
// Dependencies 
namespace System::Threading::Tasks {
// Is value type: true
...
static_assert(offsetof(::System::Threading::Tasks::CausalitySynchronousWork, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::CausalitySynchronousWork) == 0x4, "Size mismatch!");
