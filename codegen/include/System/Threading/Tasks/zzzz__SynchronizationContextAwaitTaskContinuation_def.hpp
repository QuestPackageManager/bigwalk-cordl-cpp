...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::SynchronizationContextAwaitTaskContinuation*);
...
/// @brief Method <.cctor>b__7_0, addr 0x181767e80, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::SynchronizationContextAwaitTaskContinuation___c) == 0x10, "Size mismatch!");
...
/// @brief Method GetPostActionCallback, addr 0x1817704c0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method PostAction, addr 0x181770560, size 0x80, virtual false, abstract: false, final false
static inline void PostAction(::System::Object*  state) ;

/// @brief Method Run, addr 0x1817705e0, size 0xf0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181770760, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::SynchronizationContextAwaitTaskContinuation) == 0x28, "Size mismatch!");
