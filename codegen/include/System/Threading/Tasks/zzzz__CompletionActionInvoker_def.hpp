...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::CompletionActionInvoker*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::CompletionActionInvoker*, "System.Threading.Tasks", "CompletionActionInvoker");
...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x18176b6e0, size 0x20, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Threading::Tasks::CompletionActionInvoker) == 0x20, "Size mismatch!");
