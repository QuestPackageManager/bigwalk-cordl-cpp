...
// Write type traits
MARK_REF_T(::System::Threading::Tasks::StandardTaskContinuation*);
DEFINE_IL2CPP_CLASS(::System::Threading::Tasks::StandardTaskContinuation*, "System.Threading.Tasks", "StandardTaskContinuation");
...
/// @brief Method Run, addr 0x181770360, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181770430, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Tasks::StandardTaskContinuation) == 0x28, "Size mismatch!");
