...
static_assert(offsetof(::System::Threading::Tasks::TaskCreationOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::TaskCreationOptions) == 0x4, "Size mismatch!");
