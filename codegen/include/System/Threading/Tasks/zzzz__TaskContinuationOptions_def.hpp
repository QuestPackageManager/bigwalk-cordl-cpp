...
static_assert(offsetof(::System::Threading::Tasks::TaskContinuationOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::Tasks::TaskContinuationOptions) == 0x4, "Size mismatch!");
