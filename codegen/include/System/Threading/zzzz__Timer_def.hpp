...
// Write type traits
MARK_REF_T(::System::Threading::Timer*);
MARK_REF_T(::System::Threading::Timer_Scheduler*);
MARK_VAL_T(::System::Threading::Timer_TimerComparer);
DEFINE_IL2CPP_CLASS(::System::Threading::Timer*, "System.Threading", "Timer");
DEFINE_IL2CPP_CLASS(::System::Threading::Timer_Scheduler*, "System.Threading", "Timer/Scheduler");
DEFINE_IL2CPP_CLASS(::System::Threading::Timer_TimerComparer, "System.Threading", "Timer/TimerComparer");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
/// @brief Method Compare, addr 0x18177a600, size 0x20, virtual true, abstract: false, final true
inline int32_t Compare(::System::Threading::Timer*  tx, ::System::Threading::Timer*  ty) ;

/// @brief Method System.Collections.IComparer.Compare, addr 0x18177a620, size 0x60, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Threading::Timer_TimerComparer) == 0x1, "Size mismatch!");
...
/// @brief Method Add, addr 0x18176f6c0, size 0x90, virtual false, abstract: false, final false
inline void Add(::System::Threading::Timer*  timer) ;

/// @brief Method Change, addr 0x18176f750, size 0x1c0, virtual false, abstract: false, final false
inline void Change(::System::Threading::Timer*  timer, int64_t  new_next_run) ;

/// @brief Method FireTimer, addr 0x18176f910, size 0xa0, virtual false, abstract: false, final false
inline void FireTimer(::System::Threading::Timer*  timer) ;

/// @brief Method InitScheduler, addr 0x18176f9b0, size 0x110, virtual false, abstract: false, final false
inline void InitScheduler() ;

/// @brief Method InternalRemove, addr 0x18176fac0, size 0x20, virtual false, abstract: false, final false
inline void InternalRemove(::System::Threading::Timer*  timer) ;

static inline ::System::Threading::Timer_Scheduler* New_ctor() ;

/// @brief Method Remove, addr 0x18176fae0, size 0xa0, virtual false, abstract: false, final false
inline void Remove(::System::Threading::Timer*  timer) ;

/// @brief Method RunSchedulerLoop, addr 0x18176fb80, size 0x280, virtual false, abstract: false, final false
inline int32_t RunSchedulerLoop() ;

/// @brief Method SchedulerThread, addr 0x18176fe00, size 0x180, virtual false, abstract: false, final false
inline void SchedulerThread() ;

/// @brief Method TimerCB, addr 0x18176ff80, size 0x50, virtual false, abstract: false, final false
static inline void TimerCB(::System::Object*  o) ;

/// @brief Method WakeupScheduler, addr 0x18176ffd0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181770170, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Threading::Timer_Scheduler* getStaticF_instance() ;

/// @brief Method get_Instance, addr 0x1817702c0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Change, addr 0x18177a800, size 0x60, virtual false, abstract: false, final false
inline bool Change(::System::TimeSpan  dueTime, ::System::TimeSpan  period) ;

/// @brief Method Change, addr 0x18177a7e0, size 0x20, virtual false, abstract: false, final false
inline bool Change(int32_t  dueTime, int32_t  period) ;

/// @brief Method Change, addr 0x18177a680, size 0x160, virtual false, abstract: false, final false
inline bool Change(int64_t  dueTime, int64_t  period, bool  first) ;

/// @brief Method Dispose, addr 0x18177a900, size 0x50, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x18177a860, size 0xa0, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::ValueTask DisposeAsync() ;

/// @brief Method GetTimeMonotonic, addr 0x18177a950, size 0x10, virtual false, abstract: false, final false
static inline int64_t GetTimeMonotonic() ;

/// @brief Method Init, addr 0x18177a960, size 0x80, virtual false, abstract: false, final false
inline void Init(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int64_t  dueTime, int64_t  period) ;

/// @brief Method KeepRootedWhileScheduled, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18177aa60, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18177a9e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int32_t  dueTime, int32_t  period) ;

/// @brief Method get_scheduler, addr 0x1817702c0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::Timer) == 0x48, "Size mismatch!");
