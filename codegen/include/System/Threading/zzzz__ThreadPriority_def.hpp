...
DEFINE_IL2CPP_CLASS(::System::Threading::ThreadPriority, "System.Threading", "ThreadPriority");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
static_assert(offsetof(::System::Threading::ThreadPriority, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::ThreadPriority) == 0x4, "Size mismatch!");
