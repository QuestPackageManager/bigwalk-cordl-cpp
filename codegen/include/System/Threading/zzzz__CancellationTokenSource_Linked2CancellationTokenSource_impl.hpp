...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::*)(::System::Threading::CancellationToken, ::System::Threading::CancellationToken)>(&::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::_ctor)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x181761f00;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*>(),
                        {".ctor", {}, {::i2c::type_of<::System::Threading::CancellationToken>(), ::i2c::type_of<::System::Threading::CancellationToken>()}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::*)(bool)>(&::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::Dispose)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x181761eb0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*>(),
                    {::i2c::class_of<::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*>(), 5}
                ));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, token1, token2);
}
...
inline ::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource* GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource::New_ctor(::System::Threading::CancellationToken  token1, ::System::Threading::CancellationToken  token2)  {
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*>(token1, token2));
}
// Ctor Parameters []
