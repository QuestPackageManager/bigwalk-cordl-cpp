...
DEFINE_IL2CPP_CLASS(::System::Threading::LockRecursionPolicy, "System.Threading", "LockRecursionPolicy");
// Dependencies 
namespace System::Threading {
// Is value type: true
...
static_assert(offsetof(::System::Threading::LockRecursionPolicy, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Threading::LockRecursionPolicy) == 0x4, "Size mismatch!");
