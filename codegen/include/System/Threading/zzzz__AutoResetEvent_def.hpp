...
// Write type traits
MARK_REF_T(::System::Threading::AutoResetEvent*);
DEFINE_IL2CPP_CLASS(::System::Threading::AutoResetEvent*, "System.Threading", "AutoResetEvent");
...
/// @brief Method .ctor, addr 0x181759200, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Threading::AutoResetEvent) == 0x30, "Size mismatch!");
