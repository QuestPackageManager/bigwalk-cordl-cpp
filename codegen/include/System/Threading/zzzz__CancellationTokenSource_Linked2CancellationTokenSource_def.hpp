...
// Write type traits
MARK_REF_T(::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource*, "System.Threading", "CancellationTokenSource/Linked2CancellationTokenSource");
...
/// @brief Method Dispose, addr 0x181761eb0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181761f00, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::CancellationTokenSource_Linked2CancellationTokenSource) == 0x70, "Size mismatch!");
