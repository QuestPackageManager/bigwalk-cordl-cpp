...
DEFINE_IL2CPP_CLASS(::System::Threading::NativeOverlapped, "System.Threading", "NativeOverlapped");
...
static_assert(sizeof(::System::Threading::NativeOverlapped) == 0x20, "Size mismatch!");
