...
/// @brief Method .ctor, addr 0x18169bd00, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::AttributeTargets  validOn) ;

static inline ::System::AttributeUsageAttribute* getStaticF_Default() ;

/// @brief Method get_AllowMultiple, addr 0x18039e7b0, size 0x10, virtual false, abstract: false, final false
inline bool get_AllowMultiple() ;

/// @brief Method get_Inherited, addr 0x1804e67f0, size 0x10, virtual false, abstract: false, final false
inline bool get_Inherited() ;

static inline void setStaticF_Default(::System::AttributeUsageAttribute*  value) ;

/// @brief Method set_AllowMultiple, addr 0x18039e7c0, size 0x10, virtual false, abstract: false, final false
inline void set_AllowMultiple(bool  value) ;

/// @brief Method set_Inherited, addr 0x1804e6810, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::AttributeUsageAttribute) == 0x18, "Size mismatch!");
