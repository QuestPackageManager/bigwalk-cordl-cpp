...
DEFINE_IL2CPP_GEN_CLASS(::System::ValueTuple_8, "System", "ValueTuple`8");
// Dependencies 
namespace System {
// cpp template
template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename TRest>
