...
/// @brief Field <Location>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__Location_k__BackingField, put=__cordl_internal_set__Location_k__BackingField)) ::System::Resources::UltimateResourceFallbackLocation  _Location_k__BackingField;
...
/// @brief Method .ctor, addr 0x181666000, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  cultureName) ;

/// @brief Method get_CultureName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CultureName() ;

/// @brief Method get_Location, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Resources::NeutralResourcesLanguageAttribute) == 0x20, "Size mismatch!");
