...
// Write type traits
MARK_REF_T(::System::Resources::ResourceReader*);
MARK_REF_T(::System::Resources::ResourceReader_ResourceEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Resources::ResourceReader*, "System.Resources", "ResourceReader");
DEFINE_IL2CPP_CLASS(::System::Resources::ResourceReader_ResourceEnumerator*, "System.Resources", "ResourceReader/ResourceEnumerator");
...
/// @brief Method MoveNext, addr 0x181666a10, size 0x30, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::System::Resources::ResourceReader_ResourceEnumerator* New_ctor(::System::Resources::ResourceReader*  reader) ;

/// @brief Method Reset, addr 0x181666a40, size 0x50, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181666a90, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Resources::ResourceReader*  reader) ;

/// @brief Method get_Current, addr 0x181666ac0, size 0x40, virtual true, abstract: false, final true
inline ::System::Object* get_Current() ;

/// @brief Method get_DataPosition, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_DataPosition() ;

/// @brief Method get_Entry, addr 0x181666b00, size 0x2d0, virtual true, abstract: false, final true
inline ::System::Collections::DictionaryEntry get_Entry() ;

/// @brief Method get_Key, addr 0x181666dd0, size 0xa0, virtual true, abstract: false, final true
inline ::System::Object* get_Key() ;

/// @brief Method get_Value, addr 0x181666e70, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Field _nameHashes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__nameHashes, put=__cordl_internal_set__nameHashes)) ::ArrayW<int32_t>  _nameHashes;

/// @brief Field _nameHashesPtr, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__nameHashesPtr, put=__cordl_internal_set__nameHashesPtr)) int32_t*  _nameHashesPtr;

/// @brief Field _namePositions, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__namePositions, put=__cordl_internal_set__namePositions)) ::ArrayW<int32_t>  _namePositions;

/// @brief Field _namePositionsPtr, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__namePositionsPtr, put=__cordl_internal_set__namePositionsPtr)) int32_t*  _namePositionsPtr;
...
/// @brief Field _typeNamePositions, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__typeNamePositions, put=__cordl_internal_set__typeNamePositions)) ::ArrayW<int32_t>  _typeNamePositions;

/// @brief Field _typeTable, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__typeTable, put=__cordl_internal_set__typeTable)) ::ArrayW<::System::RuntimeType*>  _typeTable;
...
/// @brief Method AllocateStringForNameIndex, addr 0x181667670, size 0x5c0, virtual false, abstract: false, final false
inline ::StringW AllocateStringForNameIndex(int32_t  index, ::by_ref<int32_t>  dataOffset) ;

/// @brief Method Close, addr 0x181667c30, size 0xc0, virtual true, abstract: false, final true
inline void Close() ;

/// @brief Method CompareStringEqualsName, addr 0x181667cf0, size 0x2f0, virtual false, abstract: false, final false
inline bool CompareStringEqualsName(::StringW  name) ;

/// @brief Method DeserializeObject, addr 0x181667fe0, size 0x130, virtual false, abstract: false, final false
inline ::System::Object* DeserializeObject(int32_t  typeIndex) ;

/// @brief Method Dispose, addr 0x1816681d0, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181668110, size 0xc0, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method FindPosForResource, addr 0x1816681e0, size 0x3d0, virtual false, abstract: false, final false
inline int32_t FindPosForResource(::StringW  name) ;

/// @brief Method FindType, addr 0x1816685b0, size 0x230, virtual false, abstract: false, final false
inline ::System::RuntimeType* FindType(int32_t  typeIndex) ;

/// @brief Method GetEnumerator, addr 0x181668830, size 0x80, virtual true, abstract: false, final true
inline ::System::Collections::IDictionaryEnumerator* GetEnumerator() ;

/// @brief Method GetEnumeratorInternal, addr 0x1816687e0, size 0x50, virtual false, abstract: false, final false
inline ::System::Resources::ResourceReader_ResourceEnumerator* GetEnumeratorInternal() ;

/// @brief Method GetNameHash, addr 0x1816688b0, size 0x40, virtual false, abstract: false, final false
inline int32_t GetNameHash(int32_t  index) ;

/// @brief Method GetNamePosition, addr 0x1816688f0, size 0x100, virtual false, abstract: false, final false
inline int32_t GetNamePosition(int32_t  index) ;

/// @brief Method GetValueForNameIndex, addr 0x1816689f0, size 0x230, virtual false, abstract: false, final false
inline ::System::Object* GetValueForNameIndex(int32_t  index) ;

/// @brief Method LoadObject, addr 0x181668e00, size 0x30, virtual false, abstract: false, final false
inline ::System::Object* LoadObject(int32_t  pos) ;

/// @brief Method LoadObject, addr 0x181668e30, size 0x60, virtual false, abstract: false, final false
inline ::System::Object* LoadObject(int32_t  pos, ::by_ref<::System::Resources::ResourceTypeCode>  typeCode) ;

/// @brief Method LoadObjectV1, addr 0x181668c20, size 0xf0, virtual false, abstract: false, final false
inline ::System::Object* LoadObjectV1(int32_t  pos) ;

/// @brief Method LoadObjectV2, addr 0x181668d10, size 0xf0, virtual false, abstract: false, final false
inline ::System::Object* LoadObjectV2(int32_t  pos, ::by_ref<::System::Resources::ResourceTypeCode>  typeCode) ;

/// @brief Method LoadString, addr 0x181668e90, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method ReadResources, addr 0x1816690a0, size 0x140, virtual false, abstract: false, final false
inline void ReadResources() ;

/// @brief Method ReadUnalignedI4, addr 0x1816691e0, size 0x20, virtual false, abstract: false, final false
static inline int32_t ReadUnalignedI4(int32_t*  p) ;

/// @brief Method SkipString, addr 0x181669200, size 0xb0, virtual false, abstract: false, final false
inline void SkipString() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181668830, size 0x80, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method _LoadObjectV1, addr 0x1816692b0, size 0x5f0, virtual false, abstract: false, final false
inline ::System::Object* _LoadObjectV1(int32_t  pos) ;

/// @brief Method _LoadObjectV2, addr 0x1816698a0, size 0x9f0, virtual false, abstract: false, final false
inline ::System::Object* _LoadObjectV2(int32_t  pos, ::by_ref<::System::Resources::ResourceTypeCode>  typeCode) ;

/// @brief Method _ReadResources, addr 0x18166a290, size 0x800, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__nameHashes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__nameHashes() ;

constexpr int32_t* const& __cordl_internal_get__nameHashesPtr() const;

constexpr int32_t*& __cordl_internal_get__nameHashesPtr() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get__namePositions() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__namePositions() ;

constexpr int32_t* const& __cordl_internal_get__namePositionsPtr() const;

constexpr int32_t*& __cordl_internal_get__namePositionsPtr() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get__typeNamePositions() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__typeNamePositions() ;

constexpr ::ArrayW<::System::RuntimeType*> const& __cordl_internal_get__typeTable() const;

constexpr ::ArrayW<::System::RuntimeType*>& __cordl_internal_get__typeTable() ;
...
constexpr void __cordl_internal_set__nameHashes(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set__nameHashesPtr(int32_t*  value) ;

constexpr void __cordl_internal_set__namePositions(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set__namePositionsPtr(int32_t*  value) ;
...
constexpr void __cordl_internal_set__typeNamePositions(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set__typeTable(::ArrayW<::System::RuntimeType*>  value) ;

constexpr void __cordl_internal_set__ums(::System::IO::UnmanagedMemoryStream*  value) ;

constexpr void __cordl_internal_set__version(int32_t  value) ;

/// @brief Method .ctor, addr 0x18166aa90, size 0x120, virtual false, abstract: false, final false
...
/// @brief Field _namePositions, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<int32_t>  ____namePositions;
...
/// @brief Field _typeTable, offset: 0x50, size: 0x8, def value: None
 ::ArrayW<::System::RuntimeType*>  ____typeTable;

/// @brief Field _typeNamePositions, offset: 0x58, size: 0x8, def value: None
 ::ArrayW<int32_t>  ____typeNamePositions;
...
static_assert(sizeof(::System::Resources::ResourceReader) == 0x80, "Size mismatch!");
