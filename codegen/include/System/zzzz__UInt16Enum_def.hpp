...
DEFINE_IL2CPP_CLASS(::System::UInt16Enum, "System", "UInt16Enum");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::UInt16Enum, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::System::UInt16Enum) == 0x2, "Size mismatch!");
