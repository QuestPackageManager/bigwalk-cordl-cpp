...
// Write type traits
MARK_REF_T(::System::PointerSpec*);
DEFINE_IL2CPP_CLASS(::System::PointerSpec*, "System", "PointerSpec");
...
/// @brief Method Append, addr 0x181763c40, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method Resolve, addr 0x181763c60, size 0x50, virtual true, abstract: false, final true
inline ::System::Type* Resolve(::System::Type*  type) ;

/// @brief Method ToString, addr 0x181763cb0, size 0x60, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::PointerSpec) == 0x18, "Size mismatch!");
