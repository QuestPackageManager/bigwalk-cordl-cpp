...
public:
// Declarations
/// @brief Method Abs, addr 0x181c1d4f0, size 0x10, virtual false, abstract: false, final false
static inline uint32_t Abs(int32_t  a) ;

/// @brief Method CbitHighZero, addr 0x181c13280, size 0x70, virtual false, abstract: false, final false
static inline int32_t CbitHighZero(uint32_t  u) ;

/// @brief Method CbitHighZero, addr 0x181c1d500, size 0xa0, virtual false, abstract: false, final false
static inline int32_t CbitHighZero(uint64_t  uu) ;

/// @brief Method CombineHash, addr 0x181c1d5a0, size 0x10, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  n1, int32_t  n2) ;

/// @brief Method CombineHash, addr 0x181c1d5a0, size 0x10, virtual false, abstract: false, final false
static inline uint32_t CombineHash(uint32_t  u1, uint32_t  u2) ;

/// @brief Method DangerousMakeTwosComplement, addr 0x181c1d5b0, size 0x60, virtual false, abstract: false, final false
static inline void DangerousMakeTwosComplement(::ArrayW<uint32_t>  d) ;

/// @brief Method GetDoubleFromParts, addr 0x181c1d610, size 0x140, virtual false, abstract: false, final false
static inline double_t GetDoubleFromParts(int32_t  sign, int32_t  exp, uint64_t  man) ;

/// @brief Method GetDoubleParts, addr 0x181c1d750, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method MakeUlong, addr 0x181c1d7e0, size 0x10, virtual false, abstract: false, final false
