...
/// @brief Method Add, addr 0x181c12ce0, size 0x80, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Add(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method Add, addr 0x181c12c50, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Add(::ArrayW<uint32_t>  left, uint32_t  right) ;

/// @brief Method Add, addr 0x181c12ba0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method AddDivisor, addr 0x181c12b00, size 0x30, virtual false, abstract: false, final false
static inline uint32_t AddDivisor(uint32_t*  left, int32_t  leftLength, uint32_t*  right, int32_t  rightLength) ;

/// @brief Method AddSelf, addr 0x181c12b30, size 0x70, virtual false, abstract: false, final false
static inline void AddSelf(uint32_t*  left, int32_t  leftLength, uint32_t*  right, int32_t  rightLength) ;

/// @brief Method Compare, addr 0x181c12d60, size 0x50, virtual false, abstract: false, final false
static inline int32_t Compare(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method CreateCopy, addr 0x181c12db0, size 0x50, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> CreateCopy(::ArrayW<uint32_t>  value) ;

/// @brief Method Divide, addr 0x181c131e0, size 0xa0, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Divide(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method Divide, addr 0x181c13160, size 0x80, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Divide(::ArrayW<uint32_t>  left, uint32_t  right) ;

/// @brief Method Divide, addr 0x181c12e40, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method DivideGuessTooBig, addr 0x181c12e00, size 0x40, virtual false, abstract: false, final false
static inline bool DivideGuessTooBig(uint64_t  q, uint64_t  valHi, uint32_t  valLo, uint32_t  divHi, uint32_t  divLo) ;

/// @brief Method LeadingZeros, addr 0x181c13280, size 0x70, virtual false, abstract: false, final false
static inline int32_t LeadingZeros(uint32_t  value) ;

/// @brief Method Multiply, addr 0x181c132f0, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Multiply(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method Multiply, addr 0x181c13890, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Multiply(::ArrayW<uint32_t>  left, uint32_t  right) ;

/// @brief Method Multiply, addr 0x181c13380, size 0x510, virtual false, abstract: false, final false
...
/// @brief Method Remainder, addr 0x181c13920, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Remainder(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method Remainder, addr 0x181c139b0, size 0x40, virtual false, abstract: false, final false
static inline uint32_t Remainder(::ArrayW<uint32_t>  left, uint32_t  right) ;

/// @brief Method Square, addr 0x181c13dd0, size 0x60, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Square(::ArrayW<uint32_t>  value) ;

/// @brief Method Square, addr 0x181c139f0, size 0x3e0, virtual false, abstract: false, final false
static inline void Square(uint32_t*  value, int32_t  valueLength, uint32_t*  bits, int32_t  bitsLength) ;

/// @brief Method Subtract, addr 0x181c13f90, size 0x110, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Subtract(::ArrayW<uint32_t>  left, ::ArrayW<uint32_t>  right) ;

/// @brief Method Subtract, addr 0x181c14150, size 0x80, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t> Subtract(::ArrayW<uint32_t>  left, uint32_t  right) ;

/// @brief Method Subtract, addr 0x181c140a0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SubtractCore, addr 0x181c13e30, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SubtractDivisor, addr 0x181c13f40, size 0x50, virtual false, abstract: false, final false
