...
public:
// Declarations
/// @brief Method Bind, addr 0x181b233c0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method FallbackDeleteIndex, addr 0x181b202e0, size 0x30, virtual false, abstract: false, final false
...
inline ::System::Dynamic::DynamicMetaObject* FallbackDeleteIndex(::System::Dynamic::DynamicMetaObject*  target, ::ArrayW<::System::Dynamic::DynamicMetaObject*>  indexes, ::System::Dynamic::DynamicMetaObject*  errorSuggestion) ;
