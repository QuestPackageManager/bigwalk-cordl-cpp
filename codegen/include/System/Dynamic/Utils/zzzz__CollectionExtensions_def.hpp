...
template<typename T>
static inline ::System::Runtime::CompilerServices::TrueReadOnlyCollection_1<T>* AddFirst(::System::Collections::ObjectModel::ReadOnlyCollection_1<T>*  list, T  item) ;

/// @brief Method AddLast, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T> AddLast(::ArrayW<T>  array, T  item) ;

/// @brief Method RemoveFirst, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T> RemoveFirst(::ArrayW<T>  array) ;

/// @brief Method RemoveLast, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T> RemoveLast(::ArrayW<T>  array) ;

/// @brief Method ToReadOnly, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* ToReadOnly(::System::Collections::Generic::IEnumerable_1<T>*  enumerable) ;
...
static_assert(sizeof(::System::Dynamic::Utils::CollectionExtensions) == 0x10, "Size mismatch!");
