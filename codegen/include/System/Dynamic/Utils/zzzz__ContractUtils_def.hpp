...
public:
// Declarations
/// @brief Method GetParamName, addr 0x181b349a0, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetParamName(::StringW  paramName, int32_t  index) ;

/// @brief Method Requires, addr 0x181b34a20, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method RequiresNotNull, addr 0x180631410, size 0x20, virtual false, abstract: false, final false
static inline void RequiresNotNull(::System::Object*  value, ::StringW  paramName) ;

/// @brief Method RequiresNotNull, addr 0x181b349f0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Unreachable, addr 0x181b34a50, size 0x30, virtual false, abstract: false, final false
