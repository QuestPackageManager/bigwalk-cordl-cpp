...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Dynamic::Utils::CacheDict_2);
MARK_GEN_REF_T_PTR(::System::Dynamic::Utils::CacheDict_2_Entry);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Dynamic::Utils::CacheDict_2, "System.Dynamic.Utils", "CacheDict`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Dynamic::Utils::CacheDict_2_Entry, "System.Dynamic.Utils", "CacheDict`2/Entry");
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*>  _entries;
...
constexpr ::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*> const& __cordl_internal_get__entries() const;

constexpr ::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*>& __cordl_internal_get__entries() ;

constexpr int32_t const& __cordl_internal_get__mask() const;

constexpr int32_t& __cordl_internal_get__mask() ;

constexpr void __cordl_internal_set__entries(::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*>  value) ;
...
/// @brief Field _entries, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Dynamic::Utils::CacheDict_2_Entry<TKey,TValue>*>  ____entries;
