...
// Write type traits
MARK_REF_T(::GlobalNamespace::BindingRestrictions_MergedRestriction*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BindingRestrictions_MergedRestriction*, "System.Dynamic", "BindingRestrictions/MergedRestriction");
...
/// @brief Method GetExpression, addr 0x181b29220, size 0x260, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BindingRestrictions_MergedRestriction) == 0x20, "Size mismatch!");
