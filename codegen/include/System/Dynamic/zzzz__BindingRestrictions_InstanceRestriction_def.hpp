...
// Write type traits
MARK_REF_T(::GlobalNamespace::BindingRestrictions_InstanceRestriction*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BindingRestrictions_InstanceRestriction*, "System.Dynamic", "BindingRestrictions/InstanceRestriction");
...
/// @brief Method Equals, addr 0x181b26cd0, size 0x40, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetExpression, addr 0x181b26d10, size 0x220, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression() ;

/// @brief Method GetHashCode, addr 0x181b26f30, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BindingRestrictions_InstanceRestriction) == 0x20, "Size mismatch!");
