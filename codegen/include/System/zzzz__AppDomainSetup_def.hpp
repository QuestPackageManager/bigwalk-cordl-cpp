...
/// @brief Field configuration_bytes, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_configuration_bytes, put=__cordl_internal_set_configuration_bytes)) ::ArrayW<uint8_t>  configuration_bytes;
...
/// @brief Field domain_initializer_args, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_domain_initializer_args, put=__cordl_internal_set_domain_initializer_args)) ::ArrayW<::StringW>  domain_initializer_args;
...
/// @brief Field partial_visible_assemblies, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_partial_visible_assemblies, put=__cordl_internal_set_partial_visible_assemblies)) ::ArrayW<::StringW>  partial_visible_assemblies;
...
/// @brief Field serialized_non_primitives, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_serialized_non_primitives, put=__cordl_internal_set_serialized_non_primitives)) ::ArrayW<uint8_t>  serialized_non_primitives;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_configuration_bytes() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_configuration_bytes() ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_domain_initializer_args() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_domain_initializer_args() ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_partial_visible_assemblies() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_partial_visible_assemblies() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_serialized_non_primitives() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_serialized_non_primitives() ;
...
constexpr void __cordl_internal_set_configuration_bytes(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_domain_initializer_args(::ArrayW<::StringW>  value) ;
...
constexpr void __cordl_internal_set_partial_visible_assemblies(::ArrayW<::StringW>  value) ;
...
constexpr void __cordl_internal_set_serialized_non_primitives(::ArrayW<uint8_t>  value) ;
...
/// @brief Field domain_initializer_args, offset: 0x88, size: 0x8, def value: None
 ::ArrayW<::StringW>  ___domain_initializer_args;
...
/// @brief Field configuration_bytes, offset: 0x98, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___configuration_bytes;

/// @brief Field serialized_non_primitives, offset: 0xa0, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___serialized_non_primitives;
...
static_assert(sizeof(::System::AppDomainSetup) == 0xc8, "Size mismatch!");
