...
public:
// Declarations
/// @brief Method Dispose, addr 0x181de3590, size 0x30, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Emit, addr 0x181de3e40, size 0x80, virtual false, abstract: false, final false
inline void Emit(int32_t  op) ;

/// @brief Method Emit, addr 0x181de3d70, size 0xd0, virtual false, abstract: false, final false
inline void Emit(int32_t  op, int32_t  opd1) ;

/// @brief Method Emit, addr 0x181de3ec0, size 0x120, virtual false, abstract: false, final false
inline void Emit(int32_t  op, int32_t  opd1, int32_t  opd2) ;

/// @brief Method EmitFragment, addr 0x181de35c0, size 0x7b0, virtual false, abstract: false, final false
inline void EmitFragment(int32_t  nodetype, ::System::Text::RegularExpressions::RegexNode*  node, int32_t  curIndex) ;

/// @brief Method MapCapnum, addr 0x181de3fe0, size 0xa0, virtual false, abstract: false, final false
inline int32_t MapCapnum(int32_t  capnum) ;

/// @brief Method PatchJump, addr 0x181de4080, size 0x20, virtual false, abstract: false, final false
inline void PatchJump(int32_t  offset, int32_t  jumpDest) ;

/// @brief Method RegexCodeFromRegexTree, addr 0x181de40a0, size 0x470, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexCode* RegexCodeFromRegexTree(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method StringCode, addr 0x181de4510, size 0xe0, virtual false, abstract: false, final false
inline int32_t StringCode(::StringW  str) ;

/// @brief Method Write, addr 0x181de45f0, size 0x1d0, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCode* Write(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method .ctor, addr 0x181de47c0, size 0x110, virtual false, abstract: false, final false
