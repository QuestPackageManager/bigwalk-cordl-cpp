...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::Regex*);
MARK_REF_T(::System::Text::RegularExpressions::Regex_CachedCodeEntry*);
...
/// @brief Method Equals, addr 0x181dc5ca0, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x181dc5c10, size 0x90, virtual true, abstract: false, final true
inline bool Equals(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey  other) ;

/// @brief Method GetHashCode, addr 0x181dc5d50, size 0x70, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x181ce6ae0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181dc5dc0, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey) == 0x18, "Size mismatch!");
...
/// @brief Field Capslist, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_Capslist, put=__cordl_internal_set_Capslist)) ::ArrayW<::StringW>  Capslist;
...
static inline ::System::Text::RegularExpressions::Regex_CachedCodeEntry* New_ctor(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey  key, ::System::Collections::Hashtable*  capnames, ::ArrayW<::StringW>  capslist, ::System::Text::RegularExpressions::RegexCode*  code, ::System::Collections::Hashtable*  caps, int32_t  capsize, ::System::Text::RegularExpressions::ExclusiveReference*  runner, ::System::WeakReference_1<::System::Text::RegularExpressions::RegexReplacement*>*  replref) ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_Capslist() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_Capslist() ;
...
constexpr void __cordl_internal_set_Capslist(::ArrayW<::StringW>  value) ;
...
/// @brief Method .ctor, addr 0x181dc5e30, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey  key, ::System::Collections::Hashtable*  capnames, ::ArrayW<::StringW>  capslist, ::System::Text::RegularExpressions::RegexCode*  code, ::System::Collections::Hashtable*  caps, int32_t  capsize, ::System::Text::RegularExpressions::ExclusiveReference*  runner, ::System::WeakReference_1<::System::Text::RegularExpressions::RegexReplacement*>*  replref) ;
...
static_assert(sizeof(::System::Text::RegularExpressions::Regex_CachedCodeEntry) == 0x70, "Size mismatch!");
...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::System::Collections::Generic::Dictionary_2<::System::Text::RegularExpressions::Regex_CachedCodeEntryKey,::System::Text::RegularExpressions::Regex_CachedCodeEntry*>*  s_cache;
...
/// @brief Method Escape, addr 0x181dd3380, size 0x30, virtual false, abstract: false, final false
static inline ::StringW Escape(::StringW  str) ;

/// @brief Method FillCacheDictionary, addr 0x181dd33b0, size 0xa0, virtual false, abstract: false, final false
inline void FillCacheDictionary() ;

/// @brief Method GetCachedCode, addr 0x181dc5a80, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetCachedCodeEntryInternal, addr 0x181dd3450, size 0x5b0, virtual false, abstract: false, final false
...
/// @brief Method GroupNameFromNumber, addr 0x181dd3a00, size 0xb0, virtual false, abstract: false, final false
inline ::StringW GroupNameFromNumber(int32_t  i) ;

/// @brief Method GroupNumberFromName, addr 0x181dd3ab0, size 0xd0, virtual false, abstract: false, final false
inline int32_t GroupNumberFromName(::StringW  name) ;

/// @brief Method InitDefaultMatchTimeout, addr 0x181dd3b80, size 0x1c0, virtual false, abstract: false, final false
static inline ::System::TimeSpan InitDefaultMatchTimeout() ;

/// @brief Method InitializeReferences, addr 0x181dd3d40, size 0x80, virtual false, abstract: false, final false
inline void InitializeReferences() ;

/// @brief Method IsMatch, addr 0x181dd3e90, size 0x60, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input) ;

/// @brief Method IsMatch, addr 0x181dd3dc0, size 0x60, virtual false, abstract: false, final false
static inline bool IsMatch(::StringW  input, ::StringW  pattern) ;

/// @brief Method IsMatch, addr 0x181dd3e20, size 0x70, virtual false, abstract: false, final false
static inline bool IsMatch(::StringW  input, ::StringW  pattern, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method IsMatch, addr 0x181dd3f40, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method IsMatch, addr 0x181dd3ef0, size 0x50, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input, int32_t  startat) ;

/// @brief Method LookupCachedAndPromote, addr 0x181dd4010, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x181dd4320, size 0x60, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input) ;

/// @brief Method Match, addr 0x181dd44a0, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, ::StringW  pattern) ;

/// @brief Method Match, addr 0x181dd4380, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x181dd4450, size 0x50, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, int32_t  startat) ;

/// @brief Method Matches, addr 0x181dd46e0, size 0x120, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::MatchCollection* Matches(::StringW  input) ;

/// @brief Method Matches, addr 0x181dd4570, size 0x170, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::MatchCollection* Matches(::StringW  input, ::StringW  pattern) ;

/// @brief Method Matches, addr 0x181dd4800, size 0x150, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::MatchCollection* Matches(::StringW  input, ::StringW  pattern, ::System::Text::RegularExpressions::RegexOptions  options, ::System::TimeSpan  matchTimeout) ;

/// @brief Method Matches, addr 0x181dd4950, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x181dd4b50, size 0x120, virtual false, abstract: false, final false
static inline ::StringW Replace(::StringW  input, ::StringW  pattern, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x181dd4d30, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x181dd4a50, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x181dd4c70, size 0xc0, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x181dd4e50, size 0xa0, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement, int32_t  count, int32_t  startat) ;

/// @brief Method Run, addr 0x181dd4ef0, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetCacheValue, addr 0x181dd5260, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method TryGetCacheValueSmall, addr 0x181dd5140, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method UseOptionInvariant, addr 0x181dd52f0, size 0x10, virtual false, abstract: false, final false
inline bool UseOptionInvariant() ;

/// @brief Method UseOptionR, addr 0x181dd5300, size 0x10, virtual false, abstract: false, final false
inline bool UseOptionR() ;

/// @brief Method ValidateMatchTimeout, addr 0x181dd5310, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dd58d0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dd54f0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern) ;

/// @brief Method .ctor, addr 0x181dd5860, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method .ctor, addr 0x181dd5560, size 0x300, virtual false, abstract: false, final false
...
static inline ::System::Collections::Generic::Dictionary_2<::System::Text::RegularExpressions::Regex_CachedCodeEntryKey,::System::Text::RegularExpressions::Regex_CachedCodeEntry*>* getStaticF_s_cache() ;
...
/// @brief Method get_Options, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexOptions get_Options() ;

/// @brief Method get_RightToLeft, addr 0x181dd5300, size 0x10, virtual false, abstract: false, final false
...
static inline void setStaticF_s_cache(::System::Collections::Generic::Dictionary_2<::System::Text::RegularExpressions::Regex_CachedCodeEntryKey,::System::Text::RegularExpressions::Regex_CachedCodeEntry*>*  value) ;
...
static_assert(sizeof(::System::Text::RegularExpressions::Regex) == 0x70, "Size mismatch!");
