...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::RegexReplacement*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::RegexReplacement*, "System.Text.RegularExpressions", "RegexReplacement");
...
/// @brief Method Replace, addr 0x181de1e10, size 0x3d0, virtual false, abstract: false, final false
inline ::StringW Replace(::System::Text::RegularExpressions::Regex*  regex, ::StringW  input, int32_t  count, int32_t  startat) ;

/// @brief Method ReplacementImpl, addr 0x181de2330, size 0x140, virtual false, abstract: false, final false
inline void ReplacementImpl(::System::Text::StringBuilder*  sb, ::System::Text::RegularExpressions::Match*  match) ;

/// @brief Method ReplacementImplRTL, addr 0x181de21e0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181de2470, size 0x350, virtual false, abstract: false, final false
inline void _ctor(::StringW  rep, ::System::Text::RegularExpressions::RegexNode*  concat, ::System::Collections::Hashtable*  _caps) ;

/// @brief Method get_Pattern, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexReplacement) == 0x28, "Size mismatch!");
