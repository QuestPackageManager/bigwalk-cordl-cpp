...
/// @brief Method AddMatch, addr 0x181dc9120, size 0x130, virtual true, abstract: false, final false
inline void AddMatch(int32_t  cap, int32_t  start, int32_t  len) ;

/// @brief Method BalanceMatch, addr 0x181dc9250, size 0x100, virtual true, abstract: false, final false
inline void BalanceMatch(int32_t  cap) ;

/// @brief Method GroupToStringImpl, addr 0x181dc9350, size 0x130, virtual true, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> GroupToStringImpl(int32_t  groupnum) ;

/// @brief Method IsMatched, addr 0x181dc9480, size 0x40, virtual true, abstract: false, final false
inline bool IsMatched(int32_t  cap) ;

/// @brief Method LastGroupToStringImpl, addr 0x181dc94c0, size 0x40, virtual false, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> LastGroupToStringImpl() ;

/// @brief Method MatchIndex, addr 0x181dc9500, size 0x50, virtual true, abstract: false, final false
inline int32_t MatchIndex(int32_t  cap) ;

/// @brief Method MatchLength, addr 0x181dc9550, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method NextMatch, addr 0x181dc95a0, size 0x50, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* NextMatch() ;

/// @brief Method RemoveMatch, addr 0x181dc95f0, size 0x10, virtual true, abstract: false, final false
inline void RemoveMatch(int32_t  cap) ;

/// @brief Method Reset, addr 0x181dc9600, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method Tidy, addr 0x181dc96a0, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dc99a0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181dc9880, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method get_Empty, addr 0x181dc99c0, size 0x40, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::Match* get_Empty() ;

/// @brief Method get_Groups, addr 0x181dc9a00, size 0x70, virtual true, abstract: false, final false
