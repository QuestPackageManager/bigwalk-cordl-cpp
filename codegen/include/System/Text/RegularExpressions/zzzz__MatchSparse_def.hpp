...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::MatchSparse*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::MatchSparse*, "System.Text.RegularExpressions", "MatchSparse");
...
/// @brief Method .ctor, addr 0x181dc9030, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Groups, addr 0x181dc90a0, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Text::RegularExpressions::MatchSparse) == 0x80, "Size mismatch!");
