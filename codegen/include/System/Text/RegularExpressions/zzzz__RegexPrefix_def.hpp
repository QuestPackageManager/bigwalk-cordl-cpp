...
/// @brief Method .ctor, addr 0x181de1ba0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_CaseInsensitive, addr 0x180311f90, size 0x20, virtual false, abstract: false, final false
inline bool get_CaseInsensitive() ;

/// @brief Method get_Empty, addr 0x181de1be0, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexPrefix get_Empty() ;

/// @brief Method get_Prefix, addr 0x1803ed930, size 0x10, virtual false, abstract: false, final false
