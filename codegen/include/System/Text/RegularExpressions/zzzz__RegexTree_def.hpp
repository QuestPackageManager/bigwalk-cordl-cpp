...
// Write type traits
MARK_REF_T(::System::Text::RegularExpressions::RegexTree*);
DEFINE_IL2CPP_CLASS(::System::Text::RegularExpressions::RegexTree*, "System.Text.RegularExpressions", "RegexTree");
...
/// @brief Field CapNumList, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_CapNumList, put=__cordl_internal_set_CapNumList)) ::ArrayW<int32_t>  CapNumList;
...
static inline ::System::Text::RegularExpressions::RegexTree* New_ctor(::System::Text::RegularExpressions::RegexNode*  root, ::System::Collections::Hashtable*  caps, ::ArrayW<int32_t>  capNumList, int32_t  capTop, ::System::Collections::Hashtable*  capNames, ::ArrayW<::StringW>  capsList, ::System::Text::RegularExpressions::RegexOptions  options) ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_CapNumList() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_CapNumList() ;
...
constexpr ::System::Text::RegularExpressions::RegexNode* const& __cordl_internal_get_Root() const;
...
constexpr void __cordl_internal_set_CapNumList(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x181de3500, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Text::RegularExpressions::RegexNode*  root, ::System::Collections::Hashtable*  caps, ::ArrayW<int32_t>  capNumList, int32_t  capTop, ::System::Collections::Hashtable*  capNames, ::ArrayW<::StringW>  capsList, ::System::Text::RegularExpressions::RegexOptions  options) ;
...
static_assert(sizeof(::System::Text::RegularExpressions::RegexTree) == 0x48, "Size mismatch!");
