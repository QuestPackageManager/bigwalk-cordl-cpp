...
/// @brief Method InternalFallback, addr 0x1815e89a0, size 0x150, virtual true, abstract: false, final false
inline bool InternalFallback(char16_t  ch, ::by_ref<char16_t*>  chars) ;

/// @brief Method InternalGetNextChar, addr 0x1815e8af0, size 0x40, virtual false, abstract: false, final false
inline char16_t InternalGetNextChar() ;

/// @brief Method InternalInitialize, addr 0x1815e8b30, size 0x40, virtual false, abstract: false, final false
inline void InternalInitialize(char16_t*  charStart, char16_t*  charEnd, ::System::Text::EncoderNLS*  encoder, bool  setEncoder) ;

/// @brief Method InternalReset, addr 0x1815e8b70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x1815e8b90, size 0x40, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ThrowLastCharRecursive, addr 0x1815e8bd0, size 0x50, virtual false, abstract: false, final false
