...
// Write type traits
MARK_REF_T(::System::Text::DecoderExceptionFallbackBuffer*);
DEFINE_IL2CPP_CLASS(::System::Text::DecoderExceptionFallbackBuffer*, "System.Text", "DecoderExceptionFallbackBuffer");
...
/// @brief Method Fallback, addr 0x18176bcd0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Throw, addr 0x18176bce0, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Text::DecoderExceptionFallbackBuffer) == 0x20, "Size mismatch!");
