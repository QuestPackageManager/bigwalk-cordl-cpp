...
DEFINE_IL2CPP_CLASS(::System::Text::NormalizationForm, "System.Text", "NormalizationForm");
// Dependencies 
namespace System::Text {
// Is value type: true
...
static_assert(offsetof(::System::Text::NormalizationForm, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Text::NormalizationForm) == 0x4, "Size mismatch!");
