...
// Write type traits
MARK_REF_T(::System::Collections::Specialized::NameObjectCollectionBase*);
MARK_REF_T(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry*);
MARK_REF_T(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectKeysEnumerator*);
DEFINE_IL2CPP_CLASS(::System::Collections::Specialized::NameObjectCollectionBase*, "System.Collections.Specialized", "NameObjectCollectionBase");
DEFINE_IL2CPP_CLASS(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry*, "System.Collections.Specialized", "NameObjectCollectionBase/NameObjectEntry");
DEFINE_IL2CPP_CLASS(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectKeysEnumerator*, "System.Collections.Specialized", "NameObjectCollectionBase/NameObjectKeysEnumerator");
...
static_assert(sizeof(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry) == 0x20, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x181e177f0, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x181e17880, size 0x40, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181e178c0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Specialized::NameObjectCollectionBase*  coll) ;

/// @brief Method get_Current, addr 0x181e178f0, size 0x70, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Collections::Specialized::NameObjectCollectionBase_NameObjectKeysEnumerator) == 0x28, "Size mismatch!");
...
/// @brief Method BaseAdd, addr 0x181e160c0, size 0x110, virtual false, abstract: false, final false
inline void BaseAdd(::StringW  name, ::System::Object*  value) ;

/// @brief Method BaseGet, addr 0x181e162c0, size 0x70, virtual false, abstract: false, final false
inline ::System::Object* BaseGet(int32_t  index) ;

/// @brief Method BaseGet, addr 0x181e16240, size 0x80, virtual false, abstract: false, final false
inline ::System::Object* BaseGet(::StringW  name) ;

/// @brief Method BaseGetKey, addr 0x181e161d0, size 0x70, virtual false, abstract: false, final false
inline ::StringW BaseGetKey(int32_t  index) ;

/// @brief Method BaseRemove, addr 0x181e16330, size 0x290, virtual false, abstract: false, final false
inline void BaseRemove(::StringW  name) ;

/// @brief Method BaseSet, addr 0x181e165c0, size 0xf0, virtual false, abstract: false, final false
inline void BaseSet(::StringW  name, ::System::Object*  value) ;

/// @brief Method FindEntry, addr 0x181e166b0, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::Specialized::NameObjectCollectionBase_NameObjectEntry* FindEntry(::StringW  key) ;

/// @brief Method GetEnumerator, addr 0x181e16720, size 0x50, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetObjectData, addr 0x181e16770, size 0x4a0, virtual true, abstract: false, final false
...
static inline ::System::Collections::Specialized::NameObjectCollectionBase* New_ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method OnDeserialization, addr 0x181e16c10, size 0x5f0, virtual true, abstract: false, final false
inline void OnDeserialization(::System::Object*  sender) ;

/// @brief Method Reset, addr 0x181e17200, size 0xa0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x181e172a0, size 0xb0, virtual false, abstract: false, final false
inline void Reset(int32_t  capacity) ;

/// @brief Method System.Collections.ICollection.CopyTo, addr 0x181e17350, size 0x240, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181e17720, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x1815fd430, size 0x20, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Specialized::NameObjectCollectionBase) == 0x50, "Size mismatch!");
