...
// Write type traits
MARK_REF_T(::System::Collections::Specialized::NotifyCollectionChangedEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Collections::Specialized::NotifyCollectionChangedEventArgs*, "System.Collections.Specialized", "NotifyCollectionChangedEventArgs");
...
/// @brief Method InitializeAdd, addr 0x181e19ba0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method InitializeAddOrRemove, addr 0x181e19ae0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method InitializeMoveOrReplace, addr 0x181e19c10, size 0xc0, virtual false, abstract: false, final false
inline void InitializeMoveOrReplace(::System::Collections::Specialized::NotifyCollectionChangedAction  action, ::System::Collections::IList*  newItems, ::System::Collections::IList*  oldItems, int32_t  startingIndex, int32_t  oldStartingIndex) ;

/// @brief Method InitializeRemove, addr 0x181e19cd0, size 0x70, virtual false, abstract: false, final false
...
static inline ::System::Collections::Specialized::NotifyCollectionChangedEventArgs* New_ctor(::System::Collections::Specialized::NotifyCollectionChangedAction  action, ::System::Object*  changedItem, int32_t  index) ;

static inline ::System::Collections::Specialized::NotifyCollectionChangedEventArgs* New_ctor(::System::Collections::Specialized::NotifyCollectionChangedAction  action, ::System::Object*  newItem, ::System::Object*  oldItem, int32_t  index) ;

static inline ::System::Collections::Specialized::NotifyCollectionChangedEventArgs* New_ctor(::System::Collections::Specialized::NotifyCollectionChangedAction  action, ::System::Collections::IList*  newItems, ::System::Collections::IList*  oldItems, int32_t  startingIndex) ;
...
/// @brief Method .ctor, addr 0x181e19eb0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Specialized::NotifyCollectionChangedAction  action) ;

/// @brief Method .ctor, addr 0x181e19d40, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e1a080, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e19f40, size 0x140, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Specialized::NotifyCollectionChangedEventArgs) == 0x30, "Size mismatch!");
