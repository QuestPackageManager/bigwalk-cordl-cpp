...
/// @brief Method CreateMask, addr 0x1802edd00, size 0x10, virtual false, abstract: false, final false
static inline int32_t CreateMask() ;

/// @brief Method CreateMask, addr 0x181e0ea90, size 0x40, virtual false, abstract: false, final false
static inline int32_t CreateMask(int32_t  previous) ;

/// @brief Method Equals, addr 0x181e0ead0, size 0x70, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x181e0eb40, size 0x40, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x181e0eb80, size 0xc0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x181e0ec40, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW ToString(::System::Collections::Specialized::BitVector32  value) ;

/// @brief Method get_Item, addr 0x181e0ecf0, size 0x20, virtual false, abstract: false, final false
inline bool get_Item(int32_t  bit) ;

/// @brief Method set_Item, addr 0x181e0ed10, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Specialized::BitVector32) == 0x4, "Size mismatch!");
