...
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::LargeArrayBuilder_1, "System.Collections.Generic", "LargeArrayBuilder`1");
...
inline void AddWithBufferAllocation(T  item, ::by_ref<::ArrayW<T>>  destination, ::by_ref<int32_t>  index) ;
...
inline ::ArrayW<T> GetBuffer(int32_t  index) ;
...
inline bool TryMove(::by_ref<::ArrayW<T>>  array) ;
...
/// @brief Field _buffers, offset: 0x10, size: 0x10, def value: None
 ::System::Collections::Generic::ArrayBuilder_1<::ArrayW<T>>  _buffers;
