...
// Write type traits
MARK_REF_T(::System::Collections::Generic::BitHelper*);
DEFINE_IL2CPP_CLASS(::System::Collections::Generic::BitHelper*, "System.Collections.Generic", "BitHelper");
...
/// @brief Field _array, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__array, put=__cordl_internal_set__array)) ::ArrayW<int32_t>  _array;
...
/// @brief Method IsMarked, addr 0x181b34890, size 0x60, virtual false, abstract: false, final false
inline bool IsMarked(int32_t  bitPosition) ;

/// @brief Method MarkBit, addr 0x181b348f0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ToIntArrayLength, addr 0x181b34940, size 0x20, virtual false, abstract: false, final false
static inline int32_t ToIntArrayLength(int32_t  n) ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get__array() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__array() ;
...
constexpr void __cordl_internal_set__array(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x181b34970, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<int32_t>  bitArray, int32_t  length) ;

/// @brief Method .ctor, addr 0x181b34960, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Collections::Generic::BitHelper) == 0x30, "Size mismatch!");
