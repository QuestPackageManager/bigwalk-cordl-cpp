...
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::List_1_Enumerator, "System.Collections.Generic", "List`1/Enumerator");
// Dependencies 
namespace System::Collections::Generic {
// cpp template
template<typename T>
...
/// @brief Field s_emptyArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_emptyArray, put=setStaticF_s_emptyArray)) ::ArrayW<T>  s_emptyArray;
...
static inline ::ArrayW<T> getStaticF_s_emptyArray() ;
...
static inline void setStaticF_s_emptyArray(::ArrayW<T>  value) ;
