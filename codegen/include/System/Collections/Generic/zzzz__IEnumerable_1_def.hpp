...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::IEnumerable_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::IEnumerable_1, "System.Collections.Generic", "IEnumerable`1");
// Dependencies 
namespace System::Collections::Generic {
// cpp template
template<typename T>
