...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::NullableEqualityComparer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::NullableEqualityComparer_1, "System.Collections.Generic", "NullableEqualityComparer`1");
...
inline int32_t IndexOf(::ArrayW<::System::Nullable_1<T>>  array, ::System::Nullable_1<T>  value, int32_t  startIndex, int32_t  count) ;

/// @brief Method LastIndexOf, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline int32_t LastIndexOf(::ArrayW<::System::Nullable_1<T>>  array, ::System::Nullable_1<T>  value, int32_t  startIndex, int32_t  count) ;
