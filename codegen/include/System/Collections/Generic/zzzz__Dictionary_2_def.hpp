...
namespace System::Collections::Generic {
template<typename TKey,typename TValue>
struct KeyCollection_Dictionary_2_Enumerator;
}
namespace System::Collections::Generic {
template<typename TKey,typename TValue>
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::Dictionary_2);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::Dictionary_2_KeyCollection);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::Dictionary_2_ValueCollection);
...
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::Dictionary_2, "System.Collections.Generic", "Dictionary`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::Dictionary_2_KeyCollection, "System.Collections.Generic", "Dictionary`2/KeyCollection");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::Dictionary_2_ValueCollection, "System.Collections.Generic", "Dictionary`2/ValueCollection");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::Dictionary_2_Entry, "System.Collections.Generic", "Dictionary`2/Entry");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::Dictionary_2_Enumerator, "System.Collections.Generic", "Dictionary`2/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::KeyCollection_Dictionary_2_Enumerator, "System.Collections.Generic", "Dictionary`2/KeyCollection/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::System::Collections::Generic::ValueCollection_Dictionary_2_Enumerator, "System.Collections.Generic", "Dictionary`2/ValueCollection/Enumerator");
// Dependencies 
namespace System::Collections::Generic {
// cpp template
template<typename TKey,typename TValue>
...
// Ctor Parameters [CppParam { name: "_dictionary", ty: "::System::Collections::Generic::Dictionary_2<TKey,TValue>*", modifiers: "", def_value: None }, CppParam { name: "_version", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_current", ty: "::System::Collections::Generic::KeyValuePair_2<TKey,TValue>", modifiers: "", def_value: None }, CppParam { name: "_getEnumeratorRetType", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "_dictionary", ty: "::System::Collections::Generic::Dictionary_2<TKey,TValue>*", modifiers: "", def_value: None }, CppParam { name: "_index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_version", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_currentKey", ty: "TKey", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "_dictionary", ty: "::System::Collections::Generic::Dictionary_2<TKey,TValue>*", modifiers: "", def_value: None }, CppParam { name: "_index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_version", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_currentValue", ty: "TValue", modifiers: "", def_value: None }]
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>  _entries;
...
static inline ::System::Collections::Generic::Dictionary_2<TKey,TValue>* New_ctor(::System::Collections::Generic::IDictionary_2<TKey,TValue>*  dictionary, ::System::Collections::Generic::IEqualityComparer_1<TKey>*  comparer) ;

static inline ::System::Collections::Generic::Dictionary_2<TKey,TValue>* New_ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;
...
inline bool Remove(TKey  key, ::by_ref<TValue>  value) ;
...
constexpr ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>> const& __cordl_internal_get__entries() const;

constexpr ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>& __cordl_internal_get__entries() ;
...
constexpr void __cordl_internal_set__entries(::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>  value) ;
...
/// @brief Field _entries, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::Dictionary_2_Entry<TKey,TValue>>  ____entries;
