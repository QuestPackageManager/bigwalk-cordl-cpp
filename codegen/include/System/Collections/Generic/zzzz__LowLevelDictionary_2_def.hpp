...
class LowLevelDictionary_2_DefaultComparer_1;
}
namespace System::Collections::Generic {
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::LowLevelDictionary_2);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1);
MARK_GEN_REF_T_PTR(::System::Collections::Generic::LowLevelDictionary_2_Entry);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::LowLevelDictionary_2, "System.Collections.Generic", "LowLevelDictionary`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1, "System.Collections.Generic", "LowLevelDictionary`2/DefaultComparer`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::LowLevelDictionary_2_Entry, "System.Collections.Generic", "LowLevelDictionary`2/Entry");
...
// Declarations
template<typename T>
using DefaultComparer_1 = ::System::Collections::Generic::LowLevelDictionary_2_DefaultComparer_1<TKey, TValue, T>;
...
/// @brief Field _buckets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__buckets, put=__cordl_internal_set__buckets)) ::ArrayW<::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey,TValue>*>  _buckets;
...
constexpr ::ArrayW<::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey,TValue>*> const& __cordl_internal_get__buckets() const;

constexpr ::ArrayW<::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey,TValue>*>& __cordl_internal_get__buckets() ;
...
constexpr void __cordl_internal_set__buckets(::ArrayW<::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey,TValue>*>  value) ;
...
/// @brief Field _buckets, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::LowLevelDictionary_2_Entry<TKey,TValue>*>  ____buckets;
