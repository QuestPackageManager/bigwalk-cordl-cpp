...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Generic::ArraySortHelper_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Generic::ArraySortHelper_1, "System.Collections.Generic", "ArraySortHelper`1");
...
inline int32_t BinarySearch(::ArrayW<T>  array, int32_t  index, int32_t  length, T  value, ::System::Collections::Generic::IComparer_1<T>*  comparer) ;

/// @brief Method DownHeap, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void DownHeap(::ArrayW<T>  keys, int32_t  i, int32_t  n, int32_t  lo, ::System::Comparison_1<T>*  comparer) ;

/// @brief Method Heapsort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void Heapsort(::ArrayW<T>  keys, int32_t  lo, int32_t  hi, ::System::Comparison_1<T>*  comparer) ;

/// @brief Method InsertionSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void InsertionSort(::ArrayW<T>  keys, int32_t  lo, int32_t  hi, ::System::Comparison_1<T>*  comparer) ;

/// @brief Method InternalBinarySearch, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline int32_t InternalBinarySearch(::ArrayW<T>  array, int32_t  index, int32_t  length, T  value, ::System::Collections::Generic::IComparer_1<T>*  comparer) ;

/// @brief Method IntroSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void IntroSort(::ArrayW<T>  keys, int32_t  lo, int32_t  hi, int32_t  depthLimit, ::System::Comparison_1<T>*  comparer) ;

/// @brief Method IntrospectiveSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void IntrospectiveSort(::ArrayW<T>  keys, int32_t  left, int32_t  length, ::System::Comparison_1<T>*  comparer) ;
...
static inline int32_t PickPivotAndPartition(::ArrayW<T>  keys, int32_t  lo, int32_t  hi, ::System::Comparison_1<T>*  comparer) ;

/// @brief Method Sort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void Sort(::ArrayW<T>  keys, int32_t  index, int32_t  length, ::System::Collections::Generic::IComparer_1<T>*  comparer) ;

/// @brief Method Sort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline void Sort(::ArrayW<T>  keys, int32_t  index, int32_t  length, ::System::Comparison_1<T>*  comparer) ;
...
static inline void SwapIfGreater(::ArrayW<T>  keys, ::System::Comparison_1<T>*  comparer, int32_t  a, int32_t  b) ;
