...
inline void SnapForObservation(::by_ref<::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*>  head, ::by_ref<int32_t>  headHead, ::by_ref<::System::Collections::Concurrent::ConcurrentQueue_1_Segment<T>*>  tail, ::by_ref<int32_t>  tailTail) ;
