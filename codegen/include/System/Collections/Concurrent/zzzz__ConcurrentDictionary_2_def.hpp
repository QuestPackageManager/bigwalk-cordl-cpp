...
class ConcurrentDictionary_2_DictionaryEnumerator;
}
namespace System::Collections::Concurrent {
template<typename TKey,typename TValue>
class ConcurrentDictionary_2_Node;
}
namespace System::Collections::Concurrent {
template<typename TKey,typename TValue>
class ConcurrentDictionary_2_Tables;
}
namespace System::Collections::Concurrent {
template<typename TKey,typename TValue>
class ConcurrentDictionary_2__GetEnumerator_d__35;
}
...
// Write type traits
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_DictionaryEnumerator);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_Node);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_Tables);
MARK_GEN_REF_T_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2__GetEnumerator_d__35);
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2, "System.Collections.Concurrent", "ConcurrentDictionary`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_DictionaryEnumerator, "System.Collections.Concurrent", "ConcurrentDictionary`2/DictionaryEnumerator");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_Node, "System.Collections.Concurrent", "ConcurrentDictionary`2/Node");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2_Tables, "System.Collections.Concurrent", "ConcurrentDictionary`2/Tables");
DEFINE_IL2CPP_GEN_CLASS_PTR(::System::Collections::Concurrent::ConcurrentDictionary_2__GetEnumerator_d__35, "System.Collections.Concurrent", "ConcurrentDictionary`2/<GetEnumerator>d__35");
...
static inline ::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>* New_ctor(TKey  key, TValue  value, int32_t  hashcode, ::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*  next) ;
...
// Dependencies System.Collections.Concurrent.ConcurrentDictionary`2::Node<TKey, TValue>, System.Object
namespace System::Collections::Concurrent {
// cpp template
template<typename TKey,typename TValue>
// Is value type: false
...
/// @brief Field _buckets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__buckets, put=__cordl_internal_set__buckets)) ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  _buckets;

/// @brief Field _countPerLock, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__countPerLock, put=__cordl_internal_set__countPerLock)) ::ArrayW<int32_t>  _countPerLock;

/// @brief Field _locks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__locks, put=__cordl_internal_set__locks)) ::ArrayW<::System::Object*>  _locks;

static inline ::System::Collections::Concurrent::ConcurrentDictionary_2_Tables<TKey,TValue>* New_ctor(::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  buckets, ::ArrayW<::System::Object*>  locks, ::ArrayW<int32_t>  countPerLock) ;

constexpr ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*> const& __cordl_internal_get__buckets() const;

constexpr ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>& __cordl_internal_get__buckets() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get__countPerLock() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get__countPerLock() ;

constexpr ::ArrayW<::System::Object*> const& __cordl_internal_get__locks() const;

constexpr ::ArrayW<::System::Object*>& __cordl_internal_get__locks() ;

constexpr void __cordl_internal_set__buckets(::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  value) ;

constexpr void __cordl_internal_set__countPerLock(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set__locks(::ArrayW<::System::Object*>  value) ;

/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  buckets, ::ArrayW<::System::Object*>  locks, ::ArrayW<int32_t>  countPerLock) ;
...
/// @brief Field _buckets, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  ____buckets;

/// @brief Field _locks, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::System::Object*>  ____locks;

/// @brief Field _countPerLock, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<int32_t>  ____countPerLock;
...
/// @brief Field _enumerator, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__enumerator, put=__cordl_internal_set__enumerator)) ::System::Collections::Generic::IEnumerator_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  _enumerator;
...
static inline ::System::Collections::Concurrent::ConcurrentDictionary_2_DictionaryEnumerator<TKey,TValue>* New_ctor(::System::Collections::Concurrent::ConcurrentDictionary_2<TKey,TValue>*  dictionary) ;
...
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_System_Collections_Generic_KeyValuePair_TKey_TValue___get_Current)) ::System::Collections::Generic::KeyValuePair_2<TKey,TValue>  System_Collections_Generic_IEnumerator_System_Collections_Generic_KeyValuePair_TKey_TValue___Current;
...
/// @brief Field <buckets>5__2, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__buckets_5__2, put=__cordl_internal_set__buckets_5__2)) ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  _buckets_5__2;
...
/// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<TKey,TValue>>.get_Current, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
...
constexpr ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*> const& __cordl_internal_get__buckets_5__2() const;

constexpr ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>& __cordl_internal_get__buckets_5__2() ;
...
constexpr void __cordl_internal_set__buckets_5__2(::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  value) ;
...
/// @brief Field <buckets>5__2, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Concurrent::ConcurrentDictionary_2_Node<TKey,TValue>*>  ____buckets_5__2;
...
/// @brief Field _serializationArray, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__serializationArray, put=__cordl_internal_set__serializationArray)) ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  _serializationArray;
...
inline void AcquireAllLocks(::by_ref<int32_t>  locksAcquired) ;

/// @brief Method AcquireLocks, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void AcquireLocks(int32_t  fromInclusive, int32_t  toExclusive, ::by_ref<int32_t>  locksAcquired) ;
...
inline void CopyToEntries(::ArrayW<::System::Collections::DictionaryEntry>  array, int32_t  index) ;

/// @brief Method CopyToObjects, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void CopyToObjects(::ArrayW<::System::Object*>  array, int32_t  index) ;

/// @brief Method CopyToPairs, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void CopyToPairs(::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  array, int32_t  index) ;
...
static inline void GetBucketAndLockNo(int32_t  hashcode, ::by_ref<int32_t>  bucketNo, ::by_ref<int32_t>  lockNo, int32_t  bucketCount, int32_t  lockCount) ;
...
static inline ::System::Collections::Concurrent::ConcurrentDictionary_2<TKey,TValue>* New_ctor(int32_t  concurrencyLevel, int32_t  capacity, bool  growLockArray, ::System::Collections::Generic::IEqualityComparer_1<TKey>*  comparer) ;
...
inline void System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___CopyTo(::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  array, int32_t  index) ;
...
inline ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>> ToArray() ;
...
inline bool TryAddInternal(TKey  key, int32_t  hashcode, TValue  value, bool  updateIfExists, bool  acquireLock, ::by_ref<TValue>  resultingValue) ;
...
inline bool TryGetValueInternal(TKey  key, int32_t  hashcode, ::by_ref<TValue>  value) ;

/// @brief Method TryRemove, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool TryRemove(TKey  key, ::by_ref<TValue>  value) ;

/// @brief Method TryRemoveInternal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline bool TryRemoveInternal(TKey  key, ::by_ref<TValue>  value, bool  matchValue, TValue  oldValue) ;
...
constexpr ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>> const& __cordl_internal_get__serializationArray() const;

constexpr ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>& __cordl_internal_get__serializationArray() ;
...
constexpr void __cordl_internal_set__serializationArray(::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  value) ;
...
/// @brief Field _serializationArray, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>  ____serializationArray;
