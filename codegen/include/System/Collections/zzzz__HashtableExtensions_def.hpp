...
template<typename T>
static inline bool TryGetValue(::System::Collections::Hashtable*  table, ::System::Object*  key, ::by_ref<T>  value) ;
...
static_assert(sizeof(::System::Collections::HashtableExtensions) == 0x10, "Size mismatch!");
