...
/// @brief Method GetGenericArguments, addr 0x181683100, size 0x20, virtual true, abstract: false, final true
inline ::ArrayW<::System::Type*> GetGenericArguments() ;

/// @brief Method GetGenericTypeDefinition, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final true
inline ::System::Type* GetGenericTypeDefinition() ;

/// @brief Method HasElementTypeImpl, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x181683120, size 0x110, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181683230, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  genericTypeDefinition, ::ArrayW<::System::Type*>  typeArguments) ;

/// @brief Method get_ContainsGenericParameters, addr 0x181683340, size 0x80, virtual true, abstract: false, final true
inline bool get_ContainsGenericParameters() ;

/// @brief Method get_ElementType, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final true
inline ::System::Reflection::SignatureType* get_ElementType() ;

/// @brief Method get_GenericParameterPosition, addr 0x1816833c0, size 0x20, virtual true, abstract: false, final true
inline int32_t get_GenericParameterPosition() ;

/// @brief Method get_GenericTypeArguments, addr 0x1816833e0, size 0x50, virtual true, abstract: false, final true
inline ::ArrayW<::System::Type*> get_GenericTypeArguments() ;

/// @brief Method get_IsConstructedGenericType, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
inline bool get_IsConstructedGenericType() ;

/// @brief Method get_IsGenericMethodParameter, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsGenericMethodParameter() ;

/// @brief Method get_IsGenericParameter, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsGenericParameter() ;

/// @brief Method get_IsGenericTypeDefinition, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_Name, addr 0x181683430, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Name() ;

/// @brief Method get_Namespace, addr 0x181683450, size 0x20, virtual true, abstract: false, final true
