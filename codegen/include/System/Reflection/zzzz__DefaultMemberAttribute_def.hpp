...
/// @brief Method get_MemberName, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Reflection::DefaultMemberAttribute) == 0x18, "Size mismatch!");
