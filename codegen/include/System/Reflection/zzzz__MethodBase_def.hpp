...
/// @brief Method ConstructParameters, addr 0x18167bee0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method FormatNameAndSig, addr 0x18167c060, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method GetMethodFromHandle, addr 0x18167c2a0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method GetParameterTypes, addr 0x18167c3e0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method GetParametersCount, addr 0x18167c4a0, size 0x20, virtual true, abstract: false, final false
inline int32_t GetParametersCount() ;

/// @brief Method GetParametersInternal, addr 0x18167c4c0, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<::System::Reflection::ParameterInfo*> GetParametersInternal() ;

/// @brief Method GetParametersNoCopy, addr 0x18167c4c0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x18167c4e0, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method get_CallingConvention, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::CallingConventions get_CallingConvention() ;

/// @brief Method get_ContainsGenericParameters, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_ContainsGenericParameters() ;

/// @brief Method get_IsAbstract, addr 0x18167c520, size 0x30, virtual true, abstract: false, final true
inline bool get_IsAbstract() ;

/// @brief Method get_IsConstructor, addr 0x18167c550, size 0x80, virtual true, abstract: false, final true
inline bool get_IsConstructor() ;

/// @brief Method get_IsGenericMethod, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsGenericMethod() ;

/// @brief Method get_IsGenericMethodDefinition, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsGenericMethodDefinition() ;

/// @brief Method get_IsPublic, addr 0x18167c5d0, size 0x30, virtual true, abstract: false, final true
inline bool get_IsPublic() ;

/// @brief Method get_IsSecurityCritical, addr 0x18167c600, size 0x20, virtual true, abstract: false, final false
inline bool get_IsSecurityCritical() ;

/// @brief Method get_IsSpecialName, addr 0x18167c620, size 0x30, virtual true, abstract: false, final true
inline bool get_IsSpecialName() ;

/// @brief Method get_IsStatic, addr 0x18167c650, size 0x30, virtual true, abstract: false, final true
inline bool get_IsStatic() ;

/// @brief Method get_IsVirtual, addr 0x18167c680, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x18167c6b0, size 0x170, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Reflection::MethodBase*  left, ::System::Reflection::MethodBase*  right) ;

/// @brief Method op_Inequality, addr 0x18167c820, size 0x20, virtual false, abstract: false, final false
