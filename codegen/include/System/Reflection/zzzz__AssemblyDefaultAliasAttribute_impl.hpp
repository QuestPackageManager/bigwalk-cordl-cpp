...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::System::Reflection::AssemblyDefaultAliasAttribute::*)(::StringW)>(&::System::Reflection::AssemblyDefaultAliasAttribute::_ctor)> {
  ...
  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::Reflection::AssemblyDefaultAliasAttribute*>(),
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->____DefaultAlias_k__BackingField = value;
}
...
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, defaultAlias);
}
...
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::System::Reflection::AssemblyDefaultAliasAttribute*>(defaultAlias));
}
// Ctor Parameters []
