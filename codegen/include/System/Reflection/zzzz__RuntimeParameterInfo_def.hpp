...
/// @brief Method FormatParameters, addr 0x181681820, size 0x160, virtual false, abstract: false, final false
static inline void FormatParameters(::System::Text::StringBuilder*  sb, ::ArrayW<::System::Reflection::ParameterInfo*>  p, ::System::Reflection::CallingConventions  callingConvention, bool  serialization) ;
...
/// @brief Method GetDefaultValueImpl, addr 0x1816819a0, size 0x60, virtual false, abstract: false, final false
inline ::System::Object* GetDefaultValueImpl(::System::Reflection::ParameterInfo*  pinfo) ;

/// @brief Method GetPseudoCustomAttributes, addr 0x181681de0, size 0x1a0, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*> GetPseudoCustomAttributes() ;

/// @brief Method GetPseudoCustomAttributesData, addr 0x181681a00, size 0x3e0, virtual false, abstract: false, final false
...
/// @brief Method New, addr 0x181681f80, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method New, addr 0x1816820b0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181682150, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181682260, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::ParameterInfo*  pinfo, ::System::Reflection::MemberInfo*  member) ;

/// @brief Method .ctor, addr 0x1816821e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_DefaultValue, addr 0x181682380, size 0x1e0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Reflection::RuntimeParameterInfo) == 0x48, "Size mismatch!");
