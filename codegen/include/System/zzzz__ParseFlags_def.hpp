...
DEFINE_IL2CPP_CLASS(::System::ParseFlags, "System", "ParseFlags");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::ParseFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::ParseFlags) == 0x4, "Size mismatch!");
