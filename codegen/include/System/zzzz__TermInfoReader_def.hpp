...
// Write type traits
MARK_REF_T(::System::TermInfoReader*);
DEFINE_IL2CPP_CLASS(::System::TermInfoReader*, "System", "TermInfoReader");
...
/// @brief Method DetermineVersion, addr 0x1817562f0, size 0x80, virtual false, abstract: false, final false
inline void DetermineVersion(int16_t  magic) ;

/// @brief Method Get, addr 0x1817565f0, size 0xb0, virtual false, abstract: false, final false
inline ::StringW Get(::System::TermInfoStrings  tstr) ;

/// @brief Method Get, addr 0x1817566a0, size 0x80, virtual false, abstract: false, final false
inline int32_t Get(::System::TermInfoNumbers  number) ;

/// @brief Method GetInt16, addr 0x181756370, size 0x40, virtual false, abstract: false, final false
inline int16_t GetInt16(::ArrayW<uint8_t>  buffer, int32_t  offset) ;

/// @brief Method GetString, addr 0x181756570, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x1817563b0, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetStringBytes(::ArrayW<uint8_t>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x181756440, size 0x130, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> GetStringBytes(::System::TermInfoStrings  tstr) ;

static inline ::System::TermInfoReader* New_ctor(::StringW  term, ::ArrayW<uint8_t>  buffer) ;

static inline ::System::TermInfoReader* New_ctor(::StringW  term, ::StringW  filename) ;

/// @brief Method ReadHeader, addr 0x181756720, size 0x180, virtual false, abstract: false, final false
inline void ReadHeader(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  position) ;

/// @brief Method ReadNames, addr 0x1817568a0, size 0x30, virtual false, abstract: false, final false
inline void ReadNames(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  position) ;
...
/// @brief Method .ctor, addr 0x1817568d0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  term, ::ArrayW<uint8_t>  buffer) ;

/// @brief Method .ctor, addr 0x181756940, size 0x150, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::TermInfoReader) == 0x30, "Size mismatch!");
