...
// Write type traits
MARK_REF_T(::System::ConsoleCancelEventArgs*);
DEFINE_IL2CPP_CLASS(::System::ConsoleCancelEventArgs*, "System", "ConsoleCancelEventArgs");
...
/// @brief Method .ctor, addr 0x1817209e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Cancel, addr 0x18039e7b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::ConsoleCancelEventArgs) == 0x18, "Size mismatch!");
