...
DEFINE_IL2CPP_CLASS(::System::AppContext_SwitchValueState, "System", "AppContext/SwitchValueState");
...
static_assert(offsetof(::System::AppContext_SwitchValueState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::AppContext_SwitchValueState) == 0x4, "Size mismatch!");
...
/// @brief Method InitializeDefaultSwitchValues, addr 0x18172e910, size 0x110, virtual false, abstract: false, final false
static inline void InitializeDefaultSwitchValues() ;

/// @brief Method TryGetSwitch, addr 0x18172ea20, size 0x300, virtual false, abstract: false, final false
