...
// Write type traits
MARK_REF_T(::System::AssemblyLoadEventArgs*);
DEFINE_IL2CPP_CLASS(::System::AssemblyLoadEventArgs*, "System", "AssemblyLoadEventArgs");
...
/// @brief Field <LoadedAssembly>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__LoadedAssembly_k__BackingField, put=__cordl_internal_set__LoadedAssembly_k__BackingField)) ::System::Reflection::Assembly*  _LoadedAssembly_k__BackingField;
...
static_assert(sizeof(::System::AssemblyLoadEventArgs) == 0x18, "Size mismatch!");
