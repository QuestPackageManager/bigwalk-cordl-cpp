...
// Write type traits
MARK_REF_T(::System::LocalDataStoreElement*);
DEFINE_IL2CPP_CLASS(::System::LocalDataStoreElement*, "System", "LocalDataStoreElement");
...
/// @brief Method .ctor, addr 0x1803bda70, size 0x10, virtual false, abstract: false, final false
inline void _ctor(int64_t  cookie) ;

/// @brief Method get_Cookie, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::LocalDataStoreElement) == 0x20, "Size mismatch!");
