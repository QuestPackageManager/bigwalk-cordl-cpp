...
static_assert(offsetof(::System::Diagnostics::StackTrace_TraceFormat, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method AddFrames, addr 0x1816ceb90, size 0x430, virtual false, abstract: false, final false
inline bool AddFrames(::System::Text::StringBuilder*  sb, bool  separator, ::by_ref<bool>  isAsync) ;

/// @brief Method ConvertAsyncStateMachineMethod, addr 0x1816cefc0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method GetAotId, addr 0x1816cf1b0, size 0xc0, virtual false, abstract: false, final false
static inline ::StringW GetAotId() ;

/// @brief Method GetFrame, addr 0x1816cf270, size 0x50, virtual true, abstract: false, final false
inline ::System::Diagnostics::StackFrame* GetFrame(int32_t  index) ;

/// @brief Method GetFrames, addr 0x1816cf2c0, size 0x140, virtual true, abstract: false, final false
inline ::ArrayW<::System::Diagnostics::StackFrame*> GetFrames() ;

/// @brief Method GetFullNameForStackTrace, addr 0x1816cf400, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x1816cf8f0, size 0x120, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x1816cfa10, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816cfb30, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816cfad0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x1816cfa40, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x1816cfa30, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x1816cfac0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_FrameCount, addr 0x1816cfb40, size 0x20, virtual true, abstract: false, final false
inline int32_t get_FrameCount() ;

/// @brief Method get_trace, addr 0x1816cfb60, size 0x10, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Diagnostics::StackFrame*> get_trace(::System::Exception*  e, int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method init_frames, addr 0x1816cfb70, size 0x150, virtual false, abstract: false, final false
