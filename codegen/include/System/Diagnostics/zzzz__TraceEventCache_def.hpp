...
// Write type traits
MARK_REF_T(::System::Diagnostics::TraceEventCache*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::TraceEventCache*, "System.Diagnostics", "TraceEventCache");
...
/// @brief Method GetProcessId, addr 0x181de51a0, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetProcessId() ;

/// @brief Method GetThreadId, addr 0x18174a3b0, size 0x20, virtual false, abstract: false, final false
static inline int32_t GetThreadId() ;

/// @brief Method InitProcessInfo, addr 0x181de51d0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181de5330, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Callstack, addr 0x181de5380, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Callstack() ;

/// @brief Method get_DateTime, addr 0x181de53c0, size 0x70, virtual false, abstract: false, final false
inline ::System::DateTime get_DateTime() ;

/// @brief Method get_LogicalOperationStack, addr 0x181de5430, size 0xe0, virtual false, abstract: false, final false
inline ::System::Collections::Stack* get_LogicalOperationStack() ;

/// @brief Method get_ProcessId, addr 0x181de51a0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_ProcessId() ;

/// @brief Method get_ThreadId, addr 0x181de5510, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_ThreadId() ;

/// @brief Method get_Timestamp, addr 0x181de5550, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::TraceEventCache) == 0x28, "Size mismatch!");
