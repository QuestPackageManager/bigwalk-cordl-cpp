...
/// @brief Method GetFileColumnNumber, addr 0x1803231b0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetFileColumnNumber() ;

/// @brief Method GetFileLineNumber, addr 0x180392fe0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetFileLineNumber() ;

/// @brief Method GetFileName, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final false
inline ::StringW GetFileName() ;

/// @brief Method GetILOffset, addr 0x180303b50, size 0x10, virtual true, abstract: false, final false
inline int32_t GetILOffset() ;

/// @brief Method GetInternalMethodName, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::StringW GetInternalMethodName() ;

/// @brief Method GetMethod, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
inline ::System::Reflection::MethodBase* GetMethod() ;

/// @brief Method GetMethodAddress, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline int64_t GetMethodAddress() ;

/// @brief Method GetMethodIndex, addr 0x180396ee0, size 0x10, virtual false, abstract: false, final false
inline uint32_t GetMethodIndex() ;

/// @brief Method GetNativeOffset, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetNativeOffset() ;

/// @brief Method GetSecureFileName, addr 0x1816ce8d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x1816ce910, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816ceb00, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816ceaa0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method get_frame_info, addr 0x1816ceb50, size 0x40, virtual false, abstract: false, final false
static inline bool get_frame_info(int32_t  skip, bool  needFileInfo, ::by_ref<::System::Reflection::MethodBase*>  method, ::by_ref<int32_t>  iloffset, ::by_ref<int32_t>  native_offset, ::by_ref<::StringW>  file, ::by_ref<int32_t>  line, ::by_ref<int32_t>  column) ;
