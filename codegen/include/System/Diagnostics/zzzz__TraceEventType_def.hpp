...
DEFINE_IL2CPP_CLASS(::System::Diagnostics::TraceEventType, "System.Diagnostics", "TraceEventType");
// Dependencies 
namespace System::Diagnostics {
// Is value type: true
...
static_assert(offsetof(::System::Diagnostics::TraceEventType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::TraceEventType) == 0x4, "Size mismatch!");
