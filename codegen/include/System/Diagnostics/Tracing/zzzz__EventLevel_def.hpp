...
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Tracing::EventLevel, "System.Diagnostics.Tracing", "EventLevel");
// Dependencies 
namespace System::Diagnostics::Tracing {
// Is value type: true
...
static_assert(offsetof(::System::Diagnostics::Tracing::EventLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::Tracing::EventLevel) == 0x4, "Size mismatch!");
