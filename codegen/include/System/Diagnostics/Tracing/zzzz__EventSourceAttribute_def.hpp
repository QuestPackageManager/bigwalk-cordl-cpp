...
// Write type traits
MARK_REF_T(::System::Diagnostics::Tracing::EventSourceAttribute*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Tracing::EventSourceAttribute*, "System.Diagnostics.Tracing", "EventSourceAttribute");
...
/// @brief Method set_Guid, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::Tracing::EventSourceAttribute) == 0x20, "Size mismatch!");
