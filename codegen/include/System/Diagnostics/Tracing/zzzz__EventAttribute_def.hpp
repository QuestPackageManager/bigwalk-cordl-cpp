...
/// @brief Field <Keywords>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__Keywords_k__BackingField, put=__cordl_internal_set__Keywords_k__BackingField)) ::System::Diagnostics::Tracing::EventKeywords  _Keywords_k__BackingField;
...
/// @brief Method set_EventId, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
inline void set_EventId(int32_t  value) ;

/// @brief Method set_Keywords, addr 0x1803bda70, size 0x10, virtual false, abstract: false, final false
inline void set_Keywords(::System::Diagnostics::Tracing::EventKeywords  value) ;

/// @brief Method set_Level, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
inline void set_Level(::System::Diagnostics::Tracing::EventLevel  value) ;

/// @brief Method set_Message, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::Tracing::EventAttribute) == 0x28, "Size mismatch!");
