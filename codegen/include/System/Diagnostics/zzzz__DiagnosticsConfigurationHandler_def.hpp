...
/// @brief Method Create, addr 0x181dac3c0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dac3e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Diagnostics::DiagnosticsConfigurationHandler) == 0x10, "Size mismatch!");
