...
// Write type traits
MARK_REF_T(::System::Diagnostics::Switch*);
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Switch*, "System.Diagnostics", "Switch");
...
/// @brief Method .ctor, addr 0x181de4c60, size 0x200, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  description, ::StringW  defaultSwitchValue) ;

/// @brief Method _pruneCachedSwitches, addr 0x181de4e60, size 0x340, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Diagnostics::Switch) == 0x30, "Size mismatch!");
