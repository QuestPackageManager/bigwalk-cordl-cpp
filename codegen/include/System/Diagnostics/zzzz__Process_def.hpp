...
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Process_State, "System.Diagnostics", "Process/State");
DEFINE_IL2CPP_CLASS(::System::Diagnostics::Process_StreamReadMode, "System.Diagnostics", "Process/StreamReadMode");
...
static_assert(offsetof(::System::Diagnostics::Process_StreamReadMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::Process_StreamReadMode) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Diagnostics::Process_State, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::Process_State) == 0x4, "Size mismatch!");
...
/// @brief Field disposed, offset 0xb8, size 0x1 
 __declspec(property(get=__cordl_internal_get_disposed, put=__cordl_internal_set_disposed)) bool  disposed;

/// @brief Field error, offset 0xd0, size 0x8 
...
/// @brief Field errorStreamReadMode, offset 0xc0, size 0x4 
...
/// @brief Field inputStreamReadMode, offset 0xc4, size 0x4 
...
/// @brief Field outputStreamReadMode, offset 0xbc, size 0x4 
...
/// @brief Field standardInput, offset 0xa8, size 0x8 
...
/// @brief Field standardOutput, offset 0xa0, size 0x8 
...
/// @brief Field synchronizingObject, offset 0x98, size 0x8 
...
/// @brief Field waitHandle, offset 0x90, size 0x8 
...
/// @brief Method Close, addr 0x181dda0d0, size 0x200, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x181dda2d0, size 0x50, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureState, addr 0x181dda320, size 0x140, virtual false, abstract: false, final false
inline void EnsureState(::System::Diagnostics::Process_State  state) ;

/// @brief Method GetCurrentProcess, addr 0x181dda460, size 0x60, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Process* GetCurrentProcess() ;

/// @brief Method GetProcessHandle, addr 0x181dda770, size 0x10, virtual false, abstract: false, final false
inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* GetProcessHandle(int32_t  access) ;

/// @brief Method GetProcessHandle, addr 0x181dda4c0, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method OnExited, addr 0x181dda780, size 0x190, virtual false, abstract: false, final false
inline void OnExited() ;

/// @brief Method ProcessName_icall, addr 0x181dda910, size 0x10, virtual false, abstract: false, final false
static inline ::StringW ProcessName_icall(::System::IntPtr  handle) ;

/// @brief Method ProcessName_internal, addr 0x181dda920, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW ProcessName_internal(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  handle) ;

/// @brief Method RaiseOnExited, addr 0x181dda9c0, size 0x220, virtual false, abstract: false, final false
inline void RaiseOnExited() ;

/// @brief Method Refresh, addr 0x181ddabe0, size 0x50, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method ReleaseProcessHandle, addr 0x181ddac30, size 0x20, virtual false, abstract: false, final false
inline void ReleaseProcessHandle(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  handle) ;

/// @brief Method StopWatchingForExit, addr 0x181ddac50, size 0xf0, virtual false, abstract: false, final false
inline void StopWatchingForExit() ;

/// @brief Method ToString, addr 0x181ddad40, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ddae00, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  machineName, bool  isRemoteMachine, int32_t  processId, ::System::Diagnostics::ProcessInfo*  processInfo) ;

/// @brief Method get_Associated, addr 0x181ddae50, size 0x10, virtual false, abstract: false, final false
inline bool get_Associated() ;

/// @brief Method get_HasExited, addr 0x181ddae60, size 0x300, virtual false, abstract: false, final false
inline bool get_HasExited() ;

/// @brief Method get_Id, addr 0x181ddb160, size 0x50, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_ProcessName, addr 0x181ddb1b0, size 0x1b0, virtual false, abstract: false, final false
inline ::StringW get_ProcessName() ;

/// @brief Method get_SynchronizingObject, addr 0x181ddb360, size 0x130, virtual false, abstract: false, final false
...
/// @brief Field watchForExit, offset: 0x6a, size: 0x1, def value: None
 bool  ___watchForExit;

/// @brief Field watchingForExit, offset: 0x6b, size: 0x1, def value: None
 bool  ___watchingForExit;

/// @brief Field onExited, offset: 0x70, size: 0x8, def value: None
 ::System::EventHandler*  ___onExited;

/// @brief Field exited, offset: 0x78, size: 0x1, def value: None
 bool  ___exited;

/// @brief Field exitCode, offset: 0x7c, size: 0x4, def value: None
 int32_t  ___exitCode;

/// @brief Field signaled, offset: 0x80, size: 0x1, def value: None
 bool  ___signaled;

/// @brief Field haveExitTime, offset: 0x81, size: 0x1, def value: None
 bool  ___haveExitTime;

/// @brief Field raisedOnExited, offset: 0x82, size: 0x1, def value: None
 bool  ___raisedOnExited;

/// @brief Field registeredWaitHandle, offset: 0x88, size: 0x8, def value: None
 ::System::Threading::RegisteredWaitHandle*  ___registeredWaitHandle;

/// @brief Field waitHandle, offset: 0x90, size: 0x8, def value: None
 ::System::Threading::WaitHandle*  ___waitHandle;

/// @brief Field synchronizingObject, offset: 0x98, size: 0x8, def value: None
 ::System::ComponentModel::ISynchronizeInvoke*  ___synchronizingObject;

/// @brief Field standardOutput, offset: 0xa0, size: 0x8, def value: None
 ::System::IO::StreamReader*  ___standardOutput;

/// @brief Field standardInput, offset: 0xa8, size: 0x8, def value: None
 ::System::IO::StreamWriter*  ___standardInput;

/// @brief Field standardError, offset: 0xb0, size: 0x8, def value: None
 ::System::IO::StreamReader*  ___standardError;

/// @brief Field disposed, offset: 0xb8, size: 0x1, def value: None
 bool  ___disposed;

/// @brief Field outputStreamReadMode, offset: 0xbc, size: 0x4, def value: None
 ::System::Diagnostics::Process_StreamReadMode  ___outputStreamReadMode;

/// @brief Field errorStreamReadMode, offset: 0xc0, size: 0x4, def value: None
 ::System::Diagnostics::Process_StreamReadMode  ___errorStreamReadMode;

/// @brief Field inputStreamReadMode, offset: 0xc4, size: 0x4, def value: None
 ::System::Diagnostics::Process_StreamReadMode  ___inputStreamReadMode;

/// @brief Field output, offset: 0xc8, size: 0x8, def value: None
 ::System::Diagnostics::AsyncStreamReader*  ___output;

/// @brief Field error, offset: 0xd0, size: 0x8, def value: None
 ::System::Diagnostics::AsyncStreamReader*  ___error;

/// @brief Field process_name, offset: 0xd8, size: 0x8, def value: None
...
static_assert(offsetof(::System::Diagnostics::Process, ___watchForExit) == 0x6a, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___watchingForExit) == 0x6b, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___onExited) == 0x70, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___exited) == 0x78, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___exitCode) == 0x7c, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___signaled) == 0x80, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___haveExitTime) == 0x81, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___raisedOnExited) == 0x82, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___registeredWaitHandle) == 0x88, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___waitHandle) == 0x90, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___synchronizingObject) == 0x98, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___standardOutput) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___standardInput) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___standardError) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___disposed) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___outputStreamReadMode) == 0xbc, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___errorStreamReadMode) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___inputStreamReadMode) == 0xc4, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___output) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___error) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::System::Diagnostics::Process, ___process_name) == 0xd8, "Offset mismatch!");

static_assert(sizeof(::System::Diagnostics::Process) == 0xe0, "Size mismatch!");
