...
DEFINE_IL2CPP_CLASS(::System::TypeCode, "System", "TypeCode");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::TypeCode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::TypeCode) == 0x4, "Size mismatch!");
