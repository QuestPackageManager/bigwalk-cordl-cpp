...
static_assert(offsetof(::System::Net::FtpWebRequest_RequestStage, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method MoveNext, addr 0x181e33c10, size 0x200, virtual true, abstract: false, final true
...
/// @brief Method <get_ClientCertificates>b__114_0, addr 0x181e33e10, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field _connection, offset 0xb8, size 0x8 
...
/// @brief Field _ftpWebResponse, offset 0xd8, size 0x8 
...
/// @brief Field _onceFailed, offset 0xcc, size 0x1 
...
/// @brief Field _readAsyncResult, offset 0xf0, size 0x8 
...
/// @brief Field _readWriteTimeout, offset 0xe0, size 0x4 
...
/// @brief Field _requestCompleteAsyncResult, offset 0xf8, size 0x8 
...
/// @brief Field _requestStage, offset 0xc8, size 0x4 
...
/// @brief Field _stream, offset 0xc0, size 0x8 
...
/// @brief Field _timedOut, offset 0x94, size 0x1 
...
/// @brief Field _timerCallback, offset 0xa8, size 0x8 
...
/// @brief Field _timerQueue, offset 0xa0, size 0x8 
...
/// @brief Field _writeAsyncResult, offset 0xe8, size 0x8 
...
/// @brief Method Abort, addr 0x181e2a470, size 0x2f0, virtual true, abstract: false, final false
inline void Abort() ;

/// @brief Method AsyncRequestCallback, addr 0x181e2a760, size 0x7f0, virtual false, abstract: false, final false
inline void AsyncRequestCallback(::System::Object*  obj) ;

/// @brief Method AttemptedRecovery, addr 0x181e2af50, size 0x1f0, virtual false, abstract: false, final false
inline bool AttemptedRecovery(::System::Exception*  e) ;

/// @brief Method BeginGetResponse, addr 0x181e2b140, size 0x4b0, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback*  callback, ::System::Object*  state) ;

/// @brief Method CheckError, addr 0x181e2b5f0, size 0x20, virtual false, abstract: false, final false
inline void CheckError() ;

/// @brief Method CreateConnection, addr 0x181e2b6a0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Net::FtpControlStream* CreateConnection() ;

/// @brief Method CreateConnectionAsync, addr 0x181e2b610, size 0x90, virtual false, abstract: false, final false
inline void CreateConnectionAsync() ;

/// @brief Method DataStreamClosed, addr 0x181e2b760, size 0xa0, virtual false, abstract: false, final false
inline void DataStreamClosed(::System::Net::CloseExState  closeState) ;

/// @brief Method EndGetResponse, addr 0x181e2b800, size 0x1c0, virtual true, abstract: false, final false
inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EnsureFtpWebResponse, addr 0x181e2b9c0, size 0x500, virtual false, abstract: false, final false
inline void EnsureFtpWebResponse(::System::Exception*  exception) ;

/// @brief Method FinishRequestStage, addr 0x181e2bec0, size 0x3c0, virtual false, abstract: false, final false
inline ::System::Net::FtpWebRequest_RequestStage FinishRequestStage(::System::Net::FtpWebRequest_RequestStage  stage) ;

/// @brief Method GetResponse, addr 0x181e2c280, size 0x540, virtual true, abstract: false, final false
inline ::System::Net::WebResponse* GetResponse() ;

static inline ::System::Net::FtpWebRequest* New_ctor(::System::Uri*  uri) ;

/// @brief Method RequestCallback, addr 0x181e2c7c0, size 0x20, virtual false, abstract: false, final false
inline void RequestCallback(::System::Object*  obj) ;

/// @brief Method SetException, addr 0x181e2c7e0, size 0x360, virtual false, abstract: false, final false
inline void SetException(::System::Exception*  exception) ;

/// @brief Method SubmitRequest, addr 0x181e2cb40, size 0x420, virtual false, abstract: false, final false
inline void SubmitRequest(bool  isAsync) ;

/// @brief Method SyncRequestCallback, addr 0x181e2cf60, size 0x280, virtual false, abstract: false, final false
inline void SyncRequestCallback(::System::Object*  obj) ;

/// @brief Method TimedSubmitRequestHelper, addr 0x181e2d1e0, size 0x420, virtual false, abstract: false, final false
inline ::System::IO::Stream* TimedSubmitRequestHelper(bool  isAsync) ;

/// @brief Method TimerCallback, addr 0x181e2d600, size 0x80, virtual false, abstract: false, final false
inline void TimerCallback(::System::Net::TimerThread_Timer*  timer, int32_t  timeNoticed, ::System::Object*  context) ;

/// @brief Method TranslateConnectException, addr 0x181e2d680, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e2d8f0, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method get_Aborted, addr 0x181b6ab30, size 0x10, virtual false, abstract: false, final false
inline bool get_Aborted() ;

/// @brief Method get_ClientCertificates, addr 0x181e2dbd0, size 0xd0, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates() ;

/// @brief Method get_ContentLength, addr 0x1803a74e0, size 0x10, virtual true, abstract: false, final false
inline int64_t get_ContentLength() ;

/// @brief Method get_ContentOffset, addr 0x1802ec4c0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_ContentOffset() ;

/// @brief Method get_Credentials, addr 0x1802e5850, size 0x10, virtual true, abstract: false, final false
inline ::System::Net::ICredentials* get_Credentials() ;

/// @brief Method get_EnableSsl, addr 0x18030d8a0, size 0x10, virtual false, abstract: false, final false
inline bool get_EnableSsl() ;

/// @brief Method get_Headers, addr 0x181e2dca0, size 0x90, virtual true, abstract: false, final false
inline ::System::Net::WebHeaderCollection* get_Headers() ;

/// @brief Method get_InUse, addr 0x181e2dd30, size 0x20, virtual false, abstract: false, final false
inline bool get_InUse() ;

/// @brief Method get_Method, addr 0x181e2dd50, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Method() ;

/// @brief Method get_MethodInfo, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::FtpMethodInfo* get_MethodInfo() ;

/// @brief Method get_Proxy, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::System::Net::IWebProxy* get_Proxy() ;

/// @brief Method get_ReadWriteTimeout, addr 0x1813ef6d0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ReadWriteTimeout() ;

/// @brief Method get_RemainingTimeout, addr 0x18051e7a0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_RemainingTimeout() ;

/// @brief Method get_RenameTo, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_RenameTo() ;

/// @brief Method get_RequestUri, addr 0x1802e58c0, size 0x10, virtual true, abstract: false, final false
inline ::System::Uri* get_RequestUri() ;

/// @brief Method get_Timeout, addr 0x1803fa740, size 0x10, virtual true, abstract: false, final false
inline int32_t get_Timeout() ;

/// @brief Method get_TimerQueue, addr 0x181e2dd60, size 0x70, virtual false, abstract: false, final false
inline ::System::Net::TimerThread_Queue* get_TimerQueue() ;

/// @brief Method get_UseBinary, addr 0x181b6ab20, size 0x10, virtual false, abstract: false, final false
inline bool get_UseBinary() ;

/// @brief Method get_UseDefaultCredentials, addr 0x181e2ddd0, size 0x20, virtual true, abstract: false, final false
inline bool get_UseDefaultCredentials() ;

/// @brief Method get_UsePassive, addr 0x180cbfa60, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_CachePolicy, addr 0x181e2ddf0, size 0x30, virtual true, abstract: false, final false
inline void set_CachePolicy(::System::Net::Cache::RequestCachePolicy*  value) ;

/// @brief Method set_Credentials, addr 0x181e2de20, size 0xb0, virtual true, abstract: false, final false
inline void set_Credentials(::System::Net::ICredentials*  value) ;

/// @brief Method set_Method, addr 0x181e2ded0, size 0xe0, virtual true, abstract: false, final false
inline void set_Method(::StringW  value) ;

/// @brief Method set_Proxy, addr 0x181e2ddf0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Field _async, offset: 0x92, size: 0x1, def value: None
 bool  ____async;

/// @brief Field _aborted, offset: 0x93, size: 0x1, def value: None
 bool  ____aborted;

/// @brief Field _timedOut, offset: 0x94, size: 0x1, def value: None
 bool  ____timedOut;

/// @brief Field _exception, offset: 0x98, size: 0x8, def value: None
 ::System::Exception*  ____exception;

/// @brief Field _timerQueue, offset: 0xa0, size: 0x8, def value: None
 ::System::Net::TimerThread_Queue*  ____timerQueue;

/// @brief Field _timerCallback, offset: 0xa8, size: 0x8, def value: None
 ::System::Net::TimerThread_Callback*  ____timerCallback;

/// @brief Field _enableSsl, offset: 0xb0, size: 0x1, def value: None
 bool  ____enableSsl;

/// @brief Field _connection, offset: 0xb8, size: 0x8, def value: None
 ::System::Net::FtpControlStream*  ____connection;

/// @brief Field _stream, offset: 0xc0, size: 0x8, def value: None
 ::System::IO::Stream*  ____stream;

/// @brief Field _requestStage, offset: 0xc8, size: 0x4, def value: None
 ::System::Net::FtpWebRequest_RequestStage  ____requestStage;

/// @brief Field _onceFailed, offset: 0xcc, size: 0x1, def value: None
 bool  ____onceFailed;

/// @brief Field _ftpRequestHeaders, offset: 0xd0, size: 0x8, def value: None
 ::System::Net::WebHeaderCollection*  ____ftpRequestHeaders;

/// @brief Field _ftpWebResponse, offset: 0xd8, size: 0x8, def value: None
 ::System::Net::FtpWebResponse*  ____ftpWebResponse;

/// @brief Field _readWriteTimeout, offset: 0xe0, size: 0x4, def value: None
 int32_t  ____readWriteTimeout;

/// @brief Field _writeAsyncResult, offset: 0xe8, size: 0x8, def value: None
 ::System::Net::ContextAwareResult*  ____writeAsyncResult;

/// @brief Field _readAsyncResult, offset: 0xf0, size: 0x8, def value: None
 ::System::Net::LazyAsyncResult*  ____readAsyncResult;

/// @brief Field _requestCompleteAsyncResult, offset: 0xf8, size: 0x8, def value: None
...
static_assert(offsetof(::System::Net::FtpWebRequest, ____async) == 0x92, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____aborted) == 0x93, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____timedOut) == 0x94, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____exception) == 0x98, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____timerQueue) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____timerCallback) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____enableSsl) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____connection) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____stream) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____requestStage) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____onceFailed) == 0xcc, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____ftpRequestHeaders) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____ftpWebResponse) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____readWriteTimeout) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____writeAsyncResult) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____readAsyncResult) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::System::Net::FtpWebRequest, ____requestCompleteAsyncResult) == 0xf8, "Offset mismatch!");

static_assert(sizeof(::System::Net::FtpWebRequest) == 0x100, "Size mismatch!");
