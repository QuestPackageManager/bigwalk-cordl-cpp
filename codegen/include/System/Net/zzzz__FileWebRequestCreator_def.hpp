...
// Write type traits
MARK_REF_T(::System::Net::FileWebRequestCreator*);
DEFINE_IL2CPP_CLASS(::System::Net::FileWebRequestCreator*, "System.Net", "FileWebRequestCreator");
...
/// @brief Method Create, addr 0x181e41c90, size 0x100, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::Net::FileWebRequestCreator) == 0x10, "Size mismatch!");
