...
/// @brief Method .ctor, addr 0x181dae240, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x181dae260, size 0x230, virtual true, abstract: false, final false
