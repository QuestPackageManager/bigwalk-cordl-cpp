...
// Write type traits
MARK_REF_T(::System::Net::ReceiveState*);
DEFINE_IL2CPP_CLASS(::System::Net::ReceiveState*, "System.Net", "ReceiveState");
...
/// @brief Method .ctor, addr 0x181e32f30, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::ReceiveState) == 0x30, "Size mismatch!");
