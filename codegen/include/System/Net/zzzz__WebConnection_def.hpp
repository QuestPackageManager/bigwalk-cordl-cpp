...
DEFINE_IL2CPP_CLASS(::System::Net::WebConnection__Connect_d__16, "System.Net", "WebConnection/<Connect>d__16");
DEFINE_IL2CPP_CLASS(::System::Net::WebConnection__CreateStream_d__18, "System.Net", "WebConnection/<CreateStream>d__18");
DEFINE_IL2CPP_CLASS(::System::Net::WebConnection__InitConnection_d__19, "System.Net", "WebConnection/<InitConnection>d__19");
...
/// @brief Method <Connect>b__16_0, addr 0x181d90cc0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method <Connect>b__16_1, addr 0x181d90d30, size 0x80, virtual false, abstract: false, final false
...
// Dependencies System.Net.IPAddress, System.Runtime.CompilerServices.AsyncTaskMethodBuilder, System.Runtime.CompilerServices.ConfiguredTaskAwaitable::ConfiguredTaskAwaiter, System.Threading.CancellationToken
namespace System::Net {
// Is value type: true
...
/// @brief Method MoveNext, addr 0x181d8ad60, size 0x680, virtual true, abstract: false, final true
...
/// @brief Field <>7__wrap2, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Net::IPAddress*>  __7__wrap2;
...
static_assert(sizeof(::System::Net::WebConnection__Connect_d__16) == 0x60, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x181d8b3e0, size 0x510, virtual true, abstract: false, final true
inline void MoveNext() ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::WebConnection*", modifiers: "", def_value: None }, CppParam { name: "operation", ty: "::System::Net::WebOperation*", modifiers: "", def_value: None }, CppParam { name: "reused", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_stream_5__2", ty: "::System::Net::Sockets::NetworkStream*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::IO::Stream*>", modifiers: "", def_value: None }]
constexpr WebConnection__CreateStream_d__18(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>  __t__builder, ::System::Net::WebConnection*  __4__this, ::System::Net::WebOperation*  operation, bool  reused, ::System::Threading::CancellationToken  cancellationToken, ::System::Net::Sockets::NetworkStream*  _stream_5__2, ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter  __u__1, ::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::IO::Stream*>  __u__2) noexcept;
...
static_assert(sizeof(::System::Net::WebConnection__CreateStream_d__18) == 0x68, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x181d8c5a0, size 0x630, virtual true, abstract: false, final true
inline void MoveNext() ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::WebRequestStream*>", modifiers: "", def_value: None }, CppParam { name: "operation", ty: "::System::Net::WebOperation*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::WebConnection*", modifiers: "", def_value: None }, CppParam { name: "_reused_5__2", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<bool>", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Net::WebConnection__InitConnection_d__19) == 0x60, "Size mismatch!");
...
/// @brief Method CanReuse, addr 0x181d92f30, size 0x20, virtual false, abstract: false, final false
inline bool CanReuse() ;

/// @brief Method CanReuseConnection, addr 0x181d92c60, size 0x2d0, virtual false, abstract: false, final false
inline bool CanReuseConnection(::System::Net::WebOperation*  operation) ;

/// @brief Method CheckReusable, addr 0x181d92f50, size 0x40, virtual false, abstract: false, final false
inline bool CheckReusable() ;

/// @brief Method Close, addr 0x181d930c0, size 0xa0, virtual false, abstract: false, final false
inline void Close(bool  reset) ;

/// @brief Method CloseSocket, addr 0x181d92f90, size 0x130, virtual false, abstract: false, final false
inline void CloseSocket() ;

/// @brief Method Connect, addr 0x181d93160, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Continue, addr 0x181d93230, size 0x160, virtual false, abstract: false, final false
inline bool Continue(::System::Net::WebOperation*  next) ;

/// @brief Method CreateStream, addr 0x181d93390, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181d93470, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181d93470, size 0x40, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetException, addr 0x181d934b0, size 0x130, virtual false, abstract: false, final false
static inline ::System::Net::WebException* GetException(::System::Net::WebExceptionStatus  status, ::System::Exception*  error) ;

/// @brief Method InitConnection, addr 0x181d935e0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method PrepareSharingNtlm, addr 0x181d936b0, size 0x200, virtual false, abstract: false, final false
inline bool PrepareSharingNtlm(::System::Net::WebOperation*  operation) ;

/// @brief Method ReadLine, addr 0x181d938b0, size 0x180, virtual false, abstract: false, final false
static inline bool ReadLine(::ArrayW<uint8_t>  buffer, ::by_ref<int32_t>  start, int32_t  max, ::by_ref<::StringW>  output) ;

/// @brief Method Reset, addr 0x181d93a60, size 0xb0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ResetNtlm, addr 0x181d93a30, size 0x30, virtual false, abstract: false, final false
inline void ResetNtlm() ;

/// @brief Method StartOperation, addr 0x181d93b10, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1802e5e30, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePoint*  sPoint) ;

/// @brief Method get_Closed, addr 0x181d93c80, size 0x10, virtual false, abstract: false, final false
inline bool get_Closed() ;

/// @brief Method get_IdleSince, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_IdleSince() ;

/// @brief Method get_NtlmAuthenticated, addr 0x18037a0f0, size 0x10, virtual false, abstract: false, final false
inline bool get_NtlmAuthenticated() ;

/// @brief Method get_NtlmCredential, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::NetworkCredential* get_NtlmCredential() ;

/// @brief Method get_ServicePoint, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

/// @brief Method get_UnsafeAuthenticatedConnectionSharing, addr 0x1814f8710, size 0x10, virtual false, abstract: false, final false
inline bool get_UnsafeAuthenticatedConnectionSharing() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_NtlmAuthenticated, addr 0x1803a7530, size 0x10, virtual false, abstract: false, final false
inline void set_NtlmAuthenticated(bool  value) ;

/// @brief Method set_NtlmCredential, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
inline void set_NtlmCredential(::System::Net::NetworkCredential*  value) ;

/// @brief Method set_UnsafeAuthenticatedConnectionSharing, addr 0x1818376c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::WebConnection) == 0x60, "Size mismatch!");
