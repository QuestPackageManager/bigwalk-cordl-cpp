...
/// @brief Method <SetAndVerifySelectionCallback>b__0, addr 0x181dae160, size 0x40, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* _SetAndVerifySelectionCallback_b__0(::StringW  t, ::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  lc, ::System::Security::Cryptography::X509Certificates::X509Certificate*  rc, ::ArrayW<::StringW>  ai) ;
...
/// @brief Method AuthenticateAsClient, addr 0x181dacfe0, size 0x70, virtual true, abstract: false, final false
inline void AuthenticateAsClient(::StringW  targetHost) ;

/// @brief Method AuthenticateAsClient, addr 0x181dacf70, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method AuthenticateAsClientAsync, addr 0x181dacf00, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method AuthenticateAsServer, addr 0x181dad050, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method BeginAuthenticateAsClient, addr 0x181dad0c0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method BeginRead, addr 0x181dad150, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x181dad1d0, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CheckDisposed, addr 0x181dad250, size 0x60, virtual false, abstract: false, final false
inline void CheckDisposed() ;

/// @brief Method Dispose, addr 0x181dad2b0, size 0xb0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndAuthenticateAsClient, addr 0x1815f46a0, size 0x10, virtual true, abstract: false, final false
inline void EndAuthenticateAsClient(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndRead, addr 0x1815f4690, size 0x10, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x1815f46a0, size 0x10, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Flush, addr 0x181d38c80, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x181dad360, size 0x20, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetProvider, addr 0x181dad380, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x181dad450, size 0x80, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x181dad3d0, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method Seek, addr 0x181dad4d0, size 0x30, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetAndVerifySelectionCallback, addr 0x181dad500, size 0x130, virtual false, abstract: false, final false
inline void SetAndVerifySelectionCallback(::System::Net::Security::LocalCertificateSelectionCallback*  callback) ;

/// @brief Method SetAndVerifyValidationCallback, addr 0x181dad630, size 0xb0, virtual false, abstract: false, final false
inline void SetAndVerifyValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback*  callback) ;

/// @brief Method SetLength, addr 0x181dad6e0, size 0x70, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x181dad7d0, size 0x80, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteAsync, addr 0x181dad750, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dad850, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dad980, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dad9a0, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x181dadc40, size 0x30, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x181dadc70, size 0x20, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x181dadc90, size 0x30, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Impl, addr 0x181dadcc0, size 0x60, virtual false, abstract: false, final false
inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Impl() ;

/// @brief Method get_InternalTargetHost, addr 0x181dadd20, size 0x60, virtual false, abstract: false, final false
inline ::StringW get_InternalTargetHost() ;

/// @brief Method get_IsAuthenticated, addr 0x181dadd80, size 0x70, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_Length, addr 0x181daddf0, size 0x70, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_LocalCertificate, addr 0x181dade60, size 0x60, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate() ;

/// @brief Method get_Position, addr 0x181dadec0, size 0x70, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x181dadf30, size 0x70, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x181dadfa0, size 0x70, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x181dad4d0, size 0x30, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x181dae010, size 0x70, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x181dae080, size 0x70, virtual true, abstract: false, final false
