...
// Write type traits
MARK_REF_T(::System::Net::ResponseDescription*);
DEFINE_IL2CPP_CLASS(::System::Net::ResponseDescription*, "System.Net", "ResponseDescription");
...
/// @brief Method .ctor, addr 0x181e32fe0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_InvalidStatusCode, addr 0x181e33030, size 0x20, virtual false, abstract: false, final false
inline bool get_InvalidStatusCode() ;

/// @brief Method get_PermanentFailure, addr 0x181e33050, size 0x20, virtual false, abstract: false, final false
inline bool get_PermanentFailure() ;

/// @brief Method get_PositiveCompletion, addr 0x181e33070, size 0x20, virtual false, abstract: false, final false
inline bool get_PositiveCompletion() ;

/// @brief Method get_PositiveIntermediate, addr 0x181e33090, size 0x20, virtual false, abstract: false, final false
inline bool get_PositiveIntermediate() ;

/// @brief Method get_TransientFailure, addr 0x181e330b0, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::ResponseDescription) == 0x30, "Size mismatch!");
