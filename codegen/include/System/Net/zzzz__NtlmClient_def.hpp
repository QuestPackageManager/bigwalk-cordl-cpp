...
// Write type traits
MARK_REF_T(::System::Net::NtlmClient*);
DEFINE_IL2CPP_CLASS(::System::Net::NtlmClient*, "System.Net", "NtlmClient");
...
/// @brief Method Authenticate, addr 0x181d88bb0, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x181d88c80, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Net::NtlmClient) == 0x18, "Size mismatch!");
