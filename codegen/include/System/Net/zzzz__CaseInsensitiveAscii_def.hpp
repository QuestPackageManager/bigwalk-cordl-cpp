...
// Write type traits
MARK_REF_T(::System::Net::CaseInsensitiveAscii*);
DEFINE_IL2CPP_CLASS(::System::Net::CaseInsensitiveAscii*, "System.Net", "CaseInsensitiveAscii");
...
/// @brief Field AsciiToLower, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_AsciiToLower, put=setStaticF_AsciiToLower)) ::ArrayW<uint8_t>  AsciiToLower;
...
/// @brief Method Compare, addr 0x181e234f0, size 0x140, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  firstObject, ::System::Object*  secondObject) ;

/// @brief Method Equals, addr 0x181e23630, size 0x130, virtual true, abstract: false, final true
inline bool Equals(::System::Object*  firstObject, ::System::Object*  secondObject) ;

/// @brief Method FastGetHashCode, addr 0x181e23760, size 0xc0, virtual false, abstract: false, final false
inline int32_t FastGetHashCode(::StringW  myString) ;

/// @brief Method GetHashCode, addr 0x181e23820, size 0xd0, virtual true, abstract: false, final true
...
static inline ::ArrayW<uint8_t> getStaticF_AsciiToLower() ;
...
static inline void setStaticF_AsciiToLower(::ArrayW<uint8_t>  value) ;
...
static_assert(sizeof(::System::Net::CaseInsensitiveAscii) == 0x10, "Size mismatch!");
