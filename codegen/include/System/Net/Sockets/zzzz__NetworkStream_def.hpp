...
// Write type traits
MARK_REF_T(::System::Net::Sockets::NetworkStream*);
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::NetworkStream*, "System.Net.Sockets", "NetworkStream");
...
/// @brief Method BeginRead, addr 0x181d97590, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x181d97760, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x181d97930, size 0x30, virtual false, abstract: false, final false
inline void Close(int32_t  timeout) ;

/// @brief Method Dispose, addr 0x181d97960, size 0xa0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x181d97a00, size 0x110, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x181d97b10, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method Read, addr 0x181d98260, size 0x200, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Read, addr 0x181d98050, size 0x210, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  destination) ;

/// @brief Method ReadAsync, addr 0x181d97c20, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method ReadAsync, addr 0x181d97e60, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method ReadByte, addr 0x181d97ff0, size 0x60, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x181d927e0, size 0x20, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x181d927e0, size 0x20, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetSocketTimeoutOption, addr 0x181d98460, size 0x130, virtual false, abstract: false, final false
inline void SetSocketTimeoutOption(::System::Net::Sockets::SocketShutdown  mode, int32_t  timeout, bool  silent) ;

/// @brief Method Write, addr 0x181d98b60, size 0x1b0, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Write, addr 0x181d98990, size 0x1d0, virtual true, abstract: false, final false
inline void Write(::System::ReadOnlySpan_1<uint8_t>  source) ;

/// @brief Method WriteAsync, addr 0x181d98590, size 0x230, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  size, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method WriteAsync, addr 0x181d987c0, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method WriteByte, addr 0x181d98940, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d98d10, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket) ;

/// @brief Method .ctor, addr 0x181d98d60, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket, ::System::IO::FileAccess  access, bool  ownsSocket) ;

/// @brief Method .ctor, addr 0x181d98d30, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket, bool  ownsSocket) ;

/// @brief Method get_CanRead, addr 0x18049c410, size 0x10, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x18049d830, size 0x10, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_InternalSocket, addr 0x181d98ed0, size 0x80, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_InternalSocket() ;

/// @brief Method get_Length, addr 0x181d927e0, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x181d927e0, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x181d98f50, size 0x60, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x181d98fb0, size 0x60, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x181d927e0, size 0x20, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x181d99010, size 0x50, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x181d99060, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Net::Sockets::NetworkStream) == 0x48, "Size mismatch!");
