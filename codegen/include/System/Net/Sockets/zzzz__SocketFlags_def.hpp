...
static_assert(offsetof(::System::Net::Sockets::SocketFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::Sockets::SocketFlags) == 0x4, "Size mismatch!");
