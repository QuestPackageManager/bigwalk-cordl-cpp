...
// Write type traits
MARK_REF_T(::System::Net::Sockets::LingerOption*);
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::LingerOption*, "System.Net.Sockets", "LingerOption");
...
/// @brief Method set_LingerTime, addr 0x1803924c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Sockets::LingerOption) == 0x18, "Size mismatch!");
