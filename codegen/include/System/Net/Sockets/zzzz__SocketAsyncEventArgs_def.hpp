...
// Write type traits
MARK_REF_T(::System::Net::Sockets::SocketAsyncEventArgs*);
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::SocketAsyncEventArgs*, "System.Net.Sockets", "SocketAsyncEventArgs");
// Dependencies System.EventArgs, System.Memory`1<T>, System.Net.Sockets.IPPacketInformation, System.Net.Sockets.SendPacketsElement, System.Net.Sockets.SocketAsyncOperation, System.Net.Sockets.SocketError, System.Net.Sockets.SocketFlags, System.Net.Sockets.TransmitFileOptions
namespace System::Net::Sockets {
// Is value type: false
...
/// @brief Field <ConnectByNameError>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__ConnectByNameError_k__BackingField, put=__cordl_internal_set__ConnectByNameError_k__BackingField)) ::System::Exception*  _ConnectByNameError_k__BackingField;

/// @brief Field <DisconnectReuseSocket>k__BackingField, offset 0x44, size 0x1 
 __declspec(property(get=__cordl_internal_get__DisconnectReuseSocket_k__BackingField, put=__cordl_internal_set__DisconnectReuseSocket_k__BackingField)) bool  _DisconnectReuseSocket_k__BackingField;

/// @brief Field <LastOperation>k__BackingField, offset 0x48, size 0x4 
 __declspec(property(get=__cordl_internal_get__LastOperation_k__BackingField, put=__cordl_internal_set__LastOperation_k__BackingField)) ::System::Net::Sockets::SocketAsyncOperation  _LastOperation_k__BackingField;

/// @brief Field <ReceiveMessageFromPacketInfo>k__BackingField, offset 0x50, size 0x10 
 __declspec(property(get=__cordl_internal_get__ReceiveMessageFromPacketInfo_k__BackingField, put=__cordl_internal_set__ReceiveMessageFromPacketInfo_k__BackingField)) ::System::Net::Sockets::IPPacketInformation  _ReceiveMessageFromPacketInfo_k__BackingField;

/// @brief Field <SendPacketsElements>k__BackingField, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__SendPacketsElements_k__BackingField, put=__cordl_internal_set__SendPacketsElements_k__BackingField)) ::ArrayW<::System::Net::Sockets::SendPacketsElement*>  _SendPacketsElements_k__BackingField;

/// @brief Field <SendPacketsFlags>k__BackingField, offset 0x68, size 0x4 
 __declspec(property(get=__cordl_internal_get__SendPacketsFlags_k__BackingField, put=__cordl_internal_set__SendPacketsFlags_k__BackingField)) ::System::Net::Sockets::TransmitFileOptions  _SendPacketsFlags_k__BackingField;
...
/// @brief Field <SocketError>k__BackingField, offset 0x70, size 0x4 
 __declspec(property(get=__cordl_internal_get__SocketError_k__BackingField, put=__cordl_internal_set__SocketError_k__BackingField)) ::System::Net::Sockets::SocketError  _SocketError_k__BackingField;

/// @brief Field <SocketFlags>k__BackingField, offset 0x74, size 0x4 
 __declspec(property(get=__cordl_internal_get__SocketFlags_k__BackingField, put=__cordl_internal_set__SocketFlags_k__BackingField)) ::System::Net::Sockets::SocketFlags  _SocketFlags_k__BackingField;
...
/// @brief Field _bufferListInternal, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__bufferListInternal, put=__cordl_internal_set__bufferListInternal)) ::System::Collections::Generic::List_1<::System::ArraySegment_1<uint8_t>>*  _bufferListInternal;
...
/// @brief Method Complete_internal, addr 0x181d997f0, size 0x30, virtual false, abstract: false, final false
inline void Complete_internal() ;

/// @brief Method Dispose, addr 0x181d99820, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x181d99830, size 0x10, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x1803b3b50, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method OnCompleted, addr 0x181d99840, size 0x30, virtual true, abstract: false, final false
inline void OnCompleted(::System::Net::Sockets::SocketAsyncEventArgs*  e) ;

/// @brief Method SetBuffer, addr 0x181d99870, size 0xb0, virtual false, abstract: false, final false
inline void SetBuffer(::System::Memory_1<uint8_t>  buffer) ;

/// @brief Method SetBytesTransferred, addr 0x180511530, size 0x10, virtual false, abstract: false, final false
inline void SetBytesTransferred(int32_t  value) ;

/// @brief Method SetCurrentSocket, addr 0x1802d9820, size 0x10, virtual false, abstract: false, final false
inline void SetCurrentSocket(::System::Net::Sockets::Socket*  socket) ;

/// @brief Method SetLastOperation, addr 0x181d99920, size 0x90, virtual false, abstract: false, final false
inline void SetLastOperation(::System::Net::Sockets::SocketAsyncOperation  op) ;

constexpr ::System::EventHandler_1<::System::Net::Sockets::SocketAsyncEventArgs*>* const& __cordl_internal_get_Completed() const;

constexpr ::System::EventHandler_1<::System::Net::Sockets::SocketAsyncEventArgs*>*& __cordl_internal_get_Completed() ;

constexpr ::System::Net::Sockets::Socket* const& __cordl_internal_get__AcceptSocket_k__BackingField() const;
...
constexpr ::System::Exception* const& __cordl_internal_get__ConnectByNameError_k__BackingField() const;
...
constexpr ::ArrayW<::System::Net::Sockets::SendPacketsElement*> const& __cordl_internal_get__SendPacketsElements_k__BackingField() const;

constexpr ::ArrayW<::System::Net::Sockets::SendPacketsElement*>& __cordl_internal_get__SendPacketsElements_k__BackingField() ;
...
constexpr ::System::Object* const& __cordl_internal_get__UserToken_k__BackingField() const;
...
constexpr ::System::Collections::Generic::IList_1<::System::ArraySegment_1<uint8_t>>* const& __cordl_internal_get__bufferList() const;

constexpr ::System::Collections::Generic::IList_1<::System::ArraySegment_1<uint8_t>>*& __cordl_internal_get__bufferList() ;

constexpr ::System::Collections::Generic::List_1<::System::ArraySegment_1<uint8_t>>* const& __cordl_internal_get__bufferListInternal() const;
...
constexpr ::System::Net::Sockets::Socket* const& __cordl_internal_get_current_socket() const;
...
constexpr ::System::Net::EndPoint* const& __cordl_internal_get_remote_ep() const;

constexpr ::System::Net::EndPoint*& __cordl_internal_get_remote_ep() ;

constexpr ::System::Net::Sockets::SocketAsyncResult* const& __cordl_internal_get_socket_async_result() const;
...
constexpr void __cordl_internal_set__SendPacketsElements_k__BackingField(::ArrayW<::System::Net::Sockets::SendPacketsElement*>  value) ;
...
/// @brief Method .ctor, addr 0x181d999b0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181d999f0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  flowExecutionContext) ;

/// @brief Method get_AcceptSocket, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_AcceptSocket() ;

/// @brief Method get_BufferList, addr 0x180322750, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::System::ArraySegment_1<uint8_t>>* get_BufferList() ;

/// @brief Method get_BytesTransferred, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_BytesTransferred() ;

/// @brief Method get_Count, addr 0x181561f30, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_CurrentSocket, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_CurrentSocket() ;

/// @brief Method get_MemoryBuffer, addr 0x1802ec5e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Memory_1<uint8_t> get_MemoryBuffer() ;

/// @brief Method get_Offset, addr 0x1805d4740, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Offset() ;

/// @brief Method get_SocketError, addr 0x1803fa740, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::Sockets::SocketError get_SocketError() ;

/// @brief Method get_UserToken, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* get_UserToken() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_AcceptSocket, addr 0x1802d9840, size 0x10, virtual false, abstract: false, final false
inline void set_AcceptSocket(::System::Net::Sockets::Socket*  value) ;

/// @brief Method set_BytesTransferred, addr 0x180511530, size 0x10, virtual false, abstract: false, final false
inline void set_BytesTransferred(int32_t  value) ;

/// @brief Method set_LastOperation, addr 0x1803d4ea0, size 0x10, virtual false, abstract: false, final false
inline void set_LastOperation(::System::Net::Sockets::SocketAsyncOperation  value) ;

/// @brief Method set_RemoteEndPoint, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_RemoteEndPoint(::System::Net::EndPoint*  value) ;

/// @brief Method set_SendPacketsSendSize, addr 0x1804a5a80, size 0x10, virtual false, abstract: false, final false
inline void set_SendPacketsSendSize(int32_t  value) ;

/// @brief Method set_SocketError, addr 0x18051e950, size 0x10, virtual false, abstract: false, final false
inline void set_SocketError(::System::Net::Sockets::SocketError  value) ;

/// @brief Method set_SocketFlags, addr 0x18051e940, size 0x10, virtual false, abstract: false, final false
inline void set_SocketFlags(::System::Net::Sockets::SocketFlags  value) ;

/// @brief Method set_UserToken, addr 0x1803f5420, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::Sockets::SocketAsyncEventArgs) == 0xb8, "Size mismatch!");
