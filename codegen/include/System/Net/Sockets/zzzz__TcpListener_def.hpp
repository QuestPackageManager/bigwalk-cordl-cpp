...
// Write type traits
MARK_REF_T(::System::Net::Sockets::TcpListener*);
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::TcpListener*, "System.Net.Sockets", "TcpListener");
...
public:
// Declarations
 __declspec(property(get=get_Server)) ::System::Net::Sockets::Socket*  Server;
...
/// @brief Method AcceptTcpClient, addr 0x181da4680, size 0xa0, virtual false, abstract: false, final false
inline ::System::Net::Sockets::TcpClient* AcceptTcpClient() ;

/// @brief Method Create, addr 0x181da4720, size 0x1a0, virtual false, abstract: false, final false
static inline ::System::Net::Sockets::TcpListener* Create(int32_t  port) ;

static inline ::System::Net::Sockets::TcpListener* New_ctor(::System::Net::IPAddress*  localaddr, int32_t  port) ;

/// @brief Method Start, addr 0x181da48c0, size 0x10, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Start, addr 0x181da48d0, size 0x1b0, virtual false, abstract: false, final false
inline void Start(int32_t  backlog) ;

/// @brief Method Stop, addr 0x181da4a80, size 0x120, virtual false, abstract: false, final false
inline void Stop() ;
...
constexpr ::System::Net::Sockets::Socket* const& __cordl_internal_get_m_ServerSocket() const;

constexpr ::System::Net::Sockets::Socket*& __cordl_internal_get_m_ServerSocket() ;

constexpr ::System::Net::IPEndPoint* const& __cordl_internal_get_m_ServerSocketEP() const;
...
/// @brief Method .ctor, addr 0x181da4ba0, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  localaddr, int32_t  port) ;

/// @brief Method get_Server, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_Server() ;
...
static_assert(sizeof(::System::Net::Sockets::TcpListener) == 0x28, "Size mismatch!");
