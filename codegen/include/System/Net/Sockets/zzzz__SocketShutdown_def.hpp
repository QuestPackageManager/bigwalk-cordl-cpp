...
DEFINE_IL2CPP_CLASS(::System::Net::Sockets::SocketShutdown, "System.Net.Sockets", "SocketShutdown");
// Dependencies 
namespace System::Net::Sockets {
// Is value type: true
...
static_assert(offsetof(::System::Net::Sockets::SocketShutdown, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::Sockets::SocketShutdown) == 0x4, "Size mismatch!");
