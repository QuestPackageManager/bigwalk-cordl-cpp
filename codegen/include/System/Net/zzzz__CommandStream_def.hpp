...
DEFINE_IL2CPP_CLASS(::System::Net::CommandStream_PipelineEntryFlags, "System.Net", "CommandStream/PipelineEntryFlags");
DEFINE_IL2CPP_CLASS(::System::Net::CommandStream_PipelineInstruction, "System.Net", "CommandStream/PipelineInstruction");
...
static_assert(offsetof(::System::Net::CommandStream_PipelineInstruction, value__) == 0x4, "Offset mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Net::CommandStream_PipelineEntryFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Net::CommandStream_PipelineEntryFlags) == 0x4, "Size mismatch!");
...
/// @brief Method HasFlag, addr 0x181405d70, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Abort, addr 0x181e23990, size 0x140, virtual true, abstract: false, final false
inline void Abort(::System::Exception*  e) ;

/// @brief Method BuildCommandsList, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<::System::Net::CommandStream_PipelineEntry*> BuildCommandsList(::System::Net::WebRequest*  request) ;

/// @brief Method CheckContinuePipeline, addr 0x181e23ad0, size 0x40, virtual false, abstract: false, final false
inline void CheckContinuePipeline() ;

/// @brief Method CheckValid, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool CheckValid(::System::Net::ResponseDescription*  response, ::by_ref<int32_t>  validThrough, ::by_ref<int32_t>  completeLength) ;

/// @brief Method ClearState, addr 0x181e23b10, size 0x20, virtual true, abstract: false, final false
inline void ClearState() ;

/// @brief Method ContinueCommandPipeline, addr 0x181e23b30, size 0x390, virtual false, abstract: false, final false
inline ::System::IO::Stream* ContinueCommandPipeline() ;

/// @brief Method Dispose, addr 0x181e23ec0, size 0x80, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GenerateException, addr 0x181e23f40, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GenerateException, addr 0x181e23ff0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method InitCommandPipeline, addr 0x181e24080, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method InvokeRequestCallback, addr 0x181e24120, size 0x60, virtual false, abstract: false, final false
inline void InvokeRequestCallback(::System::Object*  obj) ;

/// @brief Method MarkAsRecoverableFailure, addr 0x181e24180, size 0x10, virtual false, abstract: false, final false
inline void MarkAsRecoverableFailure() ;

static inline ::System::Net::CommandStream* New_ctor(::System::Net::Sockets::TcpClient*  client) ;

/// @brief Method PipelineCallback, addr 0x1802dd520, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method PostReadCommandProcessing, addr 0x181e24190, size 0x1c0, virtual false, abstract: false, final false
inline bool PostReadCommandProcessing(::by_ref<::System::IO::Stream*>  stream) ;

/// @brief Method PostSendCommandProcessing, addr 0x181e24350, size 0xe0, virtual false, abstract: false, final false
inline bool PostSendCommandProcessing(::by_ref<::System::IO::Stream*>  stream) ;

/// @brief Method ReadCallback, addr 0x181e24430, size 0x150, virtual false, abstract: false, final false
static inline void ReadCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method ReceiveCommandResponse, addr 0x181e24a10, size 0x290, virtual false, abstract: false, final false
inline ::System::Net::ResponseDescription* ReceiveCommandResponse() ;

/// @brief Method ReceiveCommandResponseCallback, addr 0x181e24580, size 0x490, virtual false, abstract: false, final false
inline void ReceiveCommandResponseCallback(::System::Net::ReceiveState*  state, int32_t  bytesRead) ;

/// @brief Method SubmitRequest, addr 0x181e24ca0, size 0xa0, virtual false, abstract: false, final false
inline ::System::IO::Stream* SubmitRequest(::System::Net::WebRequest*  request, bool  isAsync, bool  readInitalResponseOnConnect) ;

/// @brief Method WriteCallback, addr 0x181e24d40, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e24f30, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_Encoding, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_Encoding() ;

/// @brief Method get_RecoverableFailure, addr 0x1803023c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Encoding, addr 0x181e24fe0, size 0x50, virtual false, abstract: false, final false
