...
MARK_REF_T(::System::Net::FtpControlStream*);
MARK_REF_T(::System::Net::FtpControlStream___c__DisplayClass31_0*);
DEFINE_IL2CPP_CLASS(::System::Net::FtpControlStream_GetPathOption, "System.Net", "FtpControlStream/GetPathOption");
DEFINE_IL2CPP_CLASS(::System::Net::FtpControlStream*, "System.Net", "FtpControlStream");
DEFINE_IL2CPP_CLASS(::System::Net::FtpControlStream___c__DisplayClass31_0*, "System.Net", "FtpControlStream/<>c__DisplayClass31_0");
// Dependencies 
namespace System::Net {
// Is value type: true
...
static_assert(offsetof(::System::Net::FtpControlStream_GetPathOption, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method <PipelineCallback>b__0, addr 0x181e33e40, size 0x90, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::FtpControlStream___c__DisplayClass31_0) == 0x20, "Size mismatch!");
...
/// @brief Method AbortConnect, addr 0x181e253e0, size 0x20, virtual false, abstract: false, final false
inline void AbortConnect() ;

/// @brief Method AcceptCallback, addr 0x181e25400, size 0x270, virtual false, abstract: false, final false
static inline void AcceptCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method BuildCommandsList, addr 0x181e25670, size 0xd00, virtual true, abstract: false, final false
inline ::ArrayW<::System::Net::CommandStream_PipelineEntry*> BuildCommandsList(::System::Net::WebRequest*  req) ;

/// @brief Method CheckValid, addr 0x181e26370, size 0x240, virtual true, abstract: false, final false
inline bool CheckValid(::System::Net::ResponseDescription*  response, ::by_ref<int32_t>  validThrough, ::by_ref<int32_t>  completeLength) ;

/// @brief Method ClearState, addr 0x181e265b0, size 0xf0, virtual true, abstract: false, final false
inline void ClearState() ;

/// @brief Method ConnectCallback, addr 0x181e266a0, size 0xd0, virtual false, abstract: false, final false
static inline void ConnectCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method CreateFtpDataSocket, addr 0x181e26770, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method CreateFtpListenerSocket, addr 0x181e267d0, size 0x190, virtual false, abstract: false, final false
inline void CreateFtpListenerSocket(::System::Net::FtpWebRequest*  request) ;

/// @brief Method FormatAddress, addr 0x181e26a40, size 0x100, virtual false, abstract: false, final false
inline ::StringW FormatAddress(::System::Net::IPAddress*  address, int32_t  Port) ;

/// @brief Method FormatAddressV6, addr 0x181e26960, size 0xe0, virtual false, abstract: false, final false
inline ::StringW FormatAddressV6(::System::Net::IPAddress*  address, int32_t  port) ;

/// @brief Method FormatFtpCommand, addr 0x181e26b40, size 0xd0, virtual false, abstract: false, final false
inline ::StringW FormatFtpCommand(::StringW  command, ::StringW  parameter) ;

/// @brief Method GetContentLengthFrom213Response, addr 0x181e26c10, size 0xb0, virtual false, abstract: false, final false
inline int64_t GetContentLengthFrom213Response(::StringW  responseString) ;

/// @brief Method GetLastModifiedFrom213Response, addr 0x181e26cc0, size 0x240, virtual false, abstract: false, final false
inline ::System::DateTime GetLastModifiedFrom213Response(::StringW  str) ;

/// @brief Method GetLoginDirectory, addr 0x181e26f00, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetLoginDirectory(::StringW  str) ;

/// @brief Method GetPathInfo, addr 0x181e26f80, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetPortCommandLine, addr 0x181e270f0, size 0x340, virtual false, abstract: false, final false
inline ::StringW GetPortCommandLine(::System::Net::FtpWebRequest*  request) ;

/// @brief Method GetPortV4, addr 0x181e27430, size 0x120, virtual false, abstract: false, final false
inline int32_t GetPortV4(::StringW  responseString) ;

/// @brief Method GetPortV6, addr 0x181e27550, size 0x140, virtual false, abstract: false, final false
inline int32_t GetPortV6(::StringW  responseString) ;

/// @brief Method IsFtpDataStreamWriteable, addr 0x181e27690, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method PipelineCallback, addr 0x181e276e0, size 0x930, virtual true, abstract: false, final false
inline ::System::Net::CommandStream_PipelineInstruction PipelineCallback(::System::Net::CommandStream_PipelineEntry*  entry, ::System::Net::ResponseDescription*  response, bool  timeout, ::by_ref<::System::IO::Stream*>  stream) ;

/// @brief Method QueueOrCreateDataConection, addr 0x181e28010, size 0x7b0, virtual false, abstract: false, final false
inline ::System::Net::CommandStream_PipelineInstruction QueueOrCreateDataConection(::System::Net::CommandStream_PipelineEntry*  entry, ::System::Net::ResponseDescription*  response, bool  timeout, ::by_ref<::System::IO::Stream*>  stream, ::by_ref<bool>  isSocketReady) ;

/// @brief Method QueueOrCreateFtpDataStream, addr 0x181e287c0, size 0x3c0, virtual false, abstract: false, final false
inline ::System::Net::CommandStream_PipelineInstruction QueueOrCreateFtpDataStream(::by_ref<::System::IO::Stream*>  stream) ;

/// @brief Method SSLHandshakeCallback, addr 0x181e28b80, size 0xd0, virtual false, abstract: false, final false
static inline void SSLHandshakeCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method TryUpdateContentLength, addr 0x181e28c50, size 0xb0, virtual false, abstract: false, final false
inline void TryUpdateContentLength(::StringW  str) ;

/// @brief Method TryUpdateResponseUri, addr 0x181e28d00, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e29090, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_BannerMessage, addr 0x181e29170, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_BannerMessage() ;

/// @brief Method get_ContentLength, addr 0x1803223b0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_ContentLength() ;

/// @brief Method get_Credentials, addr 0x181e291a0, size 0xa0, virtual false, abstract: false, final false
inline ::System::Net::NetworkCredential* get_Credentials() ;

/// @brief Method get_ExitMessage, addr 0x181e29240, size 0x30, virtual false, abstract: false, final false
inline ::StringW get_ExitMessage() ;

/// @brief Method get_LastModified, addr 0x1803b2f10, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_LastModified() ;

/// @brief Method get_ResponseUri, addr 0x180337100, size 0x10, virtual false, abstract: false, final false
inline ::System::Uri* get_ResponseUri() ;

/// @brief Method get_WelcomeMessage, addr 0x181e29270, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_Credentials, addr 0x181e292a0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::FtpControlStream) == 0x110, "Size mismatch!");
