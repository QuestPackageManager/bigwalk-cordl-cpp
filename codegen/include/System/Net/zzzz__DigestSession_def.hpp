...
// Write type traits
MARK_REF_T(::System::Net::DigestSession*);
DEFINE_IL2CPP_CLASS(::System::Net::DigestSession*, "System.Net", "DigestSession");
...
/// @brief Method Authenticate, addr 0x181e40760, size 0x3a0, virtual false, abstract: false, final false
inline ::System::Net::Authorization* Authenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method HA1, addr 0x181e40b00, size 0xd0, virtual false, abstract: false, final false
inline ::StringW HA1(::StringW  username, ::StringW  password) ;

/// @brief Method HA2, addr 0x181e40bd0, size 0xa0, virtual false, abstract: false, final false
inline ::StringW HA2(::System::Net::HttpWebRequest*  webRequest) ;

/// @brief Method HashToHexString, addr 0x181e40c70, size 0x110, virtual false, abstract: false, final false
inline ::StringW HashToHexString(::StringW  toBeHashed) ;

static inline ::System::Net::DigestSession* New_ctor() ;

/// @brief Method Parse, addr 0x181e40d80, size 0x200, virtual false, abstract: false, final false
inline bool Parse(::StringW  challenge) ;

/// @brief Method Response, addr 0x181e40f80, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e411c0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Security::Cryptography::RandomNumberGenerator* getStaticF_rng() ;

/// @brief Method get_Algorithm, addr 0x181e411f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_CNonce, addr 0x181e41200, size 0xb0, virtual false, abstract: false, final false
inline ::StringW get_CNonce() ;

/// @brief Method get_LastUse, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_LastUse() ;

/// @brief Method get_Nonce, addr 0x181e412b0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Nonce() ;

/// @brief Method get_Opaque, addr 0x181e412c0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Opaque() ;

/// @brief Method get_QOP, addr 0x181e412d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_QOP() ;

/// @brief Method get_Realm, addr 0x181e412e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::DigestSession) == 0x38, "Size mismatch!");
