...
// Write type traits
MARK_REF_T(::System::Net::FtpWebResponse*);
MARK_REF_T(::System::Net::FtpWebResponse_EmptyStream*);
DEFINE_IL2CPP_CLASS(::System::Net::FtpWebResponse*, "System.Net", "FtpWebResponse");
DEFINE_IL2CPP_CLASS(::System::Net::FtpWebResponse_EmptyStream*, "System.Net", "FtpWebResponse/EmptyStream");
...
/// @brief Method .ctor, addr 0x181e25190, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Net::FtpWebResponse_EmptyStream) == 0x50, "Size mismatch!");

} // namespace end def System::Net
// Dependencies System.DateTime, System.Net.FtpStatusCode, System.Net.WebResponse
namespace System::Net {
// Is value type: false
...
/// @brief Method Close, addr 0x181e2dfb0, size 0x70, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetResponseStream, addr 0x181e2e020, size 0x90, virtual true, abstract: false, final false
inline ::System::IO::Stream* GetResponseStream() ;

static inline ::System::Net::FtpWebResponse* New_ctor(::System::IO::Stream*  responseStream, int64_t  contentLength, ::System::Uri*  responseUri, ::System::Net::FtpStatusCode  statusCode, ::StringW  statusLine, ::System::DateTime  lastModified, ::StringW  bannerMessage, ::StringW  welcomeMessage, ::StringW  exitMessage) ;

/// @brief Method SetResponseStream, addr 0x181e2e0b0, size 0x70, virtual false, abstract: false, final false
inline void SetResponseStream(::System::IO::Stream*  stream) ;

/// @brief Method UpdateStatus, addr 0x181e2e120, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e2e160, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  responseStream, int64_t  contentLength, ::System::Uri*  responseUri, ::System::Net::FtpStatusCode  statusCode, ::StringW  statusLine, ::System::DateTime  lastModified, ::StringW  bannerMessage, ::StringW  welcomeMessage, ::StringW  exitMessage) ;

/// @brief Method get_Headers, addr 0x181e2e260, size 0x100, virtual true, abstract: false, final false
inline ::System::Net::WebHeaderCollection* get_Headers() ;

/// @brief Method get_ResponseUri, addr 0x1802d97f0, size 0x10, virtual true, abstract: false, final false
inline ::System::Uri* get_ResponseUri() ;

/// @brief Method get_StatusCode, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::FtpWebResponse) == 0x70, "Size mismatch!");
