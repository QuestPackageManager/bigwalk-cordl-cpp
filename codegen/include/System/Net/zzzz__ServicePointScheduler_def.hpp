...
/// @brief Method Cleanup, addr 0x181d86b30, size 0x90, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateOrReuseConnection, addr 0x181d86bc0, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method EnqueueOperation, addr 0x181d86e10, size 0x10, virtual false, abstract: false, final false
inline void EnqueueOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method FindIdleConnection, addr 0x181d86e20, size 0x190, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation*  operation) ;

/// @brief Method GetNextOperation, addr 0x181d86fb0, size 0xb0, virtual false, abstract: false, final false
inline ::System::Net::WebOperation* GetNextOperation() ;

/// @brief Method IsEmpty, addr 0x181d87060, size 0x20, virtual false, abstract: false, final false
inline bool IsEmpty() ;
...
/// @brief Method RemoveConnection, addr 0x181d87080, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d870f0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePointScheduler*  scheduler, ::StringW  name) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_Scheduler, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <Set>b__4_0, addr 0x181d90db0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x181d864f0, size 0x70, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Set, addr 0x181d86560, size 0x140, virtual false, abstract: false, final false
inline void Set() ;

/// @brief Method WaitAsync, addr 0x181d866a0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d86750, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x181d8f4f0, size 0xb10, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::ServicePointScheduler*", modifiers: "", def_value: None }, CppParam { name: "_operationArray_5__2", ty: "::ArrayW<::System::ValueTuple_2<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebOperation*>>", modifiers: "", def_value: None }, CppParam { name: "_idleArray_5__3", ty: "::ArrayW<::System::ValueTuple_3<::System::Net::ServicePointScheduler_ConnectionGroup*,::System::Net::WebConnection*,::System::Threading::Tasks::Task*>>", modifiers: "", def_value: None }, CppParam { name: "_taskList_5__4", ty: "::System::Collections::Generic::List_1<::System::Threading::Tasks::Task*>*", modifiers: "", def_value: None }, CppParam { name: "_schedulerTask_5__5", ty: "::System::Threading::Tasks::Task_1<bool>*", modifiers: "", def_value: None }, CppParam { name: "_finalCleanup_5__6", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Threading::Tasks::Task*>", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x181d90ea0, size 0x360, virtual true, abstract: false, final true
inline void MoveNext() ;
...
/// @brief Method Cleanup, addr 0x181d89690, size 0x120, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CloseIdleConnection, addr 0x181d897b0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method FinalCleanup, addr 0x181d89840, size 0xe0, virtual false, abstract: false, final false
inline void FinalCleanup() ;

/// @brief Method GetConnectionGroup, addr 0x181d89920, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method OnConnectionClosed, addr 0x181d89ab0, size 0x30, virtual false, abstract: false, final false
inline void OnConnectionClosed(::System::Net::WebConnection*  connection) ;

/// @brief Method OnConnectionCreated, addr 0x181d89ae0, size 0x10, virtual false, abstract: false, final false
inline void OnConnectionCreated(::System::Net::WebConnection*  connection) ;

/// @brief Method OperationCompleted, addr 0x181d89af0, size 0x1e0, virtual false, abstract: false, final false
inline bool OperationCompleted(::System::Net::ServicePointScheduler_ConnectionGroup*  group, ::System::Net::WebOperation*  operation) ;

/// @brief Method RemoveIdleConnection, addr 0x181d89cd0, size 0x70, virtual false, abstract: false, final false
inline void RemoveIdleConnection(::System::Net::WebConnection*  connection) ;

/// @brief Method RemoveOperation, addr 0x181d89d40, size 0x70, virtual false, abstract: false, final false
inline void RemoveOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method Run, addr 0x181d89f70, size 0x70, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method RunScheduler, addr 0x181d89ee0, size 0x90, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* RunScheduler() ;

/// @brief Method RunSchedulerIteration, addr 0x181d89db0, size 0x130, virtual false, abstract: false, final false
inline void RunSchedulerIteration() ;

/// @brief Method SchedulerIteration, addr 0x181d89fe0, size 0x140, virtual false, abstract: false, final false
inline bool SchedulerIteration(::System::Net::ServicePointScheduler_ConnectionGroup*  group) ;

/// @brief Method SendRequest, addr 0x181d8a120, size 0x110, virtual false, abstract: false, final false
inline void SendRequest(::System::Net::WebOperation*  operation, ::StringW  groupName) ;

/// @brief Method WaitAsync, addr 0x181d8a230, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method <Run>b__31_0, addr 0x181d89ee0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181d8a2e0, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePoint*  servicePoint, int32_t  connectionLimit, int32_t  maxIdleTime) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_MaxIdleTime, addr 0x1802f42c0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_MaxIdleTime() ;

/// @brief Method get_ServicePoint, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

static inline void setStaticF_nextId(int32_t  value) ;

/// @brief Method set_ServicePoint, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
