...
// Write type traits
MARK_REF_T(::System::Net::CookieTokenizer*);
MARK_VAL_T(::System::Net::CookieTokenizer_RecognizedAttribute);
DEFINE_IL2CPP_CLASS(::System::Net::CookieTokenizer*, "System.Net", "CookieTokenizer");
DEFINE_IL2CPP_CLASS(::System::Net::CookieTokenizer_RecognizedAttribute, "System.Net", "CookieTokenizer/RecognizedAttribute");
...
/// @brief Method IsEqualTo, addr 0x181e48030, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Token, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::CookieTokenizer_RecognizedAttribute) == 0x10, "Size mismatch!");

} // namespace end def System::Net
// Dependencies System.Net.CookieToken, System.Net.CookieTokenizer::RecognizedAttribute, System.Object
namespace System::Net {
// Is value type: false
...
/// @brief Field RecognizedAttributes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_RecognizedAttributes, put=setStaticF_RecognizedAttributes)) ::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute>  RecognizedAttributes;

/// @brief Field RecognizedServerAttributes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_RecognizedServerAttributes, put=setStaticF_RecognizedServerAttributes)) ::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute>  RecognizedServerAttributes;
...
/// @brief Method Extract, addr 0x181e3cf40, size 0x50, virtual false, abstract: false, final false
inline ::StringW Extract() ;

/// @brief Method FindNext, addr 0x181e3cf90, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x181e3d180, size 0x210, virtual false, abstract: false, final false
inline ::System::Net::CookieToken Next(bool  first, bool  parseResponseCookies) ;

/// @brief Method Reset, addr 0x181e3d390, size 0x60, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method TokenFromName, addr 0x181e3d3f0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181e3d950, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  tokenStream) ;

static inline ::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute> getStaticF_RecognizedAttributes() ;

static inline ::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute> getStaticF_RecognizedServerAttributes() ;

/// @brief Method get_EndOfCookie, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_EndOfCookie() ;

/// @brief Method get_Eof, addr 0x181e3d970, size 0x10, virtual false, abstract: false, final false
inline bool get_Eof() ;

/// @brief Method get_Name, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Quoted, addr 0x1802f1be0, size 0x10, virtual false, abstract: false, final false
inline bool get_Quoted() ;

/// @brief Method get_Token, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::System::Net::CookieToken get_Token() ;

/// @brief Method get_Value, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

static inline void setStaticF_RecognizedAttributes(::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute>  value) ;

static inline void setStaticF_RecognizedServerAttributes(::ArrayW<::System::Net::CookieTokenizer_RecognizedAttribute>  value) ;

/// @brief Method set_EndOfCookie, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Quoted, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
inline void set_Quoted(bool  value) ;

/// @brief Method set_Token, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
inline void set_Token(::System::Net::CookieToken  value) ;

/// @brief Method set_Value, addr 0x1802e5d90, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Net::CookieTokenizer) == 0x48, "Size mismatch!");
