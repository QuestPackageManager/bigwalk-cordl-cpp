...
// Write type traits
MARK_REF_T(::System::Security::Util::TokenizerShortBlock*);
DEFINE_IL2CPP_CLASS(::System::Security::Util::TokenizerShortBlock*, "System.Security.Util", "TokenizerShortBlock");
...
/// @brief Field m_block, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_block, put=__cordl_internal_set_m_block)) ::ArrayW<int16_t>  m_block;
...
constexpr ::ArrayW<int16_t> const& __cordl_internal_get_m_block() const;

constexpr ::ArrayW<int16_t>& __cordl_internal_get_m_block() ;
...
constexpr void __cordl_internal_set_m_block(::ArrayW<int16_t>  value) ;

constexpr void __cordl_internal_set_m_next(::System::Security::Util::TokenizerShortBlock*  value) ;

/// @brief Method .ctor, addr 0x1815ffa90, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Util::TokenizerShortBlock) == 0x20, "Size mismatch!");
