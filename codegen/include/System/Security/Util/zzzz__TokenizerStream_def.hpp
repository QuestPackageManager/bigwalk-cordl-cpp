...
/// @brief Method AddString, addr 0x1815ffac0, size 0xd0, virtual false, abstract: false, final false
inline void AddString(::StringW  str) ;

/// @brief Method AddToken, addr 0x1815ffb90, size 0xc0, virtual false, abstract: false, final false
inline void AddToken(int16_t  token) ;

/// @brief Method GetNextFullToken, addr 0x1815ffc50, size 0x70, virtual false, abstract: false, final false
inline int16_t GetNextFullToken() ;

/// @brief Method GetNextString, addr 0x1815ffcc0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetNextString() ;

/// @brief Method GetNextToken, addr 0x1815ffd20, size 0x70, virtual false, abstract: false, final false
inline int16_t GetNextToken() ;

/// @brief Method GetTokenCount, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline int32_t GetTokenCount() ;

/// @brief Method GoToPosition, addr 0x1815ffd90, size 0xe0, virtual false, abstract: false, final false
inline void GoToPosition(int32_t  position) ;

static inline ::System::Security::Util::TokenizerStream* New_ctor() ;

/// @brief Method Reset, addr 0x1815ffe70, size 0x60, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method TagLastToken, addr 0x1815ffed0, size 0x50, virtual false, abstract: false, final false
inline void TagLastToken(int16_t  tag) ;

/// @brief Method ThrowAwayNextString, addr 0x1815fff20, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815fff60, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
