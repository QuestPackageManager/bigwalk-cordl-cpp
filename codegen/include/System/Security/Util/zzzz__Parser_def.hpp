...
// Write type traits
MARK_REF_T(::System::Security::Util::Parser*);
DEFINE_IL2CPP_CLASS(::System::Security::Util::Parser*, "System.Security.Util", "Parser");
...
/// @brief Method DetermineFormat, addr 0x1815fb440, size 0x1e0, virtual false, abstract: false, final false
inline int32_t DetermineFormat(::System::Security::Util::TokenizerStream*  stream) ;

/// @brief Method GetRequiredSizes, addr 0x1815fb620, size 0xba0, virtual false, abstract: false, final false
inline void GetRequiredSizes(::System::Security::Util::TokenizerStream*  stream, ::by_ref<int32_t>  index) ;

/// @brief Method GetTopElement, addr 0x1815fc1c0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ParseContents, addr 0x1815fc1d0, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815fc6c0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  input) ;

/// @brief Method .ctor, addr 0x1815fc760, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Util::Parser) == 0x20, "Size mismatch!");
