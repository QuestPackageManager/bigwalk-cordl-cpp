...
/// @brief Method Alloc, addr 0x1815fd470, size 0x100, virtual false, abstract: false, final false
inline void Alloc(int32_t  length, bool  realloc) ;

/// @brief Method Decrypt, addr 0x180631430, size 0xa670, virtual false, abstract: false, final false
inline void Decrypt() ;

/// @brief Method Dispose, addr 0x1815fd570, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Encrypt, addr 0x180631430, size 0xa670, virtual false, abstract: false, final false
inline void Encrypt() ;

/// @brief Method GetBuffer, addr 0x1815fd5d0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815fd730, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815fd650, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(char16_t*  value, int32_t  length) ;

/// @brief Method get_Length, addr 0x1815fd760, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::SecureString) == 0x20, "Size mismatch!");
