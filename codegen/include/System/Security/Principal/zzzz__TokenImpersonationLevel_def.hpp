...
DEFINE_IL2CPP_CLASS(::System::Security::Principal::TokenImpersonationLevel, "System.Security.Principal", "TokenImpersonationLevel");
// Dependencies 
namespace System::Security::Principal {
// Is value type: true
...
static_assert(offsetof(::System::Security::Principal::TokenImpersonationLevel, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Principal::TokenImpersonationLevel) == 0x4, "Size mismatch!");
