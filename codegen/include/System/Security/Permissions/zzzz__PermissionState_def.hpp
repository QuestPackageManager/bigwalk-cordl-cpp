...
DEFINE_IL2CPP_CLASS(::System::Security::Permissions::PermissionState, "System.Security.Permissions", "PermissionState");
// Dependencies 
namespace System::Security::Permissions {
// Is value type: true
...
static_assert(offsetof(::System::Security::Permissions::PermissionState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Permissions::PermissionState) == 0x4, "Size mismatch!");
