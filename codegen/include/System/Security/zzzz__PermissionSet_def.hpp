...
/// @brief Method CasOnlyDemand, addr 0x1815fc800, size 0x50, virtual false, abstract: false, final false
inline void CasOnlyDemand(int32_t  skip) ;

/// @brief Method CopyTo, addr 0x1815fc850, size 0xd0, virtual true, abstract: false, final false
inline void CopyTo(::System::Array*  array, int32_t  index) ;

/// @brief Method Demand, addr 0x1815fc920, size 0x170, virtual true, abstract: false, final true
inline void Demand() ;

/// @brief Method Equals, addr 0x1815fca90, size 0x1b0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetEnumerator, addr 0x1815fcc40, size 0x20, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x1815fcc60, size 0x40, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsEmpty, addr 0x1815fcca0, size 0x200, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method IsUnrestricted, addr 0x180d8f5e0, size 0x7f0, virtual false, abstract: false, final false
...
/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x1802d9d80, size 0x10, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object*  sender) ;

/// @brief Method ToString, addr 0x1815fcea0, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToXml, addr 0x1815fcee0, size 0x350, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1815f9660, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1815fd310, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Security::IPermission*  perm) ;

/// @brief Method .ctor, addr 0x1815fd380, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_IsSynchronized, addr 0x1815fd450, size 0x20, virtual true, abstract: false, final false
inline bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot, addr 0x1802e0ba0, size 0x10, virtual true, abstract: false, final false
