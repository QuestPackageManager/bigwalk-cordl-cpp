...
// Write type traits
MARK_REF_T(::System::Security::Claims::Claim*);
DEFINE_IL2CPP_CLASS(::System::Security::Claims::Claim*, "System.Security.Claims", "Claim");
...
/// @brief Method Clone, addr 0x18161e680, size 0x50, virtual true, abstract: false, final false
...
static inline ::System::Security::Claims::Claim* New_ctor(::StringW  type, ::StringW  value, ::StringW  valueType, ::StringW  issuer, ::StringW  originalIssuer, ::System::Security::Claims::ClaimsIdentity*  subject) ;

static inline ::System::Security::Claims::Claim* New_ctor(::StringW  type, ::StringW  value, ::StringW  valueType, ::StringW  issuer, ::StringW  originalIssuer, ::System::Security::Claims::ClaimsIdentity*  subject, ::StringW  propertyKey, ::StringW  propertyValue) ;

/// @brief Method OnDeserializedMethod, addr 0x18161e6d0, size 0x30, virtual false, abstract: false, final false
inline void OnDeserializedMethod(::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method ToString, addr 0x18161e700, size 0x40, virtual true, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* const& __cordl_internal_get_m_properties() const;

constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*& __cordl_internal_get_m_properties() ;

constexpr ::System::Object* const& __cordl_internal_get_m_propertyLock() const;

constexpr ::System::Object*& __cordl_internal_get_m_propertyLock() ;

constexpr ::System::Security::Claims::ClaimsIdentity* const& __cordl_internal_get_m_subject() const;
...
/// @brief Method .ctor, addr 0x18161e790, size 0x1f0, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Claims::Claim*  other, ::System::Security::Claims::ClaimsIdentity*  subject) ;

/// @brief Method .ctor, addr 0x18161e740, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18161e980, size 0x200, virtual false, abstract: false, final false
inline void _ctor(::StringW  type, ::StringW  value, ::StringW  valueType, ::StringW  issuer, ::StringW  originalIssuer, ::System::Security::Claims::ClaimsIdentity*  subject, ::StringW  propertyKey, ::StringW  propertyValue) ;

/// @brief Method get_Properties, addr 0x18161eb80, size 0xe0, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* get_Properties() ;

/// @brief Method get_Subject, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Value, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Subject, addr 0x180308de0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Claims::Claim) == 0x58, "Size mismatch!");
