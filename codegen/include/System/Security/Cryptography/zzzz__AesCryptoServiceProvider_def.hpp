...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::AesCryptoServiceProvider*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::AesCryptoServiceProvider*, "System.Security.Cryptography", "AesCryptoServiceProvider");
...
/// @brief Method CreateDecryptor, addr 0x181ad8960, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method CreateEncryptor, addr 0x181ad8a40, size 0xe0, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor(::ArrayW<uint8_t>  key, ::ArrayW<uint8_t>  iv) ;

/// @brief Method Dispose, addr 0x181ad8b20, size 0x10, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GenerateIV, addr 0x181ad8b30, size 0x30, virtual true, abstract: false, final false
inline void GenerateIV() ;

/// @brief Method GenerateKey, addr 0x181ad8b60, size 0x30, virtual true, abstract: false, final false
inline void GenerateKey() ;

static inline ::System::Security::Cryptography::AesCryptoServiceProvider* New_ctor() ;

/// @brief Method .ctor, addr 0x181ad8b90, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_IV, addr 0x181ad8bb0, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_IV() ;

/// @brief Method get_Key, addr 0x181ad8bc0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_IV, addr 0x181ad8bd0, size 0x10, virtual true, abstract: false, final false
inline void set_IV(::ArrayW<uint8_t>  value) ;

/// @brief Method set_Key, addr 0x181ad8bf0, size 0x10, virtual true, abstract: false, final false
inline void set_Key(::ArrayW<uint8_t>  value) ;

/// @brief Method set_KeySize, addr 0x181ad8be0, size 0x10, virtual true, abstract: false, final false
inline void set_KeySize(int32_t  value) ;

/// @brief Method set_Mode, addr 0x181ad8c00, size 0x60, virtual true, abstract: false, final false
inline void set_Mode(::System::Security::Cryptography::CipherMode  value) ;

/// @brief Method set_Padding, addr 0x181ad8c60, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::AesCryptoServiceProvider) == 0x48, "Size mismatch!");
