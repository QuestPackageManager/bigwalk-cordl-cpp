...
/// @brief Method BSwap, addr 0x181613b10, size 0x40, virtual false, abstract: false, final false
static inline void BSwap(::ArrayW<uint8_t>  byteBuff) ;

/// @brief Method CipherFunct, addr 0x181613b50, size 0x180, virtual false, abstract: false, final false
inline uint32_t CipherFunct(uint32_t  r, int32_t  n) ;

/// @brief Method ECB, addr 0x181613cd0, size 0x90, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method GetStrongKey, addr 0x181613d60, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Permutation, addr 0x181613db0, size 0x1a0, virtual false, abstract: false, final false
static inline void Permutation(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output, ::ArrayW<uint32_t>  permTab, bool  preSwap) ;

/// @brief Method ProcessBlock, addr 0x181613f50, size 0x380, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method SetKey, addr 0x1816142d0, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181614790, size 0x1e0, virtual false, abstract: false, final false
