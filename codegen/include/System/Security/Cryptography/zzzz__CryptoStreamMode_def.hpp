...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::CryptoStreamMode, "System.Security.Cryptography", "CryptoStreamMode");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::CryptoStreamMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::CryptoStreamMode) == 0x4, "Size mismatch!");
