...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::HMACMD5*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::HMACMD5*, "System.Security.Cryptography", "HMACMD5");
...
/// @brief Method .ctor, addr 0x181607810, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181607760, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::HMACMD5) == 0x68, "Size mismatch!");
