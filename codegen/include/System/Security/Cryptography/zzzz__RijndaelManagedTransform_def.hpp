...
/// @brief Field m_IV, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_IV, put=__cordl_internal_set_m_IV)) ::ArrayW<int32_t>  m_IV;
...
/// @brief Field m_decryptKeyExpansion, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_decryptKeyExpansion, put=__cordl_internal_set_m_decryptKeyExpansion)) ::ArrayW<int32_t>  m_decryptKeyExpansion;

/// @brief Field m_decryptindex, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_decryptindex, put=__cordl_internal_set_m_decryptindex)) ::ArrayW<int32_t>  m_decryptindex;

/// @brief Field m_depadBuffer, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_depadBuffer, put=__cordl_internal_set_m_depadBuffer)) ::ArrayW<uint8_t>  m_depadBuffer;

/// @brief Field m_encryptKeyExpansion, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_encryptKeyExpansion, put=__cordl_internal_set_m_encryptKeyExpansion)) ::ArrayW<int32_t>  m_encryptKeyExpansion;

/// @brief Field m_encryptindex, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_encryptindex, put=__cordl_internal_set_m_encryptindex)) ::ArrayW<int32_t>  m_encryptindex;
...
/// @brief Field m_lastBlockBuffer, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_lastBlockBuffer, put=__cordl_internal_set_m_lastBlockBuffer)) ::ArrayW<int32_t>  m_lastBlockBuffer;
...
/// @brief Field m_shiftRegister, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_shiftRegister, put=__cordl_internal_set_m_shiftRegister)) ::ArrayW<uint8_t>  m_shiftRegister;
...
/// @brief Field s_Rcon, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_Rcon, put=setStaticF_s_Rcon)) ::ArrayW<int32_t>  s_Rcon;

/// @brief Field s_Sbox, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_Sbox, put=setStaticF_s_Sbox)) ::ArrayW<uint8_t>  s_Sbox;

/// @brief Field s_T, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_T, put=setStaticF_s_T)) ::ArrayW<int32_t>  s_T;

/// @brief Field s_TF, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_TF, put=setStaticF_s_TF)) ::ArrayW<int32_t>  s_TF;

/// @brief Field s_iT, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_iT, put=setStaticF_s_iT)) ::ArrayW<int32_t>  s_iT;

/// @brief Field s_iTF, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_iTF, put=setStaticF_s_iTF)) ::ArrayW<int32_t>  s_iTF;
...
/// @brief Method Dec, addr 0x18160d940, size 0x230, virtual false, abstract: false, final false
inline void Dec(int32_t*  decryptindex, int32_t*  decryptKeyExpansion, int32_t*  iT, int32_t*  iTF, int32_t*  work, int32_t*  temp) ;

/// @brief Method DecryptData, addr 0x18160db70, size 0xa00, virtual false, abstract: false, final false
inline int32_t DecryptData(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount, ::by_ref<::ArrayW<uint8_t>>  outputBuffer, int32_t  outputOffset, ::System::Security::Cryptography::PaddingMode  paddingMode, bool  fLast) ;

/// @brief Method Dispose, addr 0x18160e570, size 0x120, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x18160e690, size 0x130, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Enc, addr 0x18160e7c0, size 0x210, virtual false, abstract: false, final false
inline void Enc(int32_t*  encryptindex, int32_t*  encryptKeyExpansion, int32_t*  T, int32_t*  TF, int32_t*  work, int32_t*  temp) ;

/// @brief Method EncryptData, addr 0x18160e9d0, size 0x8f0, virtual false, abstract: false, final false
inline int32_t EncryptData(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount, ::by_ref<::ArrayW<uint8_t>>  outputBuffer, int32_t  outputOffset, ::System::Security::Cryptography::PaddingMode  paddingMode, bool  fLast) ;

/// @brief Method GenerateKeyExpansion, addr 0x18160f2c0, size 0x4a0, virtual false, abstract: false, final false
inline void GenerateKeyExpansion(::ArrayW<uint8_t>  rgbKey) ;

/// @brief Method MulX, addr 0x18160f760, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x18160f790, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SubWord, addr 0x18160f810, size 0x80, virtual false, abstract: false, final false
static inline int32_t SubWord(int32_t  a) ;

/// @brief Method TransformBlock, addr 0x18160f890, size 0x2e0, virtual true, abstract: false, final true
...
/// @brief Method TransformFinalBlock, addr 0x18160fb70, size 0x2a0, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> TransformFinalBlock(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_IV() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_IV() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_decryptKeyExpansion() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_decryptKeyExpansion() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_decryptindex() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_decryptindex() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_depadBuffer() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_depadBuffer() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_encryptKeyExpansion() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_encryptKeyExpansion() ;

constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_encryptindex() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_encryptindex() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_m_lastBlockBuffer() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_m_lastBlockBuffer() ;
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_shiftRegister() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_shiftRegister() ;
...
constexpr void __cordl_internal_set_m_IV(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_m_decryptKeyExpansion(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_decryptindex(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_depadBuffer(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_m_encryptKeyExpansion(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_encryptindex(::ArrayW<int32_t>  value) ;

constexpr void __cordl_internal_set_m_inputBlockSize(int32_t  value) ;

constexpr void __cordl_internal_set_m_lastBlockBuffer(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_m_shiftRegister(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_m_transformMode(::System::Security::Cryptography::RijndaelManagedTransformMode  value) ;

/// @brief Method .ctor, addr 0x181610010, size 0x560, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  rgbKey, ::System::Security::Cryptography::CipherMode  mode, ::ArrayW<uint8_t>  rgbIV, int32_t  blockSize, int32_t  feedbackSize, ::System::Security::Cryptography::PaddingMode  PaddingValue, ::System::Security::Cryptography::RijndaelManagedTransformMode  transformMode) ;

static inline ::ArrayW<int32_t> getStaticF_s_Rcon() ;

static inline ::ArrayW<uint8_t> getStaticF_s_Sbox() ;

static inline ::ArrayW<int32_t> getStaticF_s_T() ;

static inline ::ArrayW<int32_t> getStaticF_s_TF() ;

static inline ::ArrayW<int32_t> getStaticF_s_iT() ;

static inline ::ArrayW<int32_t> getStaticF_s_iTF() ;

/// @brief Method get_CanReuseTransform, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
inline bool get_CanReuseTransform() ;

/// @brief Method get_CanTransformMultipleBlocks, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final true
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize, addr 0x180396ef0, size 0x10, virtual true, abstract: false, final true
inline int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize, addr 0x1803914a0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method rot1, addr 0x181610570, size 0x10, virtual false, abstract: false, final false
static inline int32_t rot1(int32_t  val) ;

/// @brief Method rot2, addr 0x181610580, size 0x10, virtual false, abstract: false, final false
static inline int32_t rot2(int32_t  val) ;

/// @brief Method rot3, addr 0x181610590, size 0x10, virtual false, abstract: false, final false
static inline int32_t rot3(int32_t  val) ;

static inline void setStaticF_s_Rcon(::ArrayW<int32_t>  value) ;

static inline void setStaticF_s_Sbox(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_s_T(::ArrayW<int32_t>  value) ;

static inline void setStaticF_s_TF(::ArrayW<int32_t>  value) ;

static inline void setStaticF_s_iT(::ArrayW<int32_t>  value) ;

static inline void setStaticF_s_iTF(::ArrayW<int32_t>  value) ;
...
/// @brief Field m_encryptKeyExpansion, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___m_encryptKeyExpansion;

/// @brief Field m_decryptKeyExpansion, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<int32_t>  ___m_decryptKeyExpansion;
...
static_assert(sizeof(::System::Security::Cryptography::RijndaelManagedTransform) == 0x80, "Size mismatch!");
