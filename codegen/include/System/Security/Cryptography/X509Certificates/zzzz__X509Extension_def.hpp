...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509Extension*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509Extension*, "System.Security.Cryptography.X509Certificates", "X509Extension");
...
/// @brief Method CopyFrom, addr 0x181df7f20, size 0xa0, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method FormatUnkownData, addr 0x181df7fc0, size 0xb0, virtual false, abstract: false, final false
inline ::StringW FormatUnkownData(::ArrayW<uint8_t>  data) ;

static inline ::System::Security::Cryptography::X509Certificates::X509Extension* New_ctor() ;

static inline ::System::Security::Cryptography::X509Certificates::X509Extension* New_ctor(::StringW  oid, ::ArrayW<uint8_t>  rawData, bool  critical) ;
...
/// @brief Method .ctor, addr 0x181df8070, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid, ::ArrayW<uint8_t>  rawData, bool  critical) ;

/// @brief Method get_Critical, addr 0x1803a7410, size 0x10, virtual false, abstract: false, final false
inline bool get_Critical() ;

/// @brief Method set_Critical, addr 0x1803a7480, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509Extension) == 0x28, "Size mismatch!");
