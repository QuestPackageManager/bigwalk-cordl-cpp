...
/// @brief Method Clone, addr 0x181deed80, size 0x190, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone() ;

/// @brief Method GetDSAPrivateKey, addr 0x181deef10, size 0x70, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey() ;

/// @brief Method GetRSAPrivateKey, addr 0x181deef80, size 0x70, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey() ;

/// @brief Method GetRawCertData, addr 0x181deeff0, size 0x40, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> GetRawCertData() ;

/// @brief Method ImportPkcs12, addr 0x181def600, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ImportPkcs12, addr 0x181def030, size 0x5d0, virtual false, abstract: false, final false
...
static inline ::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono* New_ctor(::ArrayW<uint8_t>  rawData, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags) ;

/// @brief Method Verify, addr 0x181def670, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1803d9970, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method .ctor, addr 0x181defb00, size 0x180, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*  other) ;

/// @brief Method .ctor, addr 0x181def940, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method get_Cert, addr 0x181dc4ba0, size 0x20, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_Cert() ;

/// @brief Method get_HasPrivateKey, addr 0x181defc80, size 0x30, virtual true, abstract: false, final false
inline bool get_HasPrivateKey() ;

/// @brief Method get_IntermediateCertificates, addr 0x180322760, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates() ;

/// @brief Method get_IsValid, addr 0x180351a50, size 0x10, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_MonoCertificate, addr 0x1803d9940, size 0x10, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate() ;

/// @brief Method get_PrivateKey, addr 0x181defcb0, size 0x350, virtual true, abstract: false, final false
...
/// @brief Method set_PrivateKey, addr 0x181df0000, size 0x1c0, virtual true, abstract: false, final false
