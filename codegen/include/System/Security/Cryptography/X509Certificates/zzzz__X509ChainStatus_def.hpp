...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509ChainStatus, "System.Security.Cryptography.X509Certificates", "X509ChainStatus");
...
/// @brief Method GetInformation, addr 0x181df6a80, size 0x150, virtual false, abstract: false, final false
static inline ::StringW GetInformation(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  flags) ;

/// @brief Method .ctor, addr 0x181df6bd0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method set_StatusInformation, addr 0x180378fe0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509ChainStatus) == 0x10, "Size mismatch!");
