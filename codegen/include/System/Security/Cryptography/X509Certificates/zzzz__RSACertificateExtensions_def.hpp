...
public:
// Declarations
/// @brief Method GetRSAPublicKey, addr 0x181af2a50, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::RSACertificateExtensions) == 0x10, "Size mismatch!");
