...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::X509Certificates::X509ChainPolicy*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::X509Certificates::X509ChainPolicy*, "System.Security.Cryptography.X509Certificates", "X509ChainPolicy");
// Dependencies System.DateTime, System.Object, System.Security.Cryptography.X509Certificates.X509RevocationFlag, System.Security.Cryptography.X509Certificates.X509RevocationMode, System.Security.Cryptography.X509Certificates.X509VerificationFlags, System.TimeSpan
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
...
public:
// Declarations
 __declspec(property(get=get_ExtraStore, put=set_ExtraStore)) ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection*  ExtraStore;

 __declspec(property(get=get_RevocationFlag)) ::System::Security::Cryptography::X509Certificates::X509RevocationFlag  RevocationFlag;
 ...
 __declspec(property(get=get_VerificationTime)) ::System::DateTime  VerificationTime;
...
/// @brief Method Reset, addr 0x181df6730, size 0xd0, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x181df6730, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ExtraStore, addr 0x181df6800, size 0x220, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_ExtraStore() ;

/// @brief Method get_RevocationFlag, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509RevocationFlag get_RevocationFlag() ;

/// @brief Method get_RevocationMode, addr 0x180392ff0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509RevocationMode get_RevocationMode() ;

/// @brief Method get_VerificationFlags, addr 0x1803eb0e0, size 0x10, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509VerificationFlags get_VerificationFlags() ;

/// @brief Method get_VerificationTime, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTime get_VerificationTime() ;

/// @brief Method set_ExtraStore, addr 0x1802d9850, size 0x10, virtual false, abstract: false, final false
inline void set_ExtraStore(::System::Security::Cryptography::X509Certificates::X509Certificate2Collection*  value) ;

/// @brief Method set_RevocationMode, addr 0x181df6a20, size 0x30, virtual false, abstract: false, final false
inline void set_RevocationMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode  value) ;

/// @brief Method set_VerificationFlags, addr 0x181df6a50, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::X509Certificates::X509ChainPolicy) == 0x50, "Size mismatch!");
