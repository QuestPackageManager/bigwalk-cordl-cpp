...
public:
// Declarations
/// @brief Method Create, addr 0x18160d230, size 0x40, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* Create() ;

/// @brief Method EncryptValue, addr 0x18160d270, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method FromXmlString, addr 0x18160d2a0, size 0x3f0, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x18160d690, size 0x280, virtual true, abstract: false, final false
