...
/// @brief Method Dispose, addr 0x1816093e0, size 0xb0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method HashCore, addr 0x181609490, size 0x180, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t>  rgbData, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x181609610, size 0x190, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize, addr 0x1816097a0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816097c0, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
