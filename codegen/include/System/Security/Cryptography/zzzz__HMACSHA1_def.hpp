...
static inline ::System::Security::Cryptography::HMACSHA1* New_ctor(::ArrayW<uint8_t>  key) ;

static inline ::System::Security::Cryptography::HMACSHA1* New_ctor(::ArrayW<uint8_t>  key, bool  useManagedSha1) ;

/// @brief Method .ctor, addr 0x181607af0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181607a40, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  key) ;

/// @brief Method .ctor, addr 0x181607a40, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t>  key, bool  useManagedSha1) ;
...
static_assert(sizeof(::System::Security::Cryptography::HMACSHA1) == 0x68, "Size mismatch!");
