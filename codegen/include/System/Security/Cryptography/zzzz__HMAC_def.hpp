...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::HMAC*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::HMAC*, "System.Security.Cryptography", "HMAC");
...
/// @brief Field m_inner, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_inner, put=__cordl_internal_set_m_inner)) ::ArrayW<uint8_t>  m_inner;
...
/// @brief Method Create, addr 0x1816080e0, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HMAC* Create() ;

/// @brief Method Dispose, addr 0x1816081b0, size 0xc0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method HashCore, addr 0x181608270, size 0x130, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t>  rgb, int32_t  ib, int32_t  cb) ;

/// @brief Method HashFinal, addr 0x1816083a0, size 0x360, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize, addr 0x181608900, size 0x50, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeKey, addr 0x181608700, size 0x200, virtual false, abstract: false, final false
inline void InitializeKey(::ArrayW<uint8_t>  key) ;

static inline ::System::Security::Cryptography::HMAC* New_ctor() ;

/// @brief Method UpdateIOPadBuffers, addr 0x181608950, size 0xe0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_inner() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_inner() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_m_outer() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_m_outer() ;
...
constexpr void __cordl_internal_set_m_inner(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set_m_outer(::ArrayW<uint8_t>  value) ;

/// @brief Method .ctor, addr 0x181608a30, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BlockSizeValue, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_BlockSizeValue() ;

/// @brief Method get_Key, addr 0x181608a40, size 0x50, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_BlockSizeValue, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
inline void set_BlockSizeValue(int32_t  value) ;

/// @brief Method set_Key, addr 0x181608a90, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::HMAC) == 0x68, "Size mismatch!");
