...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::SHA384*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::SHA384*, "System.Security.Cryptography", "SHA384");
...
public:
// Declarations
/// @brief Method Create, addr 0x18161af20, size 0x30, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA384* Create() ;

static inline ::System::Security::Cryptography::SHA384* New_ctor() ;

/// @brief Method .ctor, addr 0x18161af50, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::SHA384) == 0x28, "Size mismatch!");
