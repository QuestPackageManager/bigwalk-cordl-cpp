...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::AesTransform*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::AesTransform*, "System.Security.Cryptography", "AesTransform");
...
/// @brief Field Rcon, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Rcon, put=setStaticF_Rcon)) ::ArrayW<uint32_t>  Rcon;

/// @brief Field SBox, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SBox, put=setStaticF_SBox)) ::ArrayW<uint8_t>  SBox;
...
/// @brief Field expandedKey, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_expandedKey, put=__cordl_internal_set_expandedKey)) ::ArrayW<uint32_t>  expandedKey;

/// @brief Field iSBox, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_iSBox, put=setStaticF_iSBox)) ::ArrayW<uint8_t>  iSBox;

/// @brief Field iT0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_iT0, put=setStaticF_iT0)) ::ArrayW<uint32_t>  iT0;

/// @brief Field iT1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_iT1, put=setStaticF_iT1)) ::ArrayW<uint32_t>  iT1;

/// @brief Field iT2, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_iT2, put=setStaticF_iT2)) ::ArrayW<uint32_t>  iT2;

/// @brief Field iT3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_iT3, put=setStaticF_iT3)) ::ArrayW<uint32_t>  iT3;

/// @brief Method Decrypt128, addr 0x181ad9200, size 0x13e0, virtual false, abstract: false, final false
inline void Decrypt128(::ArrayW<uint8_t>  indata, ::ArrayW<uint8_t>  outdata, ::ArrayW<uint32_t>  ekey) ;

/// @brief Method ECB, addr 0x181ada5e0, size 0x30, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method Encrypt128, addr 0x181ada610, size 0x1410, virtual false, abstract: false, final false
...
/// @brief Method SubByte, addr 0x181adba20, size 0x70, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_expandedKey() const;

constexpr ::ArrayW<uint32_t>& __cordl_internal_get_expandedKey() ;
...
/// @brief Method .ctor, addr 0x181adbe30, size 0x610, virtual false, abstract: false, final false
...
static inline ::ArrayW<uint8_t> getStaticF_SBox() ;
...
static inline ::ArrayW<uint8_t> getStaticF_iSBox() ;

static inline ::ArrayW<uint32_t> getStaticF_iT0() ;

static inline ::ArrayW<uint32_t> getStaticF_iT1() ;

static inline ::ArrayW<uint32_t> getStaticF_iT2() ;

static inline ::ArrayW<uint32_t> getStaticF_iT3() ;

static inline void setStaticF_Rcon(::ArrayW<uint32_t>  value) ;

static inline void setStaticF_SBox(::ArrayW<uint8_t>  value) ;
...
static inline void setStaticF_iSBox(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_iT0(::ArrayW<uint32_t>  value) ;

static inline void setStaticF_iT1(::ArrayW<uint32_t>  value) ;

static inline void setStaticF_iT2(::ArrayW<uint32_t>  value) ;

static inline void setStaticF_iT3(::ArrayW<uint32_t>  value) ;
...
static_assert(sizeof(::System::Security::Cryptography::AesTransform) == 0x68, "Size mismatch!");
