...
/// @brief Field IVValue, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_IVValue, put=__cordl_internal_set_IVValue)) ::ArrayW<uint8_t>  IVValue;
...
/// @brief Field LegalBlockSizesValue, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_LegalBlockSizesValue, put=__cordl_internal_set_LegalBlockSizesValue)) ::ArrayW<::System::Security::Cryptography::KeySizes*>  LegalBlockSizesValue;
...
/// @brief Method Clear, addr 0x18161bdd0, size 0x90, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Create, addr 0x18161bf40, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SymmetricAlgorithm* Create(::StringW  algName) ;

/// @brief Method CreateDecryptor, addr 0x18161be60, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method CreateEncryptor, addr 0x18161bed0, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x18161bf90, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method ValidKeySize, addr 0x18161c010, size 0x90, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_IVValue() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_IVValue() ;

constexpr int32_t const& __cordl_internal_get_KeySizeValue() const;

constexpr int32_t& __cordl_internal_get_KeySizeValue() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_KeyValue() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_KeyValue() ;

constexpr ::ArrayW<::System::Security::Cryptography::KeySizes*> const& __cordl_internal_get_LegalBlockSizesValue() const;

constexpr ::ArrayW<::System::Security::Cryptography::KeySizes*>& __cordl_internal_get_LegalBlockSizesValue() ;
...
constexpr void __cordl_internal_set_IVValue(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_LegalBlockSizesValue(::ArrayW<::System::Security::Cryptography::KeySizes*>  value) ;
...
/// @brief Method .ctor, addr 0x18161c0a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BlockSize, addr 0x180303b50, size 0x10, virtual true, abstract: false, final false
inline int32_t get_BlockSize() ;

/// @brief Method get_FeedbackSize, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_FeedbackSize() ;

/// @brief Method get_IV, addr 0x18161c0b0, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_IV() ;

/// @brief Method get_Key, addr 0x18161c120, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_Key() ;

/// @brief Method get_KeySize, addr 0x180392fe0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_LegalKeySizes, addr 0x18161c190, size 0x50, virtual true, abstract: false, final false
inline ::ArrayW<::System::Security::Cryptography::KeySizes*> get_LegalKeySizes() ;

/// @brief Method get_Mode, addr 0x1803231b0, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::CipherMode get_Mode() ;

/// @brief Method get_Padding, addr 0x1803eb0e0, size 0x10, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::PaddingMode get_Padding() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_BlockSize, addr 0x18161c1e0, size 0xf0, virtual true, abstract: false, final false
inline void set_BlockSize(int32_t  value) ;

/// @brief Method set_IV, addr 0x18161c2d0, size 0x110, virtual true, abstract: false, final false
inline void set_IV(::ArrayW<uint8_t>  value) ;

/// @brief Method set_Key, addr 0x18161c470, size 0x120, virtual true, abstract: false, final false
inline void set_Key(::ArrayW<uint8_t>  value) ;

/// @brief Method set_KeySize, addr 0x18161c3e0, size 0x90, virtual true, abstract: false, final false
inline void set_KeySize(int32_t  value) ;

/// @brief Method set_Mode, addr 0x18161c590, size 0x70, virtual true, abstract: false, final false
inline void set_Mode(::System::Security::Cryptography::CipherMode  value) ;

/// @brief Method set_Padding, addr 0x18161c600, size 0x70, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::SymmetricAlgorithm) == 0x48, "Size mismatch!");
