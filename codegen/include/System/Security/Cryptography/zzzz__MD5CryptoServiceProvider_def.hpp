...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::MD5CryptoServiceProvider*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::MD5CryptoServiceProvider*, "System.Security.Cryptography", "MD5CryptoServiceProvider");
...
/// @brief Method AddLength, addr 0x181615040, size 0x70, virtual false, abstract: false, final false
inline void AddLength(uint64_t  length, ::ArrayW<uint8_t>  buffer, int32_t  position) ;

/// @brief Method Dispose, addr 0x1816150b0, size 0x80, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x181615130, size 0x20, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HashCore, addr 0x181615150, size 0x140, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x181615290, size 0x1e0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize, addr 0x181615470, size 0x40, virtual true, abstract: false, final false
inline void Initialize() ;

static inline ::System::Security::Cryptography::MD5CryptoServiceProvider* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x1816154b0, size 0xdf0, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset) ;

/// @brief Method ProcessFinalBlock, addr 0x1816162a0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181616480, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::Security::Cryptography::MD5CryptoServiceProvider) == 0x50, "Size mismatch!");
