...
// Write type traits
MARK_REF_T(::System::Security::Cryptography::HashAlgorithm*);
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::HashAlgorithm*, "System.Security.Cryptography", "HashAlgorithm");
...
/// @brief Field HashValue, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_HashValue, put=__cordl_internal_set_HashValue)) ::ArrayW<uint8_t>  HashValue;
...
/// @brief Method CaptureHashCodeAndReinitialize, addr 0x181608b10, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> CaptureHashCodeAndReinitialize() ;

/// @brief Method Clear, addr 0x181608ba0, size 0x20, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeHash, addr 0x181608d00, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ComputeHash(::ArrayW<uint8_t>  buffer) ;

/// @brief Method ComputeHash, addr 0x181608d90, size 0xe0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ComputeHash(::ArrayW<uint8_t>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ComputeHash, addr 0x181608bc0, size 0x140, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ComputeHash(::System::IO::Stream*  inputStream) ;

/// @brief Method Create, addr 0x181608e70, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181608ec0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method TransformBlock, addr 0x181608ed0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method TransformFinalBlock, addr 0x181608f80, size 0xf0, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t> TransformFinalBlock(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method ValidateTransformBlock, addr 0x181609070, size 0xc0, virtual false, abstract: false, final false
inline void ValidateTransformBlock(::ArrayW<uint8_t>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

constexpr int32_t const& __cordl_internal_get_HashSizeValue() const;

constexpr int32_t& __cordl_internal_get_HashSizeValue() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_HashValue() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_HashValue() ;
...
constexpr void __cordl_internal_set_HashValue(::ArrayW<uint8_t>  value) ;
...
/// @brief Method get_CanReuseTransform, addr 0x1802f6470, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method get_Hash, addr 0x181609130, size 0xd0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method get_HashSize, addr 0x1803924b0, size 0x10, virtual true, abstract: false, final false
inline int32_t get_HashSize() ;

/// @brief Method get_InputBlockSize, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
inline int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize, addr 0x1802edd00, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Security::Cryptography::HashAlgorithm) == 0x28, "Size mismatch!");
