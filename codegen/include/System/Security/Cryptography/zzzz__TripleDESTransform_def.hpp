...
/// @brief Method ECB, addr 0x181632250, size 0xf0, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t>  input, ::ArrayW<uint8_t>  output) ;

/// @brief Method GetStrongKey, addr 0x181632340, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816323b0, size 0x360, virtual false, abstract: false, final false
