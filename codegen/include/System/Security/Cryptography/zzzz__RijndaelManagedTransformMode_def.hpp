...
DEFINE_IL2CPP_CLASS(::System::Security::Cryptography::RijndaelManagedTransformMode, "System.Security.Cryptography", "RijndaelManagedTransformMode");
// Dependencies 
namespace System::Security::Cryptography {
// Is value type: true
...
static_assert(offsetof(::System::Security::Cryptography::RijndaelManagedTransformMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Security::Cryptography::RijndaelManagedTransformMode) == 0x4, "Size mismatch!");
