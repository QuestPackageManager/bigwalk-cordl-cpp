...
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::ValueTuple_2<T1,T2>>(),
...
auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                            ...
                            {::i2c::class_of<::System::ValueTuple_2<T1,T2>>(), 0}
                        )));
...
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::ValueTuple_2<T1,T2>>(),
                        {"Equals", {}, {::i2c::type_of<::System::ValueTuple_2<T1,T2>>()}}
                    )));
...
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::System::ValueTuple_2<T1,T2>>(),
                        {"CompareTo", {}, {::i2c::type_of<::System::ValueTuple_2<T1,T2>>()}}
                    )));
return ::cordl_internals::RunMethodRethrow<int32_t>(*this, ___internal_method, other);
}
template<typename T1,typename T2>
...
auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                            reinterpret_cast<Il2CppObject*>(this)->klass,
                            {::i2c::class_of<::System::ValueTuple_2<T1,T2>>(), 2}
                        )));
...
auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                            reinterpret_cast<Il2CppObject*>(this)->klass,
                            {::i2c::class_of<::System::ValueTuple_2<T1,T2>>(), 3}
                        )));
...
template<typename T1,typename T2>
constexpr ::System::IEquatable_1<::System::ValueTuple_2<T1,T2>>* System::ValueTuple_2<T1,T2>::i___System__IEquatable_1___System__ValueTuple_2_T1_T2__()  {
return static_cast<::System::IEquatable_1<::System::ValueTuple_2<T1,T2>>*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::Collections::IStructuralEquatable* System::ValueTuple_2<T1,T2>::i___System__Collections__IStructuralEquatable()  {
return static_cast<::System::Collections::IStructuralEquatable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::Collections::IStructuralComparable* System::ValueTuple_2<T1,T2>::i___System__Collections__IStructuralComparable()  {
return static_cast<::System::Collections::IStructuralComparable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::IComparable* System::ValueTuple_2<T1,T2>::i___System__IComparable()  {
return static_cast<::System::IComparable*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::IComparable_1<::System::ValueTuple_2<T1,T2>>* System::ValueTuple_2<T1,T2>::i___System__IComparable_1___System__ValueTuple_2_T1_T2__()  {
return static_cast<::System::IComparable_1<::System::ValueTuple_2<T1,T2>>*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::IValueTupleInternal* System::ValueTuple_2<T1,T2>::i___System__IValueTupleInternal()  {
return static_cast<::System::IValueTupleInternal*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
template<typename T1,typename T2>
constexpr ::System::Runtime::CompilerServices::ITuple* System::ValueTuple_2<T1,T2>::i___System__Runtime__CompilerServices__ITuple()  {
return static_cast<::System::Runtime::CompilerServices::ITuple*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
// Ctor Parameters [CppParam { name: "Item1", ty: "T1", modifiers: "", def_value: Some("{}") }, CppParam { name: "Item2", ty: "T2", modifiers: "", def_value: Some("{}") }]
template<typename T1,typename T2>
constexpr ::System::ValueTuple_2<T1,T2>::ValueTuple_2(T1  Item1, T2  Item2) noexcept  {
this->Item1 = Item1;
this->Item2 = Item2;
}
// Ctor Parameters []
template<typename T1,typename T2>
constexpr ::System::ValueTuple_2<T1,T2>::ValueTuple_2()   {
}
