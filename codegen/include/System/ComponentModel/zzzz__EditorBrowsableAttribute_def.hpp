...
/// @brief Method Equals, addr 0x181debeb0, size 0x40, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::ComponentModel::EditorBrowsableAttribute) == 0x18, "Size mismatch!");
