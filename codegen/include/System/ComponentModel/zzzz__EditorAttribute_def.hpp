...
/// @brief Method Equals, addr 0x181dfca90, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181dfcb00, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  baseTypeName) ;

/// @brief Method get_EditorBaseTypeName, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_EditorBaseTypeName() ;

/// @brief Method get_EditorTypeName, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_EditorTypeName() ;

/// @brief Method get_TypeId, addr 0x181dfcb60, size 0xa0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::ComponentModel::EditorAttribute) == 0x28, "Size mismatch!");
