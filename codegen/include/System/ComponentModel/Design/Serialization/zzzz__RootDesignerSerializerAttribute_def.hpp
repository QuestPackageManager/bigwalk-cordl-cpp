...
/// @brief Method .ctor, addr 0x181e1bac0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  serializerTypeName, ::StringW  baseSerializerTypeName, bool  reloadable) ;

/// @brief Method get_SerializerBaseTypeName, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SerializerBaseTypeName() ;

/// @brief Method get_TypeId, addr 0x181e1bb10, size 0xa0, virtual true, abstract: false, final false
