...
/// @brief Method CreateTablesHierarchy, addr 0x181bca3a0, size 0x260, virtual false, abstract: false, final false
inline void CreateTablesHierarchy(::System::Data::DataTable*  dt) ;

/// @brief Method CreateToplevelTables, addr 0x181bca600, size 0x290, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataTable*> CreateToplevelTables() ;

/// @brief Method GetNestedChildRelations, addr 0x181bca890, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method PreserveSpace, addr 0x181bcaab0, size 0x70, virtual false, abstract: false, final false
static inline bool PreserveSpace(::System::Object*  value) ;

/// @brief Method RowHasErrors, addr 0x181bcab20, size 0xc0, virtual false, abstract: false, final false
static inline bool RowHasErrors(::System::Data::DataRow*  row) ;

/// @brief Method Save, addr 0x181bcb010, size 0x610, virtual false, abstract: false, final false
inline void Save(::System::Xml::XmlWriter*  xw, bool  writeSchema) ;

/// @brief Method SaveDiffgramData, addr 0x181bcabe0, size 0x430, virtual false, abstract: false, final false
inline void SaveDiffgramData(::System::Xml::XmlWriter*  xw, ::System::Collections::Hashtable*  rowsOrder) ;

/// @brief Method XmlDataRowWriter, addr 0x181bcb620, size 0xfb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181bcc700, size 0x230, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  ds) ;

/// @brief Method .ctor, addr 0x181bcc5d0, size 0x130, virtual false, abstract: false, final false
