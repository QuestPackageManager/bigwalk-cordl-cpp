...
// Write type traits
MARK_REF_T(::System::Data::Function*);
DEFINE_IL2CPP_CLASS(::System::Data::Function*, "System.Data", "Function");
// Dependencies System.Data.FunctionId, System.Object, System.Type
namespace System::Data {
// Is value type: false
...
/// @brief Field _parameters, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__parameters, put=__cordl_internal_set__parameters)) ::ArrayW<::System::Type*>  _parameters;
...
/// @brief Field s_functionName, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_functionName, put=setStaticF_s_functionName)) ::ArrayW<::StringW>  s_functionName;
...
constexpr ::ArrayW<::System::Type*> const& __cordl_internal_get__parameters() const;

constexpr ::ArrayW<::System::Type*>& __cordl_internal_get__parameters() ;
...
constexpr void __cordl_internal_set__parameters(::ArrayW<::System::Type*>  value) ;

constexpr void __cordl_internal_set__result(::System::Type*  value) ;

/// @brief Method .ctor, addr 0x181b90130, size 0x110, virtual false, abstract: false, final false
...
static inline ::ArrayW<::StringW> getStaticF_s_functionName() ;

static inline void setStaticF_s_functionName(::ArrayW<::StringW>  value) ;
...
/// @brief Field _parameters, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::System::Type*>  ____parameters;
...
static_assert(sizeof(::System::Data::Function) == 0x38, "Size mismatch!");
