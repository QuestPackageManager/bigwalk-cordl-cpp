...
DEFINE_IL2CPP_CLASS(::System::Data::DataError_ColumnError, "System.Data", "DataError/ColumnError");
// Dependencies 
namespace System::Data {
// Is value type: true
...
static_assert(sizeof(::System::Data::DataError_ColumnError) == 0x10, "Size mismatch!");
...
/// @brief Field _errorList, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__errorList, put=__cordl_internal_set__errorList)) ::ArrayW<::System::Data::DataError_ColumnError>  _errorList;
...
/// @brief Method Clear, addr 0x181b83ec0, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Clear, addr 0x181b83e30, size 0x90, virtual false, abstract: false, final false
inline void Clear(::System::Data::DataColumn*  column) ;

/// @brief Method GetColumnError, addr 0x181b83f20, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetColumnError(::System::Data::DataColumn*  column) ;

/// @brief Method GetColumnsInError, addr 0x181b83f80, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> GetColumnsInError() ;

/// @brief Method IndexOf, addr 0x181b84010, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetColumnError, addr 0x181b840e0, size 0x190, virtual false, abstract: false, final false
inline void SetColumnError(::System::Data::DataColumn*  column, ::StringW  error) ;

/// @brief Method SetText, addr 0x181b84270, size 0x30, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Data::DataError_ColumnError> const& __cordl_internal_get__errorList() const;

constexpr ::ArrayW<::System::Data::DataError_ColumnError>& __cordl_internal_get__errorList() ;
...
constexpr void __cordl_internal_set__errorList(::ArrayW<::System::Data::DataError_ColumnError>  value) ;
...
/// @brief Method .ctor, addr 0x181b842a0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  rowError) ;

/// @brief Method get_HasErrors, addr 0x181b84300, size 0x20, virtual false, abstract: false, final false
inline bool get_HasErrors() ;

/// @brief Method get_Text, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method set_Text, addr 0x181b84270, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field _errorList, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Data::DataError_ColumnError>  ____errorList;
