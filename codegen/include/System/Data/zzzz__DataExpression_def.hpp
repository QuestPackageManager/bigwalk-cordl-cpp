...
// Write type traits
MARK_REF_T(::System::Data::DataExpression*);
DEFINE_IL2CPP_CLASS(::System::Data::DataExpression*, "System.Data", "DataExpression");
// Dependencies System.Data.Common.StorageType, System.Data.DataColumn, System.Object
namespace System::Data {
// Is value type: false
...
/// @brief Field _dependency, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__dependency, put=__cordl_internal_set__dependency)) ::ArrayW<::System::Data::DataColumn*>  _dependency;
...
/// @brief Method Bind, addr 0x181b986f0, size 0xe0, virtual false, abstract: false, final false
inline void Bind(::System::Data::DataTable*  table) ;

/// @brief Method DependsOn, addr 0x181b987d0, size 0x30, virtual false, abstract: false, final false
inline bool DependsOn(::System::Data::DataColumn*  column) ;

/// @brief Method Evaluate, addr 0x181b98930, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* Evaluate() ;

/// @brief Method Evaluate, addr 0x181b98800, size 0x130, virtual false, abstract: false, final false
inline ::System::Object* Evaluate(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method GetDependency, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*> GetDependency() ;

/// @brief Method HasLocalAggregate, addr 0x181b98940, size 0x30, virtual false, abstract: false, final false
inline bool HasLocalAggregate() ;

/// @brief Method HasRemoteAggregate, addr 0x181b98970, size 0x30, virtual false, abstract: false, final false
inline bool HasRemoteAggregate() ;

/// @brief Method Invoke, addr 0x181b989a0, size 0x80, virtual true, abstract: false, final true
inline bool Invoke(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method IsTableAggregate, addr 0x181b98a20, size 0x30, virtual false, abstract: false, final false
inline bool IsTableAggregate() ;

/// @brief Method IsUnknown, addr 0x181b98a50, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ToBoolean, addr 0x181b98a60, size 0x190, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Data::DataColumn*> const& __cordl_internal_get__dependency() const;

constexpr ::ArrayW<::System::Data::DataColumn*>& __cordl_internal_get__dependency() ;
...
constexpr void __cordl_internal_set__dependency(::ArrayW<::System::Data::DataColumn*>  value) ;
...
/// @brief Method .ctor, addr 0x181b98bf0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::StringW  expression) ;

/// @brief Method .ctor, addr 0x181b98c10, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::StringW  expression, ::System::Type*  type) ;

/// @brief Method get_Expression, addr 0x181b98f00, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Expression() ;

/// @brief Method get_HasValue, addr 0x1802ed970, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _dependency, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::System::Data::DataColumn*>  ____dependency;
...
static_assert(sizeof(::System::Data::DataExpression) == 0x48, "Size mismatch!");
