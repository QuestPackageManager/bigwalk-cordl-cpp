...
/// @brief Method SetDataTable, addr 0x181b99db0, size 0x20, virtual false, abstract: false, final false
inline void SetDataTable(::System::Data::DataTable*  table) ;

/// @brief Method SetDataViewManager, addr 0x181b87600, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b99dd0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ApplyDefaultSort, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_ApplyDefaultSort() ;

/// @brief Method get_RowFilter, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_RowFilter() ;

/// @brief Method get_RowStateFilter, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline ::System::Data::DataViewRowState get_RowStateFilter() ;

/// @brief Method get_Sort, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
