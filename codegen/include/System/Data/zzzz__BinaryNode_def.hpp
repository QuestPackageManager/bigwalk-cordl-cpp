...
DEFINE_IL2CPP_CLASS(::System::Data::BinaryNode_DataTypePrecedence, "System.Data", "BinaryNode/DataTypePrecedence");
...
static_assert(offsetof(::System::Data::BinaryNode_DataTypePrecedence, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::Data::BinaryNode_DataTypePrecedence) == 0x4, "Size mismatch!");
...
/// @brief Method BinaryCompare, addr 0x181b91ec0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method BinaryCompare, addr 0x181b91ef0, size 0xc00, virtual false, abstract: false, final false
...
/// @brief Method Bind, addr 0x181b92af0, size 0x70, virtual true, abstract: false, final false
inline void Bind(::System::Data::DataTable*  table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>*  list) ;

/// @brief Method DependsOn, addr 0x181b92b60, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method Eval, addr 0x181b96f40, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Eval, addr 0x181b96f00, size 0x40, virtual true, abstract: false, final false
inline ::System::Object* Eval(::ArrayW<int32_t>  recordNos) ;

/// @brief Method Eval, addr 0x181b96f70, size 0x30, virtual true, abstract: false, final false
inline ::System::Object* Eval(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method EvalBinaryOp, addr 0x181b92bc0, size 0x4340, virtual false, abstract: false, final false
...
/// @brief Method GetPrecedence, addr 0x181b97110, size 0x190, virtual false, abstract: false, final false
inline ::System::Data::BinaryNode_DataTypePrecedence GetPrecedence(::System::Data::Common::StorageType  storageType) ;

/// @brief Method GetPrecedenceType, addr 0x181b96fa0, size 0x170, virtual false, abstract: false, final false
static inline ::System::Data::Common::StorageType GetPrecedenceType(::System::Data::BinaryNode_DataTypePrecedence  code) ;

/// @brief Method HasLocalAggregate, addr 0x181b972a0, size 0x50, virtual true, abstract: false, final false
inline bool HasLocalAggregate() ;

/// @brief Method HasRemoteAggregate, addr 0x181b972f0, size 0x50, virtual true, abstract: false, final false
inline bool HasRemoteAggregate() ;

/// @brief Method IsConstant, addr 0x181b97340, size 0x50, virtual true, abstract: false, final false
inline bool IsConstant() ;

/// @brief Method IsMixed, addr 0x181b97410, size 0x70, virtual false, abstract: false, final false
inline bool IsMixed(::System::Data::Common::StorageType  left, ::System::Data::Common::StorageType  right) ;

/// @brief Method IsMixedSql, addr 0x181b97390, size 0x80, virtual false, abstract: false, final false
inline bool IsMixedSql(::System::Data::Common::StorageType  left, ::System::Data::Common::StorageType  right) ;

/// @brief Method IsTableConstant, addr 0x181b97480, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method Optimize, addr 0x181b974d0, size 0x2a0, virtual true, abstract: false, final false
inline ::System::Data::ExpressionNode* Optimize() ;

/// @brief Method ResultSqlType, addr 0x181b97770, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method ResultType, addr 0x181b97b60, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method SetTypeMismatchError, addr 0x181b97df0, size 0x30, virtual false, abstract: false, final false
inline void SetTypeMismatchError(int32_t  op, ::System::Type*  left, ::System::Type*  right) ;

/// @brief Method SqlResultType, addr 0x181b97e20, size 0xf0, virtual false, abstract: false, final false
