...
/// @brief Method Argument, addr 0x181b7a0f0, size 0x80, virtual false, abstract: false, final false
static inline ::System::ArgumentException* Argument(::StringW  error) ;

/// @brief Method ArgumentOutOfRange, addr 0x181bede20, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  message, ::StringW  parameterName) ;

/// @brief Method ArgumentOutOfRange, addr 0x181bedda0, size 0x80, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  parameterName) ;

/// @brief Method InvalidAcceptRejectRule, addr 0x181bedeb0, size 0x30, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidAcceptRejectRule(::System::Data::AcceptRejectRule  value) ;

/// @brief Method InvalidEnumerationValue, addr 0x181bedee0, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidEnumerationValue(::System::Type*  type, int32_t  value) ;

/// @brief Method InvalidMissingSchemaAction, addr 0x181bedf70, size 0x30, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidMissingSchemaAction(::System::Data::MissingSchemaAction  value) ;

/// @brief Method InvalidOperation, addr 0x181b7a570, size 0x80, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* InvalidOperation(::StringW  error) ;

/// @brief Method InvalidRule, addr 0x181bedfa0, size 0x30, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidRule(::System::Data::Rule  value) ;

/// @brief Method InvalidSeekOrigin, addr 0x181bedfd0, size 0x20, virtual false, abstract: false, final false
static inline ::System::Exception* InvalidSeekOrigin(::StringW  parameterName) ;

/// @brief Method IsCatchableExceptionType, addr 0x181bedff0, size 0x110, virtual false, abstract: false, final false
static inline bool IsCatchableExceptionType(::System::Exception*  e) ;

/// @brief Method IsCatchableOrSecurityExceptionType, addr 0x181bee100, size 0xe0, virtual false, abstract: false, final false
static inline bool IsCatchableOrSecurityExceptionType(::System::Exception*  e) ;

/// @brief Method NotSupported, addr 0x181bee1e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method TraceExceptionAsReturnValue, addr 0x181bee260, size 0x60, virtual false, abstract: false, final false
static inline void TraceExceptionAsReturnValue(::System::Exception*  e) ;

/// @brief Method TraceExceptionWithoutRethrow, addr 0x181bee2c0, size 0x60, virtual false, abstract: false, final false
static inline void TraceExceptionWithoutRethrow(::System::Exception*  e) ;

/// @brief Method WrongType, addr 0x181bee320, size 0xc0, virtual false, abstract: false, final false
