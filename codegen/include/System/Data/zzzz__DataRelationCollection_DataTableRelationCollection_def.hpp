...
/// @brief Field RelationPropertyChanged, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_RelationPropertyChanged, put=__cordl_internal_set_RelationPropertyChanged)) ::System::ComponentModel::CollectionChangeEventHandler*  RelationPropertyChanged;
...
/// @brief Method AddCache, addr 0x181b8f850, size 0x40, virtual false, abstract: false, final false
inline void AddCache(::System::Data::DataRelation*  relation) ;

/// @brief Method AddCore, addr 0x181b8f890, size 0xd0, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method EnsureDataSet, addr 0x181b8f960, size 0x30, virtual false, abstract: false, final false
inline void EnsureDataSet() ;

/// @brief Method GetDataSet, addr 0x181b8f990, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method RemoveCache, addr 0x181b8f9c0, size 0xd0, virtual false, abstract: false, final false
inline void RemoveCache(::System::Data::DataRelation*  relation) ;

/// @brief Method RemoveCore, addr 0x181b8fa90, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b8fbe0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, bool  fParentCollection) ;

/// @brief Method add_RelationPropertyChanged, addr 0x181b83470, size 0x80, virtual false, abstract: false, final false
inline void add_RelationPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_Item, addr 0x181b8d4e0, size 0xc0, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x181b8d420, size 0xc0, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x1802e5850, size 0x10, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_RelationPropertyChanged, addr 0x181b83780, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DataRelationCollection_DataTableRelationCollection) == 0x58, "Size mismatch!");
