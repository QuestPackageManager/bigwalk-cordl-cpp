...
// Write type traits
MARK_REF_T(::System::Data::NameNode*);
DEFINE_IL2CPP_CLASS(::System::Data::NameNode*, "System.Data", "NameNode");
...
/// @brief Method Bind, addr 0x181ba17b0, size 0x140, virtual true, abstract: false, final false
inline void Bind(::System::Data::DataTable*  table, ::System::Collections::Generic::List_1<::System::Data::DataColumn*>*  list) ;

/// @brief Method DependsOn, addr 0x181ba18f0, size 0x80, virtual true, abstract: false, final false
inline bool DependsOn(::System::Data::DataColumn*  column) ;

/// @brief Method Eval, addr 0x181ba1650, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Eval, addr 0x181ba1970, size 0xa0, virtual true, abstract: false, final false
inline ::System::Object* Eval(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method HasLocalAggregate, addr 0x181ba1a10, size 0x60, virtual true, abstract: false, final false
inline bool HasLocalAggregate() ;

/// @brief Method HasRemoteAggregate, addr 0x181ba1a70, size 0x60, virtual true, abstract: false, final false
inline bool HasRemoteAggregate() ;

/// @brief Method IsConstant, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final false
inline bool IsConstant() ;

/// @brief Method IsTableConstant, addr 0x181ba1ad0, size 0x60, virtual true, abstract: false, final false
inline bool IsTableConstant() ;

static inline ::System::Data::NameNode* New_ctor(::System::Data::DataTable*  table, ::StringW  name) ;

static inline ::System::Data::NameNode* New_ctor(::System::Data::DataTable*  table, ::ArrayW<char16_t>  text, int32_t  start, int32_t  pos) ;
...
/// @brief Method ParseName, addr 0x181ba1b30, size 0x220, virtual false, abstract: false, final false
static inline ::StringW ParseName(::ArrayW<char16_t>  text, int32_t  start, int32_t  pos) ;
...
/// @brief Method .ctor, addr 0x181ba1d50, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::ArrayW<char16_t>  text, int32_t  start, int32_t  pos) ;

/// @brief Method get_IsSqlColumn, addr 0x181ba1db0, size 0xa0, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Data::NameNode) == 0x30, "Size mismatch!");
