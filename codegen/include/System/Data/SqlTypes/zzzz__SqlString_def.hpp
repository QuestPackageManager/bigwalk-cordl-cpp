...
/// @brief Method Compare, addr 0x181beb020, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method CompareBinary, addr 0x181beabe0, size 0x1c0, virtual false, abstract: false, final false
static inline int32_t CompareBinary(::System::Data::SqlTypes::SqlString  x, ::System::Data::SqlTypes::SqlString  y) ;

/// @brief Method CompareBinary2, addr 0x181beaa90, size 0x150, virtual false, abstract: false, final false
static inline int32_t CompareBinary2(::System::Data::SqlTypes::SqlString  x, ::System::Data::SqlTypes::SqlString  y) ;

/// @brief Method CompareOptionsFromSqlCompareOptions, addr 0x181beada0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x181beaf80, size 0xa0, virtual false, abstract: false, final false
inline int32_t CompareTo(::System::Data::SqlTypes::SqlString  value) ;

/// @brief Method CompareTo, addr 0x181beae40, size 0x140, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  value) ;

/// @brief Method Equals, addr 0x181beb100, size 0x190, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method FBinarySort, addr 0x181beb290, size 0x20, virtual false, abstract: false, final false
inline bool FBinarySort() ;

/// @brief Method GetHashCode, addr 0x181beb2b0, size 0x1d0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetXsdType, addr 0x181bd9f20, size 0x40, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet*  schemaSet) ;

/// @brief Method SetCompareInfo, addr 0x181beb480, size 0x60, virtual false, abstract: false, final false
inline void SetCompareInfo() ;

/// @brief Method StringCompare, addr 0x181beb4e0, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x181beb8e0, size 0xb0, virtual true, abstract: false, final true
inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader*  reader) ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x181beb990, size 0x70, virtual true, abstract: false, final true
inline void System_Xml_Serialization_IXmlSerializable_WriteXml(::System::Xml::XmlWriter*  writer) ;

/// @brief Method ToString, addr 0x181beba00, size 0x20, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateSqlCompareOptions, addr 0x181beba20, size 0x50, virtual false, abstract: false, final false
static inline void ValidateSqlCompareOptions(::System::Data::SqlTypes::SqlCompareOptions  compareOptions) ;

/// @brief Method .ctor, addr 0x181bebce0, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::StringW  data) ;

/// @brief Method .ctor, addr 0x181bebc20, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::StringW  data, int32_t  lcid, ::System::Data::SqlTypes::SqlCompareOptions  compareOptions) ;

/// @brief Method .ctor, addr 0x181bebec0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(bool  fNull) ;

/// @brief Method .ctor, addr 0x181bebde0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_IsNull, addr 0x1818b47c0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Value, addr 0x181bebf20, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method op_Addition, addr 0x181bebf80, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181bec1a0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x181bec250, size 0x60, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_value", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_cmpInfo", ty: "::System::Globalization::CompareInfo*", modifiers: "", def_value: None }, CppParam { name: "m_lcid", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_flag", ty: "::System::Data::SqlTypes::SqlCompareOptions", modifiers: "", def_value: None }, CppParam { name: "m_fNotNull", ty: "bool", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Data::SqlTypes::SqlString) == 0x20, "Size mismatch!");
