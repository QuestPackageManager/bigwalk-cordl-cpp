...
/// @brief Field _rgbBuf, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__rgbBuf, put=__cordl_internal_set__rgbBuf)) ::ArrayW<uint8_t>  _rgbBuf;

/// @brief Field _rgbWorkBuf, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__rgbWorkBuf, put=__cordl_internal_set__rgbWorkBuf)) ::ArrayW<uint8_t>  _rgbWorkBuf;
...
/// @brief Method CopyStreamToBuffer, addr 0x181bd9380, size 0x130, virtual false, abstract: false, final false
inline void CopyStreamToBuffer() ;

/// @brief Method FStream, addr 0x181bd94b0, size 0x10, virtual false, abstract: false, final false
inline bool FStream() ;

/// @brief Method GetXsdType, addr 0x181bc86c0, size 0x40, virtual false, abstract: false, final false
static inline ::System::Xml::XmlQualifiedName* GetXsdType(::System::Xml::Schema::XmlSchemaSet*  schemaSet) ;

static inline ::System::Data::SqlTypes::SqlBytes* New_ctor() ;

static inline ::System::Data::SqlTypes::SqlBytes* New_ctor(::ArrayW<uint8_t>  buffer) ;
...
inline void SetBuffer(::ArrayW<uint8_t>  buffer) ;
...
/// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x181bd9560, size 0x150, virtual true, abstract: false, final true
inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader*  r) ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x181bd96b0, size 0x210, virtual true, abstract: false, final true
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__rgbBuf() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__rgbBuf() ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__rgbWorkBuf() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__rgbWorkBuf() ;
...
constexpr void __cordl_internal_set__rgbBuf(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set__rgbWorkBuf(::ArrayW<uint8_t>  value) ;
...
/// @brief Method .ctor, addr 0x181bd98c0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::SqlTypes::SqlBinary  value) ;

/// @brief Method get_Buffer, addr 0x181bd99d0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method get_Length, addr 0x181bd9b20, size 0x70, virtual false, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Null, addr 0x181bd9b90, size 0x90, virtual false, abstract: false, final false
static inline ::System::Data::SqlTypes::SqlBytes* get_Null() ;

/// @brief Method get_Value, addr 0x181bd9c20, size 0x1d0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::SqlTypes::SqlBytes) == 0x38, "Size mismatch!");
