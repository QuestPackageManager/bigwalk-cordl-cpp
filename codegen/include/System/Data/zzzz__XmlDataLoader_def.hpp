...
// Write type traits
MARK_REF_T(::System::Data::XmlDataLoader*);
DEFINE_IL2CPP_CLASS(::System::Data::XmlDataLoader*, "System.Data", "XmlDataLoader");
...
/// @brief Method AttachRows, addr 0x181bbf940, size 0x160, virtual false, abstract: false, final false
inline void AttachRows(::System::Data::DataRow*  parentRow, ::System::Xml::XmlNode*  parentElement) ;

/// @brief Method CountNonNSAttributes, addr 0x181bbfaa0, size 0x160, virtual false, abstract: false, final false
inline int32_t CountNonNSAttributes(::System::Xml::XmlNode*  node) ;

/// @brief Method FColumnElement, addr 0x181bbfc00, size 0x1f0, virtual false, abstract: false, final false
inline bool FColumnElement(::System::Xml::XmlElement*  e) ;

/// @brief Method FExcludedNamespace, addr 0x181bbfdf0, size 0x70, virtual false, abstract: false, final false
inline bool FExcludedNamespace(::StringW  ns) ;

/// @brief Method FIgnoreNamespace, addr 0x181bbfeb0, size 0xc0, virtual false, abstract: false, final false
inline bool FIgnoreNamespace(::System::Xml::XmlNode*  node) ;

/// @brief Method FIgnoreNamespace, addr 0x181bbfe60, size 0x50, virtual false, abstract: false, final false
inline bool FIgnoreNamespace(::System::Xml::XmlReader*  node) ;

/// @brief Method GetInitialTextFromNodes, addr 0x181bbff70, size 0x250, virtual false, abstract: false, final false
inline ::StringW GetInitialTextFromNodes(::by_ref<::System::Xml::XmlNode*>  n) ;

/// @brief Method GetRowFromElement, addr 0x181bc01c0, size 0x60, virtual false, abstract: false, final false
inline ::System::Data::DataRow* GetRowFromElement(::System::Xml::XmlElement*  e) ;

/// @brief Method GetTextOnlyColumn, addr 0x181bc0220, size 0x90, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* GetTextOnlyColumn(::System::Data::DataRow*  row) ;

/// @brief Method GetValueForTextOnlyColums, addr 0x181bc02b0, size 0x260, virtual false, abstract: false, final false
inline ::StringW GetValueForTextOnlyColums(::System::Xml::XmlNode*  n) ;

/// @brief Method InitNameTable, addr 0x181bc0510, size 0x290, virtual false, abstract: false, final false
inline void InitNameTable() ;

/// @brief Method IsTextLikeNode, addr 0x181bc07a0, size 0x40, virtual false, abstract: false, final false
inline bool IsTextLikeNode(::System::Xml::XmlNodeType  n) ;

/// @brief Method IsTextOnly, addr 0x181bc07e0, size 0x30, virtual false, abstract: false, final false
inline bool IsTextOnly(::System::Data::DataColumn*  c) ;

/// @brief Method LoadColumn, addr 0x181bc0810, size 0x7d0, virtual false, abstract: false, final false
inline void LoadColumn(::System::Data::DataColumn*  column, ::ArrayW<::System::Object*>  foundColumns) ;

/// @brief Method LoadData, addr 0x181bc1240, size 0x310, virtual false, abstract: false, final false
inline void LoadData(::System::Xml::XmlReader*  reader) ;

/// @brief Method LoadData, addr 0x181bc0fe0, size 0x260, virtual false, abstract: false, final false
inline void LoadData(::System::Xml::XmlDocument*  xdoc) ;

/// @brief Method LoadRowData, addr 0x181bc1550, size 0xc40, virtual false, abstract: false, final false
inline void LoadRowData(::System::Data::DataRow*  row, ::System::Xml::XmlElement*  rowElement) ;

/// @brief Method LoadRows, addr 0x181bc2190, size 0x340, virtual false, abstract: false, final false
inline void LoadRows(::System::Data::DataRow*  parentRow, ::System::Xml::XmlNode*  parentElement) ;

/// @brief Method LoadTable, addr 0x181bc24d0, size 0xa60, virtual false, abstract: false, final false
inline void LoadTable(::System::Data::DataTable*  table, bool  isNested) ;

/// @brief Method LoadTopMostTable, addr 0x181bc2f30, size 0x7a0, virtual false, abstract: false, final false
...
/// @brief Method ProcessXsdSchema, addr 0x181bc36d0, size 0x1d0, virtual false, abstract: false, final false
inline bool ProcessXsdSchema() ;

/// @brief Method SetRowValueFromXmlText, addr 0x181bc38a0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181bc38e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataset, bool  IsXdr, bool  ignoreSchema) ;

/// @brief Method .ctor, addr 0x181bc3ad0, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataset, bool  IsXdr, ::System::Xml::XmlElement*  topNode, bool  ignoreSchema) ;

/// @brief Method .ctor, addr 0x181bc3960, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  datatable, bool  IsXdr, bool  ignoreSchema) ;

/// @brief Method .ctor, addr 0x181bc39f0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  datatable, bool  IsXdr, ::System::Xml::XmlElement*  topNode, bool  ignoreSchema) ;

/// @brief Method get_FromInference, addr 0x18165d5a0, size 0x10, virtual false, abstract: false, final false
inline bool get_FromInference() ;

/// @brief Method set_FromInference, addr 0x1817eed40, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Data::XmlDataLoader) == 0xc8, "Size mismatch!");
