...
/// @brief Method CheckConstraint, addr 0x181b81150, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method CheckStateForProperty, addr 0x181b811a0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x181723810, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181b811f0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConstraintName, addr 0x1802d9810, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_ConstraintName() ;

/// @brief Method get_ExtendedProperties, addr 0x181b81240, size 0x50, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_InCollection, addr 0x18037a0f0, size 0x10, virtual true, abstract: false, final false
inline bool get_InCollection() ;

/// @brief Method get_SchemaName, addr 0x181b81290, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get__DataSet, addr 0x1802d97e0, size 0x10, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get__DataSet() ;

/// @brief Method set_ConstraintName, addr 0x181b812d0, size 0x1d0, virtual true, abstract: false, final false
inline void set_ConstraintName(::StringW  value) ;

/// @brief Method set_InCollection, addr 0x181b814a0, size 0x50, virtual true, abstract: false, final false
inline void set_InCollection(bool  value) ;

/// @brief Method set_SchemaName, addr 0x181b814f0, size 0x40, virtual false, abstract: false, final false
