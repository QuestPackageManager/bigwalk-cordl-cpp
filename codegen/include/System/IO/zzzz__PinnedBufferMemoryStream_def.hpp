...
// Write type traits
MARK_REF_T(::System::IO::PinnedBufferMemoryStream*);
DEFINE_IL2CPP_CLASS(::System::IO::PinnedBufferMemoryStream*, "System.IO", "PinnedBufferMemoryStream");
...
/// @brief Field _array, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__array, put=__cordl_internal_set__array)) ::ArrayW<uint8_t>  _array;
...
/// @brief Method Dispose, addr 0x1816d8dd0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method Read, addr 0x1816d8e10, size 0x20, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  buffer) ;

/// @brief Method Write, addr 0x1816d8e30, size 0x20, virtual true, abstract: false, final false
inline void Write(::System::ReadOnlySpan_1<uint8_t>  buffer) ;

constexpr ::ArrayW<uint8_t> const& __cordl_internal_get__array() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get__array() ;
...
constexpr void __cordl_internal_set__array(::ArrayW<uint8_t>  value) ;

constexpr void __cordl_internal_set__pinningHandle(::System::Runtime::InteropServices::GCHandle  value) ;

/// @brief Method .ctor, addr 0x1816d8e50, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::IO::PinnedBufferMemoryStream) == 0x78, "Size mismatch!");
