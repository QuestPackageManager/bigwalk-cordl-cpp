...
DEFINE_IL2CPP_CLASS(::System::IO::Compression::CompressionMode, "System.IO.Compression", "CompressionMode");
// Dependencies 
namespace System::IO::Compression {
// Is value type: true
...
static_assert(offsetof(::System::IO::Compression::CompressionMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::IO::Compression::CompressionMode) == 0x4, "Size mismatch!");
