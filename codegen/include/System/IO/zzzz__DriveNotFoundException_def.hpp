...
// Write type traits
MARK_REF_T(::System::IO::DriveNotFoundException*);
DEFINE_IL2CPP_CLASS(::System::IO::DriveNotFoundException*, "System.IO", "DriveNotFoundException");
...
/// @brief Method .ctor, addr 0x1816d3370, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::IO::DriveNotFoundException) == 0x90, "Size mismatch!");
