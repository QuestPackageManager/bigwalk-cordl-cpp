...
/// @brief Method Dispose, addr 0x1816f33c0, size 0x30, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::System::IO::StringReader* New_ctor(::StringW  s) ;

/// @brief Method Peek, addr 0x1816f33f0, size 0x40, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x1816f37a0, size 0x50, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x1816f3670, size 0x130, virtual true, abstract: false, final false
inline int32_t Read(::by_ref<::ArrayW<char16_t>>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x1816f3430, size 0xf0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x1816f3520, size 0x100, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x1816f3620, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816f37f0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::IO::StringReader) == 0x28, "Size mismatch!");
