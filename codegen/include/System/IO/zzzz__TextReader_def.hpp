...
// Write type traits
MARK_REF_T(::System::IO::TextReader*);
...
DEFINE_IL2CPP_CLASS(::System::IO::TextReader__ReadToEndAsync_d__14, "System.IO", "TextReader/<ReadToEndAsync>d__14");
...
/// @brief Method <ReadAsyncInternal>b__17_0, addr 0x1816e1ae0, size 0xa0, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::IO::TextReader___c) == 0x10, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x1816e1510, size 0x570, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::IO::TextReader__ReadToEndAsync_d__14) == 0x48, "Size mismatch!");
...
/// @brief Method Close, addr 0x1816de000, size 0x30, virtual true, abstract: false, final false
inline void Close() ;
...
/// @brief Method Read, addr 0x1816de770, size 0x110, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read, addr 0x1816de590, size 0x1e0, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadAsync, addr 0x1816de1c0, size 0x150, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsyncInternal, addr 0x1816de030, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method ReadLine, addr 0x1816de310, size 0xf0, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x1816de4a0, size 0xf0, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadToEndAsync, addr 0x1816de400, size 0xa0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsync() ;

/// @brief Method Synchronized, addr 0x1816de880, size 0x70, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::System::IO::TextReader) == 0x18, "Size mismatch!");
