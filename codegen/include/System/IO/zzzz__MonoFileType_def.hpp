...
DEFINE_IL2CPP_CLASS(::System::IO::MonoFileType, "System.IO", "MonoFileType");
// Dependencies 
namespace System::IO {
// Is value type: true
...
static_assert(offsetof(::System::IO::MonoFileType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::IO::MonoFileType) == 0x4, "Size mismatch!");
