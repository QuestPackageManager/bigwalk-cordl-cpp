...
DEFINE_IL2CPP_CLASS(::System::IO::SearchOption, "System.IO", "SearchOption");
// Dependencies 
namespace System::IO {
// Is value type: true
...
/// @brief Field AllDirectories value: I32(1)
static ::System::IO::SearchOption const AllDirectories;

/// @brief Field TopDirectoryOnly value: I32(0)
...
static_assert(offsetof(::System::IO::SearchOption, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::IO::SearchOption) == 0x4, "Size mismatch!");
