...
CORDL_MODULE_EXPORT(EndOfStreamException)
...
// Write type traits
MARK_REF_T(::System::IO::EndOfStreamException*);
DEFINE_IL2CPP_CLASS(::System::IO::EndOfStreamException*, "System.IO", "EndOfStreamException");
...
/// @brief Method .ctor, addr 0x1816d33a0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x181605390, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x1816d33d0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr EndOfStreamException() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "EndOfStreamException", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
EndOfStreamException(EndOfStreamException && ) = delete;
...
static_assert(sizeof(::System::IO::EndOfStreamException) == 0x90, "Size mismatch!");
