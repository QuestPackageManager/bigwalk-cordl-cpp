...
DEFINE_IL2CPP_CLASS(::System::DayOfWeek, "System", "DayOfWeek");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::DayOfWeek, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::DayOfWeek) == 0x4, "Size mismatch!");
