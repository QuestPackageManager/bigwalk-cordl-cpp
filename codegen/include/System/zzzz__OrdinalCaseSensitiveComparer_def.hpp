...
// Write type traits
MARK_REF_T(::System::OrdinalCaseSensitiveComparer*);
DEFINE_IL2CPP_CLASS(::System::OrdinalCaseSensitiveComparer*, "System", "OrdinalCaseSensitiveComparer");
...
/// @brief Method Compare, addr 0x181663a90, size 0x20, virtual true, abstract: false, final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals, addr 0x181663b90, size 0x20, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x181721c80, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method GetObjectData, addr 0x181721cb0, size 0x50, virtual true, abstract: false, final true
...
static_assert(sizeof(::System::OrdinalCaseSensitiveComparer) == 0x18, "Size mismatch!");
