...
// Write type traits
MARK_REF_T(::System::AppDomainUnloadedException*);
DEFINE_IL2CPP_CLASS(::System::AppDomainUnloadedException*, "System", "AppDomainUnloadedException");
...
/// @brief Method .ctor, addr 0x18171d390, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::System::AppDomainUnloadedException) == 0x90, "Size mismatch!");
