...
/// @brief Method Init, addr 0x181dc8680, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncCallback, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncWaitHandle, addr 0x181dc86d0, size 0xd0, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x1802f1be0, size 0x10, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x180503cd0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsCompleted() ;

/// @brief Convert to "::System::IAsyncResult"
constexpr ::System::IAsyncResult* i___System__IAsyncResult() noexcept;

/// @brief Method set_CompletedSynchronously, addr 0x1803cc020, size 0x10, virtual false, abstract: false, final false
inline void set_CompletedSynchronously(bool  value) ;

/// @brief Method set_IsCompleted, addr 0x181dc87a0, size 0xe0, virtual false, abstract: false, final false
