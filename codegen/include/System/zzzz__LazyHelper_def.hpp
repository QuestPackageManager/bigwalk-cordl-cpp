...
// Write type traits
MARK_REF_T(::System::LazyHelper*);
DEFINE_IL2CPP_CLASS(::System::LazyHelper*, "System", "LazyHelper");
...
/// @brief Method Create, addr 0x18170eb20, size 0x110, virtual false, abstract: false, final false
static inline ::System::LazyHelper* Create(::System::Threading::LazyThreadSafetyMode  mode, bool  useDefaultConstructor) ;

/// @brief Method CreateViaDefaultConstructor, addr 0x18170eac0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Object* CreateViaDefaultConstructor(::System::Type*  type) ;

/// @brief Method GetModeFromIsThreadSafe, addr 0x18170ec30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ThrowException, addr 0x18170ec40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18170eda0, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::LazyHelper) == 0x20, "Size mismatch!");
