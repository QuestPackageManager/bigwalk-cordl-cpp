...
DEFINE_IL2CPP_CLASS(::System::TokenType, "System", "TokenType");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::TokenType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::TokenType) == 0x4, "Size mismatch!");
