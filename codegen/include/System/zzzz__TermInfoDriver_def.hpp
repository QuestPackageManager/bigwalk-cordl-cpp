...
// Write type traits
MARK_REF_T(::System::TermInfoDriver*);
DEFINE_IL2CPP_CLASS(::System::TermInfoDriver*, "System", "TermInfoDriver");
// Dependencies System.ConsoleColor, System.Object
namespace System {
// Is value type: false
...
/// @brief Field _consoleColorToAnsiCode, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__consoleColorToAnsiCode, put=setStaticF__consoleColorToAnsiCode)) ::ArrayW<int32_t>  _consoleColorToAnsiCode;
...
/// @brief Field control_characters, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get_control_characters, put=__cordl_internal_set_control_characters)) ::ArrayW<uint8_t>  control_characters;
...
/// @brief Field echobuf, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get_echobuf, put=__cordl_internal_set_echobuf)) ::ArrayW<char16_t>  echobuf;
...
/// @brief Field locations, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_locations, put=setStaticF_locations)) ::ArrayW<::StringW>  locations;
...
/// @brief Field native_terminal_size, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_native_terminal_size, put=setStaticF_native_terminal_size)) int32_t*  native_terminal_size;
...
/// @brief Field terminal_size, offset 0xffffffff, size 0x4 
 __declspec(property(get=getStaticF_terminal_size, put=setStaticF_terminal_size)) int32_t  terminal_size;
...
/// @brief Method AddStringMapping, addr 0x181750db0, size 0x160, virtual false, abstract: false, final false
inline void AddStringMapping(::System::TermInfoStrings  s) ;

/// @brief Method AddToBuffer, addr 0x181750f10, size 0xe0, virtual false, abstract: false, final false
inline void AddToBuffer(int32_t  b) ;

/// @brief Method AdjustBuffer, addr 0x181750ff0, size 0x20, virtual false, abstract: false, final false
inline void AdjustBuffer() ;

/// @brief Method ChangeColor, addr 0x181751010, size 0xf0, virtual false, abstract: false, final false
inline void ChangeColor(::StringW  format, ::System::ConsoleColor  color) ;

/// @brief Method CheckWindowDimensions, addr 0x181751100, size 0xb0, virtual false, abstract: false, final false
inline void CheckWindowDimensions() ;

/// @brief Method Clear, addr 0x1817511b0, size 0x40, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method CreateKeyInfoFromInt, addr 0x1817511f0, size 0x150, virtual false, abstract: false, final false
inline ::System::ConsoleKeyInfo CreateKeyInfoFromInt(int32_t  n, bool  alt) ;

/// @brief Method CreateKeyMap, addr 0x181751340, size 0x25c0, virtual false, abstract: false, final false
inline void CreateKeyMap() ;

/// @brief Method Echo, addr 0x181753940, size 0x140, virtual false, abstract: false, final false
inline void Echo(::System::ConsoleKeyInfo  key) ;

/// @brief Method EchoFlush, addr 0x181753900, size 0x40, virtual false, abstract: false, final false
inline void EchoFlush() ;

/// @brief Method GetCursorPosition, addr 0x181753a80, size 0x240, virtual false, abstract: false, final false
inline void GetCursorPosition() ;

/// @brief Method GetKeyFromBuffer, addr 0x181753cc0, size 0x330, virtual false, abstract: false, final false
inline ::System::Object* GetKeyFromBuffer(bool  cooked) ;

/// @brief Method IncrementX, addr 0x181753ff0, size 0x90, virtual false, abstract: false, final false
inline void IncrementX() ;

/// @brief Method Init, addr 0x181754330, size 0x8e0, virtual true, abstract: false, final true
inline void Init() ;

/// @brief Method InitKeys, addr 0x181754080, size 0x2b0, virtual false, abstract: false, final false
inline void InitKeys() ;

/// @brief Method InputPending, addr 0x181754c10, size 0x20, virtual false, abstract: false, final false
inline bool InputPending() ;

/// @brief Method IsSpecialKey, addr 0x181754c30, size 0x50, virtual false, abstract: false, final false
inline bool IsSpecialKey(char16_t  c) ;

/// @brief Method IsSpecialKey, addr 0x181754c80, size 0x120, virtual false, abstract: false, final false
inline bool IsSpecialKey(::System::ConsoleKeyInfo  key) ;

static inline ::System::TermInfoDriver* New_ctor(::StringW  term) ;

/// @brief Method QueueEcho, addr 0x181754da0, size 0xc0, virtual false, abstract: false, final false
inline void QueueEcho(char16_t  c) ;

/// @brief Method Read, addr 0x181755330, size 0x2e0, virtual false, abstract: false, final false
inline int32_t Read(::by_ref<::ArrayW<char16_t>>  dest, int32_t  index, int32_t  count) ;

/// @brief Method ReadKey, addr 0x181755080, size 0xb0, virtual true, abstract: false, final true
inline ::System::ConsoleKeyInfo ReadKey(bool  intercept) ;

/// @brief Method ReadKeyInternal, addr 0x181754e60, size 0x220, virtual false, abstract: false, final false
inline ::System::ConsoleKeyInfo ReadKeyInternal(::by_ref<bool>  fresh) ;

/// @brief Method ReadLine, addr 0x181755130, size 0x10, virtual true, abstract: false, final true
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x181755140, size 0x10, virtual false, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadUntilConditionInternal, addr 0x181755150, size 0x1e0, virtual false, abstract: false, final false
inline ::StringW ReadUntilConditionInternal(bool  haltOnNewLine) ;

/// @brief Method ResetColor, addr 0x181755610, size 0x50, virtual true, abstract: false, final true
inline void ResetColor() ;

/// @brief Method SearchTerminfo, addr 0x181755660, size 0xf0, virtual false, abstract: false, final false
static inline ::StringW SearchTerminfo(::StringW  term) ;

/// @brief Method SetCursorPosition, addr 0x181755750, size 0x170, virtual true, abstract: false, final true
inline void SetCursorPosition(int32_t  left, int32_t  top) ;

/// @brief Method TryTermInfoDir, addr 0x1817558c0, size 0xe0, virtual false, abstract: false, final false
static inline ::StringW TryTermInfoDir(::StringW  dir, ::StringW  term) ;

/// @brief Method WriteConsole, addr 0x1817559a0, size 0x20, virtual false, abstract: false, final false
inline void WriteConsole(::StringW  str) ;

/// @brief Method WriteSpecialKey, addr 0x1817559c0, size 0x50, virtual false, abstract: false, final false
inline void WriteSpecialKey(char16_t  c) ;

/// @brief Method WriteSpecialKey, addr 0x181755a10, size 0x1b0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_control_characters() const;

constexpr ::ArrayW<uint8_t>& __cordl_internal_get_control_characters() ;
...
constexpr ::ArrayW<char16_t> const& __cordl_internal_get_echobuf() const;

constexpr ::ArrayW<char16_t>& __cordl_internal_get_echobuf() ;
...
constexpr ::System::Object* const& __cordl_internal_get_initLock() const;
...
constexpr ::System::Collections::Hashtable* const& __cordl_internal_get_keymap() const;
...
constexpr ::System::TermInfoReader* const& __cordl_internal_get_reader() const;
...
constexpr ::System::ByteMatcher* const& __cordl_internal_get_rootmap() const;
...
constexpr ::System::IO::StreamReader* const& __cordl_internal_get_stdin() const;

constexpr ::System::IO::StreamReader*& __cordl_internal_get_stdin() ;

constexpr ::System::IO::CStreamWriter* const& __cordl_internal_get_stdout() const;
...
constexpr void __cordl_internal_set_control_characters(::ArrayW<uint8_t>  value) ;
...
constexpr void __cordl_internal_set_echobuf(::ArrayW<char16_t>  value) ;
...
/// @brief Method .ctor, addr 0x181755cc0, size 0x4c0, virtual false, abstract: false, final false
inline void _ctor(::StringW  term) ;

static inline ::ArrayW<int32_t> getStaticF__consoleColorToAnsiCode() ;

static inline ::ArrayW<::StringW> getStaticF_locations() ;

static inline int32_t* getStaticF_native_terminal_size() ;

static inline int32_t getStaticF_terminal_size() ;

/// @brief Method get_Initialized, addr 0x1805fa960, size 0x10, virtual true, abstract: false, final true
inline bool get_Initialized() ;

/// @brief Method get_WindowHeight, addr 0x181756180, size 0x30, virtual true, abstract: false, final true
inline int32_t get_WindowHeight() ;

/// @brief Method get_WindowWidth, addr 0x1817561b0, size 0x30, virtual true, abstract: false, final true
...
static inline void setStaticF__consoleColorToAnsiCode(::ArrayW<int32_t>  value) ;

static inline void setStaticF_locations(::ArrayW<::StringW>  value) ;

static inline void setStaticF_native_terminal_size(int32_t*  value) ;

static inline void setStaticF_terminal_size(int32_t  value) ;

/// @brief Method set_ForegroundColor, addr 0x1817561e0, size 0x110, virtual true, abstract: false, final true
...
/// @brief Field control_characters, offset: 0x108, size: 0x8, def value: None
 ::ArrayW<uint8_t>  ___control_characters;

/// @brief Field echobuf, offset: 0x110, size: 0x8, def value: None
 ::ArrayW<char16_t>  ___echobuf;
...
static_assert(sizeof(::System::TermInfoDriver) == 0x120, "Size mismatch!");
