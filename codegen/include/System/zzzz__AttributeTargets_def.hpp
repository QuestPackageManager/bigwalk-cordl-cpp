...
DEFINE_IL2CPP_CLASS(::System::AttributeTargets, "System", "AttributeTargets");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::AttributeTargets, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::AttributeTargets) == 0x4, "Size mismatch!");
