...
DEFINE_IL2CPP_CLASS(::System::UInt32Enum, "System", "UInt32Enum");
// Dependencies 
namespace System {
// Is value type: true
...
static_assert(offsetof(::System::UInt32Enum, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::System::UInt32Enum) == 0x4, "Size mismatch!");
