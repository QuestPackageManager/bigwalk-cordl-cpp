...
// Write type traits
MARK_REF_T(::System::LocalDataStoreSlot*);
DEFINE_IL2CPP_CLASS(::System::LocalDataStoreSlot*, "System", "LocalDataStoreSlot");
...
/// @brief Method Finalize, addr 0x181739cf0, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181739d20, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::LocalDataStoreMgr*  mgr, int32_t  slot, int64_t  cookie) ;

/// @brief Method get_Cookie, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_Cookie() ;

/// @brief Method get_Manager, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::System::LocalDataStoreMgr* get_Manager() ;

/// @brief Method get_Slot, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::LocalDataStoreSlot) == 0x28, "Size mismatch!");
