...
public:
// Declarations
 __declspec(property(get=get_KeyData)) ::ArrayW<uint8_t>  KeyData;
...
/// @brief Method Compare, addr 0x1816beb50, size 0x180, virtual false, abstract: false, final false
static inline int32_t Compare(::System::Globalization::SortKey*  sortkey1, ::System::Globalization::SortKey*  sortkey2) ;

/// @brief Method Equals, addr 0x1816becd0, size 0x150, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x1816bee20, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Globalization::SortKey* New_ctor() ;

static inline ::System::Globalization::SortKey* New_ctor(int32_t  lcid, ::StringW  source, ::ArrayW<uint8_t>  buffer, ::System::Globalization::CompareOptions  opt, int32_t  lv1Length, int32_t  lv2Length, int32_t  lv3Length, int32_t  kanaSmallLength, int32_t  markTypeLength, int32_t  katakanaLength, int32_t  kanaWidthLength, int32_t  identLength) ;

static inline ::System::Globalization::SortKey* New_ctor(int32_t  lcid, ::StringW  source, ::System::Globalization::CompareOptions  opt) ;

static inline ::System::Globalization::SortKey* New_ctor(::StringW  localeName, ::StringW  str, ::System::Globalization::CompareOptions  options, ::ArrayW<uint8_t>  keyData) ;

/// @brief Method ToString, addr 0x1816bee80, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816bf060, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816bef60, size 0x50, virtual false, abstract: false, final false
inline void _ctor(int32_t  lcid, ::StringW  source, ::ArrayW<uint8_t>  buffer, ::System::Globalization::CompareOptions  opt, int32_t  lv1Length, int32_t  lv2Length, int32_t  lv3Length, int32_t  kanaSmallLength, int32_t  markTypeLength, int32_t  katakanaLength, int32_t  kanaWidthLength, int32_t  identLength) ;

/// @brief Method .ctor, addr 0x1816befb0, size 0xb0, virtual false, abstract: false, final false
...
inline void _ctor(::StringW  localeName, ::StringW  str, ::System::Globalization::CompareOptions  options, ::ArrayW<uint8_t>  keyData) ;

/// @brief Method get_KeyData, addr 0x1802ecc10, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> get_KeyData() ;

/// @brief Method get_OriginalString, addr 0x1802db4a0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::SortKey) == 0x28, "Size mismatch!");
