...
// Write type traits
MARK_REF_T(::System::Globalization::EncodingTable*);
DEFINE_IL2CPP_CLASS(::System::Globalization::EncodingTable*, "System.Globalization", "EncodingTable");
// Dependencies System.Globalization.InternalCodePageDataItem, System.Globalization.InternalEncodingDataItem, System.Object
namespace System::Globalization {
// Is value type: false
...
/// @brief Field codePageDataPtr, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_codePageDataPtr, put=setStaticF_codePageDataPtr)) ::ArrayW<::System::Globalization::InternalCodePageDataItem>  codePageDataPtr;

/// @brief Field encodingDataPtr, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_encodingDataPtr, put=setStaticF_encodingDataPtr)) ::ArrayW<::System::Globalization::InternalEncodingDataItem>  encodingDataPtr;

/// @brief Field hashByCodePage, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_hashByCodePage, put=setStaticF_hashByCodePage)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Globalization::CodePageDataItem*>*  hashByCodePage;
...
/// @brief Method ENC, addr 0x1816b3a50, size 0x40, virtual false, abstract: false, final false
static inline ::System::Globalization::InternalEncodingDataItem ENC(::StringW  name, uint16_t  cp) ;

/// @brief Method GetCodePageDataItem, addr 0x1816b3a90, size 0x230, virtual false, abstract: false, final false
static inline ::System::Globalization::CodePageDataItem* GetCodePageDataItem(int32_t  codepage) ;

/// @brief Method GetCodePageFromName, addr 0x1816b3cc0, size 0x1a0, virtual false, abstract: false, final false
static inline int32_t GetCodePageFromName(::StringW  name) ;

/// @brief Method GetNumEncodingItems, addr 0x1816b3e60, size 0x40, virtual false, abstract: false, final false
static inline int32_t GetNumEncodingItems() ;

/// @brief Method MapCodePageDataItem, addr 0x1816b3ea0, size 0x40, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Globalization::InternalEncodingDataItem> getStaticF_encodingDataPtr() ;
...
/// @brief Method internalGetCodePageFromName, addr 0x1816bd3b0, size 0x2a0, virtual false, abstract: false, final false
...
static inline void setStaticF_encodingDataPtr(::ArrayW<::System::Globalization::InternalEncodingDataItem>  value) ;
...
static_assert(sizeof(::System::Globalization::EncodingTable) == 0x10, "Size mismatch!");
