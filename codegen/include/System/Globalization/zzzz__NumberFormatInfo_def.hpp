...
// Declarations
 ...
 __declspec(property(get=get_CurrencyGroupSizes)) ::ArrayW<int32_t>  CurrencyGroupSizes;
 ...
 __declspec(property(get=get_NumberGroupSeparator)) ::StringW  NumberGroupSeparator;

 __declspec(property(get=get_NumberGroupSizes)) ::ArrayW<int32_t>  NumberGroupSizes;
 ...
 __declspec(property(get=get_PercentGroupSizes)) ::ArrayW<int32_t>  PercentGroupSizes;
...
/// @brief Field currencyGroupSizes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_currencyGroupSizes, put=__cordl_internal_set_currencyGroupSizes)) ::ArrayW<int32_t>  currencyGroupSizes;
...
/// @brief Field nativeDigits, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_nativeDigits, put=__cordl_internal_set_nativeDigits)) ::ArrayW<::StringW>  nativeDigits;
...
/// @brief Field numberGroupSizes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_numberGroupSizes, put=__cordl_internal_set_numberGroupSizes)) ::ArrayW<int32_t>  numberGroupSizes;
...
/// @brief Field percentGroupSizes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_percentGroupSizes, put=__cordl_internal_set_percentGroupSizes)) ::ArrayW<int32_t>  percentGroupSizes;
...
/// @brief Method Clone, addr 0x1816be020, size 0x50, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method GetFormat, addr 0x1816be070, size 0x50, virtual true, abstract: false, final true
inline ::System::Object* GetFormat(::System::Type*  formatType) ;

/// @brief Method GetInstance, addr 0x1816be0c0, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method OnDeserialized, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method OnDeserializing, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method OnSerializing, addr 0x1816be2a0, size 0x90, virtual false, abstract: false, final false
inline void OnSerializing(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method ReadOnly, addr 0x1816be330, size 0x70, virtual false, abstract: false, final false
static inline ::System::Globalization::NumberFormatInfo* ReadOnly(::System::Globalization::NumberFormatInfo*  nfi) ;

/// @brief Method ValidateParseStyleFloatingPoint, addr 0x1816be3a0, size 0x70, virtual false, abstract: false, final false
static inline void ValidateParseStyleFloatingPoint(::System::Globalization::NumberStyles  style) ;

/// @brief Method ValidateParseStyleInteger, addr 0x1816be410, size 0x80, virtual false, abstract: false, final false
static inline void ValidateParseStyleInteger(::System::Globalization::NumberStyles  style) ;

/// @brief Method VerifyWritable, addr 0x1816be490, size 0x40, virtual false, abstract: false, final false
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_currencyGroupSizes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_currencyGroupSizes() ;
...
constexpr ::ArrayW<::StringW> const& __cordl_internal_get_nativeDigits() const;

constexpr ::ArrayW<::StringW>& __cordl_internal_get_nativeDigits() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_numberGroupSizes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_numberGroupSizes() ;
...
constexpr ::ArrayW<int32_t> const& __cordl_internal_get_percentGroupSizes() const;

constexpr ::ArrayW<int32_t>& __cordl_internal_get_percentGroupSizes() ;
...
constexpr void __cordl_internal_set_currencyGroupSizes(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_nativeDigits(::ArrayW<::StringW>  value) ;
...
constexpr void __cordl_internal_set_numberGroupSizes(::ArrayW<int32_t>  value) ;
...
constexpr void __cordl_internal_set_percentGroupSizes(::ArrayW<int32_t>  value) ;
...
/// @brief Method .ctor, addr 0x1816be4d0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816be4e0, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method get_CurrencyDecimalDigits, addr 0x1803b2d80, size 0x10, virtual false, abstract: false, final false
inline int32_t get_CurrencyDecimalDigits() ;

/// @brief Method get_CurrencyDecimalSeparator, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CurrencyDecimalSeparator() ;

/// @brief Method get_CurrencyGroupSeparator, addr 0x1802e58c0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CurrencyGroupSeparator() ;

/// @brief Method get_CurrencyGroupSizes, addr 0x1816be890, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_CurrencyGroupSizes() ;

/// @brief Method get_CurrencyNegativePattern, addr 0x1803b2c60, size 0x10, virtual false, abstract: false, final false
inline int32_t get_CurrencyNegativePattern() ;

/// @brief Method get_CurrencyPositivePattern, addr 0x1803b2d50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_CurrencyPositivePattern() ;

/// @brief Method get_CurrencySymbol, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CurrencySymbol() ;

/// @brief Method get_CurrentInfo, addr 0x1816be8e0, size 0x80, virtual false, abstract: false, final false
static inline ::System::Globalization::NumberFormatInfo* get_CurrentInfo() ;

/// @brief Method get_InvariantInfo, addr 0x1816be960, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Globalization::NumberFormatInfo* get_InvariantInfo() ;

/// @brief Method get_IsReadOnly, addr 0x180352b10, size 0x10, virtual false, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_NaNSymbol, addr 0x1802e5710, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NaNSymbol() ;

/// @brief Method get_NegativeInfinitySymbol, addr 0x1803a74e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NegativeInfinitySymbol() ;

/// @brief Method get_NegativeSign, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NegativeSign() ;

/// @brief Method get_NumberDecimalDigits, addr 0x1803b2c70, size 0x10, virtual false, abstract: false, final false
inline int32_t get_NumberDecimalDigits() ;

/// @brief Method get_NumberDecimalSeparator, addr 0x1802d9800, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NumberDecimalSeparator() ;

/// @brief Method get_NumberGroupSeparator, addr 0x1802e5850, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_NumberGroupSeparator() ;

/// @brief Method get_NumberGroupSizes, addr 0x1816bea20, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_NumberGroupSizes() ;

/// @brief Method get_NumberNegativePattern, addr 0x1816bea70, size 0x10, virtual false, abstract: false, final false
inline int32_t get_NumberNegativePattern() ;

/// @brief Method get_PerMilleSymbol, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PerMilleSymbol() ;

/// @brief Method get_PercentDecimalDigits, addr 0x1805e8f50, size 0x10, virtual false, abstract: false, final false
inline int32_t get_PercentDecimalDigits() ;

/// @brief Method get_PercentDecimalSeparator, addr 0x1802ec4c0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PercentDecimalSeparator() ;

/// @brief Method get_PercentGroupSeparator, addr 0x1802e5800, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PercentGroupSeparator() ;

/// @brief Method get_PercentGroupSizes, addr 0x1816bea80, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_PercentGroupSizes() ;

/// @brief Method get_PercentNegativePattern, addr 0x180cbfa10, size 0x20, virtual false, abstract: false, final false
inline int32_t get_PercentNegativePattern() ;

/// @brief Method get_PercentPositivePattern, addr 0x1813abaa0, size 0x20, virtual false, abstract: false, final false
inline int32_t get_PercentPositivePattern() ;

/// @brief Method get_PercentSymbol, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PercentSymbol() ;

/// @brief Method get_PositiveInfinitySymbol, addr 0x18039fe40, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_PositiveInfinitySymbol() ;

/// @brief Method get_PositiveSign, addr 0x1802d9810, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_NaNSymbol, addr 0x1816bead0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::NumberFormatInfo) == 0xd8, "Size mismatch!");
