...
DEFINE_IL2CPP_CLASS(::System::Globalization::HebrewNumber_HS, "System.Globalization", "HebrewNumber/HS");
DEFINE_IL2CPP_CLASS(::System::Globalization::HebrewNumber_HebrewToken, "System.Globalization", "HebrewNumber/HebrewToken");
DEFINE_IL2CPP_CLASS(::System::Globalization::HebrewNumber*, "System.Globalization", "HebrewNumber");
DEFINE_IL2CPP_CLASS(::System::Globalization::HebrewNumber_HebrewValue, "System.Globalization", "HebrewNumber/HebrewValue");
// Dependencies 
namespace System::Globalization {
// Is value type: true
...
static_assert(offsetof(::System::Globalization::HebrewNumber_HebrewToken, value__) == 0x2, "Offset mismatch!");

static_assert(sizeof(::System::Globalization::HebrewNumber_HebrewToken) == 0x2, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "token", ty: "::System::Globalization::HebrewNumber_HebrewToken", modifiers: "", def_value: None }, CppParam { name: "value", ty: "int16_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::System::Globalization::HebrewNumber_HebrewValue) == 0x4, "Size mismatch!");
...
// Non member Declarations
static_assert(offsetof(::System::Globalization::HebrewNumber_HS, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::System::Globalization::HebrewNumber_HS) == 0x1, "Size mismatch!");
...
/// @brief Field s_hebrewValues, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_hebrewValues, put=setStaticF_s_hebrewValues)) ::ArrayW<::System::Globalization::HebrewNumber_HebrewValue>  s_hebrewValues;
...
/// @brief Method IsDigit, addr 0x1816906c0, size 0x70, virtual false, abstract: false, final false
static inline bool IsDigit(char16_t  ch) ;

/// @brief Method ParseByChar, addr 0x181690730, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x181690840, size 0x270, virtual false, abstract: false, final false
...
static inline ::ArrayW<::System::Globalization::HebrewNumber_HS> getStaticF_s_numberPasingState() ;

static inline void setStaticF_s_hebrewValues(::ArrayW<::System::Globalization::HebrewNumber_HebrewValue>  value) ;

static inline void setStaticF_s_maxHebrewNumberCh(char16_t  value) ;

static inline void setStaticF_s_numberPasingState(::ArrayW<::System::Globalization::HebrewNumber_HS>  value) ;
