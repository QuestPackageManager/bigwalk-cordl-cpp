...
// Write type traits
MARK_REF_T(::System::Globalization::Bootstring*);
DEFINE_IL2CPP_CLASS(::System::Globalization::Bootstring*, "System.Globalization", "Bootstring");
...
/// @brief Method Adapt, addr 0x1816c4ad0, size 0x80, virtual false, abstract: false, final false
inline int32_t Adapt(int32_t  delta, int32_t  numPoints, bool  firstTime) ;

/// @brief Method Decode, addr 0x1816c4b80, size 0x240, virtual false, abstract: false, final false
inline ::StringW Decode(::StringW  s, int32_t  offset) ;

/// @brief Method DecodeDigit, addr 0x1816c4b50, size 0x30, virtual false, abstract: false, final false
inline int32_t DecodeDigit(char16_t  c) ;

/// @brief Method Encode, addr 0x1816c4de0, size 0x3c0, virtual false, abstract: false, final false
inline ::StringW Encode(::StringW  s, int32_t  offset) ;

/// @brief Method EncodeDigit, addr 0x1816c4dc0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816c51a0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::Bootstring) == 0x30, "Size mismatch!");
