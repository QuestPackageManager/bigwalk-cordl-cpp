...
// Write type traits
MARK_REF_T(::System::Globalization::StringInfo*);
DEFINE_IL2CPP_CLASS(::System::Globalization::StringInfo*, "System.Globalization", "StringInfo");
...
/// @brief Method Equals, addr 0x1816bf190, size 0x50, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetCurrentTextElementLen, addr 0x1816bf1e0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method OnDeserialized, addr 0x1816bf2f0, size 0x20, virtual false, abstract: false, final false
inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method OnDeserializing, addr 0x1816bf310, size 0x20, virtual false, abstract: false, final false
inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method ParseCombiningCharacters, addr 0x1816bf330, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1816bf560, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x1816bf500, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_Indexes, addr 0x1816bf5d0, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_Indexes() ;

/// @brief Method get_LengthInTextElements, addr 0x1816bf620, size 0x50, virtual false, abstract: false, final false
inline int32_t get_LengthInTextElements() ;

/// @brief Method get_String, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_String() ;

/// @brief Method set_String, addr 0x1816bf500, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::System::Globalization::StringInfo) == 0x20, "Size mismatch!");
