...
DEFINE_IL2CPP_CLASS(::System::Globalization::CultureData_NumberFormatEntryManaged, "System.Globalization", "CultureData/NumberFormatEntryManaged");
// Dependencies 
namespace System::Globalization {
// Is value type: true
...
static_assert(sizeof(::System::Globalization::CultureData_NumberFormatEntryManaged) == 0x5c, "Size mismatch!");
...
/// @brief Method AbbrevEraNames, addr 0x1816ae2f0, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> AbbrevEraNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedDayNames, addr 0x1816ae310, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> AbbreviatedDayNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedEnglishEraNames, addr 0x1816ae330, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> AbbreviatedEnglishEraNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedGenitiveMonthNames, addr 0x1816ae350, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> AbbreviatedGenitiveMonthNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedMonthNames, addr 0x1816ae370, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> AbbreviatedMonthNames(int32_t  calendarId) ;

/// @brief Method DateSeparator, addr 0x1816ae390, size 0x50, virtual false, abstract: false, final false
inline ::StringW DateSeparator(int32_t  calendarId) ;

/// @brief Method DayNames, addr 0x1816ae3e0, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> DayNames(int32_t  calendarId) ;

/// @brief Method EraNames, addr 0x1816ae400, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> EraNames(int32_t  calendarId) ;

/// @brief Method GenitiveMonthNames, addr 0x1816ae420, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> GenitiveMonthNames(int32_t  calendarId) ;

/// @brief Method GetCalendar, addr 0x1816ae5c0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Globalization::CalendarData* GetCalendar(int32_t  calendarId) ;

/// @brief Method GetCalendarIds, addr 0x1816ae440, size 0x180, virtual false, abstract: false, final false
inline ::ArrayW<::System::Globalization::CalendarId> GetCalendarIds() ;

/// @brief Method GetCultureData, addr 0x1816ae770, size 0x60, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureData* GetCultureData(::StringW  cultureName, bool  useUserOverride) ;

/// @brief Method GetCultureData, addr 0x1816ae680, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetDateSeparator, addr 0x1816ae7d0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW GetDateSeparator(::StringW  format) ;

/// @brief Method GetNFIValues, addr 0x1816ae7e0, size 0x5a0, virtual false, abstract: false, final false
inline void GetNFIValues(::System::Globalization::NumberFormatInfo*  nfi) ;

/// @brief Method GetSeparator, addr 0x1816aed80, size 0x200, virtual false, abstract: false, final false
static inline ::StringW GetSeparator(::StringW  format, ::StringW  timeParts) ;

/// @brief Method IndexOfTimePart, addr 0x1816aef80, size 0xd0, virtual false, abstract: false, final false
static inline int32_t IndexOfTimePart(::StringW  format, int32_t  startIndex, ::StringW  timeParts) ;

/// @brief Method LeapYearMonthNames, addr 0x1816af050, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> LeapYearMonthNames(int32_t  calendarId) ;

/// @brief Method LongDates, addr 0x1816af070, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> LongDates(int32_t  calendarId) ;

/// @brief Method MonthDay, addr 0x1816af090, size 0x20, virtual false, abstract: false, final false
inline ::StringW MonthDay(int32_t  calendarId) ;

/// @brief Method MonthNames, addr 0x1816af0b0, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> MonthNames(int32_t  calendarId) ;

static inline ::System::Globalization::CultureData* New_ctor(::StringW  name) ;

/// @brief Method ReescapeWin32String, addr 0x1802e0ba0, size 0x10, virtual false, abstract: false, final false
static inline ::StringW ReescapeWin32String(::StringW  str) ;

/// @brief Method ReescapeWin32Strings, addr 0x1802e0ba0, size 0x10, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW> ReescapeWin32Strings(::ArrayW<::StringW>  array) ;

/// @brief Method ShortDates, addr 0x1816af0d0, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> ShortDates(int32_t  calendarId) ;

/// @brief Method UnescapeNlsString, addr 0x1816af0f0, size 0x170, virtual false, abstract: false, final false
static inline ::StringW UnescapeNlsString(::StringW  str, int32_t  start, int32_t  end) ;

/// @brief Method YearMonths, addr 0x1816af260, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1802f8080, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method create_group_sizes_array, addr 0x1816af280, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> create_group_sizes_array(int32_t  gs0, int32_t  gs1) ;

/// @brief Method fill_culture_data, addr 0x1816af2f0, size 0x10, virtual false, abstract: false, final false
inline void fill_culture_data(int32_t  datetimeIndex) ;

/// @brief Method fill_number_data, addr 0x1816af300, size 0x10, virtual false, abstract: false, final false
static inline uint8_t* fill_number_data(int32_t  index, ::by_ref<::System::Globalization::CultureData_NumberFormatEntryManaged>  nfe) ;

static inline ::System::Globalization::CultureData* getStaticF_s_Invariant() ;

/// @brief Method get_CalendarIds, addr 0x1816af310, size 0x100, virtual false, abstract: false, final false
inline ::ArrayW<int32_t> get_CalendarIds() ;

/// @brief Method get_CultureName, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_CultureName() ;

/// @brief Method get_IFIRSTDAYOFWEEK, addr 0x180392fe0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_IFIRSTDAYOFWEEK() ;

/// @brief Method get_IFIRSTWEEKOFYEAR, addr 0x1803231b0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_IFIRSTWEEKOFYEAR() ;

/// @brief Method get_Invariant, addr 0x1816af410, size 0x260, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureData* get_Invariant() ;

/// @brief Method get_IsInvariantCulture, addr 0x1816af670, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInvariantCulture() ;

/// @brief Method get_LongTimes, addr 0x180ded9f0, size 0xc370, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_LongTimes() ;

/// @brief Method get_SAM1159, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SAM1159() ;

/// @brief Method get_SCOMPAREINFO, addr 0x18146d2d0, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_SCOMPAREINFO() ;

/// @brief Method get_SISO639LANGNAME, addr 0x1802e0b30, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SISO639LANGNAME() ;

/// @brief Method get_SPM2359, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_SPM2359() ;

/// @brief Method get_STEXTINFO, addr 0x1802e75e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_STEXTINFO() ;

/// @brief Method get_ShortTimes, addr 0x1816af680, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::StringW> get_ShortTimes() ;

/// @brief Method get_TimeSeparator, addr 0x1802d97e0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_TimeSeparator() ;

/// @brief Method get_UseUserOverride, addr 0x1802e75b0, size 0x10, virtual false, abstract: false, final false
inline bool get_UseUserOverride() ;

/// @brief Method idx2string, addr 0x1816af690, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method strlen, addr 0x1816af6f0, size 0x50, virtual false, abstract: false, final false
