...
// Write type traits
MARK_REF_T(::System::AssemblyLoadEventHandler*);
DEFINE_IL2CPP_CLASS(::System::AssemblyLoadEventHandler*, "System", "AssemblyLoadEventHandler");
...
static_assert(sizeof(::System::AssemblyLoadEventHandler) == 0x80, "Size mismatch!");
