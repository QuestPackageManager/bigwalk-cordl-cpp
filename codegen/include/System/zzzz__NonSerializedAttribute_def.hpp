...
// Write type traits
MARK_REF_T(::System::NonSerializedAttribute*);
DEFINE_IL2CPP_CLASS(::System::NonSerializedAttribute*, "System", "NonSerializedAttribute");
...
static_assert(sizeof(::System::NonSerializedAttribute) == 0x10, "Size mismatch!");
