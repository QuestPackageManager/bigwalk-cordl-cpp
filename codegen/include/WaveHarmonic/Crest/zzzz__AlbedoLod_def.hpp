...
// Write type traits
MARK_REF_T(::WaveHarmonic::Crest::AlbedoLod*);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::AlbedoLod*, "WaveHarmonic.Crest", "AlbedoLod");
// Dependencies UnityEngine.Color, WaveHarmonic.Crest.Lod
namespace WaveHarmonic::Crest {
// Is value type: false
// CS Name: WaveHarmonic.Crest.AlbedoLod
class CORDL_TYPE AlbedoLod : public ::WaveHarmonic::Crest::Lod {
public:
// Declarations
...
static inline ::WaveHarmonic::Crest::AlbedoLod* New_ctor() ;

/// @brief Method OnLoad, addr 0x1825502c0, size 0x50, virtual false, abstract: false, final false
static inline void OnLoad() ;

/// @brief Method .ctor, addr 0x1825503c0, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ClearColor, addr 0x1821c80f0, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_ClearColor() ;

/// @brief Method get_GizmoColor, addr 0x182550240, size 0x40, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_GizmoColor() ;

/// @brief Method get_ID, addr 0x1825503f0, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_ID() ;

/// @brief Method get_Inputs, addr 0x182550280, size 0x40, virtual true, abstract: false, final false
inline ::WaveHarmonic::Crest::Utility::SortedList_2<int32_t,::WaveHarmonic::Crest::ILodInput*>* get_Inputs() ;

/// @brief Method get_NeedToReadWriteTextureData, addr 0x1802f1be0, size 0x10, virtual true, abstract: false, final false
inline bool get_NeedToReadWriteTextureData() ;

/// @brief Method get_RequestedTextureFormat, addr 0x182550400, size 0x10, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "", ty: "AlbedoLod", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
AlbedoLod(AlbedoLod && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "AlbedoLod", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
AlbedoLod(AlbedoLod const& ) = delete;
...
static_assert(sizeof(::WaveHarmonic::Crest::AlbedoLod) == 0xa0, "Size mismatch!");
