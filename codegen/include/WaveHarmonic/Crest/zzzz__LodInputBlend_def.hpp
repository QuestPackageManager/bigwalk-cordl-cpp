...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::LodInputBlend);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::LodInputBlend, "WaveHarmonic.Crest", "LodInputBlend");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.LodInputBlend
...
static ::WaveHarmonic::Crest::LodInputBlend const Additive;

/// @brief Field Alpha value: I32(4)
static ::WaveHarmonic::Crest::LodInputBlend const Alpha;

/// @brief Field AlphaClip value: I32(5)
static ::WaveHarmonic::Crest::LodInputBlend const AlphaClip;

/// @brief Field Maximum value: I32(3)
static ::WaveHarmonic::Crest::LodInputBlend const Maximum;

/// @brief Field Minimum value: I32(2)
static ::WaveHarmonic::Crest::LodInputBlend const Minimum;

/// @brief Field Off value: I32(0)
static ::WaveHarmonic::Crest::LodInputBlend const Off;
...
static_assert(offsetof(::WaveHarmonic::Crest::LodInputBlend, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::LodInputBlend) == 0x4, "Size mismatch!");
