...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::Placement);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::Placement, "WaveHarmonic.Crest", "Placement");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.Placement
...
static ::WaveHarmonic::Crest::Placement const Fixed;

/// @brief Field Transform value: I32(1)
static ::WaveHarmonic::Crest::Placement const Transform;

/// @brief Field Viewpoint value: I32(2)
static ::WaveHarmonic::Crest::Placement const Viewpoint;
...
static_assert(offsetof(::WaveHarmonic::Crest::Placement, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::Placement) == 0x4, "Size mismatch!");
