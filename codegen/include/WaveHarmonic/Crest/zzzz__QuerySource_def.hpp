#pragma once
// IWYU pragma private; include "WaveHarmonic/Crest/QuerySource.hpp"
...
// Write type traits
MARK_VAL_T(::WaveHarmonic::Crest::QuerySource);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::QuerySource, "WaveHarmonic.Crest", "QuerySource");
// Dependencies 
namespace WaveHarmonic::Crest {
// Is value type: true
// CS Name: WaveHarmonic.Crest.QuerySource
...
static ::WaveHarmonic::Crest::QuerySource const Transform;

/// @brief Field Viewer value: I32(1)
static ::WaveHarmonic::Crest::QuerySource const Viewer;
...
static_assert(offsetof(::WaveHarmonic::Crest::QuerySource, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::WaveHarmonic::Crest::QuerySource) == 0x4, "Size mismatch!");
