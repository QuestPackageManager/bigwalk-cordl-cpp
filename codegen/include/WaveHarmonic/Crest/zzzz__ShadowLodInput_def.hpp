...
#include <cstdint>
CORDL_MODULE_EXPORT(ShadowLodInput)
...
namespace WaveHarmonic::Crest {
class ShadowLodInput;
}
// Write type traits
MARK_REF_T(::WaveHarmonic::Crest::ShadowLodInput*);
DEFINE_IL2CPP_CLASS(::WaveHarmonic::Crest::ShadowLodInput*, "WaveHarmonic.Crest", "ShadowLodInput");
// Dependencies WaveHarmonic.Crest.LodInput
namespace WaveHarmonic::Crest {
// Is value type: false
// CS Name: WaveHarmonic.Crest.ShadowLodInput
class CORDL_TYPE ShadowLodInput : public ::WaveHarmonic::Crest::LodInput {
public:
// Declarations
...
static inline ::WaveHarmonic::Crest::ShadowLodInput* New_ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr ShadowLodInput() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ShadowLodInput", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ShadowLodInput(ShadowLodInput && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ShadowLodInput", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
ShadowLodInput(ShadowLodInput const& ) = delete;
...
static_assert(sizeof(::WaveHarmonic::Crest::ShadowLodInput) == 0xb0, "Size mismatch!");
