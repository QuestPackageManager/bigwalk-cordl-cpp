...
constexpr  Mirror::RpcMessage::operator ::Mirror::NetworkMessage*()  {
...
constexpr ::Mirror::NetworkMessage* Mirror::RpcMessage::i___Mirror__NetworkMessage()  {
return static_cast<::Mirror::NetworkMessage*>(static_cast<void*>(::i2c::to_object<true>(*this, false)));
}
...
constexpr ::Mirror::RpcMessage::RpcMessage(uint32_t  netId, uint8_t  componentIndex, uint16_t  functionHash, ::System::ArraySegment_1<uint8_t>  payload) noexcept  {
this->netId = netId;
...
// Ctor Parameters []
constexpr ::Mirror::RpcMessage::RpcMessage()   {
}
