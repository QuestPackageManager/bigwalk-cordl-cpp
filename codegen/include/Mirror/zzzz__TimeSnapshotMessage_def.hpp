...
CORDL_MODULE_INIT
#include <cstddef>
CORDL_MODULE_EXPORT(TimeSnapshotMessage)
namespace Mirror {
...
// Write type traits
MARK_VAL_T(::Mirror::TimeSnapshotMessage);
DEFINE_IL2CPP_CLASS(::Mirror::TimeSnapshotMessage, "Mirror", "TimeSnapshotMessage");
// Dependencies 
namespace Mirror {
// Is value type: true
// CS Name: Mirror.TimeSnapshotMessage
#pragma pack(push, 0)
struct CORDL_TYPE TimeSnapshotMessage {
public:
// Declarations
...
static_assert(sizeof(::Mirror::TimeSnapshotMessage) == 0x1, "Size mismatch!");
