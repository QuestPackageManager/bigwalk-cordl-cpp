...
// Write type traits
MARK_REF_T(::Mirror::Examples::CCU::Monster*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::CCU::Monster*, "Mirror.Examples.CCU", "Monster");
// Dependencies Mirror.NetworkBehaviour, UnityEngine.Vector3
namespace Mirror::Examples::CCU {
// Is value type: false
// CS Name: Mirror.Examples.CCU.Monster
class CORDL_TYPE Monster : public ::Mirror::NetworkBehaviour {
public:
// Declarations
...
/// @brief Field tf, offset 0x90, size 0x8 
...
static inline ::Mirror::Examples::CCU::Monster* New_ctor() ;

/// @brief Method OnStartServer, addr 0x18155d900, size 0x60, virtual true, abstract: false, final false
inline void OnStartServer() ;

/// @brief Method Update, addr 0x18155d960, size 0x340, virtual false, abstract: false, final false
inline void Update() ;
...
// Ctor Parameters [CppParam { name: "", ty: "Monster", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
Monster(Monster && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "Monster", modifiers: "const&", def_value: None }]
...
/// @brief Field tf, offset: 0x90, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Transform>  ___tf;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___speed) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___movementProbability) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___movementDistance) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___moving) == 0x74, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___start) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___destination) == 0x84, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::CCU::Monster, ___tf) == 0x90, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::CCU::Monster) == 0x98, "Size mismatch!");
