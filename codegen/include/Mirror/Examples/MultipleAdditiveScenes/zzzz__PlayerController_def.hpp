...
// Write type traits
MARK_VAL_T(::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState);
MARK_REF_T(::Mirror::Examples::MultipleAdditiveScenes::PlayerController*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState, "Mirror.Examples.MultipleAdditiveScenes", "PlayerController/GroundState");
DEFINE_IL2CPP_CLASS(::Mirror::Examples::MultipleAdditiveScenes::PlayerController*, "Mirror.Examples.MultipleAdditiveScenes", "PlayerController");
// Dependencies 
namespace Mirror::Examples::MultipleAdditiveScenes {
// Is value type: true
// CS Name: Mirror.Examples.MultipleAdditiveScenes.PlayerController/GroundState
...
static ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState const Falling;

/// @brief Field Grounded value: U8(2)
static ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState const Grounded;

/// @brief Field Jumping value: U8(0)
static ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState const Jumping;
...
static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState) == 0x1, "Size mismatch!");

} // namespace end def Mirror::Examples::MultipleAdditiveScenes
// Dependencies Mirror.Examples.MultipleAdditiveScenes.PlayerController::GroundState, Mirror.NetworkBehaviour, UnityEngine.Vector3, UnityEngine.Vector3Int
namespace Mirror::Examples::MultipleAdditiveScenes {
// Is value type: false
// CS Name: Mirror.Examples.MultipleAdditiveScenes.PlayerController
class CORDL_TYPE PlayerController : public ::Mirror::NetworkBehaviour {
public:
// Declarations
using GroundState = ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState;
...
/// @brief Field groundState, offset 0x88, size 0x1 
 __declspec(property(get=__cordl_internal_get_groundState, put=__cordl_internal_set_groundState)) ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState  groundState;
...
static inline ::Mirror::Examples::MultipleAdditiveScenes::PlayerController* New_ctor() ;
...
constexpr ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState const& __cordl_internal_get_groundState() const;

constexpr ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState& __cordl_internal_get_groundState() ;
...
constexpr void __cordl_internal_set_groundState(::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState  value) ;
...
/// @brief Field groundState, offset: 0x88, size: 0x1, def value: None
 ::Mirror::Examples::MultipleAdditiveScenes::PlayerController_GroundState  ___groundState;
...
// Non member Declarations
static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___characterController) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___moveSpeedMultiplier) == 0x70, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___maxTurnSpeed) == 0x74, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___turnDelta) == 0x78, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___initialJumpSpeed) == 0x7c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___maxJumpSpeed) == 0x80, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___jumpDelta) == 0x84, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___groundState) == 0x88, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___horizontal) == 0x8c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___vertical) == 0x90, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___turnSpeed) == 0x94, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___jumpSpeed) == 0x98, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___animVelocity) == 0x9c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___animRotation) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___velocity) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController, ___direction) == 0xb0, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::MultipleAdditiveScenes::PlayerController) == 0xc0, "Size mismatch!");
