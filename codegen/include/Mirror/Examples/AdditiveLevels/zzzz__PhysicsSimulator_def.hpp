...
// Write type traits
MARK_REF_T(::Mirror::Examples::AdditiveLevels::PhysicsSimulator*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::AdditiveLevels::PhysicsSimulator*, "Mirror.Examples.AdditiveLevels", "PhysicsSimulator");
// Dependencies UnityEngine.MonoBehaviour, UnityEngine.PhysicsScene, UnityEngine.PhysicsScene2D
namespace Mirror::Examples::AdditiveLevels {
// Is value type: false
// CS Name: Mirror.Examples.AdditiveLevels.PhysicsSimulator
...
static inline ::Mirror::Examples::AdditiveLevels::PhysicsSimulator* New_ctor() ;
...
static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PhysicsSimulator, ___physicsScene) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PhysicsSimulator, ___physicsScene2D) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PhysicsSimulator, ___simulatePhysicsScene) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::PhysicsSimulator, ___simulatePhysicsScene2D) == 0x2d, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::AdditiveLevels::PhysicsSimulator) == 0x30, "Size mismatch!");
