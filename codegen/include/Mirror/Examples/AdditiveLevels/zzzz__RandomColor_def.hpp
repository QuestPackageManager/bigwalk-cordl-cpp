...
// Write type traits
MARK_REF_T(::Mirror::Examples::AdditiveLevels::RandomColor*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::AdditiveLevels::RandomColor*, "Mirror.Examples.AdditiveLevels", "RandomColor");
// Dependencies Mirror.NetworkBehaviour, UnityEngine.Color32
namespace Mirror::Examples::AdditiveLevels {
// Is value type: false
// CS Name: Mirror.Examples.AdditiveLevels.RandomColor
...
/// @brief Method DeserializeSyncVars, addr 0x18156b0e0, size 0xd0, virtual true, abstract: false, final false
inline void DeserializeSyncVars(::Mirror::NetworkReader*  reader, bool  initialState) ;

/// @brief Method MirrorProcessed, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void MirrorProcessed() ;

static inline ::Mirror::Examples::AdditiveLevels::RandomColor* New_ctor() ;

/// @brief Method OnDestroy, addr 0x181562790, size 0x10, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnStartServer, addr 0x18156b280, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method set_Networkcolor, addr 0x18156b510, size 0x70, virtual false, abstract: false, final false
...
static_assert(offsetof(::Mirror::Examples::AdditiveLevels::RandomColor, ___color) == 0x68, "Offset mismatch!");

static_assert(offsetof(::Mirror::Examples::AdditiveLevels::RandomColor, ___cachedMaterial) == 0x70, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::AdditiveLevels::RandomColor) == 0x78, "Size mismatch!");
