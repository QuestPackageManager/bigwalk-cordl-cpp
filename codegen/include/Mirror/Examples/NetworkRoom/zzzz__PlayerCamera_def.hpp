...
// Write type traits
MARK_REF_T(::Mirror::Examples::NetworkRoom::PlayerCamera*);
DEFINE_IL2CPP_CLASS(::Mirror::Examples::NetworkRoom::PlayerCamera*, "Mirror.Examples.NetworkRoom", "PlayerCamera");
// Dependencies Mirror.NetworkBehaviour
namespace Mirror::Examples::NetworkRoom {
// Is value type: false
// CS Name: Mirror.Examples.NetworkRoom.PlayerCamera
...
static inline ::Mirror::Examples::NetworkRoom::PlayerCamera* New_ctor() ;
...
static_assert(offsetof(::Mirror::Examples::NetworkRoom::PlayerCamera, ___mainCam) == 0x68, "Offset mismatch!");

static_assert(sizeof(::Mirror::Examples::NetworkRoom::PlayerCamera) == 0x70, "Size mismatch!");
