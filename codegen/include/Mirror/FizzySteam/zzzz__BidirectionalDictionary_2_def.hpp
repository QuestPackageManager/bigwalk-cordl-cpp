...
// Write type traits
MARK_GEN_REF_T_PTR(::Mirror::FizzySteam::BidirectionalDictionary_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Mirror::FizzySteam::BidirectionalDictionary_2, "Mirror.FizzySteam", "BidirectionalDictionary`2");
// Dependencies System.Object
namespace Mirror::FizzySteam {
// cpp template
template<typename T1,typename T2>
// Is value type: false
// CS Name: Mirror.FizzySteam.BidirectionalDictionary`2<T1,T2>
...
static inline ::Mirror::FizzySteam::BidirectionalDictionary_2<T1,T2>* New_ctor() ;
