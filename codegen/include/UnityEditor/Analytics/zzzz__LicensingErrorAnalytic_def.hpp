...
/// @brief Method CreateLicensingErrorAnalytic, addr 0x182546ea0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182546ef0, size 0x270, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::LicensingErrorAnalytic) == 0x58, "Size mismatch!");
