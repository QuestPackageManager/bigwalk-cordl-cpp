...
public:
// Declarations
/// @brief Method CreatePackageManagerTestAnalytic, addr 0x182547e60, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182547eb0, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::PackageManagerTestAnalytic) == 0x60, "Size mismatch!");
