...
// Write type traits
MARK_REF_T(::UnityEditor::Analytics::CollabOperationAnalytic*);
DEFINE_IL2CPP_CLASS(::UnityEditor::Analytics::CollabOperationAnalytic*, "UnityEditor.Analytics", "CollabOperationAnalytic");
...
/// @brief Method CreateCollabOperationAnalytic, addr 0x182546c50, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182546ca0, size 0x200, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::CollabOperationAnalytic) == 0x58, "Size mismatch!");
