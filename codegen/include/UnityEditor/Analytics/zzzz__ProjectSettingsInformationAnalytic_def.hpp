...
/// @brief Method CreateProjectSettingsInformationAnalytic, addr 0x182547ef0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182547f40, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
