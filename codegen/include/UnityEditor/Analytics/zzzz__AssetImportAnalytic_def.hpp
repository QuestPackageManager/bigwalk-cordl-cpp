...
// Write type traits
MARK_REF_T(::UnityEditor::Analytics::AssetImportAnalytic*);
DEFINE_IL2CPP_CLASS(::UnityEditor::Analytics::AssetImportAnalytic*, "UnityEditor.Analytics", "AssetImportAnalytic");
...
/// @brief Method CreateAssetImportAnalytic, addr 0x1825467f0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182546840, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::AssetImportAnalytic) == 0x40, "Size mismatch!");
