...
public:
// Declarations
/// @brief Method CreatePackageManagerRemovePackageAnalytic, addr 0x182547930, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182547980, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
