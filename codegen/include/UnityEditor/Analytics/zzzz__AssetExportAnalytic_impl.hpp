...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEditor::Analytics::AssetExportAnalytic::*)()>(&::UnityEditor::Analytics::AssetExportAnalytic::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x182546780;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEditor::Analytics::AssetExportAnalytic*>(),
                        {".ctor", {}, {}}
                    )));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEditor::Analytics::AssetExportAnalytic* (*)()>(&::UnityEditor::Analytics::AssetExportAnalytic::CreateAssetExportAnalytic)> {
  ...
  constexpr static std::size_t addrs = 0x182546730;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::UnityEditor::Analytics::AssetExportAnalytic*>(),
                        {"CreateAssetExportAnalytic", {}, {}}
                    )));
    return ___internal_method;
  }
};
...
constexpr ::ArrayW<::StringW>& UnityEditor::Analytics::AssetExportAnalytic::__cordl_internal_get_asset_extensions()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___asset_extensions;
}
constexpr ::ArrayW<::StringW> const& UnityEditor::Analytics::AssetExportAnalytic::__cordl_internal_get_asset_extensions() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___asset_extensions;
}
constexpr void UnityEditor::Analytics::AssetExportAnalytic::__cordl_internal_set_asset_extensions(::ArrayW<::StringW>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___asset_extensions = value;
}
...
return ::cordl_internals::RunMethodRethrow<::UnityEditor::Analytics::AssetExportAnalytic*>(nullptr, ___internal_method);
}
inline ::UnityEditor::Analytics::AssetExportAnalytic* UnityEditor::Analytics::AssetExportAnalytic::New_ctor()  {
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEditor::Analytics::AssetExportAnalytic*>());
}
// Ctor Parameters []
