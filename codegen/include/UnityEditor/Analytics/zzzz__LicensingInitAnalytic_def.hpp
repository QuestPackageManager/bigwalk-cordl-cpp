...
/// @brief Method CreateLicensingInitAnalytic, addr 0x182547160, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1825471b0, size 0x280, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::LicensingInitAnalytic) == 0x68, "Size mismatch!");
