...
/// @brief Method CreatePackageManagerResolveErrorPackageAnalytic, addr 0x182547a50, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182547aa0, size 0x270, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::PackageManagerResolveErrorPackageAnalytic) == 0x70, "Size mismatch!");
