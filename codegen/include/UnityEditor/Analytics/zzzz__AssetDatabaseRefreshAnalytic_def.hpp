...
/// @brief Method CreateAssetDatabaseRefreshAnalytic, addr 0x182546420, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x182546470, size 0x2c0, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(sizeof(::UnityEditor::Analytics::AssetDatabaseRefreshAnalytic) == 0xd8, "Size mismatch!");
