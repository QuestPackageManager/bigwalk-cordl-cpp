...
/// @brief Method .ctor, addr 0x182547870, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEditor::Analytics::PackageManagerBaseAnalytic) == 0x60, "Size mismatch!");
