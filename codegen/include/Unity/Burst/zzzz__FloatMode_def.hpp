...
DEFINE_IL2CPP_CLASS(::Unity::Burst::FloatMode, "Unity.Burst", "FloatMode");
// Dependencies 
namespace Unity::Burst {
// Is value type: true
...
static_assert(offsetof(::Unity::Burst::FloatMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Burst::FloatMode) == 0x4, "Size mismatch!");
