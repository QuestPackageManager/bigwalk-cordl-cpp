...
DEFINE_IL2CPP_CLASS(::Unity::Burst::OptimizeFor, "Unity.Burst", "OptimizeFor");
// Dependencies 
namespace Unity::Burst {
// Is value type: true
...
static_assert(offsetof(::Unity::Burst::OptimizeFor, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Burst::OptimizeFor) == 0x4, "Size mismatch!");
