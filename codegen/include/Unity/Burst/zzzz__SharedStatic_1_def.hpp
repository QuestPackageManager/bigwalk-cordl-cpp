...
static inline ::Unity::Burst::SharedStatic_1<T> GetOrCreatePartiallyUnsafeWithHashCode(uint32_t  alignment, int64_t  hashCode) ;
...
template<typename TContext>
static inline ::Unity::Burst::SharedStatic_1<T> GetOrCreatePartiallyUnsafeWithSubHashCode(uint32_t  alignment, int64_t  subHashCode) ;
