...
static inline void ExpectAliased(::by_ref<A>  a, ::by_ref<B>  b) ;

/// @brief Method ExpectAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename A>
static inline void ExpectAliased(::by_ref<A>  a, void*  b) ;

/// @brief Method ExpectAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename B>
static inline void ExpectAliased(void*  a, ::by_ref<B>  b) ;

/// @brief Method ExpectAliased, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
template<typename A,typename B>
static inline void ExpectNotAliased(::by_ref<A>  a, ::by_ref<B>  b) ;

/// @brief Method ExpectNotAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename A>
static inline void ExpectNotAliased(::by_ref<A>  a, void*  b) ;

/// @brief Method ExpectNotAliased, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename B>
static inline void ExpectNotAliased(void*  a, ::by_ref<B>  b) ;

/// @brief Method ExpectNotAliased, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
