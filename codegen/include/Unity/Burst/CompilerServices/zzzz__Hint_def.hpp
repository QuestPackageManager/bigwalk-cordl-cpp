...
public:
// Declarations
/// @brief Method Assume, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
static inline void Assume(bool  condition) ;

/// @brief Method Likely, addr 0x1805ed850, size 0x10, virtual false, abstract: false, final false
static inline bool Likely(bool  condition) ;

/// @brief Method Unlikely, addr 0x1805ed850, size 0x10, virtual false, abstract: false, final false
