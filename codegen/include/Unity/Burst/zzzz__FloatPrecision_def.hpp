...
DEFINE_IL2CPP_CLASS(::Unity::Burst::FloatPrecision, "Unity.Burst", "FloatPrecision");
// Dependencies 
namespace Unity::Burst {
// Is value type: true
...
static_assert(offsetof(::Unity::Burst::FloatPrecision, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Burst::FloatPrecision) == 0x4, "Size mismatch!");
