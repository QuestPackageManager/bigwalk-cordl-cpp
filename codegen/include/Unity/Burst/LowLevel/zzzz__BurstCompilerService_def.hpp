...
DEFINE_IL2CPP_CLASS(::Unity::Burst::LowLevel::BurstCompilerService_BurstLogType, "Unity.Burst.LowLevel", "BurstCompilerService/BurstLogType");
...
static_assert(offsetof(::Unity::Burst::LowLevel::BurstCompilerService_BurstLogType, value__) == 0x4, "Offset mismatch!");
...
/// @brief Method CompileAsyncDelegateMethod, addr 0x182240a50, size 0x120, virtual false, abstract: false, final false
static inline int32_t CompileAsyncDelegateMethod(::System::Object*  delegateMethod, ::StringW  compilerOptions) ;

/// @brief Method CompileAsyncDelegateMethod_Injected, addr 0x182240a40, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method GetAsyncCompiledAsyncDelegateMethod, addr 0x182240b70, size 0x10, virtual false, abstract: false, final false
static inline void* GetAsyncCompiledAsyncDelegateMethod(int32_t  userID) ;

/// @brief Method GetCurrentExecutionMode, addr 0x182240b80, size 0x10, virtual false, abstract: false, final false
static inline uint32_t GetCurrentExecutionMode() ;

/// @brief Method GetDisassembly, addr 0x182240ba0, size 0x150, virtual false, abstract: false, final false
static inline ::StringW GetDisassembly(::System::Reflection::MethodInfo*  m, ::StringW  compilerOptions) ;

/// @brief Method GetDisassembly_Injected, addr 0x182240b90, size 0x10, virtual false, abstract: false, final false
static inline void GetDisassembly_Injected(::System::Reflection::MethodInfo*  m, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  compilerOptions, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  ret) ;

/// @brief Method GetOrCreateSharedMemory, addr 0x182240cf0, size 0x10, virtual false, abstract: false, final false
static inline void* GetOrCreateSharedMemory(::by_ref<::UnityEngine::Hash128>  key, uint32_t  size_of, uint32_t  alignment) ;

/// @brief Method LoadBurstLibrary, addr 0x182240d10, size 0x110, virtual false, abstract: false, final false
static inline bool LoadBurstLibrary(::StringW  fullPathToLibBurstGenerated) ;

/// @brief Method LoadBurstLibrary_Injected, addr 0x182240d00, size 0x10, virtual false, abstract: false, final false
static inline bool LoadBurstLibrary_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper>  fullPathToLibBurstGenerated) ;

/// @brief Method Log, addr 0x182240e20, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method RuntimeLog, addr 0x182240e30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method SetCurrentExecutionMode, addr 0x182240e40, size 0x10, virtual false, abstract: false, final false
