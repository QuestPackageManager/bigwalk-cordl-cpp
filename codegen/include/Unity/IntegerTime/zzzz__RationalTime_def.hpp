...
DEFINE_IL2CPP_CLASS(::Unity::IntegerTime::RationalTime_TicksPerSecond, "Unity.IntegerTime", "RationalTime/TicksPerSecond");
// Dependencies 
namespace Unity::IntegerTime {
// Is value type: true
...
/// @brief Method Equals, addr 0x18224c260, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method Gcd, addr 0x18224c2e0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Simplify, addr 0x18224c330, size 0x60, virtual false, abstract: false, final false
static inline void Simplify(::by_ref<uint32_t>  num, ::by_ref<uint32_t>  den) ;

/// @brief Method .ctor, addr 0x18224c6b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline int64_t get_Count() ;

/// @brief Method op_Explicit, addr 0x182249d50, size 0x100, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Count", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "m_TicksPerSecond", ty: "::Unity::IntegerTime::RationalTime_TicksPerSecond", modifiers: "", def_value: None }]
