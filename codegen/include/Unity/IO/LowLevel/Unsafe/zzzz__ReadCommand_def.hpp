...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::ReadCommand, "Unity.IO.LowLevel.Unsafe", "ReadCommand");
// Dependencies 
namespace Unity::IO::LowLevel::Unsafe {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "Buffer", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "Offset", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "Size", ty: "int64_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::ReadCommand) == 0x18, "Size mismatch!");
