...
DEFINE_IL2CPP_CLASS(::Unity::IO::LowLevel::Unsafe::FileInfoResult, "Unity.IO.LowLevel.Unsafe", "FileInfoResult");
...
static_assert(sizeof(::Unity::IO::LowLevel::Unsafe::FileInfoResult) == 0x10, "Size mismatch!");
