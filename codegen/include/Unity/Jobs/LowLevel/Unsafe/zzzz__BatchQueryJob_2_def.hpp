...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Jobs::LowLevel::Unsafe::BatchQueryJob_2, "Unity.Jobs.LowLevel.Unsafe", "BatchQueryJob`2");
...
// Ctor Parameters [CppParam { name: "commands", ty: "::Unity::Collections::NativeArray_1<CommandT>", modifiers: "", def_value: None }, CppParam { name: "results", ty: "::Unity::Collections::NativeArray_1<ResultT>", modifiers: "", def_value: None }]
