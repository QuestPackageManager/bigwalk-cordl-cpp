...
DEFINE_IL2CPP_CLASS(::Unity::Jobs::LowLevel::Unsafe::ScheduleMode, "Unity.Jobs.LowLevel.Unsafe", "ScheduleMode");
// Dependencies 
namespace Unity::Jobs::LowLevel::Unsafe {
// Is value type: true
...
static_assert(offsetof(::Unity::Jobs::LowLevel::Unsafe::ScheduleMode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Jobs::LowLevel::Unsafe::ScheduleMode) == 0x4, "Size mismatch!");
