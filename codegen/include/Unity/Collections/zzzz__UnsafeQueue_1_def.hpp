...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::UnsafeQueue_1_Enumerator, "Unity.Collections", "UnsafeQueue`1/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::UnsafeQueue_1_ParallelWriter, "Unity.Collections", "UnsafeQueue`1/ParallelWriter");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::UnsafeQueue_1_ReadOnly, "Unity.Collections", "UnsafeQueue`1/ReadOnly");
// Dependencies 
namespace Unity::Collections {
// cpp template
template<typename T>
...
// Ctor Parameters [CppParam { name: "m_FirstBlock", ty: "::Unity::Collections::UnsafeQueueBlockHeader*", modifiers: "", def_value: None }, CppParam { name: "m_Block", ty: "::Unity::Collections::UnsafeQueueBlockHeader*", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "value", ty: "T", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::UnsafeQueueData*", modifiers: "", def_value: None }, CppParam { name: "m_AllocatorLabel", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "m_ThreadIndex", ty: "int32_t", modifiers: "", def_value: None }]
