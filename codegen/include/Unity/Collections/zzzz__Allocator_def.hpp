...
DEFINE_IL2CPP_CLASS(::Unity::Collections::Allocator, "Unity.Collections", "Allocator");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
static_assert(offsetof(::Unity::Collections::Allocator, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::Allocator) == 0x4, "Size mismatch!");
