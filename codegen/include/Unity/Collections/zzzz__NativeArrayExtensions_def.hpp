...
/// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyFrom(::by_ref<::Unity::Collections::NativeArray_1<T>>  container, ::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeHashSet_1<T>>  other) ;

/// @brief Method CopyFrom, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyFrom(::by_ref<::Unity::Collections::NativeArray_1<T>>  container, ::by_ref<::Unity::Collections::NativeHashSet_1<T>>  other) ;
...
template<typename T>
static inline void Initialize(::by_ref<::Unity::Collections::NativeArray_1<T>>  array, int32_t  length, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
