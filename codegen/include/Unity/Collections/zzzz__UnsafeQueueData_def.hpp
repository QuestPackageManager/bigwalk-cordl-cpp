...
template<typename T>
static inline ::Unity::Collections::UnsafeQueueBlockHeader* AllocateWriteBlockMT(::Unity::Collections::UnsafeQueueData*  data, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, int32_t  threadIndex) ;

/// @brief Method DeallocateQueue, addr 0x181ec70d0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentWriteBlockTLS, addr 0x180901d70, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Collections::UnsafeQueueBlockHeader* GetCurrentWriteBlockTLS(int32_t  threadIndex) ;

/// @brief Method SetCurrentWriteBlockTLS, addr 0x180901d80, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_FirstBlock", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "m_LastBlock", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "m_MaxItems", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CurrentRead", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CurrentWriteBlockTLS", ty: "uint8_t*", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::UnsafeQueueData) == 0x20, "Size mismatch!");
