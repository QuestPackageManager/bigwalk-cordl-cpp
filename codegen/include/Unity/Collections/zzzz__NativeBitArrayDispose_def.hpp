...
public:
// Declarations
/// @brief Method Dispose, addr 0x181ebea40, size 0xa0, virtual false, abstract: false, final false
inline void Dispose() ;
...
static_assert(sizeof(::Unity::Collections::NativeBitArrayDispose) == 0x10, "Size mismatch!");
