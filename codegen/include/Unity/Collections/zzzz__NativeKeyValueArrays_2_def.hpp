...
// Ctor Parameters [CppParam { name: "Keys", ty: "::Unity::Collections::NativeArray_1<TKey>", modifiers: "", def_value: None }, CppParam { name: "Values", ty: "::Unity::Collections::NativeArray_1<TValue>", modifiers: "", def_value: None }]
