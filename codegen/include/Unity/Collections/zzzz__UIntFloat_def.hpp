...
DEFINE_IL2CPP_CLASS(::Unity::Collections::UIntFloat, "Unity.Collections", "UIntFloat");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "floatValue", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "intValue", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "doubleValue", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "longValue", ty: "uint64_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::UIntFloat) == 0x8, "Size mismatch!");
