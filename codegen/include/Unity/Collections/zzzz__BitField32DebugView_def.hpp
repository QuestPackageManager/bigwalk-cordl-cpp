...
// Write type traits
MARK_REF_T(::Unity::Collections::BitField32DebugView*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::BitField32DebugView*, "Unity.Collections", "BitField32DebugView");
...
/// @brief Method get_Bits, addr 0x181ea8e80, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Collections::BitField32DebugView) == 0x18, "Size mismatch!");
