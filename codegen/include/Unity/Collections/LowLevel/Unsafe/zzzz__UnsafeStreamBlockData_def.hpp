...
public:
// Declarations
/// @brief Method Allocate, addr 0x181ec72c0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x181ec73b0, size 0x90, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Allocator", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "Blocks", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: None }, CppParam { name: "BlockCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Ranges", ty: "::Unity::Collections::AllocatorManager_Block", modifiers: "", def_value: None }, CppParam { name: "RangeCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnsafeStreamBlockData(::Unity::Collections::AllocatorManager_AllocatorHandle  Allocator, ::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*  Blocks, int32_t  BlockCount, ::Unity::Collections::AllocatorManager_Block  Ranges, int32_t  RangeCount) noexcept;
