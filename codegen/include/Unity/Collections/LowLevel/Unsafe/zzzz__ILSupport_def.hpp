...
// Write type traits
MARK_REF_T(::Unity::Collections::LowLevel::Unsafe::ILSupport*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::ILSupport*, "Unity.Collections.LowLevel.Unsafe", "ILSupport");
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::ILSupport) == 0x10, "Size mismatch!");
