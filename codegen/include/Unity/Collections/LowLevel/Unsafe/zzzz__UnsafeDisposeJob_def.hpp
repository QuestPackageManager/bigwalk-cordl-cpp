...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeDisposeJob, "Unity.Collections.LowLevel.Unsafe", "UnsafeDisposeJob");
...
/// @brief Method Execute, addr 0x181ec6ca0, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeDisposeJob) == 0x10, "Size mismatch!");
