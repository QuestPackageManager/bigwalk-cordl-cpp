...
/// @brief Method MoveNext, addr 0x181ec6d30, size 0x40, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x1812accd0, size 0x1150, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method .ctor, addr 0x1812ae670, size 0x870, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapData*", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_BucketIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_NextIndex", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeParallelHashMapDataEnumerator) == 0x18, "Size mismatch!");
