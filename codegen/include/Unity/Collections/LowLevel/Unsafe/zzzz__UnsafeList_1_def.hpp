...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::UnsafeList_1_Enumerator, "Unity.Collections.LowLevel.Unsafe", "UnsafeList`1/Enumerator");
...
// Ctor Parameters [CppParam { name: "m_Ptr", ty: "T*", modifiers: "", def_value: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }]
...
static inline ::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>* Create(int32_t  initialCapacity, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator, ::Unity::Collections::NativeArrayOptions  options) ;
