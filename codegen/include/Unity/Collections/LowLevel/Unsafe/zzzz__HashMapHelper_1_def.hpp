...
static inline int64_t CalculateDataSize(int32_t  capacity, int32_t  bucketCapacity, int32_t  sizeOfTValue, ::by_ref<int64_t>  outKeyOffset, ::by_ref<int64_t>  outNextOffset, ::by_ref<int64_t>  outBucketOffset) ;
