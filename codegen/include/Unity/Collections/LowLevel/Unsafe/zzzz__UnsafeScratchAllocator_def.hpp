...
/// @brief Method Allocate, addr 0x181ec71a0, size 0x40, virtual false, abstract: false, final false
inline void* Allocate(int32_t  sizeInBytes, int32_t  alignmentInBytes) ;

/// @brief Method CheckAllocationDoesNotExceedCapacity, addr 0x181ec71e0, size 0xc0, virtual false, abstract: false, final false
inline void CheckAllocationDoesNotExceedCapacity(uint64_t  requestedSize) ;

/// @brief Method .ctor, addr 0x181ec72a0, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Pointer", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "m_LengthInBytes", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CapacityInBytes", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeScratchAllocator) == 0x10, "Size mismatch!");
