...
DEFINE_IL2CPP_CLASS(::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeParallelHashMap, "Unity.Collections.LowLevel.Unsafe", "UntypedUnsafeParallelHashMap");
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UntypedUnsafeParallelHashMap) == 0x10, "Size mismatch!");
