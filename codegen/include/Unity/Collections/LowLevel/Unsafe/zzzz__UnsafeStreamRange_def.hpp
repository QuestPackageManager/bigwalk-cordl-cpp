...
// Ctor Parameters [CppParam { name: "Block", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeStreamBlock*", modifiers: "", def_value: None }, CppParam { name: "OffsetInFirstBlock", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ElementCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "LastOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "NumberOfBlocks", ty: "int32_t", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Unity::Collections::LowLevel::Unsafe::UnsafeStreamRange) == 0x18, "Size mismatch!");
