...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::LowLevel::Unsafe::BurstRuntime_HashCode64_1, "Unity.Collections.LowLevel.Unsafe", "BurstRuntime/HashCode64`1");
// Dependencies 
namespace Unity::Collections::LowLevel::Unsafe {
// cpp template
template<typename T>
...
// Declarations
template<typename T>
using HashCode64_1 = ::Unity::Collections::LowLevel::Unsafe::BurstRuntime_HashCode64_1<T>;
