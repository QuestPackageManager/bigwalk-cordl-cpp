...
inline ::by_ref<T> get_Item(int32_t  elementIndex) ;
...
// Ctor Parameters [CppParam { name: "m_backingAllocatorHandle", ty: "::Unity::Collections::AllocatorManager_AllocatorHandle", modifiers: "", def_value: None }, CppParam { name: "m_lengthInElements", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_capacityInElements", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_log2BlockSizeInElements", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_blocks", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_block", ty: "::System::IntPtr*", modifiers: "", def_value: None }]
constexpr ArrayOfArrays_1(::Unity::Collections::AllocatorManager_AllocatorHandle  m_backingAllocatorHandle, int32_t  m_lengthInElements, int32_t  m_capacityInElements, int32_t  m_log2BlockSizeInElements, int32_t  m_blocks, ::System::IntPtr*  m_block) noexcept;
