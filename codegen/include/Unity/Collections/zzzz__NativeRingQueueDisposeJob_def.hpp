...
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeRingQueueDisposeJob, "Unity.Collections", "NativeRingQueueDisposeJob");
...
/// @brief Method Execute, addr 0x181ebf450, size 0x20, virtual true, abstract: false, final true
inline void Execute() ;
...
static_assert(sizeof(::Unity::Collections::NativeRingQueueDisposeJob) == 0x8, "Size mismatch!");
