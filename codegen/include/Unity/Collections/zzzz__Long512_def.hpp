...
DEFINE_IL2CPP_CLASS(::Unity::Collections::Long512, "Unity.Collections", "Long512");
...
// Ctor Parameters [CppParam { name: "f0", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f1", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f2", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f3", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f4", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f5", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f6", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }, CppParam { name: "f7", ty: "::Unity::Collections::Long64", modifiers: "", def_value: None }]
constexpr Long512(::Unity::Collections::Long64  f0, ::Unity::Collections::Long64  f1, ::Unity::Collections::Long64  f2, ::Unity::Collections::Long64  f3, ::Unity::Collections::Long64  f4, ::Unity::Collections::Long64  f5, ::Unity::Collections::Long64  f6, ::Unity::Collections::Long64  f7) noexcept;
...
static_assert(sizeof(::Unity::Collections::Long512) == 0x1000, "Size mismatch!");
