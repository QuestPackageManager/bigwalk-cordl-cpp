...
// Write type traits
MARK_REF_T(::Unity::Collections::StreamCompressionModel_SharedStaticCompressionModel*);
...
DEFINE_IL2CPP_CLASS(::Unity::Collections::StreamCompressionModel_SharedStaticCompressionModel*, "Unity.Collections", "StreamCompressionModel/SharedStaticCompressionModel");
DEFINE_IL2CPP_CLASS(::Unity::Collections::StreamCompressionModel, "Unity.Collections", "StreamCompressionModel");
DEFINE_IL2CPP_CLASS(::Unity::Collections::StreamCompressionModel__bucketOffsets_e__FixedBuffer, "Unity.Collections", "StreamCompressionModel/<bucketOffsets>e__FixedBuffer");
...
// Dependencies Unity.Collections.StreamCompressionModel::<bucketOffsets>e__FixedBuffer, Unity.Collections.StreamCompressionModel::<bucketSizes>e__FixedBuffer, Unity.Collections.StreamCompressionModel::<decodeTable>e__FixedBuffer, Unity.Collections.StreamCompressionModel::<encodeTable>e__FixedBuffer
namespace Unity::Collections {
// Is value type: true
...
/// @brief Field k_BucketOffsets, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_BucketOffsets, put=setStaticF_k_BucketOffsets)) ::ArrayW<uint32_t>  k_BucketOffsets;

/// @brief Field k_BucketSizes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_BucketSizes, put=setStaticF_k_BucketSizes)) ::ArrayW<uint8_t>  k_BucketSizes;

/// @brief Field k_DefaultModelData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_DefaultModelData, put=setStaticF_k_DefaultModelData)) ::ArrayW<uint8_t>  k_DefaultModelData;
...
/// @brief Method CalculateBucket, addr 0x181ec2440, size 0xe0, virtual false, abstract: false, final false
inline int32_t CalculateBucket(uint32_t  value) ;

/// @brief Method CheckAlphabetAndMaxCodeLength, addr 0x181ec2520, size 0x30, virtual false, abstract: false, final false
static inline void CheckAlphabetAndMaxCodeLength(int32_t  alphabetSize, int32_t  maxCodeLength) ;

/// @brief Method CheckAlphabetSize, addr 0x181ec2550, size 0x60, virtual false, abstract: false, final false
static inline void CheckAlphabetSize(int32_t  alphabetSize) ;

/// @brief Method CheckExceedMaxCodeLength, addr 0x181ec25b0, size 0x20, virtual false, abstract: false, final false
static inline void CheckExceedMaxCodeLength(int32_t  length, int32_t  maxCodeLength) ;

/// @brief Method CheckSymbolLength, addr 0x181ec25d0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GenerateHuffmanCodes, addr 0x181ec2600, size 0x1b0, virtual false, abstract: false, final false
static inline void GenerateHuffmanCodes(::Unity::Collections::NativeArray_1<uint8_t>  symbolCodes, int32_t  symbolCodesOffset, ::Unity::Collections::NativeArray_1<uint8_t>  symbolLengths, int32_t  symbolLengthsOffset, int32_t  alphabetSize, int32_t  maxCodeLength) ;

/// @brief Method GenerateHuffmanDecodeTable, addr 0x181ec27b0, size 0xc0, virtual false, abstract: false, final false
static inline void GenerateHuffmanDecodeTable(::Unity::Collections::NativeArray_1<uint16_t>  decodeTable, int32_t  decodeTableOffset, ::Unity::Collections::NativeArray_1<uint8_t>  symbolLengths, ::Unity::Collections::NativeArray_1<uint8_t>  symbolCodes, int32_t  alphabetSize, int32_t  maxCodeLength) ;

/// @brief Method GetCompressedSizeInBits, addr 0x181ec2870, size 0x40, virtual false, abstract: false, final false
inline int32_t GetCompressedSizeInBits(uint32_t  value) ;

/// @brief Method Initialize, addr 0x181ec28b0, size 0x3e0, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method ReverseBits, addr 0x181ec2c90, size 0x60, virtual false, abstract: false, final false
...
static inline ::ArrayW<uint8_t> getStaticF_k_BucketSizes() ;

static inline ::ArrayW<uint8_t> getStaticF_k_DefaultModelData() ;

static inline ::ArrayW<int32_t> getStaticF_k_FirstBucketCandidate() ;

/// @brief Method get_Default, addr 0x181ec2e50, size 0xf0, virtual false, abstract: false, final false
...
static inline void setStaticF_k_BucketSizes(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_k_DefaultModelData(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_k_FirstBucketCandidate(::ArrayW<int32_t>  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr StreamCompressionModel() ;

// Ctor Parameters [CppParam { name: "m_Initialized", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "encodeTable", ty: "::Unity::Collections::StreamCompressionModel__encodeTable_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "decodeTable", ty: "::Unity::Collections::StreamCompressionModel__decodeTable_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "bucketSizes", ty: "::Unity::Collections::StreamCompressionModel__bucketSizes_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "bucketOffsets", ty: "::Unity::Collections::StreamCompressionModel__bucketOffsets_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr StreamCompressionModel(uint8_t  m_Initialized, ::Unity::Collections::StreamCompressionModel__encodeTable_e__FixedBuffer  encodeTable, ::Unity::Collections::StreamCompressionModel__decodeTable_e__FixedBuffer  decodeTable, ::Unity::Collections::StreamCompressionModel__bucketSizes_e__FixedBuffer  bucketSizes, ::Unity::Collections::StreamCompressionModel__bucketOffsets_e__FixedBuffer  bucketOffsets) noexcept;
...
static_assert(sizeof(::Unity::Collections::StreamCompressionModel) == 0xf4, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::Unity::Collections::StreamCompressionModel_SharedStaticCompressionModel) == 0x10, "Size mismatch!");
