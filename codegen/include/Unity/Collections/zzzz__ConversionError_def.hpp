...
DEFINE_IL2CPP_CLASS(::Unity::Collections::ConversionError, "Unity.Collections", "ConversionError");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
static_assert(offsetof(::Unity::Collections::ConversionError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::ConversionError) == 0x4, "Size mismatch!");
