...
public:
// Declarations
/// @brief Method Dispose, addr 0x181ebf330, size 0x20, virtual false, abstract: false, final false
inline void Dispose() ;
...
static_assert(sizeof(::Unity::Collections::NativeHashMapDispose) == 0x10, "Size mismatch!");
