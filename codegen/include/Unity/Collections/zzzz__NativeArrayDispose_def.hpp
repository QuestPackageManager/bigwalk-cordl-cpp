...
public:
// Declarations
/// @brief Method Dispose, addr 0x182248a40, size 0x20, virtual false, abstract: false, final false
inline void Dispose() ;
...
static_assert(sizeof(::Unity::Collections::NativeArrayDispose) == 0x10, "Size mismatch!");
