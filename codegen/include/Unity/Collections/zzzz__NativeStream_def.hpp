...
/// @brief Method AllocateBlock, addr 0x181ebf490, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AllocateForEach, addr 0x181ebf4a0, size 0x20, virtual false, abstract: false, final false
inline void AllocateForEach(int32_t  forEachCount) ;

/// @brief Method AsReader, addr 0x181ebf4c0, size 0x80, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Reader AsReader() ;

/// @brief Method AsWriter, addr 0x181ebf540, size 0xe0, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeStream_Writer AsWriter() ;

/// @brief Method CheckForEachCountGreaterThanZero, addr 0x181ebf620, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x181ebf690, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method ScheduleConstruct, addr 0x181ebf7a0, size 0xa0, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::by_ref<::Unity::Collections::NativeStream>  stream, ::Unity::Collections::NativeArray_1<int32_t>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;

/// @brief Method ScheduleConstruct, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::Unity::Jobs::JobHandle ScheduleConstruct(::by_ref<::Unity::Collections::NativeStream>  stream, ::Unity::Collections::NativeList_1<T>  bufferCount, ::Unity::Jobs::JobHandle  dependency, ::Unity::Collections::AllocatorManager_AllocatorHandle  allocator) ;
...
/// @brief Method Allocate, addr 0x181ec7f20, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CheckAllocateSize, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckAllocateSize(int32_t  size) ;

/// @brief Method CheckBeginForEachIndex, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckBeginForEachIndex(int32_t  foreachIndex) ;

/// @brief Method CheckEndForEachIndex, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method PatchMinMaxRange, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181ec80b0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method CheckEndForEachIndex, addr 0x181ec15e0, size 0x50, virtual false, abstract: false, final false
inline void CheckEndForEachIndex() ;

/// @brief Method CheckNotReadingOutOfBounds, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckNotReadingOutOfBounds(int32_t  size) ;

/// @brief Method CheckRead, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
inline void CheckRead() ;

/// @brief Method CheckReadSize, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ReadUnsafePtr, addr 0x181ec1650, size 0x50, virtual false, abstract: false, final false
inline uint8_t* ReadUnsafePtr(int32_t  size) ;

/// @brief Method .ctor, addr 0x181ec1700, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::NativeStream>  stream) ;
