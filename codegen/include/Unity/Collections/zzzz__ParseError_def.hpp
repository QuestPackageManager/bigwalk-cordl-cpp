...
DEFINE_IL2CPP_CLASS(::Unity::Collections::ParseError, "Unity.Collections", "ParseError");
// Dependencies 
namespace Unity::Collections {
// Is value type: true
...
static_assert(offsetof(::Unity::Collections::ParseError, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Collections::ParseError) == 0x4, "Size mismatch!");
