...
struct SortJobDefer_2_SegmentSortMerge;
}
namespace Unity::Collections {
template<typename T,typename U>
struct SortJobDefer_2_SegmentSort;
}
...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::SortJobDefer_2, "Unity.Collections", "SortJobDefer`2");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::SortJobDefer_2_SegmentSort, "Unity.Collections", "SortJobDefer`2/SegmentSort");
DEFINE_IL2CPP_GEN_CLASS(::Unity::Collections::SortJobDefer_2_SegmentSortMerge, "Unity.Collections", "SortJobDefer`2/SegmentSortMerge");
...
// Ctor Parameters [CppParam { name: "DataRO", ty: "::Unity::Collections::NativeList_1<T>", modifiers: "", def_value: None }, CppParam { name: "Data", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<T>*", modifiers: "", def_value: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "Data", ty: "::Unity::Collections::NativeList_1<T>", modifiers: "", def_value: None }, CppParam { name: "Comp", ty: "U", modifiers: "", def_value: None }, CppParam { name: "SegmentWidth", ty: "int32_t", modifiers: "", def_value: None }]
