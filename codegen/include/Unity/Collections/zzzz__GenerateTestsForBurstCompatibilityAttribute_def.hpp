...
DEFINE_IL2CPP_CLASS(::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute_BurstCompatibleCompileTarget, "Unity.Collections", "GenerateTestsForBurstCompatibilityAttribute/BurstCompatibleCompileTarget");
...
static_assert(offsetof(::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute_BurstCompatibleCompileTarget, value__) == 0x4, "Offset mismatch!");
...
/// @brief Field CompileTarget, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_CompileTarget, put=__cordl_internal_set_CompileTarget)) ::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute_BurstCompatibleCompileTarget  CompileTarget;

 __declspec(property(get=get_GenericTypeArguments, put=set_GenericTypeArguments)) ::ArrayW<::System::Type*>  GenericTypeArguments;
...
/// @brief Method get_GenericTypeArguments, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<::System::Type*> get_GenericTypeArguments() ;

/// @brief Method set_GenericTypeArguments, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Collections::GenerateTestsForBurstCompatibilityAttribute) == 0x28, "Size mismatch!");
