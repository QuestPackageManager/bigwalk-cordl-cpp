...
// Write type traits
MARK_REF_T(::Unity::Collections::NativeDisableParallelForRestrictionAttribute*);
DEFINE_IL2CPP_CLASS(::Unity::Collections::NativeDisableParallelForRestrictionAttribute*, "Unity.Collections", "NativeDisableParallelForRestrictionAttribute");
...
static_assert(sizeof(::Unity::Collections::NativeDisableParallelForRestrictionAttribute) == 0x10, "Size mismatch!");
