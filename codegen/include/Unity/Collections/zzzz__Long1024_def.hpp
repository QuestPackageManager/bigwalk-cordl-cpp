...
/// @brief Method ElementAt, addr 0x1808fb150, size 0x40, virtual true, abstract: false, final true
inline ::by_ref<int64_t> ElementAt(int32_t  index) ;

/// @brief Method get_Length, addr 0x180908c80, size 0x40, virtual true, abstract: false, final true
