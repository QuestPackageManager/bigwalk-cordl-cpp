...
/// @brief Method get_Reason, addr 0x1802db4a0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Reason() ;

/// @brief Method set_Reason, addr 0x180308500, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Collections::ExcludeFromBurstCompatTestingAttribute) == 0x18, "Size mismatch!");
