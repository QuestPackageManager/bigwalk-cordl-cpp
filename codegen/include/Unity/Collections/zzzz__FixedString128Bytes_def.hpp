...
/// @brief Method CheckCapacityInRange, addr 0x181eaf400, size 0x90, virtual false, abstract: false, final false
inline void CheckCapacityInRange(int32_t  capacity) ;

/// @brief Method CheckCopyError, addr 0x181eaf490, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method CheckIndexInRange, addr 0x181ea7530, size 0xd0, virtual false, abstract: false, final false
inline void CheckIndexInRange(int32_t  index) ;

/// @brief Method CheckLengthInRange, addr 0x181eaf530, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetEnumerator, addr 0x181eafd30, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eafee0, size 0x20, virtual false, abstract: false, final false
inline ::Unity::Collections::CopyError Initialize(::StringW  source) ;

/// @brief Method Initialize, addr 0x181eafe30, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x181eaff00, size 0x40, virtual false, abstract: false, final false
inline ::Unity::Collections::FormatError Initialize(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method Initialize, addr 0x181eafe50, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method TryResize, addr 0x181eaff60, size 0xa0, virtual true, abstract: false, final true
inline bool TryResize(int32_t  newLength, ::Unity::Collections::NativeArrayOptions  clearOptions) ;

/// @brief Method .ctor, addr 0x181eb0100, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::NativeText_ReadOnly  other) ;

/// @brief Method .ctor, addr 0x181eb0000, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x181eb0040, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::by_ref<::Unity::Collections::LowLevel::Unsafe::UnsafeText>  other) ;

/// @brief Method .ctor, addr 0x181eaff00, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::Unicode_Rune  rune, int32_t  count) ;

/// @brief Method .ctor, addr 0x181eb00c0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  source) ;

/// @brief Method get_Capacity, addr 0x180772350, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method get_UTF8MaxLengthInBytes, addr 0x180772350, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x181eb0180, size 0xf0, virtual false, abstract: false, final false
static inline bool op_Equality(::by_ref<::Unity::Collections::FixedString128Bytes>  a, ::StringW  b) ;
...
/// @brief Method op_Implicit, addr 0x181eb0370, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x181eb03e0, size 0x100, virtual false, abstract: false, final false
static inline bool op_Inequality(::by_ref<::Unity::Collections::FixedString128Bytes>  a, ::StringW  b) ;
...
// Ctor Parameters [CppParam { name: "utf8LengthInBytes", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "bytes", ty: "::Unity::Collections::FixedBytes126", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x181ea74c0, size 0x50, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x181eaef40, size 0x20, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x181eaf070, size 0x30, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x181eaf2f0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::Unity::Collections::FixedString128Bytes  other) ;

/// @brief Method get_Current, addr 0x180371750, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "target", ty: "::Unity::Collections::FixedString128Bytes", modifiers: "", def_value: None }, CppParam { name: "offset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "current", ty: "::Unity::Collections::Unicode_Rune", modifiers: "", def_value: None }]
