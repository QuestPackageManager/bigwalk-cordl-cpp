...
static_assert(offsetof(::Unity::Hierarchy::HierarchyNodeFlags, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Hierarchy::HierarchyNodeFlags) == 0x4, "Size mismatch!");
