...
DEFINE_IL2CPP_CLASS(::Unity::Hierarchy::HierarchySearchFilterOperator, "Unity.Hierarchy", "HierarchySearchFilterOperator");
// Dependencies 
namespace Unity::Hierarchy {
// Is value type: true
...
static_assert(offsetof(::Unity::Hierarchy::HierarchySearchFilterOperator, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Hierarchy::HierarchySearchFilterOperator) == 0x4, "Size mismatch!");
