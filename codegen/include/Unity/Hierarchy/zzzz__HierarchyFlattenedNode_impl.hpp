...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::by_ref<::Unity::Hierarchy::HierarchyFlattenedNode> (*)()>(&::Unity::Hierarchy::HierarchyFlattenedNode::get_Null)> {
  ...
  constexpr static std::size_t addrs = 0x1822b93d0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Unity::Hierarchy::HierarchyFlattenedNode::*)()>(&::Unity::Hierarchy::HierarchyFlattenedNode::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1822b9380;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(::by_ref<::Unity::Hierarchy::HierarchyFlattenedNode>, ::by_ref<::Unity::Hierarchy::HierarchyFlattenedNode>)>(&::Unity::Hierarchy::HierarchyFlattenedNode::op_Equality)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x1822b93e0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Unity::Hierarchy::HierarchyFlattenedNode::*)(::Unity::Hierarchy::HierarchyFlattenedNode)>(&::Unity::Hierarchy::HierarchyFlattenedNode::Equals)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x1822b91a0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(),
                        {"Equals", {}, {::i2c::type_of<::Unity::Hierarchy::HierarchyFlattenedNode>()}}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::Unity::Hierarchy::HierarchyFlattenedNode::*)()>(&::Unity::Hierarchy::HierarchyFlattenedNode::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x1822b92b0;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(),
                    {::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(), 3}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Unity::Hierarchy::HierarchyFlattenedNode::*)(::System::Object*)>(&::Unity::Hierarchy::HierarchyFlattenedNode::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x1822b9200;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(),
                    {::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(), 0}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Unity::Hierarchy::HierarchyFlattenedNode::*)()>(&::Unity::Hierarchy::HierarchyFlattenedNode::GetHashCode)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x1822b9290;

  inline static const ::MethodInfo* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(
                    ::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(),
                    {::i2c::class_of<::Unity::Hierarchy::HierarchyFlattenedNode>(), 2}
                ));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::by_ref<::Unity::Hierarchy::HierarchyNode> (*)(::by_ref<::Unity::Hierarchy::HierarchyFlattenedNode>)>(&::Unity::Hierarchy::HierarchyFlattenedNode::GetNodeByRef)> {
  constexpr static std::size_t size = 0x10;
...
// Ctor Parameters [CppParam { name: "m_Node", ty: "::Unity::Hierarchy::HierarchyNode", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Type", ty: "::Unity::Hierarchy::HierarchyNodeType", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Version", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ParentOffset", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_NextSiblingOffset", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ChildIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_ChildrenCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Depth", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::Hierarchy::HierarchyFlattenedNode::HierarchyFlattenedNode(::Unity::Hierarchy::HierarchyNode  m_Node, ::Unity::Hierarchy::HierarchyNodeType  m_Type, int32_t  m_Version, int32_t  m_ParentOffset, int32_t  m_NextSiblingOffset, int32_t  m_ChildIndex, int32_t  m_ChildrenCount, int32_t  m_Depth) noexcept  {
this->m_Node = m_Node;
this->m_Type = m_Type;
