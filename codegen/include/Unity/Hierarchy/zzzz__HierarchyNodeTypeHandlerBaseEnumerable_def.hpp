...
/// @brief Method Dispose, addr 0x1822b85f0, size 0xb0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x1812ab560, size 0x1770, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x1822b86a0, size 0x160, virtual false, abstract: false, final false
inline void _ctor(::Unity::Hierarchy::Hierarchy*  hierarchy) ;

/// @brief Method get_Current, addr 0x1822b8090, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Handlers", ty: "::ArrayW<::System::IntPtr>", modifiers: "", def_value: None }, CppParam { name: "m_Count", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Index", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method GetEnumerator, addr 0x1822b9d10, size 0xf0, virtual false, abstract: false, final false
