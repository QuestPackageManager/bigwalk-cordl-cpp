...
/// @brief Method QuoteStringIfNeeded, addr 0x1822baa50, size 0x70, virtual false, abstract: false, final false
static inline ::StringW QuoteStringIfNeeded(::StringW  s) ;

/// @brief Method ToString, addr 0x1822babc0, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x1822baac0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_Invalid, addr 0x1822badc0, size 0x20, virtual false, abstract: false, final false
static inline ::by_ref<::Unity::Hierarchy::HierarchySearchFilter> get_Invalid() ;

/// @brief Method get_IsValid, addr 0x1822bade0, size 0x30, virtual false, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_Name, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NumValue, addr 0x180346a80, size 0x10, virtual false, abstract: false, final false
inline float_t get_NumValue() ;

/// @brief Method get_Op, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
...
static inline void setStaticF_s_WhiteSpaces(::ArrayW<char16_t>  value) ;

// Ctor Parameters []
// @brief default ctor
constexpr HierarchySearchFilter() ;

// Ctor Parameters [CppParam { name: "_Name_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_Value_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_NumValue_k__BackingField", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_Op_k__BackingField", ty: "::Unity::Hierarchy::HierarchySearchFilterOperator", modifiers: "", def_value: None }]
constexpr HierarchySearchFilter(::StringW  _Name_k__BackingField, ::StringW  _Value_k__BackingField, float_t  _NumValue_k__BackingField, ::Unity::Hierarchy::HierarchySearchFilterOperator  _Op_k__BackingField) noexcept;
...
static_assert(sizeof(::Unity::Hierarchy::HierarchySearchFilter) == 0x18, "Size mismatch!");
