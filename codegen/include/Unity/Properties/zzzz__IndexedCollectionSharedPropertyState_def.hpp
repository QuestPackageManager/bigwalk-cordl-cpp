...
DEFINE_IL2CPP_CLASS(::Unity::Properties::IndexedCollectionSharedPropertyState, "Unity.Properties", "IndexedCollectionSharedPropertyState");
// Dependencies 
namespace Unity::Properties {
// Is value type: true
...
static_assert(sizeof(::Unity::Properties::IndexedCollectionSharedPropertyState) == 0x8, "Size mismatch!");
