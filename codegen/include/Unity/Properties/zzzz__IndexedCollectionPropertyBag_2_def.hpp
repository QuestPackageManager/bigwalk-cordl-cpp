...
template<typename TContainer>
inline void Unity_Properties_IListPropertyAccept_TList__Accept(::Unity::Properties::IListPropertyVisitor*  visitor, ::Unity::Properties::Property_2<TContainer,TList>*  property, ::by_ref<TContainer>  container, ::by_ref<TList>  list) ;
