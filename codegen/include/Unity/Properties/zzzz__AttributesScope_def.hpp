...
/// @brief Method Dispose, addr 0x182303c80, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x182303d30, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::Unity::Properties::IProperty*  target, ::Unity::Properties::IProperty*  source) ;

/// @brief Method .ctor, addr 0x182303cb0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::AttributesScope) == 0x10, "Size mismatch!");
