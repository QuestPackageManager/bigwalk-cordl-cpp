...
DEFINE_IL2CPP_CLASS(::Unity::Properties::VisitParameters, "Unity.Properties", "VisitParameters");
...
/// @brief Method get_IgnoreExceptions, addr 0x1803474c0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::VisitParameters) == 0x4, "Size mismatch!");
