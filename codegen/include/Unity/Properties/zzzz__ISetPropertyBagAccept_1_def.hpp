...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::ISetPropertyBagAccept_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::ISetPropertyBagAccept_1, "Unity.Properties", "ISetPropertyBagAccept`1");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename TContainer>
...
inline void Accept(::Unity::Properties::ISetPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container) ;
