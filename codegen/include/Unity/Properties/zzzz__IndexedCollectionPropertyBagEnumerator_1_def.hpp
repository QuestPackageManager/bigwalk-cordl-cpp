...
DEFINE_IL2CPP_GEN_CLASS(::Unity::Properties::IndexedCollectionPropertyBagEnumerator_1, "Unity.Properties", "IndexedCollectionPropertyBagEnumerator`1");
...
// Ctor Parameters [CppParam { name: "m_Impl", ty: "::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1<TContainer>*", modifiers: "", def_value: None }, CppParam { name: "m_Previous", ty: "::Unity::Properties::IndexedCollectionSharedPropertyState", modifiers: "", def_value: None }, CppParam { name: "m_Container", ty: "TContainer", modifiers: "", def_value: None }, CppParam { name: "m_Position", ty: "int32_t", modifiers: "", def_value: None }]
constexpr IndexedCollectionPropertyBagEnumerator_1(::Unity::Properties::IIndexedCollectionPropertyBagEnumerator_1<TContainer>*  m_Impl, ::Unity::Properties::IndexedCollectionSharedPropertyState  m_Previous, TContainer  m_Container, int32_t  m_Position) noexcept;
