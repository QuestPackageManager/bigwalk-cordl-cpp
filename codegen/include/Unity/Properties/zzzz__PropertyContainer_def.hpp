...
class GetValueVisitor_1_PropertyContainer___c;
}
namespace Unity::Properties {
...
namespace Unity::Properties {
template<typename TSrcValue>
class PropertyContainer_GetValueVisitor_1;
}
namespace Unity::Properties {
struct PropertyPath;
}
...
// Write type traits
MARK_REF_T(::Unity::Properties::GetPropertyVisitor_PropertyContainer___c*);
MARK_GEN_REF_T_PTR(::Unity::Properties::GetValueVisitor_1_PropertyContainer___c);
MARK_REF_T(::Unity::Properties::PropertyContainer*);
MARK_REF_T(::Unity::Properties::PropertyContainer_GetPropertyVisitor*);
MARK_GEN_REF_T_PTR(::Unity::Properties::PropertyContainer_GetValueVisitor_1);
DEFINE_IL2CPP_CLASS(::Unity::Properties::GetPropertyVisitor_PropertyContainer___c*, "Unity.Properties", "PropertyContainer/GetPropertyVisitor/<>c");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::GetValueVisitor_1_PropertyContainer___c, "Unity.Properties", "PropertyContainer/GetValueVisitor`1/<>c");
...
/// @brief Method <.cctor>b__5_0, addr 0x18230ccb0, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyContainer_GetPropertyVisitor* __cctor_b__5_0() ;

/// @brief Method <.cctor>b__5_1, addr 0x1809708d0, size 0x1000, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Properties::GetPropertyVisitor_PropertyContainer___c) == 0x10, "Size mismatch!");
...
/// @brief Method Reset, addr 0x182304e70, size 0x80, virtual true, abstract: false, final false
inline void Reset() ;
...
template<typename TSrcValue>
using GetValueVisitor_1 = ::Unity::Properties::PropertyContainer_GetValueVisitor_1<TSrcValue>;

/// @brief Method Accept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline void Accept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container, ::Unity::Properties::VisitParameters  parameters) ;

/// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container, ::Unity::Properties::VisitParameters  parameters) ;

/// @brief Method TryAccept, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryAccept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container, ::by_ref<::Unity::Properties::VisitReturnCode>  returnCode, ::Unity::Properties::VisitParameters  parameters) ;
...
/// @brief Method TryGetProperty, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer>
static inline bool TryGetProperty(::by_ref<TContainer>  container, ::by_ref<::Unity::Properties::PropertyPath>  path, ::by_ref<::Unity::Properties::IProperty*>  property, ::by_ref<::Unity::Properties::VisitReturnCode>  returnCode) ;

/// @brief Method TryGetValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TContainer,typename TValue>
static inline bool TryGetValue(::by_ref<TContainer>  container, ::StringW  name, ::by_ref<TValue>  value) ;
...
// Non member Declarations
static_assert(sizeof(::Unity::Properties::PropertyContainer) == 0x10, "Size mismatch!");
