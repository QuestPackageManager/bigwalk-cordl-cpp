...
// Write type traits
MARK_REF_T(::Unity::Properties::IPropertyVisitor*);
DEFINE_IL2CPP_CLASS(::Unity::Properties::IPropertyVisitor*, "Unity.Properties", "IPropertyVisitor");
// Dependencies 
namespace Unity::Properties {
// Is value type: false
...
template<typename TContainer,typename TValue>
inline void Visit(::Unity::Properties::Property_2<TContainer,TValue>*  property, ::by_ref<TContainer>  container) ;
