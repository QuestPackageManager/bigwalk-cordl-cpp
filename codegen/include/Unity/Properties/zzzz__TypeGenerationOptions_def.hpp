...
static_assert(offsetof(::Unity::Properties::TypeGenerationOptions, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Properties::TypeGenerationOptions) == 0x4, "Size mismatch!");
