...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::IIndexedProperties_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::IIndexedProperties_1, "Unity.Properties", "IIndexedProperties`1");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename TContainer>
...
inline bool TryGetProperty(::by_ref<TContainer>  container, int32_t  index, ::by_ref<::Unity::Properties::IProperty_1<TContainer>*>  property) ;
