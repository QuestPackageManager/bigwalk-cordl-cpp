...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::IConstructorWithCount_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::IConstructorWithCount_1, "Unity.Properties", "IConstructorWithCount`1");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename T>
