...
CORDL_MODULE_EXPORT(INamedProperties_1)
...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::INamedProperties_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::INamedProperties_1, "Unity.Properties", "INamedProperties`1");
// Dependencies 
namespace Unity::Properties {
// cpp template
template<typename TContainer>
// Is value type: false
// CS Name: Unity.Properties.INamedProperties`1<TContainer>
class CORDL_TYPE INamedProperties_1 {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "", ty: "INamedProperties_1", modifiers: "const&", def_value: None }]
