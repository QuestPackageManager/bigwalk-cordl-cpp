...
DEFINE_IL2CPP_CLASS(::Unity::Properties::InstantiationKind, "Unity.Properties", "InstantiationKind");
// Dependencies 
namespace Unity::Properties {
// Is value type: true
...
static_assert(offsetof(::Unity::Properties::InstantiationKind, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Unity::Properties::InstantiationKind) == 0x4, "Size mismatch!");
