...
// Write type traits
MARK_GEN_REF_T_PTR(::Unity::Properties::PropertyBag_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Unity::Properties::PropertyBag_1, "Unity.Properties", "PropertyBag`1");
...
inline void Unity_Properties_IPropertyBag_Accept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::by_ref<::System::Object*>  container) ;
...
inline void Unity_Properties_IPropertyBag_TContainer__Accept(::Unity::Properties::IPropertyBagVisitor*  visitor, ::by_ref<TContainer>  container) ;
...
/// @brief Method Unity.Properties.IPropertyBag<TContainer>.GetProperties, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
inline ::Unity::Properties::PropertyCollection_1<TContainer> Unity_Properties_IPropertyBag_TContainer__GetProperties(::by_ref<TContainer>  container) ;
