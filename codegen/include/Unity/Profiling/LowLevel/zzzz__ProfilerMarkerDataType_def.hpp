...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::LowLevel::ProfilerMarkerDataType, "Unity.Profiling.LowLevel", "ProfilerMarkerDataType");
// Dependencies 
namespace Unity::Profiling::LowLevel {
// Is value type: true
...
static_assert(offsetof(::Unity::Profiling::LowLevel::ProfilerMarkerDataType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Unity::Profiling::LowLevel::ProfilerMarkerDataType) == 0x1, "Size mismatch!");
