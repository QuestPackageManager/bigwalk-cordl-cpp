...
DEFINE_IL2CPP_CLASS(::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderDescription, "Unity.Profiling.LowLevel.Unsafe", "ProfilerRecorderDescription");
...
public:
// Declarations
 __declspec(property(get=get_Flags)) ::Unity::Profiling::LowLevel::MarkerFlags  Flags;
...
/// @brief Method get_Flags, addr 0x18052ca70, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "category", ty: "::Unity::Profiling::ProfilerCategory", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::Unity::Profiling::LowLevel::MarkerFlags", modifiers: "", def_value: None }, CppParam { name: "dataType", ty: "::Unity::Profiling::LowLevel::ProfilerMarkerDataType", modifiers: "", def_value: None }, CppParam { name: "unitType", ty: "::Unity::Profiling::ProfilerMarkerDataUnit", modifiers: "", def_value: None }, CppParam { name: "reserved0", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nameUtf8Len", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "nameUtf8", ty: "uint8_t*", modifiers: "", def_value: None }]
constexpr ProfilerRecorderDescription(::Unity::Profiling::ProfilerCategory  category, ::Unity::Profiling::LowLevel::MarkerFlags  flags, ::Unity::Profiling::LowLevel::ProfilerMarkerDataType  dataType, ::Unity::Profiling::ProfilerMarkerDataUnit  unitType, int32_t  reserved0, int32_t  nameUtf8Len, uint8_t*  nameUtf8) noexcept;
...
static_assert(sizeof(::Unity::Profiling::LowLevel::Unsafe::ProfilerRecorderDescription) == 0x18, "Size mismatch!");
