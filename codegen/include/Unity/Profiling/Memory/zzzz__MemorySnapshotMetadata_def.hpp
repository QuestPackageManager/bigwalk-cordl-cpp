...
// Write type traits
MARK_REF_T(::Unity::Profiling::Memory::MemorySnapshotMetadata*);
DEFINE_IL2CPP_CLASS(::Unity::Profiling::Memory::MemorySnapshotMetadata*, "Unity.Profiling.Memory", "MemorySnapshotMetadata");
...
/// @brief Method get_Data, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Unity::Profiling::Memory::MemorySnapshotMetadata) == 0x20, "Size mismatch!");
