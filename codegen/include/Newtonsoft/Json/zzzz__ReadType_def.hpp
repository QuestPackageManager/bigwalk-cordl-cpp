...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::ReadType, "Newtonsoft.Json", "ReadType");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::ReadType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::ReadType) == 0x4, "Size mismatch!");
