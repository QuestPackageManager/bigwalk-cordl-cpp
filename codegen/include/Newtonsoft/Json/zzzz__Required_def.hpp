...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Required, "Newtonsoft.Json", "Required");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Required, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Required) == 0x4, "Size mismatch!");
