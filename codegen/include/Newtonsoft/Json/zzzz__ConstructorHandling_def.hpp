...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::ConstructorHandling, "Newtonsoft.Json", "ConstructorHandling");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
/// @brief Field AllowNonPublicDefaultConstructor value: I32(1)
...
static_assert(offsetof(::Newtonsoft::Json::ConstructorHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::ConstructorHandling) == 0x4, "Size mismatch!");
