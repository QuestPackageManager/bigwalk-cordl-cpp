...
public:
// Declarations
 __declspec(property(get=get_Chars)) ::ArrayW<char16_t>  Chars;
...
/// @brief Method ToString, addr 0x1817e5460, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method get_Chars, addr 0x1803a88d0, size 0x10, virtual false, abstract: false, final false
inline ::ArrayW<char16_t> get_Chars() ;

/// @brief Method get_Item, addr 0x1817e5490, size 0x160, virtual false, abstract: false, final false
inline char16_t get_Item(int32_t  i) ;

/// @brief Method get_Length, addr 0x1803bdb30, size 0x10, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_StartIndex, addr 0x1802f1880, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::StringReference) == 0x10, "Size mismatch!");
