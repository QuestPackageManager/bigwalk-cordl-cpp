...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::PrimitiveTypeCode, "Newtonsoft.Json.Utilities", "PrimitiveTypeCode");
// Dependencies 
namespace Newtonsoft::Json::Utilities {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Utilities::PrimitiveTypeCode, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Utilities::PrimitiveTypeCode) == 0x4, "Size mismatch!");
