...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::JsonTokenUtils*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::JsonTokenUtils*, "Newtonsoft.Json.Utilities", "JsonTokenUtils");
...
public:
// Declarations
/// @brief Method IsEndToken, addr 0x1817c59c0, size 0x10, virtual false, abstract: false, final false
static inline bool IsEndToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsPrimitiveToken, addr 0x1817c59d0, size 0x20, virtual false, abstract: false, final false
static inline bool IsPrimitiveToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsStartToken, addr 0x1817c59f0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::JsonTokenUtils) == 0x10, "Size mismatch!");
