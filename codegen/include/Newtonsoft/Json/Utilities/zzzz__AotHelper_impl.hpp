...
::cordl_internals::setStaticField<::Newtonsoft::Json::Utilities::AotHelper___c__1_1<T>*, "<>9", ::Newtonsoft::Json::Utilities::AotHelper___c__1_1<T>*>(std::forward<::Newtonsoft::Json::Utilities::AotHelper___c__1_1<T>*>(value));
}
template<typename T>
...
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__1_1<T>*>(),
                        {".ctor", {}, {}}
                    )));
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*, "<>9", ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>(std::forward<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>(value));
}
template<typename TKey,typename TValue>
inline ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>* Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*, "<>9", ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>();
}
template<typename TKey,typename TValue>
inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::setStaticF___9__3_0(::System::Action*  value)  {
::cordl_internals::setStaticField<::System::Action*, "<>9__3_0", ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>(std::forward<::System::Action*>(value));
}
template<typename TKey,typename TValue>
inline ::System::Action* Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::getStaticF___9__3_0()  {
return ::cordl_internals::getStaticField<::System::Action*, "<>9__3_0", ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>();
}
template<typename TKey,typename TValue>
inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>(),
                        {".ctor", {}, {}}
                    )));
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template<typename TKey,typename TValue>
inline void Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::_EnsureDictionary_b__3_0()  {
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                        ::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>(),
                        {"<EnsureDictionary>b__3_0", {}, {}}
                    )));
return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template<typename TKey,typename TValue>
inline ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>* Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::New_ctor()  {
return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>*>());
}
// Ctor Parameters []
template<typename TKey,typename TValue>
constexpr ::Newtonsoft::Json::Utilities::AotHelper___c__3_2<TKey,TValue>::AotHelper___c__3_2()   {
}
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::System::Action*)>(&::Newtonsoft::Json::Utilities::AotHelper::Ensure)> {
  ...
  constexpr static std::size_t addrs = 0x1817b75b0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)()>(&::Newtonsoft::Json::Utilities::AotHelper::IsFalse)> {
  ...
  constexpr static std::size_t addrs = 0x1817b7670;
...
template<typename T>
inline void Newtonsoft::Json::Utilities::AotHelper::EnsureType()  {
static auto* ___internal_method_base = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                    ::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(),
                    {"EnsureType", {::i2c::class_of<T>()}, {}}
                )));
...
template<typename TKey,typename TValue>
inline void Newtonsoft::Json::Utilities::AotHelper::EnsureDictionary()  {
static auto* ___internal_method_base = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(
                    ::i2c::class_of<::Newtonsoft::Json::Utilities::AotHelper*>(),
                    {"EnsureDictionary", {::i2c::class_of<TKey>(), ::i2c::class_of<TValue>()}, {}}
                )));
static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::make_generic(
                    ___internal_method_base,
