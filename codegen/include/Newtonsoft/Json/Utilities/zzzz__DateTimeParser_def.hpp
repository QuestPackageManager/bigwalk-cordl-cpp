...
/// @brief Method Parse, addr 0x1817bde10, size 0x110, virtual false, abstract: false, final false
inline bool Parse(::ArrayW<char16_t>  text, int32_t  startIndex, int32_t  length) ;

/// @brief Method Parse2Digit, addr 0x1817bd550, size 0x70, virtual false, abstract: false, final false
inline bool Parse2Digit(int32_t  start, ::by_ref<int32_t>  num) ;

/// @brief Method Parse4Digit, addr 0x1817bd5c0, size 0xb0, virtual false, abstract: false, final false
inline bool Parse4Digit(int32_t  start, ::by_ref<int32_t>  num) ;

/// @brief Method ParseChar, addr 0x1817bd670, size 0x40, virtual false, abstract: false, final false
inline bool ParseChar(int32_t  start, char16_t  ch) ;

/// @brief Method ParseDate, addr 0x1817bd6b0, size 0x1c0, virtual false, abstract: false, final false
inline bool ParseDate(int32_t  start) ;

/// @brief Method ParseTime, addr 0x1817bd8d0, size 0x320, virtual false, abstract: false, final false
inline bool ParseTime(::by_ref<int32_t>  start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x1817bd870, size 0x60, virtual false, abstract: false, final false
inline bool ParseTimeAndZoneAndWhitespace(int32_t  start) ;

/// @brief Method ParseZone, addr 0x1817bdbf0, size 0x220, virtual false, abstract: false, final false
