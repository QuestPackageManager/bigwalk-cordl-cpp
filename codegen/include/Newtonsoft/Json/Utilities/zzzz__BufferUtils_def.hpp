...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::BufferUtils*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Utilities::BufferUtils*, "Newtonsoft.Json.Utilities", "BufferUtils");
...
public:
// Declarations
/// @brief Method EnsureBufferSize, addr 0x1817b99a0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method RentBuffer, addr 0x1817b9a10, size 0x30, virtual false, abstract: false, final false
static inline ::ArrayW<char16_t> RentBuffer(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  minSize) ;

/// @brief Method ReturnBuffer, addr 0x1817b9a40, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::BufferUtils) == 0x10, "Size mismatch!");
