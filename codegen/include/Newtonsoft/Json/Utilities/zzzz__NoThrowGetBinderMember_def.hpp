...
/// @brief Method FallbackGetMember, addr 0x1817c6770, size 0x100, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Utilities::NoThrowGetBinderMember) == 0x30, "Size mismatch!");
