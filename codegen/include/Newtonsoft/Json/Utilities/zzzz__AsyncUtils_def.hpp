...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Utilities::AsyncUtils*);
MARK_REF_T(::Newtonsoft::Json::Utilities::AsyncUtils___c*);
MARK_GEN_REF_T_PTR(::Newtonsoft::Json::Utilities::AsyncUtils___c__6_1);
...
/// @brief Method <FromCanceled>b__5_0, addr 0x1802d9d80, size 0x10, virtual false, abstract: false, final false
...
template<typename T>
using __c__6_1 = ::Newtonsoft::Json::Utilities::AsyncUtils___c__6_1<T>;
...
/// @brief Method CancelIfRequestedAsync, addr 0x1817b7700, size 0x40, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Threading::Tasks::Task_1<T>* CancelIfRequestedAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FromCanceled, addr 0x1817b7740, size 0xd0, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Threading::Tasks::Task_1<T>* FromCanceled(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method IsCompletedSuccessfully, addr 0x1817b7810, size 0x30, virtual false, abstract: false, final false
static inline bool IsCompletedSuccessfully(::System::Threading::Tasks::Task*  task) ;

/// @brief Method ReadAsync, addr 0x1817b7840, size 0x90, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::System::IO::TextReader*  reader, ::ArrayW<char16_t>  buffer, int32_t  index, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ToAsync, addr 0x1817b78d0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<bool>* ToAsync(bool  value) ;

/// @brief Method WriteAsync, addr 0x1817b79a0, size 0x90, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* WriteAsync(::System::IO::TextWriter*  writer, ::ArrayW<char16_t>  value, int32_t  start, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method WriteAsync, addr 0x1817b7930, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method WriteAsync, addr 0x1817b7a30, size 0x70, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Newtonsoft::Json::Utilities::AsyncUtils) == 0x10, "Size mismatch!");
