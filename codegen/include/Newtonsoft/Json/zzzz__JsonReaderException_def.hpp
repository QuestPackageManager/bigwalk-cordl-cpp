...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::JsonReaderException*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonReaderException*, "Newtonsoft.Json", "JsonReaderException");
...
/// @brief Method Create, addr 0x181780fd0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x1817811d0, size 0x10, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::JsonReaderException* Create(::Newtonsoft::Json::JsonReader*  reader, ::StringW  message) ;

/// @brief Method Create, addr 0x1817810b0, size 0x120, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::JsonReaderException) == 0xa0, "Size mismatch!");
