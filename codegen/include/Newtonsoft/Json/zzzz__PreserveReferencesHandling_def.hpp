...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::PreserveReferencesHandling, "Newtonsoft.Json", "PreserveReferencesHandling");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::PreserveReferencesHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::PreserveReferencesHandling) == 0x4, "Size mismatch!");
