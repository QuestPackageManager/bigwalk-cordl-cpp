...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::JsonContainerContract*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::JsonContainerContract*, "Newtonsoft.Json.Serialization", "JsonContainerContract");
// Dependencies Newtonsoft.Json.ReferenceLoopHandling, Newtonsoft.Json.Serialization.JsonContract, Newtonsoft.Json.TypeNameHandling, System.Nullable`1<T>
namespace Newtonsoft::Json::Serialization {
// Is value type: false
...
constexpr ::Newtonsoft::Json::Serialization::JsonContract* const& __cordl_internal_get__finalItemContract() const;

constexpr ::Newtonsoft::Json::Serialization::JsonContract*& __cordl_internal_get__finalItemContract() ;

constexpr ::Newtonsoft::Json::Serialization::JsonContract* const& __cordl_internal_get__itemContract() const;
...
/// @brief Method .ctor, addr 0x1817d5920, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_FinalItemContract, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* get_FinalItemContract() ;

/// @brief Method get_ItemContract, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* get_ItemContract() ;

/// @brief Method get_ItemConverter, addr 0x1802ec4d0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::JsonConverter* get_ItemConverter() ;

/// @brief Method get_ItemIsReference, addr 0x180459fd0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<bool> get_ItemIsReference() ;

/// @brief Method get_ItemReferenceLoopHandling, addr 0x1817d59c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::ReferenceLoopHandling> get_ItemReferenceLoopHandling() ;

/// @brief Method get_ItemTypeNameHandling, addr 0x1817d59d0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<::Newtonsoft::Json::TypeNameHandling> get_ItemTypeNameHandling() ;

/// @brief Method set_ItemContract, addr 0x1817d59e0, size 0x70, virtual false, abstract: false, final false
inline void set_ItemContract(::Newtonsoft::Json::Serialization::JsonContract*  value) ;

/// @brief Method set_ItemConverter, addr 0x1802ec810, size 0x20, virtual false, abstract: false, final false
inline void set_ItemConverter(::Newtonsoft::Json::JsonConverter*  value) ;

/// @brief Method set_ItemIsReference, addr 0x180459fe0, size 0x10, virtual false, abstract: false, final false
inline void set_ItemIsReference(::System::Nullable_1<bool>  value) ;

/// @brief Method set_ItemReferenceLoopHandling, addr 0x1817d5a50, size 0x10, virtual false, abstract: false, final false
inline void set_ItemReferenceLoopHandling(::System::Nullable_1<::Newtonsoft::Json::ReferenceLoopHandling>  value) ;

/// @brief Method set_ItemTypeNameHandling, addr 0x1817d5a60, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonContainerContract) == 0xc0, "Size mismatch!");
