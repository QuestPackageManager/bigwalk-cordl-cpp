...
/// @brief Method GetValue, addr 0x1817fad20, size 0x1b0, virtual true, abstract: false, final true
...
/// @brief Method SetValue, addr 0x1817faed0, size 0x110, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1817fafe0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::ReflectionValueProvider) == 0x18, "Size mismatch!");
