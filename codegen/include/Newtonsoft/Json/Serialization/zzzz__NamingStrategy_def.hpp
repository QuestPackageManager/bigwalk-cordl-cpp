...
/// @brief Field <OverrideSpecifiedNames>k__BackingField, offset 0x12, size 0x1 
 __declspec(property(get=__cordl_internal_get__OverrideSpecifiedNames_k__BackingField, put=__cordl_internal_set__OverrideSpecifiedNames_k__BackingField)) bool  _OverrideSpecifiedNames_k__BackingField;

/// @brief Field <ProcessDictionaryKeys>k__BackingField, offset 0x10, size 0x1 
 __declspec(property(get=__cordl_internal_get__ProcessDictionaryKeys_k__BackingField, put=__cordl_internal_set__ProcessDictionaryKeys_k__BackingField)) bool  _ProcessDictionaryKeys_k__BackingField;

/// @brief Field <ProcessExtensionDataNames>k__BackingField, offset 0x11, size 0x1 
 __declspec(property(get=__cordl_internal_get__ProcessExtensionDataNames_k__BackingField, put=__cordl_internal_set__ProcessExtensionDataNames_k__BackingField)) bool  _ProcessExtensionDataNames_k__BackingField;

/// @brief Method Equals, addr 0x1817faa60, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x1817fa9e0, size 0x80, virtual false, abstract: false, final false
inline bool Equals(::Newtonsoft::Json::Serialization::NamingStrategy*  other) ;

/// @brief Method GetDictionaryKey, addr 0x1817fab10, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetDictionaryKey(::StringW  key) ;

/// @brief Method GetExtensionDataName, addr 0x1817fab30, size 0x20, virtual true, abstract: false, final false
inline ::StringW GetExtensionDataName(::StringW  name) ;

/// @brief Method GetHashCode, addr 0x1817fab50, size 0xc0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetPropertyName, addr 0x1817fac10, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method get_OverrideSpecifiedNames, addr 0x180e837b0, size 0x60, virtual false, abstract: false, final false
inline bool get_OverrideSpecifiedNames() ;

/// @brief Method get_ProcessDictionaryKeys, addr 0x180392490, size 0x10, virtual false, abstract: false, final false
inline bool get_ProcessDictionaryKeys() ;

/// @brief Method get_ProcessExtensionDataNames, addr 0x180503b10, size 0x10, virtual false, abstract: false, final false
inline bool get_ProcessExtensionDataNames() ;

/// @brief Method set_OverrideSpecifiedNames, addr 0x181014340, size 0x2de0, virtual false, abstract: false, final false
inline void set_OverrideSpecifiedNames(bool  value) ;

/// @brief Method set_ProcessDictionaryKeys, addr 0x1803924a0, size 0x10, virtual false, abstract: false, final false
inline void set_ProcessDictionaryKeys(bool  value) ;

/// @brief Method set_ProcessExtensionDataNames, addr 0x180503b60, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::NamingStrategy) == 0x18, "Size mismatch!");
