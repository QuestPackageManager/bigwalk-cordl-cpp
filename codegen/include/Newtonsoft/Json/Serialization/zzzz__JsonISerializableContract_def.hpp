...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::JsonISerializableContract*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::JsonISerializableContract*, "Newtonsoft.Json.Serialization", "JsonISerializableContract");
...
/// @brief Field <ISerializableCreator>k__BackingField, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__ISerializableCreator_k__BackingField, put=__cordl_internal_set__ISerializableCreator_k__BackingField)) ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>*  _ISerializableCreator_k__BackingField;
...
/// @brief Method .ctor, addr 0x1817d7730, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_ISerializableCreator, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ISerializableCreator() ;

/// @brief Method set_ISerializableCreator, addr 0x1803d3a10, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::JsonISerializableContract) == 0xc8, "Size mismatch!");
