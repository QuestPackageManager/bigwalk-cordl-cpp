...
/// @brief Method CreateTemporaryDictionary, addr 0x1817d6370, size 0x190, virtual false, abstract: false, final false
inline ::System::Collections::IDictionary* CreateTemporaryDictionary() ;

/// @brief Method CreateWrapper, addr 0x1817d6500, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817d66f0, size 0x8b0, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_DictionaryKeyResolver, addr 0x1802edc30, size 0x10, virtual false, abstract: false, final false
inline ::System::Func_2<::StringW,::StringW>* get_DictionaryKeyResolver() ;

/// @brief Method get_DictionaryKeyType, addr 0x1803223b0, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_DictionaryKeyType() ;

/// @brief Method get_DictionaryValueType, addr 0x1803b2f10, size 0x10, virtual false, abstract: false, final false
inline ::System::Type* get_DictionaryValueType() ;

/// @brief Method get_HasParameterizedCreator, addr 0x1803716c0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreator() ;

/// @brief Method get_HasParameterizedCreatorInternal, addr 0x1817d6fa0, size 0x30, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreatorInternal() ;

/// @brief Method get_KeyContract, addr 0x1803b2dc0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* get_KeyContract() ;

/// @brief Method get_OverrideCreator, addr 0x1803370d0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator() ;

/// @brief Method get_ParameterizedCreator, addr 0x1817d6fd0, size 0x80, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator() ;

/// @brief Method get_ShouldCreateWrapper, addr 0x1817d7050, size 0x10, virtual false, abstract: false, final false
inline bool get_ShouldCreateWrapper() ;

/// @brief Method set_DictionaryKeyResolver, addr 0x1803d3a10, size 0x20, virtual false, abstract: false, final false
inline void set_DictionaryKeyResolver(::System::Func_2<::StringW,::StringW>*  value) ;

/// @brief Method set_HasParameterizedCreator, addr 0x1817d7060, size 0x10, virtual false, abstract: false, final false
inline void set_HasParameterizedCreator(bool  value) ;

/// @brief Method set_KeyContract, addr 0x1813fdc30, size 0x20, virtual false, abstract: false, final false
inline void set_KeyContract(::Newtonsoft::Json::Serialization::JsonContract*  value) ;

/// @brief Method set_OverrideCreator, addr 0x180337190, size 0x20, virtual false, abstract: false, final false
