...
/// @brief Method Close, addr 0x1817fb090, size 0x30, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetDeserializedJsonMessage, addr 0x1817fb0c0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x1817fb510, size 0x80, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAsBoolean, addr 0x1817fb0f0, size 0x80, virtual true, abstract: false, final false
inline ::System::Nullable_1<bool> ReadAsBoolean() ;

/// @brief Method ReadAsBytes, addr 0x1817fb170, size 0x80, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t> ReadAsBytes() ;

/// @brief Method ReadAsDateTime, addr 0x1817fb280, size 0x80, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> ReadAsDateTime() ;

/// @brief Method ReadAsDateTimeOffset, addr 0x1817fb1f0, size 0x90, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::DateTimeOffset> ReadAsDateTimeOffset() ;

/// @brief Method ReadAsDecimal, addr 0x1817fb300, size 0x90, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::Decimal> ReadAsDecimal() ;

/// @brief Method ReadAsDouble, addr 0x1817fb390, size 0x80, virtual true, abstract: false, final false
inline ::System::Nullable_1<double_t> ReadAsDouble() ;

/// @brief Method ReadAsInt32, addr 0x1817fb410, size 0x80, virtual true, abstract: false, final false
inline ::System::Nullable_1<int32_t> ReadAsInt32() ;

/// @brief Method ReadAsString, addr 0x1817fb490, size 0x80, virtual true, abstract: false, final false
inline ::StringW ReadAsString() ;

/// @brief Method WriteCurrentToken, addr 0x1817fb590, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817fb5e0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method set_QuoteChar, addr 0x1817fb6f0, size 0x30, virtual true, abstract: false, final false
