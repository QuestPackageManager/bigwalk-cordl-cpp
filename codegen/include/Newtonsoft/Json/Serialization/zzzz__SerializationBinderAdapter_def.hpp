...
/// @brief Method BindToName, addr 0x1817fb020, size 0x30, virtual true, abstract: false, final true
inline void BindToName(::System::Type*  serializedType, ::by_ref<::StringW>  assemblyName, ::by_ref<::StringW>  typeName) ;

/// @brief Method BindToType, addr 0x1817fb050, size 0x30, virtual true, abstract: false, final true
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::SerializationBinderAdapter) == 0x18, "Size mismatch!");
