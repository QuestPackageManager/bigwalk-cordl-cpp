...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Serialization::ReflectionAttributeProvider*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Serialization::ReflectionAttributeProvider*, "Newtonsoft.Json.Serialization", "ReflectionAttributeProvider");
...
/// @brief Method GetAttributes, addr 0x1817fac40, size 0x50, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IList_1<::System::Attribute*>* GetAttributes(::System::Type*  attributeType, bool  inherit) ;

/// @brief Method GetAttributes, addr 0x1817fac90, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1817face0, size 0x40, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Serialization::ReflectionAttributeProvider) == 0x18, "Size mismatch!");
