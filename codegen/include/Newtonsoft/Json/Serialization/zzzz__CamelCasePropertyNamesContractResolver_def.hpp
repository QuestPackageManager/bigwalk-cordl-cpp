...
/// @brief Method GetNameTable, addr 0x1817cd4f0, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method ResolveContract, addr 0x1817cd530, size 0x270, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type*  type) ;

/// @brief Method .ctor, addr 0x1817cd830, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
