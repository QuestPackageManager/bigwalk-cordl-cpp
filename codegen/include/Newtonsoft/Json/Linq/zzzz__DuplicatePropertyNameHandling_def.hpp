...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling, "Newtonsoft.Json.Linq", "DuplicatePropertyNameHandling");
// Dependencies 
namespace Newtonsoft::Json::Linq {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling) == 0x4, "Size mismatch!");
