...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonLoadSettings*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonLoadSettings*, "Newtonsoft.Json.Linq", "JsonLoadSettings");
...
/// @brief Field _duplicatePropertyNameHandling, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__duplicatePropertyNameHandling, put=__cordl_internal_set__duplicatePropertyNameHandling)) ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling  _duplicatePropertyNameHandling;
...
/// @brief Method .ctor, addr 0x181810900, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CommentHandling, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::CommentHandling get_CommentHandling() ;

/// @brief Method get_DuplicatePropertyNameHandling, addr 0x1802f41a0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling get_DuplicatePropertyNameHandling() ;

/// @brief Method get_LineInfoHandling, addr 0x1803924b0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::LineInfoHandling get_LineInfoHandling() ;

/// @brief Method set_CommentHandling, addr 0x181810910, size 0x30, virtual false, abstract: false, final false
inline void set_CommentHandling(::Newtonsoft::Json::Linq::CommentHandling  value) ;

/// @brief Method set_DuplicatePropertyNameHandling, addr 0x181810940, size 0x30, virtual false, abstract: false, final false
inline void set_DuplicatePropertyNameHandling(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling  value) ;

/// @brief Method set_LineInfoHandling, addr 0x181788a40, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonLoadSettings) == 0x20, "Size mismatch!");
