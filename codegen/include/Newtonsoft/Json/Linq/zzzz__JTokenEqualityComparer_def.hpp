...
/// @brief Method Equals, addr 0x18181d900, size 0x20, virtual true, abstract: false, final true
inline bool Equals(::Newtonsoft::Json::Linq::JToken*  x, ::Newtonsoft::Json::Linq::JToken*  y) ;

/// @brief Method GetHashCode, addr 0x18181d920, size 0x30, virtual true, abstract: false, final true
