...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JProperty__LoadAsync_d__4, "Newtonsoft.Json.Linq", "JProperty/<LoadAsync>d__4");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JProperty__WriteToAsync_d__1, "Newtonsoft.Json.Linq", "JProperty/<WriteToAsync>d__1");
...
/// @brief Method MoveNext, addr 0x181811990, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x180308500, size 0x30, virtual true, abstract: false, final true
inline void Add(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method Clear, addr 0x181677430, size 0x20, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x181806e80, size 0x10, virtual true, abstract: false, final true
inline bool Contains(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method CopyTo, addr 0x181806e90, size 0x40, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::Newtonsoft::Json::Linq::JToken*>  array, int32_t  arrayIndex) ;

/// @brief Method GetEnumerator, addr 0x181806ed0, size 0x50, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x181806f20, size 0x10, virtual true, abstract: false, final true
inline int32_t IndexOf(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method Insert, addr 0x181806f30, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x181806f70, size 0x30, virtual true, abstract: false, final true
inline bool Remove(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method RemoveAt, addr 0x181806f50, size 0x20, virtual true, abstract: false, final true
inline void RemoveAt(int32_t  index) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181806ed0, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method get_Count, addr 0x181806fa0, size 0x10, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x1802e2bd0, size 0x10, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Item, addr 0x181806fb0, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method set_Item, addr 0x181806fd0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x181812760, size 0x540, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::Newtonsoft::Json::Linq::JProperty*>", modifiers: "", def_value: None }, CppParam { name: "reader", ty: "::Newtonsoft::Json::JsonReader*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "settings", ty: "::Newtonsoft::Json::Linq::JsonLoadSettings*", modifiers: "", def_value: None }, CppParam { name: "_p_5__2", ty: "::Newtonsoft::Json::Linq::JProperty*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<bool>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JProperty__LoadAsync_d__4) == 0x60, "Size mismatch!");
...
/// @brief Method MoveNext, addr 0x181814cf0, size 0x290, virtual true, abstract: false, final true
inline void MoveNext() ;
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JProperty__WriteToAsync_d__1) == 0x58, "Size mismatch!");
...
/// @brief Method ClearItems, addr 0x181807000, size 0x80, virtual true, abstract: false, final false
inline void ClearItems() ;

/// @brief Method CloneToken, addr 0x181807080, size 0x80, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* CloneToken(::Newtonsoft::Json::Linq::JsonCloneSettings*  settings) ;

/// @brief Method ContainsItem, addr 0x181807100, size 0x20, virtual true, abstract: false, final false
inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method DeepEquals, addr 0x181807120, size 0x80, virtual true, abstract: false, final false
inline bool DeepEquals(::Newtonsoft::Json::Linq::JToken*  node) ;

/// @brief Method GetDeepHashCode, addr 0x1818071a0, size 0x80, virtual true, abstract: false, final false
inline int32_t GetDeepHashCode() ;

/// @brief Method GetItem, addr 0x181807220, size 0x30, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* GetItem(int32_t  index) ;

/// @brief Method IndexOfItem, addr 0x181807250, size 0x40, virtual true, abstract: false, final false
inline int32_t IndexOfItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method InsertItem, addr 0x181807290, size 0x100, virtual true, abstract: false, final false
inline bool InsertItem(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  item, bool  skipParentCheck, bool  copyAnnotations) ;

/// @brief Method Load, addr 0x181807480, size 0x10, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JProperty* Load(::Newtonsoft::Json::JsonReader*  reader) ;

/// @brief Method Load, addr 0x181807490, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method LoadAsync, addr 0x181807470, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method LoadAsync, addr 0x181807390, size 0xe0, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<::Newtonsoft::Json::Linq::JProperty*>* LoadAsync(::Newtonsoft::Json::JsonReader*  reader, ::Newtonsoft::Json::Linq::JsonLoadSettings*  settings, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method MergeItem, addr 0x1818076f0, size 0x90, virtual true, abstract: false, final false
...
static inline ::Newtonsoft::Json::Linq::JProperty* New_ctor(::StringW  name, ::ArrayW<::System::Object*>  content) ;
...
/// @brief Method RemoveItem, addr 0x181807000, size 0x80, virtual true, abstract: false, final false
inline bool RemoveItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method RemoveItemAt, addr 0x181807000, size 0x80, virtual true, abstract: false, final false
inline void RemoveItemAt(int32_t  index) ;

/// @brief Method SetItem, addr 0x181807780, size 0x270, virtual true, abstract: false, final false
inline void SetItem(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method WriteTo, addr 0x181807c80, size 0xa0, virtual true, abstract: false, final false
inline void WriteTo(::Newtonsoft::Json::JsonWriter*  writer, ::ArrayW<::Newtonsoft::Json::JsonConverter*>  converters) ;

/// @brief Method WriteToAsync, addr 0x1818079f0, size 0x100, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WriteToAsync(::System::Threading::Tasks::Task*  task, ::Newtonsoft::Json::JsonWriter*  writer, ::System::Threading::CancellationToken  cancellationToken, ::ArrayW<::Newtonsoft::Json::JsonConverter*>  converters) ;

/// @brief Method WriteToAsync, addr 0x181807af0, size 0x190, virtual true, abstract: false, final false
...
/// @brief Method WriteValueAsync, addr 0x181807d20, size 0x70, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WriteValueAsync(::Newtonsoft::Json::JsonWriter*  writer, ::System::Threading::CancellationToken  cancellationToken, ::ArrayW<::Newtonsoft::Json::JsonConverter*>  converters) ;
...
/// @brief Method .ctor, addr 0x181807e80, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x181807d90, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::ArrayW<::System::Object*>  content) ;

/// @brief Method .ctor, addr 0x181807ee0, size 0x160, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Object*  content) ;

/// @brief Method .ctor, addr 0x181807da0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Linq::JProperty*  other) ;

/// @brief Method .ctor, addr 0x181807e10, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Name, addr 0x1803a74d0, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Type, addr 0x180309580, size 0x10, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JTokenType get_Type() ;

/// @brief Method get_Value, addr 0x181808040, size 0x20, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* get_Value() ;

/// @brief Method set_Value, addr 0x181808060, size 0xd0, virtual false, abstract: false, final false
