...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::QueryOperator, "Newtonsoft.Json.Linq.JsonPath", "QueryOperator");
// Dependencies 
namespace Newtonsoft::Json::Linq::JsonPath {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryOperator, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryOperator) == 0x4, "Size mismatch!");
