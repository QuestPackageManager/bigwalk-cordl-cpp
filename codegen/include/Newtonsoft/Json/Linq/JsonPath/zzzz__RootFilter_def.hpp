...
/// @brief Method ExecuteFilter, addr 0x1818259b0, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::RootFilter) == 0x10, "Size mismatch!");
