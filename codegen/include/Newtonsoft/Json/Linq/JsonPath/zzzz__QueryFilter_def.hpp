...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::QueryFilter*);
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::QueryFilter__ExecuteFilter_d__2*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::QueryFilter*, "Newtonsoft.Json.Linq.JsonPath", "QueryFilter");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::QueryFilter__ExecuteFilter_d__2*, "Newtonsoft.Json.Linq.JsonPath", "QueryFilter/<ExecuteFilter>d__2");
...
/// @brief Method MoveNext, addr 0x181827340, size 0x2d0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Newtonsoft::Json::Linq::JsonPath::QueryFilter__ExecuteFilter_d__2* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x1818280b0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x1818280b0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x181828600, size 0x130, virtual true, abstract: false, final true
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryFilter__ExecuteFilter_d__2) == 0x70, "Size mismatch!");
...
/// @brief Method ExecuteFilter, addr 0x181824e70, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryFilter) == 0x18, "Size mismatch!");
