...
namespace Newtonsoft::Json::Linq::JsonPath {
class QueryScanFilter__ExecuteFilter_d__2;
}
...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter*);
MARK_REF_T(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter*, "Newtonsoft.Json.Linq.JsonPath", "QueryScanFilter");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2*, "Newtonsoft.Json.Linq.JsonPath", "QueryScanFilter/<ExecuteFilter>d__2");
// Dependencies System.Object
namespace Newtonsoft::Json::Linq::JsonPath {
// Is value type: false
// CS Name: Newtonsoft.Json.Linq.JsonPath.QueryScanFilter/<ExecuteFilter>d__2
class CORDL_TYPE QueryScanFilter__ExecuteFilter_d__2 : public ::System::Object {
public:
// Declarations
...
/// @brief Method MoveNext, addr 0x181826fa0, size 0x3a0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator, addr 0x181828330, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x181828330, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method System.IDisposable.Dispose, addr 0x181828820, size 0x130, virtual true, abstract: false, final true
...
constexpr ::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter* const& __cordl_internal_get___4__this() const;
...
/// @brief Method <>m__Finally1, addr 0x180d75a40, size 0x15100, virtual false, abstract: false, final false
inline void __m__Finally1() ;

/// @brief Method <>m__Finally2, addr 0x181828a10, size 0x30, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr QueryScanFilter__ExecuteFilter_d__2() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "QueryScanFilter__ExecuteFilter_d__2", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
QueryScanFilter__ExecuteFilter_d__2(QueryScanFilter__ExecuteFilter_d__2 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "QueryScanFilter__ExecuteFilter_d__2", modifiers: "const&", def_value: None }]
...
static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, ___current) == 0x28, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____3__current) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____4__this) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, ___root) == 0x40, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____3__root) == 0x48, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, ___settings) == 0x50, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____3__settings) == 0x58, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____7__wrap1) == 0x60, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2, _____7__wrap2) == 0x68, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2) == 0x70, "Size mismatch!");
...
public:
// Declarations
using _ExecuteFilter_d__2 = ::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter__ExecuteFilter_d__2;
...
/// @brief Method ExecuteFilter, addr 0x181824f20, size 0xb0, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryScanFilter) == 0x18, "Size mismatch!");
