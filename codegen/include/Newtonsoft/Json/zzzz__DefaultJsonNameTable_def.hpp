...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::DefaultJsonNameTable*);
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*>  _entries;
...
/// @brief Method Add, addr 0x18177d150, size 0x2b0, virtual false, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x18177cfb0, size 0x1a0, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x18177d400, size 0x1b0, virtual true, abstract: false, final false
inline ::StringW Get(::ArrayW<char16_t>  key, int32_t  start, int32_t  length) ;

/// @brief Method Grow, addr 0x18177d5b0, size 0x100, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x18177d6b0, size 0x80, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*> const& __cordl_internal_get__entries() const;

constexpr ::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*>& __cordl_internal_get__entries() ;
...
constexpr void __cordl_internal_set__entries(::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*>  value) ;

constexpr void __cordl_internal_set__mask(int32_t  value) ;

/// @brief Method .ctor, addr 0x18177d760, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _entries, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::Newtonsoft::Json::DefaultJsonNameTable_Entry*>  ____entries;
...
static_assert(sizeof(::Newtonsoft::Json::DefaultJsonNameTable) == 0x28, "Size mismatch!");
