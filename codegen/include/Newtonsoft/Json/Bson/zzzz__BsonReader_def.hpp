...
MARK_REF_T(::Newtonsoft::Json::Bson::BsonReader*);
MARK_REF_T(::Newtonsoft::Json::Bson::BsonReader_ContainerContext*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonReader_BsonReaderState, "Newtonsoft.Json.Bson", "BsonReader/BsonReaderState");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonReader*, "Newtonsoft.Json.Bson", "BsonReader");
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonReader_ContainerContext*, "Newtonsoft.Json.Bson", "BsonReader/ContainerContext");
// Dependencies 
namespace Newtonsoft::Json::Bson {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Bson::BsonReader_BsonReaderState, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Bson::BsonReader_BsonReaderState) == 0x4, "Size mismatch!");
...
/// @brief Field SeqRange1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SeqRange1, put=setStaticF_SeqRange1)) ::ArrayW<uint8_t>  SeqRange1;

/// @brief Field SeqRange2, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SeqRange2, put=setStaticF_SeqRange2)) ::ArrayW<uint8_t>  SeqRange2;

/// @brief Field SeqRange3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SeqRange3, put=setStaticF_SeqRange3)) ::ArrayW<uint8_t>  SeqRange3;

/// @brief Field SeqRange4, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SeqRange4, put=setStaticF_SeqRange4)) ::ArrayW<uint8_t>  SeqRange4;
...
/// @brief Method BytesInSequence, addr 0x18182ab90, size 0xa0, virtual false, abstract: false, final false
inline int32_t BytesInSequence(uint8_t  b) ;

/// @brief Method Close, addr 0x18182ac30, size 0x40, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EnsureBuffers, addr 0x18182ac70, size 0xa0, virtual false, abstract: false, final false
inline void EnsureBuffers() ;

/// @brief Method GetLastFullCharStop, addr 0x18182ad10, size 0x100, virtual false, abstract: false, final false
inline int32_t GetLastFullCharStop(int32_t  start) ;

/// @brief Method GetString, addr 0x18182ae10, size 0x2a0, virtual false, abstract: false, final false
inline ::StringW GetString(int32_t  length) ;

/// @brief Method MovePosition, addr 0x18182b0b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method PopContext, addr 0x18182b0d0, size 0x90, virtual false, abstract: false, final false
inline void PopContext() ;

/// @brief Method PushContext, addr 0x18182b160, size 0x90, virtual false, abstract: false, final false
inline void PushContext(::Newtonsoft::Json::Bson::BsonReader_ContainerContext*  newContext) ;

/// @brief Method Read, addr 0x18182c420, size 0x120, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadBinary, addr 0x18182b1f0, size 0x100, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadBinary(::by_ref<::Newtonsoft::Json::Bson::BsonBinaryType>  binaryType) ;

/// @brief Method ReadByte, addr 0x18182b2f0, size 0x40, virtual false, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadBytes, addr 0x18182b330, size 0x40, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t> ReadBytes(int32_t  count) ;

/// @brief Method ReadCodeWScope, addr 0x18182b370, size 0x200, virtual false, abstract: false, final false
inline bool ReadCodeWScope() ;

/// @brief Method ReadDouble, addr 0x18182b570, size 0x40, virtual false, abstract: false, final false
inline double_t ReadDouble() ;

/// @brief Method ReadElement, addr 0x18182b5b0, size 0x50, virtual false, abstract: false, final false
inline ::StringW ReadElement() ;

/// @brief Method ReadInt32, addr 0x18182b600, size 0x40, virtual false, abstract: false, final false
inline int32_t ReadInt32() ;

/// @brief Method ReadInt64, addr 0x18182b640, size 0x40, virtual false, abstract: false, final false
inline int64_t ReadInt64() ;

/// @brief Method ReadLengthString, addr 0x18182b680, size 0x90, virtual false, abstract: false, final false
inline ::StringW ReadLengthString() ;

/// @brief Method ReadNormal, addr 0x18182b710, size 0x290, virtual false, abstract: false, final false
inline bool ReadNormal() ;

/// @brief Method ReadReference, addr 0x18182b9a0, size 0x270, virtual false, abstract: false, final false
inline bool ReadReference() ;

/// @brief Method ReadString, addr 0x18182bc10, size 0x260, virtual false, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ReadType, addr 0x18182c3e0, size 0x40, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Bson::BsonType ReadType() ;

/// @brief Method ReadType, addr 0x18182be70, size 0x570, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18182c720, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::IO::BinaryReader*  reader) ;

/// @brief Method .ctor, addr 0x18182c680, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::BinaryReader*  reader, bool  readRootValueAsArray, ::System::DateTimeKind  dateTimeKindHandling) ;

/// @brief Method .ctor, addr 0x18182c7b0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream) ;

/// @brief Method .ctor, addr 0x18182c860, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, bool  readRootValueAsArray, ::System::DateTimeKind  dateTimeKindHandling) ;

static inline ::ArrayW<uint8_t> getStaticF_SeqRange1() ;

static inline ::ArrayW<uint8_t> getStaticF_SeqRange2() ;

static inline ::ArrayW<uint8_t> getStaticF_SeqRange3() ;

static inline ::ArrayW<uint8_t> getStaticF_SeqRange4() ;

/// @brief Method get_DateTimeKindHandling, addr 0x1803b2c70, size 0x10, virtual false, abstract: false, final false
inline ::System::DateTimeKind get_DateTimeKindHandling() ;

/// @brief Method get_JsonNet35BinaryCompatibility, addr 0x1803b2d40, size 0x10, virtual false, abstract: false, final false
inline bool get_JsonNet35BinaryCompatibility() ;

/// @brief Method get_ReadRootValueAsArray, addr 0x1803b2c80, size 0x10, virtual false, abstract: false, final false
inline bool get_ReadRootValueAsArray() ;

static inline void setStaticF_SeqRange1(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_SeqRange2(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_SeqRange3(::ArrayW<uint8_t>  value) ;

static inline void setStaticF_SeqRange4(::ArrayW<uint8_t>  value) ;

/// @brief Method set_DateTimeKindHandling, addr 0x18182c930, size 0x10, virtual false, abstract: false, final false
inline void set_DateTimeKindHandling(::System::DateTimeKind  value) ;

/// @brief Method set_JsonNet35BinaryCompatibility, addr 0x181581490, size 0x10, virtual false, abstract: false, final false
inline void set_JsonNet35BinaryCompatibility(bool  value) ;

/// @brief Method set_ReadRootValueAsArray, addr 0x1803b30e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonReader) == 0xb0, "Size mismatch!");
