...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonType, "Newtonsoft.Json.Bson", "BsonType");
// Dependencies 
namespace Newtonsoft::Json::Bson {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Bson::BsonType, value__) == 0x1, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Bson::BsonType) == 0x1, "Size mismatch!");
