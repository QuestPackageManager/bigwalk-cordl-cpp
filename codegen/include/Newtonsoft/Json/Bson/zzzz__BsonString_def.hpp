...
/// @brief Method .ctor, addr 0x18182c9f0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  value, bool  includeLength) ;

/// @brief Method get_ByteCount, addr 0x1802e2ba0, size 0x10, virtual false, abstract: false, final false
inline int32_t get_ByteCount() ;

/// @brief Method get_IncludeLength, addr 0x1803e0b00, size 0x10, virtual false, abstract: false, final false
inline bool get_IncludeLength() ;

/// @brief Method set_ByteCount, addr 0x1802e2f70, size 0x10, virtual false, abstract: false, final false
