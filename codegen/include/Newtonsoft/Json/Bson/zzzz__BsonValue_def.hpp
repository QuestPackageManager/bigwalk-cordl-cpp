...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Bson::BsonValue*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Bson::BsonValue*, "Newtonsoft.Json.Bson", "BsonValue");
...
/// @brief Method .ctor, addr 0x18182ca30, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  value, ::Newtonsoft::Json::Bson::BsonType  type) ;

/// @brief Method get_Type, addr 0x1802f1be0, size 0x10, virtual true, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::Bson::BsonValue) == 0x30, "Size mismatch!");
