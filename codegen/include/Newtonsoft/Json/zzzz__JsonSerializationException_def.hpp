...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::JsonSerializationException*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonSerializationException*, "Newtonsoft.Json", "JsonSerializationException");
...
/// @brief Method Create, addr 0x1817854c0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x181785280, size 0x120, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::JsonSerializationException* Create(::Newtonsoft::Json::JsonReader*  reader, ::StringW  message) ;

/// @brief Method Create, addr 0x1817853a0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817811e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  path, int32_t  lineNumber, int32_t  linePosition, ::System::Exception*  innerException) ;

/// @brief Method get_LineNumber, addr 0x1805d4730, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x180cbfa00, size 0x10, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_Path, addr 0x1802ec4b0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::JsonSerializationException) == 0xa0, "Size mismatch!");
