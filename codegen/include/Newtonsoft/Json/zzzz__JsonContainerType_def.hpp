...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonContainerType, "Newtonsoft.Json", "JsonContainerType");
// Dependencies 
namespace Newtonsoft::Json {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::JsonContainerType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::JsonContainerType) == 0x4, "Size mismatch!");
