...
/// @brief Method .ctor, addr 0x1817fd420, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method get_Schema, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <GenerateInternal>b__0, addr 0x1817fdd90, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method AddNullType, addr 0x1817eba60, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x1817ecfc0, size 0x90, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type) ;

/// @brief Method Generate, addr 0x1817ecfa0, size 0x20, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type, ::Newtonsoft::Json::Schema::JsonSchemaResolver*  resolver) ;

/// @brief Method Generate, addr 0x1817ecf10, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x1817ece70, size 0xa0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type, bool  rootSchemaNullable) ;

/// @brief Method GenerateISerializableContract, addr 0x1817eba70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GenerateInternal, addr 0x1817eba90, size 0x10c0, virtual false, abstract: false, final false
...
/// @brief Method GenerateObjectSchema, addr 0x1817ecb50, size 0x320, virtual false, abstract: false, final false
inline void GenerateObjectSchema(::System::Type*  type, ::Newtonsoft::Json::Serialization::JsonObjectContract*  contract) ;

/// @brief Method GetDescription, addr 0x1817ed050, size 0xb0, virtual false, abstract: false, final false
inline ::StringW GetDescription(::System::Type*  type) ;

/// @brief Method GetJsonSchemaType, addr 0x1817ed100, size 0x1d0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaType GetJsonSchemaType(::System::Type*  type, ::Newtonsoft::Json::Required  valueRequired) ;

/// @brief Method GetTitle, addr 0x1817ed2d0, size 0x50, virtual false, abstract: false, final false
inline ::StringW GetTitle(::System::Type*  type) ;

/// @brief Method GetTypeId, addr 0x1817ed320, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method HasFlag, addr 0x1817ed3e0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x1817ed490, size 0x140, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaGenerator_TypeSchema* Pop() ;

/// @brief Method Push, addr 0x1817ed5d0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817ed6c0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ContractResolver, addr 0x1817ed710, size 0x50, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::IContractResolver* get_ContractResolver() ;

/// @brief Method get_CurrentSchema, addr 0x1802d97f0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* get_CurrentSchema() ;

/// @brief Method get_UndefinedSchemaIdHandling, addr 0x180303b50, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::UndefinedSchemaIdHandling get_UndefinedSchemaIdHandling() ;

/// @brief Method set_ContractResolver, addr 0x1802ecc20, size 0x10, virtual false, abstract: false, final false
inline void set_ContractResolver(::Newtonsoft::Json::Serialization::IContractResolver*  value) ;

/// @brief Method set_UndefinedSchemaIdHandling, addr 0x180378ff0, size 0x10, virtual false, abstract: false, final false
