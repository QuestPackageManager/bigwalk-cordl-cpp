...
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Schema::JsonSchemaType, "Newtonsoft.Json.Schema", "JsonSchemaType");
// Dependencies 
namespace Newtonsoft::Json::Schema {
// Is value type: true
...
static_assert(offsetof(::Newtonsoft::Json::Schema::JsonSchemaType, value__) == 0x4, "Offset mismatch!");

static_assert(sizeof(::Newtonsoft::Json::Schema::JsonSchemaType) == 0x4, "Size mismatch!");
