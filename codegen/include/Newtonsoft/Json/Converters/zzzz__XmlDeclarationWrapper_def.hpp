...
/// @brief Method get_Encoding, addr 0x181831830, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Encoding() ;

/// @brief Method get_Standalone, addr 0x181831850, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Standalone() ;

/// @brief Method get_Version, addr 0x181831870, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method set_Encoding, addr 0x181831890, size 0x20, virtual true, abstract: false, final true
inline void set_Encoding(::StringW  value) ;

/// @brief Method set_Standalone, addr 0x1818318b0, size 0x20, virtual true, abstract: false, final true
