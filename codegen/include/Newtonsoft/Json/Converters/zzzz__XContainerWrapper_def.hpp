...
/// @brief Method AppendChild, addr 0x18182f720, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method WrapNode, addr 0x18182f7d0, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method get_ChildNodes, addr 0x18182fae0, size 0x2d0, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes() ;

/// @brief Method get_Container, addr 0x18182fdb0, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XContainer* get_Container() ;

/// @brief Method get_HasChildNodes, addr 0x18182fe00, size 0x60, virtual true, abstract: false, final false
inline bool get_HasChildNodes() ;

/// @brief Method get_ParentNode, addr 0x18182fe60, size 0xc0, virtual true, abstract: false, final false
