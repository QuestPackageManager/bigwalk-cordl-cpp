...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::Converters::IXmlDocumentType*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::Converters::IXmlDocumentType*, "Newtonsoft.Json.Converters", "IXmlDocumentType");
// Dependencies 
namespace Newtonsoft::Json::Converters {
// Is value type: false
