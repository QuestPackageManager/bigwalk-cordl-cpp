...
/// @brief Method .ctor, addr 0x181830010, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDocumentType*  documentType) ;

/// @brief Method get_InternalSubset, addr 0x181830050, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_InternalSubset() ;

/// @brief Method get_LocalName, addr 0x181830070, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x181830080, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Name() ;

/// @brief Method get_Public, addr 0x1818300a0, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Public() ;

/// @brief Method get_System, addr 0x1818300c0, size 0x20, virtual true, abstract: false, final true
