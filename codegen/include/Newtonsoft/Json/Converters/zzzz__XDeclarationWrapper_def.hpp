...
/// @brief Method .ctor, addr 0x18182ff20, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDeclaration*  declaration) ;

/// @brief Method get_Declaration, addr 0x1802ecc10, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XDeclaration* get_Declaration() ;

/// @brief Method get_Encoding, addr 0x180da2e30, size 0x1d0, virtual true, abstract: false, final true
...
/// @brief Method get_Standalone, addr 0x18182ff70, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Standalone() ;

/// @brief Method get_Version, addr 0x18182ff90, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method set_Encoding, addr 0x18182ffb0, size 0x30, virtual true, abstract: false, final true
inline void set_Encoding(::StringW  value) ;

/// @brief Method set_Standalone, addr 0x18182ffe0, size 0x30, virtual true, abstract: false, final true
...
static_assert(sizeof(::Newtonsoft::Json::Converters::XDeclarationWrapper) == 0x20, "Size mismatch!");
