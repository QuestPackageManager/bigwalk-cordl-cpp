...
/// @brief Method .ctor, addr 0x1803d5ac0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::MemberSerialization  memberSerialization) ;

/// @brief Method get_ItemNullValueHandling, addr 0x180371760, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::NullValueHandling get_ItemNullValueHandling() ;

/// @brief Method get_ItemRequired, addr 0x1803becf0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Required get_ItemRequired() ;

/// @brief Method get_MemberSerialization, addr 0x1803d5ab0, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method get_MissingMemberHandling, addr 0x1803fa740, size 0x10, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::MissingMemberHandling get_MissingMemberHandling() ;

/// @brief Method set_ItemNullValueHandling, addr 0x181780560, size 0x30, virtual false, abstract: false, final false
inline void set_ItemNullValueHandling(::Newtonsoft::Json::NullValueHandling  value) ;

/// @brief Method set_ItemRequired, addr 0x181780590, size 0x30, virtual false, abstract: false, final false
inline void set_ItemRequired(::Newtonsoft::Json::Required  value) ;

/// @brief Method set_MemberSerialization, addr 0x1803d5ac0, size 0x10, virtual false, abstract: false, final false
inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization  value) ;

/// @brief Method set_MissingMemberHandling, addr 0x1817805c0, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::JsonObjectAttribute) == 0x88, "Size mismatch!");
