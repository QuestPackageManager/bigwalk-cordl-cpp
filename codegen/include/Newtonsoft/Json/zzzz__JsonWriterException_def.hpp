...
/// @brief Method Create, addr 0x1817c5a00, size 0x80, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::JsonWriterException* Create(::StringW  path, ::StringW  message, ::System::Exception*  ex) ;

/// @brief Method Create, addr 0x1817c5a80, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x1817c5b20, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  path, ::System::Exception*  innerException) ;

/// @brief Method get_Path, addr 0x180312ea0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Newtonsoft::Json::JsonWriterException) == 0x98, "Size mismatch!");
