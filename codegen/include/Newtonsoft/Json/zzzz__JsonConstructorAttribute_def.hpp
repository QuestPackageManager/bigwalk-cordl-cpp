...
// Write type traits
MARK_REF_T(::Newtonsoft::Json::JsonConstructorAttribute*);
DEFINE_IL2CPP_CLASS(::Newtonsoft::Json::JsonConstructorAttribute*, "Newtonsoft.Json", "JsonConstructorAttribute");
...
static_assert(sizeof(::Newtonsoft::Json::JsonConstructorAttribute) == 0x10, "Size mismatch!");
